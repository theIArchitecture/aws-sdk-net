...
{
    /// <summary>
    /// Implementation of CRC64NVME, using the SDK-wide instance of AWS Common Runtime's checksums.
    /// </summary>
    public class CrtCrc64NVME : HashAlgorithm
    {
        ...
        protected override void HashCore(byte[] array, int ibStart, int cbSize)
        {
            ...
            _rollingResult = ChecksumCRTWrapper.Crc64NVME(buffer, _rollingResult);
        }
