...
namespace Amazon.ACMPCA.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AccessDescriptionUnmarshaller : IJsonUnmarshaller<AccessDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AccessDescription Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
