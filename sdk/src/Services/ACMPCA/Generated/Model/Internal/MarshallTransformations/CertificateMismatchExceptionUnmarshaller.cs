...
namespace Amazon.ACMPCA.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CertificateMismatchExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<CertificateMismatchException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public CertificateMismatchException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public CertificateMismatchException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
