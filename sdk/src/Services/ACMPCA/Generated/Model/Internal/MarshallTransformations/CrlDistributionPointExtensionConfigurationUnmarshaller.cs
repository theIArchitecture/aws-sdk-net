...
namespace Amazon.ACMPCA.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CrlDistributionPointExtensionConfigurationUnmarshaller : IJsonUnmarshaller<CrlDistributionPointExtensionConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CrlDistributionPointExtensionConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("OmitExtension", targetDepth))
                {
                    ...
                    unmarshalledObject.OmitExtension = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
