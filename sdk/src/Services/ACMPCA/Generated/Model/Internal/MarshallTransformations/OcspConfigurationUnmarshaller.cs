...
namespace Amazon.ACMPCA.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OcspConfigurationUnmarshaller : IJsonUnmarshaller<OcspConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public OcspConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("OcspCustomCname", targetDepth))
                {
                    ...
                    unmarshalledObject.OcspCustomCname = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
