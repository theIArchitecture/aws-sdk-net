...
namespace Amazon.ACMPCA.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RevocationConfigurationUnmarshaller : IJsonUnmarshaller<RevocationConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RevocationConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
