...
namespace Amazon.ACMPCA.Model
{
    ...
    public partial class RequestAlreadyProcessedException : AmazonACMPCAException
    {
        ...
        public RequestAlreadyProcessedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public RequestAlreadyProcessedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
