...
namespace Amazon.AIOps.Internal
{
    ...
    public class AmazonAIOpsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonAIOpsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for AIOps.
        /// </summary>
        public AmazonAIOpsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonAIOpsAuthSchemeParameters
            {
    ...
    public class AmazonAIOpsAuthSchemeResolver : IAuthSchemeResolver<AmazonAIOpsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonAIOpsAuthSchemeParameters authParameters)
        {
