...
namespace Amazon.AIOps.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateInvestigationGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateInvestigationGroupResponse response = new CreateInvestigationGroupResponse();
        ...
        internal static CreateInvestigationGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateInvestigationGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
