...
{
    /// <summary>
    /// Response Unmarshaller for ListInvestigationGroups operation
    /// </summary>  
    public class ListInvestigationGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListInvestigationGroupsResponse response = new ListInvestigationGroupsResponse();
        ...
        private static ListInvestigationGroupsResponseUnmarshaller _instance = new ListInvestigationGroupsResponseUnmarshaller();        

        internal static ListInvestigationGroupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListInvestigationGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
