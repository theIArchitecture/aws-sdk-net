...
namespace Amazon.AIOps.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateInvestigationGroupRequestMarshaller : IMarshaller<IRequest, UpdateInvestigationGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static UpdateInvestigationGroupRequestMarshaller _instance = new UpdateInvestigationGroupRequestMarshaller();        

        internal static UpdateInvestigationGroupRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateInvestigationGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
