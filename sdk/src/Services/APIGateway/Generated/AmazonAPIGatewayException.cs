...
namespace Amazon.APIGateway
{
    ...
    public partial class AmazonAPIGatewayException : AmazonServiceException
    {
        ...
        public AmazonAPIGatewayException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonAPIGatewayException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
