...
{
    /// <summary>
    /// Response Unmarshaller for CreateDomainNameAccessAssociation operation
    /// </summary>  
    public class CreateDomainNameAccessAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDomainNameAccessAssociationResponse response = new CreateDomainNameAccessAssociationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("accessAssociationSource", targetDepth))
                {
                    ...
                    response.AccessAssociationSource = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("accessAssociationSourceType", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AccessAssociationSourceType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("domainNameAccessAssociationArn", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.DomainNameAccessAssociationArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateDomainNameAccessAssociationResponseUnmarshaller _instance = new CreateDomainNameAccessAssociationResponseUnmarshaller();        

        internal static CreateDomainNameAccessAssociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDomainNameAccessAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
