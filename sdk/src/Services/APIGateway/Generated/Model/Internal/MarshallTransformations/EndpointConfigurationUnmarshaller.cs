...
namespace Amazon.APIGateway.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EndpointConfigurationUnmarshaller : IJsonUnmarshaller<EndpointConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EndpointConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.VpcEndpointIds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
