...
namespace Amazon.APIGateway.Model
{
    ...
    internal sealed partial class GetApiKeysPaginator : IPaginator<GetApiKeysResponse>, IGetApiKeysPaginator
    {
        ...
        public IPaginatedEnumerable<ApiKey> Items => 
            new PaginatedResultKeyResponse<GetApiKeysResponse, ApiKey>(this, (i) => i.Items ?? new List<ApiKey>());
        ...
        async IAsyncEnumerable<GetApiKeysResponse> IPaginator<GetApiKeysResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
