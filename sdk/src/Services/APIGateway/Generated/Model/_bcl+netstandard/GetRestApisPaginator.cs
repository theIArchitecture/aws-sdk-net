...
namespace Amazon.APIGateway.Model
{
    ...
    internal sealed partial class GetRestApisPaginator : IPaginator<GetRestApisResponse>, IGetRestApisPaginator
    {
        ...
        public IPaginatedEnumerable<RestApi> Items => 
            new PaginatedResultKeyResponse<GetRestApisResponse, RestApi>(this, (i) => i.Items ?? new List<RestApi>());
        ...
        async IAsyncEnumerable<GetRestApisResponse> IPaginator<GetRestApisResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
