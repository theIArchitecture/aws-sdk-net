...
namespace Amazon.APIGateway.Model
{
    ...
    internal sealed partial class GetUsagePlansPaginator : IPaginator<GetUsagePlansResponse>, IGetUsagePlansPaginator
    {
        ...
        public IPaginatedEnumerable<UsagePlan> Items => 
            new PaginatedResultKeyResponse<GetUsagePlansResponse, UsagePlan>(this, (i) => i.Items ?? new List<UsagePlan>());
        ...
        async IAsyncEnumerable<GetUsagePlansResponse> IPaginator<GetUsagePlansResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
