...
namespace Amazon.ARCRegionswitch.Internal
{
    ...
    public class AmazonARCRegionswitchAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonARCRegionswitchAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ARCRegionswitch.
        /// </summary>
        public AmazonARCRegionswitchAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonARCRegionswitchAuthSchemeParameters
            {
    ...
    public class AmazonARCRegionswitchAuthSchemeResolver : IAuthSchemeResolver<AmazonARCRegionswitchAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonARCRegionswitchAuthSchemeParameters authParameters)
        {
