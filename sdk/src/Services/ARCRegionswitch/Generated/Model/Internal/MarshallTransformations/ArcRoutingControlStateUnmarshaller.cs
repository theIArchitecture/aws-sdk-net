...
namespace Amazon.ARCRegionswitch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ArcRoutingControlStateUnmarshaller : IJsonUnmarshaller<ArcRoutingControlState, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ArcRoutingControlState Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
