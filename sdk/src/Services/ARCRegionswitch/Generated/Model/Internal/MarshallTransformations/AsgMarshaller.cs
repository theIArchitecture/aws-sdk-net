...
namespace Amazon.ARCRegionswitch.Model.Internal.MarshallTransformations
{
    ...
    /// Asg Marshaller
    /// </summary>
    public class AsgMarshaller : IRequestMarshaller<Asg, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(Asg requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static AsgMarshaller Instance = new AsgMarshaller();
