...
{
    /// <summary>
    /// CancelPlanExecution Request Marshaller
    /// </summary>       
    public class CancelPlanExecutionRequestMarshaller : IMarshaller<IRequest, CancelPlanExecutionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CancelPlanExecutionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CancelPlanExecutionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ARCRegionswitch");
            string target = "ArcRegionSwitch.CancelPlanExecution";
        ...
        private static CancelPlanExecutionRequestMarshaller _instance = new CancelPlanExecutionRequestMarshaller();        

        internal static CancelPlanExecutionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelPlanExecutionRequestMarshaller Instance
        {
            get
            {
                return _instance;
