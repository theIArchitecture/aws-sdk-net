...
{
    /// <summary>
    /// Response Unmarshaller for CreatePlan operation
    /// </summary>  
    public class CreatePlanResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreatePlanResponseUnmarshaller _instance = new CreatePlanResponseUnmarshaller();        

        internal static CreatePlanResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePlanResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
