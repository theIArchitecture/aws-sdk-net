...
{
    /// <summary>
    /// Response Unmarshaller for CustomActionLambdaConfiguration Object
    /// </summary>  
    public class CustomActionLambdaConfigurationUnmarshaller : IJsonUnmarshaller<CustomActionLambdaConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CustomActionLambdaConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            CustomActionLambdaConfiguration unmarshalledObject = new CustomActionLambdaConfiguration();
        ...
        private static CustomActionLambdaConfigurationUnmarshaller _instance = new CustomActionLambdaConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CustomActionLambdaConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
