...
{
    /// <summary>
    /// Response Unmarshaller for EcsCapacityIncreaseConfiguration Object
    /// </summary>  
    public class EcsCapacityIncreaseConfigurationUnmarshaller : IJsonUnmarshaller<EcsCapacityIncreaseConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EcsCapacityIncreaseConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            EcsCapacityIncreaseConfiguration unmarshalledObject = new EcsCapacityIncreaseConfiguration();
        ...
        private static EcsCapacityIncreaseConfigurationUnmarshaller _instance = new EcsCapacityIncreaseConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static EcsCapacityIncreaseConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
