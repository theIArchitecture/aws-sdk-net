...
namespace Amazon.ARCRegionswitch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExecutionApprovalConfigurationUnmarshaller : IJsonUnmarshaller<ExecutionApprovalConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ExecutionApprovalConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("approvalRole", targetDepth))
                {
                    ...
                    unmarshalledObject.ApprovalRole = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
