...
namespace Amazon.ARCRegionswitch.Model.Internal.MarshallTransformations
{
    ...
    /// Lambdas Marshaller
    /// </summary>
    public class LambdasMarshaller : IRequestMarshaller<Lambdas, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(Lambdas requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static LambdasMarshaller Instance = new LambdasMarshaller();
