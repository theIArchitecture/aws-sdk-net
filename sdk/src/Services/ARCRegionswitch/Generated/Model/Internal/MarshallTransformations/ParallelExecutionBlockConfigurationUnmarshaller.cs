...
namespace Amazon.ARCRegionswitch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ParallelExecutionBlockConfigurationUnmarshaller : IJsonUnmarshaller<ParallelExecutionBlockConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ParallelExecutionBlockConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
