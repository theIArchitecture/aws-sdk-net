...
{
    /// <summary>
    /// Response Unmarshaller for Route53HealthCheckConfiguration Object
    /// </summary>  
    public class Route53HealthCheckConfigurationUnmarshaller : IJsonUnmarshaller<Route53HealthCheckConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Route53HealthCheckConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            Route53HealthCheckConfiguration unmarshalledObject = new Route53HealthCheckConfiguration();
        ...
        private static Route53HealthCheckConfigurationUnmarshaller _instance = new Route53HealthCheckConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static Route53HealthCheckConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
