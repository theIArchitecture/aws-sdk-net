...
namespace Amazon.ARCRegionswitch.Model.Internal.MarshallTransformations
{
    ...
    /// Service Marshaller
    /// </summary>
    public class ServiceMarshaller : IRequestMarshaller<Service, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(Service requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static ServiceMarshaller Instance = new ServiceMarshaller();
