...
{
    /// <summary>
    /// UpdatePlanExecution Request Marshaller
    /// </summary>       
    public class UpdatePlanExecutionRequestMarshaller : IMarshaller<IRequest, UpdatePlanExecutionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdatePlanExecutionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdatePlanExecutionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ARCRegionswitch");
            string target = "ArcRegionSwitch.UpdatePlanExecution";
        ...
        private static UpdatePlanExecutionRequestMarshaller _instance = new UpdatePlanExecutionRequestMarshaller();        

        internal static UpdatePlanExecutionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePlanExecutionRequestMarshaller Instance
        {
            get
            {
                return _instance;
