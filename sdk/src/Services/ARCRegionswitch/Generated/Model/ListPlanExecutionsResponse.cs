...
{
    /// <summary>
    /// This is the response object from the ListPlanExecutions operation.
    /// </summary>
    public partial class ListPlanExecutionsResponse : AmazonWebServiceResponse
    {
        private List<AbbreviatedExecution> _items = AWSConfigs.InitializeCollections ? new List<AbbreviatedExecution>() : null;
        ...
        /// </summary>
        public List<AbbreviatedExecution> Items
        {
