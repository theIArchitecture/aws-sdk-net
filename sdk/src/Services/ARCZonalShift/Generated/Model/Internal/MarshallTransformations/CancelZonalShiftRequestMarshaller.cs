...
{
    /// <summary>
    /// CancelZonalShift Request Marshaller
    /// </summary>       
    public class CancelZonalShiftRequestMarshaller : IMarshaller<IRequest, CancelZonalShiftRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CancelZonalShiftRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CancelZonalShiftRequest publicRequest)
        {
        ...
        private static CancelZonalShiftRequestMarshaller _instance = new CancelZonalShiftRequestMarshaller();        

        internal static CancelZonalShiftRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelZonalShiftRequestMarshaller Instance
        {
            get
            {
                return _instance;
