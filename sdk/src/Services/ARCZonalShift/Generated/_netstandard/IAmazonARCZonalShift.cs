...
namespace Amazon.ARCZonalShift
{
    ...
    public partial interface IAmazonARCZonalShift : IAmazonService, IDisposable
    {
        ...
        Task<CancelPracticeRunResponse> CancelPracticeRunAsync(CancelPracticeRunRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StartPracticeRunResponse> StartPracticeRunAsync(StartPracticeRunRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonARCZonalShiftConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonARCZonalShiftConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonARCZonalShiftConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonARCZonalShiftConfig to create AmazonARCZonalShiftClient");
            }

            return awsCredentials == null ? 
                    new AmazonARCZonalShiftClient(serviceClientConfig) :
                    new AmazonARCZonalShiftClient(awsCredentials, serviceClientConfig);
        }
