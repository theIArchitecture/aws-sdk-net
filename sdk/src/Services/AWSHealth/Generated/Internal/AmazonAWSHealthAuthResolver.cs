...
namespace Amazon.AWSHealth.Internal
{
    ...
    public class AmazonAWSHealthAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonAWSHealthAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for AWSHealth.
        /// </summary>
        public AmazonAWSHealthAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonAWSHealthAuthSchemeParameters
            {
    ...
    public class AmazonAWSHealthAuthSchemeResolver : IAuthSchemeResolver<AmazonAWSHealthAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonAWSHealthAuthSchemeParameters authParameters)
        {
