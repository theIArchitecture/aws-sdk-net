...
namespace Amazon.AWSHealth.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UnsupportedLocaleExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<UnsupportedLocaleException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public UnsupportedLocaleException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public UnsupportedLocaleException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
