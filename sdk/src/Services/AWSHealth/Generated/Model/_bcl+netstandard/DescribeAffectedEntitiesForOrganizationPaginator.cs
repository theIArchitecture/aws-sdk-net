...
namespace Amazon.AWSHealth.Model
{
    ...
    internal sealed partial class DescribeAffectedEntitiesForOrganizationPaginator : IPaginator<DescribeAffectedEntitiesForOrganizationResponse>, IDescribeAffectedEntitiesForOrganizationPaginator
    {
        ...
        public IPaginatedEnumerable<AffectedEntity> Entities => 
            new PaginatedResultKeyResponse<DescribeAffectedEntitiesForOrganizationResponse, AffectedEntity>(this, (i) => i.Entities ?? new List<AffectedEntity>());
        ...
        async IAsyncEnumerable<DescribeAffectedEntitiesForOrganizationResponse> IPaginator<DescribeAffectedEntitiesForOrganizationResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
