...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonAWSHealthConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonAWSHealthConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonAWSHealthConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonAWSHealthConfig to create AmazonAWSHealthClient");
            }

            return awsCredentials == null ? 
                    new AmazonAWSHealthClient(serviceClientConfig) :
                    new AmazonAWSHealthClient(awsCredentials, serviceClientConfig);
        }
