...
namespace Amazon.AWSMarketplaceCommerceAnalytics
{
    ...
    public partial class AmazonAWSMarketplaceCommerceAnalyticsException : AmazonServiceException
    {
        ...
        public AmazonAWSMarketplaceCommerceAnalyticsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonAWSMarketplaceCommerceAnalyticsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
