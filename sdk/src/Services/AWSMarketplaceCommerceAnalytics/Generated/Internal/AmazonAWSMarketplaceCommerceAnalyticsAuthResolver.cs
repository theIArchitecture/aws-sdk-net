...
namespace Amazon.AWSMarketplaceCommerceAnalytics.Internal
{
    ...
    public class AmazonAWSMarketplaceCommerceAnalyticsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonAWSMarketplaceCommerceAnalyticsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for AWSMarketplaceCommerceAnalytics.
        /// </summary>
        public AmazonAWSMarketplaceCommerceAnalyticsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonAWSMarketplaceCommerceAnalyticsAuthSchemeParameters
            {
    ...
    public class AmazonAWSMarketplaceCommerceAnalyticsAuthSchemeResolver : IAuthSchemeResolver<AmazonAWSMarketplaceCommerceAnalyticsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonAWSMarketplaceCommerceAnalyticsAuthSchemeParameters authParameters)
        {
