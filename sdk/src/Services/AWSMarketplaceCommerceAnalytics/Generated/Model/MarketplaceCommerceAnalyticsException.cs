...
namespace Amazon.AWSMarketplaceCommerceAnalytics.Model
{
    ...
    public partial class MarketplaceCommerceAnalyticsException : AmazonAWSMarketplaceCommerceAnalyticsException
    {
        ...
        public MarketplaceCommerceAnalyticsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public MarketplaceCommerceAnalyticsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
