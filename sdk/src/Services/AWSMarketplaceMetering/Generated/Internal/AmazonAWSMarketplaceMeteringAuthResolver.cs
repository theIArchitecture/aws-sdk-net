...
namespace Amazon.AWSMarketplaceMetering.Internal
{
    ...
    public class AmazonAWSMarketplaceMeteringAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonAWSMarketplaceMeteringAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for AWSMarketplaceMetering.
        /// </summary>
        public AmazonAWSMarketplaceMeteringAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonAWSMarketplaceMeteringAuthSchemeParameters
            {
    ...
    public class AmazonAWSMarketplaceMeteringAuthSchemeResolver : IAuthSchemeResolver<AmazonAWSMarketplaceMeteringAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonAWSMarketplaceMeteringAuthSchemeParameters authParameters)
        {
