...
namespace Amazon.AWSMarketplaceMetering.Model
{
    ...
    public partial class CustomerNotEntitledException : AmazonAWSMarketplaceMeteringException
    {
        ...
        public CustomerNotEntitledException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CustomerNotEntitledException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
