...
namespace Amazon.AWSMarketplaceMetering.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DisabledApiExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<DisabledApiException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public DisabledApiException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public DisabledApiException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
