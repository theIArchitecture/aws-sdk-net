...
namespace Amazon.AWSMarketplaceMetering.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InvalidCustomerIdentifierExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<InvalidCustomerIdentifierException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public InvalidCustomerIdentifierException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public InvalidCustomerIdentifierException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
