...
namespace Amazon.AWSMarketplaceMetering.Model
{
    ...
    public partial class InvalidCustomerIdentifierException : AmazonAWSMarketplaceMeteringException
    {
        ...
        public InvalidCustomerIdentifierException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidCustomerIdentifierException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
