...
namespace Amazon.AWSMarketplaceMetering.Model
{
    ...
    public partial class InvalidEndpointRegionException : AmazonAWSMarketplaceMeteringException
    {
        ...
        public InvalidEndpointRegionException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidEndpointRegionException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
