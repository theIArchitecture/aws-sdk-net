...
namespace Amazon.AWSMarketplaceMetering.Model
{
    ...
    public partial class InvalidProductCodeException : AmazonAWSMarketplaceMeteringException
    {
        ...
        public InvalidProductCodeException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidProductCodeException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
