...
namespace Amazon.AWSMarketplaceMetering.Model
{
    ...
    public partial class InvalidPublicKeyVersionException : AmazonAWSMarketplaceMeteringException
    {
        ...
        public InvalidPublicKeyVersionException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidPublicKeyVersionException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
