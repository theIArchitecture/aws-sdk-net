...
namespace Amazon.AWSMarketplaceMetering.Model
{
    ...
    public partial class InvalidUsageAllocationsException : AmazonAWSMarketplaceMeteringException
    {
        ...
        public InvalidUsageAllocationsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidUsageAllocationsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
