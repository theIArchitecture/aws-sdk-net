...
namespace Amazon.AWSMarketplaceMetering.Model
{
    ...
    public partial class InvalidUsageDimensionException : AmazonAWSMarketplaceMeteringException
    {
        ...
        public InvalidUsageDimensionException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidUsageDimensionException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
