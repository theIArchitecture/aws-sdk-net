...
namespace Amazon.AWSMarketplaceMetering.Model
{
    ...
    public partial class TimestampOutOfBoundsException : AmazonAWSMarketplaceMeteringException
    {
        ...
        public TimestampOutOfBoundsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TimestampOutOfBoundsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
