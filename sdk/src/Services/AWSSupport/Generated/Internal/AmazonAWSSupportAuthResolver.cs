...
namespace Amazon.AWSSupport.Internal
{
    ...
    public class AmazonAWSSupportAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonAWSSupportAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for AWSSupport.
        /// </summary>
        public AmazonAWSSupportAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonAWSSupportAuthSchemeParameters
            {
    ...
    public class AmazonAWSSupportAuthSchemeResolver : IAuthSchemeResolver<AmazonAWSSupportAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonAWSSupportAuthSchemeParameters authParameters)
        {
