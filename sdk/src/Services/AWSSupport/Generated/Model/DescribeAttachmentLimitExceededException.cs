...
namespace Amazon.AWSSupport.Model
{
    ...
    public partial class DescribeAttachmentLimitExceededException : AmazonAWSSupportException
    {
        ...
        public DescribeAttachmentLimitExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DescribeAttachmentLimitExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
