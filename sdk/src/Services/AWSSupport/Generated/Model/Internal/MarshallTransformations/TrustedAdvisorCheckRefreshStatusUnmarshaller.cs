...
namespace Amazon.AWSSupport.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TrustedAdvisorCheckRefreshStatusUnmarshaller : IJsonUnmarshaller<TrustedAdvisorCheckRefreshStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TrustedAdvisorCheckRefreshStatus Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("millisUntilNextRefreshable", targetDepth))
                {
                    ...
                    unmarshalledObject.MillisUntilNextRefreshable = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
