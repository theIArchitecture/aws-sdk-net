...
namespace Amazon.AccessAnalyzer.Model
{
    ...
    /// configuration for a new DynamoDB stream or an existing DynamoDB stream that you own
    /// by specifying the policy for the DynamoDB stream. For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_PutResourcePolicy.html">PutResourcePolicy</a>.
    /// 
    ///  <ul> <li> 
    /// <para>
    ...
    /// the access preview assumes a DynamoDB stream without a policy.
    /// </para>
    ///  </li> <li> 
    /// <para>
    ...
    ///  </li> </ul>
    /// </summary>
    public partial class DynamodbStreamConfiguration
    {
        private string _streamPolicy;

        /// <summary>
        /// Gets and sets the property StreamPolicy. 
        /// <para>
        /// The proposed resource policy defining who can access or manage the DynamoDB stream.
        /// </para>
        /// </summary>
        public string StreamPolicy
        {
            get { return this._streamPolicy; }
            set { this._streamPolicy = value; }
        }

        // Check to see if StreamPolicy property is set
        internal bool IsSetStreamPolicy()
        {
            return this._streamPolicy != null;
        }
