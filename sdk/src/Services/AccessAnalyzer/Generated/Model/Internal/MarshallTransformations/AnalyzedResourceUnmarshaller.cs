...
namespace Amazon.AccessAnalyzer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AnalyzedResourceUnmarshaller : IJsonUnmarshaller<AnalyzedResource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AnalyzedResource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.SharedVia = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
