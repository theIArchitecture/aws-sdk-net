...
namespace Amazon.AccessAnalyzer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AnalyzerConfigurationUnmarshaller : IJsonUnmarshaller<AnalyzerConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AnalyzerConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("unusedAccess", targetDepth))
                {
                    ...
                    unmarshalledObject.UnusedAccess = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
