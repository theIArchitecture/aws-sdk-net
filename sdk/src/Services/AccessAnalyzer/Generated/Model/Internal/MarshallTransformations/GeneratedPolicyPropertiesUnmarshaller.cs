...
namespace Amazon.AccessAnalyzer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GeneratedPolicyPropertiesUnmarshaller : IJsonUnmarshaller<GeneratedPolicyProperties, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            GeneratedPolicyProperties unmarshalledObject = new GeneratedPolicyProperties();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GeneratedPolicyPropertiesUnmarshaller Instance
        {
            get
            {
                return _instance;
