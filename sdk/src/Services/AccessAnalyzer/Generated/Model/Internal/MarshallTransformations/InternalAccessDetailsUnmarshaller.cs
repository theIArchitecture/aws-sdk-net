...
{
    /// <summary>
    /// Response Unmarshaller for InternalAccessDetails Object
    /// </summary>  
    public class InternalAccessDetailsUnmarshaller : IJsonUnmarshaller<InternalAccessDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InternalAccessDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            InternalAccessDetails unmarshalledObject = new InternalAccessDetails();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("principalOwnerAccount", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PrincipalOwnerAccount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("serviceControlPolicyRestriction", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ServiceControlPolicyRestriction = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static InternalAccessDetailsUnmarshaller _instance = new InternalAccessDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static InternalAccessDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
