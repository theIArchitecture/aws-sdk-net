...
namespace Amazon.AccessAnalyzer.Model.Internal.MarshallTransformations
{
    ...
    public class UnusedIamUserAccessKeyDetailsUnmarshaller : IJsonUnmarshaller<UnusedIamUserAccessKeyDetails, JsonUnmarshallerContext>
    {
        ...
        private static UnusedIamUserAccessKeyDetailsUnmarshaller _instance = new UnusedIamUserAccessKeyDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static UnusedIamUserAccessKeyDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
