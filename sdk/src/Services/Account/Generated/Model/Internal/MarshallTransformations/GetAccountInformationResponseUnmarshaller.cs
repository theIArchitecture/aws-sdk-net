...
{
    /// <summary>
    /// Response Unmarshaller for GetAccountInformation operation
    /// </summary>  
    public class GetAccountInformationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("AccountCreatedDate", targetDepth))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    response.AccountCreatedDate = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetAccountInformationResponseUnmarshaller _instance = new GetAccountInformationResponseUnmarshaller();        

        internal static GetAccountInformationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAccountInformationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
