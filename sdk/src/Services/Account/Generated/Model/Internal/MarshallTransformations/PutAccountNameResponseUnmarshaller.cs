...
{
    /// <summary>
    /// Response Unmarshaller for PutAccountName operation
    /// </summary>  
    public class PutAccountNameResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutAccountNameResponse response = new PutAccountNameResponse();
        ...
        private static PutAccountNameResponseUnmarshaller _instance = new PutAccountNameResponseUnmarshaller();        

        internal static PutAccountNameResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutAccountNameResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
