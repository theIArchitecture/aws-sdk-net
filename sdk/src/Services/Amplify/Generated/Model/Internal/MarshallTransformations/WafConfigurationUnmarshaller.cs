...
namespace Amazon.Amplify.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class WafConfigurationUnmarshaller : IJsonUnmarshaller<WafConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public WafConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.WafStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
