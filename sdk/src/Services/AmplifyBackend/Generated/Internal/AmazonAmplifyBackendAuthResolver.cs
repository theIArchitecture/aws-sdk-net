...
namespace Amazon.AmplifyBackend.Internal
{
    ...
    public class AmazonAmplifyBackendAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonAmplifyBackendAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for AmplifyBackend.
        /// </summary>
        public AmazonAmplifyBackendAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonAmplifyBackendAuthSchemeParameters
            {
    ...
    public class AmazonAmplifyBackendAuthSchemeResolver : IAuthSchemeResolver<AmazonAmplifyBackendAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonAmplifyBackendAuthSchemeParameters authParameters)
        {
