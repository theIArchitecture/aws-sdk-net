...
namespace Amazon.AmplifyBackend.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BackendAPIAuthTypeUnmarshaller : IJsonUnmarshaller<BackendAPIAuthType, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BackendAPIAuthType Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
