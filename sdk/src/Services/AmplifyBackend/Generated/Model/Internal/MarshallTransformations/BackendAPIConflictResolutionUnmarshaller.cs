...
namespace Amazon.AmplifyBackend.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BackendAPIConflictResolutionUnmarshaller : IJsonUnmarshaller<BackendAPIConflictResolution, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BackendAPIConflictResolution Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
