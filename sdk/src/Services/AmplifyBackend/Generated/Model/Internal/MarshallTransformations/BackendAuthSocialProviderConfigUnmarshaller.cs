...
namespace Amazon.AmplifyBackend.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BackendAuthSocialProviderConfigUnmarshaller : IJsonUnmarshaller<BackendAuthSocialProviderConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BackendAuthSocialProviderConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
