...
namespace Amazon.AmplifyBackend.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateBackendAuthForgotPasswordConfigUnmarshaller : IJsonUnmarshaller<CreateBackendAuthForgotPasswordConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CreateBackendAuthForgotPasswordConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
