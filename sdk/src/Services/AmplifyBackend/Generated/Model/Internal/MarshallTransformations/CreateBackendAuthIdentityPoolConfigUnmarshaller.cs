...
namespace Amazon.AmplifyBackend.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateBackendAuthIdentityPoolConfigUnmarshaller : IJsonUnmarshaller<CreateBackendAuthIdentityPoolConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CreateBackendAuthIdentityPoolConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("unauthenticatedLogin", targetDepth))
                {
                    ...
                    unmarshalledObject.UnauthenticatedLogin = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
