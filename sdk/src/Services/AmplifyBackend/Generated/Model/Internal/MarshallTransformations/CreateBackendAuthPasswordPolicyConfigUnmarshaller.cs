...
namespace Amazon.AmplifyBackend.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateBackendAuthPasswordPolicyConfigUnmarshaller : IJsonUnmarshaller<CreateBackendAuthPasswordPolicyConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CreateBackendAuthPasswordPolicyConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("additionalConstraints", targetDepth))
                {
                    ...
                    unmarshalledObject.AdditionalConstraints = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
