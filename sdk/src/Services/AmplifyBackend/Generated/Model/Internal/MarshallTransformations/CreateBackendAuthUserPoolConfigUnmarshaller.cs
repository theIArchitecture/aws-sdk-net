...
namespace Amazon.AmplifyBackend.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateBackendAuthUserPoolConfigUnmarshaller : IJsonUnmarshaller<CreateBackendAuthUserPoolConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CreateBackendAuthUserPoolConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
