...
namespace Amazon.AmplifyBackend.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EmailSettingsUnmarshaller : IJsonUnmarshaller<EmailSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EmailSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
