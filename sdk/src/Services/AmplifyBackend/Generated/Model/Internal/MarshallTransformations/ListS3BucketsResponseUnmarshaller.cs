...
{
    /// <summary>
    /// Response Unmarshaller for ListS3Buckets operation
    /// </summary>  
    public class ListS3BucketsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListS3BucketsResponse response = new ListS3BucketsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<S3BucketInfo, S3BucketInfoUnmarshaller>(S3BucketInfoUnmarshaller.Instance);
        ...
        private static ListS3BucketsResponseUnmarshaller _instance = new ListS3BucketsResponseUnmarshaller();        

        internal static ListS3BucketsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListS3BucketsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
