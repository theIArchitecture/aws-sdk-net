...
namespace Amazon.AmplifyUIBuilder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CodegenDependencyUnmarshaller : IJsonUnmarshaller<CodegenDependency, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CodegenDependency Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("isSemVer", targetDepth))
                {
                    ...
                    unmarshalledObject.IsSemVer = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SupportedVersion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
