...
namespace Amazon.AmplifyUIBuilder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FormDataTypeConfigUnmarshaller : IJsonUnmarshaller<FormDataTypeConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FormDataTypeConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DataTypeName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
