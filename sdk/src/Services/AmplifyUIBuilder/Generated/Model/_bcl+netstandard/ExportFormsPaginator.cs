...
namespace Amazon.AmplifyUIBuilder.Model
{
    ...
    internal sealed partial class ExportFormsPaginator : IPaginator<ExportFormsResponse>, IExportFormsPaginator
    {
        ...
        public IPaginatedEnumerable<Form> Entities => 
            new PaginatedResultKeyResponse<ExportFormsResponse, Form>(this, (i) => i.Entities ?? new List<Form>());
        ...
        async IAsyncEnumerable<ExportFormsResponse> IPaginator<ExportFormsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
