...
namespace Amazon.ApiGatewayManagementApi
{
    ...
    public partial class AmazonApiGatewayManagementApiException : AmazonServiceException
    {
        ...
        public AmazonApiGatewayManagementApiException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonApiGatewayManagementApiException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
