...
namespace Amazon.ApiGatewayManagementApi.Internal
{
    ...
    public class AmazonApiGatewayManagementApiAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonApiGatewayManagementApiAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ApiGatewayManagementApi.
        /// </summary>
        public AmazonApiGatewayManagementApiAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonApiGatewayManagementApiAuthSchemeParameters
            {
    ...
    public class AmazonApiGatewayManagementApiAuthSchemeResolver : IAuthSchemeResolver<AmazonApiGatewayManagementApiAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonApiGatewayManagementApiAuthSchemeParameters authParameters)
        {
