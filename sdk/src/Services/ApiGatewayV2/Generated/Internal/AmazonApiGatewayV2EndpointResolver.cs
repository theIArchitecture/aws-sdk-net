...
{
    /// <summary>
    /// Amazon ApiGatewayV2 endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for ApiGatewayV2 service requests.
    /// Collects values for ApiGatewayV2EndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses ApiGatewayV2EndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonApiGatewayV2EndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonApiGatewayV2Config)requestContext.ClientConfig;
            var result = new ApiGatewayV2EndpointParameters();
