...
namespace Amazon.ApiGatewayV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ApiMappingUnmarshaller : IJsonUnmarshaller<ApiMapping, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ApiMapping Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ApiMappingId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("apiMappingKey", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ApiMappingKey = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
