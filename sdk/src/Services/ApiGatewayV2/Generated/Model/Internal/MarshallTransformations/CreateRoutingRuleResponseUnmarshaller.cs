...
{
    /// <summary>
    /// Response Unmarshaller for CreateRoutingRule operation
    /// </summary>  
    public class CreateRoutingRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRoutingRuleResponse response = new CreateRoutingRuleResponse();
        ...
        private static CreateRoutingRuleResponseUnmarshaller _instance = new CreateRoutingRuleResponseUnmarshaller();        

        internal static CreateRoutingRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRoutingRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
