...
{
    /// <summary>
    /// Response Unmarshaller for GetRoutingRule operation
    /// </summary>  
    public class GetRoutingRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRoutingRuleResponse response = new GetRoutingRuleResponse();
        ...
        private static GetRoutingRuleResponseUnmarshaller _instance = new GetRoutingRuleResponseUnmarshaller();        

        internal static GetRoutingRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRoutingRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
