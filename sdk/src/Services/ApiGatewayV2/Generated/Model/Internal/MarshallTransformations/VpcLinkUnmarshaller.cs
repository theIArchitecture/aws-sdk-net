...
namespace Amazon.ApiGatewayV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VpcLinkUnmarshaller : IJsonUnmarshaller<VpcLink, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public VpcLink Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.VpcLinkStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("vpcLinkStatusMessage", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.VpcLinkStatusMessage = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("vpcLinkVersion", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.VpcLinkVersion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
