...
namespace Amazon.AppConfig.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConfigurationProfileSummaryUnmarshaller : IJsonUnmarshaller<ConfigurationProfileSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ConfigurationProfileSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ValidatorTypes", targetDepth))
                {
                    ...
                    unmarshalledObject.ValidatorTypes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
