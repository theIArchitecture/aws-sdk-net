...
namespace Amazon.AppConfig.Model.Internal.MarshallTransformations
{
    ...
    public class CreateExtensionAssociationRequestMarshaller : IMarshaller<IRequest, CreateExtensionAssociationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateExtensionAssociationRequest publicRequest)
        {
            ...
            {
                context.Writer.WritePropertyName("ExtensionIdentifier");
                context.Writer.WriteStringValue(publicRequest.ExtensionIdentifier);
            }

            if(publicRequest.IsSetExtensionVersionNumber())
            {
                context.Writer.WritePropertyName("ExtensionVersionNumber");
                context.Writer.WriteNumberValue(publicRequest.ExtensionVersionNumber.Value);
            }
        ...
        private static CreateExtensionAssociationRequestMarshaller _instance = new CreateExtensionAssociationRequestMarshaller();        

        internal static CreateExtensionAssociationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateExtensionAssociationRequestMarshaller Instance
        {
            get
            {
                return _instance;
