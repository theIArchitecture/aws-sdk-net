...
namespace Amazon.AppConfig.Model.Internal.MarshallTransformations
{
    ...
    public class CreateExtensionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static CreateExtensionResponseUnmarshaller _instance = new CreateExtensionResponseUnmarshaller();        

        internal static CreateExtensionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateExtensionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
