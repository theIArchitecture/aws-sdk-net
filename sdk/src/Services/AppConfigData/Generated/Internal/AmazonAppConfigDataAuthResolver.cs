...
namespace Amazon.AppConfigData.Internal
{
    ...
    public class AmazonAppConfigDataAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonAppConfigDataAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for AppConfigData.
        /// </summary>
        public AmazonAppConfigDataAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonAppConfigDataAuthSchemeParameters
            {
    ...
    public class AmazonAppConfigDataAuthSchemeResolver : IAuthSchemeResolver<AmazonAppConfigDataAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonAppConfigDataAuthSchemeParameters authParameters)
        {
