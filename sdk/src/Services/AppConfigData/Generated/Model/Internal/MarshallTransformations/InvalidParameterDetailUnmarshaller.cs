...
namespace Amazon.AppConfigData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InvalidParameterDetailUnmarshaller : IJsonUnmarshaller<InvalidParameterDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InvalidParameterDetail Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
