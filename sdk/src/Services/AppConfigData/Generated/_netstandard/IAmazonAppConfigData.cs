...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonAppConfigDataConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonAppConfigDataConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonAppConfigDataConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonAppConfigDataConfig to create AmazonAppConfigDataClient");
            }

            return awsCredentials == null ? 
                    new AmazonAppConfigDataClient(serviceClientConfig) :
                    new AmazonAppConfigDataClient(awsCredentials, serviceClientConfig);
        }
