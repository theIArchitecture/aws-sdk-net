...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AppBundleSummaryUnmarshaller : IJsonUnmarshaller<AppBundleSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AppBundleSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
