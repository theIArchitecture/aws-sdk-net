...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AppBundleUnmarshaller : IJsonUnmarshaller<AppBundle, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AppBundle Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.CustomerManagedKeyArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
