...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AuditLogDestinationConfigurationUnmarshaller : IJsonUnmarshaller<AuditLogDestinationConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AuditLogDestinationConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
