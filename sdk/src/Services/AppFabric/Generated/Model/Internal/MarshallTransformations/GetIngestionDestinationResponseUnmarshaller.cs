...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetIngestionDestinationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetIngestionDestinationResponse response = new GetIngestionDestinationResponse();
        ...
        internal static GetIngestionDestinationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetIngestionDestinationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
