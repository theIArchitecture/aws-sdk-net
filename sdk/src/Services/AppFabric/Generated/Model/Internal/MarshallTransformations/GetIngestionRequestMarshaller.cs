...
{
    /// <summary>
    /// GetIngestion Request Marshaller
    /// </summary>       
    public class GetIngestionRequestMarshaller : IMarshaller<IRequest, GetIngestionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetIngestionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetIngestionRequest publicRequest)
        {
        ...
        private static GetIngestionRequestMarshaller _instance = new GetIngestionRequestMarshaller();        

        internal static GetIngestionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetIngestionRequestMarshaller Instance
        {
            get
            {
                return _instance;
