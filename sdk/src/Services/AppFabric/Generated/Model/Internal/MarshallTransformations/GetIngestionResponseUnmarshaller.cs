...
{
    /// <summary>
    /// Response Unmarshaller for GetIngestion operation
    /// </summary>  
    public class GetIngestionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetIngestionResponse response = new GetIngestionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ingestion", targetDepth))
                {
                    ...
                    response.Ingestion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetIngestionResponseUnmarshaller _instance = new GetIngestionResponseUnmarshaller();        

        internal static GetIngestionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetIngestionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
