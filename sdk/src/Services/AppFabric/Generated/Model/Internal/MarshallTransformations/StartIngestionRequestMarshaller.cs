...
{
    /// <summary>
    /// StartIngestion Request Marshaller
    /// </summary>       
    public class StartIngestionRequestMarshaller : IMarshaller<IRequest, StartIngestionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartIngestionRequest)input);
        }
        ...
        public IRequest Marshall(StartIngestionRequest publicRequest)
        {
            ...
            request.ResourcePath = "/appbundles/{appBundleIdentifier}/ingestions/{ingestionIdentifier}/start";

            return request;
        }
        private static StartIngestionRequestMarshaller _instance = new StartIngestionRequestMarshaller();        

        internal static StartIngestionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartIngestionRequestMarshaller Instance
        {
            get
            {
                return _instance;
