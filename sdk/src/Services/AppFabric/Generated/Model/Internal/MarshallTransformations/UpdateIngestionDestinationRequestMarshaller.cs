...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateIngestionDestinationRequestMarshaller : IMarshaller<IRequest, UpdateIngestionDestinationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static UpdateIngestionDestinationRequestMarshaller _instance = new UpdateIngestionDestinationRequestMarshaller();        

        internal static UpdateIngestionDestinationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateIngestionDestinationRequestMarshaller Instance
        {
            get
            {
                return _instance;
