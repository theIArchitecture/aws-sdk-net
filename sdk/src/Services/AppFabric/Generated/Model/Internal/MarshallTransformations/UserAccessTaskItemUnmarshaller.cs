...
namespace Amazon.AppFabric.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UserAccessTaskItemUnmarshaller : IJsonUnmarshaller<UserAccessTaskItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            UserAccessTaskItem unmarshalledObject = new UserAccessTaskItem();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UserAccessTaskItemUnmarshaller Instance
        {
            get
            {
                return _instance;
