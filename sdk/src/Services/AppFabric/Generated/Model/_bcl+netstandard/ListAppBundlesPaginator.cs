...
{
    /// <summary>
    /// Base class for ListAppBundles paginators.
    /// </summary>
    internal sealed partial class ListAppBundlesPaginator : IPaginator<ListAppBundlesResponse>, IListAppBundlesPaginator
    {
        private readonly IAmazonAppFabric _client;
        private readonly ListAppBundlesRequest _request;
        private int _isPaginatorInUse = 0;
        
        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<ListAppBundlesResponse> Responses => new PaginatedResponse<ListAppBundlesResponse>(this);
...
#if BCL
        IEnumerable<ListAppBundlesResponse> IPaginator<ListAppBundlesResponse>.Paginate()
        {
            ...
            ListAppBundlesResponse response;
            do
            {
                _request.NextToken = nextToken;
                response = _client.ListAppBundles(_request);
        ...
        async IAsyncEnumerable<ListAppBundlesResponse> IPaginator<ListAppBundlesResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.ListAppBundlesAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
