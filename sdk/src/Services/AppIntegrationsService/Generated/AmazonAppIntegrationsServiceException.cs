...
namespace Amazon.AppIntegrationsService
{
    ...
    public partial class AmazonAppIntegrationsServiceException : AmazonServiceException
    {
        ...
        public AmazonAppIntegrationsServiceException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonAppIntegrationsServiceException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
