...
namespace Amazon.AppIntegrationsService.Internal
{
    ...
    public class AmazonAppIntegrationsServiceAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonAppIntegrationsServiceAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for AppIntegrationsService.
        /// </summary>
        public AmazonAppIntegrationsServiceAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonAppIntegrationsServiceAuthSchemeParameters
            {
    ...
    public class AmazonAppIntegrationsServiceAuthSchemeResolver : IAuthSchemeResolver<AmazonAppIntegrationsServiceAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonAppIntegrationsServiceAuthSchemeParameters authParameters)
        {
