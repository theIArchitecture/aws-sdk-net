    ...
    public class ApplicationConfigMarshaller : IRequestMarshaller<ApplicationConfig, JsonMarshallerContext> 
    {
        ...
        public void Marshall(ApplicationConfig requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetContactHandling())
            {
                context.Writer.WritePropertyName("ContactHandling");
                context.Writer.WriteStartObject();

                var marshaller = ContactHandlingMarshaller.Instance;
                marshaller.Marshall(requestObject.ContactHandling, context);
