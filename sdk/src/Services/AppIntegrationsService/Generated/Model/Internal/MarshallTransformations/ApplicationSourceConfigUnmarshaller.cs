...
namespace Amazon.AppIntegrationsService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ApplicationSourceConfigUnmarshaller : IJsonUnmarshaller<ApplicationSourceConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ApplicationSourceConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
