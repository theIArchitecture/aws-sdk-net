...
{
    /// <summary>
    /// Response Unmarshaller for CreateDataIntegrationAssociation operation
    /// </summary>  
    public class CreateDataIntegrationAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDataIntegrationAssociationResponse response = new CreateDataIntegrationAssociationResponse();
        ...
        private static CreateDataIntegrationAssociationResponseUnmarshaller _instance = new CreateDataIntegrationAssociationResponseUnmarshaller();        

        internal static CreateDataIntegrationAssociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDataIntegrationAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
