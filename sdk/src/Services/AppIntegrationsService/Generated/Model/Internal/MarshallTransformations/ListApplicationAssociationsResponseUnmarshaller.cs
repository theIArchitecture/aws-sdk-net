    ...
    public class ListApplicationAssociationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ApplicationAssociationSummary, ApplicationAssociationSummaryUnmarshaller>(ApplicationAssociationSummaryUnmarshaller.Instance);
                    response.ApplicationAssociations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
