    ...
    public class ListEventIntegrationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<EventIntegration, EventIntegrationUnmarshaller>(EventIntegrationUnmarshaller.Instance);
                    response.EventIntegrations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
