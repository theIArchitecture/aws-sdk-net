...
{
    /// <summary>
    /// Base class for ListDataIntegrationAssociations paginators.
    /// </summary>
    internal sealed partial class ListDataIntegrationAssociationsPaginator : IPaginator<ListDataIntegrationAssociationsResponse>, IListDataIntegrationAssociationsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<ListDataIntegrationAssociationsResponse> Responses => new PaginatedResponse<ListDataIntegrationAssociationsResponse>(this);
...
#if BCL
        IEnumerable<ListDataIntegrationAssociationsResponse> IPaginator<ListDataIntegrationAssociationsResponse>.Paginate()
        {
            ...
            ListDataIntegrationAssociationsResponse response;
            do
            {
                _request.NextToken = nextToken;
                response = _client.ListDataIntegrationAssociations(_request);
