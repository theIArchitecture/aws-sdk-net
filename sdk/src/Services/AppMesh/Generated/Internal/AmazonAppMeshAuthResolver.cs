...
namespace Amazon.AppMesh.Internal
{
    ...
    public class AmazonAppMeshAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonAppMeshAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for AppMesh.
        /// </summary>
        public AmazonAppMeshAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonAppMeshAuthSchemeParameters
            {
    ...
    public class AmazonAppMeshAuthSchemeResolver : IAuthSchemeResolver<AmazonAppMeshAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonAppMeshAuthSchemeParameters authParameters)
        {
