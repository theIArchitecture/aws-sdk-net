...
namespace Amazon.AppMesh.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class HttpGatewayRouteMatchUnmarshaller : IJsonUnmarshaller<HttpGatewayRouteMatch, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public HttpGatewayRouteMatch Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<HttpGatewayRouteHeader, HttpGatewayRouteHeaderUnmarshaller>(HttpGatewayRouteHeaderUnmarshaller.Instance);
