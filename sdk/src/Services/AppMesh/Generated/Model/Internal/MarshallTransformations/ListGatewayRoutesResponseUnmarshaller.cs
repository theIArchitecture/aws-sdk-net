    ...
    public class ListGatewayRoutesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<GatewayRouteRef, GatewayRouteRefUnmarshaller>(GatewayRouteRefUnmarshaller.Instance);
                    response.GatewayRoutes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
