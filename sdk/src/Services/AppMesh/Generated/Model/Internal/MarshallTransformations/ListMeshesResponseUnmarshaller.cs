    ...
    public class ListMeshesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<MeshRef, MeshRefUnmarshaller>(MeshRefUnmarshaller.Instance);
                    response.Meshes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
