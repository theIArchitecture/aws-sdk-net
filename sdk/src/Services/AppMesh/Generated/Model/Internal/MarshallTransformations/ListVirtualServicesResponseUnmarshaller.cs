    ...
    public class ListVirtualServicesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<VirtualServiceRef, VirtualServiceRefUnmarshaller>(VirtualServiceRefUnmarshaller.Instance);
                    response.VirtualServices = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
