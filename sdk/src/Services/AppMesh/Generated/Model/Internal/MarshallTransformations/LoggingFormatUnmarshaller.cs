...
namespace Amazon.AppMesh.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LoggingFormatUnmarshaller : IJsonUnmarshaller<LoggingFormat, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LoggingFormat Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<JsonFormatRef, JsonFormatRefUnmarshaller>(JsonFormatRefUnmarshaller.Instance);
