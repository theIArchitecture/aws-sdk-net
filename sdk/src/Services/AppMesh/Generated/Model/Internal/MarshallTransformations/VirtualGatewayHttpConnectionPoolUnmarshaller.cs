...
namespace Amazon.AppMesh.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VirtualGatewayHttpConnectionPoolUnmarshaller : IJsonUnmarshaller<VirtualGatewayHttpConnectionPool, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public VirtualGatewayHttpConnectionPool Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.MaxPendingRequests = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
