...
namespace Amazon.AppMesh.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VirtualGatewayTlsValidationContextAcmTrustUnmarshaller : IJsonUnmarshaller<VirtualGatewayTlsValidationContextAcmTrust, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public VirtualGatewayTlsValidationContextAcmTrust Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("certificateAuthorityArns", targetDepth))
                {
                    ...
                    unmarshalledObject.CertificateAuthorityArns = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
