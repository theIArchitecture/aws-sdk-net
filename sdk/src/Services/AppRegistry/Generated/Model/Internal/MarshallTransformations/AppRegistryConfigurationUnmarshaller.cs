...
namespace Amazon.AppRegistry.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AppRegistryConfigurationUnmarshaller : IJsonUnmarshaller<AppRegistryConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AppRegistryConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("tagQueryConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.TagQueryConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
