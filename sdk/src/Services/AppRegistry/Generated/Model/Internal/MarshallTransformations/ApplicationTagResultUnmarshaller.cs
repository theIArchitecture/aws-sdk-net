...
namespace Amazon.AppRegistry.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ApplicationTagResultUnmarshaller : IJsonUnmarshaller<ApplicationTagResult, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ApplicationTagResult Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("applicationTagStatus", targetDepth))
                {
                    ...
                    unmarshalledObject.ApplicationTagStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ResourcesListItem, ResourcesListItemUnmarshaller>(ResourcesListItemUnmarshaller.Instance);
