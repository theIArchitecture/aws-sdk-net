...
{
    /// <summary>
    /// Response Unmarshaller for CreateAutoScalingConfiguration operation
    /// </summary>  
    public class CreateAutoScalingConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAutoScalingConfigurationResponse response = new CreateAutoScalingConfigurationResponse();
        ...
        private static CreateAutoScalingConfigurationResponseUnmarshaller _instance = new CreateAutoScalingConfigurationResponseUnmarshaller();        

        internal static CreateAutoScalingConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAutoScalingConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
