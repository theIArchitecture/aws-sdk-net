...
{
    /// <summary>
    /// Response Unmarshaller for CreateObservabilityConfiguration operation
    /// </summary>  
    public class CreateObservabilityConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateObservabilityConfigurationResponse response = new CreateObservabilityConfigurationResponse();
        ...
        private static CreateObservabilityConfigurationResponseUnmarshaller _instance = new CreateObservabilityConfigurationResponseUnmarshaller();        

        internal static CreateObservabilityConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateObservabilityConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
