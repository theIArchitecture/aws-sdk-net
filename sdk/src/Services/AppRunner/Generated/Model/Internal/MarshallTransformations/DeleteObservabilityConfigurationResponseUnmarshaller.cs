...
{
    /// <summary>
    /// Response Unmarshaller for DeleteObservabilityConfiguration operation
    /// </summary>  
    public class DeleteObservabilityConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteObservabilityConfigurationResponse response = new DeleteObservabilityConfigurationResponse();
        ...
        private static DeleteObservabilityConfigurationResponseUnmarshaller _instance = new DeleteObservabilityConfigurationResponseUnmarshaller();        

        internal static DeleteObservabilityConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteObservabilityConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
