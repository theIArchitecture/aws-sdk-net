...
{
    /// <summary>
    /// Response Unmarshaller for DeleteVpcConnector operation
    /// </summary>  
    public class DeleteVpcConnectorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteVpcConnectorResponse response = new DeleteVpcConnectorResponse();
        ...
        private static DeleteVpcConnectorResponseUnmarshaller _instance = new DeleteVpcConnectorResponseUnmarshaller();        

        internal static DeleteVpcConnectorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVpcConnectorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
