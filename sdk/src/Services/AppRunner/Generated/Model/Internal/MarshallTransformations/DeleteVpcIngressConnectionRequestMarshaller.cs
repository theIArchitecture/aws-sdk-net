...
namespace Amazon.AppRunner.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteVpcIngressConnectionRequestMarshaller : IMarshaller<IRequest, DeleteVpcIngressConnectionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(DeleteVpcIngressConnectionRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetVpcIngressConnectionArn())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.VpcIngressConnectionArn);
            }
