...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAutoScalingConfiguration operation
    /// </summary>  
    public class DescribeAutoScalingConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAutoScalingConfigurationResponse response = new DescribeAutoScalingConfigurationResponse();
        ...
        private static DescribeAutoScalingConfigurationResponseUnmarshaller _instance = new DescribeAutoScalingConfigurationResponseUnmarshaller();        

        internal static DescribeAutoScalingConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAutoScalingConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
