...
{
    /// <summary>
    /// Response Unmarshaller for DescribeCustomDomains operation
    /// </summary>  
    public class DescribeCustomDomainsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeCustomDomainsResponse response = new DescribeCustomDomainsResponse();
        ...
        private static DescribeCustomDomainsResponseUnmarshaller _instance = new DescribeCustomDomainsResponseUnmarshaller();        

        internal static DescribeCustomDomainsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeCustomDomainsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
