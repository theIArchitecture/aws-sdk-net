...
{
    /// <summary>
    /// Response Unmarshaller for DescribeObservabilityConfiguration operation
    /// </summary>  
    public class DescribeObservabilityConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeObservabilityConfigurationResponse response = new DescribeObservabilityConfigurationResponse();
        ...
        private static DescribeObservabilityConfigurationResponseUnmarshaller _instance = new DescribeObservabilityConfigurationResponseUnmarshaller();        

        internal static DescribeObservabilityConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeObservabilityConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
