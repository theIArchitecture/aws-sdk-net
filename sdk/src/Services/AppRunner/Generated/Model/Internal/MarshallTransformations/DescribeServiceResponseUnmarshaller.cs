...
{
    /// <summary>
    /// Response Unmarshaller for DescribeService operation
    /// </summary>  
    public class DescribeServiceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeServiceResponseUnmarshaller _instance = new DescribeServiceResponseUnmarshaller();        

        internal static DescribeServiceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeServiceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
