...
namespace Amazon.AppRunner.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IngressConfigurationUnmarshaller : IJsonUnmarshaller<IngressConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IngressConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("IsPubliclyAccessible", targetDepth))
                {
                    ...
                    unmarshalledObject.IsPubliclyAccessible = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
