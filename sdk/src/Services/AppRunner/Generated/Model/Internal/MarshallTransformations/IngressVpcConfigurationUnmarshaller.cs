...
namespace Amazon.AppRunner.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IngressVpcConfigurationUnmarshaller : IJsonUnmarshaller<IngressVpcConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IngressVpcConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
