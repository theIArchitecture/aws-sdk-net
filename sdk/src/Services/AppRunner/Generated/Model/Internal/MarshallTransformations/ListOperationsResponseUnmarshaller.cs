    ...
    public class ListOperationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<OperationSummary, OperationSummaryUnmarshaller>(OperationSummaryUnmarshaller.Instance);
                    response.OperationSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
