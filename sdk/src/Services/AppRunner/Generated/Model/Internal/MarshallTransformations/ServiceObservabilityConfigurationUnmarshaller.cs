...
namespace Amazon.AppRunner.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ServiceObservabilityConfigurationUnmarshaller : IJsonUnmarshaller<ServiceObservabilityConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ServiceObservabilityConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
