...
namespace Amazon.AppRunner.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SourceCodeVersionUnmarshaller : IJsonUnmarshaller<SourceCodeVersion, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SourceCodeVersion Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
