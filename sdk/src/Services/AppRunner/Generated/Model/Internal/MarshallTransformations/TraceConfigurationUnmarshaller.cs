...
namespace Amazon.AppRunner.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TraceConfigurationUnmarshaller : IJsonUnmarshaller<TraceConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TraceConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
