...
namespace Amazon.AppRunner.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VpcIngressConnectionSummaryUnmarshaller : IJsonUnmarshaller<VpcIngressConnectionSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public VpcIngressConnectionSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
