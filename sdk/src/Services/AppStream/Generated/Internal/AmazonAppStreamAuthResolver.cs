...
namespace Amazon.AppStream.Internal
{
    ...
    public class AmazonAppStreamAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonAppStreamAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for AppStream.
        /// </summary>
        public AmazonAppStreamAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonAppStreamAuthSchemeParameters
            {
    ...
    public class AmazonAppStreamAuthSchemeResolver : IAuthSchemeResolver<AmazonAppStreamAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonAppStreamAuthSchemeParameters authParameters)
        {
