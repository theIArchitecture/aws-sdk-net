...
{
    /// <summary>
    /// Response Unmarshaller for AssociateAppBlockBuilderAppBlock operation
    /// </summary>  
    public class AssociateAppBlockBuilderAppBlockResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateAppBlockBuilderAppBlockResponse response = new AssociateAppBlockBuilderAppBlockResponse();
        ...
        private static AssociateAppBlockBuilderAppBlockResponseUnmarshaller _instance = new AssociateAppBlockBuilderAppBlockResponseUnmarshaller();        

        internal static AssociateAppBlockBuilderAppBlockResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateAppBlockBuilderAppBlockResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
