...
{
    /// <summary>
    /// CreateAppBlockBuilder Request Marshaller
    /// </summary>       
    public class CreateAppBlockBuilderRequestMarshaller : IMarshaller<IRequest, CreateAppBlockBuilderRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateAppBlockBuilderRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateAppBlockBuilderRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.AppStream");
            string target = "PhotonAdminProxyService.CreateAppBlockBuilder";
        ...
        private static CreateAppBlockBuilderRequestMarshaller _instance = new CreateAppBlockBuilderRequestMarshaller();        

        internal static CreateAppBlockBuilderRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAppBlockBuilderRequestMarshaller Instance
        {
            get
            {
                return _instance;
