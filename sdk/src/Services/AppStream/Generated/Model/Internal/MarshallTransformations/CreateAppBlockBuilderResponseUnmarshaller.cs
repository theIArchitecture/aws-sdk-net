...
{
    /// <summary>
    /// Response Unmarshaller for CreateAppBlockBuilder operation
    /// </summary>  
    public class CreateAppBlockBuilderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAppBlockBuilderResponse response = new CreateAppBlockBuilderResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = AppBlockBuilderUnmarshaller.Instance;
                    response.AppBlockBuilder = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateAppBlockBuilderResponseUnmarshaller _instance = new CreateAppBlockBuilderResponseUnmarshaller();        

        internal static CreateAppBlockBuilderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAppBlockBuilderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
