...
{
    /// <summary>
    /// Response Unmarshaller for CreateAppBlock operation
    /// </summary>  
    public class CreateAppBlockResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAppBlockResponse response = new CreateAppBlockResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AppBlock", targetDepth))
                {
                    var unmarshaller = AppBlockUnmarshaller.Instance;
                    response.AppBlock = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateAppBlockResponseUnmarshaller _instance = new CreateAppBlockResponseUnmarshaller();        

        internal static CreateAppBlockResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAppBlockResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
