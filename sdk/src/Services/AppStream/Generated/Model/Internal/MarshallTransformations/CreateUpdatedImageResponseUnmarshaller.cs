...
{
    /// <summary>
    /// Response Unmarshaller for CreateUpdatedImage operation
    /// </summary>  
    public class CreateUpdatedImageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateUpdatedImageResponse response = new CreateUpdatedImageResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("canUpdateImage", targetDepth))
                {
                    ...
                    response.CanUpdateImage = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateUpdatedImageResponseUnmarshaller _instance = new CreateUpdatedImageResponseUnmarshaller();        

        internal static CreateUpdatedImageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateUpdatedImageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
