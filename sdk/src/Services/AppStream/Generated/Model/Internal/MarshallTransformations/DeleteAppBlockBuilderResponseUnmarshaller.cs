...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAppBlockBuilder operation
    /// </summary>  
    public class DeleteAppBlockBuilderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAppBlockBuilderResponse response = new DeleteAppBlockBuilderResponse();
        ...
        private static DeleteAppBlockBuilderResponseUnmarshaller _instance = new DeleteAppBlockBuilderResponseUnmarshaller();        

        internal static DeleteAppBlockBuilderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAppBlockBuilderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
