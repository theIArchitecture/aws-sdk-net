...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAppBlock operation
    /// </summary>  
    public class DeleteAppBlockResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAppBlockResponse response = new DeleteAppBlockResponse();
        ...
        private static DeleteAppBlockResponseUnmarshaller _instance = new DeleteAppBlockResponseUnmarshaller();        

        internal static DeleteAppBlockResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAppBlockResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
