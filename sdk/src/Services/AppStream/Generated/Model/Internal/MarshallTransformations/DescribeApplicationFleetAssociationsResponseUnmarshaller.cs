    ...
    public class DescribeApplicationFleetAssociationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ApplicationFleetAssociation, ApplicationFleetAssociationUnmarshaller>(ApplicationFleetAssociationUnmarshaller.Instance);
                    response.ApplicationFleetAssociations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
