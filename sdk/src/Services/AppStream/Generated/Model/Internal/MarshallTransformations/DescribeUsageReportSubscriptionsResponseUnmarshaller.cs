    ...
    public class DescribeUsageReportSubscriptionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<UsageReportSubscription, UsageReportSubscriptionUnmarshaller>(UsageReportSubscriptionUnmarshaller.Instance);
                    response.UsageReportSubscriptions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
