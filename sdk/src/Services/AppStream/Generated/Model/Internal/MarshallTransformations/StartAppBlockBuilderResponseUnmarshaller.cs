...
{
    /// <summary>
    /// Response Unmarshaller for StartAppBlockBuilder operation
    /// </summary>  
    public class StartAppBlockBuilderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartAppBlockBuilderResponse response = new StartAppBlockBuilderResponse();
        ...
        private static StartAppBlockBuilderResponseUnmarshaller _instance = new StartAppBlockBuilderResponseUnmarshaller();        

        internal static StartAppBlockBuilderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartAppBlockBuilderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
