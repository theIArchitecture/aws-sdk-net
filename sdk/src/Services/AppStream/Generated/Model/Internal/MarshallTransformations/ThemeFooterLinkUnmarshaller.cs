...
namespace Amazon.AppStream.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ThemeFooterLinkUnmarshaller : IJsonUnmarshaller<ThemeFooterLink, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ThemeFooterLink Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FooterLinkURL = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
