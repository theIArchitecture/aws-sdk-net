...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAppBlockBuilder operation
    /// </summary>  
    public class UpdateAppBlockBuilderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAppBlockBuilderResponse response = new UpdateAppBlockBuilderResponse();
        ...
        private static UpdateAppBlockBuilderResponseUnmarshaller _instance = new UpdateAppBlockBuilderResponseUnmarshaller();        

        internal static UpdateAppBlockBuilderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAppBlockBuilderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
