...
{
    /// <summary>
    /// Response Unmarshaller for UpdateThemeForStack operation
    /// </summary>  
    public class UpdateThemeForStackResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateThemeForStackResponse response = new UpdateThemeForStackResponse();
        ...
        private static UpdateThemeForStackResponseUnmarshaller _instance = new UpdateThemeForStackResponseUnmarshaller();        

        internal static UpdateThemeForStackResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateThemeForStackResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
