...
namespace Amazon.AppSync.Internal
{
    ...
    public class AmazonAppSyncAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonAppSyncAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for AppSync.
        /// </summary>
        public AmazonAppSyncAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonAppSyncAuthSchemeParameters
            {
    ...
    public class AmazonAppSyncAuthSchemeResolver : IAuthSchemeResolver<AmazonAppSyncAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonAppSyncAuthSchemeParameters authParameters)
        {
