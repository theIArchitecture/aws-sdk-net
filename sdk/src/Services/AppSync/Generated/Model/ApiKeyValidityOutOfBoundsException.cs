...
namespace Amazon.AppSync.Model
{
    ...
    public partial class ApiKeyValidityOutOfBoundsException : AmazonAppSyncException
    {
        ...
        public ApiKeyValidityOutOfBoundsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ApiKeyValidityOutOfBoundsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
