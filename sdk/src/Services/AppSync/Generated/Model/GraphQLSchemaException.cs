...
namespace Amazon.AppSync.Model
{
    ...
    public partial class GraphQLSchemaException : AmazonAppSyncException
    {
        ...
        public GraphQLSchemaException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public GraphQLSchemaException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
