...
namespace Amazon.AppSync.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ApiAssociationUnmarshaller : IJsonUnmarshaller<ApiAssociation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            ApiAssociation unmarshalledObject = new ApiAssociation();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ApiAssociationUnmarshaller Instance
        {
            get
            {
                return _instance;
