...
{
    /// <summary>
    /// Response Unmarshaller for AssociateMergedGraphqlApi operation
    /// </summary>  
    public class AssociateMergedGraphqlApiResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateMergedGraphqlApiResponse response = new AssociateMergedGraphqlApiResponse();
        ...
        private static AssociateMergedGraphqlApiResponseUnmarshaller _instance = new AssociateMergedGraphqlApiResponseUnmarshaller();        

        internal static AssociateMergedGraphqlApiResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateMergedGraphqlApiResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
