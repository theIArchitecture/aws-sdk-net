...
namespace Amazon.AppSync.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AuthorizationConfigUnmarshaller : IJsonUnmarshaller<AuthorizationConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AuthorizationConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("awsIamConfig", targetDepth))
                {
                    ...
                    unmarshalledObject.AwsIamConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
