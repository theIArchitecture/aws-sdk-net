...
{
    /// <summary>
    /// CreateChannelNamespace Request Marshaller
    /// </summary>       
    public class CreateChannelNamespaceRequestMarshaller : IMarshaller<IRequest, CreateChannelNamespaceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateChannelNamespaceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateChannelNamespaceRequest publicRequest)
        {
        ...
        private static CreateChannelNamespaceRequestMarshaller _instance = new CreateChannelNamespaceRequestMarshaller();        

        internal static CreateChannelNamespaceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateChannelNamespaceRequestMarshaller Instance
        {
            get
            {
                return _instance;
