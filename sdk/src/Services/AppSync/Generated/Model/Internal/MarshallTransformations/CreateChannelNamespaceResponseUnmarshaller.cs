...
{
    /// <summary>
    /// Response Unmarshaller for CreateChannelNamespace operation
    /// </summary>  
    public class CreateChannelNamespaceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateChannelNamespaceResponse response = new CreateChannelNamespaceResponse();
        ...
        private static CreateChannelNamespaceResponseUnmarshaller _instance = new CreateChannelNamespaceResponseUnmarshaller();        

        internal static CreateChannelNamespaceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateChannelNamespaceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
