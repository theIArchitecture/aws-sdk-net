...
{
    /// <summary>
    /// Response Unmarshaller for DeleteChannelNamespace operation
    /// </summary>  
    public class DeleteChannelNamespaceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteChannelNamespaceResponse response = new DeleteChannelNamespaceResponse();
        ...
        private static DeleteChannelNamespaceResponseUnmarshaller _instance = new DeleteChannelNamespaceResponseUnmarshaller();        

        internal static DeleteChannelNamespaceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteChannelNamespaceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
