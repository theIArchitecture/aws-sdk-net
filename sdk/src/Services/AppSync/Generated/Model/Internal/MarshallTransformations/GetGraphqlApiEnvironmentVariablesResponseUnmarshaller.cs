...
{
    /// <summary>
    /// Response Unmarshaller for GetGraphqlApiEnvironmentVariables operation
    /// </summary>  
    public class GetGraphqlApiEnvironmentVariablesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetGraphqlApiEnvironmentVariablesResponse response = new GetGraphqlApiEnvironmentVariablesResponse();
        ...
        private static GetGraphqlApiEnvironmentVariablesResponseUnmarshaller _instance = new GetGraphqlApiEnvironmentVariablesResponseUnmarshaller();        

        internal static GetGraphqlApiEnvironmentVariablesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGraphqlApiEnvironmentVariablesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
