...
{
    /// <summary>
    /// PutGraphqlApiEnvironmentVariables Request Marshaller
    /// </summary>       
    public class PutGraphqlApiEnvironmentVariablesRequestMarshaller : IMarshaller<IRequest, PutGraphqlApiEnvironmentVariablesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutGraphqlApiEnvironmentVariablesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutGraphqlApiEnvironmentVariablesRequest publicRequest)
        {
        ...
        private static PutGraphqlApiEnvironmentVariablesRequestMarshaller _instance = new PutGraphqlApiEnvironmentVariablesRequestMarshaller();        

        internal static PutGraphqlApiEnvironmentVariablesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutGraphqlApiEnvironmentVariablesRequestMarshaller Instance
        {
            get
            {
                return _instance;
