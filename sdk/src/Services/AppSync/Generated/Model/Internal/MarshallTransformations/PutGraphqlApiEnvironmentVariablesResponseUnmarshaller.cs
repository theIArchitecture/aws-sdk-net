...
{
    /// <summary>
    /// Response Unmarshaller for PutGraphqlApiEnvironmentVariables operation
    /// </summary>  
    public class PutGraphqlApiEnvironmentVariablesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutGraphqlApiEnvironmentVariablesResponse response = new PutGraphqlApiEnvironmentVariablesResponse();
        ...
        private static PutGraphqlApiEnvironmentVariablesResponseUnmarshaller _instance = new PutGraphqlApiEnvironmentVariablesResponseUnmarshaller();        

        internal static PutGraphqlApiEnvironmentVariablesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutGraphqlApiEnvironmentVariablesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
