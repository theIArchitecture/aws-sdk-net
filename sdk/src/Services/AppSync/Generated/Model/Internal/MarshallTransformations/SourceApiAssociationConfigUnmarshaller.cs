...
namespace Amazon.AppSync.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SourceApiAssociationConfigUnmarshaller : IJsonUnmarshaller<SourceApiAssociationConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SourceApiAssociationConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("mergeType", targetDepth))
                {
                    ...
                    unmarshalledObject.MergeType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
