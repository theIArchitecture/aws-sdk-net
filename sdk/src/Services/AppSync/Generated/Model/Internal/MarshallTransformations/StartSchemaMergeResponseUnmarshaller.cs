...
{
    /// <summary>
    /// Response Unmarshaller for StartSchemaMerge operation
    /// </summary>  
    public class StartSchemaMergeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartSchemaMergeResponse response = new StartSchemaMergeResponse();
        ...
        private static StartSchemaMergeResponseUnmarshaller _instance = new StartSchemaMergeResponseUnmarshaller();        

        internal static StartSchemaMergeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartSchemaMergeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
