...
{
    /// <summary>
    /// Response Unmarshaller for UpdateChannelNamespace operation
    /// </summary>  
    public class UpdateChannelNamespaceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateChannelNamespaceResponse response = new UpdateChannelNamespaceResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("channelNamespace", targetDepth))
                {
                    var unmarshaller = ChannelNamespaceUnmarshaller.Instance;
                    response.ChannelNamespace = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateChannelNamespaceResponseUnmarshaller _instance = new UpdateChannelNamespaceResponseUnmarshaller();        

        internal static UpdateChannelNamespaceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateChannelNamespaceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
