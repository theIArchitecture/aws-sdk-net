...
namespace Amazon.AppSync.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateSourceApiAssociationRequestMarshaller : IMarshaller<IRequest, UpdateSourceApiAssociationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static UpdateSourceApiAssociationRequestMarshaller _instance = new UpdateSourceApiAssociationRequestMarshaller();        

        internal static UpdateSourceApiAssociationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSourceApiAssociationRequestMarshaller Instance
        {
            get
            {
                return _instance;
