...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSourceApiAssociation operation
    /// </summary>  
    public class UpdateSourceApiAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSourceApiAssociationResponse response = new UpdateSourceApiAssociationResponse();
        ...
        private static UpdateSourceApiAssociationResponseUnmarshaller _instance = new UpdateSourceApiAssociationResponseUnmarshaller();        

        internal static UpdateSourceApiAssociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSourceApiAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
