...
namespace Amazon.AppSync.Model
{
    ...
    {
        private RdsDataApiConfig _rdsDataApiConfig;
        ...
        {
            get { return this._rdsDataApiConfig; }
            set { this._rdsDataApiConfig = value; }
        }

        // Check to see if RdsDataApiConfig property is set
        internal bool IsSetRdsDataApiConfig()
        {
            return this._rdsDataApiConfig != null;
        }
