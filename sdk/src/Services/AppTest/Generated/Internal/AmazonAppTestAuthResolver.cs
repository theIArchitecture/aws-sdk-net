...
namespace Amazon.AppTest.Internal
{
    ...
    public class AmazonAppTestAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonAppTestAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for AppTest.
        /// </summary>
        public AmazonAppTestAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonAppTestAuthSchemeParameters
            {
    ...
    public class AmazonAppTestAuthSchemeResolver : IAuthSchemeResolver<AmazonAppTestAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonAppTestAuthSchemeParameters authParameters)
        {
