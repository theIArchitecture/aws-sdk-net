...
{
    /// <summary>
    /// Response Unmarshaller for BatchStepInput Object
    /// </summary>  
    public class BatchStepInputUnmarshaller : IJsonUnmarshaller<BatchStepInput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchStepInput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            BatchStepInput unmarshalledObject = new BatchStepInput();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("batchJobName", targetDepth))
                {
                    ...
                    unmarshalledObject.BatchJobName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static BatchStepInputUnmarshaller _instance = new BatchStepInputUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BatchStepInputUnmarshaller Instance
        {
            get
            {
                return _instance;
