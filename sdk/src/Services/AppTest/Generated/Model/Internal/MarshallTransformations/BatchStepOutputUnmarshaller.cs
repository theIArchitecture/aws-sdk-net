...
{
    /// <summary>
    /// Response Unmarshaller for BatchStepOutput Object
    /// </summary>  
    public class BatchStepOutputUnmarshaller : IJsonUnmarshaller<BatchStepOutput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchStepOutput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            BatchStepOutput unmarshalledObject = new BatchStepOutput();
        ...
        private static BatchStepOutputUnmarshaller _instance = new BatchStepOutputUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BatchStepOutputUnmarshaller Instance
        {
            get
            {
                return _instance;
