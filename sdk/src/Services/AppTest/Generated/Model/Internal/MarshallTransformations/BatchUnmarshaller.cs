...
namespace Amazon.AppTest.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchUnmarshaller : IJsonUnmarshaller<Batch, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Batch Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
