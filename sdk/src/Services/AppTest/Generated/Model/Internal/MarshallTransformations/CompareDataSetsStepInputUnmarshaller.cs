...
namespace Amazon.AppTest.Model.Internal.MarshallTransformations
{
    ...
    public class CompareDataSetsStepInputUnmarshaller : IJsonUnmarshaller<CompareDataSetsStepInput, JsonUnmarshallerContext>
    {
        ...
        private static CompareDataSetsStepInputUnmarshaller _instance = new CompareDataSetsStepInputUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CompareDataSetsStepInputUnmarshaller Instance
        {
            get
            {
                return _instance;
