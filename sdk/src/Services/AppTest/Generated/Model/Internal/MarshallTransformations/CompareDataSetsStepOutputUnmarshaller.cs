...
namespace Amazon.AppTest.Model.Internal.MarshallTransformations
{
    ...
    public class CompareDataSetsStepOutputUnmarshaller : IJsonUnmarshaller<CompareDataSetsStepOutput, JsonUnmarshallerContext>
    {
        ...
        private static CompareDataSetsStepOutputUnmarshaller _instance = new CompareDataSetsStepOutputUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CompareDataSetsStepOutputUnmarshaller Instance
        {
            get
            {
                return _instance;
