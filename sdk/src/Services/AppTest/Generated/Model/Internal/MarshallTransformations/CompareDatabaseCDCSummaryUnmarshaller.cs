...
namespace Amazon.AppTest.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CompareDatabaseCDCSummaryUnmarshaller : IJsonUnmarshaller<CompareDatabaseCDCSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CompareDatabaseCDCSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
