...
{
    /// <summary>
    /// Response Unmarshaller for CreateTestSuite operation
    /// </summary>  
    public class CreateTestSuiteResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateTestSuiteResponseUnmarshaller _instance = new CreateTestSuiteResponseUnmarshaller();        

        internal static CreateTestSuiteResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTestSuiteResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
