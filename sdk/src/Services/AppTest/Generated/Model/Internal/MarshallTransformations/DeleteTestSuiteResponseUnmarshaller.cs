...
{
    /// <summary>
    /// Response Unmarshaller for DeleteTestSuite operation
    /// </summary>  
    public class DeleteTestSuiteResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteTestSuiteResponseUnmarshaller _instance = new DeleteTestSuiteResponseUnmarshaller();        

        internal static DeleteTestSuiteResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTestSuiteResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
