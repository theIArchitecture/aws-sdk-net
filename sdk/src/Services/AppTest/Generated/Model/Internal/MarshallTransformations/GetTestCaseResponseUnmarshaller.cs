...
{
    /// <summary>
    /// Response Unmarshaller for GetTestCase operation
    /// </summary>  
    public class GetTestCaseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTestCaseResponse response = new GetTestCaseResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = TestCaseLatestVersionUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TestCaseArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetTestCaseResponseUnmarshaller _instance = new GetTestCaseResponseUnmarshaller();        

        internal static GetTestCaseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTestCaseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
