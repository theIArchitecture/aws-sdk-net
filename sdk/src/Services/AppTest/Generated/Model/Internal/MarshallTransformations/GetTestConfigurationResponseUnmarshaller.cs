...
{
    /// <summary>
    /// Response Unmarshaller for GetTestConfiguration operation
    /// </summary>  
    public class GetTestConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTestConfigurationResponse response = new GetTestConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = TestConfigurationLatestVersionUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TestConfigurationArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetTestConfigurationResponseUnmarshaller _instance = new GetTestConfigurationResponseUnmarshaller();        

        internal static GetTestConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTestConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
