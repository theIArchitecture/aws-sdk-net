...
{
    /// <summary>
    /// Response Unmarshaller for M2ManagedApplicationStepInput Object
    /// </summary>  
    public class M2ManagedApplicationStepInputUnmarshaller : IJsonUnmarshaller<M2ManagedApplicationStepInput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public M2ManagedApplicationStepInput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            M2ManagedApplicationStepInput unmarshalledObject = new M2ManagedApplicationStepInput();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = M2ManagedActionPropertiesUnmarshaller.Instance;
        ...
        private static M2ManagedApplicationStepInputUnmarshaller _instance = new M2ManagedApplicationStepInputUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static M2ManagedApplicationStepInputUnmarshaller Instance
        {
            get
            {
                return _instance;
