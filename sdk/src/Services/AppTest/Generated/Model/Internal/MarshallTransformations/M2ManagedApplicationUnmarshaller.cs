...
{
    /// <summary>
    /// Response Unmarshaller for M2ManagedApplication Object
    /// </summary>  
    public class M2ManagedApplicationUnmarshaller : IJsonUnmarshaller<M2ManagedApplication, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public M2ManagedApplication Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            M2ManagedApplication unmarshalledObject = new M2ManagedApplication();
        ...
        private static M2ManagedApplicationUnmarshaller _instance = new M2ManagedApplicationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static M2ManagedApplicationUnmarshaller Instance
        {
            get
            {
                return _instance;
