...
namespace Amazon.AppTest.Model.Internal.MarshallTransformations
{
    ...
    public class M2NonManagedApplicationStepSummaryUnmarshaller : IJsonUnmarshaller<M2NonManagedApplicationStepSummary, JsonUnmarshallerContext>
    {
        ...
        private static M2NonManagedApplicationStepSummaryUnmarshaller _instance = new M2NonManagedApplicationStepSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static M2NonManagedApplicationStepSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
