...
{
    /// <summary>
    /// Response Unmarshaller for M2NonManagedApplication Object
    /// </summary>  
    public class M2NonManagedApplicationUnmarshaller : IJsonUnmarshaller<M2NonManagedApplication, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public M2NonManagedApplication Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            M2NonManagedApplication unmarshalledObject = new M2NonManagedApplication();
        ...
        private static M2NonManagedApplicationUnmarshaller _instance = new M2NonManagedApplicationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static M2NonManagedApplicationUnmarshaller Instance
        {
            get
            {
                return _instance;
