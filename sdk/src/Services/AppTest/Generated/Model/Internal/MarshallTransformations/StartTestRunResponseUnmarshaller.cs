...
{
    /// <summary>
    /// Response Unmarshaller for StartTestRun operation
    /// </summary>  
    public class StartTestRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartTestRunResponse response = new StartTestRunResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TestRunStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static StartTestRunResponseUnmarshaller _instance = new StartTestRunResponseUnmarshaller();        

        internal static StartTestRunResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartTestRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
