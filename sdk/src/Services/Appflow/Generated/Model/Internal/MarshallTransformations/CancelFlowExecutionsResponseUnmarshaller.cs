...
namespace Amazon.Appflow.Model.Internal.MarshallTransformations
{
    ...
    public class CancelFlowExecutionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("invalidExecutions", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.InvalidExecutions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CancelFlowExecutionsResponseUnmarshaller _instance = new CancelFlowExecutionsResponseUnmarshaller();        

        internal static CancelFlowExecutionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelFlowExecutionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
