...
namespace Amazon.Appflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConnectorEntityUnmarshaller : IJsonUnmarshaller<ConnectorEntity, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ConnectorEntity Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("hasNestedEntities", targetDepth))
                {
                    ...
                    unmarshalledObject.HasNestedEntities = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
