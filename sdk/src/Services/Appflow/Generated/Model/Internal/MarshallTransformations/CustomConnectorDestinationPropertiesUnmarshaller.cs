...
{
    /// <summary>
    /// Response Unmarshaller for CustomConnectorDestinationProperties Object
    /// </summary>  
    public class CustomConnectorDestinationPropertiesUnmarshaller : IJsonUnmarshaller<CustomConnectorDestinationProperties, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CustomConnectorDestinationProperties Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            CustomConnectorDestinationProperties unmarshalledObject = new CustomConnectorDestinationProperties();
        ...
        private static CustomConnectorDestinationPropertiesUnmarshaller _instance = new CustomConnectorDestinationPropertiesUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CustomConnectorDestinationPropertiesUnmarshaller Instance
        {
            get
            {
                return _instance;
