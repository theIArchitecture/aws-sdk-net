...
namespace Amazon.Appflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MetadataCatalogConfigUnmarshaller : IJsonUnmarshaller<MetadataCatalogConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MetadataCatalogConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("glueDataCatalog", targetDepth))
                {
                    ...
                    unmarshalledObject.GlueDataCatalog = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
