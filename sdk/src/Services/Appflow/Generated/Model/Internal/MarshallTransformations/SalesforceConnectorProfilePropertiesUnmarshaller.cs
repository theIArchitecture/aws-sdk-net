...
namespace Amazon.Appflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SalesforceConnectorProfilePropertiesUnmarshaller : IJsonUnmarshaller<SalesforceConnectorProfileProperties, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SalesforceConnectorProfileProperties Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    unmarshalledObject.UsePrivateLinkForMetadataAndAuthorization = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
