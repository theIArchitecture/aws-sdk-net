...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonAppflowConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonAppflowConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonAppflowConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonAppflowConfig to create AmazonAppflowClient");
            }

            return awsCredentials == null ? 
                    new AmazonAppflowClient(serviceClientConfig) :
                    new AmazonAppflowClient(awsCredentials, serviceClientConfig);
        }
