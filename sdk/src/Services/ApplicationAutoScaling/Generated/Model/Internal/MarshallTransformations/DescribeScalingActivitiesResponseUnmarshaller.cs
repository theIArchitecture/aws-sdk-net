    ...
    public class DescribeScalingActivitiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ScalingActivity, ScalingActivityUnmarshaller>(ScalingActivityUnmarshaller.Instance);
                    response.ScalingActivities = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
