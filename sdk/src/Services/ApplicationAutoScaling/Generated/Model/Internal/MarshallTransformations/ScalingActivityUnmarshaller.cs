...
namespace Amazon.ApplicationAutoScaling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ScalingActivityUnmarshaller : IJsonUnmarshaller<ScalingActivity, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ScalingActivity Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<NotScaledReason, NotScaledReasonUnmarshaller>(NotScaledReasonUnmarshaller.Instance);
                    unmarshalledObject.NotScaledReasons = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
