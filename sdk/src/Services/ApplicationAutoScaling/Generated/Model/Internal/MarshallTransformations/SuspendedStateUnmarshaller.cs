...
namespace Amazon.ApplicationAutoScaling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SuspendedStateUnmarshaller : IJsonUnmarshaller<SuspendedState, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SuspendedState Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
