...
namespace Amazon.ApplicationAutoScaling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TargetTrackingMetricStatUnmarshaller : IJsonUnmarshaller<TargetTrackingMetricStat, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TargetTrackingMetricStat Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
