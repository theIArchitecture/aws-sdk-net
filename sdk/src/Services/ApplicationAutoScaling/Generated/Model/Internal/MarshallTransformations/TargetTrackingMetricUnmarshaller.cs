...
namespace Amazon.ApplicationAutoScaling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TargetTrackingMetricUnmarshaller : IJsonUnmarshaller<TargetTrackingMetric, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TargetTrackingMetric Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<TargetTrackingMetricDimension, TargetTrackingMetricDimensionUnmarshaller>(TargetTrackingMetricDimensionUnmarshaller.Instance);
