...
namespace Amazon.ApplicationCostProfiler
{
    ...
    public partial class AmazonApplicationCostProfilerException : AmazonServiceException
    {
        ...
        public AmazonApplicationCostProfilerException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonApplicationCostProfilerException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
