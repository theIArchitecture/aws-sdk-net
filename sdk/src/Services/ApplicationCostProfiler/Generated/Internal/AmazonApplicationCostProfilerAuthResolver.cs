...
namespace Amazon.ApplicationCostProfiler.Internal
{
    ...
    public class AmazonApplicationCostProfilerAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonApplicationCostProfilerAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ApplicationCostProfiler.
        /// </summary>
        public AmazonApplicationCostProfilerAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonApplicationCostProfilerAuthSchemeParameters
            {
    ...
    public class AmazonApplicationCostProfilerAuthSchemeResolver : IAuthSchemeResolver<AmazonApplicationCostProfilerAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonApplicationCostProfilerAuthSchemeParameters authParameters)
        {
