...
namespace Amazon.ApplicationDiscoveryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AuthorizationErrorExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<AuthorizationErrorException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public AuthorizationErrorException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public AuthorizationErrorException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
