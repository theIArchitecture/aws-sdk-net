...
{
    /// <summary>
    /// Response Unmarshaller for BatchDeleteAgents operation
    /// </summary>  
    public class BatchDeleteAgentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchDeleteAgentsResponse response = new BatchDeleteAgentsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BatchDeleteAgentError, BatchDeleteAgentErrorUnmarshaller>(BatchDeleteAgentErrorUnmarshaller.Instance);
        ...
        private static BatchDeleteAgentsResponseUnmarshaller _instance = new BatchDeleteAgentsResponseUnmarshaller();        

        internal static BatchDeleteAgentsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDeleteAgentsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
