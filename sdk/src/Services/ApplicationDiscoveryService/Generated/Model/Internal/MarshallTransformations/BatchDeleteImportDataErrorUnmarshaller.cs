...
namespace Amazon.ApplicationDiscoveryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchDeleteImportDataErrorUnmarshaller : IJsonUnmarshaller<BatchDeleteImportDataError, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchDeleteImportDataError Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
