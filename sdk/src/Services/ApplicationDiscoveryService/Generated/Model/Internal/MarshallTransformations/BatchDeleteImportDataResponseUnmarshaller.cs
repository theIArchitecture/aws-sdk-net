    ...
    public class BatchDeleteImportDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BatchDeleteImportDataError, BatchDeleteImportDataErrorUnmarshaller>(BatchDeleteImportDataErrorUnmarshaller.Instance);
