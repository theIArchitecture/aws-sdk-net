...
namespace Amazon.ApplicationDiscoveryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConfigurationTagUnmarshaller : IJsonUnmarshaller<ConfigurationTag, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ConfigurationTag Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("timeOfCreation", targetDepth))
                {
                    ...
                    unmarshalledObject.TimeOfCreation = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
