...
namespace Amazon.ApplicationDiscoveryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ContinuousExportDescriptionUnmarshaller : IJsonUnmarshaller<ContinuousExportDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ContinuousExportDescription Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("schemaStorageConfig", targetDepth))
                {
                    ...
                    unmarshalledObject.SchemaStorageConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
