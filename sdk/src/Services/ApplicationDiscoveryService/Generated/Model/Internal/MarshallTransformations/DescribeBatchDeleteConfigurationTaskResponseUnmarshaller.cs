...
{
    /// <summary>
    /// Response Unmarshaller for DescribeBatchDeleteConfigurationTask operation
    /// </summary>  
    public class DescribeBatchDeleteConfigurationTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeBatchDeleteConfigurationTaskResponse response = new DescribeBatchDeleteConfigurationTaskResponse();
        ...
        private static DescribeBatchDeleteConfigurationTaskResponseUnmarshaller _instance = new DescribeBatchDeleteConfigurationTaskResponseUnmarshaller();        

        internal static DescribeBatchDeleteConfigurationTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeBatchDeleteConfigurationTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
