...
namespace Amazon.ApplicationDiscoveryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FailedConfigurationUnmarshaller : IJsonUnmarshaller<FailedConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FailedConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("errorStatusCode", targetDepth))
                {
                    ...
                    unmarshalledObject.ErrorStatusCode = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
