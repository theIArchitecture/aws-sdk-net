...
namespace Amazon.ApplicationDiscoveryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class HomeRegionNotSetExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<HomeRegionNotSetException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public HomeRegionNotSetException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public HomeRegionNotSetException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
