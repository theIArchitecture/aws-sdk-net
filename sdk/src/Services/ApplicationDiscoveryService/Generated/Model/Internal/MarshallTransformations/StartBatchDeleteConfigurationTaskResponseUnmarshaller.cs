...
{
    /// <summary>
    /// Response Unmarshaller for StartBatchDeleteConfigurationTask operation
    /// </summary>  
    public class StartBatchDeleteConfigurationTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartBatchDeleteConfigurationTaskResponse response = new StartBatchDeleteConfigurationTaskResponse();
        ...
        private static StartBatchDeleteConfigurationTaskResponseUnmarshaller _instance = new StartBatchDeleteConfigurationTaskResponseUnmarshaller();        

        internal static StartBatchDeleteConfigurationTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartBatchDeleteConfigurationTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
