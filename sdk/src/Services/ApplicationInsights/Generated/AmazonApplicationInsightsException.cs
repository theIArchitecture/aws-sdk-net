...
namespace Amazon.ApplicationInsights
{
    ...
    public partial class AmazonApplicationInsightsException : AmazonServiceException
    {
        ...
        public AmazonApplicationInsightsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonApplicationInsightsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
