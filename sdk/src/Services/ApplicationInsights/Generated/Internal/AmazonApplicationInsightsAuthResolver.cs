...
namespace Amazon.ApplicationInsights.Internal
{
    ...
    public class AmazonApplicationInsightsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonApplicationInsightsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ApplicationInsights.
        /// </summary>
        public AmazonApplicationInsightsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonApplicationInsightsAuthSchemeParameters
            {
    ...
    public class AmazonApplicationInsightsAuthSchemeResolver : IAuthSchemeResolver<AmazonApplicationInsightsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonApplicationInsightsAuthSchemeParameters authParameters)
        {
