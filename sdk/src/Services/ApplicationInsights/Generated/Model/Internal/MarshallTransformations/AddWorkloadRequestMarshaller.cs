...
{
    /// <summary>
    /// AddWorkload Request Marshaller
    /// </summary>       
    public class AddWorkloadRequestMarshaller : IMarshaller<IRequest, AddWorkloadRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AddWorkloadRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AddWorkloadRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ApplicationInsights");
            string target = "EC2WindowsBarleyService.AddWorkload";
        ...
        private static AddWorkloadRequestMarshaller _instance = new AddWorkloadRequestMarshaller();        

        internal static AddWorkloadRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddWorkloadRequestMarshaller Instance
        {
            get
            {
                return _instance;
