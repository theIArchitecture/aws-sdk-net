...
{
    /// <summary>
    /// Response Unmarshaller for AddWorkload operation
    /// </summary>  
    public class AddWorkloadResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AddWorkloadResponse response = new AddWorkloadResponse();
        ...
        private static AddWorkloadResponseUnmarshaller _instance = new AddWorkloadResponseUnmarshaller();        

        internal static AddWorkloadResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddWorkloadResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
