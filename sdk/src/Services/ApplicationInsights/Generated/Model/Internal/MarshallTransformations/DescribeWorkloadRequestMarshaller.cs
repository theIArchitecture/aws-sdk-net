...
{
    /// <summary>
    /// DescribeWorkload Request Marshaller
    /// </summary>       
    public class DescribeWorkloadRequestMarshaller : IMarshaller<IRequest, DescribeWorkloadRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeWorkloadRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeWorkloadRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ApplicationInsights");
            string target = "EC2WindowsBarleyService.DescribeWorkload";
            ...
            if(publicRequest.IsSetWorkloadId())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.WorkloadId);
            }
        ...
        private static DescribeWorkloadRequestMarshaller _instance = new DescribeWorkloadRequestMarshaller();        

        internal static DescribeWorkloadRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeWorkloadRequestMarshaller Instance
        {
            get
            {
                return _instance;
