...
{
    /// <summary>
    /// Response Unmarshaller for DescribeWorkload operation
    /// </summary>  
    public class DescribeWorkloadResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeWorkloadResponse response = new DescribeWorkloadResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.WorkloadRemarks = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeWorkloadResponseUnmarshaller _instance = new DescribeWorkloadResponseUnmarshaller();        

        internal static DescribeWorkloadResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeWorkloadResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
