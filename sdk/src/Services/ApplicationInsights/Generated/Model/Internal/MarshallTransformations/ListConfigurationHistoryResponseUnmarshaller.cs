    ...
    public class ListConfigurationHistoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ConfigurationEvent, ConfigurationEventUnmarshaller>(ConfigurationEventUnmarshaller.Instance);
                    response.EventList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
