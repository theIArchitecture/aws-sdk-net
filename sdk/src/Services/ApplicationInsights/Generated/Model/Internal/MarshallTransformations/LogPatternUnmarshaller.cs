...
namespace Amazon.ApplicationInsights.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LogPatternUnmarshaller : IJsonUnmarshaller<LogPattern, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LogPattern Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PatternSetName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
