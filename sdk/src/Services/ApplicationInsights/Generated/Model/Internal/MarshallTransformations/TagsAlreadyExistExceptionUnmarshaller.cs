...
namespace Amazon.ApplicationInsights.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TagsAlreadyExistExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<TagsAlreadyExistException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public TagsAlreadyExistException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public TagsAlreadyExistException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
