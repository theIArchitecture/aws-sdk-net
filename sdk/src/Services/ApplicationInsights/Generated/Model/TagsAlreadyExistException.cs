...
namespace Amazon.ApplicationInsights.Model
{
    ...
    public partial class TagsAlreadyExistException : AmazonApplicationInsightsException
    {
        ...
        public TagsAlreadyExistException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TagsAlreadyExistException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
