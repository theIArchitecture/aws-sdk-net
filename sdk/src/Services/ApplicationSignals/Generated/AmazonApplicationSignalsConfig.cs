...
namespace Amazon.ApplicationSignals
{
    ...
    public partial class AmazonApplicationSignalsConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Application Signals", "4.0.2.0");
        ...
        /// Default constructor
        /// </summary>
        public AmazonApplicationSignalsConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonApplicationSignalsDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "Application Signals";
            this.AuthenticationServiceName = "application-signals";
            this.EndpointProvider = new AmazonApplicationSignalsEndpointProvider();
        }
