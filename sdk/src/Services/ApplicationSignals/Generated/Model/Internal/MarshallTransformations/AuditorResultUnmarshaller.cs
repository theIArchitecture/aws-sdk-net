...
namespace Amazon.ApplicationSignals.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AuditorResultUnmarshaller : IJsonUnmarshaller<AuditorResult, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AuditorResult Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Auditor", targetDepth))
                {
                    ...
                    unmarshalledObject.Auditor = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
