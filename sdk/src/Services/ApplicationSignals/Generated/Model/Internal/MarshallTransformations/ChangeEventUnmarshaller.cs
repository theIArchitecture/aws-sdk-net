...
namespace Amazon.ApplicationSignals.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ChangeEventUnmarshaller : IJsonUnmarshaller<ChangeEvent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            ChangeEvent unmarshalledObject = new ChangeEvent();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ChangeEventType", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ChangeEventUnmarshaller Instance
        {
            get
            {
                return _instance;
