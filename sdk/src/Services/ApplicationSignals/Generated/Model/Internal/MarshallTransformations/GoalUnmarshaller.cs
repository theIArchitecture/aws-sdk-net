...
{
    /// <summary>
    /// Response Unmarshaller for Goal Object
    /// </summary>  
    public class GoalUnmarshaller : IJsonUnmarshaller<Goal, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Goal Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            Goal unmarshalledObject = new Goal();
        ...
        private static GoalUnmarshaller _instance = new GoalUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static GoalUnmarshaller Instance
        {
            get
            {
                return _instance;
