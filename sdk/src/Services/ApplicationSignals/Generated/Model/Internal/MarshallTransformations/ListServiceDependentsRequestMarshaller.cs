...
{
    /// <summary>
    /// ListServiceDependents Request Marshaller
    /// </summary>       
    public class ListServiceDependentsRequestMarshaller : IMarshaller<IRequest, ListServiceDependentsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListServiceDependentsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListServiceDependentsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/service-dependents";
#if !NETFRAMEWORK
        ...
        private static ListServiceDependentsRequestMarshaller _instance = new ListServiceDependentsRequestMarshaller();        

        internal static ListServiceDependentsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListServiceDependentsRequestMarshaller Instance
        {
            get
            {
                return _instance;
