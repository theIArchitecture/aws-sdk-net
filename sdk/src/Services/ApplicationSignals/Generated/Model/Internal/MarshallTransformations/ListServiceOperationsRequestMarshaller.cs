...
{
    /// <summary>
    /// ListServiceOperations Request Marshaller
    /// </summary>       
    public class ListServiceOperationsRequestMarshaller : IMarshaller<IRequest, ListServiceOperationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListServiceOperationsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListServiceOperationsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/service-operations";
#if !NETFRAMEWORK
        ...
        private static ListServiceOperationsRequestMarshaller _instance = new ListServiceOperationsRequestMarshaller();        

        internal static ListServiceOperationsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListServiceOperationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
