...
{
    /// <summary>
    /// ListServiceStates Request Marshaller
    /// </summary>       
    public class ListServiceStatesRequestMarshaller : IMarshaller<IRequest, ListServiceStatesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListServiceStatesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListServiceStatesRequest publicRequest)
        {
            ...
            request.ResourcePath = "/service/states";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetAttributeFilters())
            {
                ...
                foreach(var publicRequestAttributeFiltersListValue in publicRequest.AttributeFilters)
                {
                    ...
                    marshaller.Marshall(publicRequestAttributeFiltersListValue, context);
        ...
        private static ListServiceStatesRequestMarshaller _instance = new ListServiceStatesRequestMarshaller();        

        internal static ListServiceStatesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListServiceStatesRequestMarshaller Instance
        {
            get
            {
                return _instance;
