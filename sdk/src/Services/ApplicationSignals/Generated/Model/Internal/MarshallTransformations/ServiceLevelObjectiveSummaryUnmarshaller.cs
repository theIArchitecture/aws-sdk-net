...
{
    /// <summary>
    /// Response Unmarshaller for ServiceLevelObjectiveSummary Object
    /// </summary>  
    public class ServiceLevelObjectiveSummaryUnmarshaller : IJsonUnmarshaller<ServiceLevelObjectiveSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ServiceLevelObjectiveSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ServiceLevelObjectiveSummary unmarshalledObject = new ServiceLevelObjectiveSummary();
        ...
        private static ServiceLevelObjectiveSummaryUnmarshaller _instance = new ServiceLevelObjectiveSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ServiceLevelObjectiveSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
