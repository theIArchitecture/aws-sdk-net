...
namespace Amazon.ApplicationSignals.Model
{
    ...
    public partial class ListServiceOperationsResponse : AmazonWebServiceResponse
    {
        ...
        private List<ServiceOperation> _serviceOperations = AWSConfigs.InitializeCollections ? new List<ServiceOperation>() : null;
        ...
        {
            get { return this._serviceOperations; }
            set { this._serviceOperations = value; }
        }

        // Check to see if ServiceOperations property is set
        internal bool IsSetServiceOperations()
        {
            return this._serviceOperations != null && (this._serviceOperations.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
