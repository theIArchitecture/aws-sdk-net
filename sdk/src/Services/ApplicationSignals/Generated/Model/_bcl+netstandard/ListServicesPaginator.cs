...
namespace Amazon.ApplicationSignals.Model
{
    ...
    internal sealed partial class ListServicesPaginator : IPaginator<ListServicesResponse>, IListServicesPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<ServiceSummary> ServiceSummaries => 
            new PaginatedResultKeyResponse<ListServicesResponse, ServiceSummary>(this, (i) => i.ServiceSummaries ?? new List<ServiceSummary>());

        internal ListServicesPaginator(IAmazonApplicationSignals client, ListServicesRequest request)
        {
            this._client = client;
