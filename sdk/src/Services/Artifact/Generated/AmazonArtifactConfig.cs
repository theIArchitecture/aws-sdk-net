...
namespace Amazon.Artifact
{
    ...
    public partial class AmazonArtifactConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Artifact", "4.0.1.5");
        ...
        /// Default constructor
        /// </summary>
        public AmazonArtifactConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonArtifactDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "Artifact";
            this.AuthenticationServiceName = "artifact";
            this.EndpointProvider = new AmazonArtifactEndpointProvider();
        }
