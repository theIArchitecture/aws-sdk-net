...
namespace Amazon.Artifact.Internal
{
    ...
    public class AmazonArtifactAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonArtifactAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Artifact.
        /// </summary>
        public AmazonArtifactAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonArtifactAuthSchemeParameters
            {
    ...
    public class AmazonArtifactAuthSchemeResolver : IAuthSchemeResolver<AmazonArtifactAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonArtifactAuthSchemeParameters authParameters)
        {
