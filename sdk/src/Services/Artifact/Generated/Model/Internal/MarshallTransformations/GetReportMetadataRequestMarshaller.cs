...
namespace Amazon.Artifact.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetReportMetadataRequestMarshaller : IMarshaller<IRequest, GetReportMetadataRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetReportMetadataRequestMarshaller _instance = new GetReportMetadataRequestMarshaller();        

        internal static GetReportMetadataRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetReportMetadataRequestMarshaller Instance
        {
            get
            {
                return _instance;
