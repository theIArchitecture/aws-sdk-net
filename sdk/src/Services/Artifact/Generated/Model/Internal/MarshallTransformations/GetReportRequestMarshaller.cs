...
namespace Amazon.Artifact.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetReportRequestMarshaller : IMarshaller<IRequest, GetReportRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetReportRequestMarshaller _instance = new GetReportRequestMarshaller();        

        internal static GetReportRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetReportRequestMarshaller Instance
        {
            get
            {
                return _instance;
