...
namespace Amazon.Artifact.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ReportSummaryUnmarshaller : IJsonUnmarshaller<ReportSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ReportSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
