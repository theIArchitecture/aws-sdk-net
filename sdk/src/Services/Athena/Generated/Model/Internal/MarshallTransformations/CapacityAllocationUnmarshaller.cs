...
namespace Amazon.Athena.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CapacityAllocationUnmarshaller : IJsonUnmarshaller<CapacityAllocation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CapacityAllocation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("RequestCompletionTime", targetDepth))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    unmarshalledObject.RequestCompletionTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
