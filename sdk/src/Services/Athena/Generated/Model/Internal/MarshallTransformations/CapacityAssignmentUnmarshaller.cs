...
namespace Amazon.Athena.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CapacityAssignmentUnmarshaller : IJsonUnmarshaller<CapacityAssignment, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CapacityAssignment Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("WorkGroupNames", targetDepth))
                {
                    ...
                    unmarshalledObject.WorkGroupNames = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
