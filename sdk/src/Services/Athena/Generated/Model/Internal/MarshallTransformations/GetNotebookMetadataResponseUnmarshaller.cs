...
{
    /// <summary>
    /// Response Unmarshaller for GetNotebookMetadata operation
    /// </summary>  
    public class GetNotebookMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetNotebookMetadataResponse response = new GetNotebookMetadataResponse();
        ...
        private static GetNotebookMetadataResponseUnmarshaller _instance = new GetNotebookMetadataResponseUnmarshaller();        

        internal static GetNotebookMetadataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetNotebookMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
