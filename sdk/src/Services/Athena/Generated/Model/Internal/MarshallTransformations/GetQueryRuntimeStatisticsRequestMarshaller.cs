...
namespace Amazon.Athena.Model.Internal.MarshallTransformations
{
    ...
    public class GetQueryRuntimeStatisticsRequestMarshaller : IMarshaller<IRequest, GetQueryRuntimeStatisticsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(GetQueryRuntimeStatisticsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Athena");
            string target = "AmazonAthena.GetQueryRuntimeStatistics";
        ...
        private static GetQueryRuntimeStatisticsRequestMarshaller _instance = new GetQueryRuntimeStatisticsRequestMarshaller();        

        internal static GetQueryRuntimeStatisticsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetQueryRuntimeStatisticsRequestMarshaller Instance
        {
            get
            {
                return _instance;
