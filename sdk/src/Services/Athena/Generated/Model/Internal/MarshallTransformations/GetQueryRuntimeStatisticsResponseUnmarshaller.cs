...
namespace Amazon.Athena.Model.Internal.MarshallTransformations
{
    ...
    public class GetQueryRuntimeStatisticsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("QueryRuntimeStatistics", targetDepth))
                {
                    var unmarshaller = QueryRuntimeStatisticsUnmarshaller.Instance;
                    response.QueryRuntimeStatistics = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetQueryRuntimeStatisticsResponseUnmarshaller _instance = new GetQueryRuntimeStatisticsResponseUnmarshaller();        

        internal static GetQueryRuntimeStatisticsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetQueryRuntimeStatisticsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
