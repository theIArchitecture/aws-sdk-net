...
namespace Amazon.Athena.Model.Internal.MarshallTransformations
{
    ...
    public class GetSessionStatusRequestMarshaller : IMarshaller<IRequest, GetSessionStatusRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(GetSessionStatusRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Athena");
            string target = "AmazonAthena.GetSessionStatus";
        ...
        private static GetSessionStatusRequestMarshaller _instance = new GetSessionStatusRequestMarshaller();        

        internal static GetSessionStatusRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSessionStatusRequestMarshaller Instance
        {
            get
            {
                return _instance;
