...
namespace Amazon.Athena.Model.Internal.MarshallTransformations
{
    ...
    public class GetSessionStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static GetSessionStatusResponseUnmarshaller _instance = new GetSessionStatusResponseUnmarshaller();        

        internal static GetSessionStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSessionStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
