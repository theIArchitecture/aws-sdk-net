...
namespace Amazon.Athena.Model.Internal.MarshallTransformations
{
    ...
    public class ImportNotebookResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static ImportNotebookResponseUnmarshaller _instance = new ImportNotebookResponseUnmarshaller();        

        internal static ImportNotebookResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImportNotebookResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
