...
namespace Amazon.Athena.Model.Internal.MarshallTransformations
{
    ...
    public class ListApplicationDPUSizesRequestMarshaller : IMarshaller<IRequest, ListApplicationDPUSizesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(ListApplicationDPUSizesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Athena");
            string target = "AmazonAthena.ListApplicationDPUSizes";
        ...
        private static ListApplicationDPUSizesRequestMarshaller _instance = new ListApplicationDPUSizesRequestMarshaller();        

        internal static ListApplicationDPUSizesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListApplicationDPUSizesRequestMarshaller Instance
        {
            get
            {
                return _instance;
