...
namespace Amazon.Athena.Model.Internal.MarshallTransformations
{
    ...
    public class ListApplicationDPUSizesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("ApplicationDPUSizes", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<ApplicationDPUSizes, ApplicationDPUSizesUnmarshaller>(ApplicationDPUSizesUnmarshaller.Instance);
                    response.ApplicationDPUSizes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListApplicationDPUSizesResponseUnmarshaller _instance = new ListApplicationDPUSizesResponseUnmarshaller();        

        internal static ListApplicationDPUSizesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListApplicationDPUSizesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
