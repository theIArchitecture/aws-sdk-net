    ...
    public class ListCalculationExecutionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<CalculationSummary, CalculationSummaryUnmarshaller>(CalculationSummaryUnmarshaller.Instance);
                    response.Calculations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListCalculationExecutionsResponseUnmarshaller _instance = new ListCalculationExecutionsResponseUnmarshaller();        

        internal static ListCalculationExecutionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCalculationExecutionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
