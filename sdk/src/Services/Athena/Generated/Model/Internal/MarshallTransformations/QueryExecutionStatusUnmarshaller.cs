...
namespace Amazon.Athena.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class QueryExecutionStatusUnmarshaller : IJsonUnmarshaller<QueryExecutionStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public QueryExecutionStatus Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AthenaError", targetDepth))
                {
                    ...
                    unmarshalledObject.AthenaError = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
