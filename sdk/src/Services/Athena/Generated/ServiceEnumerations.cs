...
namespace Amazon.Athena
{
    ...
    public class QueryResultType : ConstantClass
    {
        ...
        /// <summary>
        /// Constant DATA_MANIFEST for QueryResultType
        /// </summary>
        public static readonly QueryResultType DATA_MANIFEST = new QueryResultType("DATA_MANIFEST");
        /// <summary>
        /// Constant DATA_ROWS for QueryResultType
        /// </summary>
        public static readonly QueryResultType DATA_ROWS = new QueryResultType("DATA_ROWS");
