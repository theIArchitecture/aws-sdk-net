...
namespace Amazon.AuditManager.Internal
{
    ...
    public class AmazonAuditManagerAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonAuditManagerAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for AuditManager.
        /// </summary>
        public AmazonAuditManagerAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonAuditManagerAuthSchemeParameters
            {
    ...
    public class AmazonAuditManagerAuthSchemeResolver : IAuthSchemeResolver<AmazonAuditManagerAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonAuditManagerAuthSchemeParameters authParameters)
        {
