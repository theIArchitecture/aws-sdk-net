...
namespace Amazon.AuditManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssessmentReportEvidenceErrorUnmarshaller : IJsonUnmarshaller<AssessmentReportEvidenceError, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AssessmentReportEvidenceError Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.EvidenceId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
