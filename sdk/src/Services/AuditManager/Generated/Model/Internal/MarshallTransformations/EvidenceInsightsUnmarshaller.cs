...
{
    /// <summary>
    /// Response Unmarshaller for EvidenceInsights Object
    /// </summary>  
    public class EvidenceInsightsUnmarshaller : IJsonUnmarshaller<EvidenceInsights, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EvidenceInsights Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            EvidenceInsights unmarshalledObject = new EvidenceInsights();
        ...
        private static EvidenceInsightsUnmarshaller _instance = new EvidenceInsightsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static EvidenceInsightsUnmarshaller Instance
        {
            get
            {
                return _instance;
