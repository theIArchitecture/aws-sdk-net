        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("signatureAlgorithm", targetDepth))
                {
                    ...
                    response.SignatureAlgorithm = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("signatureDateTime", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SignatureDateTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("signatureKeyId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SignatureKeyId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("signatureValid", targetDepth))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    response.SignatureValid = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
