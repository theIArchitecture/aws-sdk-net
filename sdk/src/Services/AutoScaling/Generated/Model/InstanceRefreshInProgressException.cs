...
namespace Amazon.AutoScaling.Model
{
    ...
    public partial class InstanceRefreshInProgressException : AmazonAutoScalingException
    {
        ...
        public InstanceRefreshInProgressException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InstanceRefreshInProgressException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
