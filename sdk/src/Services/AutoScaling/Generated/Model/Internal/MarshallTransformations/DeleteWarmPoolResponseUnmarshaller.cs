...
{
    /// <summary>
    /// Response Unmarshaller for DeleteWarmPool operation
    /// </summary>  
    public class DeleteWarmPoolResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteWarmPoolResponse response = new DeleteWarmPoolResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteWarmPoolResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, DeleteWarmPoolResponse response)
        {
        ...
        private static DeleteWarmPoolResponseUnmarshaller _instance = new DeleteWarmPoolResponseUnmarshaller();        

        internal static DeleteWarmPoolResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteWarmPoolResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
