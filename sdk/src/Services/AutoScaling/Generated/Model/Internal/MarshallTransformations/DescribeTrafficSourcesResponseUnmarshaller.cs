...
{
    /// <summary>
    /// Response Unmarshaller for DescribeTrafficSources operation
    /// </summary>  
    public class DescribeTrafficSourcesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeTrafficSourcesResponse response = new DescribeTrafficSourcesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeTrafficSourcesResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, DescribeTrafficSourcesResponse response)
        {
        ...
        private static DescribeTrafficSourcesResponseUnmarshaller _instance = new DescribeTrafficSourcesResponseUnmarshaller();        

        internal static DescribeTrafficSourcesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTrafficSourcesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
