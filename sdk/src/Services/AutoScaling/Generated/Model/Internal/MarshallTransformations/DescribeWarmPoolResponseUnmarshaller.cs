...
{
    /// <summary>
    /// Response Unmarshaller for DescribeWarmPool operation
    /// </summary>  
    public class DescribeWarmPoolResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeWarmPoolResponse response = new DescribeWarmPoolResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeWarmPoolResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, DescribeWarmPoolResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("WarmPoolConfiguration", targetDepth))
                    {
                        ...
                        response.WarmPoolConfiguration = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
           }
        ...
        private static DescribeWarmPoolResponseUnmarshaller _instance = new DescribeWarmPoolResponseUnmarshaller();        

        internal static DescribeWarmPoolResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeWarmPoolResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
