...
namespace Amazon.AutoScaling.Model
{
    ...
    public partial class ScalingActivityInProgressException : AmazonAutoScalingException
    {
        ...
        public ScalingActivityInProgressException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ScalingActivityInProgressException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
