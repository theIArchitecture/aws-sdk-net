...
namespace Amazon.AutoScaling.Model
{
    ...
    public partial class ServiceLinkedRoleFailureException : AmazonAutoScalingException
    {
        ...
        public ServiceLinkedRoleFailureException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ServiceLinkedRoleFailureException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
