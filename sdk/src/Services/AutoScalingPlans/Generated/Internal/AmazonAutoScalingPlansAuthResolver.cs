...
namespace Amazon.AutoScalingPlans.Internal
{
    ...
    public class AmazonAutoScalingPlansAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonAutoScalingPlansAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for AutoScalingPlans.
        /// </summary>
        public AmazonAutoScalingPlansAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonAutoScalingPlansAuthSchemeParameters
            {
    ...
    public class AmazonAutoScalingPlansAuthSchemeResolver : IAuthSchemeResolver<AmazonAutoScalingPlansAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonAutoScalingPlansAuthSchemeParameters authParameters)
        {
