    ...
    public class DescribeScalingPlanResourcesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ScalingPlanResource, ScalingPlanResourceUnmarshaller>(ScalingPlanResourceUnmarshaller.Instance);
                    response.ScalingPlanResources = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
