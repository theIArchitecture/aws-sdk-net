...
namespace Amazon.AutoScalingPlans.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PredefinedScalingMetricSpecificationUnmarshaller : IJsonUnmarshaller<PredefinedScalingMetricSpecification, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PredefinedScalingMetricSpecification Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("PredefinedScalingMetricType", targetDepth))
                {
                    ...
                    unmarshalledObject.PredefinedScalingMetricType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
