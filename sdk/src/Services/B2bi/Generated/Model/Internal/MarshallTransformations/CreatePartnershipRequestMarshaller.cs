...
{
    /// <summary>
    /// CreatePartnership Request Marshaller
    /// </summary>       
    public class CreatePartnershipRequestMarshaller : IMarshaller<IRequest, CreatePartnershipRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreatePartnershipRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreatePartnershipRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.B2bi");
            string target = "B2BI.CreatePartnership";
        ...
        private static CreatePartnershipRequestMarshaller _instance = new CreatePartnershipRequestMarshaller();        

        internal static CreatePartnershipRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePartnershipRequestMarshaller Instance
        {
            get
            {
                return _instance;
