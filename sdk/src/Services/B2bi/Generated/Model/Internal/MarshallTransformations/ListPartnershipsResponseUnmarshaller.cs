...
{
    /// <summary>
    /// Response Unmarshaller for ListPartnerships operation
    /// </summary>  
    public class ListPartnershipsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListPartnershipsResponse response = new ListPartnershipsResponse();
        ...
        private static ListPartnershipsResponseUnmarshaller _instance = new ListPartnershipsResponseUnmarshaller();        

        internal static ListPartnershipsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPartnershipsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
