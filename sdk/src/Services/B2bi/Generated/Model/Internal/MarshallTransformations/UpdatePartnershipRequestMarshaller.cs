...
{
    /// <summary>
    /// UpdatePartnership Request Marshaller
    /// </summary>       
    public class UpdatePartnershipRequestMarshaller : IMarshaller<IRequest, UpdatePartnershipRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdatePartnershipRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdatePartnershipRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.B2bi");
            string target = "B2BI.UpdatePartnership";
        ...
        private static UpdatePartnershipRequestMarshaller _instance = new UpdatePartnershipRequestMarshaller();        

        internal static UpdatePartnershipRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePartnershipRequestMarshaller Instance
        {
            get
            {
                return _instance;
