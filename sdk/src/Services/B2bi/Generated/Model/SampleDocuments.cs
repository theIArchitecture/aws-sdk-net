...
{
    /// <summary>
    /// Describes a structure that contains the Amazon S3 bucket and an array of the corresponding
    /// keys used to identify the location for your sample documents.
    /// </summary>
    public partial class SampleDocuments
    {
        private string _bucketName;
        private List<SampleDocumentKeys> _keys = AWSConfigs.InitializeCollections ? new List<SampleDocumentKeys>() : null;
        ...
        public List<SampleDocumentKeys> Keys
        {
