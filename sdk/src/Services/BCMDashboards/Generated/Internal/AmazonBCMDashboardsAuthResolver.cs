...
namespace Amazon.BCMDashboards.Internal
{
    ...
    public class AmazonBCMDashboardsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonBCMDashboardsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for BCMDashboards.
        /// </summary>
        public AmazonBCMDashboardsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonBCMDashboardsAuthSchemeParameters
            {
    ...
    public class AmazonBCMDashboardsAuthSchemeResolver : IAuthSchemeResolver<AmazonBCMDashboardsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonBCMDashboardsAuthSchemeParameters authParameters)
        {
