...
{
    /// <summary>
    /// Specifies the values and match options for cost category-based filtering in cost and
    /// usage queries.
    /// </summary>
    public partial class CostCategoryValues
    {
        ...
        /// <para>
        /// The match options for cost category values, such as <c>EQUALS</c>, <c>CONTAINS</c>,
        /// <c>STARTS_WITH</c>, or <c>ENDS_WITH</c>.
        /// </para>
        /// <para />
