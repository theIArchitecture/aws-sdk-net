...
{
    /// <summary>
    /// Specifies the values and match options for dimension-based filtering in cost and usage
    /// queries.
    /// </summary>
    public partial class DimensionValues
    {
        ...
        /// <para>
        /// The key of the dimension to filter on (for example, <c>SERVICE</c>, <c>USAGE_TYPE</c>,
        /// or <c>OPERATION</c>).
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// The match options for dimension values, such as <c>EQUALS</c>, <c>CONTAINS</c>, <c>STARTS_WITH</c>,
        /// or <c>ENDS_WITH</c>.
        /// </para>
        /// <para />
