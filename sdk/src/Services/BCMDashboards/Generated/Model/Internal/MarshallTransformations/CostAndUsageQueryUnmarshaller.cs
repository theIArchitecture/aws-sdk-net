...
{
    /// <summary>
    /// Response Unmarshaller for CostAndUsageQuery Object
    /// </summary>  
    public class CostAndUsageQueryUnmarshaller : IJsonUnmarshaller<CostAndUsageQuery, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CostAndUsageQuery Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            CostAndUsageQuery unmarshalledObject = new CostAndUsageQuery();
        ...
        private static CostAndUsageQueryUnmarshaller _instance = new CostAndUsageQueryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CostAndUsageQueryUnmarshaller Instance
        {
            get
            {
                return _instance;
