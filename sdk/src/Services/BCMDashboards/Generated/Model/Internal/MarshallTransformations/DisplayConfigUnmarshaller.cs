...
{
    /// <summary>
    /// Response Unmarshaller for DisplayConfig Object
    /// </summary>  
    public class DisplayConfigUnmarshaller : IJsonUnmarshaller<DisplayConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DisplayConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            DisplayConfig unmarshalledObject = new DisplayConfig();
        ...
        private static DisplayConfigUnmarshaller _instance = new DisplayConfigUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DisplayConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
