...
{
    /// <summary>
    /// Response Unmarshaller for ReservationCoverageQuery Object
    /// </summary>  
    public class ReservationCoverageQueryUnmarshaller : IJsonUnmarshaller<ReservationCoverageQuery, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ReservationCoverageQuery Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ReservationCoverageQuery unmarshalledObject = new ReservationCoverageQuery();
        ...
        private static ReservationCoverageQueryUnmarshaller _instance = new ReservationCoverageQueryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ReservationCoverageQueryUnmarshaller Instance
        {
            get
            {
                return _instance;
