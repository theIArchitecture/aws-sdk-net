...
{
    /// <summary>
    /// Response Unmarshaller for ReservationUtilizationQuery Object
    /// </summary>  
    public class ReservationUtilizationQueryUnmarshaller : IJsonUnmarshaller<ReservationUtilizationQuery, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ReservationUtilizationQuery Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ReservationUtilizationQuery unmarshalledObject = new ReservationUtilizationQuery();
        ...
        private static ReservationUtilizationQueryUnmarshaller _instance = new ReservationUtilizationQueryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ReservationUtilizationQueryUnmarshaller Instance
        {
            get
            {
                return _instance;
