...
{
    /// <summary>
    /// Response Unmarshaller for SavingsPlansCoverageQuery Object
    /// </summary>  
    public class SavingsPlansCoverageQueryUnmarshaller : IJsonUnmarshaller<SavingsPlansCoverageQuery, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SavingsPlansCoverageQuery Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            SavingsPlansCoverageQuery unmarshalledObject = new SavingsPlansCoverageQuery();
        ...
        private static SavingsPlansCoverageQueryUnmarshaller _instance = new SavingsPlansCoverageQueryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SavingsPlansCoverageQueryUnmarshaller Instance
        {
            get
            {
                return _instance;
