...
{
    /// <summary>
    /// Response Unmarshaller for WidgetConfig Object
    /// </summary>  
    public class WidgetConfigUnmarshaller : IJsonUnmarshaller<WidgetConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public WidgetConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            WidgetConfig unmarshalledObject = new WidgetConfig();
        ...
        private static WidgetConfigUnmarshaller _instance = new WidgetConfigUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static WidgetConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
