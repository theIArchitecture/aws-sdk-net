...
namespace Amazon.BCMDashboards.Model
{
    ...
    {
        private List<DashboardReference> _dashboards = AWSConfigs.InitializeCollections ? new List<DashboardReference>() : null;
        ...
        public List<DashboardReference> Dashboards
        {
        ...
        /// <para>
        /// The token to use to retrieve the next page of results. Not returned if there are no
