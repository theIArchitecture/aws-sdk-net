...
{
    /// <summary>
    /// Defines the parameters for querying Savings Plans coverage data, including metrics,
    /// grouping options, and time granularity.
    /// </summary>
    public partial class SavingsPlansCoverageQuery
    {
        ...
        ///  <note> 
        /// <para>
        /// Valid value for SavingsPlansCoverageQuery metrics is <c>SpendCoveredBySavingsPlans</c>.
        /// </para>
        ///  </note>
        /// <para />
        /// Starting with version 4 of the SDK this property will default to null. If no data for this property is returned
