...
namespace Amazon.BCMDashboards.Model
{
    ...
    {
        private readonly IAmazonBCMDashboards _client;
        ...
        /// <summary>
        /// Enumerable containing all of the Dashboards
        /// </summary>
        public IPaginatedEnumerable<DashboardReference> Dashboards => 
            new PaginatedResultKeyResponse<ListDashboardsResponse, DashboardReference>(this, (i) => i.Dashboards ?? new List<DashboardReference>());

        internal ListDashboardsPaginator(IAmazonBCMDashboards client, ListDashboardsRequest request)
        {
            this._client = client;
