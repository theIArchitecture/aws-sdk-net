...
namespace Amazon.BCMDataExports
{
    ...
    public partial class AmazonBCMDataExportsConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("BCM Data Exports", "4.0.0.25");
        ...
        /// Default constructor
        /// </summary>
        public AmazonBCMDataExportsConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonBCMDataExportsDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "BCM Data Exports";
            this.AuthenticationServiceName = "bcm-data-exports";
            this.EndpointProvider = new AmazonBCMDataExportsEndpointProvider();
        }
