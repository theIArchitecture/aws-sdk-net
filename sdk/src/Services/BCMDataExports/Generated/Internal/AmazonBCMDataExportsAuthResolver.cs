...
namespace Amazon.BCMDataExports.Internal
{
    ...
    public class AmazonBCMDataExportsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonBCMDataExportsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for BCMDataExports.
        /// </summary>
        public AmazonBCMDataExportsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonBCMDataExportsAuthSchemeParameters
            {
    ...
    public class AmazonBCMDataExportsAuthSchemeResolver : IAuthSchemeResolver<AmazonBCMDataExportsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonBCMDataExportsAuthSchemeParameters authParameters)
        {
