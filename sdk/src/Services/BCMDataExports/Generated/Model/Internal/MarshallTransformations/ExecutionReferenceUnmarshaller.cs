...
namespace Amazon.BCMDataExports.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExecutionReferenceUnmarshaller : IJsonUnmarshaller<ExecutionReference, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ExecutionReference Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
