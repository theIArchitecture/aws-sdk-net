...
{
    /// <summary>
    /// GetExecution Request Marshaller
    /// </summary>       
    public class GetExecutionRequestMarshaller : IMarshaller<IRequest, GetExecutionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetExecutionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetExecutionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.BCMDataExports");
            string target = "AWSBillingAndCostManagementDataExports.GetExecution";
        ...
        private static GetExecutionRequestMarshaller _instance = new GetExecutionRequestMarshaller();        

        internal static GetExecutionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetExecutionRequestMarshaller Instance
        {
            get
            {
                return _instance;
