...
{
    /// <summary>
    /// Response Unmarshaller for GetExecution operation
    /// </summary>  
    public class GetExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Export", targetDepth))
                {
                    ...
                    response.Export = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetExecutionResponseUnmarshaller _instance = new GetExecutionResponseUnmarshaller();        

        internal static GetExecutionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetExecutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
