...
namespace Amazon.BCMPricingCalculator.Internal
{
    ...
    public class AmazonBCMPricingCalculatorAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonBCMPricingCalculatorAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for BCMPricingCalculator.
        /// </summary>
        public AmazonBCMPricingCalculatorAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonBCMPricingCalculatorAuthSchemeParameters
            {
    ...
    public class AmazonBCMPricingCalculatorAuthSchemeResolver : IAuthSchemeResolver<AmazonBCMPricingCalculatorAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonBCMPricingCalculatorAuthSchemeParameters authParameters)
        {
