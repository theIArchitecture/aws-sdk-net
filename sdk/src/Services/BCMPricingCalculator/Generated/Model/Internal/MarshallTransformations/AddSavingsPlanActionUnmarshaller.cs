    ...
    public class AddSavingsPlanActionUnmarshaller : IJsonUnmarshaller<AddSavingsPlanAction, JsonUnmarshallerContext>
    {
        ...
        public AddSavingsPlanAction Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("savingsPlanOfferingId", targetDepth))
                {
        ...
        private static AddSavingsPlanActionUnmarshaller _instance = new AddSavingsPlanActionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AddSavingsPlanActionUnmarshaller Instance
        {
            get
            {
                return _instance;
