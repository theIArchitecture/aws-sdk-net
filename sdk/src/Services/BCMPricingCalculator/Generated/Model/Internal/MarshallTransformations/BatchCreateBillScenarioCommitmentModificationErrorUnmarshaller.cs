...
namespace Amazon.BCMPricingCalculator.Model.Internal.MarshallTransformations
{
    ...
    public class BatchCreateBillScenarioCommitmentModificationErrorUnmarshaller : IJsonUnmarshaller<BatchCreateBillScenarioCommitmentModificationError, JsonUnmarshallerContext>
    {
        ...
        private static BatchCreateBillScenarioCommitmentModificationErrorUnmarshaller _instance = new BatchCreateBillScenarioCommitmentModificationErrorUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BatchCreateBillScenarioCommitmentModificationErrorUnmarshaller Instance
        {
            get
            {
                return _instance;
