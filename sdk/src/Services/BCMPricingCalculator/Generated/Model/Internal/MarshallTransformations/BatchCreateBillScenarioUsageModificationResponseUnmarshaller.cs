...
{
    /// <summary>
    /// Response Unmarshaller for BatchCreateBillScenarioUsageModification operation
    /// </summary>  
    public class BatchCreateBillScenarioUsageModificationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchCreateBillScenarioUsageModificationResponse response = new BatchCreateBillScenarioUsageModificationResponse();
        ...
        private static BatchCreateBillScenarioUsageModificationResponseUnmarshaller _instance = new BatchCreateBillScenarioUsageModificationResponseUnmarshaller();        

        internal static BatchCreateBillScenarioUsageModificationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchCreateBillScenarioUsageModificationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
