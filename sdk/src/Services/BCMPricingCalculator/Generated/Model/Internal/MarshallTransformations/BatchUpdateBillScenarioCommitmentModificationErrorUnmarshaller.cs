...
namespace Amazon.BCMPricingCalculator.Model.Internal.MarshallTransformations
{
    ...
    public class BatchUpdateBillScenarioCommitmentModificationErrorUnmarshaller : IJsonUnmarshaller<BatchUpdateBillScenarioCommitmentModificationError, JsonUnmarshallerContext>
    {
        ...
        private static BatchUpdateBillScenarioCommitmentModificationErrorUnmarshaller _instance = new BatchUpdateBillScenarioCommitmentModificationErrorUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BatchUpdateBillScenarioCommitmentModificationErrorUnmarshaller Instance
        {
            get
            {
                return _instance;
