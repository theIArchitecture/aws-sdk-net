...
{
    /// <summary>
    /// Response Unmarshaller for CreateBillScenario operation
    /// </summary>  
    public class CreateBillScenarioResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateBillScenarioResponse response = new CreateBillScenarioResponse();
        ...
        private static CreateBillScenarioResponseUnmarshaller _instance = new CreateBillScenarioResponseUnmarshaller();        

        internal static CreateBillScenarioResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateBillScenarioResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
