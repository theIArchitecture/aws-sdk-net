...
{
    /// <summary>
    /// Response Unmarshaller for GetBillEstimate operation
    /// </summary>  
    public class GetBillEstimateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetBillEstimateResponse response = new GetBillEstimateResponse();
        ...
        private static GetBillEstimateResponseUnmarshaller _instance = new GetBillEstimateResponseUnmarshaller();        

        internal static GetBillEstimateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBillEstimateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
