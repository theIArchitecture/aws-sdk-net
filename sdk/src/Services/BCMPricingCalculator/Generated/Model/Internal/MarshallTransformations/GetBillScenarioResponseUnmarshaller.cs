...
{
    /// <summary>
    /// Response Unmarshaller for GetBillScenario operation
    /// </summary>  
    public class GetBillScenarioResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetBillScenarioResponse response = new GetBillScenarioResponse();
        ...
        private static GetBillScenarioResponseUnmarshaller _instance = new GetBillScenarioResponseUnmarshaller();        

        internal static GetBillScenarioResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBillScenarioResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
