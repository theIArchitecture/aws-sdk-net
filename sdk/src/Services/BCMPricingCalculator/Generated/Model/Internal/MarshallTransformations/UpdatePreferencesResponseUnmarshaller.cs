...
{
    /// <summary>
    /// Response Unmarshaller for UpdatePreferences operation
    /// </summary>  
    public class UpdatePreferencesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdatePreferencesResponse response = new UpdatePreferencesResponse();
        ...
        private static UpdatePreferencesResponseUnmarshaller _instance = new UpdatePreferencesResponseUnmarshaller();        

        internal static UpdatePreferencesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePreferencesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
