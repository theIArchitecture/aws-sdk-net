...
namespace Amazon.BCMPricingCalculator.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UsageQuantityUnmarshaller : IJsonUnmarshaller<UsageQuantity, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public UsageQuantity Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("startHour", targetDepth))
                {
                    ...
                    unmarshalledObject.StartHour = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
