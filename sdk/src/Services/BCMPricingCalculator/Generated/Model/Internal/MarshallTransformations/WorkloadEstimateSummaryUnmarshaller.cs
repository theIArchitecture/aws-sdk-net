...
namespace Amazon.BCMPricingCalculator.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class WorkloadEstimateSummaryUnmarshaller : IJsonUnmarshaller<WorkloadEstimateSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public WorkloadEstimateSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("costCurrency", targetDepth))
                {
                    ...
                    unmarshalledObject.CostCurrency = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    unmarshalledObject.RateTimestamp = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("rateType", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RateType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
