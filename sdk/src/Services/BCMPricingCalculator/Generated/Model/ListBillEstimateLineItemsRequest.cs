...
{
    /// <summary>
    /// Container for the parameters to the ListBillEstimateLineItems operation.
    /// Lists the line items associated with a bill estimate.
    /// </summary>
    public partial class ListBillEstimateLineItemsRequest : AmazonBCMPricingCalculatorRequest
    {
        private string _billEstimateId;
        private List<ListBillEstimateLineItemsFilter> _filters = AWSConfigs.InitializeCollections ? new List<ListBillEstimateLineItemsFilter>() : null;
        ...
        /// </summary>
        public List<ListBillEstimateLineItemsFilter> Filters
        {
