...
{
    /// <summary>
    /// Container for the parameters to the ListBillEstimates operation.
    /// Lists all bill estimates for the account.
    /// </summary>
    public partial class ListBillEstimatesRequest : AmazonBCMPricingCalculatorRequest
    {
        private FilterTimestamp _createdAtFilter;
        private FilterTimestamp _expiresAtFilter;
        private List<ListBillEstimatesFilter> _filters = AWSConfigs.InitializeCollections ? new List<ListBillEstimatesFilter>() : null;
        ...
        /// </summary>
        public List<ListBillEstimatesFilter> Filters
        {
