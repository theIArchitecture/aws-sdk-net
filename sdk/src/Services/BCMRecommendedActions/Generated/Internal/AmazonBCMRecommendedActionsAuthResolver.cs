...
namespace Amazon.BCMRecommendedActions.Internal
{
    ...
    public class AmazonBCMRecommendedActionsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonBCMRecommendedActionsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for BCMRecommendedActions.
        /// </summary>
        public AmazonBCMRecommendedActionsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonBCMRecommendedActionsAuthSchemeParameters
            {
    ...
    public class AmazonBCMRecommendedActionsAuthSchemeResolver : IAuthSchemeResolver<AmazonBCMRecommendedActionsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonBCMRecommendedActionsAuthSchemeParameters authParameters)
        {
