...
namespace Amazon.Batch.Internal
{
    ...
    public class AmazonBatchAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonBatchAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Batch.
        /// </summary>
        public AmazonBatchAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonBatchAuthSchemeParameters
            {
    ...
    public class AmazonBatchAuthSchemeResolver : IAuthSchemeResolver<AmazonBatchAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonBatchAuthSchemeParameters authParameters)
        {
