...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AttemptDetailUnmarshaller : IJsonUnmarshaller<AttemptDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AttemptDetail Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AttemptEcsTaskDetails, AttemptEcsTaskDetailsUnmarshaller>(AttemptEcsTaskDetailsUnmarshaller.Instance);
