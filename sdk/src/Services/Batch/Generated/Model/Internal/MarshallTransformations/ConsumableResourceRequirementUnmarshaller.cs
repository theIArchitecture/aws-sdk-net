...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConsumableResourceRequirementUnmarshaller : IJsonUnmarshaller<ConsumableResourceRequirement, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ConsumableResourceRequirement Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("consumableResource", targetDepth))
                {
                    ...
                    unmarshalledObject.ConsumableResource = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
