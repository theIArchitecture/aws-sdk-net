...
{
    /// <summary>
    /// Response Unmarshaller for CreateConsumableResource operation
    /// </summary>  
    public class CreateConsumableResourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateConsumableResourceResponse response = new CreateConsumableResourceResponse();
        ...
        private static CreateConsumableResourceResponseUnmarshaller _instance = new CreateConsumableResourceResponseUnmarshaller();        

        internal static CreateConsumableResourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateConsumableResourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
