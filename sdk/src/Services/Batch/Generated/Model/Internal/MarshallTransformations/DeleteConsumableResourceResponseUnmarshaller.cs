...
{
    /// <summary>
    /// Response Unmarshaller for DeleteConsumableResource operation
    /// </summary>  
    public class DeleteConsumableResourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteConsumableResourceResponse response = new DeleteConsumableResourceResponse();
        ...
        private static DeleteConsumableResourceResponseUnmarshaller _instance = new DeleteConsumableResourceResponseUnmarshaller();        

        internal static DeleteConsumableResourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteConsumableResourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
