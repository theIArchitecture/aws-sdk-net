...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteSchedulingPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSchedulingPolicyResponse response = new DeleteSchedulingPolicyResponse();
        ...
        private static DeleteSchedulingPolicyResponseUnmarshaller _instance = new DeleteSchedulingPolicyResponseUnmarshaller();        

        internal static DeleteSchedulingPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSchedulingPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
