    ...
    public class DescribeJobDefinitionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<JobDefinition, JobDefinitionUnmarshaller>(JobDefinitionUnmarshaller.Instance);
                    response.JobDefinitions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
