...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    public class DescribeSchedulingPoliciesRequestMarshaller : IMarshaller<IRequest, DescribeSchedulingPoliciesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeSchedulingPoliciesRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/describeschedulingpolicies";
#if !NETFRAMEWORK
        ...
        private static DescribeSchedulingPoliciesRequestMarshaller _instance = new DescribeSchedulingPoliciesRequestMarshaller();        

        internal static DescribeSchedulingPoliciesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSchedulingPoliciesRequestMarshaller Instance
        {
            get
            {
                return _instance;
