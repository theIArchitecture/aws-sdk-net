...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EksAttemptContainerDetailUnmarshaller : IJsonUnmarshaller<EksAttemptContainerDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EksAttemptContainerDetail Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("containerID", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ContainerID = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
