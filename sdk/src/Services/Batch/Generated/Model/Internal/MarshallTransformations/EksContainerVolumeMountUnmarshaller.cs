...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    public class EksContainerVolumeMountUnmarshaller : IJsonUnmarshaller<EksContainerVolumeMount, JsonUnmarshallerContext>
    {
        ...
        private static EksContainerVolumeMountUnmarshaller _instance = new EksContainerVolumeMountUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static EksContainerVolumeMountUnmarshaller Instance
        {
            get
            {
                return _instance;
