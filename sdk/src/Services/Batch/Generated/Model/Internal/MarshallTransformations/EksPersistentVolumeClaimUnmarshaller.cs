...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EksPersistentVolumeClaimUnmarshaller : IJsonUnmarshaller<EksPersistentVolumeClaim, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EksPersistentVolumeClaim Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("claimName", targetDepth))
                {
                    ...
                    unmarshalledObject.ClaimName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
