...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetJobQueueSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetJobQueueSnapshotResponse response = new GetJobQueueSnapshotResponse();
        ...
        internal static GetJobQueueSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetJobQueueSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
