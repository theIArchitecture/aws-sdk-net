...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListSchedulingPoliciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSchedulingPoliciesResponse response = new ListSchedulingPoliciesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SchedulingPolicyListingDetail, SchedulingPolicyListingDetailUnmarshaller>(SchedulingPolicyListingDetailUnmarshaller.Instance);
        ...
        private static ListSchedulingPoliciesResponseUnmarshaller _instance = new ListSchedulingPoliciesResponseUnmarshaller();        

        internal static ListSchedulingPoliciesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSchedulingPoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
