...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NodePropertiesSummaryUnmarshaller : IJsonUnmarshaller<NodePropertiesSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NodePropertiesSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("isMainNode", targetDepth))
                {
                    ...
                    unmarshalledObject.IsMainNode = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("nodeIndex", targetDepth))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.NodeIndex = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
