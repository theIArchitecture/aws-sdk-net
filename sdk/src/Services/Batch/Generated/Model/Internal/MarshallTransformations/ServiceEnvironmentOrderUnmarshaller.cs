...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ServiceEnvironmentOrderUnmarshaller : IJsonUnmarshaller<ServiceEnvironmentOrder, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ServiceEnvironmentOrder Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("serviceEnvironment", targetDepth))
                {
                    ...
                    unmarshalledObject.ServiceEnvironment = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
