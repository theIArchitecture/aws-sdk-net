...
{
    /// <summary>
    /// Response Unmarshaller for TerminateServiceJob operation
    /// </summary>  
    public class TerminateServiceJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TerminateServiceJobResponse response = new TerminateServiceJobResponse();
        ...
        private static TerminateServiceJobResponseUnmarshaller _instance = new TerminateServiceJobResponseUnmarshaller();        

        internal static TerminateServiceJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TerminateServiceJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
