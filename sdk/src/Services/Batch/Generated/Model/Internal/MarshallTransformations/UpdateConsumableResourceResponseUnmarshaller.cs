...
{
    /// <summary>
    /// Response Unmarshaller for UpdateConsumableResource operation
    /// </summary>  
    public class UpdateConsumableResourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateConsumableResourceResponse response = new UpdateConsumableResourceResponse();
        ...
        private static UpdateConsumableResourceResponseUnmarshaller _instance = new UpdateConsumableResourceResponseUnmarshaller();        

        internal static UpdateConsumableResourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateConsumableResourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
