...
namespace Amazon.Batch
{
    ...
    public partial interface IAmazonBatch : IAmazonService, IDisposable
    {
        ...
        Task<CreateConsumableResourceResponse> CreateConsumableResourceAsync(CreateConsumableResourceRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<CreateServiceEnvironmentResponse> CreateServiceEnvironmentAsync(CreateServiceEnvironmentRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteConsumableResourceResponse> DeleteConsumableResourceAsync(DeleteConsumableResourceRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteServiceEnvironmentResponse> DeleteServiceEnvironmentAsync(DeleteServiceEnvironmentRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DescribeConsumableResourceResponse> DescribeConsumableResourceAsync(DescribeConsumableResourceRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DescribeServiceEnvironmentsResponse> DescribeServiceEnvironmentsAsync(DescribeServiceEnvironmentsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DescribeServiceJobResponse> DescribeServiceJobAsync(DescribeServiceJobRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetJobQueueSnapshotResponse> GetJobQueueSnapshotAsync(GetJobQueueSnapshotRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListConsumableResourcesResponse> ListConsumableResourcesAsync(ListConsumableResourcesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListServiceJobsResponse> ListServiceJobsAsync(ListServiceJobsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<SubmitServiceJobResponse> SubmitServiceJobAsync(SubmitServiceJobRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<TerminateServiceJobResponse> TerminateServiceJobAsync(TerminateServiceJobRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateConsumableResourceResponse> UpdateConsumableResourceAsync(UpdateConsumableResourceRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonBatchConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonBatchConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonBatchConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonBatchConfig to create AmazonBatchClient");
            }

            return awsCredentials == null ? 
                    new AmazonBatchClient(serviceClientConfig) :
                    new AmazonBatchClient(awsCredentials, serviceClientConfig);
        }
