...
namespace Amazon.Bedrock.Internal
{
    ...
    public class AmazonBedrockAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonBedrockAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Bedrock.
        /// </summary>
        public AmazonBedrockAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonBedrockAuthSchemeParameters
            {
    ...
    public class AmazonBedrockAuthSchemeResolver : IAuthSchemeResolver<AmazonBedrockAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonBedrockAuthSchemeParameters authParameters)
        {
