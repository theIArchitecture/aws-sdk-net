...
{
    /// <summary>
    /// An annotation for adding a new custom type to an Automated Reasoning policy, defining
    /// a set of possible values for variables.
    /// </summary>
    public partial class AutomatedReasoningPolicyAddTypeAnnotation
    {
        private string _description;
        private string _name;
        private List<AutomatedReasoningPolicyDefinitionTypeValue> _values = AWSConfigs.InitializeCollections ? new List<AutomatedReasoningPolicyDefinitionTypeValue>() : null;
        ...
        public List<AutomatedReasoningPolicyDefinitionTypeValue> Values
        {
