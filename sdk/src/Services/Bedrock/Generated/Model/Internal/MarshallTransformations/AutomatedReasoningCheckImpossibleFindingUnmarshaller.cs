...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AutomatedReasoningCheckImpossibleFindingUnmarshaller : IJsonUnmarshaller<AutomatedReasoningCheckImpossibleFinding, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            AutomatedReasoningCheckImpossibleFinding unmarshalledObject = new AutomatedReasoningCheckImpossibleFinding();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AutomatedReasoningCheckImpossibleFindingUnmarshaller Instance
        {
            get
            {
                return _instance;
