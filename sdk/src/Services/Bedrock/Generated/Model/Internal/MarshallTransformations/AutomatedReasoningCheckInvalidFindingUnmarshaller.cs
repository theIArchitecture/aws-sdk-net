...
{
    /// <summary>
    /// Response Unmarshaller for AutomatedReasoningCheckInvalidFinding Object
    /// </summary>  
    public class AutomatedReasoningCheckInvalidFindingUnmarshaller : IJsonUnmarshaller<AutomatedReasoningCheckInvalidFinding, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AutomatedReasoningCheckInvalidFinding Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            AutomatedReasoningCheckInvalidFinding unmarshalledObject = new AutomatedReasoningCheckInvalidFinding();
        ...
        private static AutomatedReasoningCheckInvalidFindingUnmarshaller _instance = new AutomatedReasoningCheckInvalidFindingUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AutomatedReasoningCheckInvalidFindingUnmarshaller Instance
        {
            get
            {
                return _instance;
