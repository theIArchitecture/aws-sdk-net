...
{
    /// <summary>
    /// Response Unmarshaller for AutomatedReasoningPolicyDefinition Object
    /// </summary>  
    public class AutomatedReasoningPolicyDefinitionUnmarshaller : IJsonUnmarshaller<AutomatedReasoningPolicyDefinition, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AutomatedReasoningPolicyDefinition Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            AutomatedReasoningPolicyDefinition unmarshalledObject = new AutomatedReasoningPolicyDefinition();
        ...
        private static AutomatedReasoningPolicyDefinitionUnmarshaller _instance = new AutomatedReasoningPolicyDefinitionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AutomatedReasoningPolicyDefinitionUnmarshaller Instance
        {
            get
            {
                return _instance;
