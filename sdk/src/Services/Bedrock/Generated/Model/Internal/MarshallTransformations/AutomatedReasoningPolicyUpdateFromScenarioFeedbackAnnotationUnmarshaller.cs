...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AutomatedReasoningPolicyUpdateFromScenarioFeedbackAnnotationUnmarshaller : IJsonUnmarshaller<AutomatedReasoningPolicyUpdateFromScenarioFeedbackAnnotation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AutomatedReasoningPolicyUpdateFromScenarioFeedbackAnnotation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ScenarioExpression = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
