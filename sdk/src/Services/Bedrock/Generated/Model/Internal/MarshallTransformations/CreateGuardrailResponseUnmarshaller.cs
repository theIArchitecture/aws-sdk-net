...
{
    /// <summary>
    /// Response Unmarshaller for CreateGuardrail operation
    /// </summary>  
    public class CreateGuardrailResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateGuardrailResponse response = new CreateGuardrailResponse();
        ...
        private static CreateGuardrailResponseUnmarshaller _instance = new CreateGuardrailResponseUnmarshaller();        

        internal static CreateGuardrailResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateGuardrailResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
