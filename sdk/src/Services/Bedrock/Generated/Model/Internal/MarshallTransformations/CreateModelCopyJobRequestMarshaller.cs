...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateModelCopyJobRequestMarshaller : IMarshaller<IRequest, CreateModelCopyJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static CreateModelCopyJobRequestMarshaller _instance = new CreateModelCopyJobRequestMarshaller();        

        internal static CreateModelCopyJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateModelCopyJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
