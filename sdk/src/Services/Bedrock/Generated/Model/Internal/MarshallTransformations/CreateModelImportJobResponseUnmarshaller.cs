...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateModelImportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateModelImportJobResponse response = new CreateModelImportJobResponse();
        ...
        internal static CreateModelImportJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateModelImportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
