...
{
    /// <summary>
    /// Response Unmarshaller for CreatePromptRouter operation
    /// </summary>  
    public class CreatePromptRouterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePromptRouterResponse response = new CreatePromptRouterResponse();
        ...
        private static CreatePromptRouterResponseUnmarshaller _instance = new CreatePromptRouterResponseUnmarshaller();        

        internal static CreatePromptRouterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePromptRouterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
