...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    public class CustomMetricDefinitionUnmarshaller : IJsonUnmarshaller<CustomMetricDefinition, JsonUnmarshallerContext>
    {
        ...
        private static CustomMetricDefinitionUnmarshaller _instance = new CustomMetricDefinitionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CustomMetricDefinitionUnmarshaller Instance
        {
            get
            {
                return _instance;
