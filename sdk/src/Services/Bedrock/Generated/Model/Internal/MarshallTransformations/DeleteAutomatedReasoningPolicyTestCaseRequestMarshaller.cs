...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteAutomatedReasoningPolicyTestCaseRequestMarshaller : IMarshaller<IRequest, DeleteAutomatedReasoningPolicyTestCaseRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteAutomatedReasoningPolicyTestCaseRequestMarshaller _instance = new DeleteAutomatedReasoningPolicyTestCaseRequestMarshaller();        

        internal static DeleteAutomatedReasoningPolicyTestCaseRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAutomatedReasoningPolicyTestCaseRequestMarshaller Instance
        {
            get
            {
                return _instance;
