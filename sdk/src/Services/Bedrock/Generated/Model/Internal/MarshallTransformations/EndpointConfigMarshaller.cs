    ...
    public class EndpointConfigMarshaller : IRequestMarshaller<EndpointConfig, JsonMarshallerContext> 
    {
        ...
        public void Marshall(EndpointConfig requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetSageMaker())
            {
                context.Writer.WritePropertyName("sageMaker");
                context.Writer.WriteStartObject();

                var marshaller = SageMakerEndpointMarshaller.Instance;
                marshaller.Marshall(requestObject.SageMaker, context);
