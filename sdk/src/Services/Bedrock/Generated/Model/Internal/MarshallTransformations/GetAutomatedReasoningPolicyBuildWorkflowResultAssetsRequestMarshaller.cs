...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetAutomatedReasoningPolicyBuildWorkflowResultAssetsRequestMarshaller : IMarshaller<IRequest, GetAutomatedReasoningPolicyBuildWorkflowResultAssetsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetAutomatedReasoningPolicyBuildWorkflowResultAssetsRequestMarshaller _instance = new GetAutomatedReasoningPolicyBuildWorkflowResultAssetsRequestMarshaller();        

        internal static GetAutomatedReasoningPolicyBuildWorkflowResultAssetsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAutomatedReasoningPolicyBuildWorkflowResultAssetsRequestMarshaller Instance
        {
            get
            {
                return _instance;
