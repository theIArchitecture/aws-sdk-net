...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetFoundationModelAvailabilityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetFoundationModelAvailabilityResponse response = new GetFoundationModelAvailabilityResponse();
        ...
        internal static GetFoundationModelAvailabilityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFoundationModelAvailabilityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
