...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetModelCopyJobRequestMarshaller : IMarshaller<IRequest, GetModelCopyJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetModelCopyJobRequestMarshaller _instance = new GetModelCopyJobRequestMarshaller();        

        internal static GetModelCopyJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetModelCopyJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
