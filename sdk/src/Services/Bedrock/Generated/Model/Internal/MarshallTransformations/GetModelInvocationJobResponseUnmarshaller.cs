...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetModelInvocationJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetModelInvocationJobResponse response = new GetModelInvocationJobResponse();
        ...
        internal static GetModelInvocationJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetModelInvocationJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
