...
{
    /// <summary>
    /// Response Unmarshaller for GetPromptRouter operation
    /// </summary>  
    public class GetPromptRouterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPromptRouterResponse response = new GetPromptRouterResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("fallbackModel", targetDepth))
                {
                    ...
                    response.FallbackModel = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PromptRouterArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("promptRouterName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PromptRouterName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("routingCriteria", targetDepth))
                {
                    var unmarshaller = RoutingCriteriaUnmarshaller.Instance;
                    response.RoutingCriteria = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetPromptRouterResponseUnmarshaller _instance = new GetPromptRouterResponseUnmarshaller();        

        internal static GetPromptRouterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPromptRouterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
