...
{
    /// <summary>
    /// ListEvaluationJobs Request Marshaller
    /// </summary>       
    public class ListEvaluationJobsRequestMarshaller : IMarshaller<IRequest, ListEvaluationJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListEvaluationJobsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListEvaluationJobsRequest publicRequest)
        {
        ...
        private static ListEvaluationJobsRequestMarshaller _instance = new ListEvaluationJobsRequestMarshaller();        

        internal static ListEvaluationJobsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListEvaluationJobsRequestMarshaller Instance
        {
            get
            {
                return _instance;
