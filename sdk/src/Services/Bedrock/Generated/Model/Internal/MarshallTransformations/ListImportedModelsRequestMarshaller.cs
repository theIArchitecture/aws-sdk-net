...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListImportedModelsRequestMarshaller : IMarshaller<IRequest, ListImportedModelsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListImportedModelsRequestMarshaller _instance = new ListImportedModelsRequestMarshaller();        

        internal static ListImportedModelsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListImportedModelsRequestMarshaller Instance
        {
            get
            {
                return _instance;
