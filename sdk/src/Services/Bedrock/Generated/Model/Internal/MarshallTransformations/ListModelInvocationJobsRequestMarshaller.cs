...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListModelInvocationJobsRequestMarshaller : IMarshaller<IRequest, ListModelInvocationJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListModelInvocationJobsRequestMarshaller _instance = new ListModelInvocationJobsRequestMarshaller();        

        internal static ListModelInvocationJobsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListModelInvocationJobsRequestMarshaller Instance
        {
            get
            {
                return _instance;
