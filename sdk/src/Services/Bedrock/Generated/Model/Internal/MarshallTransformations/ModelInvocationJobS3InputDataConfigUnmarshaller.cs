...
namespace Amazon.Bedrock.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ModelInvocationJobS3InputDataConfigUnmarshaller : IJsonUnmarshaller<ModelInvocationJobS3InputDataConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ModelInvocationJobS3InputDataConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.S3InputFormat = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
