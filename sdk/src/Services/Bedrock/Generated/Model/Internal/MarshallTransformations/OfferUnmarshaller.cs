...
{
    /// <summary>
    /// Response Unmarshaller for Offer Object
    /// </summary>  
    public class OfferUnmarshaller : IJsonUnmarshaller<Offer, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Offer Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            Offer unmarshalledObject = new Offer();
        ...
        private static OfferUnmarshaller _instance = new OfferUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static OfferUnmarshaller Instance
        {
            get
            {
                return _instance;
