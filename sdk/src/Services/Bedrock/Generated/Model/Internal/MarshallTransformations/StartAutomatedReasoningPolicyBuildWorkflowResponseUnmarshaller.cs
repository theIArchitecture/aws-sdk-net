...
{
    /// <summary>
    /// Response Unmarshaller for StartAutomatedReasoningPolicyBuildWorkflow operation
    /// </summary>  
    public class StartAutomatedReasoningPolicyBuildWorkflowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartAutomatedReasoningPolicyBuildWorkflowResponse response = new StartAutomatedReasoningPolicyBuildWorkflowResponse();
        ...
        private static StartAutomatedReasoningPolicyBuildWorkflowResponseUnmarshaller _instance = new StartAutomatedReasoningPolicyBuildWorkflowResponseUnmarshaller();        

        internal static StartAutomatedReasoningPolicyBuildWorkflowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartAutomatedReasoningPolicyBuildWorkflowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
