...
{
    /// <summary>
    /// Response Unmarshaller for TermDetails Object
    /// </summary>  
    public class TermDetailsUnmarshaller : IJsonUnmarshaller<TermDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TermDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            TermDetails unmarshalledObject = new TermDetails();
        ...
        private static TermDetailsUnmarshaller _instance = new TermDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TermDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
