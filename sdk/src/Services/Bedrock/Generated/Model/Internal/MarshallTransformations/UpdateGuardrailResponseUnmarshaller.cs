...
{
    /// <summary>
    /// Response Unmarshaller for UpdateGuardrail operation
    /// </summary>  
    public class UpdateGuardrailResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateGuardrailResponse response = new UpdateGuardrailResponse();
        ...
        private static UpdateGuardrailResponseUnmarshaller _instance = new UpdateGuardrailResponseUnmarshaller();        

        internal static UpdateGuardrailResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateGuardrailResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
