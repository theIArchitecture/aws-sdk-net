...
{
    /// <summary>
    /// This is the response object from the ListEvaluationJobs operation.
    /// </summary>
    public partial class ListEvaluationJobsResponse : AmazonWebServiceResponse
    {
        private List<EvaluationSummary> _jobSummaries = AWSConfigs.InitializeCollections ? new List<EvaluationSummary>() : null;
        ...
        public List<EvaluationSummary> JobSummaries
        {
