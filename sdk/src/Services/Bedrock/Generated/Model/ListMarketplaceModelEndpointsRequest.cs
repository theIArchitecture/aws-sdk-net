...
{
    /// <summary>
    /// Container for the parameters to the ListMarketplaceModelEndpoints operation.
    ...
    public partial class ListMarketplaceModelEndpointsRequest : AmazonBedrockRequest
    {
        ...
        private string _modelSourceEquals;
        ...
        public string ModelSourceEquals
        {
            get { return this._modelSourceEquals; }
            set { this._modelSourceEquals = value; }
        }

        // Check to see if ModelSourceEquals property is set
        internal bool IsSetModelSourceEquals()
        {
            return this._modelSourceEquals != null;
        }
