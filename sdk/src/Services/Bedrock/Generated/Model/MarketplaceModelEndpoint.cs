...
namespace Amazon.Bedrock.Model
{
    ...
    public partial class MarketplaceModelEndpoint
    {
        ...
        private string _endpointStatusMessage;
        ...
        /// </para>
        /// </summary>
        public string EndpointStatusMessage
        {
            get { return this._endpointStatusMessage; }
            set { this._endpointStatusMessage = value; }
        }

        // Check to see if EndpointStatusMessage property is set
        internal bool IsSetEndpointStatusMessage()
        {
            return this._endpointStatusMessage != null;
        }
