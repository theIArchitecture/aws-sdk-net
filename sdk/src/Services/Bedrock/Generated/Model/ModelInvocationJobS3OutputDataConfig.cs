...
namespace Amazon.Bedrock.Model
{
    ...
    public partial class ModelInvocationJobS3OutputDataConfig
    {
        ...
        {
            get { return this._s3EncryptionKeyId; }
            set { this._s3EncryptionKeyId = value; }
        }

        // Check to see if S3EncryptionKeyId property is set
        internal bool IsSetS3EncryptionKeyId()
        {
            return this._s3EncryptionKeyId != null;
        }
