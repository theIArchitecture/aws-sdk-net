...
{
    /// <summary>
    /// Configuration for accessing Amazon BedrockAgent service
    /// </summary>
    public partial class AmazonBedrockAgentConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Bedrock Agent", "4.0.5.6");
        ...
        /// Default constructor
        /// </summary>
        public AmazonBedrockAgentConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonBedrockAgentDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "Bedrock Agent";
            this.AuthenticationServiceName = "bedrock";
            this.EndpointProvider = new AmazonBedrockAgentEndpointProvider();
        }
