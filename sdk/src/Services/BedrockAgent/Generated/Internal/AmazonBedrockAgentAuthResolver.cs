...
namespace Amazon.BedrockAgent.Internal
{
    ...
    public class AmazonBedrockAgentAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonBedrockAgentAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for BedrockAgent.
        /// </summary>
        public AmazonBedrockAgentAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonBedrockAgentAuthSchemeParameters
            {
    ...
    public class AmazonBedrockAgentAuthSchemeResolver : IAuthSchemeResolver<AmazonBedrockAgentAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonBedrockAgentAuthSchemeParameters authParameters)
        {
