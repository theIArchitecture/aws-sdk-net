...
namespace Amazon.BedrockAgent.Model
{
    ...
    /// </summary>
    public partial class ConfluenceDataSourceConfiguration
    {
        private ConfluenceCrawlerConfiguration _crawlerConfiguration;
        private ConfluenceSourceConfiguration _sourceConfiguration;

        /// <summary>
        /// Gets and sets the property CrawlerConfiguration. 
        /// <para>
        /// The configuration of the Confluence content. For example, configuring specific types
        /// of Confluence content.
        /// </para>
        /// </summary>
        public ConfluenceCrawlerConfiguration CrawlerConfiguration
        {
        ...
        public ConfluenceSourceConfiguration SourceConfiguration
        {
