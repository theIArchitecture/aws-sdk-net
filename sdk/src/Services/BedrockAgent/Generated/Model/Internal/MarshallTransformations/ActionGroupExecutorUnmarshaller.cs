...
namespace Amazon.BedrockAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ActionGroupExecutorUnmarshaller : IJsonUnmarshaller<ActionGroupExecutor, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ActionGroupExecutor Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("customControl", targetDepth))
                {
                    ...
                    unmarshalledObject.CustomControl = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
