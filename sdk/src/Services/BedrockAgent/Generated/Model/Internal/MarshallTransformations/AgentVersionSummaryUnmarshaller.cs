...
{
    /// <summary>
    /// Response Unmarshaller for AgentVersionSummary Object
    /// </summary>  
    public class AgentVersionSummaryUnmarshaller : IJsonUnmarshaller<AgentVersionSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AgentVersionSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            AgentVersionSummary unmarshalledObject = new AgentVersionSummary();
        ...
        private static AgentVersionSummaryUnmarshaller _instance = new AgentVersionSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AgentVersionSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
