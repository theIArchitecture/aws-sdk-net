...
{
    /// <summary>
    /// AssociateAgentCollaborator Request Marshaller
    /// </summary>       
    public class AssociateAgentCollaboratorRequestMarshaller : IMarshaller<IRequest, AssociateAgentCollaboratorRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AssociateAgentCollaboratorRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AssociateAgentCollaboratorRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetCollaborationInstruction())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.CollaborationInstruction);
            }

            if(publicRequest.IsSetCollaboratorName())
            {
                context.Writer.WritePropertyName("collaboratorName");
                context.Writer.WriteStringValue(publicRequest.CollaboratorName);
            }

            if(publicRequest.IsSetRelayConversationHistory())
            {
                context.Writer.WritePropertyName("relayConversationHistory");
                context.Writer.WriteStringValue(publicRequest.RelayConversationHistory);
            }
        ...
        private static AssociateAgentCollaboratorRequestMarshaller _instance = new AssociateAgentCollaboratorRequestMarshaller();        

        internal static AssociateAgentCollaboratorRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateAgentCollaboratorRequestMarshaller Instance
        {
            get
            {
                return _instance;
