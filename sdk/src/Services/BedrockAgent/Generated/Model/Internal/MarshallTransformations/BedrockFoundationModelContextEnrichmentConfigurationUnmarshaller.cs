...
namespace Amazon.BedrockAgent.Model.Internal.MarshallTransformations
{
    ...
    public class BedrockFoundationModelContextEnrichmentConfigurationUnmarshaller : IJsonUnmarshaller<BedrockFoundationModelContextEnrichmentConfiguration, JsonUnmarshallerContext>
    {
        ...
        private static BedrockFoundationModelContextEnrichmentConfigurationUnmarshaller _instance = new BedrockFoundationModelContextEnrichmentConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BedrockFoundationModelContextEnrichmentConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
