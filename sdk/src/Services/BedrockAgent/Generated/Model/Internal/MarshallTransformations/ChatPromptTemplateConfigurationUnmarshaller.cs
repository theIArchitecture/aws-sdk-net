...
{
    /// <summary>
    /// Response Unmarshaller for ChatPromptTemplateConfiguration Object
    /// </summary>  
    public class ChatPromptTemplateConfigurationUnmarshaller : IJsonUnmarshaller<ChatPromptTemplateConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ChatPromptTemplateConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ChatPromptTemplateConfiguration unmarshalledObject = new ChatPromptTemplateConfiguration();
        ...
        private static ChatPromptTemplateConfigurationUnmarshaller _instance = new ChatPromptTemplateConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ChatPromptTemplateConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
