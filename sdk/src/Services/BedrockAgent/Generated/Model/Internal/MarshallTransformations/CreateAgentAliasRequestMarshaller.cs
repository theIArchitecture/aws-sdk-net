...
{
    /// <summary>
    /// CreateAgentAlias Request Marshaller
    /// </summary>       
    public class CreateAgentAliasRequestMarshaller : IMarshaller<IRequest, CreateAgentAliasRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateAgentAliasRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateAgentAliasRequest publicRequest)
        {
            ...
            request.ResourcePath = "/agents/{agentId}/agentaliases/";
#if !NETFRAMEWORK
        ...
        private static CreateAgentAliasRequestMarshaller _instance = new CreateAgentAliasRequestMarshaller();        

        internal static CreateAgentAliasRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAgentAliasRequestMarshaller Instance
        {
            get
            {
                return _instance;
