...
namespace Amazon.BedrockAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteAgentActionGroupRequestMarshaller : IMarshaller<IRequest, DeleteAgentActionGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteAgentActionGroupRequestMarshaller _instance = new DeleteAgentActionGroupRequestMarshaller();        

        internal static DeleteAgentActionGroupRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAgentActionGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
