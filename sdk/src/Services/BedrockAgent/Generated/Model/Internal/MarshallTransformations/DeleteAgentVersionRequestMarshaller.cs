...
{
    /// <summary>
    /// DeleteAgentVersion Request Marshaller
    /// </summary>       
    public class DeleteAgentVersionRequestMarshaller : IMarshaller<IRequest, DeleteAgentVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteAgentVersionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteAgentVersionRequest publicRequest)
        {
            ...
            request.ResourcePath = "/agents/{agentId}/agentversions/{agentVersion}/";
            request.UseQueryString = true;

            return request;
        }
        private static DeleteAgentVersionRequestMarshaller _instance = new DeleteAgentVersionRequestMarshaller();        

        internal static DeleteAgentVersionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAgentVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
