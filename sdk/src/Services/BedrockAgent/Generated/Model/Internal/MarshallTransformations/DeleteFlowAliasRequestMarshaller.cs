...
{
    /// <summary>
    /// DeleteFlowAlias Request Marshaller
    /// </summary>       
    public class DeleteFlowAliasRequestMarshaller : IMarshaller<IRequest, DeleteFlowAliasRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteFlowAliasRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteFlowAliasRequest publicRequest)
        {
        ...
        private static DeleteFlowAliasRequestMarshaller _instance = new DeleteFlowAliasRequestMarshaller();        

        internal static DeleteFlowAliasRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteFlowAliasRequestMarshaller Instance
        {
            get
            {
                return _instance;
