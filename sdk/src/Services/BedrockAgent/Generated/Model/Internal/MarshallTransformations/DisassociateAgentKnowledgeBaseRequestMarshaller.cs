...
{
    /// <summary>
    /// DisassociateAgentKnowledgeBase Request Marshaller
    /// </summary>       
    public class DisassociateAgentKnowledgeBaseRequestMarshaller : IMarshaller<IRequest, DisassociateAgentKnowledgeBaseRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DisassociateAgentKnowledgeBaseRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DisassociateAgentKnowledgeBaseRequest publicRequest)
        {
        ...
        private static DisassociateAgentKnowledgeBaseRequestMarshaller _instance = new DisassociateAgentKnowledgeBaseRequestMarshaller();        

        internal static DisassociateAgentKnowledgeBaseRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateAgentKnowledgeBaseRequestMarshaller Instance
        {
            get
            {
                return _instance;
