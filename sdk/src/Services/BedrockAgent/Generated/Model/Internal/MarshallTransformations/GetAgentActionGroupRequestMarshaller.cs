...
{
    /// <summary>
    /// GetAgentActionGroup Request Marshaller
    /// </summary>       
    public class GetAgentActionGroupRequestMarshaller : IMarshaller<IRequest, GetAgentActionGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetAgentActionGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetAgentActionGroupRequest publicRequest)
        {
        ...
        private static GetAgentActionGroupRequestMarshaller _instance = new GetAgentActionGroupRequestMarshaller();        

        internal static GetAgentActionGroupRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAgentActionGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
