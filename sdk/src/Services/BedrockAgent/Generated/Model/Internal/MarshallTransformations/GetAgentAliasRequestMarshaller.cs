...
{
    /// <summary>
    /// GetAgentAlias Request Marshaller
    /// </summary>       
    public class GetAgentAliasRequestMarshaller : IMarshaller<IRequest, GetAgentAliasRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetAgentAliasRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetAgentAliasRequest publicRequest)
        {
        ...
        private static GetAgentAliasRequestMarshaller _instance = new GetAgentAliasRequestMarshaller();        

        internal static GetAgentAliasRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAgentAliasRequestMarshaller Instance
        {
            get
            {
                return _instance;
