...
{
    /// <summary>
    /// GetAgentVersion Request Marshaller
    /// </summary>       
    public class GetAgentVersionRequestMarshaller : IMarshaller<IRequest, GetAgentVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetAgentVersionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetAgentVersionRequest publicRequest)
        {
        ...
        private static GetAgentVersionRequestMarshaller _instance = new GetAgentVersionRequestMarshaller();        

        internal static GetAgentVersionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAgentVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
