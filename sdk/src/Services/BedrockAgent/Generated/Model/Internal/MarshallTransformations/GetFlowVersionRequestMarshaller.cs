...
{
    /// <summary>
    /// GetFlowVersion Request Marshaller
    /// </summary>       
    public class GetFlowVersionRequestMarshaller : IMarshaller<IRequest, GetFlowVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetFlowVersionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetFlowVersionRequest publicRequest)
        {
        ...
        private static GetFlowVersionRequestMarshaller _instance = new GetFlowVersionRequestMarshaller();        

        internal static GetFlowVersionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFlowVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
