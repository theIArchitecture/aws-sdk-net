...
namespace Amazon.BedrockAgent.Model.Internal.MarshallTransformations
{
    ...
    public class IteratorFlowNodeConfigurationUnmarshaller : IJsonUnmarshaller<IteratorFlowNodeConfiguration, JsonUnmarshallerContext>
    {
        ...
        private static IteratorFlowNodeConfigurationUnmarshaller _instance = new IteratorFlowNodeConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static IteratorFlowNodeConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
