...
{
    /// <summary>
    /// ListAgentActionGroups Request Marshaller
    /// </summary>       
    public class ListAgentActionGroupsRequestMarshaller : IMarshaller<IRequest, ListAgentActionGroupsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListAgentActionGroupsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListAgentActionGroupsRequest publicRequest)
        {
        ...
        private static ListAgentActionGroupsRequestMarshaller _instance = new ListAgentActionGroupsRequestMarshaller();        

        internal static ListAgentActionGroupsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAgentActionGroupsRequestMarshaller Instance
        {
            get
            {
                return _instance;
