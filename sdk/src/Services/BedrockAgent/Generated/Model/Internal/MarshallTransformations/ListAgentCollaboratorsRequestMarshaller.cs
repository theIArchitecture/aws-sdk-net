...
{
    /// <summary>
    /// ListAgentCollaborators Request Marshaller
    /// </summary>       
    public class ListAgentCollaboratorsRequestMarshaller : IMarshaller<IRequest, ListAgentCollaboratorsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListAgentCollaboratorsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListAgentCollaboratorsRequest publicRequest)
        {
        ...
        private static ListAgentCollaboratorsRequestMarshaller _instance = new ListAgentCollaboratorsRequestMarshaller();        

        internal static ListAgentCollaboratorsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAgentCollaboratorsRequestMarshaller Instance
        {
            get
            {
                return _instance;
