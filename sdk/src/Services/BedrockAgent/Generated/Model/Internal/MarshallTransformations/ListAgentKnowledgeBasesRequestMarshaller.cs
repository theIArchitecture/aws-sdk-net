...
{
    /// <summary>
    /// ListAgentKnowledgeBases Request Marshaller
    /// </summary>       
    public class ListAgentKnowledgeBasesRequestMarshaller : IMarshaller<IRequest, ListAgentKnowledgeBasesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListAgentKnowledgeBasesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListAgentKnowledgeBasesRequest publicRequest)
        {
        ...
        private static ListAgentKnowledgeBasesRequestMarshaller _instance = new ListAgentKnowledgeBasesRequestMarshaller();        

        internal static ListAgentKnowledgeBasesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAgentKnowledgeBasesRequestMarshaller Instance
        {
            get
            {
                return _instance;
