...
{
    /// <summary>
    /// PrepareAgent Request Marshaller
    /// </summary>       
    public class PrepareAgentRequestMarshaller : IMarshaller<IRequest, PrepareAgentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PrepareAgentRequest)input);
        }
        ...
        private static PrepareAgentRequestMarshaller _instance = new PrepareAgentRequestMarshaller();        

        internal static PrepareAgentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PrepareAgentRequestMarshaller Instance
        {
            get
            {
                return _instance;
