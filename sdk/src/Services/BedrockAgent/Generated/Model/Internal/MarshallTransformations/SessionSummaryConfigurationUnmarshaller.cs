...
namespace Amazon.BedrockAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SessionSummaryConfigurationUnmarshaller : IJsonUnmarshaller<SessionSummaryConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SessionSummaryConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("maxRecentSessions", targetDepth))
                {
                    ...
                    unmarshalledObject.MaxRecentSessions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
