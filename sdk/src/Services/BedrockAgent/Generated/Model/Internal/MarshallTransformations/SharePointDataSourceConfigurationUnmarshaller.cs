...
namespace Amazon.BedrockAgent.Model.Internal.MarshallTransformations
{
    ...
    public class SharePointDataSourceConfigurationUnmarshaller : IJsonUnmarshaller<SharePointDataSourceConfiguration, JsonUnmarshallerContext>
    {
        ...
        private static SharePointDataSourceConfigurationUnmarshaller _instance = new SharePointDataSourceConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SharePointDataSourceConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
