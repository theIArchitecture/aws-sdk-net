...
namespace Amazon.BedrockAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UnknownNodeInputFlowValidationDetailsUnmarshaller : IJsonUnmarshaller<UnknownNodeInputFlowValidationDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            UnknownNodeInputFlowValidationDetails unmarshalledObject = new UnknownNodeInputFlowValidationDetails();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UnknownNodeInputFlowValidationDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
