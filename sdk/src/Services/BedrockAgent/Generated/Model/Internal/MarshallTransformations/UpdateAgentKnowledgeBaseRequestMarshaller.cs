...
{
    /// <summary>
    /// UpdateAgentKnowledgeBase Request Marshaller
    /// </summary>       
    public class UpdateAgentKnowledgeBaseRequestMarshaller : IMarshaller<IRequest, UpdateAgentKnowledgeBaseRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateAgentKnowledgeBaseRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateAgentKnowledgeBaseRequest publicRequest)
        {
        ...
        private static UpdateAgentKnowledgeBaseRequestMarshaller _instance = new UpdateAgentKnowledgeBaseRequestMarshaller();        

        internal static UpdateAgentKnowledgeBaseRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAgentKnowledgeBaseRequestMarshaller Instance
        {
            get
            {
                return _instance;
