...
namespace Amazon.BedrockAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VectorIngestionConfigurationUnmarshaller : IJsonUnmarshaller<VectorIngestionConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public VectorIngestionConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("customTransformationConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.CustomTransformationConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
