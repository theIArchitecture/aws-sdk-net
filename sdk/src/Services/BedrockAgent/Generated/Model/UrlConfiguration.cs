...
namespace Amazon.BedrockAgent.Model
{
    ...
    /// crawl the URLs.
    /// </summary>
    public partial class UrlConfiguration
    {
        private List<SeedUrl> _seedUrls = AWSConfigs.InitializeCollections ? new List<SeedUrl>() : null;
