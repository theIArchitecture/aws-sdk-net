...
namespace Amazon.BedrockAgentCore.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CodeInterpreterResultUnmarshaller : IJsonUnmarshaller<CodeInterpreterResult, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            CodeInterpreterResult unmarshalledObject = new CodeInterpreterResult();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CodeInterpreterResultUnmarshaller Instance
        {
            get
            {
                return _instance;
