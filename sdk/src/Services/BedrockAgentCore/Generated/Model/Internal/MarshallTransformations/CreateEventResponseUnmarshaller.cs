...
{
    /// <summary>
    /// Response Unmarshaller for CreateEvent operation
    /// </summary>  
    public class CreateEventResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateEventResponseUnmarshaller _instance = new CreateEventResponseUnmarshaller();        

        internal static CreateEventResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateEventResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
