...
{
    /// <summary>
    /// Response Unmarshaller for DeleteMemoryRecord operation
    /// </summary>  
    public class DeleteMemoryRecordResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteMemoryRecordResponse response = new DeleteMemoryRecordResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("memoryRecordId", targetDepth))
                {
                    ...
                    response.MemoryRecordId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DeleteMemoryRecordResponseUnmarshaller _instance = new DeleteMemoryRecordResponseUnmarshaller();        

        internal static DeleteMemoryRecordResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteMemoryRecordResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
