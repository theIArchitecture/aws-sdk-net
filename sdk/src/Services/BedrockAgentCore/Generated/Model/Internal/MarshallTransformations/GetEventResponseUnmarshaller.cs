...
{
    /// <summary>
    /// Response Unmarshaller for GetEvent operation
    /// </summary>  
    public class GetEventResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetEventResponseUnmarshaller _instance = new GetEventResponseUnmarshaller();        

        internal static GetEventResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEventResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
