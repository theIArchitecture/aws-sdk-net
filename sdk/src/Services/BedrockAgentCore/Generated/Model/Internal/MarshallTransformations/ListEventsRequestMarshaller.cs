...
namespace Amazon.BedrockAgentCore.Model.Internal.MarshallTransformations
{
    ...
    public class ListEventsRequestMarshaller : IMarshaller<IRequest, ListEventsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListEventsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/memories/{memoryId}/actor/{actorId}/sessions/{sessionId}";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetFilter())
            {
                ...
                var marshaller = FilterInputMarshaller.Instance;
                marshaller.Marshall(publicRequest.Filter, context);

                context.Writer.WriteEndObject();
            }

            if(publicRequest.IsSetIncludePayloads())
            {
                context.Writer.WritePropertyName("includePayloads");
                context.Writer.WriteBooleanValue(publicRequest.IncludePayloads.Value);
            }
