...
{
    /// <summary>
    /// Response Unmarshaller for MemoryRecordSummary Object
    /// </summary>  
    public class MemoryRecordSummaryUnmarshaller : IJsonUnmarshaller<MemoryRecordSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MemoryRecordSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            MemoryRecordSummary unmarshalledObject = new MemoryRecordSummary();
        ...
        private static MemoryRecordSummaryUnmarshaller _instance = new MemoryRecordSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static MemoryRecordSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
