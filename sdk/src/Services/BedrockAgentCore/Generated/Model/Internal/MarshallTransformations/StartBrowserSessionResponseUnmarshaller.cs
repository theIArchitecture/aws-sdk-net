...
{
    /// <summary>
    /// Response Unmarshaller for StartBrowserSession operation
    /// </summary>  
    public class StartBrowserSessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartBrowserSessionResponse response = new StartBrowserSessionResponse();
        ...
        private static StartBrowserSessionResponseUnmarshaller _instance = new StartBrowserSessionResponseUnmarshaller();        

        internal static StartBrowserSessionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartBrowserSessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
