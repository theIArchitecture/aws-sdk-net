...
{
    /// <summary>
    /// Response Unmarshaller for StopBrowserSession operation
    /// </summary>  
    public class StopBrowserSessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopBrowserSessionResponse response = new StopBrowserSessionResponse();
        ...
        private static StopBrowserSessionResponseUnmarshaller _instance = new StopBrowserSessionResponseUnmarshaller();        

        internal static StopBrowserSessionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopBrowserSessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
