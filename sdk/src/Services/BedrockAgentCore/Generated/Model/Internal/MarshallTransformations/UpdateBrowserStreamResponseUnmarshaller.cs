...
{
    /// <summary>
    /// Response Unmarshaller for UpdateBrowserStream operation
    /// </summary>  
    public class UpdateBrowserStreamResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateBrowserStreamResponse response = new UpdateBrowserStreamResponse();
        ...
        private static UpdateBrowserStreamResponseUnmarshaller _instance = new UpdateBrowserStreamResponseUnmarshaller();        

        internal static UpdateBrowserStreamResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBrowserStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
