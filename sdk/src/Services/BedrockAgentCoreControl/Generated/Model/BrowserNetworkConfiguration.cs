...
{
    /// <summary>
    /// The network configuration for a browser. This structure defines how the browser connects
    /// to the network.
    /// </summary>
    public partial class BrowserNetworkConfiguration
    {
        ...
        /// <para>
        /// The network mode for the browser. This field specifies how the browser connects to
        /// the network.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
        public BrowserNetworkMode NetworkMode
        {
