...
{
    /// <summary>
    /// Container for the parameters to the CreateBrowser operation.
    ...
    public partial class CreateBrowserRequest : AmazonBedrockAgentCoreControlRequest
    {
        ...
        /// <para>
        /// The Amazon Resource Name (ARN) of the IAM role that provides permissions for the browser
        ...
        /// <para>
        /// The network configuration for the browser. This configuration specifies the network
        /// mode for the browser.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
        ...
        /// <para>
        /// The recording configuration for the browser. When enabled, browser sessions are recorded
        /// and stored in the specified Amazon S3 location.
        /// </para>
        /// </summary>
