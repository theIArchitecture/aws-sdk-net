...
namespace Amazon.BedrockAgentCoreControl.Model.Internal.MarshallTransformations
{
    ...
    public class ContainerConfigurationUnmarshaller : IJsonUnmarshaller<ContainerConfiguration, JsonUnmarshallerContext>
    {
        ...
        public ContainerConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("containerUri", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ContainerUri = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ContainerConfigurationUnmarshaller _instance = new ContainerConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ContainerConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
