...
{
    /// <summary>
    /// Response Unmarshaller for CreateAgentRuntimeEndpoint operation
    /// </summary>  
    public class CreateAgentRuntimeEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAgentRuntimeEndpointResponse response = new CreateAgentRuntimeEndpointResponse();
        ...
        private static CreateAgentRuntimeEndpointResponseUnmarshaller _instance = new CreateAgentRuntimeEndpointResponseUnmarshaller();        

        internal static CreateAgentRuntimeEndpointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAgentRuntimeEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
