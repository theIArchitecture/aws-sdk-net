...
{
    /// <summary>
    /// CreateAgentRuntime Request Marshaller
    /// </summary>       
    public class CreateAgentRuntimeRequestMarshaller : IMarshaller<IRequest, CreateAgentRuntimeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateAgentRuntimeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateAgentRuntimeRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetAgentRuntimeName())
            {
                context.Writer.WritePropertyName("agentRuntimeName");
                context.Writer.WriteStringValue(publicRequest.AgentRuntimeName);
            }
        ...
        private static CreateAgentRuntimeRequestMarshaller _instance = new CreateAgentRuntimeRequestMarshaller();        

        internal static CreateAgentRuntimeRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAgentRuntimeRequestMarshaller Instance
        {
            get
            {
                return _instance;
