...
{
    /// <summary>
    /// Response Unmarshaller for CreateAgentRuntime operation
    /// </summary>  
    public class CreateAgentRuntimeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAgentRuntimeResponse response = new CreateAgentRuntimeResponse();
        ...
        private static CreateAgentRuntimeResponseUnmarshaller _instance = new CreateAgentRuntimeResponseUnmarshaller();        

        internal static CreateAgentRuntimeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAgentRuntimeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
