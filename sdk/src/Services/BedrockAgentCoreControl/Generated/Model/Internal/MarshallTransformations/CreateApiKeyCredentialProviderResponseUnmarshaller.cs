...
{
    /// <summary>
    /// Response Unmarshaller for CreateApiKeyCredentialProvider operation
    /// </summary>  
    public class CreateApiKeyCredentialProviderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateApiKeyCredentialProviderResponse response = new CreateApiKeyCredentialProviderResponse();
        ...
        private static CreateApiKeyCredentialProviderResponseUnmarshaller _instance = new CreateApiKeyCredentialProviderResponseUnmarshaller();        

        internal static CreateApiKeyCredentialProviderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateApiKeyCredentialProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
