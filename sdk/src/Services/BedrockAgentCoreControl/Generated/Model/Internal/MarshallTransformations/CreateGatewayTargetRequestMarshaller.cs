...
{
    /// <summary>
    /// CreateGatewayTarget Request Marshaller
    /// </summary>       
    public class CreateGatewayTargetRequestMarshaller : IMarshaller<IRequest, CreateGatewayTargetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateGatewayTargetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateGatewayTargetRequest publicRequest)
        {
        ...
        private static CreateGatewayTargetRequestMarshaller _instance = new CreateGatewayTargetRequestMarshaller();        

        internal static CreateGatewayTargetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateGatewayTargetRequestMarshaller Instance
        {
            get
            {
                return _instance;
