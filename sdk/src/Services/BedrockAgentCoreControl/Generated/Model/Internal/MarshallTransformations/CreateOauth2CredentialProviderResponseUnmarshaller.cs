...
{
    /// <summary>
    /// Response Unmarshaller for CreateOauth2CredentialProvider operation
    /// </summary>  
    public class CreateOauth2CredentialProviderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateOauth2CredentialProviderResponse response = new CreateOauth2CredentialProviderResponse();
        ...
        private static CreateOauth2CredentialProviderResponseUnmarshaller _instance = new CreateOauth2CredentialProviderResponseUnmarshaller();        

        internal static CreateOauth2CredentialProviderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateOauth2CredentialProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
