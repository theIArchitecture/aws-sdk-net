...
{
    /// <summary>
    /// DeleteAgentRuntimeEndpoint Request Marshaller
    /// </summary>       
    public class DeleteAgentRuntimeEndpointRequestMarshaller : IMarshaller<IRequest, DeleteAgentRuntimeEndpointRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteAgentRuntimeEndpointRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteAgentRuntimeEndpointRequest publicRequest)
        {
        ...
        private static DeleteAgentRuntimeEndpointRequestMarshaller _instance = new DeleteAgentRuntimeEndpointRequestMarshaller();        

        internal static DeleteAgentRuntimeEndpointRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAgentRuntimeEndpointRequestMarshaller Instance
        {
            get
            {
                return _instance;
