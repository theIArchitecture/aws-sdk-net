...
{
    /// <summary>
    /// Response Unmarshaller for DeleteGatewayTarget operation
    /// </summary>  
    public class DeleteGatewayTargetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteGatewayTargetResponse response = new DeleteGatewayTargetResponse();
        ...
        private static DeleteGatewayTargetResponseUnmarshaller _instance = new DeleteGatewayTargetResponseUnmarshaller();        

        internal static DeleteGatewayTargetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteGatewayTargetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
