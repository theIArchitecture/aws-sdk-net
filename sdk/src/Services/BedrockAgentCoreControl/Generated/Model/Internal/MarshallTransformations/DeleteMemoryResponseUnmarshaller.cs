...
{
    /// <summary>
    /// Response Unmarshaller for DeleteMemory operation
    /// </summary>  
    public class DeleteMemoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteMemoryResponse response = new DeleteMemoryResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("memoryId", targetDepth))
                {
                    ...
                    response.MemoryId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DeleteMemoryResponseUnmarshaller _instance = new DeleteMemoryResponseUnmarshaller();        

        internal static DeleteMemoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteMemoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
