...
{
    /// <summary>
    /// Response Unmarshaller for GetApiKeyCredentialProvider operation
    /// </summary>  
    public class GetApiKeyCredentialProviderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetApiKeyCredentialProviderResponse response = new GetApiKeyCredentialProviderResponse();
        ...
        private static GetApiKeyCredentialProviderResponseUnmarshaller _instance = new GetApiKeyCredentialProviderResponseUnmarshaller();        

        internal static GetApiKeyCredentialProviderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetApiKeyCredentialProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
