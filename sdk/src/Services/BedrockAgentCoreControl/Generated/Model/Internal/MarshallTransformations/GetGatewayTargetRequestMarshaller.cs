...
{
    /// <summary>
    /// GetGatewayTarget Request Marshaller
    /// </summary>       
    public class GetGatewayTargetRequestMarshaller : IMarshaller<IRequest, GetGatewayTargetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetGatewayTargetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetGatewayTargetRequest publicRequest)
        {
        ...
        private static GetGatewayTargetRequestMarshaller _instance = new GetGatewayTargetRequestMarshaller();        

        internal static GetGatewayTargetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGatewayTargetRequestMarshaller Instance
        {
            get
            {
                return _instance;
