...
{
    /// <summary>
    /// Response Unmarshaller for GetGatewayTarget operation
    /// </summary>  
    public class GetGatewayTargetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetGatewayTargetResponse response = new GetGatewayTargetResponse();
        ...
        private static GetGatewayTargetResponseUnmarshaller _instance = new GetGatewayTargetResponseUnmarshaller();        

        internal static GetGatewayTargetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGatewayTargetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
