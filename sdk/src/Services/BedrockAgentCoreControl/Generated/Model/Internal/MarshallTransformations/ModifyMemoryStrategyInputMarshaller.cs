...
{
    /// <summary>
    /// ModifyMemoryStrategyInput Marshaller
    /// </summary>
    public class ModifyMemoryStrategyInputMarshaller : IRequestMarshaller<ModifyMemoryStrategyInput, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(ModifyMemoryStrategyInput requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetConfiguration())
            {
                ...
                var marshaller = ModifyStrategyConfigurationMarshaller.Instance;
        ...
        /// </summary>
        public readonly static ModifyMemoryStrategyInputMarshaller Instance = new ModifyMemoryStrategyInputMarshaller();
