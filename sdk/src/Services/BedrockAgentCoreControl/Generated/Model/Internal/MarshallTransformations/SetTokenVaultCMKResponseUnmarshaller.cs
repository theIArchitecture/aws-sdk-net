...
{
    /// <summary>
    /// Response Unmarshaller for SetTokenVaultCMK operation
    /// </summary>  
    public class SetTokenVaultCMKResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SetTokenVaultCMKResponse response = new SetTokenVaultCMKResponse();
        ...
        private static SetTokenVaultCMKResponseUnmarshaller _instance = new SetTokenVaultCMKResponseUnmarshaller();        

        internal static SetTokenVaultCMKResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetTokenVaultCMKResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
