...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAgentRuntimeEndpoint operation
    /// </summary>  
    public class UpdateAgentRuntimeEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAgentRuntimeEndpointResponse response = new UpdateAgentRuntimeEndpointResponse();
        ...
        private static UpdateAgentRuntimeEndpointResponseUnmarshaller _instance = new UpdateAgentRuntimeEndpointResponseUnmarshaller();        

        internal static UpdateAgentRuntimeEndpointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAgentRuntimeEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
