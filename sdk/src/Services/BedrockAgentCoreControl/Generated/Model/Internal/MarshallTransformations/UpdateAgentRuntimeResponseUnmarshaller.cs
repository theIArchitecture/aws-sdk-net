...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAgentRuntime operation
    /// </summary>  
    public class UpdateAgentRuntimeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAgentRuntimeResponse response = new UpdateAgentRuntimeResponse();
        ...
        private static UpdateAgentRuntimeResponseUnmarshaller _instance = new UpdateAgentRuntimeResponseUnmarshaller();        

        internal static UpdateAgentRuntimeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAgentRuntimeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
