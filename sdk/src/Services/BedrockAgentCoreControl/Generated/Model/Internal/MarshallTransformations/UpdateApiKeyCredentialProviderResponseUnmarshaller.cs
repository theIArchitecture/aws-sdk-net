...
{
    /// <summary>
    /// Response Unmarshaller for UpdateApiKeyCredentialProvider operation
    /// </summary>  
    public class UpdateApiKeyCredentialProviderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateApiKeyCredentialProviderResponse response = new UpdateApiKeyCredentialProviderResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("apiKeySecretArn", targetDepth))
                {
                    ...
                    response.ApiKeySecretArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateApiKeyCredentialProviderResponseUnmarshaller _instance = new UpdateApiKeyCredentialProviderResponseUnmarshaller();        

        internal static UpdateApiKeyCredentialProviderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateApiKeyCredentialProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
