...
{
    /// <summary>
    /// Response Unmarshaller for UpdateGatewayTarget operation
    /// </summary>  
    public class UpdateGatewayTargetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateGatewayTargetResponse response = new UpdateGatewayTargetResponse();
        ...
        private static UpdateGatewayTargetResponseUnmarshaller _instance = new UpdateGatewayTargetResponseUnmarshaller();        

        internal static UpdateGatewayTargetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateGatewayTargetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
