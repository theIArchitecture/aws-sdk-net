...
namespace Amazon.BedrockAgentCoreControl.Model
{
    ...
    internal sealed partial class ListGatewaysPaginator : IPaginator<ListGatewaysResponse>, IListGatewaysPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<GatewaySummary> Items => 
            new PaginatedResultKeyResponse<ListGatewaysResponse, GatewaySummary>(this, (i) => i.Items ?? new List<GatewaySummary>());

        internal ListGatewaysPaginator(IAmazonBedrockAgentCoreControl client, ListGatewaysRequest request)
        {
            this._client = client;
