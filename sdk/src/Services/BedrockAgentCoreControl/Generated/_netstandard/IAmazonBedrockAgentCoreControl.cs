...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonBedrockAgentCoreControlConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonBedrockAgentCoreControlConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonBedrockAgentCoreControlConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonBedrockAgentCoreControlConfig to create AmazonBedrockAgentCoreControlClient");
            }

            return awsCredentials == null ? 
                    new AmazonBedrockAgentCoreControlClient(serviceClientConfig) :
                    new AmazonBedrockAgentCoreControlClient(awsCredentials, serviceClientConfig);
        }
