...
namespace Amazon.BedrockAgentRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ApiInvocationInputUnmarshaller : IJsonUnmarshaller<ApiInvocationInput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ApiInvocationInput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ApiParameter, ApiParameterUnmarshaller>(ApiParameterUnmarshaller.Instance);
