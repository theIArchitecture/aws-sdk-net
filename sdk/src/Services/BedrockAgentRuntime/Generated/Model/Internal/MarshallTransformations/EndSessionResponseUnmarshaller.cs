...
{
    /// <summary>
    /// Response Unmarshaller for EndSession operation
    /// </summary>  
    public class EndSessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static EndSessionResponseUnmarshaller _instance = new EndSessionResponseUnmarshaller();        

        internal static EndSessionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EndSessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
