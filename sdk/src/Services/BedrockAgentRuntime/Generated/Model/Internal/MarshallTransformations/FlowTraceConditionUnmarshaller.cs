...
namespace Amazon.BedrockAgentRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FlowTraceConditionUnmarshaller : IJsonUnmarshaller<FlowTraceCondition, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            FlowTraceCondition unmarshalledObject = new FlowTraceCondition();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static FlowTraceConditionUnmarshaller Instance
        {
            get
            {
                return _instance;
