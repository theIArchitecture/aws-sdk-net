...
namespace Amazon.BedrockAgentRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FlowTraceNodeOutputEventUnmarshaller : IJsonUnmarshaller<FlowTraceNodeOutputEvent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FlowTraceNodeOutputEvent Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<FlowTraceNodeOutputField, FlowTraceNodeOutputFieldUnmarshaller>(FlowTraceNodeOutputFieldUnmarshaller.Instance);
