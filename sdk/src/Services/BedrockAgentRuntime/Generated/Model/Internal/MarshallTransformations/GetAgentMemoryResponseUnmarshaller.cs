...
{
    /// <summary>
    /// Response Unmarshaller for GetAgentMemory operation
    /// </summary>  
    public class GetAgentMemoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAgentMemoryResponse response = new GetAgentMemoryResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("memoryContents", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<Memory, MemoryUnmarshaller>(MemoryUnmarshaller.Instance);
                    response.MemoryContents = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetAgentMemoryResponseUnmarshaller _instance = new GetAgentMemoryResponseUnmarshaller();        

        internal static GetAgentMemoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAgentMemoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
