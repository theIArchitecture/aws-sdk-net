...
{
    /// <summary>
    /// GetFlowExecution Request Marshaller
    /// </summary>       
    public class GetFlowExecutionRequestMarshaller : IMarshaller<IRequest, GetFlowExecutionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetFlowExecutionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetFlowExecutionRequest publicRequest)
        {
            ...
            request.ResourcePath = "/flows/{flowIdentifier}/aliases/{flowAliasIdentifier}/executions/{executionIdentifier}";

            return request;
        }
        private static GetFlowExecutionRequestMarshaller _instance = new GetFlowExecutionRequestMarshaller();        

        internal static GetFlowExecutionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFlowExecutionRequestMarshaller Instance
        {
            get
            {
                return _instance;
