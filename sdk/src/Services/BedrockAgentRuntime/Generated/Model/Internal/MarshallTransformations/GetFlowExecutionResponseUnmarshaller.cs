...
namespace Amazon.BedrockAgentRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetFlowExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetFlowExecutionResponse response = new GetFlowExecutionResponse();
        ...
        internal static GetFlowExecutionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFlowExecutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
