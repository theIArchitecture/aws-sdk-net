...
{
    /// <summary>
    /// InvokeFlow Request Marshaller
    /// </summary>       
    public class InvokeFlowRequestMarshaller : IMarshaller<IRequest, InvokeFlowRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((InvokeFlowRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(InvokeFlowRequest publicRequest)
        {
        ...
        private static InvokeFlowRequestMarshaller _instance = new InvokeFlowRequestMarshaller();        

        internal static InvokeFlowRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InvokeFlowRequestMarshaller Instance
        {
            get
            {
                return _instance;
