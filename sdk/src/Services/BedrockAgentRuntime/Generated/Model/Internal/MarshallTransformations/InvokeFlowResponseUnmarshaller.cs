...
{
    /// <summary>
    /// Response Unmarshaller for InvokeFlow operation
    /// </summary>  
    public class InvokeFlowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static InvokeFlowResponseUnmarshaller _instance = new InvokeFlowResponseUnmarshaller();        

        internal static InvokeFlowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InvokeFlowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
