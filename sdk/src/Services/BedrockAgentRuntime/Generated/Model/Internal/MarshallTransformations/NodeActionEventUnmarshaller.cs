...
{
    /// <summary>
    /// Response Unmarshaller for NodeActionEvent Object
    /// </summary>  
    public class NodeActionEventUnmarshaller : IJsonUnmarshaller<NodeActionEvent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NodeActionEvent Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            NodeActionEvent unmarshalledObject = new NodeActionEvent();
        ...
        private static NodeActionEventUnmarshaller _instance = new NodeActionEventUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static NodeActionEventUnmarshaller Instance
        {
            get
            {
                return _instance;
