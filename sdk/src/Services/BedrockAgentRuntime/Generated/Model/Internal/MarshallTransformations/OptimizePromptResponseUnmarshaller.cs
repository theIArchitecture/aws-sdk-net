...
{
    /// <summary>
    /// Response Unmarshaller for OptimizePrompt operation
    /// </summary>  
    public class OptimizePromptResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            response.OptimizedPrompt = new OptimizedPromptStream(context.Stream);
        ...
        private static OptimizePromptResponseUnmarshaller _instance = new OptimizePromptResponseUnmarshaller();        

        internal static OptimizePromptResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static OptimizePromptResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
