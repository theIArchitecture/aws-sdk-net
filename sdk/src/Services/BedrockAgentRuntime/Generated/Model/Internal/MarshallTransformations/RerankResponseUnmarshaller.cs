...
{
    /// <summary>
    /// Response Unmarshaller for Rerank operation
    /// </summary>  
    public class RerankResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<RerankResult, RerankResultUnmarshaller>(RerankResultUnmarshaller.Instance);
        ...
        private static RerankResponseUnmarshaller _instance = new RerankResponseUnmarshaller();        

        internal static RerankResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RerankResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
