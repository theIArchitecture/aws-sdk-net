...
{
    /// <summary>
    /// Response Unmarshaller for RetrieveAndGenerate operation
    /// </summary>  
    public class RetrieveAndGenerateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RetrieveAndGenerateResponse response = new RetrieveAndGenerateResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("citations", targetDepth))
                {
                    ...
                    response.Citations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static RetrieveAndGenerateResponseUnmarshaller _instance = new RetrieveAndGenerateResponseUnmarshaller();        

        internal static RetrieveAndGenerateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RetrieveAndGenerateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
