...
{
    /// <summary>
    /// Response Unmarshaller for RetrieveAndGenerateStream operation
    /// </summary>  
    public class RetrieveAndGenerateStreamResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RetrieveAndGenerateStreamResponse response = new RetrieveAndGenerateStreamResponse();
            response.Stream = new RetrieveAndGenerateStreamResponseOutput(context.Stream);
            if (context.ResponseData.IsHeaderPresent("x-amzn-bedrock-knowledge-base-session-id"))
                response.SessionId = context.ResponseData.GetHeaderValue("x-amzn-bedrock-knowledge-base-session-id");
        ...
        private static RetrieveAndGenerateStreamResponseUnmarshaller _instance = new RetrieveAndGenerateStreamResponseUnmarshaller();        

        internal static RetrieveAndGenerateStreamResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RetrieveAndGenerateStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
