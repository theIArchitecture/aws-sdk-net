...
{
    /// <summary>
    /// StartFlowExecution Request Marshaller
    /// </summary>       
    public class StartFlowExecutionRequestMarshaller : IMarshaller<IRequest, StartFlowExecutionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartFlowExecutionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartFlowExecutionRequest publicRequest)
        {
            ...
            request.ResourcePath = "/flows/{flowIdentifier}/aliases/{flowAliasIdentifier}/executions";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetFlowExecutionName())
            {
                context.Writer.WritePropertyName("flowExecutionName");
                context.Writer.WriteStringValue(publicRequest.FlowExecutionName);
            }
            ...
            if(publicRequest.IsSetInputs())
            {
                ...
                foreach(var publicRequestInputsListValue in publicRequest.Inputs)
                {
                    ...
                    var marshaller = FlowInputMarshaller.Instance;
        ...
        private static StartFlowExecutionRequestMarshaller _instance = new StartFlowExecutionRequestMarshaller();        

        internal static StartFlowExecutionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartFlowExecutionRequestMarshaller Instance
        {
            get
            {
                return _instance;
