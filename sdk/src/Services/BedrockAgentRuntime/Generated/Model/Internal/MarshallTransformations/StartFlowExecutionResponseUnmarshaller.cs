...
{
    /// <summary>
    /// Response Unmarshaller for StartFlowExecution operation
    /// </summary>  
    public class StartFlowExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartFlowExecutionResponse response = new StartFlowExecutionResponse();
        ...
        private static StartFlowExecutionResponseUnmarshaller _instance = new StartFlowExecutionResponseUnmarshaller();        

        internal static StartFlowExecutionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartFlowExecutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
