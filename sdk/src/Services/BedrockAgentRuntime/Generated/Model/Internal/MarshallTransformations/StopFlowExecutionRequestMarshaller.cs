...
namespace Amazon.BedrockAgentRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class StopFlowExecutionRequestMarshaller : IMarshaller<IRequest, StopFlowExecutionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static StopFlowExecutionRequestMarshaller _instance = new StopFlowExecutionRequestMarshaller();        

        internal static StopFlowExecutionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopFlowExecutionRequestMarshaller Instance
        {
            get
            {
                return _instance;
