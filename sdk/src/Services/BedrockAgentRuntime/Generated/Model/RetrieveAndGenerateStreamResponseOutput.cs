...
namespace Amazon.BedrockAgentRuntime.Model
{
    ...
    /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Naming", "CA1710:Identifiers should have correct suffix", Justification = "RetrieveAndGenerateStreamResponseOutputCollection is not descriptive")]
    ...
    public sealed class RetrieveAndGenerateStreamResponseOutput : EnumerableEventOutputStream<IEventStreamEvent, BedrockAgentRuntimeEventStreamException>
    {
        /// <summary>
            ...
            {"Citation", payload => 
                {
                    ...
                    return new CitationEventUnmarshaller().Unmarshall(context, ref reader);
                }
            },
            {"Guardrail", payload => 
                {
                    var context = EventStreamUtils.ConvertMessageToJsonContext(payload);
                    var reader = new StreamingUtf8JsonReader(context.Stream);
                    return new GuardrailEventUnmarshaller().Unmarshall(context, ref reader);
                }
            },
            {"Output", payload => 
                {
                    var context = EventStreamUtils.ConvertMessageToJsonContext(payload);
                    var reader = new StreamingUtf8JsonReader(context.Stream);
                    return new RetrieveAndGenerateOutputEventUnmarshaller().Unmarshall(context, ref reader);
                }
            },
        };
        /// <summary>
        ...
        ///<summary>
        ///Raised when an Citation event is received
        ///</summary>
        public event EventHandler<EventStreamEventReceivedArgs<CitationEvent>> CitationReceived;
        ///<summary>
        ///Raised when an Guardrail event is received
        ///</summary>
        public event EventHandler<EventStreamEventReceivedArgs<GuardrailEvent>> GuardrailReceived;
        ///<summary>
        ///Raised when an Output event is received
        ///</summary>
        public event EventHandler<EventStreamEventReceivedArgs<RetrieveAndGenerateOutputEvent>> OutputReceived;

        /// <summary>
        /// Construct an instance
        /// </summary>
        /// <param name="stream"></param>        
        public RetrieveAndGenerateStreamResponseOutput(Stream stream) : this (stream, null)
        {
        }
        ...
        public RetrieveAndGenerateStreamResponseOutput(Stream stream, IEventStreamDecoder eventStreamDecoder) : base(stream, eventStreamDecoder)
        {
            ...
            Decoder.MessageReceived += (sender, args) =>
            {
                ...
                var _ =
                    ...
                    RaiseEvent(CitationReceived,ev) ||
                    RaiseEvent(GuardrailReceived,ev) ||
