...
namespace Amazon.BedrockDataAutomation
{
    ...
    public partial class AmazonBedrockDataAutomationConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Bedrock Data Automation", "4.0.3.2");
        ...
        /// Default constructor
        /// </summary>
        public AmazonBedrockDataAutomationConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonBedrockDataAutomationDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "Bedrock Data Automation";
            this.AuthenticationServiceName = "bedrock";
            this.EndpointProvider = new AmazonBedrockDataAutomationEndpointProvider();
        }
