...
{
    /// <summary>
    /// BlueprintItem Marshaller
    /// </summary>
    public class BlueprintItemMarshaller : IRequestMarshaller<BlueprintItem, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(BlueprintItem requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetBlueprintStage())
            {
                ...
                context.Writer.WriteStringValue(requestObject.BlueprintStage);
            }

            if(requestObject.IsSetBlueprintVersion())
            {
                context.Writer.WritePropertyName("blueprintVersion");
                context.Writer.WriteStringValue(requestObject.BlueprintVersion);
            }
        ...
        /// </summary>
        public readonly static BlueprintItemMarshaller Instance = new BlueprintItemMarshaller();
