...
{
    /// <summary>
    /// Response Unmarshaller for BlueprintItem Object
    /// </summary>  
    public class BlueprintItemUnmarshaller : IJsonUnmarshaller<BlueprintItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BlueprintItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            BlueprintItem unmarshalledObject = new BlueprintItem();
        ...
        private static BlueprintItemUnmarshaller _instance = new BlueprintItemUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BlueprintItemUnmarshaller Instance
        {
            get
            {
                return _instance;
