...
namespace Amazon.BedrockDataAutomation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DataAutomationProjectSummaryUnmarshaller : IJsonUnmarshaller<DataAutomationProjectSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DataAutomationProjectSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
