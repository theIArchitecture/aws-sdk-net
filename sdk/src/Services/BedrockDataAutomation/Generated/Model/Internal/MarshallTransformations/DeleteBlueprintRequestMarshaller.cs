...
{
    /// <summary>
    /// DeleteBlueprint Request Marshaller
    /// </summary>       
    public class DeleteBlueprintRequestMarshaller : IMarshaller<IRequest, DeleteBlueprintRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteBlueprintRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteBlueprintRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetBlueprintVersion())
                request.Parameters.Add("blueprintVersion", StringUtils.FromString(publicRequest.BlueprintVersion));
            request.ResourcePath = "/blueprints/{blueprintArn}/";
            request.UseQueryString = true;

            return request;
        }
        private static DeleteBlueprintRequestMarshaller _instance = new DeleteBlueprintRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteBlueprintRequestMarshaller Instance
        {
            get
            {
                return _instance;
