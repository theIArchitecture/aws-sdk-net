...
{
    /// <summary>
    /// Response Unmarshaller for DocumentOutputFormat Object
    /// </summary>  
    public class DocumentOutputFormatUnmarshaller : IJsonUnmarshaller<DocumentOutputFormat, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DocumentOutputFormat Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            DocumentOutputFormat unmarshalledObject = new DocumentOutputFormat();
        ...
        private static DocumentOutputFormatUnmarshaller _instance = new DocumentOutputFormatUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DocumentOutputFormatUnmarshaller Instance
        {
            get
            {
                return _instance;
