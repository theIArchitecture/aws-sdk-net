...
{
    /// <summary>
    /// Response Unmarshaller for DocumentStandardOutputConfiguration Object
    /// </summary>  
    public class DocumentStandardOutputConfigurationUnmarshaller : IJsonUnmarshaller<DocumentStandardOutputConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DocumentStandardOutputConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            DocumentStandardOutputConfiguration unmarshalledObject = new DocumentStandardOutputConfiguration();
        ...
        private static DocumentStandardOutputConfigurationUnmarshaller _instance = new DocumentStandardOutputConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DocumentStandardOutputConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
