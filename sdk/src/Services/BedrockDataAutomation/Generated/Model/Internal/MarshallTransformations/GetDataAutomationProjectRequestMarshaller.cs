...
{
    /// <summary>
    /// GetDataAutomationProject Request Marshaller
    /// </summary>       
    public class GetDataAutomationProjectRequestMarshaller : IMarshaller<IRequest, GetDataAutomationProjectRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetDataAutomationProjectRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetDataAutomationProjectRequest publicRequest)
        {
        ...
        private static GetDataAutomationProjectRequestMarshaller _instance = new GetDataAutomationProjectRequestMarshaller();        

        internal static GetDataAutomationProjectRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDataAutomationProjectRequestMarshaller Instance
        {
            get
            {
                return _instance;
