...
namespace Amazon.BedrockDataAutomation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OverrideConfigurationUnmarshaller : IJsonUnmarshaller<OverrideConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public OverrideConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
