...
{
    /// <summary>
    /// Configuration for accessing Amazon BedrockDataAutomationRuntime service
    /// </summary>
    public partial class AmazonBedrockDataAutomationRuntimeConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Bedrock Data Automation Runtime", "4.0.1.21");
        ...
        /// Default constructor
        /// </summary>
        public AmazonBedrockDataAutomationRuntimeConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonBedrockDataAutomationRuntimeDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "Bedrock Data Automation Runtime";
            this.AuthenticationServiceName = "bedrock";
            this.EndpointProvider = new AmazonBedrockDataAutomationRuntimeEndpointProvider();
        }
