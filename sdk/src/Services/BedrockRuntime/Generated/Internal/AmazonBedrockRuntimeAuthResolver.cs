...
namespace Amazon.BedrockRuntime.Internal
{
    ...
    public class AmazonBedrockRuntimeAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonBedrockRuntimeAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for BedrockRuntime.
        /// </summary>
        public AmazonBedrockRuntimeAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonBedrockRuntimeAuthSchemeParameters
            {
    ...
    public class AmazonBedrockRuntimeAuthSchemeResolver : IAuthSchemeResolver<AmazonBedrockRuntimeAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonBedrockRuntimeAuthSchemeParameters authParameters)
        {
