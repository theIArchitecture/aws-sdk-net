...
namespace Amazon.BedrockRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConverseStreamResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ConverseStreamResponse response = new ConverseStreamResponse();
            response.Stream = new ConverseStreamOutput(context.Stream);
        ...
        private static ConverseStreamResponseUnmarshaller _instance = new ConverseStreamResponseUnmarshaller();        

        internal static ConverseStreamResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ConverseStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
