...
{
    /// <summary>
    /// Response Unmarshaller for CountTokens operation
    /// </summary>  
    public class CountTokensResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CountTokensResponse response = new CountTokensResponse();
        ...
        private static CountTokensResponseUnmarshaller _instance = new CountTokensResponseUnmarshaller();        

        internal static CountTokensResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CountTokensResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
