...
{
    /// <summary>
    /// Response Unmarshaller for GuardrailAutomatedReasoningImpossibleFinding Object
    /// </summary>  
    public class GuardrailAutomatedReasoningImpossibleFindingUnmarshaller : IJsonUnmarshaller<GuardrailAutomatedReasoningImpossibleFinding, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GuardrailAutomatedReasoningImpossibleFinding Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            GuardrailAutomatedReasoningImpossibleFinding unmarshalledObject = new GuardrailAutomatedReasoningImpossibleFinding();
        ...
        private static GuardrailAutomatedReasoningImpossibleFindingUnmarshaller _instance = new GuardrailAutomatedReasoningImpossibleFindingUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static GuardrailAutomatedReasoningImpossibleFindingUnmarshaller Instance
        {
            get
            {
                return _instance;
