...
{
    /// <summary>
    /// Response Unmarshaller for GuardrailAutomatedReasoningInvalidFinding Object
    /// </summary>  
    public class GuardrailAutomatedReasoningInvalidFindingUnmarshaller : IJsonUnmarshaller<GuardrailAutomatedReasoningInvalidFinding, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GuardrailAutomatedReasoningInvalidFinding Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            GuardrailAutomatedReasoningInvalidFinding unmarshalledObject = new GuardrailAutomatedReasoningInvalidFinding();
        ...
        private static GuardrailAutomatedReasoningInvalidFindingUnmarshaller _instance = new GuardrailAutomatedReasoningInvalidFindingUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static GuardrailAutomatedReasoningInvalidFindingUnmarshaller Instance
        {
            get
            {
                return _instance;
