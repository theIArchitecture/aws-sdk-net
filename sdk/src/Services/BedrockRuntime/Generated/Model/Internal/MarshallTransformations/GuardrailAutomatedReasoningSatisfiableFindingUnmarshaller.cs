...
{
    /// <summary>
    /// Response Unmarshaller for GuardrailAutomatedReasoningSatisfiableFinding Object
    /// </summary>  
    public class GuardrailAutomatedReasoningSatisfiableFindingUnmarshaller : IJsonUnmarshaller<GuardrailAutomatedReasoningSatisfiableFinding, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GuardrailAutomatedReasoningSatisfiableFinding Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            GuardrailAutomatedReasoningSatisfiableFinding unmarshalledObject = new GuardrailAutomatedReasoningSatisfiableFinding();
        ...
        private static GuardrailAutomatedReasoningSatisfiableFindingUnmarshaller _instance = new GuardrailAutomatedReasoningSatisfiableFindingUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static GuardrailAutomatedReasoningSatisfiableFindingUnmarshaller Instance
        {
            get
            {
                return _instance;
