...
namespace Amazon.BedrockRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GuardrailAutomatedReasoningTranslationUnmarshaller : IJsonUnmarshaller<GuardrailAutomatedReasoningTranslation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GuardrailAutomatedReasoningTranslation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<GuardrailAutomatedReasoningInputTextReference, GuardrailAutomatedReasoningInputTextReferenceUnmarshaller>(GuardrailAutomatedReasoningInputTextReferenceUnmarshaller.Instance);
