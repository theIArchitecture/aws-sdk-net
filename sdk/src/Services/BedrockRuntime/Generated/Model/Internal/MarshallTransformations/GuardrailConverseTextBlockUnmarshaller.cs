...
namespace Amazon.BedrockRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GuardrailConverseTextBlockUnmarshaller : IJsonUnmarshaller<GuardrailConverseTextBlock, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GuardrailConverseTextBlock Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("qualifiers", targetDepth))
                {
                    ...
                    unmarshalledObject.Qualifiers = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
