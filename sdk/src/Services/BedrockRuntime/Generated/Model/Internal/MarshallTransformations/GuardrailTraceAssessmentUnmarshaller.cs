...
{
    /// <summary>
    /// Response Unmarshaller for GuardrailTraceAssessment Object
    /// </summary>  
    public class GuardrailTraceAssessmentUnmarshaller : IJsonUnmarshaller<GuardrailTraceAssessment, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GuardrailTraceAssessment Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            GuardrailTraceAssessment unmarshalledObject = new GuardrailTraceAssessment();
        ...
        private static GuardrailTraceAssessmentUnmarshaller _instance = new GuardrailTraceAssessmentUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static GuardrailTraceAssessmentUnmarshaller Instance
        {
            get
            {
                return _instance;
