...
namespace Amazon.BedrockRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PromptRouterTraceUnmarshaller : IJsonUnmarshaller<PromptRouterTrace, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PromptRouterTrace Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("invokedModelId", targetDepth))
                {
                    ...
                    unmarshalledObject.InvokedModelId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
