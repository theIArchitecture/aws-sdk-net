...
namespace Amazon.BedrockRuntime.Model
{
    ...
    /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Naming", "CA1710:Identifiers should have correct suffix", Justification = "InvokeModelWithBidirectionalStreamOutputCollection is not descriptive")]
    ...
    public sealed class InvokeModelWithBidirectionalStreamOutput : EnumerableEventOutputStream<IEventStreamEvent, BedrockRuntimeEventStreamException>
    {
        /// <summary>
            ...
            {"Chunk", payload => 
                {
                    ...
                    return new BidirectionalOutputPayloadPartUnmarshaller().Unmarshall(context, ref reader);
                }
            },
        };
        /// <summary>
        ...
        ///</summary>
        public event EventHandler<EventStreamEventReceivedArgs<BidirectionalOutputPayloadPart>> ChunkReceived;

        /// <summary>
        /// Construct an instance
        /// </summary>
        /// <param name="stream"></param>        
        public InvokeModelWithBidirectionalStreamOutput(Stream stream) : this (stream, null)
        {
        }
        ...
        public InvokeModelWithBidirectionalStreamOutput(Stream stream, IEventStreamDecoder eventStreamDecoder) : base(stream, eventStreamDecoder)
        {
