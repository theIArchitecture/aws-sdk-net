...
namespace Amazon.Billing
{
    ...
    public partial class AmazonBillingConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Billing", "4.0.3.2");
        ...
        /// Default constructor
        /// </summary>
        public AmazonBillingConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonBillingDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "Billing";
            this.AuthenticationServiceName = "billing";
            this.EndpointProvider = new AmazonBillingEndpointProvider();
        }
