...
namespace Amazon.Billing.Internal
{
    ...
    public class AmazonBillingAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonBillingAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Billing.
        /// </summary>
        public AmazonBillingAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonBillingAuthSchemeParameters
            {
    ...
    public class AmazonBillingAuthSchemeResolver : IAuthSchemeResolver<AmazonBillingAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonBillingAuthSchemeParameters authParameters)
        {
