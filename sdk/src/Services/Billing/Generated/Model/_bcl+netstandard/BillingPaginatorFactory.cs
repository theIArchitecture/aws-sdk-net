...
namespace Amazon.Billing.Model
{
    ...
    public class BillingPaginatorFactory : IBillingPaginatorFactory
    {
        ...
        internal BillingPaginatorFactory(IAmazonBilling client) 
        {
            this.client = client;
        }
        ...
        {
            return new ListBillingViewsPaginator(this.client, request);
        }
        ...
        {
            return new ListSourceViewsForBillingViewPaginator(this.client, request);
        }
    }
}