...
{
    /// <summary>
    /// Response Unmarshaller for AssociateAccounts operation
    /// </summary>  
    public class AssociateAccountsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateAccountsResponse response = new AssociateAccountsResponse();
        ...
        private static AssociateAccountsResponseUnmarshaller _instance = new AssociateAccountsResponseUnmarshaller();        

        internal static AssociateAccountsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateAccountsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
