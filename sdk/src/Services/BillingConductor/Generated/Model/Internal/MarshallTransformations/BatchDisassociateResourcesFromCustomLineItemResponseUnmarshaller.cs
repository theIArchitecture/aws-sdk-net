...
{
    /// <summary>
    /// Response Unmarshaller for BatchDisassociateResourcesFromCustomLineItem operation
    /// </summary>  
    public class BatchDisassociateResourcesFromCustomLineItemResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchDisassociateResourcesFromCustomLineItemResponse response = new BatchDisassociateResourcesFromCustomLineItemResponse();
        ...
        private static BatchDisassociateResourcesFromCustomLineItemResponseUnmarshaller _instance = new BatchDisassociateResourcesFromCustomLineItemResponseUnmarshaller();        

        internal static BatchDisassociateResourcesFromCustomLineItemResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDisassociateResourcesFromCustomLineItemResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
