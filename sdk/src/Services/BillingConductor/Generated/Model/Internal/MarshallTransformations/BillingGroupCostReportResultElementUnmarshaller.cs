...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BillingGroupCostReportResultElementUnmarshaller : IJsonUnmarshaller<BillingGroupCostReportResultElement, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            BillingGroupCostReportResultElement unmarshalledObject = new BillingGroupCostReportResultElement();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BillingGroupCostReportResultElementUnmarshaller Instance
        {
            get
            {
                return _instance;
