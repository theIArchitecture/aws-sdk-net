...
{
    /// <summary>
    /// Response Unmarshaller for CreatePricingPlan operation
    /// </summary>  
    public class CreatePricingPlanResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePricingPlanResponse response = new CreatePricingPlanResponse();
        ...
        private static CreatePricingPlanResponseUnmarshaller _instance = new CreatePricingPlanResponseUnmarshaller();        

        internal static CreatePricingPlanResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePricingPlanResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
