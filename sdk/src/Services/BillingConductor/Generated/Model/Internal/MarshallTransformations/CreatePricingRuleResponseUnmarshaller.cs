...
{
    /// <summary>
    /// Response Unmarshaller for CreatePricingRule operation
    /// </summary>  
    public class CreatePricingRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePricingRuleResponse response = new CreatePricingRuleResponse();
        ...
        private static CreatePricingRuleResponseUnmarshaller _instance = new CreatePricingRuleResponseUnmarshaller();        

        internal static CreatePricingRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePricingRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
