...
{
    /// <summary>
    /// Response Unmarshaller for CustomLineItemListElement Object
    /// </summary>  
    public class CustomLineItemListElementUnmarshaller : IJsonUnmarshaller<CustomLineItemListElement, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CustomLineItemListElement Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static CustomLineItemListElementUnmarshaller _instance = new CustomLineItemListElementUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CustomLineItemListElementUnmarshaller Instance
        {
            get
            {
                return _instance;
