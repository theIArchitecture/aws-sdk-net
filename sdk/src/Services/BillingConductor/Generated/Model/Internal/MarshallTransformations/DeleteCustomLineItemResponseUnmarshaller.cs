...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    public class DeleteCustomLineItemResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static DeleteCustomLineItemResponseUnmarshaller _instance = new DeleteCustomLineItemResponseUnmarshaller();        

        internal static DeleteCustomLineItemResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCustomLineItemResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
