...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    public class DisassociateAccountsRequestMarshaller : IMarshaller<IRequest, DisassociateAccountsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(DisassociateAccountsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/disassociate-accounts";
#if !NETFRAMEWORK
        ...
        private static DisassociateAccountsRequestMarshaller _instance = new DisassociateAccountsRequestMarshaller();        

        internal static DisassociateAccountsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateAccountsRequestMarshaller Instance
        {
            get
            {
                return _instance;
