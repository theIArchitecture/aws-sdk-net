...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    public class DisassociatePricingRulesRequestMarshaller : IMarshaller<IRequest, DisassociatePricingRulesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(DisassociatePricingRulesRequest publicRequest)
        {
            ...
            request.ResourcePath = "/disassociate-pricing-rules";
#if !NETFRAMEWORK
        ...
        private static DisassociatePricingRulesRequestMarshaller _instance = new DisassociatePricingRulesRequestMarshaller();        

        internal static DisassociatePricingRulesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociatePricingRulesRequestMarshaller Instance
        {
            get
            {
                return _instance;
