...
{
    /// <summary>
    /// GetBillingGroupCostReport Request Marshaller
    /// </summary>       
    public class GetBillingGroupCostReportRequestMarshaller : IMarshaller<IRequest, GetBillingGroupCostReportRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetBillingGroupCostReportRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetBillingGroupCostReportRequest publicRequest)
        {
        ...
        private static GetBillingGroupCostReportRequestMarshaller _instance = new GetBillingGroupCostReportRequestMarshaller();        

        internal static GetBillingGroupCostReportRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBillingGroupCostReportRequestMarshaller Instance
        {
            get
            {
                return _instance;
