...
namespace Amazon.BillingConductor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LineItemFilterUnmarshaller : IJsonUnmarshaller<LineItemFilter, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LineItemFilter Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.MatchOption = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
