    ...
    public class ListAccountAssociationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AccountAssociationsListElement, AccountAssociationsListElementUnmarshaller>(AccountAssociationsListElementUnmarshaller.Instance);
        ...
        private static ListAccountAssociationsResponseUnmarshaller _instance = new ListAccountAssociationsResponseUnmarshaller();        

        internal static ListAccountAssociationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAccountAssociationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
