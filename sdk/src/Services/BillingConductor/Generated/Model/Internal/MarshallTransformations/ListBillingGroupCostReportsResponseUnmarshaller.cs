    ...
    public class ListBillingGroupCostReportsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BillingGroupCostReportElement, BillingGroupCostReportElementUnmarshaller>(BillingGroupCostReportElementUnmarshaller.Instance);
                    response.BillingGroupCostReports = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListBillingGroupCostReportsResponseUnmarshaller _instance = new ListBillingGroupCostReportsResponseUnmarshaller();        

        internal static ListBillingGroupCostReportsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListBillingGroupCostReportsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
