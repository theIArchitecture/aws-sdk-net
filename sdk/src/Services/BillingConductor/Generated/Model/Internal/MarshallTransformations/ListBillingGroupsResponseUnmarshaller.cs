    ...
    public class ListBillingGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BillingGroupListElement, BillingGroupListElementUnmarshaller>(BillingGroupListElementUnmarshaller.Instance);
                    response.BillingGroups = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
