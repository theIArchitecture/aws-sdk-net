...
{
    /// <summary>
    /// Response Unmarshaller for ListResourcesAssociatedToCustomLineItem operation
    /// </summary>  
    public class ListResourcesAssociatedToCustomLineItemResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListResourcesAssociatedToCustomLineItemResponse response = new ListResourcesAssociatedToCustomLineItemResponse();
        ...
        private static ListResourcesAssociatedToCustomLineItemResponseUnmarshaller _instance = new ListResourcesAssociatedToCustomLineItemResponseUnmarshaller();        

        internal static ListResourcesAssociatedToCustomLineItemResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListResourcesAssociatedToCustomLineItemResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
