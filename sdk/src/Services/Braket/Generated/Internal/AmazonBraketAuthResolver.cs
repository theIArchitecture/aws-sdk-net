...
namespace Amazon.Braket.Internal
{
    ...
    public class AmazonBraketAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonBraketAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Braket.
        /// </summary>
        public AmazonBraketAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonBraketAuthSchemeParameters
            {
    ...
    public class AmazonBraketAuthSchemeResolver : IAuthSchemeResolver<AmazonBraketAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonBraketAuthSchemeParameters authParameters)
        {
