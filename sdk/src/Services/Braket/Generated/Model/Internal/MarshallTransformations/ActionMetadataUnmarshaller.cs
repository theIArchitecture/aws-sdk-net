...
namespace Amazon.Braket.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ActionMetadataUnmarshaller : IJsonUnmarshaller<ActionMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ActionMetadata Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("executableCount", targetDepth))
                {
                    ...
                    unmarshalledObject.ExecutableCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
