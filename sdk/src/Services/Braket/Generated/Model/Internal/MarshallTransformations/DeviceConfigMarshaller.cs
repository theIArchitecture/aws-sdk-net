...
namespace Amazon.Braket.Model.Internal.MarshallTransformations
{
    ...
    public class DeviceConfigMarshaller : IRequestMarshaller<DeviceConfig, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(DeviceConfig requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetDevice())
            {
                context.Writer.WritePropertyName("device");
                context.Writer.WriteStringValue(requestObject.Device);
            }
