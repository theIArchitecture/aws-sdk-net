...
namespace Amazon.Braket.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class JobStoppingConditionUnmarshaller : IJsonUnmarshaller<JobStoppingCondition, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            JobStoppingCondition unmarshalledObject = new JobStoppingCondition();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static JobStoppingConditionUnmarshaller Instance
        {
            get
            {
                return _instance;
