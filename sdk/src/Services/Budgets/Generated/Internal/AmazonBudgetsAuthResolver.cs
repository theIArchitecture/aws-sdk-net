...
namespace Amazon.Budgets.Internal
{
    ...
    public class AmazonBudgetsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonBudgetsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Budgets.
        /// </summary>
        public AmazonBudgetsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonBudgetsAuthSchemeParameters
            {
    ...
    public class AmazonBudgetsAuthSchemeResolver : IAuthSchemeResolver<AmazonBudgetsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonBudgetsAuthSchemeParameters authParameters)
        {
