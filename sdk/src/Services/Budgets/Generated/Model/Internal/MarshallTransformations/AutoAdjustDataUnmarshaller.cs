...
namespace Amazon.Budgets.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AutoAdjustDataUnmarshaller : IJsonUnmarshaller<AutoAdjustData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AutoAdjustData Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
