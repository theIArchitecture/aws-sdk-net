...
namespace Amazon.Budgets.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BudgetPerformanceHistoryUnmarshaller : IJsonUnmarshaller<BudgetPerformanceHistory, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BudgetPerformanceHistory Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
