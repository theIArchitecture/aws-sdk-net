...
{
    /// <summary>
    /// Response Unmarshaller for DescribeBudgetNotificationsForAccount operation
    /// </summary>  
    public class DescribeBudgetNotificationsForAccountResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeBudgetNotificationsForAccountResponse response = new DescribeBudgetNotificationsForAccountResponse();
        ...
        private static DescribeBudgetNotificationsForAccountResponseUnmarshaller _instance = new DescribeBudgetNotificationsForAccountResponseUnmarshaller();        

        internal static DescribeBudgetNotificationsForAccountResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeBudgetNotificationsForAccountResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
