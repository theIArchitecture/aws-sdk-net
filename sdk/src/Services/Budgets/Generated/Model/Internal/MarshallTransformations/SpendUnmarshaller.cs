...
namespace Amazon.Budgets.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SpendUnmarshaller : IJsonUnmarshaller<Spend, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Spend Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
