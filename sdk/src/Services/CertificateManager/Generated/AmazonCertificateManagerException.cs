...
namespace Amazon.CertificateManager
{
    ...
    public partial class AmazonCertificateManagerException : AmazonServiceException
    {
        ...
        public AmazonCertificateManagerException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonCertificateManagerException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
