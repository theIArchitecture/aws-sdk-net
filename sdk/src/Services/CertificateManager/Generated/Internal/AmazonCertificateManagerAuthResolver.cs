...
namespace Amazon.CertificateManager.Internal
{
    ...
    public class AmazonCertificateManagerAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCertificateManagerAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CertificateManager.
        /// </summary>
        public AmazonCertificateManagerAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCertificateManagerAuthSchemeParameters
            {
    ...
    public class AmazonCertificateManagerAuthSchemeResolver : IAuthSchemeResolver<AmazonCertificateManagerAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCertificateManagerAuthSchemeParameters authParameters)
        {
