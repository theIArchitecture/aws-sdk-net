...
{
    /// <summary>
    /// Amazon CertificateManager endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for CertificateManager service requests.
    /// Collects values for CertificateManagerEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses CertificateManagerEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonCertificateManagerEndpointResolver : BaseEndpointResolver
    {
