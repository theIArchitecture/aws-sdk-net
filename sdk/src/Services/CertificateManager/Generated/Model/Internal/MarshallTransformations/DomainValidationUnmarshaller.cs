...
namespace Amazon.CertificateManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DomainValidationUnmarshaller : IJsonUnmarshaller<DomainValidation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DomainValidation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("HttpRedirect", targetDepth))
                {
                    ...
                    unmarshalledObject.HttpRedirect = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
