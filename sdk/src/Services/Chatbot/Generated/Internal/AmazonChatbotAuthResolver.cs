...
namespace Amazon.Chatbot.Internal
{
    ...
    public class AmazonChatbotAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonChatbotAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Chatbot.
        /// </summary>
        public AmazonChatbotAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonChatbotAuthSchemeParameters
            {
    ...
    public class AmazonChatbotAuthSchemeResolver : IAuthSchemeResolver<AmazonChatbotAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonChatbotAuthSchemeParameters authParameters)
        {
