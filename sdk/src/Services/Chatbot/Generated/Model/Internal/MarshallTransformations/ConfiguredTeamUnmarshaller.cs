...
namespace Amazon.Chatbot.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConfiguredTeamUnmarshaller : IJsonUnmarshaller<ConfiguredTeam, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            ConfiguredTeam unmarshalledObject = new ConfiguredTeam();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ConfiguredTeamUnmarshaller Instance
        {
            get
            {
                return _instance;
