...
{
    /// <summary>
    /// Response Unmarshaller for CreateChimeWebhookConfiguration operation
    /// </summary>  
    public class CreateChimeWebhookConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateChimeWebhookConfigurationResponse response = new CreateChimeWebhookConfigurationResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("CreateChimeWebhookConfigurationException"))
                {
                    return CreateChimeWebhookConfigurationExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static CreateChimeWebhookConfigurationResponseUnmarshaller _instance = new CreateChimeWebhookConfigurationResponseUnmarshaller();        

        internal static CreateChimeWebhookConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateChimeWebhookConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
