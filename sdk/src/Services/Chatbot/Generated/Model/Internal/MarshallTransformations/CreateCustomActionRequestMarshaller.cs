...
{
    /// <summary>
    /// CreateCustomAction Request Marshaller
    /// </summary>       
    public class CreateCustomActionRequestMarshaller : IMarshaller<IRequest, CreateCustomActionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateCustomActionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateCustomActionRequest publicRequest)
        {
        ...
        private static CreateCustomActionRequestMarshaller _instance = new CreateCustomActionRequestMarshaller();        

        internal static CreateCustomActionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCustomActionRequestMarshaller Instance
        {
            get
            {
                return _instance;
