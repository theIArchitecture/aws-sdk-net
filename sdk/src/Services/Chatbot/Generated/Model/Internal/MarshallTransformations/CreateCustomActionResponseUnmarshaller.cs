...
{
    /// <summary>
    /// Response Unmarshaller for CreateCustomAction operation
    /// </summary>  
    public class CreateCustomActionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateCustomActionResponse response = new CreateCustomActionResponse();
        ...
        private static CreateCustomActionResponseUnmarshaller _instance = new CreateCustomActionResponseUnmarshaller();        

        internal static CreateCustomActionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCustomActionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
