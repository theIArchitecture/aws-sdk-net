...
{
    /// <summary>
    /// Response Unmarshaller for CustomActionAttachment Object
    /// </summary>  
    public class CustomActionAttachmentUnmarshaller : IJsonUnmarshaller<CustomActionAttachment, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CustomActionAttachment Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            CustomActionAttachment unmarshalledObject = new CustomActionAttachment();
        ...
        private static CustomActionAttachmentUnmarshaller _instance = new CustomActionAttachmentUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CustomActionAttachmentUnmarshaller Instance
        {
            get
            {
                return _instance;
