...
namespace Amazon.Chatbot.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteCustomActionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteCustomActionResponse response = new DeleteCustomActionResponse();
        ...
        internal static DeleteCustomActionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCustomActionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
