...
{
    /// <summary>
    /// Response Unmarshaller for GetCustomAction operation
    /// </summary>  
    public class GetCustomActionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCustomActionResponse response = new GetCustomActionResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("CustomAction", targetDepth))
                {
                    var unmarshaller = CustomActionUnmarshaller.Instance;
                    response.CustomAction = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetCustomActionResponseUnmarshaller _instance = new GetCustomActionResponseUnmarshaller();        

        internal static GetCustomActionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCustomActionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
