...
namespace Amazon.Chime.Internal
{
    ...
    public class AmazonChimeAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonChimeAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Chime.
        /// </summary>
        public AmazonChimeAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonChimeAuthSchemeParameters
            {
    ...
    public class AmazonChimeAuthSchemeResolver : IAuthSchemeResolver<AmazonChimeAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonChimeAuthSchemeParameters authParameters)
        {
