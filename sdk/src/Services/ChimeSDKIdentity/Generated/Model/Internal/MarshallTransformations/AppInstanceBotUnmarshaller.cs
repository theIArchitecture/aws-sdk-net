...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AppInstanceBotUnmarshaller : IJsonUnmarshaller<AppInstanceBot, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AppInstanceBot Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
