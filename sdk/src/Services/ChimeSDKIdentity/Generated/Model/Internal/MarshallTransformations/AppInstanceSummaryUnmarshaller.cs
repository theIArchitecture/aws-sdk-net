...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AppInstanceSummaryUnmarshaller : IJsonUnmarshaller<AppInstanceSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AppInstanceSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
