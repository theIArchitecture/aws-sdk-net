...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AppInstanceUnmarshaller : IJsonUnmarshaller<AppInstance, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AppInstance Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
