...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AppInstanceUserUnmarshaller : IJsonUnmarshaller<AppInstanceUser, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AppInstanceUser Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
