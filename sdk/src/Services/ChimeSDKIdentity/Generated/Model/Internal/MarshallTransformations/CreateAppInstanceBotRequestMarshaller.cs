...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateAppInstanceBotRequestMarshaller : IMarshaller<IRequest, CreateAppInstanceBotRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static CreateAppInstanceBotRequestMarshaller _instance = new CreateAppInstanceBotRequestMarshaller();        

        internal static CreateAppInstanceBotRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAppInstanceBotRequestMarshaller Instance
        {
            get
            {
                return _instance;
