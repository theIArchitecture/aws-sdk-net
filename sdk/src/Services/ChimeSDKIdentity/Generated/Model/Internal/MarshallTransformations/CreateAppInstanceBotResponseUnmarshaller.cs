...
{
    /// <summary>
    /// Response Unmarshaller for CreateAppInstanceBot operation
    /// </summary>  
    public class CreateAppInstanceBotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAppInstanceBotResponse response = new CreateAppInstanceBotResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AppInstanceBotArn", targetDepth))
                {
                    ...
                    response.AppInstanceBotArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateAppInstanceBotResponseUnmarshaller _instance = new CreateAppInstanceBotResponseUnmarshaller();        

        internal static CreateAppInstanceBotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAppInstanceBotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
