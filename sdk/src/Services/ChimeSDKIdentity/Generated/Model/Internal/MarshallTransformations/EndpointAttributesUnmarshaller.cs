...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EndpointAttributesUnmarshaller : IJsonUnmarshaller<EndpointAttributes, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EndpointAttributes Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
