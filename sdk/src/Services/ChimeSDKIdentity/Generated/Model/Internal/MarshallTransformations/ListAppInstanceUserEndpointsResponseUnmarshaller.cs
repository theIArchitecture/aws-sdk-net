    ...
    public class ListAppInstanceUserEndpointsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AppInstanceUserEndpointSummary, AppInstanceUserEndpointSummaryUnmarshaller>(AppInstanceUserEndpointSummaryUnmarshaller.Instance);
                    response.AppInstanceUserEndpoints = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
