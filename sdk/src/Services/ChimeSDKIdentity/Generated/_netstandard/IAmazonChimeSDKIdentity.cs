...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonChimeSDKIdentityConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonChimeSDKIdentityConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonChimeSDKIdentityConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonChimeSDKIdentityConfig to create AmazonChimeSDKIdentityClient");
            }

            return awsCredentials == null ? 
                    new AmazonChimeSDKIdentityClient(serviceClientConfig) :
                    new AmazonChimeSDKIdentityClient(awsCredentials, serviceClientConfig);
        }
