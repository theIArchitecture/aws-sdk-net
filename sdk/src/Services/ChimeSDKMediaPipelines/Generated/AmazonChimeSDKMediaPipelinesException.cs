...
namespace Amazon.ChimeSDKMediaPipelines
{
    ...
    public partial class AmazonChimeSDKMediaPipelinesException : AmazonServiceException
    {
        ...
        public AmazonChimeSDKMediaPipelinesException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonChimeSDKMediaPipelinesException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
