...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConcatenationSinkUnmarshaller : IJsonUnmarshaller<ConcatenationSink, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ConcatenationSink Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("S3BucketSinkConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.S3BucketSinkConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
