...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConcatenationSourceUnmarshaller : IJsonUnmarshaller<ConcatenationSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ConcatenationSource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("MediaCapturePipelineSourceConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.MediaCapturePipelineSourceConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
