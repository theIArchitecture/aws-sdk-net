...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateMediaStreamPipelineResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateMediaStreamPipelineResponse response = new CreateMediaStreamPipelineResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("MediaStreamPipeline", targetDepth))
                {
                    ...
                    response.MediaStreamPipeline = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static CreateMediaStreamPipelineResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMediaStreamPipelineResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
