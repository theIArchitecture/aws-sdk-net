...
{
    /// <summary>
    /// Response Unmarshaller for GetMediaPipelineKinesisVideoStreamPool operation
    /// </summary>  
    public class GetMediaPipelineKinesisVideoStreamPoolResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMediaPipelineKinesisVideoStreamPoolResponse response = new GetMediaPipelineKinesisVideoStreamPoolResponse();
        ...
        private static GetMediaPipelineKinesisVideoStreamPoolResponseUnmarshaller _instance = new GetMediaPipelineKinesisVideoStreamPoolResponseUnmarshaller();        

        internal static GetMediaPipelineKinesisVideoStreamPoolResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMediaPipelineKinesisVideoStreamPoolResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
