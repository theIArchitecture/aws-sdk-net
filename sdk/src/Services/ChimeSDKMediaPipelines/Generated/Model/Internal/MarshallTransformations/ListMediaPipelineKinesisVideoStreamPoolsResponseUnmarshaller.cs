...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListMediaPipelineKinesisVideoStreamPoolsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMediaPipelineKinesisVideoStreamPoolsResponse response = new ListMediaPipelineKinesisVideoStreamPoolsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("KinesisVideoStreamPools", targetDepth))
                {
                    ...
                    response.KinesisVideoStreamPools = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListMediaPipelineKinesisVideoStreamPoolsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMediaPipelineKinesisVideoStreamPoolsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
