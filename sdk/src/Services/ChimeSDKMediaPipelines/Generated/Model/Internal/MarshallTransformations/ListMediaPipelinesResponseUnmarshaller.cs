    ...
    public class ListMediaPipelinesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<MediaPipelineSummary, MediaPipelineSummaryUnmarshaller>(MediaPipelineSummaryUnmarshaller.Instance);
                    response.MediaPipelines = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
