...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MediaCapturePipelineUnmarshaller : IJsonUnmarshaller<MediaCapturePipeline, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MediaCapturePipeline Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SinkIamRoleArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("SseAwsKeyManagementParams", targetDepth))
                {
                    ...
                    unmarshalledObject.SseAwsKeyManagementParams = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
