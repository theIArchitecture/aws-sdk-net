...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StopVoiceToneAnalysisTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopVoiceToneAnalysisTaskResponse response = new StopVoiceToneAnalysisTaskResponse();
        ...
        internal static StopVoiceToneAnalysisTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopVoiceToneAnalysisTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
