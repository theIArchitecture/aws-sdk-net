...
namespace Amazon.ChimeSDKMediaPipelines.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateMediaInsightsPipelineConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateMediaInsightsPipelineConfigurationResponse response = new UpdateMediaInsightsPipelineConfigurationResponse();
        ...
        internal static UpdateMediaInsightsPipelineConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMediaInsightsPipelineConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
