...
{
    /// <summary>
    /// Response Unmarshaller for UpdateMediaPipelineKinesisVideoStreamPool operation
    /// </summary>  
    public class UpdateMediaPipelineKinesisVideoStreamPoolResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateMediaPipelineKinesisVideoStreamPoolResponse response = new UpdateMediaPipelineKinesisVideoStreamPoolResponse();
        ...
        private static UpdateMediaPipelineKinesisVideoStreamPoolResponseUnmarshaller _instance = new UpdateMediaPipelineKinesisVideoStreamPoolResponseUnmarshaller();        

        internal static UpdateMediaPipelineKinesisVideoStreamPoolResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMediaPipelineKinesisVideoStreamPoolResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
