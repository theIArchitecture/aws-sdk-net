...
{
    /// <summary>
    /// Response Unmarshaller for BatchUpdateAttendeeCapabilitiesExcept operation
    /// </summary>  
    public class BatchUpdateAttendeeCapabilitiesExceptResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchUpdateAttendeeCapabilitiesExceptResponse response = new BatchUpdateAttendeeCapabilitiesExceptResponse();
        ...
        private static BatchUpdateAttendeeCapabilitiesExceptResponseUnmarshaller _instance = new BatchUpdateAttendeeCapabilitiesExceptResponseUnmarshaller();        

        internal static BatchUpdateAttendeeCapabilitiesExceptResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchUpdateAttendeeCapabilitiesExceptResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
