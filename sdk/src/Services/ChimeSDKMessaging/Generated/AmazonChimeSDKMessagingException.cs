...
namespace Amazon.ChimeSDKMessaging
{
    ...
    public partial class AmazonChimeSDKMessagingException : AmazonServiceException
    {
        ...
        public AmazonChimeSDKMessagingException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonChimeSDKMessagingException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
