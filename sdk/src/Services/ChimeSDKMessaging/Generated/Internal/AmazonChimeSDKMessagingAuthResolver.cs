...
namespace Amazon.ChimeSDKMessaging.Internal
{
    ...
    public class AmazonChimeSDKMessagingAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonChimeSDKMessagingAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ChimeSDKMessaging.
        /// </summary>
        public AmazonChimeSDKMessagingAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonChimeSDKMessagingAuthSchemeParameters
            {
    ...
    public class AmazonChimeSDKMessagingAuthSchemeResolver : IAuthSchemeResolver<AmazonChimeSDKMessagingAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonChimeSDKMessagingAuthSchemeParameters authParameters)
        {
