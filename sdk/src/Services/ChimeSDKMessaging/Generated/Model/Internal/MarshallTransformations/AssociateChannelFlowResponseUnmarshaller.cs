...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssociateChannelFlowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateChannelFlowResponse response = new AssociateChannelFlowResponse();
        ...
        internal static AssociateChannelFlowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateChannelFlowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
