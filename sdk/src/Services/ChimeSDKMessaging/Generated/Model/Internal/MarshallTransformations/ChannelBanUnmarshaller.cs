...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ChannelBanUnmarshaller : IJsonUnmarshaller<ChannelBan, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ChannelBan Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
