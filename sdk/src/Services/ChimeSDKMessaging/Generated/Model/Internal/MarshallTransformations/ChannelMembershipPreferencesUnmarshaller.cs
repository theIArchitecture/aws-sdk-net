...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    public class ChannelMembershipPreferencesUnmarshaller : IJsonUnmarshaller<ChannelMembershipPreferences, JsonUnmarshallerContext>
    {
        ...
        private static ChannelMembershipPreferencesUnmarshaller _instance = new ChannelMembershipPreferencesUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ChannelMembershipPreferencesUnmarshaller Instance
        {
            get
            {
                return _instance;
