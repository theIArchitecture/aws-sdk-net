...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteChannelFlowRequestMarshaller : IMarshaller<IRequest, DeleteChannelFlowRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteChannelFlowRequestMarshaller _instance = new DeleteChannelFlowRequestMarshaller();        

        internal static DeleteChannelFlowRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteChannelFlowRequestMarshaller Instance
        {
            get
            {
                return _instance;
