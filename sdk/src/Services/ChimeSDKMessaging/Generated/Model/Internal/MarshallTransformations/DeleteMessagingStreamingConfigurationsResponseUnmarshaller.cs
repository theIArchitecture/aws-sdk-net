...
{
    /// <summary>
    /// Response Unmarshaller for DeleteMessagingStreamingConfigurations operation
    /// </summary>  
    public class DeleteMessagingStreamingConfigurationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteMessagingStreamingConfigurationsResponse response = new DeleteMessagingStreamingConfigurationsResponse();
        ...
        private static DeleteMessagingStreamingConfigurationsResponseUnmarshaller _instance = new DeleteMessagingStreamingConfigurationsResponseUnmarshaller();        

        internal static DeleteMessagingStreamingConfigurationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteMessagingStreamingConfigurationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
