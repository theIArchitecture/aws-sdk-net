...
{
    /// <summary>
    /// Response Unmarshaller for DescribeChannelFlow operation
    /// </summary>  
    public class DescribeChannelFlowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeChannelFlowResponse response = new DescribeChannelFlowResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ChannelFlow", targetDepth))
                {
                    var unmarshaller = ChannelFlowUnmarshaller.Instance;
                    response.ChannelFlow = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeChannelFlowResponseUnmarshaller _instance = new DescribeChannelFlowResponseUnmarshaller();        

        internal static DescribeChannelFlowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeChannelFlowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
