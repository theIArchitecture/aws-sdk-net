...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateChannelFlow operation
    /// </summary>  
    public class DisassociateChannelFlowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateChannelFlowResponse response = new DisassociateChannelFlowResponse();
        ...
        private static DisassociateChannelFlowResponseUnmarshaller _instance = new DisassociateChannelFlowResponseUnmarshaller();        

        internal static DisassociateChannelFlowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateChannelFlowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
