...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetChannelMembershipPreferencesRequestMarshaller : IMarshaller<IRequest, GetChannelMembershipPreferencesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetChannelMembershipPreferencesRequestMarshaller _instance = new GetChannelMembershipPreferencesRequestMarshaller();        

        internal static GetChannelMembershipPreferencesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetChannelMembershipPreferencesRequestMarshaller Instance
        {
            get
            {
                return _instance;
