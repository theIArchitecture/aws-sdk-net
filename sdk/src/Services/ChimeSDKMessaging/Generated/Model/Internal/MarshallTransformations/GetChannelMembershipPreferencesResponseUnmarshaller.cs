...
{
    /// <summary>
    /// Response Unmarshaller for GetChannelMembershipPreferences operation
    /// </summary>  
    public class GetChannelMembershipPreferencesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetChannelMembershipPreferencesResponse response = new GetChannelMembershipPreferencesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Member", targetDepth))
                {
                    ...
                    response.Member = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("Preferences", targetDepth))
                {
                    var unmarshaller = ChannelMembershipPreferencesUnmarshaller.Instance;
                    response.Preferences = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetChannelMembershipPreferencesResponseUnmarshaller _instance = new GetChannelMembershipPreferencesResponseUnmarshaller();        

        internal static GetChannelMembershipPreferencesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetChannelMembershipPreferencesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
