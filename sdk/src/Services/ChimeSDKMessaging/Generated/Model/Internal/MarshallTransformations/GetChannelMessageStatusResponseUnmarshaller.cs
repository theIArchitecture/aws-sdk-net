...
{
    /// <summary>
    /// Response Unmarshaller for GetChannelMessageStatus operation
    /// </summary>  
    public class GetChannelMessageStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetChannelMessageStatusResponse response = new GetChannelMessageStatusResponse();
        ...
        private static GetChannelMessageStatusResponseUnmarshaller _instance = new GetChannelMessageStatusResponseUnmarshaller();        

        internal static GetChannelMessageStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetChannelMessageStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
