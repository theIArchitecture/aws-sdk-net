    ...
    public class ListChannelModeratorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ChannelModeratorSummary, ChannelModeratorSummaryUnmarshaller>(ChannelModeratorSummaryUnmarshaller.Instance);
                    response.ChannelModerators = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
