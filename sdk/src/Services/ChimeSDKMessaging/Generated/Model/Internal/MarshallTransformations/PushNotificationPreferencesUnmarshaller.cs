...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PushNotificationPreferencesUnmarshaller : IJsonUnmarshaller<PushNotificationPreferences, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PushNotificationPreferences Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AllowNotifications", targetDepth))
                {
                    ...
                    unmarshalledObject.AllowNotifications = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("FilterRule", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FilterRule = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
