...
{
    /// <summary>
    /// Response Unmarshaller for PutChannelExpirationSettings operation
    /// </summary>  
    public class PutChannelExpirationSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutChannelExpirationSettingsResponse response = new PutChannelExpirationSettingsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ExpirationSettings", targetDepth))
                {
                    ...
                    response.ExpirationSettings = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static PutChannelExpirationSettingsResponseUnmarshaller _instance = new PutChannelExpirationSettingsResponseUnmarshaller();        

        internal static PutChannelExpirationSettingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutChannelExpirationSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
