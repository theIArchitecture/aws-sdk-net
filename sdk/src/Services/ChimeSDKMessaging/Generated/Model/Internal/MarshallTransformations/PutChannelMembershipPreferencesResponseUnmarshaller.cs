...
{
    /// <summary>
    /// Response Unmarshaller for PutChannelMembershipPreferences operation
    /// </summary>  
    public class PutChannelMembershipPreferencesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutChannelMembershipPreferencesResponse response = new PutChannelMembershipPreferencesResponse();
        ...
        private static PutChannelMembershipPreferencesResponseUnmarshaller _instance = new PutChannelMembershipPreferencesResponseUnmarshaller();        

        internal static PutChannelMembershipPreferencesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutChannelMembershipPreferencesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
