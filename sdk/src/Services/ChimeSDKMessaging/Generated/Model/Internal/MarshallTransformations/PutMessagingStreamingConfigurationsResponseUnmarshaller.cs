...
{
    /// <summary>
    /// Response Unmarshaller for PutMessagingStreamingConfigurations operation
    /// </summary>  
    public class PutMessagingStreamingConfigurationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutMessagingStreamingConfigurationsResponse response = new PutMessagingStreamingConfigurationsResponse();
        ...
        private static PutMessagingStreamingConfigurationsResponseUnmarshaller _instance = new PutMessagingStreamingConfigurationsResponseUnmarshaller();        

        internal static PutMessagingStreamingConfigurationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutMessagingStreamingConfigurationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
