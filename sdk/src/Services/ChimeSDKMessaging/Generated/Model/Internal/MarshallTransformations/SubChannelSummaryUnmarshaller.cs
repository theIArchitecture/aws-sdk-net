...
namespace Amazon.ChimeSDKMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SubChannelSummaryUnmarshaller : IJsonUnmarshaller<SubChannelSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SubChannelSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("MembershipCount", targetDepth))
                {
                    ...
                    unmarshalledObject.MembershipCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
