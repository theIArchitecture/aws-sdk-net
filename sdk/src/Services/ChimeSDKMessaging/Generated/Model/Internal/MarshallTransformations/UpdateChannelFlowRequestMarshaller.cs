...
{
    /// <summary>
    /// UpdateChannelFlow Request Marshaller
    /// </summary>       
    public class UpdateChannelFlowRequestMarshaller : IMarshaller<IRequest, UpdateChannelFlowRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateChannelFlowRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateChannelFlowRequest publicRequest)
        {
        ...
        private static UpdateChannelFlowRequestMarshaller _instance = new UpdateChannelFlowRequestMarshaller();        

        internal static UpdateChannelFlowRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateChannelFlowRequestMarshaller Instance
        {
            get
            {
                return _instance;
