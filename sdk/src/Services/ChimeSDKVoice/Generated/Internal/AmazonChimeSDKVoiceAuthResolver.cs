...
namespace Amazon.ChimeSDKVoice.Internal
{
    ...
    public class AmazonChimeSDKVoiceAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonChimeSDKVoiceAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ChimeSDKVoice.
        /// </summary>
        public AmazonChimeSDKVoiceAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonChimeSDKVoiceAuthSchemeParameters
            {
    ...
    public class AmazonChimeSDKVoiceAuthSchemeResolver : IAuthSchemeResolver<AmazonChimeSDKVoiceAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonChimeSDKVoiceAuthSchemeParameters authParameters)
        {
