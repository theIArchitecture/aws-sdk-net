...
{
    /// <summary>
    /// Response Unmarshaller for CreateVoiceProfileDomain operation
    /// </summary>  
    public class CreateVoiceProfileDomainResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateVoiceProfileDomainResponse response = new CreateVoiceProfileDomainResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("VoiceProfileDomain", targetDepth))
                {
                    ...
                    response.VoiceProfileDomain = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateVoiceProfileDomainResponseUnmarshaller _instance = new CreateVoiceProfileDomainResponseUnmarshaller();        

        internal static CreateVoiceProfileDomainResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateVoiceProfileDomainResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
