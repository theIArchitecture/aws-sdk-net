...
{
    /// <summary>
    /// Response Unmarshaller for DeleteVoiceConnectorExternalSystemsConfiguration operation
    /// </summary>  
    public class DeleteVoiceConnectorExternalSystemsConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteVoiceConnectorExternalSystemsConfigurationResponse response = new DeleteVoiceConnectorExternalSystemsConfigurationResponse();
        ...
        private static DeleteVoiceConnectorExternalSystemsConfigurationResponseUnmarshaller _instance = new DeleteVoiceConnectorExternalSystemsConfigurationResponseUnmarshaller();        

        internal static DeleteVoiceConnectorExternalSystemsConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVoiceConnectorExternalSystemsConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
