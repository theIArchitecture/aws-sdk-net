...
{
    /// <summary>
    /// Response Unmarshaller for DeleteVoiceProfileDomain operation
    /// </summary>  
    public class DeleteVoiceProfileDomainResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteVoiceProfileDomainResponse response = new DeleteVoiceProfileDomainResponse();
        ...
        private static DeleteVoiceProfileDomainResponseUnmarshaller _instance = new DeleteVoiceProfileDomainResponseUnmarshaller();        

        internal static DeleteVoiceProfileDomainResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVoiceProfileDomainResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
