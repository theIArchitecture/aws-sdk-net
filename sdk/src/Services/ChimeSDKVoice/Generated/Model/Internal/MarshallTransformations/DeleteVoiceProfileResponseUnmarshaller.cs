...
namespace Amazon.ChimeSDKVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteVoiceProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteVoiceProfileResponse response = new DeleteVoiceProfileResponse();
        ...
        internal static DeleteVoiceProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVoiceProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
