...
namespace Amazon.ChimeSDKVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetSipMediaApplicationAlexaSkillConfigurationRequestMarshaller : IMarshaller<IRequest, GetSipMediaApplicationAlexaSkillConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetSipMediaApplicationAlexaSkillConfigurationRequestMarshaller _instance = new GetSipMediaApplicationAlexaSkillConfigurationRequestMarshaller();        

        internal static GetSipMediaApplicationAlexaSkillConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSipMediaApplicationAlexaSkillConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
