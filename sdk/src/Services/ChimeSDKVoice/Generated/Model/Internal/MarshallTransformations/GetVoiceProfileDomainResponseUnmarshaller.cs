...
namespace Amazon.ChimeSDKVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetVoiceProfileDomainResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetVoiceProfileDomainResponse response = new GetVoiceProfileDomainResponse();
        ...
        internal static GetVoiceProfileDomainResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetVoiceProfileDomainResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
