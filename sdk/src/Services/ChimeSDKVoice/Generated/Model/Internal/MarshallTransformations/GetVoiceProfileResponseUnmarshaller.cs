...
{
    /// <summary>
    /// Response Unmarshaller for GetVoiceProfile operation
    /// </summary>  
    public class GetVoiceProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetVoiceProfileResponse response = new GetVoiceProfileResponse();
        ...
        private static GetVoiceProfileResponseUnmarshaller _instance = new GetVoiceProfileResponseUnmarshaller();        

        internal static GetVoiceProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetVoiceProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
