    ...
    public class ListProxySessionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ProxySession, ProxySessionUnmarshaller>(ProxySessionUnmarshaller.Instance);
                    response.ProxySessions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
