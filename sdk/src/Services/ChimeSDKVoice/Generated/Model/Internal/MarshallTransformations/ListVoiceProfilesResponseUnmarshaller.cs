...
{
    /// <summary>
    /// Response Unmarshaller for ListVoiceProfiles operation
    /// </summary>  
    public class ListVoiceProfilesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListVoiceProfilesResponse response = new ListVoiceProfilesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<VoiceProfileSummary, VoiceProfileSummaryUnmarshaller>(VoiceProfileSummaryUnmarshaller.Instance);
                    response.VoiceProfiles = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListVoiceProfilesResponseUnmarshaller _instance = new ListVoiceProfilesResponseUnmarshaller();        

        internal static ListVoiceProfilesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListVoiceProfilesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
