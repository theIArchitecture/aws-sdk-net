...
namespace Amazon.ChimeSDKVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SipMediaApplicationAlexaSkillConfigurationUnmarshaller : IJsonUnmarshaller<SipMediaApplicationAlexaSkillConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            SipMediaApplicationAlexaSkillConfiguration unmarshalledObject = new SipMediaApplicationAlexaSkillConfiguration();
            ...
            {
                if (context.TestExpression("AlexaSkillIds", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.AlexaSkillIds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("AlexaSkillStatus", targetDepth))
                {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SipMediaApplicationAlexaSkillConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
