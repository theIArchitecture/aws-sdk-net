...
{
    /// <summary>
    /// Response Unmarshaller for UpdateVoiceProfileDomain operation
    /// </summary>  
    public class UpdateVoiceProfileDomainResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateVoiceProfileDomainResponse response = new UpdateVoiceProfileDomainResponse();
        ...
        private static UpdateVoiceProfileDomainResponseUnmarshaller _instance = new UpdateVoiceProfileDomainResponseUnmarshaller();        

        internal static UpdateVoiceProfileDomainResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateVoiceProfileDomainResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
