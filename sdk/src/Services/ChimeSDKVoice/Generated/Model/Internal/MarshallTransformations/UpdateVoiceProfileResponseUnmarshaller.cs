...
{
    /// <summary>
    /// Response Unmarshaller for UpdateVoiceProfile operation
    /// </summary>  
    public class UpdateVoiceProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateVoiceProfileResponse response = new UpdateVoiceProfileResponse();
        ...
        private static UpdateVoiceProfileResponseUnmarshaller _instance = new UpdateVoiceProfileResponseUnmarshaller();        

        internal static UpdateVoiceProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateVoiceProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
