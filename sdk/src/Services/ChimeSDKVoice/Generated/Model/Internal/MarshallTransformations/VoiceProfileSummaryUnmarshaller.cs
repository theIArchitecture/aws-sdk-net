...
namespace Amazon.ChimeSDKVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VoiceProfileSummaryUnmarshaller : IJsonUnmarshaller<VoiceProfileSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public VoiceProfileSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("VoiceProfileArn", targetDepth))
                {
                    ...
                    unmarshalledObject.VoiceProfileArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
