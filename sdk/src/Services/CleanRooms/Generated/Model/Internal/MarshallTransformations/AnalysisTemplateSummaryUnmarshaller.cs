...
{
    /// <summary>
    /// Response Unmarshaller for AnalysisTemplateSummary Object
    /// </summary>  
    public class AnalysisTemplateSummaryUnmarshaller : IJsonUnmarshaller<AnalysisTemplateSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AnalysisTemplateSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            AnalysisTemplateSummary unmarshalledObject = new AnalysisTemplateSummary();
        ...
        private static AnalysisTemplateSummaryUnmarshaller _instance = new AnalysisTemplateSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AnalysisTemplateSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
