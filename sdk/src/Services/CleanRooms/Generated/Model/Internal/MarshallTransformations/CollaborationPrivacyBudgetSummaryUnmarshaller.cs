...
{
    /// <summary>
    /// Response Unmarshaller for CollaborationPrivacyBudgetSummary Object
    /// </summary>  
    public class CollaborationPrivacyBudgetSummaryUnmarshaller : IJsonUnmarshaller<CollaborationPrivacyBudgetSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CollaborationPrivacyBudgetSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            CollaborationPrivacyBudgetSummary unmarshalledObject = new CollaborationPrivacyBudgetSummary();
        ...
        private static CollaborationPrivacyBudgetSummaryUnmarshaller _instance = new CollaborationPrivacyBudgetSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CollaborationPrivacyBudgetSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
