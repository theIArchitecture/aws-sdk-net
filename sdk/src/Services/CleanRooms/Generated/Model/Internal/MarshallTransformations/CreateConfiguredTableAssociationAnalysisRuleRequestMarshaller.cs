...
{
    /// <summary>
    /// CreateConfiguredTableAssociationAnalysisRule Request Marshaller
    /// </summary>       
    public class CreateConfiguredTableAssociationAnalysisRuleRequestMarshaller : IMarshaller<IRequest, CreateConfiguredTableAssociationAnalysisRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateConfiguredTableAssociationAnalysisRuleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateConfiguredTableAssociationAnalysisRuleRequest publicRequest)
        {
        ...
        private static CreateConfiguredTableAssociationAnalysisRuleRequestMarshaller _instance = new CreateConfiguredTableAssociationAnalysisRuleRequestMarshaller();        

        internal static CreateConfiguredTableAssociationAnalysisRuleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateConfiguredTableAssociationAnalysisRuleRequestMarshaller Instance
        {
            get
            {
                return _instance;
