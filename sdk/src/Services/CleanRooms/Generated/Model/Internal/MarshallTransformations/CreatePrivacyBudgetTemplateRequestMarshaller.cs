...
{
    /// <summary>
    /// CreatePrivacyBudgetTemplate Request Marshaller
    /// </summary>       
    public class CreatePrivacyBudgetTemplateRequestMarshaller : IMarshaller<IRequest, CreatePrivacyBudgetTemplateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreatePrivacyBudgetTemplateRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreatePrivacyBudgetTemplateRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetAutoRefresh())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.AutoRefresh);
            }
            ...
            if(publicRequest.IsSetPrivacyBudgetType())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.PrivacyBudgetType);
            }
        ...
        private static CreatePrivacyBudgetTemplateRequestMarshaller _instance = new CreatePrivacyBudgetTemplateRequestMarshaller();        

        internal static CreatePrivacyBudgetTemplateRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePrivacyBudgetTemplateRequestMarshaller Instance
        {
            get
            {
                return _instance;
