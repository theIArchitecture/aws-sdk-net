...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeletePrivacyBudgetTemplateRequestMarshaller : IMarshaller<IRequest, DeletePrivacyBudgetTemplateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeletePrivacyBudgetTemplateRequestMarshaller _instance = new DeletePrivacyBudgetTemplateRequestMarshaller();        

        internal static DeletePrivacyBudgetTemplateRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePrivacyBudgetTemplateRequestMarshaller Instance
        {
            get
            {
                return _instance;
