...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DifferentialPrivacyTemplateParametersOutputUnmarshaller : IJsonUnmarshaller<DifferentialPrivacyTemplateParametersOutput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DifferentialPrivacyTemplateParametersOutput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.UsersNoisePerQuery = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
