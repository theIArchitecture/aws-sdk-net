...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetCollaborationPrivacyBudgetTemplateRequestMarshaller : IMarshaller<IRequest, GetCollaborationPrivacyBudgetTemplateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetCollaborationPrivacyBudgetTemplateRequestMarshaller _instance = new GetCollaborationPrivacyBudgetTemplateRequestMarshaller();        

        internal static GetCollaborationPrivacyBudgetTemplateRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCollaborationPrivacyBudgetTemplateRequestMarshaller Instance
        {
            get
            {
                return _instance;
