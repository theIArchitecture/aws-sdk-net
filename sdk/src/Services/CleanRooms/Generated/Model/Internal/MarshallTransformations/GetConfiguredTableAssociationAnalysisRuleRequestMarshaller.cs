...
{
    /// <summary>
    /// GetConfiguredTableAssociationAnalysisRule Request Marshaller
    /// </summary>       
    public class GetConfiguredTableAssociationAnalysisRuleRequestMarshaller : IMarshaller<IRequest, GetConfiguredTableAssociationAnalysisRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetConfiguredTableAssociationAnalysisRuleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetConfiguredTableAssociationAnalysisRuleRequest publicRequest)
        {
        ...
        private static GetConfiguredTableAssociationAnalysisRuleRequestMarshaller _instance = new GetConfiguredTableAssociationAnalysisRuleRequestMarshaller();        

        internal static GetConfiguredTableAssociationAnalysisRuleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetConfiguredTableAssociationAnalysisRuleRequestMarshaller Instance
        {
            get
            {
                return _instance;
