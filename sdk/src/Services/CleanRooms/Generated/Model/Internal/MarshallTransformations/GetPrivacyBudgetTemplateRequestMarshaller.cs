...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetPrivacyBudgetTemplateRequestMarshaller : IMarshaller<IRequest, GetPrivacyBudgetTemplateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetPrivacyBudgetTemplateRequestMarshaller _instance = new GetPrivacyBudgetTemplateRequestMarshaller();        

        internal static GetPrivacyBudgetTemplateRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPrivacyBudgetTemplateRequestMarshaller Instance
        {
            get
            {
                return _instance;
