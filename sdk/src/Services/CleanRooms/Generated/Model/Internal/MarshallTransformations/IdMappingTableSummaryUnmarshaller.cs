...
{
    /// <summary>
    /// Response Unmarshaller for IdMappingTableSummary Object
    /// </summary>  
    public class IdMappingTableSummaryUnmarshaller : IJsonUnmarshaller<IdMappingTableSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IdMappingTableSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            IdMappingTableSummary unmarshalledObject = new IdMappingTableSummary();
        ...
        private static IdMappingTableSummaryUnmarshaller _instance = new IdMappingTableSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static IdMappingTableSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
