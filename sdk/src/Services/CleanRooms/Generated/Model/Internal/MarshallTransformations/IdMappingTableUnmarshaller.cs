...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IdMappingTableUnmarshaller : IJsonUnmarshaller<IdMappingTable, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            IdMappingTable unmarshalledObject = new IdMappingTable();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static IdMappingTableUnmarshaller Instance
        {
            get
            {
                return _instance;
