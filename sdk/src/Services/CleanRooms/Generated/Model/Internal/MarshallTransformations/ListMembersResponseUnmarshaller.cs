    ...
    public class ListMembersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<MemberSummary, MemberSummaryUnmarshaller>(MemberSummaryUnmarshaller.Instance);
                    response.MemberSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
