...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PaymentConfigurationUnmarshaller : IJsonUnmarshaller<PaymentConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PaymentConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = JobComputePaymentConfigUnmarshaller.Instance;
