...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ProtectedJobResultUnmarshaller : IJsonUnmarshaller<ProtectedJobResult, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            ProtectedJobResult unmarshalledObject = new ProtectedJobResult();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ProtectedJobResultUnmarshaller Instance
        {
            get
            {
                return _instance;
