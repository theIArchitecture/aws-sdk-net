...
namespace Amazon.CleanRooms.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateConfiguredAudienceModelAssociationRequestMarshaller : IMarshaller<IRequest, UpdateConfiguredAudienceModelAssociationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static UpdateConfiguredAudienceModelAssociationRequestMarshaller _instance = new UpdateConfiguredAudienceModelAssociationRequestMarshaller();        

        internal static UpdateConfiguredAudienceModelAssociationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateConfiguredAudienceModelAssociationRequestMarshaller Instance
        {
            get
            {
                return _instance;
