...
{
    /// <summary>
    /// UpdateConfiguredTableAssociationAnalysisRule Request Marshaller
    /// </summary>       
    public class UpdateConfiguredTableAssociationAnalysisRuleRequestMarshaller : IMarshaller<IRequest, UpdateConfiguredTableAssociationAnalysisRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateConfiguredTableAssociationAnalysisRuleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateConfiguredTableAssociationAnalysisRuleRequest publicRequest)
        {
        ...
        private static UpdateConfiguredTableAssociationAnalysisRuleRequestMarshaller _instance = new UpdateConfiguredTableAssociationAnalysisRuleRequestMarshaller();        

        internal static UpdateConfiguredTableAssociationAnalysisRuleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateConfiguredTableAssociationAnalysisRuleRequestMarshaller Instance
        {
            get
            {
                return _instance;
