...
{
    /// <summary>
    /// Container for the parameters to the ListCollaborationIdNamespaceAssociations operation.
    /// Returns a list of the ID namespace associations in a collaboration.
    /// </summary>
    public partial class ListCollaborationIdNamespaceAssociationsRequest : AmazonCleanRoomsRequest
    {
        ...
        /// <para>
        /// The unique identifier of the collaboration that contains the ID namespace associations
