...
namespace Amazon.CleanRooms.Model
{
    ...
    internal sealed partial class ListConfiguredTableAssociationsPaginator : IPaginator<ListConfiguredTableAssociationsResponse>, IListConfiguredTableAssociationsPaginator
    {
        ...
        public IPaginatedEnumerable<ConfiguredTableAssociationSummary> ConfiguredTableAssociationSummaries => 
            new PaginatedResultKeyResponse<ListConfiguredTableAssociationsResponse, ConfiguredTableAssociationSummary>(this, (i) => i.ConfiguredTableAssociationSummaries ?? new List<ConfiguredTableAssociationSummary>());
        ...
        async IAsyncEnumerable<ListConfiguredTableAssociationsResponse> IPaginator<ListConfiguredTableAssociationsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
