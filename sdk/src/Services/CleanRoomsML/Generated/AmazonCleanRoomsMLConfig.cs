...
namespace Amazon.CleanRoomsML
{
    ...
    public partial class AmazonCleanRoomsMLConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("CleanRoomsML", "4.0.4.4");
        ...
        /// Default constructor
        /// </summary>
        public AmazonCleanRoomsMLConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonCleanRoomsMLDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "CleanRoomsML";
            this.AuthenticationServiceName = "cleanrooms-ml";
            this.EndpointProvider = new AmazonCleanRoomsMLEndpointProvider();
        }
