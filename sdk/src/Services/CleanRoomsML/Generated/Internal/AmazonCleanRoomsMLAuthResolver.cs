...
namespace Amazon.CleanRoomsML.Internal
{
    ...
    public class AmazonCleanRoomsMLAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCleanRoomsMLAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CleanRoomsML.
        /// </summary>
        public AmazonCleanRoomsMLAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCleanRoomsMLAuthSchemeParameters
            {
    ...
    public class AmazonCleanRoomsMLAuthSchemeResolver : IAuthSchemeResolver<AmazonCleanRoomsMLAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCleanRoomsMLAuthSchemeParameters authParameters)
        {
