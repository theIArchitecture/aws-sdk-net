...
namespace Amazon.CleanRoomsML.Model.Internal.MarshallTransformations
{
    ...
    public class AudienceQualityMetricsUnmarshaller : IJsonUnmarshaller<AudienceQualityMetrics, JsonUnmarshallerContext>
    {
        ...
        private static AudienceQualityMetricsUnmarshaller _instance = new AudienceQualityMetricsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AudienceQualityMetricsUnmarshaller Instance
        {
            get
            {
                return _instance;
