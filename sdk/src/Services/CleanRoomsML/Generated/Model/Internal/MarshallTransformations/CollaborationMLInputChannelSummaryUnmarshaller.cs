...
{
    /// <summary>
    /// Response Unmarshaller for CollaborationMLInputChannelSummary Object
    /// </summary>  
    public class CollaborationMLInputChannelSummaryUnmarshaller : IJsonUnmarshaller<CollaborationMLInputChannelSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CollaborationMLInputChannelSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            CollaborationMLInputChannelSummary unmarshalledObject = new CollaborationMLInputChannelSummary();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("configuredModelAlgorithmAssociations", targetDepth))
                {
                    ...
                    unmarshalledObject.ConfiguredModelAlgorithmAssociations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CollaborationMLInputChannelSummaryUnmarshaller _instance = new CollaborationMLInputChannelSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CollaborationMLInputChannelSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
