...
{
    /// <summary>
    /// Response Unmarshaller for CollaborationTrainedModelInferenceJobSummary Object
    /// </summary>  
    public class CollaborationTrainedModelInferenceJobSummaryUnmarshaller : IJsonUnmarshaller<CollaborationTrainedModelInferenceJobSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CollaborationTrainedModelInferenceJobSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            CollaborationTrainedModelInferenceJobSummary unmarshalledObject = new CollaborationTrainedModelInferenceJobSummary();
        ...
        private static CollaborationTrainedModelInferenceJobSummaryUnmarshaller _instance = new CollaborationTrainedModelInferenceJobSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CollaborationTrainedModelInferenceJobSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
