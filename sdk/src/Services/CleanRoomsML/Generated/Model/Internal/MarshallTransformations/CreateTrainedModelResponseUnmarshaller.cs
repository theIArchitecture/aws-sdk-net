...
{
    /// <summary>
    /// Response Unmarshaller for CreateTrainedModel operation
    /// </summary>  
    public class CreateTrainedModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTrainedModelResponse response = new CreateTrainedModelResponse();
        ...
        private static CreateTrainedModelResponseUnmarshaller _instance = new CreateTrainedModelResponseUnmarshaller();        

        internal static CreateTrainedModelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTrainedModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
