    ...
    public class DataSourceMarshaller : IRequestMarshaller<DataSource, JsonMarshallerContext> 
    {
        ...
        public void Marshall(DataSource requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetGlueDataSource())
            {
                context.Writer.WritePropertyName("glueDataSource");
                context.Writer.WriteStartObject();

                var marshaller = GlueDataSourceMarshaller.Instance;
                marshaller.Marshall(requestObject.GlueDataSource, context);
