...
namespace Amazon.CleanRoomsML.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteAudienceGenerationJobRequestMarshaller : IMarshaller<IRequest, DeleteAudienceGenerationJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteAudienceGenerationJobRequestMarshaller _instance = new DeleteAudienceGenerationJobRequestMarshaller();        

        internal static DeleteAudienceGenerationJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAudienceGenerationJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
