...
{
    /// <summary>
    /// DeleteConfiguredModelAlgorithmAssociation Request Marshaller
    /// </summary>       
    public class DeleteConfiguredModelAlgorithmAssociationRequestMarshaller : IMarshaller<IRequest, DeleteConfiguredModelAlgorithmAssociationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteConfiguredModelAlgorithmAssociationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteConfiguredModelAlgorithmAssociationRequest publicRequest)
        {
        ...
        private static DeleteConfiguredModelAlgorithmAssociationRequestMarshaller _instance = new DeleteConfiguredModelAlgorithmAssociationRequestMarshaller();        

        internal static DeleteConfiguredModelAlgorithmAssociationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteConfiguredModelAlgorithmAssociationRequestMarshaller Instance
        {
            get
            {
                return _instance;
