...
namespace Amazon.CleanRoomsML.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteMLConfigurationRequestMarshaller : IMarshaller<IRequest, DeleteMLConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteMLConfigurationRequestMarshaller _instance = new DeleteMLConfigurationRequestMarshaller();        

        internal static DeleteMLConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteMLConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
