...
namespace Amazon.CleanRoomsML.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteTrainingDatasetRequestMarshaller : IMarshaller<IRequest, DeleteTrainingDatasetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteTrainingDatasetRequestMarshaller _instance = new DeleteTrainingDatasetRequestMarshaller();        

        internal static DeleteTrainingDatasetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTrainingDatasetRequestMarshaller Instance
        {
            get
            {
                return _instance;
