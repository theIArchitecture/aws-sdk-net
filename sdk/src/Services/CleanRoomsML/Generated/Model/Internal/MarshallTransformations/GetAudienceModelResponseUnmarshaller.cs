...
{
    /// <summary>
    /// Response Unmarshaller for GetAudienceModel operation
    /// </summary>  
    public class GetAudienceModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAudienceModelResponse response = new GetAudienceModelResponse();
        ...
        private static GetAudienceModelResponseUnmarshaller _instance = new GetAudienceModelResponseUnmarshaller();        

        internal static GetAudienceModelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAudienceModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
