...
{
    /// <summary>
    /// Response Unmarshaller for GetCollaborationMLInputChannel operation
    /// </summary>  
    public class GetCollaborationMLInputChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCollaborationMLInputChannelResponse response = new GetCollaborationMLInputChannelResponse();
        ...
        private static GetCollaborationMLInputChannelResponseUnmarshaller _instance = new GetCollaborationMLInputChannelResponseUnmarshaller();        

        internal static GetCollaborationMLInputChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCollaborationMLInputChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
