...
{
    /// <summary>
    /// GetCollaborationTrainedModel Request Marshaller
    /// </summary>       
    public class GetCollaborationTrainedModelRequestMarshaller : IMarshaller<IRequest, GetCollaborationTrainedModelRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetCollaborationTrainedModelRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetCollaborationTrainedModelRequest publicRequest)
        {
            ...
            request.ResourcePath = "/collaborations/{collaborationIdentifier}/trained-models/{trainedModelArn}";
            request.UseQueryString = true;

            return request;
        }
        private static GetCollaborationTrainedModelRequestMarshaller _instance = new GetCollaborationTrainedModelRequestMarshaller();        

        internal static GetCollaborationTrainedModelRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCollaborationTrainedModelRequestMarshaller Instance
        {
            get
            {
                return _instance;
