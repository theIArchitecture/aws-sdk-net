...
{
    /// <summary>
    /// Response Unmarshaller for GetCollaborationTrainedModel operation
    /// </summary>  
    public class GetCollaborationTrainedModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCollaborationTrainedModelResponse response = new GetCollaborationTrainedModelResponse();
        ...
        private static GetCollaborationTrainedModelResponseUnmarshaller _instance = new GetCollaborationTrainedModelResponseUnmarshaller();        

        internal static GetCollaborationTrainedModelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCollaborationTrainedModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
