...
{
    /// <summary>
    /// Response Unmarshaller for GetConfiguredAudienceModelPolicy operation
    /// </summary>  
    public class GetConfiguredAudienceModelPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetConfiguredAudienceModelPolicyResponse response = new GetConfiguredAudienceModelPolicyResponse();
        ...
        private static GetConfiguredAudienceModelPolicyResponseUnmarshaller _instance = new GetConfiguredAudienceModelPolicyResponseUnmarshaller();        

        internal static GetConfiguredAudienceModelPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetConfiguredAudienceModelPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
