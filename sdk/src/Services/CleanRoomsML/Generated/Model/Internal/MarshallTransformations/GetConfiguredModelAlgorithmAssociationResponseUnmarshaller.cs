...
{
    /// <summary>
    /// Response Unmarshaller for GetConfiguredModelAlgorithmAssociation operation
    /// </summary>  
    public class GetConfiguredModelAlgorithmAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetConfiguredModelAlgorithmAssociationResponse response = new GetConfiguredModelAlgorithmAssociationResponse();
        ...
        private static GetConfiguredModelAlgorithmAssociationResponseUnmarshaller _instance = new GetConfiguredModelAlgorithmAssociationResponseUnmarshaller();        

        internal static GetConfiguredModelAlgorithmAssociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetConfiguredModelAlgorithmAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
