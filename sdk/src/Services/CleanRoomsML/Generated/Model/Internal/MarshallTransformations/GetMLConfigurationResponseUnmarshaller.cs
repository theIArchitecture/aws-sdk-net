...
{
    /// <summary>
    /// Response Unmarshaller for GetMLConfiguration operation
    /// </summary>  
    public class GetMLConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMLConfigurationResponse response = new GetMLConfigurationResponse();
        ...
        private static GetMLConfigurationResponseUnmarshaller _instance = new GetMLConfigurationResponseUnmarshaller();        

        internal static GetMLConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMLConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
