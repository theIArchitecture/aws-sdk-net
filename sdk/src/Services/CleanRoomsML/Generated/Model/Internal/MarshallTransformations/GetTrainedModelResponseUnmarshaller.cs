...
{
    /// <summary>
    /// Response Unmarshaller for GetTrainedModel operation
    /// </summary>  
    public class GetTrainedModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTrainedModelResponse response = new GetTrainedModelResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("dataChannels", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<ModelTrainingDataChannel, ModelTrainingDataChannelUnmarshaller>(ModelTrainingDataChannelUnmarshaller.Instance);
                    response.DataChannels = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("trainingContainerImageDigest", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static GetTrainedModelResponseUnmarshaller _instance = new GetTrainedModelResponseUnmarshaller();        

        internal static GetTrainedModelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTrainedModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
