...
{
    /// <summary>
    /// Response Unmarshaller for GetTrainingDataset operation
    /// </summary>  
    public class GetTrainingDatasetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTrainingDatasetResponse response = new GetTrainingDatasetResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("trainingData", targetDepth))
                {
                    ...
                    response.TrainingData = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("trainingDatasetArn", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TrainingDatasetArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetTrainingDatasetResponseUnmarshaller _instance = new GetTrainingDatasetResponseUnmarshaller();        

        internal static GetTrainingDatasetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTrainingDatasetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
