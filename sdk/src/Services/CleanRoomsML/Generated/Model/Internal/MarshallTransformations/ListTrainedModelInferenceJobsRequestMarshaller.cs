...
{
    /// <summary>
    /// ListTrainedModelInferenceJobs Request Marshaller
    /// </summary>       
    public class ListTrainedModelInferenceJobsRequestMarshaller : IMarshaller<IRequest, ListTrainedModelInferenceJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListTrainedModelInferenceJobsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListTrainedModelInferenceJobsRequest publicRequest)
        {
        ...
        private static ListTrainedModelInferenceJobsRequestMarshaller _instance = new ListTrainedModelInferenceJobsRequestMarshaller();        

        internal static ListTrainedModelInferenceJobsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTrainedModelInferenceJobsRequestMarshaller Instance
        {
            get
            {
                return _instance;
