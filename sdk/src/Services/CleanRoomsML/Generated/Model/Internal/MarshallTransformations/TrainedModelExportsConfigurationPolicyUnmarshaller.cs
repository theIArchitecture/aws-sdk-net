...
namespace Amazon.CleanRoomsML.Model.Internal.MarshallTransformations
{
    ...
    public class TrainedModelExportsConfigurationPolicyUnmarshaller : IJsonUnmarshaller<TrainedModelExportsConfigurationPolicy, JsonUnmarshallerContext>
    {
        ...
        private static TrainedModelExportsConfigurationPolicyUnmarshaller _instance = new TrainedModelExportsConfigurationPolicyUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TrainedModelExportsConfigurationPolicyUnmarshaller Instance
        {
            get
            {
                return _instance;
