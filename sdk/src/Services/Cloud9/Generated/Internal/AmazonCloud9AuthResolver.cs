...
namespace Amazon.Cloud9.Internal
{
    ...
    public class AmazonCloud9AuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCloud9AuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Cloud9.
        /// </summary>
        public AmazonCloud9AuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCloud9AuthSchemeParameters
            {
    ...
    public class AmazonCloud9AuthSchemeResolver : IAuthSchemeResolver<AmazonCloud9AuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCloud9AuthSchemeParameters authParameters)
        {
