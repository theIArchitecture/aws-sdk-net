...
namespace Amazon.Cloud9.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConcurrentAccessExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<ConcurrentAccessException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public ConcurrentAccessException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public ConcurrentAccessException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
