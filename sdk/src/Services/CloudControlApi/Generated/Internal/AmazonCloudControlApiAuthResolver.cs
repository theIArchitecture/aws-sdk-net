...
namespace Amazon.CloudControlApi.Internal
{
    ...
    public class AmazonCloudControlApiAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCloudControlApiAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CloudControlApi.
        /// </summary>
        public AmazonCloudControlApiAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCloudControlApiAuthSchemeParameters
            {
    ...
    public class AmazonCloudControlApiAuthSchemeResolver : IAuthSchemeResolver<AmazonCloudControlApiAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCloudControlApiAuthSchemeParameters authParameters)
        {
