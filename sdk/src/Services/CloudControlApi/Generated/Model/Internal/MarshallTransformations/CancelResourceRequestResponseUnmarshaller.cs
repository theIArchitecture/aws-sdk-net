...
{
    /// <summary>
    /// Response Unmarshaller for CancelResourceRequest operation
    /// </summary>  
    public class CancelResourceRequestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelResourceRequestResponse response = new CancelResourceRequestResponse();
        ...
        private static CancelResourceRequestResponseUnmarshaller _instance = new CancelResourceRequestResponseUnmarshaller();        

        internal static CancelResourceRequestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelResourceRequestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
