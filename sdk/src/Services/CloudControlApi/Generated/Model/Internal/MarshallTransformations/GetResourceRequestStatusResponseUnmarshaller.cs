...
{
    /// <summary>
    /// Response Unmarshaller for GetResourceRequestStatus operation
    /// </summary>  
    public class GetResourceRequestStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetResourceRequestStatusResponse response = new GetResourceRequestStatusResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("RequestTokenNotFoundException"))
                {
                    return RequestTokenNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
            }
        ...
        private static GetResourceRequestStatusResponseUnmarshaller _instance = new GetResourceRequestStatusResponseUnmarshaller();        

        internal static GetResourceRequestStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetResourceRequestStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
