...
namespace Amazon.CloudControlApi.Model.Internal.MarshallTransformations
{
    ...
    public class ListResourcesRequestMarshaller : IMarshaller<IRequest, ListResourcesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListResourcesRequest publicRequest)
        {
            ...
            string target = "CloudApiService.ListResources";
            ...
            if(publicRequest.IsSetResourceModel())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ResourceModel);
            }
            ...
            if(publicRequest.IsSetTypeVersionId())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.TypeVersionId);
            }
