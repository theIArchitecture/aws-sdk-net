...
{
    /// <summary>
    /// Response Unmarshaller for ResourceDescription Object
    /// </summary>  
    public class ResourceDescriptionUnmarshaller : IJsonUnmarshaller<ResourceDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResourceDescription Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static ResourceDescriptionUnmarshaller _instance = new ResourceDescriptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ResourceDescriptionUnmarshaller Instance
        {
            get
            {
                return _instance;
