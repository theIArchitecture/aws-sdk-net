...
namespace Amazon.CloudDirectory.Internal
{
    ...
    public class AmazonCloudDirectoryAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCloudDirectoryAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CloudDirectory.
        /// </summary>
        public AmazonCloudDirectoryAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCloudDirectoryAuthSchemeParameters
            {
    ...
    public class AmazonCloudDirectoryAuthSchemeResolver : IAuthSchemeResolver<AmazonCloudDirectoryAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCloudDirectoryAuthSchemeParameters authParameters)
        {
