...
namespace Amazon.CloudDirectory.Model
{
    ...
    public partial class FacetValidationException : AmazonCloudDirectoryException
    {
        ...
        public FacetValidationException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public FacetValidationException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
