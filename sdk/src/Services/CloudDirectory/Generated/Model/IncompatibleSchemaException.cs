...
namespace Amazon.CloudDirectory.Model
{
    ...
    public partial class IncompatibleSchemaException : AmazonCloudDirectoryException
    {
        ...
        public IncompatibleSchemaException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public IncompatibleSchemaException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
