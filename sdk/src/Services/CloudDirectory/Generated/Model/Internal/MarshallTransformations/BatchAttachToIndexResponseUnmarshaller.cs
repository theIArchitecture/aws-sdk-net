...
namespace Amazon.CloudDirectory.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchAttachToIndexResponseUnmarshaller : IJsonUnmarshaller<BatchAttachToIndexResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchAttachToIndexResponse Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AttachedObjectIdentifier", targetDepth))
                {
                    ...
                    unmarshalledObject.AttachedObjectIdentifier = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
