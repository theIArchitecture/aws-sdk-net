...
namespace Amazon.CloudDirectory.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchListObjectPoliciesResponseUnmarshaller : IJsonUnmarshaller<BatchListObjectPoliciesResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchListObjectPoliciesResponse Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AttachedPolicyIds", targetDepth))
                {
                    ...
                    unmarshalledObject.AttachedPolicyIds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
