...
namespace Amazon.CloudDirectory.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FacetUnmarshaller : IJsonUnmarshaller<Facet, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Facet Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("FacetStyle", targetDepth))
                {
                    ...
                    unmarshalledObject.FacetStyle = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
