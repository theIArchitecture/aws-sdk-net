...
namespace Amazon.CloudDirectory.Model
{
    ...
    public partial class RetryableConflictException : AmazonCloudDirectoryException
    {
        ...
        public RetryableConflictException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public RetryableConflictException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
