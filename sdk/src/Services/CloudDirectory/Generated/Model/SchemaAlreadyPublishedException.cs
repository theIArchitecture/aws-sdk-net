...
namespace Amazon.CloudDirectory.Model
{
    ...
    public partial class SchemaAlreadyPublishedException : AmazonCloudDirectoryException
    {
        ...
        public SchemaAlreadyPublishedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public SchemaAlreadyPublishedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
