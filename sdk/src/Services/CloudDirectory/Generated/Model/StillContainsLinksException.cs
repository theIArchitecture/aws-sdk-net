...
namespace Amazon.CloudDirectory.Model
{
    ...
    public partial class StillContainsLinksException : AmazonCloudDirectoryException
    {
        ...
        public StillContainsLinksException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public StillContainsLinksException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
