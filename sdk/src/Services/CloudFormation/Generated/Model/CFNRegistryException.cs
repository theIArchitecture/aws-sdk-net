...
namespace Amazon.CloudFormation.Model
{
    ...
    public partial class CFNRegistryException : AmazonCloudFormationException
    {
        ...
        public CFNRegistryException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CFNRegistryException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
