...
namespace Amazon.CloudFormation.Model
{
    ...
    public partial class CreatedButModifiedException : AmazonCloudFormationException
    {
        ...
        public CreatedButModifiedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CreatedButModifiedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
