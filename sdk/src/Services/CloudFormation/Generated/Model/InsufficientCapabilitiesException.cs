...
namespace Amazon.CloudFormation.Model
{
    ...
    public partial class InsufficientCapabilitiesException : AmazonCloudFormationException
    {
        ...
        public InsufficientCapabilitiesException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InsufficientCapabilitiesException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
