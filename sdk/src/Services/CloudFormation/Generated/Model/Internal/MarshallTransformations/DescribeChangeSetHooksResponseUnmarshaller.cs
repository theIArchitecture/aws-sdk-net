...
{
    /// <summary>
    /// Response Unmarshaller for DescribeChangeSetHooks operation
    /// </summary>  
    public class DescribeChangeSetHooksResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeChangeSetHooksResponse response = new DescribeChangeSetHooksResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeChangeSetHooksResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, DescribeChangeSetHooksResponse response)
        {
        ...
        private static DescribeChangeSetHooksResponseUnmarshaller _instance = new DescribeChangeSetHooksResponseUnmarshaller();        

        internal static DescribeChangeSetHooksResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeChangeSetHooksResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
