...
namespace Amazon.CloudFormation.Model.Internal.MarshallTransformations
{
    ...
    public class ManagedExecutionUnmarshaller : IXmlUnmarshaller<ManagedExecution, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ManagedExecution Unmarshall(XmlUnmarshallerContext context)
        {
            ManagedExecution unmarshalledObject = new ManagedExecution();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ManagedExecutionUnmarshaller Instance
        {
            get
            {
                return _instance;
