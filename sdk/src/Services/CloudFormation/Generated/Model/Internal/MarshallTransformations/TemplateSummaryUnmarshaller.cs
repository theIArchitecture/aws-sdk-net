...
namespace Amazon.CloudFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TemplateSummaryUnmarshaller : IXmlUnmarshaller<TemplateSummary, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public TemplateSummary Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("GeneratedTemplateId", targetDepth))
                    {
                        ...
                        unmarshalledObject.GeneratedTemplateId = unmarshaller.Unmarshall(context);
                        continue;
                    }
                    if (context.TestExpression("GeneratedTemplateName", targetDepth))
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.GeneratedTemplateName = unmarshaller.Unmarshall(context);
                        continue;
                    }
                    ...
                    if (context.TestExpression("NumberOfResources", targetDepth))
                    {
                        ...
                        unmarshalledObject.NumberOfResources = unmarshaller.Unmarshall(context);
                        continue;
                    }
