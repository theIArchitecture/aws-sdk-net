...
{
    /// <summary>
    /// TestType Request Marshaller
    /// </summary>       
    public class TestTypeRequestMarshaller : IMarshaller<IRequest, TestTypeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((TestTypeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(TestTypeRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudFormation");
            request.Parameters.Add("Action", "TestType");
        ...
        internal static TestTypeRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TestTypeRequestMarshaller Instance
        {
            get
            {
                return _instance;
