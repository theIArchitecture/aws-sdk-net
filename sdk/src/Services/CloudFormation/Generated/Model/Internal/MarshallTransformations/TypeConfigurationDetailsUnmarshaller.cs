...
namespace Amazon.CloudFormation.Model.Internal.MarshallTransformations
{
    ...
    public class TypeConfigurationDetailsUnmarshaller : IXmlUnmarshaller<TypeConfigurationDetails, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public TypeConfigurationDetails Unmarshall(XmlUnmarshallerContext context)
        {
            TypeConfigurationDetails unmarshalledObject = new TypeConfigurationDetails();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("IsDefaultConfiguration", targetDepth))
                    {
                        ...
                        unmarshalledObject.IsDefaultConfiguration = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TypeConfigurationDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
