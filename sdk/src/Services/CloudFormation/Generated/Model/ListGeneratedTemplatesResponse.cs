...
namespace Amazon.CloudFormation.Model
{
    ...
    /// </summary>
    public partial class ListGeneratedTemplatesResponse : AmazonWebServiceResponse
    {
        private string _nextToken;
        private List<TemplateSummary> _summaries = AWSConfigs.InitializeCollections ? new List<TemplateSummary>() : null;

        /// <summary>
        /// Gets and sets the property NextToken. 
        /// <para>
        /// If the request doesn't return all the remaining results, <c>NextToken</c> is set to
        /// a token. To retrieve the next set of results, call <c>ListGeneratedTemplates</c> again
        ...
        /// </summary>
        public List<TemplateSummary> Summaries
        {
