...
{
    /// <summary>
    /// Container for the parameters to the ListStackRefactorActions operation.
    /// Lists the stack refactor actions that will be taken after calling the <a>ExecuteStackRefactor</a>
    /// action.
    /// </summary>
    public partial class ListStackRefactorActionsRequest : AmazonCloudFormationRequest
    {
