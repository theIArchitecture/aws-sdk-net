...
namespace Amazon.CloudFormation.Model
{
    ...
    public partial class StackSetNotEmptyException : AmazonCloudFormationException
    {
        ...
        public StackSetNotEmptyException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public StackSetNotEmptyException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
