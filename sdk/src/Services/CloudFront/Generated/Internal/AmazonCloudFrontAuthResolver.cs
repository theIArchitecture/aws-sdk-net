...
namespace Amazon.CloudFront.Internal
{
    ...
    public class AmazonCloudFrontAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCloudFrontAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CloudFront.
        /// </summary>
        public AmazonCloudFrontAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCloudFrontAuthSchemeParameters
            {
    ...
    public class AmazonCloudFrontAuthSchemeResolver : IAuthSchemeResolver<AmazonCloudFrontAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCloudFrontAuthSchemeParameters authParameters)
        {
