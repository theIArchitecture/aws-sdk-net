...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class CachePolicyAlreadyExistsException : AmazonCloudFrontException
    {
        ...
        public CachePolicyAlreadyExistsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CachePolicyAlreadyExistsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
