...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class CannotChangeImmutablePublicKeyFieldsException : AmazonCloudFrontException
    {
        ...
        public CannotChangeImmutablePublicKeyFieldsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CannotChangeImmutablePublicKeyFieldsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
