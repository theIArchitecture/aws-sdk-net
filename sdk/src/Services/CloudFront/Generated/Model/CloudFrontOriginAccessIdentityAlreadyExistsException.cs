...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class CloudFrontOriginAccessIdentityAlreadyExistsException : AmazonCloudFrontException
    {
        ...
        public CloudFrontOriginAccessIdentityAlreadyExistsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CloudFrontOriginAccessIdentityAlreadyExistsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
