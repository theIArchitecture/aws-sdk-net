...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class ContinuousDeploymentPolicyInUseException : AmazonCloudFrontException
    {
        ...
        public ContinuousDeploymentPolicyInUseException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ContinuousDeploymentPolicyInUseException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
