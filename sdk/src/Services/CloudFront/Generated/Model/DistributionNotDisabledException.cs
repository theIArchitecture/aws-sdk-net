...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class DistributionNotDisabledException : AmazonCloudFrontException
    {
        ...
        public DistributionNotDisabledException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DistributionNotDisabledException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
