...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class IllegalFieldLevelEncryptionConfigAssociationWithCacheBehaviorException : AmazonCloudFrontException
    {
        ...
        public IllegalFieldLevelEncryptionConfigAssociationWithCacheBehaviorException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public IllegalFieldLevelEncryptionConfigAssociationWithCacheBehaviorException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
