...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public partial class AnycastIpListCollectionUnmarshaller : IXmlUnmarshaller<AnycastIpListCollection, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public AnycastIpListCollection Unmarshall(XmlUnmarshallerContext context)
        {
            AnycastIpListCollection unmarshalledObject = new AnycastIpListCollection();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("Items/AnycastIpListSummary", targetDepth))
                    {
                        if (unmarshalledObject.Items == null)
                        {
                            unmarshalledObject.Items = new List<AnycastIpListSummary>();
                        }
                        var unmarshaller = AnycastIpListSummaryUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AnycastIpListCollectionUnmarshaller Instance
        {
            get
            {
                return _instance;
