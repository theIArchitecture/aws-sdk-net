...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public partial class AssociateDistributionTenantWebACLResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        {
            AssociateDistributionTenantWebACLResponse response = new AssociateDistributionTenantWebACLResponse();
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, AssociateDistributionTenantWebACLResponse response)
        {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateDistributionTenantWebACLResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
