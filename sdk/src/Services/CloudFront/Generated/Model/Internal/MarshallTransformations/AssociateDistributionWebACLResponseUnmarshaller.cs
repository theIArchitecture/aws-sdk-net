...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public partial class AssociateDistributionWebACLResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        {
            AssociateDistributionWebACLResponse response = new AssociateDistributionWebACLResponse();
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, AssociateDistributionWebACLResponse response)
        {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateDistributionWebACLResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
