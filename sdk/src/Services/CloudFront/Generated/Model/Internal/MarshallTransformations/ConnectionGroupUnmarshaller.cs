...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public partial class ConnectionGroupUnmarshaller : IXmlUnmarshaller<ConnectionGroup, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ConnectionGroup Unmarshall(XmlUnmarshallerContext context)
        {
            ConnectionGroup unmarshalledObject = new ConnectionGroup();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("Ipv6Enabled", targetDepth))
                    {
                        var unmarshaller = NullableBoolUnmarshaller.Instance;
                        unmarshalledObject.Ipv6Enabled = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ConnectionGroupUnmarshaller Instance
        {
            get
            {
                return _instance;
