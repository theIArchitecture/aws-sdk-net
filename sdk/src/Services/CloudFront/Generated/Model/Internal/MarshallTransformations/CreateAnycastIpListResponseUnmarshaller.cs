...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public partial class CreateAnycastIpListResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        {
            CreateAnycastIpListResponse response = new CreateAnycastIpListResponse();
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, CreateAnycastIpListResponse response)
        {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAnycastIpListResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
