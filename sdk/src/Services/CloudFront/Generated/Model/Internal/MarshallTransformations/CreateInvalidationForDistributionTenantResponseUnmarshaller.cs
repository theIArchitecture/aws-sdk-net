...
{
    /// <summary>
    /// Response Unmarshaller for CreateInvalidationForDistributionTenant operation
    /// </summary>  
    public partial class CreateInvalidationForDistributionTenantResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateInvalidationForDistributionTenantResponse response = new CreateInvalidationForDistributionTenantResponse();
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, CreateInvalidationForDistributionTenantResponse response)
        {
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, CreateInvalidationForDistributionTenantResponse response);

        private static CreateInvalidationForDistributionTenantResponseUnmarshaller _instance = new CreateInvalidationForDistributionTenantResponseUnmarshaller();        

        internal static CreateInvalidationForDistributionTenantResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateInvalidationForDistributionTenantResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
