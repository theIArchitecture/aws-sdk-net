...
{
    /// <summary>
    /// Response Unmarshaller for CreateKeyValueStore operation
    /// </summary>  
    public partial class CreateKeyValueStoreResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateKeyValueStoreResponse response = new CreateKeyValueStoreResponse();
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, CreateKeyValueStoreResponse response);

        private static CreateKeyValueStoreResponseUnmarshaller _instance = new CreateKeyValueStoreResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateKeyValueStoreResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
