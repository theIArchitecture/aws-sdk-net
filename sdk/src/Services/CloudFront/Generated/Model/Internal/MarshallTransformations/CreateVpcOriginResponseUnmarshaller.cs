...
{
    /// <summary>
    /// Response Unmarshaller for CreateVpcOrigin operation
    /// </summary>  
    public partial class CreateVpcOriginResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateVpcOriginResponse response = new CreateVpcOriginResponse();
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, CreateVpcOriginResponse response)
        {
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, CreateVpcOriginResponse response);

        private static CreateVpcOriginResponseUnmarshaller _instance = new CreateVpcOriginResponseUnmarshaller();        

        internal static CreateVpcOriginResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateVpcOriginResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
