...
{
    /// <summary>
    /// Response Unmarshaller for DescribeFunction operation
    /// </summary>  
    public partial class DescribeFunctionResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeFunctionResponse response = new DescribeFunctionResponse();
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, DescribeFunctionResponse response);

        private static DescribeFunctionResponseUnmarshaller _instance = new DescribeFunctionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeFunctionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
