...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public partial class DisassociateDistributionWebACLRequestMarshaller : IMarshaller<IRequest, DisassociateDistributionWebACLRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((DisassociateDistributionWebACLRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DisassociateDistributionWebACLRequest publicRequest)
        {
        ...
        internal static DisassociateDistributionWebACLRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateDistributionWebACLRequestMarshaller Instance
        {
            get
            {
                return _instance;
