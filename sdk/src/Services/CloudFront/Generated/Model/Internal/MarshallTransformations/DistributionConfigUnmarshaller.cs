...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public partial class DistributionConfigUnmarshaller : IXmlUnmarshaller<DistributionConfig, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        public DistributionConfig Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("TenantConfig", targetDepth))
                    {
                        var unmarshaller = TenantConfigUnmarshaller.Instance;
                        unmarshalledObject.TenantConfig = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        partial void XmlStructureUnmarshallCustomization(XmlUnmarshallerContext context, DistributionConfig unmarshalledObject, int targetDepth);
