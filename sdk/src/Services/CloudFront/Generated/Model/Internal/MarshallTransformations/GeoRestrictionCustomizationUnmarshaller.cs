...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public partial class GeoRestrictionCustomizationUnmarshaller : IXmlUnmarshaller<GeoRestrictionCustomization, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public GeoRestrictionCustomization Unmarshall(XmlUnmarshallerContext context)
        {
            GeoRestrictionCustomization unmarshalledObject = new GeoRestrictionCustomization();
            ...
            while (context.Read())
            {
                ...
                {
                    if (context.TestExpression("Locations/Location", targetDepth))
                    {
                        if (unmarshalledObject.Locations == null)
                        {
                            unmarshalledObject.Locations = new List<string>();
                        }
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.Locations.Add(unmarshaller.Unmarshall(context));
                        continue;
                    }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GeoRestrictionCustomizationUnmarshaller Instance
        {
            get
            {
                return _instance;
