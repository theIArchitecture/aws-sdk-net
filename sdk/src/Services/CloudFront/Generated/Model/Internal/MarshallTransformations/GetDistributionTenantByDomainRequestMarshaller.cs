...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public partial class GetDistributionTenantByDomainRequestMarshaller : IMarshaller<IRequest, GetDistributionTenantByDomainRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((GetDistributionTenantByDomainRequest)input);
        }
        ...
        internal static GetDistributionTenantByDomainRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDistributionTenantByDomainRequestMarshaller Instance
        {
            get
            {
                return _instance;
