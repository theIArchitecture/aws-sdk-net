...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public partial class GetInvalidationForDistributionTenantRequestMarshaller : IMarshaller<IRequest, GetInvalidationForDistributionTenantRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((GetInvalidationForDistributionTenantRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetInvalidationForDistributionTenantRequest publicRequest)
        {
            var request = new DefaultRequest(publicRequest, "Amazon.CloudFront");
            request.HttpMethod = "GET";
            if (!publicRequest.IsSetDistributionTenantId())
                throw new AmazonCloudFrontException("Request object does not have required field DistributionTenantId set");
            request.AddPathResource("{DistributionTenantId}", StringUtils.FromString(publicRequest.DistributionTenantId));
        ...
        internal static GetInvalidationForDistributionTenantRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetInvalidationForDistributionTenantRequestMarshaller Instance
        {
            get
            {
                return _instance;
