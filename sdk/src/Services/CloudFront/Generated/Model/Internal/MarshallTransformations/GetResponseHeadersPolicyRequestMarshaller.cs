...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public partial class GetResponseHeadersPolicyRequestMarshaller : IMarshaller<IRequest, GetResponseHeadersPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((GetResponseHeadersPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetResponseHeadersPolicyRequest publicRequest)
        {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetResponseHeadersPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
