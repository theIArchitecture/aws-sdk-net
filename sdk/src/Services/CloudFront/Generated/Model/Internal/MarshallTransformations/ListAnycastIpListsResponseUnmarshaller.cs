...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public partial class ListAnycastIpListsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, ListAnycastIpListsResponse response)
        {
            ...
            while (context.Read())
            {
                ...
                {
                    if (context.TestExpression("AnycastIpListCollection", targetDepth))
                    {
                        var unmarshaller = AnycastIpListCollectionUnmarshaller.Instance;
                        response.AnycastIpLists = unmarshaller.Unmarshall(context);
                        continue;
                    }
                    if (context.TestExpression("AnycastIpListCollection", targetDepth))
                    {
        ...
        internal static ListAnycastIpListsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAnycastIpListsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
