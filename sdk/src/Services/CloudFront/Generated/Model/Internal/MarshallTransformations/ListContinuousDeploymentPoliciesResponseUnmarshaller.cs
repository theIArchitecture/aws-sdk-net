...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public partial class ListContinuousDeploymentPoliciesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, ListContinuousDeploymentPoliciesResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = ContinuousDeploymentPolicyListUnmarshaller.Instance;
                        response.ContinuousDeploymentPolicyList = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListContinuousDeploymentPoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
