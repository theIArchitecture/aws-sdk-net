...
{
    /// <summary>
    /// ListDistributionTenants Request Marshaller
    /// </summary>       
    public partial class ListDistributionTenantsRequestMarshaller : IMarshaller<IRequest, ListDistributionTenantsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListDistributionTenantsRequest)input);
        }
            ...
            {   
                ...
                if (publicRequest.AssociationFilter != null)
                {
                    ...
                    if(publicRequest.AssociationFilter.IsSetConnectionGroupId())
                        xmlWriter.WriteElementString("ConnectionGroupId", StringUtils.FromString(publicRequest.AssociationFilter.ConnectionGroupId));
                    if(publicRequest.AssociationFilter.IsSetDistributionId())
        ...
        internal static ListDistributionTenantsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDistributionTenantsRequestMarshaller Instance
        {
            get
            {
                return _instance;
