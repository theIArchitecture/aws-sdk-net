...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public partial class ListDistributionsByConnectionModeResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, ListDistributionsByConnectionModeResponse response)
        {
        ...
        internal static ListDistributionsByConnectionModeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDistributionsByConnectionModeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
