...
{
    /// <summary>
    /// ListDistributionsByVpcOriginId Request Marshaller
    /// </summary>       
    public partial class ListDistributionsByVpcOriginIdRequestMarshaller : IMarshaller<IRequest, ListDistributionsByVpcOriginIdRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListDistributionsByVpcOriginIdRequest)input);
        }
        ...
        public IRequest Marshall(ListDistributionsByVpcOriginIdRequest publicRequest)
        {
            ...
            request.AddPathResource("{VpcOriginId}", StringUtils.FromString(publicRequest.VpcOriginId));
        ...
        internal static ListDistributionsByVpcOriginIdRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDistributionsByVpcOriginIdRequestMarshaller Instance
        {
            get
            {
                return _instance;
