...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public partial class OriginAccessControlConfigUnmarshaller : IXmlUnmarshaller<OriginAccessControlConfig, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public OriginAccessControlConfig Unmarshall(XmlUnmarshallerContext context)
        {
            OriginAccessControlConfig unmarshalledObject = new OriginAccessControlConfig();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static OriginAccessControlConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
