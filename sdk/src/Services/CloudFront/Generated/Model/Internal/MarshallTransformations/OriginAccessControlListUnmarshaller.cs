...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public partial class OriginAccessControlListUnmarshaller : IXmlUnmarshaller<OriginAccessControlList, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public OriginAccessControlList Unmarshall(XmlUnmarshallerContext context)
        {
            OriginAccessControlList unmarshalledObject = new OriginAccessControlList();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("Items/OriginAccessControlSummary", targetDepth))
                    {
                        if (unmarshalledObject.Items == null)
                        {
                            unmarshalledObject.Items = new List<OriginAccessControlSummary>();
                        }
                        var unmarshaller = OriginAccessControlSummaryUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>  
        public static OriginAccessControlListUnmarshaller Instance
        {
            get
            {
                return _instance;
