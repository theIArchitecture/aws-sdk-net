...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public partial class OriginsUnmarshaller : IXmlUnmarshaller<Origins, XmlUnmarshallerContext>
    {
        /// <summary>
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("Items/Origin", targetDepth))
                    {
                        ...
                        {
                            unmarshalledObject.Items = new List<Origin>();
                        }
        ...
        partial void XmlStructureUnmarshallCustomization(XmlUnmarshallerContext context, Origins unmarshalledObject, int targetDepth);
