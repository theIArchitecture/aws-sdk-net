...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public partial class ParameterDefinitionSchemaUnmarshaller : IXmlUnmarshaller<ParameterDefinitionSchema, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ParameterDefinitionSchema Unmarshall(XmlUnmarshallerContext context)
        {
            ParameterDefinitionSchema unmarshalledObject = new ParameterDefinitionSchema();
            ...
            while (context.Read())
            {
                ...
                {
                    if (context.TestExpression("StringSchema", targetDepth))
                    {
                        var unmarshaller = StringSchemaConfigUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ParameterDefinitionSchemaUnmarshaller Instance
        {
            get
            {
                return _instance;
