...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public partial class ResponseHeadersPolicyConfigUnmarshaller : IXmlUnmarshaller<ResponseHeadersPolicyConfig, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ResponseHeadersPolicyConfig Unmarshall(XmlUnmarshallerContext context)
        {
            ResponseHeadersPolicyConfig unmarshalledObject = new ResponseHeadersPolicyConfig();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = ResponseHeadersPolicyCorsConfigUnmarshaller.Instance;
                        unmarshalledObject.CorsConfig = unmarshaller.Unmarshall(context);
                        continue;
                    }
                    if (context.TestExpression("CustomHeadersConfig", targetDepth))
                    {
                        var unmarshaller = ResponseHeadersPolicyCustomHeadersConfigUnmarshaller.Instance;
                        unmarshalledObject.CustomHeadersConfig = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ResponseHeadersPolicyConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
