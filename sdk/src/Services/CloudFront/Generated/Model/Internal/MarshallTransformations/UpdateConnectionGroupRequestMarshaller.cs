...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public partial class UpdateConnectionGroupRequestMarshaller : IMarshaller<IRequest, UpdateConnectionGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((UpdateConnectionGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateConnectionGroupRequest publicRequest)
        {
            ...
            {   
                xmlWriter.WriteStartElement("UpdateConnectionGroupRequest", "http://cloudfront.amazonaws.com/doc/2020-05-31/");
        ...
        internal static UpdateConnectionGroupRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateConnectionGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
