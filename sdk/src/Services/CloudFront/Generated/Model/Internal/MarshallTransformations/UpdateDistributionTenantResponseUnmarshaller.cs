...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDistributionTenant operation
    /// </summary>  
    public partial class UpdateDistributionTenantResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDistributionTenantResponse response = new UpdateDistributionTenantResponse();
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, UpdateDistributionTenantResponse response)
        {
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, UpdateDistributionTenantResponse response);

        private static UpdateDistributionTenantResponseUnmarshaller _instance = new UpdateDistributionTenantResponseUnmarshaller();        

        internal static UpdateDistributionTenantResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDistributionTenantResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
