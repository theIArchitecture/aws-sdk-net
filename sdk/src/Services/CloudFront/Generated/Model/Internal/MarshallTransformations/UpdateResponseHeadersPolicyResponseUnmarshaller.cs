...
{
    /// <summary>
    /// Response Unmarshaller for UpdateResponseHeadersPolicy operation
    /// </summary>  
    public partial class UpdateResponseHeadersPolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateResponseHeadersPolicyResponse response = new UpdateResponseHeadersPolicyResponse();
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, UpdateResponseHeadersPolicyResponse response);

        private static UpdateResponseHeadersPolicyResponseUnmarshaller _instance = new UpdateResponseHeadersPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateResponseHeadersPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
