...
{
    /// <summary>
    /// Response Unmarshaller for UpdateVpcOrigin operation
    /// </summary>  
    public partial class UpdateVpcOriginResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateVpcOriginResponse response = new UpdateVpcOriginResponse();
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, UpdateVpcOriginResponse response)
        {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("CannotUpdateEntityWhileInUse"))
                {
                    return CannotUpdateEntityWhileInUseExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, UpdateVpcOriginResponse response);

        private static UpdateVpcOriginResponseUnmarshaller _instance = new UpdateVpcOriginResponseUnmarshaller();        

        internal static UpdateVpcOriginResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateVpcOriginResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
