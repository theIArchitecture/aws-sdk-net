...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class InvalidDefaultRootObjectException : AmazonCloudFrontException
    {
        ...
        public InvalidDefaultRootObjectException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidDefaultRootObjectException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
