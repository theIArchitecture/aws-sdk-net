...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class InvalidDomainNameForOriginAccessControlException : AmazonCloudFrontException
    {
        ...
        public InvalidDomainNameForOriginAccessControlException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidDomainNameForOriginAccessControlException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
