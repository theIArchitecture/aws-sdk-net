...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class InvalidForwardCookiesException : AmazonCloudFrontException
    {
        ...
        public InvalidForwardCookiesException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidForwardCookiesException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
