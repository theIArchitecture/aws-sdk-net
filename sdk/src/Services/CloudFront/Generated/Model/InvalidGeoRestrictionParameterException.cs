...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class InvalidGeoRestrictionParameterException : AmazonCloudFrontException
    {
        ...
        public InvalidGeoRestrictionParameterException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidGeoRestrictionParameterException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
