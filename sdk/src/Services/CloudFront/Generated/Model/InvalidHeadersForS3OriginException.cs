...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class InvalidHeadersForS3OriginException : AmazonCloudFrontException
    {
        ...
        public InvalidHeadersForS3OriginException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidHeadersForS3OriginException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
