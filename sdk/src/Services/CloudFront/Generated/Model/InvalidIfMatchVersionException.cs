...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class InvalidIfMatchVersionException : AmazonCloudFrontException
    {
        ...
        public InvalidIfMatchVersionException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidIfMatchVersionException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
