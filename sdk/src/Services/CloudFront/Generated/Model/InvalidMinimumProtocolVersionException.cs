...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class InvalidMinimumProtocolVersionException : AmazonCloudFrontException
    {
        ...
        public InvalidMinimumProtocolVersionException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidMinimumProtocolVersionException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
