...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class InvalidOriginAccessControlException : AmazonCloudFrontException
    {
        ...
        public InvalidOriginAccessControlException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidOriginAccessControlException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
