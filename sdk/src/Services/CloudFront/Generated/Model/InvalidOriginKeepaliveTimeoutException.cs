...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class InvalidOriginKeepaliveTimeoutException : AmazonCloudFrontException
    {
        ...
        public InvalidOriginKeepaliveTimeoutException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidOriginKeepaliveTimeoutException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
