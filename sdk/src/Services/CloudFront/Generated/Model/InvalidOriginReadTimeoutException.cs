...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class InvalidOriginReadTimeoutException : AmazonCloudFrontException
    {
        ...
        public InvalidOriginReadTimeoutException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidOriginReadTimeoutException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
