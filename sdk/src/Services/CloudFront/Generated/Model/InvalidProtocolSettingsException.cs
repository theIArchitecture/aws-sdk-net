...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class InvalidProtocolSettingsException : AmazonCloudFrontException
    {
        ...
        public InvalidProtocolSettingsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidProtocolSettingsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
