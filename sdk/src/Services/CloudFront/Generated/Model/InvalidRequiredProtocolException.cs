...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class InvalidRequiredProtocolException : AmazonCloudFrontException
    {
        ...
        public InvalidRequiredProtocolException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidRequiredProtocolException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
