...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class InvalidViewerCertificateException : AmazonCloudFrontException
    {
        ...
        public InvalidViewerCertificateException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidViewerCertificateException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
