...
namespace Amazon.CloudFront.Model
{
    ...
    /// </summary>
    public partial class ListKeyValueStoresResponse : AmazonWebServiceResponse
    {
        ...
        {
            get { return this._keyValueStoreList; }
            set { this._keyValueStoreList = value; }
        }

        // Check to see if KeyValueStoreList property is set
        internal bool IsSetKeyValueStoreList()
        {
            return this._keyValueStoreList != null;
        }
