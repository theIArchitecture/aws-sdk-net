...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class MissingBodyException : AmazonCloudFrontException
    {
        ...
        public MissingBodyException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public MissingBodyException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
