...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class MonitoringSubscriptionAlreadyExistsException : AmazonCloudFrontException
    {
        ...
        public MonitoringSubscriptionAlreadyExistsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public MonitoringSubscriptionAlreadyExistsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
