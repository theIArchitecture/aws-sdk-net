...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class NoSuchCloudFrontOriginAccessIdentityException : AmazonCloudFrontException
    {
        ...
        public NoSuchCloudFrontOriginAccessIdentityException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NoSuchCloudFrontOriginAccessIdentityException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
