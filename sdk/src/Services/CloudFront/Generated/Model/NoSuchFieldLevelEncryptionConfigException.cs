...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class NoSuchFieldLevelEncryptionConfigException : AmazonCloudFrontException
    {
        ...
        public NoSuchFieldLevelEncryptionConfigException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NoSuchFieldLevelEncryptionConfigException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
