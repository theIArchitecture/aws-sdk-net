...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class NoSuchFieldLevelEncryptionProfileException : AmazonCloudFrontException
    {
        ...
        public NoSuchFieldLevelEncryptionProfileException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NoSuchFieldLevelEncryptionProfileException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
