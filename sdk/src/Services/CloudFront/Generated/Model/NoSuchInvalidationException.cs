...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class NoSuchInvalidationException : AmazonCloudFrontException
    {
        ...
        public NoSuchInvalidationException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NoSuchInvalidationException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
