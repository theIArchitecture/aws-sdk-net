...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class NoSuchMonitoringSubscriptionException : AmazonCloudFrontException
    {
        ...
        public NoSuchMonitoringSubscriptionException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NoSuchMonitoringSubscriptionException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
