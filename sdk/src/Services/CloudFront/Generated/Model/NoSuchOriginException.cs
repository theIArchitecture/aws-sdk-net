...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class NoSuchOriginException : AmazonCloudFrontException
    {
        ...
        public NoSuchOriginException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NoSuchOriginException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
