...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class OriginRequestPolicyAlreadyExistsException : AmazonCloudFrontException
    {
        ...
        public OriginRequestPolicyAlreadyExistsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public OriginRequestPolicyAlreadyExistsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
