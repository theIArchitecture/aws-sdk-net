...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class StreamingDistributionNotDisabledException : AmazonCloudFrontException
    {
        ...
        public StreamingDistributionNotDisabledException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public StreamingDistributionNotDisabledException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
