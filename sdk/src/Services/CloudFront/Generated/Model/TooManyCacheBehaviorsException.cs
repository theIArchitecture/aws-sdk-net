...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class TooManyCacheBehaviorsException : AmazonCloudFrontException
    {
        ...
        public TooManyCacheBehaviorsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TooManyCacheBehaviorsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
