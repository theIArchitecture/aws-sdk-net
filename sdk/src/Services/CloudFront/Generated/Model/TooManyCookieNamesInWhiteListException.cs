...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class TooManyCookieNamesInWhiteListException : AmazonCloudFrontException
    {
        ...
        public TooManyCookieNamesInWhiteListException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TooManyCookieNamesInWhiteListException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
