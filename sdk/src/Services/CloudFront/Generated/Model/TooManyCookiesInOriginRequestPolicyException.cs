...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class TooManyCookiesInOriginRequestPolicyException : AmazonCloudFrontException
    {
        ...
        public TooManyCookiesInOriginRequestPolicyException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TooManyCookiesInOriginRequestPolicyException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
