...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class TooManyInvalidationsInProgressException : AmazonCloudFrontException
    {
        ...
        public TooManyInvalidationsInProgressException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TooManyInvalidationsInProgressException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
