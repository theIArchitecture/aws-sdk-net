...
namespace Amazon.CloudFront.Model
{
    ...
    public partial class VpcOriginSummary
    {
        ...
        /// <summary>
        /// Gets and sets the property OriginEndpointArn. 
        /// <para>
        ...
        {
            get { return this._originEndpointArn; }
            set { this._originEndpointArn = value; }
        }

        // Check to see if OriginEndpointArn property is set
        internal bool IsSetOriginEndpointArn()
        {
            return this._originEndpointArn != null;
        }
