...
namespace Amazon.CloudFrontKeyValueStore.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteKeyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        internal static DeleteKeyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
