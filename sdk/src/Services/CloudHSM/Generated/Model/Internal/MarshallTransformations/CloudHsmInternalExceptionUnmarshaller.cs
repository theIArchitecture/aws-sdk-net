...
namespace Amazon.CloudHSM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CloudHsmInternalExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<CloudHsmInternalException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public CloudHsmInternalException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public CloudHsmInternalException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
