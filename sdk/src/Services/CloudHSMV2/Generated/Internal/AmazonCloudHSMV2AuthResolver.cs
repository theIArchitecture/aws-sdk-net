...
namespace Amazon.CloudHSMV2.Internal
{
    ...
    public class AmazonCloudHSMV2AuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCloudHSMV2AuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CloudHSMV2.
        /// </summary>
        public AmazonCloudHSMV2AuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCloudHSMV2AuthSchemeParameters
            {
    ...
    public class AmazonCloudHSMV2AuthSchemeResolver : IAuthSchemeResolver<AmazonCloudHSMV2AuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCloudHSMV2AuthSchemeParameters authParameters)
        {
