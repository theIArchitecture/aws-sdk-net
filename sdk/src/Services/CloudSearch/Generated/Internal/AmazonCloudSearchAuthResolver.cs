...
namespace Amazon.CloudSearch.Internal
{
    ...
    public class AmazonCloudSearchAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCloudSearchAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CloudSearch.
        /// </summary>
        public AmazonCloudSearchAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCloudSearchAuthSchemeParameters
            {
    ...
    public class AmazonCloudSearchAuthSchemeResolver : IAuthSchemeResolver<AmazonCloudSearchAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCloudSearchAuthSchemeParameters authParameters)
        {
