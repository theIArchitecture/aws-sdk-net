...
namespace Amazon.CloudSearch.Model.Internal.MarshallTransformations
{
    ...
    public class ResourceAlreadyExistsExceptionUnmarshaller : IXmlErrorResponseUnmarshaller<ResourceAlreadyExistsException, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ResourceAlreadyExistsException Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public ResourceAlreadyExistsException Unmarshall(XmlUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse)
        {
            ResourceAlreadyExistsException response = new ResourceAlreadyExistsException(errorResponse.Message, errorResponse.InnerException, 
