...
namespace Amazon.CloudSearchDomain
{
    ...
    public partial class AmazonCloudSearchDomainException : AmazonServiceException
    {
        ...
        public AmazonCloudSearchDomainException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonCloudSearchDomainException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
