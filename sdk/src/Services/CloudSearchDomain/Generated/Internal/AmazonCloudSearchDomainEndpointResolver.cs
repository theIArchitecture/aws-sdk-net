...
{
    /// <summary>
    /// Amazon CloudSearchDomain endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for CloudSearchDomain service requests.
    /// Collects values for CloudSearchDomainEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses CloudSearchDomainEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonCloudSearchDomainEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonCloudSearchDomainConfig)requestContext.ClientConfig;
            var result = new CloudSearchDomainEndpointParameters();
