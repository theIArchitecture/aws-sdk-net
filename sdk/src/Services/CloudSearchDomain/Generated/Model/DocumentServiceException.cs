...
namespace Amazon.CloudSearchDomain.Model
{
    ...
    public partial class DocumentServiceException : AmazonCloudSearchDomainException
    {
        ...
        public DocumentServiceException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DocumentServiceException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
