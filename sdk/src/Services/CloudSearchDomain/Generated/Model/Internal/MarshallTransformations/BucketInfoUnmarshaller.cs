...
namespace Amazon.CloudSearchDomain.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BucketInfoUnmarshaller : IJsonUnmarshaller<BucketInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BucketInfo Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
