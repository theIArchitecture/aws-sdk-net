...
namespace Amazon.CloudSearchDomain.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SuggestStatusUnmarshaller : IJsonUnmarshaller<SuggestStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SuggestStatus Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
