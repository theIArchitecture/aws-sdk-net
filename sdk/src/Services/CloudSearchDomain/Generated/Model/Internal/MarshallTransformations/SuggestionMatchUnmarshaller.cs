...
namespace Amazon.CloudSearchDomain.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SuggestionMatchUnmarshaller : IJsonUnmarshaller<SuggestionMatch, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SuggestionMatch Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
