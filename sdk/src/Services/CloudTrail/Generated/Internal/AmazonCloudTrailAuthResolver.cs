...
namespace Amazon.CloudTrail.Internal
{
    ...
    public class AmazonCloudTrailAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCloudTrailAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CloudTrail.
        /// </summary>
        public AmazonCloudTrailAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCloudTrailAuthSchemeParameters
            {
    ...
    public class AmazonCloudTrailAuthSchemeResolver : IAuthSchemeResolver<AmazonCloudTrailAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCloudTrailAuthSchemeParameters authParameters)
        {
