...
namespace Amazon.CloudTrail.Model
{
    ...
    public partial class CloudTrailAccessNotEnabledException : AmazonCloudTrailException
    {
        ...
        public CloudTrailAccessNotEnabledException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CloudTrailAccessNotEnabledException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
