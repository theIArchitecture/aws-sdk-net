...
namespace Amazon.CloudTrail.Model
{
    ...
    public partial class CloudTrailInvalidClientTokenIdException : AmazonCloudTrailException
    {
        ...
        public CloudTrailInvalidClientTokenIdException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CloudTrailInvalidClientTokenIdException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
