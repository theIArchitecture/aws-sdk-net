...
{
    /// <summary>
    /// CreateEventDataStore Request Marshaller
    /// </summary>       
    public class CreateEventDataStoreRequestMarshaller : IMarshaller<IRequest, CreateEventDataStoreRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateEventDataStoreRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateEventDataStoreRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudTrail");
            string target = "com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.CreateEventDataStore";
            ...
            if(publicRequest.IsSetStartIngestion())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.StartIngestion.Value);
            }
        ...
        private static CreateEventDataStoreRequestMarshaller _instance = new CreateEventDataStoreRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateEventDataStoreRequestMarshaller Instance
        {
            get
            {
                return _instance;
