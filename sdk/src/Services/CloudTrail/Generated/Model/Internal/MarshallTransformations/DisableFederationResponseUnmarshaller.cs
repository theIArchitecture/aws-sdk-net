...
{
    /// <summary>
    /// Response Unmarshaller for DisableFederation operation
    /// </summary>  
    public class DisableFederationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisableFederationResponse response = new DisableFederationResponse();
        ...
        private static DisableFederationResponseUnmarshaller _instance = new DisableFederationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisableFederationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
