...
{
    /// <summary>
    /// Response Unmarshaller for GetEventDataStore operation
    /// </summary>  
    public class GetEventDataStoreResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetEventDataStoreResponseUnmarshaller _instance = new GetEventDataStoreResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEventDataStoreResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
