...
{
    /// <summary>
    /// Response Unmarshaller for ListEventDataStores operation
    /// </summary>  
    public class ListEventDataStoresResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListEventDataStoresResponse response = new ListEventDataStoresResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<EventDataStore, EventDataStoreUnmarshaller>(EventDataStoreUnmarshaller.Instance);
                    response.EventDataStores = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListEventDataStoresResponseUnmarshaller _instance = new ListEventDataStoresResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListEventDataStoresResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
