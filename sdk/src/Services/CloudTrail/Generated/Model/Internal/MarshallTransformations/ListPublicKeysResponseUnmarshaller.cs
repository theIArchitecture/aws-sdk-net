    ...
    public class ListPublicKeysResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<PublicKey, PublicKeyUnmarshaller>(PublicKeyUnmarshaller.Instance);
                    response.PublicKeyList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
