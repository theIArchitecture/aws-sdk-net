...
namespace Amazon.CloudTrail.Model.Internal.MarshallTransformations
{
    ...
    public class ListQueriesRequestMarshaller : IMarshaller<IRequest, ListQueriesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListQueriesRequest publicRequest)
        {
            ...
            string target = "com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.ListQueries";
            ...
            if(publicRequest.IsSetQueryStatus())
            {
                context.Writer.WritePropertyName("QueryStatus");
                context.Writer.WriteStringValue(publicRequest.QueryStatus);
            }
