...
{
    /// <summary>
    /// Response Unmarshaller for ListQueries operation
    /// </summary>  
    public class ListQueriesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListQueriesResponse response = new ListQueriesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<Query, QueryUnmarshaller>(QueryUnmarshaller.Instance);
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidDateRangeException"))
                {
                    return InvalidDateRangeExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidQueryStatusException"))
                {
                    return InvalidQueryStatusExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static ListQueriesResponseUnmarshaller _instance = new ListQueriesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListQueriesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
