    ...
    public class ListTrailsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<TrailInfo, TrailInfoUnmarshaller>(TrailInfoUnmarshaller.Instance);
                    response.Trails = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
