...
{
    /// <summary>
    /// Response Unmarshaller for RestoreEventDataStore operation
    /// </summary>  
    public class RestoreEventDataStoreResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RestoreEventDataStoreResponse response = new RestoreEventDataStoreResponse();
        ...
        private static RestoreEventDataStoreResponseUnmarshaller _instance = new RestoreEventDataStoreResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RestoreEventDataStoreResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
