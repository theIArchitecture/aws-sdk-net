...
{
    /// <summary>
    /// Response Unmarshaller for StartDashboardRefresh operation
    /// </summary>  
    public class StartDashboardRefreshResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartDashboardRefreshResponse response = new StartDashboardRefreshResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("RefreshId", targetDepth))
                {
                    ...
                    response.RefreshId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static StartDashboardRefreshResponseUnmarshaller _instance = new StartDashboardRefreshResponseUnmarshaller();        

        internal static StartDashboardRefreshResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartDashboardRefreshResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
