...
{
    /// <summary>
    /// Response Unmarshaller for StartEventDataStoreIngestion operation
    /// </summary>  
    public class StartEventDataStoreIngestionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartEventDataStoreIngestionResponse response = new StartEventDataStoreIngestionResponse();
        ...
        private static StartEventDataStoreIngestionResponseUnmarshaller _instance = new StartEventDataStoreIngestionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartEventDataStoreIngestionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
