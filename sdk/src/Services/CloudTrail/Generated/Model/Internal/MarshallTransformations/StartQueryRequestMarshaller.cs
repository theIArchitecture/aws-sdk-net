...
namespace Amazon.CloudTrail.Model.Internal.MarshallTransformations
{
    ...
    public class StartQueryRequestMarshaller : IMarshaller<IRequest, StartQueryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(StartQueryRequest publicRequest)
        {
            ...
            string target = "com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.StartQuery";
            ...
            if(publicRequest.IsSetDeliveryS3Uri())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.DeliveryS3Uri);
            }
            ...
            if(publicRequest.IsSetQueryParameters())
            {
                ...
                {
                        context.Writer.WriteStringValue(publicRequestQueryParametersListValue);
                }
