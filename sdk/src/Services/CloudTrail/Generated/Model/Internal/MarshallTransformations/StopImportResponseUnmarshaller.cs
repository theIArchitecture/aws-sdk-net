...
{
    /// <summary>
    /// Response Unmarshaller for StopImport operation
    /// </summary>  
    public class StopImportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    response.EndEventTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("ImportSource", targetDepth))
                {
                    ...
                    response.ImportSource = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ImportStatistics", targetDepth))
                {
                    var unmarshaller = ImportStatisticsUnmarshaller.Instance;
                    response.ImportStatistics = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    response.StartEventTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static StopImportResponseUnmarshaller _instance = new StopImportResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopImportResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
