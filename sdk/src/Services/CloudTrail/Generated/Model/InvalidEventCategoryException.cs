...
namespace Amazon.CloudTrail.Model
{
    ...
    public partial class InvalidEventCategoryException : AmazonCloudTrailException
    {
        ...
        public InvalidEventCategoryException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidEventCategoryException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
