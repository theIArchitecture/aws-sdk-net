...
namespace Amazon.CloudTrail.Model
{
    ...
    {
        private List<DashboardDetail> _dashboards = AWSConfigs.InitializeCollections ? new List<DashboardDetail>() : null;
        private string _nextToken;

        /// <summary>
        /// Gets and sets the property Dashboards. 
        /// <para>
        ///  Contains information about dashboards in the account, in the current Region that
        ...
        /// </summary>
        public List<DashboardDetail> Dashboards
        {
