...
namespace Amazon.CloudTrail.Model
{
    ...
    public partial class ResourcePolicyNotValidException : AmazonCloudTrailException
    {
        ...
        public ResourcePolicyNotValidException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ResourcePolicyNotValidException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
