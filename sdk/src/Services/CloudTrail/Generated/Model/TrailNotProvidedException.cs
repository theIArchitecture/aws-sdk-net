...
namespace Amazon.CloudTrail.Model
{
    ...
    public partial class TrailNotProvidedException : AmazonCloudTrailException
    {
        ...
        public TrailNotProvidedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TrailNotProvidedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
