...
namespace Amazon.CloudTrailData
{
    ...
    public partial class AmazonCloudTrailDataException : AmazonServiceException
    {
        ...
        public AmazonCloudTrailDataException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonCloudTrailDataException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
