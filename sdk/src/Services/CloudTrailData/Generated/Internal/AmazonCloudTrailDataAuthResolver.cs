...
namespace Amazon.CloudTrailData.Internal
{
    ...
    public class AmazonCloudTrailDataAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCloudTrailDataAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CloudTrailData.
        /// </summary>
        public AmazonCloudTrailDataAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCloudTrailDataAuthSchemeParameters
            {
    ...
    public class AmazonCloudTrailDataAuthSchemeResolver : IAuthSchemeResolver<AmazonCloudTrailDataAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCloudTrailDataAuthSchemeParameters authParameters)
        {
