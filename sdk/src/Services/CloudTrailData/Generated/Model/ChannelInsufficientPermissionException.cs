...
namespace Amazon.CloudTrailData.Model
{
    ...
    public partial class ChannelInsufficientPermissionException : AmazonCloudTrailDataException
    {
        ...
        public ChannelInsufficientPermissionException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ChannelInsufficientPermissionException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
