...
namespace Amazon.CloudTrailData.Model
{
    ...
    public partial class ChannelUnsupportedSchemaException : AmazonCloudTrailDataException
    {
        ...
        public ChannelUnsupportedSchemaException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ChannelUnsupportedSchemaException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
