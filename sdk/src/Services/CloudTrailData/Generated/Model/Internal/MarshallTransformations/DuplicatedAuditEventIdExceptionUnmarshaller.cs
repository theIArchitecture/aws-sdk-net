...
namespace Amazon.CloudTrailData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DuplicatedAuditEventIdExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<DuplicatedAuditEventIdException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public DuplicatedAuditEventIdException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
