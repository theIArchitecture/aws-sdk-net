...
namespace Amazon.CloudTrailData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResultErrorEntryUnmarshaller : IJsonUnmarshaller<ResultErrorEntry, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResultErrorEntry Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
