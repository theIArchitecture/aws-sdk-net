...
namespace Amazon.CloudTrailData.Model
{
    ...
    public partial class InvalidChannelARNException : AmazonCloudTrailDataException
    {
        ...
        public InvalidChannelARNException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidChannelARNException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
