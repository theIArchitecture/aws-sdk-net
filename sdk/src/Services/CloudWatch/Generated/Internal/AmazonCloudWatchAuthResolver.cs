...
namespace Amazon.CloudWatch.Internal
{
    ...
    public class AmazonCloudWatchAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCloudWatchAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CloudWatch.
        /// </summary>
        public AmazonCloudWatchAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCloudWatchAuthSchemeParameters
            {
    ...
    public class AmazonCloudWatchAuthSchemeResolver : IAuthSchemeResolver<AmazonCloudWatchAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCloudWatchAuthSchemeParameters authParameters)
        {
