...
namespace Amazon.CloudWatch.Model
{
    ...
    public partial class DashboardNotFoundErrorException : AmazonCloudWatchException
    {
        ...
        public DashboardNotFoundErrorException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DashboardNotFoundErrorException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
