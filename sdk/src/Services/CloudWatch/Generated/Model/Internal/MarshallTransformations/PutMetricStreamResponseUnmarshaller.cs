...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutMetricStreamResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutMetricStreamResponse response = new PutMetricStreamResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("PutMetricStreamResult", 2))
                    {
        ...
        private static PutMetricStreamResponseUnmarshaller _instance = new PutMetricStreamResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutMetricStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
