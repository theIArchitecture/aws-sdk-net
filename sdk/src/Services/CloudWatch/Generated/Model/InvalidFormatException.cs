...
namespace Amazon.CloudWatch.Model
{
    ...
    public partial class InvalidFormatException : AmazonCloudWatchException
    {
        ...
        public InvalidFormatException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidFormatException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
