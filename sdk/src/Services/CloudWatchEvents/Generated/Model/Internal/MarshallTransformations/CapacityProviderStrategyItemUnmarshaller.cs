...
namespace Amazon.CloudWatchEvents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CapacityProviderStrategyItemUnmarshaller : IJsonUnmarshaller<CapacityProviderStrategyItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CapacityProviderStrategyItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
