...
namespace Amazon.CloudWatchEvents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateApiDestinationRequestMarshaller : IMarshaller<IRequest, CreateApiDestinationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateApiDestinationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateApiDestinationRequest publicRequest)
        {
        ...
        private static CreateApiDestinationRequestMarshaller _instance = new CreateApiDestinationRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateApiDestinationRequestMarshaller Instance
        {
            get
            {
                return _instance;
