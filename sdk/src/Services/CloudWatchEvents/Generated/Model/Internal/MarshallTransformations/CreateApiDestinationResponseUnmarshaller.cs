...
namespace Amazon.CloudWatchEvents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateApiDestinationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateApiDestinationResponse response = new CreateApiDestinationResponse();
        ...
        private static CreateApiDestinationResponseUnmarshaller _instance = new CreateApiDestinationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateApiDestinationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
