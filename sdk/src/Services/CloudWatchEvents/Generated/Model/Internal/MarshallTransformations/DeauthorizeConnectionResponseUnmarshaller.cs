...
namespace Amazon.CloudWatchEvents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeauthorizeConnectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeauthorizeConnectionResponse response = new DeauthorizeConnectionResponse();
        ...
        private static DeauthorizeConnectionResponseUnmarshaller _instance = new DeauthorizeConnectionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeauthorizeConnectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
