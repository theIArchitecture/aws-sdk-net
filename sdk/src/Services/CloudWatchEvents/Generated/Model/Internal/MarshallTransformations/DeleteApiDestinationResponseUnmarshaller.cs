...
namespace Amazon.CloudWatchEvents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteApiDestinationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteApiDestinationResponse response = new DeleteApiDestinationResponse();
        ...
        private static DeleteApiDestinationResponseUnmarshaller _instance = new DeleteApiDestinationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteApiDestinationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
