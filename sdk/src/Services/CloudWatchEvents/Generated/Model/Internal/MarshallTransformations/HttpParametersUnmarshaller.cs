...
namespace Amazon.CloudWatchEvents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class HttpParametersUnmarshaller : IJsonUnmarshaller<HttpParameters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public HttpParameters Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
