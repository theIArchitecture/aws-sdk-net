    ...
    public class ListReplaysResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<Replay, ReplayUnmarshaller>(ReplayUnmarshaller.Instance);
                    response.Replays = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
