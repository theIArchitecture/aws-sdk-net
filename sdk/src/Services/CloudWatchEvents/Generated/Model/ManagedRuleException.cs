...
namespace Amazon.CloudWatchEvents.Model
{
    ...
    public partial class ManagedRuleException : AmazonCloudWatchEventsException
    {
        ...
        public ManagedRuleException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ManagedRuleException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
