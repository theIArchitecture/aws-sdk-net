...
namespace Amazon.CloudWatchEvents.Model
{
    ...
    public partial class PolicyLengthExceededException : AmazonCloudWatchEventsException
    {
        ...
        public PolicyLengthExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public PolicyLengthExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
