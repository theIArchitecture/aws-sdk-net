...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonCloudWatchEventsConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonCloudWatchEventsConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonCloudWatchEventsConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonCloudWatchEventsConfig to create AmazonCloudWatchEventsClient");
            }

            return awsCredentials == null ? 
                    new AmazonCloudWatchEventsClient(serviceClientConfig) :
                    new AmazonCloudWatchEventsClient(awsCredentials, serviceClientConfig);
        }
