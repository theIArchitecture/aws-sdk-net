...
namespace Amazon.CloudWatchEvidently
{
    ...
    public partial class AmazonCloudWatchEvidentlyException : AmazonServiceException
    {
        ...
        public AmazonCloudWatchEvidentlyException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonCloudWatchEvidentlyException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
