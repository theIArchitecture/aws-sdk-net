...
namespace Amazon.CloudWatchEvidently.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExperimentResultsDataUnmarshaller : IJsonUnmarshaller<ExperimentResultsData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ExperimentResultsData Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ResultStat = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
