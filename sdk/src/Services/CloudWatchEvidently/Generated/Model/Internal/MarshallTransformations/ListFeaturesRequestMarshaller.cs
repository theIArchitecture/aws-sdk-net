...
{
    /// <summary>
    /// ListFeatures Request Marshaller
    /// </summary>       
    public class ListFeaturesRequestMarshaller : IMarshaller<IRequest, ListFeaturesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListFeaturesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListFeaturesRequest publicRequest)
        {
        ...
        private static ListFeaturesRequestMarshaller _instance = new ListFeaturesRequestMarshaller();        

        internal static ListFeaturesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFeaturesRequestMarshaller Instance
        {
            get
            {
                return _instance;
