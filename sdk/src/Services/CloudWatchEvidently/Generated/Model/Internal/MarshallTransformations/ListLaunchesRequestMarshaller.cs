...
{
    /// <summary>
    /// ListLaunches Request Marshaller
    /// </summary>       
    public class ListLaunchesRequestMarshaller : IMarshaller<IRequest, ListLaunchesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListLaunchesRequest)input);
        }
        ...
        private static ListLaunchesRequestMarshaller _instance = new ListLaunchesRequestMarshaller();        

        internal static ListLaunchesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLaunchesRequestMarshaller Instance
        {
            get
            {
                return _instance;
