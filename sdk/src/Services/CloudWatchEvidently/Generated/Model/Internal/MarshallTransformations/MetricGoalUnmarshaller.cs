...
namespace Amazon.CloudWatchEvidently.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MetricGoalUnmarshaller : IJsonUnmarshaller<MetricGoal, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MetricGoal Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("desiredChange", targetDepth))
                {
                    ...
                    unmarshalledObject.DesiredChange = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
