...
namespace Amazon.CloudWatchEvidently.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OnlineAbDefinitionUnmarshaller : IJsonUnmarshaller<OnlineAbDefinition, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public OnlineAbDefinition Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("controlTreatmentName", targetDepth))
                {
                    ...
                    unmarshalledObject.ControlTreatmentName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("treatmentWeights", targetDepth))
                {
                    ...
                    unmarshalledObject.TreatmentWeights = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
