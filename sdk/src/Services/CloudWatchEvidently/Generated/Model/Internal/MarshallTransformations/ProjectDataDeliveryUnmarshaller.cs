...
{
    /// <summary>
    /// Response Unmarshaller for ProjectDataDelivery Object
    /// </summary>  
    public class ProjectDataDeliveryUnmarshaller : IJsonUnmarshaller<ProjectDataDelivery, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ProjectDataDelivery Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static ProjectDataDeliveryUnmarshaller _instance = new ProjectDataDeliveryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ProjectDataDeliveryUnmarshaller Instance
        {
            get
            {
                return _instance;
