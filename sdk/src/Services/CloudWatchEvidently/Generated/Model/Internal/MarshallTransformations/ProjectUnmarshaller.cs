        ...
        public Project Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("appConfigResource", targetDepth))
                {
                    ...
                    unmarshalledObject.AppConfigResource = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = ProjectDataDeliveryUnmarshaller.Instance;
                    unmarshalledObject.DataDelivery = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
