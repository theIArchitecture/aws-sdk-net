...
namespace Amazon.CloudWatchEvidently.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SegmentOverrideUnmarshaller : IJsonUnmarshaller<SegmentOverride, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SegmentOverride Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("evaluationOrder", targetDepth))
                {
                    ...
                    unmarshalledObject.EvaluationOrder = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("weights", targetDepth))
                {
                    ...
                    unmarshalledObject.Weights = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
