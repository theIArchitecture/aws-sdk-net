...
{
    /// <summary>
    /// Response Unmarshaller for UpdateProjectDataDelivery operation
    /// </summary>  
    public class UpdateProjectDataDeliveryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateProjectDataDeliveryResponse response = new UpdateProjectDataDeliveryResponse();
        ...
        private static UpdateProjectDataDeliveryResponseUnmarshaller _instance = new UpdateProjectDataDeliveryResponseUnmarshaller();        

        internal static UpdateProjectDataDeliveryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateProjectDataDeliveryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
