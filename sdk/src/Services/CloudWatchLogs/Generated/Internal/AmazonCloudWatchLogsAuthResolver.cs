...
namespace Amazon.CloudWatchLogs.Internal
{
    ...
    public class AmazonCloudWatchLogsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCloudWatchLogsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CloudWatchLogs.
        /// </summary>
        public AmazonCloudWatchLogsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCloudWatchLogsAuthSchemeParameters
            {
    ...
    public class AmazonCloudWatchLogsAuthSchemeResolver : IAuthSchemeResolver<AmazonCloudWatchLogsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCloudWatchLogsAuthSchemeParameters authParameters)
        {
