...
namespace Amazon.CloudWatchLogs.Model
{
    ...
    /// </summary>
    public partial class DeliveryDestinationConfiguration
    {
        ...
        {
            get { return this._destinationResourceArn; }
            set { this._destinationResourceArn = value; }
        }

        // Check to see if DestinationResourceArn property is set
        internal bool IsSetDestinationResourceArn()
        {
            return this._destinationResourceArn != null;
        }
