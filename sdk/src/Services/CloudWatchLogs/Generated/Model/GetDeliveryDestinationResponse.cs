...
namespace Amazon.CloudWatchLogs.Model
{
    ...
    /// </summary>
    public partial class GetDeliveryDestinationResponse : AmazonWebServiceResponse
    {
        ...
        {
            get { return this._deliveryDestination; }
            set { this._deliveryDestination = value; }
        }

        // Check to see if DeliveryDestination property is set
        internal bool IsSetDeliveryDestination()
        {
            return this._deliveryDestination != null;
        }
