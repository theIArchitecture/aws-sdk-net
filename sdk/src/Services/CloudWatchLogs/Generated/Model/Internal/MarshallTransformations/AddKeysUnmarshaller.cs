...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AddKeysUnmarshaller : IJsonUnmarshaller<AddKeys, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AddKeys Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AddKeyEntry, AddKeyEntryUnmarshaller>(AddKeyEntryUnmarshaller.Instance);
