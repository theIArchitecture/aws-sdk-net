...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteAccountPolicyRequestMarshaller : IMarshaller<IRequest, DeleteAccountPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteAccountPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteAccountPolicyRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudWatchLogs");
            string target = "Logs_20140328.DeleteAccountPolicy";
        ...
        private static DeleteAccountPolicyRequestMarshaller _instance = new DeleteAccountPolicyRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAccountPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
