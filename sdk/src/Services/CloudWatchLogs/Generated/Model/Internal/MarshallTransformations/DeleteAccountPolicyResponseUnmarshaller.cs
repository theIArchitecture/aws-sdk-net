...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteAccountPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAccountPolicyResponse response = new DeleteAccountPolicyResponse();
        ...
        private static DeleteAccountPolicyResponseUnmarshaller _instance = new DeleteAccountPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAccountPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
