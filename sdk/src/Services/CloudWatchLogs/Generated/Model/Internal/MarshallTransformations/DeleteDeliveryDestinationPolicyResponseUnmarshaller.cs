...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteDeliveryDestinationPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDeliveryDestinationPolicyResponse response = new DeleteDeliveryDestinationPolicyResponse();
        ...
        private static DeleteDeliveryDestinationPolicyResponseUnmarshaller _instance = new DeleteDeliveryDestinationPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDeliveryDestinationPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
