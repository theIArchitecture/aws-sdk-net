...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteDeliverySourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDeliverySourceResponse response = new DeleteDeliverySourceResponse();
        ...
        private static DeleteDeliverySourceResponseUnmarshaller _instance = new DeleteDeliverySourceResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDeliverySourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
