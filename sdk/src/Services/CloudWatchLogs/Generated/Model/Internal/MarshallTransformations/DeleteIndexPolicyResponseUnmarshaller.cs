...
{
    /// <summary>
    /// Response Unmarshaller for DeleteIndexPolicy operation
    /// </summary>  
    public class DeleteIndexPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteIndexPolicyResponse response = new DeleteIndexPolicyResponse();
        ...
        private static DeleteIndexPolicyResponseUnmarshaller _instance = new DeleteIndexPolicyResponseUnmarshaller();        

        internal static DeleteIndexPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteIndexPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
