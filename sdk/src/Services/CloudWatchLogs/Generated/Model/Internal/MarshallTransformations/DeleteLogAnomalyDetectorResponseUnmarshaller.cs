...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteLogAnomalyDetectorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteLogAnomalyDetectorResponse response = new DeleteLogAnomalyDetectorResponse();
        ...
        private static DeleteLogAnomalyDetectorResponseUnmarshaller _instance = new DeleteLogAnomalyDetectorResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteLogAnomalyDetectorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
