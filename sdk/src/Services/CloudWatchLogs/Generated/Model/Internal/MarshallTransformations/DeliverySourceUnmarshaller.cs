...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeliverySourceUnmarshaller : IJsonUnmarshaller<DeliverySource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DeliverySource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static DeliverySourceUnmarshaller _instance = new DeliverySourceUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DeliverySourceUnmarshaller Instance
        {
            get
            {
                return _instance;
