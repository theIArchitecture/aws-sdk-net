...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeAccountPoliciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAccountPoliciesResponse response = new DescribeAccountPoliciesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AccountPolicy, AccountPolicyUnmarshaller>(AccountPolicyUnmarshaller.Instance);
                    response.AccountPolicies = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeAccountPoliciesResponseUnmarshaller _instance = new DescribeAccountPoliciesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAccountPoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
