...
{
    /// <summary>
    /// Response Unmarshaller for DescribeFieldIndexes operation
    /// </summary>  
    public class DescribeFieldIndexesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeFieldIndexesResponse response = new DescribeFieldIndexesResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("fieldIndexes", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<FieldIndex, FieldIndexUnmarshaller>(FieldIndexUnmarshaller.Instance);
                    response.FieldIndexes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeFieldIndexesResponseUnmarshaller _instance = new DescribeFieldIndexesResponseUnmarshaller();        

        internal static DescribeFieldIndexesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeFieldIndexesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
