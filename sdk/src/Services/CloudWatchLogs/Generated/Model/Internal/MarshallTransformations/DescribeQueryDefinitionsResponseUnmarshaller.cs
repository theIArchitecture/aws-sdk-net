    ...
    public class DescribeQueryDefinitionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<QueryDefinition, QueryDefinitionUnmarshaller>(QueryDefinitionUnmarshaller.Instance);
                    response.QueryDefinitions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
