...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListLogAnomalyDetectorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListLogAnomalyDetectorsResponse response = new ListLogAnomalyDetectorsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AnomalyDetector, AnomalyDetectorUnmarshaller>(AnomalyDetectorUnmarshaller.Instance);
                    response.AnomalyDetectors = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListLogAnomalyDetectorsResponseUnmarshaller _instance = new ListLogAnomalyDetectorsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLogAnomalyDetectorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
