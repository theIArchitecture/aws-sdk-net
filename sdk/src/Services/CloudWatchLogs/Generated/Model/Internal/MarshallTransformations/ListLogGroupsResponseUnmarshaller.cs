...
{
    /// <summary>
    /// Response Unmarshaller for ListLogGroups operation
    /// </summary>  
    public class ListLogGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListLogGroupsResponse response = new ListLogGroupsResponse();
        ...
        private static ListLogGroupsResponseUnmarshaller _instance = new ListLogGroupsResponseUnmarshaller();        

        internal static ListLogGroupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLogGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
