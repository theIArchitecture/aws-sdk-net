...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OpenSearchApplicationUnmarshaller : IJsonUnmarshaller<OpenSearchApplication, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public OpenSearchApplication Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("applicationEndpoint", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ApplicationEndpoint = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
