...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutAccountPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutAccountPolicyResponse response = new PutAccountPolicyResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = AccountPolicyUnmarshaller.Instance;
                    response.AccountPolicy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static PutAccountPolicyResponseUnmarshaller _instance = new PutAccountPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutAccountPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
