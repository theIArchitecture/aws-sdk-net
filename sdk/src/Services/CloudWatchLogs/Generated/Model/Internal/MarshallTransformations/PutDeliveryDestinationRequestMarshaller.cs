...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class PutDeliveryDestinationRequestMarshaller : IMarshaller<IRequest, PutDeliveryDestinationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutDeliveryDestinationRequest)input);
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutDeliveryDestinationRequestMarshaller Instance
        {
            get
            {
                return _instance;
