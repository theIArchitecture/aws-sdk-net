...
{
    /// <summary>
    /// PutTransformer Request Marshaller
    /// </summary>       
    public class PutTransformerRequestMarshaller : IMarshaller<IRequest, PutTransformerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutTransformerRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutTransformerRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudWatchLogs");
            string target = "Logs_20140328.PutTransformer";
        ...
        private static PutTransformerRequestMarshaller _instance = new PutTransformerRequestMarshaller();        

        internal static PutTransformerRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutTransformerRequestMarshaller Instance
        {
            get
            {
                return _instance;
