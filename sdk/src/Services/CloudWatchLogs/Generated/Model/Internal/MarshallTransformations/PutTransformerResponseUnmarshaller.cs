...
{
    /// <summary>
    /// Response Unmarshaller for PutTransformer operation
    /// </summary>  
    public class PutTransformerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutTransformerResponse response = new PutTransformerResponse();
        ...
        private static PutTransformerResponseUnmarshaller _instance = new PutTransformerResponseUnmarshaller();        

        internal static PutTransformerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutTransformerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
