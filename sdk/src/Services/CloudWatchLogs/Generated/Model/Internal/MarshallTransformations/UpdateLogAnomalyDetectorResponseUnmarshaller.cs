...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateLogAnomalyDetectorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateLogAnomalyDetectorResponse response = new UpdateLogAnomalyDetectorResponse();
        ...
        private static UpdateLogAnomalyDetectorResponseUnmarshaller _instance = new UpdateLogAnomalyDetectorResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateLogAnomalyDetectorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
