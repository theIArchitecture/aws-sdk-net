...
namespace Amazon.CloudWatchLogs.Model
{
    ...
    public partial class InvalidSequenceTokenException : AmazonCloudWatchLogsException
    {
        ...
        public InvalidSequenceTokenException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidSequenceTokenException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
