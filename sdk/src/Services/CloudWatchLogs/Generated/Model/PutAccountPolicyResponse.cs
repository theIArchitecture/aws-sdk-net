...
namespace Amazon.CloudWatchLogs.Model
{
    ...
    /// </summary>
    public partial class PutAccountPolicyResponse : AmazonWebServiceResponse
    {
        ...
        {
            get { return this._accountPolicy; }
            set { this._accountPolicy = value; }
        }

        // Check to see if AccountPolicy property is set
        internal bool IsSetAccountPolicy()
        {
            return this._accountPolicy != null;
        }
