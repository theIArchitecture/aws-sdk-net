...
namespace Amazon.CloudWatchLogs.Model
{
    ...
    /// </summary>
    public partial class PutDeliverySourceResponse : AmazonWebServiceResponse
    {
        ...
        /// </para>
        /// </summary>
        public DeliverySource DeliverySource
        {
            get { return this._deliverySource; }
            set { this._deliverySource = value; }
        }

        // Check to see if DeliverySource property is set
        internal bool IsSetDeliverySource()
        {
            return this._deliverySource != null;
        }
