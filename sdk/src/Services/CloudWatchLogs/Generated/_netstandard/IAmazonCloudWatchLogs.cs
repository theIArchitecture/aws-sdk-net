...
namespace Amazon.CloudWatchLogs
{
    ...
    public partial interface IAmazonCloudWatchLogs : IAmazonService, IDisposable
    {
        ...
        Task<DeleteIndexPolicyResponse> DeleteIndexPolicyAsync(DeleteIndexPolicyRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DescribeFieldIndexesResponse> DescribeFieldIndexesAsync(DescribeFieldIndexesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DescribeIndexPoliciesResponse> DescribeIndexPoliciesAsync(DescribeIndexPoliciesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetLogObjectResponse> GetLogObjectAsync(GetLogObjectRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListLogGroupsResponse> ListLogGroupsAsync(ListLogGroupsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<PutIndexPolicyResponse> PutIndexPolicyAsync(PutIndexPolicyRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<PutTransformerResponse> PutTransformerAsync(PutTransformerRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<TestTransformerResponse> TestTransformerAsync(TestTransformerRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonCloudWatchLogsConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonCloudWatchLogsConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonCloudWatchLogsConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonCloudWatchLogsConfig to create AmazonCloudWatchLogsClient");
            }

            return awsCredentials == null ? 
                    new AmazonCloudWatchLogsClient(serviceClientConfig) :
                    new AmazonCloudWatchLogsClient(awsCredentials, serviceClientConfig);
        }
