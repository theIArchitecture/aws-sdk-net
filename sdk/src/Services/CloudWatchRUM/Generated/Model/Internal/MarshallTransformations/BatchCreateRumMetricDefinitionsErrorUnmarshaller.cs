...
namespace Amazon.CloudWatchRUM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchCreateRumMetricDefinitionsErrorUnmarshaller : IJsonUnmarshaller<BatchCreateRumMetricDefinitionsError, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchCreateRumMetricDefinitionsError Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
