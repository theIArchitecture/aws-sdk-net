...
namespace Amazon.CloudWatchRUM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchDeleteRumMetricDefinitionsErrorUnmarshaller : IJsonUnmarshaller<BatchDeleteRumMetricDefinitionsError, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchDeleteRumMetricDefinitionsError Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
