...
namespace Amazon.CloudWatchRUM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class BatchDeleteRumMetricDefinitionsRequestMarshaller : IMarshaller<IRequest, BatchDeleteRumMetricDefinitionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static BatchDeleteRumMetricDefinitionsRequestMarshaller _instance = new BatchDeleteRumMetricDefinitionsRequestMarshaller();        

        internal static BatchDeleteRumMetricDefinitionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDeleteRumMetricDefinitionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
