...
namespace Amazon.CloudWatchRUM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteRumMetricsDestinationRequestMarshaller : IMarshaller<IRequest, DeleteRumMetricsDestinationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteRumMetricsDestinationRequestMarshaller _instance = new DeleteRumMetricsDestinationRequestMarshaller();        

        internal static DeleteRumMetricsDestinationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRumMetricsDestinationRequestMarshaller Instance
        {
            get
            {
                return _instance;
