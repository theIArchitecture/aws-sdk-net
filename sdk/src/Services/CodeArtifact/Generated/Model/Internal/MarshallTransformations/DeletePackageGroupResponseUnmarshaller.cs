...
{
    /// <summary>
    /// Response Unmarshaller for DeletePackageGroup operation
    /// </summary>  
    public class DeletePackageGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeletePackageGroupResponse response = new DeletePackageGroupResponse();
        ...
        private static DeletePackageGroupResponseUnmarshaller _instance = new DeletePackageGroupResponseUnmarshaller();        

        internal static DeletePackageGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePackageGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
