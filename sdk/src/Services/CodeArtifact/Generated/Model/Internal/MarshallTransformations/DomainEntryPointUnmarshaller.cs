...
namespace Amazon.CodeArtifact.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DomainEntryPointUnmarshaller : IJsonUnmarshaller<DomainEntryPoint, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DomainEntryPoint Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
