...
{
    /// <summary>
    /// Response Unmarshaller for GetAssociatedPackageGroup operation
    /// </summary>  
    public class GetAssociatedPackageGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAssociatedPackageGroupResponse response = new GetAssociatedPackageGroupResponse();
        ...
        private static GetAssociatedPackageGroupResponseUnmarshaller _instance = new GetAssociatedPackageGroupResponseUnmarshaller();        

        internal static GetAssociatedPackageGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAssociatedPackageGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
