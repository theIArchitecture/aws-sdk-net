...
{
    /// <summary>
    /// PackageGroupAllowedRepository Marshaller
    /// </summary>
    public class PackageGroupAllowedRepositoryMarshaller : IRequestMarshaller<PackageGroupAllowedRepository, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(PackageGroupAllowedRepository requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetOriginRestrictionType())
            {
                ...
                context.Writer.WriteStringValue(requestObject.OriginRestrictionType);
            }
        ...
        /// </summary>
        public readonly static PackageGroupAllowedRepositoryMarshaller Instance = new PackageGroupAllowedRepositoryMarshaller();
