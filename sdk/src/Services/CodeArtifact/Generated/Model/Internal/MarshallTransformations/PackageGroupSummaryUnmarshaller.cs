...
{
    /// <summary>
    /// Response Unmarshaller for PackageGroupSummary Object
    /// </summary>  
    public class PackageGroupSummaryUnmarshaller : IJsonUnmarshaller<PackageGroupSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PackageGroupSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            PackageGroupSummary unmarshalledObject = new PackageGroupSummary();
        ...
        private static PackageGroupSummaryUnmarshaller _instance = new PackageGroupSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PackageGroupSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
