...
namespace Amazon.CodeArtifact.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PackageOriginConfigurationUnmarshaller : IJsonUnmarshaller<PackageOriginConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PackageOriginConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
