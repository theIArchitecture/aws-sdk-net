...
namespace Amazon.CodeArtifact.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PackageVersionErrorUnmarshaller : IJsonUnmarshaller<PackageVersionError, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PackageVersionError Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
