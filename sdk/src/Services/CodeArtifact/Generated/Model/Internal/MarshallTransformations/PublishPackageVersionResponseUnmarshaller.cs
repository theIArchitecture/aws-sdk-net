...
{
    /// <summary>
    /// Response Unmarshaller for PublishPackageVersion operation
    /// </summary>  
    public class PublishPackageVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PublishPackageVersionResponse response = new PublishPackageVersionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = AssetSummaryUnmarshaller.Instance;
        ...
        private static PublishPackageVersionResponseUnmarshaller _instance = new PublishPackageVersionResponseUnmarshaller();        

        internal static PublishPackageVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PublishPackageVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
