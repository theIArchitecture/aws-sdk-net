...
namespace Amazon.CodeArtifact.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RepositoryExternalConnectionInfoUnmarshaller : IJsonUnmarshaller<RepositoryExternalConnectionInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RepositoryExternalConnectionInfo Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("externalConnectionName", targetDepth))
                {
                    ...
                    unmarshalledObject.ExternalConnectionName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("packageFormat", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PackageFormat = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
