...
{
    /// <summary>
    /// Response Unmarshaller for UpdatePackageGroupOriginConfiguration operation
    /// </summary>  
    public class UpdatePackageGroupOriginConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdatePackageGroupOriginConfigurationResponse response = new UpdatePackageGroupOriginConfigurationResponse();
        ...
        private static UpdatePackageGroupOriginConfigurationResponseUnmarshaller _instance = new UpdatePackageGroupOriginConfigurationResponseUnmarshaller();        

        internal static UpdatePackageGroupOriginConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePackageGroupOriginConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
