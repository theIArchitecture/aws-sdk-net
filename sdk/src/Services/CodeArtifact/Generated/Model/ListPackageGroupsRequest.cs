...
{
    /// <summary>
    /// Container for the parameters to the ListPackageGroups operation.
    /// Returns a list of package groups in the requested domain.
    /// </summary>
    public partial class ListPackageGroupsRequest : AmazonCodeArtifactRequest
    {
        ...
        /// <para>
        ///  A prefix for which to search package groups. When included, <c>ListPackageGroups</c>
        /// will return only package groups with patterns that match the prefix. 
        /// </para>
        /// </summary>
        [AWSProperty(Min=0, Max=520)]
