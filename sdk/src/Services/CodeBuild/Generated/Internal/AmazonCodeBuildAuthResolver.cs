...
namespace Amazon.CodeBuild.Internal
{
    ...
    public class AmazonCodeBuildAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCodeBuildAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CodeBuild.
        /// </summary>
        public AmazonCodeBuildAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCodeBuildAuthSchemeParameters
            {
    ...
    public class AmazonCodeBuildAuthSchemeResolver : IAuthSchemeResolver<AmazonCodeBuildAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCodeBuildAuthSchemeParameters authParameters)
        {
