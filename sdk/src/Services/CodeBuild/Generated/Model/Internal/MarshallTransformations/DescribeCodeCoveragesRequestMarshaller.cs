    ...
    public class DescribeCodeCoveragesRequestMarshaller : IMarshaller<IRequest, DescribeCodeCoveragesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DescribeCodeCoveragesRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetMaxLineCoveragePercentage())
            {
                ...
                {
                    context.Writer.WriteStringValue(StringUtils.FromSpecialDoubleValue(publicRequest.MaxLineCoveragePercentage.Value));
                }
                else
                {
                    context.Writer.WriteNumberValue(publicRequest.MaxLineCoveragePercentage.Value);
                }
            }
            ...
            if(publicRequest.IsSetMinLineCoveragePercentage())
            {
                ...
                {
                    context.Writer.WriteStringValue(StringUtils.FromSpecialDoubleValue(publicRequest.MinLineCoveragePercentage.Value));
                }
                else
                {
                    context.Writer.WriteNumberValue(publicRequest.MinLineCoveragePercentage.Value);
                }
            }
            ...
            if(publicRequest.IsSetReportArn())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ReportArn);
            }
