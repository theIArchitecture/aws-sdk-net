...
namespace Amazon.CodeBuild.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class WebhookFilterUnmarshaller : IJsonUnmarshaller<WebhookFilter, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public WebhookFilter Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("excludeMatchedPattern", targetDepth))
                {
                    ...
                    unmarshalledObject.ExcludeMatchedPattern = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
