...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateDevEnvironmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDevEnvironmentResponse response = new CreateDevEnvironmentResponse();
        ...
        internal static CreateDevEnvironmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDevEnvironmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
