...
{
    /// <summary>
    /// CreateSourceRepository Request Marshaller
    /// </summary>       
    public class CreateSourceRepositoryRequestMarshaller : IMarshaller<IRequest, CreateSourceRepositoryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateSourceRepositoryRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateSourceRepositoryRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/spaces/{spaceName}/projects/{projectName}/sourceRepositories/{name}";
#if !NETFRAMEWORK
        ...
        private static CreateSourceRepositoryRequestMarshaller _instance = new CreateSourceRepositoryRequestMarshaller();        

        internal static CreateSourceRepositoryRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSourceRepositoryRequestMarshaller Instance
        {
            get
            {
                return _instance;
