...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateSourceRepositoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSourceRepositoryResponse response = new CreateSourceRepositoryResponse();
        ...
        internal static CreateSourceRepositoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSourceRepositoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
