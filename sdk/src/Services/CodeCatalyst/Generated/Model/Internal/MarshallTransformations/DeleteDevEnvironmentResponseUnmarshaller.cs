...
{
    /// <summary>
    /// Response Unmarshaller for DeleteDevEnvironment operation
    /// </summary>  
    public class DeleteDevEnvironmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDevEnvironmentResponse response = new DeleteDevEnvironmentResponse();
        ...
        private static DeleteDevEnvironmentResponseUnmarshaller _instance = new DeleteDevEnvironmentResponseUnmarshaller();        

        internal static DeleteDevEnvironmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDevEnvironmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
