...
{
    /// <summary>
    /// DeleteSourceRepository Request Marshaller
    /// </summary>       
    public class DeleteSourceRepositoryRequestMarshaller : IMarshaller<IRequest, DeleteSourceRepositoryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteSourceRepositoryRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteSourceRepositoryRequest publicRequest)
        {
        ...
        private static DeleteSourceRepositoryRequestMarshaller _instance = new DeleteSourceRepositoryRequestMarshaller();        

        internal static DeleteSourceRepositoryRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSourceRepositoryRequestMarshaller Instance
        {
            get
            {
                return _instance;
