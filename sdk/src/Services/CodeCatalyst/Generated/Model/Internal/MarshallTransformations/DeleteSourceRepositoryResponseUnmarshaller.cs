...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSourceRepository operation
    /// </summary>  
    public class DeleteSourceRepositoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSourceRepositoryResponse response = new DeleteSourceRepositoryResponse();
        ...
        private static DeleteSourceRepositoryResponseUnmarshaller _instance = new DeleteSourceRepositoryResponseUnmarshaller();        

        internal static DeleteSourceRepositoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSourceRepositoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
