...
{
    /// <summary>
    /// GetSourceRepositoryCloneUrls Request Marshaller
    /// </summary>       
    public class GetSourceRepositoryCloneUrlsRequestMarshaller : IMarshaller<IRequest, GetSourceRepositoryCloneUrlsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetSourceRepositoryCloneUrlsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetSourceRepositoryCloneUrlsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/spaces/{spaceName}/projects/{projectName}/sourceRepositories/{sourceRepositoryName}/cloneUrls";

            return request;
        }
        private static GetSourceRepositoryCloneUrlsRequestMarshaller _instance = new GetSourceRepositoryCloneUrlsRequestMarshaller();        

        internal static GetSourceRepositoryCloneUrlsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSourceRepositoryCloneUrlsRequestMarshaller Instance
        {
            get
            {
                return _instance;
