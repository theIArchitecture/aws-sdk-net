...
{
    /// <summary>
    /// GetSourceRepository Request Marshaller
    /// </summary>       
    public class GetSourceRepositoryRequestMarshaller : IMarshaller<IRequest, GetSourceRepositoryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetSourceRepositoryRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetSourceRepositoryRequest publicRequest)
        {
        ...
        private static GetSourceRepositoryRequestMarshaller _instance = new GetSourceRepositoryRequestMarshaller();        

        internal static GetSourceRepositoryRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSourceRepositoryRequestMarshaller Instance
        {
            get
            {
                return _instance;
