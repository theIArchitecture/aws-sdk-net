...
{
    /// <summary>
    /// Response Unmarshaller for GetSourceRepository operation
    /// </summary>  
    public class GetSourceRepositoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSourceRepositoryResponse response = new GetSourceRepositoryResponse();
        ...
        private static GetSourceRepositoryResponseUnmarshaller _instance = new GetSourceRepositoryResponseUnmarshaller();        

        internal static GetSourceRepositoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSourceRepositoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
