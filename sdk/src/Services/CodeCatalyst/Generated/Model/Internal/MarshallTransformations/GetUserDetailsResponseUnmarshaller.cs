...
{
    /// <summary>
    /// Response Unmarshaller for GetUserDetails operation
    /// </summary>  
    public class GetUserDetailsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = EmailAddressUnmarshaller.Instance;
        ...
        private static GetUserDetailsResponseUnmarshaller _instance = new GetUserDetailsResponseUnmarshaller();        

        internal static GetUserDetailsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetUserDetailsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
