...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ProjectInformationUnmarshaller : IJsonUnmarshaller<ProjectInformation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ProjectInformation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
