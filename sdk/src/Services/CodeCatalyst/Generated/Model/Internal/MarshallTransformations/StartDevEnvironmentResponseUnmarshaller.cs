...
{
    /// <summary>
    /// Response Unmarshaller for StartDevEnvironment operation
    /// </summary>  
    public class StartDevEnvironmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartDevEnvironmentResponse response = new StartDevEnvironmentResponse();
        ...
        private static StartDevEnvironmentResponseUnmarshaller _instance = new StartDevEnvironmentResponseUnmarshaller();        

        internal static StartDevEnvironmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartDevEnvironmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
