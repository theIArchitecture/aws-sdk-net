...
{
    /// <summary>
    /// Response Unmarshaller for StartDevEnvironmentSession operation
    /// </summary>  
    public class StartDevEnvironmentSessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartDevEnvironmentSessionResponse response = new StartDevEnvironmentSessionResponse();
        ...
        private static StartDevEnvironmentSessionResponseUnmarshaller _instance = new StartDevEnvironmentSessionResponseUnmarshaller();        

        internal static StartDevEnvironmentSessionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartDevEnvironmentSessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
