...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class StopDevEnvironmentRequestMarshaller : IMarshaller<IRequest, StopDevEnvironmentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static StopDevEnvironmentRequestMarshaller _instance = new StopDevEnvironmentRequestMarshaller();        

        internal static StopDevEnvironmentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopDevEnvironmentRequestMarshaller Instance
        {
            get
            {
                return _instance;
