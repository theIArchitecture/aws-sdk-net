...
{
    /// <summary>
    /// Response Unmarshaller for StopDevEnvironment operation
    /// </summary>  
    public class StopDevEnvironmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopDevEnvironmentResponse response = new StopDevEnvironmentResponse();
        ...
        private static StopDevEnvironmentResponseUnmarshaller _instance = new StopDevEnvironmentResponseUnmarshaller();        

        internal static StopDevEnvironmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopDevEnvironmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
