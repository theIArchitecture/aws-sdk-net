...
namespace Amazon.CodeCatalyst.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateDevEnvironmentRequestMarshaller : IMarshaller<IRequest, UpdateDevEnvironmentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static UpdateDevEnvironmentRequestMarshaller _instance = new UpdateDevEnvironmentRequestMarshaller();        

        internal static UpdateDevEnvironmentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDevEnvironmentRequestMarshaller Instance
        {
            get
            {
                return _instance;
