...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDevEnvironment operation
    /// </summary>  
    public class UpdateDevEnvironmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDevEnvironmentResponse response = new UpdateDevEnvironmentResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<IdeConfiguration, IdeConfigurationUnmarshaller>(IdeConfigurationUnmarshaller.Instance);
        ...
        private static UpdateDevEnvironmentResponseUnmarshaller _instance = new UpdateDevEnvironmentResponseUnmarshaller();        

        internal static UpdateDevEnvironmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDevEnvironmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
