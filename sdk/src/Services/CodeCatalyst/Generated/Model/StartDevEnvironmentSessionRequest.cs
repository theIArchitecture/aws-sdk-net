...
{
    /// <summary>
    /// Container for the parameters to the StartDevEnvironmentSession operation.
    /// Starts a session for a specified Dev Environment.
    /// </summary>
    public partial class StartDevEnvironmentSessionRequest : AmazonCodeCatalystRequest
    {
        private string _id;
        private string _projectName;
        private DevEnvironmentSessionConfiguration _sessionConfiguration;
        ...
        /// </summary>
        [AWSProperty(Required=true)]
        public DevEnvironmentSessionConfiguration SessionConfiguration
        {
