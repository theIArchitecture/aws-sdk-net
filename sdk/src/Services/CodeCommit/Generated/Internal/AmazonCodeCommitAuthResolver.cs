...
namespace Amazon.CodeCommit.Internal
{
    ...
    public class AmazonCodeCommitAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCodeCommitAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CodeCommit.
        /// </summary>
        public AmazonCodeCommitAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCodeCommitAuthSchemeParameters
            {
    ...
    public class AmazonCodeCommitAuthSchemeResolver : IAuthSchemeResolver<AmazonCodeCommitAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCodeCommitAuthSchemeParameters authParameters)
        {
