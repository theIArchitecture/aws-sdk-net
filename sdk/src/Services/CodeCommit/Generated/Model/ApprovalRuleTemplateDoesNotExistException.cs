...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class ApprovalRuleTemplateDoesNotExistException : AmazonCodeCommitException
    {
        ...
        public ApprovalRuleTemplateDoesNotExistException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ApprovalRuleTemplateDoesNotExistException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
