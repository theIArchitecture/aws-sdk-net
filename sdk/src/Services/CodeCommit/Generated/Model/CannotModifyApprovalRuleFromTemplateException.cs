...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class CannotModifyApprovalRuleFromTemplateException : AmazonCodeCommitException
    {
        ...
        public CannotModifyApprovalRuleFromTemplateException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CannotModifyApprovalRuleFromTemplateException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
