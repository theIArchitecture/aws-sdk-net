...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class ClientRequestTokenRequiredException : AmazonCodeCommitException
    {
        ...
        public ClientRequestTokenRequiredException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ClientRequestTokenRequiredException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
