...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class CommentDeletedException : AmazonCodeCommitException
    {
        ...
        public CommentDeletedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CommentDeletedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
