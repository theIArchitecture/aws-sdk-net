...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class CommentNotCreatedByCallerException : AmazonCodeCommitException
    {
        ...
        public CommentNotCreatedByCallerException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CommentNotCreatedByCallerException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
