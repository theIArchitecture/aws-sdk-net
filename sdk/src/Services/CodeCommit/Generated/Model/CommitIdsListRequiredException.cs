...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class CommitIdsListRequiredException : AmazonCodeCommitException
    {
        ...
        public CommitIdsListRequiredException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CommitIdsListRequiredException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
