...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class ConcurrentReferenceUpdateException : AmazonCodeCommitException
    {
        ...
        public ConcurrentReferenceUpdateException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ConcurrentReferenceUpdateException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
