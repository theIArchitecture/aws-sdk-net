...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class FileNameConflictsWithDirectoryNameException : AmazonCodeCommitException
    {
        ...
        public FileNameConflictsWithDirectoryNameException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public FileNameConflictsWithDirectoryNameException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
