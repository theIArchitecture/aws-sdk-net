...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MergeHunkUnmarshaller : IJsonUnmarshaller<MergeHunk, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MergeHunk Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("isConflict", targetDepth))
                {
                    ...
                    unmarshalledObject.IsConflict = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
