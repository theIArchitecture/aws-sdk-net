...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RepositoryNamesRequiredExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<RepositoryNamesRequiredException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public RepositoryNamesRequiredException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public RepositoryNamesRequiredException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
