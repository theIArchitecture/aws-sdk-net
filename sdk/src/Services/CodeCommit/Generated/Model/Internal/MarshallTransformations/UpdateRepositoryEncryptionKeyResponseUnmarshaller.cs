...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRepositoryEncryptionKey operation
    /// </summary>  
    public class UpdateRepositoryEncryptionKeyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateRepositoryEncryptionKeyResponse response = new UpdateRepositoryEncryptionKeyResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.OriginalKmsKeyId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("repositoryId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RepositoryId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("EncryptionKeyInvalidIdException"))
                {
                    return EncryptionKeyInvalidIdExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("EncryptionKeyInvalidUsageException"))
                {
                    return EncryptionKeyInvalidUsageExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("EncryptionKeyRequiredException"))
                {
                    return EncryptionKeyRequiredExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static UpdateRepositoryEncryptionKeyResponseUnmarshaller _instance = new UpdateRepositoryEncryptionKeyResponseUnmarshaller();        

        internal static UpdateRepositoryEncryptionKeyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRepositoryEncryptionKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
