...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class InvalidActorArnException : AmazonCodeCommitException
    {
        ...
        public InvalidActorArnException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidActorArnException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
