...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class InvalidDestinationCommitSpecifierException : AmazonCodeCommitException
    {
        ...
        public InvalidDestinationCommitSpecifierException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidDestinationCommitSpecifierException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
