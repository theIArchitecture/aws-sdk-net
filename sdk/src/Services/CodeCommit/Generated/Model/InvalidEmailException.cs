...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class InvalidEmailException : AmazonCodeCommitException
    {
        ...
        public InvalidEmailException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidEmailException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
