...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class InvalidReplacementTypeException : AmazonCodeCommitException
    {
        ...
        public InvalidReplacementTypeException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidReplacementTypeException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
