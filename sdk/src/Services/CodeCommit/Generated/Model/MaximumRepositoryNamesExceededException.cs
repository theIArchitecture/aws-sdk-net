...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class MaximumRepositoryNamesExceededException : AmazonCodeCommitException
    {
        ...
        public MaximumRepositoryNamesExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public MaximumRepositoryNamesExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
