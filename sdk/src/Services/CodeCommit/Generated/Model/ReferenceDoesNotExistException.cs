...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class ReferenceDoesNotExistException : AmazonCodeCommitException
    {
        ...
        public ReferenceDoesNotExistException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ReferenceDoesNotExistException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
