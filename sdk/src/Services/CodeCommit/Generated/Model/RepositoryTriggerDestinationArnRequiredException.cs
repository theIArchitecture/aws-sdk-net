...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class RepositoryTriggerDestinationArnRequiredException : AmazonCodeCommitException
    {
        ...
        public RepositoryTriggerDestinationArnRequiredException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public RepositoryTriggerDestinationArnRequiredException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
