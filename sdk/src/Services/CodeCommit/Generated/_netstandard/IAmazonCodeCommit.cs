...
namespace Amazon.CodeCommit
{
    ...
    public partial interface IAmazonCodeCommit : IAmazonService, IDisposable
    {
        ...
        Task<ListFileCommitHistoryResponse> ListFileCommitHistoryAsync(ListFileCommitHistoryRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateRepositoryEncryptionKeyResponse> UpdateRepositoryEncryptionKeyAsync(UpdateRepositoryEncryptionKeyRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonCodeCommitConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonCodeCommitConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonCodeCommitConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonCodeCommitConfig to create AmazonCodeCommitClient");
            }

            return awsCredentials == null ? 
                    new AmazonCodeCommitClient(serviceClientConfig) :
                    new AmazonCodeCommitClient(awsCredentials, serviceClientConfig);
        }
