...
namespace Amazon.CodeConnections.Internal
{
    ...
    public class AmazonCodeConnectionsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCodeConnectionsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CodeConnections.
        /// </summary>
        public AmazonCodeConnectionsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCodeConnectionsAuthSchemeParameters
            {
    ...
    public class AmazonCodeConnectionsAuthSchemeResolver : IAuthSchemeResolver<AmazonCodeConnectionsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCodeConnectionsAuthSchemeParameters authParameters)
        {
