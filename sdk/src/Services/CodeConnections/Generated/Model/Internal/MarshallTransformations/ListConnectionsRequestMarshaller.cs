...
namespace Amazon.CodeConnections.Model.Internal.MarshallTransformations
{
    ...
    public class ListConnectionsRequestMarshaller : IMarshaller<IRequest, ListConnectionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListConnectionsRequest publicRequest)
        {
            ...
            string target = "com.amazonaws.codeconnections.CodeConnections_20231201.ListConnections";
            ...
            if(publicRequest.IsSetHostArnFilter())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.HostArnFilter);
            }
            ...
            if(publicRequest.IsSetProviderTypeFilter())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ProviderTypeFilter);
            }
