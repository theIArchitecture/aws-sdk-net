...
namespace Amazon.CodeConnections
{
    ...
    /// <summary>
    /// Constants used for properties of type PullRequestComment.
    /// </summary>
    public class PullRequestComment : ConstantClass
    {

        /// <summary>
        /// Constant DISABLED for PullRequestComment
        /// </summary>
        public static readonly PullRequestComment DISABLED = new PullRequestComment("DISABLED");
        /// <summary>
        /// Constant ENABLED for PullRequestComment
        /// </summary>
        public static readonly PullRequestComment ENABLED = new PullRequestComment("ENABLED");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public PullRequestComment(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static PullRequestComment FindValue(string value)
        {
            return FindValue<PullRequestComment>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator PullRequestComment(string value)
        {
            return FindValue(value);
        }
    }
