...
#elif NETCOREAPP3_1
[assembly: AssemblyDescription("The Amazon Web Services SDK for .NET (.NET Core 3.1) - AWS CodeConnections. Duplicating the CodeStar Connections service into the new, rebranded AWS CodeConnections service.")]
#elif NET8_0
[assembly: AssemblyDescription("The Amazon Web Services SDK for .NET (.NET 8.0) - AWS CodeConnections. Duplicating the CodeStar Connections service into the new, rebranded AWS CodeConnections service.")]
#else
