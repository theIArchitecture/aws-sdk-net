...
namespace Amazon.CodeDeploy.Model
{
    ...
    public partial class DeploymentTargetListSizeExceededException : AmazonCodeDeployException
    {
        ...
        public DeploymentTargetListSizeExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DeploymentTargetListSizeExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
