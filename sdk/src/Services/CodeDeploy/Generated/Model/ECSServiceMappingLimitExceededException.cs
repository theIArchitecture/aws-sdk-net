...
namespace Amazon.CodeDeploy.Model
{
    ...
    public partial class ECSServiceMappingLimitExceededException : AmazonCodeDeployException
    {
        ...
        public ECSServiceMappingLimitExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ECSServiceMappingLimitExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
