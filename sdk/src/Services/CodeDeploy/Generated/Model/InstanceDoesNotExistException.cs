...
namespace Amazon.CodeDeploy.Model
{
    ...
    public partial class InstanceDoesNotExistException : AmazonCodeDeployException
    {
        ...
        public InstanceDoesNotExistException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InstanceDoesNotExistException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
