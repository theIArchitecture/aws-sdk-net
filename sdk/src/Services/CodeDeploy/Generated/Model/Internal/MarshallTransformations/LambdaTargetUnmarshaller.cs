...
namespace Amazon.CodeDeploy.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LambdaTargetUnmarshaller : IJsonUnmarshaller<LambdaTarget, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LambdaTarget Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("lambdaFunctionInfo", targetDepth))
                {
                    ...
                    unmarshalledObject.LambdaFunctionInfo = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
