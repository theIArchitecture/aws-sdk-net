...
namespace Amazon.CodeDeploy.Model
{
    ...
    public partial class InvalidBlueGreenDeploymentConfigurationException : AmazonCodeDeployException
    {
        ...
        public InvalidBlueGreenDeploymentConfigurationException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidBlueGreenDeploymentConfigurationException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
