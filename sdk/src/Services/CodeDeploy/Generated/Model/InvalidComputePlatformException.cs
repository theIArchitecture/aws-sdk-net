...
namespace Amazon.CodeDeploy.Model
{
    ...
    public partial class InvalidComputePlatformException : AmazonCodeDeployException
    {
        ...
        public InvalidComputePlatformException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidComputePlatformException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
