...
namespace Amazon.CodeDeploy.Model
{
    ...
    public partial class InvalidIgnoreApplicationStopFailuresValueException : AmazonCodeDeployException
    {
        ...
        public InvalidIgnoreApplicationStopFailuresValueException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidIgnoreApplicationStopFailuresValueException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
