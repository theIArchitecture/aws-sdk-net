...
namespace Amazon.CodeDeploy.Model
{
    ...
    public partial class MultipleIamArnsProvidedException : AmazonCodeDeployException
    {
        ...
        public MultipleIamArnsProvidedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public MultipleIamArnsProvidedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
