...
namespace Amazon.CodeGuruProfiler.Internal
{
    ...
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for CodeGuruProfiler service requests.
    /// Collects values for CodeGuruProfilerEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses CodeGuruProfilerEndpointProvider.
