...
namespace Amazon.CodeGuruProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FrameMetricDatumUnmarshaller : IJsonUnmarshaller<FrameMetricDatum, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FrameMetricDatum Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
