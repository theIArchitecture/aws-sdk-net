...
namespace Amazon.CodeGuruProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FrameMetricUnmarshaller : IJsonUnmarshaller<FrameMetric, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FrameMetric Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
