...
{
    /// <summary>
    /// Amazon CodeGuruReviewer endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for CodeGuruReviewer service requests.
    /// Collects values for CodeGuruReviewerEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses CodeGuruReviewerEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonCodeGuruReviewerEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonCodeGuruReviewerConfig)requestContext.ClientConfig;
            var result = new CodeGuruReviewerEndpointParameters();
