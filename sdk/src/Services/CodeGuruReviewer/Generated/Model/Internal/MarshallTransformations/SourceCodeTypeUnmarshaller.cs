...
namespace Amazon.CodeGuruReviewer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SourceCodeTypeUnmarshaller : IJsonUnmarshaller<SourceCodeType, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SourceCodeType Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
