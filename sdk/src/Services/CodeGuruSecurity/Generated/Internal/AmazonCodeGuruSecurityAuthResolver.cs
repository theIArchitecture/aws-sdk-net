...
namespace Amazon.CodeGuruSecurity.Internal
{
    ...
    public class AmazonCodeGuruSecurityAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCodeGuruSecurityAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CodeGuruSecurity.
        /// </summary>
        public AmazonCodeGuruSecurityAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCodeGuruSecurityAuthSchemeParameters
            {
    ...
    public class AmazonCodeGuruSecurityAuthSchemeResolver : IAuthSchemeResolver<AmazonCodeGuruSecurityAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCodeGuruSecurityAuthSchemeParameters authParameters)
        {
