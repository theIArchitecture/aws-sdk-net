...
namespace Amazon.CodeGuruSecurity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateScanRequestMarshaller : IMarshaller<IRequest, CreateScanRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static CreateScanRequestMarshaller _instance = new CreateScanRequestMarshaller();        

        internal static CreateScanRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateScanRequestMarshaller Instance
        {
            get
            {
                return _instance;
