...
namespace Amazon.CodeGuruSecurity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FindingMetricsValuePerSeverityUnmarshaller : IJsonUnmarshaller<FindingMetricsValuePerSeverity, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FindingMetricsValuePerSeverity Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
