...
namespace Amazon.CodeGuruSecurity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetMetricsSummaryRequestMarshaller : IMarshaller<IRequest, GetMetricsSummaryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetMetricsSummaryRequestMarshaller _instance = new GetMetricsSummaryRequestMarshaller();        

        internal static GetMetricsSummaryRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMetricsSummaryRequestMarshaller Instance
        {
            get
            {
                return _instance;
