...
{
    /// <summary>
    /// Response Unmarshaller for GetScan operation
    /// </summary>  
    public class GetScanResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetScanResponse response = new GetScanResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("numberOfRevisions", targetDepth))
                {
                    ...
                    response.NumberOfRevisions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetScanResponseUnmarshaller _instance = new GetScanResponseUnmarshaller();        

        internal static GetScanResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetScanResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
