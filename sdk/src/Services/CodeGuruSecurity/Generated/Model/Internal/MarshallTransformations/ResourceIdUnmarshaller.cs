...
namespace Amazon.CodeGuruSecurity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResourceIdUnmarshaller : IJsonUnmarshaller<ResourceId, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResourceId Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("codeArtifactId", targetDepth))
                {
                    ...
                    unmarshalledObject.CodeArtifactId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
