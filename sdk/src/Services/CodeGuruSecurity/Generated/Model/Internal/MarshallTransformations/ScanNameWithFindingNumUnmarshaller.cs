...
namespace Amazon.CodeGuruSecurity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ScanNameWithFindingNumUnmarshaller : IJsonUnmarshaller<ScanNameWithFindingNum, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ScanNameWithFindingNum Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
