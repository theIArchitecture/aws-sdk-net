...
namespace Amazon.CodeGuruSecurity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ScanSummaryUnmarshaller : IJsonUnmarshaller<ScanSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ScanSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ScanNameArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
