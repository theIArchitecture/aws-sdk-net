...
namespace Amazon.CodePipeline.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExecutionTriggerUnmarshaller : IJsonUnmarshaller<ExecutionTrigger, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ExecutionTrigger Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("triggerDetail", targetDepth))
                {
                    ...
                    unmarshalledObject.TriggerDetail = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
