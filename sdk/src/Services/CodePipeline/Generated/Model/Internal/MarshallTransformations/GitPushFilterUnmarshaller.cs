...
{
    /// <summary>
    /// Response Unmarshaller for GitPushFilter Object
    /// </summary>  
    public class GitPushFilterUnmarshaller : IJsonUnmarshaller<GitPushFilter, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GitPushFilter Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static GitPushFilterUnmarshaller _instance = new GitPushFilterUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static GitPushFilterUnmarshaller Instance
        {
            get
            {
                return _instance;
