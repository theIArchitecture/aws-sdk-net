...
{
    /// <summary>
    /// Response Unmarshaller for ListRuleTypes operation
    /// </summary>  
    public class ListRuleTypesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListRuleTypesResponse response = new ListRuleTypesResponse();
        ...
        private static ListRuleTypesResponseUnmarshaller _instance = new ListRuleTypesResponseUnmarshaller();        

        internal static ListRuleTypesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRuleTypesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
