...
namespace Amazon.CodePipeline.Model.Internal.MarshallTransformations
{
    ...
    public class PipelineExecutionOutdatedExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<PipelineExecutionOutdatedException, JsonUnmarshallerContext>
    {
        ...
        private static PipelineExecutionOutdatedExceptionUnmarshaller _instance = new PipelineExecutionOutdatedExceptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PipelineExecutionOutdatedExceptionUnmarshaller Instance
        {
            get
            {
                return _instance;
