...
namespace Amazon.CodePipeline.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PipelineTriggerDeclarationUnmarshaller : IJsonUnmarshaller<PipelineTriggerDeclaration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PipelineTriggerDeclaration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("gitConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.GitConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
