...
namespace Amazon.CodePipeline.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResolvedPipelineVariableUnmarshaller : IJsonUnmarshaller<ResolvedPipelineVariable, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResolvedPipelineVariable Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ResolvedValue = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
