...
{
    /// <summary>
    /// Response Unmarshaller for RuleExecutionInput Object
    /// </summary>  
    public class RuleExecutionInputUnmarshaller : IJsonUnmarshaller<RuleExecutionInput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RuleExecutionInput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            RuleExecutionInput unmarshalledObject = new RuleExecutionInput();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ruleTypeId", targetDepth))
                {
                    ...
                    unmarshalledObject.RuleTypeId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static RuleExecutionInputUnmarshaller _instance = new RuleExecutionInputUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RuleExecutionInputUnmarshaller Instance
        {
            get
            {
                return _instance;
