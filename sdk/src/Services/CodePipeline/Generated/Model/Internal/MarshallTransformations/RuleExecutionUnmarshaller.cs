...
{
    /// <summary>
    /// Response Unmarshaller for RuleExecution Object
    /// </summary>  
    public class RuleExecutionUnmarshaller : IJsonUnmarshaller<RuleExecution, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RuleExecution Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            RuleExecution unmarshalledObject = new RuleExecution();
        ...
        private static RuleExecutionUnmarshaller _instance = new RuleExecutionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RuleExecutionUnmarshaller Instance
        {
            get
            {
                return _instance;
