...
{
    /// <summary>
    /// Container for the parameters to the ListRuleExecutions operation.
    /// Lists the rule executions that have occurred in a pipeline configured for conditions
    /// with rules.
    /// </summary>
    public partial class ListRuleExecutionsRequest : AmazonCodePipelineRequest
    {
        private RuleExecutionFilter _filter;
        ...
        /// </para>
        /// </summary>
        public RuleExecutionFilter Filter
        {
        ...
        /// <para>
        /// The token that was returned from the previous <c>ListRuleExecutions</c> call, which
