...
namespace Amazon.CodePipeline.Model
{
    ...
    public partial class PipelineExecutionNotFoundException : AmazonCodePipelineException
    {
        ...
        public PipelineExecutionNotFoundException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public PipelineExecutionNotFoundException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
