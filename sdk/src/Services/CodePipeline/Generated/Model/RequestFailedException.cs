...
namespace Amazon.CodePipeline.Model
{
    ...
    [Serializable]
    #endif
    public partial class RequestFailedException : AmazonCodePipelineException
    {
        ...
        public RequestFailedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public RequestFailedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
