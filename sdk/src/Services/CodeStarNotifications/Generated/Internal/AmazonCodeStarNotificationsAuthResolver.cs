...
namespace Amazon.CodeStarNotifications.Internal
{
    ...
    public class AmazonCodeStarNotificationsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCodeStarNotificationsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CodeStarNotifications.
        /// </summary>
        public AmazonCodeStarNotificationsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCodeStarNotificationsAuthSchemeParameters
            {
    ...
    public class AmazonCodeStarNotificationsAuthSchemeResolver : IAuthSchemeResolver<AmazonCodeStarNotificationsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCodeStarNotificationsAuthSchemeParameters authParameters)
        {
