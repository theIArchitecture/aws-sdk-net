...
{
    /// <summary>
    /// Amazon CodeStarNotifications endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for CodeStarNotifications service requests.
    /// Collects values for CodeStarNotificationsEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses CodeStarNotificationsEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonCodeStarNotificationsEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonCodeStarNotificationsConfig)requestContext.ClientConfig;
            var result = new CodeStarNotificationsEndpointParameters();
