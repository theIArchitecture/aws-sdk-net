...
namespace Amazon.CodeStarNotifications.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EventTypeSummaryUnmarshaller : IJsonUnmarshaller<EventTypeSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EventTypeSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("EventTypeId", targetDepth))
                {
                    ...
                    unmarshalledObject.EventTypeId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
