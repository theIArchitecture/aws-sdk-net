...
namespace Amazon.CodeStarNotifications.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TargetSummaryUnmarshaller : IJsonUnmarshaller<TargetSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TargetSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("TargetAddress", targetDepth))
                {
                    ...
                    unmarshalledObject.TargetAddress = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
