...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSyncConfiguration operation
    /// </summary>  
    public class DeleteSyncConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSyncConfigurationResponse response = new DeleteSyncConfigurationResponse();
        ...
        private static DeleteSyncConfigurationResponseUnmarshaller _instance = new DeleteSyncConfigurationResponseUnmarshaller();        

        internal static DeleteSyncConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSyncConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
