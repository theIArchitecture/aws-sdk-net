...
{
    /// <summary>
    /// Response Unmarshaller for GetRepositoryLink operation
    /// </summary>  
    public class GetRepositoryLinkResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRepositoryLinkResponse response = new GetRepositoryLinkResponse();
        ...
        private static GetRepositoryLinkResponseUnmarshaller _instance = new GetRepositoryLinkResponseUnmarshaller();        

        internal static GetRepositoryLinkResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRepositoryLinkResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
