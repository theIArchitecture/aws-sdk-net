...
namespace Amazon.CodeStarconnections.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RepositorySyncAttemptUnmarshaller : IJsonUnmarshaller<RepositorySyncAttempt, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RepositorySyncAttempt Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
