...
namespace Amazon.CognitoIdentity.Internal
{
    ...
    public class AmazonCognitoIdentityAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCognitoIdentityAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CognitoIdentity.
        /// </summary>
        public AmazonCognitoIdentityAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCognitoIdentityAuthSchemeParameters
            {
    ...
    public class AmazonCognitoIdentityAuthSchemeResolver : IAuthSchemeResolver<AmazonCognitoIdentityAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCognitoIdentityAuthSchemeParameters authParameters)
        {
            switch (authParameters.Operation)
            {
                case "GetCredentialsForIdentityRequest":
                    return AuthSchemeOption.DEFAULT_NOAUTH;
                case "GetIdRequest":
                    return AuthSchemeOption.DEFAULT_NOAUTH;
                case "GetOpenIdTokenRequest":
                    return AuthSchemeOption.DEFAULT_NOAUTH;
