...
namespace Amazon.CognitoIdentity.Model
{
    ...
    public partial class DeveloperUserAlreadyRegisteredException : AmazonCognitoIdentityException
    {
        ...
        public DeveloperUserAlreadyRegisteredException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DeveloperUserAlreadyRegisteredException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
