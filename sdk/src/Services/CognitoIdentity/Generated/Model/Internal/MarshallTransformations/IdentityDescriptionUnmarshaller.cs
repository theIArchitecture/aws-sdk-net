...
namespace Amazon.CognitoIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IdentityDescriptionUnmarshaller : IJsonUnmarshaller<IdentityDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IdentityDescription Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Logins", targetDepth))
                {
                    ...
                    unmarshalledObject.Logins = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
