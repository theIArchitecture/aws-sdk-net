...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonCognitoIdentityConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonCognitoIdentityConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonCognitoIdentityConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonCognitoIdentityConfig to create AmazonCognitoIdentityClient");
            }

            return awsCredentials == null ? 
                    new AmazonCognitoIdentityClient(serviceClientConfig) :
                    new AmazonCognitoIdentityClient(awsCredentials, serviceClientConfig);
        }
