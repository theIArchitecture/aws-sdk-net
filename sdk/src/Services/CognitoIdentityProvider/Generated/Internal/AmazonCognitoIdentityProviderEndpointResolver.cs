...
namespace Amazon.CognitoIdentityProvider.Internal
{
    ...
    /// </summary>
    public class AmazonCognitoIdentityProviderEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonCognitoIdentityProviderConfig)requestContext.ClientConfig;
            var result = new CognitoIdentityProviderEndpointParameters();
