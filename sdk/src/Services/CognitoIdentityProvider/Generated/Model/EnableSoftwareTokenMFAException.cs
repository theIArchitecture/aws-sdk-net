...
namespace Amazon.CognitoIdentityProvider.Model
{
    ...
    public partial class EnableSoftwareTokenMFAException : AmazonCognitoIdentityProviderException
    {
        ...
        public EnableSoftwareTokenMFAException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public EnableSoftwareTokenMFAException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
