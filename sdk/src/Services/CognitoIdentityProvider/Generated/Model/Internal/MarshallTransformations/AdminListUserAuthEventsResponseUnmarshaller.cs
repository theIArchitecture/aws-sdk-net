    ...
    public class AdminListUserAuthEventsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AuthEventType, AuthEventTypeUnmarshaller>(AuthEventTypeUnmarshaller.Instance);
                    response.AuthEvents = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
