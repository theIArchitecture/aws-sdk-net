...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AdvancedSecurityAdditionalFlowsTypeUnmarshaller : IJsonUnmarshaller<AdvancedSecurityAdditionalFlowsType, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AdvancedSecurityAdditionalFlowsType Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("CustomAuthMode", targetDepth))
                {
                    ...
                    unmarshalledObject.CustomAuthMode = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
