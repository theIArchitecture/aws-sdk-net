...
{
    /// <summary>
    /// Response Unmarshaller for CreateManagedLoginBranding operation
    /// </summary>  
    public class CreateManagedLoginBrandingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateManagedLoginBrandingResponse response = new CreateManagedLoginBrandingResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("ManagedLoginBrandingExistsException"))
                {
                    return ManagedLoginBrandingExistsExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static CreateManagedLoginBrandingResponseUnmarshaller _instance = new CreateManagedLoginBrandingResponseUnmarshaller();        

        internal static CreateManagedLoginBrandingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateManagedLoginBrandingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
