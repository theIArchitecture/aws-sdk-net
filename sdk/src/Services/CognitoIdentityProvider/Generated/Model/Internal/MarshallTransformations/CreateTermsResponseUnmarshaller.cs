...
{
    /// <summary>
    /// Response Unmarshaller for CreateTerms operation
    /// </summary>  
    public class CreateTermsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTermsResponse response = new CreateTermsResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("TermsExistsException"))
                {
                    return TermsExistsExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static CreateTermsResponseUnmarshaller _instance = new CreateTermsResponseUnmarshaller();        

        internal static CreateTermsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTermsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
