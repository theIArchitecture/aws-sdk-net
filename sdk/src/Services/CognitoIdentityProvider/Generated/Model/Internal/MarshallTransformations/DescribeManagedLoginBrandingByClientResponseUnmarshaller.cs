...
{
    /// <summary>
    /// Response Unmarshaller for DescribeManagedLoginBrandingByClient operation
    /// </summary>  
    public class DescribeManagedLoginBrandingByClientResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeManagedLoginBrandingByClientResponse response = new DescribeManagedLoginBrandingByClientResponse();
        ...
        private static DescribeManagedLoginBrandingByClientResponseUnmarshaller _instance = new DescribeManagedLoginBrandingByClientResponseUnmarshaller();        

        internal static DescribeManagedLoginBrandingByClientResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeManagedLoginBrandingByClientResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
