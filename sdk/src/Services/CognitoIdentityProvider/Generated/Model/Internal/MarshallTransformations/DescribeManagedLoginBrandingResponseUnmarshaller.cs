...
{
    /// <summary>
    /// Response Unmarshaller for DescribeManagedLoginBranding operation
    /// </summary>  
    public class DescribeManagedLoginBrandingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeManagedLoginBrandingResponse response = new DescribeManagedLoginBrandingResponse();
        ...
        private static DescribeManagedLoginBrandingResponseUnmarshaller _instance = new DescribeManagedLoginBrandingResponseUnmarshaller();        

        internal static DescribeManagedLoginBrandingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeManagedLoginBrandingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
