...
{
    /// <summary>
    /// Response Unmarshaller for DescribeTerms operation
    /// </summary>  
    public class DescribeTermsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeTermsResponse response = new DescribeTermsResponse();
        ...
        private static DescribeTermsResponseUnmarshaller _instance = new DescribeTermsResponseUnmarshaller();        

        internal static DescribeTermsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTermsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
