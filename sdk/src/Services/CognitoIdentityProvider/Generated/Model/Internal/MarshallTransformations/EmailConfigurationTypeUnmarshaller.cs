...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EmailConfigurationTypeUnmarshaller : IJsonUnmarshaller<EmailConfigurationType, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EmailConfigurationType Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.EmailSendingAccount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ReplyToEmailAddress = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
