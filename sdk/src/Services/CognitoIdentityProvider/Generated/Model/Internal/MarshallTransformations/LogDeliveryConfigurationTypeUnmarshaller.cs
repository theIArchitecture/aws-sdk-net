...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    public class LogDeliveryConfigurationTypeUnmarshaller : IJsonUnmarshaller<LogDeliveryConfigurationType, JsonUnmarshallerContext>
    {
        ...
        private static LogDeliveryConfigurationTypeUnmarshaller _instance = new LogDeliveryConfigurationTypeUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static LogDeliveryConfigurationTypeUnmarshaller Instance
        {
            get
            {
                return _instance;
