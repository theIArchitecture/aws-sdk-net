...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NewDeviceMetadataTypeUnmarshaller : IJsonUnmarshaller<NewDeviceMetadataType, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NewDeviceMetadataType Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("DeviceGroupKey", targetDepth))
                {
                    ...
                    unmarshalledObject.DeviceGroupKey = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
