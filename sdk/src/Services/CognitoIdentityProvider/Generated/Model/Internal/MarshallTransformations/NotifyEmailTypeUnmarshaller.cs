...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NotifyEmailTypeUnmarshaller : IJsonUnmarshaller<NotifyEmailType, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NotifyEmailType Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TextBody = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
