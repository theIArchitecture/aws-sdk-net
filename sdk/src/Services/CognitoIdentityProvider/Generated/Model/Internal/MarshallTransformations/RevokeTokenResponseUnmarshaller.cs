...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RevokeTokenResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("UnsupportedTokenTypeException"))
                {
                    return UnsupportedTokenTypeExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
            }
        ...
        private static RevokeTokenResponseUnmarshaller _instance = new RevokeTokenResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RevokeTokenResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
