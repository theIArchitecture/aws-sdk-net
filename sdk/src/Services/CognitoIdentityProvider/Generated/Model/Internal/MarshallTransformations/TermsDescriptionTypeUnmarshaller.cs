...
{
    /// <summary>
    /// Response Unmarshaller for TermsDescriptionType Object
    /// </summary>  
    public class TermsDescriptionTypeUnmarshaller : IJsonUnmarshaller<TermsDescriptionType, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TermsDescriptionType Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            TermsDescriptionType unmarshalledObject = new TermsDescriptionType();
        ...
        private static TermsDescriptionTypeUnmarshaller _instance = new TermsDescriptionTypeUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TermsDescriptionTypeUnmarshaller Instance
        {
            get
            {
                return _instance;
