...
{
    /// <summary>
    /// Response Unmarshaller for UpdateTerms operation
    /// </summary>  
    public class UpdateTermsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateTermsResponse response = new UpdateTermsResponse();
        ...
        private static UpdateTermsResponseUnmarshaller _instance = new UpdateTermsResponseUnmarshaller();        

        internal static UpdateTermsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTermsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
