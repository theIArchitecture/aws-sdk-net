...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class WebAuthnConfigurationTypeUnmarshaller : IJsonUnmarshaller<WebAuthnConfigurationType, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public WebAuthnConfigurationType Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.UserVerification = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
