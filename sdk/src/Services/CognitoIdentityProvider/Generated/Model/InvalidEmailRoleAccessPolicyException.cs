...
namespace Amazon.CognitoIdentityProvider.Model
{
    ...
    public partial class InvalidEmailRoleAccessPolicyException : AmazonCognitoIdentityProviderException
    {
        ...
        public InvalidEmailRoleAccessPolicyException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidEmailRoleAccessPolicyException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
