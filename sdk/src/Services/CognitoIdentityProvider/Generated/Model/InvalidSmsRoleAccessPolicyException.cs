...
namespace Amazon.CognitoIdentityProvider.Model
{
    ...
    public partial class InvalidSmsRoleAccessPolicyException : AmazonCognitoIdentityProviderException
    {
        ...
        public InvalidSmsRoleAccessPolicyException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidSmsRoleAccessPolicyException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
