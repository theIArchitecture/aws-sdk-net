...
{
    /// <summary>
    /// This is the response object from the ListWebAuthnCredentials operation.
    /// </summary>
    public partial class ListWebAuthnCredentialsResponse : AmazonWebServiceResponse
    {
        private List<WebAuthnCredentialDescription> _credentials = AWSConfigs.InitializeCollections ? new List<WebAuthnCredentialDescription>() : null;
