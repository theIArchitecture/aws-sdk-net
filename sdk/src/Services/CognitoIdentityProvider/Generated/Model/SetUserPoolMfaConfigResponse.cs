...
namespace Amazon.CognitoIdentityProvider.Model
{
    ...
    public partial class SetUserPoolMfaConfigResponse : AmazonWebServiceResponse
    {
        ...
        /// <para>
        /// Displays multi-factor authentication (MFA) as on, off, or optional. When <c>ON</c>,
        ...
        /// Includes the message template and the SMS message sending configuration for Amazon
        /// SNS.
        /// </para>
        /// </summary>
