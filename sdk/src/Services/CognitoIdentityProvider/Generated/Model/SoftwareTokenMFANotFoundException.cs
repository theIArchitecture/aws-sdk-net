...
namespace Amazon.CognitoIdentityProvider.Model
{
    ...
    public partial class SoftwareTokenMFANotFoundException : AmazonCognitoIdentityProviderException
    {
        ...
        public SoftwareTokenMFANotFoundException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public SoftwareTokenMFANotFoundException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
