...
namespace Amazon.CognitoIdentityProvider.Model
{
    ...
    public partial class TooManyFailedAttemptsException : AmazonCognitoIdentityProviderException
    {
        ...
        public TooManyFailedAttemptsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TooManyFailedAttemptsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
