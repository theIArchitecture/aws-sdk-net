...
namespace Amazon.CognitoIdentityProvider.Model
{
    ...
    public partial class UnexpectedLambdaException : AmazonCognitoIdentityProviderException
    {
        ...
        public UnexpectedLambdaException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public UnexpectedLambdaException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
