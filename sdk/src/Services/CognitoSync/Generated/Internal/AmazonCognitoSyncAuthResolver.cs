...
namespace Amazon.CognitoSync.Internal
{
    ...
    public class AmazonCognitoSyncAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCognitoSyncAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CognitoSync.
        /// </summary>
        public AmazonCognitoSyncAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCognitoSyncAuthSchemeParameters
            {
    ...
    public class AmazonCognitoSyncAuthSchemeResolver : IAuthSchemeResolver<AmazonCognitoSyncAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCognitoSyncAuthSchemeParameters authParameters)
        {
