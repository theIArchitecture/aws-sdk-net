...
namespace Amazon.CognitoSync.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CognitoStreamsUnmarshaller : IJsonUnmarshaller<CognitoStreams, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CognitoStreams Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.StreamingStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
