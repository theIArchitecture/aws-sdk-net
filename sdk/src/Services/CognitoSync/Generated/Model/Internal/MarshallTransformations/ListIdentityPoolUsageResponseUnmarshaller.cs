    ...
    public class ListIdentityPoolUsageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<IdentityPoolUsage, IdentityPoolUsageUnmarshaller>(IdentityPoolUsageUnmarshaller.Instance);
                    response.IdentityPoolUsages = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
