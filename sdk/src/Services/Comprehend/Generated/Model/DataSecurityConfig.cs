...
namespace Amazon.Comprehend.Model
{
    ...
    /// </summary>
    public partial class DataSecurityConfig
    {
        private string _dataLakeKmsKeyId;
        private string _modelKmsKeyId;
        private string _volumeKmsKeyId;
        private VpcConfig _vpcConfig;

        /// <summary>
        /// Gets and sets the property DataLakeKmsKeyId. 
        /// <para>
        ...
        {
            get { return this._dataLakeKmsKeyId; }
            set { this._dataLakeKmsKeyId = value; }
        }

        // Check to see if DataLakeKmsKeyId property is set
        internal bool IsSetDataLakeKmsKeyId()
        {
            return this._dataLakeKmsKeyId != null;
        }
