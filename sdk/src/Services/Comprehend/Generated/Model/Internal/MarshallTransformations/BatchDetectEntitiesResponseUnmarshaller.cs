    ...
    public class BatchDetectEntitiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BatchDetectEntitiesItemResult, BatchDetectEntitiesItemResultUnmarshaller>(BatchDetectEntitiesItemResultUnmarshaller.Instance);
