    ...
    public class BatchDetectKeyPhrasesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BatchDetectKeyPhrasesItemResult, BatchDetectKeyPhrasesItemResultUnmarshaller>(BatchDetectKeyPhrasesItemResultUnmarshaller.Instance);
