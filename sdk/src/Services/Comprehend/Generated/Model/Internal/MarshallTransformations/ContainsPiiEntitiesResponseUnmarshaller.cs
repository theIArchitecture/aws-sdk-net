...
{
    /// <summary>
    /// Response Unmarshaller for ContainsPiiEntities operation
    /// </summary>  
    public class ContainsPiiEntitiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ContainsPiiEntitiesResponse response = new ContainsPiiEntitiesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<EntityLabel, EntityLabelUnmarshaller>(EntityLabelUnmarshaller.Instance);
        ...
        private static ContainsPiiEntitiesResponseUnmarshaller _instance = new ContainsPiiEntitiesResponseUnmarshaller();        

        internal static ContainsPiiEntitiesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ContainsPiiEntitiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
