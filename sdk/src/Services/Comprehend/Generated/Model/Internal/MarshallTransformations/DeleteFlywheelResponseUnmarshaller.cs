...
{
    /// <summary>
    /// Response Unmarshaller for DeleteFlywheel operation
    /// </summary>  
    public class DeleteFlywheelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteFlywheelResponse response = new DeleteFlywheelResponse();
        ...
        private static DeleteFlywheelResponseUnmarshaller _instance = new DeleteFlywheelResponseUnmarshaller();        

        internal static DeleteFlywheelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteFlywheelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
