...
{
    /// <summary>
    /// Response Unmarshaller for DescribeFlywheelIteration operation
    /// </summary>  
    public class DescribeFlywheelIterationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeFlywheelIterationResponse response = new DescribeFlywheelIterationResponse();
        ...
        private static DescribeFlywheelIterationResponseUnmarshaller _instance = new DescribeFlywheelIterationResponseUnmarshaller();        

        internal static DescribeFlywheelIterationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeFlywheelIterationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
