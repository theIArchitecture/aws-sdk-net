...
{
    /// <summary>
    /// Response Unmarshaller for DetectToxicContent operation
    /// </summary>  
    public class DetectToxicContentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DetectToxicContentResponse response = new DetectToxicContentResponse();
        ...
        private static DetectToxicContentResponseUnmarshaller _instance = new DetectToxicContentResponseUnmarshaller();        

        internal static DetectToxicContentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetectToxicContentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
