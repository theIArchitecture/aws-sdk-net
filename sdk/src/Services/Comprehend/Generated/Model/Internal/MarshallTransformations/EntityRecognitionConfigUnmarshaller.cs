...
namespace Amazon.Comprehend.Model.Internal.MarshallTransformations
{
    ...
    public class EntityRecognitionConfigUnmarshaller : IJsonUnmarshaller<EntityRecognitionConfig, JsonUnmarshallerContext>
    {
        ...
        private static EntityRecognitionConfigUnmarshaller _instance = new EntityRecognitionConfigUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static EntityRecognitionConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
