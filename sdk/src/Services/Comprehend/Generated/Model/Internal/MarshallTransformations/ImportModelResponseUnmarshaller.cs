...
{
    /// <summary>
    /// Response Unmarshaller for ImportModel operation
    /// </summary>  
    public class ImportModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ImportModelResponse response = new ImportModelResponse();
        ...
        private static ImportModelResponseUnmarshaller _instance = new ImportModelResponseUnmarshaller();        

        internal static ImportModelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImportModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
