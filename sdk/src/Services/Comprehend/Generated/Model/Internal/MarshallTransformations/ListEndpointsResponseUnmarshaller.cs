    ...
    public class ListEndpointsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<EndpointProperties, EndpointPropertiesUnmarshaller>(EndpointPropertiesUnmarshaller.Instance);
                    response.EndpointPropertiesList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
