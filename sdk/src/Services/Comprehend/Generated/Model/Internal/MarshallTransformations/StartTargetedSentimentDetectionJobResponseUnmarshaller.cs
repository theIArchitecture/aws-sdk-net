...
{
    /// <summary>
    /// Response Unmarshaller for StartTargetedSentimentDetectionJob operation
    /// </summary>  
    public class StartTargetedSentimentDetectionJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartTargetedSentimentDetectionJobResponse response = new StartTargetedSentimentDetectionJobResponse();
        ...
        private static StartTargetedSentimentDetectionJobResponseUnmarshaller _instance = new StartTargetedSentimentDetectionJobResponseUnmarshaller();        

        internal static StartTargetedSentimentDetectionJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartTargetedSentimentDetectionJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
