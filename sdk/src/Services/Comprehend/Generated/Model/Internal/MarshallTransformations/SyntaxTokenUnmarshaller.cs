...
namespace Amazon.Comprehend.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SyntaxTokenUnmarshaller : IJsonUnmarshaller<SyntaxToken, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SyntaxToken Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("PartOfSpeech", targetDepth))
                {
                    ...
                    unmarshalledObject.PartOfSpeech = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
