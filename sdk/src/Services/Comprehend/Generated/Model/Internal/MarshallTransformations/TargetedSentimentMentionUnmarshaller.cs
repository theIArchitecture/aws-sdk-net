...
namespace Amazon.Comprehend.Model.Internal.MarshallTransformations
{
    ...
    public class TargetedSentimentMentionUnmarshaller : IJsonUnmarshaller<TargetedSentimentMention, JsonUnmarshallerContext>
    {
        ...
        private static TargetedSentimentMentionUnmarshaller _instance = new TargetedSentimentMentionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TargetedSentimentMentionUnmarshaller Instance
        {
            get
            {
                return _instance;
