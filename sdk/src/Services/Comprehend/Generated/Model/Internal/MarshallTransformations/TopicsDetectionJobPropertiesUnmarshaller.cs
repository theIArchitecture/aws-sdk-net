...
namespace Amazon.Comprehend.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TopicsDetectionJobPropertiesUnmarshaller : IJsonUnmarshaller<TopicsDetectionJobProperties, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TopicsDetectionJobProperties Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("NumberOfTopics", targetDepth))
                {
                    ...
                    unmarshalledObject.NumberOfTopics = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
