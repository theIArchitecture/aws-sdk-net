...
{
    /// <summary>
    /// Amazon ComprehendMedical endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for ComprehendMedical service requests.
    /// Collects values for ComprehendMedicalEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses ComprehendMedicalEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonComprehendMedicalEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonComprehendMedicalConfig)requestContext.ClientConfig;
            var result = new ComprehendMedicalEndpointParameters();
