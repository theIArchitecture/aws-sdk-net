...
namespace Amazon.ComprehendMedical.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AttributeUnmarshaller : IJsonUnmarshaller<Attribute, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Attribute Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<Trait, TraitUnmarshaller>(TraitUnmarshaller.Instance);
