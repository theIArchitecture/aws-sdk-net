...
{
    /// <summary>
    /// Response Unmarshaller for DescribeSNOMEDCTInferenceJob operation
    /// </summary>  
    public class DescribeSNOMEDCTInferenceJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeSNOMEDCTInferenceJobResponse response = new DescribeSNOMEDCTInferenceJobResponse();
        ...
        private static DescribeSNOMEDCTInferenceJobResponseUnmarshaller _instance = new DescribeSNOMEDCTInferenceJobResponseUnmarshaller();        

        internal static DescribeSNOMEDCTInferenceJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSNOMEDCTInferenceJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
