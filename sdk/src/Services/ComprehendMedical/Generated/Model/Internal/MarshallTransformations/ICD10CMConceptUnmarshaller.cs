...
namespace Amazon.ComprehendMedical.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ICD10CMConceptUnmarshaller : IJsonUnmarshaller<ICD10CMConcept, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ICD10CMConcept Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
