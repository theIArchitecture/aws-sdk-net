...
{
    /// <summary>
    /// Response Unmarshaller for InferSNOMEDCT operation
    /// </summary>  
    public class InferSNOMEDCTResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            InferSNOMEDCTResponse response = new InferSNOMEDCTResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = CharactersUnmarshaller.Instance;
                    response.Characters = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("Entities", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<SNOMEDCTEntity, SNOMEDCTEntityUnmarshaller>(SNOMEDCTEntityUnmarshaller.Instance);
                ...
                {
                    var unmarshaller = SNOMEDCTDetailsUnmarshaller.Instance;
                    response.SNOMEDCTDetails = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static InferSNOMEDCTResponseUnmarshaller _instance = new InferSNOMEDCTResponseUnmarshaller();        

        internal static InferSNOMEDCTResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InferSNOMEDCTResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
