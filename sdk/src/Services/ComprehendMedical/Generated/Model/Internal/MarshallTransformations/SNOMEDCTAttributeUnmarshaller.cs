...
{
    /// <summary>
    /// Response Unmarshaller for SNOMEDCTAttribute Object
    /// </summary>  
    public class SNOMEDCTAttributeUnmarshaller : IJsonUnmarshaller<SNOMEDCTAttribute, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SNOMEDCTAttribute Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            SNOMEDCTAttribute unmarshalledObject = new SNOMEDCTAttribute();
        ...
        private static SNOMEDCTAttributeUnmarshaller _instance = new SNOMEDCTAttributeUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SNOMEDCTAttributeUnmarshaller Instance
        {
            get
            {
                return _instance;
