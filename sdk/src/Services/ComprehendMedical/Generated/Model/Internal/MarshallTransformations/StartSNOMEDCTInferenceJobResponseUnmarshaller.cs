...
{
    /// <summary>
    /// Response Unmarshaller for StartSNOMEDCTInferenceJob operation
    /// </summary>  
    public class StartSNOMEDCTInferenceJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartSNOMEDCTInferenceJobResponse response = new StartSNOMEDCTInferenceJobResponse();
        ...
        private static StartSNOMEDCTInferenceJobResponseUnmarshaller _instance = new StartSNOMEDCTInferenceJobResponseUnmarshaller();        

        internal static StartSNOMEDCTInferenceJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartSNOMEDCTInferenceJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
