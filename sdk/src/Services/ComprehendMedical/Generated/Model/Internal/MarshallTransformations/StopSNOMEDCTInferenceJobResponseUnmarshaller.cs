...
{
    /// <summary>
    /// Response Unmarshaller for StopSNOMEDCTInferenceJob operation
    /// </summary>  
    public class StopSNOMEDCTInferenceJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopSNOMEDCTInferenceJobResponse response = new StopSNOMEDCTInferenceJobResponse();
        ...
        private static StopSNOMEDCTInferenceJobResponseUnmarshaller _instance = new StopSNOMEDCTInferenceJobResponseUnmarshaller();        

        internal static StopSNOMEDCTInferenceJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopSNOMEDCTInferenceJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
