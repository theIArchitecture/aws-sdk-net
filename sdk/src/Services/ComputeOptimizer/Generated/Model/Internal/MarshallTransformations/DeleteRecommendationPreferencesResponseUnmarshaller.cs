...
{
    /// <summary>
    /// Response Unmarshaller for DeleteRecommendationPreferences operation
    /// </summary>  
    public class DeleteRecommendationPreferencesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteRecommendationPreferencesResponse response = new DeleteRecommendationPreferencesResponse();
        ...
        private static DeleteRecommendationPreferencesResponseUnmarshaller _instance = new DeleteRecommendationPreferencesResponseUnmarshaller();        

        internal static DeleteRecommendationPreferencesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRecommendationPreferencesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
