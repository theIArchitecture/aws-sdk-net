...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    public class ECSServiceProjectedUtilizationMetricUnmarshaller : IJsonUnmarshaller<ECSServiceProjectedUtilizationMetric, JsonUnmarshallerContext>
    {
        ...
        private static ECSServiceProjectedUtilizationMetricUnmarshaller _instance = new ECSServiceProjectedUtilizationMetricUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ECSServiceProjectedUtilizationMetricUnmarshaller Instance
        {
            get
            {
                return _instance;
