...
{
    /// <summary>
    /// ExportEBSVolumeRecommendations Request Marshaller
    /// </summary>       
    public class ExportEBSVolumeRecommendationsRequestMarshaller : IMarshaller<IRequest, ExportEBSVolumeRecommendationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ExportEBSVolumeRecommendationsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ExportEBSVolumeRecommendationsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ComputeOptimizer");
            string target = "ComputeOptimizerService.ExportEBSVolumeRecommendations";
        ...
        private static ExportEBSVolumeRecommendationsRequestMarshaller _instance = new ExportEBSVolumeRecommendationsRequestMarshaller();        

        internal static ExportEBSVolumeRecommendationsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExportEBSVolumeRecommendationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
