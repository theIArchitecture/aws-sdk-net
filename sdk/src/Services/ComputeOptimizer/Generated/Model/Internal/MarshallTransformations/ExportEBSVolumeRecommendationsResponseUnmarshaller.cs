...
{
    /// <summary>
    /// Response Unmarshaller for ExportEBSVolumeRecommendations operation
    /// </summary>  
    public class ExportEBSVolumeRecommendationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ExportEBSVolumeRecommendationsResponse response = new ExportEBSVolumeRecommendationsResponse();
        ...
        private static ExportEBSVolumeRecommendationsResponseUnmarshaller _instance = new ExportEBSVolumeRecommendationsResponseUnmarshaller();        

        internal static ExportEBSVolumeRecommendationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExportEBSVolumeRecommendationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
