...
{
    /// <summary>
    /// ExportLambdaFunctionRecommendations Request Marshaller
    /// </summary>       
    public class ExportLambdaFunctionRecommendationsRequestMarshaller : IMarshaller<IRequest, ExportLambdaFunctionRecommendationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ExportLambdaFunctionRecommendationsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ExportLambdaFunctionRecommendationsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ComputeOptimizer");
            string target = "ComputeOptimizerService.ExportLambdaFunctionRecommendations";
        ...
        private static ExportLambdaFunctionRecommendationsRequestMarshaller _instance = new ExportLambdaFunctionRecommendationsRequestMarshaller();        

        internal static ExportLambdaFunctionRecommendationsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExportLambdaFunctionRecommendationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
