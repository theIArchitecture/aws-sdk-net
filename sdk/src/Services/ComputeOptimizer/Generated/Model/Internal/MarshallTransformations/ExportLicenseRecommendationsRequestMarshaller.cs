...
{
    /// <summary>
    /// ExportLicenseRecommendations Request Marshaller
    /// </summary>       
    public class ExportLicenseRecommendationsRequestMarshaller : IMarshaller<IRequest, ExportLicenseRecommendationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ExportLicenseRecommendationsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ExportLicenseRecommendationsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ComputeOptimizer");
            string target = "ComputeOptimizerService.ExportLicenseRecommendations";
            ...
            if(publicRequest.IsSetFilters())
            {
                ...
                foreach(var publicRequestFiltersListValue in publicRequest.Filters)
                {
                    ...
                    var marshaller = LicenseRecommendationFilterMarshaller.Instance;
        ...
        private static ExportLicenseRecommendationsRequestMarshaller _instance = new ExportLicenseRecommendationsRequestMarshaller();        

        internal static ExportLicenseRecommendationsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExportLicenseRecommendationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
