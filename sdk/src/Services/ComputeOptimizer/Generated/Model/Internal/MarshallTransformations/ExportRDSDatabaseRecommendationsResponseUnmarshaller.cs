...
{
    /// <summary>
    /// Response Unmarshaller for ExportRDSDatabaseRecommendations operation
    /// </summary>  
    public class ExportRDSDatabaseRecommendationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ExportRDSDatabaseRecommendationsResponse response = new ExportRDSDatabaseRecommendationsResponse();
        ...
        private static ExportRDSDatabaseRecommendationsResponseUnmarshaller _instance = new ExportRDSDatabaseRecommendationsResponseUnmarshaller();        

        internal static ExportRDSDatabaseRecommendationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExportRDSDatabaseRecommendationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
