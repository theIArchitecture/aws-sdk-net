    ...
    public class GetEC2InstanceRecommendationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<InstanceRecommendation, InstanceRecommendationUnmarshaller>(InstanceRecommendationUnmarshaller.Instance);
                    response.InstanceRecommendations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
