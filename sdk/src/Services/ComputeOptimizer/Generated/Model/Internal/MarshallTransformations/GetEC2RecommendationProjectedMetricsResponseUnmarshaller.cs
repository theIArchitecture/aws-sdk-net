    ...
    public class GetEC2RecommendationProjectedMetricsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<RecommendedOptionProjectedMetric, RecommendedOptionProjectedMetricUnmarshaller>(RecommendedOptionProjectedMetricUnmarshaller.Instance);
