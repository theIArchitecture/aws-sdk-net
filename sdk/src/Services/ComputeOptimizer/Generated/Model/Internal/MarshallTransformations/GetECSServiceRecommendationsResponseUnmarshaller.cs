...
{
    /// <summary>
    /// Response Unmarshaller for GetECSServiceRecommendations operation
    /// </summary>  
    public class GetECSServiceRecommendationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetECSServiceRecommendationsResponse response = new GetECSServiceRecommendationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ECSServiceRecommendation, ECSServiceRecommendationUnmarshaller>(ECSServiceRecommendationUnmarshaller.Instance);
                    response.EcsServiceRecommendations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetECSServiceRecommendationsResponseUnmarshaller _instance = new GetECSServiceRecommendationsResponseUnmarshaller();        

        internal static GetECSServiceRecommendationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetECSServiceRecommendationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
