...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetEffectiveRecommendationPreferencesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("enhancedInfrastructureMetrics", targetDepth))
                {
                    ...
                    response.EnhancedInfrastructureMetrics = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("externalMetricsPreference", targetDepth))
                {
                    ...
                    response.ExternalMetricsPreference = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("preferredResources", targetDepth))
                {
                    ...
                    response.PreferredResources = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("utilizationPreferences", targetDepth))
                {
                    ...
                    response.UtilizationPreferences = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
