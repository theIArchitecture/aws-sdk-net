        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("memberAccountsEnrolled", targetDepth))
                {
                    ...
                    response.MemberAccountsEnrolled = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("numberOfMemberAccountsOptedIn", targetDepth))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    response.NumberOfMemberAccountsOptedIn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
