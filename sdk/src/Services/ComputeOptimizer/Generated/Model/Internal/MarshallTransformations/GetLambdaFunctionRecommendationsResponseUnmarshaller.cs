    ...
    public class GetLambdaFunctionRecommendationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<LambdaFunctionRecommendation, LambdaFunctionRecommendationUnmarshaller>(LambdaFunctionRecommendationUnmarshaller.Instance);
                    response.LambdaFunctionRecommendations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
