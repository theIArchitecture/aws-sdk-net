...
{
    /// <summary>
    /// GetRDSDatabaseRecommendations Request Marshaller
    /// </summary>       
    public class GetRDSDatabaseRecommendationsRequestMarshaller : IMarshaller<IRequest, GetRDSDatabaseRecommendationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetRDSDatabaseRecommendationsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetRDSDatabaseRecommendationsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ComputeOptimizer");
            string target = "ComputeOptimizerService.GetRDSDatabaseRecommendations";
        ...
        private static GetRDSDatabaseRecommendationsRequestMarshaller _instance = new GetRDSDatabaseRecommendationsRequestMarshaller();        

        internal static GetRDSDatabaseRecommendationsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRDSDatabaseRecommendationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
