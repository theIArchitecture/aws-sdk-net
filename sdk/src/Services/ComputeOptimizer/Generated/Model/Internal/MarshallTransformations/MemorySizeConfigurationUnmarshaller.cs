...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    public class MemorySizeConfigurationUnmarshaller : IJsonUnmarshaller<MemorySizeConfiguration, JsonUnmarshallerContext>
    {
        ...
        private static MemorySizeConfigurationUnmarshaller _instance = new MemorySizeConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static MemorySizeConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
