...
{
    /// <summary>
    /// Response Unmarshaller for PutRecommendationPreferences operation
    /// </summary>  
    public class PutRecommendationPreferencesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutRecommendationPreferencesResponse response = new PutRecommendationPreferencesResponse();
        ...
        private static PutRecommendationPreferencesResponseUnmarshaller _instance = new PutRecommendationPreferencesResponseUnmarshaller();        

        internal static PutRecommendationPreferencesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutRecommendationPreferencesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
