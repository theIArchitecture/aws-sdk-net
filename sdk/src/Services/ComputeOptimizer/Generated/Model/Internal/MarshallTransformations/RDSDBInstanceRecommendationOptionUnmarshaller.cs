...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    public class RDSDBInstanceRecommendationOptionUnmarshaller : IJsonUnmarshaller<RDSDBInstanceRecommendationOption, JsonUnmarshallerContext>
    {
        ...
        private static RDSDBInstanceRecommendationOptionUnmarshaller _instance = new RDSDBInstanceRecommendationOptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RDSDBInstanceRecommendationOptionUnmarshaller Instance
        {
            get
            {
                return _instance;
