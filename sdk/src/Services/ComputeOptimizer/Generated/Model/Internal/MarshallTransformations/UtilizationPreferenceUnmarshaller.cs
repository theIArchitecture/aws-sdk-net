...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    public class UtilizationPreferenceUnmarshaller : IJsonUnmarshaller<UtilizationPreference, JsonUnmarshallerContext>
    {
        ...
        private static UtilizationPreferenceUnmarshaller _instance = new UtilizationPreferenceUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static UtilizationPreferenceUnmarshaller Instance
        {
            get
            {
                return _instance;
