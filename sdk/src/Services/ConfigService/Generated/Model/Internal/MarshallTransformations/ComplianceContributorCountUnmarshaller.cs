...
namespace Amazon.ConfigService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ComplianceContributorCountUnmarshaller : IJsonUnmarshaller<ComplianceContributorCount, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ComplianceContributorCount Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("CapExceeded", targetDepth))
                {
                    ...
                    unmarshalledObject.CapExceeded = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("CappedCount", targetDepth))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.CappedCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
