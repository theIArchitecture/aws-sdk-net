    ...
    public class DescribeConfigRulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ConfigRule, ConfigRuleUnmarshaller>(ConfigRuleUnmarshaller.Instance);
                    response.ConfigRules = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
