...
{
    /// <summary>
    /// Response Unmarshaller for GetResourceEvaluationSummary operation
    /// </summary>  
    public class GetResourceEvaluationSummaryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetResourceEvaluationSummaryResponse response = new GetResourceEvaluationSummaryResponse();
        ...
        private static GetResourceEvaluationSummaryResponseUnmarshaller _instance = new GetResourceEvaluationSummaryResponseUnmarshaller();        

        internal static GetResourceEvaluationSummaryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetResourceEvaluationSummaryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
