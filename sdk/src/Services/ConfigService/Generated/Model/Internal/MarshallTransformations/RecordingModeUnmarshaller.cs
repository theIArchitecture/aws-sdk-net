...
{
    /// <summary>
    /// Response Unmarshaller for RecordingMode Object
    /// </summary>  
    public class RecordingModeUnmarshaller : IJsonUnmarshaller<RecordingMode, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RecordingMode Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            RecordingMode unmarshalledObject = new RecordingMode();
        ...
        private static RecordingModeUnmarshaller _instance = new RecordingModeUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RecordingModeUnmarshaller Instance
        {
            get
            {
                return _instance;
