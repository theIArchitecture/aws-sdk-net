...
namespace Amazon.ConfigService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResourceEvaluationUnmarshaller : IJsonUnmarshaller<ResourceEvaluation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResourceEvaluation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("EvaluationStartTimestamp", targetDepth))
                {
                    ...
                    unmarshalledObject.EvaluationStartTimestamp = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
