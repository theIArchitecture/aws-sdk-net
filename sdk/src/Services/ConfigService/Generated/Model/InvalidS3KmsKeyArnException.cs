...
namespace Amazon.ConfigService.Model
{
    ...
    public partial class InvalidS3KmsKeyArnException : AmazonConfigServiceException
    {
        ...
        public InvalidS3KmsKeyArnException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidS3KmsKeyArnException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
