...
namespace Amazon.ConfigService.Model
{
    ...
    public partial class NoAvailableConfigurationRecorderException : AmazonConfigServiceException
    {
        ...
        public NoAvailableConfigurationRecorderException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NoAvailableConfigurationRecorderException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
