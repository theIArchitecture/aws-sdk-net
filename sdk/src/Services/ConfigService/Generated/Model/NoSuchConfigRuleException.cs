...
namespace Amazon.ConfigService.Model
{
    ...
    public partial class NoSuchConfigRuleException : AmazonConfigServiceException
    {
        ...
        public NoSuchConfigRuleException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NoSuchConfigRuleException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
