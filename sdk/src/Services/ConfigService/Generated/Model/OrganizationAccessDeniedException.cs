...
namespace Amazon.ConfigService.Model
{
    ...
    public partial class OrganizationAccessDeniedException : AmazonConfigServiceException
    {
        ...
        public OrganizationAccessDeniedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public OrganizationAccessDeniedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
