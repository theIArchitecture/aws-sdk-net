...
namespace Amazon.ConfigService.Model
{
    ...
    public partial class PutOrganizationConfigRuleRequest : AmazonConfigServiceRequest
    {
        ...
        /// <para>
        /// An <c>OrganizationCustomPolicyRuleMetadata</c> object. This object specifies metadata
        /// for your organization's Config Custom Policy rule. The metadata includes the runtime
        /// system in use, which accounts have debug logging enabled, and other custom rule metadata,
        /// such as resource type, resource ID of Amazon Web Services resource, and organization
        /// trigger types that initiate Config to evaluate Amazon Web Services resources against
        /// a rule.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// An <c>OrganizationCustomRuleMetadata</c> object. This object specifies organization
        ...
        /// <para>
        /// An <c>OrganizationManagedRuleMetadata</c> object. This object specifies organization
