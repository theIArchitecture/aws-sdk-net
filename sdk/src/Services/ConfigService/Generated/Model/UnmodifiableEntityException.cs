...
namespace Amazon.ConfigService.Model
{
    ...
    [Serializable]
    #endif
    public partial class UnmodifiableEntityException : AmazonConfigServiceException
    {
        ...
        public UnmodifiableEntityException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public UnmodifiableEntityException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
