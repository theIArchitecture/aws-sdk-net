...
namespace Amazon.ConfigService.Model
{
    ...
    public interface IDescribeConfigurationAggregatorSourcesStatusPaginator
    {
        ...
        /// </summary>
        IPaginatedEnumerable<DescribeConfigurationAggregatorSourcesStatusResponse> Responses { get; }

        /// <summary>
        /// Enumerable containing all of the AggregatedSourceStatusList
        /// </summary>
        IPaginatedEnumerable<AggregatedSourceStatus> AggregatedSourceStatusList { get; }
    }
}