...
namespace Amazon.Connect.Internal
{
    ...
    public class AmazonConnectAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonConnectAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Connect.
        /// </summary>
        public AmazonConnectAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonConnectAuthSchemeParameters
            {
    ...
    public class AmazonConnectAuthSchemeResolver : IAuthSchemeResolver<AmazonConnectAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonConnectAuthSchemeParameters authParameters)
        {
