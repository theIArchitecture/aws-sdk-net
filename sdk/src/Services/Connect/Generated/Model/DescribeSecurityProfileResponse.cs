...
namespace Amazon.Connect.Model
{
    ...
    public partial class DescribeSecurityProfileResponse : AmazonWebServiceResponse
    {
        ...
        /// <summary>
        /// Gets and sets the property SecurityProfile. 
        /// <para>
        ...
        // Check to see if SecurityProfile property is set
        internal bool IsSetSecurityProfile()
        {
            return this._securityProfile != null;
        }
