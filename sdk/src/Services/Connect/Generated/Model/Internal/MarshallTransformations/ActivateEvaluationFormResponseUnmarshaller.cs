...
{
    /// <summary>
    /// Response Unmarshaller for ActivateEvaluationForm operation
    /// </summary>  
    public class ActivateEvaluationFormResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ActivateEvaluationFormResponse response = new ActivateEvaluationFormResponse();
        ...
        private static ActivateEvaluationFormResponseUnmarshaller _instance = new ActivateEvaluationFormResponseUnmarshaller();        

        internal static ActivateEvaluationFormResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ActivateEvaluationFormResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
