...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AgentContactReferenceUnmarshaller : IJsonUnmarshaller<AgentContactReference, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AgentContactReference Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AgentContactState", targetDepth))
                {
                    ...
                    unmarshalledObject.AgentContactState = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
