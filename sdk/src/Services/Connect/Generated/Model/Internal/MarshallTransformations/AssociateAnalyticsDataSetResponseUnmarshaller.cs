...
{
    /// <summary>
    /// Response Unmarshaller for AssociateAnalyticsDataSet operation
    /// </summary>  
    public class AssociateAnalyticsDataSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateAnalyticsDataSetResponse response = new AssociateAnalyticsDataSetResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ResourceShareArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ResourceShareId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ResourceShareId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("TargetAccountId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TargetAccountId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static AssociateAnalyticsDataSetResponseUnmarshaller _instance = new AssociateAnalyticsDataSetResponseUnmarshaller();        

        internal static AssociateAnalyticsDataSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateAnalyticsDataSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
