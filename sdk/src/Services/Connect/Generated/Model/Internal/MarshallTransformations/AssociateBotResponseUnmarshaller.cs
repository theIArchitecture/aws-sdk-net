...
{
    /// <summary>
    /// Response Unmarshaller for AssociateBot operation
    /// </summary>  
    public class AssociateBotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateBotResponse response = new AssociateBotResponse();
        ...
        private static AssociateBotResponseUnmarshaller _instance = new AssociateBotResponseUnmarshaller();        

        internal static AssociateBotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateBotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
