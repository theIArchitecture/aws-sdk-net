...
{
    /// <summary>
    /// Response Unmarshaller for AssociateFlow operation
    /// </summary>  
    public class AssociateFlowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateFlowResponse response = new AssociateFlowResponse();
        ...
        private static AssociateFlowResponseUnmarshaller _instance = new AssociateFlowResponseUnmarshaller();        

        internal static AssociateFlowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateFlowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
