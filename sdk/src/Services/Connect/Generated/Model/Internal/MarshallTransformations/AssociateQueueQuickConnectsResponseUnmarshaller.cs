...
{
    /// <summary>
    /// Response Unmarshaller for AssociateQueueQuickConnects operation
    /// </summary>  
    public class AssociateQueueQuickConnectsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateQueueQuickConnectsResponse response = new AssociateQueueQuickConnectsResponse();
        ...
        private static AssociateQueueQuickConnectsResponseUnmarshaller _instance = new AssociateQueueQuickConnectsResponseUnmarshaller();        

        internal static AssociateQueueQuickConnectsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateQueueQuickConnectsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
