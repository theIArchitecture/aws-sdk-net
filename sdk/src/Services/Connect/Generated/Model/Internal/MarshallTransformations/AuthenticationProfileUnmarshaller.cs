...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AuthenticationProfileUnmarshaller : IJsonUnmarshaller<AuthenticationProfile, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AuthenticationProfile Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.BlockedIps = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.PeriodicSessionDuration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
