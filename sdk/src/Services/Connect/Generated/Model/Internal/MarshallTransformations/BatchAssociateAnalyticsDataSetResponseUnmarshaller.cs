...
{
    /// <summary>
    /// Response Unmarshaller for BatchAssociateAnalyticsDataSet operation
    /// </summary>  
    public class BatchAssociateAnalyticsDataSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchAssociateAnalyticsDataSetResponse response = new BatchAssociateAnalyticsDataSetResponse();
        ...
        private static BatchAssociateAnalyticsDataSetResponseUnmarshaller _instance = new BatchAssociateAnalyticsDataSetResponseUnmarshaller();        

        internal static BatchAssociateAnalyticsDataSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchAssociateAnalyticsDataSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
