...
{
    /// <summary>
    /// Response Unmarshaller for BatchDisassociateAnalyticsDataSet operation
    /// </summary>  
    public class BatchDisassociateAnalyticsDataSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchDisassociateAnalyticsDataSetResponse response = new BatchDisassociateAnalyticsDataSetResponse();
        ...
        private static BatchDisassociateAnalyticsDataSetResponseUnmarshaller _instance = new BatchDisassociateAnalyticsDataSetResponseUnmarshaller();        

        internal static BatchDisassociateAnalyticsDataSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDisassociateAnalyticsDataSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
