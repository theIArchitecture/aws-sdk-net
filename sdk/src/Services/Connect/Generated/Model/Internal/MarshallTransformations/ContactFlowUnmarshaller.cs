...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ContactFlowUnmarshaller : IJsonUnmarshaller<ContactFlow, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ContactFlow Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FlowContentSha256 = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
