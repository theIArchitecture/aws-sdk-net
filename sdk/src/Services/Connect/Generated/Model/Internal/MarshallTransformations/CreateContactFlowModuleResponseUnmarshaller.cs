...
{
    /// <summary>
    /// Response Unmarshaller for CreateContactFlowModule operation
    /// </summary>  
    public class CreateContactFlowModuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateContactFlowModuleResponse response = new CreateContactFlowModuleResponse();
        ...
        private static CreateContactFlowModuleResponseUnmarshaller _instance = new CreateContactFlowModuleResponseUnmarshaller();        

        internal static CreateContactFlowModuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateContactFlowModuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
