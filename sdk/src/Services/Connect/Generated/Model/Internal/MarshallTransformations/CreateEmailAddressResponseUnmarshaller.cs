...
{
    /// <summary>
    /// Response Unmarshaller for CreateEmailAddress operation
    /// </summary>  
    public class CreateEmailAddressResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateEmailAddressResponse response = new CreateEmailAddressResponse();
        ...
        private static CreateEmailAddressResponseUnmarshaller _instance = new CreateEmailAddressResponseUnmarshaller();        

        internal static CreateEmailAddressResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateEmailAddressResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
