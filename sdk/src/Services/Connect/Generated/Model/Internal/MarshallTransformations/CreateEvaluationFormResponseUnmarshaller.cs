...
{
    /// <summary>
    /// Response Unmarshaller for CreateEvaluationForm operation
    /// </summary>  
    public class CreateEvaluationFormResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateEvaluationFormResponse response = new CreateEvaluationFormResponse();
        ...
        private static CreateEvaluationFormResponseUnmarshaller _instance = new CreateEvaluationFormResponseUnmarshaller();        

        internal static CreateEvaluationFormResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateEvaluationFormResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
