...
{
    /// <summary>
    /// Response Unmarshaller for CreateHoursOfOperationOverride operation
    /// </summary>  
    public class CreateHoursOfOperationOverrideResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateHoursOfOperationOverrideResponse response = new CreateHoursOfOperationOverrideResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("HoursOfOperationOverrideId", targetDepth))
                {
                    ...
                    response.HoursOfOperationOverrideId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateHoursOfOperationOverrideResponseUnmarshaller _instance = new CreateHoursOfOperationOverrideResponseUnmarshaller();        

        internal static CreateHoursOfOperationOverrideResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateHoursOfOperationOverrideResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
