...
{
    /// <summary>
    /// Response Unmarshaller for CreateParticipant operation
    /// </summary>  
    public class CreateParticipantResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("ParticipantCredentials", targetDepth))
                {
                    var unmarshaller = ParticipantTokenCredentialsUnmarshaller.Instance;
                    response.ParticipantCredentials = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateParticipantResponseUnmarshaller _instance = new CreateParticipantResponseUnmarshaller();        

        internal static CreateParticipantResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateParticipantResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
