...
{
    /// <summary>
    /// Response Unmarshaller for CreatePersistentContactAssociation operation
    /// </summary>  
    public class CreatePersistentContactAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePersistentContactAssociationResponse response = new CreatePersistentContactAssociationResponse();
        ...
        private static CreatePersistentContactAssociationResponseUnmarshaller _instance = new CreatePersistentContactAssociationResponseUnmarshaller();        

        internal static CreatePersistentContactAssociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePersistentContactAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
