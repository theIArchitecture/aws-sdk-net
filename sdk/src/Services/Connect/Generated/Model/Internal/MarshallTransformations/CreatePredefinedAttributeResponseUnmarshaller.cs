...
{
    /// <summary>
    /// Response Unmarshaller for CreatePredefinedAttribute operation
    /// </summary>  
    public class CreatePredefinedAttributeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePredefinedAttributeResponse response = new CreatePredefinedAttributeResponse();
        ...
        private static CreatePredefinedAttributeResponseUnmarshaller _instance = new CreatePredefinedAttributeResponseUnmarshaller();        

        internal static CreatePredefinedAttributeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePredefinedAttributeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
