...
{
    /// <summary>
    /// Response Unmarshaller for CreatePushNotificationRegistration operation
    /// </summary>  
    public class CreatePushNotificationRegistrationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePushNotificationRegistrationResponse response = new CreatePushNotificationRegistrationResponse();
        ...
        private static CreatePushNotificationRegistrationResponseUnmarshaller _instance = new CreatePushNotificationRegistrationResponseUnmarshaller();        

        internal static CreatePushNotificationRegistrationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePushNotificationRegistrationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
