...
{
    /// <summary>
    /// Response Unmarshaller for CreateTrafficDistributionGroup operation
    /// </summary>  
    public class CreateTrafficDistributionGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTrafficDistributionGroupResponse response = new CreateTrafficDistributionGroupResponse();
        ...
        private static CreateTrafficDistributionGroupResponseUnmarshaller _instance = new CreateTrafficDistributionGroupResponseUnmarshaller();        

        internal static CreateTrafficDistributionGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTrafficDistributionGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
