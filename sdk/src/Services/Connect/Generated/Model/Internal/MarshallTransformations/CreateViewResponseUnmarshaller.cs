...
{
    /// <summary>
    /// Response Unmarshaller for CreateView operation
    /// </summary>  
    public class CreateViewResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateViewResponseUnmarshaller _instance = new CreateViewResponseUnmarshaller();        

        internal static CreateViewResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateViewResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
