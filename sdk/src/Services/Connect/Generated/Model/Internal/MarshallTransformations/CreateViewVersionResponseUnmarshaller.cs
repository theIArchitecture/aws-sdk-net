...
{
    /// <summary>
    /// Response Unmarshaller for CreateViewVersion operation
    /// </summary>  
    public class CreateViewVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateViewVersionResponse response = new CreateViewVersionResponse();
        ...
        private static CreateViewVersionResponseUnmarshaller _instance = new CreateViewVersionResponseUnmarshaller();        

        internal static CreateViewVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateViewVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
