...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    public class CustomerVoiceActivityUnmarshaller : IJsonUnmarshaller<CustomerVoiceActivity, JsonUnmarshallerContext>
    {
        ...
        private static CustomerVoiceActivityUnmarshaller _instance = new CustomerVoiceActivityUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CustomerVoiceActivityUnmarshaller Instance
        {
            get
            {
                return _instance;
