...
{
    /// <summary>
    /// Response Unmarshaller for DeactivateEvaluationForm operation
    /// </summary>  
    public class DeactivateEvaluationFormResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeactivateEvaluationFormResponse response = new DeactivateEvaluationFormResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("EvaluationFormArn", targetDepth))
                {
                    ...
                    response.EvaluationFormArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("EvaluationFormId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.EvaluationFormId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("EvaluationFormVersion", targetDepth))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    response.EvaluationFormVersion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DeactivateEvaluationFormResponseUnmarshaller _instance = new DeactivateEvaluationFormResponseUnmarshaller();        

        internal static DeactivateEvaluationFormResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeactivateEvaluationFormResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
