...
{
    /// <summary>
    /// Response Unmarshaller for DeleteContactEvaluation operation
    /// </summary>  
    public class DeleteContactEvaluationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteContactEvaluationResponse response = new DeleteContactEvaluationResponse();
        ...
        private static DeleteContactEvaluationResponseUnmarshaller _instance = new DeleteContactEvaluationResponseUnmarshaller();        

        internal static DeleteContactEvaluationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteContactEvaluationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
