...
{
    /// <summary>
    /// Response Unmarshaller for DeleteContactFlowModule operation
    /// </summary>  
    public class DeleteContactFlowModuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteContactFlowModuleResponse response = new DeleteContactFlowModuleResponse();
        ...
        private static DeleteContactFlowModuleResponseUnmarshaller _instance = new DeleteContactFlowModuleResponseUnmarshaller();        

        internal static DeleteContactFlowModuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteContactFlowModuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
