...
{
    /// <summary>
    /// Response Unmarshaller for DeleteContactFlow operation
    /// </summary>  
    public class DeleteContactFlowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteContactFlowResponse response = new DeleteContactFlowResponse();
        ...
        private static DeleteContactFlowResponseUnmarshaller _instance = new DeleteContactFlowResponseUnmarshaller();        

        internal static DeleteContactFlowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteContactFlowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
