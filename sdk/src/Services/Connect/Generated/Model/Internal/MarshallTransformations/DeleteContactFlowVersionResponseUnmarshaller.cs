...
{
    /// <summary>
    /// Response Unmarshaller for DeleteContactFlowVersion operation
    /// </summary>  
    public class DeleteContactFlowVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteContactFlowVersionResponse response = new DeleteContactFlowVersionResponse();
        ...
        private static DeleteContactFlowVersionResponseUnmarshaller _instance = new DeleteContactFlowVersionResponseUnmarshaller();        

        internal static DeleteContactFlowVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteContactFlowVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
