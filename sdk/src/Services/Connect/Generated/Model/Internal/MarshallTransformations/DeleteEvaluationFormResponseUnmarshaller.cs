...
{
    /// <summary>
    /// Response Unmarshaller for DeleteEvaluationForm operation
    /// </summary>  
    public class DeleteEvaluationFormResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteEvaluationFormResponse response = new DeleteEvaluationFormResponse();
        ...
        private static DeleteEvaluationFormResponseUnmarshaller _instance = new DeleteEvaluationFormResponseUnmarshaller();        

        internal static DeleteEvaluationFormResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteEvaluationFormResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
