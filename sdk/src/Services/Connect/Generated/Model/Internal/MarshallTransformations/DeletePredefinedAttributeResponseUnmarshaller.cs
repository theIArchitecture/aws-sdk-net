...
{
    /// <summary>
    /// Response Unmarshaller for DeletePredefinedAttribute operation
    /// </summary>  
    public class DeletePredefinedAttributeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeletePredefinedAttributeResponse response = new DeletePredefinedAttributeResponse();
        ...
        private static DeletePredefinedAttributeResponseUnmarshaller _instance = new DeletePredefinedAttributeResponseUnmarshaller();        

        internal static DeletePredefinedAttributeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePredefinedAttributeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
