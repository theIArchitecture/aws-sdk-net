...
{
    /// <summary>
    /// Response Unmarshaller for DeleteRoutingProfile operation
    /// </summary>  
    public class DeleteRoutingProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteRoutingProfileResponse response = new DeleteRoutingProfileResponse();
        ...
        private static DeleteRoutingProfileResponseUnmarshaller _instance = new DeleteRoutingProfileResponseUnmarshaller();        

        internal static DeleteRoutingProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRoutingProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
