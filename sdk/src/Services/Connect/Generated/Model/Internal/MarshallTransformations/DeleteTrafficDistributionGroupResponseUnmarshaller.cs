...
{
    /// <summary>
    /// Response Unmarshaller for DeleteTrafficDistributionGroup operation
    /// </summary>  
    public class DeleteTrafficDistributionGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteTrafficDistributionGroupResponse response = new DeleteTrafficDistributionGroupResponse();
        ...
        private static DeleteTrafficDistributionGroupResponseUnmarshaller _instance = new DeleteTrafficDistributionGroupResponseUnmarshaller();        

        internal static DeleteTrafficDistributionGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTrafficDistributionGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
