...
{
    /// <summary>
    /// Response Unmarshaller for DeleteViewVersion operation
    /// </summary>  
    public class DeleteViewVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteViewVersionResponse response = new DeleteViewVersionResponse();
        ...
        private static DeleteViewVersionResponseUnmarshaller _instance = new DeleteViewVersionResponseUnmarshaller();        

        internal static DeleteViewVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteViewVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
