...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAgentStatus operation
    /// </summary>  
    public class DescribeAgentStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAgentStatusResponse response = new DescribeAgentStatusResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = AgentStatusUnmarshaller.Instance;
        ...
        private static DescribeAgentStatusResponseUnmarshaller _instance = new DescribeAgentStatusResponseUnmarshaller();        

        internal static DescribeAgentStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAgentStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
