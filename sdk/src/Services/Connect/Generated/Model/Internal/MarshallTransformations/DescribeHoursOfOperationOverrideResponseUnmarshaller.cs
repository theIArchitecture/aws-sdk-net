...
{
    /// <summary>
    /// Response Unmarshaller for DescribeHoursOfOperationOverride operation
    /// </summary>  
    public class DescribeHoursOfOperationOverrideResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeHoursOfOperationOverrideResponse response = new DescribeHoursOfOperationOverrideResponse();
        ...
        private static DescribeHoursOfOperationOverrideResponseUnmarshaller _instance = new DescribeHoursOfOperationOverrideResponseUnmarshaller();        

        internal static DescribeHoursOfOperationOverrideResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeHoursOfOperationOverrideResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
