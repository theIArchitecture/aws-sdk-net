...
{
    /// <summary>
    /// Response Unmarshaller for DescribeQueue operation
    /// </summary>  
    public class DescribeQueueResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeQueueResponse response = new DescribeQueueResponse();
        ...
        private static DescribeQueueResponseUnmarshaller _instance = new DescribeQueueResponseUnmarshaller();        

        internal static DescribeQueueResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeQueueResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
