...
{
    /// <summary>
    /// Response Unmarshaller for DescribeTrafficDistributionGroup operation
    /// </summary>  
    public class DescribeTrafficDistributionGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeTrafficDistributionGroupResponse response = new DescribeTrafficDistributionGroupResponse();
        ...
        private static DescribeTrafficDistributionGroupResponseUnmarshaller _instance = new DescribeTrafficDistributionGroupResponseUnmarshaller();        

        internal static DescribeTrafficDistributionGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTrafficDistributionGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
