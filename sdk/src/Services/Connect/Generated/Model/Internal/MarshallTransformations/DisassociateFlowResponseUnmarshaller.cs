...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateFlow operation
    /// </summary>  
    public class DisassociateFlowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateFlowResponse response = new DisassociateFlowResponse();
        ...
        private static DisassociateFlowResponseUnmarshaller _instance = new DisassociateFlowResponseUnmarshaller();        

        internal static DisassociateFlowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateFlowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
