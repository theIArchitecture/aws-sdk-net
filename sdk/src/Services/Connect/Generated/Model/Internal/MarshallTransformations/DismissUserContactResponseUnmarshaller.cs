...
{
    /// <summary>
    /// Response Unmarshaller for DismissUserContact operation
    /// </summary>  
    public class DismissUserContactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DismissUserContactResponse response = new DismissUserContactResponse();
        ...
        private static DismissUserContactResponseUnmarshaller _instance = new DismissUserContactResponseUnmarshaller();        

        internal static DismissUserContactResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DismissUserContactResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
