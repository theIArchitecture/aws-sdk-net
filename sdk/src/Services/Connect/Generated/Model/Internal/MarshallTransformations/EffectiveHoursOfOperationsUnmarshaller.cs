...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    public class EffectiveHoursOfOperationsUnmarshaller : IJsonUnmarshaller<EffectiveHoursOfOperations, JsonUnmarshallerContext>
    {
        ...
        private static EffectiveHoursOfOperationsUnmarshaller _instance = new EffectiveHoursOfOperationsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static EffectiveHoursOfOperationsUnmarshaller Instance
        {
            get
            {
                return _instance;
