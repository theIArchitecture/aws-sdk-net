...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EvaluationAnswerDataUnmarshaller : IJsonUnmarshaller<EvaluationAnswerData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EvaluationAnswerData Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("NumericValue", targetDepth))
                {
                    ...
                    unmarshalledObject.NumericValue = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
