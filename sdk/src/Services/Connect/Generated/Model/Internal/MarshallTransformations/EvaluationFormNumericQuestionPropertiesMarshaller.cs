...
{
    /// <summary>
    /// EvaluationFormNumericQuestionProperties Marshaller
    /// </summary>
    public class EvaluationFormNumericQuestionPropertiesMarshaller : IRequestMarshaller<EvaluationFormNumericQuestionProperties, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(EvaluationFormNumericQuestionProperties requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetAutomation())
            {
                ...
                var marshaller = EvaluationFormNumericQuestionAutomationMarshaller.Instance;
            ...
            if(requestObject.IsSetOptions())
            {
                ...
                foreach(var requestObjectOptionsListValue in requestObject.Options)
                {
                    ...
                    var marshaller = EvaluationFormNumericQuestionOptionMarshaller.Instance;
        ...
        /// </summary>
        public readonly static EvaluationFormNumericQuestionPropertiesMarshaller Instance = new EvaluationFormNumericQuestionPropertiesMarshaller();
