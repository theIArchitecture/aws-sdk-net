...
{
    /// <summary>
    /// Response Unmarshaller for EvaluationFormSection Object
    /// </summary>  
    public class EvaluationFormSectionUnmarshaller : IJsonUnmarshaller<EvaluationFormSection, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EvaluationFormSection Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            EvaluationFormSection unmarshalledObject = new EvaluationFormSection();
        ...
        private static EvaluationFormSectionUnmarshaller _instance = new EvaluationFormSectionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static EvaluationFormSectionUnmarshaller Instance
        {
            get
            {
                return _instance;
