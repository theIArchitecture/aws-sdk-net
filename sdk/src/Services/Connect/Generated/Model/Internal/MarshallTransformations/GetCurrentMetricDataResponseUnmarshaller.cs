        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("DataSnapshotTime", targetDepth))
                {
                    ...
                    response.DataSnapshotTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("MetricResults", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<CurrentMetricResult, CurrentMetricResultUnmarshaller>(CurrentMetricResultUnmarshaller.Instance);
