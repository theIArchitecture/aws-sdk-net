...
{
    /// <summary>
    /// Response Unmarshaller for GetCurrentUserData operation
    /// </summary>  
    public class GetCurrentUserDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCurrentUserDataResponse response = new GetCurrentUserDataResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<UserData, UserDataUnmarshaller>(UserDataUnmarshaller.Instance);
                    response.UserDataList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetCurrentUserDataResponseUnmarshaller _instance = new GetCurrentUserDataResponseUnmarshaller();        

        internal static GetCurrentUserDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCurrentUserDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
