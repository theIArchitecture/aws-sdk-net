...
{
    /// <summary>
    /// Response Unmarshaller for GetFlowAssociation operation
    /// </summary>  
    public class GetFlowAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetFlowAssociationResponse response = new GetFlowAssociationResponse();
        ...
        private static GetFlowAssociationResponseUnmarshaller _instance = new GetFlowAssociationResponseUnmarshaller();        

        internal static GetFlowAssociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFlowAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
