...
{
    /// <summary>
    /// Response Unmarshaller for GetPromptFile operation
    /// </summary>  
    public class GetPromptFileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPromptFileResponse response = new GetPromptFileResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PromptPresignedUrl = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetPromptFileResponseUnmarshaller _instance = new GetPromptFileResponseUnmarshaller();        

        internal static GetPromptFileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPromptFileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
