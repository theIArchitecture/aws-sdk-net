...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    public class HoursOfOperationTimeSliceUnmarshaller : IJsonUnmarshaller<HoursOfOperationTimeSlice, JsonUnmarshallerContext>
    {
        ...
        private static HoursOfOperationTimeSliceUnmarshaller _instance = new HoursOfOperationTimeSliceUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static HoursOfOperationTimeSliceUnmarshaller Instance
        {
            get
            {
                return _instance;
