...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class HoursOfOperationUnmarshaller : IJsonUnmarshaller<HoursOfOperation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public HoursOfOperation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<HoursOfOperationConfig, HoursOfOperationConfigUnmarshaller>(HoursOfOperationConfigUnmarshaller.Instance);
