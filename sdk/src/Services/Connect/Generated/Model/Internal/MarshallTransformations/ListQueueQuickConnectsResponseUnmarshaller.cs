...
{
    /// <summary>
    /// Response Unmarshaller for ListQueueQuickConnects operation
    /// </summary>  
    public class ListQueueQuickConnectsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListQueueQuickConnectsResponse response = new ListQueueQuickConnectsResponse();
        ...
        private static ListQueueQuickConnectsResponseUnmarshaller _instance = new ListQueueQuickConnectsResponseUnmarshaller();        

        internal static ListQueueQuickConnectsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListQueueQuickConnectsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
