    ...
    public class ListTrafficDistributionGroupUsersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<TrafficDistributionGroupUserSummary, TrafficDistributionGroupUserSummaryUnmarshaller>(TrafficDistributionGroupUserSummaryUnmarshaller.Instance);
                    response.TrafficDistributionGroupUserSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
