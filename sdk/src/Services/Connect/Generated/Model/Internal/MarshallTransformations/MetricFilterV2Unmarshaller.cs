...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MetricFilterV2Unmarshaller : IJsonUnmarshaller<MetricFilterV2, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MetricFilterV2 Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("MetricFilterValues", targetDepth))
                {
                    ...
                    unmarshalledObject.MetricFilterValues = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
