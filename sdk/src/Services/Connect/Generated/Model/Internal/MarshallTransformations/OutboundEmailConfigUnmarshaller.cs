...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OutboundEmailConfigUnmarshaller : IJsonUnmarshaller<OutboundEmailConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public OutboundEmailConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("OutboundEmailAddressId", targetDepth))
                {
                    ...
                    unmarshalledObject.OutboundEmailAddressId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
