...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PredefinedAttributeConfigurationUnmarshaller : IJsonUnmarshaller<PredefinedAttributeConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PredefinedAttributeConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("EnableValueValidationOnAssociation", targetDepth))
                {
                    ...
                    unmarshalledObject.EnableValueValidationOnAssociation = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
