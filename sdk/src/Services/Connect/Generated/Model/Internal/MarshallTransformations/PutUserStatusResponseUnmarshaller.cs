...
{
    /// <summary>
    /// Response Unmarshaller for PutUserStatus operation
    /// </summary>  
    public class PutUserStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutUserStatusResponse response = new PutUserStatusResponse();
        ...
        private static PutUserStatusResponseUnmarshaller _instance = new PutUserStatusResponseUnmarshaller();        

        internal static PutUserStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutUserStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
