...
{
    /// <summary>
    /// QueueSearchCriteria Marshaller
    /// </summary>
    public class QueueSearchCriteriaMarshaller : IRequestMarshaller<QueueSearchCriteria, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(QueueSearchCriteria requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetQueueTypeCondition())
            {
                context.Writer.WritePropertyName("QueueTypeCondition");
                context.Writer.WriteStringValue(requestObject.QueueTypeCondition);
            }
        ...
        /// </summary>
        public readonly static QueueSearchCriteriaMarshaller Instance = new QueueSearchCriteriaMarshaller();
