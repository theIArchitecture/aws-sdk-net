...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    public class RealTimeContactAnalysisSegmentCategoriesUnmarshaller : IJsonUnmarshaller<RealTimeContactAnalysisSegmentCategories, JsonUnmarshallerContext>
    {
        ...
        private static RealTimeContactAnalysisSegmentCategoriesUnmarshaller _instance = new RealTimeContactAnalysisSegmentCategoriesUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RealTimeContactAnalysisSegmentCategoriesUnmarshaller Instance
        {
            get
            {
                return _instance;
