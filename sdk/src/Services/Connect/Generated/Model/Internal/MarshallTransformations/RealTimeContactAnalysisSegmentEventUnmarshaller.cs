...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    public class RealTimeContactAnalysisSegmentEventUnmarshaller : IJsonUnmarshaller<RealTimeContactAnalysisSegmentEvent, JsonUnmarshallerContext>
    {
        ...
        private static RealTimeContactAnalysisSegmentEventUnmarshaller _instance = new RealTimeContactAnalysisSegmentEventUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RealTimeContactAnalysisSegmentEventUnmarshaller Instance
        {
            get
            {
                return _instance;
