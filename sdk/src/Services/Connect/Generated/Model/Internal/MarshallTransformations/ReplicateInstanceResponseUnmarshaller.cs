...
{
    /// <summary>
    /// Response Unmarshaller for ReplicateInstance operation
    /// </summary>  
    public class ReplicateInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ReplicateInstanceResponse response = new ReplicateInstanceResponse();
        ...
        private static ReplicateInstanceResponseUnmarshaller _instance = new ReplicateInstanceResponseUnmarshaller();        

        internal static ReplicateInstanceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ReplicateInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
