...
{
    /// <summary>
    /// Response Unmarshaller for ResumeContact operation
    /// </summary>  
    public class ResumeContactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ResumeContactResponse response = new ResumeContactResponse();
        ...
        private static ResumeContactResponseUnmarshaller _instance = new ResumeContactResponseUnmarshaller();        

        internal static ResumeContactResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ResumeContactResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
