...
{
    /// <summary>
    /// Response Unmarshaller for SearchAgentStatuses operation
    /// </summary>  
    public class SearchAgentStatusesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchAgentStatusesResponse response = new SearchAgentStatusesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AgentStatus, AgentStatusUnmarshaller>(AgentStatusUnmarshaller.Instance);
                    response.AgentStatuses = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static SearchAgentStatusesResponseUnmarshaller _instance = new SearchAgentStatusesResponseUnmarshaller();        

        internal static SearchAgentStatusesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchAgentStatusesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
