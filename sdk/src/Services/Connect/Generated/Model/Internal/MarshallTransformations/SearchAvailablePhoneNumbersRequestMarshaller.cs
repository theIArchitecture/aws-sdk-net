...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    public class SearchAvailablePhoneNumbersRequestMarshaller : IMarshaller<IRequest, SearchAvailablePhoneNumbersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(SearchAvailablePhoneNumbersRequest publicRequest)
        {
            ...
            request.ResourcePath = "/phone-number/search-available";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetPhoneNumberCountryCode())
            {
                context.Writer.WritePropertyName("PhoneNumberCountryCode");
                context.Writer.WriteStringValue(publicRequest.PhoneNumberCountryCode);
            }

            if(publicRequest.IsSetPhoneNumberPrefix())
            {
                context.Writer.WritePropertyName("PhoneNumberPrefix");
                context.Writer.WriteStringValue(publicRequest.PhoneNumberPrefix);
            }

            if(publicRequest.IsSetPhoneNumberType())
            {
                context.Writer.WritePropertyName("PhoneNumberType");
                context.Writer.WriteStringValue(publicRequest.PhoneNumberType);
            }
