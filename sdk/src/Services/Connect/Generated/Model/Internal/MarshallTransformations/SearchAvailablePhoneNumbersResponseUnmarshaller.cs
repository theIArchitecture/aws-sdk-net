    ...
    public class SearchAvailablePhoneNumbersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AvailableNumberSummary, AvailableNumberSummaryUnmarshaller>(AvailableNumberSummaryUnmarshaller.Instance);
                    response.AvailableNumbersList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
