...
{
    /// <summary>
    /// Response Unmarshaller for SearchHoursOfOperations operation
    /// </summary>  
    public class SearchHoursOfOperationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchHoursOfOperationsResponse response = new SearchHoursOfOperationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<HoursOfOperation, HoursOfOperationUnmarshaller>(HoursOfOperationUnmarshaller.Instance);
                    response.HoursOfOperations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static SearchHoursOfOperationsResponseUnmarshaller _instance = new SearchHoursOfOperationsResponseUnmarshaller();        

        internal static SearchHoursOfOperationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchHoursOfOperationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
