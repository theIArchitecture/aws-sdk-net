...
{
    /// <summary>
    /// Response Unmarshaller for SearchQueues operation
    /// </summary>  
    public class SearchQueuesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchQueuesResponse response = new SearchQueuesResponse();
        ...
        private static SearchQueuesResponseUnmarshaller _instance = new SearchQueuesResponseUnmarshaller();        

        internal static SearchQueuesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchQueuesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
