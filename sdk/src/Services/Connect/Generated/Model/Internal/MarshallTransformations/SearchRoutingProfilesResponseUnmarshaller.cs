...
{
    /// <summary>
    /// Response Unmarshaller for SearchRoutingProfiles operation
    /// </summary>  
    public class SearchRoutingProfilesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchRoutingProfilesResponse response = new SearchRoutingProfilesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<RoutingProfile, RoutingProfileUnmarshaller>(RoutingProfileUnmarshaller.Instance);
                    response.RoutingProfiles = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static SearchRoutingProfilesResponseUnmarshaller _instance = new SearchRoutingProfilesResponseUnmarshaller();        

        internal static SearchRoutingProfilesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchRoutingProfilesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
