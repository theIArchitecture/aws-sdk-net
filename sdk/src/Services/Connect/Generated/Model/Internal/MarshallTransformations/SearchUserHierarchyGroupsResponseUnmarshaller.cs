...
{
    /// <summary>
    /// Response Unmarshaller for SearchUserHierarchyGroups operation
    /// </summary>  
    public class SearchUserHierarchyGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchUserHierarchyGroupsResponse response = new SearchUserHierarchyGroupsResponse();
        ...
        private static SearchUserHierarchyGroupsResponseUnmarshaller _instance = new SearchUserHierarchyGroupsResponseUnmarshaller();        

        internal static SearchUserHierarchyGroupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchUserHierarchyGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
