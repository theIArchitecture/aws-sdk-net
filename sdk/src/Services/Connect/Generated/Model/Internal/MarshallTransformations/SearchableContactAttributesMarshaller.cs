...
{
    /// <summary>
    /// SearchableContactAttributes Marshaller
    /// </summary>
    public class SearchableContactAttributesMarshaller : IRequestMarshaller<SearchableContactAttributes, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(SearchableContactAttributes requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetCriteria())
            {
                ...
                foreach(var requestObjectCriteriaListValue in requestObject.Criteria)
                {
                    ...
                    var marshaller = SearchableContactAttributesCriteriaMarshaller.Instance;
        ...
        /// </summary>
        public readonly static SearchableContactAttributesMarshaller Instance = new SearchableContactAttributesMarshaller();
