...
{
    /// <summary>
    /// Response Unmarshaller for SendChatIntegrationEvent operation
    /// </summary>  
    public class SendChatIntegrationEventResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SendChatIntegrationEventResponse response = new SendChatIntegrationEventResponse();
        ...
        private static SendChatIntegrationEventResponseUnmarshaller _instance = new SendChatIntegrationEventResponseUnmarshaller();        

        internal static SendChatIntegrationEventResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendChatIntegrationEventResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
