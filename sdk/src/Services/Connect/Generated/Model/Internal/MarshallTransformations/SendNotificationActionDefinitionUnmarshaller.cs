...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SendNotificationActionDefinitionUnmarshaller : IJsonUnmarshaller<SendNotificationActionDefinition, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SendNotificationActionDefinition Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Recipient", targetDepth))
                {
                    ...
                    unmarshalledObject.Recipient = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
