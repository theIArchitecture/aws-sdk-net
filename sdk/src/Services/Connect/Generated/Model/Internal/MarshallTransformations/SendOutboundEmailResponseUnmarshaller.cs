...
{
    /// <summary>
    /// Response Unmarshaller for SendOutboundEmail operation
    /// </summary>  
    public class SendOutboundEmailResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SendOutboundEmailResponse response = new SendOutboundEmailResponse();
        ...
        private static SendOutboundEmailResponseUnmarshaller _instance = new SendOutboundEmailResponseUnmarshaller();        

        internal static SendOutboundEmailResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendOutboundEmailResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
