...
{
    /// <summary>
    /// Response Unmarshaller for StartAttachedFileUpload operation
    /// </summary>  
    public class StartAttachedFileUploadResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartAttachedFileUploadResponse response = new StartAttachedFileUploadResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = UploadUrlMetadataUnmarshaller.Instance;
                    response.UploadUrlMetadata = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static StartAttachedFileUploadResponseUnmarshaller _instance = new StartAttachedFileUploadResponseUnmarshaller();        

        internal static StartAttachedFileUploadResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartAttachedFileUploadResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
