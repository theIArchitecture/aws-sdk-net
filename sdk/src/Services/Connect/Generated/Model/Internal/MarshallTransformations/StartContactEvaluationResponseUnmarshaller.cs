...
{
    /// <summary>
    /// Response Unmarshaller for StartContactEvaluation operation
    /// </summary>  
    public class StartContactEvaluationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartContactEvaluationResponse response = new StartContactEvaluationResponse();
        ...
        private static StartContactEvaluationResponseUnmarshaller _instance = new StartContactEvaluationResponseUnmarshaller();        

        internal static StartContactEvaluationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartContactEvaluationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
