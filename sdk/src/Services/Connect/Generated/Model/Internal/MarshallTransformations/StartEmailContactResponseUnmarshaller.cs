...
{
    /// <summary>
    /// Response Unmarshaller for StartEmailContact operation
    /// </summary>  
    public class StartEmailContactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartEmailContactResponse response = new StartEmailContactResponse();
        ...
        private static StartEmailContactResponseUnmarshaller _instance = new StartEmailContactResponseUnmarshaller();        

        internal static StartEmailContactResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartEmailContactResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
