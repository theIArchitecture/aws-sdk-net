...
{
    /// <summary>
    /// StartOutboundEmailContact Request Marshaller
    /// </summary>       
    public class StartOutboundEmailContactRequestMarshaller : IMarshaller<IRequest, StartOutboundEmailContactRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartOutboundEmailContactRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartOutboundEmailContactRequest publicRequest)
        {
        ...
        private static StartOutboundEmailContactRequestMarshaller _instance = new StartOutboundEmailContactRequestMarshaller();        

        internal static StartOutboundEmailContactRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartOutboundEmailContactRequestMarshaller Instance
        {
            get
            {
                return _instance;
