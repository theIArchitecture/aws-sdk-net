...
{
    /// <summary>
    /// Response Unmarshaller for StartScreenSharing operation
    /// </summary>  
    public class StartScreenSharingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartScreenSharingResponse response = new StartScreenSharingResponse();
        ...
        private static StartScreenSharingResponseUnmarshaller _instance = new StartScreenSharingResponseUnmarshaller();        

        internal static StartScreenSharingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartScreenSharingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
