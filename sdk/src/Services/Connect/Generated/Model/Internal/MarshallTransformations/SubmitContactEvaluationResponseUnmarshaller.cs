...
{
    /// <summary>
    /// Response Unmarshaller for SubmitContactEvaluation operation
    /// </summary>  
    public class SubmitContactEvaluationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SubmitContactEvaluationResponse response = new SubmitContactEvaluationResponse();
        ...
        private static SubmitContactEvaluationResponseUnmarshaller _instance = new SubmitContactEvaluationResponseUnmarshaller();        

        internal static SubmitContactEvaluationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SubmitContactEvaluationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
