...
{
    /// <summary>
    /// Response Unmarshaller for TagContact operation
    /// </summary>  
    public class TagContactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TagContactResponse response = new TagContactResponse();
        ...
        private static TagContactResponseUnmarshaller _instance = new TagContactResponseUnmarshaller();        

        internal static TagContactResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TagContactResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
