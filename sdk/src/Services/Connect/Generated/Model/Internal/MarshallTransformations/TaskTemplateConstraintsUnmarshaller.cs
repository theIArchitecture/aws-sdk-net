...
{
    /// <summary>
    /// Response Unmarshaller for TaskTemplateConstraints Object
    /// </summary>  
    public class TaskTemplateConstraintsUnmarshaller : IJsonUnmarshaller<TaskTemplateConstraints, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TaskTemplateConstraints Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            TaskTemplateConstraints unmarshalledObject = new TaskTemplateConstraints();
        ...
        private static TaskTemplateConstraintsUnmarshaller _instance = new TaskTemplateConstraintsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TaskTemplateConstraintsUnmarshaller Instance
        {
            get
            {
                return _instance;
