...
namespace Amazon.Connect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TaskTemplateFieldUnmarshaller : IJsonUnmarshaller<TaskTemplateField, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TaskTemplateField Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SingleSelectOptions", targetDepth))
                {
                    ...
                    unmarshalledObject.SingleSelectOptions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
