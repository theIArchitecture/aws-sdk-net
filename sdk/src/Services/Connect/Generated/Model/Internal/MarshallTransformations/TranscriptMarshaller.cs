...
{
    /// <summary>
    /// Transcript Marshaller
    /// </summary>
    public class TranscriptMarshaller : IRequestMarshaller<Transcript, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(Transcript requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetCriteria())
            {
                ...
                foreach(var requestObjectCriteriaListValue in requestObject.Criteria)
                {
                    ...
                    var marshaller = TranscriptCriteriaMarshaller.Instance;
        ...
        /// </summary>
        public readonly static TranscriptMarshaller Instance = new TranscriptMarshaller();
