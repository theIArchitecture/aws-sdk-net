...
{
    /// <summary>
    /// TransferContact Request Marshaller
    /// </summary>       
    public class TransferContactRequestMarshaller : IMarshaller<IRequest, TransferContactRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((TransferContactRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(TransferContactRequest publicRequest)
        {
        ...
        private static TransferContactRequestMarshaller _instance = new TransferContactRequestMarshaller();        

        internal static TransferContactRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TransferContactRequestMarshaller Instance
        {
            get
            {
                return _instance;
