...
{
    /// <summary>
    /// Response Unmarshaller for TransferContact operation
    /// </summary>  
    public class TransferContactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TransferContactResponse response = new TransferContactResponse();
        ...
        private static TransferContactResponseUnmarshaller _instance = new TransferContactResponseUnmarshaller();        

        internal static TransferContactResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TransferContactResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
