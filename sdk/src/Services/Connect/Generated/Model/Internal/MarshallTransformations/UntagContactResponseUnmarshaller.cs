...
{
    /// <summary>
    /// Response Unmarshaller for UntagContact operation
    /// </summary>  
    public class UntagContactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UntagContactResponse response = new UntagContactResponse();
        ...
        private static UntagContactResponseUnmarshaller _instance = new UntagContactResponseUnmarshaller();        

        internal static UntagContactResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UntagContactResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
