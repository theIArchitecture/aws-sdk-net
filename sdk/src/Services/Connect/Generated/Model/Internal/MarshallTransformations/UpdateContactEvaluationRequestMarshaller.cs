...
{
    /// <summary>
    /// UpdateContactEvaluation Request Marshaller
    /// </summary>       
    public class UpdateContactEvaluationRequestMarshaller : IMarshaller<IRequest, UpdateContactEvaluationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateContactEvaluationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateContactEvaluationRequest publicRequest)
        {
        ...
        private static UpdateContactEvaluationRequestMarshaller _instance = new UpdateContactEvaluationRequestMarshaller();        

        internal static UpdateContactEvaluationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateContactEvaluationRequestMarshaller Instance
        {
            get
            {
                return _instance;
