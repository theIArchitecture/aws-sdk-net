...
{
    /// <summary>
    /// Response Unmarshaller for UpdateContactEvaluation operation
    /// </summary>  
    public class UpdateContactEvaluationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateContactEvaluationResponse response = new UpdateContactEvaluationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("EvaluationArn", targetDepth))
                {
                    ...
                    response.EvaluationArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("EvaluationId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.EvaluationId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateContactEvaluationResponseUnmarshaller _instance = new UpdateContactEvaluationResponseUnmarshaller();        

        internal static UpdateContactEvaluationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateContactEvaluationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
