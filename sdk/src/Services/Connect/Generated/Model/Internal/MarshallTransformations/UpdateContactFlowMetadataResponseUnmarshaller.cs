...
{
    /// <summary>
    /// Response Unmarshaller for UpdateContactFlowMetadata operation
    /// </summary>  
    public class UpdateContactFlowMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateContactFlowMetadataResponse response = new UpdateContactFlowMetadataResponse();
        ...
        private static UpdateContactFlowMetadataResponseUnmarshaller _instance = new UpdateContactFlowMetadataResponseUnmarshaller();        

        internal static UpdateContactFlowMetadataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateContactFlowMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
