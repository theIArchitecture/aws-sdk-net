...
{
    /// <summary>
    /// Response Unmarshaller for UpdateContactFlowModuleMetadata operation
    /// </summary>  
    public class UpdateContactFlowModuleMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateContactFlowModuleMetadataResponse response = new UpdateContactFlowModuleMetadataResponse();
        ...
        private static UpdateContactFlowModuleMetadataResponseUnmarshaller _instance = new UpdateContactFlowModuleMetadataResponseUnmarshaller();        

        internal static UpdateContactFlowModuleMetadataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateContactFlowModuleMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
