...
{
    /// <summary>
    /// Response Unmarshaller for UpdateContactRoutingData operation
    /// </summary>  
    public class UpdateContactRoutingDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateContactRoutingDataResponse response = new UpdateContactRoutingDataResponse();
        ...
        private static UpdateContactRoutingDataResponseUnmarshaller _instance = new UpdateContactRoutingDataResponseUnmarshaller();        

        internal static UpdateContactRoutingDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateContactRoutingDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
