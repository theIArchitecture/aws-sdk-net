...
{
    /// <summary>
    /// Response Unmarshaller for UpdateEmailAddressMetadata operation
    /// </summary>  
    public class UpdateEmailAddressMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateEmailAddressMetadataResponse response = new UpdateEmailAddressMetadataResponse();
        ...
        private static UpdateEmailAddressMetadataResponseUnmarshaller _instance = new UpdateEmailAddressMetadataResponseUnmarshaller();        

        internal static UpdateEmailAddressMetadataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateEmailAddressMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
