...
{
    /// <summary>
    /// Response Unmarshaller for UpdateEvaluationForm operation
    /// </summary>  
    public class UpdateEvaluationFormResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateEvaluationFormResponse response = new UpdateEvaluationFormResponse();
        ...
        private static UpdateEvaluationFormResponseUnmarshaller _instance = new UpdateEvaluationFormResponseUnmarshaller();        

        internal static UpdateEvaluationFormResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateEvaluationFormResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
