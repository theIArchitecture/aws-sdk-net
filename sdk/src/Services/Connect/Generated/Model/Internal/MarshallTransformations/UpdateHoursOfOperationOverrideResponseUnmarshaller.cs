...
{
    /// <summary>
    /// Response Unmarshaller for UpdateHoursOfOperationOverride operation
    /// </summary>  
    public class UpdateHoursOfOperationOverrideResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateHoursOfOperationOverrideResponse response = new UpdateHoursOfOperationOverrideResponse();
        ...
        private static UpdateHoursOfOperationOverrideResponseUnmarshaller _instance = new UpdateHoursOfOperationOverrideResponseUnmarshaller();        

        internal static UpdateHoursOfOperationOverrideResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateHoursOfOperationOverrideResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
