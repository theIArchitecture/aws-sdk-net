...
{
    /// <summary>
    /// Response Unmarshaller for UpdateHoursOfOperation operation
    /// </summary>  
    public class UpdateHoursOfOperationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateHoursOfOperationResponse response = new UpdateHoursOfOperationResponse();
        ...
        private static UpdateHoursOfOperationResponseUnmarshaller _instance = new UpdateHoursOfOperationResponseUnmarshaller();        

        internal static UpdateHoursOfOperationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateHoursOfOperationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
