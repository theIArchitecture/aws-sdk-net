...
{
    /// <summary>
    /// Response Unmarshaller for UpdatePhoneNumberMetadata operation
    /// </summary>  
    public class UpdatePhoneNumberMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdatePhoneNumberMetadataResponse response = new UpdatePhoneNumberMetadataResponse();
        ...
        private static UpdatePhoneNumberMetadataResponseUnmarshaller _instance = new UpdatePhoneNumberMetadataResponseUnmarshaller();        

        internal static UpdatePhoneNumberMetadataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePhoneNumberMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
