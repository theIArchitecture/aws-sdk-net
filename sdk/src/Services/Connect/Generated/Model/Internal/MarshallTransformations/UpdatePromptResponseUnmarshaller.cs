...
{
    /// <summary>
    /// Response Unmarshaller for UpdatePrompt operation
    /// </summary>  
    public class UpdatePromptResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdatePromptResponse response = new UpdatePromptResponse();
        ...
        private static UpdatePromptResponseUnmarshaller _instance = new UpdatePromptResponseUnmarshaller();        

        internal static UpdatePromptResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePromptResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
