...
{
    /// <summary>
    /// Response Unmarshaller for UpdateQueueMaxContacts operation
    /// </summary>  
    public class UpdateQueueMaxContactsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateQueueMaxContactsResponse response = new UpdateQueueMaxContactsResponse();
        ...
        private static UpdateQueueMaxContactsResponseUnmarshaller _instance = new UpdateQueueMaxContactsResponseUnmarshaller();        

        internal static UpdateQueueMaxContactsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateQueueMaxContactsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
