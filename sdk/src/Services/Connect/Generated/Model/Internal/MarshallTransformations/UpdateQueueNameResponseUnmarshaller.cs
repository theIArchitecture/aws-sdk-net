...
{
    /// <summary>
    /// Response Unmarshaller for UpdateQueueName operation
    /// </summary>  
    public class UpdateQueueNameResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateQueueNameResponse response = new UpdateQueueNameResponse();
        ...
        private static UpdateQueueNameResponseUnmarshaller _instance = new UpdateQueueNameResponseUnmarshaller();        

        internal static UpdateQueueNameResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateQueueNameResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
