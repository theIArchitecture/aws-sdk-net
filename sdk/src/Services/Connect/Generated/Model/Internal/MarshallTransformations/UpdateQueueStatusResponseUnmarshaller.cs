...
{
    /// <summary>
    /// Response Unmarshaller for UpdateQueueStatus operation
    /// </summary>  
    public class UpdateQueueStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateQueueStatusResponse response = new UpdateQueueStatusResponse();
        ...
        private static UpdateQueueStatusResponseUnmarshaller _instance = new UpdateQueueStatusResponseUnmarshaller();        

        internal static UpdateQueueStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateQueueStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
