...
{
    /// <summary>
    /// Response Unmarshaller for UpdateTrafficDistribution operation
    /// </summary>  
    public class UpdateTrafficDistributionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateTrafficDistributionResponse response = new UpdateTrafficDistributionResponse();
        ...
        private static UpdateTrafficDistributionResponseUnmarshaller _instance = new UpdateTrafficDistributionResponseUnmarshaller();        

        internal static UpdateTrafficDistributionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTrafficDistributionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
