...
{
    /// <summary>
    /// Response Unmarshaller for UpdateUserProficiencies operation
    /// </summary>  
    public class UpdateUserProficienciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateUserProficienciesResponse response = new UpdateUserProficienciesResponse();
        ...
        private static UpdateUserProficienciesResponseUnmarshaller _instance = new UpdateUserProficienciesResponseUnmarshaller();        

        internal static UpdateUserProficienciesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateUserProficienciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
