...
{
    /// <summary>
    /// Response Unmarshaller for UpdateViewContent operation
    /// </summary>  
    public class UpdateViewContentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateViewContentResponse response = new UpdateViewContentResponse();
        ...
        private static UpdateViewContentResponseUnmarshaller _instance = new UpdateViewContentResponseUnmarshaller();        

        internal static UpdateViewContentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateViewContentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
