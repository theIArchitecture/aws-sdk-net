...
{
    /// <summary>
    /// Response Unmarshaller for UpdateViewMetadata operation
    /// </summary>  
    public class UpdateViewMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateViewMetadataResponse response = new UpdateViewMetadataResponse();
        ...
        private static UpdateViewMetadataResponseUnmarshaller _instance = new UpdateViewMetadataResponseUnmarshaller();        

        internal static UpdateViewMetadataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateViewMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
