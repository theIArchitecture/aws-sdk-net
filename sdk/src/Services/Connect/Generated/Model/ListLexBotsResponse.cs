...
namespace Amazon.Connect.Model
{
    ...
    {
        private List<LexBot> _lexBots = AWSConfigs.InitializeCollections ? new List<LexBot>() : null;
        private string _nextToken;

        /// <summary>
        /// Gets and sets the property LexBots. 
        /// <para>
        /// The names and Amazon Web Services Regions of the Amazon Lex bots associated with the
        /// specified instance.
        /// </para>
        /// <para />
