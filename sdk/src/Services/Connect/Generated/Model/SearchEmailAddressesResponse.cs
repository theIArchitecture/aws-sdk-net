...
{
    /// <summary>
    /// This is the response object from the SearchEmailAddresses operation.
    /// </summary>
    public partial class SearchEmailAddressesResponse : AmazonWebServiceResponse
    {
        private long? _approximateTotalCount;
        private List<EmailAddressMetadata> _emailAddresses = AWSConfigs.InitializeCollections ? new List<EmailAddressMetadata>() : null;
        ...
        // Check to see if EmailAddresses property is set
        internal bool IsSetEmailAddresses()
        {
            return this._emailAddresses != null && (this._emailAddresses.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
