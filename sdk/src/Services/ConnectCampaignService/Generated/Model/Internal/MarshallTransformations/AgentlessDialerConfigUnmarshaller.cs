...
namespace Amazon.ConnectCampaignService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AgentlessDialerConfigUnmarshaller : IJsonUnmarshaller<AgentlessDialerConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AgentlessDialerConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
