...
namespace Amazon.ConnectCampaignService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetCampaignStateBatchRequestMarshaller : IMarshaller<IRequest, GetCampaignStateBatchRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(GetCampaignStateBatchRequest publicRequest)
        {
            ...
            request.ResourcePath = "/campaigns-state";
#if !NETFRAMEWORK
        ...
        private static GetCampaignStateBatchRequestMarshaller _instance = new GetCampaignStateBatchRequestMarshaller();        

        internal static GetCampaignStateBatchRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCampaignStateBatchRequestMarshaller Instance
        {
            get
            {
                return _instance;
