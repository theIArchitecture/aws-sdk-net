...
{
    /// <summary>
    /// StartInstanceOnboardingJob Request Marshaller
    /// </summary>       
    public class StartInstanceOnboardingJobRequestMarshaller : IMarshaller<IRequest, StartInstanceOnboardingJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartInstanceOnboardingJobRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartInstanceOnboardingJobRequest publicRequest)
        {
        ...
        private static StartInstanceOnboardingJobRequestMarshaller _instance = new StartInstanceOnboardingJobRequestMarshaller();        

        internal static StartInstanceOnboardingJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartInstanceOnboardingJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
