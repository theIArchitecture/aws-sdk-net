...
{
    /// <summary>
    /// UpdateCampaignOutboundCallConfig Request Marshaller
    /// </summary>       
    public class UpdateCampaignOutboundCallConfigRequestMarshaller : IMarshaller<IRequest, UpdateCampaignOutboundCallConfigRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateCampaignOutboundCallConfigRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateCampaignOutboundCallConfigRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetConnectContactFlowId())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ConnectContactFlowId);
            }

            if(publicRequest.IsSetConnectSourcePhoneNumber())
            {
                context.Writer.WritePropertyName("connectSourcePhoneNumber");
                context.Writer.WriteStringValue(publicRequest.ConnectSourcePhoneNumber);
            }
        ...
        private static UpdateCampaignOutboundCallConfigRequestMarshaller _instance = new UpdateCampaignOutboundCallConfigRequestMarshaller();        

        internal static UpdateCampaignOutboundCallConfigRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCampaignOutboundCallConfigRequestMarshaller Instance
        {
            get
            {
                return _instance;
