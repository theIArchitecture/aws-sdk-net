...
namespace Amazon.ConnectCampaignsV2.Model
{
    ...
    /// </summary>
    public partial class CommunicationTimeConfig
    {
        private TimeWindow _email;
        ...
        /// <summary>
        /// Gets and sets the property LocalTimeZoneConfig.
        /// </summary>
        [AWSProperty(Required=true)]
        public LocalTimeZoneConfig LocalTimeZoneConfig
        {
            get { return this._localTimeZoneConfig; }
            set { this._localTimeZoneConfig = value; }
        }

        // Check to see if LocalTimeZoneConfig property is set
        internal bool IsSetLocalTimeZoneConfig()
        {
            return this._localTimeZoneConfig != null;
        }

        /// <summary>
        /// Gets and sets the property Sms.
        /// </summary>
        public TimeWindow Sms
        {
