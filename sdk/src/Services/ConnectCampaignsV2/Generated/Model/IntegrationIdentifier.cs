...
namespace Amazon.ConnectCampaignsV2.Model
{
    ...
    {
        private CustomerProfilesIntegrationIdentifier _customerProfiles;
        private QConnectIntegrationIdentifier _qConnect;

        /// <summary>
        /// Gets and sets the property CustomerProfiles.
        /// </summary>
        public CustomerProfilesIntegrationIdentifier CustomerProfiles
        {
        ...
        /// </summary>
        public QConnectIntegrationIdentifier QConnect
        {
