...
namespace Amazon.ConnectCampaignsV2.Model
{
    ...
    {
        private CustomerProfilesIntegrationSummary _customerProfiles;
        private QConnectIntegrationSummary _qConnect;

        /// <summary>
        /// Gets and sets the property CustomerProfiles.
        /// </summary>
        public CustomerProfilesIntegrationSummary CustomerProfiles
        {
        ...
        /// </summary>
        public QConnectIntegrationSummary QConnect
        {
