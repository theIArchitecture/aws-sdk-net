...
{
    /// <summary>
    /// EmailChannelSubtypeConfig Marshaller
    /// </summary>
    public class EmailChannelSubtypeConfigMarshaller : IRequestMarshaller<EmailChannelSubtypeConfig, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(EmailChannelSubtypeConfig requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetDefaultOutboundConfig())
            {
                ...
                var marshaller = EmailOutboundConfigMarshaller.Instance;
            ...
            if(requestObject.IsSetOutboundMode())
            {
                ...
                var marshaller = EmailOutboundModeMarshaller.Instance;
        ...
        /// </summary>
        public readonly static EmailChannelSubtypeConfigMarshaller Instance = new EmailChannelSubtypeConfigMarshaller();
