...
{
    /// <summary>
    /// PutConnectInstanceIntegration Request Marshaller
    /// </summary>       
    public class PutConnectInstanceIntegrationRequestMarshaller : IMarshaller<IRequest, PutConnectInstanceIntegrationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutConnectInstanceIntegrationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutConnectInstanceIntegrationRequest publicRequest)
        {
        ...
        private static PutConnectInstanceIntegrationRequestMarshaller _instance = new PutConnectInstanceIntegrationRequestMarshaller();        

        internal static PutConnectInstanceIntegrationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutConnectInstanceIntegrationRequestMarshaller Instance
        {
            get
            {
                return _instance;
