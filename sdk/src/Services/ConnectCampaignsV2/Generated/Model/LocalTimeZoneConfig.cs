...
namespace Amazon.ConnectCampaignsV2.Model
{
    ...
    /// </summary>
    public partial class LocalTimeZoneConfig
    {
        ...
        // Check to see if DefaultTimeZone property is set
        internal bool IsSetDefaultTimeZone()
        {
            return this._defaultTimeZone != null;
        }

        /// <summary>
        /// Gets and sets the property LocalTimeZoneDetection.
        /// <para />
        ...
        /// </summary>
        public List<string> LocalTimeZoneDetection
        {
            get { return this._localTimeZoneDetection; }
            set { this._localTimeZoneDetection = value; }
        }

        // Check to see if LocalTimeZoneDetection property is set
