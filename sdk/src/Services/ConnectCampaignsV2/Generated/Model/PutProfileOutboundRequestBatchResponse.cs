...
namespace Amazon.ConnectCampaignsV2.Model
{
    ...
    /// </summary>
    public partial class PutProfileOutboundRequestBatchResponse : AmazonWebServiceResponse
    {
        private List<FailedProfileOutboundRequest> _failedRequests = AWSConfigs.InitializeCollections ? new List<FailedProfileOutboundRequest>() : null;
        private List<SuccessfulProfileOutboundRequest> _successfulRequests = AWSConfigs.InitializeCollections ? new List<SuccessfulProfileOutboundRequest>() : null;
        ...
        public List<FailedProfileOutboundRequest> FailedRequests
        {
        ...
        /// </summary>
        [AWSProperty(Min=0, Max=20)]
        public List<SuccessfulProfileOutboundRequest> SuccessfulRequests
        {
