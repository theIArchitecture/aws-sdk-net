...
namespace Amazon.ConnectCases.Internal
{
    ...
    public class AmazonConnectCasesAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonConnectCasesAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ConnectCases.
        /// </summary>
        public AmazonConnectCasesAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonConnectCasesAuthSchemeParameters
            {
    ...
    public class AmazonConnectCasesAuthSchemeResolver : IAuthSchemeResolver<AmazonConnectCasesAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonConnectCasesAuthSchemeParameters authParameters)
        {
