...
namespace Amazon.ConnectCases.Model
{
    ...
    {
        private OperandOne _operandOne;
        private OperandTwo _operandTwo;
        ...
        public OperandOne OperandOne
        {
            get { return this._operandOne; }
            set { this._operandOne = value; }
        }

        // Check to see if OperandOne property is set
        internal bool IsSetOperandOne()
        {
            return this._operandOne != null;
        }
        ...
        /// </summary>
        [AWSProperty(Required=true)]
        public OperandTwo OperandTwo
        {
            get { return this._operandTwo; }
            set { this._operandTwo = value; }
        }

        // Check to see if OperandTwo property is set
        internal bool IsSetOperandTwo()
        {
            return this._operandTwo != null;
        }
