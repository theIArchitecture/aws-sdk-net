...
namespace Amazon.ConnectCases.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AuditEventPerformedByUnmarshaller : IJsonUnmarshaller<AuditEventPerformedBy, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AuditEventPerformedBy Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("iamPrincipalArn", targetDepth))
                {
                    ...
                    unmarshalledObject.IamPrincipalArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
