...
{
    /// <summary>
    /// This is the response object from the ListCaseRules operation.
    /// </summary>
    public partial class ListCaseRulesResponse : AmazonWebServiceResponse
    {
        private List<CaseRuleSummary> _caseRules = AWSConfigs.InitializeCollections ? new List<CaseRuleSummary>() : null;
        ...
        public List<CaseRuleSummary> CaseRules
        {
