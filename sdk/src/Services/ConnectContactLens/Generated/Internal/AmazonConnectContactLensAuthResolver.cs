...
namespace Amazon.ConnectContactLens.Internal
{
    ...
    public class AmazonConnectContactLensAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonConnectContactLensAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ConnectContactLens.
        /// </summary>
        public AmazonConnectContactLensAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonConnectContactLensAuthSchemeParameters
            {
    ...
    public class AmazonConnectContactLensAuthSchemeResolver : IAuthSchemeResolver<AmazonConnectContactLensAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonConnectContactLensAuthSchemeParameters authParameters)
        {
