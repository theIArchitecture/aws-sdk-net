...
namespace Amazon.ConnectContactLens.Internal
{
    ...
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for ConnectContactLens service requests.
    /// Collects values for ConnectContactLensEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses ConnectContactLensEndpointProvider.
