...
namespace Amazon.ConnectContactLens.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CategoryDetailsUnmarshaller : IJsonUnmarshaller<CategoryDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CategoryDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
