...
namespace Amazon.ConnectContactLens.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PostContactSummaryUnmarshaller : IJsonUnmarshaller<PostContactSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PostContactSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
