...
namespace Amazon.ConnectParticipant.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AttachmentItemUnmarshaller : IJsonUnmarshaller<AttachmentItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AttachmentItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
