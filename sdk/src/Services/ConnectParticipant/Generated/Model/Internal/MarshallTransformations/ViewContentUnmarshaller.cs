...
{
    /// <summary>
    /// Response Unmarshaller for ViewContent Object
    /// </summary>  
    public class ViewContentUnmarshaller : IJsonUnmarshaller<ViewContent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ViewContent Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ViewContent unmarshalledObject = new ViewContent();
        ...
        private static ViewContentUnmarshaller _instance = new ViewContentUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ViewContentUnmarshaller Instance
        {
            get
            {
                return _instance;
