...
{
    /// <summary>
    /// CreateAssistantAssociation Request Marshaller
    /// </summary>       
    public class CreateAssistantAssociationRequestMarshaller : IMarshaller<IRequest, CreateAssistantAssociationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateAssistantAssociationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateAssistantAssociationRequest publicRequest)
        {
            ...
            request.ResourcePath = "/assistants/{assistantId}/associations";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetAssociation())
            {
                ...
                var marshaller = AssistantAssociationInputDataMarshaller.Instance;
        ...
        private static CreateAssistantAssociationRequestMarshaller _instance = new CreateAssistantAssociationRequestMarshaller();        

        internal static CreateAssistantAssociationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAssistantAssociationRequestMarshaller Instance
        {
            get
            {
                return _instance;
