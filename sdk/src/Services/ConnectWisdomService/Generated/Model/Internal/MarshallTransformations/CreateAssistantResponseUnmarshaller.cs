...
{
    /// <summary>
    /// Response Unmarshaller for CreateAssistant operation
    /// </summary>  
    public class CreateAssistantResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAssistantResponse response = new CreateAssistantResponse();
        ...
        private static CreateAssistantResponseUnmarshaller _instance = new CreateAssistantResponseUnmarshaller();        

        internal static CreateAssistantResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAssistantResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
