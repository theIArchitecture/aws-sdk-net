...
{
    /// <summary>
    /// Response Unmarshaller for CreateQuickResponse operation
    /// </summary>  
    public class CreateQuickResponseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateQuickResponseResponse response = new CreateQuickResponseResponse();
        ...
        private static CreateQuickResponseResponseUnmarshaller _instance = new CreateQuickResponseResponseUnmarshaller();        

        internal static CreateQuickResponseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateQuickResponseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
