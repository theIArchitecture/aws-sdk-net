...
{
    /// <summary>
    /// ListQuickResponses Request Marshaller
    /// </summary>       
    public class ListQuickResponsesRequestMarshaller : IMarshaller<IRequest, ListQuickResponsesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListQuickResponsesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListQuickResponsesRequest publicRequest)
        {
        ...
        private static ListQuickResponsesRequestMarshaller _instance = new ListQuickResponsesRequestMarshaller();        

        internal static ListQuickResponsesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListQuickResponsesRequestMarshaller Instance
        {
            get
            {
                return _instance;
