...
namespace Amazon.ConnectWisdomService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NotifyRecommendationsReceivedErrorUnmarshaller : IJsonUnmarshaller<NotifyRecommendationsReceivedError, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NotifyRecommendationsReceivedError Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
