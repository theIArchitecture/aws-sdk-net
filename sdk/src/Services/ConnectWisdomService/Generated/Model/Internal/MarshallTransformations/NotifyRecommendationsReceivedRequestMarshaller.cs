...
namespace Amazon.ConnectWisdomService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class NotifyRecommendationsReceivedRequestMarshaller : IMarshaller<IRequest, NotifyRecommendationsReceivedRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static NotifyRecommendationsReceivedRequestMarshaller _instance = new NotifyRecommendationsReceivedRequestMarshaller();        

        internal static NotifyRecommendationsReceivedRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static NotifyRecommendationsReceivedRequestMarshaller Instance
        {
            get
            {
                return _instance;
