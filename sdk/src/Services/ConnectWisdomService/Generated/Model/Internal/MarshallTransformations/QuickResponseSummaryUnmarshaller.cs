...
{
    /// <summary>
    /// Response Unmarshaller for QuickResponseSummary Object
    /// </summary>  
    public class QuickResponseSummaryUnmarshaller : IJsonUnmarshaller<QuickResponseSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public QuickResponseSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            QuickResponseSummary unmarshalledObject = new QuickResponseSummary();
        ...
        private static QuickResponseSummaryUnmarshaller _instance = new QuickResponseSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static QuickResponseSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
