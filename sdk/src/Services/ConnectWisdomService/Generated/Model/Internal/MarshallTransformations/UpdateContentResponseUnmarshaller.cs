...
{
    /// <summary>
    /// Response Unmarshaller for UpdateContent operation
    /// </summary>  
    public class UpdateContentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateContentResponseUnmarshaller _instance = new UpdateContentResponseUnmarshaller();        

        internal static UpdateContentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateContentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
