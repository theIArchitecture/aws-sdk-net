...
namespace Amazon.ControlCatalog
{
    ...
    public partial class AmazonControlCatalogConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("ControlCatalog", "4.0.2.5");
        ...
        /// Default constructor
        /// </summary>
        public AmazonControlCatalogConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonControlCatalogDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "ControlCatalog";
            this.AuthenticationServiceName = "controlcatalog";
            this.EndpointProvider = new AmazonControlCatalogEndpointProvider();
        }
