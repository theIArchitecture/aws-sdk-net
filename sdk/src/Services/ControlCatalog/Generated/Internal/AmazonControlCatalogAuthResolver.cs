...
namespace Amazon.ControlCatalog.Internal
{
    ...
    public class AmazonControlCatalogAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonControlCatalogAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ControlCatalog.
        /// </summary>
        public AmazonControlCatalogAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonControlCatalogAuthSchemeParameters
            {
    ...
    public class AmazonControlCatalogAuthSchemeResolver : IAuthSchemeResolver<AmazonControlCatalogAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonControlCatalogAuthSchemeParameters authParameters)
        {
