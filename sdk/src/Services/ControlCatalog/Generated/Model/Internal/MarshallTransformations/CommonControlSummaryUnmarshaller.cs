...
{
    /// <summary>
    /// Response Unmarshaller for CommonControlSummary Object
    /// </summary>  
    public class CommonControlSummaryUnmarshaller : IJsonUnmarshaller<CommonControlSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CommonControlSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = AssociatedObjectiveSummaryUnmarshaller.Instance;
        ...
        private static CommonControlSummaryUnmarshaller _instance = new CommonControlSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CommonControlSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
