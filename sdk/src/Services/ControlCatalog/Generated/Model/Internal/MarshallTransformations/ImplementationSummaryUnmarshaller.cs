...
namespace Amazon.ControlCatalog.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ImplementationSummaryUnmarshaller : IJsonUnmarshaller<ImplementationSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ImplementationSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
