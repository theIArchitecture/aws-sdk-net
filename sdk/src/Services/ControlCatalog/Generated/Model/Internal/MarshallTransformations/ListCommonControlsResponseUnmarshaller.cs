...
{
    /// <summary>
    /// Response Unmarshaller for ListCommonControls operation
    /// </summary>  
    public class ListCommonControlsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListCommonControlsResponse response = new ListCommonControlsResponse();
        ...
        private static ListCommonControlsResponseUnmarshaller _instance = new ListCommonControlsResponseUnmarshaller();        

        internal static ListCommonControlsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCommonControlsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
