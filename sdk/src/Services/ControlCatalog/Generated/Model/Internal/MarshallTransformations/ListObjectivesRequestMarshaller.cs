...
{
    /// <summary>
    /// ListObjectives Request Marshaller
    /// </summary>       
    public class ListObjectivesRequestMarshaller : IMarshaller<IRequest, ListObjectivesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListObjectivesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListObjectivesRequest publicRequest)
        {
        ...
        private static ListObjectivesRequestMarshaller _instance = new ListObjectivesRequestMarshaller();        

        internal static ListObjectivesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListObjectivesRequestMarshaller Instance
        {
            get
            {
                return _instance;
