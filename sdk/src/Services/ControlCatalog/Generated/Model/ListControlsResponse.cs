...
namespace Amazon.ControlCatalog.Model
{
    ...
    {
        private List<ControlSummary> _controls = AWSConfigs.InitializeCollections ? new List<ControlSummary>() : null;
        private string _nextToken;

        /// <summary>
        /// Gets and sets the property Controls. 
        /// <para>
        /// Returns a list of controls, given as structures of type <i>controlSummary</i>.
        /// </para>
        /// <para />
        ...
        public List<ControlSummary> Controls
        {
