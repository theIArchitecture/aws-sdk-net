...
{
    /// <summary>
    /// Base class for ListObjectives paginators.
    /// </summary>
    internal sealed partial class ListObjectivesPaginator : IPaginator<ListObjectivesResponse>, IListObjectivesPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<ListObjectivesResponse> Responses => new PaginatedResponse<ListObjectivesResponse>(this);
...
#if BCL
        IEnumerable<ListObjectivesResponse> IPaginator<ListObjectivesResponse>.Paginate()
        {
            ...
            ListObjectivesResponse response;
            do
            {
                _request.NextToken = nextToken;
                response = _client.ListObjectives(_request);
        ...
        async IAsyncEnumerable<ListObjectivesResponse> IPaginator<ListObjectivesResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
