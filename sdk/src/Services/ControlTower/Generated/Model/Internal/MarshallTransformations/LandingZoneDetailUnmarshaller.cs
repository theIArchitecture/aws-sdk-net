...
namespace Amazon.ControlTower.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LandingZoneDetailUnmarshaller : IJsonUnmarshaller<LandingZoneDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LandingZoneDetail Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.LatestAvailableVersion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("manifest", targetDepth))
                {
                    var unmarshaller = Amazon.Runtime.Documents.Internal.Transform.DocumentUnmarshaller.Instance;
                    unmarshalledObject.Manifest = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
