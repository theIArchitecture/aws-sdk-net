...
{
    /// <summary>
    /// Response Unmarshaller for ListLandingZoneOperations operation
    /// </summary>  
    public class ListLandingZoneOperationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListLandingZoneOperationsResponse response = new ListLandingZoneOperationsResponse();
        ...
        private static ListLandingZoneOperationsResponseUnmarshaller _instance = new ListLandingZoneOperationsResponseUnmarshaller();        

        internal static ListLandingZoneOperationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLandingZoneOperationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
