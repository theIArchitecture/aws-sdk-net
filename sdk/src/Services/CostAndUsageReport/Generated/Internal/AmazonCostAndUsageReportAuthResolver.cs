...
namespace Amazon.CostAndUsageReport.Internal
{
    ...
    public class AmazonCostAndUsageReportAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCostAndUsageReportAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CostAndUsageReport.
        /// </summary>
        public AmazonCostAndUsageReportAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCostAndUsageReportAuthSchemeParameters
            {
    ...
    public class AmazonCostAndUsageReportAuthSchemeResolver : IAuthSchemeResolver<AmazonCostAndUsageReportAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCostAndUsageReportAuthSchemeParameters authParameters)
        {
