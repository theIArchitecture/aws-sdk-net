...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonCostAndUsageReportConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonCostAndUsageReportConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonCostAndUsageReportConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonCostAndUsageReportConfig to create AmazonCostAndUsageReportClient");
            }

            return awsCredentials == null ? 
                    new AmazonCostAndUsageReportClient(serviceClientConfig) :
                    new AmazonCostAndUsageReportClient(awsCredentials, serviceClientConfig);
        }
