...
namespace Amazon.CostExplorer.Internal
{
    ...
    public class AmazonCostExplorerAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCostExplorerAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CostExplorer.
        /// </summary>
        public AmazonCostExplorerAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCostExplorerAuthSchemeParameters
            {
    ...
    public class AmazonCostExplorerAuthSchemeResolver : IAuthSchemeResolver<AmazonCostExplorerAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCostExplorerAuthSchemeParameters authParameters)
        {
