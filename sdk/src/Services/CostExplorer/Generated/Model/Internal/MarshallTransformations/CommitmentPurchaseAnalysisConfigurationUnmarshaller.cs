...
namespace Amazon.CostExplorer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CommitmentPurchaseAnalysisConfigurationUnmarshaller : IJsonUnmarshaller<CommitmentPurchaseAnalysisConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CommitmentPurchaseAnalysisConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("SavingsPlansPurchaseAnalysisConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.SavingsPlansPurchaseAnalysisConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
