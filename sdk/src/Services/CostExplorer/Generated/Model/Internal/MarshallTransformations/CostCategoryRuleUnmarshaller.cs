...
namespace Amazon.CostExplorer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CostCategoryRuleUnmarshaller : IJsonUnmarshaller<CostCategoryRule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CostCategoryRule Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("InheritedValue", targetDepth))
                {
                    ...
                    unmarshalledObject.InheritedValue = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
