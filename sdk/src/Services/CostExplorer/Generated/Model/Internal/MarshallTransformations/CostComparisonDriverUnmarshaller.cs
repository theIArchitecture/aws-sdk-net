...
{
    /// <summary>
    /// Response Unmarshaller for CostComparisonDriver Object
    /// </summary>  
    public class CostComparisonDriverUnmarshaller : IJsonUnmarshaller<CostComparisonDriver, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CostComparisonDriver Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            CostComparisonDriver unmarshalledObject = new CostComparisonDriver();
        ...
        private static CostComparisonDriverUnmarshaller _instance = new CostComparisonDriverUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CostComparisonDriverUnmarshaller Instance
        {
            get
            {
                return _instance;
