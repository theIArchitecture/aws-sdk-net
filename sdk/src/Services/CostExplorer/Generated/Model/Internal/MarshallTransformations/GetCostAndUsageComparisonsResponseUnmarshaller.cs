...
{
    /// <summary>
    /// Response Unmarshaller for GetCostAndUsageComparisons operation
    /// </summary>  
    public class GetCostAndUsageComparisonsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCostAndUsageComparisonsResponse response = new GetCostAndUsageComparisonsResponse();
        ...
        private static GetCostAndUsageComparisonsResponseUnmarshaller _instance = new GetCostAndUsageComparisonsResponseUnmarshaller();        

        internal static GetCostAndUsageComparisonsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCostAndUsageComparisonsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
