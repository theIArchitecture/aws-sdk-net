...
{
    /// <summary>
    /// Response Unmarshaller for GetCostComparisonDrivers operation
    /// </summary>  
    public class GetCostComparisonDriversResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCostComparisonDriversResponse response = new GetCostComparisonDriversResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("CostComparisonDrivers", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<CostComparisonDriver, CostComparisonDriverUnmarshaller>(CostComparisonDriverUnmarshaller.Instance);
                    response.CostComparisonDrivers = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetCostComparisonDriversResponseUnmarshaller _instance = new GetCostComparisonDriversResponseUnmarshaller();        

        internal static GetCostComparisonDriversResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCostComparisonDriversResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
