...
namespace Amazon.CostExplorer.Model.Internal.MarshallTransformations
{
    ...
    public class ReservedCapacityDetailsUnmarshaller : IJsonUnmarshaller<ReservedCapacityDetails, JsonUnmarshallerContext>
    {
        ...
        private static ReservedCapacityDetailsUnmarshaller _instance = new ReservedCapacityDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ReservedCapacityDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
