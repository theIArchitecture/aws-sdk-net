...
namespace Amazon.CostExplorer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RootCauseImpactUnmarshaller : IJsonUnmarshaller<RootCauseImpact, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RootCauseImpact Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Contribution", targetDepth))
                {
                    ...
                    unmarshalledObject.Contribution = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
