...
{
    /// <summary>
    /// Response Unmarshaller for StartCommitmentPurchaseAnalysis operation
    /// </summary>  
    public class StartCommitmentPurchaseAnalysisResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartCommitmentPurchaseAnalysisResponse response = new StartCommitmentPurchaseAnalysisResponse();
        ...
        private static StartCommitmentPurchaseAnalysisResponseUnmarshaller _instance = new StartCommitmentPurchaseAnalysisResponseUnmarshaller();        

        internal static StartCommitmentPurchaseAnalysisResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartCommitmentPurchaseAnalysisResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
