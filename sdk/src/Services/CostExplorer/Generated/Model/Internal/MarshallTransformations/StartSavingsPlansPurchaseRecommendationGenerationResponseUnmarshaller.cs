...
{
    /// <summary>
    /// Response Unmarshaller for StartSavingsPlansPurchaseRecommendationGeneration operation
    /// </summary>  
    public class StartSavingsPlansPurchaseRecommendationGenerationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartSavingsPlansPurchaseRecommendationGenerationResponse response = new StartSavingsPlansPurchaseRecommendationGenerationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.GenerationStartedTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return GenerationExistsExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static StartSavingsPlansPurchaseRecommendationGenerationResponseUnmarshaller _instance = new StartSavingsPlansPurchaseRecommendationGenerationResponseUnmarshaller();        

        internal static StartSavingsPlansPurchaseRecommendationGenerationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartSavingsPlansPurchaseRecommendationGenerationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
