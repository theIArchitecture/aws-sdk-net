...
namespace Amazon.CostExplorer.Model
{
    ...
    public partial class UnresolvableUsageUnitException : AmazonCostExplorerException
    {
        ...
        public UnresolvableUsageUnitException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public UnresolvableUsageUnitException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
