...
namespace Amazon.CostExplorer
{
    ...
    public partial interface IAmazonCostExplorer : IAmazonService, IDisposable
    {
        ...
        Task<GetCommitmentPurchaseAnalysisResponse> GetCommitmentPurchaseAnalysisAsync(GetCommitmentPurchaseAnalysisRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetCostAndUsageComparisonsResponse> GetCostAndUsageComparisonsAsync(GetCostAndUsageComparisonsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetCostComparisonDriversResponse> GetCostComparisonDriversAsync(GetCostComparisonDriversRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListCommitmentPurchaseAnalysesResponse> ListCommitmentPurchaseAnalysesAsync(ListCommitmentPurchaseAnalysesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListCostAllocationTagBackfillHistoryResponse> ListCostAllocationTagBackfillHistoryAsync(ListCostAllocationTagBackfillHistoryRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListCostAllocationTagsResponse> ListCostAllocationTagsAsync(ListCostAllocationTagsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListSavingsPlansPurchaseRecommendationGenerationResponse> ListSavingsPlansPurchaseRecommendationGenerationAsync(ListSavingsPlansPurchaseRecommendationGenerationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StartCommitmentPurchaseAnalysisResponse> StartCommitmentPurchaseAnalysisAsync(StartCommitmentPurchaseAnalysisRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StartCostAllocationTagBackfillResponse> StartCostAllocationTagBackfillAsync(StartCostAllocationTagBackfillRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StartSavingsPlansPurchaseRecommendationGenerationResponse> StartSavingsPlansPurchaseRecommendationGenerationAsync(StartSavingsPlansPurchaseRecommendationGenerationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateCostAllocationTagsStatusResponse> UpdateCostAllocationTagsStatusAsync(UpdateCostAllocationTagsStatusRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonCostExplorerConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonCostExplorerConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonCostExplorerConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonCostExplorerConfig to create AmazonCostExplorerClient");
            }

            return awsCredentials == null ? 
                    new AmazonCostExplorerClient(serviceClientConfig) :
                    new AmazonCostExplorerClient(awsCredentials, serviceClientConfig);
        }
