...
namespace Amazon.CostOptimizationHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DynamoDbReservedCapacityUnmarshaller : IJsonUnmarshaller<DynamoDbReservedCapacity, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DynamoDbReservedCapacity Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
