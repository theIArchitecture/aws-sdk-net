...
namespace Amazon.CostOptimizationHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EbsVolumeUnmarshaller : IJsonUnmarshaller<EbsVolume, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EbsVolume Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = EbsVolumeConfigurationUnmarshaller.Instance;
