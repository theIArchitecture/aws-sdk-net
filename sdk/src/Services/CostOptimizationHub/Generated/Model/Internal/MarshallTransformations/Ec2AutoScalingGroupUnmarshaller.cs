...
namespace Amazon.CostOptimizationHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class Ec2AutoScalingGroupUnmarshaller : IJsonUnmarshaller<Ec2AutoScalingGroup, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Ec2AutoScalingGroup Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
