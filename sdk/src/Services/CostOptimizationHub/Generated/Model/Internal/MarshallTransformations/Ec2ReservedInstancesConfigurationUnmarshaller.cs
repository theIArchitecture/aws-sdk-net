...
{
    /// <summary>
    /// Response Unmarshaller for Ec2ReservedInstancesConfiguration Object
    /// </summary>  
    public class Ec2ReservedInstancesConfigurationUnmarshaller : IJsonUnmarshaller<Ec2ReservedInstancesConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Ec2ReservedInstancesConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            Ec2ReservedInstancesConfiguration unmarshalledObject = new Ec2ReservedInstancesConfiguration();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.OfferingClass = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static Ec2ReservedInstancesConfigurationUnmarshaller _instance = new Ec2ReservedInstancesConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static Ec2ReservedInstancesConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
