...
{
    /// <summary>
    /// Response Unmarshaller for ListRecommendationSummaries operation
    /// </summary>  
    public class ListRecommendationSummariesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListRecommendationSummariesResponse response = new ListRecommendationSummariesResponse();
        ...
        private static ListRecommendationSummariesResponseUnmarshaller _instance = new ListRecommendationSummariesResponseUnmarshaller();        

        internal static ListRecommendationSummariesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRecommendationSummariesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
