...
{
    /// <summary>
    /// Response Unmarshaller for MemoryDbReservedInstancesConfiguration Object
    /// </summary>  
    public class MemoryDbReservedInstancesConfigurationUnmarshaller : IJsonUnmarshaller<MemoryDbReservedInstancesConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MemoryDbReservedInstancesConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            MemoryDbReservedInstancesConfiguration unmarshalledObject = new MemoryDbReservedInstancesConfiguration();
        ...
        private static MemoryDbReservedInstancesConfigurationUnmarshaller _instance = new MemoryDbReservedInstancesConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static MemoryDbReservedInstancesConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
