...
namespace Amazon.CostOptimizationHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OpenSearchReservedInstancesUnmarshaller : IJsonUnmarshaller<OpenSearchReservedInstances, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public OpenSearchReservedInstances Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
