...
namespace Amazon.CostOptimizationHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RedshiftReservedInstancesConfigurationUnmarshaller : IJsonUnmarshaller<RedshiftReservedInstancesConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RedshiftReservedInstancesConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
