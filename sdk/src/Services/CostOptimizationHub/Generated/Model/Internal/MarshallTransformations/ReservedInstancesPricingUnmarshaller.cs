...
namespace Amazon.CostOptimizationHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ReservedInstancesPricingUnmarshaller : IJsonUnmarshaller<ReservedInstancesPricing, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ReservedInstancesPricing Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("estimatedMonthlyAmortizedReservationCost", targetDepth))
                {
                    ...
                    unmarshalledObject.EstimatedMonthlyAmortizedReservationCost = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableDoubleUnmarshaller.Instance;
                    unmarshalledObject.MonthlyReservationEligibleCost = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
