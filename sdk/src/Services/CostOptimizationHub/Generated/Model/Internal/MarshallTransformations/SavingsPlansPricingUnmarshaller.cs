...
namespace Amazon.CostOptimizationHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SavingsPlansPricingUnmarshaller : IJsonUnmarshaller<SavingsPlansPricing, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SavingsPlansPricing Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
