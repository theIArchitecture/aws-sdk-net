...
namespace Amazon.CostOptimizationHub.Model.Internal.MarshallTransformations
{
    ...
    public class UpdatePreferencesRequestMarshaller : IMarshaller<IRequest, UpdatePreferencesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(UpdatePreferencesRequest publicRequest)
        {
            ...
            string target = "CostOptimizationHubService.UpdatePreferences";
            ...
            if(publicRequest.IsSetMemberAccountDiscountVisibility())
            {
                context.Writer.WritePropertyName("memberAccountDiscountVisibility");
