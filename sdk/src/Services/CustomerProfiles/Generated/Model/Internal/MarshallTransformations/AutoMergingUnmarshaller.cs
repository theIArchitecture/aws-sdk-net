...
namespace Amazon.CustomerProfiles.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AutoMergingUnmarshaller : IJsonUnmarshaller<AutoMerging, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AutoMerging Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("MinAllowedConfidenceScoreForMerging", targetDepth))
                {
                    ...
                    unmarshalledObject.MinAllowedConfidenceScoreForMerging = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
