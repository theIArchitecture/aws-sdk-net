...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetProfile operation
    /// </summary>  
    public class BatchGetProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchGetProfileResponse response = new BatchGetProfileResponse();
        ...
        private static BatchGetProfileResponseUnmarshaller _instance = new BatchGetProfileResponseUnmarshaller();        

        internal static BatchGetProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
