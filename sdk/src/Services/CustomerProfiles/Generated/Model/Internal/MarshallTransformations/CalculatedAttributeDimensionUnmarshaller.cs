...
namespace Amazon.CustomerProfiles.Model.Internal.MarshallTransformations
{
    ...
    public class CalculatedAttributeDimensionUnmarshaller : IJsonUnmarshaller<CalculatedAttributeDimension, JsonUnmarshallerContext>
    {
        ...
        private static CalculatedAttributeDimensionUnmarshaller _instance = new CalculatedAttributeDimensionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CalculatedAttributeDimensionUnmarshaller Instance
        {
            get
            {
                return _instance;
