...
{
    /// <summary>
    /// CreateIntegrationWorkflow Request Marshaller
    /// </summary>       
    public class CreateIntegrationWorkflowRequestMarshaller : IMarshaller<IRequest, CreateIntegrationWorkflowRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateIntegrationWorkflowRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateIntegrationWorkflowRequest publicRequest)
        {
            ...
            request.ResourcePath = "/domains/{DomainName}/workflows/integrations";
#if !NETFRAMEWORK
        ...
        private static CreateIntegrationWorkflowRequestMarshaller _instance = new CreateIntegrationWorkflowRequestMarshaller();        

        internal static CreateIntegrationWorkflowRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateIntegrationWorkflowRequestMarshaller Instance
        {
            get
            {
                return _instance;
