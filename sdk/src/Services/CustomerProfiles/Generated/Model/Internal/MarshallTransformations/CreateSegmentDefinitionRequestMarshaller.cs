...
{
    /// <summary>
    /// CreateSegmentDefinition Request Marshaller
    /// </summary>       
    public class CreateSegmentDefinitionRequestMarshaller : IMarshaller<IRequest, CreateSegmentDefinitionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateSegmentDefinitionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateSegmentDefinitionRequest publicRequest)
        {
        ...
        private static CreateSegmentDefinitionRequestMarshaller _instance = new CreateSegmentDefinitionRequestMarshaller();        

        internal static CreateSegmentDefinitionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSegmentDefinitionRequestMarshaller Instance
        {
            get
            {
                return _instance;
