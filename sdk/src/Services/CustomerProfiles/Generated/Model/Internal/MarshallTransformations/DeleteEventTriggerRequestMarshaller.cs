...
{
    /// <summary>
    /// DeleteEventTrigger Request Marshaller
    /// </summary>       
    public class DeleteEventTriggerRequestMarshaller : IMarshaller<IRequest, DeleteEventTriggerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteEventTriggerRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteEventTriggerRequest publicRequest)
        {
        ...
        private static DeleteEventTriggerRequestMarshaller _instance = new DeleteEventTriggerRequestMarshaller();        

        internal static DeleteEventTriggerRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteEventTriggerRequestMarshaller Instance
        {
            get
            {
                return _instance;
