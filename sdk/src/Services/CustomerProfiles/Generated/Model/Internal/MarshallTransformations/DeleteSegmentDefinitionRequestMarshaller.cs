...
{
    /// <summary>
    /// DeleteSegmentDefinition Request Marshaller
    /// </summary>       
    public class DeleteSegmentDefinitionRequestMarshaller : IMarshaller<IRequest, DeleteSegmentDefinitionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteSegmentDefinitionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteSegmentDefinitionRequest publicRequest)
        {
        ...
        private static DeleteSegmentDefinitionRequestMarshaller _instance = new DeleteSegmentDefinitionRequestMarshaller();        

        internal static DeleteSegmentDefinitionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSegmentDefinitionRequestMarshaller Instance
        {
            get
            {
                return _instance;
