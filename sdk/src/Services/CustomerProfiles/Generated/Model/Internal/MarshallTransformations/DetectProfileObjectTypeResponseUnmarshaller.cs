...
{
    /// <summary>
    /// Response Unmarshaller for DetectProfileObjectType operation
    /// </summary>  
    public class DetectProfileObjectTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DetectProfileObjectTypeResponse response = new DetectProfileObjectTypeResponse();
        ...
        private static DetectProfileObjectTypeResponseUnmarshaller _instance = new DetectProfileObjectTypeResponseUnmarshaller();        

        internal static DetectProfileObjectTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetectProfileObjectTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
