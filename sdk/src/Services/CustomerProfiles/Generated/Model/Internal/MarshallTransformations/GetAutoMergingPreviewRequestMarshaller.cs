...
{
    /// <summary>
    /// GetAutoMergingPreview Request Marshaller
    /// </summary>       
    public class GetAutoMergingPreviewRequestMarshaller : IMarshaller<IRequest, GetAutoMergingPreviewRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetAutoMergingPreviewRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetAutoMergingPreviewRequest publicRequest)
        {
        ...
        private static GetAutoMergingPreviewRequestMarshaller _instance = new GetAutoMergingPreviewRequestMarshaller();        

        internal static GetAutoMergingPreviewRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAutoMergingPreviewRequestMarshaller Instance
        {
            get
            {
                return _instance;
