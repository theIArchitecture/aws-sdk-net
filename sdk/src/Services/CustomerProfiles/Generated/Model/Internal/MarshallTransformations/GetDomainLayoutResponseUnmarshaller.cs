...
{
    /// <summary>
    /// Response Unmarshaller for GetDomainLayout operation
    /// </summary>  
    public class GetDomainLayoutResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDomainLayoutResponse response = new GetDomainLayoutResponse();
        ...
        private static GetDomainLayoutResponseUnmarshaller _instance = new GetDomainLayoutResponseUnmarshaller();        

        internal static GetDomainLayoutResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDomainLayoutResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
