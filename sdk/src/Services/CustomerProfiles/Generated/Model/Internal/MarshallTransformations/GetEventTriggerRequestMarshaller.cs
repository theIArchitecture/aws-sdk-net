...
{
    /// <summary>
    /// GetEventTrigger Request Marshaller
    /// </summary>       
    public class GetEventTriggerRequestMarshaller : IMarshaller<IRequest, GetEventTriggerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetEventTriggerRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetEventTriggerRequest publicRequest)
        {
        ...
        private static GetEventTriggerRequestMarshaller _instance = new GetEventTriggerRequestMarshaller();        

        internal static GetEventTriggerRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEventTriggerRequestMarshaller Instance
        {
            get
            {
                return _instance;
