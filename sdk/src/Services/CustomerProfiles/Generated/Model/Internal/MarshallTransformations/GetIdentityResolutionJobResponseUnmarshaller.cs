...
{
    /// <summary>
    /// Response Unmarshaller for GetIdentityResolutionJob operation
    /// </summary>  
    public class GetIdentityResolutionJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetIdentityResolutionJobResponse response = new GetIdentityResolutionJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AutoMerging", targetDepth))
                {
                    ...
                    response.AutoMerging = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("ExportingLocation", targetDepth))
                {
                    ...
                    response.ExportingLocation = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    response.JobExpirationTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("JobStats", targetDepth))
                {
                    ...
                    response.JobStats = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetIdentityResolutionJobResponseUnmarshaller _instance = new GetIdentityResolutionJobResponseUnmarshaller();        

        internal static GetIdentityResolutionJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetIdentityResolutionJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
