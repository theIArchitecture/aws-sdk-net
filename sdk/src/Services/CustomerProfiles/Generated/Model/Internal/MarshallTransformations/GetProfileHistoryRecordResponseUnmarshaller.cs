...
{
    /// <summary>
    /// Response Unmarshaller for GetProfileHistoryRecord operation
    /// </summary>  
    public class GetProfileHistoryRecordResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetProfileHistoryRecordResponse response = new GetProfileHistoryRecordResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PerformedBy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ProfileObjectUniqueKey", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ProfileObjectUniqueKey = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetProfileHistoryRecordResponseUnmarshaller _instance = new GetProfileHistoryRecordResponseUnmarshaller();        

        internal static GetProfileHistoryRecordResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetProfileHistoryRecordResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
