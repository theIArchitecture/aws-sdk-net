...
{
    /// <summary>
    /// GetSegmentDefinition Request Marshaller
    /// </summary>       
    public class GetSegmentDefinitionRequestMarshaller : IMarshaller<IRequest, GetSegmentDefinitionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetSegmentDefinitionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetSegmentDefinitionRequest publicRequest)
        {
        ...
        private static GetSegmentDefinitionRequestMarshaller _instance = new GetSegmentDefinitionRequestMarshaller();        

        internal static GetSegmentDefinitionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSegmentDefinitionRequestMarshaller Instance
        {
            get
            {
                return _instance;
