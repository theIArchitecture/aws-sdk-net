...
namespace Amazon.CustomerProfiles.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetSegmentEstimateRequestMarshaller : IMarshaller<IRequest, GetSegmentEstimateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetSegmentEstimateRequestMarshaller _instance = new GetSegmentEstimateRequestMarshaller();        

        internal static GetSegmentEstimateRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSegmentEstimateRequestMarshaller Instance
        {
            get
            {
                return _instance;
