...
{
    /// <summary>
    /// GetSegmentMembership Request Marshaller
    /// </summary>       
    public class GetSegmentMembershipRequestMarshaller : IMarshaller<IRequest, GetSegmentMembershipRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetSegmentMembershipRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetSegmentMembershipRequest publicRequest)
        {
        ...
        private static GetSegmentMembershipRequestMarshaller _instance = new GetSegmentMembershipRequestMarshaller();        

        internal static GetSegmentMembershipRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSegmentMembershipRequestMarshaller Instance
        {
            get
            {
                return _instance;
