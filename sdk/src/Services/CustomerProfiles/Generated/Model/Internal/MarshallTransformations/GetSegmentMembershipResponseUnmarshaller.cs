...
{
    /// <summary>
    /// Response Unmarshaller for GetSegmentMembership operation
    /// </summary>  
    public class GetSegmentMembershipResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSegmentMembershipResponse response = new GetSegmentMembershipResponse();
        ...
        private static GetSegmentMembershipResponseUnmarshaller _instance = new GetSegmentMembershipResponseUnmarshaller();        

        internal static GetSegmentMembershipResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSegmentMembershipResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
