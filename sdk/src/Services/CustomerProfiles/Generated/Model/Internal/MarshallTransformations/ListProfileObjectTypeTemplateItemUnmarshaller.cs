...
namespace Amazon.CustomerProfiles.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListProfileObjectTypeTemplateItemUnmarshaller : IJsonUnmarshaller<ListProfileObjectTypeTemplateItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ListProfileObjectTypeTemplateItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SourceObject = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
