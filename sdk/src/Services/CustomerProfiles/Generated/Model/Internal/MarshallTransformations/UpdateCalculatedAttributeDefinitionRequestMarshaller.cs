...
{
    /// <summary>
    /// UpdateCalculatedAttributeDefinition Request Marshaller
    /// </summary>       
    public class UpdateCalculatedAttributeDefinitionRequestMarshaller : IMarshaller<IRequest, UpdateCalculatedAttributeDefinitionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateCalculatedAttributeDefinitionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateCalculatedAttributeDefinitionRequest publicRequest)
        {
        ...
        private static UpdateCalculatedAttributeDefinitionRequestMarshaller _instance = new UpdateCalculatedAttributeDefinitionRequestMarshaller();        

        internal static UpdateCalculatedAttributeDefinitionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCalculatedAttributeDefinitionRequestMarshaller Instance
        {
            get
            {
                return _instance;
