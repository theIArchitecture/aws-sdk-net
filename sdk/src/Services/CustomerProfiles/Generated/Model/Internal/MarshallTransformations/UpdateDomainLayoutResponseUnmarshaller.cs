...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDomainLayout operation
    /// </summary>  
    public class UpdateDomainLayoutResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDomainLayoutResponse response = new UpdateDomainLayoutResponse();
        ...
        private static UpdateDomainLayoutResponseUnmarshaller _instance = new UpdateDomainLayoutResponseUnmarshaller();        

        internal static UpdateDomainLayoutResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDomainLayoutResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
