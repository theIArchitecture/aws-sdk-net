...
namespace Amazon.DAX.Internal
{
    ...
    public class AmazonDAXAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonDAXAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for DAX.
        /// </summary>
        public AmazonDAXAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonDAXAuthSchemeParameters
            {
    ...
    public class AmazonDAXAuthSchemeResolver : IAuthSchemeResolver<AmazonDAXAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonDAXAuthSchemeParameters authParameters)
        {
