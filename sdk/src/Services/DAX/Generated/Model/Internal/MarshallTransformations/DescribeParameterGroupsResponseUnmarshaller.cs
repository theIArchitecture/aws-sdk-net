    ...
    public class DescribeParameterGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ParameterGroup, ParameterGroupUnmarshaller>(ParameterGroupUnmarshaller.Instance);
                    response.ParameterGroups = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
