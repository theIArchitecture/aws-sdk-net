...
namespace Amazon.DLM.Internal
{
    ...
    public class AmazonDLMAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonDLMAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for DLM.
        /// </summary>
        public AmazonDLMAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonDLMAuthSchemeParameters
            {
    ...
    public class AmazonDLMAuthSchemeResolver : IAuthSchemeResolver<AmazonDLMAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonDLMAuthSchemeParameters authParameters)
        {
