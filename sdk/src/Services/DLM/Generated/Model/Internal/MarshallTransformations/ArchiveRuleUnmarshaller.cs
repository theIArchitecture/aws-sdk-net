...
namespace Amazon.DLM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ArchiveRuleUnmarshaller : IJsonUnmarshaller<ArchiveRule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ArchiveRule Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
