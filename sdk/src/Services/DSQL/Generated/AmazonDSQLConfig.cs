...
namespace Amazon.DSQL
{
    ...
    public partial class AmazonDSQLConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("DSQL", "4.0.4.8");
        ...
        /// Default constructor
        /// </summary>
        public AmazonDSQLConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonDSQLDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "DSQL";
            this.AuthenticationServiceName = "dsql";
            this.EndpointProvider = new AmazonDSQLEndpointProvider();
        }
