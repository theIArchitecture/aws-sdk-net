...
namespace Amazon.DSQL.Internal
{
    ...
    public class AmazonDSQLAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonDSQLAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for DSQL.
        /// </summary>
        public AmazonDSQLAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonDSQLAuthSchemeParameters
            {
    ...
    public class AmazonDSQLAuthSchemeResolver : IAuthSchemeResolver<AmazonDSQLAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonDSQLAuthSchemeParameters authParameters)
        {
