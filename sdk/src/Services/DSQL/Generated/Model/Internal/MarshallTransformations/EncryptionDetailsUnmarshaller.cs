...
namespace Amazon.DSQL.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EncryptionDetailsUnmarshaller : IJsonUnmarshaller<EncryptionDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            EncryptionDetails unmarshalledObject = new EncryptionDetails();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EncryptionDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
