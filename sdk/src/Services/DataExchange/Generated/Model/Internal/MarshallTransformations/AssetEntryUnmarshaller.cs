...
namespace Amazon.DataExchange.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssetEntryUnmarshaller : IJsonUnmarshaller<AssetEntry, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AssetEntry Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("AssetDetails", targetDepth))
                {
                    ...
                    unmarshalledObject.AssetDetails = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
