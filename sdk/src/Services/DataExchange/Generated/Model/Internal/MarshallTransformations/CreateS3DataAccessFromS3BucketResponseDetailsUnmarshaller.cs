...
namespace Amazon.DataExchange.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateS3DataAccessFromS3BucketResponseDetailsUnmarshaller : IJsonUnmarshaller<CreateS3DataAccessFromS3BucketResponseDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CreateS3DataAccessFromS3BucketResponseDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AssetSource", targetDepth))
                {
                    ...
                    unmarshalledObject.AssetSource = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
