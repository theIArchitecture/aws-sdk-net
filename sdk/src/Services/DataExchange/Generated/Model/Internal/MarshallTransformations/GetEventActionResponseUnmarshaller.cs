...
{
    /// <summary>
    /// Response Unmarshaller for GetEventAction operation
    /// </summary>  
    public class GetEventActionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetEventActionResponse response = new GetEventActionResponse();
        ...
        private static GetEventActionResponseUnmarshaller _instance = new GetEventActionResponseUnmarshaller();        

        internal static GetEventActionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEventActionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
