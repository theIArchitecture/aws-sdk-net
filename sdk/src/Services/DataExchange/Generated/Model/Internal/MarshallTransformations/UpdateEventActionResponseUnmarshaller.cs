...
namespace Amazon.DataExchange.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateEventActionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateEventActionResponse response = new UpdateEventActionResponse();
        ...
        internal static UpdateEventActionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateEventActionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
