...
namespace Amazon.DataPipeline.Internal
{
    ...
    public class AmazonDataPipelineAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonDataPipelineAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for DataPipeline.
        /// </summary>
        public AmazonDataPipelineAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonDataPipelineAuthSchemeParameters
            {
    ...
    public class AmazonDataPipelineAuthSchemeResolver : IAuthSchemeResolver<AmazonDataPipelineAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonDataPipelineAuthSchemeParameters authParameters)
        {
