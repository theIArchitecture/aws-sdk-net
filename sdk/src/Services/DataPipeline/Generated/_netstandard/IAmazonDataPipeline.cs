...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonDataPipelineConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonDataPipelineConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonDataPipelineConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonDataPipelineConfig to create AmazonDataPipelineClient");
            }

            return awsCredentials == null ? 
                    new AmazonDataPipelineClient(serviceClientConfig) :
                    new AmazonDataPipelineClient(awsCredentials, serviceClientConfig);
        }
