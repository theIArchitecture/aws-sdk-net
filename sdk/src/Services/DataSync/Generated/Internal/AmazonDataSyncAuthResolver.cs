...
namespace Amazon.DataSync.Internal
{
    ...
    public class AmazonDataSyncAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonDataSyncAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for DataSync.
        /// </summary>
        public AmazonDataSyncAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonDataSyncAuthSchemeParameters
            {
    ...
    public class AmazonDataSyncAuthSchemeResolver : IAuthSchemeResolver<AmazonDataSyncAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonDataSyncAuthSchemeParameters authParameters)
        {
