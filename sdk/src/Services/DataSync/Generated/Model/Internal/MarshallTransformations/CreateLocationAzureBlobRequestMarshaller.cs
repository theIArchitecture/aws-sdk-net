...
{
    /// <summary>
    /// CreateLocationAzureBlob Request Marshaller
    /// </summary>       
    public class CreateLocationAzureBlobRequestMarshaller : IMarshaller<IRequest, CreateLocationAzureBlobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateLocationAzureBlobRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateLocationAzureBlobRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DataSync");
            string target = "FmrsService.CreateLocationAzureBlob";
        ...
        private static CreateLocationAzureBlobRequestMarshaller _instance = new CreateLocationAzureBlobRequestMarshaller();        

        internal static CreateLocationAzureBlobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLocationAzureBlobRequestMarshaller Instance
        {
            get
            {
                return _instance;
