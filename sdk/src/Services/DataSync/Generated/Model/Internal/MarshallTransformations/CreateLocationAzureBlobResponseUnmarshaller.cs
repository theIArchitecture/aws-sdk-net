...
{
    /// <summary>
    /// Response Unmarshaller for CreateLocationAzureBlob operation
    /// </summary>  
    public class CreateLocationAzureBlobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLocationAzureBlobResponse response = new CreateLocationAzureBlobResponse();
        ...
        private static CreateLocationAzureBlobResponseUnmarshaller _instance = new CreateLocationAzureBlobResponseUnmarshaller();        

        internal static CreateLocationAzureBlobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLocationAzureBlobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
