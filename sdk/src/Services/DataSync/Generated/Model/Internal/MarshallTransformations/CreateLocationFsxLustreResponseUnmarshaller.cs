...
{
    /// <summary>
    /// Response Unmarshaller for CreateLocationFsxLustre operation
    /// </summary>  
    public class CreateLocationFsxLustreResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLocationFsxLustreResponse response = new CreateLocationFsxLustreResponse();
        ...
        private static CreateLocationFsxLustreResponseUnmarshaller _instance = new CreateLocationFsxLustreResponseUnmarshaller();        

        internal static CreateLocationFsxLustreResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLocationFsxLustreResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
