...
{
    /// <summary>
    /// Response Unmarshaller for CreateLocationFsxOntap operation
    /// </summary>  
    public class CreateLocationFsxOntapResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLocationFsxOntapResponse response = new CreateLocationFsxOntapResponse();
        ...
        private static CreateLocationFsxOntapResponseUnmarshaller _instance = new CreateLocationFsxOntapResponseUnmarshaller();        

        internal static CreateLocationFsxOntapResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLocationFsxOntapResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
