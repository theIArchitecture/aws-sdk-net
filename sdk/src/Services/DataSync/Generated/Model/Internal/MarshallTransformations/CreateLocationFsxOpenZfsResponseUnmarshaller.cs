...
{
    /// <summary>
    /// Response Unmarshaller for CreateLocationFsxOpenZfs operation
    /// </summary>  
    public class CreateLocationFsxOpenZfsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLocationFsxOpenZfsResponse response = new CreateLocationFsxOpenZfsResponse();
        ...
        private static CreateLocationFsxOpenZfsResponseUnmarshaller _instance = new CreateLocationFsxOpenZfsResponseUnmarshaller();        

        internal static CreateLocationFsxOpenZfsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLocationFsxOpenZfsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
