...
{
    /// <summary>
    /// Response Unmarshaller for DescribeLocationAzureBlob operation
    /// </summary>  
    public class DescribeLocationAzureBlobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeLocationAzureBlobResponse response = new DescribeLocationAzureBlobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AccessTier", targetDepth))
                {
                    ...
                    response.AccessTier = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.BlobType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeLocationAzureBlobResponseUnmarshaller _instance = new DescribeLocationAzureBlobResponseUnmarshaller();        

        internal static DescribeLocationAzureBlobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeLocationAzureBlobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
