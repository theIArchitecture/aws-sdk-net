...
{
    /// <summary>
    /// Response Unmarshaller for DescribeLocationFsxOntap operation
    /// </summary>  
    public class DescribeLocationFsxOntapResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeLocationFsxOntapResponse response = new DescribeLocationFsxOntapResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("FsxFilesystemArn", targetDepth))
                {
                    ...
                    response.FsxFilesystemArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = FsxProtocolUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.StorageVirtualMachineArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeLocationFsxOntapResponseUnmarshaller _instance = new DescribeLocationFsxOntapResponseUnmarshaller();        

        internal static DescribeLocationFsxOntapResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeLocationFsxOntapResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
