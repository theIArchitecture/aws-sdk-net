...
{
    /// <summary>
    /// Response Unmarshaller for DescribeLocationFsxOpenZfs operation
    /// </summary>  
    public class DescribeLocationFsxOpenZfsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeLocationFsxOpenZfsResponse response = new DescribeLocationFsxOpenZfsResponse();
        ...
        private static DescribeLocationFsxOpenZfsResponseUnmarshaller _instance = new DescribeLocationFsxOpenZfsResponseUnmarshaller();        

        internal static DescribeLocationFsxOpenZfsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeLocationFsxOpenZfsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
