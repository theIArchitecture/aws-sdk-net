    ...
    public class ListAgentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AgentListEntry, AgentListEntryUnmarshaller>(AgentListEntryUnmarshaller.Instance);
                    response.Agents = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
