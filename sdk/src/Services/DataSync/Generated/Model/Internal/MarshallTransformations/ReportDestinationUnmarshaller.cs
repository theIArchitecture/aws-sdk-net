...
namespace Amazon.DataSync.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ReportDestinationUnmarshaller : IJsonUnmarshaller<ReportDestination, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ReportDestination Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = ReportDestinationS3Unmarshaller.Instance;
