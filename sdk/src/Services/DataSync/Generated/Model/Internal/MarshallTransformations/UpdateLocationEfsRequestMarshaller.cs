...
{
    /// <summary>
    /// UpdateLocationEfs Request Marshaller
    /// </summary>       
    public class UpdateLocationEfsRequestMarshaller : IMarshaller<IRequest, UpdateLocationEfsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateLocationEfsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateLocationEfsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DataSync");
            string target = "FmrsService.UpdateLocationEfs";
            ...
            if(publicRequest.IsSetFileSystemAccessRoleArn())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.FileSystemAccessRoleArn);
            }

            if(publicRequest.IsSetInTransitEncryption())
            {
                context.Writer.WritePropertyName("InTransitEncryption");
                context.Writer.WriteStringValue(publicRequest.InTransitEncryption);
            }
        ...
        private static UpdateLocationEfsRequestMarshaller _instance = new UpdateLocationEfsRequestMarshaller();        

        internal static UpdateLocationEfsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateLocationEfsRequestMarshaller Instance
        {
            get
            {
                return _instance;
