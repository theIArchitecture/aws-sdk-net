...
{
    /// <summary>
    /// Response Unmarshaller for UpdateLocationEfs operation
    /// </summary>  
    public class UpdateLocationEfsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateLocationEfsResponse response = new UpdateLocationEfsResponse();
        ...
        private static UpdateLocationEfsResponseUnmarshaller _instance = new UpdateLocationEfsResponseUnmarshaller();        

        internal static UpdateLocationEfsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateLocationEfsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
