...
{
    /// <summary>
    /// Response Unmarshaller for UpdateLocationNfs operation
    /// </summary>  
    public class UpdateLocationNfsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateLocationNfsResponse response = new UpdateLocationNfsResponse();
        ...
        private static UpdateLocationNfsResponseUnmarshaller _instance = new UpdateLocationNfsResponseUnmarshaller();        

        internal static UpdateLocationNfsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateLocationNfsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
