...
{
    /// <summary>
    /// Response Unmarshaller for UpdateLocationS3 operation
    /// </summary>  
    public class UpdateLocationS3ResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateLocationS3Response response = new UpdateLocationS3Response();
        ...
        private static UpdateLocationS3ResponseUnmarshaller _instance = new UpdateLocationS3ResponseUnmarshaller();        

        internal static UpdateLocationS3ResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateLocationS3ResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
