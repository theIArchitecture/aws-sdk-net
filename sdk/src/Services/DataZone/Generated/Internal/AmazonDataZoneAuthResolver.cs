...
namespace Amazon.DataZone.Internal
{
    ...
    public class AmazonDataZoneAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonDataZoneAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for DataZone.
        /// </summary>
        public AmazonDataZoneAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonDataZoneAuthSchemeParameters
            {
    ...
    public class AmazonDataZoneAuthSchemeResolver : IAuthSchemeResolver<AmazonDataZoneAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonDataZoneAuthSchemeParameters authParameters)
        {
