...
{
    /// <summary>
    /// Container for the parameters to the AddEntityOwner operation.
    /// Adds the owner of an entity (a domain unit).
    /// </summary>
    public partial class AddEntityOwnerRequest : AmazonDataZoneRequest
    {
        private string _clientToken;
        private string _domainIdentifier;
        private string _entityIdentifier;
        private DataZoneEntityType _entityType;
        private OwnerProperties _owner;
