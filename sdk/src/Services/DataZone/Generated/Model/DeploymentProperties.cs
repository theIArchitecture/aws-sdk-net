...
namespace Amazon.DataZone.Model
{
    ...
    {
        private int? _endTimeoutMinutes;
        private int? _startTimeoutMinutes;
        ...
        // Check to see if EndTimeoutMinutes property is set
        internal bool IsSetEndTimeoutMinutes()
        {
            return this._endTimeoutMinutes.HasValue; 
        }
        ...
        // Check to see if StartTimeoutMinutes property is set
        internal bool IsSetStartTimeoutMinutes()
        {
            return this._startTimeoutMinutes.HasValue; 
        }
