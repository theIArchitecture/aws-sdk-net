...
namespace Amazon.DataZone.Model
{
    ...
    public partial class GetConnectionResponse : AmazonWebServiceResponse
    {
        ...
        private string _environmentUserRole;
        ...
        /// <summary>
        /// Gets and sets the property EnvironmentUserRole. 
        /// <para>
        /// The environment user role.
        /// </para>
        /// </summary>
        public string EnvironmentUserRole
        {
            get { return this._environmentUserRole; }
            set { this._environmentUserRole = value; }
        }

        // Check to see if EnvironmentUserRole property is set
        internal bool IsSetEnvironmentUserRole()
        {
            return this._environmentUserRole != null;
        }
