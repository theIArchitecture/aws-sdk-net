...
{
    /// <summary>
    /// Response Unmarshaller for AcceptPredictions operation
    /// </summary>  
    public class AcceptPredictionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AcceptPredictionsResponse response = new AcceptPredictionsResponse();
        ...
        private static AcceptPredictionsResponseUnmarshaller _instance = new AcceptPredictionsResponseUnmarshaller();        

        internal static AcceptPredictionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AcceptPredictionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
