    ...
    public class ActionParametersMarshaller : IRequestMarshaller<ActionParameters, JsonMarshallerContext> 
    {
        ...
        public void Marshall(ActionParameters requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetAwsConsoleLink())
            {
                context.Writer.WritePropertyName("awsConsoleLink");
                context.Writer.WriteStartObject();

                var marshaller = AwsConsoleLinkParametersMarshaller.Instance;
                marshaller.Marshall(requestObject.AwsConsoleLink, context);
