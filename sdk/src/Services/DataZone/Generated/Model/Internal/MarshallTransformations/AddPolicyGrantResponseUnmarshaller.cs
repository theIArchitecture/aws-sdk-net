...
{
    /// <summary>
    /// Response Unmarshaller for AddPolicyGrant operation
    /// </summary>  
    public class AddPolicyGrantResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static AddPolicyGrantResponseUnmarshaller _instance = new AddPolicyGrantResponseUnmarshaller();        

        internal static AddPolicyGrantResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddPolicyGrantResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
