...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssetFilterConfigurationUnmarshaller : IJsonUnmarshaller<AssetFilterConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AssetFilterConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("rowConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.RowConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
