...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssetScopeUnmarshaller : IJsonUnmarshaller<AssetScope, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AssetScope Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("filterIds", targetDepth))
                {
                    ...
                    unmarshalledObject.FilterIds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
