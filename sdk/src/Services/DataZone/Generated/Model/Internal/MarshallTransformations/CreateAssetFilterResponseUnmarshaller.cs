...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateAssetFilterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAssetFilterResponse response = new CreateAssetFilterResponse();
        ...
        internal static CreateAssetFilterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAssetFilterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
