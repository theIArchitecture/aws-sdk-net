...
{
    /// <summary>
    /// CreateAssetRevision Request Marshaller
    /// </summary>       
    public class CreateAssetRevisionRequestMarshaller : IMarshaller<IRequest, CreateAssetRevisionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateAssetRevisionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateAssetRevisionRequest publicRequest)
        {
        ...
        private static CreateAssetRevisionRequestMarshaller _instance = new CreateAssetRevisionRequestMarshaller();        

        internal static CreateAssetRevisionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAssetRevisionRequestMarshaller Instance
        {
            get
            {
                return _instance;
