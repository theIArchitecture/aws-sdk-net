...
{
    /// <summary>
    /// Response Unmarshaller for CreateAssetType operation
    /// </summary>  
    public class CreateAssetTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAssetTypeResponse response = new CreateAssetTypeResponse();
        ...
        private static CreateAssetTypeResponseUnmarshaller _instance = new CreateAssetTypeResponseUnmarshaller();        

        internal static CreateAssetTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAssetTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
