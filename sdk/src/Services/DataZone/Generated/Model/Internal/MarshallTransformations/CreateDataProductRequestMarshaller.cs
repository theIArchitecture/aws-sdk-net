...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateDataProductRequestMarshaller : IMarshaller<IRequest, CreateDataProductRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static CreateDataProductRequestMarshaller _instance = new CreateDataProductRequestMarshaller();        

        internal static CreateDataProductRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDataProductRequestMarshaller Instance
        {
            get
            {
                return _instance;
