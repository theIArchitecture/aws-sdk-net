...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateDataProductResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDataProductResponse response = new CreateDataProductResponse();
        ...
        internal static CreateDataProductResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDataProductResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
