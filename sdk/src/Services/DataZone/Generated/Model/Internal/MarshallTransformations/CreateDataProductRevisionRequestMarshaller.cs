...
{
    /// <summary>
    /// CreateDataProductRevision Request Marshaller
    /// </summary>       
    public class CreateDataProductRevisionRequestMarshaller : IMarshaller<IRequest, CreateDataProductRevisionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateDataProductRevisionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateDataProductRevisionRequest publicRequest)
        {
        ...
        private static CreateDataProductRevisionRequestMarshaller _instance = new CreateDataProductRevisionRequestMarshaller();        

        internal static CreateDataProductRevisionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDataProductRevisionRequestMarshaller Instance
        {
            get
            {
                return _instance;
