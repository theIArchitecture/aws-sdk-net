...
{
    /// <summary>
    /// Response Unmarshaller for CreateDataProductRevision operation
    /// </summary>  
    public class CreateDataProductRevisionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDataProductRevisionResponse response = new CreateDataProductRevisionResponse();
        ...
        private static CreateDataProductRevisionResponseUnmarshaller _instance = new CreateDataProductRevisionResponseUnmarshaller();        

        internal static CreateDataProductRevisionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDataProductRevisionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
