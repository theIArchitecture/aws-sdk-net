...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateEnvironmentActionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateEnvironmentActionResponse response = new CreateEnvironmentActionResponse();
        ...
        internal static CreateEnvironmentActionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateEnvironmentActionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
