...
{
    /// <summary>
    /// Response Unmarshaller for CreateEnvironmentBlueprint operation
    /// </summary>  
    public class CreateEnvironmentBlueprintResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateEnvironmentBlueprintResponse response = new CreateEnvironmentBlueprintResponse();
        ...
        private static CreateEnvironmentBlueprintResponseUnmarshaller _instance = new CreateEnvironmentBlueprintResponseUnmarshaller();        

        internal static CreateEnvironmentBlueprintResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateEnvironmentBlueprintResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
