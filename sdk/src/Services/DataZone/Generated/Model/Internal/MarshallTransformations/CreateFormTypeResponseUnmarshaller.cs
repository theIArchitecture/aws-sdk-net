...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateFormTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateFormTypeResponse response = new CreateFormTypeResponse();
        ...
        internal static CreateFormTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateFormTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
