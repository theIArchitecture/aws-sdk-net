...
{
    /// <summary>
    /// Response Unmarshaller for CreateGlossary operation
    /// </summary>  
    public class CreateGlossaryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateGlossaryResponse response = new CreateGlossaryResponse();
        ...
        private static CreateGlossaryResponseUnmarshaller _instance = new CreateGlossaryResponseUnmarshaller();        

        internal static CreateGlossaryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateGlossaryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
