...
{
    /// <summary>
    /// Response Unmarshaller for CreateGlossaryTerm operation
    /// </summary>  
    public class CreateGlossaryTermResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateGlossaryTermResponse response = new CreateGlossaryTermResponse();
        ...
        private static CreateGlossaryTermResponseUnmarshaller _instance = new CreateGlossaryTermResponseUnmarshaller();        

        internal static CreateGlossaryTermResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateGlossaryTermResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
