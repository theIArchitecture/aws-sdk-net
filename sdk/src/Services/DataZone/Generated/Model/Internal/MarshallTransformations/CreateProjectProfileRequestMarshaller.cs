...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateProjectProfileRequestMarshaller : IMarshaller<IRequest, CreateProjectProfileRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static CreateProjectProfileRequestMarshaller _instance = new CreateProjectProfileRequestMarshaller();        

        internal static CreateProjectProfileRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateProjectProfileRequestMarshaller Instance
        {
            get
            {
                return _instance;
