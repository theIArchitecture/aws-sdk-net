...
{
    /// <summary>
    /// Response Unmarshaller for CreateSubscriptionGrant operation
    /// </summary>  
    public class CreateSubscriptionGrantResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSubscriptionGrantResponse response = new CreateSubscriptionGrantResponse();
        ...
        private static CreateSubscriptionGrantResponseUnmarshaller _instance = new CreateSubscriptionGrantResponseUnmarshaller();        

        internal static CreateSubscriptionGrantResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSubscriptionGrantResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
