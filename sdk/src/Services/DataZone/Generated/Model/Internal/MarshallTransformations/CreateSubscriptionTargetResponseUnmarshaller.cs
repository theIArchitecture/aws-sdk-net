...
{
    /// <summary>
    /// Response Unmarshaller for CreateSubscriptionTarget operation
    /// </summary>  
    public class CreateSubscriptionTargetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSubscriptionTargetResponse response = new CreateSubscriptionTargetResponse();
        ...
        private static CreateSubscriptionTargetResponseUnmarshaller _instance = new CreateSubscriptionTargetResponseUnmarshaller();        

        internal static CreateSubscriptionTargetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSubscriptionTargetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
