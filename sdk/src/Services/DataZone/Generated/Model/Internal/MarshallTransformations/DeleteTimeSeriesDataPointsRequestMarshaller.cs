...
{
    /// <summary>
    /// DeleteTimeSeriesDataPoints Request Marshaller
    /// </summary>       
    public class DeleteTimeSeriesDataPointsRequestMarshaller : IMarshaller<IRequest, DeleteTimeSeriesDataPointsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteTimeSeriesDataPointsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteTimeSeriesDataPointsRequest publicRequest)
        {
        ...
        private static DeleteTimeSeriesDataPointsRequestMarshaller _instance = new DeleteTimeSeriesDataPointsRequestMarshaller();        

        internal static DeleteTimeSeriesDataPointsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTimeSeriesDataPointsRequestMarshaller Instance
        {
            get
            {
                return _instance;
