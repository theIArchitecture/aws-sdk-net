...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FormTypeDataUnmarshaller : IJsonUnmarshaller<FormTypeData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FormTypeData Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("imports", targetDepth))
                {
                    ...
                    unmarshalledObject.Imports = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
