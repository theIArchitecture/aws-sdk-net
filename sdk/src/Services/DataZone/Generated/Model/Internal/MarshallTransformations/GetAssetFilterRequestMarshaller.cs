...
{
    /// <summary>
    /// GetAssetFilter Request Marshaller
    /// </summary>       
    public class GetAssetFilterRequestMarshaller : IMarshaller<IRequest, GetAssetFilterRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetAssetFilterRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetAssetFilterRequest publicRequest)
        {
        ...
        private static GetAssetFilterRequestMarshaller _instance = new GetAssetFilterRequestMarshaller();        

        internal static GetAssetFilterRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAssetFilterRequestMarshaller Instance
        {
            get
            {
                return _instance;
