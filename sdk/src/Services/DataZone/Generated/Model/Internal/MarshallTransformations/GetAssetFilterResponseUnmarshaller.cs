...
{
    /// <summary>
    /// Response Unmarshaller for GetAssetFilter operation
    /// </summary>  
    public class GetAssetFilterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAssetFilterResponse response = new GetAssetFilterResponse();
        ...
        private static GetAssetFilterResponseUnmarshaller _instance = new GetAssetFilterResponseUnmarshaller();        

        internal static GetAssetFilterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAssetFilterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
