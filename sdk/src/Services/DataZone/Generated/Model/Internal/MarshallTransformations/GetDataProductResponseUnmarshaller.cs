...
{
    /// <summary>
    /// Response Unmarshaller for GetDataProduct operation
    /// </summary>  
    public class GetDataProductResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDataProductResponse response = new GetDataProductResponse();
        ...
        private static GetDataProductResponseUnmarshaller _instance = new GetDataProductResponseUnmarshaller();        

        internal static GetDataProductResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDataProductResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
