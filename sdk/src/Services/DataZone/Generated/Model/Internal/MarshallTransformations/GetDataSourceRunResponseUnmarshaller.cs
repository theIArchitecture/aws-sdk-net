...
{
    /// <summary>
    /// Response Unmarshaller for GetDataSourceRun operation
    /// </summary>  
    public class GetDataSourceRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDataSourceRunResponse response = new GetDataSourceRunResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("dataSourceConfigurationSnapshot", targetDepth))
                {
                    ...
                    response.DataSourceConfigurationSnapshot = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("lineageSummary", targetDepth))
                {
                    ...
                    response.LineageSummary = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("runStatisticsForAssets", targetDepth))
                {
                    ...
                    response.RunStatisticsForAssets = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetDataSourceRunResponseUnmarshaller _instance = new GetDataSourceRunResponseUnmarshaller();        

        internal static GetDataSourceRunResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDataSourceRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
