...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetEnvironmentActionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetEnvironmentActionResponse response = new GetEnvironmentActionResponse();
        ...
        internal static GetEnvironmentActionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEnvironmentActionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
