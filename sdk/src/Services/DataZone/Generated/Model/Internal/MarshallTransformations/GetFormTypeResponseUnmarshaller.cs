...
{
    /// <summary>
    /// Response Unmarshaller for GetFormType operation
    /// </summary>  
    public class GetFormTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetFormTypeResponse response = new GetFormTypeResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<Import, ImportUnmarshaller>(ImportUnmarshaller.Instance);
                    response.Imports = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetFormTypeResponseUnmarshaller _instance = new GetFormTypeResponseUnmarshaller();        

        internal static GetFormTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFormTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
