...
{
    /// <summary>
    /// Response Unmarshaller for GetGlossary operation
    /// </summary>  
    public class GetGlossaryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetGlossaryResponse response = new GetGlossaryResponse();
        ...
        private static GetGlossaryResponseUnmarshaller _instance = new GetGlossaryResponseUnmarshaller();        

        internal static GetGlossaryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGlossaryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
