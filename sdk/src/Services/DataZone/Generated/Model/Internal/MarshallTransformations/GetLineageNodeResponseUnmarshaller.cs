...
{
    /// <summary>
    /// Response Unmarshaller for GetLineageNode operation
    /// </summary>  
    public class GetLineageNodeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetLineageNodeResponse response = new GetLineageNodeResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<LineageNodeReference, LineageNodeReferenceUnmarshaller>(LineageNodeReferenceUnmarshaller.Instance);
                    response.DownstreamNodes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SourceIdentifier = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<LineageNodeReference, LineageNodeReferenceUnmarshaller>(LineageNodeReferenceUnmarshaller.Instance);
                    response.UpstreamNodes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetLineageNodeResponseUnmarshaller _instance = new GetLineageNodeResponseUnmarshaller();        

        internal static GetLineageNodeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLineageNodeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
