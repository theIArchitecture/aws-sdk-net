...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetMetadataGenerationRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMetadataGenerationRunResponse response = new GetMetadataGenerationRunResponse();
        ...
        internal static GetMetadataGenerationRunResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMetadataGenerationRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
