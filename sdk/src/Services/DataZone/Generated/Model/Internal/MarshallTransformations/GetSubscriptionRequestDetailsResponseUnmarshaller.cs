...
{
    /// <summary>
    /// Response Unmarshaller for GetSubscriptionRequestDetails operation
    /// </summary>  
    public class GetSubscriptionRequestDetailsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSubscriptionRequestDetailsResponse response = new GetSubscriptionRequestDetailsResponse();
        ...
        private static GetSubscriptionRequestDetailsResponseUnmarshaller _instance = new GetSubscriptionRequestDetailsResponseUnmarshaller();        

        internal static GetSubscriptionRequestDetailsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSubscriptionRequestDetailsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
