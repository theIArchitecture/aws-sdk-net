...
{
    /// <summary>
    /// GetSubscriptionTarget Request Marshaller
    /// </summary>       
    public class GetSubscriptionTargetRequestMarshaller : IMarshaller<IRequest, GetSubscriptionTargetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetSubscriptionTargetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetSubscriptionTargetRequest publicRequest)
        {
        ...
        private static GetSubscriptionTargetRequestMarshaller _instance = new GetSubscriptionTargetRequestMarshaller();        

        internal static GetSubscriptionTargetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSubscriptionTargetRequestMarshaller Instance
        {
            get
            {
                return _instance;
