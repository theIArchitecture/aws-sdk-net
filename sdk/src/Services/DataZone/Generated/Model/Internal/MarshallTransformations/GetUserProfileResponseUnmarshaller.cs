...
{
    /// <summary>
    /// Response Unmarshaller for GetUserProfile operation
    /// </summary>  
    public class GetUserProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetUserProfileResponseUnmarshaller _instance = new GetUserProfileResponseUnmarshaller();        

        internal static GetUserProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetUserProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
