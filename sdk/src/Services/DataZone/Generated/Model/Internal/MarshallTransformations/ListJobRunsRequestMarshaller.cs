    ...
    public class ListJobRunsRequestMarshaller : IMarshaller<IRequest, ListJobRunsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListJobRunsRequest publicRequest)
        {
            ...
            if (!publicRequest.IsSetJobIdentifier())
                throw new AmazonDataZoneException("Request object does not have required field JobIdentifier set");
            ...
            request.ResourcePath = "/v2/domains/{domainIdentifier}/jobs/{jobIdentifier}/runs";
