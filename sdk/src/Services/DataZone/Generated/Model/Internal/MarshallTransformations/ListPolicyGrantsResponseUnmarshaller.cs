...
{
    /// <summary>
    /// Response Unmarshaller for ListPolicyGrants operation
    /// </summary>  
    public class ListPolicyGrantsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListPolicyGrantsResponse response = new ListPolicyGrantsResponse();
        ...
        private static ListPolicyGrantsResponseUnmarshaller _instance = new ListPolicyGrantsResponseUnmarshaller();        

        internal static ListPolicyGrantsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPolicyGrantsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
