...
{
    /// <summary>
    /// ListSubscriptionTargets Request Marshaller
    /// </summary>       
    public class ListSubscriptionTargetsRequestMarshaller : IMarshaller<IRequest, ListSubscriptionTargetsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListSubscriptionTargetsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListSubscriptionTargetsRequest publicRequest)
        {
        ...
        private static ListSubscriptionTargetsRequestMarshaller _instance = new ListSubscriptionTargetsRequestMarshaller();        

        internal static ListSubscriptionTargetsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSubscriptionTargetsRequestMarshaller Instance
        {
            get
            {
                return _instance;
