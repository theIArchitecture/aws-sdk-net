...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    public class ListSubscriptionsRequestMarshaller : IMarshaller<IRequest, ListSubscriptionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListSubscriptionsRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetSubscriptionRequestIdentifier())
                request.Parameters.Add("subscriptionRequestIdentifier", StringUtils.FromString(publicRequest.SubscriptionRequestIdentifier));
            request.ResourcePath = "/v2/domains/{domainIdentifier}/subscriptions";
