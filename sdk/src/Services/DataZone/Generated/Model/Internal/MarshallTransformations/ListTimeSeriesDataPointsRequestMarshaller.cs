...
{
    /// <summary>
    /// ListTimeSeriesDataPoints Request Marshaller
    /// </summary>       
    public class ListTimeSeriesDataPointsRequestMarshaller : IMarshaller<IRequest, ListTimeSeriesDataPointsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListTimeSeriesDataPointsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListTimeSeriesDataPointsRequest publicRequest)
        {
        ...
        private static ListTimeSeriesDataPointsRequestMarshaller _instance = new ListTimeSeriesDataPointsRequestMarshaller();        

        internal static ListTimeSeriesDataPointsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTimeSeriesDataPointsRequestMarshaller Instance
        {
            get
            {
                return _instance;
