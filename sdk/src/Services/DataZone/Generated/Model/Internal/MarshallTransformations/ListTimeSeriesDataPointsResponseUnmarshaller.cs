...
{
    /// <summary>
    /// Response Unmarshaller for ListTimeSeriesDataPoints operation
    /// </summary>  
    public class ListTimeSeriesDataPointsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTimeSeriesDataPointsResponse response = new ListTimeSeriesDataPointsResponse();
        ...
        private static ListTimeSeriesDataPointsResponseUnmarshaller _instance = new ListTimeSeriesDataPointsResponseUnmarshaller();        

        internal static ListTimeSeriesDataPointsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTimeSeriesDataPointsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
