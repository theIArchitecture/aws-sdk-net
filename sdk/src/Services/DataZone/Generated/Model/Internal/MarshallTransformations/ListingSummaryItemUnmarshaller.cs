...
{
    /// <summary>
    /// Response Unmarshaller for ListingSummaryItem Object
    /// </summary>  
    public class ListingSummaryItemUnmarshaller : IJsonUnmarshaller<ListingSummaryItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ListingSummaryItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ListingSummaryItem unmarshalledObject = new ListingSummaryItem();
        ...
        private static ListingSummaryItemUnmarshaller _instance = new ListingSummaryItemUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ListingSummaryItemUnmarshaller Instance
        {
            get
            {
                return _instance;
