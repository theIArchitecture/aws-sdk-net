...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    public class OwnerPropertiesOutputUnmarshaller : IJsonUnmarshaller<OwnerPropertiesOutput, JsonUnmarshallerContext>
    {
        ...
        private static OwnerPropertiesOutputUnmarshaller _instance = new OwnerPropertiesOutputUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static OwnerPropertiesOutputUnmarshaller Instance
        {
            get
            {
                return _instance;
