...
{
    /// <summary>
    /// Response Unmarshaller for PostLineageEvent operation
    /// </summary>  
    public class PostLineageEventResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static PostLineageEventResponseUnmarshaller _instance = new PostLineageEventResponseUnmarshaller();        

        internal static PostLineageEventResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PostLineageEventResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
