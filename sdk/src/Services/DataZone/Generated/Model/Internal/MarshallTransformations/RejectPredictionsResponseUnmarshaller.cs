...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RejectPredictionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RejectPredictionsResponse response = new RejectPredictionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AssetRevision = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static RejectPredictionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RejectPredictionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
