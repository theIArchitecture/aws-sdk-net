...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    public class SearchInventoryResultItemUnmarshaller : IJsonUnmarshaller<SearchInventoryResultItem, JsonUnmarshallerContext>
    {
        ...
        private static SearchInventoryResultItemUnmarshaller _instance = new SearchInventoryResultItemUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SearchInventoryResultItemUnmarshaller Instance
        {
            get
            {
                return _instance;
