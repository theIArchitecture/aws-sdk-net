...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class SearchTypesRequestMarshaller : IMarshaller<IRequest, SearchTypesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static SearchTypesRequestMarshaller _instance = new SearchTypesRequestMarshaller();        

        internal static SearchTypesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchTypesRequestMarshaller Instance
        {
            get
            {
                return _instance;
