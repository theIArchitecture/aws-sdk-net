...
{
    /// <summary>
    /// Response Unmarshaller for StartDataSourceRun operation
    /// </summary>  
    public class StartDataSourceRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartDataSourceRunResponse response = new StartDataSourceRunResponse();
        ...
        private static StartDataSourceRunResponseUnmarshaller _instance = new StartDataSourceRunResponseUnmarshaller();        

        internal static StartDataSourceRunResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartDataSourceRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
