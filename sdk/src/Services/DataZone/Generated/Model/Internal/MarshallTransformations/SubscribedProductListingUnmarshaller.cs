...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SubscribedProductListingUnmarshaller : IJsonUnmarshaller<SubscribedProductListing, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SubscribedProductListing Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AssetInDataProductListingItem, AssetInDataProductListingItemUnmarshaller>(AssetInDataProductListingItemUnmarshaller.Instance);
                    unmarshalledObject.AssetListings = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
