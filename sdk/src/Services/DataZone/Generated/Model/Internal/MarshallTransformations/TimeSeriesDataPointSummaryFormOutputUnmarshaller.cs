...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TimeSeriesDataPointSummaryFormOutputUnmarshaller : IJsonUnmarshaller<TimeSeriesDataPointSummaryFormOutput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TimeSeriesDataPointSummaryFormOutput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("contentSummary", targetDepth))
                {
                    ...
                    unmarshalledObject.ContentSummary = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
