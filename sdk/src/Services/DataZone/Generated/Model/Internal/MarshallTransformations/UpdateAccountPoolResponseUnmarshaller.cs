...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateAccountPoolResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAccountPoolResponse response = new UpdateAccountPoolResponse();
        ...
        internal static UpdateAccountPoolResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAccountPoolResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
