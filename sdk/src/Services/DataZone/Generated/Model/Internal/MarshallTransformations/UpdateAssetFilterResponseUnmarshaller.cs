...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAssetFilter operation
    /// </summary>  
    public class UpdateAssetFilterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAssetFilterResponse response = new UpdateAssetFilterResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("effectiveColumnNames", targetDepth))
                {
                    ...
                    response.EffectiveColumnNames = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("effectiveRowFilter", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.EffectiveRowFilter = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateAssetFilterResponseUnmarshaller _instance = new UpdateAssetFilterResponseUnmarshaller();        

        internal static UpdateAssetFilterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAssetFilterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
