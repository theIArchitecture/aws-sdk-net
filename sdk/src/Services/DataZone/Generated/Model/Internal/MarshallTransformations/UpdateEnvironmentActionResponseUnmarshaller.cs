...
{
    /// <summary>
    /// Response Unmarshaller for UpdateEnvironmentAction operation
    /// </summary>  
    public class UpdateEnvironmentActionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateEnvironmentActionResponse response = new UpdateEnvironmentActionResponse();
        ...
        private static UpdateEnvironmentActionResponseUnmarshaller _instance = new UpdateEnvironmentActionResponseUnmarshaller();        

        internal static UpdateEnvironmentActionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateEnvironmentActionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
