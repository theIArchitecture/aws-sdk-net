...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateEnvironmentProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateEnvironmentProfileResponse response = new UpdateEnvironmentProfileResponse();
        ...
        internal static UpdateEnvironmentProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateEnvironmentProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
