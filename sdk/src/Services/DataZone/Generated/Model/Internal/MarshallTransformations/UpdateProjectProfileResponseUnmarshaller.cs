...
namespace Amazon.DataZone.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateProjectProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateProjectProfileResponse response = new UpdateProjectProfileResponse();
        ...
        internal static UpdateProjectProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateProjectProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
