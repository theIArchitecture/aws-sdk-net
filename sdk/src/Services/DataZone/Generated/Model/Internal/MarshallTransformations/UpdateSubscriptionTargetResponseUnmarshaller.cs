...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSubscriptionTarget operation
    /// </summary>  
    public class UpdateSubscriptionTargetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSubscriptionTargetResponse response = new UpdateSubscriptionTargetResponse();
        ...
        private static UpdateSubscriptionTargetResponseUnmarshaller _instance = new UpdateSubscriptionTargetResponseUnmarshaller();        

        internal static UpdateSubscriptionTargetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSubscriptionTargetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
