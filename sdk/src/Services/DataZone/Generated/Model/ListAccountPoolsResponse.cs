...
{
    /// <summary>
    /// This is the response object from the ListAccountPools operation.
    /// </summary>
    public partial class ListAccountPoolsResponse : AmazonWebServiceResponse
    {
        private List<AccountPoolSummary> _items = AWSConfigs.InitializeCollections ? new List<AccountPoolSummary>() : null;
        ...
        /// </summary>
        public List<AccountPoolSummary> Items
        {
