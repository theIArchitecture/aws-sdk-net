...
{
    /// <summary>
    /// This is the response object from the ListEnvironmentBlueprints operation.
    /// </summary>
    public partial class ListEnvironmentBlueprintsResponse : AmazonWebServiceResponse
    {
        private List<EnvironmentBlueprintSummary> _items = AWSConfigs.InitializeCollections ? new List<EnvironmentBlueprintSummary>() : null;
        ...
        public List<EnvironmentBlueprintSummary> Items
        {
