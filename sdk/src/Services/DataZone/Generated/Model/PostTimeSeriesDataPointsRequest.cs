...
{
    /// <summary>
    /// Container for the parameters to the PostTimeSeriesDataPoints operation.
    ...
    public partial class PostTimeSeriesDataPointsRequest : AmazonDataZoneRequest
    {
        ...
        private List<TimeSeriesDataPointFormInput> _forms = AWSConfigs.InitializeCollections ? new List<TimeSeriesDataPointFormInput>() : null;
        ...
        /// </summary>
        [AWSProperty(Required=true)]
        public List<TimeSeriesDataPointFormInput> Forms
        {
