...
namespace Amazon.DataZone.Model
{
    ...
    internal sealed partial class ListConnectionsPaginator : IPaginator<ListConnectionsResponse>, IListConnectionsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<ConnectionSummary> Items => 
            new PaginatedResultKeyResponse<ListConnectionsResponse, ConnectionSummary>(this, (i) => i.Items ?? new List<ConnectionSummary>());

        internal ListConnectionsPaginator(IAmazonDataZone client, ListConnectionsRequest request)
        {
            this._client = client;
