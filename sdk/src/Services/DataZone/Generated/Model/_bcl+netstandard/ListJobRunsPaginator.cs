...
namespace Amazon.DataZone.Model
{
    ...
    internal sealed partial class ListJobRunsPaginator : IPaginator<ListJobRunsResponse>, IListJobRunsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<JobRunSummary> Items => 
            new PaginatedResultKeyResponse<ListJobRunsResponse, JobRunSummary>(this, (i) => i.Items ?? new List<JobRunSummary>());

        internal ListJobRunsPaginator(IAmazonDataZone client, ListJobRunsRequest request)
        {
            this._client = client;
