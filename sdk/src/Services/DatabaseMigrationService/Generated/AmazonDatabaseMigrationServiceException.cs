...
namespace Amazon.DatabaseMigrationService
{
    ...
    public partial class AmazonDatabaseMigrationServiceException : AmazonServiceException
    {
        ...
        public AmazonDatabaseMigrationServiceException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonDatabaseMigrationServiceException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
