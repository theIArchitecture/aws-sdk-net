...
namespace Amazon.DatabaseMigrationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AccountQuotaUnmarshaller : IJsonUnmarshaller<AccountQuota, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AccountQuota Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AccountQuotaName", targetDepth))
                {
                    ...
                    unmarshalledObject.AccountQuotaName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
