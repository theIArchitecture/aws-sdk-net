...
{
    /// <summary>
    /// CreateDataProvider Request Marshaller
    /// </summary>       
    public class CreateDataProviderRequestMarshaller : IMarshaller<IRequest, CreateDataProviderRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateDataProviderRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateDataProviderRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DatabaseMigrationService");
            string target = "AmazonDMSv20160101.CreateDataProvider";
        ...
        private static CreateDataProviderRequestMarshaller _instance = new CreateDataProviderRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDataProviderRequestMarshaller Instance
        {
            get
            {
                return _instance;
