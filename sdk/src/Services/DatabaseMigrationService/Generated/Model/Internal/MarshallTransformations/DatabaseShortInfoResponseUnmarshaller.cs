...
namespace Amazon.DatabaseMigrationService.Model.Internal.MarshallTransformations
{
    ...
    public class DatabaseShortInfoResponseUnmarshaller : IJsonUnmarshaller<DatabaseShortInfoResponse, JsonUnmarshallerContext>
    {
        ...
        private static DatabaseShortInfoResponseUnmarshaller _instance = new DatabaseShortInfoResponseUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DatabaseShortInfoResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
