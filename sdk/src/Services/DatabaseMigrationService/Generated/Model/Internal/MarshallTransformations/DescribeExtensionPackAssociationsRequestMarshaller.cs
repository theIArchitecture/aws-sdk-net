...
{
    /// <summary>
    /// DescribeExtensionPackAssociations Request Marshaller
    /// </summary>       
    public class DescribeExtensionPackAssociationsRequestMarshaller : IMarshaller<IRequest, DescribeExtensionPackAssociationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeExtensionPackAssociationsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeExtensionPackAssociationsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DatabaseMigrationService");
            string target = "AmazonDMSv20160101.DescribeExtensionPackAssociations";
        ...
        private static DescribeExtensionPackAssociationsRequestMarshaller _instance = new DescribeExtensionPackAssociationsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeExtensionPackAssociationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
