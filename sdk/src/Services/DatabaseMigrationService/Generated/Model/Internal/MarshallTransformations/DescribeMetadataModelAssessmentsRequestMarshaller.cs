...
{
    /// <summary>
    /// DescribeMetadataModelAssessments Request Marshaller
    /// </summary>       
    public class DescribeMetadataModelAssessmentsRequestMarshaller : IMarshaller<IRequest, DescribeMetadataModelAssessmentsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeMetadataModelAssessmentsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeMetadataModelAssessmentsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DatabaseMigrationService");
            string target = "AmazonDMSv20160101.DescribeMetadataModelAssessments";
        ...
        private static DescribeMetadataModelAssessmentsRequestMarshaller _instance = new DescribeMetadataModelAssessmentsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeMetadataModelAssessmentsRequestMarshaller Instance
        {
            get
            {
                return _instance;
