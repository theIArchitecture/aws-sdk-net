...
{
    /// <summary>
    /// DescribeMetadataModelConversions Request Marshaller
    /// </summary>       
    public class DescribeMetadataModelConversionsRequestMarshaller : IMarshaller<IRequest, DescribeMetadataModelConversionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeMetadataModelConversionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeMetadataModelConversionsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DatabaseMigrationService");
            string target = "AmazonDMSv20160101.DescribeMetadataModelConversions";
        ...
        private static DescribeMetadataModelConversionsRequestMarshaller _instance = new DescribeMetadataModelConversionsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeMetadataModelConversionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
