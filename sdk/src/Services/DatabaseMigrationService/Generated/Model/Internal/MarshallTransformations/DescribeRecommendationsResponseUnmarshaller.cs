...
{
    /// <summary>
    /// Response Unmarshaller for DescribeRecommendations operation
    /// </summary>  
    public class DescribeRecommendationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeRecommendationsResponse response = new DescribeRecommendationsResponse();
        ...
        private static DescribeRecommendationsResponseUnmarshaller _instance = new DescribeRecommendationsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeRecommendationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
