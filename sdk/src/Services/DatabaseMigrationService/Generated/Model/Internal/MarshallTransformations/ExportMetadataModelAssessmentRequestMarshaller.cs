...
{
    /// <summary>
    /// ExportMetadataModelAssessment Request Marshaller
    /// </summary>       
    public class ExportMetadataModelAssessmentRequestMarshaller : IMarshaller<IRequest, ExportMetadataModelAssessmentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ExportMetadataModelAssessmentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ExportMetadataModelAssessmentRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DatabaseMigrationService");
            string target = "AmazonDMSv20160101.ExportMetadataModelAssessment";
            ...
            if(publicRequest.IsSetAssessmentReportTypes())
            {
                ...
                {
                        context.Writer.WriteStringValue(publicRequestAssessmentReportTypesListValue);
                }
        ...
        private static ExportMetadataModelAssessmentRequestMarshaller _instance = new ExportMetadataModelAssessmentRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExportMetadataModelAssessmentRequestMarshaller Instance
        {
            get
            {
                return _instance;
