...
{
    /// <summary>
    /// Response Unmarshaller for IbmDb2LuwDataProviderSettings Object
    /// </summary>  
    public class IbmDb2LuwDataProviderSettingsUnmarshaller : IJsonUnmarshaller<IbmDb2LuwDataProviderSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IbmDb2LuwDataProviderSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            IbmDb2LuwDataProviderSettings unmarshalledObject = new IbmDb2LuwDataProviderSettings();
        ...
        private static IbmDb2LuwDataProviderSettingsUnmarshaller _instance = new IbmDb2LuwDataProviderSettingsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static IbmDb2LuwDataProviderSettingsUnmarshaller Instance
        {
            get
            {
                return _instance;
