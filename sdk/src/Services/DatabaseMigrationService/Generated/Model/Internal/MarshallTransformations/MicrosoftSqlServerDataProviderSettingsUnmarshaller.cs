...
{
    /// <summary>
    /// Response Unmarshaller for MicrosoftSqlServerDataProviderSettings Object
    /// </summary>  
    public class MicrosoftSqlServerDataProviderSettingsUnmarshaller : IJsonUnmarshaller<MicrosoftSqlServerDataProviderSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MicrosoftSqlServerDataProviderSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            MicrosoftSqlServerDataProviderSettings unmarshalledObject = new MicrosoftSqlServerDataProviderSettings();
        ...
        private static MicrosoftSqlServerDataProviderSettingsUnmarshaller _instance = new MicrosoftSqlServerDataProviderSettingsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static MicrosoftSqlServerDataProviderSettingsUnmarshaller Instance
        {
            get
            {
                return _instance;
