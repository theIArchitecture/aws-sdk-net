...
{
    /// <summary>
    /// Response Unmarshaller for ModifyInstanceProfile operation
    /// </summary>  
    public class ModifyInstanceProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyInstanceProfileResponse response = new ModifyInstanceProfileResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("InstanceProfile", targetDepth))
                {
                    ...
                    response.InstanceProfile = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ModifyInstanceProfileResponseUnmarshaller _instance = new ModifyInstanceProfileResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyInstanceProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
