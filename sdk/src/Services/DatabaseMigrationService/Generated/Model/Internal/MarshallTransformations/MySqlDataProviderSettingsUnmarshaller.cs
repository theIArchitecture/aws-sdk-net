...
{
    /// <summary>
    /// Response Unmarshaller for MySqlDataProviderSettings Object
    /// </summary>  
    public class MySqlDataProviderSettingsUnmarshaller : IJsonUnmarshaller<MySqlDataProviderSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MySqlDataProviderSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            MySqlDataProviderSettings unmarshalledObject = new MySqlDataProviderSettings();
        ...
        private static MySqlDataProviderSettingsUnmarshaller _instance = new MySqlDataProviderSettingsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static MySqlDataProviderSettingsUnmarshaller Instance
        {
            get
            {
                return _instance;
