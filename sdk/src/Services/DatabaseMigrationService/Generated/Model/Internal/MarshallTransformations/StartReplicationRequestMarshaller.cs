...
namespace Amazon.DatabaseMigrationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class StartReplicationRequestMarshaller : IMarshaller<IRequest, StartReplicationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(StartReplicationRequest publicRequest)
        {
            ...
            string target = "AmazonDMSv20160101.StartReplication";
            ...
            if(publicRequest.IsSetPremigrationAssessmentSettings())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.PremigrationAssessmentSettings);
            }
        ...
        private static StartReplicationRequestMarshaller _instance = new StartReplicationRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartReplicationRequestMarshaller Instance
        {
            get
            {
                return _instance;
