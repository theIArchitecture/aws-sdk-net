...
namespace Amazon.DatabaseMigrationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SupportedEndpointTypeUnmarshaller : IJsonUnmarshaller<SupportedEndpointType, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SupportedEndpointType Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ReplicationInstanceEngineMinimumVersion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("SupportsCDC", targetDepth))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    unmarshalledObject.SupportsCDC = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
