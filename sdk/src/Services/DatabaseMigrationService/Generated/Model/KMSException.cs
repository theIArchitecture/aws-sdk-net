...
namespace Amazon.DatabaseMigrationService.Model
{
    ...
    public partial class KMSException : AmazonDatabaseMigrationServiceException
    {
        ...
        public KMSException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public KMSException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
