...
namespace Amazon.DatabaseMigrationService.Model
{
    ...
    public partial class ReplicationSubnetGroupDoesNotCoverEnoughAZsException : AmazonDatabaseMigrationServiceException
    {
        ...
        public ReplicationSubnetGroupDoesNotCoverEnoughAZsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ReplicationSubnetGroupDoesNotCoverEnoughAZsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
