...
namespace Amazon.DatabaseMigrationService.Model
{
    ...
    internal sealed partial class DescribeEndpointTypesPaginator : IPaginator<DescribeEndpointTypesResponse>, IDescribeEndpointTypesPaginator
    {
        ...
        async IAsyncEnumerable<DescribeEndpointTypesResponse> IPaginator<DescribeEndpointTypesResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
