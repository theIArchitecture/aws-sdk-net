...
namespace Amazon.Deadline.Internal
{
    ...
    public class AmazonDeadlineAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonDeadlineAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Deadline.
        /// </summary>
        public AmazonDeadlineAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonDeadlineAuthSchemeParameters
            {
    ...
    public class AmazonDeadlineAuthSchemeResolver : IAuthSchemeResolver<AmazonDeadlineAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonDeadlineAuthSchemeParameters authParameters)
        {
