...
namespace Amazon.Deadline.Model
{
    ...
    {
        private JobAttachmentsFileSystem _fileSystem;
        private List<ManifestProperties> _manifests = AWSConfigs.InitializeCollections ? new List<ManifestProperties>() : null;
        ...
        public List<ManifestProperties> Manifests
        {
