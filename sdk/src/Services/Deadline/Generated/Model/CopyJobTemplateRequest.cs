...
{
    /// <summary>
    /// Container for the parameters to the CopyJobTemplate operation.
    /// Copies a job template to an Amazon S3 bucket.
    /// </summary>
    public partial class CopyJobTemplateRequest : AmazonDeadlineRequest
    {
        private string _farmId;
        private string _jobId;
        private string _queueId;
        private S3Location _targets3Location;
        ...
        /// <summary>
        /// Gets and sets the property TargetS3Location. 
        /// <para>
        /// The Amazon S3 bucket name and key where you would like to add a copy of the job template.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
        public S3Location TargetS3Location
        {
            get { return this._targets3Location; }
            set { this._targets3Location = value; }
        }

        // Check to see if TargetS3Location property is set
        internal bool IsSetTargetS3Location()
        {
            return this._targets3Location != null;
        }
