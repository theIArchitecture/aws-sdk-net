...
{
    /// <summary>
    /// AssociateMemberToFarm Request Marshaller
    /// </summary>       
    public class AssociateMemberToFarmRequestMarshaller : IMarshaller<IRequest, AssociateMemberToFarmRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AssociateMemberToFarmRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AssociateMemberToFarmRequest publicRequest)
        {
        ...
        private static AssociateMemberToFarmRequestMarshaller _instance = new AssociateMemberToFarmRequestMarshaller();        

        internal static AssociateMemberToFarmRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateMemberToFarmRequestMarshaller Instance
        {
            get
            {
                return _instance;
