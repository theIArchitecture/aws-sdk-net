...
{
    /// <summary>
    /// Response Unmarshaller for CreateFarm operation
    /// </summary>  
    public class CreateFarmResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateFarmResponseUnmarshaller _instance = new CreateFarmResponseUnmarshaller();        

        internal static CreateFarmResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateFarmResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
