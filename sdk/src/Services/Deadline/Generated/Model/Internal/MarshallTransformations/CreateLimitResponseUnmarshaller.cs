...
{
    /// <summary>
    /// Response Unmarshaller for CreateLimit operation
    /// </summary>  
    public class CreateLimitResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLimitResponse response = new CreateLimitResponse();
        ...
        private static CreateLimitResponseUnmarshaller _instance = new CreateLimitResponseUnmarshaller();        

        internal static CreateLimitResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLimitResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
