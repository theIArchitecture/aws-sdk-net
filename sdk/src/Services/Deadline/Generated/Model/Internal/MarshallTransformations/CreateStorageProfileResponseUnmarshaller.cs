...
{
    /// <summary>
    /// Response Unmarshaller for CreateStorageProfile operation
    /// </summary>  
    public class CreateStorageProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateStorageProfileResponse response = new CreateStorageProfileResponse();
        ...
        private static CreateStorageProfileResponseUnmarshaller _instance = new CreateStorageProfileResponseUnmarshaller();        

        internal static CreateStorageProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateStorageProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
