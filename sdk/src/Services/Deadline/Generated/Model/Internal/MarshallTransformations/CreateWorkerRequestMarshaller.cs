...
{
    /// <summary>
    /// CreateWorker Request Marshaller
    /// </summary>       
    public class CreateWorkerRequestMarshaller : IMarshaller<IRequest, CreateWorkerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateWorkerRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateWorkerRequest publicRequest)
        {
        ...
        private static CreateWorkerRequestMarshaller _instance = new CreateWorkerRequestMarshaller();        

        internal static CreateWorkerRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWorkerRequestMarshaller Instance
        {
            get
            {
                return _instance;
