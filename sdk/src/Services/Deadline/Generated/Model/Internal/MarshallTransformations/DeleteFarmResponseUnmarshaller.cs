...
{
    /// <summary>
    /// Response Unmarshaller for DeleteFarm operation
    /// </summary>  
    public class DeleteFarmResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteFarmResponseUnmarshaller _instance = new DeleteFarmResponseUnmarshaller();        

        internal static DeleteFarmResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteFarmResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
