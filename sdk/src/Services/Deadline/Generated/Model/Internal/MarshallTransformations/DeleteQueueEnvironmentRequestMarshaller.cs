...
{
    /// <summary>
    /// DeleteQueueEnvironment Request Marshaller
    /// </summary>       
    public class DeleteQueueEnvironmentRequestMarshaller : IMarshaller<IRequest, DeleteQueueEnvironmentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteQueueEnvironmentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteQueueEnvironmentRequest publicRequest)
        {
        ...
        private static DeleteQueueEnvironmentRequestMarshaller _instance = new DeleteQueueEnvironmentRequestMarshaller();        

        internal static DeleteQueueEnvironmentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteQueueEnvironmentRequestMarshaller Instance
        {
            get
            {
                return _instance;
