...
{
    /// <summary>
    /// DeleteQueueFleetAssociation Request Marshaller
    /// </summary>       
    public class DeleteQueueFleetAssociationRequestMarshaller : IMarshaller<IRequest, DeleteQueueFleetAssociationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteQueueFleetAssociationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteQueueFleetAssociationRequest publicRequest)
        {
        ...
        private static DeleteQueueFleetAssociationRequestMarshaller _instance = new DeleteQueueFleetAssociationRequestMarshaller();        

        internal static DeleteQueueFleetAssociationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteQueueFleetAssociationRequestMarshaller Instance
        {
            get
            {
                return _instance;
