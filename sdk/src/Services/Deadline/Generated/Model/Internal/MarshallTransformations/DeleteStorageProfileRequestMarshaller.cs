...
{
    /// <summary>
    /// DeleteStorageProfile Request Marshaller
    /// </summary>       
    public class DeleteStorageProfileRequestMarshaller : IMarshaller<IRequest, DeleteStorageProfileRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteStorageProfileRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteStorageProfileRequest publicRequest)
        {
        ...
        private static DeleteStorageProfileRequestMarshaller _instance = new DeleteStorageProfileRequestMarshaller();        

        internal static DeleteStorageProfileRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteStorageProfileRequestMarshaller Instance
        {
            get
            {
                return _instance;
