...
{
    /// <summary>
    /// DisassociateMemberFromFarm Request Marshaller
    /// </summary>       
    public class DisassociateMemberFromFarmRequestMarshaller : IMarshaller<IRequest, DisassociateMemberFromFarmRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DisassociateMemberFromFarmRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DisassociateMemberFromFarmRequest publicRequest)
        {
        ...
        private static DisassociateMemberFromFarmRequestMarshaller _instance = new DisassociateMemberFromFarmRequestMarshaller();        

        internal static DisassociateMemberFromFarmRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateMemberFromFarmRequestMarshaller Instance
        {
            get
            {
                return _instance;
