...
{
    /// <summary>
    /// Response Unmarshaller for FleetMember Object
    /// </summary>  
    public class FleetMemberUnmarshaller : IJsonUnmarshaller<FleetMember, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FleetMember Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            FleetMember unmarshalledObject = new FleetMember();
        ...
        private static FleetMemberUnmarshaller _instance = new FleetMemberUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static FleetMemberUnmarshaller Instance
        {
            get
            {
                return _instance;
