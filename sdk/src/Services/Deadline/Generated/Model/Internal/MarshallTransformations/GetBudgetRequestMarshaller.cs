...
{
    /// <summary>
    /// GetBudget Request Marshaller
    /// </summary>       
    public class GetBudgetRequestMarshaller : IMarshaller<IRequest, GetBudgetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetBudgetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetBudgetRequest publicRequest)
        {
        ...
        private static GetBudgetRequestMarshaller _instance = new GetBudgetRequestMarshaller();        

        internal static GetBudgetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBudgetRequestMarshaller Instance
        {
            get
            {
                return _instance;
