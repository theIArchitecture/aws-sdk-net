...
{
    /// <summary>
    /// GetQueueEnvironment Request Marshaller
    /// </summary>       
    public class GetQueueEnvironmentRequestMarshaller : IMarshaller<IRequest, GetQueueEnvironmentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetQueueEnvironmentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetQueueEnvironmentRequest publicRequest)
        {
        ...
        private static GetQueueEnvironmentRequestMarshaller _instance = new GetQueueEnvironmentRequestMarshaller();        

        internal static GetQueueEnvironmentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetQueueEnvironmentRequestMarshaller Instance
        {
            get
            {
                return _instance;
