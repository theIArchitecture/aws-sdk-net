...
{
    /// <summary>
    /// Response Unmarshaller for GetQueueEnvironment operation
    /// </summary>  
    public class GetQueueEnvironmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetQueueEnvironmentResponse response = new GetQueueEnvironmentResponse();
        ...
        private static GetQueueEnvironmentResponseUnmarshaller _instance = new GetQueueEnvironmentResponseUnmarshaller();        

        internal static GetQueueEnvironmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetQueueEnvironmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
