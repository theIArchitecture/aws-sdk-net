...
{
    /// <summary>
    /// Response Unmarshaller for GetQueueFleetAssociation operation
    /// </summary>  
    public class GetQueueFleetAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetQueueFleetAssociationResponse response = new GetQueueFleetAssociationResponse();
        ...
        private static GetQueueFleetAssociationResponseUnmarshaller _instance = new GetQueueFleetAssociationResponseUnmarshaller();        

        internal static GetQueueFleetAssociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetQueueFleetAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
