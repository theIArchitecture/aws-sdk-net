...
{
    /// <summary>
    /// GetStorageProfileForQueue Request Marshaller
    /// </summary>       
    public class GetStorageProfileForQueueRequestMarshaller : IMarshaller<IRequest, GetStorageProfileForQueueRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetStorageProfileForQueueRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetStorageProfileForQueueRequest publicRequest)
        {
            ...
            request.ResourcePath = "/2023-10-12/farms/{farmId}/queues/{queueId}/storage-profiles/{storageProfileId}";
            
            request.HostPrefix = $"management.";

            return request;
        }
        private static GetStorageProfileForQueueRequestMarshaller _instance = new GetStorageProfileForQueueRequestMarshaller();        

        internal static GetStorageProfileForQueueRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetStorageProfileForQueueRequestMarshaller Instance
        {
            get
            {
                return _instance;
