...
{
    /// <summary>
    /// Response Unmarshaller for GetStorageProfileForQueue operation
    /// </summary>  
    public class GetStorageProfileForQueueResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetStorageProfileForQueueResponse response = new GetStorageProfileForQueueResponse();
        ...
        private static GetStorageProfileForQueueResponseUnmarshaller _instance = new GetStorageProfileForQueueResponseUnmarshaller();        

        internal static GetStorageProfileForQueueResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetStorageProfileForQueueResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
