...
{
    /// <summary>
    /// Response Unmarshaller for JobRunAsUser Object
    /// </summary>  
    public class JobRunAsUserUnmarshaller : IJsonUnmarshaller<JobRunAsUser, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public JobRunAsUser Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            JobRunAsUser unmarshalledObject = new JobRunAsUser();
        ...
        private static JobRunAsUserUnmarshaller _instance = new JobRunAsUserUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static JobRunAsUserUnmarshaller Instance
        {
            get
            {
                return _instance;
