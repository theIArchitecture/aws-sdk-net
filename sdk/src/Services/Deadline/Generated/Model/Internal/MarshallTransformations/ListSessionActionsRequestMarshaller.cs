...
{
    /// <summary>
    /// ListSessionActions Request Marshaller
    /// </summary>       
    public class ListSessionActionsRequestMarshaller : IMarshaller<IRequest, ListSessionActionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListSessionActionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListSessionActionsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/2023-10-12/farms/{farmId}/queues/{queueId}/jobs/{jobId}/session-actions";
        ...
        private static ListSessionActionsRequestMarshaller _instance = new ListSessionActionsRequestMarshaller();        

        internal static ListSessionActionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSessionActionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
