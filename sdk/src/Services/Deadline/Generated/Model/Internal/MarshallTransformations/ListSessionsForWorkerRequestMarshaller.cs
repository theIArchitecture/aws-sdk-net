...
{
    /// <summary>
    /// ListSessionsForWorker Request Marshaller
    /// </summary>       
    public class ListSessionsForWorkerRequestMarshaller : IMarshaller<IRequest, ListSessionsForWorkerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListSessionsForWorkerRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListSessionsForWorkerRequest publicRequest)
        {
            ...
            request.ResourcePath = "/2023-10-12/farms/{farmId}/fleets/{fleetId}/workers/{workerId}/sessions";
        ...
        private static ListSessionsForWorkerRequestMarshaller _instance = new ListSessionsForWorkerRequestMarshaller();        

        internal static ListSessionsForWorkerRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSessionsForWorkerRequestMarshaller Instance
        {
            get
            {
                return _instance;
