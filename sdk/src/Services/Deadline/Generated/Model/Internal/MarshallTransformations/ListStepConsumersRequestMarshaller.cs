...
{
    /// <summary>
    /// ListStepConsumers Request Marshaller
    /// </summary>       
    public class ListStepConsumersRequestMarshaller : IMarshaller<IRequest, ListStepConsumersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListStepConsumersRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListStepConsumersRequest publicRequest)
        {
            ...
            request.ResourcePath = "/2023-10-12/farms/{farmId}/queues/{queueId}/jobs/{jobId}/steps/{stepId}/consumers";
        ...
        private static ListStepConsumersRequestMarshaller _instance = new ListStepConsumersRequestMarshaller();        

        internal static ListStepConsumersRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListStepConsumersRequestMarshaller Instance
        {
            get
            {
                return _instance;
