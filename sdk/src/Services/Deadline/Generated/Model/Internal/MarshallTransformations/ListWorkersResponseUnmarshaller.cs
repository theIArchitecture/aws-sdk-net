...
{
    /// <summary>
    /// Response Unmarshaller for ListWorkers operation
    /// </summary>  
    public class ListWorkersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListWorkersResponseUnmarshaller _instance = new ListWorkersResponseUnmarshaller();        

        internal static ListWorkersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListWorkersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
