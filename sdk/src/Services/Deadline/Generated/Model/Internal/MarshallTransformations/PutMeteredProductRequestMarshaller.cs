...
{
    /// <summary>
    /// PutMeteredProduct Request Marshaller
    /// </summary>       
    public class PutMeteredProductRequestMarshaller : IMarshaller<IRequest, PutMeteredProductRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutMeteredProductRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutMeteredProductRequest publicRequest)
        {
        ...
        private static PutMeteredProductRequestMarshaller _instance = new PutMeteredProductRequestMarshaller();        

        internal static PutMeteredProductRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutMeteredProductRequestMarshaller Instance
        {
            get
            {
                return _instance;
