...
{
    /// <summary>
    /// Response Unmarshaller for QueueMember Object
    /// </summary>  
    public class QueueMemberUnmarshaller : IJsonUnmarshaller<QueueMember, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public QueueMember Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            QueueMember unmarshalledObject = new QueueMember();
        ...
        private static QueueMemberUnmarshaller _instance = new QueueMemberUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static QueueMemberUnmarshaller Instance
        {
            get
            {
                return _instance;
