...
{
    /// <summary>
    /// SearchSteps Request Marshaller
    /// </summary>       
    public class SearchStepsRequestMarshaller : IMarshaller<IRequest, SearchStepsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SearchStepsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SearchStepsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/2023-10-12/farms/{farmId}/search/steps";
#if !NETFRAMEWORK
        ...
        private static SearchStepsRequestMarshaller _instance = new SearchStepsRequestMarshaller();        

        internal static SearchStepsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchStepsRequestMarshaller Instance
        {
            get
            {
                return _instance;
