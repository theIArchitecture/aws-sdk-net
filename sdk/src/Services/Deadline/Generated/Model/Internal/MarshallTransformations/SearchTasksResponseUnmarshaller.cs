...
{
    /// <summary>
    /// Response Unmarshaller for SearchTasks operation
    /// </summary>  
    public class SearchTasksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static SearchTasksResponseUnmarshaller _instance = new SearchTasksResponseUnmarshaller();        

        internal static SearchTasksResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchTasksResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
