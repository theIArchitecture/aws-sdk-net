...
namespace Amazon.Deadline.Model.Internal.MarshallTransformations
{
    ...
    public class SessionActionDefinitionUnmarshaller : IJsonUnmarshaller<SessionActionDefinition, JsonUnmarshallerContext>
    {
        ...
        private static SessionActionDefinitionUnmarshaller _instance = new SessionActionDefinitionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SessionActionDefinitionUnmarshaller Instance
        {
            get
            {
                return _instance;
