...
{
    /// <summary>
    /// Response Unmarshaller for StepDetailsEntity Object
    /// </summary>  
    public class StepDetailsEntityUnmarshaller : IJsonUnmarshaller<StepDetailsEntity, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public StepDetailsEntity Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            StepDetailsEntity unmarshalledObject = new StepDetailsEntity();
        ...
        private static StepDetailsEntityUnmarshaller _instance = new StepDetailsEntityUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static StepDetailsEntityUnmarshaller Instance
        {
            get
            {
                return _instance;
