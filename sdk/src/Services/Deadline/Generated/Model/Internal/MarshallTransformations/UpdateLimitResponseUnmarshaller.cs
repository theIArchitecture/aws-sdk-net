...
{
    /// <summary>
    /// Response Unmarshaller for UpdateLimit operation
    /// </summary>  
    public class UpdateLimitResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateLimitResponseUnmarshaller _instance = new UpdateLimitResponseUnmarshaller();        

        internal static UpdateLimitResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateLimitResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
