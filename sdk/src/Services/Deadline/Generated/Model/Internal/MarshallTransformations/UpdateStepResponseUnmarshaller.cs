...
{
    /// <summary>
    /// Response Unmarshaller for UpdateStep operation
    /// </summary>  
    public class UpdateStepResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateStepResponseUnmarshaller _instance = new UpdateStepResponseUnmarshaller();        

        internal static UpdateStepResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateStepResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
