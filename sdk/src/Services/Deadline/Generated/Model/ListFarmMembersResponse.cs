...
{
    /// <summary>
    /// This is the response object from the ListFarmMembers operation.
    /// </summary>
    public partial class ListFarmMembersResponse : AmazonWebServiceResponse
    {
        private List<FarmMember> _members = AWSConfigs.InitializeCollections ? new List<FarmMember>() : null;
        ...
        public List<FarmMember> Members
        {
