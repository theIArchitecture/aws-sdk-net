...
{
    /// <summary>
    /// This is the response object from the ListFarms operation.
    /// </summary>
    public partial class ListFarmsResponse : AmazonWebServiceResponse
    {
        private List<FarmSummary> _farms = AWSConfigs.InitializeCollections ? new List<FarmSummary>() : null;
        private string _nextToken;

        /// <summary>
        /// Gets and sets the property Farms. 
        /// <para>
        /// Farms on the list.
        /// </para>
        /// <para />
        ...
        public List<FarmSummary> Farms
        {
            get { return this._farms; }
            set { this._farms = value; }
        }

        // Check to see if Farms property is set
        internal bool IsSetFarms()
        {
            return this._farms != null && (this._farms.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
