...
{
    /// <summary>
    /// This is the response object from the ListFleetMembers operation.
    /// </summary>
    public partial class ListFleetMembersResponse : AmazonWebServiceResponse
    {
        private List<FleetMember> _members = AWSConfigs.InitializeCollections ? new List<FleetMember>() : null;
        ...
        public List<FleetMember> Members
        {
