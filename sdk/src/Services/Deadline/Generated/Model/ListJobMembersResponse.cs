...
{
    /// <summary>
    /// This is the response object from the ListJobMembers operation.
    /// </summary>
    public partial class ListJobMembersResponse : AmazonWebServiceResponse
    {
        private List<JobMember> _members = AWSConfigs.InitializeCollections ? new List<JobMember>() : null;
