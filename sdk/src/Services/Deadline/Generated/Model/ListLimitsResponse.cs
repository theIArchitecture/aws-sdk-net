...
{
    /// <summary>
    /// This is the response object from the ListLimits operation.
    /// </summary>
    public partial class ListLimitsResponse : AmazonWebServiceResponse
    {
        private List<LimitSummary> _limits = AWSConfigs.InitializeCollections ? new List<LimitSummary>() : null;
        ...
        public List<LimitSummary> Limits
        {
