...
namespace Amazon.Deadline.Model
{
    ...
    public partial class ListQueueFleetAssociationsResponse : AmazonWebServiceResponse
    {
        ...
        private List<QueueFleetAssociationSummary> _queueFleetAssociations = AWSConfigs.InitializeCollections ? new List<QueueFleetAssociationSummary>() : null;
        ...
        /// <summary>
        /// Gets and sets the property QueueFleetAssociations. 
        /// <para>
        ...
        public List<QueueFleetAssociationSummary> QueueFleetAssociations
        {
            get { return this._queueFleetAssociations; }
            set { this._queueFleetAssociations = value; }
        }

        // Check to see if QueueFleetAssociations property is set
        internal bool IsSetQueueFleetAssociations()
        {
            return this._queueFleetAssociations != null && (this._queueFleetAssociations.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
