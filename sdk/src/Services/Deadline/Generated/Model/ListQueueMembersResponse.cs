...
{
    /// <summary>
    /// This is the response object from the ListQueueMembers operation.
    /// </summary>
    public partial class ListQueueMembersResponse : AmazonWebServiceResponse
    {
        private List<QueueMember> _members = AWSConfigs.InitializeCollections ? new List<QueueMember>() : null;
