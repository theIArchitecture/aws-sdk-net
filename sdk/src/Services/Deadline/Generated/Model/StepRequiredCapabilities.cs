...
namespace Amazon.Deadline.Model
{
    ...
    /// </summary>
    public partial class StepRequiredCapabilities
    {
        private List<StepAmountCapability> _amounts = AWSConfigs.InitializeCollections ? new List<StepAmountCapability>() : null;
        private List<StepAttributeCapability> _attributes = AWSConfigs.InitializeCollections ? new List<StepAttributeCapability>() : null;
