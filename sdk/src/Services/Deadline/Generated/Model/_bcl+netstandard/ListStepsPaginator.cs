...
namespace Amazon.Deadline.Model
{
    ...
    internal sealed partial class ListStepsPaginator : IPaginator<ListStepsResponse>, IListStepsPaginator
    {
        ...
        internal ListStepsPaginator(IAmazonDeadline client, ListStepsRequest request)
        {
            this._client = client;
        ...
        async IAsyncEnumerable<ListStepsResponse> IPaginator<ListStepsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
