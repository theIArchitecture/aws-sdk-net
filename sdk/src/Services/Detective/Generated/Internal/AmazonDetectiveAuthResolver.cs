...
namespace Amazon.Detective.Internal
{
    ...
    public class AmazonDetectiveAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonDetectiveAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Detective.
        /// </summary>
        public AmazonDetectiveAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonDetectiveAuthSchemeParameters
            {
    ...
    public class AmazonDetectiveAuthSchemeResolver : IAuthSchemeResolver<AmazonDetectiveAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonDetectiveAuthSchemeParameters authParameters)
        {
