...
namespace Amazon.Detective.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DatasourcePackageUsageInfoUnmarshaller : IJsonUnmarshaller<DatasourcePackageUsageInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DatasourcePackageUsageInfo Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
