...
{
    /// <summary>
    /// Response Unmarshaller for ListIndicators operation
    /// </summary>  
    public class ListIndicatorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListIndicatorsResponse response = new ListIndicatorsResponse();
        ...
        private static ListIndicatorsResponseUnmarshaller _instance = new ListIndicatorsResponseUnmarshaller();        

        internal static ListIndicatorsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListIndicatorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
