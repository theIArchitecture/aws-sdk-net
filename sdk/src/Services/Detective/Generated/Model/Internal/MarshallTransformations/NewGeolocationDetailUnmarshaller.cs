...
{
    /// <summary>
    /// Response Unmarshaller for NewGeolocationDetail Object
    /// </summary>  
    public class NewGeolocationDetailUnmarshaller : IJsonUnmarshaller<NewGeolocationDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NewGeolocationDetail Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static NewGeolocationDetailUnmarshaller _instance = new NewGeolocationDetailUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static NewGeolocationDetailUnmarshaller Instance
        {
            get
            {
                return _instance;
