...
namespace Amazon.Detective.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UnprocessedGraphUnmarshaller : IJsonUnmarshaller<UnprocessedGraph, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public UnprocessedGraph Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
