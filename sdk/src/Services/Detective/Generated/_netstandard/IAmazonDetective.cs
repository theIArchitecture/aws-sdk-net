...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonDetectiveConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonDetectiveConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonDetectiveConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonDetectiveConfig to create AmazonDetectiveClient");
            }

            return awsCredentials == null ? 
                    new AmazonDetectiveClient(serviceClientConfig) :
                    new AmazonDetectiveClient(awsCredentials, serviceClientConfig);
        }
