...
namespace Amazon.DevOpsGuru.Model.Internal.MarshallTransformations
{
    ...
    public class CostEstimationResourceCollectionFilterMarshaller : IRequestMarshaller<CostEstimationResourceCollectionFilter, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(CostEstimationResourceCollectionFilter requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetCloudFormation())
            {
                ...
                var marshaller = CloudFormationCostEstimationResourceCollectionFilterMarshaller.Instance;
