...
{
    /// <summary>
    /// Response Unmarshaller for DescribeOrganizationResourceCollectionHealth operation
    /// </summary>  
    public class DescribeOrganizationResourceCollectionHealthResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeOrganizationResourceCollectionHealthResponse response = new DescribeOrganizationResourceCollectionHealthResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AccountHealth, AccountHealthUnmarshaller>(AccountHealthUnmarshaller.Instance);
        ...
        private static DescribeOrganizationResourceCollectionHealthResponseUnmarshaller _instance = new DescribeOrganizationResourceCollectionHealthResponseUnmarshaller();        

        internal static DescribeOrganizationResourceCollectionHealthResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeOrganizationResourceCollectionHealthResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
