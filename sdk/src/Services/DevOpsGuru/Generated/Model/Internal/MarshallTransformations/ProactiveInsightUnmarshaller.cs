...
namespace Amazon.DevOpsGuru.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ProactiveInsightUnmarshaller : IJsonUnmarshaller<ProactiveInsight, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ProactiveInsight Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SsmOpsItemId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
