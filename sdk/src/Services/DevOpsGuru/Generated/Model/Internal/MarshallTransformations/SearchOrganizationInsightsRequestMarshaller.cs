...
{
    /// <summary>
    /// SearchOrganizationInsights Request Marshaller
    /// </summary>       
    public class SearchOrganizationInsightsRequestMarshaller : IMarshaller<IRequest, SearchOrganizationInsightsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SearchOrganizationInsightsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SearchOrganizationInsightsRequest publicRequest)
        {
        ...
        private static SearchOrganizationInsightsRequestMarshaller _instance = new SearchOrganizationInsightsRequestMarshaller();        

        internal static SearchOrganizationInsightsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchOrganizationInsightsRequestMarshaller Instance
        {
            get
            {
                return _instance;
