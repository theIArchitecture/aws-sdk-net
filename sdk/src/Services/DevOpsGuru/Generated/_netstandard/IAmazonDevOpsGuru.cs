...
namespace Amazon.DevOpsGuru
{
    ...
    public partial interface IAmazonDevOpsGuru : IAmazonService, IDisposable
    {
        ...
        Task<DescribeEventSourcesConfigResponse> DescribeEventSourcesConfigAsync(DescribeEventSourcesConfigRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DescribeFeedbackResponse> DescribeFeedbackAsync(DescribeFeedbackRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DescribeOrganizationHealthResponse> DescribeOrganizationHealthAsync(DescribeOrganizationHealthRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DescribeOrganizationOverviewResponse> DescribeOrganizationOverviewAsync(DescribeOrganizationOverviewRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DescribeOrganizationResourceCollectionHealthResponse> DescribeOrganizationResourceCollectionHealthAsync(DescribeOrganizationResourceCollectionHealthRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetCostEstimationResponse> GetCostEstimationAsync(GetCostEstimationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListAnomalousLogGroupsResponse> ListAnomalousLogGroupsAsync(ListAnomalousLogGroupsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListMonitoredResourcesResponse> ListMonitoredResourcesAsync(ListMonitoredResourcesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListOrganizationInsightsResponse> ListOrganizationInsightsAsync(ListOrganizationInsightsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<SearchOrganizationInsightsResponse> SearchOrganizationInsightsAsync(SearchOrganizationInsightsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StartCostEstimationResponse> StartCostEstimationAsync(StartCostEstimationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateEventSourcesConfigResponse> UpdateEventSourcesConfigAsync(UpdateEventSourcesConfigRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonDevOpsGuruConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonDevOpsGuruConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonDevOpsGuruConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonDevOpsGuruConfig to create AmazonDevOpsGuruClient");
            }

            return awsCredentials == null ? 
                    new AmazonDevOpsGuruClient(serviceClientConfig) :
                    new AmazonDevOpsGuruClient(awsCredentials, serviceClientConfig);
        }
