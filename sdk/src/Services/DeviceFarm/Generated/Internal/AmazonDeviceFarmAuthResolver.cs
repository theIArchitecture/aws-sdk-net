...
namespace Amazon.DeviceFarm.Internal
{
    ...
    public class AmazonDeviceFarmAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonDeviceFarmAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for DeviceFarm.
        /// </summary>
        public AmazonDeviceFarmAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonDeviceFarmAuthSchemeParameters
            {
    ...
    public class AmazonDeviceFarmAuthSchemeResolver : IAuthSchemeResolver<AmazonDeviceFarmAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonDeviceFarmAuthSchemeParameters authParameters)
        {
