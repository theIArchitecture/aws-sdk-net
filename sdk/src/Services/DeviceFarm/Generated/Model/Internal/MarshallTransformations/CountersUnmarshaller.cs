...
namespace Amazon.DeviceFarm.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CountersUnmarshaller : IJsonUnmarshaller<Counters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Counters Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("errored", targetDepth))
                {
                    ...
                    unmarshalledObject.Errored = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.Warned = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
