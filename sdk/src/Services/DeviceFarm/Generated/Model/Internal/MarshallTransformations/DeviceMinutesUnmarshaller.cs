...
namespace Amazon.DeviceFarm.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeviceMinutesUnmarshaller : IJsonUnmarshaller<DeviceMinutes, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DeviceMinutes Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("metered", targetDepth))
                {
                    ...
                    unmarshalledObject.Metered = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableDoubleUnmarshaller.Instance;
                    unmarshalledObject.Unmetered = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
