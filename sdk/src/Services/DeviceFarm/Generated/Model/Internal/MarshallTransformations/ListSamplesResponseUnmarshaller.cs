    ...
    public class ListSamplesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<Sample, SampleUnmarshaller>(SampleUnmarshaller.Instance);
                    response.Samples = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
