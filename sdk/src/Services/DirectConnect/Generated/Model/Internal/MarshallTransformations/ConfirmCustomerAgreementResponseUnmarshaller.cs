...
{
    /// <summary>
    /// Response Unmarshaller for ConfirmCustomerAgreement operation
    /// </summary>  
    public class ConfirmCustomerAgreementResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ConfirmCustomerAgreementResponse response = new ConfirmCustomerAgreementResponse();
        ...
        private static ConfirmCustomerAgreementResponseUnmarshaller _instance = new ConfirmCustomerAgreementResponseUnmarshaller();        

        internal static ConfirmCustomerAgreementResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ConfirmCustomerAgreementResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
