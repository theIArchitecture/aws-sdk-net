...
{
    /// <summary>
    /// Response Unmarshaller for DescribeCustomerMetadata operation
    /// </summary>  
    public class DescribeCustomerMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeCustomerMetadataResponse response = new DescribeCustomerMetadataResponse();
        ...
        private static DescribeCustomerMetadataResponseUnmarshaller _instance = new DescribeCustomerMetadataResponseUnmarshaller();        

        internal static DescribeCustomerMetadataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeCustomerMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
