...
{
    /// <summary>
    /// Response Unmarshaller for DescribeRouterConfiguration operation
    /// </summary>  
    public class DescribeRouterConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeRouterConfigurationResponse response = new DescribeRouterConfigurationResponse();
        ...
        private static DescribeRouterConfigurationResponseUnmarshaller _instance = new DescribeRouterConfigurationResponseUnmarshaller();        

        internal static DescribeRouterConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeRouterConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
