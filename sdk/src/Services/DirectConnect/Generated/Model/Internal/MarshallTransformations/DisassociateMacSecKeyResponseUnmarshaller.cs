...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateMacSecKey operation
    /// </summary>  
    public class DisassociateMacSecKeyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateMacSecKeyResponse response = new DisassociateMacSecKeyResponse();
        ...
        private static DisassociateMacSecKeyResponseUnmarshaller _instance = new DisassociateMacSecKeyResponseUnmarshaller();        

        internal static DisassociateMacSecKeyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateMacSecKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
