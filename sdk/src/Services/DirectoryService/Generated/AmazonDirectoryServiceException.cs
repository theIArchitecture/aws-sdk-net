...
namespace Amazon.DirectoryService
{
    ...
    public partial class AmazonDirectoryServiceException : AmazonServiceException
    {
        ...
        public AmazonDirectoryServiceException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonDirectoryServiceException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
