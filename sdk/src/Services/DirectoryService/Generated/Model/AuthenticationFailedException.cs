...
namespace Amazon.DirectoryService.Model
{
    ...
    public partial class AuthenticationFailedException : AmazonDirectoryServiceException
    {
        ...
        public AuthenticationFailedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AuthenticationFailedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
