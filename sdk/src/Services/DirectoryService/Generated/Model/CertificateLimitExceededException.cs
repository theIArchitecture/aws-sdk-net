...
namespace Amazon.DirectoryService.Model
{
    ...
    public partial class CertificateLimitExceededException : AmazonDirectoryServiceException
    {
        ...
        public CertificateLimitExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CertificateLimitExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
