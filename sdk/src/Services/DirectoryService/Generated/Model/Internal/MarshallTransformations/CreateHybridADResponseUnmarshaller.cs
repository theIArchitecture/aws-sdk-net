...
{
    /// <summary>
    /// Response Unmarshaller for CreateHybridAD operation
    /// </summary>  
    public class CreateHybridADResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateHybridADResponse response = new CreateHybridADResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("ADAssessmentLimitExceededException"))
                {
                    return ADAssessmentLimitExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                ...
                {
                    return DirectoryLimitExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static CreateHybridADResponseUnmarshaller _instance = new CreateHybridADResponseUnmarshaller();        

        internal static CreateHybridADResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateHybridADResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
