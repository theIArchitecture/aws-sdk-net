...
{
    /// <summary>
    /// Response Unmarshaller for DescribeADAssessment operation
    /// </summary>  
    public class DescribeADAssessmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeADAssessmentResponse response = new DescribeADAssessmentResponse();
        ...
        private static DescribeADAssessmentResponseUnmarshaller _instance = new DescribeADAssessmentResponseUnmarshaller();        

        internal static DescribeADAssessmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeADAssessmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
