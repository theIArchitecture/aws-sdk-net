    ...
    public class DescribeDirectoriesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DirectoryDescription, DirectoryDescriptionUnmarshaller>(DirectoryDescriptionUnmarshaller.Instance);
                    response.DirectoryDescriptions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
