    ...
    public class DescribeDomainControllersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DomainController, DomainControllerUnmarshaller>(DomainControllerUnmarshaller.Instance);
                    response.DomainControllers = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
