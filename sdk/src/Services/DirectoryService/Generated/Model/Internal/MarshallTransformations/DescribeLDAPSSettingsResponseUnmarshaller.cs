    ...
    public class DescribeLDAPSSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<LDAPSSettingInfo, LDAPSSettingInfoUnmarshaller>(LDAPSSettingInfoUnmarshaller.Instance);
                    response.LDAPSSettingsInfo = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
