    ...
    public class DescribeRegionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<RegionDescription, RegionDescriptionUnmarshaller>(RegionDescriptionUnmarshaller.Instance);
                    response.RegionsDescription = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
