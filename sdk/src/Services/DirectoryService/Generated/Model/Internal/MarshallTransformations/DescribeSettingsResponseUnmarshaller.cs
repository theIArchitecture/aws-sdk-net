...
{
    /// <summary>
    /// Response Unmarshaller for DescribeSettings operation
    /// </summary>  
    public class DescribeSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeSettingsResponse response = new DescribeSettingsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SettingEntry, SettingEntryUnmarshaller>(SettingEntryUnmarshaller.Instance);
                    response.SettingEntries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeSettingsResponseUnmarshaller _instance = new DescribeSettingsResponseUnmarshaller();        

        internal static DescribeSettingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
