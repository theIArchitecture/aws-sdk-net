    ...
    public class DescribeSharedDirectoriesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SharedDirectory, SharedDirectoryUnmarshaller>(SharedDirectoryUnmarshaller.Instance);
                    response.SharedDirectories = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
