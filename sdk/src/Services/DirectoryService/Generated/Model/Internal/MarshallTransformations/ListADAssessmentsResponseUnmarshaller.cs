...
{
    /// <summary>
    /// Response Unmarshaller for ListADAssessments operation
    /// </summary>  
    public class ListADAssessmentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListADAssessmentsResponse response = new ListADAssessmentsResponse();
        ...
        private static ListADAssessmentsResponseUnmarshaller _instance = new ListADAssessmentsResponseUnmarshaller();        

        internal static ListADAssessmentsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListADAssessmentsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
