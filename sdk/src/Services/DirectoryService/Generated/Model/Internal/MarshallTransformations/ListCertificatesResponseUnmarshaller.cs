    ...
    public class ListCertificatesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<CertificateInfo, CertificateInfoUnmarshaller>(CertificateInfoUnmarshaller.Instance);
                    response.CertificatesInfo = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
