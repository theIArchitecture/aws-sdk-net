    ...
    public class ListIpRoutesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<IpRouteInfo, IpRouteInfoUnmarshaller>(IpRouteInfoUnmarshaller.Instance);
                    response.IpRoutesInfo = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
