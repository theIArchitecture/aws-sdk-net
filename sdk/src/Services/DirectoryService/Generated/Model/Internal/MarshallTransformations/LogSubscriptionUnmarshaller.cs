...
namespace Amazon.DirectoryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LogSubscriptionUnmarshaller : IJsonUnmarshaller<LogSubscription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LogSubscription Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SubscriptionCreatedDateTime", targetDepth))
                {
                    ...
                    unmarshalledObject.SubscriptionCreatedDateTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
