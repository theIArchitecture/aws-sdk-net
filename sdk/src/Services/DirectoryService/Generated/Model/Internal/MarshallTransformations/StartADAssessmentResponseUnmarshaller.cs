...
{
    /// <summary>
    /// Response Unmarshaller for StartADAssessment operation
    /// </summary>  
    public class StartADAssessmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartADAssessmentResponse response = new StartADAssessmentResponse();
        ...
        private static StartADAssessmentResponseUnmarshaller _instance = new StartADAssessmentResponseUnmarshaller();        

        internal static StartADAssessmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartADAssessmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
