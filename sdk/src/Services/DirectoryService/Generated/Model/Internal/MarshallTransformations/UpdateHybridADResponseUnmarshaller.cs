...
{
    /// <summary>
    /// Response Unmarshaller for UpdateHybridAD operation
    /// </summary>  
    public class UpdateHybridADResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateHybridADResponse response = new UpdateHybridADResponse();
        ...
        private static UpdateHybridADResponseUnmarshaller _instance = new UpdateHybridADResponseUnmarshaller();        

        internal static UpdateHybridADResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateHybridADResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
