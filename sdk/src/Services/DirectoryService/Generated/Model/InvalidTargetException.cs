...
namespace Amazon.DirectoryService.Model
{
    ...
    public partial class InvalidTargetException : AmazonDirectoryServiceException
    {
        ...
        public InvalidTargetException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidTargetException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
