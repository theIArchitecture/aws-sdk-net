...
namespace Amazon.DirectoryService.Model
{
    ...
    public partial class SnapshotLimitExceededException : AmazonDirectoryServiceException
    {
        ...
        public SnapshotLimitExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public SnapshotLimitExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
