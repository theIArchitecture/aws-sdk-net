...
namespace Amazon.DirectoryService
{
    ...
    public partial interface IAmazonDirectoryService : IAmazonService, IDisposable
    {
        ...
        Task<CreateHybridADResponse> CreateHybridADAsync(CreateHybridADRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteADAssessmentResponse> DeleteADAssessmentAsync(DeleteADAssessmentRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DescribeADAssessmentResponse> DescribeADAssessmentAsync(DescribeADAssessmentRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DescribeCAEnrollmentPolicyResponse> DescribeCAEnrollmentPolicyAsync(DescribeCAEnrollmentPolicyRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DescribeDirectoryDataAccessResponse> DescribeDirectoryDataAccessAsync(DescribeDirectoryDataAccessRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DescribeHybridADUpdateResponse> DescribeHybridADUpdateAsync(DescribeHybridADUpdateRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DisableCAEnrollmentPolicyResponse> DisableCAEnrollmentPolicyAsync(DisableCAEnrollmentPolicyRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DisableDirectoryDataAccessResponse> DisableDirectoryDataAccessAsync(DisableDirectoryDataAccessRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<EnableCAEnrollmentPolicyResponse> EnableCAEnrollmentPolicyAsync(EnableCAEnrollmentPolicyRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<EnableDirectoryDataAccessResponse> EnableDirectoryDataAccessAsync(EnableDirectoryDataAccessRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListADAssessmentsResponse> ListADAssessmentsAsync(ListADAssessmentsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StartADAssessmentResponse> StartADAssessmentAsync(StartADAssessmentRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateHybridADResponse> UpdateHybridADAsync(UpdateHybridADRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonDirectoryServiceConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonDirectoryServiceConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonDirectoryServiceConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonDirectoryServiceConfig to create AmazonDirectoryServiceClient");
            }

            return awsCredentials == null ? 
                    new AmazonDirectoryServiceClient(serviceClientConfig) :
                    new AmazonDirectoryServiceClient(awsCredentials, serviceClientConfig);
        }
