...
namespace Amazon.DirectoryServiceData.Internal
{
    ...
    public class AmazonDirectoryServiceDataAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonDirectoryServiceDataAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for DirectoryServiceData.
        /// </summary>
        public AmazonDirectoryServiceDataAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonDirectoryServiceDataAuthSchemeParameters
            {
    ...
    public class AmazonDirectoryServiceDataAuthSchemeResolver : IAuthSchemeResolver<AmazonDirectoryServiceDataAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonDirectoryServiceDataAuthSchemeParameters authParameters)
        {
