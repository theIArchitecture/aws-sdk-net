...
{
    /// <summary>
    /// RemoveGroupMember Request Marshaller
    /// </summary>       
    public class RemoveGroupMemberRequestMarshaller : IMarshaller<IRequest, RemoveGroupMemberRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RemoveGroupMemberRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RemoveGroupMemberRequest publicRequest)
        {
        ...
        private static RemoveGroupMemberRequestMarshaller _instance = new RemoveGroupMemberRequestMarshaller();        

        internal static RemoveGroupMemberRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveGroupMemberRequestMarshaller Instance
        {
            get
            {
                return _instance;
