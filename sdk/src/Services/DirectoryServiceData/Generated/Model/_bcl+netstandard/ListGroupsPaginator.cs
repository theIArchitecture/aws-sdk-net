...
namespace Amazon.DirectoryServiceData.Model
{
    ...
    internal sealed partial class ListGroupsPaginator : IPaginator<ListGroupsResponse>, IListGroupsPaginator
    {
        ...
        public IPaginatedEnumerable<GroupSummary> Groups => 
            new PaginatedResultKeyResponse<ListGroupsResponse, GroupSummary>(this, (i) => i.Groups ?? new List<GroupSummary>());

        internal ListGroupsPaginator(IAmazonDirectoryServiceData client, ListGroupsRequest request)
        {
            this._client = client;
