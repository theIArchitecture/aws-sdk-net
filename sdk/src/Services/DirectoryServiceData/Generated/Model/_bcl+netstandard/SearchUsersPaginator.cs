...
namespace Amazon.DirectoryServiceData.Model
{
    ...
    internal sealed partial class SearchUsersPaginator : IPaginator<SearchUsersResponse>, ISearchUsersPaginator
    {
        ...
        public IPaginatedEnumerable<User> Users => 
            new PaginatedResultKeyResponse<SearchUsersResponse, User>(this, (i) => i.Users ?? new List<User>());

        internal SearchUsersPaginator(IAmazonDirectoryServiceData client, SearchUsersRequest request)
        {
            this._client = client;
