...
namespace Amazon.DirectoryServiceData
{
    ...
    public partial interface IAmazonDirectoryServiceData : IAmazonService, IDisposable
    {
        ...
        Task<AddGroupMemberResponse> AddGroupMemberAsync(AddGroupMemberRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListGroupsForMemberResponse> ListGroupsForMemberAsync(ListGroupsForMemberRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<RemoveGroupMemberResponse> RemoveGroupMemberAsync(RemoveGroupMemberRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonDirectoryServiceDataConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonDirectoryServiceDataConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonDirectoryServiceDataConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonDirectoryServiceDataConfig to create AmazonDirectoryServiceDataClient");
            }

            return awsCredentials == null ? 
                    new AmazonDirectoryServiceDataClient(serviceClientConfig) :
                    new AmazonDirectoryServiceDataClient(awsCredentials, serviceClientConfig);
        }
