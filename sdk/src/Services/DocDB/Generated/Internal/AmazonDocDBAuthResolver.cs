...
namespace Amazon.DocDB.Internal
{
    ...
    public class AmazonDocDBAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonDocDBAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for DocDB.
        /// </summary>
        public AmazonDocDBAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonDocDBAuthSchemeParameters
            {
    ...
    public class AmazonDocDBAuthSchemeResolver : IAuthSchemeResolver<AmazonDocDBAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonDocDBAuthSchemeParameters authParameters)
        {
