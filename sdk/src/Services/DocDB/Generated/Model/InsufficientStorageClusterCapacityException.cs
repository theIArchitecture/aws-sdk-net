...
namespace Amazon.DocDB.Model
{
    ...
    public partial class InsufficientStorageClusterCapacityException : AmazonDocDBException
    {
        ...
        public InsufficientStorageClusterCapacityException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InsufficientStorageClusterCapacityException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
