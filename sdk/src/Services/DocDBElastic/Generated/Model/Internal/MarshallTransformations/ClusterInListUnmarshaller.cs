...
namespace Amazon.DocDBElastic.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ClusterInListUnmarshaller : IJsonUnmarshaller<ClusterInList, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ClusterInList Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
