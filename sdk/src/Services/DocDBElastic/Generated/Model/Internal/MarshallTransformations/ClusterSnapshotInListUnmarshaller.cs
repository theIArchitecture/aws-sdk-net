...
namespace Amazon.DocDBElastic.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ClusterSnapshotInListUnmarshaller : IJsonUnmarshaller<ClusterSnapshotInList, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ClusterSnapshotInList Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
