...
namespace Amazon.DocDBElastic.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListPendingMaintenanceActionsRequestMarshaller : IMarshaller<IRequest, ListPendingMaintenanceActionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListPendingMaintenanceActionsRequestMarshaller _instance = new ListPendingMaintenanceActionsRequestMarshaller();        

        internal static ListPendingMaintenanceActionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPendingMaintenanceActionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
