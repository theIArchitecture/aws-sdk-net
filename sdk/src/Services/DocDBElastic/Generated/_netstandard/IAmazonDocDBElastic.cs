...
namespace Amazon.DocDBElastic
{
    ...
    public partial interface IAmazonDocDBElastic : IAmazonService, IDisposable
    {
        ...
        Task<GetClusterSnapshotResponse> GetClusterSnapshotAsync(GetClusterSnapshotRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetPendingMaintenanceActionResponse> GetPendingMaintenanceActionAsync(GetPendingMaintenanceActionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListClusterSnapshotsResponse> ListClusterSnapshotsAsync(ListClusterSnapshotsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListPendingMaintenanceActionsResponse> ListPendingMaintenanceActionsAsync(ListPendingMaintenanceActionsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<RestoreClusterFromSnapshotResponse> RestoreClusterFromSnapshotAsync(RestoreClusterFromSnapshotRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StartClusterResponse> StartClusterAsync(StartClusterRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StopClusterResponse> StopClusterAsync(StopClusterRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonDocDBElasticConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonDocDBElasticConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonDocDBElasticConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonDocDBElasticConfig to create AmazonDocDBElasticClient");
            }

            return awsCredentials == null ? 
                    new AmazonDocDBElasticClient(serviceClientConfig) :
                    new AmazonDocDBElasticClient(awsCredentials, serviceClientConfig);
        }
