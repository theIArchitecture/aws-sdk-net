...
namespace Amazon.Drs.Internal
{
    ...
    public class AmazonDrsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonDrsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Drs.
        /// </summary>
        public AmazonDrsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonDrsAuthSchemeParameters
            {
    ...
    public class AmazonDrsAuthSchemeResolver : IAuthSchemeResolver<AmazonDrsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonDrsAuthSchemeParameters authParameters)
        {
