...
{
    /// <summary>
    /// Response Unmarshaller for CreateSourceNetwork operation
    /// </summary>  
    public class CreateSourceNetworkResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSourceNetworkResponse response = new CreateSourceNetworkResponse();
        ...
        private static CreateSourceNetworkResponseUnmarshaller _instance = new CreateSourceNetworkResponseUnmarshaller();        

        internal static CreateSourceNetworkResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSourceNetworkResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
