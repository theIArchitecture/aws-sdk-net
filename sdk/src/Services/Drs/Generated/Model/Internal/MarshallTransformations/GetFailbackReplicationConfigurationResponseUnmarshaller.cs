...
{
    /// <summary>
    /// Response Unmarshaller for GetFailbackReplicationConfiguration operation
    /// </summary>  
    public class GetFailbackReplicationConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetFailbackReplicationConfigurationResponse response = new GetFailbackReplicationConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("usePrivateIP", targetDepth))
                {
                    ...
                    response.UsePrivateIP = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetFailbackReplicationConfigurationResponseUnmarshaller _instance = new GetFailbackReplicationConfigurationResponseUnmarshaller();        

        internal static GetFailbackReplicationConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFailbackReplicationConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
