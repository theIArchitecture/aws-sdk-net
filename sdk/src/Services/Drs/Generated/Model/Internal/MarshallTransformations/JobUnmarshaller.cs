    ...
    public class JobUnmarshaller : IJsonUnmarshaller<Job, JsonUnmarshallerContext>
    {
        ...
        public Job Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ParticipatingResource, ParticipatingResourceUnmarshaller>(ParticipatingResourceUnmarshaller.Instance);
                    unmarshalledObject.ParticipatingResources = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
