...
namespace Amazon.Drs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PITPolicyRuleUnmarshaller : IJsonUnmarshaller<PITPolicyRule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PITPolicyRule Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.RetentionDuration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
