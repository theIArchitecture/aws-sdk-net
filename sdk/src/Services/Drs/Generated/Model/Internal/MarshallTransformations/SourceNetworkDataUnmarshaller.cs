...
namespace Amazon.Drs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SourceNetworkDataUnmarshaller : IJsonUnmarshaller<SourceNetworkData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SourceNetworkData Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SourceVpc = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TargetVpc = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
