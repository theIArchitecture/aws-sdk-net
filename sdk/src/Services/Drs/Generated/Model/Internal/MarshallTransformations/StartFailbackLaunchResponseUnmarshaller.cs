...
{
    /// <summary>
    /// Response Unmarshaller for StartFailbackLaunch operation
    /// </summary>  
    public class StartFailbackLaunchResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartFailbackLaunchResponse response = new StartFailbackLaunchResponse();
        ...
        private static StartFailbackLaunchResponseUnmarshaller _instance = new StartFailbackLaunchResponseUnmarshaller();        

        internal static StartFailbackLaunchResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartFailbackLaunchResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
