...
{
    /// <summary>
    /// Response Unmarshaller for StartRecovery operation
    /// </summary>  
    public class StartRecoveryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartRecoveryResponse response = new StartRecoveryResponse();
        ...
        private static StartRecoveryResponseUnmarshaller _instance = new StartRecoveryResponseUnmarshaller();        

        internal static StartRecoveryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartRecoveryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
