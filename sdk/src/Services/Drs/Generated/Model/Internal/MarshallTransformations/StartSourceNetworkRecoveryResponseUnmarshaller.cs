...
{
    /// <summary>
    /// Response Unmarshaller for StartSourceNetworkRecovery operation
    /// </summary>  
    public class StartSourceNetworkRecoveryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartSourceNetworkRecoveryResponse response = new StartSourceNetworkRecoveryResponse();
        ...
        private static StartSourceNetworkRecoveryResponseUnmarshaller _instance = new StartSourceNetworkRecoveryResponseUnmarshaller();        

        internal static StartSourceNetworkRecoveryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartSourceNetworkRecoveryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
