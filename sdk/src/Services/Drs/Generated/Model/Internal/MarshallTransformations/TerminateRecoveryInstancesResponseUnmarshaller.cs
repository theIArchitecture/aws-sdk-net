...
{
    /// <summary>
    /// Response Unmarshaller for TerminateRecoveryInstances operation
    /// </summary>  
    public class TerminateRecoveryInstancesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TerminateRecoveryInstancesResponse response = new TerminateRecoveryInstancesResponse();
        ...
        private static TerminateRecoveryInstancesResponseUnmarshaller _instance = new TerminateRecoveryInstancesResponseUnmarshaller();        

        internal static TerminateRecoveryInstancesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TerminateRecoveryInstancesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
