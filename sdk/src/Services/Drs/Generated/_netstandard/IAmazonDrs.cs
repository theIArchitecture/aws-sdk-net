...
namespace Amazon.Drs
{
    ...
    public partial interface IAmazonDrs : IAmazonService, IDisposable
    {
        ...
        Task<DeleteLaunchActionResponse> DeleteLaunchActionAsync(DeleteLaunchActionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListLaunchActionsResponse> ListLaunchActionsAsync(ListLaunchActionsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<PutLaunchActionResponse> PutLaunchActionAsync(PutLaunchActionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonDrsConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonDrsConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonDrsConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonDrsConfig to create AmazonDrsClient");
            }

            return awsCredentials == null ? 
                    new AmazonDrsClient(serviceClientConfig) :
                    new AmazonDrsClient(awsCredentials, serviceClientConfig);
        }
