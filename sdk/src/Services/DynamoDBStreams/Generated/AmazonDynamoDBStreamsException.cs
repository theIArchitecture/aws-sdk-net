...
namespace Amazon.DynamoDBStreams
{
    ...
    [Serializable]
#endif
    public partial class AmazonDynamoDBStreamsException : AmazonServiceException
    {
        /// <summary>
        ...
        public AmazonDynamoDBStreamsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonDynamoDBStreamsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
...
#if !NETSTANDARD
        /// <summary>
        /// Constructs a new instance of the AmazonDynamoDBStreamsException class with serialized data.
        /// </summary>
