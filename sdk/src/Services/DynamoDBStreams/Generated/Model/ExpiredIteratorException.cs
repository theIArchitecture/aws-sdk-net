...
namespace Amazon.DynamoDBStreams.Model
{
    ...
    [Serializable]
    #endif
    public partial class ExpiredIteratorException : AmazonDynamoDBStreamsException
    {
        ...
        public ExpiredIteratorException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ExpiredIteratorException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
