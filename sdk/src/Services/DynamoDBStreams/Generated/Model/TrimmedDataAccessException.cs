...
namespace Amazon.DynamoDBStreams.Model
{
    ...
    [Serializable]
    #endif
    public partial class TrimmedDataAccessException : AmazonDynamoDBStreamsException
    {
        ...
        public TrimmedDataAccessException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TrimmedDataAccessException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
