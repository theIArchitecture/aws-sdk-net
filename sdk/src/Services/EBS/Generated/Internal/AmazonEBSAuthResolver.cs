...
namespace Amazon.EBS.Internal
{
    ...
    public class AmazonEBSAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonEBSAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for EBS.
        /// </summary>
        public AmazonEBSAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonEBSAuthSchemeParameters
            {
    ...
    public class AmazonEBSAuthSchemeResolver : IAuthSchemeResolver<AmazonEBSAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonEBSAuthSchemeParameters authParameters)
        {
