    ...
    public class ListChangedBlocksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ChangedBlock, ChangedBlockUnmarshaller>(ChangedBlockUnmarshaller.Instance);
                    response.ChangedBlocks = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
