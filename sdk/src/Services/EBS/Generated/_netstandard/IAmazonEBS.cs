...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonEBSConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonEBSConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonEBSConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonEBSConfig to create AmazonEBSClient");
            }

            return awsCredentials == null ? 
                    new AmazonEBSClient(serviceClientConfig) :
                    new AmazonEBSClient(awsCredentials, serviceClientConfig);
        }
