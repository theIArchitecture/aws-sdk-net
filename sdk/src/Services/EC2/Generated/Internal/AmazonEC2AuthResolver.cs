...
namespace Amazon.EC2.Internal
{
    ...
    public class AmazonEC2AuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonEC2AuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for EC2.
        /// </summary>
        public AmazonEC2AuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonEC2AuthSchemeParameters
            {
    ...
    public class AmazonEC2AuthSchemeResolver : IAuthSchemeResolver<AmazonEC2AuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonEC2AuthSchemeParameters authParameters)
        {
