...
namespace Amazon.EC2.Model
{
    ...
    /// </summary>
    public partial class BaselineEbsBandwidthMbps
    {
        private int? _max;
        private int? _min;
        ...
        /// <para>
        /// The maximum baseline bandwidth, in Mbps. If this parameter is not specified, there
        /// is no maximum limit.
        /// </para>
        /// </summary>
        public int? Max
        ...
        /// <para>
        /// The minimum baseline bandwidth, in Mbps. If this parameter is not specified, there
        /// is no minimum limit.
        /// </para>
        /// </summary>
        public int? Min
