...
{
    /// <summary>
    /// This is the response object from the DescribeDeclarativePoliciesReports operation.
    /// </summary>
    public partial class DescribeDeclarativePoliciesReportsResponse : AmazonWebServiceResponse
    {
        private string _nextToken;
        private List<DeclarativePoliciesReport> _reports = AWSConfigs.InitializeCollections ? new List<DeclarativePoliciesReport>() : null;
        ...
        /// </summary>
        public List<DeclarativePoliciesReport> Reports
        {
