...
{
    /// <summary>
    /// Container for the parameters to the DescribeRouteServerEndpoints operation.
    ...
    /// </para>
    /// </summary>
    public partial class DescribeRouteServerEndpointsRequest : AmazonEC2Request
    {
        private bool? _dryRun;
        private List<Filter> _filters = AWSConfigs.InitializeCollections ? new List<Filter>() : null;
        private int? _maxResults;
        private string _nextToken;
        private List<string> _routeServerEndpointIds = AWSConfigs.InitializeCollections ? new List<string>() : null;
        ...
        /// <summary>
        /// Gets and sets the property RouteServerEndpointIds. 
        /// <para>
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<string> RouteServerEndpointIds
        {
            get { return this._routeServerEndpointIds; }
            set { this._routeServerEndpointIds = value; }
        }

        // Check to see if RouteServerEndpointIds property is set
        internal bool IsSetRouteServerEndpointIds()
        {
            return this._routeServerEndpointIds != null && (this._routeServerEndpointIds.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
