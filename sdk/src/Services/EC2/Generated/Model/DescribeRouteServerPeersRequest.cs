...
{
    /// <summary>
    /// Container for the parameters to the DescribeRouteServerPeers operation.
    ...
    /// </para>
    /// </summary>
    public partial class DescribeRouteServerPeersRequest : AmazonEC2Request
    {
        private bool? _dryRun;
        private List<Filter> _filters = AWSConfigs.InitializeCollections ? new List<Filter>() : null;
        private int? _maxResults;
        private string _nextToken;
        private List<string> _routeServerPeerIds = AWSConfigs.InitializeCollections ? new List<string>() : null;
        ...
        /// <summary>
        /// Gets and sets the property RouteServerPeerIds. 
        /// <para>
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<string> RouteServerPeerIds
        {
            get { return this._routeServerPeerIds; }
            set { this._routeServerPeerIds = value; }
        }

        // Check to see if RouteServerPeerIds property is set
        internal bool IsSetRouteServerPeerIds()
        {
            return this._routeServerPeerIds != null && (this._routeServerPeerIds.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
