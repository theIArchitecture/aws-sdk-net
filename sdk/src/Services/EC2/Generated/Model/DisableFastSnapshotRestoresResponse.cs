...
namespace Amazon.EC2.Model
{
    ...
    {
        private List<DisableFastSnapshotRestoreSuccessItem> _successful = AWSConfigs.InitializeCollections ? new List<DisableFastSnapshotRestoreSuccessItem>() : null;
        private List<DisableFastSnapshotRestoreErrorItem> _unsuccessful = AWSConfigs.InitializeCollections ? new List<DisableFastSnapshotRestoreErrorItem>() : null;
