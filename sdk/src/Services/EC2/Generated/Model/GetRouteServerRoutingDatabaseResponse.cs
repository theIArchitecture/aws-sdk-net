...
{
    /// <summary>
    /// This is the response object from the GetRouteServerRoutingDatabase operation.
    /// </summary>
    public partial class GetRouteServerRoutingDatabaseResponse : AmazonWebServiceResponse
    {
        private bool? _areRoutesPersisted;
        private string _nextToken;
        private List<RouteServerRoute> _routes = AWSConfigs.InitializeCollections ? new List<RouteServerRoute>() : null;

        /// <summary>
        /// Gets and sets the property AreRoutesPersisted. 
        /// <para>
        ...
        // Check to see if AreRoutesPersisted property is set
        internal bool IsSetAreRoutesPersisted()
        {
            return this._areRoutesPersisted.HasValue; 
        }
        ...
        /// </summary>
        public List<RouteServerRoute> Routes
        {
