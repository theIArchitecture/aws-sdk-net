...
{
    /// <summary>
    /// AllocateIpamPoolCidr Request Marshaller
    /// </summary>       
    public class AllocateIpamPoolCidrRequestMarshaller : IMarshaller<IRequest, AllocateIpamPoolCidrRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AllocateIpamPoolCidrRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AllocateIpamPoolCidrRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "AllocateIpamPoolCidr");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AllocateIpamPoolCidrRequestMarshaller Instance
        {
            get
            {
                return _instance;
