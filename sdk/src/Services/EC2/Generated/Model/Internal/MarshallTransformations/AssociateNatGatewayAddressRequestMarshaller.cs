...
{
    /// <summary>
    /// AssociateNatGatewayAddress Request Marshaller
    /// </summary>       
    public class AssociateNatGatewayAddressRequestMarshaller : IMarshaller<IRequest, AssociateNatGatewayAddressRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AssociateNatGatewayAddressRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AssociateNatGatewayAddressRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "AssociateNatGatewayAddress");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateNatGatewayAddressRequestMarshaller Instance
        {
            get
            {
                return _instance;
