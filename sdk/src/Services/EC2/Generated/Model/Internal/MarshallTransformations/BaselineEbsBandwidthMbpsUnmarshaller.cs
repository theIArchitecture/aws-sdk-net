...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class BaselineEbsBandwidthMbpsUnmarshaller : IXmlUnmarshaller<BaselineEbsBandwidthMbps, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public BaselineEbsBandwidthMbps Unmarshall(XmlUnmarshallerContext context)
        {
            BaselineEbsBandwidthMbps unmarshalledObject = new BaselineEbsBandwidthMbps();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BaselineEbsBandwidthMbpsUnmarshaller Instance
        {
            get
            {
                return _instance;
