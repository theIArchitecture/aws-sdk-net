...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class BlockPublicAccessStatesUnmarshaller : IXmlUnmarshaller<BlockPublicAccessStates, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public BlockPublicAccessStates Unmarshall(XmlUnmarshallerContext context)
        {
            BlockPublicAccessStates unmarshalledObject = new BlockPublicAccessStates();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BlockPublicAccessStatesUnmarshaller Instance
        {
            get
            {
                return _instance;
