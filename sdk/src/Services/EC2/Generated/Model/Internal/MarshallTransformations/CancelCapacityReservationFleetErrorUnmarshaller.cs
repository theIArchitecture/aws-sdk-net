...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class CancelCapacityReservationFleetErrorUnmarshaller : IXmlUnmarshaller<CancelCapacityReservationFleetError, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public CancelCapacityReservationFleetError Unmarshall(XmlUnmarshallerContext context)
        {
            CancelCapacityReservationFleetError unmarshalledObject = new CancelCapacityReservationFleetError();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelCapacityReservationFleetErrorUnmarshaller Instance
        {
            get
            {
                return _instance;
