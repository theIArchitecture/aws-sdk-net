...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class ClientRouteEnforcementResponseOptionsUnmarshaller : IXmlUnmarshaller<ClientRouteEnforcementResponseOptions, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ClientRouteEnforcementResponseOptions Unmarshall(XmlUnmarshallerContext context)
        {
            ClientRouteEnforcementResponseOptions unmarshalledObject = new ClientRouteEnforcementResponseOptions();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ClientRouteEnforcementResponseOptionsUnmarshaller Instance
        {
            get
            {
                return _instance;
