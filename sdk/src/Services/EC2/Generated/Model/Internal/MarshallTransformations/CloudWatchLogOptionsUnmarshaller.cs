...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class CloudWatchLogOptionsUnmarshaller : IXmlUnmarshaller<CloudWatchLogOptions, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public CloudWatchLogOptions Unmarshall(XmlUnmarshallerContext context)
        {
            CloudWatchLogOptions unmarshalledObject = new CloudWatchLogOptions();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("logEnabled", targetDepth))
                    {
                        ...
                        unmarshalledObject.LogEnabled = unmarshaller.Unmarshall(context);
                        continue;
                    }
                    ...
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.LogOutputFormat = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CloudWatchLogOptionsUnmarshaller Instance
        {
            get
            {
                return _instance;
