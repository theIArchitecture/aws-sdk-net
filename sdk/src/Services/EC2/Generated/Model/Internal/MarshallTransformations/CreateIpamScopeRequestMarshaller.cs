...
{
    /// <summary>
    /// CreateIpamScope Request Marshaller
    /// </summary>       
    public class CreateIpamScopeRequestMarshaller : IMarshaller<IRequest, CreateIpamScopeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateIpamScopeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateIpamScopeRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "CreateIpamScope");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateIpamScopeRequestMarshaller Instance
        {
            get
            {
                return _instance;
