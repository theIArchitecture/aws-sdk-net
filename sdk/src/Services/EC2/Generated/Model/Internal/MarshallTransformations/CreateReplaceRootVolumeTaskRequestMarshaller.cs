...
{
    /// <summary>
    /// CreateReplaceRootVolumeTask Request Marshaller
    /// </summary>       
    public class CreateReplaceRootVolumeTaskRequestMarshaller : IMarshaller<IRequest, CreateReplaceRootVolumeTaskRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateReplaceRootVolumeTaskRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateReplaceRootVolumeTaskRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "CreateReplaceRootVolumeTask");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateReplaceRootVolumeTaskRequestMarshaller Instance
        {
            get
            {
                return _instance;
