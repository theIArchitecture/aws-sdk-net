...
{
    /// <summary>
    /// CreateStoreImageTask Request Marshaller
    /// </summary>       
    public class CreateStoreImageTaskRequestMarshaller : IMarshaller<IRequest, CreateStoreImageTaskRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateStoreImageTaskRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateStoreImageTaskRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "CreateStoreImageTask");
            ...
            return request;
                    ...
                    private static CreateStoreImageTaskRequestMarshaller _instance = new CreateStoreImageTaskRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateStoreImageTaskRequestMarshaller Instance
        {
            get
            {
                return _instance;
