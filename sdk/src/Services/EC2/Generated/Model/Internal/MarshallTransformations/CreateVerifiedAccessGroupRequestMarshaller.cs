...
{
    /// <summary>
    /// CreateVerifiedAccessGroup Request Marshaller
    /// </summary>       
    public class CreateVerifiedAccessGroupRequestMarshaller : IMarshaller<IRequest, CreateVerifiedAccessGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateVerifiedAccessGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateVerifiedAccessGroupRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "CreateVerifiedAccessGroup");
            ...
            return request;
                    ...
                    private static CreateVerifiedAccessGroupRequestMarshaller _instance = new CreateVerifiedAccessGroupRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateVerifiedAccessGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
