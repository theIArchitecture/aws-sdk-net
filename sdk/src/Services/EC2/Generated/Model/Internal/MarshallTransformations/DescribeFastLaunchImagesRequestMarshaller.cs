...
{
    /// <summary>
    /// DescribeFastLaunchImages Request Marshaller
    /// </summary>       
    public class DescribeFastLaunchImagesRequestMarshaller : IMarshaller<IRequest, DescribeFastLaunchImagesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeFastLaunchImagesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeFastLaunchImagesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DescribeFastLaunchImages");
            ...
            return request;
                    ...
                    private static DescribeFastLaunchImagesRequestMarshaller _instance = new DescribeFastLaunchImagesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeFastLaunchImagesRequestMarshaller Instance
        {
            get
            {
                return _instance;
