...
{
    /// <summary>
    /// DescribeInstanceTopology Request Marshaller
    /// </summary>       
    public class DescribeInstanceTopologyRequestMarshaller : IMarshaller<IRequest, DescribeInstanceTopologyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeInstanceTopologyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeInstanceTopologyRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DescribeInstanceTopology");
            ...
            return request;
                    ...
                    private static DescribeInstanceTopologyRequestMarshaller _instance = new DescribeInstanceTopologyRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeInstanceTopologyRequestMarshaller Instance
        {
            get
            {
                return _instance;
