...
{
    /// <summary>
    /// DescribeMacHosts Request Marshaller
    /// </summary>       
    public class DescribeMacHostsRequestMarshaller : IMarshaller<IRequest, DescribeMacHostsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeMacHostsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeMacHostsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DescribeMacHosts");
            ...
            return request;
                    ...
                    private static DescribeMacHostsRequestMarshaller _instance = new DescribeMacHostsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeMacHostsRequestMarshaller Instance
        {
            get
            {
                return _instance;
