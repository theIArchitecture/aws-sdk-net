...
{
    /// <summary>
    /// DescribeStoreImageTasks Request Marshaller
    /// </summary>       
    public class DescribeStoreImageTasksRequestMarshaller : IMarshaller<IRequest, DescribeStoreImageTasksRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeStoreImageTasksRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeStoreImageTasksRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DescribeStoreImageTasks");
            ...
            return request;
                    ...
                    private static DescribeStoreImageTasksRequestMarshaller _instance = new DescribeStoreImageTasksRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeStoreImageTasksRequestMarshaller Instance
        {
            get
            {
                return _instance;
