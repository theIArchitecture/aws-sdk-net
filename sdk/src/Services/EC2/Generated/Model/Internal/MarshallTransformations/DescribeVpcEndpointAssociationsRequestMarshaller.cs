...
{
    /// <summary>
    /// DescribeVpcEndpointAssociations Request Marshaller
    /// </summary>       
    public class DescribeVpcEndpointAssociationsRequestMarshaller : IMarshaller<IRequest, DescribeVpcEndpointAssociationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeVpcEndpointAssociationsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeVpcEndpointAssociationsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DescribeVpcEndpointAssociations");
            ...
            return request;
                    ...
                    private static DescribeVpcEndpointAssociationsRequestMarshaller _instance = new DescribeVpcEndpointAssociationsRequestMarshaller();        

        internal static DescribeVpcEndpointAssociationsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeVpcEndpointAssociationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
