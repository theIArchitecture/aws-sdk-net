...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class DestinationOptionsResponseUnmarshaller : IXmlUnmarshaller<DestinationOptionsResponse, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public DestinationOptionsResponse Unmarshall(XmlUnmarshallerContext context)
        {
            DestinationOptionsResponse unmarshalledObject = new DestinationOptionsResponse();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DestinationOptionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
