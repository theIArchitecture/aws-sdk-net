...
{
    /// <summary>
    /// DisableAwsNetworkPerformanceMetricSubscription Request Marshaller
    /// </summary>       
    public class DisableAwsNetworkPerformanceMetricSubscriptionRequestMarshaller : IMarshaller<IRequest, DisableAwsNetworkPerformanceMetricSubscriptionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DisableAwsNetworkPerformanceMetricSubscriptionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DisableAwsNetworkPerformanceMetricSubscriptionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DisableAwsNetworkPerformanceMetricSubscription");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisableAwsNetworkPerformanceMetricSubscriptionRequestMarshaller Instance
        {
            get
            {
                return _instance;
