...
{
    /// <summary>
    /// Response Unmarshaller for DisableFastLaunch operation
    /// </summary>  
    public class DisableFastLaunchResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisableFastLaunchResponse response = new DisableFastLaunchResponse();
        ...
        private static DisableFastLaunchResponseUnmarshaller _instance = new DisableFastLaunchResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisableFastLaunchResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
