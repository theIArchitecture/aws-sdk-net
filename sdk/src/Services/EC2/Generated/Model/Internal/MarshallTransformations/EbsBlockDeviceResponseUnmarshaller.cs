...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class EbsBlockDeviceResponseUnmarshaller : IXmlUnmarshaller<EbsBlockDeviceResponse, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public EbsBlockDeviceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            EbsBlockDeviceResponse unmarshalledObject = new EbsBlockDeviceResponse();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EbsBlockDeviceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
