...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class EbsStatusDetailsUnmarshaller : IXmlUnmarshaller<EbsStatusDetails, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public EbsStatusDetails Unmarshall(XmlUnmarshallerContext context)
        {
            EbsStatusDetails unmarshalledObject = new EbsStatusDetails();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EbsStatusDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
