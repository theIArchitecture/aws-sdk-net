...
{
    /// <summary>
    /// EnableFastLaunch Request Marshaller
    /// </summary>       
    public class EnableFastLaunchRequestMarshaller : IMarshaller<IRequest, EnableFastLaunchRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((EnableFastLaunchRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(EnableFastLaunchRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "EnableFastLaunch");
            ...
            return request;
                    ...
                    private static EnableFastLaunchRequestMarshaller _instance = new EnableFastLaunchRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EnableFastLaunchRequestMarshaller Instance
        {
            get
            {
                return _instance;
