...
{
    /// <summary>
    /// GetIpamAddressHistory Request Marshaller
    /// </summary>       
    public class GetIpamAddressHistoryRequestMarshaller : IMarshaller<IRequest, GetIpamAddressHistoryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetIpamAddressHistoryRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetIpamAddressHistoryRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "GetIpamAddressHistory");
            ...
            return request;
                    ...
                    private static GetIpamAddressHistoryRequestMarshaller _instance = new GetIpamAddressHistoryRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetIpamAddressHistoryRequestMarshaller Instance
        {
            get
            {
                return _instance;
