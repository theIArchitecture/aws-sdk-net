...
{
    /// <summary>
    /// GetIpamDiscoveredAccounts Request Marshaller
    /// </summary>       
    public class GetIpamDiscoveredAccountsRequestMarshaller : IMarshaller<IRequest, GetIpamDiscoveredAccountsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetIpamDiscoveredAccountsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetIpamDiscoveredAccountsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "GetIpamDiscoveredAccounts");
            request.Parameters.Add("Version", "2016-11-15");

            if(publicRequest != null)
            {
                if(publicRequest.IsSetDiscoveryRegion())
                {
                    request.Parameters.Add("DiscoveryRegion", StringUtils.FromString(publicRequest.DiscoveryRegion));
                }
            ...
            return request;
                    ...
                    private static GetIpamDiscoveredAccountsRequestMarshaller _instance = new GetIpamDiscoveredAccountsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetIpamDiscoveredAccountsRequestMarshaller Instance
        {
            get
            {
                return _instance;
