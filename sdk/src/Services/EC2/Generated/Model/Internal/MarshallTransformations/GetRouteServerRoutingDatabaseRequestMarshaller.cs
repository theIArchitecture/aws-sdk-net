...
{
    /// <summary>
    /// GetRouteServerRoutingDatabase Request Marshaller
    /// </summary>       
    public class GetRouteServerRoutingDatabaseRequestMarshaller : IMarshaller<IRequest, GetRouteServerRoutingDatabaseRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetRouteServerRoutingDatabaseRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetRouteServerRoutingDatabaseRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "GetRouteServerRoutingDatabase");
        ...
        internal static GetRouteServerRoutingDatabaseRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRouteServerRoutingDatabaseRequestMarshaller Instance
        {
            get
            {
                return _instance;
