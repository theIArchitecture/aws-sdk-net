...
{
    /// <summary>
    /// GetSecurityGroupsForVpc Request Marshaller
    /// </summary>       
    public class GetSecurityGroupsForVpcRequestMarshaller : IMarshaller<IRequest, GetSecurityGroupsForVpcRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetSecurityGroupsForVpcRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetSecurityGroupsForVpcRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "GetSecurityGroupsForVpc");
            ...
            return request;
                    ...
                    private static GetSecurityGroupsForVpcRequestMarshaller _instance = new GetSecurityGroupsForVpcRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSecurityGroupsForVpcRequestMarshaller Instance
        {
            get
            {
                return _instance;
