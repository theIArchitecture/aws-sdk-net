...
{
    /// <summary>
    /// GetSubnetCidrReservations Request Marshaller
    /// </summary>       
    public class GetSubnetCidrReservationsRequestMarshaller : IMarshaller<IRequest, GetSubnetCidrReservationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetSubnetCidrReservationsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetSubnetCidrReservationsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "GetSubnetCidrReservations");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSubnetCidrReservationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
