...
{
    /// <summary>
    /// GetTransitGatewayPolicyTableEntries Request Marshaller
    /// </summary>       
    public class GetTransitGatewayPolicyTableEntriesRequestMarshaller : IMarshaller<IRequest, GetTransitGatewayPolicyTableEntriesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetTransitGatewayPolicyTableEntriesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetTransitGatewayPolicyTableEntriesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "GetTransitGatewayPolicyTableEntries");
            ...
            return request;
                    ...
                    private static GetTransitGatewayPolicyTableEntriesRequestMarshaller _instance = new GetTransitGatewayPolicyTableEntriesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTransitGatewayPolicyTableEntriesRequestMarshaller Instance
        {
            get
            {
                return _instance;
