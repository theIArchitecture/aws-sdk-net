...
{
    /// <summary>
    /// Response Unmarshaller for ImageMetadata Object
    /// </summary>  
    public class ImageMetadataUnmarshaller : IXmlUnmarshaller<ImageMetadata, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public ImageMetadata Unmarshall(XmlUnmarshallerContext context)
        {
            ImageMetadata unmarshalledObject = new ImageMetadata();
        ...
        private static ImageMetadataUnmarshaller _instance = new ImageMetadataUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ImageMetadataUnmarshaller Instance
        {
            get
            {
                return _instance;
