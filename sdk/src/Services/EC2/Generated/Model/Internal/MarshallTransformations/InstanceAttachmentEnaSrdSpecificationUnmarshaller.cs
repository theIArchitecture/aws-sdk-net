...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class InstanceAttachmentEnaSrdSpecificationUnmarshaller : IXmlUnmarshaller<InstanceAttachmentEnaSrdSpecification, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public InstanceAttachmentEnaSrdSpecification Unmarshall(XmlUnmarshallerContext context)
        {
            InstanceAttachmentEnaSrdSpecification unmarshalledObject = new InstanceAttachmentEnaSrdSpecification();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = InstanceAttachmentEnaSrdUdpSpecificationUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InstanceAttachmentEnaSrdSpecificationUnmarshaller Instance
        {
            get
            {
                return _instance;
