...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class InstanceEventWindowStateChangeUnmarshaller : IXmlUnmarshaller<InstanceEventWindowStateChange, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public InstanceEventWindowStateChange Unmarshall(XmlUnmarshallerContext context)
        {
            InstanceEventWindowStateChange unmarshalledObject = new InstanceEventWindowStateChange();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InstanceEventWindowStateChangeUnmarshaller Instance
        {
            get
            {
                return _instance;
