...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class InstanceMaintenanceOptionsUnmarshaller : IXmlUnmarshaller<InstanceMaintenanceOptions, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public InstanceMaintenanceOptions Unmarshall(XmlUnmarshallerContext context)
        {
            InstanceMaintenanceOptions unmarshalledObject = new InstanceMaintenanceOptions();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InstanceMaintenanceOptionsUnmarshaller Instance
        {
            get
            {
                return _instance;
