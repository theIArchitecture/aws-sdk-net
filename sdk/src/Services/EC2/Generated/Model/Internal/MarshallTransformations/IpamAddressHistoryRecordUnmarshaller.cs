...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class IpamAddressHistoryRecordUnmarshaller : IXmlUnmarshaller<IpamAddressHistoryRecord, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public IpamAddressHistoryRecord Unmarshall(XmlUnmarshallerContext context)
        {
            IpamAddressHistoryRecord unmarshalledObject = new IpamAddressHistoryRecord();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.ResourceComplianceStatus = unmarshaller.Unmarshall(context);
                        continue;
                    }
                    ...
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.ResourceOverlapStatus = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static IpamAddressHistoryRecordUnmarshaller Instance
        {
            get
            {
                return _instance;
