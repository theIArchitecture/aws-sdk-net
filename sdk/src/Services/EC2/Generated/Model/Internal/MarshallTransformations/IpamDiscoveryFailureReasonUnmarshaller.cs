...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class IpamDiscoveryFailureReasonUnmarshaller : IXmlUnmarshaller<IpamDiscoveryFailureReason, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public IpamDiscoveryFailureReason Unmarshall(XmlUnmarshallerContext context)
        {
            IpamDiscoveryFailureReason unmarshalledObject = new IpamDiscoveryFailureReason();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static IpamDiscoveryFailureReasonUnmarshaller Instance
        {
            get
            {
                return _instance;
