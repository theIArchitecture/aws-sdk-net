...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class IpamPublicAddressTagsUnmarshaller : IXmlUnmarshaller<IpamPublicAddressTags, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public IpamPublicAddressTags Unmarshall(XmlUnmarshallerContext context)
        {
            IpamPublicAddressTags unmarshalledObject = new IpamPublicAddressTags();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static IpamPublicAddressTagsUnmarshaller Instance
        {
            get
            {
                return _instance;
