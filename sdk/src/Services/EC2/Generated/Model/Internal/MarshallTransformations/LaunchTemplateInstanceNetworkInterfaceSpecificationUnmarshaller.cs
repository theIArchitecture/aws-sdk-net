...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LaunchTemplateInstanceNetworkInterfaceSpecificationUnmarshaller : IXmlUnmarshaller<LaunchTemplateInstanceNetworkInterfaceSpecification, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        public LaunchTemplateInstanceNetworkInterfaceSpecification Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = LaunchTemplateEnaSrdSpecificationUnmarshaller.Instance;
