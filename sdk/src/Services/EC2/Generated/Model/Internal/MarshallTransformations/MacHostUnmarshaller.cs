...
{
    /// <summary>
    /// Response Unmarshaller for MacHost Object
    /// </summary>  
    public class MacHostUnmarshaller : IXmlUnmarshaller<MacHost, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public MacHost Unmarshall(XmlUnmarshallerContext context)
        {
            MacHost unmarshalledObject = new MacHost();
        ...
        private static MacHostUnmarshaller _instance = new MacHostUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static MacHostUnmarshaller Instance
        {
            get
            {
                return _instance;
