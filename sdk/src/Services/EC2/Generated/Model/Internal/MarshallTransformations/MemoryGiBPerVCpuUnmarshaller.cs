...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class MemoryGiBPerVCpuUnmarshaller : IXmlUnmarshaller<MemoryGiBPerVCpu, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public MemoryGiBPerVCpu Unmarshall(XmlUnmarshallerContext context)
        {
            MemoryGiBPerVCpu unmarshalledObject = new MemoryGiBPerVCpu();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static MemoryGiBPerVCpuUnmarshaller Instance
        {
            get
            {
                return _instance;
