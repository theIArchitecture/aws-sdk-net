...
{
    /// <summary>
    /// ModifyVerifiedAccessEndpointPolicy Request Marshaller
    /// </summary>       
    public class ModifyVerifiedAccessEndpointPolicyRequestMarshaller : IMarshaller<IRequest, ModifyVerifiedAccessEndpointPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ModifyVerifiedAccessEndpointPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ModifyVerifiedAccessEndpointPolicyRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "ModifyVerifiedAccessEndpointPolicy");
            ...
            return request;
                    ...
                    private static ModifyVerifiedAccessEndpointPolicyRequestMarshaller _instance = new ModifyVerifiedAccessEndpointPolicyRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyVerifiedAccessEndpointPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
