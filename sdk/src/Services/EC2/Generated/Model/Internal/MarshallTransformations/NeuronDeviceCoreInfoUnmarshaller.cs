...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class NeuronDeviceCoreInfoUnmarshaller : IXmlUnmarshaller<NeuronDeviceCoreInfo, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public NeuronDeviceCoreInfo Unmarshall(XmlUnmarshallerContext context)
        {
            NeuronDeviceCoreInfo unmarshalledObject = new NeuronDeviceCoreInfo();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static NeuronDeviceCoreInfoUnmarshaller Instance
        {
            get
            {
                return _instance;
