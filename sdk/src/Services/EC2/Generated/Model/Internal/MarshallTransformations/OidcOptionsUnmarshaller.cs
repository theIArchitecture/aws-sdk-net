...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class OidcOptionsUnmarshaller : IXmlUnmarshaller<OidcOptions, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public OidcOptions Unmarshall(XmlUnmarshallerContext context)
        {
            OidcOptions unmarshalledObject = new OidcOptions();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static OidcOptionsUnmarshaller Instance
        {
            get
            {
                return _instance;
