...
{
    /// <summary>
    /// Response Unmarshaller for PacketHeaderStatement Object
    /// </summary>  
    public class PacketHeaderStatementUnmarshaller : IXmlUnmarshaller<PacketHeaderStatement, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public PacketHeaderStatement Unmarshall(XmlUnmarshallerContext context)
        {
            PacketHeaderStatement unmarshalledObject = new PacketHeaderStatement();
        ...
        private static PacketHeaderStatementUnmarshaller _instance = new PacketHeaderStatementUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PacketHeaderStatementUnmarshaller Instance
        {
            get
            {
                return _instance;
