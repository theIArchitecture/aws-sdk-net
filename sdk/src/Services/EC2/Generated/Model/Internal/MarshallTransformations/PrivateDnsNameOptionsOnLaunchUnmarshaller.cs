...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class PrivateDnsNameOptionsOnLaunchUnmarshaller : IXmlUnmarshaller<PrivateDnsNameOptionsOnLaunch, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public PrivateDnsNameOptionsOnLaunch Unmarshall(XmlUnmarshallerContext context)
        {
            PrivateDnsNameOptionsOnLaunch unmarshalledObject = new PrivateDnsNameOptionsOnLaunch();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PrivateDnsNameOptionsOnLaunchUnmarshaller Instance
        {
            get
            {
                return _instance;
