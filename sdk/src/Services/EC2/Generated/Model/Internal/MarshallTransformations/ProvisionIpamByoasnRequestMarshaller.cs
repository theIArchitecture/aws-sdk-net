...
{
    /// <summary>
    /// ProvisionIpamByoasn Request Marshaller
    /// </summary>       
    public class ProvisionIpamByoasnRequestMarshaller : IMarshaller<IRequest, ProvisionIpamByoasnRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ProvisionIpamByoasnRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ProvisionIpamByoasnRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "ProvisionIpamByoasn");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ProvisionIpamByoasnRequestMarshaller Instance
        {
            get
            {
                return _instance;
