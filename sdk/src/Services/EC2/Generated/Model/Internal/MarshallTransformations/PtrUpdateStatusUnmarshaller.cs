...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class PtrUpdateStatusUnmarshaller : IXmlUnmarshaller<PtrUpdateStatus, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public PtrUpdateStatus Unmarshall(XmlUnmarshallerContext context)
        {
            PtrUpdateStatus unmarshalledObject = new PtrUpdateStatus();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PtrUpdateStatusUnmarshaller Instance
        {
            get
            {
                return _instance;
