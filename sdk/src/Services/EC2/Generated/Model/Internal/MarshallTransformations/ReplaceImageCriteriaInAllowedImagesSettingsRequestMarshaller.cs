...
{
    /// <summary>
    /// ReplaceImageCriteriaInAllowedImagesSettings Request Marshaller
    /// </summary>       
    public class ReplaceImageCriteriaInAllowedImagesSettingsRequestMarshaller : IMarshaller<IRequest, ReplaceImageCriteriaInAllowedImagesSettingsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ReplaceImageCriteriaInAllowedImagesSettingsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ReplaceImageCriteriaInAllowedImagesSettingsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "ReplaceImageCriteriaInAllowedImagesSettings");
            ...
            return request;
                    ...
                    private static ReplaceImageCriteriaInAllowedImagesSettingsRequestMarshaller _instance = new ReplaceImageCriteriaInAllowedImagesSettingsRequestMarshaller();        

        internal static ReplaceImageCriteriaInAllowedImagesSettingsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ReplaceImageCriteriaInAllowedImagesSettingsRequestMarshaller Instance
        {
            get
            {
                return _instance;
