...
{
    /// <summary>
    /// RestoreSnapshotTier Request Marshaller
    /// </summary>       
    public class RestoreSnapshotTierRequestMarshaller : IMarshaller<IRequest, RestoreSnapshotTierRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RestoreSnapshotTierRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RestoreSnapshotTierRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "RestoreSnapshotTier");
            ...
            if(publicRequest != null)
            {
                ...
                if(publicRequest.IsSetPermanentRestore())
                {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RestoreSnapshotTierRequestMarshaller Instance
        {
            get
            {
                return _instance;
