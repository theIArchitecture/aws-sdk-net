...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class RouteServerBgpOptionsUnmarshaller : IXmlUnmarshaller<RouteServerBgpOptions, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public RouteServerBgpOptions Unmarshall(XmlUnmarshallerContext context)
        {
            RouteServerBgpOptions unmarshalledObject = new RouteServerBgpOptions();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("peerLivenessDetection", targetDepth))
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.PeerLivenessDetection = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RouteServerBgpOptionsUnmarshaller Instance
        {
            get
            {
                return _instance;
