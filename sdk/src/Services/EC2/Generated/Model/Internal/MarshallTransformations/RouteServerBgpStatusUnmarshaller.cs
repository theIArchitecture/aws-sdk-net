...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class RouteServerBgpStatusUnmarshaller : IXmlUnmarshaller<RouteServerBgpStatus, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public RouteServerBgpStatus Unmarshall(XmlUnmarshallerContext context)
        {
            RouteServerBgpStatus unmarshalledObject = new RouteServerBgpStatus();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RouteServerBgpStatusUnmarshaller Instance
        {
            get
            {
                return _instance;
