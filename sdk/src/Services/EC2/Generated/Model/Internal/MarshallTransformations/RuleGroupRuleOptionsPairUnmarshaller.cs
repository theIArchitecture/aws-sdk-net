...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class RuleGroupRuleOptionsPairUnmarshaller : IXmlUnmarshaller<RuleGroupRuleOptionsPair, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public RuleGroupRuleOptionsPair Unmarshall(XmlUnmarshallerContext context)
        {
            RuleGroupRuleOptionsPair unmarshalledObject = new RuleGroupRuleOptionsPair();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RuleGroupRuleOptionsPairUnmarshaller Instance
        {
            get
            {
                return _instance;
