...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class SubnetCidrReservationUnmarshaller : IXmlUnmarshaller<SubnetCidrReservation, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public SubnetCidrReservation Unmarshall(XmlUnmarshallerContext context)
        {
            SubnetCidrReservation unmarshalledObject = new SubnetCidrReservation();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.SubnetCidrReservationId = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SubnetCidrReservationUnmarshaller Instance
        {
            get
            {
                return _instance;
