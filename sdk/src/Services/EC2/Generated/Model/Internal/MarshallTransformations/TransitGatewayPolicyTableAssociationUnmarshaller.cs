...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class TransitGatewayPolicyTableAssociationUnmarshaller : IXmlUnmarshaller<TransitGatewayPolicyTableAssociation, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public TransitGatewayPolicyTableAssociation Unmarshall(XmlUnmarshallerContext context)
        {
            TransitGatewayPolicyTableAssociation unmarshalledObject = new TransitGatewayPolicyTableAssociation();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TransitGatewayPolicyTableAssociationUnmarshaller Instance
        {
            get
            {
                return _instance;
