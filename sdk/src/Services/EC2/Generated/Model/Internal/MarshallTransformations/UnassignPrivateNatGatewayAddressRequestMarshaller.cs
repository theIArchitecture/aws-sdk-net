...
{
    /// <summary>
    /// UnassignPrivateNatGatewayAddress Request Marshaller
    /// </summary>       
    public class UnassignPrivateNatGatewayAddressRequestMarshaller : IMarshaller<IRequest, UnassignPrivateNatGatewayAddressRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UnassignPrivateNatGatewayAddressRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UnassignPrivateNatGatewayAddressRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "UnassignPrivateNatGatewayAddress");
            ...
            return request;
                    ...
                    private static UnassignPrivateNatGatewayAddressRequestMarshaller _instance = new UnassignPrivateNatGatewayAddressRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UnassignPrivateNatGatewayAddressRequestMarshaller Instance
        {
            get
            {
                return _instance;
