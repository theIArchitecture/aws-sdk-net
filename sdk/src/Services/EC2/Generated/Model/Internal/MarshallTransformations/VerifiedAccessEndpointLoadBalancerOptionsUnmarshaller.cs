...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class VerifiedAccessEndpointLoadBalancerOptionsUnmarshaller : IXmlUnmarshaller<VerifiedAccessEndpointLoadBalancerOptions, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public VerifiedAccessEndpointLoadBalancerOptions Unmarshall(XmlUnmarshallerContext context)
        {
            VerifiedAccessEndpointLoadBalancerOptions unmarshalledObject = new VerifiedAccessEndpointLoadBalancerOptions();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static VerifiedAccessEndpointLoadBalancerOptionsUnmarshaller Instance
        {
            get
            {
                return _instance;
