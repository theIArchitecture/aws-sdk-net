...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class VerifiedAccessEndpointPortRangeUnmarshaller : IXmlUnmarshaller<VerifiedAccessEndpointPortRange, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public VerifiedAccessEndpointPortRange Unmarshall(XmlUnmarshallerContext context)
        {
            VerifiedAccessEndpointPortRange unmarshalledObject = new VerifiedAccessEndpointPortRange();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static VerifiedAccessEndpointPortRangeUnmarshaller Instance
        {
            get
            {
                return _instance;
