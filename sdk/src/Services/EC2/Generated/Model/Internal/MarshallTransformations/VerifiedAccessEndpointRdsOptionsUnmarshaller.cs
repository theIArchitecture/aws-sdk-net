...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class VerifiedAccessEndpointRdsOptionsUnmarshaller : IXmlUnmarshaller<VerifiedAccessEndpointRdsOptions, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public VerifiedAccessEndpointRdsOptions Unmarshall(XmlUnmarshallerContext context)
        {
            VerifiedAccessEndpointRdsOptions unmarshalledObject = new VerifiedAccessEndpointRdsOptions();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("rdsDbClusterArn", targetDepth))
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.RdsDbClusterArn = unmarshaller.Unmarshall(context);
                        continue;
                    }
                    ...
                    if (context.TestExpression("rdsDbProxyArn", targetDepth))
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.RdsDbProxyArn = unmarshaller.Unmarshall(context);
                        continue;
                    }
                    if (context.TestExpression("rdsEndpoint", targetDepth))
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.RdsEndpoint = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static VerifiedAccessEndpointRdsOptionsUnmarshaller Instance
        {
            get
            {
                return _instance;
