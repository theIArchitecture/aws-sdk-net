...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class VerifiedAccessGroupUnmarshaller : IXmlUnmarshaller<VerifiedAccessGroup, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public VerifiedAccessGroup Unmarshall(XmlUnmarshallerContext context)
        {
            VerifiedAccessGroup unmarshalledObject = new VerifiedAccessGroup();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.VerifiedAccessGroupArn = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static VerifiedAccessGroupUnmarshaller Instance
        {
            get
            {
                return _instance;
