...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VolumeStatusInfoUnmarshaller : IXmlUnmarshaller<VolumeStatusInfo, XmlUnmarshallerContext>
    {
        /// <summary>
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("details/item", targetDepth))
                    {
                        ...
                        {
                            unmarshalledObject.Details = new List<VolumeStatusDetails>();
                        }
