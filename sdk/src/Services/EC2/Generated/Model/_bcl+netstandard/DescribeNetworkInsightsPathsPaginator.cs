...
namespace Amazon.EC2.Model
{
    ...
    internal sealed partial class DescribeNetworkInsightsPathsPaginator : IPaginator<DescribeNetworkInsightsPathsResponse>, IDescribeNetworkInsightsPathsPaginator
    {
        ...
        public IPaginatedEnumerable<NetworkInsightsPath> NetworkInsightsPaths => 
            new PaginatedResultKeyResponse<DescribeNetworkInsightsPathsResponse, NetworkInsightsPath>(this, (i) => i.NetworkInsightsPaths ?? new List<NetworkInsightsPath>());
        ...
        async IAsyncEnumerable<DescribeNetworkInsightsPathsResponse> IPaginator<DescribeNetworkInsightsPathsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
