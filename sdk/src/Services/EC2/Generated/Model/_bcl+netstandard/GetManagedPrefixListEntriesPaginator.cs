...
namespace Amazon.EC2.Model
{
    ...
    internal sealed partial class GetManagedPrefixListEntriesPaginator : IPaginator<GetManagedPrefixListEntriesResponse>, IGetManagedPrefixListEntriesPaginator
    {
        ...
        public IPaginatedEnumerable<PrefixListEntry> Entries => 
            new PaginatedResultKeyResponse<GetManagedPrefixListEntriesResponse, PrefixListEntry>(this, (i) => i.Entries ?? new List<PrefixListEntry>());
        ...
        async IAsyncEnumerable<GetManagedPrefixListEntriesResponse> IPaginator<GetManagedPrefixListEntriesResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
