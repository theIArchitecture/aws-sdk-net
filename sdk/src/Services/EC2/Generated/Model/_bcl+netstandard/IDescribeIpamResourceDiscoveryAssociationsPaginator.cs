...
namespace Amazon.EC2.Model
{
    ...
    public interface IDescribeIpamResourceDiscoveryAssociationsPaginator
    {
        ...
        /// </summary>
        IPaginatedEnumerable<DescribeIpamResourceDiscoveryAssociationsResponse> Responses { get; }

        /// <summary>
        /// Enumerable containing all of the IpamResourceDiscoveryAssociations
        /// </summary>
        IPaginatedEnumerable<IpamResourceDiscoveryAssociation> IpamResourceDiscoveryAssociations { get; }
    }
}