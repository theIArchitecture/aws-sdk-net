...
namespace Amazon.EC2InstanceConnect.Internal
{
    ...
    public class AmazonEC2InstanceConnectAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonEC2InstanceConnectAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for EC2InstanceConnect.
        /// </summary>
        public AmazonEC2InstanceConnectAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonEC2InstanceConnectAuthSchemeParameters
            {
    ...
    public class AmazonEC2InstanceConnectAuthSchemeResolver : IAuthSchemeResolver<AmazonEC2InstanceConnectAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonEC2InstanceConnectAuthSchemeParameters authParameters)
        {
