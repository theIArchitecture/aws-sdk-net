...
namespace Amazon.EC2InstanceConnect.Internal
{
    ...
    /// </summary>
    public class AmazonEC2InstanceConnectEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonEC2InstanceConnectConfig)requestContext.ClientConfig;
            var result = new EC2InstanceConnectEndpointParameters();
