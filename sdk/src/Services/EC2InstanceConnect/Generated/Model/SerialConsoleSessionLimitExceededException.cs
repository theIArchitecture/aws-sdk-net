...
namespace Amazon.EC2InstanceConnect.Model
{
    ...
    public partial class SerialConsoleSessionLimitExceededException : AmazonEC2InstanceConnectException
    {
        ...
        public SerialConsoleSessionLimitExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public SerialConsoleSessionLimitExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
