...
namespace Amazon.EC2InstanceConnect
{
    ...
    public partial interface IAmazonEC2InstanceConnect : IAmazonService, IDisposable
    {
        ...
        Task<SendSerialConsoleSSHPublicKeyResponse> SendSerialConsoleSSHPublicKeyAsync(SendSerialConsoleSSHPublicKeyRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonEC2InstanceConnectConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonEC2InstanceConnectConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonEC2InstanceConnectConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonEC2InstanceConnectConfig to create AmazonEC2InstanceConnectClient");
            }

            return awsCredentials == null ? 
                    new AmazonEC2InstanceConnectClient(serviceClientConfig) :
                    new AmazonEC2InstanceConnectClient(awsCredentials, serviceClientConfig);
        }
