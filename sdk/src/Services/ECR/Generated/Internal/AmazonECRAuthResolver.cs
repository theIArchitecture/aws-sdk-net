...
namespace Amazon.ECR.Internal
{
    ...
    public class AmazonECRAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonECRAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ECR.
        /// </summary>
        public AmazonECRAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonECRAuthSchemeParameters
            {
    ...
    public class AmazonECRAuthSchemeResolver : IAuthSchemeResolver<AmazonECRAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonECRAuthSchemeParameters authParameters)
        {
