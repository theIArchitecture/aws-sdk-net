...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchGetRepositoryScanningConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchGetRepositoryScanningConfigurationResponse response = new BatchGetRepositoryScanningConfigurationResponse();
        ...
        private static BatchGetRepositoryScanningConfigurationResponseUnmarshaller _instance = new BatchGetRepositoryScanningConfigurationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetRepositoryScanningConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
