...
{
    /// <summary>
    /// Response Unmarshaller for DescribeRepositoryCreationTemplates operation
    /// </summary>  
    public class DescribeRepositoryCreationTemplatesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeRepositoryCreationTemplatesResponse response = new DescribeRepositoryCreationTemplatesResponse();
        ...
        private static DescribeRepositoryCreationTemplatesResponseUnmarshaller _instance = new DescribeRepositoryCreationTemplatesResponseUnmarshaller();        

        internal static DescribeRepositoryCreationTemplatesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeRepositoryCreationTemplatesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
