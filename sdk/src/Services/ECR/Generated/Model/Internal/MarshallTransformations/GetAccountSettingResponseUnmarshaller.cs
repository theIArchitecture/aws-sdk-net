...
{
    /// <summary>
    /// Response Unmarshaller for GetAccountSetting operation
    /// </summary>  
    public class GetAccountSettingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAccountSettingResponse response = new GetAccountSettingResponse();
        ...
        private static GetAccountSettingResponseUnmarshaller _instance = new GetAccountSettingResponseUnmarshaller();        

        internal static GetAccountSettingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAccountSettingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
