...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetRegistryScanningConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRegistryScanningConfigurationResponse response = new GetRegistryScanningConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("scanningConfiguration", targetDepth))
                {
                    var unmarshaller = RegistryScanningConfigurationUnmarshaller.Instance;
                    response.ScanningConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetRegistryScanningConfigurationResponseUnmarshaller _instance = new GetRegistryScanningConfigurationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRegistryScanningConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
