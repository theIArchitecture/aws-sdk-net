...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ImageScanFindingsSummaryUnmarshaller : IJsonUnmarshaller<ImageScanFindingsSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ImageScanFindingsSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
