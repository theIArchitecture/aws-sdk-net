...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ImageScanningConfigurationUnmarshaller : IJsonUnmarshaller<ImageScanningConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ImageScanningConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
