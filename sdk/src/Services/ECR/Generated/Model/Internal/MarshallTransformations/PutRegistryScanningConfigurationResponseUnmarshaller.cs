...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutRegistryScanningConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutRegistryScanningConfigurationResponse response = new PutRegistryScanningConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("registryScanningConfiguration", targetDepth))
                {
                    ...
                    response.RegistryScanningConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static PutRegistryScanningConfigurationResponseUnmarshaller _instance = new PutRegistryScanningConfigurationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutRegistryScanningConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
