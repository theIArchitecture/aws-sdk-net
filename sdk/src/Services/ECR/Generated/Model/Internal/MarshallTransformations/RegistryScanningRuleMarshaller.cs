        ...
        public void Marshall(RegistryScanningRule requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetRepositoryFilters())
            {
                ...
                foreach(var requestObjectRepositoryFiltersListValue in requestObject.RepositoryFilters)
                {
                    ...
                    var marshaller = ScanningRepositoryFilterMarshaller.Instance;
            ...
            if(requestObject.IsSetScanFrequency())
            {
                context.Writer.WritePropertyName("scanFrequency");
                context.Writer.WriteStringValue(requestObject.ScanFrequency);
            }
