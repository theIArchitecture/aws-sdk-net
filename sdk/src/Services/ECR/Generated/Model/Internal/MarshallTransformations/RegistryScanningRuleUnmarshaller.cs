...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RegistryScanningRuleUnmarshaller : IJsonUnmarshaller<RegistryScanningRule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RegistryScanningRule Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            RegistryScanningRule unmarshalledObject = new RegistryScanningRule();
        ...
        private static RegistryScanningRuleUnmarshaller _instance = new RegistryScanningRuleUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RegistryScanningRuleUnmarshaller Instance
        {
            get
            {
                return _instance;
