...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ReplicationRuleUnmarshaller : IJsonUnmarshaller<ReplicationRule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ReplicationRule Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
