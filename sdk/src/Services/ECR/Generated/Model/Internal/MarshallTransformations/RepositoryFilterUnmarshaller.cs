...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RepositoryFilterUnmarshaller : IJsonUnmarshaller<RepositoryFilter, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RepositoryFilter Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
