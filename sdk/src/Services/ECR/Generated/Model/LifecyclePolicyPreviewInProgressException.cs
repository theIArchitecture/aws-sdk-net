...
namespace Amazon.ECR.Model
{
    ...
    public partial class LifecyclePolicyPreviewInProgressException : AmazonECRException
    {
        ...
        public LifecyclePolicyPreviewInProgressException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public LifecyclePolicyPreviewInProgressException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
