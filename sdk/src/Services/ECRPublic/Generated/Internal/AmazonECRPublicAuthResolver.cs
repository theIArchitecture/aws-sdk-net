...
namespace Amazon.ECRPublic.Internal
{
    ...
    public class AmazonECRPublicAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonECRPublicAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ECRPublic.
        /// </summary>
        public AmazonECRPublicAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonECRPublicAuthSchemeParameters
            {
    ...
    public class AmazonECRPublicAuthSchemeResolver : IAuthSchemeResolver<AmazonECRPublicAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonECRPublicAuthSchemeParameters authParameters)
        {
