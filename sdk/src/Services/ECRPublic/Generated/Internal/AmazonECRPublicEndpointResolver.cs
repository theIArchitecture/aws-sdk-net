...
{
    /// <summary>
    /// Amazon ECRPublic endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for ECRPublic service requests.
    /// Collects values for ECRPublicEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses ECRPublicEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonECRPublicEndpointResolver : BaseEndpointResolver
    {
