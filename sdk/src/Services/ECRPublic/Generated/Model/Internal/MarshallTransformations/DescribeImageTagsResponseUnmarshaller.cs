    ...
    public class DescribeImageTagsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ImageTagDetail, ImageTagDetailUnmarshaller>(ImageTagDetailUnmarshaller.Instance);
                    response.ImageTagDetails = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
