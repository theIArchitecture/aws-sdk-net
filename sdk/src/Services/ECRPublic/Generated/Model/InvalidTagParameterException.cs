...
namespace Amazon.ECRPublic.Model
{
    ...
    [Serializable]
    #endif
    public partial class InvalidTagParameterException : AmazonECRPublicException
    {
        ...
        public InvalidTagParameterException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidTagParameterException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
