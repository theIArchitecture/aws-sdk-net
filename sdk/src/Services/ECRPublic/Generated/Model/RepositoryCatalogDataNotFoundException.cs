...
namespace Amazon.ECRPublic.Model
{
    ...
    public partial class RepositoryCatalogDataNotFoundException : AmazonECRPublicException
    {
        ...
        public RepositoryCatalogDataNotFoundException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public RepositoryCatalogDataNotFoundException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
