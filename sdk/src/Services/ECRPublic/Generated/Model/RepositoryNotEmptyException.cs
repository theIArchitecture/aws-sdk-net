...
namespace Amazon.ECRPublic.Model
{
    ...
    public partial class RepositoryNotEmptyException : AmazonECRPublicException
    {
        ...
        public RepositoryNotEmptyException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public RepositoryNotEmptyException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
