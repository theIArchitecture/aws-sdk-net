...
namespace Amazon.ECS.Internal
{
    ...
    public class AmazonECSAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonECSAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ECS.
        /// </summary>
        public AmazonECSAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonECSAuthSchemeParameters
            {
    ...
    public class AmazonECSAuthSchemeResolver : IAuthSchemeResolver<AmazonECSAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonECSAuthSchemeParameters authParameters)
        {
