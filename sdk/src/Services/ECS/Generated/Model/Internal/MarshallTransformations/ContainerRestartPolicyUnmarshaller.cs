...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    public class ContainerRestartPolicyUnmarshaller : IJsonUnmarshaller<ContainerRestartPolicy, JsonUnmarshallerContext>
    {
        ...
        private static ContainerRestartPolicyUnmarshaller _instance = new ContainerRestartPolicyUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ContainerRestartPolicyUnmarshaller Instance
        {
            get
            {
                return _instance;
