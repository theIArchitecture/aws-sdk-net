...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeServiceDeploymentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeServiceDeploymentsResponse response = new DescribeServiceDeploymentsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("serviceDeployments", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<ServiceDeployment, ServiceDeploymentUnmarshaller>(ServiceDeploymentUnmarshaller.Instance);
                    response.ServiceDeployments = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeServiceDeploymentsResponseUnmarshaller _instance = new DescribeServiceDeploymentsResponseUnmarshaller();        

        internal static DescribeServiceDeploymentsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeServiceDeploymentsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
