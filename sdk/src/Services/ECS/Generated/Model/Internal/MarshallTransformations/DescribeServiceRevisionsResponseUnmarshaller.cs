...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeServiceRevisionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeServiceRevisionsResponse response = new DescribeServiceRevisionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("serviceRevisions", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<ServiceRevision, ServiceRevisionUnmarshaller>(ServiceRevisionUnmarshaller.Instance);
                    response.ServiceRevisions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeServiceRevisionsResponseUnmarshaller _instance = new DescribeServiceRevisionsResponseUnmarshaller();        

        internal static DescribeServiceRevisionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeServiceRevisionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
