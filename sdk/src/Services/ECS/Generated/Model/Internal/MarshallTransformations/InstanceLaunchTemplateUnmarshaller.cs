...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InstanceLaunchTemplateUnmarshaller : IJsonUnmarshaller<InstanceLaunchTemplate, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            InstanceLaunchTemplate unmarshalledObject = new InstanceLaunchTemplate();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InstanceLaunchTemplateUnmarshaller Instance
        {
            get
            {
                return _instance;
