...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListServiceDeploymentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListServiceDeploymentsResponse response = new ListServiceDeploymentsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ServiceDeploymentBrief, ServiceDeploymentBriefUnmarshaller>(ServiceDeploymentBriefUnmarshaller.Instance);
        ...
        private static ListServiceDeploymentsResponseUnmarshaller _instance = new ListServiceDeploymentsResponseUnmarshaller();        

        internal static ListServiceDeploymentsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListServiceDeploymentsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
