...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListServicesByNamespaceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListServicesByNamespaceResponse response = new ListServicesByNamespaceResponse();
        ...
        private static ListServicesByNamespaceResponseUnmarshaller _instance = new ListServicesByNamespaceResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListServicesByNamespaceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
