...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ManagedAgentUnmarshaller : IJsonUnmarshaller<ManagedAgent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ManagedAgent Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static ManagedAgentUnmarshaller _instance = new ManagedAgentUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ManagedAgentUnmarshaller Instance
        {
            get
            {
                return _instance;
