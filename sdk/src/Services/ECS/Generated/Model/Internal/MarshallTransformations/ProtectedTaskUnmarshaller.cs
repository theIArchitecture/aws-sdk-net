...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ProtectedTaskUnmarshaller : IJsonUnmarshaller<ProtectedTask, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ProtectedTask Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("protectionEnabled", targetDepth))
                {
                    ...
                    unmarshalledObject.ProtectionEnabled = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
