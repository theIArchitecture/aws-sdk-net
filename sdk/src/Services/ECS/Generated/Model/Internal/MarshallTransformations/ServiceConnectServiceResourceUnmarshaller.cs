...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ServiceConnectServiceResourceUnmarshaller : IJsonUnmarshaller<ServiceConnectServiceResource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ServiceConnectServiceResource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("discoveryArn", targetDepth))
                {
                    ...
                    unmarshalledObject.DiscoveryArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
