...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ServiceConnectTlsConfigurationUnmarshaller : IJsonUnmarshaller<ServiceConnectTlsConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ServiceConnectTlsConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("issuerCertificateAuthority", targetDepth))
                {
                    ...
                    unmarshalledObject.IssuerCertificateAuthority = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
