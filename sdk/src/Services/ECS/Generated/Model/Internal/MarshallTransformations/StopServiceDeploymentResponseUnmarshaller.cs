...
{
    /// <summary>
    /// Response Unmarshaller for StopServiceDeployment operation
    /// </summary>  
    public class StopServiceDeploymentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopServiceDeploymentResponse response = new StopServiceDeploymentResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("serviceDeploymentArn", targetDepth))
                {
                    ...
                    response.ServiceDeploymentArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("ServiceDeploymentNotFoundException"))
                {
                    return ServiceDeploymentNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static StopServiceDeploymentResponseUnmarshaller _instance = new StopServiceDeploymentResponseUnmarshaller();        

        internal static StopServiceDeploymentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopServiceDeploymentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
