...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public class TaskManagedEBSVolumeConfigurationMarshaller : IRequestMarshaller<TaskManagedEBSVolumeConfiguration, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(TaskManagedEBSVolumeConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetTerminationPolicy())
            {
                context.Writer.WritePropertyName("terminationPolicy");
                context.Writer.WriteStartObject();

                var marshaller = TaskManagedEBSVolumeTerminationPolicyMarshaller.Instance;
                marshaller.Marshall(requestObject.TerminationPolicy, context);
        ...
        /// </summary>
        public readonly static TaskManagedEBSVolumeConfigurationMarshaller Instance = new TaskManagedEBSVolumeConfigurationMarshaller();
