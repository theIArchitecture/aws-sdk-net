...
namespace Amazon.ECS.Model
{
    ...
    public partial class PlatformTaskDefinitionIncompatibilityException : AmazonECSException
    {
        ...
        public PlatformTaskDefinitionIncompatibilityException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public PlatformTaskDefinitionIncompatibilityException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
