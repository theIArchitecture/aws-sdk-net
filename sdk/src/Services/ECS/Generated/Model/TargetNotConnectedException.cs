...
namespace Amazon.ECS.Model
{
    ...
    [Serializable]
    #endif
    public partial class TargetNotConnectedException : AmazonECSException
    {
        ...
        public TargetNotConnectedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TargetNotConnectedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
