...
namespace Amazon.EKS.Model
{
    ...
    public partial class AssociateAccessPolicyResponse : AmazonWebServiceResponse
    {
        ...
        {
            get { return this._associatedAccessPolicy; }
            set { this._associatedAccessPolicy = value; }
        }

        // Check to see if AssociatedAccessPolicy property is set
        internal bool IsSetAssociatedAccessPolicy()
        {
            return this._associatedAccessPolicy != null;
        }
