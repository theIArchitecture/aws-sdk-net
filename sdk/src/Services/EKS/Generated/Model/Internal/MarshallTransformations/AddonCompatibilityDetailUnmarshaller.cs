...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AddonCompatibilityDetailUnmarshaller : IJsonUnmarshaller<AddonCompatibilityDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AddonCompatibilityDetail Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("compatibleVersions", targetDepth))
                {
                    ...
                    unmarshalledObject.CompatibleVersions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
