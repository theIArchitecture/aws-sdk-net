...
{
    /// <summary>
    /// Response Unmarshaller for AssociateAccessPolicy operation
    /// </summary>  
    public class AssociateAccessPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateAccessPolicyResponse response = new AssociateAccessPolicyResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = AssociatedAccessPolicyUnmarshaller.Instance;
                    response.AssociatedAccessPolicy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static AssociateAccessPolicyResponseUnmarshaller _instance = new AssociateAccessPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateAccessPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
