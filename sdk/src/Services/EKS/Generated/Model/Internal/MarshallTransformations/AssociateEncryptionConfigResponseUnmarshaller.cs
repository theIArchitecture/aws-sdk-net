...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssociateEncryptionConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateEncryptionConfigResponse response = new AssociateEncryptionConfigResponse();
        ...
        private static AssociateEncryptionConfigResponseUnmarshaller _instance = new AssociateEncryptionConfigResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateEncryptionConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
