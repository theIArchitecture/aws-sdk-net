...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeregisterClusterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeregisterClusterResponse response = new DeregisterClusterResponse();
        ...
        private static DeregisterClusterResponseUnmarshaller _instance = new DeregisterClusterResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeregisterClusterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
