...
{
    /// <summary>
    /// DescribeAccessEntry Request Marshaller
    /// </summary>       
    public class DescribeAccessEntryRequestMarshaller : IMarshaller<IRequest, DescribeAccessEntryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeAccessEntryRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeAccessEntryRequest publicRequest)
        {
        ...
        private static DescribeAccessEntryRequestMarshaller _instance = new DescribeAccessEntryRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAccessEntryRequestMarshaller Instance
        {
            get
            {
                return _instance;
