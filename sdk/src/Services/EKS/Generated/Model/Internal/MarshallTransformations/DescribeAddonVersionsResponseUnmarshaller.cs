    ...
    public class DescribeAddonVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AddonInfo, AddonInfoUnmarshaller>(AddonInfoUnmarshaller.Instance);
                    response.Addons = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
