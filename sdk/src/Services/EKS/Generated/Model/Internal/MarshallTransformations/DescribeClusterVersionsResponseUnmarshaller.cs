...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeClusterVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ClusterVersionInformation, ClusterVersionInformationUnmarshaller>(ClusterVersionInformationUnmarshaller.Instance);
                    response.ClusterVersions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
