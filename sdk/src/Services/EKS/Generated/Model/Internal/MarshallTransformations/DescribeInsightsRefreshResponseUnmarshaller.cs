...
{
    /// <summary>
    /// Response Unmarshaller for DescribeInsightsRefresh operation
    /// </summary>  
    public class DescribeInsightsRefreshResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeInsightsRefreshResponse response = new DescribeInsightsRefreshResponse();
        ...
        private static DescribeInsightsRefreshResponseUnmarshaller _instance = new DescribeInsightsRefreshResponseUnmarshaller();        

        internal static DescribeInsightsRefreshResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeInsightsRefreshResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
