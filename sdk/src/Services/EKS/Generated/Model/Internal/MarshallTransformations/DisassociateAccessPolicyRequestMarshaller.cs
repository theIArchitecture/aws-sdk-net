...
{
    /// <summary>
    /// DisassociateAccessPolicy Request Marshaller
    /// </summary>       
    public class DisassociateAccessPolicyRequestMarshaller : IMarshaller<IRequest, DisassociateAccessPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DisassociateAccessPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DisassociateAccessPolicyRequest publicRequest)
        {
            ...
            if (!publicRequest.IsSetPolicyArn())
                throw new AmazonEKSException("Request object does not have required field PolicyArn set");
            ...
            request.ResourcePath = "/clusters/{name}/access-entries/{principalArn}/access-policies/{policyArn}";

            return request;
        }
        private static DisassociateAccessPolicyRequestMarshaller _instance = new DisassociateAccessPolicyRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateAccessPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
