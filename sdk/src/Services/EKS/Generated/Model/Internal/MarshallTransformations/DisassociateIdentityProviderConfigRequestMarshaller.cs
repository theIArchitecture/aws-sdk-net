...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DisassociateIdentityProviderConfigRequestMarshaller : IMarshaller<IRequest, DisassociateIdentityProviderConfigRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DisassociateIdentityProviderConfigRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DisassociateIdentityProviderConfigRequest publicRequest)
        {
            ...
            request.ResourcePath = "/clusters/{name}/identity-provider-configs/disassociate";
#if !NETFRAMEWORK
        ...
        private static DisassociateIdentityProviderConfigRequestMarshaller _instance = new DisassociateIdentityProviderConfigRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateIdentityProviderConfigRequestMarshaller Instance
        {
            get
            {
                return _instance;
