...
{
    /// <summary>
    /// Response Unmarshaller for ListAccessEntries operation
    /// </summary>  
    public class ListAccessEntriesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAccessEntriesResponse response = new ListAccessEntriesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("accessEntries", targetDepth))
                {
                    ...
                    response.AccessEntries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListAccessEntriesResponseUnmarshaller _instance = new ListAccessEntriesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAccessEntriesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
