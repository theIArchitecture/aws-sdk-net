...
{
    /// <summary>
    /// Response Unmarshaller for ListPodIdentityAssociations operation
    /// </summary>  
    public class ListPodIdentityAssociationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListPodIdentityAssociationsResponse response = new ListPodIdentityAssociationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<PodIdentityAssociationSummary, PodIdentityAssociationSummaryUnmarshaller>(PodIdentityAssociationSummaryUnmarshaller.Instance);
        ...
        private static ListPodIdentityAssociationsResponseUnmarshaller _instance = new ListPodIdentityAssociationsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPodIdentityAssociationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
