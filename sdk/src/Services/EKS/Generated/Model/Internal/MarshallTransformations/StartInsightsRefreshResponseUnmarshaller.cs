...
{
    /// <summary>
    /// Response Unmarshaller for StartInsightsRefresh operation
    /// </summary>  
    public class StartInsightsRefreshResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartInsightsRefreshResponse response = new StartInsightsRefreshResponse();
        ...
        private static StartInsightsRefreshResponseUnmarshaller _instance = new StartInsightsRefreshResponseUnmarshaller();        

        internal static StartInsightsRefreshResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartInsightsRefreshResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
