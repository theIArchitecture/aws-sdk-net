...
namespace Amazon.EKSAuth.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AssumeRoleForPodIdentityRequestMarshaller : IMarshaller<IRequest, AssumeRoleForPodIdentityRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static AssumeRoleForPodIdentityRequestMarshaller _instance = new AssumeRoleForPodIdentityRequestMarshaller();        

        internal static AssumeRoleForPodIdentityRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssumeRoleForPodIdentityRequestMarshaller Instance
        {
            get
            {
                return _instance;
