...
namespace Amazon.EKSAuth.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssumeRoleForPodIdentityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            return new AmazonEKSAuthException(errorResponse.Message, errorResponse.InnerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, errorResponse.StatusCode);
        }

        private static AssumeRoleForPodIdentityResponseUnmarshaller _instance = new AssumeRoleForPodIdentityResponseUnmarshaller();        

        internal static AssumeRoleForPodIdentityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssumeRoleForPodIdentityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
