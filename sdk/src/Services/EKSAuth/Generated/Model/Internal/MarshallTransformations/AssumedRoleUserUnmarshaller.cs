...
namespace Amazon.EKSAuth.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssumedRoleUserUnmarshaller : IJsonUnmarshaller<AssumedRoleUser, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AssumedRoleUser Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("assumeRoleId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AssumeRoleId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
