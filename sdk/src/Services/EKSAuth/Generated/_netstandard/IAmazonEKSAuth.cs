...
namespace Amazon.EKSAuth
{
    ...
    public partial interface IAmazonEKSAuth : IAmazonService, IDisposable
    {
        ...
        Task<AssumeRoleForPodIdentityResponse> AssumeRoleForPodIdentityAsync(AssumeRoleForPodIdentityRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
