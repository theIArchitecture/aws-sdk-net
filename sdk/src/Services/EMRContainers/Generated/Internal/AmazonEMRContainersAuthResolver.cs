...
namespace Amazon.EMRContainers.Internal
{
    ...
    public class AmazonEMRContainersAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonEMRContainersAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for EMRContainers.
        /// </summary>
        public AmazonEMRContainersAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonEMRContainersAuthSchemeParameters
            {
    ...
    public class AmazonEMRContainersAuthSchemeResolver : IAuthSchemeResolver<AmazonEMRContainersAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonEMRContainersAuthSchemeParameters authParameters)
        {
