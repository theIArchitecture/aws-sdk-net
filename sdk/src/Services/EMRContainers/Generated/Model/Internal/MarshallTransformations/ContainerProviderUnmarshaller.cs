...
namespace Amazon.EMRContainers.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ContainerProviderUnmarshaller : IJsonUnmarshaller<ContainerProvider, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ContainerProvider Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
