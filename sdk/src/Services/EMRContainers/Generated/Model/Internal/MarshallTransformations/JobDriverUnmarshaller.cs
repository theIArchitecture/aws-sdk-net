...
namespace Amazon.EMRContainers.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class JobDriverUnmarshaller : IJsonUnmarshaller<JobDriver, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public JobDriver Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
