...
namespace Amazon.EMRContainers.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ParametricMonitoringConfigurationUnmarshaller : IJsonUnmarshaller<ParametricMonitoringConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ParametricMonitoringConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
