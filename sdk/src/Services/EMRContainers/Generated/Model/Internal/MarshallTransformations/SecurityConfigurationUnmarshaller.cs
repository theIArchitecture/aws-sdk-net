...
namespace Amazon.EMRContainers.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SecurityConfigurationUnmarshaller : IJsonUnmarshaller<SecurityConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SecurityConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("securityConfigurationData", targetDepth))
                {
                    ...
                    unmarshalledObject.SecurityConfigurationData = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
