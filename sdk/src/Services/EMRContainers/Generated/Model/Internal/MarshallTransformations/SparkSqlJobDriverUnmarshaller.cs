...
namespace Amazon.EMRContainers.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SparkSqlJobDriverUnmarshaller : IJsonUnmarshaller<SparkSqlJobDriver, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SparkSqlJobDriver Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SparkSqlParameters = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
