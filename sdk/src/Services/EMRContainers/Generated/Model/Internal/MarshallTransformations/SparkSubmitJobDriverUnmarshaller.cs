...
namespace Amazon.EMRContainers.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SparkSubmitJobDriverUnmarshaller : IJsonUnmarshaller<SparkSubmitJobDriver, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SparkSubmitJobDriver Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("entryPointArguments", targetDepth))
                {
                    ...
                    unmarshalledObject.EntryPointArguments = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("sparkSubmitParameters", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SparkSubmitParameters = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
