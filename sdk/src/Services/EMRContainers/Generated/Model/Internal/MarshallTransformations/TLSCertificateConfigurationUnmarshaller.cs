...
namespace Amazon.EMRContainers.Model.Internal.MarshallTransformations
{
    ...
    public class TLSCertificateConfigurationUnmarshaller : IJsonUnmarshaller<TLSCertificateConfiguration, JsonUnmarshallerContext>
    {
        ...
        private static TLSCertificateConfigurationUnmarshaller _instance = new TLSCertificateConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TLSCertificateConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
