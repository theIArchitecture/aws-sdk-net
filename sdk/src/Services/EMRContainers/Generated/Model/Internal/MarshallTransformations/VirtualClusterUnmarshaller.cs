...
namespace Amazon.EMRContainers.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VirtualClusterUnmarshaller : IJsonUnmarshaller<VirtualCluster, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public VirtualCluster Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("containerProvider", targetDepth))
                {
                    ...
                    unmarshalledObject.ContainerProvider = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SecurityConfigurationId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
