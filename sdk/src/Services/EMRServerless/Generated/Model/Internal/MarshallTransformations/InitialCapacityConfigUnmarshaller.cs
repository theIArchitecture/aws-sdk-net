...
namespace Amazon.EMRServerless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InitialCapacityConfigUnmarshaller : IJsonUnmarshaller<InitialCapacityConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InitialCapacityConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
