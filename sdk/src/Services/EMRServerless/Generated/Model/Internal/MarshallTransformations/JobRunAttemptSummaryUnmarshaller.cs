...
namespace Amazon.EMRServerless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class JobRunAttemptSummaryUnmarshaller : IJsonUnmarshaller<JobRunAttemptSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public JobRunAttemptSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    unmarshalledObject.JobCreatedAt = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
