...
namespace Amazon.EMRServerless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class WorkerTypeSpecificationUnmarshaller : IJsonUnmarshaller<WorkerTypeSpecification, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public WorkerTypeSpecification Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
