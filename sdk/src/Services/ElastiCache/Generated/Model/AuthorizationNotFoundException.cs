...
namespace Amazon.ElastiCache.Model
{
    ...
    public partial class AuthorizationNotFoundException : AmazonElastiCacheException
    {
        ...
        public AuthorizationNotFoundException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AuthorizationNotFoundException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
