...
namespace Amazon.ElastiCache.Model
{
    ...
    public partial class CacheParameterGroupQuotaExceededException : AmazonElastiCacheException
    {
        ...
        public CacheParameterGroupQuotaExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CacheParameterGroupQuotaExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
