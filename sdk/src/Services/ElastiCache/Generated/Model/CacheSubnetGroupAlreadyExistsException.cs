...
namespace Amazon.ElastiCache.Model
{
    ...
    public partial class CacheSubnetGroupAlreadyExistsException : AmazonElastiCacheException
    {
        ...
        public CacheSubnetGroupAlreadyExistsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CacheSubnetGroupAlreadyExistsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
