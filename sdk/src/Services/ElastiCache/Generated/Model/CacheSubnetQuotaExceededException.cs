...
namespace Amazon.ElastiCache.Model
{
    ...
    public partial class CacheSubnetQuotaExceededException : AmazonElastiCacheException
    {
        ...
        public CacheSubnetQuotaExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CacheSubnetQuotaExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
