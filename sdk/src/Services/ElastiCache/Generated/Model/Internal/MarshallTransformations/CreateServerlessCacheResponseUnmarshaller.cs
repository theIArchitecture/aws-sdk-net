...
{
    /// <summary>
    /// Response Unmarshaller for CreateServerlessCache operation
    /// </summary>  
    public class CreateServerlessCacheResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateServerlessCacheResponse response = new CreateServerlessCacheResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("CreateServerlessCacheResult", 2))
                    {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("ServerlessCache", targetDepth))
                    {
                        ...
                        response.ServerlessCache = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
           }
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("ServerlessCacheAlreadyExistsFault"))
                {
                    return ServerlessCacheAlreadyExistsExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("ServerlessCacheQuotaForCustomerExceededFault"))
                {
                    return ServerlessCacheQuotaForCustomerExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static CreateServerlessCacheResponseUnmarshaller _instance = new CreateServerlessCacheResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateServerlessCacheResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
