...
{
    /// <summary>
    /// Response Unmarshaller for CreateServerlessCacheSnapshot operation
    /// </summary>  
    public class CreateServerlessCacheSnapshotResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateServerlessCacheSnapshotResponse response = new CreateServerlessCacheSnapshotResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("CreateServerlessCacheSnapshotResult", 2))
                    {
        ...
        private static CreateServerlessCacheSnapshotResponseUnmarshaller _instance = new CreateServerlessCacheSnapshotResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateServerlessCacheSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
