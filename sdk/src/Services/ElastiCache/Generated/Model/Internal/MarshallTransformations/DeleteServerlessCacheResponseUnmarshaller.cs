...
{
    /// <summary>
    /// Response Unmarshaller for DeleteServerlessCache operation
    /// </summary>  
    public class DeleteServerlessCacheResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteServerlessCacheResponse response = new DeleteServerlessCacheResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteServerlessCacheResult", 2))
                    {
        ...
        private static DeleteServerlessCacheResponseUnmarshaller _instance = new DeleteServerlessCacheResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteServerlessCacheResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
