...
{
    /// <summary>
    /// Response Unmarshaller for DeleteServerlessCacheSnapshot operation
    /// </summary>  
    public class DeleteServerlessCacheSnapshotResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteServerlessCacheSnapshotResponse response = new DeleteServerlessCacheSnapshotResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteServerlessCacheSnapshotResult", 2))
                    {
        ...
        private static DeleteServerlessCacheSnapshotResponseUnmarshaller _instance = new DeleteServerlessCacheSnapshotResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteServerlessCacheSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
