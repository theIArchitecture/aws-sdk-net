...
{
    /// <summary>
    /// Response Unmarshaller for DescribeServerlessCaches operation
    /// </summary>  
    public class DescribeServerlessCachesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeServerlessCachesResponse response = new DescribeServerlessCachesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeServerlessCachesResult", 2))
                    {
        ...
        private static DescribeServerlessCachesResponseUnmarshaller _instance = new DescribeServerlessCachesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeServerlessCachesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
