...
namespace Amazon.ElastiCache.Model.Internal.MarshallTransformations
{
    ...
    public class ECPUPerSecondUnmarshaller : IXmlUnmarshaller<ECPUPerSecond, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ECPUPerSecond Unmarshall(XmlUnmarshallerContext context)
        {
            ECPUPerSecond unmarshalledObject = new ECPUPerSecond();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ECPUPerSecondUnmarshaller Instance
        {
            get
            {
                return _instance;
