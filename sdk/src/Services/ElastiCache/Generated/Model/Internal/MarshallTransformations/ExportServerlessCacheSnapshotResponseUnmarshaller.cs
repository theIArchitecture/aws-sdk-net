...
{
    /// <summary>
    /// Response Unmarshaller for ExportServerlessCacheSnapshot operation
    /// </summary>  
    public class ExportServerlessCacheSnapshotResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ExportServerlessCacheSnapshotResponse response = new ExportServerlessCacheSnapshotResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ExportServerlessCacheSnapshotResult", 2))
                    {
        ...
        private static ExportServerlessCacheSnapshotResponseUnmarshaller _instance = new ExportServerlessCacheSnapshotResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExportServerlessCacheSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
