...
{
    /// <summary>
    /// Response Unmarshaller for ModifyServerlessCache operation
    /// </summary>  
    public class ModifyServerlessCacheResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyServerlessCacheResponse response = new ModifyServerlessCacheResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ModifyServerlessCacheResult", 2))
                    {
        ...
        private static ModifyServerlessCacheResponseUnmarshaller _instance = new ModifyServerlessCacheResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyServerlessCacheResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
