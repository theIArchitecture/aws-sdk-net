...
{
    /// <summary>
    /// TestMigration Request Marshaller
    /// </summary>       
    public class TestMigrationRequestMarshaller : IMarshaller<IRequest, TestMigrationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((TestMigrationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(TestMigrationRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ElastiCache");
            request.Parameters.Add("Action", "TestMigration");
            ...
            return request;
                    ...
                    private static TestMigrationRequestMarshaller _instance = new TestMigrationRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TestMigrationRequestMarshaller Instance
        {
            get
            {
                return _instance;
