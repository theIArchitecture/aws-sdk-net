...
{
    /// <summary>
    /// Response Unmarshaller for TestMigration operation
    /// </summary>  
    public class TestMigrationResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TestMigrationResponse response = new TestMigrationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("TestMigrationResult", 2))
                    {
        ...
        private static TestMigrationResponseUnmarshaller _instance = new TestMigrationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TestMigrationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
