...
namespace Amazon.ElastiCache.Model
{
    ...
    public partial class InvalidCacheClusterStateException : AmazonElastiCacheException
    {
        ...
        public InvalidCacheClusterStateException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidCacheClusterStateException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
