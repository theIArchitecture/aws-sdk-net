...
namespace Amazon.ElastiCache.Model
{
    ...
    public partial class InvalidCacheParameterGroupStateException : AmazonElastiCacheException
    {
        ...
        public InvalidCacheParameterGroupStateException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidCacheParameterGroupStateException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
