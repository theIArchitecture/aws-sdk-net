...
namespace Amazon.ElastiCache.Model
{
    ...
    public partial class InvalidReplicationGroupStateException : AmazonElastiCacheException
    {
        ...
        public InvalidReplicationGroupStateException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidReplicationGroupStateException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
