...
namespace Amazon.ElastiCache.Model
{
    ...
    public partial class NodeGroupsPerReplicationGroupQuotaExceededException : AmazonElastiCacheException
    {
        ...
        public NodeGroupsPerReplicationGroupQuotaExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NodeGroupsPerReplicationGroupQuotaExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
