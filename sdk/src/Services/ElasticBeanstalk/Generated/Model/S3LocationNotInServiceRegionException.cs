...
namespace Amazon.ElasticBeanstalk.Model
{
    ...
    public partial class S3LocationNotInServiceRegionException : AmazonElasticBeanstalkException
    {
        ...
        public S3LocationNotInServiceRegionException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public S3LocationNotInServiceRegionException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
