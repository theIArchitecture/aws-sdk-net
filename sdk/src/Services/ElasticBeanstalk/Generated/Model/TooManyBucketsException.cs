...
namespace Amazon.ElasticBeanstalk.Model
{
    ...
    public partial class TooManyBucketsException : AmazonElasticBeanstalkException
    {
        ...
        public TooManyBucketsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TooManyBucketsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
