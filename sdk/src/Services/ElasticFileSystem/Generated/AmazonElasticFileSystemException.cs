...
namespace Amazon.ElasticFileSystem
{
    ...
    public partial class AmazonElasticFileSystemException : AmazonServiceException
    {
        ...
        public AmazonElasticFileSystemException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonElasticFileSystemException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
