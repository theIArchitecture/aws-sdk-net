...
namespace Amazon.ElasticFileSystem.Model
{
    ...
    public partial class AccessPointAlreadyExistsException : AmazonElasticFileSystemException
    {
        ...
        public AccessPointAlreadyExistsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AccessPointAlreadyExistsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
