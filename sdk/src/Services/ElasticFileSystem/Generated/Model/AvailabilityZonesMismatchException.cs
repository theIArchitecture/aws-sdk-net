...
namespace Amazon.ElasticFileSystem.Model
{
    ...
    public partial class AvailabilityZonesMismatchException : AmazonElasticFileSystemException
    {
        ...
        public AvailabilityZonesMismatchException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AvailabilityZonesMismatchException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
