...
namespace Amazon.ElasticFileSystem.Model
{
    ...
    public partial class FileSystemInUseException : AmazonElasticFileSystemException
    {
        ...
        public FileSystemInUseException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public FileSystemInUseException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
