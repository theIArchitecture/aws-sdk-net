...
namespace Amazon.ElasticFileSystem.Model
{
    ...
    public partial class InsufficientThroughputCapacityException : AmazonElasticFileSystemException
    {
        ...
        public InsufficientThroughputCapacityException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InsufficientThroughputCapacityException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
