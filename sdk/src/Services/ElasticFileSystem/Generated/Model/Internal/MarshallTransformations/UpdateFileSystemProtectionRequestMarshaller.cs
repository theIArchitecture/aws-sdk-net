...
{
    /// <summary>
    /// UpdateFileSystemProtection Request Marshaller
    /// </summary>       
    public class UpdateFileSystemProtectionRequestMarshaller : IMarshaller<IRequest, UpdateFileSystemProtectionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateFileSystemProtectionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateFileSystemProtectionRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetReplicationOverwriteProtection())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ReplicationOverwriteProtection);
            }
        ...
        private static UpdateFileSystemProtectionRequestMarshaller _instance = new UpdateFileSystemProtectionRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFileSystemProtectionRequestMarshaller Instance
        {
            get
            {
                return _instance;
