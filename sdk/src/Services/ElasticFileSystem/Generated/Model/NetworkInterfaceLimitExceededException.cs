...
namespace Amazon.ElasticFileSystem.Model
{
    ...
    public partial class NetworkInterfaceLimitExceededException : AmazonElasticFileSystemException
    {
        ...
        public NetworkInterfaceLimitExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NetworkInterfaceLimitExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
