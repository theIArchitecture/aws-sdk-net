...
namespace Amazon.ElasticFileSystem.Model
{
    ...
    public partial class NoFreeAddressesInSubnetException : AmazonElasticFileSystemException
    {
        ...
        public NoFreeAddressesInSubnetException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NoFreeAddressesInSubnetException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
