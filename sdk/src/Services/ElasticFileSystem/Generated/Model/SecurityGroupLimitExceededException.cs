...
namespace Amazon.ElasticFileSystem.Model
{
    ...
    public partial class SecurityGroupLimitExceededException : AmazonElasticFileSystemException
    {
        ...
        public SecurityGroupLimitExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public SecurityGroupLimitExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
