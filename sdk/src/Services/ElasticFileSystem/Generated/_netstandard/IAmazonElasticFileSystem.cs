...
namespace Amazon.ElasticFileSystem
{
    ...
    public partial interface IAmazonElasticFileSystem : IAmazonService, IDisposable
    {
        ...
        Task<CreateReplicationConfigurationResponse> CreateReplicationConfigurationAsync(CreateReplicationConfigurationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteReplicationConfigurationResponse> DeleteReplicationConfigurationAsync(DeleteReplicationConfigurationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DescribeAccountPreferencesResponse> DescribeAccountPreferencesAsync(DescribeAccountPreferencesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DescribeReplicationConfigurationsResponse> DescribeReplicationConfigurationsAsync(DescribeReplicationConfigurationsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<PutAccountPreferencesResponse> PutAccountPreferencesAsync(PutAccountPreferencesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateFileSystemProtectionResponse> UpdateFileSystemProtectionAsync(UpdateFileSystemProtectionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonElasticFileSystemConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonElasticFileSystemConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonElasticFileSystemConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonElasticFileSystemConfig to create AmazonElasticFileSystemClient");
            }

            return awsCredentials == null ? 
                    new AmazonElasticFileSystemClient(serviceClientConfig) :
                    new AmazonElasticFileSystemClient(awsCredentials, serviceClientConfig);
        }
