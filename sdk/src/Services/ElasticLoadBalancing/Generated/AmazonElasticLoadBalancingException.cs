...
namespace Amazon.ElasticLoadBalancing
{
    ...
    public partial class AmazonElasticLoadBalancingException : AmazonServiceException
    {
        ...
        public AmazonElasticLoadBalancingException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonElasticLoadBalancingException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
