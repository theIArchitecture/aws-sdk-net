...
namespace Amazon.ElasticLoadBalancing.Internal
{
    ...
    public class AmazonElasticLoadBalancingAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonElasticLoadBalancingAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ElasticLoadBalancing.
        /// </summary>
        public AmazonElasticLoadBalancingAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonElasticLoadBalancingAuthSchemeParameters
            {
    ...
    public class AmazonElasticLoadBalancingAuthSchemeResolver : IAuthSchemeResolver<AmazonElasticLoadBalancingAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonElasticLoadBalancingAuthSchemeParameters authParameters)
        {
