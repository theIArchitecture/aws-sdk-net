...
namespace Amazon.ElasticLoadBalancing.Model
{
    ...
    public partial class DependencyThrottleException : AmazonElasticLoadBalancingException
    {
        ...
        public DependencyThrottleException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DependencyThrottleException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
