...
namespace Amazon.ElasticLoadBalancing.Model
{
    ...
    public partial class DuplicateAccessPointNameException : AmazonElasticLoadBalancingException
    {
        ...
        public DuplicateAccessPointNameException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DuplicateAccessPointNameException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
