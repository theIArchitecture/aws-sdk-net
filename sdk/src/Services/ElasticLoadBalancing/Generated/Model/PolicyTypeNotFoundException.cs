...
namespace Amazon.ElasticLoadBalancing.Model
{
    ...
    public partial class PolicyTypeNotFoundException : AmazonElasticLoadBalancingException
    {
        ...
        public PolicyTypeNotFoundException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public PolicyTypeNotFoundException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
