...
namespace Amazon.ElasticLoadBalancing.Model
{
    ...
    public partial class TooManyPoliciesException : AmazonElasticLoadBalancingException
    {
        ...
        public TooManyPoliciesException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TooManyPoliciesException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
