...
namespace Amazon.ElasticLoadBalancingV2.Internal
{
    /// <summary>
    /// Amazon ElasticLoadBalancingV2 endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for ElasticLoadBalancingV2 service requests.
    /// Collects values for ElasticLoadBalancingV2EndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses ElasticLoadBalancingV2EndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonElasticLoadBalancingV2EndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonElasticLoadBalancingV2Config)requestContext.ClientConfig;
            var result = new ElasticLoadBalancingV2EndpointParameters();
