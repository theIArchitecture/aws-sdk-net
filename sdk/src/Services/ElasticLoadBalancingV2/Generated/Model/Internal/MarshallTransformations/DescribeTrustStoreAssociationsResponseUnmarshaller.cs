...
{
    /// <summary>
    /// Response Unmarshaller for DescribeTrustStoreAssociations operation
    /// </summary>  
    public class DescribeTrustStoreAssociationsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeTrustStoreAssociationsResponse response = new DescribeTrustStoreAssociationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeTrustStoreAssociationsResult", 2))
                    {
        ...
        private static DescribeTrustStoreAssociationsResponseUnmarshaller _instance = new DescribeTrustStoreAssociationsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTrustStoreAssociationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
