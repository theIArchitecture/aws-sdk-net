...
namespace Amazon.ElasticLoadBalancingV2.Model.Internal.MarshallTransformations
{
    ...
    public class DescribeTrustStoreRevocationUnmarshaller : IXmlUnmarshaller<DescribeTrustStoreRevocation, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public DescribeTrustStoreRevocation Unmarshall(XmlUnmarshallerContext context)
        {
            DescribeTrustStoreRevocation unmarshalledObject = new DescribeTrustStoreRevocation();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTrustStoreRevocationUnmarshaller Instance
        {
            get
            {
                return _instance;
