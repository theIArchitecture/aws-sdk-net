...
{
    /// <summary>
    /// Response Unmarshaller for DescribeTrustStoreRevocations operation
    /// </summary>  
    public class DescribeTrustStoreRevocationsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeTrustStoreRevocationsResponse response = new DescribeTrustStoreRevocationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeTrustStoreRevocationsResult", 2))
                    {
        ...
        private static DescribeTrustStoreRevocationsResponseUnmarshaller _instance = new DescribeTrustStoreRevocationsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTrustStoreRevocationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
