...
{
    /// <summary>
    /// Response Unmarshaller for DescribeTrustStores operation
    /// </summary>  
    public class DescribeTrustStoresResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeTrustStoresResponse response = new DescribeTrustStoresResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeTrustStoresResult", 2))
                    {
        ...
        private static DescribeTrustStoresResponseUnmarshaller _instance = new DescribeTrustStoresResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTrustStoresResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
