...
{
    /// <summary>
    /// Response Unmarshaller for GetTrustStoreCaCertificatesBundle operation
    /// </summary>  
    public class GetTrustStoreCaCertificatesBundleResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTrustStoreCaCertificatesBundleResponse response = new GetTrustStoreCaCertificatesBundleResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("GetTrustStoreCaCertificatesBundleResult", 2))
                    {
        ...
        private static GetTrustStoreCaCertificatesBundleResponseUnmarshaller _instance = new GetTrustStoreCaCertificatesBundleResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTrustStoreCaCertificatesBundleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
