...
{
    /// <summary>
    /// ModifyIpPools Request Marshaller
    /// </summary>       
    public class ModifyIpPoolsRequestMarshaller : IMarshaller<IRequest, ModifyIpPoolsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ModifyIpPoolsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ModifyIpPoolsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ElasticLoadBalancingV2");
            request.Parameters.Add("Action", "ModifyIpPools");
            ...
            return request;
                    ...
                    private static ModifyIpPoolsRequestMarshaller _instance = new ModifyIpPoolsRequestMarshaller();        

        internal static ModifyIpPoolsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyIpPoolsRequestMarshaller Instance
        {
            get
            {
                return _instance;
