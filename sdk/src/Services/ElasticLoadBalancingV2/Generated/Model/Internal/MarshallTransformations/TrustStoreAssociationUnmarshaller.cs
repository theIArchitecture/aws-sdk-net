...
namespace Amazon.ElasticLoadBalancingV2.Model.Internal.MarshallTransformations
{
    ...
    public class TrustStoreAssociationUnmarshaller : IXmlUnmarshaller<TrustStoreAssociation, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public TrustStoreAssociation Unmarshall(XmlUnmarshallerContext context)
        {
            TrustStoreAssociation unmarshalledObject = new TrustStoreAssociation();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TrustStoreAssociationUnmarshaller Instance
        {
            get
            {
                return _instance;
