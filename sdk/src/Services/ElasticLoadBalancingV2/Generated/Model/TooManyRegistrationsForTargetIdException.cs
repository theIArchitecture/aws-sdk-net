...
namespace Amazon.ElasticLoadBalancingV2.Model
{
    ...
    public partial class TooManyRegistrationsForTargetIdException : AmazonElasticLoadBalancingV2Exception
    {
        ...
        public TooManyRegistrationsForTargetIdException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TooManyRegistrationsForTargetIdException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
