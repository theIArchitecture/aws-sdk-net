...
{
    /// <summary>
    /// Response Unmarshaller for GetClusterSessionCredentials operation
    /// </summary>  
    public class GetClusterSessionCredentialsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetClusterSessionCredentialsResponse response = new GetClusterSessionCredentialsResponse();
        ...
        private static GetClusterSessionCredentialsResponseUnmarshaller _instance = new GetClusterSessionCredentialsResponseUnmarshaller();        

        internal static GetClusterSessionCredentialsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetClusterSessionCredentialsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
