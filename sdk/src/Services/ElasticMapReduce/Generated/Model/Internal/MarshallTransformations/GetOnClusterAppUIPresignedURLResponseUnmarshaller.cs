...
{
    /// <summary>
    /// Response Unmarshaller for GetOnClusterAppUIPresignedURL operation
    /// </summary>  
    public class GetOnClusterAppUIPresignedURLResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetOnClusterAppUIPresignedURLResponse response = new GetOnClusterAppUIPresignedURLResponse();
        ...
        private static GetOnClusterAppUIPresignedURLResponseUnmarshaller _instance = new GetOnClusterAppUIPresignedURLResponseUnmarshaller();        

        internal static GetOnClusterAppUIPresignedURLResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetOnClusterAppUIPresignedURLResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
