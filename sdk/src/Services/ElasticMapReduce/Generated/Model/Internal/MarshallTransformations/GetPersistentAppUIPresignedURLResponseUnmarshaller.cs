...
{
    /// <summary>
    /// Response Unmarshaller for GetPersistentAppUIPresignedURL operation
    /// </summary>  
    public class GetPersistentAppUIPresignedURLResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPersistentAppUIPresignedURLResponse response = new GetPersistentAppUIPresignedURLResponse();
        ...
        private static GetPersistentAppUIPresignedURLResponseUnmarshaller _instance = new GetPersistentAppUIPresignedURLResponseUnmarshaller();        

        internal static GetPersistentAppUIPresignedURLResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPersistentAppUIPresignedURLResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
