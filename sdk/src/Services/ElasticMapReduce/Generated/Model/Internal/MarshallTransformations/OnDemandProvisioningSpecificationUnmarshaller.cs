...
namespace Amazon.ElasticMapReduce.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OnDemandProvisioningSpecificationUnmarshaller : IJsonUnmarshaller<OnDemandProvisioningSpecification, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public OnDemandProvisioningSpecification Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("CapacityReservationOptions", targetDepth))
                {
                    ...
                    unmarshalledObject.CapacityReservationOptions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
