...
{
    /// <summary>
    /// Response Unmarshaller for UpdateStudio operation
    /// </summary>  
    public class UpdateStudioResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateStudioResponseUnmarshaller _instance = new UpdateStudioResponseUnmarshaller();        

        internal static UpdateStudioResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateStudioResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
