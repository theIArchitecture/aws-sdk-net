...
namespace Amazon.ElasticMapReduce
{
    ...
    public partial interface IAmazonElasticMapReduce : IAmazonService, IDisposable
    {
        ...
        Task<CreatePersistentAppUIResponse> CreatePersistentAppUIAsync(CreatePersistentAppUIRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DescribePersistentAppUIResponse> DescribePersistentAppUIAsync(DescribePersistentAppUIRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetOnClusterAppUIPresignedURLResponse> GetOnClusterAppUIPresignedURLAsync(GetOnClusterAppUIPresignedURLRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetPersistentAppUIPresignedURLResponse> GetPersistentAppUIPresignedURLAsync(GetPersistentAppUIPresignedURLRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListSupportedInstanceTypesResponse> ListSupportedInstanceTypesAsync(ListSupportedInstanceTypesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<SetKeepJobFlowAliveWhenNoStepsResponse> SetKeepJobFlowAliveWhenNoStepsAsync(SetKeepJobFlowAliveWhenNoStepsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<SetUnhealthyNodeReplacementResponse> SetUnhealthyNodeReplacementAsync(SetUnhealthyNodeReplacementRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonElasticMapReduceConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonElasticMapReduceConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonElasticMapReduceConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonElasticMapReduceConfig to create AmazonElasticMapReduceClient");
            }

            return awsCredentials == null ? 
                    new AmazonElasticMapReduceClient(serviceClientConfig) :
                    new AmazonElasticMapReduceClient(awsCredentials, serviceClientConfig);
        }
