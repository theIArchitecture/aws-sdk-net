...
namespace Amazon.ElasticTranscoder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AudioCodecOptionsUnmarshaller : IJsonUnmarshaller<AudioCodecOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AudioCodecOptions Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.BitOrder = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.Signed = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
