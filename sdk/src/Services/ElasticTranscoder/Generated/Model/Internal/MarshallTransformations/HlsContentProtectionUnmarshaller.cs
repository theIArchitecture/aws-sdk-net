...
namespace Amazon.ElasticTranscoder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class HlsContentProtectionUnmarshaller : IJsonUnmarshaller<HlsContentProtection, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public HlsContentProtection Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.KeyStoragePolicy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
