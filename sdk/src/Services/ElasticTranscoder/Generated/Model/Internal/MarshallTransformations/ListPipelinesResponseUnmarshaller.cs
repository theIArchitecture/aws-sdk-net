    ...
    public class ListPipelinesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<Pipeline, PipelineUnmarshaller>(PipelineUnmarshaller.Instance);
                    response.Pipelines = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
