...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonElasticTranscoderConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonElasticTranscoderConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonElasticTranscoderConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonElasticTranscoderConfig to create AmazonElasticTranscoderClient");
            }

            return awsCredentials == null ? 
                    new AmazonElasticTranscoderClient(serviceClientConfig) :
                    new AmazonElasticTranscoderClient(awsCredentials, serviceClientConfig);
        }
