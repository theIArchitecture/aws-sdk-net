...
namespace Amazon.Elasticsearch.Internal
{
    ...
    public class AmazonElasticsearchAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonElasticsearchAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Elasticsearch.
        /// </summary>
        public AmazonElasticsearchAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonElasticsearchAuthSchemeParameters
            {
    ...
    public class AmazonElasticsearchAuthSchemeResolver : IAuthSchemeResolver<AmazonElasticsearchAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonElasticsearchAuthSchemeParameters authParameters)
        {
