...
{
    /// <summary>
    /// Response Unmarshaller for AuthorizeVpcEndpointAccess operation
    /// </summary>  
    public class AuthorizeVpcEndpointAccessResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AuthorizeVpcEndpointAccessResponse response = new AuthorizeVpcEndpointAccessResponse();
        ...
        private static AuthorizeVpcEndpointAccessResponseUnmarshaller _instance = new AuthorizeVpcEndpointAccessResponseUnmarshaller();        

        internal static AuthorizeVpcEndpointAccessResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AuthorizeVpcEndpointAccessResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
