...
namespace Amazon.Elasticsearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AutoTuneStatusUnmarshaller : IJsonUnmarshaller<AutoTuneStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AutoTuneStatus Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
