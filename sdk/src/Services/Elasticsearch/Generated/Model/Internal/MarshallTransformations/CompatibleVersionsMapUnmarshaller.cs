...
namespace Amazon.Elasticsearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CompatibleVersionsMapUnmarshaller : IJsonUnmarshaller<CompatibleVersionsMap, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CompatibleVersionsMap Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
