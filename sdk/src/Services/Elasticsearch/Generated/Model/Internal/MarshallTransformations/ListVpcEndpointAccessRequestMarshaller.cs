...
namespace Amazon.Elasticsearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListVpcEndpointAccessRequestMarshaller : IMarshaller<IRequest, ListVpcEndpointAccessRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(ListVpcEndpointAccessRequest publicRequest)
        {
            ...
            request.ResourcePath = "/2015-01-01/es/domain/{DomainName}/listVpcEndpointAccess";
            request.UseQueryString = true;

            return request;
        }
        private static ListVpcEndpointAccessRequestMarshaller _instance = new ListVpcEndpointAccessRequestMarshaller();        

        internal static ListVpcEndpointAccessRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListVpcEndpointAccessRequestMarshaller Instance
        {
            get
            {
                return _instance;
