...
{
    /// <summary>
    /// Response Unmarshaller for ListVpcEndpointAccess operation
    /// </summary>  
    public class ListVpcEndpointAccessResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListVpcEndpointAccessResponse response = new ListVpcEndpointAccessResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AuthorizedPrincipal, AuthorizedPrincipalUnmarshaller>(AuthorizedPrincipalUnmarshaller.Instance);
                    response.AuthorizedPrincipalList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListVpcEndpointAccessResponseUnmarshaller _instance = new ListVpcEndpointAccessResponseUnmarshaller();        

        internal static ListVpcEndpointAccessResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListVpcEndpointAccessResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
