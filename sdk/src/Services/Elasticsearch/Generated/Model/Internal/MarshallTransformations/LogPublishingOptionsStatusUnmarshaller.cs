...
namespace Amazon.Elasticsearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LogPublishingOptionsStatusUnmarshaller : IJsonUnmarshaller<LogPublishingOptionsStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LogPublishingOptionsStatus Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
