...
namespace Amazon.Elasticsearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ReservedElasticsearchInstanceOfferingUnmarshaller : IJsonUnmarshaller<ReservedElasticsearchInstanceOffering, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ReservedElasticsearchInstanceOffering Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
