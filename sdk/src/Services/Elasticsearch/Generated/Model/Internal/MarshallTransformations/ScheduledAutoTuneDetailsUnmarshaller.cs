...
namespace Amazon.Elasticsearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ScheduledAutoTuneDetailsUnmarshaller : IJsonUnmarshaller<ScheduledAutoTuneDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ScheduledAutoTuneDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
