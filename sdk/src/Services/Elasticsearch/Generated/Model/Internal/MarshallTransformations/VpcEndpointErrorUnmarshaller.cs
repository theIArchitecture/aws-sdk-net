...
{
    /// <summary>
    /// Response Unmarshaller for VpcEndpointError Object
    /// </summary>  
    public class VpcEndpointErrorUnmarshaller : IJsonUnmarshaller<VpcEndpointError, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public VpcEndpointError Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static VpcEndpointErrorUnmarshaller _instance = new VpcEndpointErrorUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static VpcEndpointErrorUnmarshaller Instance
        {
            get
            {
                return _instance;
