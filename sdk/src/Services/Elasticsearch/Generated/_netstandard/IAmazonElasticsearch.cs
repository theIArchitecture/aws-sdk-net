...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonElasticsearchConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonElasticsearchConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonElasticsearchConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonElasticsearchConfig to create AmazonElasticsearchClient");
            }

            return awsCredentials == null ? 
                    new AmazonElasticsearchClient(serviceClientConfig) :
                    new AmazonElasticsearchClient(awsCredentials, serviceClientConfig);
        }
