...
namespace Amazon.EntityResolution.Model
{
    ...
    public partial class ExceedsLimitException : AmazonEntityResolutionException
    {
        ...
        public ExceedsLimitException(string message, Exception innerException) 
        ...
        /// </summary>
        /// <param name="innerException"></param>
        public ExceedsLimitException(Exception innerException) 
            : base(innerException) {}
        ...
        public ExceedsLimitException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ExceedsLimitException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
            : base(message, errorType, errorCode, requestId, statusCode) {}


#if !NETSTANDARD
        /// <summary>
        /// Constructs a new instance of the ExceedsLimitException class with serialized data.
        /// </summary>
