...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateIdMappingWorkflowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateIdMappingWorkflowResponse response = new CreateIdMappingWorkflowResponse();
        ...
        private static CreateIdMappingWorkflowResponseUnmarshaller _instance = new CreateIdMappingWorkflowResponseUnmarshaller();        

        internal static CreateIdMappingWorkflowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateIdMappingWorkflowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
