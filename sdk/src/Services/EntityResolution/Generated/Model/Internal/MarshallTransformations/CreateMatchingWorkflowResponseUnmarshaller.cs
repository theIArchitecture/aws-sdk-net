...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateMatchingWorkflowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateMatchingWorkflowResponse response = new CreateMatchingWorkflowResponse();
        ...
        private static CreateMatchingWorkflowResponseUnmarshaller _instance = new CreateMatchingWorkflowResponseUnmarshaller();        

        internal static CreateMatchingWorkflowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMatchingWorkflowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
