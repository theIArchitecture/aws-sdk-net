...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateSchemaMappingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSchemaMappingResponse response = new CreateSchemaMappingResponse();
        ...
        private static CreateSchemaMappingResponseUnmarshaller _instance = new CreateSchemaMappingResponseUnmarshaller();        

        internal static CreateSchemaMappingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSchemaMappingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
