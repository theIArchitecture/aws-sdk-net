...
{
    /// <summary>
    /// Response Unmarshaller for GenerateMatchId operation
    /// </summary>  
    public class GenerateMatchIdResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GenerateMatchIdResponse response = new GenerateMatchIdResponse();
        ...
        private static GenerateMatchIdResponseUnmarshaller _instance = new GenerateMatchIdResponseUnmarshaller();        

        internal static GenerateMatchIdResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GenerateMatchIdResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
