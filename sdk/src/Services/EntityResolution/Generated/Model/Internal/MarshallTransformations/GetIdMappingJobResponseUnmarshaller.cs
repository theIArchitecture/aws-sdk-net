...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetIdMappingJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetIdMappingJobResponse response = new GetIdMappingJobResponse();
        ...
        internal static GetIdMappingJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetIdMappingJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
