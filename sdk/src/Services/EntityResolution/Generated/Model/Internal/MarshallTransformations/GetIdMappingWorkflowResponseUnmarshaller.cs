...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetIdMappingWorkflowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetIdMappingWorkflowResponse response = new GetIdMappingWorkflowResponse();
        ...
        private static GetIdMappingWorkflowResponseUnmarshaller _instance = new GetIdMappingWorkflowResponseUnmarshaller();        

        internal static GetIdMappingWorkflowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetIdMappingWorkflowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
