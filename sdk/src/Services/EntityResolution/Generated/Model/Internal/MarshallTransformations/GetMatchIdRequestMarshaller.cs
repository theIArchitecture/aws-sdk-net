...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetMatchIdRequestMarshaller : IMarshaller<IRequest, GetMatchIdRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetMatchIdRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetMatchIdRequest publicRequest)
        {
            ...
            request.ResourcePath = "/matchingworkflows/{workflowName}/matches";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetApplyNormalization())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.ApplyNormalization.Value);
            }
        ...
        private static GetMatchIdRequestMarshaller _instance = new GetMatchIdRequestMarshaller();        

        internal static GetMatchIdRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMatchIdRequestMarshaller Instance
        {
            get
            {
                return _instance;
