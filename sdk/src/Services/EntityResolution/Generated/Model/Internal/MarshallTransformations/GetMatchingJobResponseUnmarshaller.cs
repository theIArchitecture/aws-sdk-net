...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetMatchingJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMatchingJobResponse response = new GetMatchingJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = JobMetricsUnmarshaller.Instance;
                    response.Metrics = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("outputSourceConfig", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<JobOutputSource, JobOutputSourceUnmarshaller>(JobOutputSourceUnmarshaller.Instance);
        ...
        private static GetMatchingJobResponseUnmarshaller _instance = new GetMatchingJobResponseUnmarshaller();        

        internal static GetMatchingJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMatchingJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
