...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetMatchingWorkflowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMatchingWorkflowResponse response = new GetMatchingWorkflowResponse();
        ...
        private static GetMatchingWorkflowResponseUnmarshaller _instance = new GetMatchingWorkflowResponseUnmarshaller();        

        internal static GetMatchingWorkflowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMatchingWorkflowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
