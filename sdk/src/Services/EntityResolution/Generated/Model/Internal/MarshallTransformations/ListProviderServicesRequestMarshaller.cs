...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListProviderServicesRequestMarshaller : IMarshaller<IRequest, ListProviderServicesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListProviderServicesRequestMarshaller _instance = new ListProviderServicesRequestMarshaller();        

        internal static ListProviderServicesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListProviderServicesRequestMarshaller Instance
        {
            get
            {
                return _instance;
