...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ProviderPropertiesUnmarshaller : IJsonUnmarshaller<ProviderProperties, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ProviderProperties Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("intermediateSourceConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.IntermediateSourceConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
