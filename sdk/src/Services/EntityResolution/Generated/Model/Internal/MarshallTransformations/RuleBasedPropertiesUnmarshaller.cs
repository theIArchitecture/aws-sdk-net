...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RuleBasedPropertiesUnmarshaller : IJsonUnmarshaller<RuleBasedProperties, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RuleBasedProperties Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.MatchPurpose = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
