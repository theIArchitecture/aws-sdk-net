...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SchemaInputAttributeUnmarshaller : IJsonUnmarshaller<SchemaInputAttribute, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SchemaInputAttribute Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("hashed", targetDepth))
                {
                    ...
                    unmarshalledObject.Hashed = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("matchKey", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.MatchKey = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static SchemaInputAttributeUnmarshaller _instance = new SchemaInputAttributeUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SchemaInputAttributeUnmarshaller Instance
        {
            get
            {
                return _instance;
