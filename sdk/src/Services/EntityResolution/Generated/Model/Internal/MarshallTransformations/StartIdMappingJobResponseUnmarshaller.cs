...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartIdMappingJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartIdMappingJobResponse response = new StartIdMappingJobResponse();
        ...
        private static StartIdMappingJobResponseUnmarshaller _instance = new StartIdMappingJobResponseUnmarshaller();        

        internal static StartIdMappingJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartIdMappingJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
