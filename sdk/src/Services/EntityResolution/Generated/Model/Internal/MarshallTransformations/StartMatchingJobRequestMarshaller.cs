...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class StartMatchingJobRequestMarshaller : IMarshaller<IRequest, StartMatchingJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static StartMatchingJobRequestMarshaller _instance = new StartMatchingJobRequestMarshaller();        

        internal static StartMatchingJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartMatchingJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
