...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateIdMappingWorkflowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateIdMappingWorkflowResponse response = new UpdateIdMappingWorkflowResponse();
        ...
        private static UpdateIdMappingWorkflowResponseUnmarshaller _instance = new UpdateIdMappingWorkflowResponseUnmarshaller();        

        internal static UpdateIdMappingWorkflowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateIdMappingWorkflowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
