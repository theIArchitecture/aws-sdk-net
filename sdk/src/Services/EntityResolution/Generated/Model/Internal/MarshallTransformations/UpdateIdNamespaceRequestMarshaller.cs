...
{
    /// <summary>
    /// UpdateIdNamespace Request Marshaller
    /// </summary>       
    public class UpdateIdNamespaceRequestMarshaller : IMarshaller<IRequest, UpdateIdNamespaceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateIdNamespaceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateIdNamespaceRequest publicRequest)
        {
        ...
        private static UpdateIdNamespaceRequestMarshaller _instance = new UpdateIdNamespaceRequestMarshaller();        

        internal static UpdateIdNamespaceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateIdNamespaceRequestMarshaller Instance
        {
            get
            {
                return _instance;
