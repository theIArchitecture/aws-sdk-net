...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateMatchingWorkflowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateMatchingWorkflowResponse response = new UpdateMatchingWorkflowResponse();
        ...
        private static UpdateMatchingWorkflowResponseUnmarshaller _instance = new UpdateMatchingWorkflowResponseUnmarshaller();        

        internal static UpdateMatchingWorkflowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMatchingWorkflowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
