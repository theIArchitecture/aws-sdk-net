...
namespace Amazon.EntityResolution.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateSchemaMappingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSchemaMappingResponse response = new UpdateSchemaMappingResponse();
        ...
        internal static UpdateSchemaMappingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSchemaMappingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
