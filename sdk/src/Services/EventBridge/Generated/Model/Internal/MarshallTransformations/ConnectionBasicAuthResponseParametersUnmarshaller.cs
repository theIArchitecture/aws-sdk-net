...
namespace Amazon.EventBridge.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConnectionBasicAuthResponseParametersUnmarshaller : IJsonUnmarshaller<ConnectionBasicAuthResponseParameters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ConnectionBasicAuthResponseParameters Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
