...
namespace Amazon.EventBridge.Model.Internal.MarshallTransformations
{
    ...
    public class ConnectionOAuthResponseParametersUnmarshaller : IJsonUnmarshaller<ConnectionOAuthResponseParameters, JsonUnmarshallerContext>
    {
        ...
        private static ConnectionOAuthResponseParametersUnmarshaller _instance = new ConnectionOAuthResponseParametersUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ConnectionOAuthResponseParametersUnmarshaller Instance
        {
            get
            {
                return _instance;
