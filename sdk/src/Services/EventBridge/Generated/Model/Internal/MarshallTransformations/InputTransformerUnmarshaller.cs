...
namespace Amazon.EventBridge.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InputTransformerUnmarshaller : IJsonUnmarshaller<InputTransformer, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InputTransformer Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("InputPathsMap", targetDepth))
                {
                    ...
                    unmarshalledObject.InputPathsMap = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
