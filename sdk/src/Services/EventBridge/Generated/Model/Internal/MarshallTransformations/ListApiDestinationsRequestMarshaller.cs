...
namespace Amazon.EventBridge.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListApiDestinationsRequestMarshaller : IMarshaller<IRequest, ListApiDestinationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListApiDestinationsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListApiDestinationsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EventBridge");
            string target = "AWSEvents.ListApiDestinations";
        ...
        private static ListApiDestinationsRequestMarshaller _instance = new ListApiDestinationsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListApiDestinationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
