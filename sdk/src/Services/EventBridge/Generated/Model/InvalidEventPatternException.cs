...
namespace Amazon.EventBridge.Model
{
    ...
    public partial class InvalidEventPatternException : AmazonEventBridgeException
    {
        ...
        public InvalidEventPatternException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidEventPatternException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
