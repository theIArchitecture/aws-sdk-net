...
namespace Amazon.EventBridge
{
    ...
    public partial interface IAmazonEventBridge : IAmazonService, IDisposable
    {
        ...
        Task<UpdateEventBusResponse> UpdateEventBusAsync(UpdateEventBusRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonEventBridgeConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonEventBridgeConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonEventBridgeConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonEventBridgeConfig to create AmazonEventBridgeClient");
            }

            return awsCredentials == null ? 
                    new AmazonEventBridgeClient(serviceClientConfig) :
                    new AmazonEventBridgeClient(awsCredentials, serviceClientConfig);
        }
