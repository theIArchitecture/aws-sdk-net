...
namespace Amazon.Evs.Internal
{
    ...
    public class AmazonEvsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonEvsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Evs.
        /// </summary>
        public AmazonEvsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonEvsAuthSchemeParameters
            {
    ...
    public class AmazonEvsAuthSchemeResolver : IAuthSchemeResolver<AmazonEvsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonEvsAuthSchemeParameters authParameters)
        {
