...
namespace Amazon.FIS.Internal
{
    ...
    public class AmazonFISAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonFISAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for FIS.
        /// </summary>
        public AmazonFISAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonFISAuthSchemeParameters
            {
    ...
    public class AmazonFISAuthSchemeResolver : IAuthSchemeResolver<AmazonFISAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonFISAuthSchemeParameters authParameters)
        {
