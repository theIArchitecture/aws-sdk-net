...
{
    /// <summary>
    /// DeleteTargetAccountConfiguration Request Marshaller
    /// </summary>       
    public class DeleteTargetAccountConfigurationRequestMarshaller : IMarshaller<IRequest, DeleteTargetAccountConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteTargetAccountConfigurationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteTargetAccountConfigurationRequest publicRequest)
        {
        ...
        private static DeleteTargetAccountConfigurationRequestMarshaller _instance = new DeleteTargetAccountConfigurationRequestMarshaller();        

        internal static DeleteTargetAccountConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTargetAccountConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
