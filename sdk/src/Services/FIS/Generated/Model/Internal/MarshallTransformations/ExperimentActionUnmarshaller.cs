...
namespace Amazon.FIS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExperimentActionUnmarshaller : IJsonUnmarshaller<ExperimentAction, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ExperimentAction Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
