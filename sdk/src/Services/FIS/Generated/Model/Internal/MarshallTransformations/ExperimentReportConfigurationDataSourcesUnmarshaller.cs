...
namespace Amazon.FIS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExperimentReportConfigurationDataSourcesUnmarshaller : IJsonUnmarshaller<ExperimentReportConfigurationDataSources, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ExperimentReportConfigurationDataSources Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
