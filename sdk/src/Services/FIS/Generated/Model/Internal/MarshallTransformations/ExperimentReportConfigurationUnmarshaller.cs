...
namespace Amazon.FIS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExperimentReportConfigurationUnmarshaller : IJsonUnmarshaller<ExperimentReportConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ExperimentReportConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
