...
namespace Amazon.FIS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExperimentStateUnmarshaller : IJsonUnmarshaller<ExperimentState, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ExperimentState Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
