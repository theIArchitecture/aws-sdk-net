...
namespace Amazon.FIS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExperimentTemplateS3LogConfigurationUnmarshaller : IJsonUnmarshaller<ExperimentTemplateS3LogConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ExperimentTemplateS3LogConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
