...
{
    /// <summary>
    /// Response Unmarshaller for GetAction operation
    /// </summary>  
    public class GetActionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetActionResponseUnmarshaller _instance = new GetActionResponseUnmarshaller();        

        internal static GetActionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetActionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
