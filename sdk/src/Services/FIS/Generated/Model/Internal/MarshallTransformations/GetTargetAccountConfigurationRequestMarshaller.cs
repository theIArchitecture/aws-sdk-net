...
{
    /// <summary>
    /// GetTargetAccountConfiguration Request Marshaller
    /// </summary>       
    public class GetTargetAccountConfigurationRequestMarshaller : IMarshaller<IRequest, GetTargetAccountConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetTargetAccountConfigurationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetTargetAccountConfigurationRequest publicRequest)
        {
        ...
        private static GetTargetAccountConfigurationRequestMarshaller _instance = new GetTargetAccountConfigurationRequestMarshaller();        

        internal static GetTargetAccountConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTargetAccountConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
