...
namespace Amazon.FIS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListExperimentResolvedTargetsRequestMarshaller : IMarshaller<IRequest, ListExperimentResolvedTargetsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(ListExperimentResolvedTargetsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/experiments/{id}/resolvedTargets";
            request.UseQueryString = true;

            return request;
        }
        private static ListExperimentResolvedTargetsRequestMarshaller _instance = new ListExperimentResolvedTargetsRequestMarshaller();        

        internal static ListExperimentResolvedTargetsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListExperimentResolvedTargetsRequestMarshaller Instance
        {
            get
            {
                return _instance;
