...
{
    /// <summary>
    /// Response Unmarshaller for UpdateExperimentTemplate operation
    /// </summary>  
    public class UpdateExperimentTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateExperimentTemplateResponse response = new UpdateExperimentTemplateResponse();
        ...
        private static UpdateExperimentTemplateResponseUnmarshaller _instance = new UpdateExperimentTemplateResponseUnmarshaller();        

        internal static UpdateExperimentTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateExperimentTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
