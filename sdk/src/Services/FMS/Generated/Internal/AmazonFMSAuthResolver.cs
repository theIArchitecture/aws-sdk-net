...
namespace Amazon.FMS.Internal
{
    ...
    public class AmazonFMSAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonFMSAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for FMS.
        /// </summary>
        public AmazonFMSAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonFMSAuthSchemeParameters
            {
    ...
    public class AmazonFMSAuthSchemeResolver : IAuthSchemeResolver<AmazonFMSAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonFMSAuthSchemeParameters authParameters)
        {
