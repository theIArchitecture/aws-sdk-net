...
namespace Amazon.FMS.Model
{
    ...
    /// </summary>
    public partial class FMSPolicyUpdateFirewallCreationConfigAction
    {
        private string _description;
        private string _firewallCreationConfig;
        ...
        public string FirewallCreationConfig
        {
            ...
            set { this._firewallCreationConfig = value; }
        }

        // Check to see if FirewallCreationConfig property is set
        internal bool IsSetFirewallCreationConfig()
        {
            return this._firewallCreationConfig != null;
        }
