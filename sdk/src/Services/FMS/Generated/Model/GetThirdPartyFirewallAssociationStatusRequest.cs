...
{
    /// <summary>
    /// Container for the parameters to the GetThirdPartyFirewallAssociationStatus operation.
    /// The onboarding status of a Firewall Manager admin account to third-party firewall
    /// vendor tenant.
    /// </summary>
    public partial class GetThirdPartyFirewallAssociationStatusRequest : AmazonFMSRequest
    {
