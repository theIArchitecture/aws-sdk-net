...
namespace Amazon.FMS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PartialMatchUnmarshaller : IJsonUnmarshaller<PartialMatch, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PartialMatch Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("TargetViolationReasons", targetDepth))
                {
                    ...
                    unmarshalledObject.TargetViolationReasons = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
