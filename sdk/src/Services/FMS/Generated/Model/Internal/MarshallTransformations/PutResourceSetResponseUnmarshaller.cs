...
{
    /// <summary>
    /// Response Unmarshaller for PutResourceSet operation
    /// </summary>  
    public class PutResourceSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutResourceSetResponse response = new PutResourceSetResponse();
        ...
        private static PutResourceSetResponseUnmarshaller _instance = new PutResourceSetResponseUnmarshaller();        

        internal static PutResourceSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutResourceSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
