...
namespace Amazon.FSx.Internal
{
    ...
    public class AmazonFSxAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonFSxAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for FSx.
        /// </summary>
        public AmazonFSxAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonFSxAuthSchemeParameters
            {
    ...
    public class AmazonFSxAuthSchemeResolver : IAuthSchemeResolver<AmazonFSxAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonFSxAuthSchemeParameters authParameters)
        {
