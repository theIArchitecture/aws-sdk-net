...
namespace Amazon.FSx.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DataRepositoryConfigurationUnmarshaller : IJsonUnmarshaller<DataRepositoryConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DataRepositoryConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ExportPath = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ImportPath = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
