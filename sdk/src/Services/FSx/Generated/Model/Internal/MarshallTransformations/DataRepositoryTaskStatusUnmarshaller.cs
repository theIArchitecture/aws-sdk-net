...
namespace Amazon.FSx.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DataRepositoryTaskStatusUnmarshaller : IJsonUnmarshaller<DataRepositoryTaskStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DataRepositoryTaskStatus Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
                    unmarshalledObject.ReleasedCapacity = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
