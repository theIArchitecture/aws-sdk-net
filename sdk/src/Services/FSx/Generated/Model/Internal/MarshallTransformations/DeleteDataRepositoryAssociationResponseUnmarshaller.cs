...
{
    /// <summary>
    /// Response Unmarshaller for DeleteDataRepositoryAssociation operation
    /// </summary>  
    public class DeleteDataRepositoryAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDataRepositoryAssociationResponse response = new DeleteDataRepositoryAssociationResponse();
        ...
        private static DeleteDataRepositoryAssociationResponseUnmarshaller _instance = new DeleteDataRepositoryAssociationResponseUnmarshaller();        

        internal static DeleteDataRepositoryAssociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDataRepositoryAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
