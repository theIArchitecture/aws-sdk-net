...
namespace Amazon.FSx.Model.Internal.MarshallTransformations
{
    ...
    public class DeleteVolumeRequestMarshaller : IMarshaller<IRequest, DeleteVolumeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DeleteVolumeRequest publicRequest)
        {
            ...
            string target = "AWSSimbaAPIService_v20180301.DeleteVolume";
            ...
            if(publicRequest.IsSetOntapConfiguration())
            {
                ...
                var marshaller = DeleteVolumeOntapConfigurationMarshaller.Instance;
            ...
            if(publicRequest.IsSetOpenZFSConfiguration())
            {
                ...
                var marshaller = DeleteVolumeOpenZFSConfigurationMarshaller.Instance;
