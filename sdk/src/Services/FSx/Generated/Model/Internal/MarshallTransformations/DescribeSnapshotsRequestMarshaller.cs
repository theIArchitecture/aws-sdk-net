...
namespace Amazon.FSx.Model.Internal.MarshallTransformations
{
    ...
    public class DescribeSnapshotsRequestMarshaller : IMarshaller<IRequest, DescribeSnapshotsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DescribeSnapshotsRequest publicRequest)
        {
            ...
            string target = "AWSSimbaAPIService_v20180301.DescribeSnapshots";
            ...
            if(publicRequest.IsSetFilters())
            {
                ...
                foreach(var publicRequestFiltersListValue in publicRequest.Filters)
                {
                    ...
                    var marshaller = SnapshotFilterMarshaller.Instance;
            ...
            if(publicRequest.IsSetIncludeShared())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.IncludeShared.Value);
            }
            ...
            if(publicRequest.IsSetSnapshotIds())
            {
                ...
                {
                        context.Writer.WriteStringValue(publicRequestSnapshotIdsListValue);
                }
                context.Writer.WriteEndArray();
            }
