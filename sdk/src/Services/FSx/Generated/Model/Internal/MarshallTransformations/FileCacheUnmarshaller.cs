...
{
    /// <summary>
    /// Response Unmarshaller for FileCache Object
    /// </summary>  
    public class FileCacheUnmarshaller : IJsonUnmarshaller<FileCache, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FileCache Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static FileCacheUnmarshaller _instance = new FileCacheUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static FileCacheUnmarshaller Instance
        {
            get
            {
                return _instance;
