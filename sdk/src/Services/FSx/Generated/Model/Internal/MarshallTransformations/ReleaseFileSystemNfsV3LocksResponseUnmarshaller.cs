...
{
    /// <summary>
    /// Response Unmarshaller for ReleaseFileSystemNfsV3Locks operation
    /// </summary>  
    public class ReleaseFileSystemNfsV3LocksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ReleaseFileSystemNfsV3LocksResponse response = new ReleaseFileSystemNfsV3LocksResponse();
        ...
        private static ReleaseFileSystemNfsV3LocksResponseUnmarshaller _instance = new ReleaseFileSystemNfsV3LocksResponseUnmarshaller();        

        internal static ReleaseFileSystemNfsV3LocksResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ReleaseFileSystemNfsV3LocksResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
