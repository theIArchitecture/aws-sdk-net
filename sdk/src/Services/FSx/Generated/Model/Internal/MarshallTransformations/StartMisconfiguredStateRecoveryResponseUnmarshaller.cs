...
{
    /// <summary>
    /// Response Unmarshaller for StartMisconfiguredStateRecovery operation
    /// </summary>  
    public class StartMisconfiguredStateRecoveryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartMisconfiguredStateRecoveryResponse response = new StartMisconfiguredStateRecoveryResponse();
        ...
        private static StartMisconfiguredStateRecoveryResponseUnmarshaller _instance = new StartMisconfiguredStateRecoveryResponseUnmarshaller();        

        internal static StartMisconfiguredStateRecoveryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartMisconfiguredStateRecoveryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
