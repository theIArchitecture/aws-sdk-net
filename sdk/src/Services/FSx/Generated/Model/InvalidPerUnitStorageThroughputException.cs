...
namespace Amazon.FSx.Model
{
    ...
    public partial class InvalidPerUnitStorageThroughputException : AmazonFSxException
    {
        ...
        public InvalidPerUnitStorageThroughputException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidPerUnitStorageThroughputException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
