...
namespace Amazon.FSx.Model
{
    ...
    public partial class NotServiceResourceErrorException : AmazonFSxException
    {
        ...
        public NotServiceResourceErrorException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NotServiceResourceErrorException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
