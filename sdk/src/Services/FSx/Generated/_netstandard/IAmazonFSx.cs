...
namespace Amazon.FSx
{
    ...
    public partial interface IAmazonFSx : IAmazonService, IDisposable
    {
        ...
        Task<CreateAndAttachS3AccessPointResponse> CreateAndAttachS3AccessPointAsync(CreateAndAttachS3AccessPointRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DescribeS3AccessPointAttachmentsResponse> DescribeS3AccessPointAttachmentsAsync(DescribeS3AccessPointAttachmentsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DetachAndDeleteS3AccessPointResponse> DetachAndDeleteS3AccessPointAsync(DetachAndDeleteS3AccessPointRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StartMisconfiguredStateRecoveryResponse> StartMisconfiguredStateRecoveryAsync(StartMisconfiguredStateRecoveryRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonFSxConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonFSxConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonFSxConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonFSxConfig to create AmazonFSxClient");
            }

            return awsCredentials == null ? 
                    new AmazonFSxClient(serviceClientConfig) :
                    new AmazonFSxClient(awsCredentials, serviceClientConfig);
        }
