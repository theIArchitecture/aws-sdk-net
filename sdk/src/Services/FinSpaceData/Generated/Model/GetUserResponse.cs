...
namespace Amazon.FinSpaceData.Model
{
    ...
    public partial class GetUserResponse : AmazonWebServiceResponse
    {
        ...
        /// <para>
        /// Indicates whether the user can use the <c>GetProgrammaticAccessCredentials</c> API
        ...
        /// <para>
        /// Describes the last time the user was activated. The value is determined as epoch time
        /// in milliseconds.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// Describes the last time the user details were updated. The value is determined as
        /// epoch time in milliseconds.
        /// </para>
        /// </summary>
        ...
        ///  <ul> <li> 
        /// <para>
        ///  <c>CREATING</c> – The creation is in progress.
        /// </para>
        ///  </li> <li> 
        /// <para>
