...
{
    /// <summary>
    /// Response Unmarshaller for CreateDataView operation
    /// </summary>  
    public class CreateDataViewResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDataViewResponse response = new CreateDataViewResponse();
        ...
        private static CreateDataViewResponseUnmarshaller _instance = new CreateDataViewResponseUnmarshaller();        

        internal static CreateDataViewResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDataViewResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
