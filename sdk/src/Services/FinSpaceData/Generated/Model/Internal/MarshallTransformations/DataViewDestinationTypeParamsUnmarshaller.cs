...
namespace Amazon.FinSpaceData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DataViewDestinationTypeParamsUnmarshaller : IJsonUnmarshaller<DataViewDestinationTypeParams, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DataViewDestinationTypeParams Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.S3DestinationExportFileFormat = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("s3DestinationExportFileFormatOptions", targetDepth))
                {
                    var unmarshaller = new JsonDictionaryUnmarshaller<string, string, StringUnmarshaller, StringUnmarshaller>(StringUnmarshaller.Instance, StringUnmarshaller.Instance);
                    unmarshalledObject.S3DestinationExportFileFormatOptions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
