...
namespace Amazon.FinSpaceData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DataViewErrorInfoUnmarshaller : IJsonUnmarshaller<DataViewErrorInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DataViewErrorInfo Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
