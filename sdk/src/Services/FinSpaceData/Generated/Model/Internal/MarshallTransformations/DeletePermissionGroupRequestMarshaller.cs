...
{
    /// <summary>
    /// DeletePermissionGroup Request Marshaller
    /// </summary>       
    public class DeletePermissionGroupRequestMarshaller : IMarshaller<IRequest, DeletePermissionGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeletePermissionGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeletePermissionGroupRequest publicRequest)
        {
        ...
        private static DeletePermissionGroupRequestMarshaller _instance = new DeletePermissionGroupRequestMarshaller();        

        internal static DeletePermissionGroupRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePermissionGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
