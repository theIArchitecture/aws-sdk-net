...
{
    /// <summary>
    /// GetDataView Request Marshaller
    /// </summary>       
    public class GetDataViewRequestMarshaller : IMarshaller<IRequest, GetDataViewRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetDataViewRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetDataViewRequest publicRequest)
        {
            ...
            request.ResourcePath = "/datasets/{datasetId}/dataviewsv2/{dataviewId}";

            return request;
        }
        private static GetDataViewRequestMarshaller _instance = new GetDataViewRequestMarshaller();        

        internal static GetDataViewRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDataViewRequestMarshaller Instance
        {
            get
            {
                return _instance;
