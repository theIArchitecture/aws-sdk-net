...
namespace Amazon.FinSpaceData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PermissionGroupByUserUnmarshaller : IJsonUnmarshaller<PermissionGroupByUser, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PermissionGroupByUser Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
