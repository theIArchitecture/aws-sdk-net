...
namespace Amazon.FinSpaceData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PermissionGroupUnmarshaller : IJsonUnmarshaller<PermissionGroup, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PermissionGroup Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("applicationPermissions", targetDepth))
                {
                    ...
                    unmarshalledObject.ApplicationPermissions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PermissionGroupId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
