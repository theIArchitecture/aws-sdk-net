...
namespace Amazon.FinSpaceData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SchemaUnionUnmarshaller : IJsonUnmarshaller<SchemaUnion, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SchemaUnion Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
