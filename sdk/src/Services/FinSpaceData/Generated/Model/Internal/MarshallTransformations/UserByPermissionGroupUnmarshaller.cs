...
namespace Amazon.FinSpaceData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UserByPermissionGroupUnmarshaller : IJsonUnmarshaller<UserByPermissionGroup, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public UserByPermissionGroup Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
