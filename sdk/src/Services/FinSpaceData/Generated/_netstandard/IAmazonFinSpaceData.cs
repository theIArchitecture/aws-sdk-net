...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonFinSpaceDataConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonFinSpaceDataConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonFinSpaceDataConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonFinSpaceDataConfig to create AmazonFinSpaceDataClient");
            }

            return awsCredentials == null ? 
                    new AmazonFinSpaceDataClient(serviceClientConfig) :
                    new AmazonFinSpaceDataClient(awsCredentials, serviceClientConfig);
        }
