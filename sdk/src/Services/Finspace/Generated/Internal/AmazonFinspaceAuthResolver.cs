...
namespace Amazon.Finspace.Internal
{
    ...
    public class AmazonFinspaceAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonFinspaceAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Finspace.
        /// </summary>
        public AmazonFinspaceAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonFinspaceAuthSchemeParameters
            {
    ...
    public class AmazonFinspaceAuthSchemeResolver : IAuthSchemeResolver<AmazonFinspaceAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonFinspaceAuthSchemeParameters authParameters)
        {
