...
{
    /// <summary>
    /// CreateKxChangeset Request Marshaller
    /// </summary>       
    public class CreateKxChangesetRequestMarshaller : IMarshaller<IRequest, CreateKxChangesetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateKxChangesetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateKxChangesetRequest publicRequest)
        {
        ...
        private static CreateKxChangesetRequestMarshaller _instance = new CreateKxChangesetRequestMarshaller();        

        internal static CreateKxChangesetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateKxChangesetRequestMarshaller Instance
        {
            get
            {
                return _instance;
