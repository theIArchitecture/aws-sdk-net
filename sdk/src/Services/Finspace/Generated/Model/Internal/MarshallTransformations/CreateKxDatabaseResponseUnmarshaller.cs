...
{
    /// <summary>
    /// Response Unmarshaller for CreateKxDatabase operation
    /// </summary>  
    public class CreateKxDatabaseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateKxDatabaseResponse response = new CreateKxDatabaseResponse();
        ...
        private static CreateKxDatabaseResponseUnmarshaller _instance = new CreateKxDatabaseResponseUnmarshaller();        

        internal static CreateKxDatabaseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateKxDatabaseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
