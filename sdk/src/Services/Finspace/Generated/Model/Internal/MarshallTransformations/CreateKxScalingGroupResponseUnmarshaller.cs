...
{
    /// <summary>
    /// Response Unmarshaller for CreateKxScalingGroup operation
    /// </summary>  
    public class CreateKxScalingGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateKxScalingGroupResponse response = new CreateKxScalingGroupResponse();
        ...
        private static CreateKxScalingGroupResponseUnmarshaller _instance = new CreateKxScalingGroupResponseUnmarshaller();        

        internal static CreateKxScalingGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateKxScalingGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
