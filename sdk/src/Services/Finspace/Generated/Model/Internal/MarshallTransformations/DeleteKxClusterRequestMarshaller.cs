...
{
    /// <summary>
    /// DeleteKxCluster Request Marshaller
    /// </summary>       
    public class DeleteKxClusterRequestMarshaller : IMarshaller<IRequest, DeleteKxClusterRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteKxClusterRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteKxClusterRequest publicRequest)
        {
            ...
            request.ResourcePath = "/kx/environments/{environmentId}/clusters/{clusterName}";
            request.UseQueryString = true;

            return request;
        }
        private static DeleteKxClusterRequestMarshaller _instance = new DeleteKxClusterRequestMarshaller();        

        internal static DeleteKxClusterRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteKxClusterRequestMarshaller Instance
        {
            get
            {
                return _instance;
