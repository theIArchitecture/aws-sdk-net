...
{
    /// <summary>
    /// DeleteKxDatabase Request Marshaller
    /// </summary>       
    public class DeleteKxDatabaseRequestMarshaller : IMarshaller<IRequest, DeleteKxDatabaseRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteKxDatabaseRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteKxDatabaseRequest publicRequest)
        {
        ...
        private static DeleteKxDatabaseRequestMarshaller _instance = new DeleteKxDatabaseRequestMarshaller();        

        internal static DeleteKxDatabaseRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteKxDatabaseRequestMarshaller Instance
        {
            get
            {
                return _instance;
