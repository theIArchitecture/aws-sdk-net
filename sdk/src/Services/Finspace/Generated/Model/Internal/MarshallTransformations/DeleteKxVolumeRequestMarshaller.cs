...
{
    /// <summary>
    /// DeleteKxVolume Request Marshaller
    /// </summary>       
    public class DeleteKxVolumeRequestMarshaller : IMarshaller<IRequest, DeleteKxVolumeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteKxVolumeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteKxVolumeRequest publicRequest)
        {
        ...
        private static DeleteKxVolumeRequestMarshaller _instance = new DeleteKxVolumeRequestMarshaller();        

        internal static DeleteKxVolumeRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteKxVolumeRequestMarshaller Instance
        {
            get
            {
                return _instance;
