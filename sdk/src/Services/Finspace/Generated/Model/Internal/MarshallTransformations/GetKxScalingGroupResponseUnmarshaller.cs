...
{
    /// <summary>
    /// Response Unmarshaller for GetKxScalingGroup operation
    /// </summary>  
    public class GetKxScalingGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetKxScalingGroupResponse response = new GetKxScalingGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.HostType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ScalingGroupArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("scalingGroupName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ScalingGroupName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetKxScalingGroupResponseUnmarshaller _instance = new GetKxScalingGroupResponseUnmarshaller();        

        internal static GetKxScalingGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetKxScalingGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
