...
{
    /// <summary>
    /// GetKxUser Request Marshaller
    /// </summary>       
    public class GetKxUserRequestMarshaller : IMarshaller<IRequest, GetKxUserRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetKxUserRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetKxUserRequest publicRequest)
        {
        ...
        private static GetKxUserRequestMarshaller _instance = new GetKxUserRequestMarshaller();        

        internal static GetKxUserRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetKxUserRequestMarshaller Instance
        {
            get
            {
                return _instance;
