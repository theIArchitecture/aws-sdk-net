...
{
    /// <summary>
    /// Response Unmarshaller for GetKxUser operation
    /// </summary>  
    public class GetKxUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetKxUserResponse response = new GetKxUserResponse();
        ...
        private static GetKxUserResponseUnmarshaller _instance = new GetKxUserResponseUnmarshaller();        

        internal static GetKxUserResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetKxUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
