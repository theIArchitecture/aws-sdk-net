...
{
    /// <summary>
    /// Response Unmarshaller for KxDataviewActiveVersion Object
    /// </summary>  
    public class KxDataviewActiveVersionUnmarshaller : IJsonUnmarshaller<KxDataviewActiveVersion, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public KxDataviewActiveVersion Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            KxDataviewActiveVersion unmarshalledObject = new KxDataviewActiveVersion();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("attachedClusters", targetDepth))
                {
                    ...
                    unmarshalledObject.AttachedClusters = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static KxDataviewActiveVersionUnmarshaller _instance = new KxDataviewActiveVersionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static KxDataviewActiveVersionUnmarshaller Instance
        {
            get
            {
                return _instance;
