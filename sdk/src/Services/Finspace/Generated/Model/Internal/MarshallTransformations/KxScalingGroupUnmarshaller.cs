...
{
    /// <summary>
    /// Response Unmarshaller for KxScalingGroup Object
    /// </summary>  
    public class KxScalingGroupUnmarshaller : IJsonUnmarshaller<KxScalingGroup, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public KxScalingGroup Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            KxScalingGroup unmarshalledObject = new KxScalingGroup();
        ...
        private static KxScalingGroupUnmarshaller _instance = new KxScalingGroupUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static KxScalingGroupUnmarshaller Instance
        {
            get
            {
                return _instance;
