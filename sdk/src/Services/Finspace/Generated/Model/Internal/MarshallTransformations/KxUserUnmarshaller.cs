...
{
    /// <summary>
    /// Response Unmarshaller for KxUser Object
    /// </summary>  
    public class KxUserUnmarshaller : IJsonUnmarshaller<KxUser, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public KxUser Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            KxUser unmarshalledObject = new KxUser();
        ...
        private static KxUserUnmarshaller _instance = new KxUserUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static KxUserUnmarshaller Instance
        {
            get
            {
                return _instance;
