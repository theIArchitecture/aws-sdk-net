...
{
    /// <summary>
    /// ListKxChangesets Request Marshaller
    /// </summary>       
    public class ListKxChangesetsRequestMarshaller : IMarshaller<IRequest, ListKxChangesetsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListKxChangesetsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListKxChangesetsRequest publicRequest)
        {
        ...
        private static ListKxChangesetsRequestMarshaller _instance = new ListKxChangesetsRequestMarshaller();        

        internal static ListKxChangesetsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListKxChangesetsRequestMarshaller Instance
        {
            get
            {
                return _instance;
