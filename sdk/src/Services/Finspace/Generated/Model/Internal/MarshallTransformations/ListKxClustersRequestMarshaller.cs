...
{
    /// <summary>
    /// ListKxClusters Request Marshaller
    /// </summary>       
    public class ListKxClustersRequestMarshaller : IMarshaller<IRequest, ListKxClustersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListKxClustersRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListKxClustersRequest publicRequest)
        {
        ...
        private static ListKxClustersRequestMarshaller _instance = new ListKxClustersRequestMarshaller();        

        internal static ListKxClustersRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListKxClustersRequestMarshaller Instance
        {
            get
            {
                return _instance;
