...
{
    /// <summary>
    /// Response Unmarshaller for ListKxDataviews operation
    /// </summary>  
    public class ListKxDataviewsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListKxDataviewsResponse response = new ListKxDataviewsResponse();
        ...
        private static ListKxDataviewsResponseUnmarshaller _instance = new ListKxDataviewsResponseUnmarshaller();        

        internal static ListKxDataviewsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListKxDataviewsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
