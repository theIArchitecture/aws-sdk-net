...
{
    /// <summary>
    /// ListKxVolumes Request Marshaller
    /// </summary>       
    public class ListKxVolumesRequestMarshaller : IMarshaller<IRequest, ListKxVolumesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListKxVolumesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListKxVolumesRequest publicRequest)
        {
        ...
        private static ListKxVolumesRequestMarshaller _instance = new ListKxVolumesRequestMarshaller();        

        internal static ListKxVolumesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListKxVolumesRequestMarshaller Instance
        {
            get
            {
                return _instance;
