...
{
    /// <summary>
    /// UpdateKxClusterCodeConfiguration Request Marshaller
    /// </summary>       
    public class UpdateKxClusterCodeConfigurationRequestMarshaller : IMarshaller<IRequest, UpdateKxClusterCodeConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateKxClusterCodeConfigurationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateKxClusterCodeConfigurationRequest publicRequest)
        {
        ...
        private static UpdateKxClusterCodeConfigurationRequestMarshaller _instance = new UpdateKxClusterCodeConfigurationRequestMarshaller();        

        internal static UpdateKxClusterCodeConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateKxClusterCodeConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
