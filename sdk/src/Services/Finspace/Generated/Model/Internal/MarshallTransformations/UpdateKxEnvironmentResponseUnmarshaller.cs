...
{
    /// <summary>
    /// Response Unmarshaller for UpdateKxEnvironment operation
    /// </summary>  
    public class UpdateKxEnvironmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateKxEnvironmentResponse response = new UpdateKxEnvironmentResponse();
        ...
        private static UpdateKxEnvironmentResponseUnmarshaller _instance = new UpdateKxEnvironmentResponseUnmarshaller();        

        internal static UpdateKxEnvironmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateKxEnvironmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
