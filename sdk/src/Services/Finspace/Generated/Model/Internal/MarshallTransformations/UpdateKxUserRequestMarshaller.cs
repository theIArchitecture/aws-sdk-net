...
{
    /// <summary>
    /// UpdateKxUser Request Marshaller
    /// </summary>       
    public class UpdateKxUserRequestMarshaller : IMarshaller<IRequest, UpdateKxUserRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateKxUserRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateKxUserRequest publicRequest)
        {
        ...
        private static UpdateKxUserRequestMarshaller _instance = new UpdateKxUserRequestMarshaller();        

        internal static UpdateKxUserRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateKxUserRequestMarshaller Instance
        {
            get
            {
                return _instance;
