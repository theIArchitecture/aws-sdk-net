...
{
    /// <summary>
    /// Response Unmarshaller for UpdateKxUser operation
    /// </summary>  
    public class UpdateKxUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateKxUserResponse response = new UpdateKxUserResponse();
        ...
        private static UpdateKxUserResponseUnmarshaller _instance = new UpdateKxUserResponseUnmarshaller();        

        internal static UpdateKxUserResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateKxUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
