...
{
    /// <summary>
    /// UpdateKxVolume Request Marshaller
    /// </summary>       
    public class UpdateKxVolumeRequestMarshaller : IMarshaller<IRequest, UpdateKxVolumeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateKxVolumeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateKxVolumeRequest publicRequest)
        {
        ...
        private static UpdateKxVolumeRequestMarshaller _instance = new UpdateKxVolumeRequestMarshaller();        

        internal static UpdateKxVolumeRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateKxVolumeRequestMarshaller Instance
        {
            get
            {
                return _instance;
