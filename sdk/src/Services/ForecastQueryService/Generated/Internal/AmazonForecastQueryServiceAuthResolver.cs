...
namespace Amazon.ForecastQueryService.Internal
{
    ...
    public class AmazonForecastQueryServiceAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonForecastQueryServiceAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ForecastQueryService.
        /// </summary>
        public AmazonForecastQueryServiceAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonForecastQueryServiceAuthSchemeParameters
            {
    ...
    public class AmazonForecastQueryServiceAuthSchemeResolver : IAuthSchemeResolver<AmazonForecastQueryServiceAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonForecastQueryServiceAuthSchemeParameters authParameters)
        {
