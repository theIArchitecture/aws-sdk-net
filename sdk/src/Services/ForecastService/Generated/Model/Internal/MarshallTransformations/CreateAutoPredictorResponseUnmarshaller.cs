...
{
    /// <summary>
    /// Response Unmarshaller for CreateAutoPredictor operation
    /// </summary>  
    public class CreateAutoPredictorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAutoPredictorResponse response = new CreateAutoPredictorResponse();
        ...
        private static CreateAutoPredictorResponseUnmarshaller _instance = new CreateAutoPredictorResponseUnmarshaller();        

        internal static CreateAutoPredictorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAutoPredictorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
