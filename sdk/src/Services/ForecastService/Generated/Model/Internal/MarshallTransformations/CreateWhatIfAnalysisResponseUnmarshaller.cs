...
{
    /// <summary>
    /// Response Unmarshaller for CreateWhatIfAnalysis operation
    /// </summary>  
    public class CreateWhatIfAnalysisResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateWhatIfAnalysisResponse response = new CreateWhatIfAnalysisResponse();
        ...
        private static CreateWhatIfAnalysisResponseUnmarshaller _instance = new CreateWhatIfAnalysisResponseUnmarshaller();        

        internal static CreateWhatIfAnalysisResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWhatIfAnalysisResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
