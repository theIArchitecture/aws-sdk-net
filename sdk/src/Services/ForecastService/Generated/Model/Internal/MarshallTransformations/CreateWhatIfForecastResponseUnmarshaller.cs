...
{
    /// <summary>
    /// Response Unmarshaller for CreateWhatIfForecast operation
    /// </summary>  
    public class CreateWhatIfForecastResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateWhatIfForecastResponse response = new CreateWhatIfForecastResponse();
        ...
        private static CreateWhatIfForecastResponseUnmarshaller _instance = new CreateWhatIfForecastResponseUnmarshaller();        

        internal static CreateWhatIfForecastResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWhatIfForecastResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
