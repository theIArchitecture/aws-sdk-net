...
{
    /// <summary>
    /// Response Unmarshaller for DeleteResourceTree operation
    /// </summary>  
    public class DeleteResourceTreeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteResourceTreeResponse response = new DeleteResourceTreeResponse();
        ...
        private static DeleteResourceTreeResponseUnmarshaller _instance = new DeleteResourceTreeResponseUnmarshaller();        

        internal static DeleteResourceTreeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteResourceTreeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
