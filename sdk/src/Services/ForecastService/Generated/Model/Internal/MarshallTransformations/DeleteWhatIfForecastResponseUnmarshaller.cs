...
{
    /// <summary>
    /// Response Unmarshaller for DeleteWhatIfForecast operation
    /// </summary>  
    public class DeleteWhatIfForecastResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteWhatIfForecastResponse response = new DeleteWhatIfForecastResponse();
        ...
        private static DeleteWhatIfForecastResponseUnmarshaller _instance = new DeleteWhatIfForecastResponseUnmarshaller();        

        internal static DeleteWhatIfForecastResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteWhatIfForecastResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
