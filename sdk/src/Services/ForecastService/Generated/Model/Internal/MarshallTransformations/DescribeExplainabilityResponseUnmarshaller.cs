...
{
    /// <summary>
    /// Response Unmarshaller for DescribeExplainability operation
    /// </summary>  
    public class DescribeExplainabilityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeExplainabilityResponse response = new DescribeExplainabilityResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("EnableVisualization", targetDepth))
                {
                    ...
                    response.EnableVisualization = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("EndDateTime", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.EndDateTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("ExplainabilityConfig", targetDepth))
                {
                    ...
                    response.ExplainabilityConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ExplainabilityName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ExplainabilityName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.StartDateTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeExplainabilityResponseUnmarshaller _instance = new DescribeExplainabilityResponseUnmarshaller();        

        internal static DescribeExplainabilityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeExplainabilityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
