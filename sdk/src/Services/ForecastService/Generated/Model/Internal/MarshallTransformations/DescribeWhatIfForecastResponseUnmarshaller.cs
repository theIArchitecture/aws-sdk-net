...
{
    /// <summary>
    /// Response Unmarshaller for DescribeWhatIfForecast operation
    /// </summary>  
    public class DescribeWhatIfForecastResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeWhatIfForecastResponse response = new DescribeWhatIfForecastResponse();
        ...
        private static DescribeWhatIfForecastResponseUnmarshaller _instance = new DescribeWhatIfForecastResponseUnmarshaller();        

        internal static DescribeWhatIfForecastResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeWhatIfForecastResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
