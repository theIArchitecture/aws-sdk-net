...
namespace Amazon.ForecastService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExplainabilitySummaryUnmarshaller : IJsonUnmarshaller<ExplainabilitySummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ExplainabilitySummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ExplainabilityConfig", targetDepth))
                {
                    ...
                    unmarshalledObject.ExplainabilityConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ExplainabilityName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ExplainabilityName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
