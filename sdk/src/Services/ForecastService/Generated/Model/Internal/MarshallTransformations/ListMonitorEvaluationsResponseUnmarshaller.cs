...
{
    /// <summary>
    /// Response Unmarshaller for ListMonitorEvaluations operation
    /// </summary>  
    public class ListMonitorEvaluationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMonitorEvaluationsResponse response = new ListMonitorEvaluationsResponse();
        ...
        private static ListMonitorEvaluationsResponseUnmarshaller _instance = new ListMonitorEvaluationsResponseUnmarshaller();        

        internal static ListMonitorEvaluationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMonitorEvaluationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
