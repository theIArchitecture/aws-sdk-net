...
namespace Amazon.ForecastService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PredictorBacktestExportJobSummaryUnmarshaller : IJsonUnmarshaller<PredictorBacktestExportJobSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PredictorBacktestExportJobSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PredictorBacktestExportJobArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("PredictorBacktestExportJobName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PredictorBacktestExportJobName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
