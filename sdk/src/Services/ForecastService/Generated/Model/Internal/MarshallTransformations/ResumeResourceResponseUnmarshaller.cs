...
{
    /// <summary>
    /// Response Unmarshaller for ResumeResource operation
    /// </summary>  
    public class ResumeResourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ResumeResourceResponse response = new ResumeResourceResponse();
        ...
        private static ResumeResourceResponseUnmarshaller _instance = new ResumeResourceResponseUnmarshaller();        

        internal static ResumeResourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ResumeResourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
