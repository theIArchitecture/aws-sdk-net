...
namespace Amazon.ForecastService.Model
{
    ...
    public partial class ListForecastsRequest : AmazonForecastServiceRequest
    {
        ...
        /// To include the forecasts that match the statement, specify <c>IS</c>. To exclude matching
        /// forecasts, specify <c>IS_NOT</c>.
        /// </para>
        ///  </li> <li> 
        /// <para>
        ///  <c>Key</c> - The name of the parameter to filter on. Valid values are <c>DatasetGroupArn</c>,
        /// <c>PredictorArn</c>, and <c>Status</c>.
        /// </para>
        ///  </li> <li> 
        /// <para>
        ...
        ///  
        /// <para>
        ///  <c>"Filters": [ { "Condition": "IS_NOT", "Key": "Status", "Value": "ACTIVE" } ]</c>
        /// 
        /// </para>
        /// <para />
