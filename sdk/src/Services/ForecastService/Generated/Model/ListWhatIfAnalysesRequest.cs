...
{
    /// <summary>
    /// Container for the parameters to the ListWhatIfAnalyses operation.
    ...
    /// </summary>
    public partial class ListWhatIfAnalysesRequest : AmazonForecastServiceRequest
    {
        ...
        /// To exclude matching what-if analysis jobs, specify <c>IS_NOT</c>.
        /// </para>
        ///  </li> <li> 
        /// <para>
        ///  <c>Key</c> - The name of the parameter to filter on. Valid values are <c>WhatIfAnalysisArn</c>
        /// and <c>Status</c>.
        /// </para>
        ///  </li> <li> 
        /// <para>
        ...
        ///  </li> </ul> 
        /// <para>
        /// For example, to list all jobs that export a forecast named <i>electricityWhatIf</i>,
        /// specify the following filter:
        /// </para>
        ///  
        /// <para>
        ///  <c>"Filters": [ { "Condition": "IS", "Key": "WhatIfAnalysisArn", "Value": "arn:aws:forecast:us-west-2:&lt;acct-id&gt;:forecast/electricityWhatIf"
        /// } ]</c> 
        /// </para>
        /// <para />
