...
namespace Amazon.FraudDetector.Internal
{
    ...
    public class AmazonFraudDetectorAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonFraudDetectorAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for FraudDetector.
        /// </summary>
        public AmazonFraudDetectorAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonFraudDetectorAuthSchemeParameters
            {
    ...
    public class AmazonFraudDetectorAuthSchemeResolver : IAuthSchemeResolver<AmazonFraudDetectorAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonFraudDetectorAuthSchemeParameters authParameters)
        {
