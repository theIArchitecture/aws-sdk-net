...
{
    /// <summary>
    /// GetEventPredictionMetadata Request Marshaller
    /// </summary>       
    public class GetEventPredictionMetadataRequestMarshaller : IMarshaller<IRequest, GetEventPredictionMetadataRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetEventPredictionMetadataRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetEventPredictionMetadataRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.FraudDetector");
            string target = "AWSHawksNestServiceFacade.GetEventPredictionMetadata";
            ...
            if(publicRequest.IsSetPredictionTimestamp())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.PredictionTimestamp);
            }
        ...
        private static GetEventPredictionMetadataRequestMarshaller _instance = new GetEventPredictionMetadataRequestMarshaller();        

        internal static GetEventPredictionMetadataRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEventPredictionMetadataRequestMarshaller Instance
        {
            get
            {
                return _instance;
