...
namespace Amazon.FreeTier.Internal
{
    ...
    public class AmazonFreeTierAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonFreeTierAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for FreeTier.
        /// </summary>
        public AmazonFreeTierAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonFreeTierAuthSchemeParameters
            {
    ...
    public class AmazonFreeTierAuthSchemeResolver : IAuthSchemeResolver<AmazonFreeTierAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonFreeTierAuthSchemeParameters authParameters)
        {
