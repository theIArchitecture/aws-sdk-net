...
{
    /// <summary>
    /// Response Unmarshaller for ListAccountActivities operation
    /// </summary>  
    public class ListAccountActivitiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAccountActivitiesResponse response = new ListAccountActivitiesResponse();
        ...
        private static ListAccountActivitiesResponseUnmarshaller _instance = new ListAccountActivitiesResponseUnmarshaller();        

        internal static ListAccountActivitiesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAccountActivitiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
