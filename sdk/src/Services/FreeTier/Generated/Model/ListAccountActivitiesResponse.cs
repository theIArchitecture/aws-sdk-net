...
{
    /// <summary>
    /// This is the response object from the ListAccountActivities operation.
    /// </summary>
    public partial class ListAccountActivitiesResponse : AmazonWebServiceResponse
    {
        private List<ActivitySummary> _activities = AWSConfigs.InitializeCollections ? new List<ActivitySummary>() : null;
