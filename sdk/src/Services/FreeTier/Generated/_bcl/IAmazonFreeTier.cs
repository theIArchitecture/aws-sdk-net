...
namespace Amazon.FreeTier
{
    ...
    public partial interface IAmazonFreeTier : IAmazonService, IDisposable
    {
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/freetier-2023-09-07/GetAccountActivity">REST API Reference for GetAccountActivity Operation</seealso>
        Task<GetAccountActivityResponse> GetAccountActivityAsync(GetAccountActivityRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        GetAccountPlanStateResponse GetAccountPlanState(GetAccountPlanStateRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/freetier-2023-09-07/GetAccountPlanState">REST API Reference for GetAccountPlanState Operation</seealso>
        Task<GetAccountPlanStateResponse> GetAccountPlanStateAsync(GetAccountPlanStateRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/freetier-2023-09-07/GetFreeTierUsage">REST API Reference for GetFreeTierUsage Operation</seealso>
        Task<GetFreeTierUsageResponse> GetFreeTierUsageAsync(GetFreeTierUsageRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        ListAccountActivitiesResponse ListAccountActivities(ListAccountActivitiesRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/freetier-2023-09-07/ListAccountActivities">REST API Reference for ListAccountActivities Operation</seealso>
        Task<ListAccountActivitiesResponse> ListAccountActivitiesAsync(ListAccountActivitiesRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        UpgradeAccountPlanResponse UpgradeAccountPlan(UpgradeAccountPlanRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/freetier-2023-09-07/UpgradeAccountPlan">REST API Reference for UpgradeAccountPlan Operation</seealso>
        Task<UpgradeAccountPlanResponse> UpgradeAccountPlanAsync(UpgradeAccountPlanRequest request, CancellationToken cancellationToken = default(CancellationToken));
