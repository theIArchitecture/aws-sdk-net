...
namespace Amazon.GameLift.Internal
{
    ...
    public class AmazonGameLiftAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonGameLiftAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for GameLift.
        /// </summary>
        public AmazonGameLiftAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonGameLiftAuthSchemeParameters
            {
    ...
    public class AmazonGameLiftAuthSchemeResolver : IAuthSchemeResolver<AmazonGameLiftAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonGameLiftAuthSchemeParameters authParameters)
        {
