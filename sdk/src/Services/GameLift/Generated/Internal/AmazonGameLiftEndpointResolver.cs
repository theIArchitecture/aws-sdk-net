...
{
    /// <summary>
    /// Amazon GameLift endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for GameLift service requests.
    /// Collects values for GameLiftEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses GameLiftEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonGameLiftEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonGameLiftConfig)requestContext.ClientConfig;
            var result = new GameLiftEndpointParameters();
