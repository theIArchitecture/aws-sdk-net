...
namespace Amazon.GameLift.Model
{
    ...
    public partial class DeleteGameServerGroupRequest : AmazonGameLiftRequest
    {
        ...
        ///  <ul> <li> 
        /// <para>
        ///  <c>SAFE_DELETE</c> – (default) Terminates the game server group and Amazon EC2 Auto
        /// Scaling group only when it has no game servers that are in <c>UTILIZED</c> status.
        /// </para>
        ///  </li> <li> 
        /// <para>
        ///  <c>FORCE_DELETE</c> – Terminates the game server group, including all active game
        /// servers regardless of their utilization status, and the Amazon EC2 Auto Scaling group.
        /// 
        /// </para>
        ///  </li> <li> 
        /// <para>
        ///  <c>RETAIN</c> – Does a safe delete of the game server group but retains the Amazon
