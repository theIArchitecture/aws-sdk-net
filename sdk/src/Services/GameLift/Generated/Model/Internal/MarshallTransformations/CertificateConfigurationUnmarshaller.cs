...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CertificateConfigurationUnmarshaller : IJsonUnmarshaller<CertificateConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CertificateConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("CertificateType", targetDepth))
                {
                    ...
                    unmarshalledObject.CertificateType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
