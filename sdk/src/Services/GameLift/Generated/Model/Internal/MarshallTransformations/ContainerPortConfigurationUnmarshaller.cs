...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    public class ContainerPortConfigurationUnmarshaller : IJsonUnmarshaller<ContainerPortConfiguration, JsonUnmarshallerContext>
    {
        ...
        private static ContainerPortConfigurationUnmarshaller _instance = new ContainerPortConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ContainerPortConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
