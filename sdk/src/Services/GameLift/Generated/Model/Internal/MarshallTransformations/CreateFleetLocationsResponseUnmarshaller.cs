...
{
    /// <summary>
    /// Response Unmarshaller for CreateFleetLocations operation
    /// </summary>  
    public class CreateFleetLocationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateFleetLocationsResponse response = new CreateFleetLocationsResponse();
        ...
        private static CreateFleetLocationsResponseUnmarshaller _instance = new CreateFleetLocationsResponseUnmarshaller();        

        internal static CreateFleetLocationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateFleetLocationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
