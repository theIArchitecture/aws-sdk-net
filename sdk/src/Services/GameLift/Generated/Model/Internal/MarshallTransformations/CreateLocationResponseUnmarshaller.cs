...
{
    /// <summary>
    /// Response Unmarshaller for CreateLocation operation
    /// </summary>  
    public class CreateLocationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = LocationModelUnmarshaller.Instance;
        ...
        private static CreateLocationResponseUnmarshaller _instance = new CreateLocationResponseUnmarshaller();        

        internal static CreateLocationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLocationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
