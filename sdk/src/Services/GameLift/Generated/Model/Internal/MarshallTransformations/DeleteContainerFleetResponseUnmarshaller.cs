...
{
    /// <summary>
    /// Response Unmarshaller for DeleteContainerFleet operation
    /// </summary>  
    public class DeleteContainerFleetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteContainerFleetResponse response = new DeleteContainerFleetResponse();
        ...
        private static DeleteContainerFleetResponseUnmarshaller _instance = new DeleteContainerFleetResponseUnmarshaller();        

        internal static DeleteContainerFleetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteContainerFleetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
