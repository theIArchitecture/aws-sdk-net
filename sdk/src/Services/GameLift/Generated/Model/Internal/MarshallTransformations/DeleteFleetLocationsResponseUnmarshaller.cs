...
{
    /// <summary>
    /// Response Unmarshaller for DeleteFleetLocations operation
    /// </summary>  
    public class DeleteFleetLocationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteFleetLocationsResponse response = new DeleteFleetLocationsResponse();
        ...
        private static DeleteFleetLocationsResponseUnmarshaller _instance = new DeleteFleetLocationsResponseUnmarshaller();        

        internal static DeleteFleetLocationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteFleetLocationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
