...
{
    /// <summary>
    /// Response Unmarshaller for DeregisterCompute operation
    /// </summary>  
    public class DeregisterComputeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeregisterComputeResponse response = new DeregisterComputeResponse();
        ...
        private static DeregisterComputeResponseUnmarshaller _instance = new DeregisterComputeResponseUnmarshaller();        

        internal static DeregisterComputeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeregisterComputeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
