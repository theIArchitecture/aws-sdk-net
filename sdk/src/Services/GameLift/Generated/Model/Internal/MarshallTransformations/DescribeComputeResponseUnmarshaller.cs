...
{
    /// <summary>
    /// Response Unmarshaller for DescribeCompute operation
    /// </summary>  
    public class DescribeComputeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeComputeResponse response = new DescribeComputeResponse();
        ...
        private static DescribeComputeResponseUnmarshaller _instance = new DescribeComputeResponseUnmarshaller();        

        internal static DescribeComputeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeComputeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
