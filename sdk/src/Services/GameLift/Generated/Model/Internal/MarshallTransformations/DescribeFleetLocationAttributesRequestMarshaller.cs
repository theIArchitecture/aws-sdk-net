...
{
    /// <summary>
    /// DescribeFleetLocationAttributes Request Marshaller
    /// </summary>       
    public class DescribeFleetLocationAttributesRequestMarshaller : IMarshaller<IRequest, DescribeFleetLocationAttributesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeFleetLocationAttributesRequest)input);
        }
        ...
        internal static DescribeFleetLocationAttributesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeFleetLocationAttributesRequestMarshaller Instance
        {
            get
            {
                return _instance;
