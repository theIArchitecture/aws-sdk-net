    ...
    public class DescribeGameSessionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<GameSession, GameSessionUnmarshaller>(GameSessionUnmarshaller.Instance);
                    response.GameSessions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
