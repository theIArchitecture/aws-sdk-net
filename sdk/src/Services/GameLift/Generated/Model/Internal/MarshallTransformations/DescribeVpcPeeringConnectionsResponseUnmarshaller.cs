    ...
    public class DescribeVpcPeeringConnectionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<VpcPeeringConnection, VpcPeeringConnectionUnmarshaller>(VpcPeeringConnectionUnmarshaller.Instance);
                    response.VpcPeeringConnections = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
