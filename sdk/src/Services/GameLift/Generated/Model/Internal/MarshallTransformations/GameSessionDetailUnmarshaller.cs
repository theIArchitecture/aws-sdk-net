...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GameSessionDetailUnmarshaller : IJsonUnmarshaller<GameSessionDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GameSessionDetail Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("GameSession", targetDepth))
                {
                    ...
                    unmarshalledObject.GameSession = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ProtectionPolicy", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ProtectionPolicy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
