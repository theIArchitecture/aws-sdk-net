...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PlayerLatencyPolicyUnmarshaller : IJsonUnmarshaller<PlayerLatencyPolicy, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PlayerLatencyPolicy Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("MaximumIndividualPlayerLatencyMilliseconds", targetDepth))
                {
                    ...
                    unmarshalledObject.MaximumIndividualPlayerLatencyMilliseconds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("PolicyDurationSeconds", targetDepth))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.PolicyDurationSeconds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
