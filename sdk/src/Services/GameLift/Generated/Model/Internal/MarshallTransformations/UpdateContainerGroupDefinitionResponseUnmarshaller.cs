...
{
    /// <summary>
    /// Response Unmarshaller for UpdateContainerGroupDefinition operation
    /// </summary>  
    public class UpdateContainerGroupDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateContainerGroupDefinitionResponse response = new UpdateContainerGroupDefinitionResponse();
        ...
        private static UpdateContainerGroupDefinitionResponseUnmarshaller _instance = new UpdateContainerGroupDefinitionResponseUnmarshaller();        

        internal static UpdateContainerGroupDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateContainerGroupDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
