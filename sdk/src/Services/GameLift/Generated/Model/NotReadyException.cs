...
namespace Amazon.GameLift.Model
{
    ...
    [Serializable]
    #endif
    public partial class NotReadyException : AmazonGameLiftException
    {
        ...
        /// <summary>
        /// Construct instance of NotReadyException
        /// </summary>
        ...
        /// </summary>
        /// <param name="innerException"></param>
        public NotReadyException(Exception innerException) 
            : base(innerException) {}
        ...
        public NotReadyException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NotReadyException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
            : base(message, errorType, errorCode, requestId, statusCode) {}


#if !NETSTANDARD
        /// <summary>
        /// Constructs a new instance of the NotReadyException class with serialized data.
        /// </summary>
