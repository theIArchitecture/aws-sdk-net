...
namespace Amazon.GameLift.Model
{
    ...
    /// policy triggers Amazon GameLift Servers to adjust capacity so that the metric returns
    /// to the target value. The target configuration specifies settings as needed for the
