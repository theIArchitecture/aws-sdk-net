...
namespace Amazon.GameLiftStreams
{
    ...
    public partial class AmazonGameLiftStreamsConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("GameLiftStreams", "4.0.2.5");
        ...
        /// Default constructor
        /// </summary>
        public AmazonGameLiftStreamsConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonGameLiftStreamsDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "GameLiftStreams";
            this.AuthenticationServiceName = "gameliftstreams";
            this.EndpointProvider = new AmazonGameLiftStreamsEndpointProvider();
        }
