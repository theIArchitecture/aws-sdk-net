...
{
    /// <summary>
    /// Response Unmarshaller for AddStreamGroupLocations operation
    /// </summary>  
    public class AddStreamGroupLocationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AddStreamGroupLocationsResponse response = new AddStreamGroupLocationsResponse();
        ...
        private static AddStreamGroupLocationsResponseUnmarshaller _instance = new AddStreamGroupLocationsResponseUnmarshaller();        

        internal static AddStreamGroupLocationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddStreamGroupLocationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
