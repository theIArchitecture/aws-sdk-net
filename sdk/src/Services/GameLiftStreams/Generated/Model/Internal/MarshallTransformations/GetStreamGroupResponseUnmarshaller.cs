...
{
    /// <summary>
    /// Response Unmarshaller for GetStreamGroup operation
    /// </summary>  
    public class GetStreamGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetStreamGroupResponse response = new GetStreamGroupResponse();
        ...
        private static GetStreamGroupResponseUnmarshaller _instance = new GetStreamGroupResponseUnmarshaller();        

        internal static GetStreamGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetStreamGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
