...
{
    /// <summary>
    /// Response Unmarshaller for UpdateStreamGroup operation
    /// </summary>  
    public class UpdateStreamGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateStreamGroupResponse response = new UpdateStreamGroupResponse();
        ...
        private static UpdateStreamGroupResponseUnmarshaller _instance = new UpdateStreamGroupResponseUnmarshaller();        

        internal static UpdateStreamGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateStreamGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
