...
namespace Amazon.GameLiftStreams.Model
{
    ...
    internal sealed partial class ListApplicationsPaginator : IPaginator<ListApplicationsResponse>, IListApplicationsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<ApplicationSummary> Items => 
            new PaginatedResultKeyResponse<ListApplicationsResponse, ApplicationSummary>(this, (i) => i.Items ?? new List<ApplicationSummary>());

        internal ListApplicationsPaginator(IAmazonGameLiftStreams client, ListApplicationsRequest request)
        {
            this._client = client;
