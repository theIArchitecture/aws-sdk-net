...
namespace Amazon.GeoMaps.Internal
{
    ...
    public class AmazonGeoMapsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonGeoMapsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for GeoMaps.
        /// </summary>
        public AmazonGeoMapsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonGeoMapsAuthSchemeParameters
            {
    ...
    public class AmazonGeoMapsAuthSchemeResolver : IAuthSchemeResolver<AmazonGeoMapsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonGeoMapsAuthSchemeParameters authParameters)
        {
