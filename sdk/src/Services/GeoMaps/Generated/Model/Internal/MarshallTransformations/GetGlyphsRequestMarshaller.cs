...
namespace Amazon.GeoMaps.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetGlyphsRequestMarshaller : IMarshaller<IRequest, GetGlyphsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetGlyphsRequestMarshaller _instance = new GetGlyphsRequestMarshaller();        

        internal static GetGlyphsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGlyphsRequestMarshaller Instance
        {
            get
            {
                return _instance;
