...
namespace Amazon.GeoMaps.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetSpritesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSpritesResponse response = new GetSpritesResponse();
        ...
        internal static GetSpritesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSpritesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
