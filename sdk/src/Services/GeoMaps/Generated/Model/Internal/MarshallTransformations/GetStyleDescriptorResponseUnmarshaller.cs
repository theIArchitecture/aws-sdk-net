...
namespace Amazon.GeoMaps.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetStyleDescriptorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetStyleDescriptorResponse response = new GetStyleDescriptorResponse();
        ...
        internal static GetStyleDescriptorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetStyleDescriptorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
