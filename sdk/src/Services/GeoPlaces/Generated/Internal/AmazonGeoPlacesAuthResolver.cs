...
namespace Amazon.GeoPlaces.Internal
{
    ...
    public class AmazonGeoPlacesAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonGeoPlacesAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for GeoPlaces.
        /// </summary>
        public AmazonGeoPlacesAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonGeoPlacesAuthSchemeParameters
            {
    ...
    public class AmazonGeoPlacesAuthSchemeResolver : IAuthSchemeResolver<AmazonGeoPlacesAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonGeoPlacesAuthSchemeParameters authParameters)
        {
