...
{
    /// <summary>
    /// This is the response object from the Autocomplete operation.
    /// </summary>
    public partial class AutocompleteResponse : AmazonWebServiceResponse
    {
        private string _pricingBucket;
        private List<AutocompleteResultItem> _resultItems = AWSConfigs.InitializeCollections ? new List<AutocompleteResultItem>() : null;
        ...
        public List<AutocompleteResultItem> ResultItems
        {
