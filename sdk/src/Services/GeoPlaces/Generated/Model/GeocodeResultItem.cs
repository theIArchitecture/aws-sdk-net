...
namespace Amazon.GeoPlaces.Model
{
    ...
    public partial class GeocodeResultItem
    {
        ...
        /// </para>
        /// </summary>
        public MatchScoreDetails MatchScores
        {
            get { return this._matchScores; }
            set { this._matchScores = value; }
        }

        // Check to see if MatchScores property is set
        internal bool IsSetMatchScores()
        {
            return this._matchScores != null;
        }
