...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ComponentMatchScoresUnmarshaller : IJsonUnmarshaller<ComponentMatchScores, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ComponentMatchScores Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
