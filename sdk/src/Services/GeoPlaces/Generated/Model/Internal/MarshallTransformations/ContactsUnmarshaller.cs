...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ContactsUnmarshaller : IJsonUnmarshaller<Contacts, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Contacts Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
