...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CountryHighlightsUnmarshaller : IJsonUnmarshaller<CountryHighlights, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CountryHighlights Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
