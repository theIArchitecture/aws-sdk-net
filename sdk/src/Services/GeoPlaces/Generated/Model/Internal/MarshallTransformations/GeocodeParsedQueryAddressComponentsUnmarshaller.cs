...
{
    /// <summary>
    /// Response Unmarshaller for GeocodeParsedQueryAddressComponents Object
    /// </summary>  
    public class GeocodeParsedQueryAddressComponentsUnmarshaller : IJsonUnmarshaller<GeocodeParsedQueryAddressComponents, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GeocodeParsedQueryAddressComponents Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            GeocodeParsedQueryAddressComponents unmarshalledObject = new GeocodeParsedQueryAddressComponents();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ParsedQuerySecondaryAddressComponent, ParsedQuerySecondaryAddressComponentUnmarshaller>(ParsedQuerySecondaryAddressComponentUnmarshaller.Instance);
        ...
        private static GeocodeParsedQueryAddressComponentsUnmarshaller _instance = new GeocodeParsedQueryAddressComponentsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static GeocodeParsedQueryAddressComponentsUnmarshaller Instance
        {
            get
            {
                return _instance;
