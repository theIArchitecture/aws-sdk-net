...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GeocodeRequestMarshaller : IMarshaller<IRequest, GeocodeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GeocodeRequestMarshaller _instance = new GeocodeRequestMarshaller();        

        internal static GeocodeRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GeocodeRequestMarshaller Instance
        {
            get
            {
                return _instance;
