...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PhonemeDetailsUnmarshaller : IJsonUnmarshaller<PhonemeDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PhonemeDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
