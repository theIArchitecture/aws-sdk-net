...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ReverseGeocodeResultItemUnmarshaller : IJsonUnmarshaller<ReverseGeocodeResultItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            ReverseGeocodeResultItem unmarshalledObject = new ReverseGeocodeResultItem();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ReverseGeocodeResultItemUnmarshaller Instance
        {
            get
            {
                return _instance;
