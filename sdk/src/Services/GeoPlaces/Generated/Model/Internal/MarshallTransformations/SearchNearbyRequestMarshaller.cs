...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class SearchNearbyRequestMarshaller : IMarshaller<IRequest, SearchNearbyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(SearchNearbyRequest publicRequest)
        {
            ...
            request.ResourcePath = "/search-nearby";
#if !NETFRAMEWORK
        ...
        private static SearchNearbyRequestMarshaller _instance = new SearchNearbyRequestMarshaller();        

        internal static SearchNearbyRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchNearbyRequestMarshaller Instance
        {
            get
            {
                return _instance;
