...
namespace Amazon.GeoPlaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SearchNearbyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        internal static SearchNearbyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchNearbyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
