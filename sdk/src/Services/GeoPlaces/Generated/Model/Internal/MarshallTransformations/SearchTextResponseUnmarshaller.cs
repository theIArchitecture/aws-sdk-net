...
{
    /// <summary>
    /// Response Unmarshaller for SearchText operation
    /// </summary>  
    public class SearchTextResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SearchTextResultItem, SearchTextResultItemUnmarshaller>(SearchTextResultItemUnmarshaller.Instance);
        ...
        private static SearchTextResponseUnmarshaller _instance = new SearchTextResponseUnmarshaller();        

        internal static SearchTextResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchTextResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
