...
namespace Amazon.GeoRoutes.Internal
{
    ...
    public class AmazonGeoRoutesAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonGeoRoutesAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for GeoRoutes.
        /// </summary>
        public AmazonGeoRoutesAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonGeoRoutesAuthSchemeParameters
            {
    ...
    public class AmazonGeoRoutesAuthSchemeResolver : IAuthSchemeResolver<AmazonGeoRoutesAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonGeoRoutesAuthSchemeParameters authParameters)
        {
