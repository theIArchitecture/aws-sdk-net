...
{
    /// <summary>
    /// IsolineDestinationOptions Marshaller
    /// </summary>
    public class IsolineDestinationOptionsMarshaller : IRequestMarshaller<IsolineDestinationOptions, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(IsolineDestinationOptions requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetMatching())
            {
                ...
                var marshaller = IsolineMatchingOptionsMarshaller.Instance;
            ...
            if(requestObject.IsSetSideOfStreet())
            {
                ...
                var marshaller = IsolineSideOfStreetOptionsMarshaller.Instance;
        ...
        /// </summary>
        public readonly static IsolineDestinationOptionsMarshaller Instance = new IsolineDestinationOptionsMarshaller();
