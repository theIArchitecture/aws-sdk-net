...
{
    /// <summary>
    /// Response Unmarshaller for IsolineShapeGeometry Object
    /// </summary>  
    public class IsolineShapeGeometryUnmarshaller : IJsonUnmarshaller<IsolineShapeGeometry, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IsolineShapeGeometry Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            IsolineShapeGeometry unmarshalledObject = new IsolineShapeGeometry();
        ...
        private static IsolineShapeGeometryUnmarshaller _instance = new IsolineShapeGeometryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static IsolineShapeGeometryUnmarshaller Instance
        {
            get
            {
                return _instance;
