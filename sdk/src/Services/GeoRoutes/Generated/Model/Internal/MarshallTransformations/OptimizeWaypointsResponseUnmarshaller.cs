...
{
    /// <summary>
    /// Response Unmarshaller for OptimizeWaypoints operation
    /// </summary>  
    public class OptimizeWaypointsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            OptimizeWaypointsResponse response = new OptimizeWaypointsResponse();
        ...
        private static OptimizeWaypointsResponseUnmarshaller _instance = new OptimizeWaypointsResponseUnmarshaller();        

        internal static OptimizeWaypointsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static OptimizeWaypointsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
