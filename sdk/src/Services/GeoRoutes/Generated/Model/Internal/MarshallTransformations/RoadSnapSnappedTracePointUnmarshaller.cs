...
namespace Amazon.GeoRoutes.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RoadSnapSnappedTracePointUnmarshaller : IJsonUnmarshaller<RoadSnapSnappedTracePoint, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RoadSnapSnappedTracePoint Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<double, DoubleUnmarshaller>(DoubleUnmarshaller.Instance);
                    unmarshalledObject.SnappedPosition = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
