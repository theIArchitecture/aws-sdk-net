...
{
    /// <summary>
    /// Response Unmarshaller for RouteEnterHighwayStepDetails Object
    /// </summary>  
    public class RouteEnterHighwayStepDetailsUnmarshaller : IJsonUnmarshaller<RouteEnterHighwayStepDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RouteEnterHighwayStepDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            RouteEnterHighwayStepDetails unmarshalledObject = new RouteEnterHighwayStepDetails();
        ...
        private static RouteEnterHighwayStepDetailsUnmarshaller _instance = new RouteEnterHighwayStepDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RouteEnterHighwayStepDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
