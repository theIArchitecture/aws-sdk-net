...
{
    /// <summary>
    /// Response Unmarshaller for RouteExitStepDetails Object
    /// </summary>  
    public class RouteExitStepDetailsUnmarshaller : IJsonUnmarshaller<RouteExitStepDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RouteExitStepDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            RouteExitStepDetails unmarshalledObject = new RouteExitStepDetails();
        ...
        private static RouteExitStepDetailsUnmarshaller _instance = new RouteExitStepDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RouteExitStepDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
