...
namespace Amazon.GeoRoutes.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RouteLegUnmarshaller : IJsonUnmarshaller<RouteLeg, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            RouteLeg unmarshalledObject = new RouteLeg();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RouteLegUnmarshaller Instance
        {
            get
            {
                return _instance;
