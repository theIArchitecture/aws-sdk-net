...
{
    /// <summary>
    /// RouteMatrixAvoidanceOptions Marshaller
    /// </summary>
    public class RouteMatrixAvoidanceOptionsMarshaller : IRequestMarshaller<RouteMatrixAvoidanceOptions, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(RouteMatrixAvoidanceOptions requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetAreas())
            {
                ...
                foreach(var requestObjectAreasListValue in requestObject.Areas)
                {
                    ...
                    var marshaller = RouteMatrixAvoidanceAreaMarshaller.Instance;
            ...
            if(requestObject.IsSetZoneCategories())
            {
                ...
                foreach(var requestObjectZoneCategoriesListValue in requestObject.ZoneCategories)
                {
                    ...
                    var marshaller = RouteMatrixAvoidanceZoneCategoryMarshaller.Instance;
        ...
        /// </summary>
        public readonly static RouteMatrixAvoidanceOptionsMarshaller Instance = new RouteMatrixAvoidanceOptionsMarshaller();
