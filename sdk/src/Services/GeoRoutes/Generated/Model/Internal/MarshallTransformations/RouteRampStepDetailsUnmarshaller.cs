...
{
    /// <summary>
    /// Response Unmarshaller for RouteRampStepDetails Object
    /// </summary>  
    public class RouteRampStepDetailsUnmarshaller : IJsonUnmarshaller<RouteRampStepDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RouteRampStepDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            RouteRampStepDetails unmarshalledObject = new RouteRampStepDetails();
        ...
        private static RouteRampStepDetailsUnmarshaller _instance = new RouteRampStepDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RouteRampStepDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
