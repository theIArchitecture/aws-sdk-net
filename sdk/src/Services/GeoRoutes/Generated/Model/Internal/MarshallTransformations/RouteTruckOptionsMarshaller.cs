...
{
    /// <summary>
    /// RouteTruckOptions Marshaller
    /// </summary>
    public class RouteTruckOptionsMarshaller : IRequestMarshaller<RouteTruckOptions, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(RouteTruckOptions requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetTrailer())
            {
                ...
                var marshaller = RouteTrailerOptionsMarshaller.Instance;
        ...
        /// </summary>
        public readonly static RouteTruckOptionsMarshaller Instance = new RouteTruckOptionsMarshaller();
