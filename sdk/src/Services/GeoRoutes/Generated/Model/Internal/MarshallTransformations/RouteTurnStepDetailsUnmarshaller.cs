...
namespace Amazon.GeoRoutes.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RouteTurnStepDetailsUnmarshaller : IJsonUnmarshaller<RouteTurnStepDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            RouteTurnStepDetails unmarshalledObject = new RouteTurnStepDetails();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RouteTurnStepDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
