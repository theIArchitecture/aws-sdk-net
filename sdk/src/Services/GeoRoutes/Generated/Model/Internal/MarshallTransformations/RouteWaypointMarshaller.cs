...
{
    /// <summary>
    /// RouteWaypoint Marshaller
    /// </summary>
    public class RouteWaypointMarshaller : IRequestMarshaller<RouteWaypoint, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(RouteWaypoint requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetPassThrough())
            {
                ...
                context.Writer.WriteBooleanValue(requestObject.PassThrough.Value);
            }
        ...
        /// </summary>
        public readonly static RouteWaypointMarshaller Instance = new RouteWaypointMarshaller();
