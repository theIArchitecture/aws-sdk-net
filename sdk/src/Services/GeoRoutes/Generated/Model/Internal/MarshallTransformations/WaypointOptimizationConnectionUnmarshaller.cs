...
{
    /// <summary>
    /// Response Unmarshaller for WaypointOptimizationConnection Object
    /// </summary>  
    public class WaypointOptimizationConnectionUnmarshaller : IJsonUnmarshaller<WaypointOptimizationConnection, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public WaypointOptimizationConnection Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            WaypointOptimizationConnection unmarshalledObject = new WaypointOptimizationConnection();
        ...
        private static WaypointOptimizationConnectionUnmarshaller _instance = new WaypointOptimizationConnectionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static WaypointOptimizationConnectionUnmarshaller Instance
        {
            get
            {
                return _instance;
