...
namespace Amazon.GeoRoutes.Model
{
    ...
    {
        private List<long> _distance = AWSConfigs.InitializeCollections ? new List<long>() : null;
        private List<long> _time = AWSConfigs.InitializeCollections ? new List<long>() : null;
        ...
        {
            return this._distance != null && (this._distance.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
        ...
        {
            return this._time != null && (this._time.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
