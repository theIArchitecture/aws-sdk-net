...
namespace Amazon.GeoRoutes.Model
{
    ...
    /// </summary>
    public partial class WaypointOptimizationExclusionOptions
    {
        private List<string> _countries = AWSConfigs.InitializeCollections ? new List<string>() : null;
        ...
        // Check to see if Countries property is set
        internal bool IsSetCountries()
        {
            return this._countries != null && (this._countries.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
