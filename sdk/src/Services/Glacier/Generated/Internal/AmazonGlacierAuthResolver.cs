...
namespace Amazon.Glacier.Internal
{
    ...
    public class AmazonGlacierAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonGlacierAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Glacier.
        /// </summary>
        public AmazonGlacierAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonGlacierAuthSchemeParameters
            {
    ...
    public class AmazonGlacierAuthSchemeResolver : IAuthSchemeResolver<AmazonGlacierAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonGlacierAuthSchemeParameters authParameters)
        {
