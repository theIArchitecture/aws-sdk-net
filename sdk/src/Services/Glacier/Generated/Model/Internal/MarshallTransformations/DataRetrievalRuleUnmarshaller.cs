...
namespace Amazon.Glacier.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DataRetrievalRuleUnmarshaller : IJsonUnmarshaller<DataRetrievalRule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DataRetrievalRule Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("BytesPerHour", targetDepth))
                {
                    ...
                    unmarshalledObject.BytesPerHour = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
