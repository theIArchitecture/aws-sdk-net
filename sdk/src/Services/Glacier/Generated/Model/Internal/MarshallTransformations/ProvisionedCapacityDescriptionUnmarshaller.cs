...
namespace Amazon.Glacier.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ProvisionedCapacityDescriptionUnmarshaller : IJsonUnmarshaller<ProvisionedCapacityDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ProvisionedCapacityDescription Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("CapacityId", targetDepth))
                {
                    ...
                    unmarshalledObject.CapacityId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
