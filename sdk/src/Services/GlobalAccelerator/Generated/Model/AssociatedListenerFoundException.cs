...
namespace Amazon.GlobalAccelerator.Model
{
    ...
    public partial class AssociatedListenerFoundException : AmazonGlobalAcceleratorException
    {
        ...
        public AssociatedListenerFoundException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AssociatedListenerFoundException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
