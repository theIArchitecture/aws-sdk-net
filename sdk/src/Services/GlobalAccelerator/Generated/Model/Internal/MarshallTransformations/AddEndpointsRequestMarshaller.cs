...
{
    /// <summary>
    /// AddEndpoints Request Marshaller
    /// </summary>       
    public class AddEndpointsRequestMarshaller : IMarshaller<IRequest, AddEndpointsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AddEndpointsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AddEndpointsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.GlobalAccelerator");
            string target = "GlobalAccelerator_V20180706.AddEndpoints";
        ...
        private static AddEndpointsRequestMarshaller _instance = new AddEndpointsRequestMarshaller();        

        internal static AddEndpointsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddEndpointsRequestMarshaller Instance
        {
            get
            {
                return _instance;
