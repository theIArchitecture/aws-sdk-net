...
{
    /// <summary>
    /// Response Unmarshaller for AddEndpoints operation
    /// </summary>  
    public class AddEndpointsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AddEndpointsResponse response = new AddEndpointsResponse();
        ...
        private static AddEndpointsResponseUnmarshaller _instance = new AddEndpointsResponseUnmarshaller();        

        internal static AddEndpointsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddEndpointsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
