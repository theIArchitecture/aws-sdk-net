...
namespace Amazon.GlobalAccelerator.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ByoipCidrEventUnmarshaller : IJsonUnmarshaller<ByoipCidrEvent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ByoipCidrEvent Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
