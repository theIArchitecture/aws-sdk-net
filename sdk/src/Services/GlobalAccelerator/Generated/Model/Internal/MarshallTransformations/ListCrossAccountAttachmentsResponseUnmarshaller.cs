...
{
    /// <summary>
    /// Response Unmarshaller for ListCrossAccountAttachments operation
    /// </summary>  
    public class ListCrossAccountAttachmentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListCrossAccountAttachmentsResponse response = new ListCrossAccountAttachmentsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("CrossAccountAttachments", targetDepth))
                {
                    ...
                    response.CrossAccountAttachments = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListCrossAccountAttachmentsResponseUnmarshaller _instance = new ListCrossAccountAttachmentsResponseUnmarshaller();        

        internal static ListCrossAccountAttachmentsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCrossAccountAttachmentsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
