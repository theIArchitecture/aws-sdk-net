...
{
    /// <summary>
    /// Response Unmarshaller for ListCrossAccountResourceAccounts operation
    /// </summary>  
    public class ListCrossAccountResourceAccountsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListCrossAccountResourceAccountsResponse response = new ListCrossAccountResourceAccountsResponse();
        ...
        private static ListCrossAccountResourceAccountsResponseUnmarshaller _instance = new ListCrossAccountResourceAccountsResponseUnmarshaller();        

        internal static ListCrossAccountResourceAccountsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCrossAccountResourceAccountsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
