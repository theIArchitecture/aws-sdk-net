...
{
    /// <summary>
    /// Response Unmarshaller for ListCrossAccountResources operation
    /// </summary>  
    public class ListCrossAccountResourcesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListCrossAccountResourcesResponse response = new ListCrossAccountResourcesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<CrossAccountResource, CrossAccountResourceUnmarshaller>(CrossAccountResourceUnmarshaller.Instance);
                    response.CrossAccountResources = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListCrossAccountResourcesResponseUnmarshaller _instance = new ListCrossAccountResourcesResponseUnmarshaller();        

        internal static ListCrossAccountResourcesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCrossAccountResourcesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
