    ...
    public class ListCustomRoutingEndpointGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<CustomRoutingEndpointGroup, CustomRoutingEndpointGroupUnmarshaller>(CustomRoutingEndpointGroupUnmarshaller.Instance);
                    response.EndpointGroups = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
