...
namespace Amazon.GlobalAccelerator.Model
{
    ...
    [Serializable]
    #endif
    public partial class TransactionInProgressException : AmazonGlobalAcceleratorException
    {
        ...
        public TransactionInProgressException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TransactionInProgressException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
