...
namespace Amazon.Glue.Internal
{
    ...
    public class AmazonGlueAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonGlueAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Glue.
        /// </summary>
        public AmazonGlueAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonGlueAuthSchemeParameters
            {
    ...
    public class AmazonGlueAuthSchemeResolver : IAuthSchemeResolver<AmazonGlueAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonGlueAuthSchemeParameters authParameters)
        {
