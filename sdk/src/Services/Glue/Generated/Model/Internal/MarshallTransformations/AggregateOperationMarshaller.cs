    ...
    public class AggregateOperationMarshaller : IRequestMarshaller<AggregateOperation, JsonMarshallerContext> 
    {
        ...
        public void Marshall(AggregateOperation requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetAggFunc())
            {
                context.Writer.WritePropertyName("AggFunc");
                context.Writer.WriteStringValue(requestObject.AggFunc);
            }
            ...
            if(requestObject.IsSetColumn())
            {
                ...
                foreach(var requestObjectColumnListValue in requestObject.Column)
                {
                        context.Writer.WriteStringValue(requestObjectColumnListValue);
                }
