...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetBlueprints operation
    /// </summary>  
    public class BatchGetBlueprintsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchGetBlueprintsResponse response = new BatchGetBlueprintsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<Blueprint, BlueprintUnmarshaller>(BlueprintUnmarshaller.Instance);
                    response.Blueprints = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("MissingBlueprints", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.MissingBlueprints = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static BatchGetBlueprintsResponseUnmarshaller _instance = new BatchGetBlueprintsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetBlueprintsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
