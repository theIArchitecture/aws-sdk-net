...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetDataQualityResult operation
    /// </summary>  
    public class BatchGetDataQualityResultResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchGetDataQualityResultResponse response = new BatchGetDataQualityResultResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DataQualityResult, DataQualityResultUnmarshaller>(DataQualityResultUnmarshaller.Instance);
                    response.Results = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ResultsNotFound", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.ResultsNotFound = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static BatchGetDataQualityResultResponseUnmarshaller _instance = new BatchGetDataQualityResultResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetDataQualityResultResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
