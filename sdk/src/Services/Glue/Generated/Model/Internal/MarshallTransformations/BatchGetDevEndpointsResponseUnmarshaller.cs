    ...
    public class BatchGetDevEndpointsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DevEndpoint, DevEndpointUnmarshaller>(DevEndpointUnmarshaller.Instance);
                    response.DevEndpoints = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("DevEndpointsNotFound", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.DevEndpointsNotFound = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
