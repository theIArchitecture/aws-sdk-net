...
{
    /// <summary>
    /// Response Unmarshaller for BatchPutDataQualityStatisticAnnotation operation
    /// </summary>  
    public class BatchPutDataQualityStatisticAnnotationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchPutDataQualityStatisticAnnotationResponse response = new BatchPutDataQualityStatisticAnnotationResponse();
        ...
        private static BatchPutDataQualityStatisticAnnotationResponseUnmarshaller _instance = new BatchPutDataQualityStatisticAnnotationResponseUnmarshaller();        

        internal static BatchPutDataQualityStatisticAnnotationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchPutDataQualityStatisticAnnotationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
