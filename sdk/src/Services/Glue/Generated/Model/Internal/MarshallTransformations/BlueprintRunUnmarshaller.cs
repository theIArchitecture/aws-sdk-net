...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BlueprintRunUnmarshaller : IJsonUnmarshaller<BlueprintRun, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BlueprintRun Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RollbackErrorMessage = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
