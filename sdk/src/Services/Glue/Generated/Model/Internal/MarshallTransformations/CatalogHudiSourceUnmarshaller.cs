...
{
    /// <summary>
    /// Response Unmarshaller for CatalogHudiSource Object
    /// </summary>  
    public class CatalogHudiSourceUnmarshaller : IJsonUnmarshaller<CatalogHudiSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CatalogHudiSource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            CatalogHudiSource unmarshalledObject = new CatalogHudiSource();
        ...
        private static CatalogHudiSourceUnmarshaller _instance = new CatalogHudiSourceUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CatalogHudiSourceUnmarshaller Instance
        {
            get
            {
                return _instance;
