...
{
    /// <summary>
    /// CatalogKafkaSource Marshaller
    /// </summary>
    public class CatalogKafkaSourceMarshaller : IRequestMarshaller<CatalogKafkaSource, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(CatalogKafkaSource requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetStreamingOptions())
            {
                ...
                var marshaller = KafkaStreamingSourceOptionsMarshaller.Instance;
        ...
        /// </summary>
        public readonly static CatalogKafkaSourceMarshaller Instance = new CatalogKafkaSourceMarshaller();
