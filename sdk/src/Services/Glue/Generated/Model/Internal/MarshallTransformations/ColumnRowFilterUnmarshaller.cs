...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ColumnRowFilterUnmarshaller : IJsonUnmarshaller<ColumnRowFilter, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ColumnRowFilter Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RowFilterExpression = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
