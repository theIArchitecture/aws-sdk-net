...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConnectionPasswordEncryptionUnmarshaller : IJsonUnmarshaller<ConnectionPasswordEncryption, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ConnectionPasswordEncryption Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ReturnConnectionPasswordEncrypted", targetDepth))
                {
                    ...
                    unmarshalledObject.ReturnConnectionPasswordEncrypted = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
