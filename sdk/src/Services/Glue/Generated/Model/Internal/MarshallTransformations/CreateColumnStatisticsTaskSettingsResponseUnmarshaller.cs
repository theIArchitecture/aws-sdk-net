...
{
    /// <summary>
    /// Response Unmarshaller for CreateColumnStatisticsTaskSettings operation
    /// </summary>  
    public class CreateColumnStatisticsTaskSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateColumnStatisticsTaskSettingsResponse response = new CreateColumnStatisticsTaskSettingsResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("ColumnStatisticsTaskRunningException"))
                {
                    return ColumnStatisticsTaskRunningExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static CreateColumnStatisticsTaskSettingsResponseUnmarshaller _instance = new CreateColumnStatisticsTaskSettingsResponseUnmarshaller();        

        internal static CreateColumnStatisticsTaskSettingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateColumnStatisticsTaskSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
