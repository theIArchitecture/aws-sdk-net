...
{
    /// <summary>
    /// Response Unmarshaller for CreateCustomEntityType operation
    /// </summary>  
    public class CreateCustomEntityTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateCustomEntityTypeResponse response = new CreateCustomEntityTypeResponse();
        ...
        private static CreateCustomEntityTypeResponseUnmarshaller _instance = new CreateCustomEntityTypeResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCustomEntityTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
