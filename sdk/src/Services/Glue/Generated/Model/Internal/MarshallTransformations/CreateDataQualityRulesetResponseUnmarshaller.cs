...
{
    /// <summary>
    /// Response Unmarshaller for CreateDataQualityRuleset operation
    /// </summary>  
    public class CreateDataQualityRulesetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDataQualityRulesetResponse response = new CreateDataQualityRulesetResponse();
        ...
        private static CreateDataQualityRulesetResponseUnmarshaller _instance = new CreateDataQualityRulesetResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDataQualityRulesetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
