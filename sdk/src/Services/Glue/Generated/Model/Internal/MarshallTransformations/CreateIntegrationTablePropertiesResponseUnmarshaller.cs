...
{
    /// <summary>
    /// Response Unmarshaller for CreateIntegrationTableProperties operation
    /// </summary>  
    public class CreateIntegrationTablePropertiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateIntegrationTablePropertiesResponse response = new CreateIntegrationTablePropertiesResponse();
        ...
        private static CreateIntegrationTablePropertiesResponseUnmarshaller _instance = new CreateIntegrationTablePropertiesResponseUnmarshaller();        

        internal static CreateIntegrationTablePropertiesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateIntegrationTablePropertiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
