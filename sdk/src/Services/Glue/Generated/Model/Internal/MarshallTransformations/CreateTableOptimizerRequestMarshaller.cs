...
{
    /// <summary>
    /// CreateTableOptimizer Request Marshaller
    /// </summary>       
    public class CreateTableOptimizerRequestMarshaller : IMarshaller<IRequest, CreateTableOptimizerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateTableOptimizerRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateTableOptimizerRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Glue");
            string target = "AWSGlue.CreateTableOptimizer";
        ...
        private static CreateTableOptimizerRequestMarshaller _instance = new CreateTableOptimizerRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTableOptimizerRequestMarshaller Instance
        {
            get
            {
                return _instance;
