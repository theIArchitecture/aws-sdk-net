...
{
    /// <summary>
    /// Response Unmarshaller for CreateUsageProfile operation
    /// </summary>  
    public class CreateUsageProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateUsageProfileResponse response = new CreateUsageProfileResponse();
        ...
        private static CreateUsageProfileResponseUnmarshaller _instance = new CreateUsageProfileResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateUsageProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
