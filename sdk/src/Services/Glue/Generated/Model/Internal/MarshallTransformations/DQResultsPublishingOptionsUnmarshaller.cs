...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DQResultsPublishingOptionsUnmarshaller : IJsonUnmarshaller<DQResultsPublishingOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DQResultsPublishingOptions Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    unmarshalledObject.ResultsPublishingEnabled = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
