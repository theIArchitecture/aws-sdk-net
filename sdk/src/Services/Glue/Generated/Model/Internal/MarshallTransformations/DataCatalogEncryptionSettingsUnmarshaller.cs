...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DataCatalogEncryptionSettingsUnmarshaller : IJsonUnmarshaller<DataCatalogEncryptionSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DataCatalogEncryptionSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ConnectionPasswordEncryption", targetDepth))
                {
                    ...
                    unmarshalledObject.ConnectionPasswordEncryption = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
