...
{
    /// <summary>
    /// Response Unmarshaller for DeleteCatalog operation
    /// </summary>  
    public class DeleteCatalogResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteCatalogResponseUnmarshaller _instance = new DeleteCatalogResponseUnmarshaller();        

        internal static DeleteCatalogResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCatalogResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
