...
{
    /// <summary>
    /// Response Unmarshaller for DeleteColumnStatisticsTaskSettings operation
    /// </summary>  
    public class DeleteColumnStatisticsTaskSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteColumnStatisticsTaskSettingsResponse response = new DeleteColumnStatisticsTaskSettingsResponse();
        ...
        private static DeleteColumnStatisticsTaskSettingsResponseUnmarshaller _instance = new DeleteColumnStatisticsTaskSettingsResponseUnmarshaller();        

        internal static DeleteColumnStatisticsTaskSettingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteColumnStatisticsTaskSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
