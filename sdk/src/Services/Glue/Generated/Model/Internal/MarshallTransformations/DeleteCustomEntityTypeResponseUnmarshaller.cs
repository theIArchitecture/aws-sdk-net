...
{
    /// <summary>
    /// Response Unmarshaller for DeleteCustomEntityType operation
    /// </summary>  
    public class DeleteCustomEntityTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteCustomEntityTypeResponse response = new DeleteCustomEntityTypeResponse();
        ...
        private static DeleteCustomEntityTypeResponseUnmarshaller _instance = new DeleteCustomEntityTypeResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCustomEntityTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
