...
{
    /// <summary>
    /// Response Unmarshaller for DeleteIntegrationTableProperties operation
    /// </summary>  
    public class DeleteIntegrationTablePropertiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteIntegrationTablePropertiesResponse response = new DeleteIntegrationTablePropertiesResponse();
        ...
        private static DeleteIntegrationTablePropertiesResponseUnmarshaller _instance = new DeleteIntegrationTablePropertiesResponseUnmarshaller();        

        internal static DeleteIntegrationTablePropertiesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteIntegrationTablePropertiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
