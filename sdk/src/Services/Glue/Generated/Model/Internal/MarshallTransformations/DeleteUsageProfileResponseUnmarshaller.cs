...
{
    /// <summary>
    /// Response Unmarshaller for DeleteUsageProfile operation
    /// </summary>  
    public class DeleteUsageProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteUsageProfileResponse response = new DeleteUsageProfileResponse();
        ...
        private static DeleteUsageProfileResponseUnmarshaller _instance = new DeleteUsageProfileResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteUsageProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
