...
{
    /// <summary>
    /// DynamoDBCatalogSource Marshaller
    /// </summary>
    public class DynamoDBCatalogSourceMarshaller : IRequestMarshaller<DynamoDBCatalogSource, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(DynamoDBCatalogSource requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static DynamoDBCatalogSourceMarshaller Instance = new DynamoDBCatalogSourceMarshaller();
