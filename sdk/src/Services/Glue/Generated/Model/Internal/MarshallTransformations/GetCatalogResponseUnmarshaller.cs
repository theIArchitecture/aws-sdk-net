...
{
    /// <summary>
    /// Response Unmarshaller for GetCatalog operation
    /// </summary>  
    public class GetCatalogResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetCatalogResponseUnmarshaller _instance = new GetCatalogResponseUnmarshaller();        

        internal static GetCatalogResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCatalogResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
