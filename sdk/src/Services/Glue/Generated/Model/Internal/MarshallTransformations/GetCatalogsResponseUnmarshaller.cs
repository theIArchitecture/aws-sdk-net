...
{
    /// <summary>
    /// Response Unmarshaller for GetCatalogs operation
    /// </summary>  
    public class GetCatalogsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCatalogsResponse response = new GetCatalogsResponse();
        ...
        private static GetCatalogsResponseUnmarshaller _instance = new GetCatalogsResponseUnmarshaller();        

        internal static GetCatalogsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCatalogsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
