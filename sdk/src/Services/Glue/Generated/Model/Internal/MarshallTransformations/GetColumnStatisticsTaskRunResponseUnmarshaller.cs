...
{
    /// <summary>
    /// Response Unmarshaller for GetColumnStatisticsTaskRun operation
    /// </summary>  
    public class GetColumnStatisticsTaskRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetColumnStatisticsTaskRunResponse response = new GetColumnStatisticsTaskRunResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ColumnStatisticsTaskRun", targetDepth))
                {
                    var unmarshaller = ColumnStatisticsTaskRunUnmarshaller.Instance;
                    response.ColumnStatisticsTaskRun = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetColumnStatisticsTaskRunResponseUnmarshaller _instance = new GetColumnStatisticsTaskRunResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetColumnStatisticsTaskRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
