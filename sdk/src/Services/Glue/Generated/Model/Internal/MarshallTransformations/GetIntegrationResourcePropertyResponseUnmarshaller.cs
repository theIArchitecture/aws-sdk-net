...
{
    /// <summary>
    /// Response Unmarshaller for GetIntegrationResourceProperty operation
    /// </summary>  
    public class GetIntegrationResourcePropertyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetIntegrationResourcePropertyResponse response = new GetIntegrationResourcePropertyResponse();
        ...
        private static GetIntegrationResourcePropertyResponseUnmarshaller _instance = new GetIntegrationResourcePropertyResponseUnmarshaller();        

        internal static GetIntegrationResourcePropertyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetIntegrationResourcePropertyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
