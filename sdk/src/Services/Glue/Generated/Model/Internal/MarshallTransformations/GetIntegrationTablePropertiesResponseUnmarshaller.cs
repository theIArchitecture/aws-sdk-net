...
{
    /// <summary>
    /// Response Unmarshaller for GetIntegrationTableProperties operation
    /// </summary>  
    public class GetIntegrationTablePropertiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetIntegrationTablePropertiesResponse response = new GetIntegrationTablePropertiesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SourceTableConfig", targetDepth))
                {
                    var unmarshaller = SourceTableConfigUnmarshaller.Instance;
                    response.SourceTableConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("TargetTableConfig", targetDepth))
                {
                    var unmarshaller = TargetTableConfigUnmarshaller.Instance;
                    response.TargetTableConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetIntegrationTablePropertiesResponseUnmarshaller _instance = new GetIntegrationTablePropertiesResponseUnmarshaller();        

        internal static GetIntegrationTablePropertiesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetIntegrationTablePropertiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
