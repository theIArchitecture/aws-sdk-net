    ...
    public class GetPartitionIndexesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<PartitionIndexDescriptor, PartitionIndexDescriptorUnmarshaller>(PartitionIndexDescriptorUnmarshaller.Instance);
                    response.PartitionIndexDescriptorList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
