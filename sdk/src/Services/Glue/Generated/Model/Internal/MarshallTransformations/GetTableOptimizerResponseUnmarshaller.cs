...
{
    /// <summary>
    /// Response Unmarshaller for GetTableOptimizer operation
    /// </summary>  
    public class GetTableOptimizerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTableOptimizerResponse response = new GetTableOptimizerResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("TableOptimizer", targetDepth))
                {
                    ...
                    response.TableOptimizer = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetTableOptimizerResponseUnmarshaller _instance = new GetTableOptimizerResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTableOptimizerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
