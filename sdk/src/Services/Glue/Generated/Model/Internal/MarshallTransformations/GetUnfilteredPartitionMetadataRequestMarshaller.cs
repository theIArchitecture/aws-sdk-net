...
{
    /// <summary>
    /// GetUnfilteredPartitionMetadata Request Marshaller
    /// </summary>       
    public class GetUnfilteredPartitionMetadataRequestMarshaller : IMarshaller<IRequest, GetUnfilteredPartitionMetadataRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetUnfilteredPartitionMetadataRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetUnfilteredPartitionMetadataRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Glue");
            string target = "AWSGlue.GetUnfilteredPartitionMetadata";
        ...
        private static GetUnfilteredPartitionMetadataRequestMarshaller _instance = new GetUnfilteredPartitionMetadataRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetUnfilteredPartitionMetadataRequestMarshaller Instance
        {
            get
            {
                return _instance;
