...
{
    /// <summary>
    /// Response Unmarshaller for GetUnfilteredPartitionMetadata operation
    /// </summary>  
    public class GetUnfilteredPartitionMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetUnfilteredPartitionMetadataResponse response = new GetUnfilteredPartitionMetadataResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Partition", targetDepth))
                {
                    ...
                    response.Partition = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetUnfilteredPartitionMetadataResponseUnmarshaller _instance = new GetUnfilteredPartitionMetadataResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetUnfilteredPartitionMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
