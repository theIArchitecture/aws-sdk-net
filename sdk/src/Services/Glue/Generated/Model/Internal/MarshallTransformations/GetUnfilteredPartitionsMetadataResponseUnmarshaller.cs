...
{
    /// <summary>
    /// Response Unmarshaller for GetUnfilteredPartitionsMetadata operation
    /// </summary>  
    public class GetUnfilteredPartitionsMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetUnfilteredPartitionsMetadataResponse response = new GetUnfilteredPartitionsMetadataResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<UnfilteredPartition, UnfilteredPartitionUnmarshaller>(UnfilteredPartitionUnmarshaller.Instance);
                    response.UnfilteredPartitions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetUnfilteredPartitionsMetadataResponseUnmarshaller _instance = new GetUnfilteredPartitionsMetadataResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetUnfilteredPartitionsMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
