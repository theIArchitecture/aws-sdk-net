...
{
    /// <summary>
    /// Response Unmarshaller for GetUsageProfile operation
    /// </summary>  
    public class GetUsageProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetUsageProfileResponse response = new GetUsageProfileResponse();
        ...
        private static GetUsageProfileResponseUnmarshaller _instance = new GetUsageProfileResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetUsageProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
