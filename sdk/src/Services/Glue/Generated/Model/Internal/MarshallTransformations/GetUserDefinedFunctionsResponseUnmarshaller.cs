    ...
    public class GetUserDefinedFunctionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<UserDefinedFunction, UserDefinedFunctionUnmarshaller>(UserDefinedFunctionUnmarshaller.Instance);
                    response.UserDefinedFunctions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
