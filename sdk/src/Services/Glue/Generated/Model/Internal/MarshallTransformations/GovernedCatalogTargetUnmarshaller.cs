...
{
    /// <summary>
    /// Response Unmarshaller for GovernedCatalogTarget Object
    /// </summary>  
    public class GovernedCatalogTargetUnmarshaller : IJsonUnmarshaller<GovernedCatalogTarget, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GovernedCatalogTarget Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            GovernedCatalogTarget unmarshalledObject = new GovernedCatalogTarget();
        ...
        private static GovernedCatalogTargetUnmarshaller _instance = new GovernedCatalogTargetUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static GovernedCatalogTargetUnmarshaller Instance
        {
            get
            {
                return _instance;
