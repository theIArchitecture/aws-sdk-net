...
{
    /// <summary>
    /// Response Unmarshaller for HudiTarget Object
    /// </summary>  
    public class HudiTargetUnmarshaller : IJsonUnmarshaller<HudiTarget, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public HudiTarget Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            HudiTarget unmarshalledObject = new HudiTarget();
        ...
        private static HudiTargetUnmarshaller _instance = new HudiTargetUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static HudiTargetUnmarshaller Instance
        {
            get
            {
                return _instance;
