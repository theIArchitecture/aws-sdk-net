...
{
    /// <summary>
    /// IcebergInput Marshaller
    /// </summary>
    public class IcebergInputMarshaller : IRequestMarshaller<IcebergInput, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(IcebergInput requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetMetadataOperation())
            {
                ...
                context.Writer.WriteStringValue(requestObject.MetadataOperation);
            }
        ...
        /// </summary>
        public readonly static IcebergInputMarshaller Instance = new IcebergInputMarshaller();
