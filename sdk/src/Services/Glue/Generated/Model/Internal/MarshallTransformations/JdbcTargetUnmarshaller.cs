...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class JdbcTargetUnmarshaller : IJsonUnmarshaller<JdbcTarget, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public JdbcTarget Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("EnableAdditionalMetadata", targetDepth))
                {
                    ...
                    unmarshalledObject.EnableAdditionalMetadata = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
