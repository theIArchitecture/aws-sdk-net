...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class JoinUnmarshaller : IJsonUnmarshaller<Join, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Join Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<JoinColumn, JoinColumnUnmarshaller>(JoinColumnUnmarshaller.Instance);
                ...
                if (context.TestExpression("JoinType", targetDepth))
                {
                    ...
                    unmarshalledObject.JoinType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
