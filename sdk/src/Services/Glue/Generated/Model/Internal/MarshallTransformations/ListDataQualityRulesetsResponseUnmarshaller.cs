...
{
    /// <summary>
    /// Response Unmarshaller for ListDataQualityRulesets operation
    /// </summary>  
    public class ListDataQualityRulesetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDataQualityRulesetsResponse response = new ListDataQualityRulesetsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DataQualityRulesetListDetails, DataQualityRulesetListDetailsUnmarshaller>(DataQualityRulesetListDetailsUnmarshaller.Instance);
                    response.Rulesets = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListDataQualityRulesetsResponseUnmarshaller _instance = new ListDataQualityRulesetsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDataQualityRulesetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
