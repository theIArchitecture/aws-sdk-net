...
{
    /// <summary>
    /// Response Unmarshaller for ListTableOptimizerRuns operation
    /// </summary>  
    public class ListTableOptimizerRunsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTableOptimizerRunsResponse response = new ListTableOptimizerRunsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<TableOptimizerRun, TableOptimizerRunUnmarshaller>(TableOptimizerRunUnmarshaller.Instance);
                    response.TableOptimizerRuns = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListTableOptimizerRunsResponseUnmarshaller _instance = new ListTableOptimizerRunsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTableOptimizerRunsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
