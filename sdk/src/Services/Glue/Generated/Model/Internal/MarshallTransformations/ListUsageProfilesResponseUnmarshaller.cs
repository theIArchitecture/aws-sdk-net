...
{
    /// <summary>
    /// Response Unmarshaller for ListUsageProfiles operation
    /// </summary>  
    public class ListUsageProfilesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListUsageProfilesResponse response = new ListUsageProfilesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<UsageProfileDefinition, UsageProfileDefinitionUnmarshaller>(UsageProfileDefinitionUnmarshaller.Instance);
        ...
        private static ListUsageProfilesResponseUnmarshaller _instance = new ListUsageProfilesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListUsageProfilesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
