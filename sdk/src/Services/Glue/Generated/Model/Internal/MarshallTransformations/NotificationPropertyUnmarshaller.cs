...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NotificationPropertyUnmarshaller : IJsonUnmarshaller<NotificationProperty, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NotificationProperty Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("NotifyDelayAfter", targetDepth))
                {
                    ...
                    unmarshalledObject.NotifyDelayAfter = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
