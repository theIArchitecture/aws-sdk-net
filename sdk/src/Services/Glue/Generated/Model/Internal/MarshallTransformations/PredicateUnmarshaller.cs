...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PredicateUnmarshaller : IJsonUnmarshaller<Predicate, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Predicate Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Logical", targetDepth))
                {
                    ...
                    unmarshalledObject.Logical = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
