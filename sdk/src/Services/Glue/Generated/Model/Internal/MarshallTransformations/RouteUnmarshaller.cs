...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    public class RouteUnmarshaller : IJsonUnmarshaller<Route, JsonUnmarshallerContext>
    {
        ...
        public Route Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("GroupFiltersList", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<GroupFilters, GroupFiltersUnmarshaller>(GroupFiltersUnmarshaller.Instance);
                    unmarshalledObject.GroupFiltersList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
