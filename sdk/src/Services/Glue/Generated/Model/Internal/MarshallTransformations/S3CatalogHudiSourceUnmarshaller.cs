...
{
    /// <summary>
    /// Response Unmarshaller for S3CatalogHudiSource Object
    /// </summary>  
    public class S3CatalogHudiSourceUnmarshaller : IJsonUnmarshaller<S3CatalogHudiSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public S3CatalogHudiSource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            S3CatalogHudiSource unmarshalledObject = new S3CatalogHudiSource();
        ...
        private static S3CatalogHudiSourceUnmarshaller _instance = new S3CatalogHudiSourceUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static S3CatalogHudiSourceUnmarshaller Instance
        {
            get
            {
                return _instance;
