...
{
    /// <summary>
    /// Response Unmarshaller for S3CatalogIcebergSource Object
    /// </summary>  
    public class S3CatalogIcebergSourceUnmarshaller : IJsonUnmarshaller<S3CatalogIcebergSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public S3CatalogIcebergSource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            S3CatalogIcebergSource unmarshalledObject = new S3CatalogIcebergSource();
        ...
        private static S3CatalogIcebergSourceUnmarshaller _instance = new S3CatalogIcebergSourceUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static S3CatalogIcebergSourceUnmarshaller Instance
        {
            get
            {
                return _instance;
