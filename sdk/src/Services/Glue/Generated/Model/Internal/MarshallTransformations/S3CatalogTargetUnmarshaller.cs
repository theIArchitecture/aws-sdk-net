...
{
    /// <summary>
    /// Response Unmarshaller for S3CatalogTarget Object
    /// </summary>  
    public class S3CatalogTargetUnmarshaller : IJsonUnmarshaller<S3CatalogTarget, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public S3CatalogTarget Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            S3CatalogTarget unmarshalledObject = new S3CatalogTarget();
        ...
        private static S3CatalogTargetUnmarshaller _instance = new S3CatalogTargetUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static S3CatalogTargetUnmarshaller Instance
        {
            get
            {
                return _instance;
