...
{
    /// <summary>
    /// S3ExcelSource Marshaller
    /// </summary>
    public class S3ExcelSourceMarshaller : IRequestMarshaller<S3ExcelSource, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(S3ExcelSource requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetNumberRows())
            {
                context.Writer.WritePropertyName("NumberRows");
                context.Writer.WriteNumberValue(requestObject.NumberRows.Value);
            }
            ...
            if(requestObject.IsSetSkipFooter())
            {
                context.Writer.WritePropertyName("SkipFooter");
                context.Writer.WriteNumberValue(requestObject.SkipFooter.Value);
            }
        ...
        /// </summary>
        public readonly static S3ExcelSourceMarshaller Instance = new S3ExcelSourceMarshaller();
