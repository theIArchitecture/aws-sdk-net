...
{
    /// <summary>
    /// Response Unmarshaller for S3HudiCatalogTarget Object
    /// </summary>  
    public class S3HudiCatalogTargetUnmarshaller : IJsonUnmarshaller<S3HudiCatalogTarget, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public S3HudiCatalogTarget Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            S3HudiCatalogTarget unmarshalledObject = new S3HudiCatalogTarget();
        ...
        private static S3HudiCatalogTargetUnmarshaller _instance = new S3HudiCatalogTargetUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static S3HudiCatalogTargetUnmarshaller Instance
        {
            get
            {
                return _instance;
