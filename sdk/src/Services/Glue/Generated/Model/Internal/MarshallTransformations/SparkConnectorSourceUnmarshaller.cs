...
{
    /// <summary>
    /// Response Unmarshaller for SparkConnectorSource Object
    /// </summary>  
    public class SparkConnectorSourceUnmarshaller : IJsonUnmarshaller<SparkConnectorSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SparkConnectorSource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static SparkConnectorSourceUnmarshaller _instance = new SparkConnectorSourceUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SparkConnectorSourceUnmarshaller Instance
        {
            get
            {
                return _instance;
