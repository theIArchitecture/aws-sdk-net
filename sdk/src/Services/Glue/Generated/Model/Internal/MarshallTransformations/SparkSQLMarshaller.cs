...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// SparkSQL Marshaller
    /// </summary>
    public class SparkSQLMarshaller : IRequestMarshaller<SparkSQL, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(SparkSQL requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetSqlAliases())
            {
                context.Writer.WritePropertyName("SqlAliases");
                context.Writer.WriteStartArray();
                foreach(var requestObjectSqlAliasesListValue in requestObject.SqlAliases)
                {
                    context.Writer.WriteStartObject();

                    var marshaller = SqlAliasMarshaller.Instance;
                    marshaller.Marshall(requestObjectSqlAliasesListValue, context);
        ...
        /// </summary>
        public readonly static SparkSQLMarshaller Instance = new SparkSQLMarshaller();
