...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SparkSQLUnmarshaller : IJsonUnmarshaller<SparkSQL, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SparkSQL Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SqlAlias, SqlAliasUnmarshaller>(SqlAliasUnmarshaller.Instance);
                    unmarshalledObject.SqlAliases = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
