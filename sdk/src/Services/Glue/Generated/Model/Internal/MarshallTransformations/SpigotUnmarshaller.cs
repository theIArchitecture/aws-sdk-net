...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SpigotUnmarshaller : IJsonUnmarshaller<Spigot, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Spigot Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Prob", targetDepth))
                {
                    ...
                    unmarshalledObject.Prob = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
