...
{
    /// <summary>
    /// Response Unmarshaller for StartBlueprintRun operation
    /// </summary>  
    public class StartBlueprintRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartBlueprintRunResponse response = new StartBlueprintRunResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("IllegalBlueprintStateException"))
                {
                    return IllegalBlueprintStateExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static StartBlueprintRunResponseUnmarshaller _instance = new StartBlueprintRunResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartBlueprintRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
