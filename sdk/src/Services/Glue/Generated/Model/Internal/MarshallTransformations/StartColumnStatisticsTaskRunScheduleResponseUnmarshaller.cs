...
{
    /// <summary>
    /// Response Unmarshaller for StartColumnStatisticsTaskRunSchedule operation
    /// </summary>  
    public class StartColumnStatisticsTaskRunScheduleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartColumnStatisticsTaskRunScheduleResponse response = new StartColumnStatisticsTaskRunScheduleResponse();
        ...
        private static StartColumnStatisticsTaskRunScheduleResponseUnmarshaller _instance = new StartColumnStatisticsTaskRunScheduleResponseUnmarshaller();        

        internal static StartColumnStatisticsTaskRunScheduleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartColumnStatisticsTaskRunScheduleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
