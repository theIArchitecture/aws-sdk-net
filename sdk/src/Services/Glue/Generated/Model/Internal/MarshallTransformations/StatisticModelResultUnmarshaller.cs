...
{
    /// <summary>
    /// Response Unmarshaller for StatisticModelResult Object
    /// </summary>  
    public class StatisticModelResultUnmarshaller : IJsonUnmarshaller<StatisticModelResult, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public StatisticModelResult Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            StatisticModelResult unmarshalledObject = new StatisticModelResult();
        ...
        private static StatisticModelResultUnmarshaller _instance = new StatisticModelResultUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static StatisticModelResultUnmarshaller Instance
        {
            get
            {
                return _instance;
