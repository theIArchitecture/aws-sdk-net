...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TransformConfigParameterUnmarshaller : IJsonUnmarshaller<TransformConfigParameter, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TransformConfigParameter Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ValidationRule = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
