...
{
    /// <summary>
    /// Response Unmarshaller for UpdateCatalog operation
    /// </summary>  
    public class UpdateCatalogResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateCatalogResponseUnmarshaller _instance = new UpdateCatalogResponseUnmarshaller();        

        internal static UpdateCatalogResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCatalogResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
