...
{
    /// <summary>
    /// UpdateColumnStatisticsTaskSettings Request Marshaller
    /// </summary>       
    public class UpdateColumnStatisticsTaskSettingsRequestMarshaller : IMarshaller<IRequest, UpdateColumnStatisticsTaskSettingsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateColumnStatisticsTaskSettingsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateColumnStatisticsTaskSettingsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Glue");
            string target = "AWSGlue.UpdateColumnStatisticsTaskSettings";
        ...
        private static UpdateColumnStatisticsTaskSettingsRequestMarshaller _instance = new UpdateColumnStatisticsTaskSettingsRequestMarshaller();        

        internal static UpdateColumnStatisticsTaskSettingsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateColumnStatisticsTaskSettingsRequestMarshaller Instance
        {
            get
            {
                return _instance;
