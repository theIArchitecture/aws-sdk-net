...
{
    /// <summary>
    /// Response Unmarshaller for UpdateGlueIdentityCenterConfiguration operation
    /// </summary>  
    public class UpdateGlueIdentityCenterConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateGlueIdentityCenterConfigurationResponse response = new UpdateGlueIdentityCenterConfigurationResponse();
        ...
        private static UpdateGlueIdentityCenterConfigurationResponseUnmarshaller _instance = new UpdateGlueIdentityCenterConfigurationResponseUnmarshaller();        

        internal static UpdateGlueIdentityCenterConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateGlueIdentityCenterConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
