...
{
    /// <summary>
    /// Response Unmarshaller for UpdateIntegrationTableProperties operation
    /// </summary>  
    public class UpdateIntegrationTablePropertiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateIntegrationTablePropertiesResponse response = new UpdateIntegrationTablePropertiesResponse();
        ...
        private static UpdateIntegrationTablePropertiesResponseUnmarshaller _instance = new UpdateIntegrationTablePropertiesResponseUnmarshaller();        

        internal static UpdateIntegrationTablePropertiesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateIntegrationTablePropertiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
