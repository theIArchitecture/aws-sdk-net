...
{
    /// <summary>
    /// UpdateTableOptimizer Request Marshaller
    /// </summary>       
    public class UpdateTableOptimizerRequestMarshaller : IMarshaller<IRequest, UpdateTableOptimizerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateTableOptimizerRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateTableOptimizerRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Glue");
            string target = "AWSGlue.UpdateTableOptimizer";
        ...
        private static UpdateTableOptimizerRequestMarshaller _instance = new UpdateTableOptimizerRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTableOptimizerRequestMarshaller Instance
        {
            get
            {
                return _instance;
