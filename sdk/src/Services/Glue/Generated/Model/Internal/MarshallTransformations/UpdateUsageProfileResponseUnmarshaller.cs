...
{
    /// <summary>
    /// Response Unmarshaller for UpdateUsageProfile operation
    /// </summary>  
    public class UpdateUsageProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateUsageProfileResponse response = new UpdateUsageProfileResponse();
        ...
        private static UpdateUsageProfileResponseUnmarshaller _instance = new UpdateUsageProfileResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateUsageProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
