...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class XMLClassifierUnmarshaller : IJsonUnmarshaller<XMLClassifier, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public XMLClassifier Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RowTag = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
