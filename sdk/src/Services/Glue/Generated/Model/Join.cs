...
namespace Amazon.Glue.Model
{
    ...
    {
        private List<JoinColumn> _columns = AWSConfigs.InitializeCollections ? new List<JoinColumn>() : null;
        ...
        public List<JoinColumn> Columns
        {
        ...
        /// <summary>
        /// Gets and sets the property JoinType. 
        /// <para>
        ...
        // Check to see if JoinType property is set
        internal bool IsSetJoinType()
        {
            return this._joinType != null;
        }
