...
namespace Amazon.Glue.Model
{
    ...
    /// </summary>
    public partial class S3CatalogIcebergSource
    {
        private Dictionary<string, string> _additionalIcebergOptions = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;
        ...
        /// <summary>
        /// Gets and sets the property AdditionalIcebergOptions. 
        /// <para>
        ...
        /// </summary>
        public Dictionary<string, string> AdditionalIcebergOptions
        {
            get { return this._additionalIcebergOptions; }
            set { this._additionalIcebergOptions = value; }
        }

        // Check to see if AdditionalIcebergOptions property is set
        internal bool IsSetAdditionalIcebergOptions()
        {
            return this._additionalIcebergOptions != null && (this._additionalIcebergOptions.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
