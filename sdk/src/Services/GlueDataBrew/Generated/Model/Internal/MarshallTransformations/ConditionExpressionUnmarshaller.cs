...
namespace Amazon.GlueDataBrew.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConditionExpressionUnmarshaller : IJsonUnmarshaller<ConditionExpression, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ConditionExpression Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TargetColumn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
