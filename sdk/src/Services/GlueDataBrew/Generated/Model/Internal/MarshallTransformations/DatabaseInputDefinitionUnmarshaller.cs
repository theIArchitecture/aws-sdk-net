...
namespace Amazon.GlueDataBrew.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DatabaseInputDefinitionUnmarshaller : IJsonUnmarshaller<DatabaseInputDefinition, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DatabaseInputDefinition Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("DatabaseTableName", targetDepth))
                {
                    ...
                    unmarshalledObject.DatabaseTableName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
