...
namespace Amazon.GlueDataBrew.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DatetimeOptionsUnmarshaller : IJsonUnmarshaller<DatetimeOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DatetimeOptions Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.LocaleCode = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("TimezoneOffset", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TimezoneOffset = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
