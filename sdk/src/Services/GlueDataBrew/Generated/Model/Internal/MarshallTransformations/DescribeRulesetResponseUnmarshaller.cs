...
{
    /// <summary>
    /// Response Unmarshaller for DescribeRuleset operation
    /// </summary>  
    public class DescribeRulesetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeRulesetResponse response = new DescribeRulesetResponse();
        ...
        private static DescribeRulesetResponseUnmarshaller _instance = new DescribeRulesetResponseUnmarshaller();        

        internal static DescribeRulesetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeRulesetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
