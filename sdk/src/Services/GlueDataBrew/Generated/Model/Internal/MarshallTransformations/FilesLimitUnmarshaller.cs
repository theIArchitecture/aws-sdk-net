...
namespace Amazon.GlueDataBrew.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FilesLimitUnmarshaller : IJsonUnmarshaller<FilesLimit, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FilesLimit Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("MaxFiles", targetDepth))
                {
                    ...
                    unmarshalledObject.MaxFiles = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.OrderedBy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
