...
namespace Amazon.GlueDataBrew.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FilterExpressionUnmarshaller : IJsonUnmarshaller<FilterExpression, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FilterExpression Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ValuesMap", targetDepth))
                {
                    ...
                    unmarshalledObject.ValuesMap = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
