...
{
    /// <summary>
    /// Response Unmarshaller for RulesetItem Object
    /// </summary>  
    public class RulesetItemUnmarshaller : IJsonUnmarshaller<RulesetItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RulesetItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static RulesetItemUnmarshaller _instance = new RulesetItemUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RulesetItemUnmarshaller Instance
        {
            get
            {
                return _instance;
