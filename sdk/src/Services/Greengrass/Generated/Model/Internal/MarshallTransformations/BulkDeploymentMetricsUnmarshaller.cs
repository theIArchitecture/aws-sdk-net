...
namespace Amazon.Greengrass.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BulkDeploymentMetricsUnmarshaller : IJsonUnmarshaller<BulkDeploymentMetrics, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BulkDeploymentMetrics Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("InvalidInputRecords", targetDepth))
                {
                    ...
                    unmarshalledObject.InvalidInputRecords = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.RetryAttempts = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
