...
namespace Amazon.Greengrass.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResourceDownloadOwnerSettingUnmarshaller : IJsonUnmarshaller<ResourceDownloadOwnerSetting, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResourceDownloadOwnerSetting Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("GroupOwner", targetDepth))
                {
                    ...
                    unmarshalledObject.GroupOwner = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("GroupPermission", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.GroupPermission = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
