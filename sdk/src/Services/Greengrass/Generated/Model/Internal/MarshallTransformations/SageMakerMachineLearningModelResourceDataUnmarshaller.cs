...
namespace Amazon.Greengrass.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SageMakerMachineLearningModelResourceDataUnmarshaller : IJsonUnmarshaller<SageMakerMachineLearningModelResourceData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SageMakerMachineLearningModelResourceData Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SageMakerJobArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
