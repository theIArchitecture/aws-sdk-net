...
namespace Amazon.GreengrassV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ComponentVersionListItemUnmarshaller : IJsonUnmarshaller<ComponentVersionListItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ComponentVersionListItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
