...
namespace Amazon.GreengrassV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeploymentComponentUpdatePolicyUnmarshaller : IJsonUnmarshaller<DeploymentComponentUpdatePolicy, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DeploymentComponentUpdatePolicy Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
