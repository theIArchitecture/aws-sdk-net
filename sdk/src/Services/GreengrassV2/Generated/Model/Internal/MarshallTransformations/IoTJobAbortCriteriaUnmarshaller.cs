...
namespace Amazon.GreengrassV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IoTJobAbortCriteriaUnmarshaller : IJsonUnmarshaller<IoTJobAbortCriteria, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IoTJobAbortCriteria Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
