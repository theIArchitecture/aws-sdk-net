...
namespace Amazon.GreengrassV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IoTJobExecutionsRolloutConfigUnmarshaller : IJsonUnmarshaller<IoTJobExecutionsRolloutConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IoTJobExecutionsRolloutConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
