...
namespace Amazon.GreengrassV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SystemResourceLimitsUnmarshaller : IJsonUnmarshaller<SystemResourceLimits, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SystemResourceLimits Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
