...
namespace Amazon.GreengrassV2.Model
{
    ...
    public partial class RequestAlreadyInProgressException : AmazonGreengrassV2Exception
    {
        ...
        public RequestAlreadyInProgressException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public RequestAlreadyInProgressException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
