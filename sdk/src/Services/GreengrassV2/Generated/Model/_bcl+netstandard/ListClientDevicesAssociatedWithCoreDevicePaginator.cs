...
namespace Amazon.GreengrassV2.Model
{
    ...
    /// </summary>
    internal sealed partial class ListClientDevicesAssociatedWithCoreDevicePaginator : IPaginator<ListClientDevicesAssociatedWithCoreDeviceResponse>, IListClientDevicesAssociatedWithCoreDevicePaginator
    {
        private readonly IAmazonGreengrassV2 _client;
        private readonly ListClientDevicesAssociatedWithCoreDeviceRequest _request;
        private int _isPaginatorInUse = 0;
        
        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<ListClientDevicesAssociatedWithCoreDeviceResponse> Responses => new PaginatedResponse<ListClientDevicesAssociatedWithCoreDeviceResponse>(this);
...
#if BCL
        IEnumerable<ListClientDevicesAssociatedWithCoreDeviceResponse> IPaginator<ListClientDevicesAssociatedWithCoreDeviceResponse>.Paginate()
        {
            ...
            do
            {
                ...
                response = _client.ListClientDevicesAssociatedWithCoreDevice(_request);
        ...
        async IAsyncEnumerable<ListClientDevicesAssociatedWithCoreDeviceResponse> IPaginator<ListClientDevicesAssociatedWithCoreDeviceResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.ListClientDevicesAssociatedWithCoreDeviceAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
