...
namespace Amazon.GreengrassV2
{
    ...
    /// <summary>
    /// Constants used for properties of type IotEndpointType.
    /// </summary>
    public class IotEndpointType : ConstantClass
    {

        /// <summary>
        /// Constant Fips for IotEndpointType
        /// </summary>
        public static readonly IotEndpointType Fips = new IotEndpointType("fips");
        /// <summary>
        /// Constant Standard for IotEndpointType
        /// </summary>
        public static readonly IotEndpointType Standard = new IotEndpointType("standard");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public IotEndpointType(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static IotEndpointType FindValue(string value)
        {
            return FindValue<IotEndpointType>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator IotEndpointType(string value)
        {
            return FindValue(value);
        }
    }
    ...
    /// <summary>
    /// Constants used for properties of type S3EndpointType.
    /// </summary>
    public class S3EndpointType : ConstantClass
    {

        /// <summary>
        /// Constant GLOBAL for S3EndpointType
        /// </summary>
        public static readonly S3EndpointType GLOBAL = new S3EndpointType("GLOBAL");
        /// <summary>
        /// Constant REGIONAL for S3EndpointType
        /// </summary>
        public static readonly S3EndpointType REGIONAL = new S3EndpointType("REGIONAL");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public S3EndpointType(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static S3EndpointType FindValue(string value)
        {
            return FindValue<S3EndpointType>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator S3EndpointType(string value)
        {
            return FindValue(value);
        }
    }
