...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonGreengrassV2Config))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonGreengrassV2Config();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonGreengrassV2Config;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonGreengrassV2Config to create AmazonGreengrassV2Client");
            }

            return awsCredentials == null ? 
                    new AmazonGreengrassV2Client(serviceClientConfig) :
                    new AmazonGreengrassV2Client(awsCredentials, serviceClientConfig);
        }
