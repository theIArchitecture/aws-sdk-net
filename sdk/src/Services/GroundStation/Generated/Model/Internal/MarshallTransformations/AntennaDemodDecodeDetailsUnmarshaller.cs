...
namespace Amazon.GroundStation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AntennaDemodDecodeDetailsUnmarshaller : IJsonUnmarshaller<AntennaDemodDecodeDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AntennaDemodDecodeDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("outputNode", targetDepth))
                {
                    ...
                    unmarshalledObject.OutputNode = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
