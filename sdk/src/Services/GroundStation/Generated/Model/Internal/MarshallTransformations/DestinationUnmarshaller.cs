        ...
        public Destination Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("configDetails", targetDepth))
                {
                    ...
                    unmarshalledObject.ConfigDetails = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DataflowDestinationRegion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
