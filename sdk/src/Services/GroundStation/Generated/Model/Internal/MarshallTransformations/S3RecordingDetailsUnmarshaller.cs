...
namespace Amazon.GroundStation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class S3RecordingDetailsUnmarshaller : IJsonUnmarshaller<S3RecordingDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public S3RecordingDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.KeyTemplate = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
