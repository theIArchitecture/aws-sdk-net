...
{
    /// <summary>
    /// Response Unmarshaller for UpdateEphemeris operation
    /// </summary>  
    public class UpdateEphemerisResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateEphemerisResponse response = new UpdateEphemerisResponse();
        ...
        private static UpdateEphemerisResponseUnmarshaller _instance = new UpdateEphemerisResponseUnmarshaller();        

        internal static UpdateEphemerisResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateEphemerisResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
