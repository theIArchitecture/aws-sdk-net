...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonGroundStationConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonGroundStationConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonGroundStationConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonGroundStationConfig to create AmazonGroundStationClient");
            }

            return awsCredentials == null ? 
                    new AmazonGroundStationClient(serviceClientConfig) :
                    new AmazonGroundStationClient(awsCredentials, serviceClientConfig);
        }
