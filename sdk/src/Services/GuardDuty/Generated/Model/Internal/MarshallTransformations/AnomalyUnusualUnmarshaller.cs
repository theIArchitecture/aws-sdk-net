...
{
    /// <summary>
    /// Response Unmarshaller for AnomalyUnusual Object
    /// </summary>  
    public class AnomalyUnusualUnmarshaller : IJsonUnmarshaller<AnomalyUnusual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AnomalyUnusual Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static AnomalyUnusualUnmarshaller _instance = new AnomalyUnusualUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AnomalyUnusualUnmarshaller Instance
        {
            get
            {
                return _instance;
