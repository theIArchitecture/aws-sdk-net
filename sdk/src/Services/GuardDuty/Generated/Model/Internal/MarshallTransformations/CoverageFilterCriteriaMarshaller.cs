    ...
    public class CoverageFilterCriteriaMarshaller : IRequestMarshaller<CoverageFilterCriteria, JsonMarshallerContext> 
    {
        ...
        public void Marshall(CoverageFilterCriteria requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetFilterCriterion())
            {
                context.Writer.WritePropertyName("filterCriterion");
                context.Writer.WriteStartArray();
                foreach(var requestObjectFilterCriterionListValue in requestObject.FilterCriterion)
                {
                    context.Writer.WriteStartObject();

                    var marshaller = CoverageFilterCriterionMarshaller.Instance;
                    marshaller.Marshall(requestObjectFilterCriterionListValue, context);
