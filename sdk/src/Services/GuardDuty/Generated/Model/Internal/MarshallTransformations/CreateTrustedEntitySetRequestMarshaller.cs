...
{
    /// <summary>
    /// CreateTrustedEntitySet Request Marshaller
    /// </summary>       
    public class CreateTrustedEntitySetRequestMarshaller : IMarshaller<IRequest, CreateTrustedEntitySetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateTrustedEntitySetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateTrustedEntitySetRequest publicRequest)
        {
            ...
            request.ResourcePath = "/detector/{detectorId}/trustedentityset";
#if !NETFRAMEWORK
        ...
        private static CreateTrustedEntitySetRequestMarshaller _instance = new CreateTrustedEntitySetRequestMarshaller();        

        internal static CreateTrustedEntitySetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTrustedEntitySetRequestMarshaller Instance
        {
            get
            {
                return _instance;
