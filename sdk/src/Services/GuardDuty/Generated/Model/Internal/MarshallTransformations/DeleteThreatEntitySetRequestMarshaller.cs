...
{
    /// <summary>
    /// DeleteThreatEntitySet Request Marshaller
    /// </summary>       
    public class DeleteThreatEntitySetRequestMarshaller : IMarshaller<IRequest, DeleteThreatEntitySetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteThreatEntitySetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteThreatEntitySetRequest publicRequest)
        {
        ...
        private static DeleteThreatEntitySetRequestMarshaller _instance = new DeleteThreatEntitySetRequestMarshaller();        

        internal static DeleteThreatEntitySetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteThreatEntitySetRequestMarshaller Instance
        {
            get
            {
                return _instance;
