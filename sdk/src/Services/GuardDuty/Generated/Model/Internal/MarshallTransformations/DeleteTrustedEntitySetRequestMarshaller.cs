...
{
    /// <summary>
    /// DeleteTrustedEntitySet Request Marshaller
    /// </summary>       
    public class DeleteTrustedEntitySetRequestMarshaller : IMarshaller<IRequest, DeleteTrustedEntitySetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteTrustedEntitySetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteTrustedEntitySetRequest publicRequest)
        {
        ...
        private static DeleteTrustedEntitySetRequestMarshaller _instance = new DeleteTrustedEntitySetRequestMarshaller();        

        internal static DeleteTrustedEntitySetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTrustedEntitySetRequestMarshaller Instance
        {
            get
            {
                return _instance;
