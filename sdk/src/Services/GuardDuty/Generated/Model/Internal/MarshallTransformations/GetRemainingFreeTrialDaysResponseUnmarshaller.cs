...
{
    /// <summary>
    /// Response Unmarshaller for GetRemainingFreeTrialDays operation
    /// </summary>  
    public class GetRemainingFreeTrialDaysResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRemainingFreeTrialDaysResponse response = new GetRemainingFreeTrialDaysResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AccountFreeTrialInfo, AccountFreeTrialInfoUnmarshaller>(AccountFreeTrialInfoUnmarshaller.Instance);
        ...
        private static GetRemainingFreeTrialDaysResponseUnmarshaller _instance = new GetRemainingFreeTrialDaysResponseUnmarshaller();        

        internal static GetRemainingFreeTrialDaysResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRemainingFreeTrialDaysResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
