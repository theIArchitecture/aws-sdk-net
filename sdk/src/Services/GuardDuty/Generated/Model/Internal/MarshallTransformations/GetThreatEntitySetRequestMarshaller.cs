...
{
    /// <summary>
    /// GetThreatEntitySet Request Marshaller
    /// </summary>       
    public class GetThreatEntitySetRequestMarshaller : IMarshaller<IRequest, GetThreatEntitySetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetThreatEntitySetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetThreatEntitySetRequest publicRequest)
        {
        ...
        private static GetThreatEntitySetRequestMarshaller _instance = new GetThreatEntitySetRequestMarshaller();        

        internal static GetThreatEntitySetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetThreatEntitySetRequestMarshaller Instance
        {
            get
            {
                return _instance;
