...
{
    /// <summary>
    /// Response Unmarshaller for GetThreatEntitySet operation
    /// </summary>  
    public class GetThreatEntitySetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetThreatEntitySetResponse response = new GetThreatEntitySetResponse();
        ...
        private static GetThreatEntitySetResponseUnmarshaller _instance = new GetThreatEntitySetResponseUnmarshaller();        

        internal static GetThreatEntitySetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetThreatEntitySetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
