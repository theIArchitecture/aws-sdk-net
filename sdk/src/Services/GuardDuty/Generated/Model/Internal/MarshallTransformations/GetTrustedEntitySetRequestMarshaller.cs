...
{
    /// <summary>
    /// GetTrustedEntitySet Request Marshaller
    /// </summary>       
    public class GetTrustedEntitySetRequestMarshaller : IMarshaller<IRequest, GetTrustedEntitySetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetTrustedEntitySetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetTrustedEntitySetRequest publicRequest)
        {
        ...
        private static GetTrustedEntitySetRequestMarshaller _instance = new GetTrustedEntitySetRequestMarshaller();        

        internal static GetTrustedEntitySetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTrustedEntitySetRequestMarshaller Instance
        {
            get
            {
                return _instance;
