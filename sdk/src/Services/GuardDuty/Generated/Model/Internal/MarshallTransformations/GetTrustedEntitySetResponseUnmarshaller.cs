...
{
    /// <summary>
    /// Response Unmarshaller for GetTrustedEntitySet operation
    /// </summary>  
    public class GetTrustedEntitySetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTrustedEntitySetResponse response = new GetTrustedEntitySetResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ExpectedBucketOwner = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetTrustedEntitySetResponseUnmarshaller _instance = new GetTrustedEntitySetResponseUnmarshaller();        

        internal static GetTrustedEntitySetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTrustedEntitySetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
