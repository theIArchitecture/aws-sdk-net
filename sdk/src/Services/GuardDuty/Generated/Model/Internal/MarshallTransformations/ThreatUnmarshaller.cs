    ...
    public class ThreatUnmarshaller : IJsonUnmarshaller<Threat, JsonUnmarshallerContext>
    {
        ...
        public Threat Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ItemPath, ItemPathUnmarshaller>(ItemPathUnmarshaller.Instance);
                    unmarshalledObject.ItemPaths = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
