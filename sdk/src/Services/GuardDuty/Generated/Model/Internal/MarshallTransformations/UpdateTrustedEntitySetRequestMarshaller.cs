...
{
    /// <summary>
    /// UpdateTrustedEntitySet Request Marshaller
    /// </summary>       
    public class UpdateTrustedEntitySetRequestMarshaller : IMarshaller<IRequest, UpdateTrustedEntitySetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateTrustedEntitySetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateTrustedEntitySetRequest publicRequest)
        {
        ...
        private static UpdateTrustedEntitySetRequestMarshaller _instance = new UpdateTrustedEntitySetRequestMarshaller();        

        internal static UpdateTrustedEntitySetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTrustedEntitySetRequestMarshaller Instance
        {
            get
            {
                return _instance;
