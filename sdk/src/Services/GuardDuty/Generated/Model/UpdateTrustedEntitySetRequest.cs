...
{
    /// <summary>
    /// Container for the parameters to the UpdateTrustedEntitySet operation.
    /// Updates the trusted entity set associated with the specified <c>trustedEntitySetId</c>.
    /// </summary>
    public partial class UpdateTrustedEntitySetRequest : AmazonGuardDutyRequest
    {
        ...
        /// <para>
        /// A boolean value that indicates whether GuardDuty is to start using this updated trusted
