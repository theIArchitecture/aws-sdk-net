...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonGuardDutyConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonGuardDutyConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonGuardDutyConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonGuardDutyConfig to create AmazonGuardDutyClient");
            }

            return awsCredentials == null ? 
                    new AmazonGuardDutyClient(serviceClientConfig) :
                    new AmazonGuardDutyClient(awsCredentials, serviceClientConfig);
        }
