...
namespace Amazon.HealthLake.Internal
{
    ...
    public class AmazonHealthLakeAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonHealthLakeAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for HealthLake.
        /// </summary>
        public AmazonHealthLakeAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonHealthLakeAuthSchemeParameters
            {
    ...
    public class AmazonHealthLakeAuthSchemeResolver : IAuthSchemeResolver<AmazonHealthLakeAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonHealthLakeAuthSchemeParameters authParameters)
        {
