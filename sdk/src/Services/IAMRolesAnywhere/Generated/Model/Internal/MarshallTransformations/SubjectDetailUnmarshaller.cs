...
{
    /// <summary>
    /// Response Unmarshaller for SubjectDetail Object
    /// </summary>  
    public class SubjectDetailUnmarshaller : IJsonUnmarshaller<SubjectDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SubjectDetail Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            SubjectDetail unmarshalledObject = new SubjectDetail();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<CredentialSummary, CredentialSummaryUnmarshaller>(CredentialSummaryUnmarshaller.Instance);
                ...
                if (context.TestExpression("instanceProperties", targetDepth))
                {
                    ...
                    unmarshalledObject.InstanceProperties = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static SubjectDetailUnmarshaller _instance = new SubjectDetailUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SubjectDetailUnmarshaller Instance
        {
            get
            {
                return _instance;
