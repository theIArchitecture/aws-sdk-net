...
{
    /// <summary>
    /// UpdateCrl Request Marshaller
    /// </summary>       
    public class UpdateCrlRequestMarshaller : IMarshaller<IRequest, UpdateCrlRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateCrlRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateCrlRequest publicRequest)
        {
        ...
        private static UpdateCrlRequestMarshaller _instance = new UpdateCrlRequestMarshaller();        

        internal static UpdateCrlRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCrlRequestMarshaller Instance
        {
            get
            {
                return _instance;
