...
namespace Amazon.IVS.Internal
{
    ...
    public class AmazonIVSAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonIVSAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for IVS.
        /// </summary>
        public AmazonIVSAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonIVSAuthSchemeParameters
            {
    ...
    public class AmazonIVSAuthSchemeResolver : IAuthSchemeResolver<AmazonIVSAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonIVSAuthSchemeParameters authParameters)
        {
