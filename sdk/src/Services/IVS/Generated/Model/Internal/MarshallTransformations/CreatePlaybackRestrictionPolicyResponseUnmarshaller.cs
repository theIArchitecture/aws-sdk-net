...
{
    /// <summary>
    /// Response Unmarshaller for CreatePlaybackRestrictionPolicy operation
    /// </summary>  
    public class CreatePlaybackRestrictionPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePlaybackRestrictionPolicyResponse response = new CreatePlaybackRestrictionPolicyResponse();
        ...
        private static CreatePlaybackRestrictionPolicyResponseUnmarshaller _instance = new CreatePlaybackRestrictionPolicyResponseUnmarshaller();        

        internal static CreatePlaybackRestrictionPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePlaybackRestrictionPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
