...
{
    /// <summary>
    /// Response Unmarshaller for CreateRecordingConfiguration operation
    /// </summary>  
    public class CreateRecordingConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRecordingConfigurationResponse response = new CreateRecordingConfigurationResponse();
        ...
        private static CreateRecordingConfigurationResponseUnmarshaller _instance = new CreateRecordingConfigurationResponseUnmarshaller();        

        internal static CreateRecordingConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRecordingConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
