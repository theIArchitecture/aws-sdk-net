...
{
    /// <summary>
    /// Response Unmarshaller for GetPlaybackRestrictionPolicy operation
    /// </summary>  
    public class GetPlaybackRestrictionPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPlaybackRestrictionPolicyResponse response = new GetPlaybackRestrictionPolicyResponse();
        ...
        private static GetPlaybackRestrictionPolicyResponseUnmarshaller _instance = new GetPlaybackRestrictionPolicyResponseUnmarshaller();        

        internal static GetPlaybackRestrictionPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPlaybackRestrictionPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
