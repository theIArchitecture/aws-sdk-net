...
{
    /// <summary>
    /// Response Unmarshaller for ListPlaybackRestrictionPolicies operation
    /// </summary>  
    public class ListPlaybackRestrictionPoliciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListPlaybackRestrictionPoliciesResponse response = new ListPlaybackRestrictionPoliciesResponse();
        ...
        private static ListPlaybackRestrictionPoliciesResponseUnmarshaller _instance = new ListPlaybackRestrictionPoliciesResponseUnmarshaller();        

        internal static ListPlaybackRestrictionPoliciesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPlaybackRestrictionPoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
