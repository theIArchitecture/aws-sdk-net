...
namespace Amazon.IVS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StreamEventUnmarshaller : IJsonUnmarshaller<StreamEvent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public StreamEvent Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
