...
namespace Amazon.IVSRealTime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateIngestConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateIngestConfigurationResponse response = new CreateIngestConfigurationResponse();
        ...
        internal static CreateIngestConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateIngestConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
