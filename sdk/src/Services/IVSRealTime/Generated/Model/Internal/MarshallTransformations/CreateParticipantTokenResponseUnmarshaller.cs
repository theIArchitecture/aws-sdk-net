...
namespace Amazon.IVSRealTime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateParticipantTokenResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateParticipantTokenResponse response = new CreateParticipantTokenResponse();
        ...
        internal static CreateParticipantTokenResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateParticipantTokenResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
