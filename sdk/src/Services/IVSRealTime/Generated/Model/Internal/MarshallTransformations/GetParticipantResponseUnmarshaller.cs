...
{
    /// <summary>
    /// Response Unmarshaller for GetParticipant operation
    /// </summary>  
    public class GetParticipantResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetParticipantResponseUnmarshaller _instance = new GetParticipantResponseUnmarshaller();        

        internal static GetParticipantResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetParticipantResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
