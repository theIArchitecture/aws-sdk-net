...
{
    /// <summary>
    /// Response Unmarshaller for GetStorageConfiguration operation
    /// </summary>  
    public class GetStorageConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetStorageConfigurationResponse response = new GetStorageConfigurationResponse();
        ...
        private static GetStorageConfigurationResponseUnmarshaller _instance = new GetStorageConfigurationResponseUnmarshaller();        

        internal static GetStorageConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetStorageConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
