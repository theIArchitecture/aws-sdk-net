    ...
    public class ListPublicKeysResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<PublicKeySummary, PublicKeySummaryUnmarshaller>(PublicKeySummaryUnmarshaller.Instance);
                    response.PublicKeys = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
