...
namespace Amazon.IVSRealTime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListStageSessionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListStageSessionsResponse response = new ListStageSessionsResponse();
        ...
        internal static ListStageSessionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListStageSessionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
