...
{
    /// <summary>
    /// StartComposition Request Marshaller
    /// </summary>       
    public class StartCompositionRequestMarshaller : IMarshaller<IRequest, StartCompositionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartCompositionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartCompositionRequest publicRequest)
        {
            ...
            request.ResourcePath = "/StartComposition";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetLayout())
            {
                ...
                marshaller.Marshall(publicRequest.Layout, context);
        ...
        private static StartCompositionRequestMarshaller _instance = new StartCompositionRequestMarshaller();        

        internal static StartCompositionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartCompositionRequestMarshaller Instance
        {
            get
            {
                return _instance;
