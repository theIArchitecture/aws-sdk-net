...
namespace Amazon.IVSRealTime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StopParticipantReplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopParticipantReplicationResponse response = new StopParticipantReplicationResponse();
        ...
        internal static StopParticipantReplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopParticipantReplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
