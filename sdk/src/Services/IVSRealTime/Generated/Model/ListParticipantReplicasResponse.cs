...
{
    /// <summary>
    /// This is the response object from the ListParticipantReplicas operation.
    /// </summary>
    public partial class ListParticipantReplicasResponse : AmazonWebServiceResponse
    {
        private string _nextToken;
        private List<ParticipantReplica> _replicas = AWSConfigs.InitializeCollections ? new List<ParticipantReplica>() : null;
        ...
        public List<ParticipantReplica> Replicas
        {
