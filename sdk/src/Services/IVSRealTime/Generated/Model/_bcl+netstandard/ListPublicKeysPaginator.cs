...
namespace Amazon.IVSRealTime.Model
{
    ...
    internal sealed partial class ListPublicKeysPaginator : IPaginator<ListPublicKeysResponse>, IListPublicKeysPaginator
    {
        ...
        /// <summary>
        /// Enumerable containing all of the PublicKeys
        /// </summary>
        public IPaginatedEnumerable<PublicKeySummary> PublicKeys => 
            new PaginatedResultKeyResponse<ListPublicKeysResponse, PublicKeySummary>(this, (i) => i.PublicKeys ?? new List<PublicKeySummary>());

        internal ListPublicKeysPaginator(IAmazonIVSRealTime client, ListPublicKeysRequest request)
        {
            this._client = client;
