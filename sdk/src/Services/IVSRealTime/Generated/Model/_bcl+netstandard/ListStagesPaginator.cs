...
namespace Amazon.IVSRealTime.Model
{
    ...
    internal sealed partial class ListStagesPaginator : IPaginator<ListStagesResponse>, IListStagesPaginator
    {
        ...
        internal ListStagesPaginator(IAmazonIVSRealTime client, ListStagesRequest request)
        {
            this._client = client;
        ...
        async IAsyncEnumerable<ListStagesResponse> IPaginator<ListStagesResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
