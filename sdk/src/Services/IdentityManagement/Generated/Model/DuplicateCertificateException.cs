...
namespace Amazon.IdentityManagement.Model
{
    ...
    public partial class DuplicateCertificateException : AmazonIdentityManagementServiceException
    {
        ...
        public DuplicateCertificateException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DuplicateCertificateException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
