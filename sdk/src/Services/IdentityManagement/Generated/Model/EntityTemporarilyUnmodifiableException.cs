...
namespace Amazon.IdentityManagement.Model
{
    ...
    public partial class EntityTemporarilyUnmodifiableException : AmazonIdentityManagementServiceException
    {
        ...
        public EntityTemporarilyUnmodifiableException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public EntityTemporarilyUnmodifiableException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
