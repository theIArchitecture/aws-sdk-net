...
{
    /// <summary>
    /// Response Unmarshaller for DisableOrganizationsRootSessions operation
    /// </summary>  
    public class DisableOrganizationsRootSessionsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisableOrganizationsRootSessionsResponse response = new DisableOrganizationsRootSessionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DisableOrganizationsRootSessionsResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, DisableOrganizationsRootSessionsResponse response)
        {
        ...
        private static DisableOrganizationsRootSessionsResponseUnmarshaller _instance = new DisableOrganizationsRootSessionsResponseUnmarshaller();        

        internal static DisableOrganizationsRootSessionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisableOrganizationsRootSessionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
