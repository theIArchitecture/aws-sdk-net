...
{
    /// <summary>
    /// Response Unmarshaller for EnableOrganizationsRootCredentialsManagement operation
    /// </summary>  
    public class EnableOrganizationsRootCredentialsManagementResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            EnableOrganizationsRootCredentialsManagementResponse response = new EnableOrganizationsRootCredentialsManagementResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("EnableOrganizationsRootCredentialsManagementResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, EnableOrganizationsRootCredentialsManagementResponse response)
        {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("CallerIsNotManagementAccountException"))
                {
                    return CallerIsNotManagementAccountExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static EnableOrganizationsRootCredentialsManagementResponseUnmarshaller _instance = new EnableOrganizationsRootCredentialsManagementResponseUnmarshaller();        

        internal static EnableOrganizationsRootCredentialsManagementResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EnableOrganizationsRootCredentialsManagementResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
