...
{
    /// <summary>
    /// Response Unmarshaller for EnableOrganizationsRootSessions operation
    /// </summary>  
    public class EnableOrganizationsRootSessionsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            EnableOrganizationsRootSessionsResponse response = new EnableOrganizationsRootSessionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("EnableOrganizationsRootSessionsResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, EnableOrganizationsRootSessionsResponse response)
        {
        ...
        private static EnableOrganizationsRootSessionsResponseUnmarshaller _instance = new EnableOrganizationsRootSessionsResponseUnmarshaller();        

        internal static EnableOrganizationsRootSessionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EnableOrganizationsRootSessionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
