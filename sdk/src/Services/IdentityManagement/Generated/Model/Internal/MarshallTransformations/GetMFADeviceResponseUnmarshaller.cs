...
{
    /// <summary>
    /// Response Unmarshaller for GetMFADevice operation
    /// </summary>  
    public class GetMFADeviceResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMFADeviceResponse response = new GetMFADeviceResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("GetMFADeviceResult", 2))
                    {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("EnableDate", targetDepth))
                    {
                        ...
                        response.EnableDate = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        private static GetMFADeviceResponseUnmarshaller _instance = new GetMFADeviceResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMFADeviceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
