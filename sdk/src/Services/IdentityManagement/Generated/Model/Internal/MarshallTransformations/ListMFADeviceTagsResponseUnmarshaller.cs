...
{
    /// <summary>
    /// Response Unmarshaller for ListMFADeviceTags operation
    /// </summary>  
    public class ListMFADeviceTagsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMFADeviceTagsResponse response = new ListMFADeviceTagsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ListMFADeviceTagsResult", 2))
                    {
        ...
        private static ListMFADeviceTagsResponseUnmarshaller _instance = new ListMFADeviceTagsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMFADeviceTagsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
