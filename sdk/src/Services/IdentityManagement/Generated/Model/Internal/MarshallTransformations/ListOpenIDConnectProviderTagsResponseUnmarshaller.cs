...
{
    /// <summary>
    /// Response Unmarshaller for ListOpenIDConnectProviderTags operation
    /// </summary>  
    public class ListOpenIDConnectProviderTagsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListOpenIDConnectProviderTagsResponse response = new ListOpenIDConnectProviderTagsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ListOpenIDConnectProviderTagsResult", 2))
                    {
        ...
        private static ListOpenIDConnectProviderTagsResponseUnmarshaller _instance = new ListOpenIDConnectProviderTagsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListOpenIDConnectProviderTagsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
