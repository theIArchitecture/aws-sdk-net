...
{
    /// <summary>
    /// Response Unmarshaller for ListOrganizationsFeatures operation
    /// </summary>  
    public class ListOrganizationsFeaturesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListOrganizationsFeaturesResponse response = new ListOrganizationsFeaturesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ListOrganizationsFeaturesResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, ListOrganizationsFeaturesResponse response)
        {
        ...
        private static ListOrganizationsFeaturesResponseUnmarshaller _instance = new ListOrganizationsFeaturesResponseUnmarshaller();        

        internal static ListOrganizationsFeaturesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListOrganizationsFeaturesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
