...
{
    /// <summary>
    /// Response Unmarshaller for ListSAMLProviderTags operation
    /// </summary>  
    public class ListSAMLProviderTagsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSAMLProviderTagsResponse response = new ListSAMLProviderTagsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ListSAMLProviderTagsResult", 2))
                    {
        ...
        private static ListSAMLProviderTagsResponseUnmarshaller _instance = new ListSAMLProviderTagsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSAMLProviderTagsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
