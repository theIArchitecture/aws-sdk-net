...
{
    /// <summary>
    /// Response Unmarshaller for ListServerCertificateTags operation
    /// </summary>  
    public class ListServerCertificateTagsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListServerCertificateTagsResponse response = new ListServerCertificateTagsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ListServerCertificateTagsResult", 2))
                    {
        ...
        private static ListServerCertificateTagsResponseUnmarshaller _instance = new ListServerCertificateTagsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListServerCertificateTagsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
