...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    public class SAMLPrivateKeyUnmarshaller : IXmlUnmarshaller<SAMLPrivateKey, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public SAMLPrivateKey Unmarshall(XmlUnmarshallerContext context)
        {
            SAMLPrivateKey unmarshalledObject = new SAMLPrivateKey();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SAMLPrivateKeyUnmarshaller Instance
        {
            get
            {
                return _instance;
