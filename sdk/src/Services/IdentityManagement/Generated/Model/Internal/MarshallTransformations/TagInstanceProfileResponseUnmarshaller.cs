...
{
    /// <summary>
    /// Response Unmarshaller for TagInstanceProfile operation
    /// </summary>  
    public class TagInstanceProfileResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TagInstanceProfileResponse response = new TagInstanceProfileResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("TagInstanceProfileResult", 2))
                    {
        ...
        private static TagInstanceProfileResponseUnmarshaller _instance = new TagInstanceProfileResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TagInstanceProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
