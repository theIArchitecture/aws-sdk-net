...
{
    /// <summary>
    /// Response Unmarshaller for TagMFADevice operation
    /// </summary>  
    public class TagMFADeviceResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TagMFADeviceResponse response = new TagMFADeviceResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("TagMFADeviceResult", 2))
                    {
        ...
        private static TagMFADeviceResponseUnmarshaller _instance = new TagMFADeviceResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TagMFADeviceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
