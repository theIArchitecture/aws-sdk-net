...
{
    /// <summary>
    /// Response Unmarshaller for TagOpenIDConnectProvider operation
    /// </summary>  
    public class TagOpenIDConnectProviderResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TagOpenIDConnectProviderResponse response = new TagOpenIDConnectProviderResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("TagOpenIDConnectProviderResult", 2))
                    {
        ...
        private static TagOpenIDConnectProviderResponseUnmarshaller _instance = new TagOpenIDConnectProviderResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TagOpenIDConnectProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
