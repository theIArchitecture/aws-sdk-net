...
{
    /// <summary>
    /// Response Unmarshaller for TagPolicy operation
    /// </summary>  
    public class TagPolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("TagPolicyResult", 2))
                    {
        ...
        private static TagPolicyResponseUnmarshaller _instance = new TagPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TagPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
