...
{
    /// <summary>
    /// Response Unmarshaller for TagSAMLProvider operation
    /// </summary>  
    public class TagSAMLProviderResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TagSAMLProviderResponse response = new TagSAMLProviderResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("TagSAMLProviderResult", 2))
                    {
        ...
        private static TagSAMLProviderResponseUnmarshaller _instance = new TagSAMLProviderResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TagSAMLProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
