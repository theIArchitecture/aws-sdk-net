...
{
    /// <summary>
    /// Response Unmarshaller for UntagOpenIDConnectProvider operation
    /// </summary>  
    public class UntagOpenIDConnectProviderResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UntagOpenIDConnectProviderResponse response = new UntagOpenIDConnectProviderResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("UntagOpenIDConnectProviderResult", 2))
                    {
        ...
        private static UntagOpenIDConnectProviderResponseUnmarshaller _instance = new UntagOpenIDConnectProviderResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UntagOpenIDConnectProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
