...
{
    /// <summary>
    /// Response Unmarshaller for UntagPolicy operation
    /// </summary>  
    public class UntagPolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UntagPolicyResponse response = new UntagPolicyResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("UntagPolicyResult", 2))
                    {
        ...
        private static UntagPolicyResponseUnmarshaller _instance = new UntagPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UntagPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
