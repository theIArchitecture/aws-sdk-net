...
{
    /// <summary>
    /// Response Unmarshaller for UntagServerCertificate operation
    /// </summary>  
    public class UntagServerCertificateResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UntagServerCertificateResponse response = new UntagServerCertificateResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("UntagServerCertificateResult", 2))
                    {
        ...
        private static UntagServerCertificateResponseUnmarshaller _instance = new UntagServerCertificateResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UntagServerCertificateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
