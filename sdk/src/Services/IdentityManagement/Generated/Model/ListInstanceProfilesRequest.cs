...
namespace Amazon.IdentityManagement.Model
{
    ...
    public partial class ListInstanceProfilesRequest : AmazonIdentityManagementServiceRequest
    {
        ...
        /// <para>
        ///  The path prefix for filtering the results. For example, the prefix <c>/application_abc/component_xyz/</c>
        /// gets all instance profiles whose path starts with <c>/application_abc/component_xyz/</c>.
        /// </para>
        ///  
        /// <para>
