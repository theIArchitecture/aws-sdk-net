...
{
    /// <summary>
    /// Contains the response to a successful <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_ListVirtualMFADevices.html">ListVirtualMFADevices</a>
    /// request.
    /// </summary>
    public partial class ListVirtualMFADevicesResponse : AmazonWebServiceResponse
    {
        ...
        private List<VirtualMFADevice> _virtualMFADevices = AWSConfigs.InitializeCollections ? new List<VirtualMFADevice>() : null;
        ...
        {
            return this._virtualMFADevices != null && (this._virtualMFADevices.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
