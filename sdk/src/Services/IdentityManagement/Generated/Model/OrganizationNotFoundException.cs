...
namespace Amazon.IdentityManagement.Model
{
    ...
    [Serializable]
    #endif
    public partial class OrganizationNotFoundException : AmazonIdentityManagementServiceException
    {
        ...
        public OrganizationNotFoundException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public OrganizationNotFoundException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
