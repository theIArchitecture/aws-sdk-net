...
namespace Amazon.IdentityManagement.Model
{
    ...
    [Serializable]
    #endif
    public partial class OrganizationNotInAllFeaturesModeException : AmazonIdentityManagementServiceException
    {
        ...
        public OrganizationNotInAllFeaturesModeException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public OrganizationNotInAllFeaturesModeException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
