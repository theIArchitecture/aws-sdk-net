...
namespace Amazon.IdentityManagement.Model
{
    ...
    public partial class PasswordPolicyViolationException : AmazonIdentityManagementServiceException
    {
        ...
        public PasswordPolicyViolationException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public PasswordPolicyViolationException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
