...
namespace Amazon.IdentityManagement.Model
{
    ...
    public partial class UnrecognizedPublicKeyEncodingException : AmazonIdentityManagementServiceException
    {
        ...
        public UnrecognizedPublicKeyEncodingException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public UnrecognizedPublicKeyEncodingException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
