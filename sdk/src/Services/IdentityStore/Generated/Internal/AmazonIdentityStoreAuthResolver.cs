...
namespace Amazon.IdentityStore.Internal
{
    ...
    public class AmazonIdentityStoreAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonIdentityStoreAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for IdentityStore.
        /// </summary>
        public AmazonIdentityStoreAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonIdentityStoreAuthSchemeParameters
            {
    ...
    public class AmazonIdentityStoreAuthSchemeResolver : IAuthSchemeResolver<AmazonIdentityStoreAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonIdentityStoreAuthSchemeParameters authParameters)
        {
