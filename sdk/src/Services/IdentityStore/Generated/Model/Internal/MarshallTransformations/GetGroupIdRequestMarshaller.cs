...
namespace Amazon.IdentityStore.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetGroupIdRequestMarshaller : IMarshaller<IRequest, GetGroupIdRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetGroupIdRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetGroupIdRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.IdentityStore");
            string target = "AWSIdentityStore.GetGroupId";
        ...
        private static GetGroupIdRequestMarshaller _instance = new GetGroupIdRequestMarshaller();        

        internal static GetGroupIdRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGroupIdRequestMarshaller Instance
        {
            get
            {
                return _instance;
