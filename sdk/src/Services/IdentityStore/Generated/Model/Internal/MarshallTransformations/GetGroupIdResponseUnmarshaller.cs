...
namespace Amazon.IdentityStore.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetGroupIdResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetGroupIdResponse response = new GetGroupIdResponse();
        ...
        private static GetGroupIdResponseUnmarshaller _instance = new GetGroupIdResponseUnmarshaller();        

        internal static GetGroupIdResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGroupIdResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
