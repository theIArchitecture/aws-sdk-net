...
namespace Amazon.IdentityStore.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetGroupMembershipIdRequestMarshaller : IMarshaller<IRequest, GetGroupMembershipIdRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetGroupMembershipIdRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetGroupMembershipIdRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.IdentityStore");
            string target = "AWSIdentityStore.GetGroupMembershipId";
        ...
        private static GetGroupMembershipIdRequestMarshaller _instance = new GetGroupMembershipIdRequestMarshaller();        

        internal static GetGroupMembershipIdRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGroupMembershipIdRequestMarshaller Instance
        {
            get
            {
                return _instance;
