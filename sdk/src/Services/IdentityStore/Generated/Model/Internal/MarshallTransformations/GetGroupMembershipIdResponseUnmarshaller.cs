...
namespace Amazon.IdentityStore.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetGroupMembershipIdResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetGroupMembershipIdResponse response = new GetGroupMembershipIdResponse();
        ...
        private static GetGroupMembershipIdResponseUnmarshaller _instance = new GetGroupMembershipIdResponseUnmarshaller();        

        internal static GetGroupMembershipIdResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGroupMembershipIdResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
