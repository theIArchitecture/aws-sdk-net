...
namespace Amazon.IdentityStore.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetUserIdRequestMarshaller : IMarshaller<IRequest, GetUserIdRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetUserIdRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetUserIdRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.IdentityStore");
            string target = "AWSIdentityStore.GetUserId";
        ...
        private static GetUserIdRequestMarshaller _instance = new GetUserIdRequestMarshaller();        

        internal static GetUserIdRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetUserIdRequestMarshaller Instance
        {
            get
            {
                return _instance;
