...
namespace Amazon.IdentityStore.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetUserIdResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetUserIdResponseUnmarshaller _instance = new GetUserIdResponseUnmarshaller();        

        internal static GetUserIdResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetUserIdResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
