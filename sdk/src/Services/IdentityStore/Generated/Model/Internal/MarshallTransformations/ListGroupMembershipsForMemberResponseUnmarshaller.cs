...
namespace Amazon.IdentityStore.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListGroupMembershipsForMemberResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListGroupMembershipsForMemberResponse response = new ListGroupMembershipsForMemberResponse();
        ...
        private static ListGroupMembershipsForMemberResponseUnmarshaller _instance = new ListGroupMembershipsForMemberResponseUnmarshaller();        

        internal static ListGroupMembershipsForMemberResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListGroupMembershipsForMemberResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
