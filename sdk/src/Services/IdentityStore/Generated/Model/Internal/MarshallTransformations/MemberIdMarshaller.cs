...
namespace Amazon.IdentityStore.Model.Internal.MarshallTransformations
{
    ...
    /// MemberId Marshaller
    /// </summary>
    public class MemberIdMarshaller : IRequestMarshaller<MemberId, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// </summary>
        public readonly static MemberIdMarshaller Instance = new MemberIdMarshaller();
