...
namespace Amazon.Imagebuilder.Internal
{
    ...
    public class AmazonImagebuilderAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonImagebuilderAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Imagebuilder.
        /// </summary>
        public AmazonImagebuilderAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonImagebuilderAuthSchemeParameters
            {
    ...
    public class AmazonImagebuilderAuthSchemeResolver : IAuthSchemeResolver<AmazonImagebuilderAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonImagebuilderAuthSchemeParameters authParameters)
        {
