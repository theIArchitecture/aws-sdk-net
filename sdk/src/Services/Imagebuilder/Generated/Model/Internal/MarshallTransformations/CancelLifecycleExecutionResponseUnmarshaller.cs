...
{
    /// <summary>
    /// Response Unmarshaller for CancelLifecycleExecution operation
    /// </summary>  
    public class CancelLifecycleExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelLifecycleExecutionResponse response = new CancelLifecycleExecutionResponse();
        ...
        private static CancelLifecycleExecutionResponseUnmarshaller _instance = new CancelLifecycleExecutionResponseUnmarshaller();        

        internal static CancelLifecycleExecutionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelLifecycleExecutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
