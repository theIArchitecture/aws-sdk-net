...
{
    /// <summary>
    /// Response Unmarshaller for FastLaunchConfiguration Object
    /// </summary>  
    public class FastLaunchConfigurationUnmarshaller : IJsonUnmarshaller<FastLaunchConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FastLaunchConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            FastLaunchConfiguration unmarshalledObject = new FastLaunchConfiguration();
        ...
        private static FastLaunchConfigurationUnmarshaller _instance = new FastLaunchConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static FastLaunchConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
