...
{
    /// <summary>
    /// Response Unmarshaller for GetMarketplaceResource operation
    /// </summary>  
    public class GetMarketplaceResourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMarketplaceResourceResponse response = new GetMarketplaceResourceResponse();
        ...
        private static GetMarketplaceResourceResponseUnmarshaller _instance = new GetMarketplaceResourceResponseUnmarshaller();        

        internal static GetMarketplaceResourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMarketplaceResourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
