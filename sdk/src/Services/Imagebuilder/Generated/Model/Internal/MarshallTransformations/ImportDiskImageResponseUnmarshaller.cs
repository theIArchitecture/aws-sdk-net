...
{
    /// <summary>
    /// Response Unmarshaller for ImportDiskImage operation
    /// </summary>  
    public class ImportDiskImageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ImportDiskImageResponse response = new ImportDiskImageResponse();
        ...
        private static ImportDiskImageResponseUnmarshaller _instance = new ImportDiskImageResponseUnmarshaller();        

        internal static ImportDiskImageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImportDiskImageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
