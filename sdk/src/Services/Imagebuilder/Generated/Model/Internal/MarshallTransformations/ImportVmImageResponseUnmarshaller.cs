...
{
    /// <summary>
    /// Response Unmarshaller for ImportVmImage operation
    /// </summary>  
    public class ImportVmImageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ImportVmImageResponse response = new ImportVmImageResponse();
        ...
        private static ImportVmImageResponseUnmarshaller _instance = new ImportVmImageResponseUnmarshaller();        

        internal static ImportVmImageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImportVmImageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
