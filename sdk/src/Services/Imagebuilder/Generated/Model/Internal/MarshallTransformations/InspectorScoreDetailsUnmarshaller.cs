...
namespace Amazon.Imagebuilder.Model.Internal.MarshallTransformations
{
    ...
    public class InspectorScoreDetailsUnmarshaller : IJsonUnmarshaller<InspectorScoreDetails, JsonUnmarshallerContext>
    {
        ...
        private static InspectorScoreDetailsUnmarshaller _instance = new InspectorScoreDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static InspectorScoreDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
