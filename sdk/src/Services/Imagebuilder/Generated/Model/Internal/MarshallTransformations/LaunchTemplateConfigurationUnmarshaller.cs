...
namespace Amazon.Imagebuilder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LaunchTemplateConfigurationUnmarshaller : IJsonUnmarshaller<LaunchTemplateConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LaunchTemplateConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("setDefaultVersion", targetDepth))
                {
                    ...
                    unmarshalledObject.SetDefaultVersion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
