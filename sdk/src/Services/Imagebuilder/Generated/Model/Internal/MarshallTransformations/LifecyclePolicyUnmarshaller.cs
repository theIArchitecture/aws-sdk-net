...
namespace Amazon.Imagebuilder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LifecyclePolicyUnmarshaller : IJsonUnmarshaller<LifecyclePolicy, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LifecyclePolicy Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = LifecyclePolicyResourceSelectionUnmarshaller.Instance;
