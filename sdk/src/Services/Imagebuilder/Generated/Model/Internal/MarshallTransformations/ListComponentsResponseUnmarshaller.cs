    ...
    public class ListComponentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ComponentVersion, ComponentVersionUnmarshaller>(ComponentVersionUnmarshaller.Instance);
                    response.ComponentVersionList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
