...
{
    /// <summary>
    /// Response Unmarshaller for ListImagePackages operation
    /// </summary>  
    public class ListImagePackagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListImagePackagesResponse response = new ListImagePackagesResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("imagePackageList", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<ImagePackage, ImagePackageUnmarshaller>(ImagePackageUnmarshaller.Instance);
                    response.ImagePackageList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListImagePackagesResponseUnmarshaller _instance = new ListImagePackagesResponseUnmarshaller();        

        internal static ListImagePackagesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListImagePackagesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
