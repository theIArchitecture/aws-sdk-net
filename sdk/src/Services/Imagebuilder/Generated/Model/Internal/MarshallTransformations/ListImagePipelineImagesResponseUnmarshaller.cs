    ...
    public class ListImagePipelineImagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ImageSummary, ImageSummaryUnmarshaller>(ImageSummaryUnmarshaller.Instance);
                    response.ImageSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
