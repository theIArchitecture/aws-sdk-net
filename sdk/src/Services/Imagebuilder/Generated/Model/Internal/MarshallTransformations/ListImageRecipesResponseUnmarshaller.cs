    ...
    public class ListImageRecipesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ImageRecipeSummary, ImageRecipeSummaryUnmarshaller>(ImageRecipeSummaryUnmarshaller.Instance);
                    response.ImageRecipeSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
