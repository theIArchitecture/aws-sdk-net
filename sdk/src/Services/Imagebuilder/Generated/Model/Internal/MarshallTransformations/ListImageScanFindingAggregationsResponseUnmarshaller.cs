...
{
    /// <summary>
    /// Response Unmarshaller for ListImageScanFindingAggregations operation
    /// </summary>  
    public class ListImageScanFindingAggregationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListImageScanFindingAggregationsResponse response = new ListImageScanFindingAggregationsResponse();
        ...
        private static ListImageScanFindingAggregationsResponseUnmarshaller _instance = new ListImageScanFindingAggregationsResponseUnmarshaller();        

        internal static ListImageScanFindingAggregationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListImageScanFindingAggregationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
