    ...
    public class ListImagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ImageVersion, ImageVersionUnmarshaller>(ImageVersionUnmarshaller.Instance);
                    response.ImageVersionList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
