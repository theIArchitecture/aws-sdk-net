...
{
    /// <summary>
    /// Response Unmarshaller for ListLifecycleExecutions operation
    /// </summary>  
    public class ListLifecycleExecutionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListLifecycleExecutionsResponse response = new ListLifecycleExecutionsResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("lifecycleExecutions", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<LifecycleExecution, LifecycleExecutionUnmarshaller>(LifecycleExecutionUnmarshaller.Instance);
                    response.LifecycleExecutions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListLifecycleExecutionsResponseUnmarshaller _instance = new ListLifecycleExecutionsResponseUnmarshaller();        

        internal static ListLifecycleExecutionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLifecycleExecutionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
