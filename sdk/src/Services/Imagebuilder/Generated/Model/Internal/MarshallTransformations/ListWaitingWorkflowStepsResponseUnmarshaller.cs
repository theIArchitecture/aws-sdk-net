...
{
    /// <summary>
    /// Response Unmarshaller for ListWaitingWorkflowSteps operation
    /// </summary>  
    public class ListWaitingWorkflowStepsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListWaitingWorkflowStepsResponse response = new ListWaitingWorkflowStepsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<WorkflowStepExecution, WorkflowStepExecutionUnmarshaller>(WorkflowStepExecutionUnmarshaller.Instance);
        ...
        private static ListWaitingWorkflowStepsResponseUnmarshaller _instance = new ListWaitingWorkflowStepsResponseUnmarshaller();        

        internal static ListWaitingWorkflowStepsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListWaitingWorkflowStepsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
