...
{
    /// <summary>
    /// Response Unmarshaller for ListWorkflowBuildVersions operation
    /// </summary>  
    public class ListWorkflowBuildVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListWorkflowBuildVersionsResponse response = new ListWorkflowBuildVersionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("workflowSummaryList", targetDepth))
                {
                    ...
                    response.WorkflowSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListWorkflowBuildVersionsResponseUnmarshaller _instance = new ListWorkflowBuildVersionsResponseUnmarshaller();        

        internal static ListWorkflowBuildVersionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListWorkflowBuildVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
