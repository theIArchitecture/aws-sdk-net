...
{
    /// <summary>
    /// Response Unmarshaller for ListWorkflowStepExecutions operation
    /// </summary>  
    public class ListWorkflowStepExecutionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListWorkflowStepExecutionsResponse response = new ListWorkflowStepExecutionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<WorkflowStepMetadata, WorkflowStepMetadataUnmarshaller>(WorkflowStepMetadataUnmarshaller.Instance);
        ...
        private static ListWorkflowStepExecutionsResponseUnmarshaller _instance = new ListWorkflowStepExecutionsResponseUnmarshaller();        

        internal static ListWorkflowStepExecutionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListWorkflowStepExecutionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
