...
namespace Amazon.Imagebuilder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SsmParameterConfigurationUnmarshaller : IJsonUnmarshaller<SsmParameterConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SsmParameterConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("amiAccountId", targetDepth))
                {
                    ...
                    unmarshalledObject.AmiAccountId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
