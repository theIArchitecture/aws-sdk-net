...
{
    /// <summary>
    /// Response Unmarshaller for StartResourceStateUpdate operation
    /// </summary>  
    public class StartResourceStateUpdateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartResourceStateUpdateResponse response = new StartResourceStateUpdateResponse();
        ...
        private static StartResourceStateUpdateResponseUnmarshaller _instance = new StartResourceStateUpdateResponseUnmarshaller();        

        internal static StartResourceStateUpdateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartResourceStateUpdateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
