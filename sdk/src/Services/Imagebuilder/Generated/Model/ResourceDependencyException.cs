...
namespace Amazon.Imagebuilder.Model
{
    ...
    public partial class ResourceDependencyException : AmazonImagebuilderException
    {
        ...
        public ResourceDependencyException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ResourceDependencyException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
