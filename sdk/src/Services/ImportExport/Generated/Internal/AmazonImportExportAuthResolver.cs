...
namespace Amazon.ImportExport.Internal
{
    ...
    public class AmazonImportExportAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonImportExportAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ImportExport.
        /// </summary>
        public AmazonImportExportAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonImportExportAuthSchemeParameters
            {
    ...
    public class AmazonImportExportAuthSchemeResolver : IAuthSchemeResolver<AmazonImportExportAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonImportExportAuthSchemeParameters authParameters)
        {
