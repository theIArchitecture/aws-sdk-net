...
namespace Amazon.ImportExport.Model
{
    ...
    public partial class CanceledJobIdException : AmazonImportExportException
    {
        ...
        public CanceledJobIdException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CanceledJobIdException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
