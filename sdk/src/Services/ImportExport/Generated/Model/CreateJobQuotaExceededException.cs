...
namespace Amazon.ImportExport.Model
{
    ...
    public partial class CreateJobQuotaExceededException : AmazonImportExportException
    {
        ...
        public CreateJobQuotaExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CreateJobQuotaExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
