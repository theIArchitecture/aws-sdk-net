...
namespace Amazon.ImportExport.Model
{
    ...
    public partial class InvalidFileSystemException : AmazonImportExportException
    {
        ...
        public InvalidFileSystemException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidFileSystemException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
