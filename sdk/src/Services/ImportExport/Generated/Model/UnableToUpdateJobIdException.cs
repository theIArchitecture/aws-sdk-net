...
namespace Amazon.ImportExport.Model
{
    ...
    public partial class UnableToUpdateJobIdException : AmazonImportExportException
    {
        ...
        public UnableToUpdateJobIdException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public UnableToUpdateJobIdException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
