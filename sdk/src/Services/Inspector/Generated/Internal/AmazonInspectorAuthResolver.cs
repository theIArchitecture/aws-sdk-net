...
namespace Amazon.Inspector.Internal
{
    ...
    public class AmazonInspectorAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonInspectorAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Inspector.
        /// </summary>
        public AmazonInspectorAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonInspectorAuthSchemeParameters
            {
    ...
    public class AmazonInspectorAuthSchemeResolver : IAuthSchemeResolver<AmazonInspectorAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonInspectorAuthSchemeParameters authParameters)
        {
