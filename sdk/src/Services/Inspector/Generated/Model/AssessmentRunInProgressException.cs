...
namespace Amazon.Inspector.Model
{
    ...
    public partial class AssessmentRunInProgressException : AmazonInspectorException
    {
        ...
        public AssessmentRunInProgressException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AssessmentRunInProgressException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
