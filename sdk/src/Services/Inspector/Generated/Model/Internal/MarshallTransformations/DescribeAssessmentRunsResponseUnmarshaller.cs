    ...
    public class DescribeAssessmentRunsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AssessmentRun, AssessmentRunUnmarshaller>(AssessmentRunUnmarshaller.Instance);
                    response.AssessmentRuns = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
