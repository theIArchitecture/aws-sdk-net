    ...
    public class DescribeResourceGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ResourceGroup, ResourceGroupUnmarshaller>(ResourceGroupUnmarshaller.Instance);
                    response.ResourceGroups = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
