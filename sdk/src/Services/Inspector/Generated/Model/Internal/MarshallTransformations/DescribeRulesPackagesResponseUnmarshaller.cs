    ...
    public class DescribeRulesPackagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<RulesPackage, RulesPackageUnmarshaller>(RulesPackageUnmarshaller.Instance);
                    response.RulesPackages = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
