...
namespace Amazon.Inspector.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExclusionUnmarshaller : IJsonUnmarshaller<Exclusion, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Exclusion Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
