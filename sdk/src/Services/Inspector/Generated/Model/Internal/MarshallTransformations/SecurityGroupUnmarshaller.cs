...
namespace Amazon.Inspector.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SecurityGroupUnmarshaller : IJsonUnmarshaller<SecurityGroup, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SecurityGroup Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
