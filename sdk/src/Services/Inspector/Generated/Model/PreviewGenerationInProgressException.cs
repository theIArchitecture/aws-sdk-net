...
namespace Amazon.Inspector.Model
{
    ...
    public partial class PreviewGenerationInProgressException : AmazonInspectorException
    {
        ...
        public PreviewGenerationInProgressException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public PreviewGenerationInProgressException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
