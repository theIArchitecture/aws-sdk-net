...
#if BCL
[assembly: AssemblyDescription("The Amazon Web Services SDK for .NET (4.7.2) - Amazon Inspector. Amazon Inspector identifies security issues in your application deployments.")]
#elif NETSTANDARD20
...
#elif NET8_0
[assembly: AssemblyDescription("The Amazon Web Services SDK for .NET (.NET 8.0) - Amazon Inspector. Amazon Inspector identifies security issues in your application deployments.")]
#else
