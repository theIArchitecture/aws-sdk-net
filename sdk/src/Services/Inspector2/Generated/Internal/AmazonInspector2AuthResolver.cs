...
namespace Amazon.Inspector2.Internal
{
    ...
    public class AmazonInspector2AuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonInspector2AuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Inspector2.
        /// </summary>
        public AmazonInspector2AuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonInspector2AuthSchemeParameters
            {
    ...
    public class AmazonInspector2AuthSchemeResolver : IAuthSchemeResolver<AmazonInspector2AuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonInspector2AuthSchemeParameters authParameters)
        {
