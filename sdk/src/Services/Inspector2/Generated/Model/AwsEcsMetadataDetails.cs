...
namespace Amazon.Inspector2.Model
{
    ...
    /// </summary>
    public partial class AwsEcsMetadataDetails
    {
        private string _detailsGroup;
        private string _taskDefinitionArn;

        /// <summary>
        /// Gets and sets the property DetailsGroup. 
        /// <para>
        /// The details group information for a task in a cluster.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true, Min=1, Max=256)]
        public string DetailsGroup
        {
            get { return this._detailsGroup; }
            set { this._detailsGroup = value; }
        }

        // Check to see if DetailsGroup property is set
        internal bool IsSetDetailsGroup()
        {
            return this._detailsGroup != null;
        }
