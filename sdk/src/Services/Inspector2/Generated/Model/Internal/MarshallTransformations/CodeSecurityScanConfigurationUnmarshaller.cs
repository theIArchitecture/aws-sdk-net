...
{
    /// <summary>
    /// Response Unmarshaller for CodeSecurityScanConfiguration Object
    /// </summary>  
    public class CodeSecurityScanConfigurationUnmarshaller : IJsonUnmarshaller<CodeSecurityScanConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CodeSecurityScanConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            CodeSecurityScanConfiguration unmarshalledObject = new CodeSecurityScanConfiguration();
        ...
        private static CodeSecurityScanConfigurationUnmarshaller _instance = new CodeSecurityScanConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CodeSecurityScanConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
