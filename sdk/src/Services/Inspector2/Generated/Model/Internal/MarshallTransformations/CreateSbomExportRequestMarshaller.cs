...
{
    /// <summary>
    /// CreateSbomExport Request Marshaller
    /// </summary>       
    public class CreateSbomExportRequestMarshaller : IMarshaller<IRequest, CreateSbomExportRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateSbomExportRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateSbomExportRequest publicRequest)
        {
        ...
        private static CreateSbomExportRequestMarshaller _instance = new CreateSbomExportRequestMarshaller();        

        internal static CreateSbomExportRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSbomExportRequestMarshaller Instance
        {
            get
            {
                return _instance;
