...
{
    /// <summary>
    /// Disable Request Marshaller
    /// </summary>       
    public class DisableRequestMarshaller : IMarshaller<IRequest, DisableRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DisableRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DisableRequest publicRequest)
        {
        ...
        private static DisableRequestMarshaller _instance = new DisableRequestMarshaller();        

        internal static DisableRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisableRequestMarshaller Instance
        {
            get
            {
                return _instance;
