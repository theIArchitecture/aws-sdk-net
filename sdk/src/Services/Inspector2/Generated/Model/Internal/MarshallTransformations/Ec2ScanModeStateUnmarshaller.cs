...
namespace Amazon.Inspector2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class Ec2ScanModeStateUnmarshaller : IJsonUnmarshaller<Ec2ScanModeState, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Ec2ScanModeState Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ScanModeStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
