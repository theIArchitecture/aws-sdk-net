...
namespace Amazon.Inspector2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EcrContainerImageMetadataUnmarshaller : IJsonUnmarshaller<EcrContainerImageMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EcrContainerImageMetadata Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("imagePulledAt", targetDepth))
                {
                    ...
                    unmarshalledObject.ImagePulledAt = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
