...
{
    /// <summary>
    /// Enable Request Marshaller
    /// </summary>       
    public class EnableRequestMarshaller : IMarshaller<IRequest, EnableRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((EnableRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(EnableRequest publicRequest)
        {
        ...
        private static EnableRequestMarshaller _instance = new EnableRequestMarshaller();        

        internal static EnableRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EnableRequestMarshaller Instance
        {
            get
            {
                return _instance;
