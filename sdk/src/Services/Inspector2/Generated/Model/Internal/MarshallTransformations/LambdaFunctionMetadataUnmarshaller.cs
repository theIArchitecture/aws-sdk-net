...
namespace Amazon.Inspector2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LambdaFunctionMetadataUnmarshaller : IJsonUnmarshaller<LambdaFunctionMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LambdaFunctionMetadata Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("functionTags", targetDepth))
                {
                    ...
                    unmarshalledObject.FunctionTags = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
