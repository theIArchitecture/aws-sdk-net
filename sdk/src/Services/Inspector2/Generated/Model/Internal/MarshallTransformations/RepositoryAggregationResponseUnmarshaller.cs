...
namespace Amazon.Inspector2.Model.Internal.MarshallTransformations
{
    ...
    public class RepositoryAggregationResponseUnmarshaller : IJsonUnmarshaller<RepositoryAggregationResponse, JsonUnmarshallerContext>
    {
        ...
        private static RepositoryAggregationResponseUnmarshaller _instance = new RepositoryAggregationResponseUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RepositoryAggregationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
