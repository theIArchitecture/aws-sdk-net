...
{
    /// <summary>
    /// Response Unmarshaller for ResourceScanMetadata Object
    /// </summary>  
    public class ResourceScanMetadataUnmarshaller : IJsonUnmarshaller<ResourceScanMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResourceScanMetadata Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ResourceScanMetadata unmarshalledObject = new ResourceScanMetadata();
        ...
        private static ResourceScanMetadataUnmarshaller _instance = new ResourceScanMetadataUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ResourceScanMetadataUnmarshaller Instance
        {
            get
            {
                return _instance;
