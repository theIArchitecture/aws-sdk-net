...
{
    /// <summary>
    /// UpdateCisScanConfiguration Request Marshaller
    /// </summary>       
    public class UpdateCisScanConfigurationRequestMarshaller : IMarshaller<IRequest, UpdateCisScanConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateCisScanConfigurationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateCisScanConfigurationRequest publicRequest)
        {
        ...
        private static UpdateCisScanConfigurationRequestMarshaller _instance = new UpdateCisScanConfigurationRequestMarshaller();        

        internal static UpdateCisScanConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCisScanConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
