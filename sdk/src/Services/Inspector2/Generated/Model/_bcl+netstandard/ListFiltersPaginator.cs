...
namespace Amazon.Inspector2.Model
{
    ...
    internal sealed partial class ListFiltersPaginator : IPaginator<ListFiltersResponse>, IListFiltersPaginator
    {
        ...
        async IAsyncEnumerable<ListFiltersResponse> IPaginator<ListFiltersResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
