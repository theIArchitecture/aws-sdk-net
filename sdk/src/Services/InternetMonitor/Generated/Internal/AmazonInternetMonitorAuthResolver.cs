...
namespace Amazon.InternetMonitor.Internal
{
    ...
    public class AmazonInternetMonitorAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonInternetMonitorAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for InternetMonitor.
        /// </summary>
        public AmazonInternetMonitorAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonInternetMonitorAuthSchemeParameters
            {
    ...
    public class AmazonInternetMonitorAuthSchemeResolver : IAuthSchemeResolver<AmazonInternetMonitorAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonInternetMonitorAuthSchemeParameters authParameters)
        {
