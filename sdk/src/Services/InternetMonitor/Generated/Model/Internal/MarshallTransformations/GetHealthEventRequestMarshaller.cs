...
namespace Amazon.InternetMonitor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetHealthEventRequestMarshaller : IMarshaller<IRequest, GetHealthEventRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetHealthEventRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetHealthEventRequest publicRequest)
        {
        ...
        private static GetHealthEventRequestMarshaller _instance = new GetHealthEventRequestMarshaller();        

        internal static GetHealthEventRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetHealthEventRequestMarshaller Instance
        {
            get
            {
                return _instance;
