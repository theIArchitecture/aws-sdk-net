...
namespace Amazon.InternetMonitor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetQueryStatusRequestMarshaller : IMarshaller<IRequest, GetQueryStatusRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetQueryStatusRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetQueryStatusRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v20210603/Monitors/{MonitorName}/Queries/{QueryId}/Status";

            return request;
        }
        private static GetQueryStatusRequestMarshaller _instance = new GetQueryStatusRequestMarshaller();        

        internal static GetQueryStatusRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetQueryStatusRequestMarshaller Instance
        {
            get
            {
                return _instance;
