...
namespace Amazon.InternetMonitor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListHealthEventsRequestMarshaller : IMarshaller<IRequest, ListHealthEventsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListHealthEventsRequestMarshaller _instance = new ListHealthEventsRequestMarshaller();        

        internal static ListHealthEventsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListHealthEventsRequestMarshaller Instance
        {
            get
            {
                return _instance;
