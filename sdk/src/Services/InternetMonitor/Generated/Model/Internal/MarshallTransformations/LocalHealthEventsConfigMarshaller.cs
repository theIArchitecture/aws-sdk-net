...
namespace Amazon.InternetMonitor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public class LocalHealthEventsConfigMarshaller : IRequestMarshaller<LocalHealthEventsConfig, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// </summary>
        public readonly static LocalHealthEventsConfigMarshaller Instance = new LocalHealthEventsConfigMarshaller();
