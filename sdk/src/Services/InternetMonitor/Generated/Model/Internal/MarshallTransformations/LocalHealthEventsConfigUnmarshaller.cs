...
namespace Amazon.InternetMonitor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LocalHealthEventsConfigUnmarshaller : IJsonUnmarshaller<LocalHealthEventsConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LocalHealthEventsConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = NullableDoubleUnmarshaller.Instance;
                    unmarshalledObject.MinTrafficImpact = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
