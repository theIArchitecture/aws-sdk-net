...
namespace Amazon.InternetMonitor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RoundTripTimeUnmarshaller : IJsonUnmarshaller<RoundTripTime, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RoundTripTime Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static RoundTripTimeUnmarshaller _instance = new RoundTripTimeUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RoundTripTimeUnmarshaller Instance
        {
            get
            {
                return _instance;
