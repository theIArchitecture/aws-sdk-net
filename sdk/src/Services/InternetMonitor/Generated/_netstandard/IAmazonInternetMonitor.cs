...
namespace Amazon.InternetMonitor
{
    ...
    public partial interface IAmazonInternetMonitor : IAmazonService, IDisposable
    {
        ...
        Task<GetQueryStatusResponse> GetQueryStatusAsync(GetQueryStatusRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonInternetMonitorConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonInternetMonitorConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonInternetMonitorConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonInternetMonitorConfig to create AmazonInternetMonitorClient");
            }

            return awsCredentials == null ? 
                    new AmazonInternetMonitorClient(serviceClientConfig) :
                    new AmazonInternetMonitorClient(awsCredentials, serviceClientConfig);
        }
