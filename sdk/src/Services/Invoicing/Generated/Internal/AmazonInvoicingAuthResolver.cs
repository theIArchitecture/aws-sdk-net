...
namespace Amazon.Invoicing.Internal
{
    ...
    public class AmazonInvoicingAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonInvoicingAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Invoicing.
        /// </summary>
        public AmazonInvoicingAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonInvoicingAuthSchemeParameters
            {
    ...
    public class AmazonInvoicingAuthSchemeResolver : IAuthSchemeResolver<AmazonInvoicingAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonInvoicingAuthSchemeParameters authParameters)
        {
