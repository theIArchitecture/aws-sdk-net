...
{
    /// <summary>
    /// CreateInvoiceUnit Request Marshaller
    /// </summary>       
    public class CreateInvoiceUnitRequestMarshaller : IMarshaller<IRequest, CreateInvoiceUnitRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateInvoiceUnitRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateInvoiceUnitRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Invoicing");
            string target = "Invoicing.CreateInvoiceUnit";
            ...
            if(publicRequest.IsSetInvoiceReceiver())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.InvoiceReceiver);
            }
        ...
        private static CreateInvoiceUnitRequestMarshaller _instance = new CreateInvoiceUnitRequestMarshaller();        

        internal static CreateInvoiceUnitRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateInvoiceUnitRequestMarshaller Instance
        {
            get
            {
                return _instance;
