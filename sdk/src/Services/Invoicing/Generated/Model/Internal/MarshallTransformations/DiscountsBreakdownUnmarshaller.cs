...
namespace Amazon.Invoicing.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DiscountsBreakdownUnmarshaller : IJsonUnmarshaller<DiscountsBreakdown, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DiscountsBreakdown Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DiscountsBreakdownAmount, DiscountsBreakdownAmountUnmarshaller>(DiscountsBreakdownAmountUnmarshaller.Instance);
