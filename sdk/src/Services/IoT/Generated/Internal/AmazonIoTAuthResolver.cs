...
namespace Amazon.IoT.Internal
{
    ...
    public class AmazonIoTAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonIoTAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for IoT.
        /// </summary>
        public AmazonIoTAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonIoTAuthSchemeParameters
            {
    ...
    public class AmazonIoTAuthSchemeResolver : IAuthSchemeResolver<AmazonIoTAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonIoTAuthSchemeParameters authParameters)
        {
