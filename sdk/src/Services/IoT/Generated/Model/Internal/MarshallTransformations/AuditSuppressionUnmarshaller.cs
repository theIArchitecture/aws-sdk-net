...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AuditSuppressionUnmarshaller : IJsonUnmarshaller<AuditSuppression, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AuditSuppression Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("suppressIndefinitely", targetDepth))
                {
                    ...
                    unmarshalledObject.SuppressIndefinitely = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
