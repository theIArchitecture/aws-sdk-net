...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CloudwatchAlarmActionUnmarshaller : IJsonUnmarshaller<CloudwatchAlarmAction, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CloudwatchAlarmAction Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.StateValue = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
