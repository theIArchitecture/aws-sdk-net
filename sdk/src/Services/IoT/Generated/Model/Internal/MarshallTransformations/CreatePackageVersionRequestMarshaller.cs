...
{
    /// <summary>
    /// CreatePackageVersion Request Marshaller
    /// </summary>       
    public class CreatePackageVersionRequestMarshaller : IMarshaller<IRequest, CreatePackageVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreatePackageVersionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreatePackageVersionRequest publicRequest)
        {
        ...
        private static CreatePackageVersionRequestMarshaller _instance = new CreatePackageVersionRequestMarshaller();        

        internal static CreatePackageVersionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePackageVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
