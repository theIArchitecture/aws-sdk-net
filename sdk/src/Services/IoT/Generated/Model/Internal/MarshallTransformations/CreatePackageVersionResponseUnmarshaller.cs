...
{
    /// <summary>
    /// Response Unmarshaller for CreatePackageVersion operation
    /// </summary>  
    public class CreatePackageVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePackageVersionResponse response = new CreatePackageVersionResponse();
        ...
        private static CreatePackageVersionResponseUnmarshaller _instance = new CreatePackageVersionResponseUnmarshaller();        

        internal static CreatePackageVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePackageVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
