...
{
    /// <summary>
    /// Response Unmarshaller for DeleteCertificateProvider operation
    /// </summary>  
    public class DeleteCertificateProviderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteCertificateProviderResponse response = new DeleteCertificateProviderResponse();
        ...
        private static DeleteCertificateProviderResponseUnmarshaller _instance = new DeleteCertificateProviderResponseUnmarshaller();        

        internal static DeleteCertificateProviderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCertificateProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
