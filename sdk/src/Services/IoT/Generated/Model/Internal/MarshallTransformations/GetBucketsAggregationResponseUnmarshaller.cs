...
{
    /// <summary>
    /// Response Unmarshaller for GetBucketsAggregation operation
    /// </summary>  
    public class GetBucketsAggregationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetBucketsAggregationResponse response = new GetBucketsAggregationResponse();
        ...
        private static GetBucketsAggregationResponseUnmarshaller _instance = new GetBucketsAggregationResponseUnmarshaller();        

        internal static GetBucketsAggregationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBucketsAggregationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
