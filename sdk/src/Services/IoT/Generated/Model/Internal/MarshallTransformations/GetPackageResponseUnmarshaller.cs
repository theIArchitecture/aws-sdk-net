...
{
    /// <summary>
    /// Response Unmarshaller for GetPackage operation
    /// </summary>  
    public class GetPackageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("defaultVersionName", targetDepth))
                {
                    ...
                    response.DefaultVersionName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetPackageResponseUnmarshaller _instance = new GetPackageResponseUnmarshaller();        

        internal static GetPackageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPackageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
