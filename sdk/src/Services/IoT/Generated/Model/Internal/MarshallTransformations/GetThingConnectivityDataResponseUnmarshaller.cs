...
{
    /// <summary>
    /// Response Unmarshaller for GetThingConnectivityData operation
    /// </summary>  
    public class GetThingConnectivityDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetThingConnectivityDataResponse response = new GetThingConnectivityDataResponse();
        ...
        private static GetThingConnectivityDataResponseUnmarshaller _instance = new GetThingConnectivityDataResponseUnmarshaller();        

        internal static GetThingConnectivityDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetThingConnectivityDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
