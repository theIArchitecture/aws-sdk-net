...
{
    /// <summary>
    /// Response Unmarshaller for ListFleetMetrics operation
    /// </summary>  
    public class ListFleetMetricsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListFleetMetricsResponse response = new ListFleetMetricsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<FleetMetricNameAndArn, FleetMetricNameAndArnUnmarshaller>(FleetMetricNameAndArnUnmarshaller.Instance);
                    response.FleetMetrics = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListFleetMetricsResponseUnmarshaller _instance = new ListFleetMetricsResponseUnmarshaller();        

        internal static ListFleetMetricsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFleetMetricsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
