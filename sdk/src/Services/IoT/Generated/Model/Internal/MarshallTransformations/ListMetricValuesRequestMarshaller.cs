...
{
    /// <summary>
    /// ListMetricValues Request Marshaller
    /// </summary>       
    public class ListMetricValuesRequestMarshaller : IMarshaller<IRequest, ListMetricValuesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListMetricValuesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListMetricValuesRequest publicRequest)
        {
            ...
            request.ResourcePath = "/metric-values";
            request.UseQueryString = true;

            return request;
        }
        private static ListMetricValuesRequestMarshaller _instance = new ListMetricValuesRequestMarshaller();        

        internal static ListMetricValuesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMetricValuesRequestMarshaller Instance
        {
            get
            {
                return _instance;
