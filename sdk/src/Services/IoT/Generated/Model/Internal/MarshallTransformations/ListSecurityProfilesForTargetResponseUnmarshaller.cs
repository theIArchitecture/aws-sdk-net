    ...
    public class ListSecurityProfilesForTargetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SecurityProfileTargetMapping, SecurityProfileTargetMappingUnmarshaller>(SecurityProfileTargetMappingUnmarshaller.Instance);
                    response.SecurityProfileTargetMappings = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
