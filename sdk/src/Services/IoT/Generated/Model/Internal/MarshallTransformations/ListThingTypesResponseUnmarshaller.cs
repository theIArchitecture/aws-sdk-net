    ...
    public class ListThingTypesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ThingTypeDefinition, ThingTypeDefinitionUnmarshaller>(ThingTypeDefinitionUnmarshaller.Instance);
                    response.ThingTypes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
