...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OTAUpdateFileUnmarshaller : IJsonUnmarshaller<OTAUpdateFile, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public OTAUpdateFile Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("codeSigning", targetDepth))
                {
                    ...
                    unmarshalledObject.CodeSigning = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FileVersion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
