...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RetryCriteriaUnmarshaller : IJsonUnmarshaller<RetryCriteria, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RetryCriteria Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("numberOfRetries", targetDepth))
                {
                    ...
                    unmarshalledObject.NumberOfRetries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
