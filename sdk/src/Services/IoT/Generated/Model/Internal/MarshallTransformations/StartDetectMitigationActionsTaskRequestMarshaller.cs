    ...
    public class StartDetectMitigationActionsTaskRequestMarshaller : IMarshaller<IRequest, StartDetectMitigationActionsTaskRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(StartDetectMitigationActionsTaskRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetIncludeOnlyActiveViolations())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.IncludeOnlyActiveViolations.Value);
            }

            if(publicRequest.IsSetIncludeSuppressedAlerts())
            {
                context.Writer.WritePropertyName("includeSuppressedAlerts");
                context.Writer.WriteBooleanValue(publicRequest.IncludeSuppressedAlerts.Value);
            }
