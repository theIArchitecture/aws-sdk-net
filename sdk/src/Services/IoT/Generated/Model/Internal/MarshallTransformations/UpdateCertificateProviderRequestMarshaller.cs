...
{
    /// <summary>
    /// UpdateCertificateProvider Request Marshaller
    /// </summary>       
    public class UpdateCertificateProviderRequestMarshaller : IMarshaller<IRequest, UpdateCertificateProviderRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateCertificateProviderRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateCertificateProviderRequest publicRequest)
        {
        ...
        private static UpdateCertificateProviderRequestMarshaller _instance = new UpdateCertificateProviderRequestMarshaller();        

        internal static UpdateCertificateProviderRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCertificateProviderRequestMarshaller Instance
        {
            get
            {
                return _instance;
