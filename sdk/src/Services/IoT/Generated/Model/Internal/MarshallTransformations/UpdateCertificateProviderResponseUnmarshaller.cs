...
{
    /// <summary>
    /// Response Unmarshaller for UpdateCertificateProvider operation
    /// </summary>  
    public class UpdateCertificateProviderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateCertificateProviderResponse response = new UpdateCertificateProviderResponse();
        ...
        private static UpdateCertificateProviderResponseUnmarshaller _instance = new UpdateCertificateProviderResponseUnmarshaller();        

        internal static UpdateCertificateProviderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCertificateProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
