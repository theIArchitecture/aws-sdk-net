...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    public class UpdatePackageRequestMarshaller : IMarshaller<IRequest, UpdatePackageRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(UpdatePackageRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetDefaultVersionName())
            {
                context.Writer.WritePropertyName("defaultVersionName");
                context.Writer.WriteStringValue(publicRequest.DefaultVersionName);
            }
            ...
            if(publicRequest.IsSetUnsetDefaultVersion())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.UnsetDefaultVersion.Value);
            }
