...
{
    /// <summary>
    /// Response Unmarshaller for UpdateThingType operation
    /// </summary>  
    public class UpdateThingTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateThingTypeResponse response = new UpdateThingTypeResponse();
        ...
        private static UpdateThingTypeResponseUnmarshaller _instance = new UpdateThingTypeResponseUnmarshaller();        

        internal static UpdateThingTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateThingTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
