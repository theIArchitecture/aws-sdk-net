...
namespace Amazon.IoT.Model
{
    ...
    public partial class RegistrationCodeValidationException : AmazonIoTException
    {
        ...
        public RegistrationCodeValidationException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public RegistrationCodeValidationException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
