...
namespace Amazon.IoT.Model
{
    ...
    internal sealed partial class ListJobTemplatesPaginator : IPaginator<ListJobTemplatesResponse>, IListJobTemplatesPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<JobTemplateSummary> JobTemplates => 
            new PaginatedResultKeyResponse<ListJobTemplatesResponse, JobTemplateSummary>(this, (i) => i.JobTemplates ?? new List<JobTemplateSummary>());

        internal ListJobTemplatesPaginator(IAmazonIoT client, ListJobTemplatesRequest request)
        {
            this._client = client;
        ...
        async IAsyncEnumerable<ListJobTemplatesResponse> IPaginator<ListJobTemplatesResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
