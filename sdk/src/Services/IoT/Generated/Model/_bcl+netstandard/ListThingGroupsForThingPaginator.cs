...
namespace Amazon.IoT.Model
{
    ...
    internal sealed partial class ListThingGroupsForThingPaginator : IPaginator<ListThingGroupsForThingResponse>, IListThingGroupsForThingPaginator
    {
        ...
        public IPaginatedEnumerable<GroupNameAndArn> ThingGroups => 
            new PaginatedResultKeyResponse<ListThingGroupsForThingResponse, GroupNameAndArn>(this, (i) => i.ThingGroups ?? new List<GroupNameAndArn>());
        ...
        async IAsyncEnumerable<ListThingGroupsForThingResponse> IPaginator<ListThingGroupsForThingResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
