...
namespace Amazon.IoT
{
    ...
    /// </summary>
    public class CertificateProviderOperation : ConstantClass
    {

        /// <summary>
        /// Constant CreateCertificateFromCsr for CertificateProviderOperation
        /// </summary>
        public static readonly CertificateProviderOperation CreateCertificateFromCsr = new CertificateProviderOperation("CreateCertificateFromCsr");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public CertificateProviderOperation(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static CertificateProviderOperation FindValue(string value)
        {
            return FindValue<CertificateProviderOperation>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator CertificateProviderOperation(string value)
        {
            return FindValue(value);
        }
    }
    ...
    /// <summary>
    /// Constants used for properties of type ConfigName.
    /// </summary>
    public class ConfigName : ConstantClass
    {

        /// <summary>
        /// Constant CERT_AGE_THRESHOLD_IN_DAYS for ConfigName
        /// </summary>
        public static readonly ConfigName CERT_AGE_THRESHOLD_IN_DAYS = new ConfigName("CERT_AGE_THRESHOLD_IN_DAYS");
        /// <summary>
        /// Constant CERT_EXPIRATION_THRESHOLD_IN_DAYS for ConfigName
        /// </summary>
        public static readonly ConfigName CERT_EXPIRATION_THRESHOLD_IN_DAYS = new ConfigName("CERT_EXPIRATION_THRESHOLD_IN_DAYS");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public ConfigName(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static ConfigName FindValue(string value)
        {
            return FindValue<ConfigName>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator ConfigName(string value)
        {
            return FindValue(value);
        }
    }
    ...
    public class ConfigurationStatus : ConstantClass
    {
        ...
        /// <summary>
        /// Constant HEALTHY for ConfigurationStatus
        /// </summary>
        public static readonly ConfigurationStatus HEALTHY = new ConfigurationStatus("HEALTHY");
        /// <summary>
        /// Constant UNHEALTHY for ConfigurationStatus
        /// </summary>
        public static readonly ConfigurationStatus UNHEALTHY = new ConfigurationStatus("UNHEALTHY");
    ...
    /// </summary>
    public class TargetFieldOrder : ConstantClass
    {

        /// <summary>
        /// Constant LatLon for TargetFieldOrder
        /// </summary>
        public static readonly TargetFieldOrder LatLon = new TargetFieldOrder("LatLon");
        /// <summary>
        /// Constant LonLat for TargetFieldOrder
        /// </summary>
        public static readonly TargetFieldOrder LonLat = new TargetFieldOrder("LonLat");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public TargetFieldOrder(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static TargetFieldOrder FindValue(string value)
        {
            return FindValue<TargetFieldOrder>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator TargetFieldOrder(string value)
        {
            return FindValue(value);
        }
    }
    ...
    /// </summary>
    public class ThingPrincipalType : ConstantClass
    {

        /// <summary>
        /// Constant EXCLUSIVE_THING for ThingPrincipalType
        /// </summary>
        public static readonly ThingPrincipalType EXCLUSIVE_THING = new ThingPrincipalType("EXCLUSIVE_THING");
        /// <summary>
        /// Constant NON_EXCLUSIVE_THING for ThingPrincipalType
        /// </summary>
        public static readonly ThingPrincipalType NON_EXCLUSIVE_THING = new ThingPrincipalType("NON_EXCLUSIVE_THING");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public ThingPrincipalType(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static ThingPrincipalType FindValue(string value)
        {
            return FindValue<ThingPrincipalType>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator ThingPrincipalType(string value)
        {
            return FindValue(value);
        }
    }
