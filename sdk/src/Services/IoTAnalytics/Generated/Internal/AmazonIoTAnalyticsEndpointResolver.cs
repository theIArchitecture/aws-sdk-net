...
{
    /// <summary>
    /// Amazon IoTAnalytics endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for IoTAnalytics service requests.
    /// Collects values for IoTAnalyticsEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses IoTAnalyticsEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonIoTAnalyticsEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonIoTAnalyticsConfig)requestContext.ClientConfig;
            var result = new IoTAnalyticsEndpointParameters();
