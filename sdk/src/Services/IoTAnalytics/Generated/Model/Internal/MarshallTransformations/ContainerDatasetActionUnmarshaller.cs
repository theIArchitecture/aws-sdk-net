...
namespace Amazon.IoTAnalytics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ContainerDatasetActionUnmarshaller : IJsonUnmarshaller<ContainerDatasetAction, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ContainerDatasetAction Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("resourceConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.ResourceConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
