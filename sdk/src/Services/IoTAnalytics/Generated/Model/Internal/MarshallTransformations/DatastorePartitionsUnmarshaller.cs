...
namespace Amazon.IoTAnalytics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DatastorePartitionsUnmarshaller : IJsonUnmarshaller<DatastorePartitions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DatastorePartitions Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DatastorePartition, DatastorePartitionUnmarshaller>(DatastorePartitionUnmarshaller.Instance);
