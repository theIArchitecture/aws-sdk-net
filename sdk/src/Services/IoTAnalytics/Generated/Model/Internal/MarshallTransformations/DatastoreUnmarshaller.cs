...
namespace Amazon.IoTAnalytics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DatastoreUnmarshaller : IJsonUnmarshaller<Datastore, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Datastore Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("fileFormatConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.FileFormatConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
