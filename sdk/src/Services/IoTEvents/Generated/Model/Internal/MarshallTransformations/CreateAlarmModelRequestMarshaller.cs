...
{
    /// <summary>
    /// CreateAlarmModel Request Marshaller
    /// </summary>       
    public class CreateAlarmModelRequestMarshaller : IMarshaller<IRequest, CreateAlarmModelRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateAlarmModelRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateAlarmModelRequest publicRequest)
        {
            ...
            request.ResourcePath = "/alarm-models";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetAlarmModelName())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.AlarmModelName);
            }
        ...
        private static CreateAlarmModelRequestMarshaller _instance = new CreateAlarmModelRequestMarshaller();        

        internal static CreateAlarmModelRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAlarmModelRequestMarshaller Instance
        {
            get
            {
                return _instance;
