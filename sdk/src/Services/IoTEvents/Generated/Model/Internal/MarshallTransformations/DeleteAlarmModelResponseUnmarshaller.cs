...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAlarmModel operation
    /// </summary>  
    public class DeleteAlarmModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAlarmModelResponse response = new DeleteAlarmModelResponse();
        ...
        private static DeleteAlarmModelResponseUnmarshaller _instance = new DeleteAlarmModelResponseUnmarshaller();        

        internal static DeleteAlarmModelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAlarmModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
