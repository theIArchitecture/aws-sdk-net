...
namespace Amazon.IoTEvents.Model.Internal.MarshallTransformations
{
    ...
    public class EmailRecipientsMarshaller : IRequestMarshaller<EmailRecipients, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(EmailRecipients requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetTo())
            {
                ...
                foreach(var requestObjectToListValue in requestObject.To)
                {
                    context.Writer.WriteStartObject();

                    var marshaller = RecipientDetailMarshaller.Instance;
                    marshaller.Marshall(requestObjectToListValue, context);
