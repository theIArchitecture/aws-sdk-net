...
{
    /// <summary>
    /// Response Unmarshaller for GetDetectorModelAnalysisResults operation
    /// </summary>  
    public class GetDetectorModelAnalysisResultsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDetectorModelAnalysisResultsResponse response = new GetDetectorModelAnalysisResultsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("analysisResults", targetDepth))
                {
                    ...
                    response.AnalysisResults = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetDetectorModelAnalysisResultsResponseUnmarshaller _instance = new GetDetectorModelAnalysisResultsResponseUnmarshaller();        

        internal static GetDetectorModelAnalysisResultsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDetectorModelAnalysisResultsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
