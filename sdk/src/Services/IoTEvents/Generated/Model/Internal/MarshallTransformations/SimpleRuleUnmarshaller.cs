...
namespace Amazon.IoTEvents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SimpleRuleUnmarshaller : IJsonUnmarshaller<SimpleRule, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SimpleRule Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.InputProperty = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
