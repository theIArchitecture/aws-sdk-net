...
{
    /// <summary>
    /// Response Unmarshaller for StartDetectorModelAnalysis operation
    /// </summary>  
    public class StartDetectorModelAnalysisResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartDetectorModelAnalysisResponse response = new StartDetectorModelAnalysisResponse();
        ...
        private static StartDetectorModelAnalysisResponseUnmarshaller _instance = new StartDetectorModelAnalysisResponseUnmarshaller();        

        internal static StartDetectorModelAnalysisResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartDetectorModelAnalysisResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
