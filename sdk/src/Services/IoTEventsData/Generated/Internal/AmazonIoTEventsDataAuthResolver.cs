...
namespace Amazon.IoTEventsData.Internal
{
    ...
    public class AmazonIoTEventsDataAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonIoTEventsDataAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for IoTEventsData.
        /// </summary>
        public AmazonIoTEventsDataAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonIoTEventsDataAuthSchemeParameters
            {
    ...
    public class AmazonIoTEventsDataAuthSchemeResolver : IAuthSchemeResolver<AmazonIoTEventsDataAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonIoTEventsDataAuthSchemeParameters authParameters)
        {
