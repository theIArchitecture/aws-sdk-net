...
{
    /// <summary>
    /// BatchDisableAlarm Request Marshaller
    /// </summary>       
    public class BatchDisableAlarmRequestMarshaller : IMarshaller<IRequest, BatchDisableAlarmRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((BatchDisableAlarmRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(BatchDisableAlarmRequest publicRequest)
        {
        ...
        private static BatchDisableAlarmRequestMarshaller _instance = new BatchDisableAlarmRequestMarshaller();        

        internal static BatchDisableAlarmRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDisableAlarmRequestMarshaller Instance
        {
            get
            {
                return _instance;
