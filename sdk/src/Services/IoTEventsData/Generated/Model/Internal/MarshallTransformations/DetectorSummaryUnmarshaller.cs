...
namespace Amazon.IoTEventsData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DetectorSummaryUnmarshaller : IJsonUnmarshaller<DetectorSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DetectorSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
