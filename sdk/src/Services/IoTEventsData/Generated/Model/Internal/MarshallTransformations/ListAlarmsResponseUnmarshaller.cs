...
{
    /// <summary>
    /// Response Unmarshaller for ListAlarms operation
    /// </summary>  
    public class ListAlarmsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListAlarmsResponseUnmarshaller _instance = new ListAlarmsResponseUnmarshaller();        

        internal static ListAlarmsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAlarmsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
