...
namespace Amazon.IoTFleetHub.Internal
{
    ...
    public class AmazonIoTFleetHubAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonIoTFleetHubAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for IoTFleetHub.
        /// </summary>
        public AmazonIoTFleetHubAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonIoTFleetHubAuthSchemeParameters
            {
    ...
    public class AmazonIoTFleetHubAuthSchemeResolver : IAuthSchemeResolver<AmazonIoTFleetHubAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonIoTFleetHubAuthSchemeParameters authParameters)
        {
