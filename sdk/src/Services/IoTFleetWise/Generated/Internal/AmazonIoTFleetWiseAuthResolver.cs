...
namespace Amazon.IoTFleetWise.Internal
{
    ...
    public class AmazonIoTFleetWiseAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonIoTFleetWiseAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for IoTFleetWise.
        /// </summary>
        public AmazonIoTFleetWiseAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonIoTFleetWiseAuthSchemeParameters
            {
    ...
    public class AmazonIoTFleetWiseAuthSchemeResolver : IAuthSchemeResolver<AmazonIoTFleetWiseAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonIoTFleetWiseAuthSchemeParameters authParameters)
        {
