...
{
    /// <summary>
    /// Response Unmarshaller for Actuator Object
    /// </summary>  
    public class ActuatorUnmarshaller : IJsonUnmarshaller<Actuator, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Actuator Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            Actuator unmarshalledObject = new Actuator();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("assignedValue", targetDepth))
                {
                    ...
                    unmarshalledObject.AssignedValue = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ActuatorUnmarshaller _instance = new ActuatorUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ActuatorUnmarshaller Instance
        {
            get
            {
                return _instance;
