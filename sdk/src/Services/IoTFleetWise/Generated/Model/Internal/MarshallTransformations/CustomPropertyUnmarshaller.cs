...
{
    /// <summary>
    /// Response Unmarshaller for CustomProperty Object
    /// </summary>  
    public class CustomPropertyUnmarshaller : IJsonUnmarshaller<CustomProperty, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CustomProperty Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            CustomProperty unmarshalledObject = new CustomProperty();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DataEncoding = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CustomPropertyUnmarshaller _instance = new CustomPropertyUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CustomPropertyUnmarshaller Instance
        {
            get
            {
                return _instance;
