...
namespace Amazon.IoTFleetWise.Model.Internal.MarshallTransformations
{
    ...
    public class DecoderManifestValidationExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<DecoderManifestValidationException, JsonUnmarshallerContext>
    {
        ...
        private static DecoderManifestValidationExceptionUnmarshaller _instance = new DecoderManifestValidationExceptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DecoderManifestValidationExceptionUnmarshaller Instance
        {
            get
            {
                return _instance;
