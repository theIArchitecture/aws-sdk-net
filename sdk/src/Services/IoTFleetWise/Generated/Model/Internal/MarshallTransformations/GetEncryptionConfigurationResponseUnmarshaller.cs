...
{
    /// <summary>
    /// Response Unmarshaller for GetEncryptionConfiguration operation
    /// </summary>  
    public class GetEncryptionConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetEncryptionConfigurationResponseUnmarshaller _instance = new GetEncryptionConfigurationResponseUnmarshaller();        

        internal static GetEncryptionConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEncryptionConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
