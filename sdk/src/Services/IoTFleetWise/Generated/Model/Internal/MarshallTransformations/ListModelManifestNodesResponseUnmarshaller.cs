...
{
    /// <summary>
    /// Response Unmarshaller for ListModelManifestNodes operation
    /// </summary>  
    public class ListModelManifestNodesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListModelManifestNodesResponse response = new ListModelManifestNodesResponse();
        ...
        private static ListModelManifestNodesResponseUnmarshaller _instance = new ListModelManifestNodesResponseUnmarshaller();        

        internal static ListModelManifestNodesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListModelManifestNodesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
