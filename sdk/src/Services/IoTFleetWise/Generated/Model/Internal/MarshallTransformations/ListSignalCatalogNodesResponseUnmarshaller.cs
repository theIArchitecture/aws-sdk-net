...
{
    /// <summary>
    /// Response Unmarshaller for ListSignalCatalogNodes operation
    /// </summary>  
    public class ListSignalCatalogNodesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSignalCatalogNodesResponse response = new ListSignalCatalogNodesResponse();
        ...
        private static ListSignalCatalogNodesResponseUnmarshaller _instance = new ListSignalCatalogNodesResponseUnmarshaller();        

        internal static ListSignalCatalogNodesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSignalCatalogNodesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
