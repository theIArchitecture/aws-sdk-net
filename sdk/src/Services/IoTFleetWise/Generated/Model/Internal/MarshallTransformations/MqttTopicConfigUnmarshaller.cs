...
namespace Amazon.IoTFleetWise.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MqttTopicConfigUnmarshaller : IJsonUnmarshaller<MqttTopicConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MqttTopicConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.MqttTopicArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
