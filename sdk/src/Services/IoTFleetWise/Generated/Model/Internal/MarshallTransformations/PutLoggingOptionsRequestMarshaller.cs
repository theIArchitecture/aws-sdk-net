...
namespace Amazon.IoTFleetWise.Model.Internal.MarshallTransformations
{
    ...
    public class PutLoggingOptionsRequestMarshaller : IMarshaller<IRequest, PutLoggingOptionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(PutLoggingOptionsRequest publicRequest)
        {
            ...
            string target = "IoTAutobahnControlPlane.PutLoggingOptions";
            ...
            if(publicRequest.IsSetCloudWatchLogDelivery())
            {
                context.Writer.WritePropertyName("cloudWatchLogDelivery");
                context.Writer.WriteStartObject();

                var marshaller = CloudWatchLogDeliveryOptionsMarshaller.Instance;
                marshaller.Marshall(publicRequest.CloudWatchLogDelivery, context);
