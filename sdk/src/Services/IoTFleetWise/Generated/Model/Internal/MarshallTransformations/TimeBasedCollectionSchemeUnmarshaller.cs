...
namespace Amazon.IoTFleetWise.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TimeBasedCollectionSchemeUnmarshaller : IJsonUnmarshaller<TimeBasedCollectionScheme, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TimeBasedCollectionScheme Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("periodMs", targetDepth))
                {
                    ...
                    unmarshalledObject.PeriodMs = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
