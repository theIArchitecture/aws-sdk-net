...
{
    /// <summary>
    /// This is the response object from the ListStateTemplates operation.
    /// </summary>
    public partial class ListStateTemplatesResponse : AmazonWebServiceResponse
    {
        private string _nextToken;
        private List<StateTemplateSummary> _summaries = AWSConfigs.InitializeCollections ? new List<StateTemplateSummary>() : null;
        ...
        /// </summary>
        public List<StateTemplateSummary> Summaries
        {
