...
namespace Amazon.IoTFleetWise
{
    ...
    public partial interface IAmazonIoTFleetWise : IAmazonService, IDisposable
    {
        ...
        Task<AssociateVehicleFleetResponse> AssociateVehicleFleetAsync(AssociateVehicleFleetRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<BatchCreateVehicleResponse> BatchCreateVehicleAsync(BatchCreateVehicleRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<BatchUpdateVehicleResponse> BatchUpdateVehicleAsync(BatchUpdateVehicleRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<CreateDecoderManifestResponse> CreateDecoderManifestAsync(CreateDecoderManifestRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<CreateModelManifestResponse> CreateModelManifestAsync(CreateModelManifestRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<CreateSignalCatalogResponse> CreateSignalCatalogAsync(CreateSignalCatalogRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<CreateStateTemplateResponse> CreateStateTemplateAsync(CreateStateTemplateRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<CreateVehicleResponse> CreateVehicleAsync(CreateVehicleRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteDecoderManifestResponse> DeleteDecoderManifestAsync(DeleteDecoderManifestRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteModelManifestResponse> DeleteModelManifestAsync(DeleteModelManifestRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteSignalCatalogResponse> DeleteSignalCatalogAsync(DeleteSignalCatalogRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteStateTemplateResponse> DeleteStateTemplateAsync(DeleteStateTemplateRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteVehicleResponse> DeleteVehicleAsync(DeleteVehicleRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DisassociateVehicleFleetResponse> DisassociateVehicleFleetAsync(DisassociateVehicleFleetRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetDecoderManifestResponse> GetDecoderManifestAsync(GetDecoderManifestRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetEncryptionConfigurationResponse> GetEncryptionConfigurationAsync(GetEncryptionConfigurationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetModelManifestResponse> GetModelManifestAsync(GetModelManifestRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetRegisterAccountStatusResponse> GetRegisterAccountStatusAsync(GetRegisterAccountStatusRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetSignalCatalogResponse> GetSignalCatalogAsync(GetSignalCatalogRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetStateTemplateResponse> GetStateTemplateAsync(GetStateTemplateRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetVehicleResponse> GetVehicleAsync(GetVehicleRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetVehicleStatusResponse> GetVehicleStatusAsync(GetVehicleStatusRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ImportDecoderManifestResponse> ImportDecoderManifestAsync(ImportDecoderManifestRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ImportSignalCatalogResponse> ImportSignalCatalogAsync(ImportSignalCatalogRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListDecoderManifestNetworkInterfacesResponse> ListDecoderManifestNetworkInterfacesAsync(ListDecoderManifestNetworkInterfacesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListDecoderManifestsResponse> ListDecoderManifestsAsync(ListDecoderManifestsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListDecoderManifestSignalsResponse> ListDecoderManifestSignalsAsync(ListDecoderManifestSignalsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListFleetsForVehicleResponse> ListFleetsForVehicleAsync(ListFleetsForVehicleRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListModelManifestNodesResponse> ListModelManifestNodesAsync(ListModelManifestNodesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListModelManifestsResponse> ListModelManifestsAsync(ListModelManifestsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListSignalCatalogNodesResponse> ListSignalCatalogNodesAsync(ListSignalCatalogNodesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListSignalCatalogsResponse> ListSignalCatalogsAsync(ListSignalCatalogsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListStateTemplatesResponse> ListStateTemplatesAsync(ListStateTemplatesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListVehiclesResponse> ListVehiclesAsync(ListVehiclesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListVehiclesInFleetResponse> ListVehiclesInFleetAsync(ListVehiclesInFleetRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<PutEncryptionConfigurationResponse> PutEncryptionConfigurationAsync(PutEncryptionConfigurationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateDecoderManifestResponse> UpdateDecoderManifestAsync(UpdateDecoderManifestRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateModelManifestResponse> UpdateModelManifestAsync(UpdateModelManifestRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateSignalCatalogResponse> UpdateSignalCatalogAsync(UpdateSignalCatalogRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateStateTemplateResponse> UpdateStateTemplateAsync(UpdateStateTemplateRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateVehicleResponse> UpdateVehicleAsync(UpdateVehicleRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonIoTFleetWiseConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonIoTFleetWiseConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonIoTFleetWiseConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonIoTFleetWiseConfig to create AmazonIoTFleetWiseClient");
            }

            return awsCredentials == null ? 
                    new AmazonIoTFleetWiseClient(serviceClientConfig) :
                    new AmazonIoTFleetWiseClient(awsCredentials, serviceClientConfig);
        }
