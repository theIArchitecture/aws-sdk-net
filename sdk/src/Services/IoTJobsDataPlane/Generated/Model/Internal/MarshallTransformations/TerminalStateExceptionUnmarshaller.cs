...
namespace Amazon.IoTJobsDataPlane.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TerminalStateExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<TerminalStateException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public TerminalStateException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public TerminalStateException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
