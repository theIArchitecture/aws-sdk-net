...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonIoTJobsDataPlaneConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonIoTJobsDataPlaneConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonIoTJobsDataPlaneConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonIoTJobsDataPlaneConfig to create AmazonIoTJobsDataPlaneClient");
            }

            return awsCredentials == null ? 
                    new AmazonIoTJobsDataPlaneClient(serviceClientConfig) :
                    new AmazonIoTJobsDataPlaneClient(awsCredentials, serviceClientConfig);
        }
