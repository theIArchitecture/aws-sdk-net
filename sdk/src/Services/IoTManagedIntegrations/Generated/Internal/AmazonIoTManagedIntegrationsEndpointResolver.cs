...
{
    /// <summary>
    /// Amazon IoTManagedIntegrations endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for IoTManagedIntegrations service requests.
    /// Collects values for IoTManagedIntegrationsEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses IoTManagedIntegrationsEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonIoTManagedIntegrationsEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonIoTManagedIntegrationsConfig)requestContext.ClientConfig;
            var result = new IoTManagedIntegrationsEndpointParameters();
