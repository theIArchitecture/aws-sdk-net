...
namespace Amazon.IoTManagedIntegrations.Model
{
    ...
    public partial class AuthConfigUpdate
    {
        ...
        /// </para>
        /// </summary>
        public OAuthUpdate OAuthUpdate
        {
            get { return this._oAuthUpdate; }
            set { this._oAuthUpdate = value; }
        }

        // Check to see if OAuthUpdate property is set
        internal bool IsSetOAuthUpdate()
        {
            return this._oAuthUpdate != null;
        }
