...
{
    /// <summary>
    /// CommandEndpoint Marshaller
    /// </summary>
    public class CommandEndpointMarshaller : IRequestMarshaller<CommandEndpoint, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(CommandEndpoint requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetCapabilities())
            {
                ...
                foreach(var requestObjectCapabilitiesListValue in requestObject.Capabilities)
                {
                    ...
                    var marshaller = CommandCapabilityMarshaller.Instance;
        ...
        /// </summary>
        public readonly static CommandEndpointMarshaller Instance = new CommandEndpointMarshaller();
