...
namespace Amazon.IoTManagedIntegrations.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateAccountAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAccountAssociationResponse response = new CreateAccountAssociationResponse();
        ...
        internal static CreateAccountAssociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAccountAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
