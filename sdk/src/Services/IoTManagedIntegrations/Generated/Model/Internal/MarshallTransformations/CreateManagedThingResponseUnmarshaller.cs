...
{
    /// <summary>
    /// Response Unmarshaller for CreateManagedThing operation
    /// </summary>  
    public class CreateManagedThingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateManagedThingResponse response = new CreateManagedThingResponse();
        ...
        private static CreateManagedThingResponseUnmarshaller _instance = new CreateManagedThingResponseUnmarshaller();        

        internal static CreateManagedThingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateManagedThingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
