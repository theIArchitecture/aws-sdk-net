...
{
    /// <summary>
    /// Response Unmarshaller for CreateOtaTask operation
    /// </summary>  
    public class CreateOtaTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateOtaTaskResponse response = new CreateOtaTaskResponse();
        ...
        private static CreateOtaTaskResponseUnmarshaller _instance = new CreateOtaTaskResponseUnmarshaller();        

        internal static CreateOtaTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateOtaTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
