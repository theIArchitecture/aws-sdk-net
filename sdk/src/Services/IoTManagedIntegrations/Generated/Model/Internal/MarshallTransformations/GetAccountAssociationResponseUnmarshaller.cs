...
{
    /// <summary>
    /// Response Unmarshaller for GetAccountAssociation operation
    /// </summary>  
    public class GetAccountAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAccountAssociationResponse response = new GetAccountAssociationResponse();
        ...
        private static GetAccountAssociationResponseUnmarshaller _instance = new GetAccountAssociationResponseUnmarshaller();        

        internal static GetAccountAssociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAccountAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
