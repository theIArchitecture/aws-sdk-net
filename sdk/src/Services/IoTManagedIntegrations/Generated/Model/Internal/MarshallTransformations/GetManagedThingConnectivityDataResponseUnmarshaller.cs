...
{
    /// <summary>
    /// Response Unmarshaller for GetManagedThingConnectivityData operation
    /// </summary>  
    public class GetManagedThingConnectivityDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetManagedThingConnectivityDataResponse response = new GetManagedThingConnectivityDataResponse();
        ...
        private static GetManagedThingConnectivityDataResponseUnmarshaller _instance = new GetManagedThingConnectivityDataResponseUnmarshaller();        

        internal static GetManagedThingConnectivityDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetManagedThingConnectivityDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
