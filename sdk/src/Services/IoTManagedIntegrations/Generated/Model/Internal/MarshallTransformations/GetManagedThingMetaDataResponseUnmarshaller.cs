...
{
    /// <summary>
    /// Response Unmarshaller for GetManagedThingMetaData operation
    /// </summary>  
    public class GetManagedThingMetaDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetManagedThingMetaDataResponse response = new GetManagedThingMetaDataResponse();
        ...
        private static GetManagedThingMetaDataResponseUnmarshaller _instance = new GetManagedThingMetaDataResponseUnmarshaller();        

        internal static GetManagedThingMetaDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetManagedThingMetaDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
