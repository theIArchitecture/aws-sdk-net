...
{
    /// <summary>
    /// Response Unmarshaller for GetRuntimeLogConfiguration operation
    /// </summary>  
    public class GetRuntimeLogConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRuntimeLogConfigurationResponse response = new GetRuntimeLogConfigurationResponse();
        ...
        private static GetRuntimeLogConfigurationResponseUnmarshaller _instance = new GetRuntimeLogConfigurationResponseUnmarshaller();        

        internal static GetRuntimeLogConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRuntimeLogConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
