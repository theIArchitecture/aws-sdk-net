...
namespace Amazon.IoTManagedIntegrations.Model.Internal.MarshallTransformations
{
    ...
    public class OtaTaskSchedulingConfigUnmarshaller : IJsonUnmarshaller<OtaTaskSchedulingConfig, JsonUnmarshallerContext>
    {
        ...
        private static OtaTaskSchedulingConfigUnmarshaller _instance = new OtaTaskSchedulingConfigUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static OtaTaskSchedulingConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
