...
{
    /// <summary>
    /// Response Unmarshaller for PushConfig Object
    /// </summary>  
    public class PushConfigUnmarshaller : IJsonUnmarshaller<PushConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PushConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            PushConfig unmarshalledObject = new PushConfig();
        ...
        private static PushConfigUnmarshaller _instance = new PushConfigUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PushConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
