...
{
    /// <summary>
    /// SendManagedThingCommand Request Marshaller
    /// </summary>       
    public class SendManagedThingCommandRequestMarshaller : IMarshaller<IRequest, SendManagedThingCommandRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SendManagedThingCommandRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SendManagedThingCommandRequest publicRequest)
        {
            ...
            request.ResourcePath = "/managed-things-command/{ManagedThingId}";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetConnectorAssociationId())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ConnectorAssociationId);
            }
            ...
            if(publicRequest.IsSetEndpoints())
            {
                ...
                foreach(var publicRequestEndpointsListValue in publicRequest.Endpoints)
                {
                    ...
                    var marshaller = CommandEndpointMarshaller.Instance;
        ...
        private static SendManagedThingCommandRequestMarshaller _instance = new SendManagedThingCommandRequestMarshaller();        

        internal static SendManagedThingCommandRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendManagedThingCommandRequestMarshaller Instance
        {
            get
            {
                return _instance;
