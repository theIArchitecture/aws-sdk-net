...
{
    /// <summary>
    /// Response Unmarshaller for StartDeviceDiscovery operation
    /// </summary>  
    public class StartDeviceDiscoveryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartDeviceDiscoveryResponse response = new StartDeviceDiscoveryResponse();
        ...
        private static StartDeviceDiscoveryResponseUnmarshaller _instance = new StartDeviceDiscoveryResponseUnmarshaller();        

        internal static StartDeviceDiscoveryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartDeviceDiscoveryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
