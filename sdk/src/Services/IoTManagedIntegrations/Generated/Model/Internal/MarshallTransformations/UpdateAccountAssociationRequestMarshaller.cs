...
namespace Amazon.IoTManagedIntegrations.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateAccountAssociationRequestMarshaller : IMarshaller<IRequest, UpdateAccountAssociationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static UpdateAccountAssociationRequestMarshaller _instance = new UpdateAccountAssociationRequestMarshaller();        

        internal static UpdateAccountAssociationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAccountAssociationRequestMarshaller Instance
        {
            get
            {
                return _instance;
