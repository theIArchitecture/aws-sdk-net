...
namespace Amazon.IoTSecureTunneling.Internal
{
    ...
    public class AmazonIoTSecureTunnelingAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonIoTSecureTunnelingAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for IoTSecureTunneling.
        /// </summary>
        public AmazonIoTSecureTunnelingAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonIoTSecureTunnelingAuthSchemeParameters
            {
    ...
    public class AmazonIoTSecureTunnelingAuthSchemeResolver : IAuthSchemeResolver<AmazonIoTSecureTunnelingAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonIoTSecureTunnelingAuthSchemeParameters authParameters)
        {
