...
namespace Amazon.IoTSiteWise.Internal
{
    ...
    public class AmazonIoTSiteWiseAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonIoTSiteWiseAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for IoTSiteWise.
        /// </summary>
        public AmazonIoTSiteWiseAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonIoTSiteWiseAuthSchemeParameters
            {
    ...
    public class AmazonIoTSiteWiseAuthSchemeResolver : IAuthSchemeResolver<AmazonIoTSiteWiseAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonIoTSiteWiseAuthSchemeParameters authParameters)
        {
