...
{
    /// <summary>
    /// Contains information for an entry that has been processed by the previous <a href="https://docs.aws.amazon.com/iot-sitewise/latest/APIReference/API_BatchGetAssetPropertyAggregates.html">BatchGetAssetPropertyAggregates</a>
    /// request.
    /// </summary>
    public partial class BatchGetAssetPropertyAggregatesSkippedEntry
    {
        private BatchEntryCompletionStatus _completionStatus;
        private string _entryId;
        private BatchGetAssetPropertyAggregatesErrorInfo _errorInfo;

        /// <summary>
        /// Gets and sets the property CompletionStatus. 
        /// <para>
        /// The completion status of each entry that is associated with the <a href="https://docs.aws.amazon.com/iot-sitewise/latest/APIReference/API_BatchGetAssetPropertyAggregates.html">BatchGetAssetPropertyAggregates</a>
        /// API.
        /// </para>
        /// </summary>
