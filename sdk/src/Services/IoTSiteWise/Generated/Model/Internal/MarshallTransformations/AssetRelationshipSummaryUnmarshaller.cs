...
namespace Amazon.IoTSiteWise.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssetRelationshipSummaryUnmarshaller : IJsonUnmarshaller<AssetRelationshipSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AssetRelationshipSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("hierarchyInfo", targetDepth))
                {
                    ...
                    unmarshalledObject.HierarchyInfo = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
