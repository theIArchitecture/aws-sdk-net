...
{
    /// <summary>
    /// Response Unmarshaller for AssociateTimeSeriesToAssetProperty operation
    /// </summary>  
    public class AssociateTimeSeriesToAssetPropertyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateTimeSeriesToAssetPropertyResponse response = new AssociateTimeSeriesToAssetPropertyResponse();
        ...
        private static AssociateTimeSeriesToAssetPropertyResponseUnmarshaller _instance = new AssociateTimeSeriesToAssetPropertyResponseUnmarshaller();        

        internal static AssociateTimeSeriesToAssetPropertyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateTimeSeriesToAssetPropertyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
