...
{
    /// <summary>
    /// BatchGetAssetPropertyAggregatesEntry Marshaller
    /// </summary>
    public class BatchGetAssetPropertyAggregatesEntryMarshaller : IRequestMarshaller<BatchGetAssetPropertyAggregatesEntry, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(BatchGetAssetPropertyAggregatesEntry requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetAggregateTypes())
            {
                ...
                foreach(var requestObjectAggregateTypesListValue in requestObject.AggregateTypes)
                {
                        context.Writer.WriteStringValue(requestObjectAggregateTypesListValue);
                }
        ...
        /// </summary>
        public readonly static BatchGetAssetPropertyAggregatesEntryMarshaller Instance = new BatchGetAssetPropertyAggregatesEntryMarshaller();
