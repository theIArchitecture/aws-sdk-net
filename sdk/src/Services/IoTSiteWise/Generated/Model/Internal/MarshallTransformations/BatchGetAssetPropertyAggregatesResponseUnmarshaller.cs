...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetAssetPropertyAggregates operation
    /// </summary>  
    public class BatchGetAssetPropertyAggregatesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchGetAssetPropertyAggregatesResponse response = new BatchGetAssetPropertyAggregatesResponse();
        ...
        private static BatchGetAssetPropertyAggregatesResponseUnmarshaller _instance = new BatchGetAssetPropertyAggregatesResponseUnmarshaller();        

        internal static BatchGetAssetPropertyAggregatesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetAssetPropertyAggregatesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
