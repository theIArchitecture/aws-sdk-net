...
{
    /// <summary>
    /// Response Unmarshaller for CreateAssetModelCompositeModel operation
    /// </summary>  
    public class CreateAssetModelCompositeModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAssetModelCompositeModelResponse response = new CreateAssetModelCompositeModelResponse();
        ...
        private static CreateAssetModelCompositeModelResponseUnmarshaller _instance = new CreateAssetModelCompositeModelResponseUnmarshaller();        

        internal static CreateAssetModelCompositeModelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAssetModelCompositeModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
