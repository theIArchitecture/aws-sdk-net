    ...
    public class CreateAssetRequestMarshaller : IMarshaller<IRequest, CreateAssetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateAssetRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetAssetDescription())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.AssetDescription);
            }

            if(publicRequest.IsSetAssetExternalId())
            {
                context.Writer.WritePropertyName("assetExternalId");
                context.Writer.WriteStringValue(publicRequest.AssetExternalId);
            }
            ...
            if(publicRequest.IsSetAssetName())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.AssetName);
            }
