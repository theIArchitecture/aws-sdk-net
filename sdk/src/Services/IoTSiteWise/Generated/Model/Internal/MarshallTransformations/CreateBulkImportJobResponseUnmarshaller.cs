...
{
    /// <summary>
    /// Response Unmarshaller for CreateBulkImportJob operation
    /// </summary>  
    public class CreateBulkImportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateBulkImportJobResponse response = new CreateBulkImportJobResponse();
        ...
        private static CreateBulkImportJobResponseUnmarshaller _instance = new CreateBulkImportJobResponseUnmarshaller();        

        internal static CreateBulkImportJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateBulkImportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
