...
{
    /// <summary>
    /// Response Unmarshaller for CreateComputationModel operation
    /// </summary>  
    public class CreateComputationModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateComputationModelResponse response = new CreateComputationModelResponse();
        ...
        private static CreateComputationModelResponseUnmarshaller _instance = new CreateComputationModelResponseUnmarshaller();        

        internal static CreateComputationModelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateComputationModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
