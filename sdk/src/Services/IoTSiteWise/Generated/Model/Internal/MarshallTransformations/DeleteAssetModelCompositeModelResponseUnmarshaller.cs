...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAssetModelCompositeModel operation
    /// </summary>  
    public class DeleteAssetModelCompositeModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAssetModelCompositeModelResponse response = new DeleteAssetModelCompositeModelResponse();
        ...
        private static DeleteAssetModelCompositeModelResponseUnmarshaller _instance = new DeleteAssetModelCompositeModelResponseUnmarshaller();        

        internal static DeleteAssetModelCompositeModelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAssetModelCompositeModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
