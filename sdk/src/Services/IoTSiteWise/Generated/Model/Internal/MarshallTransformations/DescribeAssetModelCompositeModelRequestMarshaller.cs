...
{
    /// <summary>
    /// DescribeAssetModelCompositeModel Request Marshaller
    /// </summary>       
    public class DescribeAssetModelCompositeModelRequestMarshaller : IMarshaller<IRequest, DescribeAssetModelCompositeModelRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeAssetModelCompositeModelRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeAssetModelCompositeModelRequest publicRequest)
        {
        ...
        private static DescribeAssetModelCompositeModelRequestMarshaller _instance = new DescribeAssetModelCompositeModelRequestMarshaller();        

        internal static DescribeAssetModelCompositeModelRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAssetModelCompositeModelRequestMarshaller Instance
        {
            get
            {
                return _instance;
