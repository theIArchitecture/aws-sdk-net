...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAssetModelInterfaceRelationship operation
    /// </summary>  
    public class DescribeAssetModelInterfaceRelationshipResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAssetModelInterfaceRelationshipResponse response = new DescribeAssetModelInterfaceRelationshipResponse();
        ...
        private static DescribeAssetModelInterfaceRelationshipResponseUnmarshaller _instance = new DescribeAssetModelInterfaceRelationshipResponseUnmarshaller();        

        internal static DescribeAssetModelInterfaceRelationshipResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAssetModelInterfaceRelationshipResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
