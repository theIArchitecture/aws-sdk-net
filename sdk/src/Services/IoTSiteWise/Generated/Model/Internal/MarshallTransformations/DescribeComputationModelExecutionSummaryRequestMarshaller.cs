...
namespace Amazon.IoTSiteWise.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeComputationModelExecutionSummaryRequestMarshaller : IMarshaller<IRequest, DescribeComputationModelExecutionSummaryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DescribeComputationModelExecutionSummaryRequestMarshaller _instance = new DescribeComputationModelExecutionSummaryRequestMarshaller();        

        internal static DescribeComputationModelExecutionSummaryRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeComputationModelExecutionSummaryRequestMarshaller Instance
        {
            get
            {
                return _instance;
