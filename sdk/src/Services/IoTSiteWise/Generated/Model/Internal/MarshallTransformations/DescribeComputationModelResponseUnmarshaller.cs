...
namespace Amazon.IoTSiteWise.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeComputationModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeComputationModelResponse response = new DescribeComputationModelResponse();
        ...
        internal static DescribeComputationModelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeComputationModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
