...
{
    /// <summary>
    /// Response Unmarshaller for ExecuteAction operation
    /// </summary>  
    public class ExecuteActionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ExecuteActionResponseUnmarshaller _instance = new ExecuteActionResponseUnmarshaller();        

        internal static ExecuteActionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExecuteActionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
