...
{
    /// <summary>
    /// Response Unmarshaller for InvokeAssistant operation
    /// </summary>  
    public class InvokeAssistantResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            InvokeAssistantResponse response = new InvokeAssistantResponse();
            response.Body = new ResponseStream(context.Stream);
            if (context.ResponseData.IsHeaderPresent("x-amz-iotsitewise-assistant-conversation-id"))
                response.ConversationId = context.ResponseData.GetHeaderValue("x-amz-iotsitewise-assistant-conversation-id");
        ...
        private static InvokeAssistantResponseUnmarshaller _instance = new InvokeAssistantResponseUnmarshaller();        

        internal static InvokeAssistantResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InvokeAssistantResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
