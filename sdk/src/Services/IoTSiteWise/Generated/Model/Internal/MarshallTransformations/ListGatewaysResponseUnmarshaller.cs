    ...
    public class ListGatewaysResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<GatewaySummary, GatewaySummaryUnmarshaller>(GatewaySummaryUnmarshaller.Instance);
                    response.GatewaySummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
