...
namespace Amazon.IoTSiteWise.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PortalTypeEntryUnmarshaller : IJsonUnmarshaller<PortalTypeEntry, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PortalTypeEntry Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("portalTools", targetDepth))
                {
                    ...
                    unmarshalledObject.PortalTools = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
