...
{
    /// <summary>
    /// Response Unmarshaller for PutStorageConfiguration operation
    /// </summary>  
    public class PutStorageConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutStorageConfigurationResponse response = new PutStorageConfigurationResponse();
        ...
        private static PutStorageConfigurationResponseUnmarshaller _instance = new PutStorageConfigurationResponseUnmarshaller();        

        internal static PutStorageConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutStorageConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
