...
namespace Amazon.IoTSiteWise.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TransformProcessingConfigUnmarshaller : IJsonUnmarshaller<TransformProcessingConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TransformProcessingConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("computeLocation", targetDepth))
                {
                    ...
                    unmarshalledObject.ComputeLocation = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
