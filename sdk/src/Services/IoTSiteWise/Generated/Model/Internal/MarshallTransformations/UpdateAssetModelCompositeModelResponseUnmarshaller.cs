...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAssetModelCompositeModel operation
    /// </summary>  
    public class UpdateAssetModelCompositeModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAssetModelCompositeModelResponse response = new UpdateAssetModelCompositeModelResponse();
        ...
        private static UpdateAssetModelCompositeModelResponseUnmarshaller _instance = new UpdateAssetModelCompositeModelResponseUnmarshaller();        

        internal static UpdateAssetModelCompositeModelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAssetModelCompositeModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
