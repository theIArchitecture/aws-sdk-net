...
{
    /// <summary>
    /// UpdateComputationModel Request Marshaller
    /// </summary>       
    public class UpdateComputationModelRequestMarshaller : IMarshaller<IRequest, UpdateComputationModelRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateComputationModelRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateComputationModelRequest publicRequest)
        {
        ...
        private static UpdateComputationModelRequestMarshaller _instance = new UpdateComputationModelRequestMarshaller();        

        internal static UpdateComputationModelRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateComputationModelRequestMarshaller Instance
        {
            get
            {
                return _instance;
