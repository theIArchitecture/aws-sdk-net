...
{
    /// <summary>
    /// Response Unmarshaller for UpdateComputationModel operation
    /// </summary>  
    public class UpdateComputationModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateComputationModelResponse response = new UpdateComputationModelResponse();
        ...
        private static UpdateComputationModelResponseUnmarshaller _instance = new UpdateComputationModelResponseUnmarshaller();        

        internal static UpdateComputationModelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateComputationModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
