...
namespace Amazon.IoTThingsGraph.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FlowExecutionMessageUnmarshaller : IJsonUnmarshaller<FlowExecutionMessage, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FlowExecutionMessage Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
