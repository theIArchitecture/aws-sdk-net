...
namespace Amazon.IoTThingsGraph.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SystemInstanceSummaryUnmarshaller : IJsonUnmarshaller<SystemInstanceSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SystemInstanceSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.GreengrassGroupName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("greengrassGroupVersionId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.GreengrassGroupVersionId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
