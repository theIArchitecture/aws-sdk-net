...
namespace Amazon.IoTTwinMaker.Internal
{
    ...
    public class AmazonIoTTwinMakerAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonIoTTwinMakerAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for IoTTwinMaker.
        /// </summary>
        public AmazonIoTTwinMakerAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonIoTTwinMakerAuthSchemeParameters
            {
    ...
    public class AmazonIoTTwinMakerAuthSchemeResolver : IAuthSchemeResolver<AmazonIoTTwinMakerAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonIoTTwinMakerAuthSchemeParameters authParameters)
        {
