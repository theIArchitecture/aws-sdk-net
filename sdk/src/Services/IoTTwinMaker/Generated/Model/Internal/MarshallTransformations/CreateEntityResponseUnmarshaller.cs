...
{
    /// <summary>
    /// Response Unmarshaller for CreateEntity operation
    /// </summary>  
    public class CreateEntityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateEntityResponseUnmarshaller _instance = new CreateEntityResponseUnmarshaller();        

        internal static CreateEntityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateEntityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
