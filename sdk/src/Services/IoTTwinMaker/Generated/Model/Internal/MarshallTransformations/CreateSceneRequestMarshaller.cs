...
namespace Amazon.IoTTwinMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateSceneRequestMarshaller : IMarshaller<IRequest, CreateSceneRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static CreateSceneRequestMarshaller _instance = new CreateSceneRequestMarshaller();        

        internal static CreateSceneRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSceneRequestMarshaller Instance
        {
            get
            {
                return _instance;
