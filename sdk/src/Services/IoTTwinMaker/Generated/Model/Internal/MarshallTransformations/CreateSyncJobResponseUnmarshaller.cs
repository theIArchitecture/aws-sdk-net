...
{
    /// <summary>
    /// Response Unmarshaller for CreateSyncJob operation
    /// </summary>  
    public class CreateSyncJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSyncJobResponse response = new CreateSyncJobResponse();
        ...
        private static CreateSyncJobResponseUnmarshaller _instance = new CreateSyncJobResponseUnmarshaller();        

        internal static CreateSyncJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSyncJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
