...
namespace Amazon.IoTTwinMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteSceneRequestMarshaller : IMarshaller<IRequest, DeleteSceneRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteSceneRequestMarshaller _instance = new DeleteSceneRequestMarshaller();        

        internal static DeleteSceneRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSceneRequestMarshaller Instance
        {
            get
            {
                return _instance;
