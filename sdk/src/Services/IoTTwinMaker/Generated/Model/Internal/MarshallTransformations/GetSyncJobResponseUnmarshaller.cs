...
{
    /// <summary>
    /// Response Unmarshaller for GetSyncJob operation
    /// </summary>  
    public class GetSyncJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSyncJobResponse response = new GetSyncJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SyncRole = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetSyncJobResponseUnmarshaller _instance = new GetSyncJobResponseUnmarshaller();        

        internal static GetSyncJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSyncJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
