...
namespace Amazon.IoTTwinMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetWorkspaceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("linkedServices", targetDepth))
                {
                    ...
                    response.LinkedServices = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetWorkspaceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetWorkspaceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
