    ...
    public class SourceConfigurationMarshaller : IRequestMarshaller<SourceConfiguration, JsonMarshallerContext> 
    {
        ...
        public void Marshall(SourceConfiguration requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetIotSiteWiseConfiguration())
            {
                context.Writer.WritePropertyName("iotSiteWiseConfiguration");
                context.Writer.WriteStartObject();

                var marshaller = IotSiteWiseSourceConfigurationMarshaller.Instance;
                marshaller.Marshall(requestObject.IotSiteWiseConfiguration, context);
            ...
            if(requestObject.IsSetIotTwinMakerConfiguration())
            {
                ...
                var marshaller = IotTwinMakerSourceConfigurationMarshaller.Instance;
            ...
            if(requestObject.IsSetS3Configuration())
            {
                ...
                var marshaller = S3SourceConfigurationMarshaller.Instance;
