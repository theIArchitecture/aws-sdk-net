...
namespace Amazon.IoTWireless.Internal
{
    ...
    public class AmazonIoTWirelessAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonIoTWirelessAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for IoTWireless.
        /// </summary>
        public AmazonIoTWirelessAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonIoTWirelessAuthSchemeParameters
            {
    ...
    public class AmazonIoTWirelessAuthSchemeResolver : IAuthSchemeResolver<AmazonIoTWirelessAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonIoTWirelessAuthSchemeParameters authParameters)
        {
