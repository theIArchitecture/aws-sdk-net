...
namespace Amazon.IoTWireless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CertificateListUnmarshaller : IJsonUnmarshaller<CertificateList, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CertificateList Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("SigningAlg", targetDepth))
                {
                    ...
                    unmarshalledObject.SigningAlg = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
