...
namespace Amazon.IoTWireless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConnectionStatusEventConfigurationUnmarshaller : IJsonUnmarshaller<ConnectionStatusEventConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ConnectionStatusEventConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("WirelessGatewayIdEventTopic", targetDepth))
                {
                    ...
                    unmarshalledObject.WirelessGatewayIdEventTopic = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
