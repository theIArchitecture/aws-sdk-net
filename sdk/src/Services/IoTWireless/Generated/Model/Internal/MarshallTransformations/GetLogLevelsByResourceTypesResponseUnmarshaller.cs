...
{
    /// <summary>
    /// Response Unmarshaller for GetLogLevelsByResourceTypes operation
    /// </summary>  
    public class GetLogLevelsByResourceTypesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetLogLevelsByResourceTypesResponse response = new GetLogLevelsByResourceTypesResponse();
        ...
        private static GetLogLevelsByResourceTypesResponseUnmarshaller _instance = new GetLogLevelsByResourceTypesResponseUnmarshaller();        

        internal static GetLogLevelsByResourceTypesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLogLevelsByResourceTypesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
