...
{
    /// <summary>
    /// Response Unmarshaller for GetResourceEventConfiguration operation
    /// </summary>  
    public class GetResourceEventConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetResourceEventConfigurationResponse response = new GetResourceEventConfigurationResponse();
        ...
        private static GetResourceEventConfigurationResponseUnmarshaller _instance = new GetResourceEventConfigurationResponseUnmarshaller();        

        internal static GetResourceEventConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetResourceEventConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
