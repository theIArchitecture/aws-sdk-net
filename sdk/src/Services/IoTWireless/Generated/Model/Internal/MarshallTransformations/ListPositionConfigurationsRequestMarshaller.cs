...
namespace Amazon.IoTWireless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListPositionConfigurationsRequestMarshaller : IMarshaller<IRequest, ListPositionConfigurationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListPositionConfigurationsRequestMarshaller _instance = new ListPositionConfigurationsRequestMarshaller();        

        internal static ListPositionConfigurationsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPositionConfigurationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
