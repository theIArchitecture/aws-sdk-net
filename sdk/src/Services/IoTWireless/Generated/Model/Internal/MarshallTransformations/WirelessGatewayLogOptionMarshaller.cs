...
namespace Amazon.IoTWireless.Model.Internal.MarshallTransformations
{
    ...
    public class WirelessGatewayLogOptionMarshaller : IRequestMarshaller<WirelessGatewayLogOption, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(WirelessGatewayLogOption requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetEvents())
            {
                ...
                foreach(var requestObjectEventsListValue in requestObject.Events)
                {
                    ...
                    var marshaller = WirelessGatewayEventLogOptionMarshaller.Instance;
