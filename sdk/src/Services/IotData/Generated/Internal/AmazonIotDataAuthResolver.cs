...
namespace Amazon.IotData.Internal
{
    ...
    public class AmazonIotDataAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonIotDataAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for IotData.
        /// </summary>
        public AmazonIotDataAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonIotDataAuthSchemeParameters
            {
    ...
    public class AmazonIotDataAuthSchemeResolver : IAuthSchemeResolver<AmazonIotDataAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonIotDataAuthSchemeParameters authParameters)
        {
