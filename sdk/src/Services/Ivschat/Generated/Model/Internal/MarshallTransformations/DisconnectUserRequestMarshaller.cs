...
namespace Amazon.Ivschat.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DisconnectUserRequestMarshaller : IMarshaller<IRequest, DisconnectUserRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DisconnectUserRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DisconnectUserRequest publicRequest)
        {
        ...
        private static DisconnectUserRequestMarshaller _instance = new DisconnectUserRequestMarshaller();        

        internal static DisconnectUserRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisconnectUserRequestMarshaller Instance
        {
            get
            {
                return _instance;
