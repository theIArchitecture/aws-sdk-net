...
namespace Amazon.Ivschat
{
    ...
    public partial interface IAmazonIvschat : IAmazonService, IDisposable
    {
        ...
        Task<CreateChatTokenResponse> CreateChatTokenAsync(CreateChatTokenRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DisconnectUserResponse> DisconnectUserAsync(DisconnectUserRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonIvschatConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonIvschatConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonIvschatConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonIvschatConfig to create AmazonIvschatClient");
            }

            return awsCredentials == null ? 
                    new AmazonIvschatClient(serviceClientConfig) :
                    new AmazonIvschatClient(awsCredentials, serviceClientConfig);
        }
