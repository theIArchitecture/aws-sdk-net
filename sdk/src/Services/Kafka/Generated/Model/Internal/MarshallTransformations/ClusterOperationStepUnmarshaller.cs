...
namespace Amazon.Kafka.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ClusterOperationStepUnmarshaller : IJsonUnmarshaller<ClusterOperationStep, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ClusterOperationStep Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("stepInfo", targetDepth))
                {
                    ...
                    unmarshalledObject.StepInfo = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
