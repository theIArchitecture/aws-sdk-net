...
{
    /// <summary>
    /// Response Unmarshaller for CreateClusterV2 operation
    /// </summary>  
    public class CreateClusterV2ResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateClusterV2ResponseUnmarshaller _instance = new CreateClusterV2ResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateClusterV2ResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
