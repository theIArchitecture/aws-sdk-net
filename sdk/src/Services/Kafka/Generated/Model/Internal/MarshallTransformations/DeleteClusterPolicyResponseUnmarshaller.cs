...
namespace Amazon.Kafka.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteClusterPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteClusterPolicyResponse response = new DeleteClusterPolicyResponse();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteClusterPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
