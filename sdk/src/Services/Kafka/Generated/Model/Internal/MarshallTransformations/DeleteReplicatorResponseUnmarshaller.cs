...
namespace Amazon.Kafka.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteReplicatorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteReplicatorResponse response = new DeleteReplicatorResponse();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteReplicatorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
