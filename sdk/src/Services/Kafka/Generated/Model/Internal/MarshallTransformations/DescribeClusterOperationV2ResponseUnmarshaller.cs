...
{
    /// <summary>
    /// Response Unmarshaller for DescribeClusterOperationV2 operation
    /// </summary>  
    public class DescribeClusterOperationV2ResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeClusterOperationV2Response response = new DescribeClusterOperationV2Response();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = ClusterOperationV2Unmarshaller.Instance;
        ...
        private static DescribeClusterOperationV2ResponseUnmarshaller _instance = new DescribeClusterOperationV2ResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeClusterOperationV2ResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
