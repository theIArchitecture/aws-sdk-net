...
{
    /// <summary>
    /// Response Unmarshaller for DescribeClusterV2 operation
    /// </summary>  
    public class DescribeClusterV2ResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeClusterV2Response response = new DescribeClusterV2Response();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("clusterInfo", targetDepth))
                {
                    ...
                    response.ClusterInfo = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeClusterV2ResponseUnmarshaller _instance = new DescribeClusterV2ResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeClusterV2ResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
