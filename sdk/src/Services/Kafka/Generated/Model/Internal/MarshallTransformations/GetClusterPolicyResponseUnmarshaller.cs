...
{
    /// <summary>
    /// Response Unmarshaller for GetClusterPolicy operation
    /// </summary>  
    public class GetClusterPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetClusterPolicyResponse response = new GetClusterPolicyResponse();
        ...
        private static GetClusterPolicyResponseUnmarshaller _instance = new GetClusterPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetClusterPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
