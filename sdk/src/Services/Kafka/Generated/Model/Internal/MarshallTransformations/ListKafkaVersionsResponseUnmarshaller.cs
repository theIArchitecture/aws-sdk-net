    ...
    public class ListKafkaVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<KafkaVersion, KafkaVersionUnmarshaller>(KafkaVersionUnmarshaller.Instance);
                    response.KafkaVersions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
