...
namespace Amazon.Kafka.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListReplicatorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListReplicatorsResponse response = new ListReplicatorsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("replicators", targetDepth))
                {
                    ...
                    response.Replicators = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListReplicatorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
