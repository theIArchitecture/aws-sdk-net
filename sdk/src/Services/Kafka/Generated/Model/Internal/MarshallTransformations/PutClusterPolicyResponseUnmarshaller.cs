...
namespace Amazon.Kafka.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutClusterPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutClusterPolicyResponse response = new PutClusterPolicyResponse();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutClusterPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
