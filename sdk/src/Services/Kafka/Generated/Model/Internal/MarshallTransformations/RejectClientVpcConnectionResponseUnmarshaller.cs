...
{
    /// <summary>
    /// Response Unmarshaller for RejectClientVpcConnection operation
    /// </summary>  
    public class RejectClientVpcConnectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RejectClientVpcConnectionResponse response = new RejectClientVpcConnectionResponse();
        ...
        private static RejectClientVpcConnectionResponseUnmarshaller _instance = new RejectClientVpcConnectionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RejectClientVpcConnectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
