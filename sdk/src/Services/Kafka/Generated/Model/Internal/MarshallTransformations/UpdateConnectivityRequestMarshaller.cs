...
{
    /// <summary>
    /// UpdateConnectivity Request Marshaller
    /// </summary>       
    public class UpdateConnectivityRequestMarshaller : IMarshaller<IRequest, UpdateConnectivityRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateConnectivityRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateConnectivityRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/clusters/{clusterArn}/connectivity";
#if !NETFRAMEWORK
        ...
        private static UpdateConnectivityRequestMarshaller _instance = new UpdateConnectivityRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateConnectivityRequestMarshaller Instance
        {
            get
            {
                return _instance;
