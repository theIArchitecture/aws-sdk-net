...
namespace Amazon.Kafka.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateReplicationInfoResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateReplicationInfoResponse response = new UpdateReplicationInfoResponse();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateReplicationInfoResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
