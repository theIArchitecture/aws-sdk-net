...
namespace Amazon.Kafka.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateSecurityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSecurityResponse response = new UpdateSecurityResponse();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSecurityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
