...
{
    /// <summary>
    /// UpdateStorage Request Marshaller
    /// </summary>       
    public class UpdateStorageRequestMarshaller : IMarshaller<IRequest, UpdateStorageRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateStorageRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateStorageRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/clusters/{clusterArn}/storage";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetVolumeSizeGB())
            {
                context.Writer.WritePropertyName("volumeSizeGB");
                context.Writer.WriteNumberValue(publicRequest.VolumeSizeGB.Value);
            }
        ...
        private static UpdateStorageRequestMarshaller _instance = new UpdateStorageRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateStorageRequestMarshaller Instance
        {
            get
            {
                return _instance;
