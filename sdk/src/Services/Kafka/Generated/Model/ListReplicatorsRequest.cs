...
{
    /// <summary>
    /// Container for the parameters to the ListReplicators operation.
    ...
    public partial class ListReplicatorsRequest : AmazonKafkaRequest
    {
        ...
        /// </para>
        /// </summary>
        public string ReplicatorNameFilter
        {
            get { return this._replicatorNameFilter; }
            set { this._replicatorNameFilter = value; }
        }

        // Check to see if ReplicatorNameFilter property is set
        internal bool IsSetReplicatorNameFilter()
        {
            return this._replicatorNameFilter != null;
        }
