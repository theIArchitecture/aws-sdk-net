...
namespace Amazon.KafkaConnect.Internal
{
    ...
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for KafkaConnect service requests.
    /// Collects values for KafkaConnectEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses KafkaConnectEndpointProvider.
