...
{
    /// <summary>
    /// Response Unmarshaller for CreateCustomPlugin operation
    /// </summary>  
    public class CreateCustomPluginResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateCustomPluginResponse response = new CreateCustomPluginResponse();
        ...
        private static CreateCustomPluginResponseUnmarshaller _instance = new CreateCustomPluginResponseUnmarshaller();        

        internal static CreateCustomPluginResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCustomPluginResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
