...
{
    /// <summary>
    /// Response Unmarshaller for CreateWorkerConfiguration operation
    /// </summary>  
    public class CreateWorkerConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateWorkerConfigurationResponse response = new CreateWorkerConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.WorkerConfigurationArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("workerConfigurationState", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.WorkerConfigurationState = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateWorkerConfigurationResponseUnmarshaller _instance = new CreateWorkerConfigurationResponseUnmarshaller();        

        internal static CreateWorkerConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWorkerConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
