    ...
    public class ListConnectorOperationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ConnectorOperationSummary, ConnectorOperationSummaryUnmarshaller>(ConnectorOperationSummaryUnmarshaller.Instance);
                    response.ConnectorOperations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
