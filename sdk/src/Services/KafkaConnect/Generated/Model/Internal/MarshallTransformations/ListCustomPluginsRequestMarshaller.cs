...
namespace Amazon.KafkaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListCustomPluginsRequestMarshaller : IMarshaller<IRequest, ListCustomPluginsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListCustomPluginsRequestMarshaller _instance = new ListCustomPluginsRequestMarshaller();        

        internal static ListCustomPluginsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCustomPluginsRequestMarshaller Instance
        {
            get
            {
                return _instance;
