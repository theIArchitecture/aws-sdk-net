...
{
    /// <summary>
    /// Response Unmarshaller for ListCustomPlugins operation
    /// </summary>  
    public class ListCustomPluginsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListCustomPluginsResponse response = new ListCustomPluginsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<CustomPluginSummary, CustomPluginSummaryUnmarshaller>(CustomPluginSummaryUnmarshaller.Instance);
                    response.CustomPlugins = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListCustomPluginsResponseUnmarshaller _instance = new ListCustomPluginsResponseUnmarshaller();        

        internal static ListCustomPluginsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCustomPluginsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
