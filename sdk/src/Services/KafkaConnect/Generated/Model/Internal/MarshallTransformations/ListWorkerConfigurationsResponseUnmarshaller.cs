...
{
    /// <summary>
    /// Response Unmarshaller for ListWorkerConfigurations operation
    /// </summary>  
    public class ListWorkerConfigurationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListWorkerConfigurationsResponse response = new ListWorkerConfigurationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("workerConfigurations", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<WorkerConfigurationSummary, WorkerConfigurationSummaryUnmarshaller>(WorkerConfigurationSummaryUnmarshaller.Instance);
                    response.WorkerConfigurations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListWorkerConfigurationsResponseUnmarshaller _instance = new ListWorkerConfigurationsResponseUnmarshaller();        

        internal static ListWorkerConfigurationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListWorkerConfigurationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
