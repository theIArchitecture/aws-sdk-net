    ...
    public class LogDeliveryMarshaller : IRequestMarshaller<LogDelivery, JsonMarshallerContext> 
    {
        ...
        public void Marshall(LogDelivery requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetWorkerLogDelivery())
            {
                context.Writer.WritePropertyName("workerLogDelivery");
                context.Writer.WriteStartObject();

                var marshaller = WorkerLogDeliveryMarshaller.Instance;
                marshaller.Marshall(requestObject.WorkerLogDelivery, context);
