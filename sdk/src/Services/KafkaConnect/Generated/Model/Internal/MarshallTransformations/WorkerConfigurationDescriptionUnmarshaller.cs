...
namespace Amazon.KafkaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class WorkerConfigurationDescriptionUnmarshaller : IJsonUnmarshaller<WorkerConfigurationDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public WorkerConfigurationDescription Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
