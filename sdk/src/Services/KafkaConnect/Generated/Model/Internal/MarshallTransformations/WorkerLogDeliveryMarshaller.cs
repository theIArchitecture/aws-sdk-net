...
{
    /// <summary>
    /// WorkerLogDelivery Marshaller
    /// </summary>
    public class WorkerLogDeliveryMarshaller : IRequestMarshaller<WorkerLogDelivery, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(WorkerLogDelivery requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetCloudWatchLogs())
            {
                ...
                var marshaller = CloudWatchLogsLogDeliveryMarshaller.Instance;
            ...
            if(requestObject.IsSetFirehose())
            {
                ...
                var marshaller = FirehoseLogDeliveryMarshaller.Instance;
            ...
            if(requestObject.IsSetS3())
            {
                ...
                var marshaller = S3LogDeliveryMarshaller.Instance;
        ...
        /// </summary>
        public readonly static WorkerLogDeliveryMarshaller Instance = new WorkerLogDeliveryMarshaller();
