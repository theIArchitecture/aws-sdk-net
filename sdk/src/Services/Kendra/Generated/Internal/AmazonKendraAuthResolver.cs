...
namespace Amazon.Kendra.Internal
{
    ...
    public class AmazonKendraAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonKendraAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Kendra.
        /// </summary>
        public AmazonKendraAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonKendraAuthSchemeParameters
            {
    ...
    public class AmazonKendraAuthSchemeResolver : IAuthSchemeResolver<AmazonKendraAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonKendraAuthSchemeParameters authParameters)
        {
