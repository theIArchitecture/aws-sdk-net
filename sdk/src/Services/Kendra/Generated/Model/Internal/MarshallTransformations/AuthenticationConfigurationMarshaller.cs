    ...
    public class AuthenticationConfigurationMarshaller : IRequestMarshaller<AuthenticationConfiguration, JsonMarshallerContext> 
    {
        ...
        public void Marshall(AuthenticationConfiguration requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetBasicAuthentication())
            {
                context.Writer.WritePropertyName("BasicAuthentication");
                context.Writer.WriteStartArray();
                foreach(var requestObjectBasicAuthenticationListValue in requestObject.BasicAuthentication)
                {
                    context.Writer.WriteStartObject();

                    var marshaller = BasicAuthenticationConfigurationMarshaller.Instance;
                    marshaller.Marshall(requestObjectBasicAuthenticationListValue, context);
