...
namespace Amazon.Kendra.Model.Internal.MarshallTransformations
{
    ...
    public class BasicAuthenticationConfigurationMarshaller : IRequestMarshaller<BasicAuthenticationConfiguration, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(BasicAuthenticationConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetCredentials())
            {
                ...
                context.Writer.WriteStringValue(requestObject.Credentials);
            }
