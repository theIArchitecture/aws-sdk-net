...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetDocumentStatus operation
    /// </summary>  
    public class BatchGetDocumentStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchGetDocumentStatusResponse response = new BatchGetDocumentStatusResponse();
        ...
        private static BatchGetDocumentStatusResponseUnmarshaller _instance = new BatchGetDocumentStatusResponseUnmarshaller();        

        internal static BatchGetDocumentStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetDocumentStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
