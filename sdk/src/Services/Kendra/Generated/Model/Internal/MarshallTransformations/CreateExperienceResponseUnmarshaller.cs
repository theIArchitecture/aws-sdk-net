...
{
    /// <summary>
    /// Response Unmarshaller for CreateExperience operation
    /// </summary>  
    public class CreateExperienceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateExperienceResponseUnmarshaller _instance = new CreateExperienceResponseUnmarshaller();        

        internal static CreateExperienceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateExperienceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
