...
{
    /// <summary>
    /// Response Unmarshaller for DescribeFeaturedResultsSet operation
    /// </summary>  
    public class DescribeFeaturedResultsSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeFeaturedResultsSetResponse response = new DescribeFeaturedResultsSetResponse();
        ...
        private static DescribeFeaturedResultsSetResponseUnmarshaller _instance = new DescribeFeaturedResultsSetResponseUnmarshaller();        

        internal static DescribeFeaturedResultsSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeFeaturedResultsSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
