...
{
    /// <summary>
    /// Response Unmarshaller for GetSnapshots operation
    /// </summary>  
    public class GetSnapshotsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SnapshotsData", targetDepth))
                {
                    ...
                    response.SnapshotsData = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("SnapshotsDataHeader", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.SnapshotsDataHeader = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("SnapShotTimeFilter", targetDepth))
                {
                    var unmarshaller = TimeRangeUnmarshaller.Instance;
                    response.SnapShotTimeFilter = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetSnapshotsResponseUnmarshaller _instance = new GetSnapshotsResponseUnmarshaller();        

        internal static GetSnapshotsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSnapshotsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
