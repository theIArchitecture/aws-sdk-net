    ...
    public class ListIndicesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<IndexConfigurationSummary, IndexConfigurationSummaryUnmarshaller>(IndexConfigurationSummaryUnmarshaller.Instance);
                    response.IndexConfigurationSummaryItems = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
