...
{
    /// <summary>
    /// PutPrincipalMapping Request Marshaller
    /// </summary>       
    public class PutPrincipalMappingRequestMarshaller : IMarshaller<IRequest, PutPrincipalMappingRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutPrincipalMappingRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutPrincipalMappingRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Kendra");
            string target = "AWSKendraFrontendService.PutPrincipalMapping";
        ...
        private static PutPrincipalMappingRequestMarshaller _instance = new PutPrincipalMappingRequestMarshaller();        

        internal static PutPrincipalMappingRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutPrincipalMappingRequestMarshaller Instance
        {
            get
            {
                return _instance;
