...
namespace Amazon.Kendra.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SourceDocumentUnmarshaller : IJsonUnmarshaller<SourceDocument, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SourceDocument Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SuggestionAttributes", targetDepth))
                {
                    ...
                    unmarshalledObject.SuggestionAttributes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
