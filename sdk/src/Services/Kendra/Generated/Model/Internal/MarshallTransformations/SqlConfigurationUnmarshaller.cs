...
namespace Amazon.Kendra.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SqlConfigurationUnmarshaller : IJsonUnmarshaller<SqlConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SqlConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("QueryIdentifiersEnclosingOption", targetDepth))
                {
                    ...
                    unmarshalledObject.QueryIdentifiersEnclosingOption = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
