...
namespace Amazon.Kendra.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SuggestableConfigUnmarshaller : IJsonUnmarshaller<SuggestableConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SuggestableConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Suggestable", targetDepth))
                {
                    ...
                    unmarshalledObject.Suggestable = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
