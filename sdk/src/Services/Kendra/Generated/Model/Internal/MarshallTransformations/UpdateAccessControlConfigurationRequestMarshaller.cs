...
{
    /// <summary>
    /// UpdateAccessControlConfiguration Request Marshaller
    /// </summary>       
    public class UpdateAccessControlConfigurationRequestMarshaller : IMarshaller<IRequest, UpdateAccessControlConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateAccessControlConfigurationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateAccessControlConfigurationRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Kendra");
            string target = "AWSKendraFrontendService.UpdateAccessControlConfiguration";
        ...
        private static UpdateAccessControlConfigurationRequestMarshaller _instance = new UpdateAccessControlConfigurationRequestMarshaller();        

        internal static UpdateAccessControlConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAccessControlConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
