...
namespace Amazon.Kendra.Model.Internal.MarshallTransformations
{
    ...
    public class UserGroupResolutionConfigurationMarshaller : IRequestMarshaller<UserGroupResolutionConfiguration, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(UserGroupResolutionConfiguration requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetUserGroupResolutionMode())
            {
                context.Writer.WritePropertyName("UserGroupResolutionMode");
                context.Writer.WriteStringValue(requestObject.UserGroupResolutionMode);
            }
