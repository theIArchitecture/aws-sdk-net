...
namespace Amazon.Kendra.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UserIdentityConfigurationUnmarshaller : IJsonUnmarshaller<UserIdentityConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public UserIdentityConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("IdentityAttributeName", targetDepth))
                {
                    ...
                    unmarshalledObject.IdentityAttributeName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
