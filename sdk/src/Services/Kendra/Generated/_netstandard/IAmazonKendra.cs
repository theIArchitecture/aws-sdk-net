...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonKendraConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonKendraConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonKendraConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonKendraConfig to create AmazonKendraClient");
            }

            return awsCredentials == null ? 
                    new AmazonKendraClient(serviceClientConfig) :
                    new AmazonKendraClient(awsCredentials, serviceClientConfig);
        }
