...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonKendraRankingConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonKendraRankingConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonKendraRankingConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonKendraRankingConfig to create AmazonKendraRankingClient");
            }

            return awsCredentials == null ? 
                    new AmazonKendraRankingClient(serviceClientConfig) :
                    new AmazonKendraRankingClient(awsCredentials, serviceClientConfig);
        }
