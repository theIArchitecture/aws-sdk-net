...
namespace Amazon.KeyManagementService
{
    ...
    public partial class AmazonKeyManagementServiceException : AmazonServiceException
    {
        ...
        public AmazonKeyManagementServiceException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonKeyManagementServiceException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
