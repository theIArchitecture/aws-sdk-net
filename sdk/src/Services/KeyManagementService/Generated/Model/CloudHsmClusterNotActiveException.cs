...
namespace Amazon.KeyManagementService.Model
{
    ...
    public partial class CloudHsmClusterNotActiveException : AmazonKeyManagementServiceException
    {
        ...
        public CloudHsmClusterNotActiveException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CloudHsmClusterNotActiveException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
