...
namespace Amazon.KeyManagementService.Model
{
    ...
    public partial class CloudHsmClusterNotRelatedException : AmazonKeyManagementServiceException
    {
        ...
        public CloudHsmClusterNotRelatedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CloudHsmClusterNotRelatedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
