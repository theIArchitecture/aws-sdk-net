...
namespace Amazon.KeyManagementService.Model
{
    ...
    public partial class CustomKeyStoreHasCMKsException : AmazonKeyManagementServiceException
    {
        ...
        public CustomKeyStoreHasCMKsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CustomKeyStoreHasCMKsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
