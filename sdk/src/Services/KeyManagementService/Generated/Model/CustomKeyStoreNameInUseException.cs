...
namespace Amazon.KeyManagementService.Model
{
    ...
    public partial class CustomKeyStoreNameInUseException : AmazonKeyManagementServiceException
    {
        ...
        public CustomKeyStoreNameInUseException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CustomKeyStoreNameInUseException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
