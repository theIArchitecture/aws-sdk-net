...
namespace Amazon.KeyManagementService.Model
{
    ...
    public partial class CustomKeyStoreNotFoundException : AmazonKeyManagementServiceException
    {
        ...
        public CustomKeyStoreNotFoundException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CustomKeyStoreNotFoundException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
