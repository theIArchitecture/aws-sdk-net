...
namespace Amazon.KeyManagementService.Model
{
    ...
    public partial class ExpiredImportTokenException : AmazonKeyManagementServiceException
    {
        ...
        public ExpiredImportTokenException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ExpiredImportTokenException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
