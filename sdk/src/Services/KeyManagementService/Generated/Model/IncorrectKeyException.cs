...
namespace Amazon.KeyManagementService.Model
{
    ...
    public partial class IncorrectKeyException : AmazonKeyManagementServiceException
    {
        ...
        public IncorrectKeyException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public IncorrectKeyException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
