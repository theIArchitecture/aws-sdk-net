...
namespace Amazon.KeyManagementService.Model
{
    ...
    public partial class IncorrectTrustAnchorException : AmazonKeyManagementServiceException
    {
        ...
        public IncorrectTrustAnchorException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public IncorrectTrustAnchorException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
