...
namespace Amazon.KeyManagementService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeriveSharedSecretRequestMarshaller : IMarshaller<IRequest, DeriveSharedSecretRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeriveSharedSecretRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeriveSharedSecretRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetKeyAgreementAlgorithm())
            {
                context.Writer.WritePropertyName("KeyAgreementAlgorithm");
                context.Writer.WriteStringValue(publicRequest.KeyAgreementAlgorithm);
            }
        ...
        private static DeriveSharedSecretRequestMarshaller _instance = new DeriveSharedSecretRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeriveSharedSecretRequestMarshaller Instance
        {
            get
            {
                return _instance;
