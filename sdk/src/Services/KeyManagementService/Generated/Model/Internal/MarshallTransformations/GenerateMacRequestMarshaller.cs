...
namespace Amazon.KeyManagementService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GenerateMacRequestMarshaller : IMarshaller<IRequest, GenerateMacRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GenerateMacRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GenerateMacRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.KeyManagementService");
            string target = "TrentService.GenerateMac";
            ...
            {
                context.Writer.WritePropertyName("MacAlgorithm");
                context.Writer.WriteStringValue(publicRequest.MacAlgorithm);
            }
        ...
        private static GenerateMacRequestMarshaller _instance = new GenerateMacRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GenerateMacRequestMarshaller Instance
        {
            get
            {
                return _instance;
