...
namespace Amazon.KeyManagementService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class VerifyMacRequestMarshaller : IMarshaller<IRequest, VerifyMacRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((VerifyMacRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(VerifyMacRequest publicRequest)
        {
        ...
        private static VerifyMacRequestMarshaller _instance = new VerifyMacRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static VerifyMacRequestMarshaller Instance
        {
            get
            {
                return _instance;
