...
namespace Amazon.KeyManagementService.Model
{
    ...
    public partial class InvalidCiphertextException : AmazonKeyManagementServiceException
    {
        ...
        public InvalidCiphertextException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidCiphertextException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
