...
namespace Amazon.KeyManagementService.Model
{
    ...
    public partial class InvalidImportTokenException : AmazonKeyManagementServiceException
    {
        ...
        public InvalidImportTokenException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidImportTokenException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
