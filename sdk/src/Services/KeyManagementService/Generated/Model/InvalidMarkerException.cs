...
namespace Amazon.KeyManagementService.Model
{
    ...
    public partial class InvalidMarkerException : AmazonKeyManagementServiceException
    {
        ...
        public InvalidMarkerException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidMarkerException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
