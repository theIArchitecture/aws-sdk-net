...
namespace Amazon.KeyManagementService.Model
{
    ...
    public partial class KMSInvalidSignatureException : AmazonKeyManagementServiceException
    {
        ...
        public KMSInvalidSignatureException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public KMSInvalidSignatureException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
