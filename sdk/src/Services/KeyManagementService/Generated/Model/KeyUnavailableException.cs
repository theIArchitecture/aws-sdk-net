...
namespace Amazon.KeyManagementService.Model
{
    ...
    public partial class KeyUnavailableException : AmazonKeyManagementServiceException
    {
        ...
        public KeyUnavailableException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public KeyUnavailableException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
