...
namespace Amazon.Keyspaces.Internal
{
    ...
    public class AmazonKeyspacesAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonKeyspacesAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Keyspaces.
        /// </summary>
        public AmazonKeyspacesAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonKeyspacesAuthSchemeParameters
            {
    ...
    public class AmazonKeyspacesAuthSchemeResolver : IAuthSchemeResolver<AmazonKeyspacesAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonKeyspacesAuthSchemeParameters authParameters)
        {
