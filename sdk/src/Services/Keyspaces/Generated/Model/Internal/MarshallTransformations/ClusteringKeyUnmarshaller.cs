...
namespace Amazon.Keyspaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ClusteringKeyUnmarshaller : IJsonUnmarshaller<ClusteringKey, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ClusteringKey Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.OrderBy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
