...
namespace Amazon.Keyspaces.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ReplicationGroupStatusUnmarshaller : IJsonUnmarshaller<ReplicationGroupStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ReplicationGroupStatus Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("keyspaceStatus", targetDepth))
                {
                    ...
                    unmarshalledObject.KeyspaceStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TablesReplicationProgress = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
