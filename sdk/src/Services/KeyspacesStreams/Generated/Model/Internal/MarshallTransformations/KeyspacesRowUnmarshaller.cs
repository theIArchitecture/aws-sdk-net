...
{
    /// <summary>
    /// Response Unmarshaller for KeyspacesRow Object
    /// </summary>  
    public class KeyspacesRowUnmarshaller : IJsonUnmarshaller<KeyspacesRow, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public KeyspacesRow Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            KeyspacesRow unmarshalledObject = new KeyspacesRow();
        ...
        private static KeyspacesRowUnmarshaller _instance = new KeyspacesRowUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static KeyspacesRowUnmarshaller Instance
        {
            get
            {
                return _instance;
