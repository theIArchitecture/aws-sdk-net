...
namespace Amazon.KeyspacesStreams.Model
{
    ...
    internal sealed partial class ListStreamsPaginator : IPaginator<ListStreamsResponse>, IListStreamsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<Stream> Streams => 
            new PaginatedResultKeyResponse<ListStreamsResponse, Stream>(this, (i) => i.Streams ?? new List<Stream>());

        internal ListStreamsPaginator(IAmazonKeyspacesStreams client, ListStreamsRequest request)
        {
            this._client = client;
