...
namespace Amazon.Kinesis.Internal
{
    ...
    public class AmazonKinesisAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonKinesisAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Kinesis.
        /// </summary>
        public AmazonKinesisAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonKinesisAuthSchemeParameters
            {
    ...
    public class AmazonKinesisAuthSchemeResolver : IAuthSchemeResolver<AmazonKinesisAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonKinesisAuthSchemeParameters authParameters)
        {
