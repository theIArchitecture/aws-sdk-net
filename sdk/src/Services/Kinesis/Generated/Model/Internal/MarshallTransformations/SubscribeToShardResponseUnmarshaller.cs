...
{
    /// <summary>
    /// Response Unmarshaller for SubscribeToShard operation
    /// </summary>  
    public class SubscribeToShardResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SubscribeToShardResponse response = new SubscribeToShardResponse();
            response.EventStream = new SubscribeToShardEventStream(context.Stream);
        ...
        private static SubscribeToShardResponseUnmarshaller _instance = new SubscribeToShardResponseUnmarshaller();        

        internal static SubscribeToShardResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SubscribeToShardResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
