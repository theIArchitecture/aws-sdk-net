...
namespace Amazon.KinesisAnalytics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DestinationSchemaUnmarshaller : IJsonUnmarshaller<DestinationSchema, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DestinationSchema Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
