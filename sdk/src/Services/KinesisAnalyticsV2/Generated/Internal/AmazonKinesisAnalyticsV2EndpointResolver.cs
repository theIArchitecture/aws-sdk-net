...
namespace Amazon.KinesisAnalyticsV2.Internal
{
    /// <summary>
    /// Amazon KinesisAnalyticsV2 endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for KinesisAnalyticsV2 service requests.
    /// Collects values for KinesisAnalyticsV2EndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses KinesisAnalyticsV2EndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonKinesisAnalyticsV2EndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonKinesisAnalyticsV2Config)requestContext.ClientConfig;
            var result = new KinesisAnalyticsV2EndpointParameters();
