...
namespace Amazon.KinesisAnalyticsV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ApplicationCodeConfigurationDescriptionUnmarshaller : IJsonUnmarshaller<ApplicationCodeConfigurationDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ApplicationCodeConfigurationDescription Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("CodeContentDescription", targetDepth))
                {
                    ...
                    unmarshalledObject.CodeContentDescription = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("CodeContentType", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.CodeContentType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
