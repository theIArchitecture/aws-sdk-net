...
namespace Amazon.KinesisAnalyticsV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ApplicationSnapshotConfigurationDescriptionUnmarshaller : IJsonUnmarshaller<ApplicationSnapshotConfigurationDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ApplicationSnapshotConfigurationDescription Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("SnapshotsEnabled", targetDepth))
                {
                    ...
                    unmarshalledObject.SnapshotsEnabled = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
