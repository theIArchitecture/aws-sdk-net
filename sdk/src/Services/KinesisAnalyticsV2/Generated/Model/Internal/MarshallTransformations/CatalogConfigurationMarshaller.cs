    ...
    public class CatalogConfigurationMarshaller : IRequestMarshaller<CatalogConfiguration, JsonMarshallerContext> 
    {
        ...
        public void Marshall(CatalogConfiguration requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetGlueDataCatalogConfiguration())
            {
                context.Writer.WritePropertyName("GlueDataCatalogConfiguration");
                context.Writer.WriteStartObject();

                var marshaller = GlueDataCatalogConfigurationMarshaller.Instance;
                marshaller.Marshall(requestObject.GlueDataCatalogConfiguration, context);
