...
namespace Amazon.KinesisAnalyticsV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CustomArtifactConfigurationDescriptionUnmarshaller : IJsonUnmarshaller<CustomArtifactConfigurationDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CustomArtifactConfigurationDescription Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("MavenReferenceDescription", targetDepth))
                {
                    ...
                    unmarshalledObject.MavenReferenceDescription = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
