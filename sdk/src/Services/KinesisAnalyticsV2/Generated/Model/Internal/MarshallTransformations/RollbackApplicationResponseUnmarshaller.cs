...
{
    /// <summary>
    /// Response Unmarshaller for RollbackApplication operation
    /// </summary>  
    public class RollbackApplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RollbackApplicationResponse response = new RollbackApplicationResponse();
        ...
        private static RollbackApplicationResponseUnmarshaller _instance = new RollbackApplicationResponseUnmarshaller();        

        internal static RollbackApplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RollbackApplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
