...
{
    /// <summary>
    /// Response Unmarshaller for S3ContentLocation Object
    /// </summary>  
    public class S3ContentLocationUnmarshaller : IJsonUnmarshaller<S3ContentLocation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public S3ContentLocation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static S3ContentLocationUnmarshaller _instance = new S3ContentLocationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static S3ContentLocationUnmarshaller Instance
        {
            get
            {
                return _instance;
