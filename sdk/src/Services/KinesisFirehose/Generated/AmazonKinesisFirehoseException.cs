...
namespace Amazon.KinesisFirehose
{
    ...
    public partial class AmazonKinesisFirehoseException : AmazonServiceException
    {
        ...
        public AmazonKinesisFirehoseException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonKinesisFirehoseException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
