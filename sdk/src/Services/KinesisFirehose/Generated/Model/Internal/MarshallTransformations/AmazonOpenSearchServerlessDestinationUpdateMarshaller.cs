...
{
    /// <summary>
    /// AmazonOpenSearchServerlessDestinationUpdate Marshaller
    /// </summary>
    public class AmazonOpenSearchServerlessDestinationUpdateMarshaller : IRequestMarshaller<AmazonOpenSearchServerlessDestinationUpdate, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(AmazonOpenSearchServerlessDestinationUpdate requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetCollectionEndpoint())
            {
                ...
                context.Writer.WriteStringValue(requestObject.CollectionEndpoint);
            }
        ...
        /// </summary>
        public readonly static AmazonOpenSearchServerlessDestinationUpdateMarshaller Instance = new AmazonOpenSearchServerlessDestinationUpdateMarshaller();
