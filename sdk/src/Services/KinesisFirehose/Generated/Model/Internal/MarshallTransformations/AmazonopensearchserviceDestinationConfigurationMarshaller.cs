...
namespace Amazon.KinesisFirehose.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public class AmazonopensearchserviceDestinationConfigurationMarshaller : IRequestMarshaller<AmazonopensearchserviceDestinationConfiguration, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(AmazonopensearchserviceDestinationConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetBufferingHints())
            {
                ...
                var marshaller = AmazonopensearchserviceBufferingHintsMarshaller.Instance;
            ...
            if(requestObject.IsSetRetryOptions())
            {
                ...
                var marshaller = AmazonopensearchserviceRetryOptionsMarshaller.Instance;
        ...
        /// </summary>
        public readonly static AmazonopensearchserviceDestinationConfigurationMarshaller Instance = new AmazonopensearchserviceDestinationConfigurationMarshaller();
