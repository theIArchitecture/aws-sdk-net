...
namespace Amazon.KinesisFirehose.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OutputFormatConfigurationUnmarshaller : IJsonUnmarshaller<OutputFormatConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public OutputFormatConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Serializer", targetDepth))
                {
                    ...
                    unmarshalledObject.Serializer = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
