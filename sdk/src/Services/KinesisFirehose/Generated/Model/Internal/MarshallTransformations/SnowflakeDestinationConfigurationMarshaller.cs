...
{
    /// <summary>
    /// SnowflakeDestinationConfiguration Marshaller
    /// </summary>
    public class SnowflakeDestinationConfigurationMarshaller : IRequestMarshaller<SnowflakeDestinationConfiguration, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(SnowflakeDestinationConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetSnowflakeVpcConfiguration())
            {
                context.Writer.WritePropertyName("SnowflakeVpcConfiguration");
                context.Writer.WriteStartObject();

                var marshaller = SnowflakeVpcConfigurationMarshaller.Instance;
                marshaller.Marshall(requestObject.SnowflakeVpcConfiguration, context);
        ...
        /// </summary>
        public readonly static SnowflakeDestinationConfigurationMarshaller Instance = new SnowflakeDestinationConfigurationMarshaller();
