...
namespace Amazon.KinesisFirehose.Model
{
    ...
    public partial class InvalidKMSResourceException : AmazonKinesisFirehoseException
    {
        ...
        public InvalidKMSResourceException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidKMSResourceException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
