...
namespace Amazon.KinesisFirehose.Model
{
    ...
    [Serializable]
    #endif
    public partial class InvalidSourceException : AmazonKinesisFirehoseException
    {
        ...
        public InvalidSourceException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidSourceException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
