...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonKinesisFirehoseConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonKinesisFirehoseConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonKinesisFirehoseConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonKinesisFirehoseConfig to create AmazonKinesisFirehoseClient");
            }

            return awsCredentials == null ? 
                    new AmazonKinesisFirehoseClient(serviceClientConfig) :
                    new AmazonKinesisFirehoseClient(awsCredentials, serviceClientConfig);
        }
