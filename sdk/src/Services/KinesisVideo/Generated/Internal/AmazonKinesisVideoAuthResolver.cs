...
namespace Amazon.KinesisVideo.Internal
{
    ...
    public class AmazonKinesisVideoAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonKinesisVideoAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for KinesisVideo.
        /// </summary>
        public AmazonKinesisVideoAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonKinesisVideoAuthSchemeParameters
            {
    ...
    public class AmazonKinesisVideoAuthSchemeResolver : IAuthSchemeResolver<AmazonKinesisVideoAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonKinesisVideoAuthSchemeParameters authParameters)
        {
