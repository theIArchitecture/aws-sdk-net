...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeMediaStorageConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeMediaStorageConfigurationResponse response = new DescribeMediaStorageConfigurationResponse();
        ...
        private static DescribeMediaStorageConfigurationResponseUnmarshaller _instance = new DescribeMediaStorageConfigurationResponseUnmarshaller();        

        internal static DescribeMediaStorageConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeMediaStorageConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
