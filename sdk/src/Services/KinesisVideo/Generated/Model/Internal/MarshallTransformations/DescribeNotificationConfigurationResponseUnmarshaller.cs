...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeNotificationConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeNotificationConfigurationResponse response = new DescribeNotificationConfigurationResponse();
        ...
        private static DescribeNotificationConfigurationResponseUnmarshaller _instance = new DescribeNotificationConfigurationResponseUnmarshaller();        

        internal static DescribeNotificationConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeNotificationConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
