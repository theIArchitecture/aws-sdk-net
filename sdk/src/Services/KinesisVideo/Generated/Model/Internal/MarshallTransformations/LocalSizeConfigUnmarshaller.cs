...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LocalSizeConfigUnmarshaller : IJsonUnmarshaller<LocalSizeConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LocalSizeConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static LocalSizeConfigUnmarshaller _instance = new LocalSizeConfigUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static LocalSizeConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
