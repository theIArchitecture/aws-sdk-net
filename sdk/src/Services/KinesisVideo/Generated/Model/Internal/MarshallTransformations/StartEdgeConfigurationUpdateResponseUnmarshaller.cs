...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartEdgeConfigurationUpdateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartEdgeConfigurationUpdateResponse response = new StartEdgeConfigurationUpdateResponse();
        ...
        private static StartEdgeConfigurationUpdateResponseUnmarshaller _instance = new StartEdgeConfigurationUpdateResponseUnmarshaller();        

        internal static StartEdgeConfigurationUpdateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartEdgeConfigurationUpdateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
