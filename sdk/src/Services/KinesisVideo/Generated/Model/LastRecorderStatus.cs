...
namespace Amazon.KinesisVideo.Model
{
    ...
    public partial class LastRecorderStatus
    {
        ...
        {
            get { return this._recorderStatus; }
            set { this._recorderStatus = value; }
        }

        // Check to see if RecorderStatus property is set
        internal bool IsSetRecorderStatus()
        {
            return this._recorderStatus != null;
        }
