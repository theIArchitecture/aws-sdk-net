...
{
    /// <summary>
    /// Response Unmarshaller for GetImages operation
    /// </summary>  
    public class GetImagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<Image, ImageUnmarshaller>(ImageUnmarshaller.Instance);
                    response.Images = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetImagesResponseUnmarshaller _instance = new GetImagesResponseUnmarshaller();        

        internal static GetImagesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetImagesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
