...
namespace Amazon.KinesisVideoArchivedMedia.Model
{
    ...
    public partial class UnsupportedStreamMediaTypeException : AmazonKinesisVideoArchivedMediaException
    {
        ...
        public UnsupportedStreamMediaTypeException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public UnsupportedStreamMediaTypeException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
