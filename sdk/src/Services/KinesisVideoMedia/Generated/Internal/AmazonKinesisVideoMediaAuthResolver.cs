...
namespace Amazon.KinesisVideoMedia.Internal
{
    ...
    public class AmazonKinesisVideoMediaAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonKinesisVideoMediaAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for KinesisVideoMedia.
        /// </summary>
        public AmazonKinesisVideoMediaAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonKinesisVideoMediaAuthSchemeParameters
            {
    ...
    public class AmazonKinesisVideoMediaAuthSchemeResolver : IAuthSchemeResolver<AmazonKinesisVideoMediaAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonKinesisVideoMediaAuthSchemeParameters authParameters)
        {
