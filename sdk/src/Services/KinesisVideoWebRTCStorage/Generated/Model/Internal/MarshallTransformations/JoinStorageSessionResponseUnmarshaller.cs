...
namespace Amazon.KinesisVideoWebRTCStorage.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class JoinStorageSessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        internal static JoinStorageSessionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static JoinStorageSessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
