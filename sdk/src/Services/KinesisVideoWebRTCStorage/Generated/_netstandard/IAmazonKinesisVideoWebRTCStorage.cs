...
namespace Amazon.KinesisVideoWebRTCStorage
{
    ...
    public partial interface IAmazonKinesisVideoWebRTCStorage : IAmazonService, IDisposable
    {
        ...
        Task<JoinStorageSessionAsViewerResponse> JoinStorageSessionAsViewerAsync(JoinStorageSessionAsViewerRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonKinesisVideoWebRTCStorageConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonKinesisVideoWebRTCStorageConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonKinesisVideoWebRTCStorageConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonKinesisVideoWebRTCStorageConfig to create AmazonKinesisVideoWebRTCStorageClient");
            }

            return awsCredentials == null ? 
                    new AmazonKinesisVideoWebRTCStorageClient(serviceClientConfig) :
                    new AmazonKinesisVideoWebRTCStorageClient(awsCredentials, serviceClientConfig);
        }
