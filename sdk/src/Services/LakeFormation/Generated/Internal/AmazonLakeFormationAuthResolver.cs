...
namespace Amazon.LakeFormation.Internal
{
    ...
    public class AmazonLakeFormationAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonLakeFormationAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for LakeFormation.
        /// </summary>
        public AmazonLakeFormationAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonLakeFormationAuthSchemeParameters
            {
    ...
    public class AmazonLakeFormationAuthSchemeResolver : IAuthSchemeResolver<AmazonLakeFormationAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonLakeFormationAuthSchemeParameters authParameters)
        {
