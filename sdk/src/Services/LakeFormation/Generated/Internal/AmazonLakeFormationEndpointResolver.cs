...
namespace Amazon.LakeFormation.Internal
{
    ...
    /// </summary>
    public class AmazonLakeFormationEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonLakeFormationConfig)requestContext.ClientConfig;
            var result = new LakeFormationEndpointParameters();
