...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AddLFTagsToResourceRequestMarshaller : IMarshaller<IRequest, AddLFTagsToResourceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AddLFTagsToResourceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AddLFTagsToResourceRequest publicRequest)
        {
        ...
        private static AddLFTagsToResourceRequestMarshaller _instance = new AddLFTagsToResourceRequestMarshaller();        

        internal static AddLFTagsToResourceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddLFTagsToResourceRequestMarshaller Instance
        {
            get
            {
                return _instance;
