...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AddLFTagsToResourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static AddLFTagsToResourceResponseUnmarshaller _instance = new AddLFTagsToResourceResponseUnmarshaller();        

        internal static AddLFTagsToResourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddLFTagsToResourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
