...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CancelTransactionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CancelTransactionResponseUnmarshaller _instance = new CancelTransactionResponseUnmarshaller();        

        internal static CancelTransactionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelTransactionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
