...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateDataCellsFilterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDataCellsFilterResponse response = new CreateDataCellsFilterResponse();
        ...
        private static CreateDataCellsFilterResponseUnmarshaller _instance = new CreateDataCellsFilterResponseUnmarshaller();        

        internal static CreateDataCellsFilterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDataCellsFilterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
