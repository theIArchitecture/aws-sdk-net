...
{
    /// <summary>
    /// Response Unmarshaller for CreateLFTagExpression operation
    /// </summary>  
    public class CreateLFTagExpressionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLFTagExpressionResponse response = new CreateLFTagExpressionResponse();
        ...
        private static CreateLFTagExpressionResponseUnmarshaller _instance = new CreateLFTagExpressionResponseUnmarshaller();        

        internal static CreateLFTagExpressionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLFTagExpressionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
