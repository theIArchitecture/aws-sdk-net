...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateLFTagResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLFTagResponse response = new CreateLFTagResponse();
        ...
        private static CreateLFTagResponseUnmarshaller _instance = new CreateLFTagResponseUnmarshaller();        

        internal static CreateLFTagResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLFTagResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
