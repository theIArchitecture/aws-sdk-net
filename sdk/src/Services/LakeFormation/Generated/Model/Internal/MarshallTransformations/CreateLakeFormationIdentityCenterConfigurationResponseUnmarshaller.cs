...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateLakeFormationIdentityCenterConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLakeFormationIdentityCenterConfigurationResponse response = new CreateLakeFormationIdentityCenterConfigurationResponse();
        ...
        private static CreateLakeFormationIdentityCenterConfigurationResponseUnmarshaller _instance = new CreateLakeFormationIdentityCenterConfigurationResponseUnmarshaller();        

        internal static CreateLakeFormationIdentityCenterConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLakeFormationIdentityCenterConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
