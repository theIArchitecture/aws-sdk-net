...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteDataCellsFilterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDataCellsFilterResponse response = new DeleteDataCellsFilterResponse();
        ...
        private static DeleteDataCellsFilterResponseUnmarshaller _instance = new DeleteDataCellsFilterResponseUnmarshaller();        

        internal static DeleteDataCellsFilterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDataCellsFilterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
