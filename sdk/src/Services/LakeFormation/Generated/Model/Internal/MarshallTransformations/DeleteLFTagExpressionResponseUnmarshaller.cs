...
{
    /// <summary>
    /// Response Unmarshaller for DeleteLFTagExpression operation
    /// </summary>  
    public class DeleteLFTagExpressionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteLFTagExpressionResponse response = new DeleteLFTagExpressionResponse();
        ...
        private static DeleteLFTagExpressionResponseUnmarshaller _instance = new DeleteLFTagExpressionResponseUnmarshaller();        

        internal static DeleteLFTagExpressionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteLFTagExpressionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
