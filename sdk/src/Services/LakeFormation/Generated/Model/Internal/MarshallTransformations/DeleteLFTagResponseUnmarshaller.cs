...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteLFTagResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteLFTagResponse response = new DeleteLFTagResponse();
        ...
        private static DeleteLFTagResponseUnmarshaller _instance = new DeleteLFTagResponseUnmarshaller();        

        internal static DeleteLFTagResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteLFTagResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
