...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteLakeFormationOptInResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteLakeFormationOptInResponse response = new DeleteLakeFormationOptInResponse();
        ...
        private static DeleteLakeFormationOptInResponseUnmarshaller _instance = new DeleteLakeFormationOptInResponseUnmarshaller();        

        internal static DeleteLakeFormationOptInResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteLakeFormationOptInResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
