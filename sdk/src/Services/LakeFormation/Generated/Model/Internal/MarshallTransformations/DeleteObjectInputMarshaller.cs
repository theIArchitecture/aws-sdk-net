...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    public class DeleteObjectInputMarshaller : IRequestMarshaller<DeleteObjectInput, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(DeleteObjectInput requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetPartitionValues())
            {
                ...
                {
                        context.Writer.WriteStringValue(requestObjectPartitionValuesListValue);
                }
