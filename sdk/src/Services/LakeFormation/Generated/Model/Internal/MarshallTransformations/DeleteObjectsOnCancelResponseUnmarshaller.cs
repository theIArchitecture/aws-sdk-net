...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteObjectsOnCancelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteObjectsOnCancelResponse response = new DeleteObjectsOnCancelResponse();
        ...
        private static DeleteObjectsOnCancelResponseUnmarshaller _instance = new DeleteObjectsOnCancelResponseUnmarshaller();        

        internal static DeleteObjectsOnCancelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteObjectsOnCancelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
