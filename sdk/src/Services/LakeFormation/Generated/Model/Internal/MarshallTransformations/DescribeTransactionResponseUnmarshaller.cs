...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeTransactionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeTransactionResponse response = new DescribeTransactionResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("TransactionDescription", targetDepth))
                {
                    var unmarshaller = TransactionDescriptionUnmarshaller.Instance;
                    response.TransactionDescription = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeTransactionResponseUnmarshaller _instance = new DescribeTransactionResponseUnmarshaller();        

        internal static DescribeTransactionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTransactionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
