...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetDataCellsFilterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDataCellsFilterResponse response = new GetDataCellsFilterResponse();
        ...
        private static GetDataCellsFilterResponseUnmarshaller _instance = new GetDataCellsFilterResponseUnmarshaller();        

        internal static GetDataCellsFilterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDataCellsFilterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
