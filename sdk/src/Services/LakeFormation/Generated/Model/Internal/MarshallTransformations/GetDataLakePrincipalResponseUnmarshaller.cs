...
{
    /// <summary>
    /// Response Unmarshaller for GetDataLakePrincipal operation
    /// </summary>  
    public class GetDataLakePrincipalResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDataLakePrincipalResponse response = new GetDataLakePrincipalResponse();
        ...
        private static GetDataLakePrincipalResponseUnmarshaller _instance = new GetDataLakePrincipalResponseUnmarshaller();        

        internal static GetDataLakePrincipalResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDataLakePrincipalResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
