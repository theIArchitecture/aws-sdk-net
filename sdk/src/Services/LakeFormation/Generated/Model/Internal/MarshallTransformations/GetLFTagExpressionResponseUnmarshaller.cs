...
{
    /// <summary>
    /// Response Unmarshaller for GetLFTagExpression operation
    /// </summary>  
    public class GetLFTagExpressionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetLFTagExpressionResponse response = new GetLFTagExpressionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Expression", targetDepth))
                {
                    ...
                    response.Expression = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetLFTagExpressionResponseUnmarshaller _instance = new GetLFTagExpressionResponseUnmarshaller();        

        internal static GetLFTagExpressionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLFTagExpressionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
