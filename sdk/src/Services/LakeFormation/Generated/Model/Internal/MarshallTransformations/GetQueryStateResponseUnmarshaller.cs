...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetQueryStateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetQueryStateResponse response = new GetQueryStateResponse();
        ...
        private static GetQueryStateResponseUnmarshaller _instance = new GetQueryStateResponseUnmarshaller();        

        internal static GetQueryStateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetQueryStateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
