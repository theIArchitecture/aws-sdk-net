...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetQueryStatisticsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetQueryStatisticsResponse response = new GetQueryStatisticsResponse();
        ...
        internal static GetQueryStatisticsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetQueryStatisticsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
