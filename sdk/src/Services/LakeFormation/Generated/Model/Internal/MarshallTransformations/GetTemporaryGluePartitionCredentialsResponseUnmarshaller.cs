...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetTemporaryGluePartitionCredentialsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTemporaryGluePartitionCredentialsResponse response = new GetTemporaryGluePartitionCredentialsResponse();
        ...
        private static GetTemporaryGluePartitionCredentialsResponseUnmarshaller _instance = new GetTemporaryGluePartitionCredentialsResponseUnmarshaller();        

        internal static GetTemporaryGluePartitionCredentialsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTemporaryGluePartitionCredentialsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
