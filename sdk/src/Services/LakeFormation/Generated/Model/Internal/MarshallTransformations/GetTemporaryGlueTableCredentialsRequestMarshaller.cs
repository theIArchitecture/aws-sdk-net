...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetTemporaryGlueTableCredentialsRequestMarshaller : IMarshaller<IRequest, GetTemporaryGlueTableCredentialsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetTemporaryGlueTableCredentialsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetTemporaryGlueTableCredentialsRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetS3Path())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.S3Path);
            }
        ...
        private static GetTemporaryGlueTableCredentialsRequestMarshaller _instance = new GetTemporaryGlueTableCredentialsRequestMarshaller();        

        internal static GetTemporaryGlueTableCredentialsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTemporaryGlueTableCredentialsRequestMarshaller Instance
        {
            get
            {
                return _instance;
