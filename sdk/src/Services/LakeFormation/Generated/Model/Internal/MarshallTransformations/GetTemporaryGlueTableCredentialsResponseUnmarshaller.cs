...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetTemporaryGlueTableCredentialsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTemporaryGlueTableCredentialsResponse response = new GetTemporaryGlueTableCredentialsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("VendedS3Path", targetDepth))
                {
                    ...
                    response.VendedS3Path = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetTemporaryGlueTableCredentialsResponseUnmarshaller _instance = new GetTemporaryGlueTableCredentialsResponseUnmarshaller();        

        internal static GetTemporaryGlueTableCredentialsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTemporaryGlueTableCredentialsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
