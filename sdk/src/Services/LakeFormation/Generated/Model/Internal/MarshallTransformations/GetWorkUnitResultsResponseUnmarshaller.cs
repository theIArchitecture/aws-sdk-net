...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetWorkUnitResultsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetWorkUnitResultsResponse response = new GetWorkUnitResultsResponse();
            response.ResultStream = context.Stream;
        ...
        private static GetWorkUnitResultsResponseUnmarshaller _instance = new GetWorkUnitResultsResponseUnmarshaller();        

        internal static GetWorkUnitResultsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetWorkUnitResultsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
