...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetWorkUnitsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetWorkUnitsResponse response = new GetWorkUnitsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<WorkUnitRange, WorkUnitRangeUnmarshaller>(WorkUnitRangeUnmarshaller.Instance);
                    response.WorkUnitRanges = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("WorkUnitsNotReadyYetException"))
                {
                    return WorkUnitsNotReadyYetExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
            }
        ...
        private static GetWorkUnitsResponseUnmarshaller _instance = new GetWorkUnitsResponseUnmarshaller();        

        internal static GetWorkUnitsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetWorkUnitsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
