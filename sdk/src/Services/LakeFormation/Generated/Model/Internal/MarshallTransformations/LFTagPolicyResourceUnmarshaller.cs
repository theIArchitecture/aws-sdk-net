...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LFTagPolicyResourceUnmarshaller : IJsonUnmarshaller<LFTagPolicyResource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LFTagPolicyResource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ExpressionName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
