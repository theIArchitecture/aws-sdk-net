...
{
    /// <summary>
    /// Response Unmarshaller for ListLFTagExpressions operation
    /// </summary>  
    public class ListLFTagExpressionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListLFTagExpressionsResponse response = new ListLFTagExpressionsResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("LFTagExpressions", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<LFTagExpression, LFTagExpressionUnmarshaller>(LFTagExpressionUnmarshaller.Instance);
                    response.LFTagExpressions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListLFTagExpressionsResponseUnmarshaller _instance = new ListLFTagExpressionsResponseUnmarshaller();        

        internal static ListLFTagExpressionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLFTagExpressionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
