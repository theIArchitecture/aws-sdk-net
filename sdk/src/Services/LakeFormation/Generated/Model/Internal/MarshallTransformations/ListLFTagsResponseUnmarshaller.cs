...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListLFTagsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("LFTags", targetDepth))
                {
                    ...
                    response.LFTags = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListLFTagsResponseUnmarshaller _instance = new ListLFTagsResponseUnmarshaller();        

        internal static ListLFTagsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLFTagsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
