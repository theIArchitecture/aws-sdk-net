...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListTableStorageOptimizersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTableStorageOptimizersResponse response = new ListTableStorageOptimizersResponse();
        ...
        private static ListTableStorageOptimizersResponseUnmarshaller _instance = new ListTableStorageOptimizersResponseUnmarshaller();        

        internal static ListTableStorageOptimizersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTableStorageOptimizersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
