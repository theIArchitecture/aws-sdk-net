...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RemoveLFTagsFromResourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static RemoveLFTagsFromResourceResponseUnmarshaller _instance = new RemoveLFTagsFromResourceResponseUnmarshaller();        

        internal static RemoveLFTagsFromResourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveLFTagsFromResourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
