...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartQueryPlanningResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartQueryPlanningResponse response = new StartQueryPlanningResponse();
        ...
        private static StartQueryPlanningResponseUnmarshaller _instance = new StartQueryPlanningResponseUnmarshaller();        

        internal static StartQueryPlanningResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartQueryPlanningResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
