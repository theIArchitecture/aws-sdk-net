...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartTransactionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static StartTransactionResponseUnmarshaller _instance = new StartTransactionResponseUnmarshaller();        

        internal static StartTransactionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartTransactionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
