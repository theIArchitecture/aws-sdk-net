...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TableResourceUnmarshaller : IJsonUnmarshaller<TableResource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TableResource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("TableWildcard", targetDepth))
                {
                    ...
                    unmarshalledObject.TableWildcard = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
