...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TaggedDatabaseUnmarshaller : IJsonUnmarshaller<TaggedDatabase, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TaggedDatabase Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static TaggedDatabaseUnmarshaller _instance = new TaggedDatabaseUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TaggedDatabaseUnmarshaller Instance
        {
            get
            {
                return _instance;
