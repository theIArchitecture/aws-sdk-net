...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateDataCellsFilterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDataCellsFilterResponse response = new UpdateDataCellsFilterResponse();
        ...
        private static UpdateDataCellsFilterResponseUnmarshaller _instance = new UpdateDataCellsFilterResponseUnmarshaller();        

        internal static UpdateDataCellsFilterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDataCellsFilterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
