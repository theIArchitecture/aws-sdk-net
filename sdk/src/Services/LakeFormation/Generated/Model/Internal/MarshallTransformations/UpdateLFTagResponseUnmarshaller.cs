...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateLFTagResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateLFTagResponse response = new UpdateLFTagResponse();
        ...
        private static UpdateLFTagResponseUnmarshaller _instance = new UpdateLFTagResponseUnmarshaller();        

        internal static UpdateLFTagResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateLFTagResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
