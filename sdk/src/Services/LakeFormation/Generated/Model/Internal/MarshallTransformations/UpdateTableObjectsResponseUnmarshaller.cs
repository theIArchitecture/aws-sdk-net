...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateTableObjectsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateTableObjectsResponse response = new UpdateTableObjectsResponse();
        ...
        private static UpdateTableObjectsResponseUnmarshaller _instance = new UpdateTableObjectsResponseUnmarshaller();        

        internal static UpdateTableObjectsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTableObjectsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
