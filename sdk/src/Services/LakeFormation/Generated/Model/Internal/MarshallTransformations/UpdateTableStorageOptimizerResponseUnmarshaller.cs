...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateTableStorageOptimizerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateTableStorageOptimizerResponse response = new UpdateTableStorageOptimizerResponse();
        ...
        private static UpdateTableStorageOptimizerResponseUnmarshaller _instance = new UpdateTableStorageOptimizerResponseUnmarshaller();        

        internal static UpdateTableStorageOptimizerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTableStorageOptimizerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
