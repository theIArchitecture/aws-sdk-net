...
namespace Amazon.Lambda.Internal
{
    ...
    public class AmazonLambdaAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonLambdaAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Lambda.
        /// </summary>
        public AmazonLambdaAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonLambdaAuthSchemeParameters
            {
    ...
    public class AmazonLambdaAuthSchemeResolver : IAuthSchemeResolver<AmazonLambdaAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonLambdaAuthSchemeParameters authParameters)
        {
