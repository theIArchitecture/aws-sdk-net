...
namespace Amazon.Lambda.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AliasRoutingConfigurationUnmarshaller : IJsonUnmarshaller<AliasRoutingConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AliasRoutingConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AdditionalVersionWeights", targetDepth))
                {
                    ...
                    unmarshalledObject.AdditionalVersionWeights = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
