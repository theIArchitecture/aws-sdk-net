...
namespace Amazon.Lambda.Model.Internal.MarshallTransformations
{
    ...
    public class InvokeResponseStreamUpdateUnmarshaller : IJsonUnmarshaller<InvokeResponseStreamUpdate, JsonUnmarshallerContext>
    {
        ...
        private static InvokeResponseStreamUpdateUnmarshaller _instance = new InvokeResponseStreamUpdateUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static InvokeResponseStreamUpdateUnmarshaller Instance
        {
            get
            {
                return _instance;
