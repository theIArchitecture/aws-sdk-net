...
namespace Amazon.Lambda.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InvokeWithResponseStreamCompleteEventUnmarshaller : IJsonUnmarshaller<InvokeWithResponseStreamCompleteEvent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InvokeWithResponseStreamCompleteEvent Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.LogResult = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
