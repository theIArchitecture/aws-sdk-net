    ...
    public class ListEventSourceMappingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<EventSourceMappingConfiguration, EventSourceMappingConfigurationUnmarshaller>(EventSourceMappingConfigurationUnmarshaller.Instance);
                    response.EventSourceMappings = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
