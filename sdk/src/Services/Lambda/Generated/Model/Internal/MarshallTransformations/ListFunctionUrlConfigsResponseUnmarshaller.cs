...
{
    /// <summary>
    /// Response Unmarshaller for ListFunctionUrlConfigs operation
    /// </summary>  
    public class ListFunctionUrlConfigsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListFunctionUrlConfigsResponse response = new ListFunctionUrlConfigsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<FunctionUrlConfig, FunctionUrlConfigUnmarshaller>(FunctionUrlConfigUnmarshaller.Instance);
                    response.FunctionUrlConfigs = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListFunctionUrlConfigsResponseUnmarshaller _instance = new ListFunctionUrlConfigsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFunctionUrlConfigsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
