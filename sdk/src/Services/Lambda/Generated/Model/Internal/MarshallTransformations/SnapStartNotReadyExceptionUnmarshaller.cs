...
namespace Amazon.Lambda.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SnapStartNotReadyExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<SnapStartNotReadyException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public SnapStartNotReadyException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public SnapStartNotReadyException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
