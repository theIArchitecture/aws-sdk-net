...
{
    /// <summary>
    /// Configuration for accessing Amazon LaunchWizard service
    /// </summary>
    public partial class AmazonLaunchWizardConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Launch Wizard", "4.0.1.5");
        ...
        /// Default constructor
        /// </summary>
        public AmazonLaunchWizardConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonLaunchWizardDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "Launch Wizard";
            this.AuthenticationServiceName = "launchwizard";
            this.EndpointProvider = new AmazonLaunchWizardEndpointProvider();
        }
