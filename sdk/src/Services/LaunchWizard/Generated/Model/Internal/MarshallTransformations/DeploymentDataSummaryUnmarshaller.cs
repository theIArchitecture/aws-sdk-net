...
{
    /// <summary>
    /// Response Unmarshaller for DeploymentDataSummary Object
    /// </summary>  
    public class DeploymentDataSummaryUnmarshaller : IJsonUnmarshaller<DeploymentDataSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DeploymentDataSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static DeploymentDataSummaryUnmarshaller _instance = new DeploymentDataSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DeploymentDataSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
