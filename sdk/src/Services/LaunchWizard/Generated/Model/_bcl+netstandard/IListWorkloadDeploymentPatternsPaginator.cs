...
namespace Amazon.LaunchWizard.Model
{
    ...
    public interface IListWorkloadDeploymentPatternsPaginator
    {
        ...
        /// </summary>
        IPaginatedEnumerable<ListWorkloadDeploymentPatternsResponse> Responses { get; }

        /// <summary>
        /// Enumerable containing all of the WorkloadDeploymentPatterns
        /// </summary>
        IPaginatedEnumerable<WorkloadDeploymentPatternDataSummary> WorkloadDeploymentPatterns { get; }
    }
}