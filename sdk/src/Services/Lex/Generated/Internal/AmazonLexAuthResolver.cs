...
namespace Amazon.Lex.Internal
{
    ...
    public class AmazonLexAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonLexAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Lex.
        /// </summary>
        public AmazonLexAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonLexAuthSchemeParameters
            {
    ...
    public class AmazonLexAuthSchemeResolver : IAuthSchemeResolver<AmazonLexAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonLexAuthSchemeParameters authParameters)
        {
