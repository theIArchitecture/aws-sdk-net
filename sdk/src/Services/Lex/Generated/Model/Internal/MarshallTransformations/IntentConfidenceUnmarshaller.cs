...
namespace Amazon.Lex.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IntentConfidenceUnmarshaller : IJsonUnmarshaller<IntentConfidence, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IntentConfidence Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
