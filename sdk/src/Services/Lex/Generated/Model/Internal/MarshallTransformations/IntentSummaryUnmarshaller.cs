...
namespace Amazon.Lex.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IntentSummaryUnmarshaller : IJsonUnmarshaller<IntentSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IntentSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("checkpointLabel", targetDepth))
                {
                    ...
                    unmarshalledObject.CheckpointLabel = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FulfillmentState = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
