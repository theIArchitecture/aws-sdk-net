...
{
    /// <summary>
    /// Amazon LexModelBuildingService endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for LexModelBuildingService service requests.
    /// Collects values for LexModelBuildingServiceEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses LexModelBuildingServiceEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonLexModelBuildingServiceEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonLexModelBuildingServiceConfig)requestContext.ClientConfig;
            var result = new LexModelBuildingServiceEndpointParameters();
