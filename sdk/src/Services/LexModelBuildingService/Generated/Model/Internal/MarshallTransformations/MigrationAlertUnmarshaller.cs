...
namespace Amazon.LexModelBuildingService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MigrationAlertUnmarshaller : IJsonUnmarshaller<MigrationAlert, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            MigrationAlert unmarshalledObject = new MigrationAlert();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static MigrationAlertUnmarshaller Instance
        {
            get
            {
                return _instance;
