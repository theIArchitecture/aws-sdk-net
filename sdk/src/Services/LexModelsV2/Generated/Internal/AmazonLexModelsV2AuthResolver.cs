...
namespace Amazon.LexModelsV2.Internal
{
    ...
    public class AmazonLexModelsV2AuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonLexModelsV2AuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for LexModelsV2.
        /// </summary>
        public AmazonLexModelsV2AuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonLexModelsV2AuthSchemeParameters
            {
    ...
    public class AmazonLexModelsV2AuthSchemeResolver : IAuthSchemeResolver<AmazonLexModelsV2AuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonLexModelsV2AuthSchemeParameters authParameters)
        {
