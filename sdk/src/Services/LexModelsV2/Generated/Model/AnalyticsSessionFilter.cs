...
namespace Amazon.LexModelsV2.Model
{
    ...
    ///  </li> <li> 
    /// <para>
    ///  <c>Duration GT 200</c> – The duration is greater than 200 seconds.
    /// </para>
    ///  </li> </ul> 
    /// <para>
    ...
    ///  </li> <li> 
    /// <para>
    ///  <c>Duration</c> – <c>EQ</c>, <c>GT</c>, <c>LT</c>.
    /// </para>
    ///  </li> <li> 
    /// <para>
    ///  <c>conversationEndState</c> – <c>EQ</c>, <c>CO</c>.
    /// </para>
    ///  </li> <li> 
    /// <para>
    ...
    ///  </li> <li> 
    /// <para>
    ///  <c>IntentPath</c> – <c>EQ</c>.
    /// </para>
    ///  </li> </ul>
    /// </summary>
    public partial class AnalyticsSessionFilter
    {
        private AnalyticsSessionFilterName _name;
        ...
        /// <para>
        /// The category by which to filter the sessions. The descriptions for each option are
        /// as follows:
        /// </para>
        ///  <ul> <li> 
        /// <para>
        ...
        ///  </li> <li> 
        /// <para>
        ///  <c>Duration</c> – The duration of the session.
        /// </para>
        ///  </li> <li> 
        /// <para>
        ///  <c>conversationEndState</c> – The final state of the session.
        /// </para>
        ///  </li> <li> 
        /// <para>
        ...
        ///  </li> <li> 
        /// <para>
        ///  <c>IntentPath</c> – The order of intents taken in a session.
        /// </para>
        ///  </li> </ul>
        /// </summary>
        [AWSProperty(Required=true)]
        public AnalyticsSessionFilterName Name
        {
