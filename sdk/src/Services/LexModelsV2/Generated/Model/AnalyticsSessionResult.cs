...
{
    /// <summary>
    /// An object containing the results for the session metrics you requested and the bin
    /// and/or group(s) they refer to, if applicable.
    /// </summary>
    public partial class AnalyticsSessionResult
    {
        private List<AnalyticsBinKey> _binKeys = AWSConfigs.InitializeCollections ? new List<AnalyticsBinKey>() : null;
        private List<AnalyticsSessionGroupByKey> _groupByKeys = AWSConfigs.InitializeCollections ? new List<AnalyticsSessionGroupByKey>() : null;
        private List<AnalyticsSessionMetricResult> _metricsResults = AWSConfigs.InitializeCollections ? new List<AnalyticsSessionMetricResult>() : null;
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<AnalyticsSessionGroupByKey> GroupByKeys
        {
        ...
        /// SDK behavior set the AWSConfigs.InitializeCollections static property to true.
        /// </summary>
        public List<AnalyticsSessionMetricResult> MetricsResults
        {
