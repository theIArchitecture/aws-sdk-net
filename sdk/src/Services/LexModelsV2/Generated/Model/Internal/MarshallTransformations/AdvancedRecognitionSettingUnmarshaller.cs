...
namespace Amazon.LexModelsV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AdvancedRecognitionSettingUnmarshaller : IJsonUnmarshaller<AdvancedRecognitionSetting, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AdvancedRecognitionSetting Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("audioRecognitionStrategy", targetDepth))
                {
                    ...
                    unmarshalledObject.AudioRecognitionStrategy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
