...
{
    /// <summary>
    /// BatchCreateCustomVocabularyItem Request Marshaller
    /// </summary>       
    public class BatchCreateCustomVocabularyItemRequestMarshaller : IMarshaller<IRequest, BatchCreateCustomVocabularyItemRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((BatchCreateCustomVocabularyItemRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(BatchCreateCustomVocabularyItemRequest publicRequest)
        {
            ...
            request.ResourcePath = "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/customvocabulary/DEFAULT/batchcreate";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetCustomVocabularyItemList())
            {
                ...
                foreach(var publicRequestCustomVocabularyItemListListValue in publicRequest.CustomVocabularyItemList)
                {
                    ...
                    var marshaller = NewCustomVocabularyItemMarshaller.Instance;
        ...
        private static BatchCreateCustomVocabularyItemRequestMarshaller _instance = new BatchCreateCustomVocabularyItemRequestMarshaller();        

        internal static BatchCreateCustomVocabularyItemRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchCreateCustomVocabularyItemRequestMarshaller Instance
        {
            get
            {
                return _instance;
