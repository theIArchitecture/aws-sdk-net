...
{
    /// <summary>
    /// Response Unmarshaller for CreateBotReplica operation
    /// </summary>  
    public class CreateBotReplicaResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateBotReplicaResponse response = new CreateBotReplicaResponse();
        ...
        private static CreateBotReplicaResponseUnmarshaller _instance = new CreateBotReplicaResponseUnmarshaller();        

        internal static CreateBotReplicaResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateBotReplicaResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
