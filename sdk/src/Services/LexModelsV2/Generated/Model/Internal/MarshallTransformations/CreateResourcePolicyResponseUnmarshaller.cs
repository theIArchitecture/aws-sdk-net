...
{
    /// <summary>
    /// Response Unmarshaller for CreateResourcePolicy operation
    /// </summary>  
    public class CreateResourcePolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateResourcePolicyResponse response = new CreateResourcePolicyResponse();
        ...
        private static CreateResourcePolicyResponseUnmarshaller _instance = new CreateResourcePolicyResponseUnmarshaller();        

        internal static CreateResourcePolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateResourcePolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
