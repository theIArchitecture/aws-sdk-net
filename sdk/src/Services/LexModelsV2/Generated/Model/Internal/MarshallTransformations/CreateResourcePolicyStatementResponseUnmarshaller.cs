...
{
    /// <summary>
    /// Response Unmarshaller for CreateResourcePolicyStatement operation
    /// </summary>  
    public class CreateResourcePolicyStatementResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateResourcePolicyStatementResponse response = new CreateResourcePolicyStatementResponse();
        ...
        private static CreateResourcePolicyStatementResponseUnmarshaller _instance = new CreateResourcePolicyStatementResponseUnmarshaller();        

        internal static CreateResourcePolicyStatementResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateResourcePolicyStatementResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
