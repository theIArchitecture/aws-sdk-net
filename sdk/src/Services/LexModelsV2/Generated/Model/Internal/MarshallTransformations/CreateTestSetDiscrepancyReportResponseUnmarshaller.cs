...
{
    /// <summary>
    /// Response Unmarshaller for CreateTestSetDiscrepancyReport operation
    /// </summary>  
    public class CreateTestSetDiscrepancyReportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTestSetDiscrepancyReportResponse response = new CreateTestSetDiscrepancyReportResponse();
        ...
        private static CreateTestSetDiscrepancyReportResponseUnmarshaller _instance = new CreateTestSetDiscrepancyReportResponseUnmarshaller();        

        internal static CreateTestSetDiscrepancyReportResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTestSetDiscrepancyReportResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
