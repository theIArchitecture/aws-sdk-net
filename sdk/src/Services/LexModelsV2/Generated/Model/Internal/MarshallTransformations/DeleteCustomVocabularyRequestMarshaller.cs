...
{
    /// <summary>
    /// DeleteCustomVocabulary Request Marshaller
    /// </summary>       
    public class DeleteCustomVocabularyRequestMarshaller : IMarshaller<IRequest, DeleteCustomVocabularyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteCustomVocabularyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteCustomVocabularyRequest publicRequest)
        {
            ...
            request.ResourcePath = "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/customvocabulary";

            return request;
        }
        private static DeleteCustomVocabularyRequestMarshaller _instance = new DeleteCustomVocabularyRequestMarshaller();        

        internal static DeleteCustomVocabularyRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCustomVocabularyRequestMarshaller Instance
        {
            get
            {
                return _instance;
