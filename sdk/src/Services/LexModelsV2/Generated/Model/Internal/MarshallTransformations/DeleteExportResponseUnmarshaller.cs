...
{
    /// <summary>
    /// Response Unmarshaller for DeleteExport operation
    /// </summary>  
    public class DeleteExportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteExportResponse response = new DeleteExportResponse();
        ...
        private static DeleteExportResponseUnmarshaller _instance = new DeleteExportResponseUnmarshaller();        

        internal static DeleteExportResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteExportResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
