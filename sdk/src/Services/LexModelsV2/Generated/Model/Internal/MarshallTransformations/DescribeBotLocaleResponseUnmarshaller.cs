    ...
    public class DescribeBotLocaleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BotLocaleHistoryEvent, BotLocaleHistoryEventUnmarshaller>(BotLocaleHistoryEventUnmarshaller.Instance);
                    response.BotLocaleHistoryEvents = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("generativeAISettings", targetDepth))
                {
                    ...
                    response.GenerativeAISettings = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("intentsCount", targetDepth))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    response.IntentsCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("lastBuildSubmittedDateTime", targetDepth))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    response.LastBuildSubmittedDateTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.LocaleName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    response.SlotTypesCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("voiceSettings", targetDepth))
                {
                    var unmarshaller = VoiceSettingsUnmarshaller.Instance;
                    response.VoiceSettings = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
