...
{
    /// <summary>
    /// Response Unmarshaller for DescribeBotReplica operation
    /// </summary>  
    public class DescribeBotReplicaResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeBotReplicaResponse response = new DescribeBotReplicaResponse();
        ...
        private static DescribeBotReplicaResponseUnmarshaller _instance = new DescribeBotReplicaResponseUnmarshaller();        

        internal static DescribeBotReplicaResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeBotReplicaResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
