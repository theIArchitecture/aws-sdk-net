...
{
    /// <summary>
    /// Response Unmarshaller for DescribeTestSet operation
    /// </summary>  
    public class DescribeTestSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeTestSetResponse response = new DescribeTestSetResponse();
        ...
        private static DescribeTestSetResponseUnmarshaller _instance = new DescribeTestSetResponseUnmarshaller();        

        internal static DescribeTestSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTestSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
