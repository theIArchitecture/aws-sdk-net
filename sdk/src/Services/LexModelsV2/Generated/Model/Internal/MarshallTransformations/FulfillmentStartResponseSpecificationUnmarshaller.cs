...
namespace Amazon.LexModelsV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FulfillmentStartResponseSpecificationUnmarshaller : IJsonUnmarshaller<FulfillmentStartResponseSpecification, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FulfillmentStartResponseSpecification Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("delayInSeconds", targetDepth))
                {
                    ...
                    unmarshalledObject.DelayInSeconds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
