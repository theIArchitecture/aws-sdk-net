...
{
    /// <summary>
    /// GenerateBotElement Request Marshaller
    /// </summary>       
    public class GenerateBotElementRequestMarshaller : IMarshaller<IRequest, GenerateBotElementRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GenerateBotElementRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GenerateBotElementRequest publicRequest)
        {
            ...
            request.ResourcePath = "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/generate";
#if !NETFRAMEWORK
            ...
            {
                context.Writer.WritePropertyName("intentId");
                context.Writer.WriteStringValue(publicRequest.IntentId);
            }
        ...
        private static GenerateBotElementRequestMarshaller _instance = new GenerateBotElementRequestMarshaller();        

        internal static GenerateBotElementRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GenerateBotElementRequestMarshaller Instance
        {
            get
            {
                return _instance;
