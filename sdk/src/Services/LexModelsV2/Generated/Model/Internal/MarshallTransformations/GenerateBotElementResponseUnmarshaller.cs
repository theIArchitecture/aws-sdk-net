...
{
    /// <summary>
    /// Response Unmarshaller for GenerateBotElement operation
    /// </summary>  
    public class GenerateBotElementResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GenerateBotElementResponse response = new GenerateBotElementResponse();
        ...
        private static GenerateBotElementResponseUnmarshaller _instance = new GenerateBotElementResponseUnmarshaller();        

        internal static GenerateBotElementResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GenerateBotElementResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
