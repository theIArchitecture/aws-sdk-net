...
{
    /// <summary>
    /// Response Unmarshaller for InputSessionStateSpecification Object
    /// </summary>  
    public class InputSessionStateSpecificationUnmarshaller : IJsonUnmarshaller<InputSessionStateSpecification, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InputSessionStateSpecification Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static InputSessionStateSpecificationUnmarshaller _instance = new InputSessionStateSpecificationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static InputSessionStateSpecificationUnmarshaller Instance
        {
            get
            {
                return _instance;
