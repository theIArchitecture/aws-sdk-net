...
namespace Amazon.LexModelsV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IntentClassificationTestResultItemCountsUnmarshaller : IJsonUnmarshaller<IntentClassificationTestResultItemCounts, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IntentClassificationTestResultItemCounts Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("intentMatchResultCounts", targetDepth))
                {
                    ...
                    unmarshalledObject.IntentMatchResultCounts = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
