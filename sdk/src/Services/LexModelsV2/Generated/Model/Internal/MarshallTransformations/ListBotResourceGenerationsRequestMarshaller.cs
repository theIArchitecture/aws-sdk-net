...
{
    /// <summary>
    /// ListBotResourceGenerations Request Marshaller
    /// </summary>       
    public class ListBotResourceGenerationsRequestMarshaller : IMarshaller<IRequest, ListBotResourceGenerationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListBotResourceGenerationsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListBotResourceGenerationsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/generations";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetSortBy())
            {
                ...
                var marshaller = GenerationSortByMarshaller.Instance;
        ...
        private static ListBotResourceGenerationsRequestMarshaller _instance = new ListBotResourceGenerationsRequestMarshaller();        

        internal static ListBotResourceGenerationsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListBotResourceGenerationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
