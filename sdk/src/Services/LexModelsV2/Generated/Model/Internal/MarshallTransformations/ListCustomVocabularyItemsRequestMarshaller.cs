...
{
    /// <summary>
    /// ListCustomVocabularyItems Request Marshaller
    /// </summary>       
    public class ListCustomVocabularyItemsRequestMarshaller : IMarshaller<IRequest, ListCustomVocabularyItemsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListCustomVocabularyItemsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListCustomVocabularyItemsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/customvocabulary/DEFAULT/list";
#if !NETFRAMEWORK
        ...
        private static ListCustomVocabularyItemsRequestMarshaller _instance = new ListCustomVocabularyItemsRequestMarshaller();        

        internal static ListCustomVocabularyItemsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCustomVocabularyItemsRequestMarshaller Instance
        {
            get
            {
                return _instance;
