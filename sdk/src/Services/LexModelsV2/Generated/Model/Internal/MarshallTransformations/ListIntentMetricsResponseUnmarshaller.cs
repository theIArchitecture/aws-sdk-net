...
{
    /// <summary>
    /// Response Unmarshaller for ListIntentMetrics operation
    /// </summary>  
    public class ListIntentMetricsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListIntentMetricsResponse response = new ListIntentMetricsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AnalyticsIntentResult, AnalyticsIntentResultUnmarshaller>(AnalyticsIntentResultUnmarshaller.Instance);
        ...
        private static ListIntentMetricsResponseUnmarshaller _instance = new ListIntentMetricsResponseUnmarshaller();        

        internal static ListIntentMetricsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListIntentMetricsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
