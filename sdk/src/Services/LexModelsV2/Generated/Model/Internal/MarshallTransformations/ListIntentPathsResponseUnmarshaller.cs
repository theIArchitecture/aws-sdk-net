...
{
    /// <summary>
    /// Response Unmarshaller for ListIntentPaths operation
    /// </summary>  
    public class ListIntentPathsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListIntentPathsResponse response = new ListIntentPathsResponse();
        ...
        private static ListIntentPathsResponseUnmarshaller _instance = new ListIntentPathsResponseUnmarshaller();        

        internal static ListIntentPathsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListIntentPathsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
