...
{
    /// <summary>
    /// ListIntentStageMetrics Request Marshaller
    /// </summary>       
    public class ListIntentStageMetricsRequestMarshaller : IMarshaller<IRequest, ListIntentStageMetricsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListIntentStageMetricsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListIntentStageMetricsRequest publicRequest)
        {
        ...
        private static ListIntentStageMetricsRequestMarshaller _instance = new ListIntentStageMetricsRequestMarshaller();        

        internal static ListIntentStageMetricsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListIntentStageMetricsRequestMarshaller Instance
        {
            get
            {
                return _instance;
