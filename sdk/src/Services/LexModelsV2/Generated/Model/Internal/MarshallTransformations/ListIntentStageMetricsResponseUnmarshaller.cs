...
{
    /// <summary>
    /// Response Unmarshaller for ListIntentStageMetrics operation
    /// </summary>  
    public class ListIntentStageMetricsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListIntentStageMetricsResponse response = new ListIntentStageMetricsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AnalyticsIntentStageResult, AnalyticsIntentStageResultUnmarshaller>(AnalyticsIntentStageResultUnmarshaller.Instance);
        ...
        private static ListIntentStageMetricsResponseUnmarshaller _instance = new ListIntentStageMetricsResponseUnmarshaller();        

        internal static ListIntentStageMetricsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListIntentStageMetricsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
