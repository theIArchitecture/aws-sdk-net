...
{
    /// <summary>
    /// ListSessionAnalyticsData Request Marshaller
    /// </summary>       
    public class ListSessionAnalyticsDataRequestMarshaller : IMarshaller<IRequest, ListSessionAnalyticsDataRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListSessionAnalyticsDataRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListSessionAnalyticsDataRequest publicRequest)
        {
            ...
            request.ResourcePath = "/bots/{botId}/analytics/sessions";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetSortBy())
            {
                ...
                var marshaller = SessionDataSortByMarshaller.Instance;
        ...
        private static ListSessionAnalyticsDataRequestMarshaller _instance = new ListSessionAnalyticsDataRequestMarshaller();        

        internal static ListSessionAnalyticsDataRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSessionAnalyticsDataRequestMarshaller Instance
        {
            get
            {
                return _instance;
