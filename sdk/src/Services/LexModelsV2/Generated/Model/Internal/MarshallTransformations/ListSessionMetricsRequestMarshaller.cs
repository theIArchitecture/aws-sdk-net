...
{
    /// <summary>
    /// ListSessionMetrics Request Marshaller
    /// </summary>       
    public class ListSessionMetricsRequestMarshaller : IMarshaller<IRequest, ListSessionMetricsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListSessionMetricsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListSessionMetricsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/bots/{botId}/analytics/sessionmetrics";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetFilters())
            {
                ...
                foreach(var publicRequestFiltersListValue in publicRequest.Filters)
                {
                    ...
                    var marshaller = AnalyticsSessionFilterMarshaller.Instance;
            ...
            if(publicRequest.IsSetGroupBy())
            {
                ...
                foreach(var publicRequestGroupByListValue in publicRequest.GroupBy)
                {
                    ...
                    var marshaller = AnalyticsSessionGroupBySpecificationMarshaller.Instance;
            ...
            if(publicRequest.IsSetMetrics())
            {
                ...
                foreach(var publicRequestMetricsListValue in publicRequest.Metrics)
                {
                    ...
                    var marshaller = AnalyticsSessionMetricMarshaller.Instance;
        ...
        private static ListSessionMetricsRequestMarshaller _instance = new ListSessionMetricsRequestMarshaller();        

        internal static ListSessionMetricsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSessionMetricsRequestMarshaller Instance
        {
            get
            {
                return _instance;
