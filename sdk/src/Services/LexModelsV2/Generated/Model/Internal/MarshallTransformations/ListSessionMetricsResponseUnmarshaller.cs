...
{
    /// <summary>
    /// Response Unmarshaller for ListSessionMetrics operation
    /// </summary>  
    public class ListSessionMetricsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSessionMetricsResponse response = new ListSessionMetricsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AnalyticsSessionResult, AnalyticsSessionResultUnmarshaller>(AnalyticsSessionResultUnmarshaller.Instance);
        ...
        private static ListSessionMetricsResponseUnmarshaller _instance = new ListSessionMetricsResponseUnmarshaller();        

        internal static ListSessionMetricsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSessionMetricsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
