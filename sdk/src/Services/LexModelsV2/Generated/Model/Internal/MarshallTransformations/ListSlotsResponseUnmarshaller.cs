    ...
    public class ListSlotsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SlotSummary, SlotSummaryUnmarshaller>(SlotSummaryUnmarshaller.Instance);
                    response.SlotSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
