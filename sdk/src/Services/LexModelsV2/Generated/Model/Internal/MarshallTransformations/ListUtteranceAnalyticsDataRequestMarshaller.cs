...
{
    /// <summary>
    /// ListUtteranceAnalyticsData Request Marshaller
    /// </summary>       
    public class ListUtteranceAnalyticsDataRequestMarshaller : IMarshaller<IRequest, ListUtteranceAnalyticsDataRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListUtteranceAnalyticsDataRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListUtteranceAnalyticsDataRequest publicRequest)
        {
            ...
            request.ResourcePath = "/bots/{botId}/analytics/utterances";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetSortBy())
            {
                ...
                var marshaller = UtteranceDataSortByMarshaller.Instance;
        ...
        private static ListUtteranceAnalyticsDataRequestMarshaller _instance = new ListUtteranceAnalyticsDataRequestMarshaller();        

        internal static ListUtteranceAnalyticsDataRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListUtteranceAnalyticsDataRequestMarshaller Instance
        {
            get
            {
                return _instance;
