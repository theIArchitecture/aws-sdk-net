...
{
    /// <summary>
    /// Response Unmarshaller for ListUtteranceAnalyticsData operation
    /// </summary>  
    public class ListUtteranceAnalyticsDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListUtteranceAnalyticsDataResponse response = new ListUtteranceAnalyticsDataResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<UtteranceSpecification, UtteranceSpecificationUnmarshaller>(UtteranceSpecificationUnmarshaller.Instance);
        ...
        private static ListUtteranceAnalyticsDataResponseUnmarshaller _instance = new ListUtteranceAnalyticsDataResponseUnmarshaller();        

        internal static ListUtteranceAnalyticsDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListUtteranceAnalyticsDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
