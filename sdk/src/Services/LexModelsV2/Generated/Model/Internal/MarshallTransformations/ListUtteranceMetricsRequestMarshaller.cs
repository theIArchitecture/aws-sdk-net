...
{
    /// <summary>
    /// ListUtteranceMetrics Request Marshaller
    /// </summary>       
    public class ListUtteranceMetricsRequestMarshaller : IMarshaller<IRequest, ListUtteranceMetricsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListUtteranceMetricsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListUtteranceMetricsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/bots/{botId}/analytics/utterancemetrics";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetAttributes())
            {
                ...
                foreach(var publicRequestAttributesListValue in publicRequest.Attributes)
                {
                    ...
                    var marshaller = AnalyticsUtteranceAttributeMarshaller.Instance;
            ...
            if(publicRequest.IsSetFilters())
            {
                ...
                foreach(var publicRequestFiltersListValue in publicRequest.Filters)
                {
                    ...
                    var marshaller = AnalyticsUtteranceFilterMarshaller.Instance;
            ...
            if(publicRequest.IsSetGroupBy())
            {
                ...
                foreach(var publicRequestGroupByListValue in publicRequest.GroupBy)
                {
                    ...
                    var marshaller = AnalyticsUtteranceGroupBySpecificationMarshaller.Instance;
            ...
            if(publicRequest.IsSetMetrics())
            {
                ...
                foreach(var publicRequestMetricsListValue in publicRequest.Metrics)
                {
                    ...
                    var marshaller = AnalyticsUtteranceMetricMarshaller.Instance;
        ...
        private static ListUtteranceMetricsRequestMarshaller _instance = new ListUtteranceMetricsRequestMarshaller();        

        internal static ListUtteranceMetricsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListUtteranceMetricsRequestMarshaller Instance
        {
            get
            {
                return _instance;
