...
{
    /// <summary>
    /// Response Unmarshaller for ListUtteranceMetrics operation
    /// </summary>  
    public class ListUtteranceMetricsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListUtteranceMetricsResponse response = new ListUtteranceMetricsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AnalyticsUtteranceResult, AnalyticsUtteranceResultUnmarshaller>(AnalyticsUtteranceResultUnmarshaller.Instance);
        ...
        private static ListUtteranceMetricsResponseUnmarshaller _instance = new ListUtteranceMetricsResponseUnmarshaller();        

        internal static ListUtteranceMetricsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListUtteranceMetricsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
