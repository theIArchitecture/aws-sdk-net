...
namespace Amazon.LexModelsV2.Model.Internal.MarshallTransformations
{
    ...
    public class MultipleValuesSettingMarshaller : IRequestMarshaller<MultipleValuesSetting, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(MultipleValuesSetting requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetAllowMultipleValues())
            {
                ...
                context.Writer.WriteBooleanValue(requestObject.AllowMultipleValues.Value);
            }
