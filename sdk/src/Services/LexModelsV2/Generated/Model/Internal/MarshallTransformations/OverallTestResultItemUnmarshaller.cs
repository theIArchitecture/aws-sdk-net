...
namespace Amazon.LexModelsV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OverallTestResultItemUnmarshaller : IJsonUnmarshaller<OverallTestResultItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public OverallTestResultItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("endToEndResultCounts", targetDepth))
                {
                    ...
                    unmarshalledObject.EndToEndResultCounts = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
