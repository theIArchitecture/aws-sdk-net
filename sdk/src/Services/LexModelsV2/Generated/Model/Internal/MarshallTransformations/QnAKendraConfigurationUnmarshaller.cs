...
{
    /// <summary>
    /// Response Unmarshaller for QnAKendraConfiguration Object
    /// </summary>  
    public class QnAKendraConfigurationUnmarshaller : IJsonUnmarshaller<QnAKendraConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public QnAKendraConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            QnAKendraConfiguration unmarshalledObject = new QnAKendraConfiguration();
        ...
        private static QnAKendraConfigurationUnmarshaller _instance = new QnAKendraConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static QnAKendraConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
