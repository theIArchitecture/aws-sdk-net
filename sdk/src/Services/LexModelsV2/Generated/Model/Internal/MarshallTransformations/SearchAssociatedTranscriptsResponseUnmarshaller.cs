...
{
    /// <summary>
    /// Response Unmarshaller for SearchAssociatedTranscripts operation
    /// </summary>  
    public class SearchAssociatedTranscriptsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchAssociatedTranscriptsResponse response = new SearchAssociatedTranscriptsResponse();
        ...
        private static SearchAssociatedTranscriptsResponseUnmarshaller _instance = new SearchAssociatedTranscriptsResponseUnmarshaller();        

        internal static SearchAssociatedTranscriptsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchAssociatedTranscriptsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
