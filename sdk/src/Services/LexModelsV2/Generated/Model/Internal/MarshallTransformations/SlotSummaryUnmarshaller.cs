...
namespace Amazon.LexModelsV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SlotSummaryUnmarshaller : IJsonUnmarshaller<SlotSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SlotSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("valueElicitationPromptSpecification", targetDepth))
                {
                    ...
                    unmarshalledObject.ValueElicitationPromptSpecification = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
