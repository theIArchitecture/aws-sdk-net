...
{
    /// <summary>
    /// Response Unmarshaller for StartBotResourceGeneration operation
    /// </summary>  
    public class StartBotResourceGenerationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartBotResourceGenerationResponse response = new StartBotResourceGenerationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.GenerationInputPrompt = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("generationStatus", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.GenerationStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static StartBotResourceGenerationResponseUnmarshaller _instance = new StartBotResourceGenerationResponseUnmarshaller();        

        internal static StartBotResourceGenerationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartBotResourceGenerationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
