...
{
    /// <summary>
    /// Response Unmarshaller for StopBotRecommendation operation
    /// </summary>  
    public class StopBotRecommendationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopBotRecommendationResponse response = new StopBotRecommendationResponse();
        ...
        private static StopBotRecommendationResponseUnmarshaller _instance = new StopBotRecommendationResponseUnmarshaller();        

        internal static StopBotRecommendationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopBotRecommendationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
