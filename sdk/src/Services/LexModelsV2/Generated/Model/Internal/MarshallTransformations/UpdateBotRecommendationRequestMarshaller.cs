...
{
    /// <summary>
    /// UpdateBotRecommendation Request Marshaller
    /// </summary>       
    public class UpdateBotRecommendationRequestMarshaller : IMarshaller<IRequest, UpdateBotRecommendationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateBotRecommendationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateBotRecommendationRequest publicRequest)
        {
        ...
        private static UpdateBotRecommendationRequestMarshaller _instance = new UpdateBotRecommendationRequestMarshaller();        

        internal static UpdateBotRecommendationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBotRecommendationRequestMarshaller Instance
        {
            get
            {
                return _instance;
