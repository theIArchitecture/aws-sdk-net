...
{
    /// <summary>
    /// Response Unmarshaller for UpdateResourcePolicy operation
    /// </summary>  
    public class UpdateResourcePolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateResourcePolicyResponse response = new UpdateResourcePolicyResponse();
        ...
        private static UpdateResourcePolicyResponseUnmarshaller _instance = new UpdateResourcePolicyResponseUnmarshaller();        

        internal static UpdateResourcePolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateResourcePolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
