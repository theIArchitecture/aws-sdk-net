...
namespace Amazon.LexModelsV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UtteranceAggregationDurationUnmarshaller : IJsonUnmarshaller<UtteranceAggregationDuration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public UtteranceAggregationDuration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("relativeAggregationDuration", targetDepth))
                {
                    ...
                    unmarshalledObject.RelativeAggregationDuration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
