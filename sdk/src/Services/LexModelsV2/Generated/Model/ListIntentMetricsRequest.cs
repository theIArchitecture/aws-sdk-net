...
{
    /// <summary>
    /// Container for the parameters to the ListIntentMetrics operation.
    ...
    public partial class ListIntentMetricsRequest : AmazonLexModelsV2Request
    {
        ...
        public List<AnalyticsIntentFilter> Filters
        {
        ...
        ///  </li> <li> 
        /// <para>
        ///  <c>IntentEndState</c> – The final state of the intent. The possible end states are
        ...
        public List<AnalyticsIntentGroupBySpecification> GroupBy
        {
        ...
        public List<AnalyticsIntentMetric> Metrics
        {
        ...
        ///  
        /// <para>
        /// Use the returned token in the nextToken parameter of a ListIntentMetrics request to
