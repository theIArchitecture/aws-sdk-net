...
namespace Amazon.LexModelsV2.Model
{
    ...
    /// </summary>
    public partial class ListSessionMetricsResponse : AmazonWebServiceResponse
    {
        private string _botId;
        private string _nextToken;
        private List<AnalyticsSessionResult> _results = AWSConfigs.InitializeCollections ? new List<AnalyticsSessionResult>() : null;
        ...
        /// <para>
        /// If the response from the ListSessionMetrics operation contains more results than specified
        /// in the maxResults parameter, a token is returned in the response.
        /// </para>
        ///  
        /// <para>
        /// Use the returned token in the nextToken parameter of a ListSessionMetrics request
        ...
        /// </summary>
        public List<AnalyticsSessionResult> Results
        {
