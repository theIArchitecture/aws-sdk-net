...
#elif NET8_0
[assembly: AssemblyDescription("The Amazon Web Services SDK for .NET (.NET 8.0) - Amazon Lex Model Building V2. This release adds support for Amazon Lex V2 APIs for model building.")]
#else
