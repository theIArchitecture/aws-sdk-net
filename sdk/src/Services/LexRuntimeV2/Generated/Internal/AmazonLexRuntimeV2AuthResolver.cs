...
namespace Amazon.LexRuntimeV2.Internal
{
    ...
    public class AmazonLexRuntimeV2AuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonLexRuntimeV2AuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for LexRuntimeV2.
        /// </summary>
        public AmazonLexRuntimeV2AuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonLexRuntimeV2AuthSchemeParameters
            {
    ...
    public class AmazonLexRuntimeV2AuthSchemeResolver : IAuthSchemeResolver<AmazonLexRuntimeV2AuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonLexRuntimeV2AuthSchemeParameters authParameters)
        {
