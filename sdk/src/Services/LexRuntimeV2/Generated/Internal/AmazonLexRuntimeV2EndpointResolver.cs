...
namespace Amazon.LexRuntimeV2.Internal
{
    ...
    /// </summary>
    public class AmazonLexRuntimeV2EndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonLexRuntimeV2Config)requestContext.ClientConfig;
            var result = new LexRuntimeV2EndpointParameters();
