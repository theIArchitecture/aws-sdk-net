...
{
    /// <summary>
    /// A notification from the client that it is disconnecting from Amazon Lex V2. Sending
    /// a <c>DisconnectionEvent</c> event is optional, but can help identify a conversation
    /// in logs.
    /// </summary>
    public partial class DisconnectionEvent
        : IEventStreamEvent
    {
