...
namespace Amazon.LexRuntimeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ActiveContextUnmarshaller : IJsonUnmarshaller<ActiveContext, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ActiveContext Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("contextAttributes", targetDepth))
                {
                    ...
                    unmarshalledObject.ContextAttributes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("timeToLive", targetDepth))
                {
                    ...
                    unmarshalledObject.TimeToLive = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
