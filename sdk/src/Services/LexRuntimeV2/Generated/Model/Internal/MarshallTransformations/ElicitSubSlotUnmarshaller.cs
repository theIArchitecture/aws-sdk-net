...
namespace Amazon.LexRuntimeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ElicitSubSlotUnmarshaller : IJsonUnmarshaller<ElicitSubSlot, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ElicitSubSlot Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
