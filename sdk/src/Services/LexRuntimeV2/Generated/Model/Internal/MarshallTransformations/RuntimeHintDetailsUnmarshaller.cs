...
namespace Amazon.LexRuntimeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RuntimeHintDetailsUnmarshaller : IJsonUnmarshaller<RuntimeHintDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RuntimeHintDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            RuntimeHintDetails unmarshalledObject = new RuntimeHintDetails();
        ...
        private static RuntimeHintDetailsUnmarshaller _instance = new RuntimeHintDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RuntimeHintDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
