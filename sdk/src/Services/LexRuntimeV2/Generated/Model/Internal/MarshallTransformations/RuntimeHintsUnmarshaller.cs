...
namespace Amazon.LexRuntimeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RuntimeHintsUnmarshaller : IJsonUnmarshaller<RuntimeHints, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RuntimeHints Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static RuntimeHintsUnmarshaller _instance = new RuntimeHintsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RuntimeHintsUnmarshaller Instance
        {
            get
            {
                return _instance;
