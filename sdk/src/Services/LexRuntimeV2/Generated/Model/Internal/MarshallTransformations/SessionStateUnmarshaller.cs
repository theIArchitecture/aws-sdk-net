...
namespace Amazon.LexRuntimeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SessionStateUnmarshaller : IJsonUnmarshaller<SessionState, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SessionState Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
