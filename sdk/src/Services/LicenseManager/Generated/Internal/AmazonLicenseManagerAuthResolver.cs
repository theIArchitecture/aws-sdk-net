...
namespace Amazon.LicenseManager.Internal
{
    ...
    public class AmazonLicenseManagerAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonLicenseManagerAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for LicenseManager.
        /// </summary>
        public AmazonLicenseManagerAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonLicenseManagerAuthSchemeParameters
            {
    ...
    public class AmazonLicenseManagerAuthSchemeResolver : IAuthSchemeResolver<AmazonLicenseManagerAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonLicenseManagerAuthSchemeParameters authParameters)
        {
