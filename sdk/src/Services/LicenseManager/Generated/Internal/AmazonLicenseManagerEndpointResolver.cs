...
{
    /// <summary>
    /// Amazon LicenseManager endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for LicenseManager service requests.
    /// Collects values for LicenseManagerEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses LicenseManagerEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonLicenseManagerEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonLicenseManagerConfig)requestContext.ClientConfig;
            var result = new LicenseManagerEndpointParameters();
