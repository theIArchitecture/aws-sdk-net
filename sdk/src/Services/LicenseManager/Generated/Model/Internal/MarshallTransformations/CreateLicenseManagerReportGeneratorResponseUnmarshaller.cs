...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateLicenseManagerReportGeneratorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLicenseManagerReportGeneratorResponse response = new CreateLicenseManagerReportGeneratorResponse();
        ...
        private static CreateLicenseManagerReportGeneratorResponseUnmarshaller _instance = new CreateLicenseManagerReportGeneratorResponseUnmarshaller();        

        internal static CreateLicenseManagerReportGeneratorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLicenseManagerReportGeneratorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
