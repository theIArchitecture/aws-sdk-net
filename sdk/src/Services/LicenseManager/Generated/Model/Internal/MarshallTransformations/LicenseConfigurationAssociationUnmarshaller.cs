...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LicenseConfigurationAssociationUnmarshaller : IJsonUnmarshaller<LicenseConfigurationAssociation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LicenseConfigurationAssociation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AmiAssociationScope", targetDepth))
                {
                    ...
                    unmarshalledObject.AmiAssociationScope = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
