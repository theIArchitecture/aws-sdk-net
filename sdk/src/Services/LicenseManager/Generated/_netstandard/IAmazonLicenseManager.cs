...
namespace Amazon.LicenseManager
{
    ...
    public partial interface IAmazonLicenseManager : IAmazonService, IDisposable
    {
        ...
        Task<CreateLicenseConversionTaskForResourceResponse> CreateLicenseConversionTaskForResourceAsync(CreateLicenseConversionTaskForResourceRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<CreateLicenseManagerReportGeneratorResponse> CreateLicenseManagerReportGeneratorAsync(CreateLicenseManagerReportGeneratorRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteLicenseManagerReportGeneratorResponse> DeleteLicenseManagerReportGeneratorAsync(DeleteLicenseManagerReportGeneratorRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetLicenseConversionTaskResponse> GetLicenseConversionTaskAsync(GetLicenseConversionTaskRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetLicenseManagerReportGeneratorResponse> GetLicenseManagerReportGeneratorAsync(GetLicenseManagerReportGeneratorRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListLicenseConversionTasksResponse> ListLicenseConversionTasksAsync(ListLicenseConversionTasksRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListLicenseManagerReportGeneratorsResponse> ListLicenseManagerReportGeneratorsAsync(ListLicenseManagerReportGeneratorsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListReceivedGrantsForOrganizationResponse> ListReceivedGrantsForOrganizationAsync(ListReceivedGrantsForOrganizationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListReceivedLicensesForOrganizationResponse> ListReceivedLicensesForOrganizationAsync(ListReceivedLicensesForOrganizationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateLicenseManagerReportGeneratorResponse> UpdateLicenseManagerReportGeneratorAsync(UpdateLicenseManagerReportGeneratorRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonLicenseManagerConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonLicenseManagerConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonLicenseManagerConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonLicenseManagerConfig to create AmazonLicenseManagerClient");
            }

            return awsCredentials == null ? 
                    new AmazonLicenseManagerClient(serviceClientConfig) :
                    new AmazonLicenseManagerClient(awsCredentials, serviceClientConfig);
        }
