...
namespace Amazon.LicenseManagerLinuxSubscriptions.Internal
{
    ...
    /// </summary>
    public class AmazonLicenseManagerLinuxSubscriptionsEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonLicenseManagerLinuxSubscriptionsConfig)requestContext.ClientConfig;
            var result = new LicenseManagerLinuxSubscriptionsEndpointParameters();
