...
namespace Amazon.LicenseManagerLinuxSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeregisterSubscriptionProviderRequestMarshaller : IMarshaller<IRequest, DeregisterSubscriptionProviderRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeregisterSubscriptionProviderRequestMarshaller _instance = new DeregisterSubscriptionProviderRequestMarshaller();        

        internal static DeregisterSubscriptionProviderRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeregisterSubscriptionProviderRequestMarshaller Instance
        {
            get
            {
                return _instance;
