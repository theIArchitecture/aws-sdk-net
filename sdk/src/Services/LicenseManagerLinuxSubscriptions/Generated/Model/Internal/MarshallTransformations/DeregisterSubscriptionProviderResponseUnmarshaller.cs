...
namespace Amazon.LicenseManagerLinuxSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeregisterSubscriptionProviderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeregisterSubscriptionProviderResponse response = new DeregisterSubscriptionProviderResponse();
        ...
        internal static DeregisterSubscriptionProviderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeregisterSubscriptionProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
