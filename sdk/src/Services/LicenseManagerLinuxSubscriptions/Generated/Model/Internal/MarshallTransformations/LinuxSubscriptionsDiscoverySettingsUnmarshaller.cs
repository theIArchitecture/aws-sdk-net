...
namespace Amazon.LicenseManagerLinuxSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LinuxSubscriptionsDiscoverySettingsUnmarshaller : IJsonUnmarshaller<LinuxSubscriptionsDiscoverySettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LinuxSubscriptionsDiscoverySettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("OrganizationIntegration", targetDepth))
                {
                    ...
                    unmarshalledObject.OrganizationIntegration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
