...
namespace Amazon.LicenseManagerLinuxSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListLinuxSubscriptionInstancesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListLinuxSubscriptionInstancesResponse response = new ListLinuxSubscriptionInstancesResponse();
        ...
        private static ListLinuxSubscriptionInstancesResponseUnmarshaller _instance = new ListLinuxSubscriptionInstancesResponseUnmarshaller();        

        internal static ListLinuxSubscriptionInstancesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLinuxSubscriptionInstancesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
