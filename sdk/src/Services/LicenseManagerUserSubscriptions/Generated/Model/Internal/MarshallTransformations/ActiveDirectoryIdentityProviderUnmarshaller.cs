...
namespace Amazon.LicenseManagerUserSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ActiveDirectoryIdentityProviderUnmarshaller : IJsonUnmarshaller<ActiveDirectoryIdentityProvider, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ActiveDirectoryIdentityProvider Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
