...
namespace Amazon.LicenseManagerUserSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeregisterIdentityProviderRequestMarshaller : IMarshaller<IRequest, DeregisterIdentityProviderRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeregisterIdentityProviderRequestMarshaller _instance = new DeregisterIdentityProviderRequestMarshaller();        

        internal static DeregisterIdentityProviderRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeregisterIdentityProviderRequestMarshaller Instance
        {
            get
            {
                return _instance;
