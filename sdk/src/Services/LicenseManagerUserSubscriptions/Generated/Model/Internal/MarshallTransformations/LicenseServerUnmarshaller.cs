...
namespace Amazon.LicenseManagerUserSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LicenseServerUnmarshaller : IJsonUnmarshaller<LicenseServer, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LicenseServer Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
