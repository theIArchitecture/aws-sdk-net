...
namespace Amazon.LicenseManagerUserSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListUserAssociationsRequestMarshaller : IMarshaller<IRequest, ListUserAssociationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListUserAssociationsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListUserAssociationsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/user/ListUserAssociations";
#if !NETFRAMEWORK
        ...
        private static ListUserAssociationsRequestMarshaller _instance = new ListUserAssociationsRequestMarshaller();        

        internal static ListUserAssociationsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListUserAssociationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
