...
namespace Amazon.LicenseManagerUserSubscriptions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class StartProductSubscriptionRequestMarshaller : IMarshaller<IRequest, StartProductSubscriptionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartProductSubscriptionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartProductSubscriptionRequest publicRequest)
        {
            ...
            request.ResourcePath = "/user/StartProductSubscription";
#if !NETFRAMEWORK
        ...
        private static StartProductSubscriptionRequestMarshaller _instance = new StartProductSubscriptionRequestMarshaller();        

        internal static StartProductSubscriptionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartProductSubscriptionRequestMarshaller Instance
        {
            get
            {
                return _instance;
