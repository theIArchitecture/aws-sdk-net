...
namespace Amazon.Lightsail.Model
{
    ...
    {
        private List<Bundle> _bundles = AWSConfigs.InitializeCollections ? new List<Bundle>() : null;
        ...
        ///  
        /// <para>
        /// To get the next page of results, perform another <c>GetBundles</c> request and specify
