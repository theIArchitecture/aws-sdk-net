...
namespace Amazon.Lightsail.Model
{
    ...
    public partial class GetDisksRequest : AmazonLightsailRequest
    {
        ...
        ///  
        /// <para>
        /// To get a page token, perform an initial <c>GetDisks</c> request. If your results are
        /// paginated, the response will return a next page token that you can specify as the
