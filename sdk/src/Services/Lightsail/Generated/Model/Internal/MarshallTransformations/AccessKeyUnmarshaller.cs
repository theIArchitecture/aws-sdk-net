...
namespace Amazon.Lightsail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AccessKeyUnmarshaller : IJsonUnmarshaller<AccessKey, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AccessKey Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("lastUsed", targetDepth))
                {
                    ...
                    unmarshalledObject.LastUsed = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
