...
{
    /// <summary>
    /// Response Unmarshaller for GetBucketBundles operation
    /// </summary>  
    public class GetBucketBundlesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetBucketBundlesResponse response = new GetBucketBundlesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BucketBundle, BucketBundleUnmarshaller>(BucketBundleUnmarshaller.Instance);
        ...
        private static GetBucketBundlesResponseUnmarshaller _instance = new GetBucketBundlesResponseUnmarshaller();        

        internal static GetBucketBundlesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBucketBundlesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
