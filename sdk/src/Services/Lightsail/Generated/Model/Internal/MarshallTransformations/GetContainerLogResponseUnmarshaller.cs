    ...
    public class GetContainerLogResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ContainerServiceLogEvent, ContainerServiceLogEventUnmarshaller>(ContainerServiceLogEventUnmarshaller.Instance);
                    response.LogEvents = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
