    ...
    public class GetDiskSnapshotsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DiskSnapshot, DiskSnapshotUnmarshaller>(DiskSnapshotUnmarshaller.Instance);
                    response.DiskSnapshots = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
