    ...
    public class GetDistributionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<LightsailDistribution, LightsailDistributionUnmarshaller>(LightsailDistributionUnmarshaller.Instance);
                    response.Distributions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
