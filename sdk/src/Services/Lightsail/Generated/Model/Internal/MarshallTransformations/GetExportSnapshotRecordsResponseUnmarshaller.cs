    ...
    public class GetExportSnapshotRecordsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ExportSnapshotRecord, ExportSnapshotRecordUnmarshaller>(ExportSnapshotRecordUnmarshaller.Instance);
                    response.ExportSnapshotRecords = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
