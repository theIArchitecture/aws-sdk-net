    ...
    public class GetRelationalDatabaseEventsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<RelationalDatabaseEvent, RelationalDatabaseEventUnmarshaller>(RelationalDatabaseEventUnmarshaller.Instance);
                    response.RelationalDatabaseEvents = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
