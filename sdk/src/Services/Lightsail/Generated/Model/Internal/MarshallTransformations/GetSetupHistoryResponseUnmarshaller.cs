...
{
    /// <summary>
    /// Response Unmarshaller for GetSetupHistory operation
    /// </summary>  
    public class GetSetupHistoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSetupHistoryResponse response = new GetSetupHistoryResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("setupHistory", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<SetupHistory, SetupHistoryUnmarshaller>(SetupHistoryUnmarshaller.Instance);
                    response.SetupHistory = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetSetupHistoryResponseUnmarshaller _instance = new GetSetupHistoryResponseUnmarshaller();        

        internal static GetSetupHistoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSetupHistoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
