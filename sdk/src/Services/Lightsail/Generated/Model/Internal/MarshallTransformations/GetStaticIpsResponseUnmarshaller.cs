    ...
    public class GetStaticIpsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<StaticIp, StaticIpUnmarshaller>(StaticIpUnmarshaller.Instance);
                    response.StaticIps = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
