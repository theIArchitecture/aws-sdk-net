...
{
    /// <summary>
    /// Response Unmarshaller for SetResourceAccessForBucket operation
    /// </summary>  
    public class SetResourceAccessForBucketResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SetResourceAccessForBucketResponse response = new SetResourceAccessForBucketResponse();
        ...
        private static SetResourceAccessForBucketResponseUnmarshaller _instance = new SetResourceAccessForBucketResponseUnmarshaller();        

        internal static SetResourceAccessForBucketResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetResourceAccessForBucketResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
