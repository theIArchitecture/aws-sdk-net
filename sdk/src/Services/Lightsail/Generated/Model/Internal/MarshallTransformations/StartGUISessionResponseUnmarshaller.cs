...
{
    /// <summary>
    /// Response Unmarshaller for StartGUISession operation
    /// </summary>  
    public class StartGUISessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartGUISessionResponse response = new StartGUISessionResponse();
        ...
        private static StartGUISessionResponseUnmarshaller _instance = new StartGUISessionResponseUnmarshaller();        

        internal static StartGUISessionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartGUISessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
