...
{
    /// <summary>
    /// Response Unmarshaller for StopGUISession operation
    /// </summary>  
    public class StopGUISessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopGUISessionResponse response = new StopGUISessionResponse();
        ...
        private static StopGUISessionResponseUnmarshaller _instance = new StopGUISessionResponseUnmarshaller();        

        internal static StopGUISessionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopGUISessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
