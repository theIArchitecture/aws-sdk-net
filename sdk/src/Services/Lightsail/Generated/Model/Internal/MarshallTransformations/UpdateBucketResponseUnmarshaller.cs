...
{
    /// <summary>
    /// Response Unmarshaller for UpdateBucket operation
    /// </summary>  
    public class UpdateBucketResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateBucketResponseUnmarshaller _instance = new UpdateBucketResponseUnmarshaller();        

        internal static UpdateBucketResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBucketResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
