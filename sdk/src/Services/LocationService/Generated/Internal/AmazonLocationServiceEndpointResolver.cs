...
{
    /// <summary>
    /// Amazon LocationService endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for LocationService service requests.
    /// Collects values for LocationServiceEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses LocationServiceEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonLocationServiceEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonLocationServiceConfig)requestContext.ClientConfig;
            var result = new LocationServiceEndpointParameters();
