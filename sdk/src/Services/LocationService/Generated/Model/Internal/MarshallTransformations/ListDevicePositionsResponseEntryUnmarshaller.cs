...
{
    /// <summary>
    /// Response Unmarshaller for ListDevicePositionsResponseEntry Object
    /// </summary>  
    public class ListDevicePositionsResponseEntryUnmarshaller : IJsonUnmarshaller<ListDevicePositionsResponseEntry, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ListDevicePositionsResponseEntry Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ListDevicePositionsResponseEntry unmarshalledObject = new ListDevicePositionsResponseEntry();
        ...
        private static ListDevicePositionsResponseEntryUnmarshaller _instance = new ListDevicePositionsResponseEntryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ListDevicePositionsResponseEntryUnmarshaller Instance
        {
            get
            {
                return _instance;
