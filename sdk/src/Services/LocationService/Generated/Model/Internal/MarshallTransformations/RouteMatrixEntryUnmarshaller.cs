...
namespace Amazon.LocationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RouteMatrixEntryUnmarshaller : IJsonUnmarshaller<RouteMatrixEntry, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RouteMatrixEntry Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = RouteMatrixEntryErrorUnmarshaller.Instance;
