...
{
    /// <summary>
    /// UpdateMap Request Marshaller
    /// </summary>       
    public class UpdateMapRequestMarshaller : IMarshaller<IRequest, UpdateMapRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateMapRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateMapRequest publicRequest)
        {
        ...
        private static UpdateMapRequestMarshaller _instance = new UpdateMapRequestMarshaller();        

        internal static UpdateMapRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMapRequestMarshaller Instance
        {
            get
            {
                return _instance;
