...
{
    /// <summary>
    /// VerifyDevicePosition Request Marshaller
    /// </summary>       
    public class VerifyDevicePositionRequestMarshaller : IMarshaller<IRequest, VerifyDevicePositionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((VerifyDevicePositionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(VerifyDevicePositionRequest publicRequest)
        {
        ...
        private static VerifyDevicePositionRequestMarshaller _instance = new VerifyDevicePositionRequestMarshaller();        

        internal static VerifyDevicePositionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static VerifyDevicePositionRequestMarshaller Instance
        {
            get
            {
                return _instance;
