...
{
    /// <summary>
    /// Response Unmarshaller for VerifyDevicePosition operation
    /// </summary>  
    public class VerifyDevicePositionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            VerifyDevicePositionResponse response = new VerifyDevicePositionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = InferredStateUnmarshaller.Instance;
                    response.InferredState = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static VerifyDevicePositionResponseUnmarshaller _instance = new VerifyDevicePositionResponseUnmarshaller();        

        internal static VerifyDevicePositionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static VerifyDevicePositionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
