...
namespace Amazon.LookoutEquipment.Internal
{
    ...
    /// </summary>
    public class AmazonLookoutEquipmentEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonLookoutEquipmentConfig)requestContext.ClientConfig;
            var result = new LookoutEquipmentEndpointParameters();
