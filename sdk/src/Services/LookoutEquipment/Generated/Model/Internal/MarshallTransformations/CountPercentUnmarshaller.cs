...
namespace Amazon.LookoutEquipment.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CountPercentUnmarshaller : IJsonUnmarshaller<CountPercent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CountPercent Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
