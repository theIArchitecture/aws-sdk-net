...
namespace Amazon.LookoutEquipment.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateInferenceSchedulerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateInferenceSchedulerResponse response = new CreateInferenceSchedulerResponse();
        ...
        private static CreateInferenceSchedulerResponseUnmarshaller _instance = new CreateInferenceSchedulerResponseUnmarshaller();        

        internal static CreateInferenceSchedulerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateInferenceSchedulerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
