...
namespace Amazon.LookoutEquipment.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateLabelGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLabelGroupResponse response = new CreateLabelGroupResponse();
        ...
        private static CreateLabelGroupResponseUnmarshaller _instance = new CreateLabelGroupResponseUnmarshaller();        

        internal static CreateLabelGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLabelGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
