...
namespace Amazon.LookoutEquipment.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateLabelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLabelResponse response = new CreateLabelResponse();
        ...
        private static CreateLabelResponseUnmarshaller _instance = new CreateLabelResponseUnmarshaller();        

        internal static CreateLabelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLabelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
