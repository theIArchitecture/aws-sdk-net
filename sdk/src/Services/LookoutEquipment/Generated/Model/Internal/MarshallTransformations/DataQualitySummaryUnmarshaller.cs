...
namespace Amazon.LookoutEquipment.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DataQualitySummaryUnmarshaller : IJsonUnmarshaller<DataQualitySummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DataQualitySummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
