...
namespace Amazon.LookoutEquipment.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ImportDatasetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ImportDatasetResponseUnmarshaller _instance = new ImportDatasetResponseUnmarshaller();        

        internal static ImportDatasetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImportDatasetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
