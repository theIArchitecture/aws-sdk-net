...
namespace Amazon.LookoutEquipment.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ImportModelVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ImportModelVersionResponse response = new ImportModelVersionResponse();
        ...
        private static ImportModelVersionResponseUnmarshaller _instance = new ImportModelVersionResponseUnmarshaller();        

        internal static ImportModelVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImportModelVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
