...
namespace Amazon.LookoutEquipment.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public class InferenceOutputConfigurationMarshaller : IRequestMarshaller<InferenceOutputConfiguration, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(InferenceOutputConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetS3OutputConfiguration())
            {
                ...
                var marshaller = InferenceS3OutputConfigurationMarshaller.Instance;
