...
namespace Amazon.LookoutEquipment.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IngestedFilesSummaryUnmarshaller : IJsonUnmarshaller<IngestedFilesSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IngestedFilesSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static IngestedFilesSummaryUnmarshaller _instance = new IngestedFilesSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static IngestedFilesSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
