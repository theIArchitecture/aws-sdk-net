...
namespace Amazon.LookoutEquipment.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InsufficientSensorDataUnmarshaller : IJsonUnmarshaller<InsufficientSensorData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InsufficientSensorData Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
