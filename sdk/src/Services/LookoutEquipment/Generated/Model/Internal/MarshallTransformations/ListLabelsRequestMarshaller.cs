...
namespace Amazon.LookoutEquipment.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListLabelsRequestMarshaller : IMarshaller<IRequest, ListLabelsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListLabelsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListLabelsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.LookoutEquipment");
            string target = "AWSLookoutEquipmentFrontendService.ListLabels";
        ...
        private static ListLabelsRequestMarshaller _instance = new ListLabelsRequestMarshaller();        

        internal static ListLabelsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLabelsRequestMarshaller Instance
        {
            get
            {
                return _instance;
