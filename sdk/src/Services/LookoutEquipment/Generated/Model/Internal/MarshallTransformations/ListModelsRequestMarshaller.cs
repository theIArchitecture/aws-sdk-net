...
namespace Amazon.LookoutEquipment.Model.Internal.MarshallTransformations
{
    ...
    public class ListModelsRequestMarshaller : IMarshaller<IRequest, ListModelsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListModelsRequest publicRequest)
        {
            ...
            string target = "AWSLookoutEquipmentFrontendService.ListModels";
            ...
            if(publicRequest.IsSetDatasetNameBeginsWith())
            {
                context.Writer.WritePropertyName("DatasetNameBeginsWith");
                context.Writer.WriteStringValue(publicRequest.DatasetNameBeginsWith);
            }
