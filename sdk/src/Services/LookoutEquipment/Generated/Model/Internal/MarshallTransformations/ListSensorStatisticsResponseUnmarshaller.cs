...
namespace Amazon.LookoutEquipment.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListSensorStatisticsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSensorStatisticsResponse response = new ListSensorStatisticsResponse();
        ...
        private static ListSensorStatisticsResponseUnmarshaller _instance = new ListSensorStatisticsResponseUnmarshaller();        

        internal static ListSensorStatisticsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSensorStatisticsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
