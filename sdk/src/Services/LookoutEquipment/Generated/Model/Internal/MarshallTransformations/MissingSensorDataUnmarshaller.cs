...
namespace Amazon.LookoutEquipment.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MissingSensorDataUnmarshaller : IJsonUnmarshaller<MissingSensorData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MissingSensorData Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.TotalNumberOfMissingValues = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
