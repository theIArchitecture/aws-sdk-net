...
namespace Amazon.LookoutEquipment.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartDataIngestionJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartDataIngestionJobResponse response = new StartDataIngestionJobResponse();
        ...
        private static StartDataIngestionJobResponseUnmarshaller _instance = new StartDataIngestionJobResponseUnmarshaller();        

        internal static StartDataIngestionJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartDataIngestionJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
