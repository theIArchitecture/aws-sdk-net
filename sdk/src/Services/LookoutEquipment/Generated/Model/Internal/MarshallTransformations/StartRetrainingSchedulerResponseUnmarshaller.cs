...
namespace Amazon.LookoutEquipment.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartRetrainingSchedulerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartRetrainingSchedulerResponse response = new StartRetrainingSchedulerResponse();
        ...
        private static StartRetrainingSchedulerResponseUnmarshaller _instance = new StartRetrainingSchedulerResponseUnmarshaller();        

        internal static StartRetrainingSchedulerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartRetrainingSchedulerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
