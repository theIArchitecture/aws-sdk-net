...
namespace Amazon.LookoutEquipment.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StopRetrainingSchedulerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopRetrainingSchedulerResponse response = new StopRetrainingSchedulerResponse();
        ...
        private static StopRetrainingSchedulerResponseUnmarshaller _instance = new StopRetrainingSchedulerResponseUnmarshaller();        

        internal static StopRetrainingSchedulerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopRetrainingSchedulerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
