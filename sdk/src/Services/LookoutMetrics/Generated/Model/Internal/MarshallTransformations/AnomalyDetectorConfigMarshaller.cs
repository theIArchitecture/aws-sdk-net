...
namespace Amazon.LookoutMetrics.Model.Internal.MarshallTransformations
{
    ...
    public class AnomalyDetectorConfigMarshaller : IRequestMarshaller<AnomalyDetectorConfig, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(AnomalyDetectorConfig requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetAnomalyDetectorFrequency())
            {
                context.Writer.WritePropertyName("AnomalyDetectorFrequency");
                context.Writer.WriteStringValue(requestObject.AnomalyDetectorFrequency);
            }
