...
namespace Amazon.LookoutMetrics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AthenaSourceConfigUnmarshaller : IJsonUnmarshaller<AthenaSourceConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AthenaSourceConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DataCatalog = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.S3ResultsPath = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
