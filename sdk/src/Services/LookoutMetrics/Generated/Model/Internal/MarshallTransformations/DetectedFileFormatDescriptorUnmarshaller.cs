...
namespace Amazon.LookoutMetrics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DetectedFileFormatDescriptorUnmarshaller : IJsonUnmarshaller<DetectedFileFormatDescriptor, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DetectedFileFormatDescriptor Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
