...
namespace Amazon.LookoutMetrics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DetectedJsonFormatDescriptorUnmarshaller : IJsonUnmarshaller<DetectedJsonFormatDescriptor, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DetectedJsonFormatDescriptor Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
