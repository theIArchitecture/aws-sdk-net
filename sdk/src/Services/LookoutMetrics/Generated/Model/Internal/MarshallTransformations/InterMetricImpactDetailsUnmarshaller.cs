...
namespace Amazon.LookoutMetrics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InterMetricImpactDetailsUnmarshaller : IJsonUnmarshaller<InterMetricImpactDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InterMetricImpactDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ContributionPercentage", targetDepth))
                {
                    ...
                    unmarshalledObject.ContributionPercentage = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
