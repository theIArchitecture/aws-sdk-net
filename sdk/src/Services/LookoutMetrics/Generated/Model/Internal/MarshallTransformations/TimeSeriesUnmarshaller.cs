...
namespace Amazon.LookoutMetrics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TimeSeriesUnmarshaller : IJsonUnmarshaller<TimeSeries, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TimeSeries Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DimensionNameValue, DimensionNameValueUnmarshaller>(DimensionNameValueUnmarshaller.Instance);
                    unmarshalledObject.DimensionList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("MetricValueList", targetDepth))
                {
                    ...
                    unmarshalledObject.MetricValueList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
