...
{
    /// <summary>
    /// UpdateAnomalyDetector Request Marshaller
    /// </summary>       
    public class UpdateAnomalyDetectorRequestMarshaller : IMarshaller<IRequest, UpdateAnomalyDetectorRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateAnomalyDetectorRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateAnomalyDetectorRequest publicRequest)
        {
        ...
        private static UpdateAnomalyDetectorRequestMarshaller _instance = new UpdateAnomalyDetectorRequestMarshaller();        

        internal static UpdateAnomalyDetectorRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAnomalyDetectorRequestMarshaller Instance
        {
            get
            {
                return _instance;
