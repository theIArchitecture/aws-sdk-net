...
{
    /// <summary>
    /// Container for the parameters to the ListAnomalyGroupSummaries operation.
    /// Returns a list of anomaly groups.
    /// </summary>
    public partial class ListAnomalyGroupSummariesRequest : AmazonLookoutMetricsRequest
    {
        private string _anomalyDetectorArn;
        private int? _maxResults;
        private string _nextToken;
        private int? _sensitivityThreshold;
        ...
        /// <summary>
        /// Gets and sets the property SensitivityThreshold. 
        /// <para>
        ...
        // Check to see if SensitivityThreshold property is set
        internal bool IsSetSensitivityThreshold()
        {
            return this._sensitivityThreshold.HasValue; 
        }
