...
{
    /// <summary>
    /// This is the response object from the ListAnomalyGroupSummaries operation.
    /// </summary>
    public partial class ListAnomalyGroupSummariesResponse : AmazonWebServiceResponse
    {
        ...
        /// <summary>
        /// Gets and sets the property AnomalyGroupStatistics. 
        /// <para>
        ...
        {
            get { return this._anomalyGroupStatistics; }
            set { this._anomalyGroupStatistics = value; }
        }

        // Check to see if AnomalyGroupStatistics property is set
        internal bool IsSetAnomalyGroupStatistics()
        {
            return this._anomalyGroupStatistics != null;
        }

        /// <summary>
        /// Gets and sets the property AnomalyGroupSummaryList. 
        /// <para>
        ...
        /// </summary>
        public List<AnomalyGroupSummary> AnomalyGroupSummaryList
        {
            get { return this._anomalyGroupSummaryList; }
            set { this._anomalyGroupSummaryList = value; }
        }
