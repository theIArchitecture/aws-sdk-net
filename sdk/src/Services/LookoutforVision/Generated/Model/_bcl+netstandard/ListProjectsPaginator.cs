...
namespace Amazon.LookoutforVision.Model
{
    ...
    internal sealed partial class ListProjectsPaginator : IPaginator<ListProjectsResponse>, IListProjectsPaginator
    {
        ...
        public IPaginatedEnumerable<ProjectMetadata> Projects => 
            new PaginatedResultKeyResponse<ListProjectsResponse, ProjectMetadata>(this, (i) => i.Projects ?? new List<ProjectMetadata>());
        ...
        async IAsyncEnumerable<ListProjectsResponse> IPaginator<ListProjectsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
