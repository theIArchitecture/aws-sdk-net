...
namespace Amazon.LookoutforVision
{
    ...
    public partial interface IAmazonLookoutforVision : IAmazonService, IDisposable
    {
        ...
        Task<DescribeModelPackagingJobResponse> DescribeModelPackagingJobAsync(DescribeModelPackagingJobRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListModelPackagingJobsResponse> ListModelPackagingJobsAsync(ListModelPackagingJobsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StartModelPackagingJobResponse> StartModelPackagingJobAsync(StartModelPackagingJobRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonLookoutforVisionConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonLookoutforVisionConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonLookoutforVisionConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonLookoutforVisionConfig to create AmazonLookoutforVisionClient");
            }

            return awsCredentials == null ? 
                    new AmazonLookoutforVisionClient(serviceClientConfig) :
                    new AmazonLookoutforVisionClient(awsCredentials, serviceClientConfig);
        }
