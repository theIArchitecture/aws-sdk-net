...
namespace Amazon.MPA.Internal
{
    ...
    public class AmazonMPAAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonMPAAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for MPA.
        /// </summary>
        public AmazonMPAAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonMPAAuthSchemeParameters
            {
    ...
    public class AmazonMPAAuthSchemeResolver : IAuthSchemeResolver<AmazonMPAAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonMPAAuthSchemeParameters authParameters)
        {
