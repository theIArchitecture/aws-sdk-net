...
namespace Amazon.MPA.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateApprovalTeamRequestMarshaller : IMarshaller<IRequest, CreateApprovalTeamRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static CreateApprovalTeamRequestMarshaller _instance = new CreateApprovalTeamRequestMarshaller();        

        internal static CreateApprovalTeamRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateApprovalTeamRequestMarshaller Instance
        {
            get
            {
                return _instance;
