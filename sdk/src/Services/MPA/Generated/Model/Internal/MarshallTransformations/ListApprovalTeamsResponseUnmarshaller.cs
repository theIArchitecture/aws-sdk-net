...
{
    /// <summary>
    /// Response Unmarshaller for ListApprovalTeams operation
    /// </summary>  
    public class ListApprovalTeamsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListApprovalTeamsResponse response = new ListApprovalTeamsResponse();
        ...
        private static ListApprovalTeamsResponseUnmarshaller _instance = new ListApprovalTeamsResponseUnmarshaller();        

        internal static ListApprovalTeamsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListApprovalTeamsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
