    ...
    public class ListSessionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ListSessionsResponseSession, ListSessionsResponseSessionUnmarshaller>(ListSessionsResponseSessionUnmarshaller.Instance);
