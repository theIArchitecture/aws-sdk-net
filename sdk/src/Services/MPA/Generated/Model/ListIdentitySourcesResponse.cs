...
namespace Amazon.MPA.Model
{
    ...
    {
        private List<IdentitySourceForList> _identitySources = AWSConfigs.InitializeCollections ? new List<IdentitySourceForList>() : null;
        private string _nextToken;

        /// <summary>
        /// Gets and sets the property IdentitySources. 
        /// <para>
        /// A <c>IdentitySources</c>. Contains details for identity sources.
        /// </para>
        /// <para />
        ...
        public List<IdentitySourceForList> IdentitySources
        {
