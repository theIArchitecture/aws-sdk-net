...
namespace Amazon.MQ.Internal
{
    ...
    public class AmazonMQAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonMQAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for MQ.
        /// </summary>
        public AmazonMQAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonMQAuthSchemeParameters
            {
    ...
    public class AmazonMQAuthSchemeResolver : IAuthSchemeResolver<AmazonMQAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonMQAuthSchemeParameters authParameters)
        {
