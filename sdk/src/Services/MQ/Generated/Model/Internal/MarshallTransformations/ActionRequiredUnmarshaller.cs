...
namespace Amazon.MQ.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ActionRequiredUnmarshaller : IJsonUnmarshaller<ActionRequired, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ActionRequired Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
