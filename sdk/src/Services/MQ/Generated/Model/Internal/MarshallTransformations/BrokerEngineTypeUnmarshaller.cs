...
namespace Amazon.MQ.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BrokerEngineTypeUnmarshaller : IJsonUnmarshaller<BrokerEngineType, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BrokerEngineType Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
