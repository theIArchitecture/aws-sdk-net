...
namespace Amazon.MQ.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DataReplicationCounterpartUnmarshaller : IJsonUnmarshaller<DataReplicationCounterpart, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DataReplicationCounterpart Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
