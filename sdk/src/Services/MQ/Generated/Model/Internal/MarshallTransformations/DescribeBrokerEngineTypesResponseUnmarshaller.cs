    ...
    public class DescribeBrokerEngineTypesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BrokerEngineType, BrokerEngineTypeUnmarshaller>(BrokerEngineTypeUnmarshaller.Instance);
                    response.BrokerEngineTypes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
