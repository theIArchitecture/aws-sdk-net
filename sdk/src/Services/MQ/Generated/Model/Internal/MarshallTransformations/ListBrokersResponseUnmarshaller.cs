    ...
    public class ListBrokersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BrokerSummary, BrokerSummaryUnmarshaller>(BrokerSummaryUnmarshaller.Instance);
                    response.BrokerSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
