...
namespace Amazon.MQ.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SanitizationWarningUnmarshaller : IJsonUnmarshaller<SanitizationWarning, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SanitizationWarning Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ElementName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
