...
namespace Amazon.MQ.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class WeeklyStartTimeUnmarshaller : IJsonUnmarshaller<WeeklyStartTime, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public WeeklyStartTime Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
