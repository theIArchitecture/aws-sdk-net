    ...
    public class ApproveAssignmentRequestMarshaller : IMarshaller<IRequest, ApproveAssignmentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ApproveAssignmentRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetAssignmentId())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.AssignmentId);
            }

            if(publicRequest.IsSetOverrideRejection())
            {
                context.Writer.WritePropertyName("OverrideRejection");
                context.Writer.WriteBooleanValue(publicRequest.OverrideRejection.Value);
            }

            if(publicRequest.IsSetRequesterFeedback())
            {
                context.Writer.WritePropertyName("RequesterFeedback");
                context.Writer.WriteStringValue(publicRequest.RequesterFeedback);
            }
