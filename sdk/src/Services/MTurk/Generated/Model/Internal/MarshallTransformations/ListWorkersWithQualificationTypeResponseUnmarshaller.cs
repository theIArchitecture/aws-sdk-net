    ...
    public class ListWorkersWithQualificationTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<Qualification, QualificationUnmarshaller>(QualificationUnmarshaller.Instance);
                    response.Qualifications = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
