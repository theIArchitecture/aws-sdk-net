...
namespace Amazon.MTurk.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PolicyParameterUnmarshaller : IJsonUnmarshaller<PolicyParameter, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PolicyParameter Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ParameterMapEntry, ParameterMapEntryUnmarshaller>(ParameterMapEntryUnmarshaller.Instance);
                    unmarshalledObject.MapEntries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
