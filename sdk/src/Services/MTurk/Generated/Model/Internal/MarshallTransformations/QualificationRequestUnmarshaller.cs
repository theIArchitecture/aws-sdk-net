...
namespace Amazon.MTurk.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class QualificationRequestUnmarshaller : IJsonUnmarshaller<QualificationRequest, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public QualificationRequest Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.QualificationRequestId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
