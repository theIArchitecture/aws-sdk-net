...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonMTurkConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonMTurkConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonMTurkConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonMTurkConfig to create AmazonMTurkClient");
            }

            return awsCredentials == null ? 
                    new AmazonMTurkClient(serviceClientConfig) :
                    new AmazonMTurkClient(awsCredentials, serviceClientConfig);
        }
