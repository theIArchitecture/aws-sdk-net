...
namespace Amazon.MWAA.Model
{
    ...
    public partial class RestApiServerException : AmazonMWAAException
    {
        ...
        public RestApiServerException(string message, Exception innerException) 
        ...
        /// </summary>
        /// <param name="innerException"></param>
        public RestApiServerException(Exception innerException) 
            : base(innerException) {}
        ...
        public RestApiServerException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public RestApiServerException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
