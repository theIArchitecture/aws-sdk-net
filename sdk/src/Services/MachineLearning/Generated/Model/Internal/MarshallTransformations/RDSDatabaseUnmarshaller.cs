...
namespace Amazon.MachineLearning.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RDSDatabaseUnmarshaller : IJsonUnmarshaller<RDSDatabase, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RDSDatabase Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
