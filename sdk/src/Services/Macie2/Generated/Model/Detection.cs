...
namespace Amazon.Macie2.Model
{
    ...
    /// S3 bucket while performing automated sensitive data discovery for an account. The
    /// information also specifies the custom or managed data identifier that detected the
    /// data. This information is available only if automated sensitive data discovery has
