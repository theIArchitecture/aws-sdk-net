...
namespace Amazon.Macie2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BucketCountPolicyAllowsUnencryptedObjectUploadsUnmarshaller : IJsonUnmarshaller<BucketCountPolicyAllowsUnencryptedObjectUploads, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BucketCountPolicyAllowsUnencryptedObjectUploads Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
                    unmarshalledObject.DeniesUnencryptedObjectUploads = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
