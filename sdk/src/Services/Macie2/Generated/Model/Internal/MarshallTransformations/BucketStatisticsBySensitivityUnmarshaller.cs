...
namespace Amazon.Macie2.Model.Internal.MarshallTransformations
{
    ...
    public class BucketStatisticsBySensitivityUnmarshaller : IJsonUnmarshaller<BucketStatisticsBySensitivity, JsonUnmarshallerContext>
    {
        ...
        private static BucketStatisticsBySensitivityUnmarshaller _instance = new BucketStatisticsBySensitivityUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BucketStatisticsBySensitivityUnmarshaller Instance
        {
            get
            {
                return _instance;
