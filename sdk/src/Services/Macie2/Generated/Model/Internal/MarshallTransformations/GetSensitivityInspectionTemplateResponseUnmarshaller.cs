...
{
    /// <summary>
    /// Response Unmarshaller for GetSensitivityInspectionTemplate operation
    /// </summary>  
    public class GetSensitivityInspectionTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSensitivityInspectionTemplateResponse response = new GetSensitivityInspectionTemplateResponse();
        ...
        private static GetSensitivityInspectionTemplateResponseUnmarshaller _instance = new GetSensitivityInspectionTemplateResponseUnmarshaller();        

        internal static GetSensitivityInspectionTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSensitivityInspectionTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
