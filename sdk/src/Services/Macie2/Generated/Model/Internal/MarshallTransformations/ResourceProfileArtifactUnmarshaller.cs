...
namespace Amazon.Macie2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResourceProfileArtifactUnmarshaller : IJsonUnmarshaller<ResourceProfileArtifact, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResourceProfileArtifact Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ClassificationResultStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
