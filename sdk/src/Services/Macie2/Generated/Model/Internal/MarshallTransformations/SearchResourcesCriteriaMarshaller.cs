...
namespace Amazon.Macie2.Model.Internal.MarshallTransformations
{
    ...
    public class SearchResourcesCriteriaMarshaller : IRequestMarshaller<SearchResourcesCriteria, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(SearchResourcesCriteria requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetSimpleCriterion())
            {
                ...
                var marshaller = SearchResourcesSimpleCriterionMarshaller.Instance;
            ...
            if(requestObject.IsSetTagCriterion())
            {
                ...
                var marshaller = SearchResourcesTagCriterionMarshaller.Instance;
