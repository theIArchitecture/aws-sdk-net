...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRevealConfiguration operation
    /// </summary>  
    public class UpdateRevealConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateRevealConfigurationResponse response = new UpdateRevealConfigurationResponse();
        ...
        private static UpdateRevealConfigurationResponseUnmarshaller _instance = new UpdateRevealConfigurationResponseUnmarshaller();        

        internal static UpdateRevealConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRevealConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
