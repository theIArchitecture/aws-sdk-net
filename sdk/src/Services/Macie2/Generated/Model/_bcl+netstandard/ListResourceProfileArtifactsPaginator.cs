...
namespace Amazon.Macie2.Model
{
    ...
    internal sealed partial class ListResourceProfileArtifactsPaginator : IPaginator<ListResourceProfileArtifactsResponse>, IListResourceProfileArtifactsPaginator
    {
        ...
        async IAsyncEnumerable<ListResourceProfileArtifactsResponse> IPaginator<ListResourceProfileArtifactsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
