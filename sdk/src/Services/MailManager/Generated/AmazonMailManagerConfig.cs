...
namespace Amazon.MailManager
{
    ...
    public partial class AmazonMailManagerConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("MailManager", "4.0.2.11");
        ...
        /// Default constructor
        /// </summary>
        public AmazonMailManagerConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonMailManagerDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "MailManager";
            this.AuthenticationServiceName = "ses";
            this.EndpointProvider = new AmazonMailManagerEndpointProvider();
        }
