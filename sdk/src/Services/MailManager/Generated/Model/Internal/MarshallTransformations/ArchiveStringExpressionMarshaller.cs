...
{
    /// <summary>
    /// ArchiveStringExpression Marshaller
    /// </summary>
    public class ArchiveStringExpressionMarshaller : IRequestMarshaller<ArchiveStringExpression, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(ArchiveStringExpression requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetEvaluate())
            {
                ...
                var marshaller = ArchiveStringToEvaluateMarshaller.Instance;
        ...
        /// </summary>
        public readonly static ArchiveStringExpressionMarshaller Instance = new ArchiveStringExpressionMarshaller();
