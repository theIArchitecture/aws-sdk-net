...
{
    /// <summary>
    /// Response Unmarshaller for CreateRelay operation
    /// </summary>  
    public class CreateRelayResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRelayResponse response = new CreateRelayResponse();
        ...
        private static CreateRelayResponseUnmarshaller _instance = new CreateRelayResponseUnmarshaller();        

        internal static CreateRelayResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRelayResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
