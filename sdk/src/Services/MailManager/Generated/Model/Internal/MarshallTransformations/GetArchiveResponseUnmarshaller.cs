...
{
    /// <summary>
    /// Response Unmarshaller for GetArchive operation
    /// </summary>  
    public class GetArchiveResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ArchiveState = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = ArchiveRetentionUnmarshaller.Instance;
                    response.Retention = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetArchiveResponseUnmarshaller _instance = new GetArchiveResponseUnmarshaller();        

        internal static GetArchiveResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetArchiveResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
