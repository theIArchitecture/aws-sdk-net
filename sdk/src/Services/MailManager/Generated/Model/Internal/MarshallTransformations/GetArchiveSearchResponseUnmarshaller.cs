...
{
    /// <summary>
    /// Response Unmarshaller for GetArchiveSearch operation
    /// </summary>  
    public class GetArchiveSearchResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetArchiveSearchResponse response = new GetArchiveSearchResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Filters", targetDepth))
                {
                    ...
                    response.Filters = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("FromTimestamp", targetDepth))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    response.FromTimestamp = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    response.ToTimestamp = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetArchiveSearchResponseUnmarshaller _instance = new GetArchiveSearchResponseUnmarshaller();        

        internal static GetArchiveSearchResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetArchiveSearchResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
