...
{
    /// <summary>
    /// IngressStringExpression Marshaller
    /// </summary>
    public class IngressStringExpressionMarshaller : IRequestMarshaller<IngressStringExpression, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(IngressStringExpression requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetEvaluate())
            {
                ...
                var marshaller = IngressStringToEvaluateMarshaller.Instance;
        ...
        /// </summary>
        public readonly static IngressStringExpressionMarshaller Instance = new IngressStringExpressionMarshaller();
