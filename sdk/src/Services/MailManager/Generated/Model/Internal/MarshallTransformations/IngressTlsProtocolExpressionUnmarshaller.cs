...
namespace Amazon.MailManager.Model.Internal.MarshallTransformations
{
    ...
    public class IngressTlsProtocolExpressionUnmarshaller : IJsonUnmarshaller<IngressTlsProtocolExpression, JsonUnmarshallerContext>
    {
        ...
        private static IngressTlsProtocolExpressionUnmarshaller _instance = new IngressTlsProtocolExpressionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static IngressTlsProtocolExpressionUnmarshaller Instance
        {
            get
            {
                return _instance;
