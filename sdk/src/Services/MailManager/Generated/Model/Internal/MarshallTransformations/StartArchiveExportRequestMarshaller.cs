...
{
    /// <summary>
    /// StartArchiveExport Request Marshaller
    /// </summary>       
    public class StartArchiveExportRequestMarshaller : IMarshaller<IRequest, StartArchiveExportRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartArchiveExportRequest)input);
        }
        ...
        internal static StartArchiveExportRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartArchiveExportRequestMarshaller Instance
        {
            get
            {
                return _instance;
