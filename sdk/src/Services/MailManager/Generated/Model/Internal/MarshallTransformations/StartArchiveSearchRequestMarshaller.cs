...
{
    /// <summary>
    /// StartArchiveSearch Request Marshaller
    /// </summary>       
    public class StartArchiveSearchRequestMarshaller : IMarshaller<IRequest, StartArchiveSearchRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartArchiveSearchRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartArchiveSearchRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.MailManager");
            string target = "MailManagerSvc.StartArchiveSearch";
        ...
        private static StartArchiveSearchRequestMarshaller _instance = new StartArchiveSearchRequestMarshaller();        

        internal static StartArchiveSearchRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartArchiveSearchRequestMarshaller Instance
        {
            get
            {
                return _instance;
