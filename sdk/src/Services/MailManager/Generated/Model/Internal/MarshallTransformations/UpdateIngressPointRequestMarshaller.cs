...
{
    /// <summary>
    /// UpdateIngressPoint Request Marshaller
    /// </summary>       
    public class UpdateIngressPointRequestMarshaller : IMarshaller<IRequest, UpdateIngressPointRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateIngressPointRequest)input);
        }
        ...
        internal static UpdateIngressPointRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateIngressPointRequestMarshaller Instance
        {
            get
            {
                return _instance;
