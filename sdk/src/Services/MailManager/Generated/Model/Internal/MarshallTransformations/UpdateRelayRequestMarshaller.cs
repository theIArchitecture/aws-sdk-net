...
{
    /// <summary>
    /// UpdateRelay Request Marshaller
    /// </summary>       
    public class UpdateRelayRequestMarshaller : IMarshaller<IRequest, UpdateRelayRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateRelayRequest)input);
        }
        ...
        internal static UpdateRelayRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRelayRequestMarshaller Instance
        {
            get
            {
                return _instance;
