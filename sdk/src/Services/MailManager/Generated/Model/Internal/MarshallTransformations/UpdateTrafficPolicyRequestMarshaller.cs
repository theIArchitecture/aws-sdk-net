...
{
    /// <summary>
    /// UpdateTrafficPolicy Request Marshaller
    /// </summary>       
    public class UpdateTrafficPolicyRequestMarshaller : IMarshaller<IRequest, UpdateTrafficPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateTrafficPolicyRequest)input);
        }
        ...
        internal static UpdateTrafficPolicyRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTrafficPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
