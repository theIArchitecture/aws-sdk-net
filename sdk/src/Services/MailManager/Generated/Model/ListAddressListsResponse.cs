...
{
    /// <summary>
    /// This is the response object from the ListAddressLists operation.
    /// </summary>
    public partial class ListAddressListsResponse : AmazonWebServiceResponse
    {
        private List<AddressList> _addressLists = AWSConfigs.InitializeCollections ? new List<AddressList>() : null;
