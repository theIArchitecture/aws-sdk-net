...
namespace Amazon.MailManager.Model
{
    ...
    {
        private AcceptAction _action;
        private List<PolicyCondition> _conditions = AWSConfigs.InitializeCollections ? new List<PolicyCondition>() : null;
