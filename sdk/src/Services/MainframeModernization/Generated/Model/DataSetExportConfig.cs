...
{
    /// <summary>
    /// Identifies one or more data sets you want to import with the <a>CreateDataSetExportTask</a>
    /// operation.
    /// </summary>
    public partial class DataSetExportConfig
    {
        private List<DataSetExportItem> _dataSets = AWSConfigs.InitializeCollections ? new List<DataSetExportItem>() : null;
        ...
        public List<DataSetExportItem> DataSets
        {
