...
{
    /// <summary>
    /// CancelBatchJobExecution Request Marshaller
    /// </summary>       
    public class CancelBatchJobExecutionRequestMarshaller : IMarshaller<IRequest, CancelBatchJobExecutionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CancelBatchJobExecutionRequest)input);
        }
        ...
        private static CancelBatchJobExecutionRequestMarshaller _instance = new CancelBatchJobExecutionRequestMarshaller();        

        internal static CancelBatchJobExecutionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelBatchJobExecutionRequestMarshaller Instance
        {
            get
            {
                return _instance;
