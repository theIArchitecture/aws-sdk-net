...
{
    /// <summary>
    /// Response Unmarshaller for GetDataSetExportTask operation
    /// </summary>  
    public class GetDataSetExportTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDataSetExportTaskResponse response = new GetDataSetExportTaskResponse();
        ...
        private static GetDataSetExportTaskResponseUnmarshaller _instance = new GetDataSetExportTaskResponseUnmarshaller();        

        internal static GetDataSetExportTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDataSetExportTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
