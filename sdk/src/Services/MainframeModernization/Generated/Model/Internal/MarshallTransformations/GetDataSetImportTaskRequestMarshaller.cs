...
namespace Amazon.MainframeModernization.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetDataSetImportTaskRequestMarshaller : IMarshaller<IRequest, GetDataSetImportTaskRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetDataSetImportTaskRequestMarshaller _instance = new GetDataSetImportTaskRequestMarshaller();        

        internal static GetDataSetImportTaskRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDataSetImportTaskRequestMarshaller Instance
        {
            get
            {
                return _instance;
