...
namespace Amazon.MainframeModernization.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListBatchJobRestartPointsRequestMarshaller : IMarshaller<IRequest, ListBatchJobRestartPointsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListBatchJobRestartPointsRequestMarshaller _instance = new ListBatchJobRestartPointsRequestMarshaller();        

        internal static ListBatchJobRestartPointsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListBatchJobRestartPointsRequestMarshaller Instance
        {
            get
            {
                return _instance;
