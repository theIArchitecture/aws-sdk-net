...
{
    /// <summary>
    /// Response Unmarshaller for CreateAccessor operation
    /// </summary>  
    public class CreateAccessorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAccessorResponse response = new CreateAccessorResponse();
        ...
        private static CreateAccessorResponseUnmarshaller _instance = new CreateAccessorResponseUnmarshaller();        

        internal static CreateAccessorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAccessorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
