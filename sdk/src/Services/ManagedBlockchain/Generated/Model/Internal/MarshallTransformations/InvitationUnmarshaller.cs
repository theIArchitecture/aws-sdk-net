...
namespace Amazon.ManagedBlockchain.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InvitationUnmarshaller : IJsonUnmarshaller<Invitation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Invitation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("NetworkSummary", targetDepth))
                {
                    ...
                    unmarshalledObject.NetworkSummary = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
