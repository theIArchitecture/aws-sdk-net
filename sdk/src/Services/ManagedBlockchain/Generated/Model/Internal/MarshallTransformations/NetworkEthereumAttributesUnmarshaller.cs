...
namespace Amazon.ManagedBlockchain.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NetworkEthereumAttributesUnmarshaller : IJsonUnmarshaller<NetworkEthereumAttributes, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NetworkEthereumAttributes Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ChainId", targetDepth))
                {
                    ...
                    unmarshalledObject.ChainId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
