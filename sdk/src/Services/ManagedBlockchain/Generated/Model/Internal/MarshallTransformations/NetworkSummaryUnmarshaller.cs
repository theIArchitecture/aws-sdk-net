...
namespace Amazon.ManagedBlockchain.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NetworkSummaryUnmarshaller : IJsonUnmarshaller<NetworkSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NetworkSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
