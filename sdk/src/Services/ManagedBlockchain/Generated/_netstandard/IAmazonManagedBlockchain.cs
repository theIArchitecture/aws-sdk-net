...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonManagedBlockchainConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonManagedBlockchainConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonManagedBlockchainConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonManagedBlockchainConfig to create AmazonManagedBlockchainClient");
            }

            return awsCredentials == null ? 
                    new AmazonManagedBlockchainClient(serviceClientConfig) :
                    new AmazonManagedBlockchainClient(awsCredentials, serviceClientConfig);
        }
