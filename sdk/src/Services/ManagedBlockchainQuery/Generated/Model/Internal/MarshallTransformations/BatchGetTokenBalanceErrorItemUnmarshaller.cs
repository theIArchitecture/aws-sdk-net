...
namespace Amazon.ManagedBlockchainQuery.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchGetTokenBalanceErrorItemUnmarshaller : IJsonUnmarshaller<BatchGetTokenBalanceErrorItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchGetTokenBalanceErrorItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
