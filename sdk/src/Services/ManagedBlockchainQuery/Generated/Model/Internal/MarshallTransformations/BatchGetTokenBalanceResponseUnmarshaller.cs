...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetTokenBalance operation
    /// </summary>  
    public class BatchGetTokenBalanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchGetTokenBalanceResponse response = new BatchGetTokenBalanceResponse();
        ...
        private static BatchGetTokenBalanceResponseUnmarshaller _instance = new BatchGetTokenBalanceResponseUnmarshaller();        

        internal static BatchGetTokenBalanceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetTokenBalanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
