...
namespace Amazon.ManagedBlockchainQuery.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ContractMetadataUnmarshaller : IJsonUnmarshaller<ContractMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ContractMetadata Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("decimals", targetDepth))
                {
                    ...
                    unmarshalledObject.Decimals = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
