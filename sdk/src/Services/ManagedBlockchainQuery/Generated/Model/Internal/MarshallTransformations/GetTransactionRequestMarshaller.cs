...
{
    /// <summary>
    /// GetTransaction Request Marshaller
    /// </summary>       
    public class GetTransactionRequestMarshaller : IMarshaller<IRequest, GetTransactionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetTransactionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetTransactionRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetTransactionHash())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.TransactionHash);
            }
        ...
        private static GetTransactionRequestMarshaller _instance = new GetTransactionRequestMarshaller();        

        internal static GetTransactionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTransactionRequestMarshaller Instance
        {
            get
            {
                return _instance;
