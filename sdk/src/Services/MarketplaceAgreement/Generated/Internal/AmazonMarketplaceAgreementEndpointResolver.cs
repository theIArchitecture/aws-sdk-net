...
namespace Amazon.MarketplaceAgreement.Internal
{
    ...
    /// </summary>
    public class AmazonMarketplaceAgreementEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonMarketplaceAgreementConfig)requestContext.ClientConfig;
            var result = new MarketplaceAgreementEndpointParameters();
