...
namespace Amazon.MarketplaceAgreement.Model.Internal.MarshallTransformations
{
    ...
    public class ConfigurableUpfrontPricingTermUnmarshaller : IJsonUnmarshaller<ConfigurableUpfrontPricingTerm, JsonUnmarshallerContext>
    {
        ...
        private static ConfigurableUpfrontPricingTermUnmarshaller _instance = new ConfigurableUpfrontPricingTermUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ConfigurableUpfrontPricingTermUnmarshaller Instance
        {
            get
            {
                return _instance;
