...
namespace Amazon.MarketplaceAgreement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RateCardItemUnmarshaller : IJsonUnmarshaller<RateCardItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RateCardItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static RateCardItemUnmarshaller _instance = new RateCardItemUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RateCardItemUnmarshaller Instance
        {
            get
            {
                return _instance;
