...
namespace Amazon.MarketplaceAgreement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RenewalTermConfigurationUnmarshaller : IJsonUnmarshaller<RenewalTermConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RenewalTermConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
