...
namespace Amazon.MarketplaceAgreement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UsageBasedRateCardItemUnmarshaller : IJsonUnmarshaller<UsageBasedRateCardItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public UsageBasedRateCardItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
