...
{
    /// <summary>
    /// AmiProductFilters Marshaller
    /// </summary>
    public class AmiProductFiltersMarshaller : IRequestMarshaller<AmiProductFilters, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(AmiProductFilters requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetEntityId())
            {
                ...
                var marshaller = AmiProductEntityIdFilterMarshaller.Instance;
            ...
            if(requestObject.IsSetLastModifiedDate())
            {
                ...
                var marshaller = AmiProductLastModifiedDateFilterMarshaller.Instance;
            ...
            if(requestObject.IsSetProductTitle())
            {
                ...
                var marshaller = AmiProductTitleFilterMarshaller.Instance;
            ...
            if(requestObject.IsSetVisibility())
            {
                ...
                var marshaller = AmiProductVisibilityFilterMarshaller.Instance;
        ...
        /// </summary>
        public readonly static AmiProductFiltersMarshaller Instance = new AmiProductFiltersMarshaller();
