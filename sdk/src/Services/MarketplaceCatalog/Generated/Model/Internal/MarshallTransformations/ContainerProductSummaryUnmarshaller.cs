...
namespace Amazon.MarketplaceCatalog.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ContainerProductSummaryUnmarshaller : IJsonUnmarshaller<ContainerProductSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ContainerProductSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
