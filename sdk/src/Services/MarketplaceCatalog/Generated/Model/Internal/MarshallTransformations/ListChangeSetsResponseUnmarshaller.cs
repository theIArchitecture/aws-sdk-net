    ...
    public class ListChangeSetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ChangeSetSummaryListItem, ChangeSetSummaryListItemUnmarshaller>(ChangeSetSummaryListItemUnmarshaller.Instance);
                    response.ChangeSetSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
