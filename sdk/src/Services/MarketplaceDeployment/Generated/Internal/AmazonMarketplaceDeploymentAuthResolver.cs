...
namespace Amazon.MarketplaceDeployment.Internal
{
    ...
    public class AmazonMarketplaceDeploymentAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonMarketplaceDeploymentAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for MarketplaceDeployment.
        /// </summary>
        public AmazonMarketplaceDeploymentAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonMarketplaceDeploymentAuthSchemeParameters
            {
    ...
    public class AmazonMarketplaceDeploymentAuthSchemeResolver : IAuthSchemeResolver<AmazonMarketplaceDeploymentAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonMarketplaceDeploymentAuthSchemeParameters authParameters)
        {
