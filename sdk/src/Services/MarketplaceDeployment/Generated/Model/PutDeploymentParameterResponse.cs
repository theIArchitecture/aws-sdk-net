...
namespace Amazon.MarketplaceDeployment.Model
{
    ...
    public partial class PutDeploymentParameterResponse : AmazonWebServiceResponse
    {
        ...
        public string DeploymentParameterId
        {
            get { return this._deploymentParameterId; }
            set { this._deploymentParameterId = value; }
        }

        // Check to see if DeploymentParameterId property is set
        internal bool IsSetDeploymentParameterId()
        {
            return this._deploymentParameterId != null;
        }
