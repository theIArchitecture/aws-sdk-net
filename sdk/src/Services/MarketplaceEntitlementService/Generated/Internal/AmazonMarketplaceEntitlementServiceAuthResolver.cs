...
namespace Amazon.MarketplaceEntitlementService.Internal
{
    ...
    public class AmazonMarketplaceEntitlementServiceAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonMarketplaceEntitlementServiceAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for MarketplaceEntitlementService.
        /// </summary>
        public AmazonMarketplaceEntitlementServiceAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonMarketplaceEntitlementServiceAuthSchemeParameters
            {
    ...
    public class AmazonMarketplaceEntitlementServiceAuthSchemeResolver : IAuthSchemeResolver<AmazonMarketplaceEntitlementServiceAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonMarketplaceEntitlementServiceAuthSchemeParameters authParameters)
        {
