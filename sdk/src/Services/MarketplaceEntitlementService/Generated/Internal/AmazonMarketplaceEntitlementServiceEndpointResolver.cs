...
{
    /// <summary>
    /// Amazon MarketplaceEntitlementService endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for MarketplaceEntitlementService service requests.
    /// Collects values for MarketplaceEntitlementServiceEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses MarketplaceEntitlementServiceEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonMarketplaceEntitlementServiceEndpointResolver : BaseEndpointResolver
    {
