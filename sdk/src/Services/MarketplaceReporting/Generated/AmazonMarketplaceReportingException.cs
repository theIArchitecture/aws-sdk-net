...
namespace Amazon.MarketplaceReporting
{
    ...
    public partial class AmazonMarketplaceReportingException : AmazonServiceException
    {
        ...
        public AmazonMarketplaceReportingException(string message, Exception innerException)
        ...
        /// </summary>
        /// <param name="innerException"></param>
        public AmazonMarketplaceReportingException(Exception innerException)
        ...
        public AmazonMarketplaceReportingException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonMarketplaceReportingException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
