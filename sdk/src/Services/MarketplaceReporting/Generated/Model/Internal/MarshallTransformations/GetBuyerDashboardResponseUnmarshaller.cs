...
namespace Amazon.MarketplaceReporting.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetBuyerDashboardResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        internal static GetBuyerDashboardResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBuyerDashboardResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
