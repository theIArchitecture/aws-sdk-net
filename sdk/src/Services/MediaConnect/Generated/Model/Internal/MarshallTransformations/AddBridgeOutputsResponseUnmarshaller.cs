...
{
    /// <summary>
    /// Response Unmarshaller for AddBridgeOutputs operation
    /// </summary>  
    public class AddBridgeOutputsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AddBridgeOutputsResponse response = new AddBridgeOutputsResponse();
        ...
        private static AddBridgeOutputsResponseUnmarshaller _instance = new AddBridgeOutputsResponseUnmarshaller();        

        internal static AddBridgeOutputsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddBridgeOutputsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
