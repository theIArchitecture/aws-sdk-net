...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AddBridgeSourcesRequestMarshaller : IMarshaller<IRequest, AddBridgeSourcesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static AddBridgeSourcesRequestMarshaller _instance = new AddBridgeSourcesRequestMarshaller();        

        internal static AddBridgeSourcesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddBridgeSourcesRequestMarshaller Instance
        {
            get
            {
                return _instance;
