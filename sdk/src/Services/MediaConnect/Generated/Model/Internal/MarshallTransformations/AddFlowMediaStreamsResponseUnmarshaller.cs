...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AddFlowMediaStreamsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AddFlowMediaStreamsResponse response = new AddFlowMediaStreamsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("mediaStreams", targetDepth))
                {
                    ...
                    response.MediaStreams = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static AddFlowMediaStreamsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddFlowMediaStreamsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
