...
{
    /// <summary>
    /// Response Unmarshaller for BridgeFlowSource Object
    /// </summary>  
    public class BridgeFlowSourceUnmarshaller : IJsonUnmarshaller<BridgeFlowSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BridgeFlowSource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            BridgeFlowSource unmarshalledObject = new BridgeFlowSource();
        ...
        private static BridgeFlowSourceUnmarshaller _instance = new BridgeFlowSourceUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BridgeFlowSourceUnmarshaller Instance
        {
            get
            {
                return _instance;
