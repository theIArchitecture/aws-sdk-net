...
{
    /// <summary>
    /// Response Unmarshaller for DeleteBridge operation
    /// </summary>  
    public class DeleteBridgeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteBridgeResponse response = new DeleteBridgeResponse();
        ...
        private static DeleteBridgeResponseUnmarshaller _instance = new DeleteBridgeResponseUnmarshaller();        

        internal static DeleteBridgeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteBridgeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
