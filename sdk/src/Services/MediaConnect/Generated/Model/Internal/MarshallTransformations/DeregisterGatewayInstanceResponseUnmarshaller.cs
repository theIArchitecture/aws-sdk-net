...
{
    /// <summary>
    /// Response Unmarshaller for DeregisterGatewayInstance operation
    /// </summary>  
    public class DeregisterGatewayInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeregisterGatewayInstanceResponse response = new DeregisterGatewayInstanceResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("gatewayInstanceArn", targetDepth))
                {
                    ...
                    response.GatewayInstanceArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("instanceState", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.InstanceState = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DeregisterGatewayInstanceResponseUnmarshaller _instance = new DeregisterGatewayInstanceResponseUnmarshaller();        

        internal static DeregisterGatewayInstanceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeregisterGatewayInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
