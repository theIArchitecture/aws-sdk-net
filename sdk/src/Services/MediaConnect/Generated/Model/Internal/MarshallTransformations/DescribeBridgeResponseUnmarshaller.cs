...
{
    /// <summary>
    /// Response Unmarshaller for DescribeBridge operation
    /// </summary>  
    public class DescribeBridgeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeBridgeResponse response = new DescribeBridgeResponse();
        ...
        private static DescribeBridgeResponseUnmarshaller _instance = new DescribeBridgeResponseUnmarshaller();        

        internal static DescribeBridgeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeBridgeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
