...
{
    /// <summary>
    /// Response Unmarshaller for DescribeFlowSourceMetadata operation
    /// </summary>  
    public class DescribeFlowSourceMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeFlowSourceMetadataResponse response = new DescribeFlowSourceMetadataResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("transportMediaInfo", targetDepth))
                {
                    ...
                    response.TransportMediaInfo = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeFlowSourceMetadataResponseUnmarshaller _instance = new DescribeFlowSourceMetadataResponseUnmarshaller();        

        internal static DescribeFlowSourceMetadataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeFlowSourceMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
