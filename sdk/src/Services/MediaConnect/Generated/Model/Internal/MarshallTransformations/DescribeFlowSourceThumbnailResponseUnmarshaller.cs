...
{
    /// <summary>
    /// Response Unmarshaller for DescribeFlowSourceThumbnail operation
    /// </summary>  
    public class DescribeFlowSourceThumbnailResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeFlowSourceThumbnailResponse response = new DescribeFlowSourceThumbnailResponse();
        ...
        private static DescribeFlowSourceThumbnailResponseUnmarshaller _instance = new DescribeFlowSourceThumbnailResponseUnmarshaller();        

        internal static DescribeFlowSourceThumbnailResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeFlowSourceThumbnailResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
