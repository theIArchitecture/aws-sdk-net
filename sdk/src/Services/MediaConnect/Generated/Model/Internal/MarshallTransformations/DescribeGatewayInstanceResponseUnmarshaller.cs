...
{
    /// <summary>
    /// Response Unmarshaller for DescribeGatewayInstance operation
    /// </summary>  
    public class DescribeGatewayInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeGatewayInstanceResponse response = new DescribeGatewayInstanceResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = GatewayInstanceUnmarshaller.Instance;
                    response.GatewayInstance = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeGatewayInstanceResponseUnmarshaller _instance = new DescribeGatewayInstanceResponseUnmarshaller();        

        internal static DescribeGatewayInstanceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeGatewayInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
