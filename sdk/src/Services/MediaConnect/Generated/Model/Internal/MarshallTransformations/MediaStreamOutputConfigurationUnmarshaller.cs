...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    public class MediaStreamOutputConfigurationUnmarshaller : IJsonUnmarshaller<MediaStreamOutputConfiguration, JsonUnmarshallerContext>
    {
        ...
        private static MediaStreamOutputConfigurationUnmarshaller _instance = new MediaStreamOutputConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static MediaStreamOutputConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
