...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MulticastSourceSettingsUnmarshaller : IJsonUnmarshaller<MulticastSourceSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MulticastSourceSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("multicastSourceIp", targetDepth))
                {
                    ...
                    unmarshalledObject.MulticastSourceIp = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
