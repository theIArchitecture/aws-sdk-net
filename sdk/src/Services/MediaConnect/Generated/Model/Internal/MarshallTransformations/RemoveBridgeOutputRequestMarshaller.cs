...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class RemoveBridgeOutputRequestMarshaller : IMarshaller<IRequest, RemoveBridgeOutputRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static RemoveBridgeOutputRequestMarshaller _instance = new RemoveBridgeOutputRequestMarshaller();        

        internal static RemoveBridgeOutputRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveBridgeOutputRequestMarshaller Instance
        {
            get
            {
                return _instance;
