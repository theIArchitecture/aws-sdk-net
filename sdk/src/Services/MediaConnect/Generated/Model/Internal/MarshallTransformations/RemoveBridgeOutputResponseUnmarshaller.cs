...
{
    /// <summary>
    /// Response Unmarshaller for RemoveBridgeOutput operation
    /// </summary>  
    public class RemoveBridgeOutputResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RemoveBridgeOutputResponse response = new RemoveBridgeOutputResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.OutputName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static RemoveBridgeOutputResponseUnmarshaller _instance = new RemoveBridgeOutputResponseUnmarshaller();        

        internal static RemoveBridgeOutputResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveBridgeOutputResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
