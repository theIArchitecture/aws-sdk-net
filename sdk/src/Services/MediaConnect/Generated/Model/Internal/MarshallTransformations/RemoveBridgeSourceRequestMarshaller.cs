...
{
    /// <summary>
    /// RemoveBridgeSource Request Marshaller
    /// </summary>       
    public class RemoveBridgeSourceRequestMarshaller : IMarshaller<IRequest, RemoveBridgeSourceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RemoveBridgeSourceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RemoveBridgeSourceRequest publicRequest)
        {
        ...
        private static RemoveBridgeSourceRequestMarshaller _instance = new RemoveBridgeSourceRequestMarshaller();        

        internal static RemoveBridgeSourceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveBridgeSourceRequestMarshaller Instance
        {
            get
            {
                return _instance;
