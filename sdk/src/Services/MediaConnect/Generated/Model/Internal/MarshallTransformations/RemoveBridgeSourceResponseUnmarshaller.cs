...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RemoveBridgeSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RemoveBridgeSourceResponse response = new RemoveBridgeSourceResponse();
        ...
        internal static RemoveBridgeSourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveBridgeSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
