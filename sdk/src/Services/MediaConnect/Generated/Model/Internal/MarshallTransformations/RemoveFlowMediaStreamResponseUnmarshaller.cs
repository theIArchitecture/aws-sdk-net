...
{
    /// <summary>
    /// Response Unmarshaller for RemoveFlowMediaStream operation
    /// </summary>  
    public class RemoveFlowMediaStreamResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RemoveFlowMediaStreamResponse response = new RemoveFlowMediaStreamResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.MediaStreamName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static RemoveFlowMediaStreamResponseUnmarshaller _instance = new RemoveFlowMediaStreamResponseUnmarshaller();        

        internal static RemoveFlowMediaStreamResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveFlowMediaStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
