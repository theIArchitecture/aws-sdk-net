...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResourceSpecificationUnmarshaller : IJsonUnmarshaller<ResourceSpecification, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResourceSpecification Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("reservedBitrate", targetDepth))
                {
                    ...
                    unmarshalledObject.ReservedBitrate = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
