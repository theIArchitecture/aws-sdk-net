...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SourcePriorityUnmarshaller : IJsonUnmarshaller<SourcePriority, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SourcePriority Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("primarySource", targetDepth))
                {
                    ...
                    unmarshalledObject.PrimarySource = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
