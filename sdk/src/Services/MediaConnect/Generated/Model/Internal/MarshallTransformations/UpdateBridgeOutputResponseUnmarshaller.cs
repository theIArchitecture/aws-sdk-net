...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateBridgeOutputResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateBridgeOutputResponse response = new UpdateBridgeOutputResponse();
        ...
        internal static UpdateBridgeOutputResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBridgeOutputResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
