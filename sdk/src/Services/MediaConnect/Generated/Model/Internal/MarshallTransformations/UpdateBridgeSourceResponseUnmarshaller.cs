...
{
    /// <summary>
    /// Response Unmarshaller for UpdateBridgeSource operation
    /// </summary>  
    public class UpdateBridgeSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateBridgeSourceResponse response = new UpdateBridgeSourceResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = BridgeSourceUnmarshaller.Instance;
        ...
        private static UpdateBridgeSourceResponseUnmarshaller _instance = new UpdateBridgeSourceResponseUnmarshaller();        

        internal static UpdateBridgeSourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBridgeSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
