...
{
    /// <summary>
    /// Response Unmarshaller for UpdateBridgeState operation
    /// </summary>  
    public class UpdateBridgeStateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateBridgeStateResponse response = new UpdateBridgeStateResponse();
        ...
        private static UpdateBridgeStateResponseUnmarshaller _instance = new UpdateBridgeStateResponseUnmarshaller();        

        internal static UpdateBridgeStateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBridgeStateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
