...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateGatewayInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateGatewayInstanceResponse response = new UpdateGatewayInstanceResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("bridgePlacement", targetDepth))
                {
                    ...
                    response.BridgePlacement = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static UpdateGatewayInstanceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateGatewayInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
