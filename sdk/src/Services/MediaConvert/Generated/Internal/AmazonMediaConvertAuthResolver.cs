...
namespace Amazon.MediaConvert.Internal
{
    ...
    public class AmazonMediaConvertAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonMediaConvertAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for MediaConvert.
        /// </summary>
        public AmazonMediaConvertAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonMediaConvertAuthSchemeParameters
            {
    ...
    public class AmazonMediaConvertAuthSchemeResolver : IAuthSchemeResolver<AmazonMediaConvertAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonMediaConvertAuthSchemeParameters authParameters)
        {
