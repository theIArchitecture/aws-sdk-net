...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CaptionSelectorUnmarshaller : IJsonUnmarshaller<CaptionSelector, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CaptionSelector Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("sourceSettings", targetDepth))
                {
                    ...
                    unmarshalledObject.SourceSettings = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
