...
{
    /// <summary>
    /// Response Unmarshaller for GifSettings Object
    /// </summary>  
    public class GifSettingsUnmarshaller : IJsonUnmarshaller<GifSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GifSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            GifSettings unmarshalledObject = new GifSettings();
        ...
        private static GifSettingsUnmarshaller _instance = new GifSettingsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static GifSettingsUnmarshaller Instance
        {
            get
            {
                return _instance;
