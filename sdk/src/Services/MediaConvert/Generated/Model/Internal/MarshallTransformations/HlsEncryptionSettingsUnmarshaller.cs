...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class HlsEncryptionSettingsUnmarshaller : IJsonUnmarshaller<HlsEncryptionSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public HlsEncryptionSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.OfflineEncrypted = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
