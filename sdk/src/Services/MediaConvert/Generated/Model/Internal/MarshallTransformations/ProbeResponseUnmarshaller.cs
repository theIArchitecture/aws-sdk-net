...
{
    /// <summary>
    /// Response Unmarshaller for Probe operation
    /// </summary>  
    public class ProbeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("probeResults", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<ProbeResult, ProbeResultUnmarshaller>(ProbeResultUnmarshaller.Instance);
                    response.ProbeResults = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ProbeResponseUnmarshaller _instance = new ProbeResponseUnmarshaller();        

        internal static ProbeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ProbeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
