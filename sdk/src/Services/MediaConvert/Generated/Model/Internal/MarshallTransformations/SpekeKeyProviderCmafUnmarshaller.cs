...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SpekeKeyProviderCmafUnmarshaller : IJsonUnmarshaller<SpekeKeyProviderCmaf, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SpekeKeyProviderCmaf Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("dashSignaledSystemIds", targetDepth))
                {
                    ...
                    unmarshalledObject.DashSignaledSystemIds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.HlsSignaledSystemIds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
