...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UncompressedSettingsUnmarshaller : IJsonUnmarshaller<UncompressedSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public UncompressedSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("fourcc", targetDepth))
                {
                    ...
                    unmarshalledObject.Fourcc = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
