...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class VideoSelector
    {
        ...
        /// <summary>
        /// Gets and sets the property Streams. Specify a stream for MediaConvert to use from
        /// your HLS input. Enter an integer corresponding to the stream order in your HLS manifest.
        /// <para />
