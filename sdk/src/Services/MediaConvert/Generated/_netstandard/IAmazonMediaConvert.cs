...
namespace Amazon.MediaConvert
{
    ...
    public partial interface IAmazonMediaConvert : IAmazonService, IDisposable
    {
        ...
        Task<ProbeResponse> ProbeAsync(ProbeRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonMediaConvertConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonMediaConvertConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonMediaConvertConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonMediaConvertConfig to create AmazonMediaConvertClient");
            }

            return awsCredentials == null ? 
                    new AmazonMediaConvertClient(serviceClientConfig) :
                    new AmazonMediaConvertClient(awsCredentials, serviceClientConfig);
        }
