...
namespace Amazon.MediaLive.Internal
{
    ...
    public class AmazonMediaLiveAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonMediaLiveAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for MediaLive.
        /// </summary>
        public AmazonMediaLiveAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonMediaLiveAuthSchemeParameters
            {
    ...
    public class AmazonMediaLiveAuthSchemeResolver : IAuthSchemeResolver<AmazonMediaLiveAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonMediaLiveAuthSchemeParameters authParameters)
        {
