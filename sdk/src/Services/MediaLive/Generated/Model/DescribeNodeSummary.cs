...
namespace Amazon.MediaLive.Model
{
    ...
    /// </summary>
    public partial class DescribeNodeSummary
    {
        private string _arn;
        ...
        private string _managedInstanceId;
        ...
        /// <summary>
        /// Gets and sets the property InstanceArn. The EC2 ARN of the Instance associated with
        /// the Node.
        /// </summary>
        ...
        /// <summary>
        /// Gets and sets the property ManagedInstanceId. At the routing layer will get it from
        /// the callerId/context for use with bring your own device.
        /// </summary>
        public string ManagedInstanceId
        {
            get { return this._managedInstanceId; }
            set { this._managedInstanceId = value; }
        }

        // Check to see if ManagedInstanceId property is set
        internal bool IsSetManagedInstanceId()
        {
            return this._managedInstanceId != null;
        }
