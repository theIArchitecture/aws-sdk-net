...
namespace Amazon.MediaLive.Model
{
    ...
    /// </summary>
    public partial class EventBridgeRuleTemplateGroupSummary
    {
        private string _arn;
        ...
        // Check to see if TemplateCount property is set
        internal bool IsSetTemplateCount()
        {
            return this._templateCount.HasValue; 
        }
