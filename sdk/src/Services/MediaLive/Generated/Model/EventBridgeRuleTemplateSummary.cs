...
namespace Amazon.MediaLive.Model
{
    ...
    /// </summary>
    public partial class EventBridgeRuleTemplateSummary
    {
        private string _arn;
        private DateTime? _createdAt;
        private string _description;
        private int? _eventTargetCount;
        ...
        // Check to see if EventTargetCount property is set
        internal bool IsSetEventTargetCount()
        {
            return this._eventTargetCount.HasValue; 
        }
