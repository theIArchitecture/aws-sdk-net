...
namespace Amazon.MediaLive.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AudioSilenceFailoverSettingsUnmarshaller : IJsonUnmarshaller<AudioSilenceFailoverSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AudioSilenceFailoverSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("audioSilenceThresholdMsec", targetDepth))
                {
                    ...
                    unmarshalledObject.AudioSilenceThresholdMsec = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
