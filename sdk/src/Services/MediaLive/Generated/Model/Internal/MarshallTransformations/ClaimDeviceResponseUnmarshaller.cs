...
{
    /// <summary>
    /// Response Unmarshaller for ClaimDevice operation
    /// </summary>  
    public class ClaimDeviceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ClaimDeviceResponse response = new ClaimDeviceResponse();
        ...
        private static ClaimDeviceResponseUnmarshaller _instance = new ClaimDeviceResponseUnmarshaller();        

        internal static ClaimDeviceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ClaimDeviceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
