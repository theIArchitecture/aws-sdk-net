...
{
    /// <summary>
    /// Response Unmarshaller for CreateChannelPlacementGroup operation
    /// </summary>  
    public class CreateChannelPlacementGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateChannelPlacementGroupResponse response = new CreateChannelPlacementGroupResponse();
        ...
        private static CreateChannelPlacementGroupResponseUnmarshaller _instance = new CreateChannelPlacementGroupResponseUnmarshaller();        

        internal static CreateChannelPlacementGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateChannelPlacementGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
