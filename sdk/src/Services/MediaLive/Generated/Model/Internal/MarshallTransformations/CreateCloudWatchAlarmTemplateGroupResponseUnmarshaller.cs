...
{
    /// <summary>
    /// Response Unmarshaller for CreateCloudWatchAlarmTemplateGroup operation
    /// </summary>  
    public class CreateCloudWatchAlarmTemplateGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateCloudWatchAlarmTemplateGroupResponse response = new CreateCloudWatchAlarmTemplateGroupResponse();
        ...
        private static CreateCloudWatchAlarmTemplateGroupResponseUnmarshaller _instance = new CreateCloudWatchAlarmTemplateGroupResponseUnmarshaller();        

        internal static CreateCloudWatchAlarmTemplateGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCloudWatchAlarmTemplateGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
