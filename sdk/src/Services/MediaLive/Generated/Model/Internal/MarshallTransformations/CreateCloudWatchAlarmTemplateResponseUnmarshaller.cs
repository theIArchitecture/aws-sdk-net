...
{
    /// <summary>
    /// Response Unmarshaller for CreateCloudWatchAlarmTemplate operation
    /// </summary>  
    public class CreateCloudWatchAlarmTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateCloudWatchAlarmTemplateResponse response = new CreateCloudWatchAlarmTemplateResponse();
        ...
        private static CreateCloudWatchAlarmTemplateResponseUnmarshaller _instance = new CreateCloudWatchAlarmTemplateResponseUnmarshaller();        

        internal static CreateCloudWatchAlarmTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCloudWatchAlarmTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
