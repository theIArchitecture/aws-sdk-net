...
{
    /// <summary>
    /// Response Unmarshaller for CreateEventBridgeRuleTemplateGroup operation
    /// </summary>  
    public class CreateEventBridgeRuleTemplateGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateEventBridgeRuleTemplateGroupResponse response = new CreateEventBridgeRuleTemplateGroupResponse();
        ...
        private static CreateEventBridgeRuleTemplateGroupResponseUnmarshaller _instance = new CreateEventBridgeRuleTemplateGroupResponseUnmarshaller();        

        internal static CreateEventBridgeRuleTemplateGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateEventBridgeRuleTemplateGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
