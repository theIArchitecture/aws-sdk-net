...
{
    /// <summary>
    /// Response Unmarshaller for CreateEventBridgeRuleTemplate operation
    /// </summary>  
    public class CreateEventBridgeRuleTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateEventBridgeRuleTemplateResponse response = new CreateEventBridgeRuleTemplateResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<EventBridgeRuleTemplateTarget, EventBridgeRuleTemplateTargetUnmarshaller>(EventBridgeRuleTemplateTargetUnmarshaller.Instance);
                    response.EventTargets = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateEventBridgeRuleTemplateResponseUnmarshaller _instance = new CreateEventBridgeRuleTemplateResponseUnmarshaller();        

        internal static CreateEventBridgeRuleTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateEventBridgeRuleTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
