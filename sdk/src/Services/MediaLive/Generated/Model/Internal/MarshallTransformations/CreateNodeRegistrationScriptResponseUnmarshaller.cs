...
{
    /// <summary>
    /// Response Unmarshaller for CreateNodeRegistrationScript operation
    /// </summary>  
    public class CreateNodeRegistrationScriptResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateNodeRegistrationScriptResponse response = new CreateNodeRegistrationScriptResponse();
        ...
        private static CreateNodeRegistrationScriptResponseUnmarshaller _instance = new CreateNodeRegistrationScriptResponseUnmarshaller();        

        internal static CreateNodeRegistrationScriptResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateNodeRegistrationScriptResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
