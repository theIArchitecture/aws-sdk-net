...
{
    /// <summary>
    /// Response Unmarshaller for CreateSdiSource operation
    /// </summary>  
    public class CreateSdiSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSdiSourceResponse response = new CreateSdiSourceResponse();
        ...
        private static CreateSdiSourceResponseUnmarshaller _instance = new CreateSdiSourceResponseUnmarshaller();        

        internal static CreateSdiSourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSdiSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
