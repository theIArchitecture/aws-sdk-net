...
{
    /// <summary>
    /// CreateSignalMap Request Marshaller
    /// </summary>       
    public class CreateSignalMapRequestMarshaller : IMarshaller<IRequest, CreateSignalMapRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateSignalMapRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateSignalMapRequest publicRequest)
        {
        ...
        private static CreateSignalMapRequestMarshaller _instance = new CreateSignalMapRequestMarshaller();        

        internal static CreateSignalMapRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSignalMapRequestMarshaller Instance
        {
            get
            {
                return _instance;
