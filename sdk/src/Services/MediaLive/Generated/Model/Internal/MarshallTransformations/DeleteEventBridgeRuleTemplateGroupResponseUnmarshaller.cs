...
{
    /// <summary>
    /// Response Unmarshaller for DeleteEventBridgeRuleTemplateGroup operation
    /// </summary>  
    public class DeleteEventBridgeRuleTemplateGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteEventBridgeRuleTemplateGroupResponse response = new DeleteEventBridgeRuleTemplateGroupResponse();
        ...
        private static DeleteEventBridgeRuleTemplateGroupResponseUnmarshaller _instance = new DeleteEventBridgeRuleTemplateGroupResponseUnmarshaller();        

        internal static DeleteEventBridgeRuleTemplateGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteEventBridgeRuleTemplateGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
