...
{
    /// <summary>
    /// Response Unmarshaller for DeleteEventBridgeRuleTemplate operation
    /// </summary>  
    public class DeleteEventBridgeRuleTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteEventBridgeRuleTemplateResponse response = new DeleteEventBridgeRuleTemplateResponse();
        ...
        private static DeleteEventBridgeRuleTemplateResponseUnmarshaller _instance = new DeleteEventBridgeRuleTemplateResponseUnmarshaller();        

        internal static DeleteEventBridgeRuleTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteEventBridgeRuleTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
