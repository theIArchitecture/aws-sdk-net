...
{
    /// <summary>
    /// DeleteNetwork Request Marshaller
    /// </summary>       
    public class DeleteNetworkRequestMarshaller : IMarshaller<IRequest, DeleteNetworkRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteNetworkRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteNetworkRequest publicRequest)
        {
        ...
        private static DeleteNetworkRequestMarshaller _instance = new DeleteNetworkRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteNetworkRequestMarshaller Instance
        {
            get
            {
                return _instance;
