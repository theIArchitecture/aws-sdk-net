...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSdiSource operation
    /// </summary>  
    public class DeleteSdiSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSdiSourceResponse response = new DeleteSdiSourceResponse();
        ...
        private static DeleteSdiSourceResponseUnmarshaller _instance = new DeleteSdiSourceResponseUnmarshaller();        

        internal static DeleteSdiSourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSdiSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
