...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSignalMap operation
    /// </summary>  
    public class DeleteSignalMapResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSignalMapResponse response = new DeleteSignalMapResponse();
        ...
        private static DeleteSignalMapResponseUnmarshaller _instance = new DeleteSignalMapResponseUnmarshaller();        

        internal static DeleteSignalMapResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSignalMapResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
