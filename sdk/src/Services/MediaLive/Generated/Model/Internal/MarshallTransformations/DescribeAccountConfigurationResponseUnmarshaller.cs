...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAccountConfiguration operation
    /// </summary>  
    public class DescribeAccountConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAccountConfigurationResponse response = new DescribeAccountConfigurationResponse();
        ...
        private static DescribeAccountConfigurationResponseUnmarshaller _instance = new DescribeAccountConfigurationResponseUnmarshaller();        

        internal static DescribeAccountConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAccountConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
