...
{
    /// <summary>
    /// Response Unmarshaller for DescribeChannelPlacementGroup operation
    /// </summary>  
    public class DescribeChannelPlacementGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeChannelPlacementGroupResponse response = new DescribeChannelPlacementGroupResponse();
        ...
        private static DescribeChannelPlacementGroupResponseUnmarshaller _instance = new DescribeChannelPlacementGroupResponseUnmarshaller();        

        internal static DescribeChannelPlacementGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeChannelPlacementGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
