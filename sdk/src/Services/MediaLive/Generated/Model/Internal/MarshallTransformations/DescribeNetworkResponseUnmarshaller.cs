...
{
    /// <summary>
    /// Response Unmarshaller for DescribeNetwork operation
    /// </summary>  
    public class DescribeNetworkResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeNetworkResponseUnmarshaller _instance = new DescribeNetworkResponseUnmarshaller();        

        internal static DescribeNetworkResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeNetworkResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
