...
{
    /// <summary>
    /// Response Unmarshaller for DescribeSdiSource operation
    /// </summary>  
    public class DescribeSdiSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeSdiSourceResponse response = new DescribeSdiSourceResponse();
        ...
        private static DescribeSdiSourceResponseUnmarshaller _instance = new DescribeSdiSourceResponseUnmarshaller();        

        internal static DescribeSdiSourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSdiSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
