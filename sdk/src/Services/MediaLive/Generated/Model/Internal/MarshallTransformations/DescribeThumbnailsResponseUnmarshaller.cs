...
{
    /// <summary>
    /// Response Unmarshaller for DescribeThumbnails operation
    /// </summary>  
    public class DescribeThumbnailsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeThumbnailsResponse response = new DescribeThumbnailsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ThumbnailDetail, ThumbnailDetailUnmarshaller>(ThumbnailDetailUnmarshaller.Instance);
        ...
        private static DescribeThumbnailsResponseUnmarshaller _instance = new DescribeThumbnailsResponseUnmarshaller();        

        internal static DescribeThumbnailsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeThumbnailsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
