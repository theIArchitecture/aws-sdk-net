...
namespace Amazon.MediaLive.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FollowModeScheduleActionStartSettingsUnmarshaller : IJsonUnmarshaller<FollowModeScheduleActionStartSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FollowModeScheduleActionStartSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("followPoint", targetDepth))
                {
                    ...
                    unmarshalledObject.FollowPoint = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("referenceActionName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ReferenceActionName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
