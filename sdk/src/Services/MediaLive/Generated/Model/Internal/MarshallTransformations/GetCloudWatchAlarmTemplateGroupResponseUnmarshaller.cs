...
{
    /// <summary>
    /// Response Unmarshaller for GetCloudWatchAlarmTemplateGroup operation
    /// </summary>  
    public class GetCloudWatchAlarmTemplateGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCloudWatchAlarmTemplateGroupResponse response = new GetCloudWatchAlarmTemplateGroupResponse();
        ...
        private static GetCloudWatchAlarmTemplateGroupResponseUnmarshaller _instance = new GetCloudWatchAlarmTemplateGroupResponseUnmarshaller();        

        internal static GetCloudWatchAlarmTemplateGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCloudWatchAlarmTemplateGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
