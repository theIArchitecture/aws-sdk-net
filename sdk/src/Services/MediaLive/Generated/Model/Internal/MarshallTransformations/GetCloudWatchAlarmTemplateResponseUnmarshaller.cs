...
{
    /// <summary>
    /// Response Unmarshaller for GetCloudWatchAlarmTemplate operation
    /// </summary>  
    public class GetCloudWatchAlarmTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCloudWatchAlarmTemplateResponse response = new GetCloudWatchAlarmTemplateResponse();
        ...
        private static GetCloudWatchAlarmTemplateResponseUnmarshaller _instance = new GetCloudWatchAlarmTemplateResponseUnmarshaller();        

        internal static GetCloudWatchAlarmTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCloudWatchAlarmTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
