...
{
    /// <summary>
    /// Response Unmarshaller for GetEventBridgeRuleTemplateGroup operation
    /// </summary>  
    public class GetEventBridgeRuleTemplateGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetEventBridgeRuleTemplateGroupResponse response = new GetEventBridgeRuleTemplateGroupResponse();
        ...
        private static GetEventBridgeRuleTemplateGroupResponseUnmarshaller _instance = new GetEventBridgeRuleTemplateGroupResponseUnmarshaller();        

        internal static GetEventBridgeRuleTemplateGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEventBridgeRuleTemplateGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
