...
{
    /// <summary>
    /// Response Unmarshaller for GetEventBridgeRuleTemplate operation
    /// </summary>  
    public class GetEventBridgeRuleTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetEventBridgeRuleTemplateResponse response = new GetEventBridgeRuleTemplateResponse();
        ...
        private static GetEventBridgeRuleTemplateResponseUnmarshaller _instance = new GetEventBridgeRuleTemplateResponseUnmarshaller();        

        internal static GetEventBridgeRuleTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEventBridgeRuleTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
