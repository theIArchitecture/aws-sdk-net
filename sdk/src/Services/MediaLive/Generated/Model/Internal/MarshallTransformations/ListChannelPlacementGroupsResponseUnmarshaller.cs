...
{
    /// <summary>
    /// Response Unmarshaller for ListChannelPlacementGroups operation
    /// </summary>  
    public class ListChannelPlacementGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListChannelPlacementGroupsResponse response = new ListChannelPlacementGroupsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DescribeChannelPlacementGroupSummary, DescribeChannelPlacementGroupSummaryUnmarshaller>(DescribeChannelPlacementGroupSummaryUnmarshaller.Instance);
        ...
        private static ListChannelPlacementGroupsResponseUnmarshaller _instance = new ListChannelPlacementGroupsResponseUnmarshaller();        

        internal static ListChannelPlacementGroupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListChannelPlacementGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
