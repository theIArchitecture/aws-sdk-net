    ...
    public class ListInputDeviceTransfersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<TransferringInputDeviceSummary, TransferringInputDeviceSummaryUnmarshaller>(TransferringInputDeviceSummaryUnmarshaller.Instance);
                    response.InputDeviceTransfers = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
