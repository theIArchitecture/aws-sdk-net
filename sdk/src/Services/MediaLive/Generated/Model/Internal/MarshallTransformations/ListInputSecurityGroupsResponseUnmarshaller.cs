    ...
    public class ListInputSecurityGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<InputSecurityGroup, InputSecurityGroupUnmarshaller>(InputSecurityGroupUnmarshaller.Instance);
                    response.InputSecurityGroups = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
