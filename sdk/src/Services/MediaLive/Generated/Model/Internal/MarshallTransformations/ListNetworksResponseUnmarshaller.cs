    ...
    public class ListNetworksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DescribeNetworkSummary, DescribeNetworkSummaryUnmarshaller>(DescribeNetworkSummaryUnmarshaller.Instance);
                    response.Networks = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
