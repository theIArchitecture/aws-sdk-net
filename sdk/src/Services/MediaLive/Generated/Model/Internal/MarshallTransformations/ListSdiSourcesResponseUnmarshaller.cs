...
{
    /// <summary>
    /// Response Unmarshaller for ListSdiSources operation
    /// </summary>  
    public class ListSdiSourcesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSdiSourcesResponse response = new ListSdiSourcesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SdiSourceSummary, SdiSourceSummaryUnmarshaller>(SdiSourceSummaryUnmarshaller.Instance);
        ...
        private static ListSdiSourcesResponseUnmarshaller _instance = new ListSdiSourcesResponseUnmarshaller();        

        internal static ListSdiSourcesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSdiSourcesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
