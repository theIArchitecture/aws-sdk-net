...
{
    /// <summary>
    /// Response Unmarshaller for MaintenanceStatus Object
    /// </summary>  
    public class MaintenanceStatusUnmarshaller : IJsonUnmarshaller<MaintenanceStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MaintenanceStatus Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            MaintenanceStatus unmarshalledObject = new MaintenanceStatus();
        ...
        private static MaintenanceStatusUnmarshaller _instance = new MaintenanceStatusUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static MaintenanceStatusUnmarshaller Instance
        {
            get
            {
                return _instance;
