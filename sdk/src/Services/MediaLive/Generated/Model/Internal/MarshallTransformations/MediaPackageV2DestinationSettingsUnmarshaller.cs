...
namespace Amazon.MediaLive.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MediaPackageV2DestinationSettingsUnmarshaller : IJsonUnmarshaller<MediaPackageV2DestinationSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MediaPackageV2DestinationSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.HlsAutoSelect = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("hlsDefault", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.HlsDefault = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
