...
namespace Amazon.MediaLive.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MultiplexContainerSettingsUnmarshaller : IJsonUnmarshaller<MultiplexContainerSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MultiplexContainerSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("multiplexM2tsSettings", targetDepth))
                {
                    ...
                    unmarshalledObject.MultiplexM2tsSettings = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
