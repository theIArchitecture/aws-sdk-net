...
namespace Amazon.MediaLive.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NielsenNaesIiNwUnmarshaller : IJsonUnmarshaller<NielsenNaesIiNw, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NielsenNaesIiNw Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("checkDigitString", targetDepth))
                {
                    ...
                    unmarshalledObject.CheckDigitString = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
