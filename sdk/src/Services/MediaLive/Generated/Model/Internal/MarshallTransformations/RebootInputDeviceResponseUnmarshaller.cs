...
{
    /// <summary>
    /// Response Unmarshaller for RebootInputDevice operation
    /// </summary>  
    public class RebootInputDeviceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RebootInputDeviceResponse response = new RebootInputDeviceResponse();
        ...
        private static RebootInputDeviceResponseUnmarshaller _instance = new RebootInputDeviceResponseUnmarshaller();        

        internal static RebootInputDeviceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RebootInputDeviceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
