...
{
    /// <summary>
    /// SrtOutputSettings Marshaller
    /// </summary>
    public class SrtOutputSettingsMarshaller : IRequestMarshaller<SrtOutputSettings, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(SrtOutputSettings requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetLatency())
            {
                ...
                context.Writer.WriteNumberValue(requestObject.Latency.Value);
            }
        ...
        /// </summary>
        public readonly static SrtOutputSettingsMarshaller Instance = new SrtOutputSettingsMarshaller();
