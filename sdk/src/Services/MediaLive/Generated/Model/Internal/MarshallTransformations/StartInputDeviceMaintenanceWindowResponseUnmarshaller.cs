...
{
    /// <summary>
    /// Response Unmarshaller for StartInputDeviceMaintenanceWindow operation
    /// </summary>  
    public class StartInputDeviceMaintenanceWindowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartInputDeviceMaintenanceWindowResponse response = new StartInputDeviceMaintenanceWindowResponse();
        ...
        private static StartInputDeviceMaintenanceWindowResponseUnmarshaller _instance = new StartInputDeviceMaintenanceWindowResponseUnmarshaller();        

        internal static StartInputDeviceMaintenanceWindowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartInputDeviceMaintenanceWindowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
