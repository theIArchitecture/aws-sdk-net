...
namespace Amazon.MediaLive.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TransferringInputDeviceSummaryUnmarshaller : IJsonUnmarshaller<TransferringInputDeviceSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TransferringInputDeviceSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TargetCustomerId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("transferType", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TransferType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
