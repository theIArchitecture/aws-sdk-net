...
{
    /// <summary>
    /// Response Unmarshaller for UpdateChannelPlacementGroup operation
    /// </summary>  
    public class UpdateChannelPlacementGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateChannelPlacementGroupResponse response = new UpdateChannelPlacementGroupResponse();
        ...
        private static UpdateChannelPlacementGroupResponseUnmarshaller _instance = new UpdateChannelPlacementGroupResponseUnmarshaller();        

        internal static UpdateChannelPlacementGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateChannelPlacementGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
