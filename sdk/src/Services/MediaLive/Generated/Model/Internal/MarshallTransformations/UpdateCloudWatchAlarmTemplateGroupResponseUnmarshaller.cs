...
{
    /// <summary>
    /// Response Unmarshaller for UpdateCloudWatchAlarmTemplateGroup operation
    /// </summary>  
    public class UpdateCloudWatchAlarmTemplateGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateCloudWatchAlarmTemplateGroupResponse response = new UpdateCloudWatchAlarmTemplateGroupResponse();
        ...
        private static UpdateCloudWatchAlarmTemplateGroupResponseUnmarshaller _instance = new UpdateCloudWatchAlarmTemplateGroupResponseUnmarshaller();        

        internal static UpdateCloudWatchAlarmTemplateGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCloudWatchAlarmTemplateGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
