...
{
    /// <summary>
    /// Response Unmarshaller for UpdateEventBridgeRuleTemplateGroup operation
    /// </summary>  
    public class UpdateEventBridgeRuleTemplateGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateEventBridgeRuleTemplateGroupResponse response = new UpdateEventBridgeRuleTemplateGroupResponse();
        ...
        private static UpdateEventBridgeRuleTemplateGroupResponseUnmarshaller _instance = new UpdateEventBridgeRuleTemplateGroupResponseUnmarshaller();        

        internal static UpdateEventBridgeRuleTemplateGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateEventBridgeRuleTemplateGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
