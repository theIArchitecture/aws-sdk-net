...
{
    /// <summary>
    /// Response Unmarshaller for UpdateEventBridgeRuleTemplate operation
    /// </summary>  
    public class UpdateEventBridgeRuleTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateEventBridgeRuleTemplateResponse response = new UpdateEventBridgeRuleTemplateResponse();
        ...
        private static UpdateEventBridgeRuleTemplateResponseUnmarshaller _instance = new UpdateEventBridgeRuleTemplateResponseUnmarshaller();        

        internal static UpdateEventBridgeRuleTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateEventBridgeRuleTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
