...
{
    /// <summary>
    /// UpdateNodeState Request Marshaller
    /// </summary>       
    public class UpdateNodeStateRequestMarshaller : IMarshaller<IRequest, UpdateNodeStateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateNodeStateRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateNodeStateRequest publicRequest)
        {
            ...
            request.ResourcePath = "/prod/clusters/{clusterId}/nodes/{nodeId}/state";
#if !NETFRAMEWORK
        ...
        private static UpdateNodeStateRequestMarshaller _instance = new UpdateNodeStateRequestMarshaller();        

        internal static UpdateNodeStateRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateNodeStateRequestMarshaller Instance
        {
            get
            {
                return _instance;
