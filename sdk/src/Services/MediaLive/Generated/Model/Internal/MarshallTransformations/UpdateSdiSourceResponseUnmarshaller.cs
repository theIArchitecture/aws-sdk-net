...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSdiSource operation
    /// </summary>  
    public class UpdateSdiSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSdiSourceResponse response = new UpdateSdiSourceResponse();
        ...
        private static UpdateSdiSourceResponseUnmarshaller _instance = new UpdateSdiSourceResponseUnmarshaller();        

        internal static UpdateSdiSourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSdiSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
