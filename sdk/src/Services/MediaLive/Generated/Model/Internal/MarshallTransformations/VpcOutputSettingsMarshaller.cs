...
namespace Amazon.MediaLive.Model.Internal.MarshallTransformations
{
    ...
    public class VpcOutputSettingsMarshaller : IRequestMarshaller<VpcOutputSettings, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(VpcOutputSettings requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetPublicAddressAllocationIds())
            {
                context.Writer.WritePropertyName("publicAddressAllocationIds");
                context.Writer.WriteStartArray();
                foreach(var requestObjectPublicAddressAllocationIdsListValue in requestObject.PublicAddressAllocationIds)
                {
                        context.Writer.WriteStringValue(requestObjectPublicAddressAllocationIdsListValue);
                }
