...
namespace Amazon.MediaLive.Model
{
    ...
    {
        private List<DescribeClusterSummary> _clusters = AWSConfigs.InitializeCollections ? new List<DescribeClusterSummary>() : null;
        private string _nextToken;

        /// <summary>
        /// Gets and sets the property Clusters. A list of the Clusters that exist in your AWS
        /// account.
        /// <para />
        ...
        /// </summary>
        public List<DescribeClusterSummary> Clusters
        {
