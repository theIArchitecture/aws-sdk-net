...
namespace Amazon.MediaLive.Model
{
    ...
    {
        private List<DescribeNetworkSummary> _networks = AWSConfigs.InitializeCollections ? new List<DescribeNetworkSummary>() : null;
        private string _nextToken;

        /// <summary>
        /// Gets and sets the property Networks. An array of networks that you have created.
        /// <para />
        ...
        /// </summary>
        public List<DescribeNetworkSummary> Networks
        {
        ...
        /// <summary>
        /// Gets and sets the property NextToken. Token for the next ListNetworks request.
        /// </summary>
