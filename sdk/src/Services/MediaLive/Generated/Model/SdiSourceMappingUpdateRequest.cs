...
{
    /// <summary>
    /// Used in SdiSourceMappingsUpdateRequest. One SDI source mapping. It connects one logical
    /// SdiSource to the physical SDI card and port that the physical SDI source uses. You
    /// must specify all three parameters in this object.
    /// </summary>
    public partial class SdiSourceMappingUpdateRequest
    {
        ...
        /// on the node hardware. For information about how physical cards are identified on your
        ...
        /// on the card. This must be an SDI port (not a timecode port, for example). For information
        ...
        /// <summary>
        /// Gets and sets the property SdiSource. The ID of a SDI source streaming on the given
        /// SDI capture card port.
        /// </summary>
