...
namespace Amazon.MediaPackage.Internal
{
    ...
    public class AmazonMediaPackageAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonMediaPackageAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for MediaPackage.
        /// </summary>
        public AmazonMediaPackageAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonMediaPackageAuthSchemeParameters
            {
    ...
    public class AmazonMediaPackageAuthSchemeResolver : IAuthSchemeResolver<AmazonMediaPackageAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonMediaPackageAuthSchemeParameters authParameters)
        {
