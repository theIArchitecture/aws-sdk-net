...
namespace Amazon.MediaPackage.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IngressAccessLogsUnmarshaller : IJsonUnmarshaller<IngressAccessLogs, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IngressAccessLogs Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
