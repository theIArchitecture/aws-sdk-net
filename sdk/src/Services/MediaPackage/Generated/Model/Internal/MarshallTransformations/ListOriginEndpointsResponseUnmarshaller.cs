    ...
    public class ListOriginEndpointsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<OriginEndpoint, OriginEndpointUnmarshaller>(OriginEndpointUnmarshaller.Instance);
                    response.OriginEndpoints = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
