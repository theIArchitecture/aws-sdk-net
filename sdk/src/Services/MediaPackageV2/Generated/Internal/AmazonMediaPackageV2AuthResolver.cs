...
namespace Amazon.MediaPackageV2.Internal
{
    ...
    public class AmazonMediaPackageV2AuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonMediaPackageV2AuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for MediaPackageV2.
        /// </summary>
        public AmazonMediaPackageV2AuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonMediaPackageV2AuthSchemeParameters
            {
    ...
    public class AmazonMediaPackageV2AuthSchemeResolver : IAuthSchemeResolver<AmazonMediaPackageV2AuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonMediaPackageV2AuthSchemeParameters authParameters)
        {
