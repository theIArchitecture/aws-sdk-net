...
namespace Amazon.MediaPackageV2.Model
{
    ...
    [Serializable]
    #endif
    public partial class ConflictException : AmazonMediaPackageV2Exception
    {
        private ConflictExceptionType _conflictExceptionType;
        ...
        protected ConflictException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
            this.ConflictExceptionType = (ConflictExceptionType)info.GetValue("ConflictExceptionType", typeof(ConflictExceptionType));
        }
        ...
        public override void GetObjectData(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
        {
            ...
            info.AddValue("ConflictExceptionType", this.ConflictExceptionType);
        }
#endif

        /// <summary>
        /// Gets and sets the property ConflictExceptionType. 
        /// <para>
        ...
        {
            get { return this._conflictExceptionType; }
            set { this._conflictExceptionType = value; }
        }

        // Check to see if ConflictExceptionType property is set
        internal bool IsSetConflictExceptionType()
        {
            return this._conflictExceptionType != null;
        }
