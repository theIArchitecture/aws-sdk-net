...
namespace Amazon.MediaPackageV2.Model
{
    ...
    public partial class GetDashManifestConfiguration
    {
        ...
        /// manifest into multiple periods. Leave this value empty to indicate that the manifest
        /// is contained all in one period. For more information about periods in the DASH manifest,
        /// see <a href="https://docs.aws.amazon.com/mediapackage/latest/userguide/multi-period.html">Multi-period
