...
{
    /// <summary>
    /// CancelHarvestJob Request Marshaller
    /// </summary>       
    public class CancelHarvestJobRequestMarshaller : IMarshaller<IRequest, CancelHarvestJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CancelHarvestJobRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CancelHarvestJobRequest publicRequest)
        {
            ...
            if (!publicRequest.IsSetHarvestJobName())
                throw new AmazonMediaPackageV2Exception("Request object does not have required field HarvestJobName set");
            request.AddPathResource("{HarvestJobName}", StringUtils.FromString(publicRequest.HarvestJobName));
            ...
            request.ResourcePath = "/channelGroup/{ChannelGroupName}/channel/{ChannelName}/originEndpoint/{OriginEndpointName}/harvestJob/{HarvestJobName}";
        ...
        private static CancelHarvestJobRequestMarshaller _instance = new CancelHarvestJobRequestMarshaller();        

        internal static CancelHarvestJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelHarvestJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
