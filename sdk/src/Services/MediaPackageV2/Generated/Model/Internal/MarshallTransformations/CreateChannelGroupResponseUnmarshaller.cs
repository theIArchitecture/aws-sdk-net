...
namespace Amazon.MediaPackageV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateChannelGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateChannelGroupResponse response = new CreateChannelGroupResponse();
        ...
        internal static CreateChannelGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateChannelGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
