...
namespace Amazon.MediaPackageV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EncryptionContractConfigurationUnmarshaller : IJsonUnmarshaller<EncryptionContractConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EncryptionContractConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("PresetSpeke20Audio", targetDepth))
                {
                    ...
                    unmarshalledObject.PresetSpeke20Audio = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("PresetSpeke20Video", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PresetSpeke20Video = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
