...
{
    /// <summary>
    /// GetHarvestJob Request Marshaller
    /// </summary>       
    public class GetHarvestJobRequestMarshaller : IMarshaller<IRequest, GetHarvestJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetHarvestJobRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetHarvestJobRequest publicRequest)
        {
        ...
        private static GetHarvestJobRequestMarshaller _instance = new GetHarvestJobRequestMarshaller();        

        internal static GetHarvestJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetHarvestJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
