...
namespace Amazon.MediaPackageV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetHarvestJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetHarvestJobResponse response = new GetHarvestJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("HarvestedManifests", targetDepth))
                {
                    ...
                    response.HarvestedManifests = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("HarvestJobName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.HarvestJobName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetHarvestJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetHarvestJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
