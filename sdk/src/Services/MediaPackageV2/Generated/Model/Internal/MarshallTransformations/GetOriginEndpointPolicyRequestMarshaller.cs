...
namespace Amazon.MediaPackageV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetOriginEndpointPolicyRequestMarshaller : IMarshaller<IRequest, GetOriginEndpointPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetOriginEndpointPolicyRequestMarshaller _instance = new GetOriginEndpointPolicyRequestMarshaller();        

        internal static GetOriginEndpointPolicyRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetOriginEndpointPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
