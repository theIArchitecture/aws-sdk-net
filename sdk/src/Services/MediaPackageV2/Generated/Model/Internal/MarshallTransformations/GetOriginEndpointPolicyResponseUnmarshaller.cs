...
{
    /// <summary>
    /// Response Unmarshaller for GetOriginEndpointPolicy operation
    /// </summary>  
    public class GetOriginEndpointPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetOriginEndpointPolicyResponse response = new GetOriginEndpointPolicyResponse();
        ...
        private static GetOriginEndpointPolicyResponseUnmarshaller _instance = new GetOriginEndpointPolicyResponseUnmarshaller();        

        internal static GetOriginEndpointPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetOriginEndpointPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
