...
{
    /// <summary>
    /// GetOriginEndpoint Request Marshaller
    /// </summary>       
    public class GetOriginEndpointRequestMarshaller : IMarshaller<IRequest, GetOriginEndpointRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetOriginEndpointRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetOriginEndpointRequest publicRequest)
        {
        ...
        private static GetOriginEndpointRequestMarshaller _instance = new GetOriginEndpointRequestMarshaller();        

        internal static GetOriginEndpointRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetOriginEndpointRequestMarshaller Instance
        {
            get
            {
                return _instance;
