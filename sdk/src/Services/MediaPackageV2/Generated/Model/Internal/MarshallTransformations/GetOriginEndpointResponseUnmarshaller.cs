...
namespace Amazon.MediaPackageV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetOriginEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetOriginEndpointResponse response = new GetOriginEndpointResponse();
        ...
        internal static GetOriginEndpointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetOriginEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
