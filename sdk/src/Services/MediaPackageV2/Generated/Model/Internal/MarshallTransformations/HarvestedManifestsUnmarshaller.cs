...
{
    /// <summary>
    /// Response Unmarshaller for HarvestedManifests Object
    /// </summary>  
    public class HarvestedManifestsUnmarshaller : IJsonUnmarshaller<HarvestedManifests, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public HarvestedManifests Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            HarvestedManifests unmarshalledObject = new HarvestedManifests();
        ...
        private static HarvestedManifestsUnmarshaller _instance = new HarvestedManifestsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static HarvestedManifestsUnmarshaller Instance
        {
            get
            {
                return _instance;
