...
{
    /// <summary>
    /// ResetOriginEndpointState Request Marshaller
    /// </summary>       
    public class ResetOriginEndpointStateRequestMarshaller : IMarshaller<IRequest, ResetOriginEndpointStateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ResetOriginEndpointStateRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ResetOriginEndpointStateRequest publicRequest)
        {
            ...
            request.ResourcePath = "/channelGroup/{ChannelGroupName}/channel/{ChannelName}/originEndpoint/{OriginEndpointName}/reset";

            return request;
        }
        private static ResetOriginEndpointStateRequestMarshaller _instance = new ResetOriginEndpointStateRequestMarshaller();        

        internal static ResetOriginEndpointStateRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ResetOriginEndpointStateRequestMarshaller Instance
        {
            get
            {
                return _instance;
