...
namespace Amazon.MediaPackageV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartTagUnmarshaller : IJsonUnmarshaller<StartTag, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public StartTag Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Precise", targetDepth))
                {
                    ...
                    unmarshalledObject.Precise = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
