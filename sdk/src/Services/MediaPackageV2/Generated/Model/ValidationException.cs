...
namespace Amazon.MediaPackageV2.Model
{
    ...
    public partial class ValidationException : AmazonMediaPackageV2Exception
    {
        ...
        {
            get { return this._validationExceptionType; }
            set { this._validationExceptionType = value; }
        }

        // Check to see if ValidationExceptionType property is set
        internal bool IsSetValidationExceptionType()
        {
            return this._validationExceptionType != null;
        }
