...
#elif NETCOREAPP3_1
[assembly: AssemblyDescription("The Amazon Web Services SDK for .NET (.NET Core 3.1) - AWS Elemental MediaPackage v2. Adds support for the MediaPackage Live v2 API")]
#elif NET8_0
[assembly: AssemblyDescription("The Amazon Web Services SDK for .NET (.NET 8.0) - AWS Elemental MediaPackage v2. Adds support for the MediaPackage Live v2 API")]
#else
