...
namespace Amazon.MediaPackageVod.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DashEncryptionUnmarshaller : IJsonUnmarshaller<DashEncryption, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DashEncryption Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
