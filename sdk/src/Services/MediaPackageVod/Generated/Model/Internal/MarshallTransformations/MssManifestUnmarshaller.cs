...
namespace Amazon.MediaPackageVod.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MssManifestUnmarshaller : IJsonUnmarshaller<MssManifest, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MssManifest Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
