...
namespace Amazon.MediaStore.Internal
{
    ...
    public class AmazonMediaStoreAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonMediaStoreAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for MediaStore.
        /// </summary>
        public AmazonMediaStoreAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonMediaStoreAuthSchemeParameters
            {
    ...
    public class AmazonMediaStoreAuthSchemeResolver : IAuthSchemeResolver<AmazonMediaStoreAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonMediaStoreAuthSchemeParameters authParameters)
        {
