...
namespace Amazon.MediaStore.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MetricPolicyUnmarshaller : IJsonUnmarshaller<MetricPolicy, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MetricPolicy Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
