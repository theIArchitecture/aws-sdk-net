...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonMediaStoreConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonMediaStoreConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonMediaStoreConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonMediaStoreConfig to create AmazonMediaStoreClient");
            }

            return awsCredentials == null ? 
                    new AmazonMediaStoreClient(serviceClientConfig) :
                    new AmazonMediaStoreClient(awsCredentials, serviceClientConfig);
        }
