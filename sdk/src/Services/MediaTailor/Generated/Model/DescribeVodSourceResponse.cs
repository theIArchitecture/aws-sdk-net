...
namespace Amazon.MediaTailor.Model
{
    ...
    {
        private List<AdBreakOpportunity> _adBreakOpportunities = AWSConfigs.InitializeCollections ? new List<AdBreakOpportunity>() : null;
        private string _arn;
        ...
        {
            return this._adBreakOpportunities != null && (this._adBreakOpportunities.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
