...
namespace Amazon.MediaTailor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ClipRangeUnmarshaller : IJsonUnmarshaller<ClipRange, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ClipRange Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
                    unmarshalledObject.StartOffsetMillis = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
