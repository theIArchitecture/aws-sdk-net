...
namespace Amazon.MediaTailor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateLiveSourceRequestMarshaller : IMarshaller<IRequest, CreateLiveSourceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static CreateLiveSourceRequestMarshaller _instance = new CreateLiveSourceRequestMarshaller();        

        internal static CreateLiveSourceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLiveSourceRequestMarshaller Instance
        {
            get
            {
                return _instance;
