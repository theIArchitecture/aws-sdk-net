...
{
    /// <summary>
    /// CreateSourceLocation Request Marshaller
    /// </summary>       
    public class CreateSourceLocationRequestMarshaller : IMarshaller<IRequest, CreateSourceLocationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateSourceLocationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateSourceLocationRequest publicRequest)
        {
        ...
        private static CreateSourceLocationRequestMarshaller _instance = new CreateSourceLocationRequestMarshaller();        

        internal static CreateSourceLocationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSourceLocationRequestMarshaller Instance
        {
            get
            {
                return _instance;
