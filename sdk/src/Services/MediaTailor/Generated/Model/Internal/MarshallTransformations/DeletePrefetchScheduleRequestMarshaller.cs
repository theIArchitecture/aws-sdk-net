...
namespace Amazon.MediaTailor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeletePrefetchScheduleRequestMarshaller : IMarshaller<IRequest, DeletePrefetchScheduleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeletePrefetchScheduleRequestMarshaller _instance = new DeletePrefetchScheduleRequestMarshaller();        

        internal static DeletePrefetchScheduleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePrefetchScheduleRequestMarshaller Instance
        {
            get
            {
                return _instance;
