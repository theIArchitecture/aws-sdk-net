...
namespace Amazon.MediaTailor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteSourceLocationRequestMarshaller : IMarshaller<IRequest, DeleteSourceLocationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteSourceLocationRequestMarshaller _instance = new DeleteSourceLocationRequestMarshaller();        

        internal static DeleteSourceLocationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSourceLocationRequestMarshaller Instance
        {
            get
            {
                return _instance;
