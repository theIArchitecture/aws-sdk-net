...
{
    /// <summary>
    /// Response Unmarshaller for DescribeSourceLocation operation
    /// </summary>  
    public class DescribeSourceLocationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeSourceLocationResponse response = new DescribeSourceLocationResponse();
        ...
        private static DescribeSourceLocationResponseUnmarshaller _instance = new DescribeSourceLocationResponseUnmarshaller();        

        internal static DescribeSourceLocationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSourceLocationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
