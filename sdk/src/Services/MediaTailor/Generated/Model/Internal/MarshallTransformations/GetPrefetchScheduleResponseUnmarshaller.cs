...
namespace Amazon.MediaTailor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetPrefetchScheduleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPrefetchScheduleResponse response = new GetPrefetchScheduleResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Consumption", targetDepth))
                {
                    ...
                    response.Consumption = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("Retrieval", targetDepth))
                {
                    ...
                    response.Retrieval = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetPrefetchScheduleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPrefetchScheduleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
