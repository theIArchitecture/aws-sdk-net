...
{
    /// <summary>
    /// ListPrefetchSchedules Request Marshaller
    /// </summary>       
    public class ListPrefetchSchedulesRequestMarshaller : IMarshaller<IRequest, ListPrefetchSchedulesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListPrefetchSchedulesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListPrefetchSchedulesRequest publicRequest)
        {
            ...
            request.ResourcePath = "/prefetchSchedule/{PlaybackConfigurationName}";
#if !NETFRAMEWORK
        ...
        private static ListPrefetchSchedulesRequestMarshaller _instance = new ListPrefetchSchedulesRequestMarshaller();        

        internal static ListPrefetchSchedulesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPrefetchSchedulesRequestMarshaller Instance
        {
            get
            {
                return _instance;
