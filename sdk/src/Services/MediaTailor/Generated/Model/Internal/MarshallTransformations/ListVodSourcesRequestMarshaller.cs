...
{
    /// <summary>
    /// ListVodSources Request Marshaller
    /// </summary>       
    public class ListVodSourcesRequestMarshaller : IMarshaller<IRequest, ListVodSourcesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListVodSourcesRequest)input);
        }
        ...
        private static ListVodSourcesRequestMarshaller _instance = new ListVodSourcesRequestMarshaller();        

        internal static ListVodSourcesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListVodSourcesRequestMarshaller Instance
        {
            get
            {
                return _instance;
