...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSourceLocation operation
    /// </summary>  
    public class UpdateSourceLocationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSourceLocationResponse response = new UpdateSourceLocationResponse();
        ...
        private static UpdateSourceLocationResponseUnmarshaller _instance = new UpdateSourceLocationResponseUnmarshaller();        

        internal static UpdateSourceLocationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSourceLocationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
