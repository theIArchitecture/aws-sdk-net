...
{
    /// <summary>
    /// UpdateVodSource Request Marshaller
    /// </summary>       
    public class UpdateVodSourceRequestMarshaller : IMarshaller<IRequest, UpdateVodSourceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateVodSourceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateVodSourceRequest publicRequest)
        {
        ...
        private static UpdateVodSourceRequestMarshaller _instance = new UpdateVodSourceRequestMarshaller();        

        internal static UpdateVodSourceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateVodSourceRequestMarshaller Instance
        {
            get
            {
                return _instance;
