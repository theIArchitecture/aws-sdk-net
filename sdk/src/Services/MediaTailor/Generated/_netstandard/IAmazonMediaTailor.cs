...
namespace Amazon.MediaTailor
{
    ...
    public partial interface IAmazonMediaTailor : IAmazonService, IDisposable
    {
        ...
        Task<UpdateProgramResponse> UpdateProgramAsync(UpdateProgramRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
