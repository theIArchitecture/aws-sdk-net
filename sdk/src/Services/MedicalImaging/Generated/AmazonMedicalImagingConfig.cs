...
namespace Amazon.MedicalImaging
{
    ...
    public partial class AmazonMedicalImagingConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Medical Imaging", "4.0.3.4");
        ...
        /// Default constructor
        /// </summary>
        public AmazonMedicalImagingConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonMedicalImagingDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "Medical Imaging";
            this.AuthenticationServiceName = "medical-imaging";
            this.EndpointProvider = new AmazonMedicalImagingEndpointProvider();
        }
