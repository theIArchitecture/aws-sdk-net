...
namespace Amazon.MedicalImaging.Internal
{
    ...
    public class AmazonMedicalImagingAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonMedicalImagingAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for MedicalImaging.
        /// </summary>
        public AmazonMedicalImagingAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonMedicalImagingAuthSchemeParameters
            {
    ...
    public class AmazonMedicalImagingAuthSchemeResolver : IAuthSchemeResolver<AmazonMedicalImagingAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonMedicalImagingAuthSchemeParameters authParameters)
        {
