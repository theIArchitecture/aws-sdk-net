...
{
    /// <summary>
    /// Response Unmarshaller for CopyImageSet operation
    /// </summary>  
    public class CopyImageSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CopyImageSetResponse response = new CopyImageSetResponse();
        ...
        private static CopyImageSetResponseUnmarshaller _instance = new CopyImageSetResponseUnmarshaller();        

        internal static CopyImageSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CopyImageSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
