...
namespace Amazon.MedicalImaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteImageSetRequestMarshaller : IMarshaller<IRequest, DeleteImageSetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteImageSetRequestMarshaller _instance = new DeleteImageSetRequestMarshaller();        

        internal static DeleteImageSetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteImageSetRequestMarshaller Instance
        {
            get
            {
                return _instance;
