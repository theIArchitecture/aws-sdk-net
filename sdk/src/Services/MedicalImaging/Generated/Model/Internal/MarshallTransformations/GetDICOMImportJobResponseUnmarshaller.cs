...
{
    /// <summary>
    /// Response Unmarshaller for GetDICOMImportJob operation
    /// </summary>  
    public class GetDICOMImportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDICOMImportJobResponse response = new GetDICOMImportJobResponse();
        ...
        private static GetDICOMImportJobResponseUnmarshaller _instance = new GetDICOMImportJobResponseUnmarshaller();        

        internal static GetDICOMImportJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDICOMImportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
