...
{
    /// <summary>
    /// GetDatastore Request Marshaller
    /// </summary>       
    public class GetDatastoreRequestMarshaller : IMarshaller<IRequest, GetDatastoreRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetDatastoreRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetDatastoreRequest publicRequest)
        {
        ...
        private static GetDatastoreRequestMarshaller _instance = new GetDatastoreRequestMarshaller();        

        internal static GetDatastoreRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDatastoreRequestMarshaller Instance
        {
            get
            {
                return _instance;
