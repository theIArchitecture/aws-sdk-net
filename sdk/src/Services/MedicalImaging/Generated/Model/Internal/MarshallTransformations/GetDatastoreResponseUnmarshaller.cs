...
{
    /// <summary>
    /// Response Unmarshaller for GetDatastore operation
    /// </summary>  
    public class GetDatastoreResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDatastoreResponse response = new GetDatastoreResponse();
        ...
        private static GetDatastoreResponseUnmarshaller _instance = new GetDatastoreResponseUnmarshaller();        

        internal static GetDatastoreResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDatastoreResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
