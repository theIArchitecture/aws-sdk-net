...
{
    /// <summary>
    /// Response Unmarshaller for GetImageFrame operation
    /// </summary>  
    public class GetImageFrameResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetImageFrameResponse response = new GetImageFrameResponse();
            response.ImageFrameBlob = context.Stream;
        ...
        private static GetImageFrameResponseUnmarshaller _instance = new GetImageFrameResponseUnmarshaller();        

        internal static GetImageFrameResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetImageFrameResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
