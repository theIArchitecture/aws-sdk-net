...
{
    /// <summary>
    /// Response Unmarshaller for GetImageSetMetadata operation
    /// </summary>  
    public class GetImageSetMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetImageSetMetadataResponse response = new GetImageSetMetadataResponse();
            response.ImageSetMetadataBlob = context.Stream;
        ...
        private static GetImageSetMetadataResponseUnmarshaller _instance = new GetImageSetMetadataResponseUnmarshaller();        

        internal static GetImageSetMetadataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetImageSetMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
