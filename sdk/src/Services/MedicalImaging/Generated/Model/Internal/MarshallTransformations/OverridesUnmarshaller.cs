...
namespace Amazon.MedicalImaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OverridesUnmarshaller : IJsonUnmarshaller<Overrides, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Overrides Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("forced", targetDepth))
                {
                    ...
                    unmarshalledObject.Forced = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
