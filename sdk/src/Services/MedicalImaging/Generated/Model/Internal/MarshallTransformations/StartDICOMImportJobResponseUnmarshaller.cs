...
{
    /// <summary>
    /// Response Unmarshaller for StartDICOMImportJob operation
    /// </summary>  
    public class StartDICOMImportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartDICOMImportJobResponse response = new StartDICOMImportJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("submittedAt", targetDepth))
                {
                    ...
                    response.SubmittedAt = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static StartDICOMImportJobResponseUnmarshaller _instance = new StartDICOMImportJobResponseUnmarshaller();        

        internal static StartDICOMImportJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartDICOMImportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
