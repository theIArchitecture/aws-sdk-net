...
namespace Amazon.MemoryDB.Internal
{
    ...
    public class AmazonMemoryDBAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonMemoryDBAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for MemoryDB.
        /// </summary>
        public AmazonMemoryDBAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonMemoryDBAuthSchemeParameters
            {
    ...
    public class AmazonMemoryDBAuthSchemeResolver : IAuthSchemeResolver<AmazonMemoryDBAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonMemoryDBAuthSchemeParameters authParameters)
        {
