...
{
    /// <summary>
    /// Response Unmarshaller for DeleteACL operation
    /// </summary>  
    public class DeleteACLResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteACLResponse response = new DeleteACLResponse();
        ...
        private static DeleteACLResponseUnmarshaller _instance = new DeleteACLResponseUnmarshaller();        

        internal static DeleteACLResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteACLResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
