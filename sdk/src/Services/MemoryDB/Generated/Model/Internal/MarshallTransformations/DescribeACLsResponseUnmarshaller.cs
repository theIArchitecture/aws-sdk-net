...
{
    /// <summary>
    /// Response Unmarshaller for DescribeACLs operation
    /// </summary>  
    public class DescribeACLsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeACLsResponse response = new DescribeACLsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ACL, ACLUnmarshaller>(ACLUnmarshaller.Instance);
                    response.ACLs = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeACLsResponseUnmarshaller _instance = new DescribeACLsResponseUnmarshaller();        

        internal static DescribeACLsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeACLsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
