...
{
    /// <summary>
    /// Response Unmarshaller for DescribeEngineVersions operation
    /// </summary>  
    public class DescribeEngineVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeEngineVersionsResponse response = new DescribeEngineVersionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<EngineVersionInfo, EngineVersionInfoUnmarshaller>(EngineVersionInfoUnmarshaller.Instance);
        ...
        private static DescribeEngineVersionsResponseUnmarshaller _instance = new DescribeEngineVersionsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeEngineVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
