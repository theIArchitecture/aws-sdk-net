...
{
    /// <summary>
    /// Response Unmarshaller for DescribeMultiRegionClusters operation
    /// </summary>  
    public class DescribeMultiRegionClustersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeMultiRegionClustersResponse response = new DescribeMultiRegionClustersResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("MultiRegionClusters", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<MultiRegionCluster, MultiRegionClusterUnmarshaller>(MultiRegionClusterUnmarshaller.Instance);
                    response.MultiRegionClusters = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeMultiRegionClustersResponseUnmarshaller _instance = new DescribeMultiRegionClustersResponseUnmarshaller();        

        internal static DescribeMultiRegionClustersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeMultiRegionClustersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
