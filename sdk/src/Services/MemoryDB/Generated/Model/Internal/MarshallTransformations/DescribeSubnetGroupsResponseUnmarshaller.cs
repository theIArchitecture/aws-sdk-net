    ...
    public class DescribeSubnetGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SubnetGroup, SubnetGroupUnmarshaller>(SubnetGroupUnmarshaller.Instance);
                    response.SubnetGroups = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
