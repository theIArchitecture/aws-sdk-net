...
{
    /// <summary>
    /// Response Unmarshaller for FailoverShard operation
    /// </summary>  
    public class FailoverShardResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            FailoverShardResponse response = new FailoverShardResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("APICallRateForCustomerExceededFault"))
                {
                    return APICallRateForCustomerExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("ShardNotFoundFault"))
                {
                    return ShardNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("TestFailoverNotAvailableFault"))
                {
                    return TestFailoverNotAvailableExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
            }
        ...
        private static FailoverShardResponseUnmarshaller _instance = new FailoverShardResponseUnmarshaller();        

        internal static FailoverShardResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static FailoverShardResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
