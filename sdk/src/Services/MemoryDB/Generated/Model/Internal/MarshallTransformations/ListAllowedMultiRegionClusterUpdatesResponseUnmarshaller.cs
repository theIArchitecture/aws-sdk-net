...
{
    /// <summary>
    /// Response Unmarshaller for ListAllowedMultiRegionClusterUpdates operation
    /// </summary>  
    public class ListAllowedMultiRegionClusterUpdatesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAllowedMultiRegionClusterUpdatesResponse response = new ListAllowedMultiRegionClusterUpdatesResponse();
        ...
        private static ListAllowedMultiRegionClusterUpdatesResponseUnmarshaller _instance = new ListAllowedMultiRegionClusterUpdatesResponseUnmarshaller();        

        internal static ListAllowedMultiRegionClusterUpdatesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAllowedMultiRegionClusterUpdatesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
