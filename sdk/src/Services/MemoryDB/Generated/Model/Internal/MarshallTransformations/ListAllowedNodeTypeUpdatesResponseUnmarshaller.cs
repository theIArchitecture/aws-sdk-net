...
{
    /// <summary>
    /// Response Unmarshaller for ListAllowedNodeTypeUpdates operation
    /// </summary>  
    public class ListAllowedNodeTypeUpdatesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAllowedNodeTypeUpdatesResponse response = new ListAllowedNodeTypeUpdatesResponse();
        ...
        private static ListAllowedNodeTypeUpdatesResponseUnmarshaller _instance = new ListAllowedNodeTypeUpdatesResponseUnmarshaller();        

        internal static ListAllowedNodeTypeUpdatesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAllowedNodeTypeUpdatesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
