...
namespace Amazon.MemoryDB.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RecurringChargeUnmarshaller : IJsonUnmarshaller<RecurringCharge, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RecurringCharge Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
