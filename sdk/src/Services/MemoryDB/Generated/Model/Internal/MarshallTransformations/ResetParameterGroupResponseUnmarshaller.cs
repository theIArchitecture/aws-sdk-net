...
{
    /// <summary>
    /// Response Unmarshaller for ResetParameterGroup operation
    /// </summary>  
    public class ResetParameterGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ResetParameterGroupResponse response = new ResetParameterGroupResponse();
        ...
        private static ResetParameterGroupResponseUnmarshaller _instance = new ResetParameterGroupResponseUnmarshaller();        

        internal static ResetParameterGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ResetParameterGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
