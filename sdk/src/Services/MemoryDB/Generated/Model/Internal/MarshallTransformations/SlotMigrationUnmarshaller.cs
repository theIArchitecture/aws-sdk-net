...
namespace Amazon.MemoryDB.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SlotMigrationUnmarshaller : IJsonUnmarshaller<SlotMigration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SlotMigration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
