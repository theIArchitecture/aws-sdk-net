...
{
    /// <summary>
    /// Response Unmarshaller for UpdateACL operation
    /// </summary>  
    public class UpdateACLResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateACLResponse response = new UpdateACLResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return DefaultUserRequiredExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("DuplicateUserNameFault"))
                {
                    return DuplicateUserNameExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static UpdateACLResponseUnmarshaller _instance = new UpdateACLResponseUnmarshaller();        

        internal static UpdateACLResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateACLResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
