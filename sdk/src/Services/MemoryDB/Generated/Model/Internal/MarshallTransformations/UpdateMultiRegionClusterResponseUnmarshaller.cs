...
{
    /// <summary>
    /// Response Unmarshaller for UpdateMultiRegionCluster operation
    /// </summary>  
    public class UpdateMultiRegionClusterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateMultiRegionClusterResponse response = new UpdateMultiRegionClusterResponse();
        ...
        private static UpdateMultiRegionClusterResponseUnmarshaller _instance = new UpdateMultiRegionClusterResponseUnmarshaller();        

        internal static UpdateMultiRegionClusterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMultiRegionClusterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
