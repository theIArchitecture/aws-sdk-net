...
#elif NETCOREAPP3_1
[assembly: AssemblyDescription("The Amazon Web Services SDK for .NET (.NET Core 3.1) - Amazon MemoryDB. AWS MemoryDB  SDK now supports all APIs for newly launched MemoryDB service.")]
#elif NET8_0
[assembly: AssemblyDescription("The Amazon Web Services SDK for .NET (.NET 8.0) - Amazon MemoryDB. AWS MemoryDB  SDK now supports all APIs for newly launched MemoryDB service.")]
#else
