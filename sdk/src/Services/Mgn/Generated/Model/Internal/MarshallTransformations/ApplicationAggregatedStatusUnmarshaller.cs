...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ApplicationAggregatedStatusUnmarshaller : IJsonUnmarshaller<ApplicationAggregatedStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ApplicationAggregatedStatus Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("totalSourceServers", targetDepth))
                {
                    ...
                    unmarshalledObject.TotalSourceServers = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
