...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ArchiveApplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ArchiveApplicationResponse response = new ArchiveApplicationResponse();
        ...
        internal static ArchiveApplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ArchiveApplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
