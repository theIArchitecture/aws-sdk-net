...
{
    /// <summary>
    /// Response Unmarshaller for ArchiveWave operation
    /// </summary>  
    public class ArchiveWaveResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ArchiveWaveResponse response = new ArchiveWaveResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("waveAggregatedStatus", targetDepth))
                {
                    ...
                    response.WaveAggregatedStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ArchiveWaveResponseUnmarshaller _instance = new ArchiveWaveResponseUnmarshaller();        

        internal static ArchiveWaveResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ArchiveWaveResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
