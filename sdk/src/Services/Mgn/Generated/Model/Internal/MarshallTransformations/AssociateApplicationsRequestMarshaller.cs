...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AssociateApplicationsRequestMarshaller : IMarshaller<IRequest, AssociateApplicationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(AssociateApplicationsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/AssociateApplications";
#if !NETFRAMEWORK
        ...
        private static AssociateApplicationsRequestMarshaller _instance = new AssociateApplicationsRequestMarshaller();        

        internal static AssociateApplicationsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateApplicationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
