...
{
    /// <summary>
    /// Response Unmarshaller for AssociateSourceServers operation
    /// </summary>  
    public class AssociateSourceServersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateSourceServersResponse response = new AssociateSourceServersResponse();
        ...
        private static AssociateSourceServersResponseUnmarshaller _instance = new AssociateSourceServersResponseUnmarshaller();        

        internal static AssociateSourceServersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateSourceServersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
