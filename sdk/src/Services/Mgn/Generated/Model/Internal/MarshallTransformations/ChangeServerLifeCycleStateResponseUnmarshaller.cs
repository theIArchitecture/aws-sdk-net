...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ChangeServerLifeCycleStateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ChangeServerLifeCycleStateResponse response = new ChangeServerLifeCycleStateResponse();
        ...
        internal static ChangeServerLifeCycleStateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ChangeServerLifeCycleStateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
