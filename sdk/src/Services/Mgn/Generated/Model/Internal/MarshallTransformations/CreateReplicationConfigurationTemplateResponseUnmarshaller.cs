...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateReplicationConfigurationTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateReplicationConfigurationTemplateResponse response = new CreateReplicationConfigurationTemplateResponse();
        ...
        internal static CreateReplicationConfigurationTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateReplicationConfigurationTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
