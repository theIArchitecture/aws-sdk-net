...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateWaveResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateWaveResponse response = new CreateWaveResponse();
        ...
        internal static CreateWaveResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWaveResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
