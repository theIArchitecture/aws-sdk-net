...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSourceServer operation
    /// </summary>  
    public class DeleteSourceServerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteSourceServerResponseUnmarshaller _instance = new DeleteSourceServerResponseUnmarshaller();        

        internal static DeleteSourceServerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSourceServerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
