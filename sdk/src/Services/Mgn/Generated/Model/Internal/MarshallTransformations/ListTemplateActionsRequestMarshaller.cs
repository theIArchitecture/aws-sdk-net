...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListTemplateActionsRequestMarshaller : IMarshaller<IRequest, ListTemplateActionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListTemplateActionsRequestMarshaller _instance = new ListTemplateActionsRequestMarshaller();        

        internal static ListTemplateActionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTemplateActionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
