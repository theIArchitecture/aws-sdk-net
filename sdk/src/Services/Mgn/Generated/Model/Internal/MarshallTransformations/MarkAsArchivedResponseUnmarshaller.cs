...
{
    /// <summary>
    /// Response Unmarshaller for MarkAsArchived operation
    /// </summary>  
    public class MarkAsArchivedResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            MarkAsArchivedResponse response = new MarkAsArchivedResponse();
        ...
        private static MarkAsArchivedResponseUnmarshaller _instance = new MarkAsArchivedResponseUnmarshaller();        

        internal static MarkAsArchivedResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static MarkAsArchivedResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
