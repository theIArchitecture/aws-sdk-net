...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PauseReplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PauseReplicationResponse response = new PauseReplicationResponse();
        ...
        internal static PauseReplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PauseReplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
