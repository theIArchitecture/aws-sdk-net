...
{
    /// <summary>
    /// Response Unmarshaller for ResumeReplication operation
    /// </summary>  
    public class ResumeReplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ResumeReplicationResponse response = new ResumeReplicationResponse();
        ...
        private static ResumeReplicationResponseUnmarshaller _instance = new ResumeReplicationResponseUnmarshaller();        

        internal static ResumeReplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ResumeReplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
