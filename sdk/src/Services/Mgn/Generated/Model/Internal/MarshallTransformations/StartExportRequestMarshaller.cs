...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class StartExportRequestMarshaller : IMarshaller<IRequest, StartExportRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static StartExportRequestMarshaller _instance = new StartExportRequestMarshaller();        

        internal static StartExportRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartExportRequestMarshaller Instance
        {
            get
            {
                return _instance;
