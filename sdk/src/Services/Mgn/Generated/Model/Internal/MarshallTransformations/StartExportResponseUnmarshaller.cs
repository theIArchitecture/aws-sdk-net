...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartExportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartExportResponse response = new StartExportResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("exportTask", targetDepth))
                {
                    ...
                    response.ExportTask = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static StartExportResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartExportResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
