...
{
    /// <summary>
    /// Response Unmarshaller for StartTest operation
    /// </summary>  
    public class StartTestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static StartTestResponseUnmarshaller _instance = new StartTestResponseUnmarshaller();        

        internal static StartTestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartTestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
