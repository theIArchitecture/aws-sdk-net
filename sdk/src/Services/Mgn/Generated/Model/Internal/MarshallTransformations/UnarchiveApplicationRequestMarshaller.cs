...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UnarchiveApplicationRequestMarshaller : IMarshaller<IRequest, UnarchiveApplicationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static UnarchiveApplicationRequestMarshaller _instance = new UnarchiveApplicationRequestMarshaller();        

        internal static UnarchiveApplicationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UnarchiveApplicationRequestMarshaller Instance
        {
            get
            {
                return _instance;
