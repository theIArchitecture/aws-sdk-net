...
{
    /// <summary>
    /// Response Unmarshaller for UnarchiveApplication operation
    /// </summary>  
    public class UnarchiveApplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UnarchiveApplicationResponse response = new UnarchiveApplicationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("applicationAggregatedStatus", targetDepth))
                {
                    ...
                    response.ApplicationAggregatedStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.LastModifiedDateTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.WaveID = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UnarchiveApplicationResponseUnmarshaller _instance = new UnarchiveApplicationResponseUnmarshaller();        

        internal static UnarchiveApplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UnarchiveApplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
