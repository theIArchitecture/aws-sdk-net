...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UnarchiveWaveResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UnarchiveWaveResponse response = new UnarchiveWaveResponse();
        ...
        internal static UnarchiveWaveResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UnarchiveWaveResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
