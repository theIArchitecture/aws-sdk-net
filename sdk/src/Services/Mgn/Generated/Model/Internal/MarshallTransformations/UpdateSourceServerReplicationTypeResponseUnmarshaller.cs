...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSourceServerReplicationType operation
    /// </summary>  
    public class UpdateSourceServerReplicationTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSourceServerReplicationTypeResponse response = new UpdateSourceServerReplicationTypeResponse();
        ...
        private static UpdateSourceServerReplicationTypeResponseUnmarshaller _instance = new UpdateSourceServerReplicationTypeResponseUnmarshaller();        

        internal static UpdateSourceServerReplicationTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSourceServerReplicationTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
