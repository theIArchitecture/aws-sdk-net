...
namespace Amazon.Mgn.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateWaveResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateWaveResponse response = new UpdateWaveResponse();
        ...
        internal static UpdateWaveResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateWaveResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
