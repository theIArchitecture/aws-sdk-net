...
namespace Amazon.Mgn.Model
{
    ...
    {
        private List<string> _importiDs = AWSConfigs.InitializeCollections ? new List<string>() : null;
        ...
        {
            return this._importiDs != null && (this._importiDs.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
