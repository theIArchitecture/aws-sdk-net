...
{
    /// <summary>
    /// DisassociateSourceResource Request Marshaller
    /// </summary>       
    public class DisassociateSourceResourceRequestMarshaller : IMarshaller<IRequest, DisassociateSourceResourceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DisassociateSourceResourceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DisassociateSourceResourceRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.MigrationHub");
            string target = "AWSMigrationHub.DisassociateSourceResource";
        ...
        private static DisassociateSourceResourceRequestMarshaller _instance = new DisassociateSourceResourceRequestMarshaller();        

        internal static DisassociateSourceResourceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateSourceResourceRequestMarshaller Instance
        {
            get
            {
                return _instance;
