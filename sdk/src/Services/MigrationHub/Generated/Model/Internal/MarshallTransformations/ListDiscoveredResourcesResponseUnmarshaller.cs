    ...
    public class ListDiscoveredResourcesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DiscoveredResource, DiscoveredResourceUnmarshaller>(DiscoveredResourceUnmarshaller.Instance);
                    response.DiscoveredResourceList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
