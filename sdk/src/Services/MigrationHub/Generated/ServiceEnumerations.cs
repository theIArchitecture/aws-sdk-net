...
namespace Amazon.MigrationHub
{
    ...
    public class UpdateType : ConstantClass
    {
        ...
        /// <summary>
        /// Constant MIGRATION_TASK_STATE_UPDATED for UpdateType
        /// </summary>
        public static readonly UpdateType MIGRATION_TASK_STATE_UPDATED = new UpdateType("MIGRATION_TASK_STATE_UPDATED");
