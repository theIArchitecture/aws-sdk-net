...
namespace Amazon.MigrationHub
{
    ...
    public partial class AmazonMigrationHubClient : AmazonServiceClient, IAmazonMigrationHub
    {
        ...
        internal virtual AssociateSourceResourceResponse AssociateSourceResource(AssociateSourceResourceRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual DisassociateSourceResourceResponse DisassociateSourceResource(DisassociateSourceResourceRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual ListMigrationTaskUpdatesResponse ListMigrationTaskUpdates(ListMigrationTaskUpdatesRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
        ...
        internal virtual ListSourceResourcesResponse ListSourceResources(ListSourceResourcesRequest request)
        {
            var options = new Amazon.Runtime.Internal.InvokeOptions();
