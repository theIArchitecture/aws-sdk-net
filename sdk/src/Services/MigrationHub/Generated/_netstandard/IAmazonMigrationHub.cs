...
namespace Amazon.MigrationHub
{
    ...
    public partial interface IAmazonMigrationHub : IAmazonService, IDisposable
    {
        ...
        Task<AssociateSourceResourceResponse> AssociateSourceResourceAsync(AssociateSourceResourceRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DisassociateSourceResourceResponse> DisassociateSourceResourceAsync(DisassociateSourceResourceRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListMigrationTaskUpdatesResponse> ListMigrationTaskUpdatesAsync(ListMigrationTaskUpdatesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListSourceResourcesResponse> ListSourceResourcesAsync(ListSourceResourcesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonMigrationHubConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonMigrationHubConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonMigrationHubConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonMigrationHubConfig to create AmazonMigrationHubClient");
            }

            return awsCredentials == null ? 
                    new AmazonMigrationHubClient(serviceClientConfig) :
                    new AmazonMigrationHubClient(awsCredentials, serviceClientConfig);
        }
