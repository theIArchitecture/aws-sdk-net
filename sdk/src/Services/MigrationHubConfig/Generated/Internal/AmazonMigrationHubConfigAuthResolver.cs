...
namespace Amazon.MigrationHubConfig.Internal
{
    ...
    public class AmazonMigrationHubConfigAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonMigrationHubConfigAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for MigrationHubConfig.
        /// </summary>
        public AmazonMigrationHubConfigAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonMigrationHubConfigAuthSchemeParameters
            {
    ...
    public class AmazonMigrationHubConfigAuthSchemeResolver : IAuthSchemeResolver<AmazonMigrationHubConfigAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonMigrationHubConfigAuthSchemeParameters authParameters)
        {
