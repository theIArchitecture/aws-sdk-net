...
namespace Amazon.MigrationHubConfig
{
    ...
    public partial interface IAmazonMigrationHubConfig : IAmazonService, IDisposable
    {
        ...
        Task<DeleteHomeRegionControlResponse> DeleteHomeRegionControlAsync(DeleteHomeRegionControlRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonMigrationHubConfigConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonMigrationHubConfigConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonMigrationHubConfigConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonMigrationHubConfigConfig to create AmazonMigrationHubConfigClient");
            }

            return awsCredentials == null ? 
                    new AmazonMigrationHubConfigClient(serviceClientConfig) :
                    new AmazonMigrationHubConfigClient(awsCredentials, serviceClientConfig);
        }
