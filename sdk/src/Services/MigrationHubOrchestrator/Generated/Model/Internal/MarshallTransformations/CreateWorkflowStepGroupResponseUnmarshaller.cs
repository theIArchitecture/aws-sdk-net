...
{
    /// <summary>
    /// Response Unmarshaller for CreateWorkflowStepGroup operation
    /// </summary>  
    public class CreateWorkflowStepGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateWorkflowStepGroupResponse response = new CreateWorkflowStepGroupResponse();
        ...
        private static CreateWorkflowStepGroupResponseUnmarshaller _instance = new CreateWorkflowStepGroupResponseUnmarshaller();        

        internal static CreateWorkflowStepGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWorkflowStepGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
