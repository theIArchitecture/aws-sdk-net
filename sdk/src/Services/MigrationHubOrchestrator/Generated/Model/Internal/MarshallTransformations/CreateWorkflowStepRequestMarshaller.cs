...
{
    /// <summary>
    /// CreateWorkflowStep Request Marshaller
    /// </summary>       
    public class CreateWorkflowStepRequestMarshaller : IMarshaller<IRequest, CreateWorkflowStepRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateWorkflowStepRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateWorkflowStepRequest publicRequest)
        {
            ...
            request.ResourcePath = "/workflowstep";
#if !NETFRAMEWORK
        ...
        private static CreateWorkflowStepRequestMarshaller _instance = new CreateWorkflowStepRequestMarshaller();        

        internal static CreateWorkflowStepRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWorkflowStepRequestMarshaller Instance
        {
            get
            {
                return _instance;
