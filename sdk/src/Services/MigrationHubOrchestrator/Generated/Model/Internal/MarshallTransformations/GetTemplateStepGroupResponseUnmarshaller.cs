...
{
    /// <summary>
    /// Response Unmarshaller for GetTemplateStepGroup operation
    /// </summary>  
    public class GetTemplateStepGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTemplateStepGroupResponse response = new GetTemplateStepGroupResponse();
        ...
        private static GetTemplateStepGroupResponseUnmarshaller _instance = new GetTemplateStepGroupResponseUnmarshaller();        

        internal static GetTemplateStepGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTemplateStepGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
