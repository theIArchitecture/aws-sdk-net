...
{
    /// <summary>
    /// GetTemplateStep Request Marshaller
    /// </summary>       
    public class GetTemplateStepRequestMarshaller : IMarshaller<IRequest, GetTemplateStepRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetTemplateStepRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetTemplateStepRequest publicRequest)
        {
            ...
            request.ResourcePath = "/templatestep/{id}";
            request.UseQueryString = true;

            return request;
        }
        private static GetTemplateStepRequestMarshaller _instance = new GetTemplateStepRequestMarshaller();        

        internal static GetTemplateStepRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTemplateStepRequestMarshaller Instance
        {
            get
            {
                return _instance;
