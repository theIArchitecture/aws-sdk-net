...
{
    /// <summary>
    /// Response Unmarshaller for GetWorkflowStepGroup operation
    /// </summary>  
    public class GetWorkflowStepGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetWorkflowStepGroupResponse response = new GetWorkflowStepGroupResponse();
        ...
        private static GetWorkflowStepGroupResponseUnmarshaller _instance = new GetWorkflowStepGroupResponseUnmarshaller();        

        internal static GetWorkflowStepGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetWorkflowStepGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
