...
namespace Amazon.MigrationHubOrchestrator.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MigrationWorkflowSummaryUnmarshaller : IJsonUnmarshaller<MigrationWorkflowSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MigrationWorkflowSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("adsApplicationConfigurationName", targetDepth))
                {
                    ...
                    unmarshalledObject.AdsApplicationConfigurationName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("completedSteps", targetDepth))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.CompletedSteps = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
