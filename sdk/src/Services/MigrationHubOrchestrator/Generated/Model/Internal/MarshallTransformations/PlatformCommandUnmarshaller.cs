...
namespace Amazon.MigrationHubOrchestrator.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PlatformCommandUnmarshaller : IJsonUnmarshaller<PlatformCommand, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PlatformCommand Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
