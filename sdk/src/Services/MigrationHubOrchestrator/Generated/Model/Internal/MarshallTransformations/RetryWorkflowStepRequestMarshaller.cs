...
{
    /// <summary>
    /// RetryWorkflowStep Request Marshaller
    /// </summary>       
    public class RetryWorkflowStepRequestMarshaller : IMarshaller<IRequest, RetryWorkflowStepRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RetryWorkflowStepRequest)input);
        }
        ...
        public IRequest Marshall(RetryWorkflowStepRequest publicRequest)
        {
            ...
            request.ResourcePath = "/retryworkflowstep/{id}";
            request.UseQueryString = true;

            return request;
        }
        private static RetryWorkflowStepRequestMarshaller _instance = new RetryWorkflowStepRequestMarshaller();        

        internal static RetryWorkflowStepRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RetryWorkflowStepRequestMarshaller Instance
        {
            get
            {
                return _instance;
