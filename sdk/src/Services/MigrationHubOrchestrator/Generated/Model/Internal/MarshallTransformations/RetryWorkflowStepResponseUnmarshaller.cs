...
{
    /// <summary>
    /// Response Unmarshaller for RetryWorkflowStep operation
    /// </summary>  
    public class RetryWorkflowStepResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RetryWorkflowStepResponse response = new RetryWorkflowStepResponse();
        ...
        private static RetryWorkflowStepResponseUnmarshaller _instance = new RetryWorkflowStepResponseUnmarshaller();        

        internal static RetryWorkflowStepResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RetryWorkflowStepResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
