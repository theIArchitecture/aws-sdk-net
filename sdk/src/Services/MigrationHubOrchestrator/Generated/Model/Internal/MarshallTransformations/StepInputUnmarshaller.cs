...
namespace Amazon.MigrationHubOrchestrator.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StepInputUnmarshaller : IJsonUnmarshaller<StepInput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public StepInput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("listOfStringsValue", targetDepth))
                {
                    ...
                    unmarshalledObject.ListOfStringsValue = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("mapOfStringValue", targetDepth))
                {
                    var unmarshaller = new JsonDictionaryUnmarshaller<string, string, StringUnmarshaller, StringUnmarshaller>(StringUnmarshaller.Instance, StringUnmarshaller.Instance);
                    unmarshalledObject.MapOfStringValue = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
