...
{
    /// <summary>
    /// Response Unmarshaller for TemplateStepSummary Object
    /// </summary>  
    public class TemplateStepSummaryUnmarshaller : IJsonUnmarshaller<TemplateStepSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TemplateStepSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            TemplateStepSummary unmarshalledObject = new TemplateStepSummary();
        ...
        private static TemplateStepSummaryUnmarshaller _instance = new TemplateStepSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TemplateStepSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
