...
{
    /// <summary>
    /// Response Unmarshaller for UpdateWorkflowStepGroup operation
    /// </summary>  
    public class UpdateWorkflowStepGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateWorkflowStepGroupResponse response = new UpdateWorkflowStepGroupResponse();
        ...
        private static UpdateWorkflowStepGroupResponseUnmarshaller _instance = new UpdateWorkflowStepGroupResponseUnmarshaller();        

        internal static UpdateWorkflowStepGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateWorkflowStepGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
