...
namespace Amazon.MigrationHubOrchestrator.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateWorkflowStepRequestMarshaller : IMarshaller<IRequest, UpdateWorkflowStepRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static UpdateWorkflowStepRequestMarshaller _instance = new UpdateWorkflowStepRequestMarshaller();        

        internal static UpdateWorkflowStepRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateWorkflowStepRequestMarshaller Instance
        {
            get
            {
                return _instance;
