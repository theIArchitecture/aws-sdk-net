...
namespace Amazon.MigrationHubOrchestrator.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class WorkflowStepGroupSummaryUnmarshaller : IJsonUnmarshaller<WorkflowStepGroupSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public WorkflowStepGroupSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
