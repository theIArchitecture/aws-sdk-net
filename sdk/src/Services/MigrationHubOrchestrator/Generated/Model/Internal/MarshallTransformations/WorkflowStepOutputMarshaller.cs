...
{
    /// <summary>
    /// WorkflowStepOutput Marshaller
    /// </summary>
    public class WorkflowStepOutputMarshaller : IRequestMarshaller<WorkflowStepOutput, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(WorkflowStepOutput requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetValue())
            {
                ...
                var marshaller = WorkflowStepOutputUnionMarshaller.Instance;
        ...
        /// </summary>
        public readonly static WorkflowStepOutputMarshaller Instance = new WorkflowStepOutputMarshaller();
