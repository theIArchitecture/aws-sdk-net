...
namespace Amazon.MigrationHubOrchestrator.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class WorkflowStepOutputUnionUnmarshaller : IJsonUnmarshaller<WorkflowStepOutputUnion, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public WorkflowStepOutputUnion Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("listOfStringValue", targetDepth))
                {
                    ...
                    unmarshalledObject.ListOfStringValue = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
