    ...
    public class ApplicationSummaryUnmarshaller : IJsonUnmarshaller<ApplicationSummary, JsonUnmarshallerContext>
    {
        ...
        public ApplicationSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = ApiGatewayProxySummaryUnmarshaller.Instance;
                    unmarshalledObject.ApiGatewayProxy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ProxyType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
