...
#elif NETCOREAPP3_1
[assembly: AssemblyDescription("The Amazon Web Services SDK for .NET (.NET Core 3.1) - AWS Migration Hub Refactor Spaces. This is the initial SDK release for AWS Migration Hub Refactor Spaces")]
#elif NET8_0
[assembly: AssemblyDescription("The Amazon Web Services SDK for .NET (.NET 8.0) - AWS Migration Hub Refactor Spaces. This is the initial SDK release for AWS Migration Hub Refactor Spaces")]
#else
