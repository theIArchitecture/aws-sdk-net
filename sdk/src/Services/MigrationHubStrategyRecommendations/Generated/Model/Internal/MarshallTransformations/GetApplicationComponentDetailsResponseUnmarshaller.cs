...
{
    /// <summary>
    /// Response Unmarshaller for GetApplicationComponentDetails operation
    /// </summary>  
    public class GetApplicationComponentDetailsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetApplicationComponentDetailsResponse response = new GetApplicationComponentDetailsResponse();
        ...
        private static GetApplicationComponentDetailsResponseUnmarshaller _instance = new GetApplicationComponentDetailsResponseUnmarshaller();        

        internal static GetApplicationComponentDetailsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetApplicationComponentDetailsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
