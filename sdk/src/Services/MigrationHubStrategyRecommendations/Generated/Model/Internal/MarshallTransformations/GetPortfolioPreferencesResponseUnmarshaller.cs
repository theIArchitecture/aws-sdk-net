...
{
    /// <summary>
    /// Response Unmarshaller for GetPortfolioPreferences operation
    /// </summary>  
    public class GetPortfolioPreferencesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPortfolioPreferencesResponse response = new GetPortfolioPreferencesResponse();
        ...
        private static GetPortfolioPreferencesResponseUnmarshaller _instance = new GetPortfolioPreferencesResponseUnmarshaller();        

        internal static GetPortfolioPreferencesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPortfolioPreferencesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
