...
namespace Amazon.MigrationHubStrategyRecommendations.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetServerStrategiesRequestMarshaller : IMarshaller<IRequest, GetServerStrategiesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetServerStrategiesRequestMarshaller _instance = new GetServerStrategiesRequestMarshaller();        

        internal static GetServerStrategiesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetServerStrategiesRequestMarshaller Instance
        {
            get
            {
                return _instance;
