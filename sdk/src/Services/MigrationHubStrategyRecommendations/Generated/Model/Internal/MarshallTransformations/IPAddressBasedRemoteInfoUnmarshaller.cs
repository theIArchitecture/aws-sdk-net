...
namespace Amazon.MigrationHubStrategyRecommendations.Model.Internal.MarshallTransformations
{
    ...
    public class IPAddressBasedRemoteInfoUnmarshaller : IJsonUnmarshaller<IPAddressBasedRemoteInfo, JsonUnmarshallerContext>
    {
        ...
        private static IPAddressBasedRemoteInfoUnmarshaller _instance = new IPAddressBasedRemoteInfoUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static IPAddressBasedRemoteInfoUnmarshaller Instance
        {
            get
            {
                return _instance;
