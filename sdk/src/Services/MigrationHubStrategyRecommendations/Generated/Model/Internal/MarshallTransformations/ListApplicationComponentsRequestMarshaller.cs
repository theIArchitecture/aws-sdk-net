...
{
    /// <summary>
    /// ListApplicationComponents Request Marshaller
    /// </summary>       
    public class ListApplicationComponentsRequestMarshaller : IMarshaller<IRequest, ListApplicationComponentsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListApplicationComponentsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListApplicationComponentsRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetApplicationComponentCriteria())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ApplicationComponentCriteria);
            }
        ...
        private static ListApplicationComponentsRequestMarshaller _instance = new ListApplicationComponentsRequestMarshaller();        

        internal static ListApplicationComponentsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListApplicationComponentsRequestMarshaller Instance
        {
            get
            {
                return _instance;
