...
{
    /// <summary>
    /// Response Unmarshaller for ManagementPreference Object
    /// </summary>  
    public class ManagementPreferenceUnmarshaller : IJsonUnmarshaller<ManagementPreference, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ManagementPreference Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ManagementPreference unmarshalledObject = new ManagementPreference();
        ...
        private static ManagementPreferenceUnmarshaller _instance = new ManagementPreferenceUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ManagementPreferenceUnmarshaller Instance
        {
            get
            {
                return _instance;
