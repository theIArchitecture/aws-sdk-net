...
namespace Amazon.MigrationHubStrategyRecommendations.Model.Internal.MarshallTransformations
{
    ...
    public class PrioritizeBusinessGoalsUnmarshaller : IJsonUnmarshaller<PrioritizeBusinessGoals, JsonUnmarshallerContext>
    {
        ...
        private static PrioritizeBusinessGoalsUnmarshaller _instance = new PrioritizeBusinessGoalsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PrioritizeBusinessGoalsUnmarshaller Instance
        {
            get
            {
                return _instance;
