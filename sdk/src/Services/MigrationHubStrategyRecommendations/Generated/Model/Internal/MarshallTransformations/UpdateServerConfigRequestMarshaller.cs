...
namespace Amazon.MigrationHubStrategyRecommendations.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateServerConfigRequestMarshaller : IMarshaller<IRequest, UpdateServerConfigRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static UpdateServerConfigRequestMarshaller _instance = new UpdateServerConfigRequestMarshaller();        

        internal static UpdateServerConfigRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateServerConfigRequestMarshaller Instance
        {
            get
            {
                return _instance;
