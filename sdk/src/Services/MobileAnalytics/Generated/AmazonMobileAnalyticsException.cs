...
namespace Amazon.MobileAnalytics
{
    ...
    public partial class AmazonMobileAnalyticsException : AmazonServiceException
    {
        ...
        public AmazonMobileAnalyticsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonMobileAnalyticsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
