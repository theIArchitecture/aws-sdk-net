...
namespace Amazon.MobileAnalytics.Internal
{
    ...
    public class AmazonMobileAnalyticsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonMobileAnalyticsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for MobileAnalytics.
        /// </summary>
        public AmazonMobileAnalyticsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonMobileAnalyticsAuthSchemeParameters
            {
    ...
    public class AmazonMobileAnalyticsAuthSchemeResolver : IAuthSchemeResolver<AmazonMobileAnalyticsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonMobileAnalyticsAuthSchemeParameters authParameters)
        {
