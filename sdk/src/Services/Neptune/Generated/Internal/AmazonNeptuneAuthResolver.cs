...
namespace Amazon.Neptune.Internal
{
    ...
    public class AmazonNeptuneAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonNeptuneAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Neptune.
        /// </summary>
        public AmazonNeptuneAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonNeptuneAuthSchemeParameters
            {
    ...
    public class AmazonNeptuneAuthSchemeResolver : IAuthSchemeResolver<AmazonNeptuneAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonNeptuneAuthSchemeParameters authParameters)
        {
