...
namespace Amazon.Neptune.Model
{
    ...
    [Serializable]
    #endif
    public partial class GlobalClusterAlreadyExistsException : AmazonNeptuneException
    {
        ...
        public GlobalClusterAlreadyExistsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public GlobalClusterAlreadyExistsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
