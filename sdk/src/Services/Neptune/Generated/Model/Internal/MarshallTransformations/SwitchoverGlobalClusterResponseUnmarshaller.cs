...
{
    /// <summary>
    /// Response Unmarshaller for SwitchoverGlobalCluster operation
    /// </summary>  
    public class SwitchoverGlobalClusterResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SwitchoverGlobalClusterResponse response = new SwitchoverGlobalClusterResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("SwitchoverGlobalClusterResult", 2))
                    {
        ...
        private static SwitchoverGlobalClusterResponseUnmarshaller _instance = new SwitchoverGlobalClusterResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SwitchoverGlobalClusterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
