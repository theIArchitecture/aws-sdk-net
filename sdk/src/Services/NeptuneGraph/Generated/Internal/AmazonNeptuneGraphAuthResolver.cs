...
namespace Amazon.NeptuneGraph.Internal
{
    ...
    public class AmazonNeptuneGraphAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonNeptuneGraphAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for NeptuneGraph.
        /// </summary>
        public AmazonNeptuneGraphAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonNeptuneGraphAuthSchemeParameters
            {
    ...
    public class AmazonNeptuneGraphAuthSchemeResolver : IAuthSchemeResolver<AmazonNeptuneGraphAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonNeptuneGraphAuthSchemeParameters authParameters)
        {
