...
{
    /// <summary>
    /// Response Unmarshaller for CreatePrivateGraphEndpoint operation
    /// </summary>  
    public class CreatePrivateGraphEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePrivateGraphEndpointResponse response = new CreatePrivateGraphEndpointResponse();
        ...
        private static CreatePrivateGraphEndpointResponseUnmarshaller _instance = new CreatePrivateGraphEndpointResponseUnmarshaller();        

        internal static CreatePrivateGraphEndpointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePrivateGraphEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
