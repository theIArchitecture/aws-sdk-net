...
{
    /// <summary>
    /// Response Unmarshaller for GetGraph operation
    /// </summary>  
    public class GetGraphResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetGraphResponseUnmarshaller _instance = new GetGraphResponseUnmarshaller();        

        internal static GetGraphResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGraphResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
