...
namespace Amazon.NeptuneGraph.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetGraphSummaryRequestMarshaller : IMarshaller<IRequest, GetGraphSummaryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetGraphSummaryRequestMarshaller _instance = new GetGraphSummaryRequestMarshaller();        

        internal static GetGraphSummaryRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGraphSummaryRequestMarshaller Instance
        {
            get
            {
                return _instance;
