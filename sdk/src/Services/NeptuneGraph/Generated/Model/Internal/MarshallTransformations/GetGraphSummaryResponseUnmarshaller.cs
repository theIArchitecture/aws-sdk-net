...
{
    /// <summary>
    /// Response Unmarshaller for GetGraphSummary operation
    /// </summary>  
    public class GetGraphSummaryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetGraphSummaryResponse response = new GetGraphSummaryResponse();
        ...
        private static GetGraphSummaryResponseUnmarshaller _instance = new GetGraphSummaryResponseUnmarshaller();        

        internal static GetGraphSummaryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGraphSummaryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
