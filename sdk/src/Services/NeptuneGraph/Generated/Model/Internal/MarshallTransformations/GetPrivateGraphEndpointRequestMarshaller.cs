...
{
    /// <summary>
    /// GetPrivateGraphEndpoint Request Marshaller
    /// </summary>       
    public class GetPrivateGraphEndpointRequestMarshaller : IMarshaller<IRequest, GetPrivateGraphEndpointRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetPrivateGraphEndpointRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetPrivateGraphEndpointRequest publicRequest)
        {
        ...
        private static GetPrivateGraphEndpointRequestMarshaller _instance = new GetPrivateGraphEndpointRequestMarshaller();        

        internal static GetPrivateGraphEndpointRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPrivateGraphEndpointRequestMarshaller Instance
        {
            get
            {
                return _instance;
