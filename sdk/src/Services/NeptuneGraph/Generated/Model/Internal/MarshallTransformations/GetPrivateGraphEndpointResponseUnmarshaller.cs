...
{
    /// <summary>
    /// Response Unmarshaller for GetPrivateGraphEndpoint operation
    /// </summary>  
    public class GetPrivateGraphEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPrivateGraphEndpointResponse response = new GetPrivateGraphEndpointResponse();
        ...
        private static GetPrivateGraphEndpointResponseUnmarshaller _instance = new GetPrivateGraphEndpointResponseUnmarshaller();        

        internal static GetPrivateGraphEndpointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPrivateGraphEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
