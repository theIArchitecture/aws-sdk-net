...
{
    /// <summary>
    /// Response Unmarshaller for GetQuery operation
    /// </summary>  
    public class GetQueryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("elapsed", targetDepth))
                {
                    ...
                    response.Elapsed = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    response.Waited = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetQueryResponseUnmarshaller _instance = new GetQueryResponseUnmarshaller();        

        internal static GetQueryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetQueryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
