...
namespace Amazon.NeptuneGraph.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GraphSummaryUnmarshaller : IJsonUnmarshaller<GraphSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GraphSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
