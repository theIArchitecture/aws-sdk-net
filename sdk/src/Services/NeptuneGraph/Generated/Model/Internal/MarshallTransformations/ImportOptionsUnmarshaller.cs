...
namespace Amazon.NeptuneGraph.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ImportOptionsUnmarshaller : IJsonUnmarshaller<ImportOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ImportOptions Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
