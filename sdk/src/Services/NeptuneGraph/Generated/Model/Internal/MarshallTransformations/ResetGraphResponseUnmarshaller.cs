...
{
    /// <summary>
    /// Response Unmarshaller for ResetGraph operation
    /// </summary>  
    public class ResetGraphResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ResetGraphResponse response = new ResetGraphResponse();
        ...
        private static ResetGraphResponseUnmarshaller _instance = new ResetGraphResponseUnmarshaller();        

        internal static ResetGraphResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ResetGraphResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
