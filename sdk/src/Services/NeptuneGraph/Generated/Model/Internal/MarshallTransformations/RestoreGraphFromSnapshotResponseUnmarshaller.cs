...
{
    /// <summary>
    /// Response Unmarshaller for RestoreGraphFromSnapshot operation
    /// </summary>  
    public class RestoreGraphFromSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RestoreGraphFromSnapshotResponse response = new RestoreGraphFromSnapshotResponse();
        ...
        private static RestoreGraphFromSnapshotResponseUnmarshaller _instance = new RestoreGraphFromSnapshotResponseUnmarshaller();        

        internal static RestoreGraphFromSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RestoreGraphFromSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
