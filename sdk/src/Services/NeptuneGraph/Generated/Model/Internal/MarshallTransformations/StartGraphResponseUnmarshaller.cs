...
{
    /// <summary>
    /// Response Unmarshaller for StartGraph operation
    /// </summary>  
    public class StartGraphResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartGraphResponse response = new StartGraphResponse();
        ...
        private static StartGraphResponseUnmarshaller _instance = new StartGraphResponseUnmarshaller();        

        internal static StartGraphResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartGraphResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
