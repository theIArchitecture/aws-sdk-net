...
namespace Amazon.Neptunedata
{
    ...
    public partial class AmazonNeptunedataConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("neptunedata", "4.0.2.5");
        ...
        /// Default constructor
        /// </summary>
        public AmazonNeptunedataConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonNeptunedataDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "neptunedata";
            this.AuthenticationServiceName = "neptune-db";
            this.EndpointProvider = new AmazonNeptunedataEndpointProvider();
        }
