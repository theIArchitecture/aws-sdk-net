...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CancelGremlinQueryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelGremlinQueryResponse response = new CancelGremlinQueryResponse();
        ...
        internal static CancelGremlinQueryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelGremlinQueryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
