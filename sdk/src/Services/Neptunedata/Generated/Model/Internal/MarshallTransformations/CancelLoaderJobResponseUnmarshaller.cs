...
{
    /// <summary>
    /// Response Unmarshaller for CancelLoaderJob operation
    /// </summary>  
    public class CancelLoaderJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelLoaderJobResponse response = new CancelLoaderJobResponse();
        ...
        private static CancelLoaderJobResponseUnmarshaller _instance = new CancelLoaderJobResponseUnmarshaller();        

        internal static CancelLoaderJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelLoaderJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
