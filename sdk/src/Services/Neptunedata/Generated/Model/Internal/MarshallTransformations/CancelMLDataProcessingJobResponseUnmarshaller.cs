...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CancelMLDataProcessingJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelMLDataProcessingJobResponse response = new CancelMLDataProcessingJobResponse();
        ...
        internal static CancelMLDataProcessingJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelMLDataProcessingJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
