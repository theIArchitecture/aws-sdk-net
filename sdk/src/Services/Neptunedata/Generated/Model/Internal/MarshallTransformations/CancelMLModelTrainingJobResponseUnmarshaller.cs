...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CancelMLModelTrainingJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelMLModelTrainingJobResponse response = new CancelMLModelTrainingJobResponse();
        ...
        internal static CancelMLModelTrainingJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelMLModelTrainingJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
