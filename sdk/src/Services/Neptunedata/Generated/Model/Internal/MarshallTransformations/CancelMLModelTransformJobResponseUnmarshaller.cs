...
{
    /// <summary>
    /// Response Unmarshaller for CancelMLModelTransformJob operation
    /// </summary>  
    public class CancelMLModelTransformJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelMLModelTransformJobResponse response = new CancelMLModelTransformJobResponse();
        ...
        private static CancelMLModelTransformJobResponseUnmarshaller _instance = new CancelMLModelTransformJobResponseUnmarshaller();        

        internal static CancelMLModelTransformJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelMLModelTransformJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
