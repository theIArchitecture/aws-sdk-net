...
{
    /// <summary>
    /// CreateMLEndpoint Request Marshaller
    /// </summary>       
    public class CreateMLEndpointRequestMarshaller : IMarshaller<IRequest, CreateMLEndpointRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateMLEndpointRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateMLEndpointRequest publicRequest)
        {
        ...
        private static CreateMLEndpointRequestMarshaller _instance = new CreateMLEndpointRequestMarshaller();        

        internal static CreateMLEndpointRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMLEndpointRequestMarshaller Instance
        {
            get
            {
                return _instance;
