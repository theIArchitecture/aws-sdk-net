...
{
    /// <summary>
    /// Response Unmarshaller for CreateMLEndpoint operation
    /// </summary>  
    public class CreateMLEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateMLEndpointResponse response = new CreateMLEndpointResponse();
        ...
        private static CreateMLEndpointResponseUnmarshaller _instance = new CreateMLEndpointResponseUnmarshaller();        

        internal static CreateMLEndpointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMLEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
