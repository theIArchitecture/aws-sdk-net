...
{
    /// <summary>
    /// DeleteMLEndpoint Request Marshaller
    /// </summary>       
    public class DeleteMLEndpointRequestMarshaller : IMarshaller<IRequest, DeleteMLEndpointRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteMLEndpointRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteMLEndpointRequest publicRequest)
        {
        ...
        private static DeleteMLEndpointRequestMarshaller _instance = new DeleteMLEndpointRequestMarshaller();        

        internal static DeleteMLEndpointRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteMLEndpointRequestMarshaller Instance
        {
            get
            {
                return _instance;
