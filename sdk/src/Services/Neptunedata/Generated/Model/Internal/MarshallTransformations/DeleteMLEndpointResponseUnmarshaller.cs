...
{
    /// <summary>
    /// Response Unmarshaller for DeleteMLEndpoint operation
    /// </summary>  
    public class DeleteMLEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteMLEndpointResponse response = new DeleteMLEndpointResponse();
        ...
        private static DeleteMLEndpointResponseUnmarshaller _instance = new DeleteMLEndpointResponseUnmarshaller();        

        internal static DeleteMLEndpointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteMLEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
