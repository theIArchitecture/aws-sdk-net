...
{
    /// <summary>
    /// Response Unmarshaller for DeletePropertygraphStatistics operation
    /// </summary>  
    public class DeletePropertygraphStatisticsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeletePropertygraphStatisticsResponse response = new DeletePropertygraphStatisticsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = DeleteStatisticsValueMapUnmarshaller.Instance;
        ...
        private static DeletePropertygraphStatisticsResponseUnmarshaller _instance = new DeletePropertygraphStatisticsResponseUnmarshaller();        

        internal static DeletePropertygraphStatisticsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePropertygraphStatisticsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
