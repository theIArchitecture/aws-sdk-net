...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSparqlStatistics operation
    /// </summary>  
    public class DeleteSparqlStatisticsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSparqlStatisticsResponse response = new DeleteSparqlStatisticsResponse();
        ...
        private static DeleteSparqlStatisticsResponseUnmarshaller _instance = new DeleteSparqlStatisticsResponseUnmarshaller();        

        internal static DeleteSparqlStatisticsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSparqlStatisticsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
