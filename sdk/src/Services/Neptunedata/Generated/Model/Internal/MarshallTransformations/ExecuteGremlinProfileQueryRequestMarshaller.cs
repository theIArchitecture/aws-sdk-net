...
{
    /// <summary>
    /// ExecuteGremlinProfileQuery Request Marshaller
    /// </summary>       
    public class ExecuteGremlinProfileQueryRequestMarshaller : IMarshaller<IRequest, ExecuteGremlinProfileQueryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ExecuteGremlinProfileQueryRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ExecuteGremlinProfileQueryRequest publicRequest)
        {
        ...
        private static ExecuteGremlinProfileQueryRequestMarshaller _instance = new ExecuteGremlinProfileQueryRequestMarshaller();        

        internal static ExecuteGremlinProfileQueryRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExecuteGremlinProfileQueryRequestMarshaller Instance
        {
            get
            {
                return _instance;
