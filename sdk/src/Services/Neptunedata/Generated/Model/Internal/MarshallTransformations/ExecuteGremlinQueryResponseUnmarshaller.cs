...
{
    /// <summary>
    /// Response Unmarshaller for ExecuteGremlinQuery operation
    /// </summary>  
    public class ExecuteGremlinQueryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ExecuteGremlinQueryResponse response = new ExecuteGremlinQueryResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("meta", targetDepth))
                {
                    var unmarshaller = Amazon.Runtime.Documents.Internal.Transform.DocumentUnmarshaller.Instance;
                    response.Meta = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = GremlinQueryStatusAttributesUnmarshaller.Instance;
        ...
        private static ExecuteGremlinQueryResponseUnmarshaller _instance = new ExecuteGremlinQueryResponseUnmarshaller();        

        internal static ExecuteGremlinQueryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExecuteGremlinQueryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
