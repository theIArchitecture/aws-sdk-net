...
{
    /// <summary>
    /// Response Unmarshaller for ExecuteOpenCypherExplainQuery operation
    /// </summary>  
    public class ExecuteOpenCypherExplainQueryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ExecuteOpenCypherExplainQueryResponse response = new ExecuteOpenCypherExplainQueryResponse();
        ...
        private static ExecuteOpenCypherExplainQueryResponseUnmarshaller _instance = new ExecuteOpenCypherExplainQueryResponseUnmarshaller();        

        internal static ExecuteOpenCypherExplainQueryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExecuteOpenCypherExplainQueryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
