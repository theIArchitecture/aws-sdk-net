...
{
    /// <summary>
    /// Response Unmarshaller for ExecuteOpenCypherQuery operation
    /// </summary>  
    public class ExecuteOpenCypherQueryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ExecuteOpenCypherQueryResponse response = new ExecuteOpenCypherQueryResponse();
        ...
        private static ExecuteOpenCypherQueryResponseUnmarshaller _instance = new ExecuteOpenCypherQueryResponseUnmarshaller();        

        internal static ExecuteOpenCypherQueryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExecuteOpenCypherQueryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
