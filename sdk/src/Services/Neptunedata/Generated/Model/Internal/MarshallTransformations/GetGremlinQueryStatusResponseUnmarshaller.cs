...
{
    /// <summary>
    /// Response Unmarshaller for GetGremlinQueryStatus operation
    /// </summary>  
    public class GetGremlinQueryStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetGremlinQueryStatusResponse response = new GetGremlinQueryStatusResponse();
        ...
        private static GetGremlinQueryStatusResponseUnmarshaller _instance = new GetGremlinQueryStatusResponseUnmarshaller();        

        internal static GetGremlinQueryStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGremlinQueryStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
