...
{
    /// <summary>
    /// Response Unmarshaller for GetLoaderJobStatus operation
    /// </summary>  
    public class GetLoaderJobStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetLoaderJobStatusResponse response = new GetLoaderJobStatusResponse();
        ...
        private static GetLoaderJobStatusResponseUnmarshaller _instance = new GetLoaderJobStatusResponseUnmarshaller();        

        internal static GetLoaderJobStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLoaderJobStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
