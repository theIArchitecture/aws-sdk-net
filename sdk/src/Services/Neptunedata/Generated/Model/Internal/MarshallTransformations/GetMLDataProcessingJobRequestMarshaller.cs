...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetMLDataProcessingJobRequestMarshaller : IMarshaller<IRequest, GetMLDataProcessingJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetMLDataProcessingJobRequestMarshaller _instance = new GetMLDataProcessingJobRequestMarshaller();        

        internal static GetMLDataProcessingJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMLDataProcessingJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
