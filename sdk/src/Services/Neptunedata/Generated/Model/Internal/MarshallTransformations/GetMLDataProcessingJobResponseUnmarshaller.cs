...
{
    /// <summary>
    /// Response Unmarshaller for GetMLDataProcessingJob operation
    /// </summary>  
    public class GetMLDataProcessingJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMLDataProcessingJobResponse response = new GetMLDataProcessingJobResponse();
        ...
        private static GetMLDataProcessingJobResponseUnmarshaller _instance = new GetMLDataProcessingJobResponseUnmarshaller();        

        internal static GetMLDataProcessingJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMLDataProcessingJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
