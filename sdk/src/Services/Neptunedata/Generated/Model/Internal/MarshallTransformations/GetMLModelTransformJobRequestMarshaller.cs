...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetMLModelTransformJobRequestMarshaller : IMarshaller<IRequest, GetMLModelTransformJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetMLModelTransformJobRequestMarshaller _instance = new GetMLModelTransformJobRequestMarshaller();        

        internal static GetMLModelTransformJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMLModelTransformJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
