...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetMLModelTransformJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMLModelTransformJobResponse response = new GetMLModelTransformJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("baseProcessingJob", targetDepth))
                {
                    ...
                    response.BaseProcessingJob = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = MlResourceDefinitionUnmarshaller.Instance;
                    response.RemoteModelTransformJob = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetMLModelTransformJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMLModelTransformJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
