...
{
    /// <summary>
    /// Response Unmarshaller for GetOpenCypherQueryStatus operation
    /// </summary>  
    public class GetOpenCypherQueryStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetOpenCypherQueryStatusResponse response = new GetOpenCypherQueryStatusResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("queryEvalStats", targetDepth))
                {
                    ...
                    response.QueryEvalStats = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetOpenCypherQueryStatusResponseUnmarshaller _instance = new GetOpenCypherQueryStatusResponseUnmarshaller();        

        internal static GetOpenCypherQueryStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetOpenCypherQueryStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
