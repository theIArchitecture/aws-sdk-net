...
{
    /// <summary>
    /// Response Unmarshaller for GetPropertygraphStatistics operation
    /// </summary>  
    public class GetPropertygraphStatisticsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPropertygraphStatisticsResponse response = new GetPropertygraphStatisticsResponse();
        ...
        private static GetPropertygraphStatisticsResponseUnmarshaller _instance = new GetPropertygraphStatisticsResponseUnmarshaller();        

        internal static GetPropertygraphStatisticsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPropertygraphStatisticsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
