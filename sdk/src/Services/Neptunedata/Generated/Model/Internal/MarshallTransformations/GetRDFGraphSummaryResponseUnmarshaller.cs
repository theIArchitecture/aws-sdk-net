...
{
    /// <summary>
    /// Response Unmarshaller for GetRDFGraphSummary operation
    /// </summary>  
    public class GetRDFGraphSummaryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRDFGraphSummaryResponse response = new GetRDFGraphSummaryResponse();
        ...
        private static GetRDFGraphSummaryResponseUnmarshaller _instance = new GetRDFGraphSummaryResponseUnmarshaller();        

        internal static GetRDFGraphSummaryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRDFGraphSummaryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
