...
{
    /// <summary>
    /// Response Unmarshaller for GetSparqlStream operation
    /// </summary>  
    public class GetSparqlStreamResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSparqlStreamResponse response = new GetSparqlStreamResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SparqlRecord, SparqlRecordUnmarshaller>(SparqlRecordUnmarshaller.Instance);
        ...
        private static GetSparqlStreamResponseUnmarshaller _instance = new GetSparqlStreamResponseUnmarshaller();        

        internal static GetSparqlStreamResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSparqlStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
