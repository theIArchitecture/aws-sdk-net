...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GremlinQueryStatusUnmarshaller : IJsonUnmarshaller<GremlinQueryStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            GremlinQueryStatus unmarshalledObject = new GremlinQueryStatus();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GremlinQueryStatusUnmarshaller Instance
        {
            get
            {
                return _instance;
