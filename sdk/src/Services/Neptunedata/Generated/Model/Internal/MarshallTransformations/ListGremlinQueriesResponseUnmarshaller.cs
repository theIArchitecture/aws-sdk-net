...
{
    /// <summary>
    /// Response Unmarshaller for ListGremlinQueries operation
    /// </summary>  
    public class ListGremlinQueriesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListGremlinQueriesResponse response = new ListGremlinQueriesResponse();
        ...
        private static ListGremlinQueriesResponseUnmarshaller _instance = new ListGremlinQueriesResponseUnmarshaller();        

        internal static ListGremlinQueriesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListGremlinQueriesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
