...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListMLDataProcessingJobsRequestMarshaller : IMarshaller<IRequest, ListMLDataProcessingJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListMLDataProcessingJobsRequestMarshaller _instance = new ListMLDataProcessingJobsRequestMarshaller();        

        internal static ListMLDataProcessingJobsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMLDataProcessingJobsRequestMarshaller Instance
        {
            get
            {
                return _instance;
