...
{
    /// <summary>
    /// Response Unmarshaller for ListMLEndpoints operation
    /// </summary>  
    public class ListMLEndpointsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMLEndpointsResponse response = new ListMLEndpointsResponse();
        ...
        private static ListMLEndpointsResponseUnmarshaller _instance = new ListMLEndpointsResponseUnmarshaller();        

        internal static ListMLEndpointsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMLEndpointsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
