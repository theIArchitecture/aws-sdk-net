...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListMLModelTrainingJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMLModelTrainingJobsResponse response = new ListMLModelTrainingJobsResponse();
        ...
        internal static ListMLModelTrainingJobsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMLModelTrainingJobsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
