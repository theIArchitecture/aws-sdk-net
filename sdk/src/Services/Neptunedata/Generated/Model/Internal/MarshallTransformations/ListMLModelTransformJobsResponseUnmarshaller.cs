...
{
    /// <summary>
    /// Response Unmarshaller for ListMLModelTransformJobs operation
    /// </summary>  
    public class ListMLModelTransformJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMLModelTransformJobsResponse response = new ListMLModelTransformJobsResponse();
        ...
        private static ListMLModelTransformJobsResponseUnmarshaller _instance = new ListMLModelTransformJobsResponseUnmarshaller();        

        internal static ListMLModelTransformJobsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMLModelTransformJobsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
