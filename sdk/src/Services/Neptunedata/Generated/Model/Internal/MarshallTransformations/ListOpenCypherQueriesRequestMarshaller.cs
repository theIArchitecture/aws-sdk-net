...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListOpenCypherQueriesRequestMarshaller : IMarshaller<IRequest, ListOpenCypherQueriesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListOpenCypherQueriesRequestMarshaller _instance = new ListOpenCypherQueriesRequestMarshaller();        

        internal static ListOpenCypherQueriesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListOpenCypherQueriesRequestMarshaller Instance
        {
            get
            {
                return _instance;
