...
{
    /// <summary>
    /// Response Unmarshaller for ListOpenCypherQueries operation
    /// </summary>  
    public class ListOpenCypherQueriesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListOpenCypherQueriesResponse response = new ListOpenCypherQueriesResponse();
        ...
        private static ListOpenCypherQueriesResponseUnmarshaller _instance = new ListOpenCypherQueriesResponseUnmarshaller();        

        internal static ListOpenCypherQueriesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListOpenCypherQueriesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
