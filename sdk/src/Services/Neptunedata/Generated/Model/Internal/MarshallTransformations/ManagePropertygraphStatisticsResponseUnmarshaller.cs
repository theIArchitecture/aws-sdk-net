...
{
    /// <summary>
    /// Response Unmarshaller for ManagePropertygraphStatistics operation
    /// </summary>  
    public class ManagePropertygraphStatisticsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ManagePropertygraphStatisticsResponse response = new ManagePropertygraphStatisticsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = RefreshStatisticsIdMapUnmarshaller.Instance;
        ...
        private static ManagePropertygraphStatisticsResponseUnmarshaller _instance = new ManagePropertygraphStatisticsResponseUnmarshaller();        

        internal static ManagePropertygraphStatisticsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ManagePropertygraphStatisticsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
