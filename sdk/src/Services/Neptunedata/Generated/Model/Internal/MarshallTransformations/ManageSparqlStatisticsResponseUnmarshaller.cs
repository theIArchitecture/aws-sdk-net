...
{
    /// <summary>
    /// Response Unmarshaller for ManageSparqlStatistics operation
    /// </summary>  
    public class ManageSparqlStatisticsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ManageSparqlStatisticsResponse response = new ManageSparqlStatisticsResponse();
        ...
        private static ManageSparqlStatisticsResponseUnmarshaller _instance = new ManageSparqlStatisticsResponseUnmarshaller();        

        internal static ManageSparqlStatisticsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ManageSparqlStatisticsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
