...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RefreshStatisticsIdMapUnmarshaller : IJsonUnmarshaller<RefreshStatisticsIdMap, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RefreshStatisticsIdMap Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
