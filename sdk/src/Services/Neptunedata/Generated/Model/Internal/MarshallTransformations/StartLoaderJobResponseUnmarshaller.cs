...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartLoaderJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartLoaderJobResponse response = new StartLoaderJobResponse();
        ...
        internal static StartLoaderJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartLoaderJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
