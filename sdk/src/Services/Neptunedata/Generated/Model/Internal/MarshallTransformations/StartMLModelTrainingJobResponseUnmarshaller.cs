...
namespace Amazon.Neptunedata.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartMLModelTrainingJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartMLModelTrainingJobResponse response = new StartMLModelTrainingJobResponse();
        ...
        internal static StartMLModelTrainingJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartMLModelTrainingJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
