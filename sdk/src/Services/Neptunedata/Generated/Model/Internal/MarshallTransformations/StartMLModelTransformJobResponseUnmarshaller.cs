...
{
    /// <summary>
    /// Response Unmarshaller for StartMLModelTransformJob operation
    /// </summary>  
    public class StartMLModelTransformJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartMLModelTransformJobResponse response = new StartMLModelTransformJobResponse();
        ...
        private static StartMLModelTransformJobResponseUnmarshaller _instance = new StartMLModelTransformJobResponseUnmarshaller();        

        internal static StartMLModelTransformJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartMLModelTransformJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
