...
{
    /// <summary>
    /// Response Unmarshaller for AcceptNetworkFirewallTransitGatewayAttachment operation
    /// </summary>  
    public class AcceptNetworkFirewallTransitGatewayAttachmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AcceptNetworkFirewallTransitGatewayAttachmentResponse response = new AcceptNetworkFirewallTransitGatewayAttachmentResponse();
        ...
        private static AcceptNetworkFirewallTransitGatewayAttachmentResponseUnmarshaller _instance = new AcceptNetworkFirewallTransitGatewayAttachmentResponseUnmarshaller();        

        internal static AcceptNetworkFirewallTransitGatewayAttachmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AcceptNetworkFirewallTransitGatewayAttachmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
