...
{
    /// <summary>
    /// AssociateAvailabilityZones Request Marshaller
    /// </summary>       
    public class AssociateAvailabilityZonesRequestMarshaller : IMarshaller<IRequest, AssociateAvailabilityZonesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AssociateAvailabilityZonesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AssociateAvailabilityZonesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.NetworkFirewall");
            string target = "NetworkFirewall_20201112.AssociateAvailabilityZones";
        ...
        private static AssociateAvailabilityZonesRequestMarshaller _instance = new AssociateAvailabilityZonesRequestMarshaller();        

        internal static AssociateAvailabilityZonesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateAvailabilityZonesRequestMarshaller Instance
        {
            get
            {
                return _instance;
