...
{
    /// <summary>
    /// Response Unmarshaller for CreateVpcEndpointAssociation operation
    /// </summary>  
    public class CreateVpcEndpointAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateVpcEndpointAssociationResponse response = new CreateVpcEndpointAssociationResponse();
        ...
        private static CreateVpcEndpointAssociationResponseUnmarshaller _instance = new CreateVpcEndpointAssociationResponseUnmarshaller();        

        internal static CreateVpcEndpointAssociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateVpcEndpointAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
