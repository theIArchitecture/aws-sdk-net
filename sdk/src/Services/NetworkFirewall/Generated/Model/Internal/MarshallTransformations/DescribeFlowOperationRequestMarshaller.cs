...
{
    /// <summary>
    /// DescribeFlowOperation Request Marshaller
    /// </summary>       
    public class DescribeFlowOperationRequestMarshaller : IMarshaller<IRequest, DescribeFlowOperationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeFlowOperationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeFlowOperationRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.NetworkFirewall");
            string target = "NetworkFirewall_20201112.DescribeFlowOperation";
            ...
            if(publicRequest.IsSetFlowOperationId())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.FlowOperationId);
            }
        ...
        private static DescribeFlowOperationRequestMarshaller _instance = new DescribeFlowOperationRequestMarshaller();        

        internal static DescribeFlowOperationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeFlowOperationRequestMarshaller Instance
        {
            get
            {
                return _instance;
