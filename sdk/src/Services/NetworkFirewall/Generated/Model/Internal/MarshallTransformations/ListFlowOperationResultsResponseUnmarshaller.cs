...
{
    /// <summary>
    /// Response Unmarshaller for ListFlowOperationResults operation
    /// </summary>  
    public class ListFlowOperationResultsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListFlowOperationResultsResponse response = new ListFlowOperationResultsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<Flow, FlowUnmarshaller>(FlowUnmarshaller.Instance);
        ...
        private static ListFlowOperationResultsResponseUnmarshaller _instance = new ListFlowOperationResultsResponseUnmarshaller();        

        internal static ListFlowOperationResultsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFlowOperationResultsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
