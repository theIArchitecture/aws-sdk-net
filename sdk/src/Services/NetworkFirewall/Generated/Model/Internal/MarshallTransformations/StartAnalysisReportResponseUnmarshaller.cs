...
{
    /// <summary>
    /// Response Unmarshaller for StartAnalysisReport operation
    /// </summary>  
    public class StartAnalysisReportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartAnalysisReportResponse response = new StartAnalysisReportResponse();
        ...
        private static StartAnalysisReportResponseUnmarshaller _instance = new StartAnalysisReportResponseUnmarshaller();        

        internal static StartAnalysisReportResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartAnalysisReportResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
