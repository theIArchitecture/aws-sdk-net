...
{
    /// <summary>
    /// Response Unmarshaller for StartFlowCapture operation
    /// </summary>  
    public class StartFlowCaptureResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartFlowCaptureResponse response = new StartFlowCaptureResponse();
        ...
        private static StartFlowCaptureResponseUnmarshaller _instance = new StartFlowCaptureResponseUnmarshaller();        

        internal static StartFlowCaptureResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartFlowCaptureResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
