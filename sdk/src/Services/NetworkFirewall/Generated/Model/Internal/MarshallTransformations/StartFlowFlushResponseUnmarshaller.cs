...
{
    /// <summary>
    /// Response Unmarshaller for StartFlowFlush operation
    /// </summary>  
    public class StartFlowFlushResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartFlowFlushResponse response = new StartFlowFlushResponse();
        ...
        private static StartFlowFlushResponseUnmarshaller _instance = new StartFlowFlushResponseUnmarshaller();        

        internal static StartFlowFlushResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartFlowFlushResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
