...
{
    /// <summary>
    /// UpdateFirewallAnalysisSettings Request Marshaller
    /// </summary>       
    public class UpdateFirewallAnalysisSettingsRequestMarshaller : IMarshaller<IRequest, UpdateFirewallAnalysisSettingsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateFirewallAnalysisSettingsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateFirewallAnalysisSettingsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.NetworkFirewall");
            string target = "NetworkFirewall_20201112.UpdateFirewallAnalysisSettings";
        ...
        private static UpdateFirewallAnalysisSettingsRequestMarshaller _instance = new UpdateFirewallAnalysisSettingsRequestMarshaller();        

        internal static UpdateFirewallAnalysisSettingsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFirewallAnalysisSettingsRequestMarshaller Instance
        {
            get
            {
                return _instance;
