...
{
    /// <summary>
    /// Response Unmarshaller for UpdateFirewallAnalysisSettings operation
    /// </summary>  
    public class UpdateFirewallAnalysisSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateFirewallAnalysisSettingsResponse response = new UpdateFirewallAnalysisSettingsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("EnabledAnalysisTypes", targetDepth))
                {
                    ...
                    response.EnabledAnalysisTypes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateFirewallAnalysisSettingsResponseUnmarshaller _instance = new UpdateFirewallAnalysisSettingsResponseUnmarshaller();        

        internal static UpdateFirewallAnalysisSettingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFirewallAnalysisSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
