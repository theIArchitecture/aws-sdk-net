...
namespace Amazon.NetworkFirewall.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VpcEndpointAssociationUnmarshaller : IJsonUnmarshaller<VpcEndpointAssociation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public VpcEndpointAssociation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = SubnetMappingUnmarshaller.Instance;
                ...
                if (context.TestExpression("VpcEndpointAssociationId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.VpcEndpointAssociationId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
