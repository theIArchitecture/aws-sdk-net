...
{
    /// <summary>
    /// GetScope Request Marshaller
    /// </summary>       
    public class GetScopeRequestMarshaller : IMarshaller<IRequest, GetScopeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetScopeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetScopeRequest publicRequest)
        {
        ...
        private static GetScopeRequestMarshaller _instance = new GetScopeRequestMarshaller();        

        internal static GetScopeRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetScopeRequestMarshaller Instance
        {
            get
            {
                return _instance;
