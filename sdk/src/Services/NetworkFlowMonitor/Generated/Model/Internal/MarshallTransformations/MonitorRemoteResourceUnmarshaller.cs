...
namespace Amazon.NetworkFlowMonitor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MonitorRemoteResourceUnmarshaller : IJsonUnmarshaller<MonitorRemoteResource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MonitorRemoteResource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
