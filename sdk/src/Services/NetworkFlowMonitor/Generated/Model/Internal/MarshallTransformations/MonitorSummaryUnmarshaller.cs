...
namespace Amazon.NetworkFlowMonitor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MonitorSummaryUnmarshaller : IJsonUnmarshaller<MonitorSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MonitorSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.MonitorStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static MonitorSummaryUnmarshaller _instance = new MonitorSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static MonitorSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
