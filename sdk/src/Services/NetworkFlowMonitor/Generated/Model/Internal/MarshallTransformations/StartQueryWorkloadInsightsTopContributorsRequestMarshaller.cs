...
{
    /// <summary>
    /// StartQueryWorkloadInsightsTopContributors Request Marshaller
    /// </summary>       
    public class StartQueryWorkloadInsightsTopContributorsRequestMarshaller : IMarshaller<IRequest, StartQueryWorkloadInsightsTopContributorsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartQueryWorkloadInsightsTopContributorsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartQueryWorkloadInsightsTopContributorsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/workloadInsights/{scopeId}/topContributorsQueries";
#if !NETFRAMEWORK
        ...
        private static StartQueryWorkloadInsightsTopContributorsRequestMarshaller _instance = new StartQueryWorkloadInsightsTopContributorsRequestMarshaller();        

        internal static StartQueryWorkloadInsightsTopContributorsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartQueryWorkloadInsightsTopContributorsRequestMarshaller Instance
        {
            get
            {
                return _instance;
