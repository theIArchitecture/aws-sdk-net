...
{
    /// <summary>
    /// Response Unmarshaller for TraversedComponent Object
    /// </summary>  
    public class TraversedComponentUnmarshaller : IJsonUnmarshaller<TraversedComponent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TraversedComponent Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            TraversedComponent unmarshalledObject = new TraversedComponent();
        ...
        private static TraversedComponentUnmarshaller _instance = new TraversedComponentUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TraversedComponentUnmarshaller Instance
        {
            get
            {
                return _instance;
