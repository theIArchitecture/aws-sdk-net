...
namespace Amazon.NetworkManager.Internal
{
    ...
    public class AmazonNetworkManagerAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonNetworkManagerAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for NetworkManager.
        /// </summary>
        public AmazonNetworkManagerAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonNetworkManagerAuthSchemeParameters
            {
    ...
    public class AmazonNetworkManagerAuthSchemeResolver : IAuthSchemeResolver<AmazonNetworkManagerAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonNetworkManagerAuthSchemeParameters authParameters)
        {
