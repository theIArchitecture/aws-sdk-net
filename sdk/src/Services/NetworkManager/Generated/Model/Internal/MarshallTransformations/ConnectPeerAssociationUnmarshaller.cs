...
{
    /// <summary>
    /// Response Unmarshaller for ConnectPeerAssociation Object
    /// </summary>  
    public class ConnectPeerAssociationUnmarshaller : IJsonUnmarshaller<ConnectPeerAssociation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ConnectPeerAssociation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static ConnectPeerAssociationUnmarshaller _instance = new ConnectPeerAssociationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ConnectPeerAssociationUnmarshaller Instance
        {
            get
            {
                return _instance;
