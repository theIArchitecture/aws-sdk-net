...
namespace Amazon.NetworkManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DisassociateConnectPeerRequestMarshaller : IMarshaller<IRequest, DisassociateConnectPeerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DisassociateConnectPeerRequestMarshaller _instance = new DisassociateConnectPeerRequestMarshaller();        

        internal static DisassociateConnectPeerRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateConnectPeerRequestMarshaller Instance
        {
            get
            {
                return _instance;
