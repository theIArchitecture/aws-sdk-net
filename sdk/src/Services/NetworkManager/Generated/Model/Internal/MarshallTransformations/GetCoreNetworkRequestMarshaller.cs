...
namespace Amazon.NetworkManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetCoreNetworkRequestMarshaller : IMarshaller<IRequest, GetCoreNetworkRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetCoreNetworkRequestMarshaller _instance = new GetCoreNetworkRequestMarshaller();        

        internal static GetCoreNetworkRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCoreNetworkRequestMarshaller Instance
        {
            get
            {
                return _instance;
