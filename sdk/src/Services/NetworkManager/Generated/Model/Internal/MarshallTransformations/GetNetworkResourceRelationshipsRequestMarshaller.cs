...
namespace Amazon.NetworkManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetNetworkResourceRelationshipsRequestMarshaller : IMarshaller<IRequest, GetNetworkResourceRelationshipsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetNetworkResourceRelationshipsRequestMarshaller _instance = new GetNetworkResourceRelationshipsRequestMarshaller();        

        internal static GetNetworkResourceRelationshipsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetNetworkResourceRelationshipsRequestMarshaller Instance
        {
            get
            {
                return _instance;
