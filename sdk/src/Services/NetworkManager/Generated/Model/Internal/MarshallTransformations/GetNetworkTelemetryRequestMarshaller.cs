...
namespace Amazon.NetworkManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetNetworkTelemetryRequestMarshaller : IMarshaller<IRequest, GetNetworkTelemetryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetNetworkTelemetryRequestMarshaller _instance = new GetNetworkTelemetryRequestMarshaller();        

        internal static GetNetworkTelemetryRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetNetworkTelemetryRequestMarshaller Instance
        {
            get
            {
                return _instance;
