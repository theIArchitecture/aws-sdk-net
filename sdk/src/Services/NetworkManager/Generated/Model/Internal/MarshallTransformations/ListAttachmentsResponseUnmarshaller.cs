...
{
    /// <summary>
    /// Response Unmarshaller for ListAttachments operation
    /// </summary>  
    public class ListAttachmentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListAttachmentsResponseUnmarshaller _instance = new ListAttachmentsResponseUnmarshaller();        

        internal static ListAttachmentsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAttachmentsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
