...
namespace Amazon.NetworkManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PathComponentUnmarshaller : IJsonUnmarshaller<PathComponent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PathComponent Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = NetworkResourceSummaryUnmarshaller.Instance;
