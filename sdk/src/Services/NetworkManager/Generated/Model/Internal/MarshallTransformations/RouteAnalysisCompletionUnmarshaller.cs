...
namespace Amazon.NetworkManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RouteAnalysisCompletionUnmarshaller : IJsonUnmarshaller<RouteAnalysisCompletion, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RouteAnalysisCompletion Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ReasonContext", targetDepth))
                {
                    ...
                    unmarshalledObject.ReasonContext = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
