...
namespace Amazon.NetworkManager.Model.Internal.MarshallTransformations
{
    ...
    public class RouteAnalysisEndpointOptionsSpecificationMarshaller : IRequestMarshaller<RouteAnalysisEndpointOptionsSpecification, JsonMarshallerContext> 
    {
        ...
        public void Marshall(RouteAnalysisEndpointOptionsSpecification requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetTransitGatewayAttachmentArn())
            {
                context.Writer.WritePropertyName("TransitGatewayAttachmentArn");
                context.Writer.WriteStringValue(requestObject.TransitGatewayAttachmentArn);
            }
