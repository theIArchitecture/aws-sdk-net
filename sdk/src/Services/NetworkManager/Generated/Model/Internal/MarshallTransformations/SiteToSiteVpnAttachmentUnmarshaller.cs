...
namespace Amazon.NetworkManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SiteToSiteVpnAttachmentUnmarshaller : IJsonUnmarshaller<SiteToSiteVpnAttachment, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SiteToSiteVpnAttachment Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("VpnConnectionArn", targetDepth))
                {
                    ...
                    unmarshalledObject.VpnConnectionArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
