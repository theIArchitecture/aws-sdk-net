...
namespace Amazon.NetworkManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TransitGatewayConnectPeerAssociationUnmarshaller : IJsonUnmarshaller<TransitGatewayConnectPeerAssociation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TransitGatewayConnectPeerAssociation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TransitGatewayConnectPeerArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
