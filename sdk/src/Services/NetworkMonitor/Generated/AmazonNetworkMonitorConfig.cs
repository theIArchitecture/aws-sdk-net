...
namespace Amazon.NetworkMonitor
{
    ...
    public partial class AmazonNetworkMonitorConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("NetworkMonitor", "4.0.1.5");
        ...
        /// Default constructor
        /// </summary>
        public AmazonNetworkMonitorConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonNetworkMonitorDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "NetworkMonitor";
            this.AuthenticationServiceName = "networkmonitor";
            this.EndpointProvider = new AmazonNetworkMonitorEndpointProvider();
        }
