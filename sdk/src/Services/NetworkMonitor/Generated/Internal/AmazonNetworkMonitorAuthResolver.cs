...
namespace Amazon.NetworkMonitor.Internal
{
    ...
    public class AmazonNetworkMonitorAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonNetworkMonitorAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for NetworkMonitor.
        /// </summary>
        public AmazonNetworkMonitorAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonNetworkMonitorAuthSchemeParameters
            {
    ...
    public class AmazonNetworkMonitorAuthSchemeResolver : IAuthSchemeResolver<AmazonNetworkMonitorAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonNetworkMonitorAuthSchemeParameters authParameters)
        {
