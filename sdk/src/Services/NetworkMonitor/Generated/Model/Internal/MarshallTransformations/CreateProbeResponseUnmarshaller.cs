...
namespace Amazon.NetworkMonitor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateProbeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateProbeResponse response = new CreateProbeResponse();
        ...
        private static CreateProbeResponseUnmarshaller _instance = new CreateProbeResponseUnmarshaller();        

        internal static CreateProbeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateProbeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
