...
namespace Amazon.NetworkMonitor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteProbeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteProbeResponse response = new DeleteProbeResponse();
        ...
        private static DeleteProbeResponseUnmarshaller _instance = new DeleteProbeResponseUnmarshaller();        

        internal static DeleteProbeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteProbeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
