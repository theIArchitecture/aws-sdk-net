...
namespace Amazon.NetworkMonitor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetProbeRequestMarshaller : IMarshaller<IRequest, GetProbeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetProbeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetProbeRequest publicRequest)
        {
        ...
        private static GetProbeRequestMarshaller _instance = new GetProbeRequestMarshaller();        

        internal static GetProbeRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetProbeRequestMarshaller Instance
        {
            get
            {
                return _instance;
