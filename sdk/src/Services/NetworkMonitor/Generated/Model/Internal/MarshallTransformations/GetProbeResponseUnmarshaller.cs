...
namespace Amazon.NetworkMonitor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetProbeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetProbeResponse response = new GetProbeResponse();
        ...
        private static GetProbeResponseUnmarshaller _instance = new GetProbeResponseUnmarshaller();        

        internal static GetProbeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetProbeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
