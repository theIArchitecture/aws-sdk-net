...
namespace Amazon.Notifications.Internal
{
    ...
    public class AmazonNotificationsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonNotificationsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Notifications.
        /// </summary>
        public AmazonNotificationsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonNotificationsAuthSchemeParameters
            {
    ...
    public class AmazonNotificationsAuthSchemeResolver : IAuthSchemeResolver<AmazonNotificationsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonNotificationsAuthSchemeParameters authParameters)
        {
