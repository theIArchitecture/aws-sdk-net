...
namespace Amazon.Notifications.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssociateChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateChannelResponse response = new AssociateChannelResponse();
        ...
        private static AssociateChannelResponseUnmarshaller _instance = new AssociateChannelResponseUnmarshaller();        

        internal static AssociateChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
