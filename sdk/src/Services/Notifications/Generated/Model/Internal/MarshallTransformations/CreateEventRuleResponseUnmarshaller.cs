...
namespace Amazon.Notifications.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateEventRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateEventRuleResponse response = new CreateEventRuleResponse();
        ...
        private static CreateEventRuleResponseUnmarshaller _instance = new CreateEventRuleResponseUnmarshaller();        

        internal static CreateEventRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateEventRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
