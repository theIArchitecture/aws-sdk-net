...
namespace Amazon.Notifications.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeregisterNotificationHubResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeregisterNotificationHubResponse response = new DeregisterNotificationHubResponse();
        ...
        private static DeregisterNotificationHubResponseUnmarshaller _instance = new DeregisterNotificationHubResponseUnmarshaller();        

        internal static DeregisterNotificationHubResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeregisterNotificationHubResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
