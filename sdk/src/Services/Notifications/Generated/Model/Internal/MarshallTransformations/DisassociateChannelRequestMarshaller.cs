...
namespace Amazon.Notifications.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DisassociateChannelRequestMarshaller : IMarshaller<IRequest, DisassociateChannelRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DisassociateChannelRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DisassociateChannelRequest publicRequest)
        {
            ...
            request.ResourcePath = "/channels/disassociate/{arn}";
#if !NETFRAMEWORK
        ...
        private static DisassociateChannelRequestMarshaller _instance = new DisassociateChannelRequestMarshaller();        

        internal static DisassociateChannelRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateChannelRequestMarshaller Instance
        {
            get
            {
                return _instance;
