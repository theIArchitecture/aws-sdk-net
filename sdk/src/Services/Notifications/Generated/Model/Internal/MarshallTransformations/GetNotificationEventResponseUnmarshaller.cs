...
namespace Amazon.Notifications.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetNotificationEventResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = NotificationEventUnmarshaller.Instance;
        ...
        private static GetNotificationEventResponseUnmarshaller _instance = new GetNotificationEventResponseUnmarshaller();        

        internal static GetNotificationEventResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetNotificationEventResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
