...
namespace Amazon.Notifications.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListNotificationEventsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListNotificationEventsResponse response = new ListNotificationEventsResponse();
        ...
        private static ListNotificationEventsResponseUnmarshaller _instance = new ListNotificationEventsResponseUnmarshaller();        

        internal static ListNotificationEventsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListNotificationEventsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
