...
namespace Amazon.Notifications.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NotificationEventSummaryUnmarshaller : IJsonUnmarshaller<NotificationEventSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NotificationEventSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
