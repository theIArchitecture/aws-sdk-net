...
namespace Amazon.Notifications.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RegisterNotificationHubResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RegisterNotificationHubResponse response = new RegisterNotificationHubResponse();
        ...
        private static RegisterNotificationHubResponseUnmarshaller _instance = new RegisterNotificationHubResponseUnmarshaller();        

        internal static RegisterNotificationHubResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterNotificationHubResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
