...
namespace Amazon.Notifications.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateEventRuleRequestMarshaller : IMarshaller<IRequest, UpdateEventRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateEventRuleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateEventRuleRequest publicRequest)
        {
        ...
        private static UpdateEventRuleRequestMarshaller _instance = new UpdateEventRuleRequestMarshaller();        

        internal static UpdateEventRuleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateEventRuleRequestMarshaller Instance
        {
            get
            {
                return _instance;
