...
namespace Amazon.Notifications.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateEventRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateEventRuleResponse response = new UpdateEventRuleResponse();
        ...
        private static UpdateEventRuleResponseUnmarshaller _instance = new UpdateEventRuleResponseUnmarshaller();        

        internal static UpdateEventRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateEventRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
