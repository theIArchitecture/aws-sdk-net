...
{
    /// <summary>
    /// Container for the parameters to the ListManagedNotificationChannelAssociations operation.
    /// Returns a list of Account contacts and Channels associated with a <c>ManagedNotificationConfiguration</c>,
    /// in paginated format.
    /// </summary>
    public partial class ListManagedNotificationChannelAssociationsRequest : AmazonNotificationsRequest
    {
        ...
        /// <para>
        /// The Amazon Resource Name (ARN) of the <c>ManagedNotificationConfiguration</c> to match.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// The start token for paginated calls. Retrieved from the response of a previous <c>ListManagedNotificationChannelAssociations</c>
        /// call.
        /// </para>
        /// </summary>
