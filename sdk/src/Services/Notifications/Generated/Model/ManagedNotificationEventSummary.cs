...
{
    /// <summary>
    /// A short summary of a <c>ManagedNotificationEvent</c>. This is only used when listing
    /// managed notification events.
    /// </summary>
    public partial class ManagedNotificationEventSummary
    {
        ...
        /// <para>
        /// The schema version of the <c>ManagedNotificationEvent</c>.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
        ...
        /// <para>
        /// Contains metadata about the event that caused the <c>ManagedNotificationEvent</c>.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
