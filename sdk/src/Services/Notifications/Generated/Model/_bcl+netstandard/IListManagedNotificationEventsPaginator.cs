...
namespace Amazon.Notifications.Model
{
    ...
    public interface IListManagedNotificationEventsPaginator
    {
        ...
        /// </summary>
        IPaginatedEnumerable<ListManagedNotificationEventsResponse> Responses { get; }

        /// <summary>
        /// Enumerable containing all of the ManagedNotificationEvents
        /// </summary>
        IPaginatedEnumerable<ManagedNotificationEventOverview> ManagedNotificationEvents { get; }
    }
}