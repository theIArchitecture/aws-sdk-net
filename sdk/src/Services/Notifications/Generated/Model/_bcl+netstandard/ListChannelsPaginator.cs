...
namespace Amazon.Notifications.Model
{
    ...
    internal sealed partial class ListChannelsPaginator : IPaginator<ListChannelsResponse>, IListChannelsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<string> Channels => 
            new PaginatedResultKeyResponse<ListChannelsResponse, string>(this, (i) => i.Channels ?? new List<string>());

        internal ListChannelsPaginator(IAmazonNotifications client, ListChannelsRequest request)
        {
            this._client = client;
