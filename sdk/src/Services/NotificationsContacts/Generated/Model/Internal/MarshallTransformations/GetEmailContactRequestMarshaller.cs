...
{
    /// <summary>
    /// GetEmailContact Request Marshaller
    /// </summary>       
    public class GetEmailContactRequestMarshaller : IMarshaller<IRequest, GetEmailContactRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetEmailContactRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetEmailContactRequest publicRequest)
        {
        ...
        private static GetEmailContactRequestMarshaller _instance = new GetEmailContactRequestMarshaller();        

        internal static GetEmailContactRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEmailContactRequestMarshaller Instance
        {
            get
            {
                return _instance;
