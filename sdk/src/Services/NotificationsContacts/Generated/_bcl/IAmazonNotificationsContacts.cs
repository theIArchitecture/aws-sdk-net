...
namespace Amazon.NotificationsContacts
{
    ...
    public partial interface IAmazonNotificationsContacts : IAmazonService, IDisposable
    {
        ...
        ActivateEmailContactResponse ActivateEmailContact(ActivateEmailContactRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/notificationscontacts-2018-05-10/ActivateEmailContact">REST API Reference for ActivateEmailContact Operation</seealso>
        Task<ActivateEmailContactResponse> ActivateEmailContactAsync(ActivateEmailContactRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        CreateEmailContactResponse CreateEmailContact(CreateEmailContactRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/notificationscontacts-2018-05-10/CreateEmailContact">REST API Reference for CreateEmailContact Operation</seealso>
        Task<CreateEmailContactResponse> CreateEmailContactAsync(CreateEmailContactRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        DeleteEmailContactResponse DeleteEmailContact(DeleteEmailContactRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/notificationscontacts-2018-05-10/DeleteEmailContact">REST API Reference for DeleteEmailContact Operation</seealso>
        Task<DeleteEmailContactResponse> DeleteEmailContactAsync(DeleteEmailContactRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        GetEmailContactResponse GetEmailContact(GetEmailContactRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/notificationscontacts-2018-05-10/GetEmailContact">REST API Reference for GetEmailContact Operation</seealso>
        Task<GetEmailContactResponse> GetEmailContactAsync(GetEmailContactRequest request, CancellationToken cancellationToken = default(CancellationToken));
        ...
        ListEmailContactsResponse ListEmailContacts(ListEmailContactsRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/notificationscontacts-2018-05-10/ListEmailContacts">REST API Reference for ListEmailContacts Operation</seealso>
        Task<ListEmailContactsResponse> ListEmailContactsAsync(ListEmailContactsRequest request, CancellationToken cancellationToken = default(CancellationToken));
