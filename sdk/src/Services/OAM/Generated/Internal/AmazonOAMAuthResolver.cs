...
namespace Amazon.OAM.Internal
{
    ...
    public class AmazonOAMAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonOAMAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for OAM.
        /// </summary>
        public AmazonOAMAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonOAMAuthSchemeParameters
            {
    ...
    public class AmazonOAMAuthSchemeResolver : IAuthSchemeResolver<AmazonOAMAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonOAMAuthSchemeParameters authParameters)
        {
