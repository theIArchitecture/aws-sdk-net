...
namespace Amazon.OAM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateSinkRequestMarshaller : IMarshaller<IRequest, CreateSinkRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static CreateSinkRequestMarshaller _instance = new CreateSinkRequestMarshaller();        

        internal static CreateSinkRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSinkRequestMarshaller Instance
        {
            get
            {
                return _instance;
