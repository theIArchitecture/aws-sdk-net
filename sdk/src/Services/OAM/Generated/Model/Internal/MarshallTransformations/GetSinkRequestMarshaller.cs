...
{
    /// <summary>
    /// GetSink Request Marshaller
    /// </summary>       
    public class GetSinkRequestMarshaller : IMarshaller<IRequest, GetSinkRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetSinkRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetSinkRequest publicRequest)
        {
        ...
        private static GetSinkRequestMarshaller _instance = new GetSinkRequestMarshaller();        

        internal static GetSinkRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSinkRequestMarshaller Instance
        {
            get
            {
                return _instance;
