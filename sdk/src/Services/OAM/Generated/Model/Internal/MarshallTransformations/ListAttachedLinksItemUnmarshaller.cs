...
{
    /// <summary>
    /// Response Unmarshaller for ListAttachedLinksItem Object
    /// </summary>  
    public class ListAttachedLinksItemUnmarshaller : IJsonUnmarshaller<ListAttachedLinksItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ListAttachedLinksItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static ListAttachedLinksItemUnmarshaller _instance = new ListAttachedLinksItemUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ListAttachedLinksItemUnmarshaller Instance
        {
            get
            {
                return _instance;
