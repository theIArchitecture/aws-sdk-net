...
namespace Amazon.OAM.Model
{
    ...
    [Serializable]
    #endif
    public partial class MissingRequiredParameterException : AmazonOAMException
    {
        ...
        public MissingRequiredParameterException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public MissingRequiredParameterException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
