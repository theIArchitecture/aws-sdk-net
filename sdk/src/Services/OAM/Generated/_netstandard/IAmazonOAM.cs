...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonOAMConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonOAMConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonOAMConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonOAMConfig to create AmazonOAMClient");
            }

            return awsCredentials == null ? 
                    new AmazonOAMClient(serviceClientConfig) :
                    new AmazonOAMClient(awsCredentials, serviceClientConfig);
        }
