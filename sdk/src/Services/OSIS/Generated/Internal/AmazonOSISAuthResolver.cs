...
namespace Amazon.OSIS.Internal
{
    ...
    public class AmazonOSISAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonOSISAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for OSIS.
        /// </summary>
        public AmazonOSISAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonOSISAuthSchemeParameters
            {
    ...
    public class AmazonOSISAuthSchemeResolver : IAuthSchemeResolver<AmazonOSISAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonOSISAuthSchemeParameters authParameters)
        {
