...
{
    /// <summary>
    /// BufferOptions Marshaller
    /// </summary>
    public class BufferOptionsMarshaller : IRequestMarshaller<BufferOptions, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(BufferOptions requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetPersistentBufferEnabled())
            {
                ...
                context.Writer.WriteBooleanValue(requestObject.PersistentBufferEnabled.Value);
            }
        ...
        /// </summary>
        public readonly static BufferOptionsMarshaller Instance = new BufferOptionsMarshaller();
