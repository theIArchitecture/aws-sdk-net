...
{
    /// <summary>
    /// Response Unmarshaller for CreatePipelineEndpoint operation
    /// </summary>  
    public class CreatePipelineEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePipelineEndpointResponse response = new CreatePipelineEndpointResponse();
        ...
        private static CreatePipelineEndpointResponseUnmarshaller _instance = new CreatePipelineEndpointResponseUnmarshaller();        

        internal static CreatePipelineEndpointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePipelineEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
