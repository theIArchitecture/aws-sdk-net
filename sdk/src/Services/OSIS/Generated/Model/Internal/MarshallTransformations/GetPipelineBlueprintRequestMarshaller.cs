...
{
    /// <summary>
    /// GetPipelineBlueprint Request Marshaller
    /// </summary>       
    public class GetPipelineBlueprintRequestMarshaller : IMarshaller<IRequest, GetPipelineBlueprintRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetPipelineBlueprintRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetPipelineBlueprintRequest publicRequest)
        {
        ...
        private static GetPipelineBlueprintRequestMarshaller _instance = new GetPipelineBlueprintRequestMarshaller();        

        internal static GetPipelineBlueprintRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPipelineBlueprintRequestMarshaller Instance
        {
            get
            {
                return _instance;
