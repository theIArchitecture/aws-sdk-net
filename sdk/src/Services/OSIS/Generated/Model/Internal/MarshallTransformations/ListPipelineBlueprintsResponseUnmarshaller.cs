...
{
    /// <summary>
    /// Response Unmarshaller for ListPipelineBlueprints operation
    /// </summary>  
    public class ListPipelineBlueprintsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListPipelineBlueprintsResponse response = new ListPipelineBlueprintsResponse();
        ...
        private static ListPipelineBlueprintsResponseUnmarshaller _instance = new ListPipelineBlueprintsResponseUnmarshaller();        

        internal static ListPipelineBlueprintsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPipelineBlueprintsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
