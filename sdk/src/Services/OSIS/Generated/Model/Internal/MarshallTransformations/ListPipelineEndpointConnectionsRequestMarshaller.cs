...
namespace Amazon.OSIS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListPipelineEndpointConnectionsRequestMarshaller : IMarshaller<IRequest, ListPipelineEndpointConnectionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListPipelineEndpointConnectionsRequestMarshaller _instance = new ListPipelineEndpointConnectionsRequestMarshaller();        

        internal static ListPipelineEndpointConnectionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPipelineEndpointConnectionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
