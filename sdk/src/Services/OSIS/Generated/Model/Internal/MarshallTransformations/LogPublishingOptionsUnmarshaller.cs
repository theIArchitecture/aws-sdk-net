...
{
    /// <summary>
    /// Response Unmarshaller for LogPublishingOptions Object
    /// </summary>  
    public class LogPublishingOptionsUnmarshaller : IJsonUnmarshaller<LogPublishingOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LogPublishingOptions Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static LogPublishingOptionsUnmarshaller _instance = new LogPublishingOptionsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static LogPublishingOptionsUnmarshaller Instance
        {
            get
            {
                return _instance;
