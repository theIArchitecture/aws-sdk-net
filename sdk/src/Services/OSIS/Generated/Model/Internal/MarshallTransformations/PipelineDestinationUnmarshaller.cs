...
namespace Amazon.OSIS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PipelineDestinationUnmarshaller : IJsonUnmarshaller<PipelineDestination, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PipelineDestination Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
