...
namespace Amazon.OSIS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PipelineEndpointUnmarshaller : IJsonUnmarshaller<PipelineEndpoint, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PipelineEndpoint Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.IngestEndpointUrl = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
