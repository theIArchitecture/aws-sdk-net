...
{
    /// <summary>
    /// Response Unmarshaller for RevokePipelineEndpointConnections operation
    /// </summary>  
    public class RevokePipelineEndpointConnectionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RevokePipelineEndpointConnectionsResponse response = new RevokePipelineEndpointConnectionsResponse();
        ...
        private static RevokePipelineEndpointConnectionsResponseUnmarshaller _instance = new RevokePipelineEndpointConnectionsResponseUnmarshaller();        

        internal static RevokePipelineEndpointConnectionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RevokePipelineEndpointConnectionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
