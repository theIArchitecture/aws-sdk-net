...
{
    /// <summary>
    /// Response Unmarshaller for StartPipeline operation
    /// </summary>  
    public class StartPipelineResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartPipelineResponse response = new StartPipelineResponse();
        ...
        private static StartPipelineResponseUnmarshaller _instance = new StartPipelineResponseUnmarshaller();        

        internal static StartPipelineResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartPipelineResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
