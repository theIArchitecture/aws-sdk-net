...
namespace Amazon.ObservabilityAdmin
{
    ...
    public partial class AmazonObservabilityAdminConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("ObservabilityAdmin", "4.0.3.4");
        ...
        /// Default constructor
        /// </summary>
        public AmazonObservabilityAdminConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonObservabilityAdminDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "ObservabilityAdmin";
            this.AuthenticationServiceName = "observabilityadmin";
            this.EndpointProvider = new AmazonObservabilityAdminEndpointProvider();
        }
