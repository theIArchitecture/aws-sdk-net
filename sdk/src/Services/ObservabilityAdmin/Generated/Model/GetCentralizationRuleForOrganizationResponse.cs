...
namespace Amazon.ObservabilityAdmin.Model
{
    ...
    {
        private CentralizationRule _centralizationRule;
        ...
        /// </para>
        /// </summary>
        public CentralizationRule CentralizationRule
        {
            get { return this._centralizationRule; }
            set { this._centralizationRule = value; }
        }

        // Check to see if CentralizationRule property is set
        internal bool IsSetCentralizationRule()
        {
            return this._centralizationRule != null;
        }
