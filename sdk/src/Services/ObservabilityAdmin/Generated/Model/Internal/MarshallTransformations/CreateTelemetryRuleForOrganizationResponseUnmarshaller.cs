...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateTelemetryRuleForOrganizationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTelemetryRuleForOrganizationResponse response = new CreateTelemetryRuleForOrganizationResponse();
        ...
        internal static CreateTelemetryRuleForOrganizationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTelemetryRuleForOrganizationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
