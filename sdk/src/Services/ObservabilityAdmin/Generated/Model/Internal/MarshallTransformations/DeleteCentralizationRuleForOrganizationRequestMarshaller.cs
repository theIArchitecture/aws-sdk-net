...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteCentralizationRuleForOrganizationRequestMarshaller : IMarshaller<IRequest, DeleteCentralizationRuleForOrganizationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteCentralizationRuleForOrganizationRequestMarshaller _instance = new DeleteCentralizationRuleForOrganizationRequestMarshaller();        

        internal static DeleteCentralizationRuleForOrganizationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCentralizationRuleForOrganizationRequestMarshaller Instance
        {
            get
            {
                return _instance;
