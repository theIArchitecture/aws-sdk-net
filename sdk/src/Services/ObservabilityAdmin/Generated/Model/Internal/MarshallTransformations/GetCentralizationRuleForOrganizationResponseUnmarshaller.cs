...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetCentralizationRuleForOrganizationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCentralizationRuleForOrganizationResponse response = new GetCentralizationRuleForOrganizationResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("CentralizationRule", targetDepth))
                {
                    var unmarshaller = CentralizationRuleUnmarshaller.Instance;
                    response.CentralizationRule = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("CreatedRegion", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.CreatedRegion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RuleHealth = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static GetCentralizationRuleForOrganizationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCentralizationRuleForOrganizationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
