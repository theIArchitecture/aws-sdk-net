...
{
    /// <summary>
    /// Response Unmarshaller for ListCentralizationRulesForOrganization operation
    /// </summary>  
    public class ListCentralizationRulesForOrganizationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListCentralizationRulesForOrganizationResponse response = new ListCentralizationRulesForOrganizationResponse();
        ...
        private static ListCentralizationRulesForOrganizationResponseUnmarshaller _instance = new ListCentralizationRulesForOrganizationResponseUnmarshaller();        

        internal static ListCentralizationRulesForOrganizationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCentralizationRulesForOrganizationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
