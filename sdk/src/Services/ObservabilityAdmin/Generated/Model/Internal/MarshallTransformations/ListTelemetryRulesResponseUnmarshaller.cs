...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListTelemetryRulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTelemetryRulesResponse response = new ListTelemetryRulesResponse();
        ...
        internal static ListTelemetryRulesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTelemetryRulesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
