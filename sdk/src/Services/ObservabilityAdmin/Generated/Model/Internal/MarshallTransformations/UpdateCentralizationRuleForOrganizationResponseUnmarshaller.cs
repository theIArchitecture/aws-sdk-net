...
namespace Amazon.ObservabilityAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateCentralizationRuleForOrganizationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateCentralizationRuleForOrganizationResponse response = new UpdateCentralizationRuleForOrganizationResponse();
        ...
        internal static UpdateCentralizationRuleForOrganizationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCentralizationRuleForOrganizationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
