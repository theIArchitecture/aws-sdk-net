...
{
    /// <summary>
    /// Response Unmarshaller for UpdateTelemetryRuleForOrganization operation
    /// </summary>  
    public class UpdateTelemetryRuleForOrganizationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateTelemetryRuleForOrganizationResponse response = new UpdateTelemetryRuleForOrganizationResponse();
        ...
        private static UpdateTelemetryRuleForOrganizationResponseUnmarshaller _instance = new UpdateTelemetryRuleForOrganizationResponseUnmarshaller();        

        internal static UpdateTelemetryRuleForOrganizationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTelemetryRuleForOrganizationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
