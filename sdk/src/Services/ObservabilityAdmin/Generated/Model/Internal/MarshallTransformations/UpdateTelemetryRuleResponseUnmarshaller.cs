...
{
    /// <summary>
    /// Response Unmarshaller for UpdateTelemetryRule operation
    /// </summary>  
    public class UpdateTelemetryRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateTelemetryRuleResponse response = new UpdateTelemetryRuleResponse();
        ...
        private static UpdateTelemetryRuleResponseUnmarshaller _instance = new UpdateTelemetryRuleResponseUnmarshaller();        

        internal static UpdateTelemetryRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTelemetryRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
