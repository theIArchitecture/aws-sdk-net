...
namespace Amazon.Odb.Internal
{
    ...
    public class AmazonOdbAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonOdbAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Odb.
        /// </summary>
        public AmazonOdbAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonOdbAuthSchemeParameters
            {
    ...
    public class AmazonOdbAuthSchemeResolver : IAuthSchemeResolver<AmazonOdbAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonOdbAuthSchemeParameters authParameters)
        {
