...
namespace Amazon.Odb.Model
{
    ...
    public partial class DbNode
    {
        ...
        /// <summary>
        /// Gets and sets the property FloatingIpAddress. 
        /// <para>
        ...
        {
            get { return this._floatingIpAddress; }
            set { this._floatingIpAddress = value; }
        }

        // Check to see if FloatingIpAddress property is set
        internal bool IsSetFloatingIpAddress()
        {
            return this._floatingIpAddress != null;
        }
        ...
        /// <para>
        /// The type of database node maintenance. Either <c>VMDB_REBOOT_MIGRATION</c> or <c>EXADBXS_REBOOT_MIGRATION</c>.
        /// </para>
        /// </summary>
