...
{
    /// <summary>
    /// Response Unmarshaller for CreateOdbNetwork operation
    /// </summary>  
    public class CreateOdbNetworkResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateOdbNetworkResponse response = new CreateOdbNetworkResponse();
        ...
        private static CreateOdbNetworkResponseUnmarshaller _instance = new CreateOdbNetworkResponseUnmarshaller();        

        internal static CreateOdbNetworkResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateOdbNetworkResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
