...
{
    /// <summary>
    /// Response Unmarshaller for DbNodeSummary Object
    /// </summary>  
    public class DbNodeSummaryUnmarshaller : IJsonUnmarshaller<DbNodeSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DbNodeSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            DbNodeSummary unmarshalledObject = new DbNodeSummary();
        ...
        private static DbNodeSummaryUnmarshaller _instance = new DbNodeSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DbNodeSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
