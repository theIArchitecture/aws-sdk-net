...
namespace Amazon.Odb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DbServerUnmarshaller : IJsonUnmarshaller<DbServer, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DbServer Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
