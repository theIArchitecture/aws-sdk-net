...
{
    /// <summary>
    /// Response Unmarshaller for ListSystemVersions operation
    /// </summary>  
    public class ListSystemVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSystemVersionsResponse response = new ListSystemVersionsResponse();
        ...
        private static ListSystemVersionsResponseUnmarshaller _instance = new ListSystemVersionsResponseUnmarshaller();        

        internal static ListSystemVersionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSystemVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
