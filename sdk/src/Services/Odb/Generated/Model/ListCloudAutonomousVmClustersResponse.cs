...
{
    /// <summary>
    /// This is the response object from the ListCloudAutonomousVmClusters operation.
    /// </summary>
    public partial class ListCloudAutonomousVmClustersResponse : AmazonWebServiceResponse
    {
        private List<CloudAutonomousVmClusterSummary> _cloudAutonomousVmClusters = AWSConfigs.InitializeCollections ? new List<CloudAutonomousVmClusterSummary>() : null;
        ...
        public List<CloudAutonomousVmClusterSummary> CloudAutonomousVmClusters
        {
