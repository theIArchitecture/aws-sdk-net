...
{
    /// <summary>
    /// This is the response object from the ListDbServers operation.
    /// </summary>
    public partial class ListDbServersResponse : AmazonWebServiceResponse
    {
        private List<DbServerSummary> _dbServers = AWSConfigs.InitializeCollections ? new List<DbServerSummary>() : null;
        ...
        public List<DbServerSummary> DbServers
        {
