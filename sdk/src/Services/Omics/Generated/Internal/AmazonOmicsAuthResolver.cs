...
namespace Amazon.Omics.Internal
{
    ...
    public class AmazonOmicsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonOmicsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Omics.
        /// </summary>
        public AmazonOmicsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonOmicsAuthSchemeParameters
            {
    ...
    public class AmazonOmicsAuthSchemeResolver : IAuthSchemeResolver<AmazonOmicsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonOmicsAuthSchemeParameters authParameters)
        {
