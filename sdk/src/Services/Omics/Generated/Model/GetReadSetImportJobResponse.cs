...
{
    /// <summary>
    /// This is the response object from the GetReadSetImportJob operation.
    /// </summary>
    public partial class GetReadSetImportJobResponse : AmazonWebServiceResponse
    {
        ...
        private List<ImportReadSetSourceItem> _sources = AWSConfigs.InitializeCollections ? new List<ImportReadSetSourceItem>() : null;
        ...
        /// </summary>
        [AWSProperty(Required=true)]
        public List<ImportReadSetSourceItem> Sources
        {
