...
{
    /// <summary>
    /// Response Unmarshaller for AbortMultipartReadSetUpload operation
    /// </summary>  
    public class AbortMultipartReadSetUploadResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AbortMultipartReadSetUploadResponse response = new AbortMultipartReadSetUploadResponse();
        ...
        private static AbortMultipartReadSetUploadResponseUnmarshaller _instance = new AbortMultipartReadSetUploadResponseUnmarshaller();        

        internal static AbortMultipartReadSetUploadResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AbortMultipartReadSetUploadResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
