...
{
    /// <summary>
    /// Response Unmarshaller for CancelRun operation
    /// </summary>  
    public class CancelRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelRunResponse response = new CancelRunResponse();
        ...
        private static CancelRunResponseUnmarshaller _instance = new CancelRunResponseUnmarshaller();        

        internal static CancelRunResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
