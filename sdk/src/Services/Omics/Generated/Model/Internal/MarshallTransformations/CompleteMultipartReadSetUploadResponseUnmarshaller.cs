...
{
    /// <summary>
    /// Response Unmarshaller for CompleteMultipartReadSetUpload operation
    /// </summary>  
    public class CompleteMultipartReadSetUploadResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CompleteMultipartReadSetUploadResponse response = new CompleteMultipartReadSetUploadResponse();
        ...
        private static CompleteMultipartReadSetUploadResponseUnmarshaller _instance = new CompleteMultipartReadSetUploadResponseUnmarshaller();        

        internal static CompleteMultipartReadSetUploadResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CompleteMultipartReadSetUploadResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
