...
{
    /// <summary>
    /// Response Unmarshaller for ContainerRegistryMap Object
    /// </summary>  
    public class ContainerRegistryMapUnmarshaller : IJsonUnmarshaller<ContainerRegistryMap, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ContainerRegistryMap Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ContainerRegistryMap unmarshalledObject = new ContainerRegistryMap();
        ...
        private static ContainerRegistryMapUnmarshaller _instance = new ContainerRegistryMapUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ContainerRegistryMapUnmarshaller Instance
        {
            get
            {
                return _instance;
