...
namespace Amazon.Omics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateMultipartReadSetUploadResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateMultipartReadSetUploadResponse response = new CreateMultipartReadSetUploadResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.GeneratedFrom = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SourceFileType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static CreateMultipartReadSetUploadResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMultipartReadSetUploadResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
