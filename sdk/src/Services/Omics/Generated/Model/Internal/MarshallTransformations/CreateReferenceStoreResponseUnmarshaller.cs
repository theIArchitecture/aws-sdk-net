...
{
    /// <summary>
    /// Response Unmarshaller for CreateReferenceStore operation
    /// </summary>  
    public class CreateReferenceStoreResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateReferenceStoreResponse response = new CreateReferenceStoreResponse();
        ...
        private static CreateReferenceStoreResponseUnmarshaller _instance = new CreateReferenceStoreResponseUnmarshaller();        

        internal static CreateReferenceStoreResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateReferenceStoreResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
