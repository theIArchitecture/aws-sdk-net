...
{
    /// <summary>
    /// Response Unmarshaller for CreateSequenceStore operation
    /// </summary>  
    public class CreateSequenceStoreResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSequenceStoreResponse response = new CreateSequenceStoreResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ETagAlgorithmFamily = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("fallbackLocation", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.FallbackLocation = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("propagatedSetLevelTags", targetDepth))
                {
                    ...
                    response.PropagatedSetLevelTags = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("s3Access", targetDepth))
                {
                    var unmarshaller = SequenceStoreS3AccessUnmarshaller.Instance;
                    response.S3Access = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateSequenceStoreResponseUnmarshaller _instance = new CreateSequenceStoreResponseUnmarshaller();        

        internal static CreateSequenceStoreResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSequenceStoreResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
