...
{
    /// <summary>
    /// Response Unmarshaller for DeleteRunGroup operation
    /// </summary>  
    public class DeleteRunGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteRunGroupResponse response = new DeleteRunGroupResponse();
        ...
        private static DeleteRunGroupResponseUnmarshaller _instance = new DeleteRunGroupResponseUnmarshaller();        

        internal static DeleteRunGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRunGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
