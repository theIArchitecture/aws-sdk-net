...
{
    /// <summary>
    /// Response Unmarshaller for DeleteS3AccessPolicy operation
    /// </summary>  
    public class DeleteS3AccessPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteS3AccessPolicyResponse response = new DeleteS3AccessPolicyResponse();
        ...
        private static DeleteS3AccessPolicyResponseUnmarshaller _instance = new DeleteS3AccessPolicyResponseUnmarshaller();        

        internal static DeleteS3AccessPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteS3AccessPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
