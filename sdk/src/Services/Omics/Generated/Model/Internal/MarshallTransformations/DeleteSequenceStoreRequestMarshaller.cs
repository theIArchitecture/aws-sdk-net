...
namespace Amazon.Omics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteSequenceStoreRequestMarshaller : IMarshaller<IRequest, DeleteSequenceStoreRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteSequenceStoreRequestMarshaller _instance = new DeleteSequenceStoreRequestMarshaller();        

        internal static DeleteSequenceStoreRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSequenceStoreRequestMarshaller Instance
        {
            get
            {
                return _instance;
