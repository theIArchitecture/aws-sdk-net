...
{
    /// <summary>
    /// Response Unmarshaller for GetAnnotationImportJob operation
    /// </summary>  
    public class GetAnnotationImportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAnnotationImportJobResponse response = new GetAnnotationImportJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("annotationFields", targetDepth))
                {
                    ...
                    response.AnnotationFields = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AnnotationImportItemDetail, AnnotationImportItemDetailUnmarshaller>(AnnotationImportItemDetailUnmarshaller.Instance);
                ...
                if (context.TestExpression("runLeftNormalization", targetDepth))
                {
                    ...
                    response.RunLeftNormalization = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetAnnotationImportJobResponseUnmarshaller _instance = new GetAnnotationImportJobResponseUnmarshaller();        

        internal static GetAnnotationImportJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAnnotationImportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
