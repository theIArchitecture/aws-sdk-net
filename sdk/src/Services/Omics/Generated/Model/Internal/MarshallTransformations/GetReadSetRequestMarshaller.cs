...
{
    /// <summary>
    /// GetReadSet Request Marshaller
    /// </summary>       
    public class GetReadSetRequestMarshaller : IMarshaller<IRequest, GetReadSetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetReadSetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetReadSetRequest publicRequest)
        {
            ...
            request.ResourcePath = "/sequencestore/{sequenceStoreId}/readset/{id}";
        ...
        private static GetReadSetRequestMarshaller _instance = new GetReadSetRequestMarshaller();        

        internal static GetReadSetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetReadSetRequestMarshaller Instance
        {
            get
            {
                return _instance;
