...
{
    /// <summary>
    /// Response Unmarshaller for GetReferenceImportJob operation
    /// </summary>  
    public class GetReferenceImportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetReferenceImportJobResponse response = new GetReferenceImportJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ImportReferenceSourceItem, ImportReferenceSourceItemUnmarshaller>(ImportReferenceSourceItemUnmarshaller.Instance);
        ...
        private static GetReferenceImportJobResponseUnmarshaller _instance = new GetReferenceImportJobResponseUnmarshaller();        

        internal static GetReferenceImportJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetReferenceImportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
