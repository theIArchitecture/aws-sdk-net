...
{
    /// <summary>
    /// Response Unmarshaller for GetReference operation
    /// </summary>  
    public class GetReferenceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetReferenceResponseUnmarshaller _instance = new GetReferenceResponseUnmarshaller();        

        internal static GetReferenceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetReferenceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
