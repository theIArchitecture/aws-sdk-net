...
{
    /// <summary>
    /// Response Unmarshaller for GetRunGroup operation
    /// </summary>  
    public class GetRunGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRunGroupResponse response = new GetRunGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("maxCpus", targetDepth))
                {
                    ...
                    response.MaxCpus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("maxDuration", targetDepth))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    response.MaxDuration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("maxGpus", targetDepth))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    response.MaxGpus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("maxRuns", targetDepth))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    response.MaxRuns = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetRunGroupResponseUnmarshaller _instance = new GetRunGroupResponseUnmarshaller();        

        internal static GetRunGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRunGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
