...
{
    /// <summary>
    /// Response Unmarshaller for GetShare operation
    /// </summary>  
    public class GetShareResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetShareResponse response = new GetShareResponse();
        ...
        private static GetShareResponseUnmarshaller _instance = new GetShareResponseUnmarshaller();        

        internal static GetShareResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetShareResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
