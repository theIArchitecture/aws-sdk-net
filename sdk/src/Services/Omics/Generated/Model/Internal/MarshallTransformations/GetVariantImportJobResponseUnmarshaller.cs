...
{
    /// <summary>
    /// Response Unmarshaller for GetVariantImportJob operation
    /// </summary>  
    public class GetVariantImportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetVariantImportJobResponse response = new GetVariantImportJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<VariantImportItemDetail, VariantImportItemDetailUnmarshaller>(VariantImportItemDetailUnmarshaller.Instance);
        ...
        private static GetVariantImportJobResponseUnmarshaller _instance = new GetVariantImportJobResponseUnmarshaller();        

        internal static GetVariantImportJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetVariantImportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
