...
{
    /// <summary>
    /// Response Unmarshaller for ListReadSetExportJobs operation
    /// </summary>  
    public class ListReadSetExportJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListReadSetExportJobsResponse response = new ListReadSetExportJobsResponse();
        ...
        private static ListReadSetExportJobsResponseUnmarshaller _instance = new ListReadSetExportJobsResponseUnmarshaller();        

        internal static ListReadSetExportJobsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListReadSetExportJobsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
