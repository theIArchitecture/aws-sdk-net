...
{
    /// <summary>
    /// Response Unmarshaller for ListRunTasks operation
    /// </summary>  
    public class ListRunTasksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListRunTasksResponse response = new ListRunTasksResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<TaskListItem, TaskListItemUnmarshaller>(TaskListItemUnmarshaller.Instance);
        ...
        private static ListRunTasksResponseUnmarshaller _instance = new ListRunTasksResponseUnmarshaller();        

        internal static ListRunTasksResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRunTasksResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
