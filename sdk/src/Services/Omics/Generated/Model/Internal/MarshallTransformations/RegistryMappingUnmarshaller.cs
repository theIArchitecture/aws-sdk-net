...
{
    /// <summary>
    /// Response Unmarshaller for RegistryMapping Object
    /// </summary>  
    public class RegistryMappingUnmarshaller : IJsonUnmarshaller<RegistryMapping, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RegistryMapping Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            RegistryMapping unmarshalledObject = new RegistryMapping();
        ...
        private static RegistryMappingUnmarshaller _instance = new RegistryMappingUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RegistryMappingUnmarshaller Instance
        {
            get
            {
                return _instance;
