...
{
    /// <summary>
    /// SequenceStoreFilter Marshaller
    /// </summary>
    public class SequenceStoreFilterMarshaller : IRequestMarshaller<SequenceStoreFilter, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(SequenceStoreFilter requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetUpdatedAfter())
            {
                ...
                context.Writer.WriteStringValue(StringUtils.FromDateTimeToISO8601WithOptionalMs(requestObject.UpdatedAfter));
            }

            if(requestObject.IsSetUpdatedBefore())
            {
                context.Writer.WritePropertyName("updatedBefore");
                context.Writer.WriteStringValue(StringUtils.FromDateTimeToISO8601WithOptionalMs(requestObject.UpdatedBefore));
            }
        ...
        /// </summary>
        public readonly static SequenceStoreFilterMarshaller Instance = new SequenceStoreFilterMarshaller();
