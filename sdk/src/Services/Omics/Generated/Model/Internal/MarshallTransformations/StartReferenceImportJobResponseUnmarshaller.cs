...
{
    /// <summary>
    /// Response Unmarshaller for StartReferenceImportJob operation
    /// </summary>  
    public class StartReferenceImportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartReferenceImportJobResponse response = new StartReferenceImportJobResponse();
        ...
        private static StartReferenceImportJobResponseUnmarshaller _instance = new StartReferenceImportJobResponseUnmarshaller();        

        internal static StartReferenceImportJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartReferenceImportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
