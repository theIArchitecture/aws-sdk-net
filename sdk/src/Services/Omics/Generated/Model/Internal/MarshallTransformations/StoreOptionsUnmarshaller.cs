...
namespace Amazon.Omics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StoreOptionsUnmarshaller : IJsonUnmarshaller<StoreOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public StoreOptions Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("tsvStoreOptions", targetDepth))
                {
                    ...
                    unmarshalledObject.TsvStoreOptions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
