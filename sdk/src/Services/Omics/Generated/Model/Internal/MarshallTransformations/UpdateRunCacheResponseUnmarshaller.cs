...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRunCache operation
    /// </summary>  
    public class UpdateRunCacheResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateRunCacheResponse response = new UpdateRunCacheResponse();
        ...
        private static UpdateRunCacheResponseUnmarshaller _instance = new UpdateRunCacheResponseUnmarshaller();        

        internal static UpdateRunCacheResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRunCacheResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
