...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRunGroup operation
    /// </summary>  
    public class UpdateRunGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateRunGroupResponse response = new UpdateRunGroupResponse();
        ...
        private static UpdateRunGroupResponseUnmarshaller _instance = new UpdateRunGroupResponseUnmarshaller();        

        internal static UpdateRunGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRunGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
