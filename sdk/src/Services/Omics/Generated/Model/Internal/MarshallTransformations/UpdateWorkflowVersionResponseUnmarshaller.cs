...
{
    /// <summary>
    /// Response Unmarshaller for UpdateWorkflowVersion operation
    /// </summary>  
    public class UpdateWorkflowVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateWorkflowVersionResponse response = new UpdateWorkflowVersionResponse();
        ...
        private static UpdateWorkflowVersionResponseUnmarshaller _instance = new UpdateWorkflowVersionResponseUnmarshaller();        

        internal static UpdateWorkflowVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateWorkflowVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
