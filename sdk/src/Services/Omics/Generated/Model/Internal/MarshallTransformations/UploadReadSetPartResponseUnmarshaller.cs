...
{
    /// <summary>
    /// Response Unmarshaller for UploadReadSetPart operation
    /// </summary>  
    public class UploadReadSetPartResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UploadReadSetPartResponse response = new UploadReadSetPartResponse();
        ...
        private static UploadReadSetPartResponseUnmarshaller _instance = new UploadReadSetPartResponseUnmarshaller();        

        internal static UploadReadSetPartResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UploadReadSetPartResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
