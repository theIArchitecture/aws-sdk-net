...
{
    /// <summary>
    /// Response Unmarshaller for CreateSecurityPolicy operation
    /// </summary>  
    public class CreateSecurityPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSecurityPolicyResponse response = new CreateSecurityPolicyResponse();
        ...
        private static CreateSecurityPolicyResponseUnmarshaller _instance = new CreateSecurityPolicyResponseUnmarshaller();        

        internal static CreateSecurityPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSecurityPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
