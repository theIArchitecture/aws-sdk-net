...
namespace Amazon.OpenSearchServerless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FipsEndpointsUnmarshaller : IJsonUnmarshaller<FipsEndpoints, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FipsEndpoints Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
