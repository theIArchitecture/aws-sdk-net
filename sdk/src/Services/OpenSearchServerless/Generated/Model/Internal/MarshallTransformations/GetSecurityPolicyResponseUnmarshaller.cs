...
{
    /// <summary>
    /// Response Unmarshaller for GetSecurityPolicy operation
    /// </summary>  
    public class GetSecurityPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSecurityPolicyResponse response = new GetSecurityPolicyResponse();
        ...
        private static GetSecurityPolicyResponseUnmarshaller _instance = new GetSecurityPolicyResponseUnmarshaller();        

        internal static GetSecurityPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSecurityPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
