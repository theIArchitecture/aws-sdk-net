    ...
    public class ListSecurityPoliciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SecurityPolicySummary, SecurityPolicySummaryUnmarshaller>(SecurityPolicySummaryUnmarshaller.Instance);
                    response.SecurityPolicySummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
