...
namespace Amazon.OpenSearchServerless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SecurityConfigStatsUnmarshaller : IJsonUnmarshaller<SecurityConfigStats, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SecurityConfigStats Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
