...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSecurityPolicy operation
    /// </summary>  
    public class UpdateSecurityPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSecurityPolicyResponse response = new UpdateSecurityPolicyResponse();
        ...
        private static UpdateSecurityPolicyResponseUnmarshaller _instance = new UpdateSecurityPolicyResponseUnmarshaller();        

        internal static UpdateSecurityPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSecurityPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
