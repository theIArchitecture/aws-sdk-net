...
namespace Amazon.OpenSearchService.Model
{
    ...
    [Serializable]
    #endif
    public partial class DependencyFailureException : AmazonOpenSearchServiceException
    {
        ...
        public DependencyFailureException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DependencyFailureException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
