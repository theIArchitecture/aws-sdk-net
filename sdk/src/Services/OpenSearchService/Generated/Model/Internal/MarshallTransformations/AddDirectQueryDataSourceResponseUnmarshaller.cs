...
{
    /// <summary>
    /// Response Unmarshaller for AddDirectQueryDataSource operation
    /// </summary>  
    public class AddDirectQueryDataSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AddDirectQueryDataSourceResponse response = new AddDirectQueryDataSourceResponse();
        ...
        private static AddDirectQueryDataSourceResponseUnmarshaller _instance = new AddDirectQueryDataSourceResponseUnmarshaller();        

        internal static AddDirectQueryDataSourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddDirectQueryDataSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
