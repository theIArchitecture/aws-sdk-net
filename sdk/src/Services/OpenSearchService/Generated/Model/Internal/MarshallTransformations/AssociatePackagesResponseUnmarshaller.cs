...
{
    /// <summary>
    /// Response Unmarshaller for AssociatePackages operation
    /// </summary>  
    public class AssociatePackagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociatePackagesResponse response = new AssociatePackagesResponse();
        ...
        private static AssociatePackagesResponseUnmarshaller _instance = new AssociatePackagesResponseUnmarshaller();        

        internal static AssociatePackagesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociatePackagesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
