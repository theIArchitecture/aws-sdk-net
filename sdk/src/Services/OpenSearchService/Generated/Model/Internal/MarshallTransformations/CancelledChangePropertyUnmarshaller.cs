...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CancelledChangePropertyUnmarshaller : IJsonUnmarshaller<CancelledChangeProperty, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CancelledChangeProperty Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ActiveValue", targetDepth))
                {
                    ...
                    unmarshalledObject.ActiveValue = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("CancelledValue", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.CancelledValue = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
