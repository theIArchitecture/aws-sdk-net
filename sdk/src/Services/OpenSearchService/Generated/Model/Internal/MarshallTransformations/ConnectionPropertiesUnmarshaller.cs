...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConnectionPropertiesUnmarshaller : IJsonUnmarshaller<ConnectionProperties, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ConnectionProperties Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("CrossClusterSearch", targetDepth))
                {
                    ...
                    unmarshalledObject.CrossClusterSearch = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
