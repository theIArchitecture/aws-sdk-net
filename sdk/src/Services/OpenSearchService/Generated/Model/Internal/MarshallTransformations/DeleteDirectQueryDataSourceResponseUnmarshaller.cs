...
{
    /// <summary>
    /// Response Unmarshaller for DeleteDirectQueryDataSource operation
    /// </summary>  
    public class DeleteDirectQueryDataSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDirectQueryDataSourceResponse response = new DeleteDirectQueryDataSourceResponse();
        ...
        private static DeleteDirectQueryDataSourceResponseUnmarshaller _instance = new DeleteDirectQueryDataSourceResponseUnmarshaller();        

        internal static DeleteDirectQueryDataSourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDirectQueryDataSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
