...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDomainNodes operation
    /// </summary>  
    public class DescribeDomainNodesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDomainNodesResponse response = new DescribeDomainNodesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DomainNodesStatus, DomainNodesStatusUnmarshaller>(DomainNodesStatusUnmarshaller.Instance);
                    response.DomainNodesStatusList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeDomainNodesResponseUnmarshaller _instance = new DescribeDomainNodesResponseUnmarshaller();        

        internal static DescribeDomainNodesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDomainNodesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
