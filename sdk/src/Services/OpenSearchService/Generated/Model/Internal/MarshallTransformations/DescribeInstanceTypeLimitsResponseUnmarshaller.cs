...
{
    /// <summary>
    /// Response Unmarshaller for DescribeInstanceTypeLimits operation
    /// </summary>  
    public class DescribeInstanceTypeLimitsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeInstanceTypeLimitsResponse response = new DescribeInstanceTypeLimitsResponse();
        ...
        private static DescribeInstanceTypeLimitsResponseUnmarshaller _instance = new DescribeInstanceTypeLimitsResponseUnmarshaller();        

        internal static DescribeInstanceTypeLimitsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeInstanceTypeLimitsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
