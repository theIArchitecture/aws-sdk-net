...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeOutboundConnectionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeOutboundConnectionsResponse response = new DescribeOutboundConnectionsResponse();
        ...
        internal static DescribeOutboundConnectionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeOutboundConnectionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
