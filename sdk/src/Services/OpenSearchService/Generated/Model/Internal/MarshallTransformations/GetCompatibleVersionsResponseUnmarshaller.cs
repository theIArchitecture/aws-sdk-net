...
{
    /// <summary>
    /// Response Unmarshaller for GetCompatibleVersions operation
    /// </summary>  
    public class GetCompatibleVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCompatibleVersionsResponse response = new GetCompatibleVersionsResponse();
        ...
        private static GetCompatibleVersionsResponseUnmarshaller _instance = new GetCompatibleVersionsResponseUnmarshaller();        

        internal static GetCompatibleVersionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCompatibleVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
