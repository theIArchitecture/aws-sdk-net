...
{
    /// <summary>
    /// Response Unmarshaller for GetDirectQueryDataSource operation
    /// </summary>  
    public class GetDirectQueryDataSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDirectQueryDataSourceResponse response = new GetDirectQueryDataSourceResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.DataSourceName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("OpenSearchArns", targetDepth))
                {
                    ...
                    response.OpenSearchArns = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetDirectQueryDataSourceResponseUnmarshaller _instance = new GetDirectQueryDataSourceResponseUnmarshaller();        

        internal static GetDirectQueryDataSourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDirectQueryDataSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
