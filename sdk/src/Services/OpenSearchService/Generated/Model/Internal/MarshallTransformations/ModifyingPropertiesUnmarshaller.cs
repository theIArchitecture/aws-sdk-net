...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ModifyingPropertiesUnmarshaller : IJsonUnmarshaller<ModifyingProperties, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ModifyingProperties Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PendingValue = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
