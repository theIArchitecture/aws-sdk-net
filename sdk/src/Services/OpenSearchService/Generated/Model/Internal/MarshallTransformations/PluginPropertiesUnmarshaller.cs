...
namespace Amazon.OpenSearchService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PluginPropertiesUnmarshaller : IJsonUnmarshaller<PluginProperties, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PluginProperties Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("UncompressedSizeInBytes", targetDepth))
                {
                    ...
                    unmarshalledObject.UncompressedSizeInBytes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
