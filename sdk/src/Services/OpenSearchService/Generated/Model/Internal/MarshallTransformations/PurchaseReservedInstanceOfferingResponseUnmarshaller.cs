...
{
    /// <summary>
    /// Response Unmarshaller for PurchaseReservedInstanceOffering operation
    /// </summary>  
    public class PurchaseReservedInstanceOfferingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PurchaseReservedInstanceOfferingResponse response = new PurchaseReservedInstanceOfferingResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ReservedInstanceId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static PurchaseReservedInstanceOfferingResponseUnmarshaller _instance = new PurchaseReservedInstanceOfferingResponseUnmarshaller();        

        internal static PurchaseReservedInstanceOfferingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PurchaseReservedInstanceOfferingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
