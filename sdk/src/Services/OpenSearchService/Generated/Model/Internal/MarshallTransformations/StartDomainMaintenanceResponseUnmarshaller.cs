...
{
    /// <summary>
    /// Response Unmarshaller for StartDomainMaintenance operation
    /// </summary>  
    public class StartDomainMaintenanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartDomainMaintenanceResponse response = new StartDomainMaintenanceResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("MaintenanceId", targetDepth))
                {
                    ...
                    response.MaintenanceId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static StartDomainMaintenanceResponseUnmarshaller _instance = new StartDomainMaintenanceResponseUnmarshaller();        

        internal static StartDomainMaintenanceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartDomainMaintenanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
