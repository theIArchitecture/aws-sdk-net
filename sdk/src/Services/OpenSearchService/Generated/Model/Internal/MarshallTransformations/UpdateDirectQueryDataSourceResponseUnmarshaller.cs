...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDirectQueryDataSource operation
    /// </summary>  
    public class UpdateDirectQueryDataSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDirectQueryDataSourceResponse response = new UpdateDirectQueryDataSourceResponse();
        ...
        private static UpdateDirectQueryDataSourceResponseUnmarshaller _instance = new UpdateDirectQueryDataSourceResponseUnmarshaller();        

        internal static UpdateDirectQueryDataSourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDirectQueryDataSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
