...
namespace Amazon.Organizations.Internal
{
    ...
    public class AmazonOrganizationsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonOrganizationsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Organizations.
        /// </summary>
        public AmazonOrganizationsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonOrganizationsAuthSchemeParameters
            {
    ...
    public class AmazonOrganizationsAuthSchemeResolver : IAuthSchemeResolver<AmazonOrganizationsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonOrganizationsAuthSchemeParameters authParameters)
        {
