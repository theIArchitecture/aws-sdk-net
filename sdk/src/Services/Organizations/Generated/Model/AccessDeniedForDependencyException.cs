...
namespace Amazon.Organizations.Model
{
    ...
    public partial class AccessDeniedForDependencyException : AmazonOrganizationsException
    {
        ...
        public AccessDeniedForDependencyException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AccessDeniedForDependencyException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
