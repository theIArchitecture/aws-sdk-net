...
namespace Amazon.Organizations.Model
{
    ...
    public partial class AccountAlreadyClosedException : AmazonOrganizationsException
    {
        ...
        public AccountAlreadyClosedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AccountAlreadyClosedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
