...
namespace Amazon.Organizations.Model
{
    ...
    public partial class CreateAccountStatusNotFoundException : AmazonOrganizationsException
    {
        ...
        public CreateAccountStatusNotFoundException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CreateAccountStatusNotFoundException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
