...
namespace Amazon.Organizations.Model
{
    ...
    public partial class DuplicateOrganizationalUnitException : AmazonOrganizationsException
    {
        ...
        public DuplicateOrganizationalUnitException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DuplicateOrganizationalUnitException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
