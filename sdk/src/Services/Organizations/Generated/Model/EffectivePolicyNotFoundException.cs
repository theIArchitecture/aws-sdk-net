...
namespace Amazon.Organizations.Model
{
    ...
    public partial class EffectivePolicyNotFoundException : AmazonOrganizationsException
    {
        ...
        public EffectivePolicyNotFoundException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public EffectivePolicyNotFoundException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
