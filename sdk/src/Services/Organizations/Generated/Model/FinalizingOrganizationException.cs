...
namespace Amazon.Organizations.Model
{
    ...
    public partial class FinalizingOrganizationException : AmazonOrganizationsException
    {
        ...
        public FinalizingOrganizationException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public FinalizingOrganizationException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
