...
{
    /// <summary>
    /// Response Unmarshaller for CloseAccount operation
    /// </summary>  
    public class CloseAccountResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("AccountAlreadyClosedException"))
                {
                    return AccountAlreadyClosedExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static CloseAccountResponseUnmarshaller _instance = new CloseAccountResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CloseAccountResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
