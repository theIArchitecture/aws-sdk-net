...
namespace Amazon.Organizations.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class HandshakeResourceUnmarshaller : IJsonUnmarshaller<HandshakeResource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public HandshakeResource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
