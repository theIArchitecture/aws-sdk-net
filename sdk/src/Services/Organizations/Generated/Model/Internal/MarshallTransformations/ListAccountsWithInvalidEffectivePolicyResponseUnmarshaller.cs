...
{
    /// <summary>
    /// Response Unmarshaller for ListAccountsWithInvalidEffectivePolicy operation
    /// </summary>  
    public class ListAccountsWithInvalidEffectivePolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAccountsWithInvalidEffectivePolicyResponse response = new ListAccountsWithInvalidEffectivePolicyResponse();
        ...
        private static ListAccountsWithInvalidEffectivePolicyResponseUnmarshaller _instance = new ListAccountsWithInvalidEffectivePolicyResponseUnmarshaller();        

        internal static ListAccountsWithInvalidEffectivePolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAccountsWithInvalidEffectivePolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
