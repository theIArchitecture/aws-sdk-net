    ...
    public class ListDelegatedAdministratorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DelegatedAdministrator, DelegatedAdministratorUnmarshaller>(DelegatedAdministratorUnmarshaller.Instance);
                    response.DelegatedAdministrators = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
