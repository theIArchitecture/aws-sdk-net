    ...
    public class ListDelegatedServicesForAccountResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DelegatedService, DelegatedServiceUnmarshaller>(DelegatedServiceUnmarshaller.Instance);
                    response.DelegatedServices = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
