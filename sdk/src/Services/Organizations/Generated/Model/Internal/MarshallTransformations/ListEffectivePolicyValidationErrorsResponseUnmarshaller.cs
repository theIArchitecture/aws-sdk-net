...
{
    /// <summary>
    /// Response Unmarshaller for ListEffectivePolicyValidationErrors operation
    /// </summary>  
    public class ListEffectivePolicyValidationErrorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListEffectivePolicyValidationErrorsResponse response = new ListEffectivePolicyValidationErrorsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("EffectivePolicyValidationErrors", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<EffectivePolicyValidationError, EffectivePolicyValidationErrorUnmarshaller>(EffectivePolicyValidationErrorUnmarshaller.Instance);
                    response.EffectivePolicyValidationErrors = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("EvaluationTimestamp", targetDepth))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    response.EvaluationTimestamp = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return EffectivePolicyNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static ListEffectivePolicyValidationErrorsResponseUnmarshaller _instance = new ListEffectivePolicyValidationErrorsResponseUnmarshaller();        

        internal static ListEffectivePolicyValidationErrorsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListEffectivePolicyValidationErrorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
