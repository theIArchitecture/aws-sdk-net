    ...
    public class ListHandshakesForOrganizationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<Handshake, HandshakeUnmarshaller>(HandshakeUnmarshaller.Instance);
                    response.Handshakes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
