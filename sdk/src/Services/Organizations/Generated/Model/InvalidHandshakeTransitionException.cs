...
namespace Amazon.Organizations.Model
{
    ...
    public partial class InvalidHandshakeTransitionException : AmazonOrganizationsException
    {
        ...
        public InvalidHandshakeTransitionException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidHandshakeTransitionException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
