...
{
    /// <summary>
    /// User-specified instances that must not be stopped. These instances will not appear
    /// in the list of instances that Amazon Web Services recommends to stop in order to free
    /// up capacity.
    /// </summary>
    public partial class InstancesToExclude
    {
        ...
        /// <para>
        /// Names of the services that own each instance that must not be stopped in order to
