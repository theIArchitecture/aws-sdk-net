...
{
    /// <summary>
    /// CancelCapacityTask Request Marshaller
    /// </summary>       
    public class CancelCapacityTaskRequestMarshaller : IMarshaller<IRequest, CancelCapacityTaskRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CancelCapacityTaskRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CancelCapacityTaskRequest publicRequest)
        {
        ...
        private static CancelCapacityTaskRequestMarshaller _instance = new CancelCapacityTaskRequestMarshaller();        

        internal static CancelCapacityTaskRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelCapacityTaskRequestMarshaller Instance
        {
            get
            {
                return _instance;
