...
namespace Amazon.Outposts.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LineItemAssetInformationUnmarshaller : IJsonUnmarshaller<LineItemAssetInformation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LineItemAssetInformation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("MacAddressList", targetDepth))
                {
                    ...
                    unmarshalledObject.MacAddressList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
