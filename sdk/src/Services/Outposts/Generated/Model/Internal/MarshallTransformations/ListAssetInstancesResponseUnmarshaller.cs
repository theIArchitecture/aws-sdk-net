    ...
    public class ListAssetInstancesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AssetInstance, AssetInstanceUnmarshaller>(AssetInstanceUnmarshaller.Instance);
                    response.AssetInstances = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
