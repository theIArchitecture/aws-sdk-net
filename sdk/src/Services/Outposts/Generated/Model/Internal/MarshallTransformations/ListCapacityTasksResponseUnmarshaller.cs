...
{
    /// <summary>
    /// Response Unmarshaller for ListCapacityTasks operation
    /// </summary>  
    public class ListCapacityTasksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListCapacityTasksResponse response = new ListCapacityTasksResponse();
        ...
        private static ListCapacityTasksResponseUnmarshaller _instance = new ListCapacityTasksResponseUnmarshaller();        

        internal static ListCapacityTasksResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCapacityTasksResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
