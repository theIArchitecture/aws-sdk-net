...
{
    /// <summary>
    /// UpdateSiteAddress Request Marshaller
    /// </summary>       
    public class UpdateSiteAddressRequestMarshaller : IMarshaller<IRequest, UpdateSiteAddressRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateSiteAddressRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateSiteAddressRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetAddressType())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.AddressType);
            }
        ...
        private static UpdateSiteAddressRequestMarshaller _instance = new UpdateSiteAddressRequestMarshaller();        

        internal static UpdateSiteAddressRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSiteAddressRequestMarshaller Instance
        {
            get
            {
                return _instance;
