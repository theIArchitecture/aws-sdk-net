...
namespace Amazon.PCS
{
    ...
    public partial class AmazonPCSConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("PCS", "4.0.8.3");
        ...
        /// Default constructor
        /// </summary>
        public AmazonPCSConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonPCSDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "PCS";
            this.AuthenticationServiceName = "pcs";
            this.EndpointProvider = new AmazonPCSEndpointProvider();
        }
