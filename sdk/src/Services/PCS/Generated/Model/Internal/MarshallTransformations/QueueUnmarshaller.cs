    ...
    public class QueueUnmarshaller : IJsonUnmarshaller<Queue, JsonUnmarshallerContext>
    {
        ...
        public Queue Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("computeNodeGroupConfigurations", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<ComputeNodeGroupConfiguration, ComputeNodeGroupConfigurationUnmarshaller>(ComputeNodeGroupConfigurationUnmarshaller.Instance);
                    unmarshalledObject.ComputeNodeGroupConfigurations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
