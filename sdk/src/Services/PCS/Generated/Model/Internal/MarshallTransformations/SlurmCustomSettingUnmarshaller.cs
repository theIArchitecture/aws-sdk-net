...
namespace Amazon.PCS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SlurmCustomSettingUnmarshaller : IJsonUnmarshaller<SlurmCustomSetting, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SlurmCustomSetting Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
