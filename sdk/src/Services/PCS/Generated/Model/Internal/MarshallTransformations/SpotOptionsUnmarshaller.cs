...
namespace Amazon.PCS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SpotOptionsUnmarshaller : IJsonUnmarshaller<SpotOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SpotOptions Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
