...
namespace Amazon.PI.Internal
{
    ...
    public class AmazonPIAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonPIAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for PI.
        /// </summary>
        public AmazonPIAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonPIAuthSchemeParameters
            {
    ...
    public class AmazonPIAuthSchemeResolver : IAuthSchemeResolver<AmazonPIAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonPIAuthSchemeParameters authParameters)
        {
