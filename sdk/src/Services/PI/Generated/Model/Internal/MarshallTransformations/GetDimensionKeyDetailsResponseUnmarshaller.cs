...
{
    /// <summary>
    /// Response Unmarshaller for GetDimensionKeyDetails operation
    /// </summary>  
    public class GetDimensionKeyDetailsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDimensionKeyDetailsResponse response = new GetDimensionKeyDetailsResponse();
        ...
        private static GetDimensionKeyDetailsResponseUnmarshaller _instance = new GetDimensionKeyDetailsResponseUnmarshaller();        

        internal static GetDimensionKeyDetailsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDimensionKeyDetailsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
