...
{
    /// <summary>
    /// Response Unmarshaller for GetResourceMetadata operation
    /// </summary>  
    public class GetResourceMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetResourceMetadataResponse response = new GetResourceMetadataResponse();
        ...
        private static GetResourceMetadataResponseUnmarshaller _instance = new GetResourceMetadataResponseUnmarshaller();        

        internal static GetResourceMetadataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetResourceMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
