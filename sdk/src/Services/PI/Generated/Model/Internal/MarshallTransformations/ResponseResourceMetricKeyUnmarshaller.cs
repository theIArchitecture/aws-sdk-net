...
namespace Amazon.PI.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResponseResourceMetricKeyUnmarshaller : IJsonUnmarshaller<ResponseResourceMetricKey, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResponseResourceMetricKey Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
