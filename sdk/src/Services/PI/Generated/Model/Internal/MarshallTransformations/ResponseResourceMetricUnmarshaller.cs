...
namespace Amazon.PI.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResponseResourceMetricUnmarshaller : IJsonUnmarshaller<ResponseResourceMetric, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResponseResourceMetric Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
