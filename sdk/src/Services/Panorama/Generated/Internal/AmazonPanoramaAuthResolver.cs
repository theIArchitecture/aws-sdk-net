...
namespace Amazon.Panorama.Internal
{
    ...
    public class AmazonPanoramaAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonPanoramaAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Panorama.
        /// </summary>
        public AmazonPanoramaAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonPanoramaAuthSchemeParameters
            {
    ...
    public class AmazonPanoramaAuthSchemeResolver : IAuthSchemeResolver<AmazonPanoramaAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonPanoramaAuthSchemeParameters authParameters)
        {
