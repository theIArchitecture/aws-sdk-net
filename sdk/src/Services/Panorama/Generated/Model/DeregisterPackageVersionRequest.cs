...
{
    /// <summary>
    /// Container for the parameters to the DeregisterPackageVersion operation.
    /// Deregisters a package version.
    /// </summary>
    public partial class DeregisterPackageVersionRequest : AmazonPanoramaRequest
    {
        private string _ownerAccount;
        private string _packageId;
        private string _packageVersion;
        private string _patchVersion;
        private string _updatedLatestPatchVersion;
        ...
        /// <summary>
        /// Gets and sets the property UpdatedLatestPatchVersion. 
        /// <para>
        /// If the version was marked latest, the new version to maker as latest.
        /// </para>
        /// </summary>
        [AWSProperty(Min=1, Max=255)]
        public string UpdatedLatestPatchVersion
        {
            get { return this._updatedLatestPatchVersion; }
            set { this._updatedLatestPatchVersion = value; }
        }

        // Check to see if UpdatedLatestPatchVersion property is set
        internal bool IsSetUpdatedLatestPatchVersion()
        {
            return this._updatedLatestPatchVersion != null;
        }
