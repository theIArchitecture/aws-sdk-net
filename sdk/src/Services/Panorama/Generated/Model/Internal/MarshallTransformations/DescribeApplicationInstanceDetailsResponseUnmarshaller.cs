...
{
    /// <summary>
    /// Response Unmarshaller for DescribeApplicationInstanceDetails operation
    /// </summary>  
    public class DescribeApplicationInstanceDetailsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeApplicationInstanceDetailsResponse response = new DescribeApplicationInstanceDetailsResponse();
        ...
        private static DescribeApplicationInstanceDetailsResponseUnmarshaller _instance = new DescribeApplicationInstanceDetailsResponseUnmarshaller();        

        internal static DescribeApplicationInstanceDetailsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeApplicationInstanceDetailsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
