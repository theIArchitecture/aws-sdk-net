...
namespace Amazon.Panorama.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EthernetPayloadUnmarshaller : IJsonUnmarshaller<EthernetPayload, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EthernetPayload Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
