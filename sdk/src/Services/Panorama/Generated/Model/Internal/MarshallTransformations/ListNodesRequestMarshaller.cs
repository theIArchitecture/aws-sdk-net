    ...
    public class ListNodesRequestMarshaller : IMarshaller<IRequest, ListNodesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListNodesRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetPackageName())
                request.Parameters.Add("packageName", StringUtils.FromString(publicRequest.PackageName));
            
            if (publicRequest.IsSetPackageVersion())
                request.Parameters.Add("packageVersion", StringUtils.FromString(publicRequest.PackageVersion));
            
            if (publicRequest.IsSetPatchVersion())
                request.Parameters.Add("patchVersion", StringUtils.FromString(publicRequest.PatchVersion));
            request.ResourcePath = "/nodes";
