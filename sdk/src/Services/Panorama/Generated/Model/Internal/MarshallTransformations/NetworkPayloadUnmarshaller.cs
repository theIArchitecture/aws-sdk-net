...
namespace Amazon.Panorama.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NetworkPayloadUnmarshaller : IJsonUnmarshaller<NetworkPayload, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NetworkPayload Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
