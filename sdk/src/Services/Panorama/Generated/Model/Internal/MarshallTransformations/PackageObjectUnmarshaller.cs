...
namespace Amazon.Panorama.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PackageObjectUnmarshaller : IJsonUnmarshaller<PackageObject, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PackageObject Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
