...
{
    /// <summary>
    /// CreateResourceSnapshot Request Marshaller
    /// </summary>       
    public class CreateResourceSnapshotRequestMarshaller : IMarshaller<IRequest, CreateResourceSnapshotRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateResourceSnapshotRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateResourceSnapshotRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.PartnerCentralSelling");
            string target = "AWSPartnerCentralSelling.CreateResourceSnapshot";
        ...
        private static CreateResourceSnapshotRequestMarshaller _instance = new CreateResourceSnapshotRequestMarshaller();        

        internal static CreateResourceSnapshotRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateResourceSnapshotRequestMarshaller Instance
        {
            get
            {
                return _instance;
