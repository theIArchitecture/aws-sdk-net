...
{
    /// <summary>
    /// Response Unmarshaller for EngagementCustomer Object
    /// </summary>  
    public class EngagementCustomerUnmarshaller : IJsonUnmarshaller<EngagementCustomer, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EngagementCustomer Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            EngagementCustomer unmarshalledObject = new EngagementCustomer();
        ...
        private static EngagementCustomerUnmarshaller _instance = new EngagementCustomerUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static EngagementCustomerUnmarshaller Instance
        {
            get
            {
                return _instance;
