...
{
    /// <summary>
    /// Response Unmarshaller for GetEngagementInvitation operation
    /// </summary>  
    public class GetEngagementInvitationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetEngagementInvitationResponseUnmarshaller _instance = new GetEngagementInvitationResponseUnmarshaller();        

        internal static GetEngagementInvitationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEngagementInvitationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
