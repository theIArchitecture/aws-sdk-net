...
{
    /// <summary>
    /// GetResourceSnapshot Request Marshaller
    /// </summary>       
    public class GetResourceSnapshotRequestMarshaller : IMarshaller<IRequest, GetResourceSnapshotRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetResourceSnapshotRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetResourceSnapshotRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.PartnerCentralSelling");
            string target = "AWSPartnerCentralSelling.GetResourceSnapshot";
            ...
            if(publicRequest.IsSetRevision())
            {
                ...
                context.Writer.WriteNumberValue(publicRequest.Revision.Value);
            }
        ...
        private static GetResourceSnapshotRequestMarshaller _instance = new GetResourceSnapshotRequestMarshaller();        

        internal static GetResourceSnapshotRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetResourceSnapshotRequestMarshaller Instance
        {
            get
            {
                return _instance;
