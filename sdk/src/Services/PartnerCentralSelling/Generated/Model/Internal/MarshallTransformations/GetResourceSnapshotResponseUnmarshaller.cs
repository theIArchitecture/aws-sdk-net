...
{
    /// <summary>
    /// Response Unmarshaller for GetResourceSnapshot operation
    /// </summary>  
    public class GetResourceSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = ResourceSnapshotPayloadUnmarshaller.Instance;
        ...
        private static GetResourceSnapshotResponseUnmarshaller _instance = new GetResourceSnapshotResponseUnmarshaller();        

        internal static GetResourceSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetResourceSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
