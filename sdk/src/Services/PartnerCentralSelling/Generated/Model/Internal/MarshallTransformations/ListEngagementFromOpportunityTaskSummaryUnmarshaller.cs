...
{
    /// <summary>
    /// Response Unmarshaller for ListEngagementFromOpportunityTaskSummary Object
    /// </summary>  
    public class ListEngagementFromOpportunityTaskSummaryUnmarshaller : IJsonUnmarshaller<ListEngagementFromOpportunityTaskSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ListEngagementFromOpportunityTaskSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ListEngagementFromOpportunityTaskSummary unmarshalledObject = new ListEngagementFromOpportunityTaskSummary();
        ...
        private static ListEngagementFromOpportunityTaskSummaryUnmarshaller _instance = new ListEngagementFromOpportunityTaskSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ListEngagementFromOpportunityTaskSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
