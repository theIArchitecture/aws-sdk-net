...
{
    /// <summary>
    /// Response Unmarshaller for OpportunityInvitationPayload Object
    /// </summary>  
    public class OpportunityInvitationPayloadUnmarshaller : IJsonUnmarshaller<OpportunityInvitationPayload, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public OpportunityInvitationPayload Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            OpportunityInvitationPayload unmarshalledObject = new OpportunityInvitationPayload();
        ...
        private static OpportunityInvitationPayloadUnmarshaller _instance = new OpportunityInvitationPayloadUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static OpportunityInvitationPayloadUnmarshaller Instance
        {
            get
            {
                return _instance;
