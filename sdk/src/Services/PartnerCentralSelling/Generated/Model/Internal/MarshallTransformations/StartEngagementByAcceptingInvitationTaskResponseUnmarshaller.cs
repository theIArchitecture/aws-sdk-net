...
{
    /// <summary>
    /// Response Unmarshaller for StartEngagementByAcceptingInvitationTask operation
    /// </summary>  
    public class StartEngagementByAcceptingInvitationTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartEngagementByAcceptingInvitationTaskResponse response = new StartEngagementByAcceptingInvitationTaskResponse();
        ...
        private static StartEngagementByAcceptingInvitationTaskResponseUnmarshaller _instance = new StartEngagementByAcceptingInvitationTaskResponseUnmarshaller();        

        internal static StartEngagementByAcceptingInvitationTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartEngagementByAcceptingInvitationTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
