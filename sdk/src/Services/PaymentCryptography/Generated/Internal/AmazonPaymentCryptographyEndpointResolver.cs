...
namespace Amazon.PaymentCryptography.Internal
{
    ...
    /// </summary>
    public class AmazonPaymentCryptographyEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonPaymentCryptographyConfig)requestContext.ClientConfig;
            var result = new PaymentCryptographyEndpointParameters();
