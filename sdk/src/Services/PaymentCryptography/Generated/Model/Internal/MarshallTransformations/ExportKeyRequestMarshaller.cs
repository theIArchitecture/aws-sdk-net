...
namespace Amazon.PaymentCryptography.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ExportKeyRequestMarshaller : IMarshaller<IRequest, ExportKeyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ExportKeyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ExportKeyRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.PaymentCryptography");
            string target = "PaymentCryptographyControlPlane.ExportKey";
            ...
            if(publicRequest.IsSetExportKeyIdentifier())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ExportKeyIdentifier);
            }
            ...
            if(publicRequest.IsSetKeyMaterial())
            {
                ...
                var marshaller = ExportKeyMaterialMarshaller.Instance;
        ...
        private static ExportKeyRequestMarshaller _instance = new ExportKeyRequestMarshaller();        

        internal static ExportKeyRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExportKeyRequestMarshaller Instance
        {
            get
            {
                return _instance;
