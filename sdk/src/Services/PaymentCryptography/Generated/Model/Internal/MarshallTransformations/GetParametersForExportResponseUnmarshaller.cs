...
namespace Amazon.PaymentCryptography.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetParametersForExportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetParametersForExportResponse response = new GetParametersForExportResponse();
        ...
        private static GetParametersForExportResponseUnmarshaller _instance = new GetParametersForExportResponseUnmarshaller();        

        internal static GetParametersForExportResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetParametersForExportResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
