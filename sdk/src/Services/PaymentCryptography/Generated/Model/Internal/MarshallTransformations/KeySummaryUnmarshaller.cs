...
namespace Amazon.PaymentCryptography.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class KeySummaryUnmarshaller : IJsonUnmarshaller<KeySummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public KeySummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static KeySummaryUnmarshaller _instance = new KeySummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static KeySummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
