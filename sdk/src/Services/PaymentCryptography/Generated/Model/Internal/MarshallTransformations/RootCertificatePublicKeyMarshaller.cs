...
namespace Amazon.PaymentCryptography.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public class RootCertificatePublicKeyMarshaller : IRequestMarshaller<RootCertificatePublicKey, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(RootCertificatePublicKey requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static RootCertificatePublicKeyMarshaller Instance = new RootCertificatePublicKeyMarshaller();
