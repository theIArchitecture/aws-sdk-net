...
namespace Amazon.PaymentCryptographyData.Internal
{
    ...
    /// </summary>
    public class AmazonPaymentCryptographyDataEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonPaymentCryptographyDataConfig)requestContext.ClientConfig;
            var result = new PaymentCryptographyDataEndpointParameters();
