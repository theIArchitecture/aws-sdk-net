...
namespace Amazon.PaymentCryptographyData.Model
{
    ...
    public partial class CardVerificationAttributes
    {
        ...
        private DiscoverDynamicCardVerificationCode _discoverDynamicCardVerificationCode;
        ...
        /// </para>
        /// </summary>
        public DiscoverDynamicCardVerificationCode DiscoverDynamicCardVerificationCode
        {
            get { return this._discoverDynamicCardVerificationCode; }
            set { this._discoverDynamicCardVerificationCode = value; }
        }

        // Check to see if DiscoverDynamicCardVerificationCode property is set
        internal bool IsSetDiscoverDynamicCardVerificationCode()
        {
            return this._discoverDynamicCardVerificationCode != null;
        }
