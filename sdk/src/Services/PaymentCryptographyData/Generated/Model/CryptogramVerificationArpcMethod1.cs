...
namespace Amazon.PaymentCryptographyData.Model
{
    ...
    public partial class CryptogramVerificationArpcMethod1
    {
        ...
        {
            get { return this._authResponseCode; }
            set { this._authResponseCode = value; }
        }

        // Check to see if AuthResponseCode property is set
        internal bool IsSetAuthResponseCode()
        {
            return this._authResponseCode != null;
        }
