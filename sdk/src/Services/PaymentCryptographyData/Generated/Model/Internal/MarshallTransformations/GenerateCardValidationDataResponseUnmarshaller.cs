...
namespace Amazon.PaymentCryptographyData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GenerateCardValidationDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GenerateCardValidationDataResponse response = new GenerateCardValidationDataResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ValidationData = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GenerateCardValidationDataResponseUnmarshaller _instance = new GenerateCardValidationDataResponseUnmarshaller();        

        internal static GenerateCardValidationDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GenerateCardValidationDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
