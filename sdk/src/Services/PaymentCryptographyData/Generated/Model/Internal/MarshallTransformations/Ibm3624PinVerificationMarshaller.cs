...
namespace Amazon.PaymentCryptographyData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public class Ibm3624PinVerificationMarshaller : IRequestMarshaller<Ibm3624PinVerification, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(Ibm3624PinVerification requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetPinOffset())
            {
                context.Writer.WritePropertyName("PinOffset");
                context.Writer.WriteStringValue(requestObject.PinOffset);
            }
        ...
        /// </summary>
        public readonly static Ibm3624PinVerificationMarshaller Instance = new Ibm3624PinVerificationMarshaller();
