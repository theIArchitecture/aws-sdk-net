...
namespace Amazon.PaymentCryptographyData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TranslatePinDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TranslatePinDataResponse response = new TranslatePinDataResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PinBlock = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static TranslatePinDataResponseUnmarshaller _instance = new TranslatePinDataResponseUnmarshaller();        

        internal static TranslatePinDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TranslatePinDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
