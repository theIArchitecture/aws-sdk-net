...
namespace Amazon.PaymentCryptographyData.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class VerifyAuthRequestCryptogramRequestMarshaller : IMarshaller<IRequest, VerifyAuthRequestCryptogramRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static VerifyAuthRequestCryptogramRequestMarshaller _instance = new VerifyAuthRequestCryptogramRequestMarshaller();        

        internal static VerifyAuthRequestCryptogramRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static VerifyAuthRequestCryptogramRequestMarshaller Instance
        {
            get
            {
                return _instance;
