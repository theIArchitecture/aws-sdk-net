...
namespace Amazon.PaymentCryptographyData
{
    ...
    public partial interface IAmazonPaymentCryptographyData : IAmazonService, IDisposable
    {
        ...
        Task<DecryptDataResponse> DecryptDataAsync(DecryptDataRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<EncryptDataResponse> EncryptDataAsync(EncryptDataRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GenerateCardValidationDataResponse> GenerateCardValidationDataAsync(GenerateCardValidationDataRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GenerateMacEmvPinChangeResponse> GenerateMacEmvPinChangeAsync(GenerateMacEmvPinChangeRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GeneratePinDataResponse> GeneratePinDataAsync(GeneratePinDataRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ReEncryptDataResponse> ReEncryptDataAsync(ReEncryptDataRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<TranslatePinDataResponse> TranslatePinDataAsync(TranslatePinDataRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<VerifyAuthRequestCryptogramResponse> VerifyAuthRequestCryptogramAsync(VerifyAuthRequestCryptogramRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<VerifyCardValidationDataResponse> VerifyCardValidationDataAsync(VerifyCardValidationDataRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<VerifyPinDataResponse> VerifyPinDataAsync(VerifyPinDataRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonPaymentCryptographyDataConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonPaymentCryptographyDataConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonPaymentCryptographyDataConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonPaymentCryptographyDataConfig to create AmazonPaymentCryptographyDataClient");
            }

            return awsCredentials == null ? 
                    new AmazonPaymentCryptographyDataClient(serviceClientConfig) :
                    new AmazonPaymentCryptographyDataClient(awsCredentials, serviceClientConfig);
        }
