...
namespace Amazon.PcaConnectorAd
{
    ...
    public partial class AmazonPcaConnectorAdConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Pca Connector Ad", "4.0.0.25");
        ...
        /// Default constructor
        /// </summary>
        public AmazonPcaConnectorAdConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonPcaConnectorAdDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "Pca Connector Ad";
            this.AuthenticationServiceName = "pca-connector-ad";
            this.EndpointProvider = new AmazonPcaConnectorAdEndpointProvider();
        }
