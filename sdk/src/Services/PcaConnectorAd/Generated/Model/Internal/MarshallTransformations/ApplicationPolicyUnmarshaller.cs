...
namespace Amazon.PcaConnectorAd.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ApplicationPolicyUnmarshaller : IJsonUnmarshaller<ApplicationPolicy, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ApplicationPolicy Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("PolicyObjectIdentifier", targetDepth))
                {
                    ...
                    unmarshalledObject.PolicyObjectIdentifier = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
