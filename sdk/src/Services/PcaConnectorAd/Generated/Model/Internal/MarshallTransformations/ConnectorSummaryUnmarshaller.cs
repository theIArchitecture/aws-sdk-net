    ...
    public class ConnectorSummaryUnmarshaller : IJsonUnmarshaller<ConnectorSummary, JsonUnmarshallerContext>
    {
        ...
        public ConnectorSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.CertificateEnrollmentPolicyServerEndpoint = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = VpcInformationUnmarshaller.Instance;
                    unmarshalledObject.VpcInformation = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
