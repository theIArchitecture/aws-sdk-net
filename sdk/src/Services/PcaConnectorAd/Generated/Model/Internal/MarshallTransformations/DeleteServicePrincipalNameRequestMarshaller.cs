...
namespace Amazon.PcaConnectorAd.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteServicePrincipalNameRequestMarshaller : IMarshaller<IRequest, DeleteServicePrincipalNameRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteServicePrincipalNameRequestMarshaller _instance = new DeleteServicePrincipalNameRequestMarshaller();        

        internal static DeleteServicePrincipalNameRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteServicePrincipalNameRequestMarshaller Instance
        {
            get
            {
                return _instance;
