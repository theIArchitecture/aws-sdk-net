...
{
    /// <summary>
    /// GetServicePrincipalName Request Marshaller
    /// </summary>       
    public class GetServicePrincipalNameRequestMarshaller : IMarshaller<IRequest, GetServicePrincipalNameRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetServicePrincipalNameRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetServicePrincipalNameRequest publicRequest)
        {
        ...
        private static GetServicePrincipalNameRequestMarshaller _instance = new GetServicePrincipalNameRequestMarshaller();        

        internal static GetServicePrincipalNameRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetServicePrincipalNameRequestMarshaller Instance
        {
            get
            {
                return _instance;
