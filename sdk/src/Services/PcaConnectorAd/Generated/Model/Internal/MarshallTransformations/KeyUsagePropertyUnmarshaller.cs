...
namespace Amazon.PcaConnectorAd.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class KeyUsagePropertyUnmarshaller : IJsonUnmarshaller<KeyUsageProperty, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public KeyUsageProperty Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("PropertyFlags", targetDepth))
                {
                    ...
                    unmarshalledObject.PropertyFlags = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
