...
{
    /// <summary>
    /// Response Unmarshaller for PrivateKeyAttributesV4 Object
    /// </summary>  
    public class PrivateKeyAttributesV4Unmarshaller : IJsonUnmarshaller<PrivateKeyAttributesV4, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PrivateKeyAttributesV4 Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static PrivateKeyAttributesV4Unmarshaller _instance = new PrivateKeyAttributesV4Unmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PrivateKeyAttributesV4Unmarshaller Instance
        {
            get
            {
                return _instance;
