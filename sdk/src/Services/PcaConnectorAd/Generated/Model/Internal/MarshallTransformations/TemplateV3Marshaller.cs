...
{
    /// <summary>
    /// TemplateV3 Marshaller
    /// </summary>
    public class TemplateV3Marshaller : IRequestMarshaller<TemplateV3, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(TemplateV3 requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetEnrollmentFlags())
            {
                ...
                var marshaller = EnrollmentFlagsV3Marshaller.Instance;
            ...
            if(requestObject.IsSetExtensions())
            {
                ...
                var marshaller = ExtensionsV3Marshaller.Instance;
            ...
            if(requestObject.IsSetGeneralFlags())
            {
                ...
                var marshaller = GeneralFlagsV3Marshaller.Instance;
            ...
            if(requestObject.IsSetPrivateKeyAttributes())
            {
                ...
                var marshaller = PrivateKeyAttributesV3Marshaller.Instance;
            ...
            if(requestObject.IsSetPrivateKeyFlags())
            {
                ...
                var marshaller = PrivateKeyFlagsV3Marshaller.Instance;
            ...
            if(requestObject.IsSetSubjectNameFlags())
            {
                ...
                var marshaller = SubjectNameFlagsV3Marshaller.Instance;
        ...
        /// </summary>
        public readonly static TemplateV3Marshaller Instance = new TemplateV3Marshaller();
