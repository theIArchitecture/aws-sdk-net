...
{
    /// <summary>
    /// This is the response object from the ListTemplateGroupAccessControlEntries operation.
    /// </summary>
    public partial class ListTemplateGroupAccessControlEntriesResponse : AmazonWebServiceResponse
    {
        ...
        /// <summary>
        /// Gets and sets the property AccessControlEntries. 
        /// <para>
        /// An access control entry grants or denies permission to an Active Directory group to
        /// enroll certificates for a template.
        /// </para>
        /// <para />
        ...
        /// </summary>
        public List<AccessControlEntrySummary> AccessControlEntries
        {
            get { return this._accessControlEntries; }
            set { this._accessControlEntries = value; }
        }
