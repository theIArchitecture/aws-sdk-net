...
namespace Amazon.PcaConnectorScep.Internal
{
    ...
    public class AmazonPcaConnectorScepAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonPcaConnectorScepAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for PcaConnectorScep.
        /// </summary>
        public AmazonPcaConnectorScepAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonPcaConnectorScepAuthSchemeParameters
            {
    ...
    public class AmazonPcaConnectorScepAuthSchemeResolver : IAuthSchemeResolver<AmazonPcaConnectorScepAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonPcaConnectorScepAuthSchemeParameters authParameters)
        {
