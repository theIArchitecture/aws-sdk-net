...
{
    /// <summary>
    /// Response Unmarshaller for Challenge Object
    /// </summary>  
    public class ChallengeUnmarshaller : IJsonUnmarshaller<Challenge, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Challenge Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            Challenge unmarshalledObject = new Challenge();
        ...
        private static ChallengeUnmarshaller _instance = new ChallengeUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ChallengeUnmarshaller Instance
        {
            get
            {
                return _instance;
