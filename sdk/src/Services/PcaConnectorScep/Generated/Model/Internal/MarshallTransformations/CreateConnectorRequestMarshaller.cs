...
namespace Amazon.PcaConnectorScep.Model.Internal.MarshallTransformations
{
    ...
    public class CreateConnectorRequestMarshaller : IMarshaller<IRequest, CreateConnectorRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateConnectorRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetMobileDeviceManagement())
            {
                context.Writer.WritePropertyName("MobileDeviceManagement");
                context.Writer.WriteStartObject();

                var marshaller = MobileDeviceManagementMarshaller.Instance;
                marshaller.Marshall(publicRequest.MobileDeviceManagement, context);
