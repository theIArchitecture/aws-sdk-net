...
{
    /// <summary>
    /// IntuneConfiguration Marshaller
    /// </summary>
    public class IntuneConfigurationMarshaller : IRequestMarshaller<IntuneConfiguration, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(IntuneConfiguration requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static IntuneConfigurationMarshaller Instance = new IntuneConfigurationMarshaller();
