...
{
    /// <summary>
    /// Response Unmarshaller for OpenIdConfiguration Object
    /// </summary>  
    public class OpenIdConfigurationUnmarshaller : IJsonUnmarshaller<OpenIdConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public OpenIdConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            OpenIdConfiguration unmarshalledObject = new OpenIdConfiguration();
        ...
        private static OpenIdConfigurationUnmarshaller _instance = new OpenIdConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static OpenIdConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
