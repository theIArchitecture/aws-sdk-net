...
{
    /// <summary>
    /// This is the response object from the ListChallengeMetadata operation.
    /// </summary>
    public partial class ListChallengeMetadataResponse : AmazonWebServiceResponse
    {
        private List<ChallengeMetadataSummary> _challenges = AWSConfigs.InitializeCollections ? new List<ChallengeMetadataSummary>() : null;
        private string _nextToken;

        /// <summary>
        /// Gets and sets the property Challenges. 
        /// <para>
        ...
        /// </summary>
        public List<ChallengeMetadataSummary> Challenges
        {
            get { return this._challenges; }
            set { this._challenges = value; }
        }

        // Check to see if Challenges property is set
        internal bool IsSetChallenges()
        {
            return this._challenges != null && (this._challenges.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
