...
namespace Amazon.PcaConnectorScep.Model
{
    ...
    [Serializable]
    #endif
    public partial class ValidationException : AmazonPcaConnectorScepException
    {
        ...
        /// <para>
        /// The reason for the validation error, if available. The service doesn't return a reason
        /// for every validation exception.
        /// </para>
        /// </summary>
