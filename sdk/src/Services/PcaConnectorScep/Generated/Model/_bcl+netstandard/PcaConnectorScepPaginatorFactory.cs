...
namespace Amazon.PcaConnectorScep.Model
{
    ...
    public class PcaConnectorScepPaginatorFactory : IPcaConnectorScepPaginatorFactory
    {
        ...
        internal PcaConnectorScepPaginatorFactory(IAmazonPcaConnectorScep client) 
        {
            this.client = client;
        }
        ...
        ///</summary>
        public IListChallengeMetadataPaginator ListChallengeMetadata(ListChallengeMetadataRequest request) 
        {
            return new ListChallengeMetadataPaginator(this.client, request);
        }
