...
namespace Amazon.PcaConnectorScep
{
    ...
    public partial interface IAmazonPcaConnectorScep : IAmazonService, IDisposable
    {
        ...
        Task<CreateChallengeResponse> CreateChallengeAsync(CreateChallengeRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteChallengeResponse> DeleteChallengeAsync(DeleteChallengeRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetChallengeMetadataResponse> GetChallengeMetadataAsync(GetChallengeMetadataRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetChallengePasswordResponse> GetChallengePasswordAsync(GetChallengePasswordRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListChallengeMetadataResponse> ListChallengeMetadataAsync(ListChallengeMetadataRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonPcaConnectorScepConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonPcaConnectorScepConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonPcaConnectorScepConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonPcaConnectorScepConfig to create AmazonPcaConnectorScepClient");
            }

            return awsCredentials == null ? 
                    new AmazonPcaConnectorScepClient(serviceClientConfig) :
                    new AmazonPcaConnectorScepClient(awsCredentials, serviceClientConfig);
        }
