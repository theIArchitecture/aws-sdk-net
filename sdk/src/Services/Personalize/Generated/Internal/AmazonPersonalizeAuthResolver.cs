...
namespace Amazon.Personalize.Internal
{
    ...
    public class AmazonPersonalizeAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonPersonalizeAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Personalize.
        /// </summary>
        public AmazonPersonalizeAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonPersonalizeAuthSchemeParameters
            {
    ...
    public class AmazonPersonalizeAuthSchemeResolver : IAuthSchemeResolver<AmazonPersonalizeAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonPersonalizeAuthSchemeParameters authParameters)
        {
