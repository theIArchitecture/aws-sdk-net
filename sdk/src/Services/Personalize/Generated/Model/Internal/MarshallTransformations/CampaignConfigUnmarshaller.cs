...
namespace Amazon.Personalize.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CampaignConfigUnmarshaller : IJsonUnmarshaller<CampaignConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CampaignConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    unmarshalledObject.SyncWithLatestSolutionVersion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
