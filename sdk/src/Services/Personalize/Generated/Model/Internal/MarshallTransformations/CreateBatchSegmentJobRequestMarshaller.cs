...
{
    /// <summary>
    /// CreateBatchSegmentJob Request Marshaller
    /// </summary>       
    public class CreateBatchSegmentJobRequestMarshaller : IMarshaller<IRequest, CreateBatchSegmentJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateBatchSegmentJobRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateBatchSegmentJobRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Personalize");
            string target = "AmazonPersonalize.CreateBatchSegmentJob";
            ...
            if(publicRequest.IsSetJobInput())
            {
                ...
                var marshaller = BatchSegmentJobInputMarshaller.Instance;
            ...
            if(publicRequest.IsSetJobOutput())
            {
                ...
                var marshaller = BatchSegmentJobOutputMarshaller.Instance;
        ...
        private static CreateBatchSegmentJobRequestMarshaller _instance = new CreateBatchSegmentJobRequestMarshaller();        

        internal static CreateBatchSegmentJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateBatchSegmentJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
