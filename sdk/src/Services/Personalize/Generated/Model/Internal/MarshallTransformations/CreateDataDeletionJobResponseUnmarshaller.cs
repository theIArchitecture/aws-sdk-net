...
{
    /// <summary>
    /// Response Unmarshaller for CreateDataDeletionJob operation
    /// </summary>  
    public class CreateDataDeletionJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDataDeletionJobResponse response = new CreateDataDeletionJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("dataDeletionJobArn", targetDepth))
                {
                    ...
                    response.DataDeletionJobArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateDataDeletionJobResponseUnmarshaller _instance = new CreateDataDeletionJobResponseUnmarshaller();        

        internal static CreateDataDeletionJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDataDeletionJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
