...
{
    /// <summary>
    /// Response Unmarshaller for CreateDatasetExportJob operation
    /// </summary>  
    public class CreateDatasetExportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDatasetExportJobResponse response = new CreateDatasetExportJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("datasetExportJobArn", targetDepth))
                {
                    ...
                    response.DatasetExportJobArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateDatasetExportJobResponseUnmarshaller _instance = new CreateDatasetExportJobResponseUnmarshaller();        

        internal static CreateDatasetExportJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDatasetExportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
