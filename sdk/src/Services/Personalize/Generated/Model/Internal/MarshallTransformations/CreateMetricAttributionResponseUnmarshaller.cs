...
{
    /// <summary>
    /// Response Unmarshaller for CreateMetricAttribution operation
    /// </summary>  
    public class CreateMetricAttributionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateMetricAttributionResponse response = new CreateMetricAttributionResponse();
        ...
        private static CreateMetricAttributionResponseUnmarshaller _instance = new CreateMetricAttributionResponseUnmarshaller();        

        internal static CreateMetricAttributionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMetricAttributionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
