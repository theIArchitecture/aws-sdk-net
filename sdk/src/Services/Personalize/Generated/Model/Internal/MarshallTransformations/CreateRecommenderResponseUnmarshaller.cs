...
{
    /// <summary>
    /// Response Unmarshaller for CreateRecommender operation
    /// </summary>  
    public class CreateRecommenderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRecommenderResponse response = new CreateRecommenderResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("recommenderArn", targetDepth))
                {
                    ...
                    response.RecommenderArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateRecommenderResponseUnmarshaller _instance = new CreateRecommenderResponseUnmarshaller();        

        internal static CreateRecommenderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRecommenderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
