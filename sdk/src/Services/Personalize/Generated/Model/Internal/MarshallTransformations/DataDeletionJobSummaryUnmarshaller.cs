...
{
    /// <summary>
    /// Response Unmarshaller for DataDeletionJobSummary Object
    /// </summary>  
    public class DataDeletionJobSummaryUnmarshaller : IJsonUnmarshaller<DataDeletionJobSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DataDeletionJobSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("dataDeletionJobArn", targetDepth))
                {
                    ...
                    unmarshalledObject.DataDeletionJobArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DataDeletionJobSummaryUnmarshaller _instance = new DataDeletionJobSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DataDeletionJobSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
