...
namespace Amazon.Personalize.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DataDeletionJobUnmarshaller : IJsonUnmarshaller<DataDeletionJob, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DataDeletionJob Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("numDeleted", targetDepth))
                {
                    ...
                    unmarshalledObject.NumDeleted = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
