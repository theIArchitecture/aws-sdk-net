...
namespace Amazon.Personalize.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EventTrackerSummaryUnmarshaller : IJsonUnmarshaller<EventTrackerSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EventTrackerSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("eventTrackerArn", targetDepth))
                {
                    ...
                    unmarshalledObject.EventTrackerArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
