...
namespace Amazon.Personalize.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SolutionUpdateSummaryUnmarshaller : IJsonUnmarshaller<SolutionUpdateSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SolutionUpdateSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("solutionUpdateConfig", targetDepth))
                {
                    ...
                    unmarshalledObject.SolutionUpdateConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
