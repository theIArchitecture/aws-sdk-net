...
{
    /// <summary>
    /// Response Unmarshaller for StartRecommender operation
    /// </summary>  
    public class StartRecommenderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartRecommenderResponse response = new StartRecommenderResponse();
        ...
        private static StartRecommenderResponseUnmarshaller _instance = new StartRecommenderResponseUnmarshaller();        

        internal static StartRecommenderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartRecommenderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
