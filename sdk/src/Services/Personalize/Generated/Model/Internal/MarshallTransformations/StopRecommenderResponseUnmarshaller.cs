...
{
    /// <summary>
    /// Response Unmarshaller for StopRecommender operation
    /// </summary>  
    public class StopRecommenderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopRecommenderResponse response = new StopRecommenderResponse();
        ...
        private static StopRecommenderResponseUnmarshaller _instance = new StopRecommenderResponseUnmarshaller();        

        internal static StopRecommenderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopRecommenderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
