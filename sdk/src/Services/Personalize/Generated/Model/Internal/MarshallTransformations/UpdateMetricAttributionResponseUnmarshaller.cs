...
{
    /// <summary>
    /// Response Unmarshaller for UpdateMetricAttribution operation
    /// </summary>  
    public class UpdateMetricAttributionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateMetricAttributionResponse response = new UpdateMetricAttributionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("metricAttributionArn", targetDepth))
                {
                    ...
                    response.MetricAttributionArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateMetricAttributionResponseUnmarshaller _instance = new UpdateMetricAttributionResponseUnmarshaller();        

        internal static UpdateMetricAttributionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMetricAttributionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
