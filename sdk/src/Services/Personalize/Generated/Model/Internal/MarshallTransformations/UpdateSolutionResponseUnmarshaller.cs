...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSolution operation
    /// </summary>  
    public class UpdateSolutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("solutionArn", targetDepth))
                {
                    ...
                    response.SolutionArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateSolutionResponseUnmarshaller _instance = new UpdateSolutionResponseUnmarshaller();        

        internal static UpdateSolutionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSolutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
