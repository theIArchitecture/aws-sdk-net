...
{
    /// <summary>
    /// Container for the parameters to the ListBatchSegmentJobs operation.
    /// Gets a list of the batch segment jobs that have been performed off of a solution version
    /// that you specify.
    /// </summary>
    public partial class ListBatchSegmentJobsRequest : AmazonPersonalizeRequest
    {
        ...
        /// <para>
        /// The Amazon Resource Name (ARN) of the solution version that the batch segment jobs
        /// used to generate batch segments.
        /// </para>
        /// </summary>
        [AWSProperty(Max=256)]
