...
{
    /// <summary>
    /// Container for the parameters to the ListDataDeletionJobs operation.
    ...
    /// users</a>.
    /// </summary>
    public partial class ListDataDeletionJobsRequest : AmazonPersonalizeRequest
    {
        ...
        /// <para>
        /// A token returned from the previous call to <c>ListDataDeletionJobs</c> for getting
