...
namespace Amazon.PersonalizeEvents.Internal
{
    ...
    public class AmazonPersonalizeEventsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonPersonalizeEventsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for PersonalizeEvents.
        /// </summary>
        public AmazonPersonalizeEventsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonPersonalizeEventsAuthSchemeParameters
            {
    ...
    public class AmazonPersonalizeEventsAuthSchemeResolver : IAuthSchemeResolver<AmazonPersonalizeEventsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonPersonalizeEventsAuthSchemeParameters authParameters)
        {
