...
{
    /// <summary>
    /// PutActions Request Marshaller
    /// </summary>       
    public class PutActionsRequestMarshaller : IMarshaller<IRequest, PutActionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutActionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutActionsRequest publicRequest)
        {
        ...
        private static PutActionsRequestMarshaller _instance = new PutActionsRequestMarshaller();        

        internal static PutActionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutActionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
