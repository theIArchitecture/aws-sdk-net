...
namespace Amazon.PersonalizeRuntime.Internal
{
    ...
    public class AmazonPersonalizeRuntimeAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonPersonalizeRuntimeAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for PersonalizeRuntime.
        /// </summary>
        public AmazonPersonalizeRuntimeAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonPersonalizeRuntimeAuthSchemeParameters
            {
    ...
    public class AmazonPersonalizeRuntimeAuthSchemeResolver : IAuthSchemeResolver<AmazonPersonalizeRuntimeAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonPersonalizeRuntimeAuthSchemeParameters authParameters)
        {
