...
namespace Amazon.PersonalizeRuntime
{
    ...
    public partial interface IAmazonPersonalizeRuntime : IAmazonService, IDisposable
    {
        ...
        Task<GetActionRecommendationsResponse> GetActionRecommendationsAsync(GetActionRecommendationsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
