...
namespace Amazon.Pinpoint.Internal
{
    ...
    public class AmazonPinpointAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonPinpointAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Pinpoint.
        /// </summary>
        public AmazonPinpointAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonPinpointAuthSchemeParameters
            {
    ...
    public class AmazonPinpointAuthSchemeResolver : IAuthSchemeResolver<AmazonPinpointAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonPinpointAuthSchemeParameters authParameters)
        {
