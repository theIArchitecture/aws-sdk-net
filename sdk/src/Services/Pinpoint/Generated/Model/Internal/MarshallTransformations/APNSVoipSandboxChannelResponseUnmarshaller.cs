...
namespace Amazon.Pinpoint.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class APNSVoipSandboxChannelResponseUnmarshaller : IJsonUnmarshaller<APNSVoipSandboxChannelResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public APNSVoipSandboxChannelResponse Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DefaultAuthenticationMethod = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    unmarshalledObject.HasTokenKey = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
