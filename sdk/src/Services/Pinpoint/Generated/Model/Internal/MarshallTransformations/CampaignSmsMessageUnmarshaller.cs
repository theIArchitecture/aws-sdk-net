...
namespace Amazon.Pinpoint.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CampaignSmsMessageUnmarshaller : IJsonUnmarshaller<CampaignSmsMessage, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CampaignSmsMessage Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.OriginationNumber = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
