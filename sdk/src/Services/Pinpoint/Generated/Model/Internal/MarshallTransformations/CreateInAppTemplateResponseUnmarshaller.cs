...
{
    /// <summary>
    /// Response Unmarshaller for CreateInAppTemplate operation
    /// </summary>  
    public class CreateInAppTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateInAppTemplateResponse response = new CreateInAppTemplateResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            if (reader.Reader.IsFinalBlock) return response;
            var unmarshaller = TemplateCreateMessageBodyUnmarshaller.Instance;
            response.TemplateCreateMessageBody = unmarshaller.Unmarshall(context, ref reader);
        ...
        private static CreateInAppTemplateResponseUnmarshaller _instance = new CreateInAppTemplateResponseUnmarshaller();        

        internal static CreateInAppTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateInAppTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
