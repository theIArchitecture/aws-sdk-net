...
namespace Amazon.Pinpoint.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExportJobsResponseUnmarshaller : IJsonUnmarshaller<ExportJobsResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ExportJobsResponse Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ExportJobResponse, ExportJobResponseUnmarshaller>(ExportJobResponseUnmarshaller.Instance);
