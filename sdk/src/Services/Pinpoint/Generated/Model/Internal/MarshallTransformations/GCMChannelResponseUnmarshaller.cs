...
namespace Amazon.Pinpoint.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GCMChannelResponseUnmarshaller : IJsonUnmarshaller<GCMChannelResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GCMChannelResponse Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    unmarshalledObject.HasFcmServiceCredentials = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
