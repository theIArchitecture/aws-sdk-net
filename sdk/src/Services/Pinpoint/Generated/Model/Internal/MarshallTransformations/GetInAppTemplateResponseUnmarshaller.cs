...
{
    /// <summary>
    /// Response Unmarshaller for GetInAppTemplate operation
    /// </summary>  
    public class GetInAppTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            var unmarshaller = InAppTemplateResponseUnmarshaller.Instance;
            response.InAppTemplateResponse = unmarshaller.Unmarshall(context, ref reader);
        ...
        private static GetInAppTemplateResponseUnmarshaller _instance = new GetInAppTemplateResponseUnmarshaller();        

        internal static GetInAppTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetInAppTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
