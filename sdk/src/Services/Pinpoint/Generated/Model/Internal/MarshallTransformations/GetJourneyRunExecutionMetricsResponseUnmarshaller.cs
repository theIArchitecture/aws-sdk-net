...
{
    /// <summary>
    /// Response Unmarshaller for GetJourneyRunExecutionMetrics operation
    /// </summary>  
    public class GetJourneyRunExecutionMetricsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            var unmarshaller = JourneyRunExecutionMetricsResponseUnmarshaller.Instance;
            response.JourneyRunExecutionMetricsResponse = unmarshaller.Unmarshall(context, ref reader);
        ...
        private static GetJourneyRunExecutionMetricsResponseUnmarshaller _instance = new GetJourneyRunExecutionMetricsResponseUnmarshaller();        

        internal static GetJourneyRunExecutionMetricsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetJourneyRunExecutionMetricsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
