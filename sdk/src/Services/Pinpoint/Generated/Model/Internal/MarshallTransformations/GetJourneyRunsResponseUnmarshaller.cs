...
{
    /// <summary>
    /// Response Unmarshaller for GetJourneyRuns operation
    /// </summary>  
    public class GetJourneyRunsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetJourneyRunsResponse response = new GetJourneyRunsResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            if (reader.Reader.IsFinalBlock) return response;
            var unmarshaller = JourneyRunsResponseUnmarshaller.Instance;
            response.JourneyRunsResponse = unmarshaller.Unmarshall(context, ref reader);
        ...
        private static GetJourneyRunsResponseUnmarshaller _instance = new GetJourneyRunsResponseUnmarshaller();        

        internal static GetJourneyRunsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetJourneyRunsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
