...
namespace Amazon.Pinpoint.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ImportJobsResponseUnmarshaller : IJsonUnmarshaller<ImportJobsResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ImportJobsResponse Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ImportJobResponse, ImportJobResponseUnmarshaller>(ImportJobResponseUnmarshaller.Instance);
