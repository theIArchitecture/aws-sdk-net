...
namespace Amazon.Pinpoint.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class JourneyTimeframeCapUnmarshaller : IJsonUnmarshaller<JourneyTimeframeCap, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public JourneyTimeframeCap Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Cap", targetDepth))
                {
                    ...
                    unmarshalledObject.Cap = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
