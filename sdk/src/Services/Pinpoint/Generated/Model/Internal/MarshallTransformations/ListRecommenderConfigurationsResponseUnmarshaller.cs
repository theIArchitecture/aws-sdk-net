...
namespace Amazon.Pinpoint.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListRecommenderConfigurationsResponseUnmarshaller : IJsonUnmarshaller<ListRecommenderConfigurationsResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ListRecommenderConfigurationsResponse Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<RecommenderConfigurationResponse, RecommenderConfigurationResponseUnmarshaller>(RecommenderConfigurationResponseUnmarshaller.Instance);
