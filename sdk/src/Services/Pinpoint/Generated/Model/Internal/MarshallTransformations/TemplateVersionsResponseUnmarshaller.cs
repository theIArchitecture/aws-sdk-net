...
namespace Amazon.Pinpoint.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TemplateVersionsResponseUnmarshaller : IJsonUnmarshaller<TemplateVersionsResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TemplateVersionsResponse Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<TemplateVersionResponse, TemplateVersionResponseUnmarshaller>(TemplateVersionResponseUnmarshaller.Instance);
