...
{
    /// <summary>
    /// Response Unmarshaller for UpdateInAppTemplate operation
    /// </summary>  
    public class UpdateInAppTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateInAppTemplateResponse response = new UpdateInAppTemplateResponse();
        ...
        private static UpdateInAppTemplateResponseUnmarshaller _instance = new UpdateInAppTemplateResponseUnmarshaller();        

        internal static UpdateInAppTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateInAppTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
