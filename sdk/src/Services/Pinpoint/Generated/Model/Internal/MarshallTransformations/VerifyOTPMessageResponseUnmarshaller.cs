...
{
    /// <summary>
    /// Response Unmarshaller for VerifyOTPMessage operation
    /// </summary>  
    public class VerifyOTPMessageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static VerifyOTPMessageResponseUnmarshaller _instance = new VerifyOTPMessageResponseUnmarshaller();        

        internal static VerifyOTPMessageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static VerifyOTPMessageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
