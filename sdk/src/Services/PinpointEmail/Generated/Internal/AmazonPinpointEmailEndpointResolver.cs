...
namespace Amazon.PinpointEmail.Internal
{
    ...
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for PinpointEmail service requests.
    /// Collects values for PinpointEmailEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses PinpointEmailEndpointProvider.
