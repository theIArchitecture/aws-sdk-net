...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonPinpointEmailConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonPinpointEmailConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonPinpointEmailConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonPinpointEmailConfig to create AmazonPinpointEmailClient");
            }

            return awsCredentials == null ? 
                    new AmazonPinpointEmailClient(serviceClientConfig) :
                    new AmazonPinpointEmailClient(awsCredentials, serviceClientConfig);
        }
