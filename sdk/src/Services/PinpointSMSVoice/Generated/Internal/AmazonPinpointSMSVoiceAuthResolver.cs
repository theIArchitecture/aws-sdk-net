...
namespace Amazon.PinpointSMSVoice.Internal
{
    ...
    public class AmazonPinpointSMSVoiceAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonPinpointSMSVoiceAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for PinpointSMSVoice.
        /// </summary>
        public AmazonPinpointSMSVoiceAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonPinpointSMSVoiceAuthSchemeParameters
            {
    ...
    public class AmazonPinpointSMSVoiceAuthSchemeResolver : IAuthSchemeResolver<AmazonPinpointSMSVoiceAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonPinpointSMSVoiceAuthSchemeParameters authParameters)
        {
