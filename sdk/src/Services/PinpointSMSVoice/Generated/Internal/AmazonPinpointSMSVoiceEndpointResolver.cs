...
namespace Amazon.PinpointSMSVoice.Internal
{
    ...
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for PinpointSMSVoice service requests.
    /// Collects values for PinpointSMSVoiceEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses PinpointSMSVoiceEndpointProvider.
