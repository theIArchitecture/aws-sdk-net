...
namespace Amazon.PinpointSMSVoice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SnsDestinationUnmarshaller : IJsonUnmarshaller<SnsDestination, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SnsDestination Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
