...
{
    /// <summary>
    /// Container for the parameters to the DescribeRegistrationVersions operation.
    ...
    public partial class DescribeRegistrationVersionsRequest : AmazonPinpointSMSVoiceV2Request
    {
        ...
        public List<RegistrationVersionFilter> Filters
        {
        ...
        /// <summary>
        /// Gets and sets the property VersionNumbers. 
        /// <para>
        ...
        public List<long> VersionNumbers
        {
            get { return this._versionNumbers; }
            set { this._versionNumbers = value; }
        }
