...
{
    /// <summary>
    /// This is the response object from the DescribeRegistrations operation.
    /// </summary>
    public partial class DescribeRegistrationsResponse : AmazonWebServiceResponse
    {
        ...
        /// <summary>
        /// Gets and sets the property Registrations. 
        /// <para>
        ...
        public List<RegistrationInformation> Registrations
        {
            get { return this._registrations; }
            set { this._registrations = value; }
        }
