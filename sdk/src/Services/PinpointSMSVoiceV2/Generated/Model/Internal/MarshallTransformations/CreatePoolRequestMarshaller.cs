...
{
    /// <summary>
    /// CreatePool Request Marshaller
    /// </summary>       
    public class CreatePoolRequestMarshaller : IMarshaller<IRequest, CreatePoolRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreatePoolRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreatePoolRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.PinpointSMSVoiceV2");
            string target = "PinpointSMSVoiceV2.CreatePool";
        ...
        private static CreatePoolRequestMarshaller _instance = new CreatePoolRequestMarshaller();        

        internal static CreatePoolRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePoolRequestMarshaller Instance
        {
            get
            {
                return _instance;
