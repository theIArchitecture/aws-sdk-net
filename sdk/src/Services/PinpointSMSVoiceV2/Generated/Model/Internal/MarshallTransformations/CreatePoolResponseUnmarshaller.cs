...
{
    /// <summary>
    /// Response Unmarshaller for CreatePool operation
    /// </summary>  
    public class CreatePoolResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreatePoolResponseUnmarshaller _instance = new CreatePoolResponseUnmarshaller();        

        internal static CreatePoolResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePoolResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
