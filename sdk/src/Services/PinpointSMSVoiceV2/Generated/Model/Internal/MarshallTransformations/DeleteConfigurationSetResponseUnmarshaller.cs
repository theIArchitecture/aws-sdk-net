        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("DefaultMessageFeedbackEnabled", targetDepth))
                {
                    ...
                    response.DefaultMessageFeedbackEnabled = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("DefaultMessageType", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.DefaultMessageType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("DefaultSenderId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.DefaultSenderId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
