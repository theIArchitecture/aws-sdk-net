...
{
    /// <summary>
    /// Response Unmarshaller for DeleteProtectConfiguration operation
    /// </summary>  
    public class DeleteProtectConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteProtectConfigurationResponse response = new DeleteProtectConfigurationResponse();
        ...
        private static DeleteProtectConfigurationResponseUnmarshaller _instance = new DeleteProtectConfigurationResponseUnmarshaller();        

        internal static DeleteProtectConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteProtectConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
