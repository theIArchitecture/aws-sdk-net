...
{
    /// <summary>
    /// Response Unmarshaller for DeleteRegistration operation
    /// </summary>  
    public class DeleteRegistrationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ApprovedVersionNumber", targetDepth))
                {
                    ...
                    response.ApprovedVersionNumber = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableLongUnmarshaller.Instance;
                    response.LatestDeniedVersionNumber = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DeleteRegistrationResponseUnmarshaller _instance = new DeleteRegistrationResponseUnmarshaller();        

        internal static DeleteRegistrationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRegistrationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
