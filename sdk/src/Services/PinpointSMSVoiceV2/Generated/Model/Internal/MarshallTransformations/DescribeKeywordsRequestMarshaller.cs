...
{
    /// <summary>
    /// DescribeKeywords Request Marshaller
    /// </summary>       
    public class DescribeKeywordsRequestMarshaller : IMarshaller<IRequest, DescribeKeywordsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeKeywordsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeKeywordsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.PinpointSMSVoiceV2");
            string target = "PinpointSMSVoiceV2.DescribeKeywords";
        ...
        private static DescribeKeywordsRequestMarshaller _instance = new DescribeKeywordsRequestMarshaller();        

        internal static DescribeKeywordsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeKeywordsRequestMarshaller Instance
        {
            get
            {
                return _instance;
