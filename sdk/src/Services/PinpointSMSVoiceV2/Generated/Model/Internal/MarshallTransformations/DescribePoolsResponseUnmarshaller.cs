...
{
    /// <summary>
    /// Response Unmarshaller for DescribePools operation
    /// </summary>  
    public class DescribePoolsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribePoolsResponse response = new DescribePoolsResponse();
        ...
        private static DescribePoolsResponseUnmarshaller _instance = new DescribePoolsResponseUnmarshaller();        

        internal static DescribePoolsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribePoolsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
