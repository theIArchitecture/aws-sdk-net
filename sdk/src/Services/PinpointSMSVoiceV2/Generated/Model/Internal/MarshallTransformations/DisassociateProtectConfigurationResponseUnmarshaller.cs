...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateProtectConfiguration operation
    /// </summary>  
    public class DisassociateProtectConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateProtectConfigurationResponse response = new DisassociateProtectConfigurationResponse();
        ...
        private static DisassociateProtectConfigurationResponseUnmarshaller _instance = new DisassociateProtectConfigurationResponseUnmarshaller();        

        internal static DisassociateProtectConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateProtectConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
