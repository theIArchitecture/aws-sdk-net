...
{
    /// <summary>
    /// Response Unmarshaller for DiscardRegistrationVersion operation
    /// </summary>  
    public class DiscardRegistrationVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DiscardRegistrationVersionResponse response = new DiscardRegistrationVersionResponse();
        ...
        private static DiscardRegistrationVersionResponseUnmarshaller _instance = new DiscardRegistrationVersionResponseUnmarshaller();        

        internal static DiscardRegistrationVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DiscardRegistrationVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
