...
namespace Amazon.PinpointSMSVoiceV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OriginationIdentityMetadataUnmarshaller : IJsonUnmarshaller<OriginationIdentityMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public OriginationIdentityMetadata Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.OriginationIdentityArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
