...
namespace Amazon.PinpointSMSVoiceV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ProtectConfigurationInformationUnmarshaller : IJsonUnmarshaller<ProtectConfigurationInformation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ProtectConfigurationInformation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AccountDefault", targetDepth))
                {
                    ...
                    unmarshalledObject.AccountDefault = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("ProtectConfigurationArn", targetDepth))
                {
                    ...
                    unmarshalledObject.ProtectConfigurationArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
