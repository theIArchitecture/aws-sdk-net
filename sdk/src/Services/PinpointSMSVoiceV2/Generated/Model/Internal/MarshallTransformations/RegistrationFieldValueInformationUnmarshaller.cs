...
namespace Amazon.PinpointSMSVoiceV2.Model.Internal.MarshallTransformations
{
    ...
    public class RegistrationFieldValueInformationUnmarshaller : IJsonUnmarshaller<RegistrationFieldValueInformation, JsonUnmarshallerContext>
    {
        ...
        private static RegistrationFieldValueInformationUnmarshaller _instance = new RegistrationFieldValueInformationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RegistrationFieldValueInformationUnmarshaller Instance
        {
            get
            {
                return _instance;
