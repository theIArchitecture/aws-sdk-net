...
namespace Amazon.PinpointSMSVoiceV2.Model.Internal.MarshallTransformations
{
    ...
    public class RegistrationSectionDefinitionUnmarshaller : IJsonUnmarshaller<RegistrationSectionDefinition, JsonUnmarshallerContext>
    {
        ...
        private static RegistrationSectionDefinitionUnmarshaller _instance = new RegistrationSectionDefinitionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RegistrationSectionDefinitionUnmarshaller Instance
        {
            get
            {
                return _instance;
