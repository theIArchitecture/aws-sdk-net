...
{
    /// <summary>
    /// Response Unmarshaller for RegistrationTypeDefinition Object
    /// </summary>  
    public class RegistrationTypeDefinitionUnmarshaller : IJsonUnmarshaller<RegistrationTypeDefinition, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RegistrationTypeDefinition Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            RegistrationTypeDefinition unmarshalledObject = new RegistrationTypeDefinition();
        ...
        private static RegistrationTypeDefinitionUnmarshaller _instance = new RegistrationTypeDefinitionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RegistrationTypeDefinitionUnmarshaller Instance
        {
            get
            {
                return _instance;
