...
namespace Amazon.PinpointSMSVoiceV2.Model.Internal.MarshallTransformations
{
    ...
    public class RegistrationVersionStatusHistoryUnmarshaller : IJsonUnmarshaller<RegistrationVersionStatusHistory, JsonUnmarshallerContext>
    {
        ...
        private static RegistrationVersionStatusHistoryUnmarshaller _instance = new RegistrationVersionStatusHistoryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RegistrationVersionStatusHistoryUnmarshaller Instance
        {
            get
            {
                return _instance;
