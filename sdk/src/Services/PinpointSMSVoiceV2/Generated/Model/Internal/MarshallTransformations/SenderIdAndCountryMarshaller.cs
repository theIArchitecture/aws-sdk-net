...
{
    /// <summary>
    /// SenderIdAndCountry Marshaller
    /// </summary>
    public class SenderIdAndCountryMarshaller : IRequestMarshaller<SenderIdAndCountry, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(SenderIdAndCountry requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetIsoCountryCode())
            {
                ...
                context.Writer.WriteStringValue(requestObject.IsoCountryCode);
            }
        ...
        /// </summary>
        public readonly static SenderIdAndCountryMarshaller Instance = new SenderIdAndCountryMarshaller();
