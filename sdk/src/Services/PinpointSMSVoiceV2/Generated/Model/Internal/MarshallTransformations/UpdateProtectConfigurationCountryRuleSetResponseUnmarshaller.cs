...
{
    /// <summary>
    /// Response Unmarshaller for UpdateProtectConfigurationCountryRuleSet operation
    /// </summary>  
    public class UpdateProtectConfigurationCountryRuleSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateProtectConfigurationCountryRuleSetResponse response = new UpdateProtectConfigurationCountryRuleSetResponse();
        ...
        private static UpdateProtectConfigurationCountryRuleSetResponseUnmarshaller _instance = new UpdateProtectConfigurationCountryRuleSetResponseUnmarshaller();        

        internal static UpdateProtectConfigurationCountryRuleSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateProtectConfigurationCountryRuleSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
