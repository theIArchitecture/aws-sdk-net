...
{
    /// <summary>
    /// Response Unmarshaller for UpdateProtectConfiguration operation
    /// </summary>  
    public class UpdateProtectConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateProtectConfigurationResponse response = new UpdateProtectConfigurationResponse();
        ...
        private static UpdateProtectConfigurationResponseUnmarshaller _instance = new UpdateProtectConfigurationResponseUnmarshaller();        

        internal static UpdateProtectConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateProtectConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
