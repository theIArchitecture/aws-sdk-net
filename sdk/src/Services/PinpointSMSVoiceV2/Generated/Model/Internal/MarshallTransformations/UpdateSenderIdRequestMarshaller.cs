...
{
    /// <summary>
    /// UpdateSenderId Request Marshaller
    /// </summary>       
    public class UpdateSenderIdRequestMarshaller : IMarshaller<IRequest, UpdateSenderIdRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateSenderIdRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateSenderIdRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.PinpointSMSVoiceV2");
            string target = "PinpointSMSVoiceV2.UpdateSenderId";
        ...
        private static UpdateSenderIdRequestMarshaller _instance = new UpdateSenderIdRequestMarshaller();        

        internal static UpdateSenderIdRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSenderIdRequestMarshaller Instance
        {
            get
            {
                return _instance;
