...
{
    /// <summary>
    /// PipeEnrichmentParameters Marshaller
    /// </summary>
    public class PipeEnrichmentParametersMarshaller : IRequestMarshaller<PipeEnrichmentParameters, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(PipeEnrichmentParameters requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetHttpParameters())
            {
                ...
                var marshaller = PipeEnrichmentHttpParametersMarshaller.Instance;
        ...
        /// </summary>
        public readonly static PipeEnrichmentParametersMarshaller Instance = new PipeEnrichmentParametersMarshaller();
