...
namespace Amazon.Pipes.Model.Internal.MarshallTransformations
{
    ...
    public class PipeSourceDynamoDBStreamParametersUnmarshaller : IJsonUnmarshaller<PipeSourceDynamoDBStreamParameters, JsonUnmarshallerContext>
    {
        ...
        private static PipeSourceDynamoDBStreamParametersUnmarshaller _instance = new PipeSourceDynamoDBStreamParametersUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PipeSourceDynamoDBStreamParametersUnmarshaller Instance
        {
            get
            {
                return _instance;
