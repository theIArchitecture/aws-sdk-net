...
{
    /// <summary>
    /// PipeSourceRabbitMQBrokerParameters Marshaller
    /// </summary>
    public class PipeSourceRabbitMQBrokerParametersMarshaller : IRequestMarshaller<PipeSourceRabbitMQBrokerParameters, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(PipeSourceRabbitMQBrokerParameters requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetVirtualHost())
            {
                context.Writer.WritePropertyName("VirtualHost");
                context.Writer.WriteStringValue(requestObject.VirtualHost);
            }
        ...
        /// </summary>
        public readonly static PipeSourceRabbitMQBrokerParametersMarshaller Instance = new PipeSourceRabbitMQBrokerParametersMarshaller();
