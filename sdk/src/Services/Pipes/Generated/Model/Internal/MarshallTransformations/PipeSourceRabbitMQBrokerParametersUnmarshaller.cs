...
{
    /// <summary>
    /// Response Unmarshaller for PipeSourceRabbitMQBrokerParameters Object
    /// </summary>  
    public class PipeSourceRabbitMQBrokerParametersUnmarshaller : IJsonUnmarshaller<PipeSourceRabbitMQBrokerParameters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PipeSourceRabbitMQBrokerParameters Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            PipeSourceRabbitMQBrokerParameters unmarshalledObject = new PipeSourceRabbitMQBrokerParameters();
        ...
        private static PipeSourceRabbitMQBrokerParametersUnmarshaller _instance = new PipeSourceRabbitMQBrokerParametersUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PipeSourceRabbitMQBrokerParametersUnmarshaller Instance
        {
            get
            {
                return _instance;
