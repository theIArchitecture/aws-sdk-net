...
namespace Amazon.Pipes.Model.Internal.MarshallTransformations
{
    ...
    public class PipeSourceSelfManagedKafkaParametersUnmarshaller : IJsonUnmarshaller<PipeSourceSelfManagedKafkaParameters, JsonUnmarshallerContext>
    {
        ...
        private static PipeSourceSelfManagedKafkaParametersUnmarshaller _instance = new PipeSourceSelfManagedKafkaParametersUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PipeSourceSelfManagedKafkaParametersUnmarshaller Instance
        {
            get
            {
                return _instance;
