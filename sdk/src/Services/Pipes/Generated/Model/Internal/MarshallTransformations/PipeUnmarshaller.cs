...
namespace Amazon.Pipes.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PipeUnmarshaller : IJsonUnmarshaller<Pipe, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Pipe Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.Enrichment = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
