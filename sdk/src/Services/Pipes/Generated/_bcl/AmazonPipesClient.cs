...
namespace Amazon.Pipes
{
    ...
    public partial class AmazonPipesClient : AmazonServiceClient, IAmazonPipes
    {
        ...
        public AmazonPipesClient(RegionEndpoint region)
            : base(new AmazonPipesConfig{RegionEndpoint = region}) { }
        ...
        protected override void CustomizeRuntimePipeline(RuntimePipeline pipeline)
        {
            ...
            pipeline.AddHandlerAfter<Amazon.Runtime.Internal.Marshaller>(new AmazonPipesAuthSchemeHandler());
        }
