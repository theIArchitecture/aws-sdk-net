...
namespace Amazon.Polly.Internal
{
    ...
    public class AmazonPollyAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonPollyAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Polly.
        /// </summary>
        public AmazonPollyAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonPollyAuthSchemeParameters
            {
    ...
    public class AmazonPollyAuthSchemeResolver : IAuthSchemeResolver<AmazonPollyAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonPollyAuthSchemeParameters authParameters)
        {
