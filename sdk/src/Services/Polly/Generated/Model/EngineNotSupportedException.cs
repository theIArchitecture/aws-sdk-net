...
namespace Amazon.Polly.Model
{
    ...
    public partial class EngineNotSupportedException : AmazonPollyException
    {
        ...
        public EngineNotSupportedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public EngineNotSupportedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
