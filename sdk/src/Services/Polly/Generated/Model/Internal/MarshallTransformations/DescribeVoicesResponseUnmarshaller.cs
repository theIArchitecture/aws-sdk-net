    ...
    public class DescribeVoicesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<Voice, VoiceUnmarshaller>(VoiceUnmarshaller.Instance);
                    response.Voices = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
