    ...
    public class ListLexiconsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<LexiconDescription, LexiconDescriptionUnmarshaller>(LexiconDescriptionUnmarshaller.Instance);
                    response.Lexicons = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
