...
namespace Amazon.Polly.Model
{
    ...
    public partial class MarksNotSupportedForFormatException : AmazonPollyException
    {
        ...
        public MarksNotSupportedForFormatException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public MarksNotSupportedForFormatException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
