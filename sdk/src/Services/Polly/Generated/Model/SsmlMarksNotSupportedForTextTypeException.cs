...
namespace Amazon.Polly.Model
{
    ...
    public partial class SsmlMarksNotSupportedForTextTypeException : AmazonPollyException
    {
        ...
        public SsmlMarksNotSupportedForTextTypeException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public SsmlMarksNotSupportedForTextTypeException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
