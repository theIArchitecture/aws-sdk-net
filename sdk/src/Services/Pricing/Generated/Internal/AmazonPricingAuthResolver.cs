...
namespace Amazon.Pricing.Internal
{
    ...
    public class AmazonPricingAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonPricingAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Pricing.
        /// </summary>
        public AmazonPricingAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonPricingAuthSchemeParameters
            {
    ...
    public class AmazonPricingAuthSchemeResolver : IAuthSchemeResolver<AmazonPricingAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonPricingAuthSchemeParameters authParameters)
        {
