...
{
    /// <summary>
    /// Response Unmarshaller for ListPriceLists operation
    /// </summary>  
    public class ListPriceListsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListPriceListsResponse response = new ListPriceListsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<PriceList, PriceListUnmarshaller>(PriceListUnmarshaller.Instance);
                    response.PriceLists = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListPriceListsResponseUnmarshaller _instance = new ListPriceListsResponseUnmarshaller();        

        internal static ListPriceListsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPriceListsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
