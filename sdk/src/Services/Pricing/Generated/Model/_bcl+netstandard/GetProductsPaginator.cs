...
{
    /// <summary>
    /// Base class for GetProducts paginators.
    /// </summary>
    internal sealed partial class GetProductsPaginator : IPaginator<GetProductsResponse>, IGetProductsPaginator
    {
        ...
        async IAsyncEnumerable<GetProductsResponse> IPaginator<GetProductsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
