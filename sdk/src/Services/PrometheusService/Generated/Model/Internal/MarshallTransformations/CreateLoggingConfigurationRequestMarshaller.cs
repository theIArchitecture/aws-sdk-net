...
namespace Amazon.PrometheusService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateLoggingConfigurationRequestMarshaller : IMarshaller<IRequest, CreateLoggingConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateLoggingConfigurationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateLoggingConfigurationRequest publicRequest)
        {
            ...
            request.ResourcePath = "/workspaces/{workspaceId}/logging";
#if !NETFRAMEWORK
        ...
        private static CreateLoggingConfigurationRequestMarshaller _instance = new CreateLoggingConfigurationRequestMarshaller();        

        internal static CreateLoggingConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLoggingConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
