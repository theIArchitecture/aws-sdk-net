...
{
    /// <summary>
    /// CreateQueryLoggingConfiguration Request Marshaller
    /// </summary>       
    public class CreateQueryLoggingConfigurationRequestMarshaller : IMarshaller<IRequest, CreateQueryLoggingConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateQueryLoggingConfigurationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateQueryLoggingConfigurationRequest publicRequest)
        {
        ...
        private static CreateQueryLoggingConfigurationRequestMarshaller _instance = new CreateQueryLoggingConfigurationRequestMarshaller();        

        internal static CreateQueryLoggingConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateQueryLoggingConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
