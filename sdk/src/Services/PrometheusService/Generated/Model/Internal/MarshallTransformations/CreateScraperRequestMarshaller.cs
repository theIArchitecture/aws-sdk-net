...
{
    /// <summary>
    /// CreateScraper Request Marshaller
    /// </summary>       
    public class CreateScraperRequestMarshaller : IMarshaller<IRequest, CreateScraperRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateScraperRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateScraperRequest publicRequest)
        {
        ...
        private static CreateScraperRequestMarshaller _instance = new CreateScraperRequestMarshaller();        

        internal static CreateScraperRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateScraperRequestMarshaller Instance
        {
            get
            {
                return _instance;
