...
{
    /// <summary>
    /// Response Unmarshaller for CreateScraper operation
    /// </summary>  
    public class CreateScraperResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateScraperResponse response = new CreateScraperResponse();
        ...
        private static CreateScraperResponseUnmarshaller _instance = new CreateScraperResponseUnmarshaller();        

        internal static CreateScraperResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateScraperResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
