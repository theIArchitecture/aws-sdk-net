...
{
    /// <summary>
    /// DeleteScraper Request Marshaller
    /// </summary>       
    public class DeleteScraperRequestMarshaller : IMarshaller<IRequest, DeleteScraperRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteScraperRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteScraperRequest publicRequest)
        {
        ...
        private static DeleteScraperRequestMarshaller _instance = new DeleteScraperRequestMarshaller();        

        internal static DeleteScraperRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteScraperRequestMarshaller Instance
        {
            get
            {
                return _instance;
