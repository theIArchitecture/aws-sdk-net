...
{
    /// <summary>
    /// Response Unmarshaller for DeleteScraper operation
    /// </summary>  
    public class DeleteScraperResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteScraperResponse response = new DeleteScraperResponse();
        ...
        private static DeleteScraperResponseUnmarshaller _instance = new DeleteScraperResponseUnmarshaller();        

        internal static DeleteScraperResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteScraperResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
