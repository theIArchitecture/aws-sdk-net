...
{
    /// <summary>
    /// Response Unmarshaller for DescribeScraper operation
    /// </summary>  
    public class DescribeScraperResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeScraperResponse response = new DescribeScraperResponse();
        ...
        private static DescribeScraperResponseUnmarshaller _instance = new DescribeScraperResponseUnmarshaller();        

        internal static DescribeScraperResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeScraperResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
