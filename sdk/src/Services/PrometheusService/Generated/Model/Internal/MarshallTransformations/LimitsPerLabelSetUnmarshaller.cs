...
namespace Amazon.PrometheusService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LimitsPerLabelSetUnmarshaller : IJsonUnmarshaller<LimitsPerLabelSet, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LimitsPerLabelSet Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
