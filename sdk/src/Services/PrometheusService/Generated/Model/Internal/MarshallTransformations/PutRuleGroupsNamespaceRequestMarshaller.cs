...
{
    /// <summary>
    /// PutRuleGroupsNamespace Request Marshaller
    /// </summary>       
    public class PutRuleGroupsNamespaceRequestMarshaller : IMarshaller<IRequest, PutRuleGroupsNamespaceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutRuleGroupsNamespaceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutRuleGroupsNamespaceRequest publicRequest)
        {
        ...
        private static PutRuleGroupsNamespaceRequestMarshaller _instance = new PutRuleGroupsNamespaceRequestMarshaller();        

        internal static PutRuleGroupsNamespaceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutRuleGroupsNamespaceRequestMarshaller Instance
        {
            get
            {
                return _instance;
