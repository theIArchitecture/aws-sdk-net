...
namespace Amazon.PrometheusService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ScraperDescriptionUnmarshaller : IJsonUnmarshaller<ScraperDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ScraperDescription Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("scrapeConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.ScrapeConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
