...
{
    /// <summary>
    /// Response Unmarshaller for UpdateScraper operation
    /// </summary>  
    public class UpdateScraperResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateScraperResponse response = new UpdateScraperResponse();
        ...
        private static UpdateScraperResponseUnmarshaller _instance = new UpdateScraperResponseUnmarshaller();        

        internal static UpdateScraperResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateScraperResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
