...
namespace Amazon.Proton.Internal
{
    ...
    public class AmazonProtonAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonProtonAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Proton.
        /// </summary>
        public AmazonProtonAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonProtonAuthSchemeParameters
            {
    ...
    public class AmazonProtonAuthSchemeResolver : IAuthSchemeResolver<AmazonProtonAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonProtonAuthSchemeParameters authParameters)
        {
