...
{
    /// <summary>
    /// Response Unmarshaller for ComponentState Object
    /// </summary>  
    public class ComponentStateUnmarshaller : IJsonUnmarshaller<ComponentState, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ComponentState Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TemplateFile = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ComponentStateUnmarshaller _instance = new ComponentStateUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ComponentStateUnmarshaller Instance
        {
            get
            {
                return _instance;
