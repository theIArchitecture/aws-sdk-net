...
namespace Amazon.Proton.Model.Internal.MarshallTransformations
{
    ...
    public class CreateComponentRequestMarshaller : IMarshaller<IRequest, CreateComponentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateComponentRequest publicRequest)
        {
            ...
            string target = "AwsProton20200720.CreateComponent";
            ...
            if(publicRequest.IsSetManifest())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.Manifest);
            }
            ...
            if(publicRequest.IsSetServiceSpec())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ServiceSpec);
            }
            ...
            if(publicRequest.IsSetTemplateFile())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.TemplateFile);
            }
