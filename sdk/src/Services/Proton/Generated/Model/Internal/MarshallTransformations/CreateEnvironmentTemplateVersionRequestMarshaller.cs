...
{
    /// <summary>
    /// CreateEnvironmentTemplateVersion Request Marshaller
    /// </summary>       
    public class CreateEnvironmentTemplateVersionRequestMarshaller : IMarshaller<IRequest, CreateEnvironmentTemplateVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateEnvironmentTemplateVersionRequest)input);
        }
        ...
        private static CreateEnvironmentTemplateVersionRequestMarshaller _instance = new CreateEnvironmentTemplateVersionRequestMarshaller();        

        internal static CreateEnvironmentTemplateVersionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateEnvironmentTemplateVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
