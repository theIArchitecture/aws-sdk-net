...
{
    /// <summary>
    /// Response Unmarshaller for EnvironmentState Object
    /// </summary>  
    public class EnvironmentStateUnmarshaller : IJsonUnmarshaller<EnvironmentState, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EnvironmentState Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            EnvironmentState unmarshalledObject = new EnvironmentState();
        ...
        private static EnvironmentStateUnmarshaller _instance = new EnvironmentStateUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static EnvironmentStateUnmarshaller Instance
        {
            get
            {
                return _instance;
