...
namespace Amazon.Proton.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EnvironmentTemplateUnmarshaller : IJsonUnmarshaller<EnvironmentTemplate, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EnvironmentTemplate Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
