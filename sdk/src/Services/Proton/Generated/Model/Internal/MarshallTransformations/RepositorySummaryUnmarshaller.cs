...
namespace Amazon.Proton.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RepositorySummaryUnmarshaller : IJsonUnmarshaller<RepositorySummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RepositorySummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
