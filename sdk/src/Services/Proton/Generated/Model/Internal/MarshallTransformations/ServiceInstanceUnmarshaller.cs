...
namespace Amazon.Proton.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ServiceInstanceUnmarshaller : IJsonUnmarshaller<ServiceInstance, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ServiceInstance Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
