...
namespace Amazon.Proton.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ServiceTemplateVersionUnmarshaller : IJsonUnmarshaller<ServiceTemplateVersion, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ServiceTemplateVersion Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<CompatibleEnvironmentTemplate, CompatibleEnvironmentTemplateUnmarshaller>(CompatibleEnvironmentTemplateUnmarshaller.Instance);
                    unmarshalledObject.CompatibleEnvironmentTemplates = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("supportedComponentSources", targetDepth))
                {
                    ...
                    unmarshalledObject.SupportedComponentSources = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
