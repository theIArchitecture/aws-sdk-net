...
{
    /// <summary>
    /// Response Unmarshaller for TemplateSyncConfig Object
    /// </summary>  
    public class TemplateSyncConfigUnmarshaller : IJsonUnmarshaller<TemplateSyncConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TemplateSyncConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.Subdirectory = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static TemplateSyncConfigUnmarshaller _instance = new TemplateSyncConfigUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TemplateSyncConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
