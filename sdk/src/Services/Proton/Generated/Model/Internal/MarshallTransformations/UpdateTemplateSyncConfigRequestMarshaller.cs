...
{
    /// <summary>
    /// UpdateTemplateSyncConfig Request Marshaller
    /// </summary>       
    public class UpdateTemplateSyncConfigRequestMarshaller : IMarshaller<IRequest, UpdateTemplateSyncConfigRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateTemplateSyncConfigRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateTemplateSyncConfigRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Proton");
            string target = "AwsProton20200720.UpdateTemplateSyncConfig";
        ...
        private static UpdateTemplateSyncConfigRequestMarshaller _instance = new UpdateTemplateSyncConfigRequestMarshaller();        

        internal static UpdateTemplateSyncConfigRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTemplateSyncConfigRequestMarshaller Instance
        {
            get
            {
                return _instance;
