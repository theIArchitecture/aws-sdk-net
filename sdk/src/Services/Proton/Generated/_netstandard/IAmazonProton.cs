...
{
    /// <summary>
    /// <para>Interface for accessing Proton</para>
    ///
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonProtonConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonProtonConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonProtonConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonProtonConfig to create AmazonProtonClient");
            }

            return awsCredentials == null ? 
                    new AmazonProtonClient(serviceClientConfig) :
                    new AmazonProtonClient(awsCredentials, serviceClientConfig);
        }
