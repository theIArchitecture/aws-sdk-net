...
{
    /// <summary>
    /// This is the response object from the DescribeQAppPermissions operation.
    /// </summary>
    public partial class DescribeQAppPermissionsResponse : AmazonWebServiceResponse
    {
        private string _appId;
        private List<PermissionOutput> _permissions = AWSConfigs.InitializeCollections ? new List<PermissionOutput>() : null;
        ...
        /// </summary>
        public List<PermissionOutput> Permissions
        {
