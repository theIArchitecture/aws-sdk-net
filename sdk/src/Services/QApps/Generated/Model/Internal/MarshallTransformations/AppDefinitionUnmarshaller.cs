...
namespace Amazon.QApps.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AppDefinitionUnmarshaller : IJsonUnmarshaller<AppDefinition, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AppDefinition Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
