...
{
    /// <summary>
    /// Response Unmarshaller for AssociateQAppWithUser operation
    /// </summary>  
    public class AssociateQAppWithUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateQAppWithUserResponse response = new AssociateQAppWithUserResponse();
        ...
        private static AssociateQAppWithUserResponseUnmarshaller _instance = new AssociateQAppWithUserResponseUnmarshaller();        

        internal static AssociateQAppWithUserResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateQAppWithUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
