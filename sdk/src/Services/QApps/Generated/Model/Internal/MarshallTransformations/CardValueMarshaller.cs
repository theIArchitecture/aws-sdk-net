...
{
    /// <summary>
    /// CardValue Marshaller
    /// </summary>
    public class CardValueMarshaller : IRequestMarshaller<CardValue, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(CardValue requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetCardId())
            {
                context.Writer.WritePropertyName("cardId");
                context.Writer.WriteStringValue(requestObject.CardId);
            }
        ...
        /// </summary>
        public readonly static CardValueMarshaller Instance = new CardValueMarshaller();
