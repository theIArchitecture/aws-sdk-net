...
{
    /// <summary>
    /// CreateQApp Request Marshaller
    /// </summary>       
    public class CreateQAppRequestMarshaller : IMarshaller<IRequest, CreateQAppRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateQAppRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateQAppRequest publicRequest)
        {
            ...
            request.ResourcePath = "/apps.create";
#if !NETFRAMEWORK
        ...
        private static CreateQAppRequestMarshaller _instance = new CreateQAppRequestMarshaller();        

        internal static CreateQAppRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateQAppRequestMarshaller Instance
        {
            get
            {
                return _instance;
