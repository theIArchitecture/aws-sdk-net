...
{
    /// <summary>
    /// Response Unmarshaller for DeleteLibraryItem operation
    /// </summary>  
    public class DeleteLibraryItemResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteLibraryItemResponse response = new DeleteLibraryItemResponse();
        ...
        private static DeleteLibraryItemResponseUnmarshaller _instance = new DeleteLibraryItemResponseUnmarshaller();        

        internal static DeleteLibraryItemResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteLibraryItemResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
