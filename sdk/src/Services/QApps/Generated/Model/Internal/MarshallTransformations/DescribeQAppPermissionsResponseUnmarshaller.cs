...
{
    /// <summary>
    /// Response Unmarshaller for DescribeQAppPermissions operation
    /// </summary>  
    public class DescribeQAppPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeQAppPermissionsResponse response = new DescribeQAppPermissionsResponse();
        ...
        private static DescribeQAppPermissionsResponseUnmarshaller _instance = new DescribeQAppPermissionsResponseUnmarshaller();        

        internal static DescribeQAppPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeQAppPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
