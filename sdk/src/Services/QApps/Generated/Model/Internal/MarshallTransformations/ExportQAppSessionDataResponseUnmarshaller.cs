...
{
    /// <summary>
    /// Response Unmarshaller for ExportQAppSessionData operation
    /// </summary>  
    public class ExportQAppSessionDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ExportQAppSessionDataResponse response = new ExportQAppSessionDataResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("csvFileLink", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.CsvFileLink = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ExportQAppSessionDataResponseUnmarshaller _instance = new ExportQAppSessionDataResponseUnmarshaller();        

        internal static ExportQAppSessionDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExportQAppSessionDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
