...
{
    /// <summary>
    /// Response Unmarshaller for FileUploadCard Object
    /// </summary>  
    public class FileUploadCardUnmarshaller : IJsonUnmarshaller<FileUploadCard, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FileUploadCard Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            FileUploadCard unmarshalledObject = new FileUploadCard();
        ...
        private static FileUploadCardUnmarshaller _instance = new FileUploadCardUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static FileUploadCardUnmarshaller Instance
        {
            get
            {
                return _instance;
