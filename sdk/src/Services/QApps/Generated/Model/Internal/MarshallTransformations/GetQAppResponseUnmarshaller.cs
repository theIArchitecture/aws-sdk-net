...
{
    /// <summary>
    /// Response Unmarshaller for GetQApp operation
    /// </summary>  
    public class GetQAppResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetQAppResponse response = new GetQAppResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = AppDefinitionUnmarshaller.Instance;
                    response.AppDefinition = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetQAppResponseUnmarshaller _instance = new GetQAppResponseUnmarshaller();        

        internal static GetQAppResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetQAppResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
