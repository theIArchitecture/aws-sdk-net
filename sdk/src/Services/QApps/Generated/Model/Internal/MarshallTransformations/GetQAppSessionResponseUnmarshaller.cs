...
{
    /// <summary>
    /// Response Unmarshaller for GetQAppSession operation
    /// </summary>  
    public class GetQAppSessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetQAppSessionResponse response = new GetQAppSessionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonDictionaryUnmarshaller<string, CardStatus, StringUnmarshaller, CardStatusUnmarshaller>(StringUnmarshaller.Instance, CardStatusUnmarshaller.Instance);
                    response.CardStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("latestPublishedAppVersion", targetDepth))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    response.LatestPublishedAppVersion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("userIsHost", targetDepth))
                {
                    ...
                    response.UserIsHost = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetQAppSessionResponseUnmarshaller _instance = new GetQAppSessionResponseUnmarshaller();        

        internal static GetQAppSessionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetQAppSessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
