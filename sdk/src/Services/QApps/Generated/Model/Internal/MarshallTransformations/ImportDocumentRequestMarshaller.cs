...
{
    /// <summary>
    /// ImportDocument Request Marshaller
    /// </summary>       
    public class ImportDocumentRequestMarshaller : IMarshaller<IRequest, ImportDocumentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ImportDocumentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ImportDocumentRequest publicRequest)
        {
        ...
        private static ImportDocumentRequestMarshaller _instance = new ImportDocumentRequestMarshaller();        

        internal static ImportDocumentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImportDocumentRequestMarshaller Instance
        {
            get
            {
                return _instance;
