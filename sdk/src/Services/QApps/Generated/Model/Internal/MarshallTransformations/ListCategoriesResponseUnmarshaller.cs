...
{
    /// <summary>
    /// Response Unmarshaller for ListCategories operation
    /// </summary>  
    public class ListCategoriesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListCategoriesResponseUnmarshaller _instance = new ListCategoriesResponseUnmarshaller();        

        internal static ListCategoriesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCategoriesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
