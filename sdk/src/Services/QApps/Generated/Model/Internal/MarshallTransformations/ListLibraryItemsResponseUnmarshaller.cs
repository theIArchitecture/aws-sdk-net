...
{
    /// <summary>
    /// Response Unmarshaller for ListLibraryItems operation
    /// </summary>  
    public class ListLibraryItemsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListLibraryItemsResponse response = new ListLibraryItemsResponse();
        ...
        private static ListLibraryItemsResponseUnmarshaller _instance = new ListLibraryItemsResponseUnmarshaller();        

        internal static ListLibraryItemsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLibraryItemsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
