...
namespace Amazon.QApps.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PermissionOutputUnmarshaller : IJsonUnmarshaller<PermissionOutput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PermissionOutput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
