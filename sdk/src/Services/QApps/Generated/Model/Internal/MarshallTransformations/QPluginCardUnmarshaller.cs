...
{
    /// <summary>
    /// Response Unmarshaller for QPluginCard Object
    /// </summary>  
    public class QPluginCardUnmarshaller : IJsonUnmarshaller<QPluginCard, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public QPluginCard Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            QPluginCard unmarshalledObject = new QPluginCard();
        ...
        private static QPluginCardUnmarshaller _instance = new QPluginCardUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static QPluginCardUnmarshaller Instance
        {
            get
            {
                return _instance;
