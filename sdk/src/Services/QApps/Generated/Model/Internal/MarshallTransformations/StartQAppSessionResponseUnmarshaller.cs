...
{
    /// <summary>
    /// Response Unmarshaller for StartQAppSession operation
    /// </summary>  
    public class StartQAppSessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartQAppSessionResponse response = new StartQAppSessionResponse();
        ...
        private static StartQAppSessionResponseUnmarshaller _instance = new StartQAppSessionResponseUnmarshaller();        

        internal static StartQAppSessionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartQAppSessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
