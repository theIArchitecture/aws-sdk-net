...
{
    /// <summary>
    /// Response Unmarshaller for UpdateLibraryItem operation
    /// </summary>  
    public class UpdateLibraryItemResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateLibraryItemResponse response = new UpdateLibraryItemResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("isRatedByUser", targetDepth))
                {
                    ...
                    response.IsRatedByUser = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("isVerified", targetDepth))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    response.IsVerified = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("libraryItemId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.LibraryItemId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ratingCount", targetDepth))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    response.RatingCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateLibraryItemResponseUnmarshaller _instance = new UpdateLibraryItemResponseUnmarshaller();        

        internal static UpdateLibraryItemResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateLibraryItemResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
