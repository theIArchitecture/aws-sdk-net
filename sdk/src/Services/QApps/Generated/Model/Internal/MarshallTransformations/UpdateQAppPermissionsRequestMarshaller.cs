...
{
    /// <summary>
    /// UpdateQAppPermissions Request Marshaller
    /// </summary>       
    public class UpdateQAppPermissionsRequestMarshaller : IMarshaller<IRequest, UpdateQAppPermissionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateQAppPermissionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateQAppPermissionsRequest publicRequest)
        {
        ...
        private static UpdateQAppPermissionsRequestMarshaller _instance = new UpdateQAppPermissionsRequestMarshaller();        

        internal static UpdateQAppPermissionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateQAppPermissionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
