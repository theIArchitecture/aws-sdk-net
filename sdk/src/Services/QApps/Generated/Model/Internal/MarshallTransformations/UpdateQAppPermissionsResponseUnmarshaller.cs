...
{
    /// <summary>
    /// Response Unmarshaller for UpdateQAppPermissions operation
    /// </summary>  
    public class UpdateQAppPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateQAppPermissionsResponse response = new UpdateQAppPermissionsResponse();
        ...
        private static UpdateQAppPermissionsResponseUnmarshaller _instance = new UpdateQAppPermissionsResponseUnmarshaller();        

        internal static UpdateQAppPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateQAppPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
