...
{
    /// <summary>
    /// Response Unmarshaller for UpdateQApp operation
    /// </summary>  
    public class UpdateQAppResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateQAppResponse response = new UpdateQAppResponse();
        ...
        private static UpdateQAppResponseUnmarshaller _instance = new UpdateQAppResponseUnmarshaller();        

        internal static UpdateQAppResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateQAppResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
