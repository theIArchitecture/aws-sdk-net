...
{
    /// <summary>
    /// UpdateQAppSession Request Marshaller
    /// </summary>       
    public class UpdateQAppSessionRequestMarshaller : IMarshaller<IRequest, UpdateQAppSessionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateQAppSessionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateQAppSessionRequest publicRequest)
        {
        ...
        private static UpdateQAppSessionRequestMarshaller _instance = new UpdateQAppSessionRequestMarshaller();        

        internal static UpdateQAppSessionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateQAppSessionRequestMarshaller Instance
        {
            get
            {
                return _instance;
