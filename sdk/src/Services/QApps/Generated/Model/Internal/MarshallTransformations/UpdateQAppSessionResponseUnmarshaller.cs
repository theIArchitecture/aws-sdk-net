...
{
    /// <summary>
    /// Response Unmarshaller for UpdateQAppSession operation
    /// </summary>  
    public class UpdateQAppSessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateQAppSessionResponse response = new UpdateQAppSessionResponse();
        ...
        private static UpdateQAppSessionResponseUnmarshaller _instance = new UpdateQAppSessionResponseUnmarshaller();        

        internal static UpdateQAppSessionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateQAppSessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
