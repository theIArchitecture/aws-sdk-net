...
{
    /// <summary>
    /// This is the response object from the ListQApps operation.
    /// </summary>
    public partial class ListQAppsResponse : AmazonWebServiceResponse
    {
        private List<UserAppItem> _apps = AWSConfigs.InitializeCollections ? new List<UserAppItem>() : null;
