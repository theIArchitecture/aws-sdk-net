...
namespace Amazon.QBusiness.Internal
{
    ...
    public class AmazonQBusinessAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonQBusinessAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for QBusiness.
        /// </summary>
        public AmazonQBusinessAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonQBusinessAuthSchemeParameters
            {
    ...
    public class AmazonQBusinessAuthSchemeResolver : IAuthSchemeResolver<AmazonQBusinessAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonQBusinessAuthSchemeParameters authParameters)
        {
