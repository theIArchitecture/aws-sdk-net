...
{
    /// <summary>
    /// Container for the parameters to the GetChatResponseConfiguration operation.
    ...
    /// and metadata.
    /// </summary>
    public partial class GetChatResponseConfigurationRequest : AmazonQBusinessRequest
    {
        ...
        /// <para>
        /// The unique identifier of the chat response configuration to retrieve from the specified
        /// application.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true, Min=36, Max=36)]
