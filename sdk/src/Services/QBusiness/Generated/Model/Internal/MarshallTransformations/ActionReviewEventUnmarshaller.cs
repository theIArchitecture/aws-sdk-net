...
{
    /// <summary>
    /// Response Unmarshaller for ActionReviewEvent Object
    /// </summary>  
    public class ActionReviewEventUnmarshaller : IJsonUnmarshaller<ActionReviewEvent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ActionReviewEvent Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ActionReviewEvent unmarshalledObject = new ActionReviewEvent();
        ...
        private static ActionReviewEventUnmarshaller _instance = new ActionReviewEventUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ActionReviewEventUnmarshaller Instance
        {
            get
            {
                return _instance;
