...
namespace Amazon.QBusiness.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AudioExtractionConfigurationUnmarshaller : IJsonUnmarshaller<AudioExtractionConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AudioExtractionConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("audioExtractionStatus", targetDepth))
                {
                    ...
                    unmarshalledObject.AudioExtractionStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
