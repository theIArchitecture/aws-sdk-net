...
namespace Amazon.QBusiness.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ChatRequestMarshaller : IMarshaller<IRequest, ChatRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ChatRequestMarshaller _instance = new ChatRequestMarshaller();        

        internal static ChatRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ChatRequestMarshaller Instance
        {
            get
            {
                return _instance;
