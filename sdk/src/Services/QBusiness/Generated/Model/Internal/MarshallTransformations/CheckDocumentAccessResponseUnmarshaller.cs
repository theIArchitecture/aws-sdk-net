...
{
    /// <summary>
    /// Response Unmarshaller for CheckDocumentAccess operation
    /// </summary>  
    public class CheckDocumentAccessResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CheckDocumentAccessResponse response = new CheckDocumentAccessResponse();
        ...
        private static CheckDocumentAccessResponseUnmarshaller _instance = new CheckDocumentAccessResponseUnmarshaller();        

        internal static CheckDocumentAccessResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CheckDocumentAccessResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
