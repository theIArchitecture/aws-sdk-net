...
namespace Amazon.QBusiness.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CopyFromSourceUnmarshaller : IJsonUnmarshaller<CopyFromSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CopyFromSource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("conversation", targetDepth))
                {
                    ...
                    unmarshalledObject.Conversation = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
