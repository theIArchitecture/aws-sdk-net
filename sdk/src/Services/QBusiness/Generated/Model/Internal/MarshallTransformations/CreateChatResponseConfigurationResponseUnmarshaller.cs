...
{
    /// <summary>
    /// Response Unmarshaller for CreateChatResponseConfiguration operation
    /// </summary>  
    public class CreateChatResponseConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateChatResponseConfigurationResponse response = new CreateChatResponseConfigurationResponse();
        ...
        private static CreateChatResponseConfigurationResponseUnmarshaller _instance = new CreateChatResponseConfigurationResponseUnmarshaller();        

        internal static CreateChatResponseConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateChatResponseConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
