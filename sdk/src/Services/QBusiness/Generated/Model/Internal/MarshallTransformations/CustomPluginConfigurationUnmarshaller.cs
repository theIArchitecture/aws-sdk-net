...
namespace Amazon.QBusiness.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CustomPluginConfigurationUnmarshaller : IJsonUnmarshaller<CustomPluginConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CustomPluginConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("apiSchemaType", targetDepth))
                {
                    ...
                    unmarshalledObject.ApiSchemaType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
