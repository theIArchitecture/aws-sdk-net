...
{
    /// <summary>
    /// DeletePlugin Request Marshaller
    /// </summary>       
    public class DeletePluginRequestMarshaller : IMarshaller<IRequest, DeletePluginRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeletePluginRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeletePluginRequest publicRequest)
        {
        ...
        private static DeletePluginRequestMarshaller _instance = new DeletePluginRequestMarshaller();        

        internal static DeletePluginRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePluginRequestMarshaller Instance
        {
            get
            {
                return _instance;
