...
{
    /// <summary>
    /// Response Unmarshaller for DocumentEnrichmentConfiguration Object
    /// </summary>  
    public class DocumentEnrichmentConfigurationUnmarshaller : IJsonUnmarshaller<DocumentEnrichmentConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DocumentEnrichmentConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static DocumentEnrichmentConfigurationUnmarshaller _instance = new DocumentEnrichmentConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DocumentEnrichmentConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
