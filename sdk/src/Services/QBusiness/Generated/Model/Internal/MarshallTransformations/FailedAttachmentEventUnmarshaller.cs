...
{
    /// <summary>
    /// Response Unmarshaller for FailedAttachmentEvent Object
    /// </summary>  
    public class FailedAttachmentEventUnmarshaller : IJsonUnmarshaller<FailedAttachmentEvent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FailedAttachmentEvent Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            FailedAttachmentEvent unmarshalledObject = new FailedAttachmentEvent();
        ...
        private static FailedAttachmentEventUnmarshaller _instance = new FailedAttachmentEventUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static FailedAttachmentEventUnmarshaller Instance
        {
            get
            {
                return _instance;
