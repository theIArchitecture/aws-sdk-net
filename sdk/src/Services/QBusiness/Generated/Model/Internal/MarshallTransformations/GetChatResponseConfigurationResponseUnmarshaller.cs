...
{
    /// <summary>
    /// Response Unmarshaller for GetChatResponseConfiguration operation
    /// </summary>  
    public class GetChatResponseConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetChatResponseConfigurationResponse response = new GetChatResponseConfigurationResponse();
        ...
        private static GetChatResponseConfigurationResponseUnmarshaller _instance = new GetChatResponseConfigurationResponseUnmarshaller();        

        internal static GetChatResponseConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetChatResponseConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
