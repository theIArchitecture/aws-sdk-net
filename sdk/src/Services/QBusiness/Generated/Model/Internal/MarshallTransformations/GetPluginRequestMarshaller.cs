...
{
    /// <summary>
    /// GetPlugin Request Marshaller
    /// </summary>       
    public class GetPluginRequestMarshaller : IMarshaller<IRequest, GetPluginRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetPluginRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetPluginRequest publicRequest)
        {
        ...
        private static GetPluginRequestMarshaller _instance = new GetPluginRequestMarshaller();        

        internal static GetPluginRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPluginRequestMarshaller Instance
        {
            get
            {
                return _instance;
