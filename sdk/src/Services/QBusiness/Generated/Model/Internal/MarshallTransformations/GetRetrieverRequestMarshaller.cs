...
{
    /// <summary>
    /// GetRetriever Request Marshaller
    /// </summary>       
    public class GetRetrieverRequestMarshaller : IMarshaller<IRequest, GetRetrieverRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetRetrieverRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetRetrieverRequest publicRequest)
        {
        ...
        private static GetRetrieverRequestMarshaller _instance = new GetRetrieverRequestMarshaller();        

        internal static GetRetrieverRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRetrieverRequestMarshaller Instance
        {
            get
            {
                return _instance;
