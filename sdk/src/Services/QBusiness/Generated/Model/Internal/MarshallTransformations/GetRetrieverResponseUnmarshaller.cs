...
{
    /// <summary>
    /// Response Unmarshaller for GetRetriever operation
    /// </summary>  
    public class GetRetrieverResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRetrieverResponse response = new GetRetrieverResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = RetrieverConfigurationUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RetrieverArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("retrieverId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RetrieverId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetRetrieverResponseUnmarshaller _instance = new GetRetrieverResponseUnmarshaller();        

        internal static GetRetrieverResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRetrieverResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
