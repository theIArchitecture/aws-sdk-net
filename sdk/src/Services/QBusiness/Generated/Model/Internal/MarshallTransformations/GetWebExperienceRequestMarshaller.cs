...
{
    /// <summary>
    /// GetWebExperience Request Marshaller
    /// </summary>       
    public class GetWebExperienceRequestMarshaller : IMarshaller<IRequest, GetWebExperienceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetWebExperienceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetWebExperienceRequest publicRequest)
        {
        ...
        private static GetWebExperienceRequestMarshaller _instance = new GetWebExperienceRequestMarshaller();        

        internal static GetWebExperienceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetWebExperienceRequestMarshaller Instance
        {
            get
            {
                return _instance;
