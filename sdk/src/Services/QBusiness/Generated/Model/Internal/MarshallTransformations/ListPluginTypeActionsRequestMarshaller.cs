...
namespace Amazon.QBusiness.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListPluginTypeActionsRequestMarshaller : IMarshaller<IRequest, ListPluginTypeActionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListPluginTypeActionsRequestMarshaller _instance = new ListPluginTypeActionsRequestMarshaller();        

        internal static ListPluginTypeActionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPluginTypeActionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
