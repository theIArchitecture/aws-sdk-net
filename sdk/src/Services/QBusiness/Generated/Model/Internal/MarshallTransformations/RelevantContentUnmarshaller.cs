...
{
    /// <summary>
    /// Response Unmarshaller for RelevantContent Object
    /// </summary>  
    public class RelevantContentUnmarshaller : IJsonUnmarshaller<RelevantContent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RelevantContent Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            RelevantContent unmarshalledObject = new RelevantContent();
        ...
        private static RelevantContentUnmarshaller _instance = new RelevantContentUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RelevantContentUnmarshaller Instance
        {
            get
            {
                return _instance;
