...
namespace Amazon.QBusiness.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StringAttributeBoostingConfigurationUnmarshaller : IJsonUnmarshaller<StringAttributeBoostingConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public StringAttributeBoostingConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("attributeValueBoosting", targetDepth))
                {
                    ...
                    unmarshalledObject.AttributeValueBoosting = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
