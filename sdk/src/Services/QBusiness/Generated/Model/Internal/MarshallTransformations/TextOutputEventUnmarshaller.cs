...
{
    /// <summary>
    /// Response Unmarshaller for TextOutputEvent Object
    /// </summary>  
    public class TextOutputEventUnmarshaller : IJsonUnmarshaller<TextOutputEvent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TextOutputEvent Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            TextOutputEvent unmarshalledObject = new TextOutputEvent();
        ...
        private static TextOutputEventUnmarshaller _instance = new TextOutputEventUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TextOutputEventUnmarshaller Instance
        {
            get
            {
                return _instance;
