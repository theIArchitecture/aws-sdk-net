...
namespace Amazon.QBusiness.Model.Internal.MarshallTransformations
{
    ...
    public class TopicConfigurationMarshaller : IRequestMarshaller<TopicConfiguration, JsonMarshallerContext> 
    {
        ...
        public void Marshall(TopicConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetExampleChatMessages())
            {
                context.Writer.WritePropertyName("exampleChatMessages");
                context.Writer.WriteStartArray();
                foreach(var requestObjectExampleChatMessagesListValue in requestObject.ExampleChatMessages)
                {
                        context.Writer.WriteStringValue(requestObjectExampleChatMessagesListValue);
                }
