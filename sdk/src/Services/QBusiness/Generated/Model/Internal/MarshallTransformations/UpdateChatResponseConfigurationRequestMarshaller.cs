...
{
    /// <summary>
    /// UpdateChatResponseConfiguration Request Marshaller
    /// </summary>       
    public class UpdateChatResponseConfigurationRequestMarshaller : IMarshaller<IRequest, UpdateChatResponseConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateChatResponseConfigurationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateChatResponseConfigurationRequest publicRequest)
        {
        ...
        private static UpdateChatResponseConfigurationRequestMarshaller _instance = new UpdateChatResponseConfigurationRequestMarshaller();        

        internal static UpdateChatResponseConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateChatResponseConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
