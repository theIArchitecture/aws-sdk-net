...
namespace Amazon.QBusiness.Model.Internal.MarshallTransformations
{
    ...
    public class WebExperienceAuthConfigurationUnmarshaller : IJsonUnmarshaller<WebExperienceAuthConfiguration, JsonUnmarshallerContext>
    {
        ...
        private static WebExperienceAuthConfigurationUnmarshaller _instance = new WebExperienceAuthConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static WebExperienceAuthConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
