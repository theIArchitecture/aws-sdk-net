...
{
    /// <summary>
    /// Container for the parameters to the ListPluginActions operation.
    /// Lists configured Amazon Q Business actions for a specific plugin in an Amazon Q Business
    /// application.
    /// </summary>
    public partial class ListPluginActionsRequest : AmazonQBusinessRequest
    {
        ...
        /// <para>
        /// If the number of plugin actions returned exceeds <c>maxResults</c>, Amazon Q Business
        /// returns a next token as a pagination token to retrieve the next set of plugin actions.
        /// </para>
        /// </summary>
