...
namespace Amazon.QConnect
{
    ...
    public partial class AmazonQConnectConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("QConnect", "4.0.2.5");
        ...
        /// Default constructor
        /// </summary>
        public AmazonQConnectConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonQConnectDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "QConnect";
            this.AuthenticationServiceName = "wisdom";
            this.EndpointProvider = new AmazonQConnectEndpointProvider();
        }
