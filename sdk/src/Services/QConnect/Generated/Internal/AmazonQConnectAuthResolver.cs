...
namespace Amazon.QConnect.Internal
{
    ...
    public class AmazonQConnectAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonQConnectAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for QConnect.
        /// </summary>
        public AmazonQConnectAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonQConnectAuthSchemeParameters
            {
    ...
    public class AmazonQConnectAuthSchemeResolver : IAuthSchemeResolver<AmazonQConnectAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonQConnectAuthSchemeParameters authParameters)
        {
