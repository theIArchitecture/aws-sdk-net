...
namespace Amazon.QConnect.Model.Internal.MarshallTransformations
{
    ...
    public class AmazonConnectGuideAssociationDataUnmarshaller : IJsonUnmarshaller<AmazonConnectGuideAssociationData, JsonUnmarshallerContext>
    {
        ...
        private static AmazonConnectGuideAssociationDataUnmarshaller _instance = new AmazonConnectGuideAssociationDataUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AmazonConnectGuideAssociationDataUnmarshaller Instance
        {
            get
            {
                return _instance;
