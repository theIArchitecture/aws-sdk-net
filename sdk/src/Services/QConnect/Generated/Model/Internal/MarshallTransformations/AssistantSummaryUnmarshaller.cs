...
{
    /// <summary>
    /// Response Unmarshaller for AssistantSummary Object
    /// </summary>  
    public class AssistantSummaryUnmarshaller : IJsonUnmarshaller<AssistantSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AssistantSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            AssistantSummary unmarshalledObject = new AssistantSummary();
            ...
            {
                if (context.TestExpression("aiAgentConfiguration", targetDepth))
                {
        ...
        private static AssistantSummaryUnmarshaller _instance = new AssistantSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AssistantSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
