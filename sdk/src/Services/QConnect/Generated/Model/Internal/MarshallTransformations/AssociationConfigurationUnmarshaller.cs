...
namespace Amazon.QConnect.Model.Internal.MarshallTransformations
{
    ...
    public class AssociationConfigurationUnmarshaller : IJsonUnmarshaller<AssociationConfiguration, JsonUnmarshallerContext>
    {
        ...
        private static AssociationConfigurationUnmarshaller _instance = new AssociationConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AssociationConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
