...
{
    /// <summary>
    /// CreateAIAgentVersion Request Marshaller
    /// </summary>       
    public class CreateAIAgentVersionRequestMarshaller : IMarshaller<IRequest, CreateAIAgentVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateAIAgentVersionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateAIAgentVersionRequest publicRequest)
        {
        ...
        private static CreateAIAgentVersionRequestMarshaller _instance = new CreateAIAgentVersionRequestMarshaller();        

        internal static CreateAIAgentVersionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAIAgentVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
