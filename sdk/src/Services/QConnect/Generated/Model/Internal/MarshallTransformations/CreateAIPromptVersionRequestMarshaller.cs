...
{
    /// <summary>
    /// CreateAIPromptVersion Request Marshaller
    /// </summary>       
    public class CreateAIPromptVersionRequestMarshaller : IMarshaller<IRequest, CreateAIPromptVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateAIPromptVersionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateAIPromptVersionRequest publicRequest)
        {
        ...
        private static CreateAIPromptVersionRequestMarshaller _instance = new CreateAIPromptVersionRequestMarshaller();        

        internal static CreateAIPromptVersionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAIPromptVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
