...
{
    /// <summary>
    /// Response Unmarshaller for CreateAIPromptVersion operation
    /// </summary>  
    public class CreateAIPromptVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAIPromptVersionResponse response = new CreateAIPromptVersionResponse();
        ...
        private static CreateAIPromptVersionResponseUnmarshaller _instance = new CreateAIPromptVersionResponseUnmarshaller();        

        internal static CreateAIPromptVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAIPromptVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
