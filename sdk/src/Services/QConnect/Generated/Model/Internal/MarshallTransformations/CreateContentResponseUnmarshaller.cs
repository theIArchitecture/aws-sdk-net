...
{
    /// <summary>
    /// Response Unmarshaller for CreateContent operation
    /// </summary>  
    public class CreateContentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateContentResponseUnmarshaller _instance = new CreateContentResponseUnmarshaller();        

        internal static CreateContentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateContentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
