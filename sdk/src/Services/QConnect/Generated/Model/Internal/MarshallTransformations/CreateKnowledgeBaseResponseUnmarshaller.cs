...
{
    /// <summary>
    /// Response Unmarshaller for CreateKnowledgeBase operation
    /// </summary>  
    public class CreateKnowledgeBaseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateKnowledgeBaseResponseUnmarshaller _instance = new CreateKnowledgeBaseResponseUnmarshaller();        

        internal static CreateKnowledgeBaseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateKnowledgeBaseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
