...
{
    /// <summary>
    /// CreateMessageTemplateAttachment Request Marshaller
    /// </summary>       
    public class CreateMessageTemplateAttachmentRequestMarshaller : IMarshaller<IRequest, CreateMessageTemplateAttachmentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateMessageTemplateAttachmentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateMessageTemplateAttachmentRequest publicRequest)
        {
            ...
            request.ResourcePath = "/knowledgeBases/{knowledgeBaseId}/messageTemplates/{messageTemplateId}/attachments";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetContentDisposition())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.ContentDisposition);
            }
        ...
        private static CreateMessageTemplateAttachmentRequestMarshaller _instance = new CreateMessageTemplateAttachmentRequestMarshaller();        

        internal static CreateMessageTemplateAttachmentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMessageTemplateAttachmentRequestMarshaller Instance
        {
            get
            {
                return _instance;
