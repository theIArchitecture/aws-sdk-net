...
{
    /// <summary>
    /// DeactivateMessageTemplate Request Marshaller
    /// </summary>       
    public class DeactivateMessageTemplateRequestMarshaller : IMarshaller<IRequest, DeactivateMessageTemplateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeactivateMessageTemplateRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeactivateMessageTemplateRequest publicRequest)
        {
            ...
            request.ResourcePath = "/knowledgeBases/{knowledgeBaseId}/messageTemplates/{messageTemplateId}/deactivate";
#if !NETFRAMEWORK
        ...
        private static DeactivateMessageTemplateRequestMarshaller _instance = new DeactivateMessageTemplateRequestMarshaller();        

        internal static DeactivateMessageTemplateRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeactivateMessageTemplateRequestMarshaller Instance
        {
            get
            {
                return _instance;
