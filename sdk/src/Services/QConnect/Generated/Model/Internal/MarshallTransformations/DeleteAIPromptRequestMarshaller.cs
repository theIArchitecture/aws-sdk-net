...
{
    /// <summary>
    /// DeleteAIPrompt Request Marshaller
    /// </summary>       
    public class DeleteAIPromptRequestMarshaller : IMarshaller<IRequest, DeleteAIPromptRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteAIPromptRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteAIPromptRequest publicRequest)
        {
        ...
        private static DeleteAIPromptRequestMarshaller _instance = new DeleteAIPromptRequestMarshaller();        

        internal static DeleteAIPromptRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAIPromptRequestMarshaller Instance
        {
            get
            {
                return _instance;
