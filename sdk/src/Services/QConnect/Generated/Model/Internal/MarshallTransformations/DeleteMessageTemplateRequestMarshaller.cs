...
{
    /// <summary>
    /// DeleteMessageTemplate Request Marshaller
    /// </summary>       
    public class DeleteMessageTemplateRequestMarshaller : IMarshaller<IRequest, DeleteMessageTemplateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteMessageTemplateRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteMessageTemplateRequest publicRequest)
        {
        ...
        private static DeleteMessageTemplateRequestMarshaller _instance = new DeleteMessageTemplateRequestMarshaller();        

        internal static DeleteMessageTemplateRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteMessageTemplateRequestMarshaller Instance
        {
            get
            {
                return _instance;
