...
namespace Amazon.QConnect.Model.Internal.MarshallTransformations
{
    ...
    public class EmailMessageTemplateContentUnmarshaller : IJsonUnmarshaller<EmailMessageTemplateContent, JsonUnmarshallerContext>
    {
        ...
        private static EmailMessageTemplateContentUnmarshaller _instance = new EmailMessageTemplateContentUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static EmailMessageTemplateContentUnmarshaller Instance
        {
            get
            {
                return _instance;
