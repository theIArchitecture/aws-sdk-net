...
{
    /// <summary>
    /// Response Unmarshaller for GenerativeDataDetails Object
    /// </summary>  
    public class GenerativeDataDetailsUnmarshaller : IJsonUnmarshaller<GenerativeDataDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GenerativeDataDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            GenerativeDataDetails unmarshalledObject = new GenerativeDataDetails();
        ...
        private static GenerativeDataDetailsUnmarshaller _instance = new GenerativeDataDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static GenerativeDataDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
