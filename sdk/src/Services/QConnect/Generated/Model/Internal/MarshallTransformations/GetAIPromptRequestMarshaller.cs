...
{
    /// <summary>
    /// GetAIPrompt Request Marshaller
    /// </summary>       
    public class GetAIPromptRequestMarshaller : IMarshaller<IRequest, GetAIPromptRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetAIPromptRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetAIPromptRequest publicRequest)
        {
        ...
        private static GetAIPromptRequestMarshaller _instance = new GetAIPromptRequestMarshaller();        

        internal static GetAIPromptRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAIPromptRequestMarshaller Instance
        {
            get
            {
                return _instance;
