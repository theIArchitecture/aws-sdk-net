...
{
    /// <summary>
    /// Response Unmarshaller for GetAIPrompt operation
    /// </summary>  
    public class GetAIPromptResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAIPromptResponse response = new GetAIPromptResponse();
        ...
        private static GetAIPromptResponseUnmarshaller _instance = new GetAIPromptResponseUnmarshaller();        

        internal static GetAIPromptResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAIPromptResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
