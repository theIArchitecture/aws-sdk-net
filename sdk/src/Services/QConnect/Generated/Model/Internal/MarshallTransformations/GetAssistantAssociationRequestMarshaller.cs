...
{
    /// <summary>
    /// GetAssistantAssociation Request Marshaller
    /// </summary>       
    public class GetAssistantAssociationRequestMarshaller : IMarshaller<IRequest, GetAssistantAssociationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetAssistantAssociationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetAssistantAssociationRequest publicRequest)
        {
        ...
        private static GetAssistantAssociationRequestMarshaller _instance = new GetAssistantAssociationRequestMarshaller();        

        internal static GetAssistantAssociationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAssistantAssociationRequestMarshaller Instance
        {
            get
            {
                return _instance;
