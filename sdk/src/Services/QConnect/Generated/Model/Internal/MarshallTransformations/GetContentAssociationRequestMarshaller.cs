...
{
    /// <summary>
    /// GetContentAssociation Request Marshaller
    /// </summary>       
    public class GetContentAssociationRequestMarshaller : IMarshaller<IRequest, GetContentAssociationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetContentAssociationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetContentAssociationRequest publicRequest)
        {
        ...
        private static GetContentAssociationRequestMarshaller _instance = new GetContentAssociationRequestMarshaller();        

        internal static GetContentAssociationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetContentAssociationRequestMarshaller Instance
        {
            get
            {
                return _instance;
