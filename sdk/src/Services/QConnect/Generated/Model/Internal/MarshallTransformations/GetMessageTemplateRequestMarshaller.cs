...
{
    /// <summary>
    /// GetMessageTemplate Request Marshaller
    /// </summary>       
    public class GetMessageTemplateRequestMarshaller : IMarshaller<IRequest, GetMessageTemplateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetMessageTemplateRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetMessageTemplateRequest publicRequest)
        {
        ...
        private static GetMessageTemplateRequestMarshaller _instance = new GetMessageTemplateRequestMarshaller();        

        internal static GetMessageTemplateRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMessageTemplateRequestMarshaller Instance
        {
            get
            {
                return _instance;
