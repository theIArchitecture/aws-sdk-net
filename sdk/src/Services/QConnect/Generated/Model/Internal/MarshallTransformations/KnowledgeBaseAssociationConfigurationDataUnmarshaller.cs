...
namespace Amazon.QConnect.Model.Internal.MarshallTransformations
{
    ...
    public class KnowledgeBaseAssociationConfigurationDataUnmarshaller : IJsonUnmarshaller<KnowledgeBaseAssociationConfigurationData, JsonUnmarshallerContext>
    {
        ...
        private static KnowledgeBaseAssociationConfigurationDataUnmarshaller _instance = new KnowledgeBaseAssociationConfigurationDataUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static KnowledgeBaseAssociationConfigurationDataUnmarshaller Instance
        {
            get
            {
                return _instance;
