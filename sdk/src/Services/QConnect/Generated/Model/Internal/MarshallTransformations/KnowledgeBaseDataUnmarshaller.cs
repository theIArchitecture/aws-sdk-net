...
{
    /// <summary>
    /// Response Unmarshaller for KnowledgeBaseData Object
    /// </summary>  
    public class KnowledgeBaseDataUnmarshaller : IJsonUnmarshaller<KnowledgeBaseData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public KnowledgeBaseData Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            KnowledgeBaseData unmarshalledObject = new KnowledgeBaseData();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ingestionFailureReasons", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.IngestionFailureReasons = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.KnowledgeBaseType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("lastContentModificationTime", targetDepth))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    unmarshalledObject.LastContentModificationTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("renderingConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.RenderingConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static KnowledgeBaseDataUnmarshaller _instance = new KnowledgeBaseDataUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static KnowledgeBaseDataUnmarshaller Instance
        {
            get
            {
                return _instance;
