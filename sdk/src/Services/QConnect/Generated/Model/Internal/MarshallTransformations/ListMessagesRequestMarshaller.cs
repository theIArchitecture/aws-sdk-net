...
namespace Amazon.QConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListMessagesRequestMarshaller : IMarshaller<IRequest, ListMessagesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListMessagesRequestMarshaller _instance = new ListMessagesRequestMarshaller();        

        internal static ListMessagesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMessagesRequestMarshaller Instance
        {
            get
            {
                return _instance;
