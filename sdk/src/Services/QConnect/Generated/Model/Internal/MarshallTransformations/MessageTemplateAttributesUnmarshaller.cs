...
{
    /// <summary>
    /// Response Unmarshaller for MessageTemplateAttributes Object
    /// </summary>  
    public class MessageTemplateAttributesUnmarshaller : IJsonUnmarshaller<MessageTemplateAttributes, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MessageTemplateAttributes Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            MessageTemplateAttributes unmarshalledObject = new MessageTemplateAttributes();
        ...
        private static MessageTemplateAttributesUnmarshaller _instance = new MessageTemplateAttributesUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static MessageTemplateAttributesUnmarshaller Instance
        {
            get
            {
                return _instance;
