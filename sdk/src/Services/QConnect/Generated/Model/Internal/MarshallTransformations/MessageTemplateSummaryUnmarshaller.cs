...
namespace Amazon.QConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MessageTemplateSummaryUnmarshaller : IJsonUnmarshaller<MessageTemplateSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MessageTemplateSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("activeVersionNumber", targetDepth))
                {
                    ...
                    unmarshalledObject.ActiveVersionNumber = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
