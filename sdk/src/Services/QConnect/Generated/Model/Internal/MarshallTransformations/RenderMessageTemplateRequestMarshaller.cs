...
{
    /// <summary>
    /// RenderMessageTemplate Request Marshaller
    /// </summary>       
    public class RenderMessageTemplateRequestMarshaller : IMarshaller<IRequest, RenderMessageTemplateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RenderMessageTemplateRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RenderMessageTemplateRequest publicRequest)
        {
            ...
            request.ResourcePath = "/knowledgeBases/{knowledgeBaseId}/messageTemplates/{messageTemplateId}/render";
#if !NETFRAMEWORK
        ...
        private static RenderMessageTemplateRequestMarshaller _instance = new RenderMessageTemplateRequestMarshaller();        

        internal static RenderMessageTemplateRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RenderMessageTemplateRequestMarshaller Instance
        {
            get
            {
                return _instance;
