...
{
    /// <summary>
    /// Response Unmarshaller for RenderMessageTemplate operation
    /// </summary>  
    public class RenderMessageTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RenderMessageTemplateResponse response = new RenderMessageTemplateResponse();
        ...
        private static RenderMessageTemplateResponseUnmarshaller _instance = new RenderMessageTemplateResponseUnmarshaller();        

        internal static RenderMessageTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RenderMessageTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
