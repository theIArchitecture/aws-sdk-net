...
{
    /// <summary>
    /// Response Unmarshaller for ResultData Object
    /// </summary>  
    public class ResultDataUnmarshaller : IJsonUnmarshaller<ResultData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResultData Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ResultData unmarshalledObject = new ResultData();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = DataSummaryUnmarshaller.Instance;
        ...
        private static ResultDataUnmarshaller _instance = new ResultDataUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ResultDataUnmarshaller Instance
        {
            get
            {
                return _instance;
