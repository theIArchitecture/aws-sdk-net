...
namespace Amazon.QConnect.Model.Internal.MarshallTransformations
{
    ...
    public class SMSMessageTemplateContentBodyUnmarshaller : IJsonUnmarshaller<SMSMessageTemplateContentBody, JsonUnmarshallerContext>
    {
        ...
        private static SMSMessageTemplateContentBodyUnmarshaller _instance = new SMSMessageTemplateContentBodyUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SMSMessageTemplateContentBodyUnmarshaller Instance
        {
            get
            {
                return _instance;
