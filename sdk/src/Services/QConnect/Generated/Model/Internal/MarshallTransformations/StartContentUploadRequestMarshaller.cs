...
{
    /// <summary>
    /// StartContentUpload Request Marshaller
    /// </summary>       
    public class StartContentUploadRequestMarshaller : IMarshaller<IRequest, StartContentUploadRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartContentUploadRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartContentUploadRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetPresignedUrlTimeToLive())
            {
                ...
                context.Writer.WriteNumberValue(publicRequest.PresignedUrlTimeToLive.Value);
            }
        ...
        private static StartContentUploadRequestMarshaller _instance = new StartContentUploadRequestMarshaller();        

        internal static StartContentUploadRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartContentUploadRequestMarshaller Instance
        {
            get
            {
                return _instance;
