...
{
    /// <summary>
    /// Response Unmarshaller for StartImportJob operation
    /// </summary>  
    public class StartImportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartImportJobResponse response = new StartImportJobResponse();
        ...
        private static StartImportJobResponseUnmarshaller _instance = new StartImportJobResponseUnmarshaller();        

        internal static StartImportJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartImportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
