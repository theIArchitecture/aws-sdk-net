...
namespace Amazon.QConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SystemAttributesUnmarshaller : IJsonUnmarshaller<SystemAttributes, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            SystemAttributes unmarshalledObject = new SystemAttributes();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SystemAttributesUnmarshaller Instance
        {
            get
            {
                return _instance;
