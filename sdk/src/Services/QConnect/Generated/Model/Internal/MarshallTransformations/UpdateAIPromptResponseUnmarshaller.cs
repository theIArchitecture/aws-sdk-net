...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAIPrompt operation
    /// </summary>  
    public class UpdateAIPromptResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAIPromptResponse response = new UpdateAIPromptResponse();
        ...
        private static UpdateAIPromptResponseUnmarshaller _instance = new UpdateAIPromptResponseUnmarshaller();        

        internal static UpdateAIPromptResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAIPromptResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
