...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSessionData operation
    /// </summary>  
    public class UpdateSessionDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSessionDataResponse response = new UpdateSessionDataResponse();
        ...
        private static UpdateSessionDataResponseUnmarshaller _instance = new UpdateSessionDataResponseUnmarshaller();        

        internal static UpdateSessionDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSessionDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
