...
{
    /// <summary>
    /// The message template fields to query message templates by. The following is the list
    /// of supported field names:
    /// 
    ///  <ul> <li> 
    /// <para>
    /// name
    ...
    ///  </li> </ul>
    /// </summary>
    public partial class MessageTemplateQueryField
    {
        private bool? _allowFuzziness;
        private string _name;
        private MessageTemplateQueryOperator _operator;
        ...
        public MessageTemplateQueryOperator Operator
        {
