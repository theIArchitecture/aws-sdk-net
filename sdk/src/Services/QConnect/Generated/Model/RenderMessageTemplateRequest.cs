...
{
    /// <summary>
    /// Container for the parameters to the RenderMessageTemplate operation.
    ...
    /// </summary>
    public partial class RenderMessageTemplateRequest : AmazonQConnectRequest
    {
        private MessageTemplateAttributes _attributes;
        ...
        /// or placeholder in the message template. The corresponding value defines the value
        /// for that variable.
        /// </para>
        /// </summary>
        [AWSProperty(Required=true)]
        public MessageTemplateAttributes Attributes
        {
