...
{
    /// <summary>
    /// Container for the parameters to the SearchMessageTemplates operation.
    /// Searches for Amazon Q in Connect message templates in the specified knowledge base.
    /// </summary>
    public partial class SearchMessageTemplatesRequest : AmazonQConnectRequest
    {
        private string _knowledgeBaseId;
        private int? _maxResults;
        private string _nextToken;
        private MessageTemplateSearchExpression _searchExpression;
        ...
        /// </summary>
        [AWSProperty(Required=true)]
        public MessageTemplateSearchExpression SearchExpression
        {
