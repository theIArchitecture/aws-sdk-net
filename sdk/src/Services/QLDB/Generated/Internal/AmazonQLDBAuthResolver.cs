...
namespace Amazon.QLDB.Internal
{
    ...
    public class AmazonQLDBAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonQLDBAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for QLDB.
        /// </summary>
        public AmazonQLDBAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonQLDBAuthSchemeParameters
            {
    ...
    public class AmazonQLDBAuthSchemeResolver : IAuthSchemeResolver<AmazonQLDBAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonQLDBAuthSchemeParameters authParameters)
        {
