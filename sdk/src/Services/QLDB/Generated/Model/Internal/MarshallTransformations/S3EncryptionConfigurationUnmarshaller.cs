...
namespace Amazon.QLDB.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class S3EncryptionConfigurationUnmarshaller : IJsonUnmarshaller<S3EncryptionConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public S3EncryptionConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ObjectEncryptionType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
