...
namespace Amazon.QLDBSession.Internal
{
    ...
    public class AmazonQLDBSessionAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonQLDBSessionAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for QLDBSession.
        /// </summary>
        public AmazonQLDBSessionAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonQLDBSessionAuthSchemeParameters
            {
    ...
    public class AmazonQLDBSessionAuthSchemeResolver : IAuthSchemeResolver<AmazonQLDBSessionAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonQLDBSessionAuthSchemeParameters authParameters)
        {
