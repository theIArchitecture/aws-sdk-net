...
namespace Amazon.QLDBSession.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AbortTransactionResultUnmarshaller : IJsonUnmarshaller<AbortTransactionResult, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AbortTransactionResult Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
