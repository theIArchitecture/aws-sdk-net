...
namespace Amazon.QLDBSession.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CommitTransactionResultUnmarshaller : IJsonUnmarshaller<CommitTransactionResult, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CommitTransactionResult Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("CommitDigest", targetDepth))
                {
                    ...
                    unmarshalledObject.CommitDigest = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
