...
namespace Amazon.QLDBSession.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartSessionResultUnmarshaller : IJsonUnmarshaller<StartSessionResult, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public StartSessionResult Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
