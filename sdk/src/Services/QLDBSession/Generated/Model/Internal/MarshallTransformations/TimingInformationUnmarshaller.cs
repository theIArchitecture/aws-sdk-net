...
namespace Amazon.QLDBSession.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TimingInformationUnmarshaller : IJsonUnmarshaller<TimingInformation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TimingInformation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ProcessingTimeMilliseconds", targetDepth))
                {
                    ...
                    unmarshalledObject.ProcessingTimeMilliseconds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
