...
namespace Amazon.QuickSight.Internal
{
    ...
    public class AmazonQuickSightAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonQuickSightAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for QuickSight.
        /// </summary>
        public AmazonQuickSightAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonQuickSightAuthSchemeParameters
            {
    ...
    public class AmazonQuickSightAuthSchemeResolver : IAuthSchemeResolver<AmazonQuickSightAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonQuickSightAuthSchemeParameters authParameters)
        {
