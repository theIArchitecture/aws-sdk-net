...
namespace Amazon.QuickSight.Model
{
    ...
    public partial class DataSetRefreshProperties
    {
        ...
        public RefreshConfiguration RefreshConfiguration
        {
            ...
            set { this._refreshConfiguration = value; }
        }

        // Check to see if RefreshConfiguration property is set
        internal bool IsSetRefreshConfiguration()
        {
            return this._refreshConfiguration != null;
        }
