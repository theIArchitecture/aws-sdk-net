...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssetBundleImportJobFolderOverrideParametersUnmarshaller : IJsonUnmarshaller<AssetBundleImportJobFolderOverrideParameters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AssetBundleImportJobFolderOverrideParameters Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ParentFolderArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
