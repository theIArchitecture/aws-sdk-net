...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    public class AssetBundleImportJobOverridePermissionsUnmarshaller : IJsonUnmarshaller<AssetBundleImportJobOverridePermissions, JsonUnmarshallerContext>
    {
        ...
        private static AssetBundleImportJobOverridePermissionsUnmarshaller _instance = new AssetBundleImportJobOverridePermissionsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AssetBundleImportJobOverridePermissionsUnmarshaller Instance
        {
            get
            {
                return _instance;
