...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssetBundleImportJobVPCConnectionOverrideTagsUnmarshaller : IJsonUnmarshaller<AssetBundleImportJobVPCConnectionOverrideTags, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AssetBundleImportJobVPCConnectionOverrideTags Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("VPCConnectionIds", targetDepth))
                {
                    ...
                    unmarshalledObject.VPCConnectionIds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
