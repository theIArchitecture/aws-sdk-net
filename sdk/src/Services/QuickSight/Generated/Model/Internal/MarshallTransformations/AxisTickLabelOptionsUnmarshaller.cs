...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AxisTickLabelOptionsUnmarshaller : IJsonUnmarshaller<AxisTickLabelOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            AxisTickLabelOptions unmarshalledObject = new AxisTickLabelOptions();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AxisTickLabelOptionsUnmarshaller Instance
        {
            get
            {
                return _instance;
