...
{
    /// <summary>
    /// Response Unmarshaller for BarChartSortConfiguration Object
    /// </summary>  
    public class BarChartSortConfigurationUnmarshaller : IJsonUnmarshaller<BarChartSortConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BarChartSortConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            BarChartSortConfiguration unmarshalledObject = new BarChartSortConfiguration();
        ...
        private static BarChartSortConfigurationUnmarshaller _instance = new BarChartSortConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BarChartSortConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
