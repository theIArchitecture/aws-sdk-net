...
{
    /// <summary>
    /// Response Unmarshaller for BarChartVisual Object
    /// </summary>  
    public class BarChartVisualUnmarshaller : IJsonUnmarshaller<BarChartVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BarChartVisual Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            BarChartVisual unmarshalledObject = new BarChartVisual();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = BarChartConfigurationUnmarshaller.Instance;
        ...
        private static BarChartVisualUnmarshaller _instance = new BarChartVisualUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BarChartVisualUnmarshaller Instance
        {
            get
            {
                return _instance;
