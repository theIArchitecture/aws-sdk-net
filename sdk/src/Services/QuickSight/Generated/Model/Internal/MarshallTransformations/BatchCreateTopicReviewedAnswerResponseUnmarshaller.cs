...
{
    /// <summary>
    /// Response Unmarshaller for BatchCreateTopicReviewedAnswer operation
    /// </summary>  
    public class BatchCreateTopicReviewedAnswerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchCreateTopicReviewedAnswerResponse response = new BatchCreateTopicReviewedAnswerResponse();
        ...
        private static BatchCreateTopicReviewedAnswerResponseUnmarshaller _instance = new BatchCreateTopicReviewedAnswerResponseUnmarshaller();        

        internal static BatchCreateTopicReviewedAnswerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchCreateTopicReviewedAnswerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
