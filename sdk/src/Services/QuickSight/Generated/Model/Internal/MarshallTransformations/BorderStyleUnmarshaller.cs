...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BorderStyleUnmarshaller : IJsonUnmarshaller<BorderStyle, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BorderStyle Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Show", targetDepth))
                {
                    ...
                    unmarshalledObject.Show = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
