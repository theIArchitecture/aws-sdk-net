...
{
    /// <summary>
    /// Response Unmarshaller for BoxPlotChartConfiguration Object
    /// </summary>  
    public class BoxPlotChartConfigurationUnmarshaller : IJsonUnmarshaller<BoxPlotChartConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BoxPlotChartConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static BoxPlotChartConfigurationUnmarshaller _instance = new BoxPlotChartConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BoxPlotChartConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
