...
{
    /// <summary>
    /// Response Unmarshaller for BoxPlotVisual Object
    /// </summary>  
    public class BoxPlotVisualUnmarshaller : IJsonUnmarshaller<BoxPlotVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BoxPlotVisual Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            BoxPlotVisual unmarshalledObject = new BoxPlotVisual();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = BoxPlotChartConfigurationUnmarshaller.Instance;
        ...
        private static BoxPlotVisualUnmarshaller _instance = new BoxPlotVisualUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BoxPlotVisualUnmarshaller Instance
        {
            get
            {
                return _instance;
