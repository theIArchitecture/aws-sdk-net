...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CastColumnTypeOperationUnmarshaller : IJsonUnmarshaller<CastColumnTypeOperation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CastColumnTypeOperation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.NewColumnType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
