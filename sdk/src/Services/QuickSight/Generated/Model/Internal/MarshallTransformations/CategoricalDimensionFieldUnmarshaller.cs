...
{
    /// <summary>
    /// Response Unmarshaller for CategoricalDimensionField Object
    /// </summary>  
    public class CategoricalDimensionFieldUnmarshaller : IJsonUnmarshaller<CategoricalDimensionField, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CategoricalDimensionField Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            CategoricalDimensionField unmarshalledObject = new CategoricalDimensionField();
        ...
        private static CategoricalDimensionFieldUnmarshaller _instance = new CategoricalDimensionFieldUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CategoricalDimensionFieldUnmarshaller Instance
        {
            get
            {
                return _instance;
