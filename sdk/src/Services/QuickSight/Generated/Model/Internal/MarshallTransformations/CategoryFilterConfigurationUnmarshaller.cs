...
{
    /// <summary>
    /// Response Unmarshaller for CategoryFilterConfiguration Object
    /// </summary>  
    public class CategoryFilterConfigurationUnmarshaller : IJsonUnmarshaller<CategoryFilterConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CategoryFilterConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            CategoryFilterConfiguration unmarshalledObject = new CategoryFilterConfiguration();
        ...
        private static CategoryFilterConfigurationUnmarshaller _instance = new CategoryFilterConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CategoryFilterConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
