...
{
    /// <summary>
    /// Response Unmarshaller for CategoryFilter Object
    /// </summary>  
    public class CategoryFilterUnmarshaller : IJsonUnmarshaller<CategoryFilter, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CategoryFilter Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            CategoryFilter unmarshalledObject = new CategoryFilter();
        ...
        private static CategoryFilterUnmarshaller _instance = new CategoryFilterUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CategoryFilterUnmarshaller Instance
        {
            get
            {
                return _instance;
