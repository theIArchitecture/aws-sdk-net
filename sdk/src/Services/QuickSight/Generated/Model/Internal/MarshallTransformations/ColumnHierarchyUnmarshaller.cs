...
{
    /// <summary>
    /// Response Unmarshaller for ColumnHierarchy Object
    /// </summary>  
    public class ColumnHierarchyUnmarshaller : IJsonUnmarshaller<ColumnHierarchy, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ColumnHierarchy Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static ColumnHierarchyUnmarshaller _instance = new ColumnHierarchyUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ColumnHierarchyUnmarshaller Instance
        {
            get
            {
                return _instance;
