...
{
    /// <summary>
    /// Response Unmarshaller for ColumnTooltipItem Object
    /// </summary>  
    public class ColumnTooltipItemUnmarshaller : IJsonUnmarshaller<ColumnTooltipItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ColumnTooltipItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ColumnTooltipItem unmarshalledObject = new ColumnTooltipItem();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TooltipTarget = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ColumnTooltipItemUnmarshaller _instance = new ColumnTooltipItemUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ColumnTooltipItemUnmarshaller Instance
        {
            get
            {
                return _instance;
