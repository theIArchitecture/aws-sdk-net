...
{
    /// <summary>
    /// Response Unmarshaller for ComboChartSortConfiguration Object
    /// </summary>  
    public class ComboChartSortConfigurationUnmarshaller : IJsonUnmarshaller<ComboChartSortConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ComboChartSortConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static ComboChartSortConfigurationUnmarshaller _instance = new ComboChartSortConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ComboChartSortConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
