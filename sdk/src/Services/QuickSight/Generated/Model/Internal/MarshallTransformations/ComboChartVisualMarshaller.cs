...
{
    /// <summary>
    /// ComboChartVisual Marshaller
    /// </summary>
    public class ComboChartVisualMarshaller : IRequestMarshaller<ComboChartVisual, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(ComboChartVisual requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetChartConfiguration())
            {
                ...
                var marshaller = ComboChartConfigurationMarshaller.Instance;
        ...
        /// </summary>
        public readonly static ComboChartVisualMarshaller Instance = new ComboChartVisualMarshaller();
