...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConditionalFormattingCustomIconConditionUnmarshaller : IJsonUnmarshaller<ConditionalFormattingCustomIconCondition, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ConditionalFormattingCustomIconCondition Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("IconOptions", targetDepth))
                {
                    ...
                    unmarshalledObject.IconOptions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
