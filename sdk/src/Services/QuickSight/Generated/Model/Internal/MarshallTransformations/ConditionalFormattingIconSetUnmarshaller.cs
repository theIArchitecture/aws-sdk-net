...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    public class ConditionalFormattingIconSetUnmarshaller : IJsonUnmarshaller<ConditionalFormattingIconSet, JsonUnmarshallerContext>
    {
        ...
        private static ConditionalFormattingIconSetUnmarshaller _instance = new ConditionalFormattingIconSetUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ConditionalFormattingIconSetUnmarshaller Instance
        {
            get
            {
                return _instance;
