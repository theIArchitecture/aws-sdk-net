...
{
    /// <summary>
    /// Response Unmarshaller for CreateAccountSubscription operation
    /// </summary>  
    public class CreateAccountSubscriptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAccountSubscriptionResponse response = new CreateAccountSubscriptionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SignupResponse", targetDepth))
                {
                    ...
                    response.SignupResponse = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateAccountSubscriptionResponseUnmarshaller _instance = new CreateAccountSubscriptionResponseUnmarshaller();        

        internal static CreateAccountSubscriptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAccountSubscriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
