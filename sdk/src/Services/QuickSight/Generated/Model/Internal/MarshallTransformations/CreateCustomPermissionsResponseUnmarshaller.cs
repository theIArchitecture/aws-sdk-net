...
{
    /// <summary>
    /// Response Unmarshaller for CreateCustomPermissions operation
    /// </summary>  
    public class CreateCustomPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateCustomPermissionsResponse response = new CreateCustomPermissionsResponse();
        ...
        private static CreateCustomPermissionsResponseUnmarshaller _instance = new CreateCustomPermissionsResponseUnmarshaller();        

        internal static CreateCustomPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCustomPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
