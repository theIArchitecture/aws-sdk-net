...
{
    /// <summary>
    /// Response Unmarshaller for CreateFolderMembership operation
    /// </summary>  
    public class CreateFolderMembershipResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateFolderMembershipResponse response = new CreateFolderMembershipResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("FolderMember", targetDepth))
                {
                    var unmarshaller = FolderMemberUnmarshaller.Instance;
                    response.FolderMember = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateFolderMembershipResponseUnmarshaller _instance = new CreateFolderMembershipResponseUnmarshaller();        

        internal static CreateFolderMembershipResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateFolderMembershipResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
