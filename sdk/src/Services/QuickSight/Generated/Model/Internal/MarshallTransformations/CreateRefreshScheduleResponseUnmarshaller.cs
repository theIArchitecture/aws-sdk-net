...
{
    /// <summary>
    /// Response Unmarshaller for CreateRefreshSchedule operation
    /// </summary>  
    public class CreateRefreshScheduleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRefreshScheduleResponse response = new CreateRefreshScheduleResponse();
        ...
        private static CreateRefreshScheduleResponseUnmarshaller _instance = new CreateRefreshScheduleResponseUnmarshaller();        

        internal static CreateRefreshScheduleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRefreshScheduleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
