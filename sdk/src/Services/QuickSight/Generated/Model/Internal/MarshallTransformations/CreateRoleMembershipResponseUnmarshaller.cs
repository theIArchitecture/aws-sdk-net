...
{
    /// <summary>
    /// Response Unmarshaller for CreateRoleMembership operation
    /// </summary>  
    public class CreateRoleMembershipResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRoleMembershipResponse response = new CreateRoleMembershipResponse();
        ...
        private static CreateRoleMembershipResponseUnmarshaller _instance = new CreateRoleMembershipResponseUnmarshaller();        

        internal static CreateRoleMembershipResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRoleMembershipResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
