...
{
    /// <summary>
    /// CreateTopicRefreshSchedule Request Marshaller
    /// </summary>       
    public class CreateTopicRefreshScheduleRequestMarshaller : IMarshaller<IRequest, CreateTopicRefreshScheduleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateTopicRefreshScheduleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateTopicRefreshScheduleRequest publicRequest)
        {
        ...
        private static CreateTopicRefreshScheduleRequestMarshaller _instance = new CreateTopicRefreshScheduleRequestMarshaller();        

        internal static CreateTopicRefreshScheduleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTopicRefreshScheduleRequestMarshaller Instance
        {
            get
            {
                return _instance;
