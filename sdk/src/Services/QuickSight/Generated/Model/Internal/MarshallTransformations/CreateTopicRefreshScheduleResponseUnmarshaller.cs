...
{
    /// <summary>
    /// Response Unmarshaller for CreateTopicRefreshSchedule operation
    /// </summary>  
    public class CreateTopicRefreshScheduleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTopicRefreshScheduleResponse response = new CreateTopicRefreshScheduleResponse();
        ...
        private static CreateTopicRefreshScheduleResponseUnmarshaller _instance = new CreateTopicRefreshScheduleResponseUnmarshaller();        

        internal static CreateTopicRefreshScheduleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTopicRefreshScheduleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
