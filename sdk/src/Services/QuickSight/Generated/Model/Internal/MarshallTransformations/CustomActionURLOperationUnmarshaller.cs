...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    public class CustomActionURLOperationUnmarshaller : IJsonUnmarshaller<CustomActionURLOperation, JsonUnmarshallerContext>
    {
        ...
        private static CustomActionURLOperationUnmarshaller _instance = new CustomActionURLOperationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CustomActionURLOperationUnmarshaller Instance
        {
            get
            {
                return _instance;
