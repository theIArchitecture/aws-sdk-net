...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CustomColorUnmarshaller : IJsonUnmarshaller<CustomColor, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CustomColor Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SpecialValue = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
