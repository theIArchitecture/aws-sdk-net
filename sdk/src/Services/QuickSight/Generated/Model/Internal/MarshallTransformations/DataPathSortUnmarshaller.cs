...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DataPathSortUnmarshaller : IJsonUnmarshaller<DataPathSort, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DataPathSort Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SortPaths", targetDepth))
                {
                    ...
                    unmarshalledObject.SortPaths = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
