...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DataPathValueUnmarshaller : IJsonUnmarshaller<DataPathValue, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DataPathValue Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("DataPathType", targetDepth))
                {
                    ...
                    unmarshalledObject.DataPathType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
