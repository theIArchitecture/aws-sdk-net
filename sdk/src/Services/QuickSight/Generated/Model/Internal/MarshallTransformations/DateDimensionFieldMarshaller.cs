...
{
    /// <summary>
    /// DateDimensionField Marshaller
    /// </summary>
    public class DateDimensionFieldMarshaller : IRequestMarshaller<DateDimensionField, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(DateDimensionField requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetDateGranularity())
            {
                context.Writer.WritePropertyName("DateGranularity");
                context.Writer.WriteStringValue(requestObject.DateGranularity);
            }
        ...
        /// </summary>
        public readonly static DateDimensionFieldMarshaller Instance = new DateDimensionFieldMarshaller();
