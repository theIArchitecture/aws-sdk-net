...
{
    /// <summary>
    /// Response Unmarshaller for DateDimensionField Object
    /// </summary>  
    public class DateDimensionFieldUnmarshaller : IJsonUnmarshaller<DateDimensionField, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DateDimensionField Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("DateGranularity", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DateGranularity = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DateDimensionFieldUnmarshaller _instance = new DateDimensionFieldUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DateDimensionFieldUnmarshaller Instance
        {
            get
            {
                return _instance;
