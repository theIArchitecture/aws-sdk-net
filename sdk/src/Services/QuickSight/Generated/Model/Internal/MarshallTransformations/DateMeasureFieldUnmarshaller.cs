...
{
    /// <summary>
    /// Response Unmarshaller for DateMeasureField Object
    /// </summary>  
    public class DateMeasureFieldUnmarshaller : IJsonUnmarshaller<DateMeasureField, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DateMeasureField Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            DateMeasureField unmarshalledObject = new DateMeasureField();
        ...
        private static DateMeasureFieldUnmarshaller _instance = new DateMeasureFieldUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DateMeasureFieldUnmarshaller Instance
        {
            get
            {
                return _instance;
