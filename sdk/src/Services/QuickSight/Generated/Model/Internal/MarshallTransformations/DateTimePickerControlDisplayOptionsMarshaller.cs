...
{
    /// <summary>
    /// DateTimePickerControlDisplayOptions Marshaller
    /// </summary>
    public class DateTimePickerControlDisplayOptionsMarshaller : IRequestMarshaller<DateTimePickerControlDisplayOptions, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(DateTimePickerControlDisplayOptions requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetDateIconVisibility())
            {
                ...
                context.Writer.WriteStringValue(requestObject.DateIconVisibility);
            }
            ...
            if(requestObject.IsSetHelperTextVisibility())
            {
                ...
                context.Writer.WriteStringValue(requestObject.HelperTextVisibility);
            }
        ...
        /// </summary>
        public readonly static DateTimePickerControlDisplayOptionsMarshaller Instance = new DateTimePickerControlDisplayOptionsMarshaller();
