...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAccountSubscription operation
    /// </summary>  
    public class DeleteAccountSubscriptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAccountSubscriptionResponse response = new DeleteAccountSubscriptionResponse();
        ...
        private static DeleteAccountSubscriptionResponseUnmarshaller _instance = new DeleteAccountSubscriptionResponseUnmarshaller();        

        internal static DeleteAccountSubscriptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAccountSubscriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
