...
{
    /// <summary>
    /// Response Unmarshaller for DeleteBrand operation
    /// </summary>  
    public class DeleteBrandResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteBrandResponseUnmarshaller _instance = new DeleteBrandResponseUnmarshaller();        

        internal static DeleteBrandResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteBrandResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
