...
{
    /// <summary>
    /// Response Unmarshaller for DeleteCustomPermissions operation
    /// </summary>  
    public class DeleteCustomPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteCustomPermissionsResponse response = new DeleteCustomPermissionsResponse();
        ...
        private static DeleteCustomPermissionsResponseUnmarshaller _instance = new DeleteCustomPermissionsResponseUnmarshaller();        

        internal static DeleteCustomPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCustomPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
