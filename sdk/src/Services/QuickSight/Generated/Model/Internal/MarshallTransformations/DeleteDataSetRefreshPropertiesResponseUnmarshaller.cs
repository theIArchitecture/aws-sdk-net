...
{
    /// <summary>
    /// Response Unmarshaller for DeleteDataSetRefreshProperties operation
    /// </summary>  
    public class DeleteDataSetRefreshPropertiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDataSetRefreshPropertiesResponse response = new DeleteDataSetRefreshPropertiesResponse();
        ...
        private static DeleteDataSetRefreshPropertiesResponseUnmarshaller _instance = new DeleteDataSetRefreshPropertiesResponseUnmarshaller();        

        internal static DeleteDataSetRefreshPropertiesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDataSetRefreshPropertiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
