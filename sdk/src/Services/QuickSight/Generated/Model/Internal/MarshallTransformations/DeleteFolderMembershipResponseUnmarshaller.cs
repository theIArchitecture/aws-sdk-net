...
{
    /// <summary>
    /// Response Unmarshaller for DeleteFolderMembership operation
    /// </summary>  
    public class DeleteFolderMembershipResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteFolderMembershipResponse response = new DeleteFolderMembershipResponse();
        ...
        private static DeleteFolderMembershipResponseUnmarshaller _instance = new DeleteFolderMembershipResponseUnmarshaller();        

        internal static DeleteFolderMembershipResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteFolderMembershipResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
