...
{
    /// <summary>
    /// Response Unmarshaller for DeleteRefreshSchedule operation
    /// </summary>  
    public class DeleteRefreshScheduleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteRefreshScheduleResponse response = new DeleteRefreshScheduleResponse();
        ...
        private static DeleteRefreshScheduleResponseUnmarshaller _instance = new DeleteRefreshScheduleResponseUnmarshaller();        

        internal static DeleteRefreshScheduleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRefreshScheduleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
