...
{
    /// <summary>
    /// DeleteRoleMembership Request Marshaller
    /// </summary>       
    public class DeleteRoleMembershipRequestMarshaller : IMarshaller<IRequest, DeleteRoleMembershipRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteRoleMembershipRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteRoleMembershipRequest publicRequest)
        {
        ...
        private static DeleteRoleMembershipRequestMarshaller _instance = new DeleteRoleMembershipRequestMarshaller();        

        internal static DeleteRoleMembershipRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRoleMembershipRequestMarshaller Instance
        {
            get
            {
                return _instance;
