...
{
    /// <summary>
    /// Response Unmarshaller for DeleteTopicRefreshSchedule operation
    /// </summary>  
    public class DeleteTopicRefreshScheduleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteTopicRefreshScheduleResponse response = new DeleteTopicRefreshScheduleResponse();
        ...
        private static DeleteTopicRefreshScheduleResponseUnmarshaller _instance = new DeleteTopicRefreshScheduleResponseUnmarshaller();        

        internal static DeleteTopicRefreshScheduleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTopicRefreshScheduleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
