...
{
    /// <summary>
    /// Response Unmarshaller for DeleteUserCustomPermission operation
    /// </summary>  
    public class DeleteUserCustomPermissionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteUserCustomPermissionResponse response = new DeleteUserCustomPermissionResponse();
        ...
        private static DeleteUserCustomPermissionResponseUnmarshaller _instance = new DeleteUserCustomPermissionResponseUnmarshaller();        

        internal static DeleteUserCustomPermissionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteUserCustomPermissionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
