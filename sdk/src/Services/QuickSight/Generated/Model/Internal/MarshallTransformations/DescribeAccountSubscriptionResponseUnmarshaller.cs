...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAccountSubscription operation
    /// </summary>  
    public class DescribeAccountSubscriptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAccountSubscriptionResponse response = new DescribeAccountSubscriptionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = AccountInfoUnmarshaller.Instance;
                    response.AccountInfo = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeAccountSubscriptionResponseUnmarshaller _instance = new DescribeAccountSubscriptionResponseUnmarshaller();        

        internal static DescribeAccountSubscriptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAccountSubscriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
