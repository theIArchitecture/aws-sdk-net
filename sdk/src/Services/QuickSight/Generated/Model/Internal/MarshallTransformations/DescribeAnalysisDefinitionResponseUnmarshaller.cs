...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAnalysisDefinition operation
    /// </summary>  
    public class DescribeAnalysisDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAnalysisDefinitionResponse response = new DescribeAnalysisDefinitionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = AnalysisDefinitionUnmarshaller.Instance;
                    response.Definition = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("Errors", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<AnalysisError, AnalysisErrorUnmarshaller>(AnalysisErrorUnmarshaller.Instance);
        ...
        private static DescribeAnalysisDefinitionResponseUnmarshaller _instance = new DescribeAnalysisDefinitionResponseUnmarshaller();        

        internal static DescribeAnalysisDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAnalysisDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
