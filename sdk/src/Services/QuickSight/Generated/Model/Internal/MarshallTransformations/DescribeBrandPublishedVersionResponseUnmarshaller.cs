...
{
    /// <summary>
    /// Response Unmarshaller for DescribeBrandPublishedVersion operation
    /// </summary>  
    public class DescribeBrandPublishedVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeBrandPublishedVersionResponse response = new DescribeBrandPublishedVersionResponse();
        ...
        private static DescribeBrandPublishedVersionResponseUnmarshaller _instance = new DescribeBrandPublishedVersionResponseUnmarshaller();        

        internal static DescribeBrandPublishedVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeBrandPublishedVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
