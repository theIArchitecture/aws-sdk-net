...
{
    /// <summary>
    /// Response Unmarshaller for DescribeCustomPermissions operation
    /// </summary>  
    public class DescribeCustomPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeCustomPermissionsResponse response = new DescribeCustomPermissionsResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("CustomPermissions", targetDepth))
                {
                    var unmarshaller = CustomPermissionsUnmarshaller.Instance;
                    response.CustomPermissions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeCustomPermissionsResponseUnmarshaller _instance = new DescribeCustomPermissionsResponseUnmarshaller();        

        internal static DescribeCustomPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeCustomPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
