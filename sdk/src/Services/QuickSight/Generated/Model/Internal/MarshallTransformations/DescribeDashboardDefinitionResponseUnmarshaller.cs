...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDashboardDefinition operation
    /// </summary>  
    public class DescribeDashboardDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDashboardDefinitionResponse response = new DescribeDashboardDefinitionResponse();
        ...
        private static DescribeDashboardDefinitionResponseUnmarshaller _instance = new DescribeDashboardDefinitionResponseUnmarshaller();        

        internal static DescribeDashboardDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDashboardDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
