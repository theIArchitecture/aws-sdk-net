...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDashboardSnapshotJob operation
    /// </summary>  
    public class DescribeDashboardSnapshotJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDashboardSnapshotJobResponse response = new DescribeDashboardSnapshotJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = SnapshotConfigurationUnmarshaller.Instance;
                    response.SnapshotConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("SnapshotJobId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SnapshotJobId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = SnapshotUserConfigurationRedactedUnmarshaller.Instance;
                    response.UserConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeDashboardSnapshotJobResponseUnmarshaller _instance = new DescribeDashboardSnapshotJobResponseUnmarshaller();        

        internal static DescribeDashboardSnapshotJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDashboardSnapshotJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
