...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDataSetRefreshProperties operation
    /// </summary>  
    public class DescribeDataSetRefreshPropertiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDataSetRefreshPropertiesResponse response = new DescribeDataSetRefreshPropertiesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("DataSetRefreshProperties", targetDepth))
                {
                    ...
                    response.DataSetRefreshProperties = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeDataSetRefreshPropertiesResponseUnmarshaller _instance = new DescribeDataSetRefreshPropertiesResponseUnmarshaller();        

        internal static DescribeDataSetRefreshPropertiesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDataSetRefreshPropertiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
