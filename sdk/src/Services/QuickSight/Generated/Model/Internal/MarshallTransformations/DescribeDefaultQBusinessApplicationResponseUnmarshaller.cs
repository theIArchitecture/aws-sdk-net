...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDefaultQBusinessApplication operation
    /// </summary>  
    public class DescribeDefaultQBusinessApplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDefaultQBusinessApplicationResponse response = new DescribeDefaultQBusinessApplicationResponse();
        ...
        private static DescribeDefaultQBusinessApplicationResponseUnmarshaller _instance = new DescribeDefaultQBusinessApplicationResponseUnmarshaller();        

        internal static DescribeDefaultQBusinessApplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDefaultQBusinessApplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
