...
{
    /// <summary>
    /// Response Unmarshaller for DescribeFolderPermissions operation
    /// </summary>  
    public class DescribeFolderPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeFolderPermissionsResponse response = new DescribeFolderPermissionsResponse();
        ...
        private static DescribeFolderPermissionsResponseUnmarshaller _instance = new DescribeFolderPermissionsResponseUnmarshaller();        

        internal static DescribeFolderPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeFolderPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
