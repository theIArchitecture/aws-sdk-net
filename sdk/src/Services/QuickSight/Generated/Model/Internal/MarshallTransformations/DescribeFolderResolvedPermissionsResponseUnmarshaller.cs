...
{
    /// <summary>
    /// Response Unmarshaller for DescribeFolderResolvedPermissions operation
    /// </summary>  
    public class DescribeFolderResolvedPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeFolderResolvedPermissionsResponse response = new DescribeFolderResolvedPermissionsResponse();
        ...
        private static DescribeFolderResolvedPermissionsResponseUnmarshaller _instance = new DescribeFolderResolvedPermissionsResponseUnmarshaller();        

        internal static DescribeFolderResolvedPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeFolderResolvedPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
