...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeGroupMembershipResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeGroupMembershipResponse response = new DescribeGroupMembershipResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("GroupMember", targetDepth))
                {
                    ...
                    response.GroupMember = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeGroupMembershipResponseUnmarshaller _instance = new DescribeGroupMembershipResponseUnmarshaller();        

        internal static DescribeGroupMembershipResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeGroupMembershipResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
