...
{
    /// <summary>
    /// Response Unmarshaller for DescribeRefreshSchedule operation
    /// </summary>  
    public class DescribeRefreshScheduleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeRefreshScheduleResponse response = new DescribeRefreshScheduleResponse();
        ...
        private static DescribeRefreshScheduleResponseUnmarshaller _instance = new DescribeRefreshScheduleResponseUnmarshaller();        

        internal static DescribeRefreshScheduleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeRefreshScheduleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
