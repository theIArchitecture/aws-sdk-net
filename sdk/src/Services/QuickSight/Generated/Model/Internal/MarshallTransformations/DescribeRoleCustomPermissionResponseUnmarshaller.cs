...
{
    /// <summary>
    /// Response Unmarshaller for DescribeRoleCustomPermission operation
    /// </summary>  
    public class DescribeRoleCustomPermissionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeRoleCustomPermissionResponse response = new DescribeRoleCustomPermissionResponse();
        ...
        private static DescribeRoleCustomPermissionResponseUnmarshaller _instance = new DescribeRoleCustomPermissionResponseUnmarshaller();        

        internal static DescribeRoleCustomPermissionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeRoleCustomPermissionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
