...
{
    /// <summary>
    /// Response Unmarshaller for DescribeTopicPermissions operation
    /// </summary>  
    public class DescribeTopicPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeTopicPermissionsResponse response = new DescribeTopicPermissionsResponse();
        ...
        private static DescribeTopicPermissionsResponseUnmarshaller _instance = new DescribeTopicPermissionsResponseUnmarshaller();        

        internal static DescribeTopicPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTopicPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
