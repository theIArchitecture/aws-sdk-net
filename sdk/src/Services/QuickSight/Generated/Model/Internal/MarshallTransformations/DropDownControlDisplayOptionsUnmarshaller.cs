...
{
    /// <summary>
    /// Response Unmarshaller for DropDownControlDisplayOptions Object
    /// </summary>  
    public class DropDownControlDisplayOptionsUnmarshaller : IJsonUnmarshaller<DropDownControlDisplayOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DropDownControlDisplayOptions Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            DropDownControlDisplayOptions unmarshalledObject = new DropDownControlDisplayOptions();
        ...
        private static DropDownControlDisplayOptionsUnmarshaller _instance = new DropDownControlDisplayOptionsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DropDownControlDisplayOptionsUnmarshaller Instance
        {
            get
            {
                return _instance;
