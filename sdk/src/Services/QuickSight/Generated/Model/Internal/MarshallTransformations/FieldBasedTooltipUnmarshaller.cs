...
{
    /// <summary>
    /// Response Unmarshaller for FieldBasedTooltip Object
    /// </summary>  
    public class FieldBasedTooltipUnmarshaller : IJsonUnmarshaller<FieldBasedTooltip, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FieldBasedTooltip Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            FieldBasedTooltip unmarshalledObject = new FieldBasedTooltip();
        ...
        private static FieldBasedTooltipUnmarshaller _instance = new FieldBasedTooltipUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static FieldBasedTooltipUnmarshaller Instance
        {
            get
            {
                return _instance;
