...
{
    /// <summary>
    /// FilledMapVisual Marshaller
    /// </summary>
    public class FilledMapVisualMarshaller : IRequestMarshaller<FilledMapVisual, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(FilledMapVisual requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetChartConfiguration())
            {
                ...
                var marshaller = FilledMapConfigurationMarshaller.Instance;
            ...
            if(requestObject.IsSetConditionalFormatting())
            {
                ...
                var marshaller = FilledMapConditionalFormattingMarshaller.Instance;
        ...
        /// </summary>
        public readonly static FilledMapVisualMarshaller Instance = new FilledMapVisualMarshaller();
