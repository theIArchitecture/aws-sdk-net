...
{
    /// <summary>
    /// Response Unmarshaller for FilledMapVisual Object
    /// </summary>  
    public class FilledMapVisualUnmarshaller : IJsonUnmarshaller<FilledMapVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FilledMapVisual Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = FilledMapConfigurationUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = FilledMapConditionalFormattingUnmarshaller.Instance;
        ...
        private static FilledMapVisualUnmarshaller _instance = new FilledMapVisualUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static FilledMapVisualUnmarshaller Instance
        {
            get
            {
                return _instance;
