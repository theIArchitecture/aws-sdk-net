...
{
    /// <summary>
    /// Response Unmarshaller for FilterListControl Object
    /// </summary>  
    public class FilterListControlUnmarshaller : IJsonUnmarshaller<FilterListControl, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FilterListControl Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            FilterListControl unmarshalledObject = new FilterListControl();
        ...
        private static FilterListControlUnmarshaller _instance = new FilterListControlUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static FilterListControlUnmarshaller Instance
        {
            get
            {
                return _instance;
