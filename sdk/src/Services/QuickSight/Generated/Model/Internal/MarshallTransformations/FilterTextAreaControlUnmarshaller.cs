...
{
    /// <summary>
    /// Response Unmarshaller for FilterTextAreaControl Object
    /// </summary>  
    public class FilterTextAreaControlUnmarshaller : IJsonUnmarshaller<FilterTextAreaControl, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FilterTextAreaControl Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            FilterTextAreaControl unmarshalledObject = new FilterTextAreaControl();
        ...
        private static FilterTextAreaControlUnmarshaller _instance = new FilterTextAreaControlUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static FilterTextAreaControlUnmarshaller Instance
        {
            get
            {
                return _instance;
