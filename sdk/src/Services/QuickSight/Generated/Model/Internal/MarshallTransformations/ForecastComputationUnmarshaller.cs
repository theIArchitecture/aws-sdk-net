...
{
    /// <summary>
    /// Response Unmarshaller for ForecastComputation Object
    /// </summary>  
    public class ForecastComputationUnmarshaller : IJsonUnmarshaller<ForecastComputation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ForecastComputation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static ForecastComputationUnmarshaller _instance = new ForecastComputationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ForecastComputationUnmarshaller Instance
        {
            get
            {
                return _instance;
