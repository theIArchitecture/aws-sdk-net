...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ForecastConfigurationUnmarshaller : IJsonUnmarshaller<ForecastConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            ForecastConfiguration unmarshalledObject = new ForecastConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ForecastConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
