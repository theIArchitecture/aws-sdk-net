...
{
    /// <summary>
    /// Response Unmarshaller for FunnelChartVisual Object
    /// </summary>  
    public class FunnelChartVisualUnmarshaller : IJsonUnmarshaller<FunnelChartVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FunnelChartVisual Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            FunnelChartVisual unmarshalledObject = new FunnelChartVisual();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = FunnelChartConfigurationUnmarshaller.Instance;
        ...
        private static FunnelChartVisualUnmarshaller _instance = new FunnelChartVisualUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static FunnelChartVisualUnmarshaller Instance
        {
            get
            {
                return _instance;
