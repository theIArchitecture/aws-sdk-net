...
{
    /// <summary>
    /// GaugeChartVisual Marshaller
    /// </summary>
    public class GaugeChartVisualMarshaller : IRequestMarshaller<GaugeChartVisual, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(GaugeChartVisual requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetChartConfiguration())
            {
                ...
                var marshaller = GaugeChartConfigurationMarshaller.Instance;
            ...
            if(requestObject.IsSetConditionalFormatting())
            {
                ...
                var marshaller = GaugeChartConditionalFormattingMarshaller.Instance;
        ...
        /// </summary>
        public readonly static GaugeChartVisualMarshaller Instance = new GaugeChartVisualMarshaller();
