...
{
    /// <summary>
    /// Response Unmarshaller for GaugeChartVisual Object
    /// </summary>  
    public class GaugeChartVisualUnmarshaller : IJsonUnmarshaller<GaugeChartVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GaugeChartVisual Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            GaugeChartVisual unmarshalledObject = new GaugeChartVisual();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = GaugeChartConfigurationUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = GaugeChartConditionalFormattingUnmarshaller.Instance;
        ...
        private static GaugeChartVisualUnmarshaller _instance = new GaugeChartVisualUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static GaugeChartVisualUnmarshaller Instance
        {
            get
            {
                return _instance;
