...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    public class GeospatialCircleSymbolStyleUnmarshaller : IJsonUnmarshaller<GeospatialCircleSymbolStyle, JsonUnmarshallerContext>
    {
        ...
        private static GeospatialCircleSymbolStyleUnmarshaller _instance = new GeospatialCircleSymbolStyleUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static GeospatialCircleSymbolStyleUnmarshaller Instance
        {
            get
            {
                return _instance;
