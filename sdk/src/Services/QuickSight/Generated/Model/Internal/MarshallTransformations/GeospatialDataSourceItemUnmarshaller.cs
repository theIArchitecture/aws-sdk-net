...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GeospatialDataSourceItemUnmarshaller : IJsonUnmarshaller<GeospatialDataSourceItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GeospatialDataSourceItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("StaticFileDataSource", targetDepth))
                {
                    ...
                    unmarshalledObject.StaticFileDataSource = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
