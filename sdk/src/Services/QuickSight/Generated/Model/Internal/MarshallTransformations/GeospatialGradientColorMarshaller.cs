...
{
    /// <summary>
    /// GeospatialGradientColor Marshaller
    /// </summary>
    public class GeospatialGradientColorMarshaller : IRequestMarshaller<GeospatialGradientColor, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(GeospatialGradientColor requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetStepColors())
            {
                context.Writer.WritePropertyName("StepColors");
                context.Writer.WriteStartArray();
                foreach(var requestObjectStepColorsListValue in requestObject.StepColors)
                {
                    context.Writer.WriteStartObject();

                    var marshaller = GeospatialGradientStepColorMarshaller.Instance;
                    marshaller.Marshall(requestObjectStepColorsListValue, context);
        ...
        /// </summary>
        public readonly static GeospatialGradientColorMarshaller Instance = new GeospatialGradientColorMarshaller();
