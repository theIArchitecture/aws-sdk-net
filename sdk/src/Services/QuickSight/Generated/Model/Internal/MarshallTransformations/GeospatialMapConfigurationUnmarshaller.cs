...
{
    /// <summary>
    /// Response Unmarshaller for GeospatialMapConfiguration Object
    /// </summary>  
    public class GeospatialMapConfigurationUnmarshaller : IJsonUnmarshaller<GeospatialMapConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GeospatialMapConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            GeospatialMapConfiguration unmarshalledObject = new GeospatialMapConfiguration();
        ...
        private static GeospatialMapConfigurationUnmarshaller _instance = new GeospatialMapConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static GeospatialMapConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
