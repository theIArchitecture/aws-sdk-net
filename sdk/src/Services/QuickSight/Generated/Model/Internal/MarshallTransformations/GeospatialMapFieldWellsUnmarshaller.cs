...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GeospatialMapFieldWellsUnmarshaller : IJsonUnmarshaller<GeospatialMapFieldWells, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GeospatialMapFieldWells Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("GeospatialMapAggregatedFieldWells", targetDepth))
                {
                    ...
                    unmarshalledObject.GeospatialMapAggregatedFieldWells = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
