...
{
    /// <summary>
    /// GeospatialMapVisual Marshaller
    /// </summary>
    public class GeospatialMapVisualMarshaller : IRequestMarshaller<GeospatialMapVisual, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(GeospatialMapVisual requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetChartConfiguration())
            {
                ...
                var marshaller = GeospatialMapConfigurationMarshaller.Instance;
        ...
        /// </summary>
        public readonly static GeospatialMapVisualMarshaller Instance = new GeospatialMapVisualMarshaller();
