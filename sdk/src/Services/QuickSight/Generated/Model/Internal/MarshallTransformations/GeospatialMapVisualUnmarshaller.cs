...
{
    /// <summary>
    /// Response Unmarshaller for GeospatialMapVisual Object
    /// </summary>  
    public class GeospatialMapVisualUnmarshaller : IJsonUnmarshaller<GeospatialMapVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GeospatialMapVisual Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            GeospatialMapVisual unmarshalledObject = new GeospatialMapVisual();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = GeospatialMapConfigurationUnmarshaller.Instance;
        ...
        private static GeospatialMapVisualUnmarshaller _instance = new GeospatialMapVisualUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static GeospatialMapVisualUnmarshaller Instance
        {
            get
            {
                return _instance;
