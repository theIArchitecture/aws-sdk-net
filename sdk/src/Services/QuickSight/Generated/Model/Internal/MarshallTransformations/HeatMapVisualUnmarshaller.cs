...
{
    /// <summary>
    /// Response Unmarshaller for HeatMapVisual Object
    /// </summary>  
    public class HeatMapVisualUnmarshaller : IJsonUnmarshaller<HeatMapVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public HeatMapVisual Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            HeatMapVisual unmarshalledObject = new HeatMapVisual();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = HeatMapConfigurationUnmarshaller.Instance;
        ...
        private static HeatMapVisualUnmarshaller _instance = new HeatMapVisualUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static HeatMapVisualUnmarshaller Instance
        {
            get
            {
                return _instance;
