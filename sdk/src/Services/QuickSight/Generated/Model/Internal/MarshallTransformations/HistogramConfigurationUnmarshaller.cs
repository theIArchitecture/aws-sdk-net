...
{
    /// <summary>
    /// Response Unmarshaller for HistogramConfiguration Object
    /// </summary>  
    public class HistogramConfigurationUnmarshaller : IJsonUnmarshaller<HistogramConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public HistogramConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            HistogramConfiguration unmarshalledObject = new HistogramConfiguration();
        ...
        private static HistogramConfigurationUnmarshaller _instance = new HistogramConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static HistogramConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
