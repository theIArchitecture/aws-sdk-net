...
{
    /// <summary>
    /// HistogramVisual Marshaller
    /// </summary>
    public class HistogramVisualMarshaller : IRequestMarshaller<HistogramVisual, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(HistogramVisual requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetChartConfiguration())
            {
                ...
                var marshaller = HistogramConfigurationMarshaller.Instance;
        ...
        /// </summary>
        public readonly static HistogramVisualMarshaller Instance = new HistogramVisualMarshaller();
