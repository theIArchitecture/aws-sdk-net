...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ImageSetUnmarshaller : IJsonUnmarshaller<ImageSet, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            ImageSet unmarshalledObject = new ImageSet();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImageSetUnmarshaller Instance
        {
            get
            {
                return _instance;
