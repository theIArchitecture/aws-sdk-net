...
{
    /// <summary>
    /// Response Unmarshaller for InsightConfiguration Object
    /// </summary>  
    public class InsightConfigurationUnmarshaller : IJsonUnmarshaller<InsightConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InsightConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            InsightConfiguration unmarshalledObject = new InsightConfiguration();
        ...
        private static InsightConfigurationUnmarshaller _instance = new InsightConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static InsightConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
