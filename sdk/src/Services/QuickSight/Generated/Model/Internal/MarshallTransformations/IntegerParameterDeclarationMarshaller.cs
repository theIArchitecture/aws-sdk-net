...
{
    /// <summary>
    /// IntegerParameterDeclaration Marshaller
    /// </summary>
    public class IntegerParameterDeclarationMarshaller : IRequestMarshaller<IntegerParameterDeclaration, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(IntegerParameterDeclaration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetDefaultValues())
            {
                ...
                var marshaller = IntegerDefaultValuesMarshaller.Instance;
            ...
            if(requestObject.IsSetValueWhenUnset())
            {
                ...
                var marshaller = IntegerValueWhenUnsetConfigurationMarshaller.Instance;
        ...
        /// </summary>
        public readonly static IntegerParameterDeclarationMarshaller Instance = new IntegerParameterDeclarationMarshaller();
