...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class KPIConditionalFormattingOptionUnmarshaller : IJsonUnmarshaller<KPIConditionalFormattingOption, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public KPIConditionalFormattingOption Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ComparisonValue", targetDepth))
                {
                    ...
                    unmarshalledObject.ComparisonValue = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
