...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class KPIConfigurationUnmarshaller : IJsonUnmarshaller<KPIConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public KPIConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("KPIOptions", targetDepth))
                {
                    ...
                    unmarshalledObject.KPIOptions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
