...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class KPIVisualLayoutOptionsUnmarshaller : IJsonUnmarshaller<KPIVisualLayoutOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public KPIVisualLayoutOptions Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("StandardLayout", targetDepth))
                {
                    ...
                    unmarshalledObject.StandardLayout = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
