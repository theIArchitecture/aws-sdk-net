...
{
    /// <summary>
    /// Response Unmarshaller for KPIVisual Object
    /// </summary>  
    public class KPIVisualUnmarshaller : IJsonUnmarshaller<KPIVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public KPIVisual Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = KPIConfigurationUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = KPIConditionalFormattingUnmarshaller.Instance;
        ...
        private static KPIVisualUnmarshaller _instance = new KPIVisualUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static KPIVisualUnmarshaller Instance
        {
            get
            {
                return _instance;
