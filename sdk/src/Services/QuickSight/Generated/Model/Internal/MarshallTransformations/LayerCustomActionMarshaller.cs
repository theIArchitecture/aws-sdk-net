...
{
    /// <summary>
    /// LayerCustomAction Marshaller
    /// </summary>
    public class LayerCustomActionMarshaller : IRequestMarshaller<LayerCustomAction, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(LayerCustomAction requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetActionOperations())
            {
                ...
                foreach(var requestObjectActionOperationsListValue in requestObject.ActionOperations)
                {
                    ...
                    var marshaller = LayerCustomActionOperationMarshaller.Instance;
        ...
        /// </summary>
        public readonly static LayerCustomActionMarshaller Instance = new LayerCustomActionMarshaller();
