...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LegendOptionsUnmarshaller : IJsonUnmarshaller<LegendOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LegendOptions Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ValueFontConfiguration", targetDepth))
                {
                    var unmarshaller = FontConfigurationUnmarshaller.Instance;
                    unmarshalledObject.ValueFontConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
