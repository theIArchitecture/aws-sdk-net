...
{
    /// <summary>
    /// LineChartVisual Marshaller
    /// </summary>
    public class LineChartVisualMarshaller : IRequestMarshaller<LineChartVisual, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(LineChartVisual requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetChartConfiguration())
            {
                ...
                var marshaller = LineChartConfigurationMarshaller.Instance;
        ...
        /// </summary>
        public readonly static LineChartVisualMarshaller Instance = new LineChartVisualMarshaller();
