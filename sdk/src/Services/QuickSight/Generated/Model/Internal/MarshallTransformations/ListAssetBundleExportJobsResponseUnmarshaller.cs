...
{
    /// <summary>
    /// Response Unmarshaller for ListAssetBundleExportJobs operation
    /// </summary>  
    public class ListAssetBundleExportJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAssetBundleExportJobsResponse response = new ListAssetBundleExportJobsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AssetBundleExportJobSummary, AssetBundleExportJobSummaryUnmarshaller>(AssetBundleExportJobSummaryUnmarshaller.Instance);
                    response.AssetBundleExportJobSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListAssetBundleExportJobsResponseUnmarshaller _instance = new ListAssetBundleExportJobsResponseUnmarshaller();        

        internal static ListAssetBundleExportJobsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAssetBundleExportJobsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
