...
{
    /// <summary>
    /// ListControlDisplayOptions Marshaller
    /// </summary>
    public class ListControlDisplayOptionsMarshaller : IRequestMarshaller<ListControlDisplayOptions, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(ListControlDisplayOptions requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetSearchOptions())
            {
                ...
                var marshaller = ListControlSearchOptionsMarshaller.Instance;
            ...
            if(requestObject.IsSetSelectAllOptions())
            {
                ...
                var marshaller = ListControlSelectAllOptionsMarshaller.Instance;
                marshaller.Marshall(requestObject.SelectAllOptions, context);
        ...
        /// </summary>
        public readonly static ListControlDisplayOptionsMarshaller Instance = new ListControlDisplayOptionsMarshaller();
