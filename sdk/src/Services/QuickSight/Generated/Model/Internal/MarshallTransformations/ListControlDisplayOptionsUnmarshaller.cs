...
{
    /// <summary>
    /// Response Unmarshaller for ListControlDisplayOptions Object
    /// </summary>  
    public class ListControlDisplayOptionsUnmarshaller : IJsonUnmarshaller<ListControlDisplayOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ListControlDisplayOptions Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ListControlDisplayOptions unmarshalledObject = new ListControlDisplayOptions();
        ...
        private static ListControlDisplayOptionsUnmarshaller _instance = new ListControlDisplayOptionsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ListControlDisplayOptionsUnmarshaller Instance
        {
            get
            {
                return _instance;
