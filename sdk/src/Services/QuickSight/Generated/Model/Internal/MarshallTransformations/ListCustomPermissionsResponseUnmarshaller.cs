...
{
    /// <summary>
    /// Response Unmarshaller for ListCustomPermissions operation
    /// </summary>  
    public class ListCustomPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListCustomPermissionsResponse response = new ListCustomPermissionsResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("CustomPermissionsList", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<CustomPermissions, CustomPermissionsUnmarshaller>(CustomPermissionsUnmarshaller.Instance);
                    response.CustomPermissionsList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListCustomPermissionsResponseUnmarshaller _instance = new ListCustomPermissionsResponseUnmarshaller();        

        internal static ListCustomPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCustomPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
