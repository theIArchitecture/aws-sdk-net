    ...
    public class ListDashboardVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DashboardVersionSummary, DashboardVersionSummaryUnmarshaller>(DashboardVersionSummaryUnmarshaller.Instance);
                    response.DashboardVersionSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
