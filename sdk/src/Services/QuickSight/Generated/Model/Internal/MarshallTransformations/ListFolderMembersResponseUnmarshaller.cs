...
{
    /// <summary>
    /// Response Unmarshaller for ListFolderMembers operation
    /// </summary>  
    public class ListFolderMembersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListFolderMembersResponse response = new ListFolderMembersResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<MemberIdArnPair, MemberIdArnPairUnmarshaller>(MemberIdArnPairUnmarshaller.Instance);
                    response.FolderMemberList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListFolderMembersResponseUnmarshaller _instance = new ListFolderMembersResponseUnmarshaller();        

        internal static ListFolderMembersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFolderMembersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
