...
{
    /// <summary>
    /// Response Unmarshaller for ListFoldersForResource operation
    /// </summary>  
    public class ListFoldersForResourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListFoldersForResourceResponse response = new ListFoldersForResourceResponse();
        ...
        private static ListFoldersForResourceResponseUnmarshaller _instance = new ListFoldersForResourceResponseUnmarshaller();        

        internal static ListFoldersForResourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFoldersForResourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
