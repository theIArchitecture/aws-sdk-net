...
{
    /// <summary>
    /// Response Unmarshaller for ListFolders operation
    /// </summary>  
    public class ListFoldersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListFoldersResponseUnmarshaller _instance = new ListFoldersResponseUnmarshaller();        

        internal static ListFoldersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFoldersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
