    ...
    public class ListGroupMembershipsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<GroupMember, GroupMemberUnmarshaller>(GroupMemberUnmarshaller.Instance);
                    response.GroupMemberList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
