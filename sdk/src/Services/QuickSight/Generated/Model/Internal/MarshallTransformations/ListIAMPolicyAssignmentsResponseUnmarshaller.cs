    ...
    public class ListIAMPolicyAssignmentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<IAMPolicyAssignmentSummary, IAMPolicyAssignmentSummaryUnmarshaller>(IAMPolicyAssignmentSummaryUnmarshaller.Instance);
                    response.IAMPolicyAssignments = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
