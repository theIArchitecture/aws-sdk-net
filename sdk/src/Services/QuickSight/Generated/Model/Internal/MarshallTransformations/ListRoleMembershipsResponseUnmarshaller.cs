...
{
    /// <summary>
    /// Response Unmarshaller for ListRoleMemberships operation
    /// </summary>  
    public class ListRoleMembershipsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListRoleMembershipsResponse response = new ListRoleMembershipsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("MembersList", targetDepth))
                {
                    ...
                    response.MembersList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListRoleMembershipsResponseUnmarshaller _instance = new ListRoleMembershipsResponseUnmarshaller();        

        internal static ListRoleMembershipsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRoleMembershipsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
