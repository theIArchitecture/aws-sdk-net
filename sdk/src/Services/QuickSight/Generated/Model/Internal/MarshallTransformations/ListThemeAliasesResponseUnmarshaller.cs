    ...
    public class ListThemeAliasesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ThemeAlias, ThemeAliasUnmarshaller>(ThemeAliasUnmarshaller.Instance);
                    response.ThemeAliasList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
