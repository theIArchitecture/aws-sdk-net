    ...
    public class ListThemeVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ThemeVersionSummary, ThemeVersionSummaryUnmarshaller>(ThemeVersionSummaryUnmarshaller.Instance);
                    response.ThemeVersionSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
