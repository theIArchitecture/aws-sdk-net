    ...
    public class ListThemesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ThemeSummary, ThemeSummaryUnmarshaller>(ThemeSummaryUnmarshaller.Instance);
                    response.ThemeSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
