    ...
    public class ListVPCConnectionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<VPCConnectionSummary, VPCConnectionSummaryUnmarshaller>(VPCConnectionSummaryUnmarshaller.Instance);
                    response.VPCConnectionSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
