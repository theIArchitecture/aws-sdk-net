...
{
    /// <summary>
    /// Response Unmarshaller for NumericEqualityFilter Object
    /// </summary>  
    public class NumericEqualityFilterUnmarshaller : IJsonUnmarshaller<NumericEqualityFilter, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NumericEqualityFilter Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static NumericEqualityFilterUnmarshaller _instance = new NumericEqualityFilterUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static NumericEqualityFilterUnmarshaller Instance
        {
            get
            {
                return _instance;
