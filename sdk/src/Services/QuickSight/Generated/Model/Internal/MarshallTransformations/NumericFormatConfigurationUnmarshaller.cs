...
{
    /// <summary>
    /// Response Unmarshaller for NumericFormatConfiguration Object
    /// </summary>  
    public class NumericFormatConfigurationUnmarshaller : IJsonUnmarshaller<NumericFormatConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NumericFormatConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = CurrencyDisplayFormatConfigurationUnmarshaller.Instance;
                    unmarshalledObject.CurrencyDisplayFormatConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static NumericFormatConfigurationUnmarshaller _instance = new NumericFormatConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static NumericFormatConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
