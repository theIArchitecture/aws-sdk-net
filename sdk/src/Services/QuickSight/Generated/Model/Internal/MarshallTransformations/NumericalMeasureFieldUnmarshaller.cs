...
{
    /// <summary>
    /// Response Unmarshaller for NumericalMeasureField Object
    /// </summary>  
    public class NumericalMeasureFieldUnmarshaller : IJsonUnmarshaller<NumericalMeasureField, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NumericalMeasureField Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            NumericalMeasureField unmarshalledObject = new NumericalMeasureField();
        ...
        private static NumericalMeasureFieldUnmarshaller _instance = new NumericalMeasureFieldUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static NumericalMeasureFieldUnmarshaller Instance
        {
            get
            {
                return _instance;
