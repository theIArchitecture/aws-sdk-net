...
{
    /// <summary>
    /// PieChartVisual Marshaller
    /// </summary>
    public class PieChartVisualMarshaller : IRequestMarshaller<PieChartVisual, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(PieChartVisual requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetChartConfiguration())
            {
                ...
                var marshaller = PieChartConfigurationMarshaller.Instance;
        ...
        /// </summary>
        public readonly static PieChartVisualMarshaller Instance = new PieChartVisualMarshaller();
