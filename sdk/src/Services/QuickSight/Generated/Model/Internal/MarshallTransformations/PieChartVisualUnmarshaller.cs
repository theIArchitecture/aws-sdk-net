...
{
    /// <summary>
    /// Response Unmarshaller for PieChartVisual Object
    /// </summary>  
    public class PieChartVisualUnmarshaller : IJsonUnmarshaller<PieChartVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PieChartVisual Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            PieChartVisual unmarshalledObject = new PieChartVisual();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = PieChartConfigurationUnmarshaller.Instance;
        ...
        private static PieChartVisualUnmarshaller _instance = new PieChartVisualUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PieChartVisualUnmarshaller Instance
        {
            get
            {
                return _instance;
