...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    public class PivotTableTotalOptionsUnmarshaller : IJsonUnmarshaller<PivotTableTotalOptions, JsonUnmarshallerContext>
    {
        ...
        private static PivotTableTotalOptionsUnmarshaller _instance = new PivotTableTotalOptionsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PivotTableTotalOptionsUnmarshaller Instance
        {
            get
            {
                return _instance;
