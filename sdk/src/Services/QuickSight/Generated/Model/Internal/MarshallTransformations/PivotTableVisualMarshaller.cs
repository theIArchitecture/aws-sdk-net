...
{
    /// <summary>
    /// PivotTableVisual Marshaller
    /// </summary>
    public class PivotTableVisualMarshaller : IRequestMarshaller<PivotTableVisual, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(PivotTableVisual requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetChartConfiguration())
            {
                ...
                var marshaller = PivotTableConfigurationMarshaller.Instance;
            ...
            if(requestObject.IsSetConditionalFormatting())
            {
                ...
                var marshaller = PivotTableConditionalFormattingMarshaller.Instance;
        ...
        /// </summary>
        public readonly static PivotTableVisualMarshaller Instance = new PivotTableVisualMarshaller();
