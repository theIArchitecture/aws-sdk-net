...
{
    /// <summary>
    /// Response Unmarshaller for PivotTotalOptions Object
    /// </summary>  
    public class PivotTotalOptionsUnmarshaller : IJsonUnmarshaller<PivotTotalOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PivotTotalOptions Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static PivotTotalOptionsUnmarshaller _instance = new PivotTotalOptionsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PivotTotalOptionsUnmarshaller Instance
        {
            get
            {
                return _instance;
