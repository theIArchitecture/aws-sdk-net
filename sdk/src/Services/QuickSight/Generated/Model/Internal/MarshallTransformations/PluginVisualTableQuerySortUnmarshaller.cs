...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    public class PluginVisualTableQuerySortUnmarshaller : IJsonUnmarshaller<PluginVisualTableQuerySort, JsonUnmarshallerContext>
    {
        ...
        private static PluginVisualTableQuerySortUnmarshaller _instance = new PluginVisualTableQuerySortUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PluginVisualTableQuerySortUnmarshaller Instance
        {
            get
            {
                return _instance;
