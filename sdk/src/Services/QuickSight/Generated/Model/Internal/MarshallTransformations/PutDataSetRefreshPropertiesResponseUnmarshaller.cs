...
{
    /// <summary>
    /// Response Unmarshaller for PutDataSetRefreshProperties operation
    /// </summary>  
    public class PutDataSetRefreshPropertiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutDataSetRefreshPropertiesResponse response = new PutDataSetRefreshPropertiesResponse();
        ...
        private static PutDataSetRefreshPropertiesResponseUnmarshaller _instance = new PutDataSetRefreshPropertiesResponseUnmarshaller();        

        internal static PutDataSetRefreshPropertiesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutDataSetRefreshPropertiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
