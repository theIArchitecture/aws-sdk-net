...
{
    /// <summary>
    /// RadarChartVisual Marshaller
    /// </summary>
    public class RadarChartVisualMarshaller : IRequestMarshaller<RadarChartVisual, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(RadarChartVisual requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetChartConfiguration())
            {
                ...
                var marshaller = RadarChartConfigurationMarshaller.Instance;
        ...
        /// </summary>
        public readonly static RadarChartVisualMarshaller Instance = new RadarChartVisualMarshaller();
