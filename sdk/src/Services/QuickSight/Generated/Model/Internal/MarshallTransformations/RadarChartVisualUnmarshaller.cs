...
{
    /// <summary>
    /// Response Unmarshaller for RadarChartVisual Object
    /// </summary>  
    public class RadarChartVisualUnmarshaller : IJsonUnmarshaller<RadarChartVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RadarChartVisual Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            RadarChartVisual unmarshalledObject = new RadarChartVisual();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = RadarChartConfigurationUnmarshaller.Instance;
        ...
        private static RadarChartVisualUnmarshaller _instance = new RadarChartVisualUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RadarChartVisualUnmarshaller Instance
        {
            get
            {
                return _instance;
