...
{
    /// <summary>
    /// Response Unmarshaller for ReferenceLineDataConfiguration Object
    /// </summary>  
    public class ReferenceLineDataConfigurationUnmarshaller : IJsonUnmarshaller<ReferenceLineDataConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ReferenceLineDataConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ReferenceLineDataConfiguration unmarshalledObject = new ReferenceLineDataConfiguration();
        ...
        private static ReferenceLineDataConfigurationUnmarshaller _instance = new ReferenceLineDataConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ReferenceLineDataConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
