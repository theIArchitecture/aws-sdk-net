...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    public class ReferenceLineLabelConfigurationUnmarshaller : IJsonUnmarshaller<ReferenceLineLabelConfiguration, JsonUnmarshallerContext>
    {
        ...
        private static ReferenceLineLabelConfigurationUnmarshaller _instance = new ReferenceLineLabelConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ReferenceLineLabelConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
