...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class S3ParametersUnmarshaller : IJsonUnmarshaller<S3Parameters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public S3Parameters Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ManifestFileLocation", targetDepth))
                {
                    ...
                    unmarshalledObject.ManifestFileLocation = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
