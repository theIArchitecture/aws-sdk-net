...
{
    /// <summary>
    /// Response Unmarshaller for SankeyDiagramVisual Object
    /// </summary>  
    public class SankeyDiagramVisualUnmarshaller : IJsonUnmarshaller<SankeyDiagramVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SankeyDiagramVisual Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            SankeyDiagramVisual unmarshalledObject = new SankeyDiagramVisual();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = SankeyDiagramChartConfigurationUnmarshaller.Instance;
        ...
        private static SankeyDiagramVisualUnmarshaller _instance = new SankeyDiagramVisualUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SankeyDiagramVisualUnmarshaller Instance
        {
            get
            {
                return _instance;
