...
{
    /// <summary>
    /// Response Unmarshaller for ScatterPlotFieldWells Object
    /// </summary>  
    public class ScatterPlotFieldWellsUnmarshaller : IJsonUnmarshaller<ScatterPlotFieldWells, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ScatterPlotFieldWells Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ScatterPlotFieldWells unmarshalledObject = new ScatterPlotFieldWells();
        ...
        private static ScatterPlotFieldWellsUnmarshaller _instance = new ScatterPlotFieldWellsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ScatterPlotFieldWellsUnmarshaller Instance
        {
            get
            {
                return _instance;
