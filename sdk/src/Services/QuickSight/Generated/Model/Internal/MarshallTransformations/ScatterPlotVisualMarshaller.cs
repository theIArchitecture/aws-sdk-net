...
{
    /// <summary>
    /// ScatterPlotVisual Marshaller
    /// </summary>
    public class ScatterPlotVisualMarshaller : IRequestMarshaller<ScatterPlotVisual, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(ScatterPlotVisual requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetChartConfiguration())
            {
                ...
                var marshaller = ScatterPlotConfigurationMarshaller.Instance;
        ...
        /// </summary>
        public readonly static ScatterPlotVisualMarshaller Instance = new ScatterPlotVisualMarshaller();
