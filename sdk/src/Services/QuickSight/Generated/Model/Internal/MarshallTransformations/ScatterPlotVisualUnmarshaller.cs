...
{
    /// <summary>
    /// Response Unmarshaller for ScatterPlotVisual Object
    /// </summary>  
    public class ScatterPlotVisualUnmarshaller : IJsonUnmarshaller<ScatterPlotVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ScatterPlotVisual Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = ScatterPlotConfigurationUnmarshaller.Instance;
        ...
        private static ScatterPlotVisualUnmarshaller _instance = new ScatterPlotVisualUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ScatterPlotVisualUnmarshaller Instance
        {
            get
            {
                return _instance;
