...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ScrollBarOptionsUnmarshaller : IJsonUnmarshaller<ScrollBarOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ScrollBarOptions Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("VisibleRange", targetDepth))
                {
                    ...
                    unmarshalledObject.VisibleRange = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
