...
{
    /// <summary>
    /// Response Unmarshaller for SearchDataSets operation
    /// </summary>  
    public class SearchDataSetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static SearchDataSetsResponseUnmarshaller _instance = new SearchDataSetsResponseUnmarshaller();        

        internal static SearchDataSetsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchDataSetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
