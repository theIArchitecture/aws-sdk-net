...
{
    /// <summary>
    /// Response Unmarshaller for SearchDataSources operation
    /// </summary>  
    public class SearchDataSourcesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchDataSourcesResponse response = new SearchDataSourcesResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("DataSourceSummaries", targetDepth))
                {
                    ...
                    response.DataSourceSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static SearchDataSourcesResponseUnmarshaller _instance = new SearchDataSourcesResponseUnmarshaller();        

        internal static SearchDataSourcesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchDataSourcesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
