...
{
    /// <summary>
    /// Response Unmarshaller for SearchFolders operation
    /// </summary>  
    public class SearchFoldersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<FolderSummary, FolderSummaryUnmarshaller>(FolderSummaryUnmarshaller.Instance);
                    response.FolderSummaryList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static SearchFoldersResponseUnmarshaller _instance = new SearchFoldersResponseUnmarshaller();        

        internal static SearchFoldersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchFoldersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
