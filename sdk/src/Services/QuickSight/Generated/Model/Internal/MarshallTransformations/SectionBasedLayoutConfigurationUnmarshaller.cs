...
{
    /// <summary>
    /// Response Unmarshaller for SectionBasedLayoutConfiguration Object
    /// </summary>  
    public class SectionBasedLayoutConfigurationUnmarshaller : IJsonUnmarshaller<SectionBasedLayoutConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SectionBasedLayoutConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            SectionBasedLayoutConfiguration unmarshalledObject = new SectionBasedLayoutConfiguration();
        ...
        private static SectionBasedLayoutConfigurationUnmarshaller _instance = new SectionBasedLayoutConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SectionBasedLayoutConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
