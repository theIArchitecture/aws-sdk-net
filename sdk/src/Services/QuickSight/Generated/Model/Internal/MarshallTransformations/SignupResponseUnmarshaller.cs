...
{
    /// <summary>
    /// Response Unmarshaller for SignupResponse Object
    /// </summary>  
    public class SignupResponseUnmarshaller : IJsonUnmarshaller<SignupResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SignupResponse Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.UserLoginName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
