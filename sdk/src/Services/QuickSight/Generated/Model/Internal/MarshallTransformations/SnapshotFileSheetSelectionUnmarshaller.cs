...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SnapshotFileSheetSelectionUnmarshaller : IJsonUnmarshaller<SnapshotFileSheetSelection, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SnapshotFileSheetSelection Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("SelectionScope", targetDepth))
                {
                    ...
                    unmarshalledObject.SelectionScope = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
