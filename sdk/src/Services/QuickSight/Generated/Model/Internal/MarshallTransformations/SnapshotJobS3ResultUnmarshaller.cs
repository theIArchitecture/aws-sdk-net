...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SnapshotJobS3ResultUnmarshaller : IJsonUnmarshaller<SnapshotJobS3Result, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SnapshotJobS3Result Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SnapshotJobResultErrorInfo, SnapshotJobResultErrorInfoUnmarshaller>(SnapshotJobResultErrorInfoUnmarshaller.Instance);
