...
{
    /// <summary>
    /// Response Unmarshaller for Spacing Object
    /// </summary>  
    public class SpacingUnmarshaller : IJsonUnmarshaller<Spacing, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Spacing Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            Spacing unmarshalledObject = new Spacing();
        ...
        private static SpacingUnmarshaller _instance = new SpacingUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SpacingUnmarshaller Instance
        {
            get
            {
                return _instance;
