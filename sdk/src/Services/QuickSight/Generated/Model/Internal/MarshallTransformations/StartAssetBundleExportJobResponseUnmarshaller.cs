...
{
    /// <summary>
    /// Response Unmarshaller for StartAssetBundleExportJob operation
    /// </summary>  
    public class StartAssetBundleExportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartAssetBundleExportJobResponse response = new StartAssetBundleExportJobResponse();
        ...
        private static StartAssetBundleExportJobResponseUnmarshaller _instance = new StartAssetBundleExportJobResponseUnmarshaller();        

        internal static StartAssetBundleExportJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartAssetBundleExportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
