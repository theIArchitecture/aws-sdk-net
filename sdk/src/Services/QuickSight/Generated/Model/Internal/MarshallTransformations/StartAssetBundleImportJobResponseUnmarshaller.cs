...
{
    /// <summary>
    /// Response Unmarshaller for StartAssetBundleImportJob operation
    /// </summary>  
    public class StartAssetBundleImportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartAssetBundleImportJobResponse response = new StartAssetBundleImportJobResponse();
        ...
        private static StartAssetBundleImportJobResponseUnmarshaller _instance = new StartAssetBundleImportJobResponseUnmarshaller();        

        internal static StartAssetBundleImportJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartAssetBundleImportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
