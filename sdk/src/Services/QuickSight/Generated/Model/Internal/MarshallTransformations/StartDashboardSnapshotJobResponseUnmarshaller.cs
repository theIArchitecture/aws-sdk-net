...
{
    /// <summary>
    /// Response Unmarshaller for StartDashboardSnapshotJob operation
    /// </summary>  
    public class StartDashboardSnapshotJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartDashboardSnapshotJobResponse response = new StartDashboardSnapshotJobResponse();
        ...
        private static StartDashboardSnapshotJobResponseUnmarshaller _instance = new StartDashboardSnapshotJobResponseUnmarshaller();        

        internal static StartDashboardSnapshotJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartDashboardSnapshotJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
