...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TableBorderOptionsUnmarshaller : IJsonUnmarshaller<TableBorderOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TableBorderOptions Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Thickness", targetDepth))
                {
                    ...
                    unmarshalledObject.Thickness = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
