...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    public class TablePaginatedReportOptionsUnmarshaller : IJsonUnmarshaller<TablePaginatedReportOptions, JsonUnmarshallerContext>
    {
        ...
        private static TablePaginatedReportOptionsUnmarshaller _instance = new TablePaginatedReportOptionsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TablePaginatedReportOptionsUnmarshaller Instance
        {
            get
            {
                return _instance;
