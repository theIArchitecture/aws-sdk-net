...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TablePinnedFieldOptionsUnmarshaller : IJsonUnmarshaller<TablePinnedFieldOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TablePinnedFieldOptions Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("PinnedLeftFields", targetDepth))
                {
                    ...
                    unmarshalledObject.PinnedLeftFields = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
