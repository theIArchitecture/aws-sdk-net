...
{
    /// <summary>
    /// TableVisual Marshaller
    /// </summary>
    public class TableVisualMarshaller : IRequestMarshaller<TableVisual, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(TableVisual requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetChartConfiguration())
            {
                ...
                var marshaller = TableConfigurationMarshaller.Instance;
            ...
            if(requestObject.IsSetConditionalFormatting())
            {
                ...
                var marshaller = TableConditionalFormattingMarshaller.Instance;
        ...
        /// </summary>
        public readonly static TableVisualMarshaller Instance = new TableVisualMarshaller();
