...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TemplateAliasUnmarshaller : IJsonUnmarshaller<TemplateAlias, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TemplateAlias Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("TemplateVersionNumber", targetDepth))
                {
                    ...
                    unmarshalledObject.TemplateVersionNumber = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
