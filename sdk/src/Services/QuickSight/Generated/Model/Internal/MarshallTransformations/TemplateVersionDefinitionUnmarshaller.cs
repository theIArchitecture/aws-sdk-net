...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    public class TemplateVersionDefinitionUnmarshaller : IJsonUnmarshaller<TemplateVersionDefinition, JsonUnmarshallerContext>
    {
        ...
        private static TemplateVersionDefinitionUnmarshaller _instance = new TemplateVersionDefinitionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TemplateVersionDefinitionUnmarshaller Instance
        {
            get
            {
                return _instance;
