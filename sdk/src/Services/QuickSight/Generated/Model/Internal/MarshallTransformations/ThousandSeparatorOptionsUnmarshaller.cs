...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ThousandSeparatorOptionsUnmarshaller : IJsonUnmarshaller<ThousandSeparatorOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ThousandSeparatorOptions Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("GroupingStyle", targetDepth))
                {
                    ...
                    unmarshalledObject.GroupingStyle = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
