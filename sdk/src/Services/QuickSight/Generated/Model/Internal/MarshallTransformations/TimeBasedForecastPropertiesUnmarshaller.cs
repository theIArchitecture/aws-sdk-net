...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    public class TimeBasedForecastPropertiesUnmarshaller : IJsonUnmarshaller<TimeBasedForecastProperties, JsonUnmarshallerContext>
    {
        ...
        private static TimeBasedForecastPropertiesUnmarshaller _instance = new TimeBasedForecastPropertiesUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TimeBasedForecastPropertiesUnmarshaller Instance
        {
            get
            {
                return _instance;
