...
{
    /// <summary>
    /// Response Unmarshaller for TimeEqualityFilter Object
    /// </summary>  
    public class TimeEqualityFilterUnmarshaller : IJsonUnmarshaller<TimeEqualityFilter, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TimeEqualityFilter Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static TimeEqualityFilterUnmarshaller _instance = new TimeEqualityFilterUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TimeEqualityFilterUnmarshaller Instance
        {
            get
            {
                return _instance;
