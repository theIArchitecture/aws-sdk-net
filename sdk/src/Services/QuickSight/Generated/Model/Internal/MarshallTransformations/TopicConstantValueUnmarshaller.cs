...
{
    /// <summary>
    /// Response Unmarshaller for TopicConstantValue Object
    /// </summary>  
    public class TopicConstantValueUnmarshaller : IJsonUnmarshaller<TopicConstantValue, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TopicConstantValue Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            TopicConstantValue unmarshalledObject = new TopicConstantValue();
        ...
        private static TopicConstantValueUnmarshaller _instance = new TopicConstantValueUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TopicConstantValueUnmarshaller Instance
        {
            get
            {
                return _instance;
