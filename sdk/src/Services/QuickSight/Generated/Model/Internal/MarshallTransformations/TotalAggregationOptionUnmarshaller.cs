...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TotalAggregationOptionUnmarshaller : IJsonUnmarshaller<TotalAggregationOption, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TotalAggregationOption Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("TotalAggregationFunction", targetDepth))
                {
                    ...
                    unmarshalledObject.TotalAggregationFunction = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
