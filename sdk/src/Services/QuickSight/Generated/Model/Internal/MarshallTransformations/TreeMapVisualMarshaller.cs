...
{
    /// <summary>
    /// TreeMapVisual Marshaller
    /// </summary>
    public class TreeMapVisualMarshaller : IRequestMarshaller<TreeMapVisual, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(TreeMapVisual requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetChartConfiguration())
            {
                ...
                var marshaller = TreeMapConfigurationMarshaller.Instance;
        ...
        /// </summary>
        public readonly static TreeMapVisualMarshaller Instance = new TreeMapVisualMarshaller();
