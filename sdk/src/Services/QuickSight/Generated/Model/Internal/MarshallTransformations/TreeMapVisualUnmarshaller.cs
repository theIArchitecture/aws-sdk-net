...
{
    /// <summary>
    /// Response Unmarshaller for TreeMapVisual Object
    /// </summary>  
    public class TreeMapVisualUnmarshaller : IJsonUnmarshaller<TreeMapVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TreeMapVisual Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            TreeMapVisual unmarshalledObject = new TreeMapVisual();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = TreeMapConfigurationUnmarshaller.Instance;
        ...
        private static TreeMapVisualUnmarshaller _instance = new TreeMapVisualUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TreeMapVisualUnmarshaller Instance
        {
            get
            {
                return _instance;
