...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TypographyUnmarshaller : IJsonUnmarshaller<Typography, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            Typography unmarshalledObject = new Typography();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TypographyUnmarshaller Instance
        {
            get
            {
                return _instance;
