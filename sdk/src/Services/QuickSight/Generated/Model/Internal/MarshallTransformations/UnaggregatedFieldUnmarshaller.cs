...
{
    /// <summary>
    /// Response Unmarshaller for UnaggregatedField Object
    /// </summary>  
    public class UnaggregatedFieldUnmarshaller : IJsonUnmarshaller<UnaggregatedField, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public UnaggregatedField Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            UnaggregatedField unmarshalledObject = new UnaggregatedField();
        ...
        private static UnaggregatedFieldUnmarshaller _instance = new UnaggregatedFieldUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static UnaggregatedFieldUnmarshaller Instance
        {
            get
            {
                return _instance;
