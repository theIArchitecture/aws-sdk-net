...
{
    /// <summary>
    /// Response Unmarshaller for UpdateCustomPermissions operation
    /// </summary>  
    public class UpdateCustomPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateCustomPermissionsResponse response = new UpdateCustomPermissionsResponse();
        ...
        private static UpdateCustomPermissionsResponseUnmarshaller _instance = new UpdateCustomPermissionsResponseUnmarshaller();        

        internal static UpdateCustomPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCustomPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
