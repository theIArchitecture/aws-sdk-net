...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDashboardLinks operation
    /// </summary>  
    public class UpdateDashboardLinksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDashboardLinksResponse response = new UpdateDashboardLinksResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("LinkEntities", targetDepth))
                {
                    ...
                    response.LinkEntities = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateDashboardLinksResponseUnmarshaller _instance = new UpdateDashboardLinksResponseUnmarshaller();        

        internal static UpdateDashboardLinksResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDashboardLinksResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
