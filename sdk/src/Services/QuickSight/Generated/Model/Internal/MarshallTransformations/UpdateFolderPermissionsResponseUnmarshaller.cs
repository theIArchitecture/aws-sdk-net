...
{
    /// <summary>
    /// Response Unmarshaller for UpdateFolderPermissions operation
    /// </summary>  
    public class UpdateFolderPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateFolderPermissionsResponse response = new UpdateFolderPermissionsResponse();
        ...
        private static UpdateFolderPermissionsResponseUnmarshaller _instance = new UpdateFolderPermissionsResponseUnmarshaller();        

        internal static UpdateFolderPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFolderPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
