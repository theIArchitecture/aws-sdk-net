...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRoleCustomPermission operation
    /// </summary>  
    public class UpdateRoleCustomPermissionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateRoleCustomPermissionResponse response = new UpdateRoleCustomPermissionResponse();
        ...
        private static UpdateRoleCustomPermissionResponseUnmarshaller _instance = new UpdateRoleCustomPermissionResponseUnmarshaller();        

        internal static UpdateRoleCustomPermissionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRoleCustomPermissionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
