...
{
    /// <summary>
    /// UpdateTopicPermissions Request Marshaller
    /// </summary>       
    public class UpdateTopicPermissionsRequestMarshaller : IMarshaller<IRequest, UpdateTopicPermissionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateTopicPermissionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateTopicPermissionsRequest publicRequest)
        {
        ...
        private static UpdateTopicPermissionsRequestMarshaller _instance = new UpdateTopicPermissionsRequestMarshaller();        

        internal static UpdateTopicPermissionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTopicPermissionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
