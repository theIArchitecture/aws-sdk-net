...
{
    /// <summary>
    /// Response Unmarshaller for UpdateTopicPermissions operation
    /// </summary>  
    public class UpdateTopicPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateTopicPermissionsResponse response = new UpdateTopicPermissionsResponse();
        ...
        private static UpdateTopicPermissionsResponseUnmarshaller _instance = new UpdateTopicPermissionsResponseUnmarshaller();        

        internal static UpdateTopicPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTopicPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
