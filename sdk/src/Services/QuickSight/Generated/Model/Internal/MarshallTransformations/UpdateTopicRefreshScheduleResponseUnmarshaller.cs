...
{
    /// <summary>
    /// Response Unmarshaller for UpdateTopicRefreshSchedule operation
    /// </summary>  
    public class UpdateTopicRefreshScheduleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateTopicRefreshScheduleResponse response = new UpdateTopicRefreshScheduleResponse();
        ...
        private static UpdateTopicRefreshScheduleResponseUnmarshaller _instance = new UpdateTopicRefreshScheduleResponseUnmarshaller();        

        internal static UpdateTopicRefreshScheduleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTopicRefreshScheduleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
