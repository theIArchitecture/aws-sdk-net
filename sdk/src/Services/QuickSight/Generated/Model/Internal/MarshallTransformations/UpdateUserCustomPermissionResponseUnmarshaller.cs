...
{
    /// <summary>
    /// Response Unmarshaller for UpdateUserCustomPermission operation
    /// </summary>  
    public class UpdateUserCustomPermissionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateUserCustomPermissionResponse response = new UpdateUserCustomPermissionResponse();
        ...
        private static UpdateUserCustomPermissionResponseUnmarshaller _instance = new UpdateUserCustomPermissionResponseUnmarshaller();        

        internal static UpdateUserCustomPermissionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateUserCustomPermissionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
