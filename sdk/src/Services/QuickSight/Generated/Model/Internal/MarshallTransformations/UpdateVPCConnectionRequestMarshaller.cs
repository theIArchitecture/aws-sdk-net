...
{
    /// <summary>
    /// UpdateVPCConnection Request Marshaller
    /// </summary>       
    public class UpdateVPCConnectionRequestMarshaller : IMarshaller<IRequest, UpdateVPCConnectionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateVPCConnectionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateVPCConnectionRequest publicRequest)
        {
        ...
        private static UpdateVPCConnectionRequestMarshaller _instance = new UpdateVPCConnectionRequestMarshaller();        

        internal static UpdateVPCConnectionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateVPCConnectionRequestMarshaller Instance
        {
            get
            {
                return _instance;
