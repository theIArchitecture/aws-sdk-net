...
{
    /// <summary>
    /// Response Unmarshaller for UpdateVPCConnection operation
    /// </summary>  
    public class UpdateVPCConnectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateVPCConnectionResponse response = new UpdateVPCConnectionResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AvailabilityStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.VPCConnectionId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateVPCConnectionResponseUnmarshaller _instance = new UpdateVPCConnectionResponseUnmarshaller();        

        internal static UpdateVPCConnectionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateVPCConnectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
