...
{
    /// <summary>
    /// Response Unmarshaller for VPCConnection Object
    /// </summary>  
    public class VPCConnectionUnmarshaller : IJsonUnmarshaller<VPCConnection, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public VPCConnection Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            VPCConnection unmarshalledObject = new VPCConnection();
        ...
        private static VPCConnectionUnmarshaller _instance = new VPCConnectionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static VPCConnectionUnmarshaller Instance
        {
            get
            {
                return _instance;
