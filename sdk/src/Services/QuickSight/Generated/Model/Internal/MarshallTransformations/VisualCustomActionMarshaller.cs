...
{
    /// <summary>
    /// VisualCustomAction Marshaller
    /// </summary>
    public class VisualCustomActionMarshaller : IRequestMarshaller<VisualCustomAction, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(VisualCustomAction requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetActionOperations())
            {
                ...
                foreach(var requestObjectActionOperationsListValue in requestObject.ActionOperations)
                {
                    ...
                    var marshaller = VisualCustomActionOperationMarshaller.Instance;
        ...
        /// </summary>
        public readonly static VisualCustomActionMarshaller Instance = new VisualCustomActionMarshaller();
