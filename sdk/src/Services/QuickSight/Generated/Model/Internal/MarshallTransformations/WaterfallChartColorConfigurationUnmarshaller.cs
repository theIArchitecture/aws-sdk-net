...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class WaterfallChartColorConfigurationUnmarshaller : IJsonUnmarshaller<WaterfallChartColorConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public WaterfallChartColorConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("GroupColorConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.GroupColorConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
