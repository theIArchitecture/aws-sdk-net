...
{
    /// <summary>
    /// WaterfallVisual Marshaller
    /// </summary>
    public class WaterfallVisualMarshaller : IRequestMarshaller<WaterfallVisual, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(WaterfallVisual requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetChartConfiguration())
            {
                ...
                var marshaller = WaterfallChartConfigurationMarshaller.Instance;
        ...
        /// </summary>
        public readonly static WaterfallVisualMarshaller Instance = new WaterfallVisualMarshaller();
