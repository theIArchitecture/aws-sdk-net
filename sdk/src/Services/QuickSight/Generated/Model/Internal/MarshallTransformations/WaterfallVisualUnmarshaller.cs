...
{
    /// <summary>
    /// Response Unmarshaller for WaterfallVisual Object
    /// </summary>  
    public class WaterfallVisualUnmarshaller : IJsonUnmarshaller<WaterfallVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public WaterfallVisual Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            WaterfallVisual unmarshalledObject = new WaterfallVisual();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = WaterfallChartConfigurationUnmarshaller.Instance;
        ...
        private static WaterfallVisualUnmarshaller _instance = new WaterfallVisualUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static WaterfallVisualUnmarshaller Instance
        {
            get
            {
                return _instance;
