...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class WordCloudFieldWellsUnmarshaller : IJsonUnmarshaller<WordCloudFieldWells, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public WordCloudFieldWells Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("WordCloudAggregatedFieldWells", targetDepth))
                {
                    ...
                    unmarshalledObject.WordCloudAggregatedFieldWells = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
