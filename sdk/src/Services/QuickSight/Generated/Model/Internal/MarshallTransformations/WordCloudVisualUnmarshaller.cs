...
{
    /// <summary>
    /// Response Unmarshaller for WordCloudVisual Object
    /// </summary>  
    public class WordCloudVisualUnmarshaller : IJsonUnmarshaller<WordCloudVisual, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public WordCloudVisual Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = WordCloudChartConfigurationUnmarshaller.Instance;
        ...
        private static WordCloudVisualUnmarshaller _instance = new WordCloudVisualUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static WordCloudVisualUnmarshaller Instance
        {
            get
            {
                return _instance;
