...
{
    /// <summary>
    /// This is the response object from the ListFolderMembers operation.
    /// </summary>
    public partial class ListFolderMembersResponse : AmazonWebServiceResponse
    {
        ...
        /// <summary>
        /// Gets and sets the property FolderMemberList. 
        /// <para>
        /// A structure that contains all of the folder members (dashboards, analyses, and datasets)
        /// in the folder.
        /// </para>
        /// <para />
        ...
        /// </summary>
        [AWSProperty(Max=100)]
        public List<MemberIdArnPair> FolderMemberList
        {
            get { return this._folderMemberList; }
            set { this._folderMemberList = value; }
        }
