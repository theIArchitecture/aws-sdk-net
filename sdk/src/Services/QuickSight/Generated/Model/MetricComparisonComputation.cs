...
namespace Amazon.QuickSight.Model
{
    ...
    /// </summary>
    public partial class MetricComparisonComputation
    {
        private string _computationId;
        private MeasureField _fromValue;
        private string _name;
        private MeasureField _targetValue;
        ...
        /// <summary>
        /// Gets and sets the property FromValue. 
        /// <para>
        ...
        public MeasureField FromValue
        {
            ...
            set { this._fromValue = value; }
        }

        // Check to see if FromValue property is set
        internal bool IsSetFromValue()
        {
            return this._fromValue != null;
        }
