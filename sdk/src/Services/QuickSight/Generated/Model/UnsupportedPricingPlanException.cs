...
namespace Amazon.QuickSight.Model
{
    ...
    public partial class UnsupportedPricingPlanException : AmazonQuickSightException
    {
        ...
        public UnsupportedPricingPlanException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public UnsupportedPricingPlanException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
