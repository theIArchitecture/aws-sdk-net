...
{
    /// <summary>
    /// Container for the parameters to the UpdateAccountCustomPermission operation.
    /// Applies a custom permissions profile to an account.
    /// </summary>
    public partial class UpdateAccountCustomPermissionRequest : AmazonQuickSightRequest
    {
        ...
        /// <para>
        /// The ID of the Amazon Web Services account for which you want to apply a custom permissions
        /// profile.
        /// </para>
        /// </summary>
