...
namespace Amazon.QuickSight
{
    ...
    public partial interface IAmazonQuickSight : IAmazonService, IDisposable
    {
        ...
        Task<DeleteAccountCustomPermissionResponse> DeleteAccountCustomPermissionAsync(DeleteAccountCustomPermissionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DescribeAccountCustomPermissionResponse> DescribeAccountCustomPermissionAsync(DescribeAccountCustomPermissionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateAccountCustomPermissionResponse> UpdateAccountCustomPermissionAsync(UpdateAccountCustomPermissionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonQuickSightConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonQuickSightConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonQuickSightConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonQuickSightConfig to create AmazonQuickSightClient");
            }

            return awsCredentials == null ? 
                    new AmazonQuickSightClient(serviceClientConfig) :
                    new AmazonQuickSightClient(awsCredentials, serviceClientConfig);
        }
