...
namespace Amazon.RAM.Internal
{
    ...
    public class AmazonRAMAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonRAMAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for RAM.
        /// </summary>
        public AmazonRAMAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonRAMAuthSchemeParameters
            {
    ...
    public class AmazonRAMAuthSchemeResolver : IAuthSchemeResolver<AmazonRAMAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonRAMAuthSchemeParameters authParameters)
        {
