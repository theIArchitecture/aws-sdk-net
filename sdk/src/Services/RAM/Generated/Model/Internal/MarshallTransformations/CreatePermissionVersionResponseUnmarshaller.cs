...
{
    /// <summary>
    /// Response Unmarshaller for CreatePermissionVersion operation
    /// </summary>  
    public class CreatePermissionVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePermissionVersionResponse response = new CreatePermissionVersionResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("MalformedPolicyTemplateException"))
                {
                    return MalformedPolicyTemplateExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("PermissionVersionsLimitExceededException"))
                {
                    return PermissionVersionsLimitExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static CreatePermissionVersionResponseUnmarshaller _instance = new CreatePermissionVersionResponseUnmarshaller();        

        internal static CreatePermissionVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePermissionVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
