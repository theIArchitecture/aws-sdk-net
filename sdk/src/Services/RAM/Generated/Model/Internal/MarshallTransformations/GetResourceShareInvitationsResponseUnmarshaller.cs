    ...
    public class GetResourceShareInvitationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ResourceShareInvitation, ResourceShareInvitationUnmarshaller>(ResourceShareInvitationUnmarshaller.Instance);
                    response.ResourceShareInvitations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
