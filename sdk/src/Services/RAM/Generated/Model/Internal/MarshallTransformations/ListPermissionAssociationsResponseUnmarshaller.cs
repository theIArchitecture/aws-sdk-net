...
{
    /// <summary>
    /// Response Unmarshaller for ListPermissionAssociations operation
    /// </summary>  
    public class ListPermissionAssociationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListPermissionAssociationsResponse response = new ListPermissionAssociationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AssociatedPermission, AssociatedPermissionUnmarshaller>(AssociatedPermissionUnmarshaller.Instance);
        ...
        private static ListPermissionAssociationsResponseUnmarshaller _instance = new ListPermissionAssociationsResponseUnmarshaller();        

        internal static ListPermissionAssociationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPermissionAssociationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
