...
{
    /// <summary>
    /// Response Unmarshaller for ListReplacePermissionAssociationsWork operation
    /// </summary>  
    public class ListReplacePermissionAssociationsWorkResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListReplacePermissionAssociationsWorkResponse response = new ListReplacePermissionAssociationsWorkResponse();
        ...
        private static ListReplacePermissionAssociationsWorkResponseUnmarshaller _instance = new ListReplacePermissionAssociationsWorkResponseUnmarshaller();        

        internal static ListReplacePermissionAssociationsWorkResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListReplacePermissionAssociationsWorkResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
