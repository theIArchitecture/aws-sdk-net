    ...
    public class ListResourceTypesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ServiceNameAndResourceType, ServiceNameAndResourceTypeUnmarshaller>(ServiceNameAndResourceTypeUnmarshaller.Instance);
