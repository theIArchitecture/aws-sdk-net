...
{
    /// <summary>
    /// Response Unmarshaller for ReplacePermissionAssociations operation
    /// </summary>  
    public class ReplacePermissionAssociationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ReplacePermissionAssociationsResponse response = new ReplacePermissionAssociationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("replacePermissionAssociationsWork", targetDepth))
                {
                    var unmarshaller = ReplacePermissionAssociationsWorkUnmarshaller.Instance;
                    response.ReplacePermissionAssociationsWork = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ReplacePermissionAssociationsResponseUnmarshaller _instance = new ReplacePermissionAssociationsResponseUnmarshaller();        

        internal static ReplacePermissionAssociationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ReplacePermissionAssociationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
