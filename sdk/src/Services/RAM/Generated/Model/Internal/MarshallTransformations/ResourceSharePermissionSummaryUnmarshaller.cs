...
namespace Amazon.RAM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResourceSharePermissionSummaryUnmarshaller : IJsonUnmarshaller<ResourceSharePermissionSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResourceSharePermissionSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
