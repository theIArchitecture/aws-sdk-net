...
namespace Amazon.RAM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResourceShareUnmarshaller : IJsonUnmarshaller<ResourceShare, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResourceShare Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("allowExternalPrincipals", targetDepth))
                {
                    ...
                    unmarshalledObject.AllowExternalPrincipals = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
