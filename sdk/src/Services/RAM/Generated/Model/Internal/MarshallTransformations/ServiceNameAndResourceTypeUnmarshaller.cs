...
namespace Amazon.RAM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ServiceNameAndResourceTypeUnmarshaller : IJsonUnmarshaller<ServiceNameAndResourceType, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ServiceNameAndResourceType Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("resourceRegionScope", targetDepth))
                {
                    ...
                    unmarshalledObject.ResourceRegionScope = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
