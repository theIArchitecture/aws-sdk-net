...
{
    /// <summary>
    /// Response Unmarshaller for SetDefaultPermissionVersion operation
    /// </summary>  
    public class SetDefaultPermissionVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SetDefaultPermissionVersionResponse response = new SetDefaultPermissionVersionResponse();
        ...
        private static SetDefaultPermissionVersionResponseUnmarshaller _instance = new SetDefaultPermissionVersionResponseUnmarshaller();        

        internal static SetDefaultPermissionVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetDefaultPermissionVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
