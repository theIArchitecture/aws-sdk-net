...
namespace Amazon.RAM
{
    ...
    public partial interface IAmazonRAM : IAmazonService, IDisposable
    {
        ...
        Task<CreatePermissionVersionResponse> CreatePermissionVersionAsync(CreatePermissionVersionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeletePermissionVersionResponse> DeletePermissionVersionAsync(DeletePermissionVersionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListPermissionAssociationsResponse> ListPermissionAssociationsAsync(ListPermissionAssociationsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListPermissionVersionsResponse> ListPermissionVersionsAsync(ListPermissionVersionsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListReplacePermissionAssociationsWorkResponse> ListReplacePermissionAssociationsWorkAsync(ListReplacePermissionAssociationsWorkRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<PromotePermissionCreatedFromPolicyResponse> PromotePermissionCreatedFromPolicyAsync(PromotePermissionCreatedFromPolicyRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ReplacePermissionAssociationsResponse> ReplacePermissionAssociationsAsync(ReplacePermissionAssociationsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<SetDefaultPermissionVersionResponse> SetDefaultPermissionVersionAsync(SetDefaultPermissionVersionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonRAMConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonRAMConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonRAMConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonRAMConfig to create AmazonRAMClient");
            }

            return awsCredentials == null ? 
                    new AmazonRAMClient(serviceClientConfig) :
                    new AmazonRAMClient(awsCredentials, serviceClientConfig);
        }
