...
namespace Amazon.RDS.Internal
{
    ...
    public class AmazonRDSAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonRDSAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for RDS.
        /// </summary>
        public AmazonRDSAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonRDSAuthSchemeParameters
            {
    ...
    public class AmazonRDSAuthSchemeResolver : IAuthSchemeResolver<AmazonRDSAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonRDSAuthSchemeParameters authParameters)
        {
