...
namespace Amazon.RDS.Model
{
    ...
    public partial class DBInstanceAutomatedBackupQuotaExceededException : AmazonRDSException
    {
        ...
        public DBInstanceAutomatedBackupQuotaExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DBInstanceAutomatedBackupQuotaExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
