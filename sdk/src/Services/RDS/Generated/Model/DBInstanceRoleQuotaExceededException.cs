...
namespace Amazon.RDS.Model
{
    ...
    public partial class DBInstanceRoleQuotaExceededException : AmazonRDSException
    {
        ...
        public DBInstanceRoleQuotaExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DBInstanceRoleQuotaExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
