...
{
    /// <summary>
    /// Response Unmarshaller for CreateDBShardGroup operation
    /// </summary>  
    public class CreateDBShardGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDBShardGroupResponse response = new CreateDBShardGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("CreateDBShardGroupResult", 2))
                    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("MaxDBShardGroupLimitReached"))
                {
                    return MaxDBShardGroupLimitReachedExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("UnsupportedDBEngineVersion"))
                {
                    return UnsupportedDBEngineVersionExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
            }
            return new AmazonRDSException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
        }
        private static CreateDBShardGroupResponseUnmarshaller _instance = new CreateDBShardGroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDBShardGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
