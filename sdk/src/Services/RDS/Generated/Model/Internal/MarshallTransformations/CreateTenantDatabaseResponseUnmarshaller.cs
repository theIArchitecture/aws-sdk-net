...
{
    /// <summary>
    /// Response Unmarshaller for CreateTenantDatabase operation
    /// </summary>  
    public class CreateTenantDatabaseResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTenantDatabaseResponse response = new CreateTenantDatabaseResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("CreateTenantDatabaseResult", 2))
                    {
        ...
        private static CreateTenantDatabaseResponseUnmarshaller _instance = new CreateTenantDatabaseResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTenantDatabaseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
