...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    public class CustomDBEngineVersionAMIUnmarshaller : IXmlUnmarshaller<CustomDBEngineVersionAMI, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public CustomDBEngineVersionAMI Unmarshall(XmlUnmarshallerContext context)
        {
            CustomDBEngineVersionAMI unmarshalledObject = new CustomDBEngineVersionAMI();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CustomDBEngineVersionAMIUnmarshaller Instance
        {
            get
            {
                return _instance;
