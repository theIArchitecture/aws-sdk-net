...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    public class DBShardGroupUnmarshaller : IXmlUnmarshaller<DBShardGroup, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public DBShardGroup Unmarshall(XmlUnmarshallerContext context)
        {
            DBShardGroup unmarshalledObject = new DBShardGroup();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("ComputeRedundancy", targetDepth))
                    {
                        ...
                        unmarshalledObject.ComputeRedundancy = unmarshaller.Unmarshall(context);
                        continue;
                    }
                    ...
                    if (context.TestExpression("MaxACU", targetDepth))
                    {
                        ...
                        unmarshalledObject.MaxACU = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DBShardGroupUnmarshaller Instance
        {
            get
            {
                return _instance;
