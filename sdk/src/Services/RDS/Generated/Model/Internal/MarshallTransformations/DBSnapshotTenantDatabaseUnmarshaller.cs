...
{
    /// <summary>
    /// Response Unmarshaller for DBSnapshotTenantDatabase Object
    /// </summary>  
    public class DBSnapshotTenantDatabaseUnmarshaller : IXmlUnmarshaller<DBSnapshotTenantDatabase, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public DBSnapshotTenantDatabase Unmarshall(XmlUnmarshallerContext context)
        {
            DBSnapshotTenantDatabase unmarshalledObject = new DBSnapshotTenantDatabase();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.DBSnapshotTenantDatabaseARN = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        private static DBSnapshotTenantDatabaseUnmarshaller _instance = new DBSnapshotTenantDatabaseUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DBSnapshotTenantDatabaseUnmarshaller Instance
        {
            get
            {
                return _instance;
