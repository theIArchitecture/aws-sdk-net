...
{
    /// <summary>
    /// Response Unmarshaller for DeleteDBShardGroup operation
    /// </summary>  
    public class DeleteDBShardGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDBShardGroupResponse response = new DeleteDBShardGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteDBShardGroupResult", 2))
                    {
        ...
        private static DeleteDBShardGroupResponseUnmarshaller _instance = new DeleteDBShardGroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDBShardGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
