...
{
    /// <summary>
    /// DeleteTenantDatabase Request Marshaller
    /// </summary>       
    public class DeleteTenantDatabaseRequestMarshaller : IMarshaller<IRequest, DeleteTenantDatabaseRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteTenantDatabaseRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteTenantDatabaseRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.RDS");
            request.Parameters.Add("Action", "DeleteTenantDatabase");
            ...
            return request;
                    ...
                    private static DeleteTenantDatabaseRequestMarshaller _instance = new DeleteTenantDatabaseRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTenantDatabaseRequestMarshaller Instance
        {
            get
            {
                return _instance;
