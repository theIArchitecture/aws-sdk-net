...
{
    /// <summary>
    /// Response Unmarshaller for DeleteTenantDatabase operation
    /// </summary>  
    public class DeleteTenantDatabaseResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteTenantDatabaseResponse response = new DeleteTenantDatabaseResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteTenantDatabaseResult", 2))
                    {
        ...
        private static DeleteTenantDatabaseResponseUnmarshaller _instance = new DeleteTenantDatabaseResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTenantDatabaseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
