...
{
    /// <summary>
    /// Response Unmarshaller for DescribeBlueGreenDeployments operation
    /// </summary>  
    public class DescribeBlueGreenDeploymentsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeBlueGreenDeploymentsResponse response = new DescribeBlueGreenDeploymentsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeBlueGreenDeploymentsResult", 2))
                    {
        ...
        private static DescribeBlueGreenDeploymentsResponseUnmarshaller _instance = new DescribeBlueGreenDeploymentsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeBlueGreenDeploymentsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
