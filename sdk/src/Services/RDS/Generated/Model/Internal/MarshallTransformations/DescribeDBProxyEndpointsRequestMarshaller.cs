...
{
    /// <summary>
    /// DescribeDBProxyEndpoints Request Marshaller
    /// </summary>       
    public class DescribeDBProxyEndpointsRequestMarshaller : IMarshaller<IRequest, DescribeDBProxyEndpointsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeDBProxyEndpointsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeDBProxyEndpointsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.RDS");
            request.Parameters.Add("Action", "DescribeDBProxyEndpoints");
            ...
            return request;
                    ...
                    private static DescribeDBProxyEndpointsRequestMarshaller _instance = new DescribeDBProxyEndpointsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDBProxyEndpointsRequestMarshaller Instance
        {
            get
            {
                return _instance;
