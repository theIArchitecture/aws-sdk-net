...
{
    /// <summary>
    /// DescribeDBRecommendations Request Marshaller
    /// </summary>       
    public class DescribeDBRecommendationsRequestMarshaller : IMarshaller<IRequest, DescribeDBRecommendationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeDBRecommendationsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeDBRecommendationsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.RDS");
            request.Parameters.Add("Action", "DescribeDBRecommendations");
            ...
            return request;
                    ...
                    private static DescribeDBRecommendationsRequestMarshaller _instance = new DescribeDBRecommendationsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDBRecommendationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
