...
{
    /// <summary>
    /// DescribeDBShardGroups Request Marshaller
    /// </summary>       
    public class DescribeDBShardGroupsRequestMarshaller : IMarshaller<IRequest, DescribeDBShardGroupsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeDBShardGroupsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeDBShardGroupsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.RDS");
            request.Parameters.Add("Action", "DescribeDBShardGroups");
            ...
            return request;
                    ...
                    private static DescribeDBShardGroupsRequestMarshaller _instance = new DescribeDBShardGroupsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDBShardGroupsRequestMarshaller Instance
        {
            get
            {
                return _instance;
