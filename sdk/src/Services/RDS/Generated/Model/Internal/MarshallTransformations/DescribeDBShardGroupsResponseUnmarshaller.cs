...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDBShardGroups operation
    /// </summary>  
    public class DescribeDBShardGroupsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDBShardGroupsResponse response = new DescribeDBShardGroupsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeDBShardGroupsResult", 2))
                    {
        ...
        private static DescribeDBShardGroupsResponseUnmarshaller _instance = new DescribeDBShardGroupsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDBShardGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
