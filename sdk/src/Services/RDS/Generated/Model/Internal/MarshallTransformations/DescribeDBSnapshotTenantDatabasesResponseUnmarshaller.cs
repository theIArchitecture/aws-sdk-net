...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDBSnapshotTenantDatabases operation
    /// </summary>  
    public class DescribeDBSnapshotTenantDatabasesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDBSnapshotTenantDatabasesResponse response = new DescribeDBSnapshotTenantDatabasesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeDBSnapshotTenantDatabasesResult", 2))
                    {
        ...
        private static DescribeDBSnapshotTenantDatabasesResponseUnmarshaller _instance = new DescribeDBSnapshotTenantDatabasesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDBSnapshotTenantDatabasesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
