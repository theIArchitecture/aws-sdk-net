...
{
    /// <summary>
    /// DescribeTenantDatabases Request Marshaller
    /// </summary>       
    public class DescribeTenantDatabasesRequestMarshaller : IMarshaller<IRequest, DescribeTenantDatabasesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeTenantDatabasesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeTenantDatabasesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.RDS");
            request.Parameters.Add("Action", "DescribeTenantDatabases");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTenantDatabasesRequestMarshaller Instance
        {
            get
            {
                return _instance;
