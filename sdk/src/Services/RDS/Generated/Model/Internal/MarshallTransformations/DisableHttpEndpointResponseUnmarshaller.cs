...
{
    /// <summary>
    /// Response Unmarshaller for DisableHttpEndpoint operation
    /// </summary>  
    public class DisableHttpEndpointResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisableHttpEndpointResponse response = new DisableHttpEndpointResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DisableHttpEndpointResult", 2))
                    {
        ...
        private static DisableHttpEndpointResponseUnmarshaller _instance = new DisableHttpEndpointResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisableHttpEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
