...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    public class LimitlessDatabaseUnmarshaller : IXmlUnmarshaller<LimitlessDatabase, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public LimitlessDatabase Unmarshall(XmlUnmarshallerContext context)
        {
            LimitlessDatabase unmarshalledObject = new LimitlessDatabase();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("MinRequiredACU", targetDepth))
                    {
                        ...
                        unmarshalledObject.MinRequiredACU = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static LimitlessDatabaseUnmarshaller Instance
        {
            get
            {
                return _instance;
