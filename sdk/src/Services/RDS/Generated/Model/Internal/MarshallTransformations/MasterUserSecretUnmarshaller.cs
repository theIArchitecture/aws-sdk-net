...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    public class MasterUserSecretUnmarshaller : IXmlUnmarshaller<MasterUserSecret, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public MasterUserSecret Unmarshall(XmlUnmarshallerContext context)
        {
            MasterUserSecret unmarshalledObject = new MasterUserSecret();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static MasterUserSecretUnmarshaller Instance
        {
            get
            {
                return _instance;
