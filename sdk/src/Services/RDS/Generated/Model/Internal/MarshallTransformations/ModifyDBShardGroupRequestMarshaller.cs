...
{
    /// <summary>
    /// ModifyDBShardGroup Request Marshaller
    /// </summary>       
    public class ModifyDBShardGroupRequestMarshaller : IMarshaller<IRequest, ModifyDBShardGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ModifyDBShardGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ModifyDBShardGroupRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.RDS");
            request.Parameters.Add("Action", "ModifyDBShardGroup");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyDBShardGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
