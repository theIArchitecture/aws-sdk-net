...
{
    /// <summary>
    /// Response Unmarshaller for ModifyTenantDatabase operation
    /// </summary>  
    public class ModifyTenantDatabaseResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyTenantDatabaseResponse response = new ModifyTenantDatabaseResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ModifyTenantDatabaseResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, ModifyTenantDatabaseResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("TenantDatabase", targetDepth))
                    {
                        var unmarshaller = TenantDatabaseUnmarshaller.Instance;
                        response.TenantDatabase = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
           }
        ...
        private static ModifyTenantDatabaseResponseUnmarshaller _instance = new ModifyTenantDatabaseResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyTenantDatabaseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
