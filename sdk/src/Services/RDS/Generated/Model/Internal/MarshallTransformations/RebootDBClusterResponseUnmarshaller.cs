...
{
    /// <summary>
    /// Response Unmarshaller for RebootDBCluster operation
    /// </summary>  
    public class RebootDBClusterResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RebootDBClusterResponse response = new RebootDBClusterResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("RebootDBClusterResult", 2))
                    {
        ...
        private static RebootDBClusterResponseUnmarshaller _instance = new RebootDBClusterResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RebootDBClusterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
