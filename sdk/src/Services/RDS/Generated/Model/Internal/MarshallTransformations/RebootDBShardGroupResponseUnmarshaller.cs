...
{
    /// <summary>
    /// Response Unmarshaller for RebootDBShardGroup operation
    /// </summary>  
    public class RebootDBShardGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RebootDBShardGroupResponse response = new RebootDBShardGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("RebootDBShardGroupResult", 2))
                    {
        ...
        private static RebootDBShardGroupResponseUnmarshaller _instance = new RebootDBShardGroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RebootDBShardGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
