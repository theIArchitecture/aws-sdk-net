...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    public class RecommendedActionParameterUnmarshaller : IXmlUnmarshaller<RecommendedActionParameter, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public RecommendedActionParameter Unmarshall(XmlUnmarshallerContext context)
        {
            RecommendedActionParameter unmarshalledObject = new RecommendedActionParameter();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RecommendedActionParameterUnmarshaller Instance
        {
            get
            {
                return _instance;
