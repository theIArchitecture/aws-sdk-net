...
{
    /// <summary>
    /// SwitchoverBlueGreenDeployment Request Marshaller
    /// </summary>       
    public class SwitchoverBlueGreenDeploymentRequestMarshaller : IMarshaller<IRequest, SwitchoverBlueGreenDeploymentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SwitchoverBlueGreenDeploymentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SwitchoverBlueGreenDeploymentRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.RDS");
            request.Parameters.Add("Action", "SwitchoverBlueGreenDeployment");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SwitchoverBlueGreenDeploymentRequestMarshaller Instance
        {
            get
            {
                return _instance;
