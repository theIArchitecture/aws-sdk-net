...
{
    /// <summary>
    /// Response Unmarshaller for SwitchoverReadReplica operation
    /// </summary>  
    public class SwitchoverReadReplicaResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SwitchoverReadReplicaResponse response = new SwitchoverReadReplicaResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("SwitchoverReadReplicaResult", 2))
                    {
        ...
        private static SwitchoverReadReplicaResponseUnmarshaller _instance = new SwitchoverReadReplicaResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SwitchoverReadReplicaResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
