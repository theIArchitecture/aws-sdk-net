...
namespace Amazon.RDS.Model
{
    ...
    public partial class InvalidDBClusterCapacityException : AmazonRDSException
    {
        ...
        public InvalidDBClusterCapacityException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidDBClusterCapacityException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
