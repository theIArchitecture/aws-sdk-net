...
namespace Amazon.RDS.Model
{
    ...
    public partial class InvalidDBClusterSnapshotStateException : AmazonRDSException
    {
        ...
        public InvalidDBClusterSnapshotStateException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidDBClusterSnapshotStateException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
