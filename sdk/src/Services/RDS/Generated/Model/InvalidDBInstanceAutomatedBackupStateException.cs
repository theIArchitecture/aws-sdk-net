...
namespace Amazon.RDS.Model
{
    ...
    public partial class InvalidDBInstanceAutomatedBackupStateException : AmazonRDSException
    {
        ...
        public InvalidDBInstanceAutomatedBackupStateException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidDBInstanceAutomatedBackupStateException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
