...
namespace Amazon.RDS.Model
{
    ...
    public partial class IssueDetails
    {
        ...
        {
            get { return this._performanceIssueDetails; }
            set { this._performanceIssueDetails = value; }
        }

        // Check to see if PerformanceIssueDetails property is set
        internal bool IsSetPerformanceIssueDetails()
        {
            return this._performanceIssueDetails != null;
        }
