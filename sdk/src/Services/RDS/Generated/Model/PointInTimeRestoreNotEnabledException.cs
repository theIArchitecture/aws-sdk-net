...
namespace Amazon.RDS.Model
{
    ...
    public partial class PointInTimeRestoreNotEnabledException : AmazonRDSException
    {
        ...
        public PointInTimeRestoreNotEnabledException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public PointInTimeRestoreNotEnabledException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
