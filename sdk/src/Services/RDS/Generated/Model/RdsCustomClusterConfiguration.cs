...
namespace Amazon.RDS.Model
{
    ...
    public partial class RdsCustomClusterConfiguration
    {
        ...
        /// <summary>
        /// Gets and sets the property InterconnectSubnetId. 
        /// <para>
        /// Reserved for future use.
        /// </para>
        /// </summary>
        public string InterconnectSubnetId
        {
            get { return this._interconnectSubnetId; }
            set { this._interconnectSubnetId = value; }
        }

        // Check to see if InterconnectSubnetId property is set
