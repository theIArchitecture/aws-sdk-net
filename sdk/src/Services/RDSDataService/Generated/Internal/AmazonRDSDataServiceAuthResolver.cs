...
namespace Amazon.RDSDataService.Internal
{
    ...
    public class AmazonRDSDataServiceAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonRDSDataServiceAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for RDSDataService.
        /// </summary>
        public AmazonRDSDataServiceAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonRDSDataServiceAuthSchemeParameters
            {
    ...
    public class AmazonRDSDataServiceAuthSchemeResolver : IAuthSchemeResolver<AmazonRDSDataServiceAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonRDSDataServiceAuthSchemeParameters authParameters)
        {
