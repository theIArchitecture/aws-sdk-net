...
namespace Amazon.RDSDataService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResultFrameUnmarshaller : IJsonUnmarshaller<ResultFrame, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResultFrame Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("resultSetMetadata", targetDepth))
                {
                    ...
                    unmarshalledObject.ResultSetMetadata = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
