...
namespace Amazon.RDSDataService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResultSetMetadataUnmarshaller : IJsonUnmarshaller<ResultSetMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResultSetMetadata Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
