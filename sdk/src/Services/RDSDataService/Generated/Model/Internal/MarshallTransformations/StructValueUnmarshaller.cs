...
namespace Amazon.RDSDataService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StructValueUnmarshaller : IJsonUnmarshaller<StructValue, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public StructValue Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
