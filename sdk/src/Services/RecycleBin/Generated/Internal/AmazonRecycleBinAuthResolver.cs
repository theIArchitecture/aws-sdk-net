...
namespace Amazon.RecycleBin.Internal
{
    ...
    public class AmazonRecycleBinAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonRecycleBinAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for RecycleBin.
        /// </summary>
        public AmazonRecycleBinAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonRecycleBinAuthSchemeParameters
            {
    ...
    public class AmazonRecycleBinAuthSchemeResolver : IAuthSchemeResolver<AmazonRecycleBinAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonRecycleBinAuthSchemeParameters authParameters)
        {
