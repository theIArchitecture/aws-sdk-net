...
namespace Amazon.RecycleBin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RetentionPeriodUnmarshaller : IJsonUnmarshaller<RetentionPeriod, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RetentionPeriod Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("RetentionPeriodUnit", targetDepth))
                {
                    ...
                    unmarshalledObject.RetentionPeriodUnit = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("RetentionPeriodValue", targetDepth))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.RetentionPeriodValue = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
