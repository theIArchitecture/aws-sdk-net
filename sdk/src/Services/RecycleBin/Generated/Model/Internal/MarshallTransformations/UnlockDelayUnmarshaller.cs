...
namespace Amazon.RecycleBin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UnlockDelayUnmarshaller : IJsonUnmarshaller<UnlockDelay, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public UnlockDelay Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("UnlockDelayUnit", targetDepth))
                {
                    ...
                    unmarshalledObject.UnlockDelayUnit = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("UnlockDelayValue", targetDepth))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.UnlockDelayValue = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
