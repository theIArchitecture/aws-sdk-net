...
{
    /// <summary>
    /// Response Unmarshaller for UnlockRule operation
    /// </summary>  
    public class UnlockRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UnlockRuleResponse response = new UnlockRuleResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ExcludeResourceTags", targetDepth))
                {
                    ...
                    response.ExcludeResourceTags = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("LockConfiguration", targetDepth))
                {
                    ...
                    response.LockConfiguration = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("LockEndTime", targetDepth))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    response.LockEndTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("LockState", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.LockState = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UnlockRuleResponseUnmarshaller _instance = new UnlockRuleResponseUnmarshaller();        

        internal static UnlockRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UnlockRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
