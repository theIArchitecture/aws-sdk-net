...
namespace Amazon.Redshift.Internal
{
    ...
    public class AmazonRedshiftAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonRedshiftAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Redshift.
        /// </summary>
        public AmazonRedshiftAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonRedshiftAuthSchemeParameters
            {
    ...
    public class AmazonRedshiftAuthSchemeResolver : IAuthSchemeResolver<AmazonRedshiftAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonRedshiftAuthSchemeParameters authParameters)
        {
