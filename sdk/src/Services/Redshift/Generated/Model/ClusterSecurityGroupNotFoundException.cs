...
namespace Amazon.Redshift.Model
{
    ...
    public partial class ClusterSecurityGroupNotFoundException : AmazonRedshiftException
    {
        ...
        public ClusterSecurityGroupNotFoundException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ClusterSecurityGroupNotFoundException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
