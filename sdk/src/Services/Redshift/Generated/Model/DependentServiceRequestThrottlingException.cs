...
namespace Amazon.Redshift.Model
{
    ...
    public partial class DependentServiceRequestThrottlingException : AmazonRedshiftException
    {
        ...
        public DependentServiceRequestThrottlingException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DependentServiceRequestThrottlingException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
