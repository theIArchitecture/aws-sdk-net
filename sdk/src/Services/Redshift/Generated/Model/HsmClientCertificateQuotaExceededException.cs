...
namespace Amazon.Redshift.Model
{
    ...
    public partial class HsmClientCertificateQuotaExceededException : AmazonRedshiftException
    {
        ...
        public HsmClientCertificateQuotaExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public HsmClientCertificateQuotaExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
