...
namespace Amazon.Redshift.Model
{
    ...
    public partial class HsmConfigurationAlreadyExistsException : AmazonRedshiftException
    {
        ...
        public HsmConfigurationAlreadyExistsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public HsmConfigurationAlreadyExistsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
