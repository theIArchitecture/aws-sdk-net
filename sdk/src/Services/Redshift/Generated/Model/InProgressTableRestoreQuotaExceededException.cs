...
namespace Amazon.Redshift.Model
{
    ...
    public partial class InProgressTableRestoreQuotaExceededException : AmazonRedshiftException
    {
        ...
        public InProgressTableRestoreQuotaExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InProgressTableRestoreQuotaExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
