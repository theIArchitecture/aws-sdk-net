...
{
    /// <summary>
    /// AddPartner Request Marshaller
    /// </summary>       
    public class AddPartnerRequestMarshaller : IMarshaller<IRequest, AddPartnerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AddPartnerRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AddPartnerRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Redshift");
            request.Parameters.Add("Action", "AddPartner");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddPartnerRequestMarshaller Instance
        {
            get
            {
                return _instance;
