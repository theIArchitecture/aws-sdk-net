...
namespace Amazon.Redshift.Model.Internal.MarshallTransformations
{
    ...
    public class CertificateAssociationUnmarshaller : IXmlUnmarshaller<CertificateAssociation, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public CertificateAssociation Unmarshall(XmlUnmarshallerContext context)
        {
            CertificateAssociation unmarshalledObject = new CertificateAssociation();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CertificateAssociationUnmarshaller Instance
        {
            get
            {
                return _instance;
