...
{
    /// <summary>
    /// Response Unmarshaller for CreateCustomDomainAssociation operation
    /// </summary>  
    public class CreateCustomDomainAssociationResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateCustomDomainAssociationResponse response = new CreateCustomDomainAssociationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("CreateCustomDomainAssociationResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, CreateCustomDomainAssociationResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        response.CustomDomainCertExpiryTime = unmarshaller.Unmarshall(context);
                        continue;
                    }
                    if (context.TestExpression("CustomDomainCertificateArn", targetDepth))
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        response.CustomDomainCertificateArn = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("CustomCnameAssociationFault"))
                {
        ...
        private static CreateCustomDomainAssociationResponseUnmarshaller _instance = new CreateCustomDomainAssociationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCustomDomainAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
