...
{
    /// <summary>
    /// Response Unmarshaller for CreateRedshiftIdcApplication operation
    /// </summary>  
    public class CreateRedshiftIdcApplicationResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRedshiftIdcApplicationResponse response = new CreateRedshiftIdcApplicationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("CreateRedshiftIdcApplicationResult", 2))
                    {
        ...
        private static CreateRedshiftIdcApplicationResponseUnmarshaller _instance = new CreateRedshiftIdcApplicationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRedshiftIdcApplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
