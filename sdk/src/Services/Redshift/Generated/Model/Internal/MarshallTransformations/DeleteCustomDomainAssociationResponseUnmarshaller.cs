...
{
    /// <summary>
    /// Response Unmarshaller for DeleteCustomDomainAssociation operation
    /// </summary>  
    public class DeleteCustomDomainAssociationResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteCustomDomainAssociationResponse response = new DeleteCustomDomainAssociationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteCustomDomainAssociationResult", 2))
                    {
        ...
        private static DeleteCustomDomainAssociationResponseUnmarshaller _instance = new DeleteCustomDomainAssociationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCustomDomainAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
