...
{
    /// <summary>
    /// Response Unmarshaller for DeleteRedshiftIdcApplication operation
    /// </summary>  
    public class DeleteRedshiftIdcApplicationResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteRedshiftIdcApplicationResponse response = new DeleteRedshiftIdcApplicationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteRedshiftIdcApplicationResult", 2))
                    {
        ...
        private static DeleteRedshiftIdcApplicationResponseUnmarshaller _instance = new DeleteRedshiftIdcApplicationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRedshiftIdcApplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
