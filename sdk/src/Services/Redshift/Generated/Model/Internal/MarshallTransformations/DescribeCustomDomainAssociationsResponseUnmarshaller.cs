...
{
    /// <summary>
    /// Response Unmarshaller for DescribeCustomDomainAssociations operation
    /// </summary>  
    public class DescribeCustomDomainAssociationsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeCustomDomainAssociationsResponse response = new DescribeCustomDomainAssociationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeCustomDomainAssociationsResult", 2))
                    {
        ...
        private static DescribeCustomDomainAssociationsResponseUnmarshaller _instance = new DescribeCustomDomainAssociationsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeCustomDomainAssociationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
