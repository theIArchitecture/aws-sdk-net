...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDataShares operation
    /// </summary>  
    public class DescribeDataSharesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDataSharesResponse response = new DescribeDataSharesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeDataSharesResult", 2))
                    {
        ...
        private static DescribeDataSharesResponseUnmarshaller _instance = new DescribeDataSharesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDataSharesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
