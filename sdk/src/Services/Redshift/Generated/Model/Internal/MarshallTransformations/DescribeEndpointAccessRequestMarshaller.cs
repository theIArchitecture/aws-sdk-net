...
{
    /// <summary>
    /// DescribeEndpointAccess Request Marshaller
    /// </summary>       
    public class DescribeEndpointAccessRequestMarshaller : IMarshaller<IRequest, DescribeEndpointAccessRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeEndpointAccessRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeEndpointAccessRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Redshift");
            request.Parameters.Add("Action", "DescribeEndpointAccess");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeEndpointAccessRequestMarshaller Instance
        {
            get
            {
                return _instance;
