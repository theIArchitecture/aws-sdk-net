...
{
    /// <summary>
    /// Response Unmarshaller for DescribeEndpointAccess operation
    /// </summary>  
    public class DescribeEndpointAccessResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeEndpointAccessResponse response = new DescribeEndpointAccessResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeEndpointAccessResult", 2))
                    {
        ...
        private static DescribeEndpointAccessResponseUnmarshaller _instance = new DescribeEndpointAccessResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeEndpointAccessResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
