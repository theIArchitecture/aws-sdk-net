...
{
    /// <summary>
    /// Response Unmarshaller for DescribeEndpointAuthorization operation
    /// </summary>  
    public class DescribeEndpointAuthorizationResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeEndpointAuthorizationResponse response = new DescribeEndpointAuthorizationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeEndpointAuthorizationResult", 2))
                    {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("EndpointAuthorizationList/member", targetDepth))
                    {
                        ...
                        if (response.EndpointAuthorizationList == null)
                        {
                            response.EndpointAuthorizationList = new List<EndpointAuthorization>();
                        }
        ...
        private static DescribeEndpointAuthorizationResponseUnmarshaller _instance = new DescribeEndpointAuthorizationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeEndpointAuthorizationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
