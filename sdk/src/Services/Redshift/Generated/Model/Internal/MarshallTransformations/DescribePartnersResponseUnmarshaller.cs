...
{
    /// <summary>
    /// Response Unmarshaller for DescribePartners operation
    /// </summary>  
    public class DescribePartnersResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribePartnersResponse response = new DescribePartnersResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribePartnersResult", 2))
                    {
        ...
        private static DescribePartnersResponseUnmarshaller _instance = new DescribePartnersResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribePartnersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
