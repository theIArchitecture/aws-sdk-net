...
{
    /// <summary>
    /// Response Unmarshaller for DescribeRedshiftIdcApplications operation
    /// </summary>  
    public class DescribeRedshiftIdcApplicationsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeRedshiftIdcApplicationsResponse response = new DescribeRedshiftIdcApplicationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeRedshiftIdcApplicationsResult", 2))
                    {
        ...
        private static DescribeRedshiftIdcApplicationsResponseUnmarshaller _instance = new DescribeRedshiftIdcApplicationsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeRedshiftIdcApplicationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
