...
{
    /// <summary>
    /// Response Unmarshaller for ModifyAquaConfiguration operation
    /// </summary>  
    public class ModifyAquaConfigurationResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyAquaConfigurationResponse response = new ModifyAquaConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ModifyAquaConfigurationResult", 2))
                    {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("AquaConfiguration", targetDepth))
                    {
                        ...
                        response.AquaConfiguration = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
           }
        ...
        private static ModifyAquaConfigurationResponseUnmarshaller _instance = new ModifyAquaConfigurationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyAquaConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
