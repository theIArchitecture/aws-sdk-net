...
{
    /// <summary>
    /// ModifyAuthenticationProfile Request Marshaller
    /// </summary>       
    public class ModifyAuthenticationProfileRequestMarshaller : IMarshaller<IRequest, ModifyAuthenticationProfileRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ModifyAuthenticationProfileRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ModifyAuthenticationProfileRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Redshift");
            request.Parameters.Add("Action", "ModifyAuthenticationProfile");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyAuthenticationProfileRequestMarshaller Instance
        {
            get
            {
                return _instance;
