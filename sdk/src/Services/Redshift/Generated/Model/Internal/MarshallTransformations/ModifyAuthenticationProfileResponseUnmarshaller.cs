...
{
    /// <summary>
    /// Response Unmarshaller for ModifyAuthenticationProfile operation
    /// </summary>  
    public class ModifyAuthenticationProfileResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyAuthenticationProfileResponse response = new ModifyAuthenticationProfileResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ModifyAuthenticationProfileResult", 2))
                    {
        ...
        private static ModifyAuthenticationProfileResponseUnmarshaller _instance = new ModifyAuthenticationProfileResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyAuthenticationProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
