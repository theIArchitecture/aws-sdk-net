...
{
    /// <summary>
    /// Response Unmarshaller for ModifyCustomDomainAssociation operation
    /// </summary>  
    public class ModifyCustomDomainAssociationResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyCustomDomainAssociationResponse response = new ModifyCustomDomainAssociationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ModifyCustomDomainAssociationResult", 2))
                    {
        ...
        private static ModifyCustomDomainAssociationResponseUnmarshaller _instance = new ModifyCustomDomainAssociationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyCustomDomainAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
