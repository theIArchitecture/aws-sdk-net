...
{
    /// <summary>
    /// Response Unmarshaller for RejectDataShare operation
    /// </summary>  
    public class RejectDataShareResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RejectDataShareResponse response = new RejectDataShareResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("RejectDataShareResult", 2))
                    {
        ...
        private static RejectDataShareResponseUnmarshaller _instance = new RejectDataShareResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RejectDataShareResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
