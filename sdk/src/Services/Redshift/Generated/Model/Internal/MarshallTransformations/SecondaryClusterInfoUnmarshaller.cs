...
namespace Amazon.Redshift.Model.Internal.MarshallTransformations
{
    ...
    public class SecondaryClusterInfoUnmarshaller : IXmlUnmarshaller<SecondaryClusterInfo, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public SecondaryClusterInfo Unmarshall(XmlUnmarshallerContext context)
        {
            SecondaryClusterInfo unmarshalledObject = new SecondaryClusterInfo();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SecondaryClusterInfoUnmarshaller Instance
        {
            get
            {
                return _instance;
