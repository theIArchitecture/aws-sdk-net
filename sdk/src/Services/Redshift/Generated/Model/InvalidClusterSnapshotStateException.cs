...
namespace Amazon.Redshift.Model
{
    ...
    public partial class InvalidClusterSnapshotStateException : AmazonRedshiftException
    {
        ...
        public InvalidClusterSnapshotStateException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidClusterSnapshotStateException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
