...
namespace Amazon.Redshift.Model
{
    ...
    public partial class InvalidRetentionPeriodException : AmazonRedshiftException
    {
        ...
        public InvalidRetentionPeriodException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidRetentionPeriodException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
