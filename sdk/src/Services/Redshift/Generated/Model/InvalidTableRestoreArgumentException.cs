...
namespace Amazon.Redshift.Model
{
    ...
    public partial class InvalidTableRestoreArgumentException : AmazonRedshiftException
    {
        ...
        public InvalidTableRestoreArgumentException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidTableRestoreArgumentException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
