...
namespace Amazon.Redshift.Model
{
    ...
    public partial class NumberOfNodesPerClusterLimitExceededException : AmazonRedshiftException
    {
        ...
        public NumberOfNodesPerClusterLimitExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NumberOfNodesPerClusterLimitExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
