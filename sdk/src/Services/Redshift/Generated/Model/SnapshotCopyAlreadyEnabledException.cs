...
namespace Amazon.Redshift.Model
{
    ...
    public partial class SnapshotCopyAlreadyEnabledException : AmazonRedshiftException
    {
        ...
        public SnapshotCopyAlreadyEnabledException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public SnapshotCopyAlreadyEnabledException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
