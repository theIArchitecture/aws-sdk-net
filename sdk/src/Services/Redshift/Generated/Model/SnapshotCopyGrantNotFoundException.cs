...
namespace Amazon.Redshift.Model
{
    ...
    public partial class SnapshotCopyGrantNotFoundException : AmazonRedshiftException
    {
        ...
        public SnapshotCopyGrantNotFoundException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public SnapshotCopyGrantNotFoundException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
