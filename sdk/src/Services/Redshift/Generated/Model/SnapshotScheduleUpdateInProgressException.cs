...
namespace Amazon.Redshift.Model
{
    ...
    public partial class SnapshotScheduleUpdateInProgressException : AmazonRedshiftException
    {
        ...
        public SnapshotScheduleUpdateInProgressException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public SnapshotScheduleUpdateInProgressException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
