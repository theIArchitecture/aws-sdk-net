...
namespace Amazon.Redshift.Model
{
    ...
    public partial class SubscriptionSeverityNotFoundException : AmazonRedshiftException
    {
        ...
        public SubscriptionSeverityNotFoundException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public SubscriptionSeverityNotFoundException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
