...
namespace Amazon.Redshift.Model
{
    ...
    public partial class UnauthorizedOperationException : AmazonRedshiftException
    {
        ...
        public UnauthorizedOperationException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public UnauthorizedOperationException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
