...
namespace Amazon.Redshift
{
    ...
    public partial interface IAmazonRedshift : IAmazonService, IDisposable
    {
        ...
        Task<DescribeCustomDomainAssociationsResponse> DescribeCustomDomainAssociationsAsync(DescribeCustomDomainAssociationsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ModifyCustomDomainAssociationResponse> ModifyCustomDomainAssociationAsync(ModifyCustomDomainAssociationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonRedshiftConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonRedshiftConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonRedshiftConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonRedshiftConfig to create AmazonRedshiftClient");
            }

            return awsCredentials == null ? 
                    new AmazonRedshiftClient(serviceClientConfig) :
                    new AmazonRedshiftClient(awsCredentials, serviceClientConfig);
        }
