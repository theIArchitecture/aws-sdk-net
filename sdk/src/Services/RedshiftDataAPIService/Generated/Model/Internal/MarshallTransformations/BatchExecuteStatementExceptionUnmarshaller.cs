...
namespace Amazon.RedshiftDataAPIService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchExecuteStatementExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<BatchExecuteStatementException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public BatchExecuteStatementException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public BatchExecuteStatementException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
