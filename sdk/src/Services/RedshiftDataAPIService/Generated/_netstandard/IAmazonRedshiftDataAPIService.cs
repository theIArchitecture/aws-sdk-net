...
namespace Amazon.RedshiftDataAPIService
{
    ...
    public partial interface IAmazonRedshiftDataAPIService : IAmazonService, IDisposable
    {
        ...
        Task<GetStatementResultV2Response> GetStatementResultV2Async(GetStatementResultV2Request request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonRedshiftDataAPIServiceConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonRedshiftDataAPIServiceConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonRedshiftDataAPIServiceConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonRedshiftDataAPIServiceConfig to create AmazonRedshiftDataAPIServiceClient");
            }

            return awsCredentials == null ? 
                    new AmazonRedshiftDataAPIServiceClient(serviceClientConfig) :
                    new AmazonRedshiftDataAPIServiceClient(awsCredentials, serviceClientConfig);
        }
