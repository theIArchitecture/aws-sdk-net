...
{
    /// <summary>
    /// Container for the parameters to the GetReservationOffering operation.
    /// Returns the reservation offering. The offering determines the payment schedule for
    /// the reservation.
    /// </summary>
    public partial class GetReservationOfferingRequest : AmazonRedshiftServerlessRequest
    {
