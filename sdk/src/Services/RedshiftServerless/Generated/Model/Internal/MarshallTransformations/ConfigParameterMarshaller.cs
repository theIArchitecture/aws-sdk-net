...
{
    /// <summary>
    /// ConfigParameter Marshaller
    /// </summary>
    public class ConfigParameterMarshaller : IRequestMarshaller<ConfigParameter, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(ConfigParameter requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetParameterKey())
            {
                ...
                context.Writer.WriteStringValue(requestObject.ParameterKey);
            }
        ...
        /// </summary>
        public readonly static ConfigParameterMarshaller Instance = new ConfigParameterMarshaller();
