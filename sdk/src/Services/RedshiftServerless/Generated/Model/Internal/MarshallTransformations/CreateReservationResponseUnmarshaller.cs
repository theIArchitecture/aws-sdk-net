...
{
    /// <summary>
    /// Response Unmarshaller for CreateReservation operation
    /// </summary>  
    public class CreateReservationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateReservationResponseUnmarshaller _instance = new CreateReservationResponseUnmarshaller();        

        internal static CreateReservationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateReservationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
