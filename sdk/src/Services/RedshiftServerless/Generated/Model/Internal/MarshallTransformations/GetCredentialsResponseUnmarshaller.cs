...
{
    /// <summary>
    /// Response Unmarshaller for GetCredentials operation
    /// </summary>  
    public class GetCredentialsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("dbPassword", targetDepth))
                {
                    ...
                    response.DbPassword = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    response.NextRefreshTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetCredentialsResponseUnmarshaller _instance = new GetCredentialsResponseUnmarshaller();        

        internal static GetCredentialsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCredentialsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
