...
{
    /// <summary>
    /// Response Unmarshaller for GetReservation operation
    /// </summary>  
    public class GetReservationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetReservationResponseUnmarshaller _instance = new GetReservationResponseUnmarshaller();        

        internal static GetReservationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetReservationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
