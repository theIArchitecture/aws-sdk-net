...
{
    /// <summary>
    /// ListSnapshots Request Marshaller
    /// </summary>       
    public class ListSnapshotsRequestMarshaller : IMarshaller<IRequest, ListSnapshotsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListSnapshotsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListSnapshotsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.RedshiftServerless");
            string target = "RedshiftServerless.ListSnapshots";
            ...
            if(publicRequest.IsSetNamespaceArn())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.NamespaceArn);
            }
        ...
        private static ListSnapshotsRequestMarshaller _instance = new ListSnapshotsRequestMarshaller();        

        internal static ListSnapshotsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSnapshotsRequestMarshaller Instance
        {
            get
            {
                return _instance;
