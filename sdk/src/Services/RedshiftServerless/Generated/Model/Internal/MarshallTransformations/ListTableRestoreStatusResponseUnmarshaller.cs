    ...
    public class ListTableRestoreStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<TableRestoreStatus, TableRestoreStatusUnmarshaller>(TableRestoreStatusUnmarshaller.Instance);
                    response.TableRestoreStatuses = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
