...
namespace Amazon.RedshiftServerless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ManagedWorkgroupListItemUnmarshaller : IJsonUnmarshaller<ManagedWorkgroupListItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ManagedWorkgroupListItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("managedWorkgroupId", targetDepth))
                {
                    ...
                    unmarshalledObject.ManagedWorkgroupId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
