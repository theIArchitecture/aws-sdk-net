...
namespace Amazon.RedshiftServerless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ReservationOfferingUnmarshaller : IJsonUnmarshaller<ReservationOffering, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ReservationOffering Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("hourlyCharge", targetDepth))
                {
                    ...
                    unmarshalledObject.HourlyCharge = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableDoubleUnmarshaller.Instance;
                    unmarshalledObject.UpfrontCharge = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
