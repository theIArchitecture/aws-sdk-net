...
{
    /// <summary>
    /// RestoreTableFromRecoveryPoint Request Marshaller
    /// </summary>       
    public class RestoreTableFromRecoveryPointRequestMarshaller : IMarshaller<IRequest, RestoreTableFromRecoveryPointRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RestoreTableFromRecoveryPointRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RestoreTableFromRecoveryPointRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.RedshiftServerless");
            string target = "RedshiftServerless.RestoreTableFromRecoveryPoint";
            ...
            if(publicRequest.IsSetRecoveryPointId())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.RecoveryPointId);
            }
        ...
        private static RestoreTableFromRecoveryPointRequestMarshaller _instance = new RestoreTableFromRecoveryPointRequestMarshaller();        

        internal static RestoreTableFromRecoveryPointRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RestoreTableFromRecoveryPointRequestMarshaller Instance
        {
            get
            {
                return _instance;
