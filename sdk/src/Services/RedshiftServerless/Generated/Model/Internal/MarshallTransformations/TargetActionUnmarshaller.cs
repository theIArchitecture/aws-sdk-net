...
namespace Amazon.RedshiftServerless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TargetActionUnmarshaller : IJsonUnmarshaller<TargetAction, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TargetAction Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("createSnapshot", targetDepth))
                {
                    ...
                    unmarshalledObject.CreateSnapshot = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
