...
namespace Amazon.RedshiftServerless.Model
{
    ...
    internal sealed partial class ListReservationsPaginator : IPaginator<ListReservationsResponse>, IListReservationsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<Reservation> ReservationsList => 
            new PaginatedResultKeyResponse<ListReservationsResponse, Reservation>(this, (i) => i.ReservationsList ?? new List<Reservation>());

        internal ListReservationsPaginator(IAmazonRedshiftServerless client, ListReservationsRequest request)
        {
            this._client = client;
