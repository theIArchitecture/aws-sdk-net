...
namespace Amazon.Rekognition.Internal
{
    ...
    /// </summary>
    public class AmazonRekognitionEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonRekognitionConfig)requestContext.ClientConfig;
            var result = new RekognitionEndpointParameters();
