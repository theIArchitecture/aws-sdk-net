...
{
    /// <summary>
    /// Response Unmarshaller for AuditImage Object
    /// </summary>  
    public class AuditImageUnmarshaller : IJsonUnmarshaller<AuditImage, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AuditImage Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            AuditImage unmarshalledObject = new AuditImage();
        ...
        private static AuditImageUnmarshaller _instance = new AuditImageUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AuditImageUnmarshaller Instance
        {
            get
            {
                return _instance;
