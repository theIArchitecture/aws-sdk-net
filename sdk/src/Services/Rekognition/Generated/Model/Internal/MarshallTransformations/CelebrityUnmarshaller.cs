...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CelebrityUnmarshaller : IJsonUnmarshaller<Celebrity, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Celebrity Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("MatchConfidence", targetDepth))
                {
                    ...
                    unmarshalledObject.MatchConfidence = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
