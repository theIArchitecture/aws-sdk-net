...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ContentModerationDetectionUnmarshaller : IJsonUnmarshaller<ContentModerationDetection, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ContentModerationDetection Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ContentTypes", targetDepth))
                {
                    ...
                    unmarshalledObject.ContentTypes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("ModerationLabel", targetDepth))
                {
                    ...
                    unmarshalledObject.ModerationLabel = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
