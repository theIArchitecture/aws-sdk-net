...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteProjectPolicyRequestMarshaller : IMarshaller<IRequest, DeleteProjectPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteProjectPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteProjectPolicyRequest publicRequest)
        {
        ...
        private static DeleteProjectPolicyRequestMarshaller _instance = new DeleteProjectPolicyRequestMarshaller();        

        internal static DeleteProjectPolicyRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteProjectPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
