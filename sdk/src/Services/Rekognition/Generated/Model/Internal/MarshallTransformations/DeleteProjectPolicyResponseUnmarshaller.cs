...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteProjectPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteProjectPolicyResponse response = new DeleteProjectPolicyResponse();
        ...
        private static DeleteProjectPolicyResponseUnmarshaller _instance = new DeleteProjectPolicyResponseUnmarshaller();        

        internal static DeleteProjectPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteProjectPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
