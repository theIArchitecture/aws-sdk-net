...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateFaces operation
    /// </summary>  
    public class DisassociateFacesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateFacesResponse response = new DisassociateFacesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DisassociatedFace, DisassociatedFaceUnmarshaller>(DisassociatedFaceUnmarshaller.Instance);
                    response.DisassociatedFaces = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("UnsuccessfulFaceDisassociations", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<UnsuccessfulFaceDisassociation, UnsuccessfulFaceDisassociationUnmarshaller>(UnsuccessfulFaceDisassociationUnmarshaller.Instance);
                    response.UnsuccessfulFaceDisassociations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DisassociateFacesResponseUnmarshaller _instance = new DisassociateFacesResponseUnmarshaller();        

        internal static DisassociateFacesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateFacesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
