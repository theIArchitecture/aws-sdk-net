    ...
    public class GetCelebrityRecognitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<CelebrityRecognition, CelebrityRecognitionUnmarshaller>(CelebrityRecognitionUnmarshaller.Instance);
                    response.Celebrities = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
