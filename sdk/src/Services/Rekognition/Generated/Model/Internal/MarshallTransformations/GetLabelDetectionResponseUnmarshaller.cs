    ...
    public class GetLabelDetectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = GetLabelDetectionRequestMetadataUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<LabelDetection, LabelDetectionUnmarshaller>(LabelDetectionUnmarshaller.Instance);
