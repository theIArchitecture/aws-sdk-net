...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListDatasetLabelsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDatasetLabelsResponse response = new ListDatasetLabelsResponse();
        ...
        private static ListDatasetLabelsResponseUnmarshaller _instance = new ListDatasetLabelsResponseUnmarshaller();        

        internal static ListDatasetLabelsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDatasetLabelsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
