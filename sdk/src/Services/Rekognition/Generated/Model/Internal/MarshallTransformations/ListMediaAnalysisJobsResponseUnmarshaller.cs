...
{
    /// <summary>
    /// Response Unmarshaller for ListMediaAnalysisJobs operation
    /// </summary>  
    public class ListMediaAnalysisJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMediaAnalysisJobsResponse response = new ListMediaAnalysisJobsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<MediaAnalysisJobDescription, MediaAnalysisJobDescriptionUnmarshaller>(MediaAnalysisJobDescriptionUnmarshaller.Instance);
                    response.MediaAnalysisJobs = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListMediaAnalysisJobsResponseUnmarshaller _instance = new ListMediaAnalysisJobsResponseUnmarshaller();        

        internal static ListMediaAnalysisJobsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMediaAnalysisJobsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
