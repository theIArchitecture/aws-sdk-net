...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListProjectPoliciesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListProjectPoliciesResponse response = new ListProjectPoliciesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ProjectPolicies", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<ProjectPolicy, ProjectPolicyUnmarshaller>(ProjectPolicyUnmarshaller.Instance);
                    response.ProjectPolicies = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListProjectPoliciesResponseUnmarshaller _instance = new ListProjectPoliciesResponseUnmarshaller();        

        internal static ListProjectPoliciesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListProjectPoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
