...
{
    /// <summary>
    /// MediaAnalysisDetectModerationLabelsConfig Marshaller
    /// </summary>
    public class MediaAnalysisDetectModerationLabelsConfigMarshaller : IRequestMarshaller<MediaAnalysisDetectModerationLabelsConfig, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(MediaAnalysisDetectModerationLabelsConfig requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetProjectVersion())
            {
                ...
                context.Writer.WriteStringValue(requestObject.ProjectVersion);
            }
        ...
        /// </summary>
        public readonly static MediaAnalysisDetectModerationLabelsConfigMarshaller Instance = new MediaAnalysisDetectModerationLabelsConfigMarshaller();
