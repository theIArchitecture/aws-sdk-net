...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MediaAnalysisDetectModerationLabelsConfigUnmarshaller : IJsonUnmarshaller<MediaAnalysisDetectModerationLabelsConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MediaAnalysisDetectModerationLabelsConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("MinConfidence", targetDepth))
                {
                    ...
                    unmarshalledObject.MinConfidence = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ProjectVersion", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ProjectVersion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
