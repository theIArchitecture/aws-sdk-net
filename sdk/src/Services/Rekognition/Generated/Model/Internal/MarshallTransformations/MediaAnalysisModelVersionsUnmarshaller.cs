...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MediaAnalysisModelVersionsUnmarshaller : IJsonUnmarshaller<MediaAnalysisModelVersions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MediaAnalysisModelVersions Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Moderation", targetDepth))
                {
                    ...
                    unmarshalledObject.Moderation = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
