...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ModerationLabelUnmarshaller : IJsonUnmarshaller<ModerationLabel, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ModerationLabel Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ParentName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("TaxonomyLevel", targetDepth))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.TaxonomyLevel = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
