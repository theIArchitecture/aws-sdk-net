...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class PutProjectPolicyRequestMarshaller : IMarshaller<IRequest, PutProjectPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutProjectPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutProjectPolicyRequest publicRequest)
        {
        ...
        private static PutProjectPolicyRequestMarshaller _instance = new PutProjectPolicyRequestMarshaller();        

        internal static PutProjectPolicyRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutProjectPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
