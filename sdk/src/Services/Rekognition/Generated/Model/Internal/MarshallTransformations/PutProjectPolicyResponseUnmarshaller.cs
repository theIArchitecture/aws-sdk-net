...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutProjectPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutProjectPolicyResponse response = new PutProjectPolicyResponse();
        ...
        private static PutProjectPolicyResponseUnmarshaller _instance = new PutProjectPolicyResponseUnmarshaller();        

        internal static PutProjectPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutProjectPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
