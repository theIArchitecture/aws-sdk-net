...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RegionOfInterestUnmarshaller : IJsonUnmarshaller<RegionOfInterest, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RegionOfInterest Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static RegionOfInterestUnmarshaller _instance = new RegionOfInterestUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RegionOfInterestUnmarshaller Instance
        {
            get
            {
                return _instance;
