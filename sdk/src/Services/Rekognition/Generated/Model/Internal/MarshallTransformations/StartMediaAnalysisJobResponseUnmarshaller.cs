...
{
    /// <summary>
    /// Response Unmarshaller for StartMediaAnalysisJob operation
    /// </summary>  
    public class StartMediaAnalysisJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartMediaAnalysisJobResponse response = new StartMediaAnalysisJobResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidManifestException"))
                {
                    return InvalidManifestExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static StartMediaAnalysisJobResponseUnmarshaller _instance = new StartMediaAnalysisJobResponseUnmarshaller();        

        internal static StartMediaAnalysisJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartMediaAnalysisJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
