...
namespace Amazon.Repostspace
{
    ...
    public partial class AmazonRepostspaceConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("repostspace", "4.0.1.11");
        ...
        /// Default constructor
        /// </summary>
        public AmazonRepostspaceConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonRepostspaceDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "repostspace";
            this.AuthenticationServiceName = "repostspace";
            this.EndpointProvider = new AmazonRepostspaceEndpointProvider();
        }
