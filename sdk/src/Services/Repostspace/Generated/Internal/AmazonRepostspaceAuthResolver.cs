...
namespace Amazon.Repostspace.Internal
{
    ...
    public class AmazonRepostspaceAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonRepostspaceAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Repostspace.
        /// </summary>
        public AmazonRepostspaceAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonRepostspaceAuthSchemeParameters
            {
    ...
    public class AmazonRepostspaceAuthSchemeResolver : IAuthSchemeResolver<AmazonRepostspaceAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonRepostspaceAuthSchemeParameters authParameters)
        {
