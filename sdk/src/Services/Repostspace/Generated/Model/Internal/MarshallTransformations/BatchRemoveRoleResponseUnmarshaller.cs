...
namespace Amazon.Repostspace.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchRemoveRoleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchRemoveRoleResponse response = new BatchRemoveRoleResponse();
        ...
        internal static BatchRemoveRoleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchRemoveRoleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
