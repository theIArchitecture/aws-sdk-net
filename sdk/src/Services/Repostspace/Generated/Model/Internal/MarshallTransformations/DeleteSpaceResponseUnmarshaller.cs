...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSpace operation
    /// </summary>  
    public class DeleteSpaceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSpaceResponse response = new DeleteSpaceResponse();
        ...
        private static DeleteSpaceResponseUnmarshaller _instance = new DeleteSpaceResponseUnmarshaller();        

        internal static DeleteSpaceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSpaceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
