...
{
    /// <summary>
    /// Response Unmarshaller for RegisterAdmin operation
    /// </summary>  
    public class RegisterAdminResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static RegisterAdminResponseUnmarshaller _instance = new RegisterAdminResponseUnmarshaller();        

        internal static RegisterAdminResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterAdminResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
