...
{
    /// <summary>
    /// Response Unmarshaller for SendInvites operation
    /// </summary>  
    public class SendInvitesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static SendInvitesResponseUnmarshaller _instance = new SendInvitesResponseUnmarshaller();        

        internal static SendInvitesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendInvitesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
