...
namespace Amazon.Repostspace.Model
{
    ...
    internal sealed partial class ListChannelsPaginator : IPaginator<ListChannelsResponse>, IListChannelsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<ChannelData> Channels => 
            new PaginatedResultKeyResponse<ListChannelsResponse, ChannelData>(this, (i) => i.Channels ?? new List<ChannelData>());

        internal ListChannelsPaginator(IAmazonRepostspace client, ListChannelsRequest request)
        {
            this._client = client;
