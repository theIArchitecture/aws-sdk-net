...
{
    /// <summary>
    /// Response Unmarshaller for BatchUpdateRecommendationStatus operation
    /// </summary>  
    public class BatchUpdateRecommendationStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchUpdateRecommendationStatusResponse response = new BatchUpdateRecommendationStatusResponse();
        ...
        private static BatchUpdateRecommendationStatusResponseUnmarshaller _instance = new BatchUpdateRecommendationStatusResponseUnmarshaller();        

        internal static BatchUpdateRecommendationStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchUpdateRecommendationStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
