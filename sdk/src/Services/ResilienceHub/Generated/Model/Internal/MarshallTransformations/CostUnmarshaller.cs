...
{
    /// <summary>
    /// Response Unmarshaller for Cost Object
    /// </summary>  
    public class CostUnmarshaller : IJsonUnmarshaller<Cost, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Cost Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            Cost unmarshalledObject = new Cost();
        ...
        private static CostUnmarshaller _instance = new CostUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CostUnmarshaller Instance
        {
            get
            {
                return _instance;
