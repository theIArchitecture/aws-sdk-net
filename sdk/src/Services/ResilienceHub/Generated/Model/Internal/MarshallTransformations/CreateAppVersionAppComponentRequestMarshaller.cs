...
{
    /// <summary>
    /// CreateAppVersionAppComponent Request Marshaller
    /// </summary>       
    public class CreateAppVersionAppComponentRequestMarshaller : IMarshaller<IRequest, CreateAppVersionAppComponentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateAppVersionAppComponentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateAppVersionAppComponentRequest publicRequest)
        {
            ...
            request.ResourcePath = "/create-app-version-app-component";
#if !NETFRAMEWORK
        ...
        private static CreateAppVersionAppComponentRequestMarshaller _instance = new CreateAppVersionAppComponentRequestMarshaller();        

        internal static CreateAppVersionAppComponentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAppVersionAppComponentRequestMarshaller Instance
        {
            get
            {
                return _instance;
