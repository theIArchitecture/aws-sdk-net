...
{
    /// <summary>
    /// Response Unmarshaller for GroupingResource Object
    /// </summary>  
    public class GroupingResourceUnmarshaller : IJsonUnmarshaller<GroupingResource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GroupingResource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            GroupingResource unmarshalledObject = new GroupingResource();
        ...
        private static GroupingResourceUnmarshaller _instance = new GroupingResourceUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static GroupingResourceUnmarshaller Instance
        {
            get
            {
                return _instance;
