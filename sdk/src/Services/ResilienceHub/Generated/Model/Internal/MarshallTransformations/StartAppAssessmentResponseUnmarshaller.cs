...
{
    /// <summary>
    /// Response Unmarshaller for StartAppAssessment operation
    /// </summary>  
    public class StartAppAssessmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartAppAssessmentResponse response = new StartAppAssessmentResponse();
        ...
        private static StartAppAssessmentResponseUnmarshaller _instance = new StartAppAssessmentResponseUnmarshaller();        

        internal static StartAppAssessmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartAppAssessmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
