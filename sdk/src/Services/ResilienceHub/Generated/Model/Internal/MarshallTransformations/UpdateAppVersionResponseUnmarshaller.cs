...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAppVersion operation
    /// </summary>  
    public class UpdateAppVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAppVersionResponse response = new UpdateAppVersionResponse();
        ...
        private static UpdateAppVersionResponseUnmarshaller _instance = new UpdateAppVersionResponseUnmarshaller();        

        internal static UpdateAppVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAppVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
