...
namespace Amazon.ResourceExplorer2.Internal
{
    ...
    public class AmazonResourceExplorer2AuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonResourceExplorer2AuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ResourceExplorer2.
        /// </summary>
        public AmazonResourceExplorer2AuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonResourceExplorer2AuthSchemeParameters
            {
    ...
    public class AmazonResourceExplorer2AuthSchemeResolver : IAuthSchemeResolver<AmazonResourceExplorer2AuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonResourceExplorer2AuthSchemeParameters authParameters)
        {
