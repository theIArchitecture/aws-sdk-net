...
{
    /// <summary>
    /// Response Unmarshaller for DeleteView operation
    /// </summary>  
    public class DeleteViewResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteViewResponseUnmarshaller _instance = new DeleteViewResponseUnmarshaller();        

        internal static DeleteViewResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteViewResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
