...
{
    /// <summary>
    /// Response Unmarshaller for OrgConfiguration Object
    /// </summary>  
    public class OrgConfigurationUnmarshaller : IJsonUnmarshaller<OrgConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public OrgConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static OrgConfigurationUnmarshaller _instance = new OrgConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static OrgConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
