...
namespace Amazon.ResourceExplorer2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResourceCountUnmarshaller : IJsonUnmarshaller<ResourceCount, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResourceCount Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("TotalResources", targetDepth))
                {
                    ...
                    unmarshalledObject.TotalResources = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
