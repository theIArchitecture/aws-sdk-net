...
{
    /// <summary>
    /// Response Unmarshaller for UpdateView operation
    /// </summary>  
    public class UpdateViewResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateViewResponse response = new UpdateViewResponse();
        ...
        private static UpdateViewResponseUnmarshaller _instance = new UpdateViewResponseUnmarshaller();        

        internal static UpdateViewResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateViewResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
