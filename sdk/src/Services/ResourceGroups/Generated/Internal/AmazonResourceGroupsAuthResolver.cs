...
namespace Amazon.ResourceGroups.Internal
{
    ...
    public class AmazonResourceGroupsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonResourceGroupsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ResourceGroups.
        /// </summary>
        public AmazonResourceGroupsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonResourceGroupsAuthSchemeParameters
            {
    ...
    public class AmazonResourceGroupsAuthSchemeResolver : IAuthSchemeResolver<AmazonResourceGroupsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonResourceGroupsAuthSchemeParameters authParameters)
        {
