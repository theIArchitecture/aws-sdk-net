...
{
    /// <summary>
    /// Response Unmarshaller for GetTagSyncTask operation
    /// </summary>  
    public class GetTagSyncTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTagSyncTaskResponse response = new GetTagSyncTaskResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TagValue = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetTagSyncTaskResponseUnmarshaller _instance = new GetTagSyncTaskResponseUnmarshaller();        

        internal static GetTagSyncTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTagSyncTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
