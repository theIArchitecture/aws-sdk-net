...
namespace Amazon.ResourceGroups.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GroupConfigurationItemUnmarshaller : IJsonUnmarshaller<GroupConfigurationItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GroupConfigurationItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<GroupConfigurationParameter, GroupConfigurationParameterUnmarshaller>(GroupConfigurationParameterUnmarshaller.Instance);
