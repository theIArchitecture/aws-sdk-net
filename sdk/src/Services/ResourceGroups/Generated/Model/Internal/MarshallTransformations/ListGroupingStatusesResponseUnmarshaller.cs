...
{
    /// <summary>
    /// Response Unmarshaller for ListGroupingStatuses operation
    /// </summary>  
    public class ListGroupingStatusesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListGroupingStatusesResponse response = new ListGroupingStatusesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("GroupingStatuses", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<GroupingStatusesItem, GroupingStatusesItemUnmarshaller>(GroupingStatusesItemUnmarshaller.Instance);
                    response.GroupingStatuses = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListGroupingStatusesResponseUnmarshaller _instance = new ListGroupingStatusesResponseUnmarshaller();        

        internal static ListGroupingStatusesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListGroupingStatusesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
