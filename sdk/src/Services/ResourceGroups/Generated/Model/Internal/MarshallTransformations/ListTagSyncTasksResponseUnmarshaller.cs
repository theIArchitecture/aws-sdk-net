...
{
    /// <summary>
    /// Response Unmarshaller for ListTagSyncTasks operation
    /// </summary>  
    public class ListTagSyncTasksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTagSyncTasksResponse response = new ListTagSyncTasksResponse();
        ...
        private static ListTagSyncTasksResponseUnmarshaller _instance = new ListTagSyncTasksResponseUnmarshaller();        

        internal static ListTagSyncTasksResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTagSyncTasksResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
