...
namespace Amazon.ResourceGroups.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResourceStatusUnmarshaller : IJsonUnmarshaller<ResourceStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResourceStatus Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
