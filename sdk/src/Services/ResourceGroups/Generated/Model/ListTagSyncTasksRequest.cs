...
{
    /// <summary>
    /// Container for the parameters to the ListTagSyncTasks operation.
    ...
    ///  </li> </ul>
    /// </summary>
    public partial class ListTagSyncTasksRequest : AmazonResourceGroupsRequest
    {
        private List<ListTagSyncTasksFilter> _filters = AWSConfigs.InitializeCollections ? new List<ListTagSyncTasksFilter>() : null;
        ...
        /// to return a list of tag-sync tasks. 
        /// </para>
        /// <para />
        ...
        /// </summary>
        public List<ListTagSyncTasksFilter> Filters
        {
