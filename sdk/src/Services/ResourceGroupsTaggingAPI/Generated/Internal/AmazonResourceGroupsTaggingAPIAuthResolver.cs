...
namespace Amazon.ResourceGroupsTaggingAPI.Internal
{
    ...
    public class AmazonResourceGroupsTaggingAPIAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonResourceGroupsTaggingAPIAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ResourceGroupsTaggingAPI.
        /// </summary>
        public AmazonResourceGroupsTaggingAPIAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonResourceGroupsTaggingAPIAuthSchemeParameters
            {
    ...
    public class AmazonResourceGroupsTaggingAPIAuthSchemeResolver : IAuthSchemeResolver<AmazonResourceGroupsTaggingAPIAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonResourceGroupsTaggingAPIAuthSchemeParameters authParameters)
        {
