...
{
    /// <summary>
    /// Amazon ResourceGroupsTaggingAPI endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for ResourceGroupsTaggingAPI service requests.
    /// Collects values for ResourceGroupsTaggingAPIEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses ResourceGroupsTaggingAPIEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonResourceGroupsTaggingAPIEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonResourceGroupsTaggingAPIConfig)requestContext.ClientConfig;
            var result = new ResourceGroupsTaggingAPIEndpointParameters();
