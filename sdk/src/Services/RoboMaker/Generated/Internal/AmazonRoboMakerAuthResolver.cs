...
namespace Amazon.RoboMaker.Internal
{
    ...
    public class AmazonRoboMakerAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonRoboMakerAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for RoboMaker.
        /// </summary>
        public AmazonRoboMakerAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonRoboMakerAuthSchemeParameters
            {
    ...
    public class AmazonRoboMakerAuthSchemeResolver : IAuthSchemeResolver<AmazonRoboMakerAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonRoboMakerAuthSchemeParameters authParameters)
        {
