...
namespace Amazon.RoboMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ComputeResponseUnmarshaller : IJsonUnmarshaller<ComputeResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ComputeResponse Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("gpuUnitLimit", targetDepth))
                {
                    ...
                    unmarshalledObject.GpuUnitLimit = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("simulationUnitLimit", targetDepth))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.SimulationUnitLimit = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
