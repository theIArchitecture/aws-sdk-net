        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("batchPolicy", targetDepth))
                {
                    ...
                    response.BatchPolicy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("createdRequests", targetDepth))
                {
                    ...
                    response.CreatedRequests = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("failedRequests", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<FailedCreateSimulationJobRequest, FailedCreateSimulationJobRequestUnmarshaller>(FailedCreateSimulationJobRequestUnmarshaller.Instance);
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SimulationJobRequest, SimulationJobRequestUnmarshaller>(SimulationJobRequestUnmarshaller.Instance);
