...
namespace Amazon.RoboMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FinishedWorldsSummaryUnmarshaller : IJsonUnmarshaller<FinishedWorldsSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FinishedWorldsSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("failureSummary", targetDepth))
                {
                    ...
                    unmarshalledObject.FailureSummary = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("finishedCount", targetDepth))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.FinishedCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("succeededWorlds", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.SucceededWorlds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
