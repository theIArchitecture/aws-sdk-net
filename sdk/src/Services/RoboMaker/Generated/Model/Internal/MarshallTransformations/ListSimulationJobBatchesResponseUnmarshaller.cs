    ...
    public class ListSimulationJobBatchesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SimulationJobBatchSummary, SimulationJobBatchSummaryUnmarshaller>(SimulationJobBatchSummaryUnmarshaller.Instance);
                    response.SimulationJobBatchSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
