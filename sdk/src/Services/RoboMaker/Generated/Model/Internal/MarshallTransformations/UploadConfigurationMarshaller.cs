...
namespace Amazon.RoboMaker.Model.Internal.MarshallTransformations
{
    ...
    public class UploadConfigurationMarshaller : IRequestMarshaller<UploadConfiguration, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(UploadConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetUploadBehavior())
            {
                context.Writer.WritePropertyName("uploadBehavior");
                context.Writer.WriteStringValue(requestObject.UploadBehavior);
            }
