...
namespace Amazon.RoboMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UploadConfigurationUnmarshaller : IJsonUnmarshaller<UploadConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public UploadConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.UploadBehavior = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
