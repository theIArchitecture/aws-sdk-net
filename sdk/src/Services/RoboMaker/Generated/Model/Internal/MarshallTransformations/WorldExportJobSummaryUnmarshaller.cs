...
namespace Amazon.RoboMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class WorldExportJobSummaryUnmarshaller : IJsonUnmarshaller<WorldExportJobSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public WorldExportJobSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("worlds", targetDepth))
                {
                    ...
                    unmarshalledObject.Worlds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
