...
namespace Amazon.RoboMaker.Model
{
    ...
    public partial class ListWorldTemplatesRequest : AmazonRoboMakerRequest
    {
        ...
        /// <para>
        /// When this parameter is used, <c>ListWorldTemplates</c> only returns <c>maxResults</c>
        /// results in a single page along with a <c>nextToken</c> response element. The remaining
        /// results of the initial request can be seen by sending another <c>ListWorldTemplates</c>
        /// request with the returned <c>nextToken</c> value. This value can be between 1 and
        /// 100. If this parameter is not used, then <c>ListWorldTemplates</c> returns up to 100
