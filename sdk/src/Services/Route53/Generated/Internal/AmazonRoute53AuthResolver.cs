...
namespace Amazon.Route53.Internal
{
    ...
    public class AmazonRoute53AuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonRoute53AuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Route53.
        /// </summary>
        public AmazonRoute53AuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonRoute53AuthSchemeParameters
            {
    ...
    public class AmazonRoute53AuthSchemeResolver : IAuthSchemeResolver<AmazonRoute53AuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonRoute53AuthSchemeParameters authParameters)
        {
