...
namespace Amazon.Route53.Model
{
    ...
    public partial class HealthCheckVersionMismatchException : AmazonRoute53Exception
    {
        ...
        public HealthCheckVersionMismatchException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public HealthCheckVersionMismatchException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
