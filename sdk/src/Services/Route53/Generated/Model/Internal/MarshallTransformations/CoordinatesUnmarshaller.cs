...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    public partial class CoordinatesUnmarshaller : IXmlUnmarshaller<Coordinates, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public Coordinates Unmarshall(XmlUnmarshallerContext context)
        {
            Coordinates unmarshalledObject = new Coordinates();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CoordinatesUnmarshaller Instance
        {
            get
            {
                return _instance;
