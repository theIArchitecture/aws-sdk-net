...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    public partial class CreateCidrCollectionResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        {
            CreateCidrCollectionResponse response = new CreateCidrCollectionResponse();
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, CreateCidrCollectionResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = CidrCollectionUnmarshaller.Instance;
                        response.Collection = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                if (errorResponse.Code != null && errorResponse.Code.Equals("CidrCollectionAlreadyExistsException"))
                {
                    return CidrCollectionAlreadyExistsExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCidrCollectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
