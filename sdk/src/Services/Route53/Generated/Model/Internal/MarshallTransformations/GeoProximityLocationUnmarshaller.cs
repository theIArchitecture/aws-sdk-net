...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    public partial class GeoProximityLocationUnmarshaller : IXmlUnmarshaller<GeoProximityLocation, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public GeoProximityLocation Unmarshall(XmlUnmarshallerContext context)
        {
            GeoProximityLocation unmarshalledObject = new GeoProximityLocation();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.LocalZoneGroup = unmarshaller.Unmarshall(context);
                        continue;
                    }
                    if (context.TestExpression("Coordinates", targetDepth))
                    {
                        var unmarshaller = CoordinatesUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GeoProximityLocationUnmarshaller Instance
        {
            get
            {
                return _instance;
