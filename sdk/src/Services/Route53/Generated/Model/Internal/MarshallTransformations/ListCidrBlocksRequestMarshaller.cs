...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    public partial class ListCidrBlocksRequestMarshaller : IMarshaller<IRequest, ListCidrBlocksRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((ListCidrBlocksRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListCidrBlocksRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetLocationName())
                request.Parameters.Add("location", StringUtils.FromString(publicRequest.LocationName));
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCidrBlocksRequestMarshaller Instance
        {
            get
            {
                return _instance;
