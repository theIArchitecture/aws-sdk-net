...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public partial class ListTrafficPolicyVersionsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, ListTrafficPolicyVersionsResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        if (response.TrafficPolicies == null)
                        {
                            response.TrafficPolicies = new List<TrafficPolicy>();
                        }
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, ListTrafficPolicyVersionsResponse response);
