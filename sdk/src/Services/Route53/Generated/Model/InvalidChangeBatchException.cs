...
namespace Amazon.Route53.Model
{
    ...
    public partial class InvalidChangeBatchException : AmazonRoute53Exception
    {
        ...
        public InvalidChangeBatchException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidChangeBatchException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
