...
namespace Amazon.Route53.Model
{
    ...
    public partial class InvalidKeySigningKeyStatusException : AmazonRoute53Exception
    {
        ...
        public InvalidKeySigningKeyStatusException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidKeySigningKeyStatusException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
