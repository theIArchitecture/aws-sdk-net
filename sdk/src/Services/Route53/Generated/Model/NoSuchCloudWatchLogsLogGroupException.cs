...
namespace Amazon.Route53.Model
{
    ...
    public partial class NoSuchCloudWatchLogsLogGroupException : AmazonRoute53Exception
    {
        ...
        public NoSuchCloudWatchLogsLogGroupException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NoSuchCloudWatchLogsLogGroupException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
