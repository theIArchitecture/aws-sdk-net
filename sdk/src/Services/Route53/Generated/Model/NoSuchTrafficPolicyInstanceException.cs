...
namespace Amazon.Route53.Model
{
    ...
    public partial class NoSuchTrafficPolicyInstanceException : AmazonRoute53Exception
    {
        ...
        public NoSuchTrafficPolicyInstanceException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NoSuchTrafficPolicyInstanceException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
