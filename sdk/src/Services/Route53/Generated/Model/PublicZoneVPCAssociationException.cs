...
namespace Amazon.Route53.Model
{
    ...
    public partial class PublicZoneVPCAssociationException : AmazonRoute53Exception
    {
        ...
        public PublicZoneVPCAssociationException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public PublicZoneVPCAssociationException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
