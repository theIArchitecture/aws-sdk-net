...
namespace Amazon.Route53.Model
{
    ...
    public partial class QueryLoggingConfigAlreadyExistsException : AmazonRoute53Exception
    {
        ...
        public QueryLoggingConfigAlreadyExistsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public QueryLoggingConfigAlreadyExistsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
