...
namespace Amazon.Route53.Model
{
    ...
    public partial class TooManyHealthChecksException : AmazonRoute53Exception
    {
        ...
        public TooManyHealthChecksException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TooManyHealthChecksException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
