...
namespace Amazon.Route53.Model
{
    ...
    public partial class TooManyTrafficPoliciesException : AmazonRoute53Exception
    {
        ...
        public TooManyTrafficPoliciesException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TooManyTrafficPoliciesException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
