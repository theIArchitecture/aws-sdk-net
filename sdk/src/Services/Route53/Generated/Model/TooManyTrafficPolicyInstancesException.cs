...
namespace Amazon.Route53.Model
{
    ...
    public partial class TooManyTrafficPolicyInstancesException : AmazonRoute53Exception
    {
        ...
        public TooManyTrafficPolicyInstancesException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TooManyTrafficPolicyInstancesException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
