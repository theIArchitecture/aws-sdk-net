...
namespace Amazon.Route53.Model
{
    ...
    internal sealed partial class ListCidrLocationsPaginator : IPaginator<ListCidrLocationsResponse>, IListCidrLocationsPaginator
    {
        ...
        async IAsyncEnumerable<ListCidrLocationsResponse> IPaginator<ListCidrLocationsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
