...
namespace Amazon.Route53Domains
{
    ...
    public partial class AmazonRoute53DomainsException : AmazonServiceException
    {
        ...
        public AmazonRoute53DomainsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonRoute53DomainsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
