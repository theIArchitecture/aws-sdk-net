...
namespace Amazon.Route53Domains.Internal
{
    ...
    public class AmazonRoute53DomainsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonRoute53DomainsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Route53Domains.
        /// </summary>
        public AmazonRoute53DomainsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonRoute53DomainsAuthSchemeParameters
            {
    ...
    public class AmazonRoute53DomainsAuthSchemeResolver : IAuthSchemeResolver<AmazonRoute53DomainsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonRoute53DomainsAuthSchemeParameters authParameters)
        {
