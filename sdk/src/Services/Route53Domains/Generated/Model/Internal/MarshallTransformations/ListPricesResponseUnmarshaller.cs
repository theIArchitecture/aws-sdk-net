    ...
    public class ListPricesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DomainPrice, DomainPriceUnmarshaller>(DomainPriceUnmarshaller.Instance);
                    response.Prices = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
