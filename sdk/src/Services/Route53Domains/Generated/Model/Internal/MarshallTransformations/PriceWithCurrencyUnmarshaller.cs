...
namespace Amazon.Route53Domains.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PriceWithCurrencyUnmarshaller : IJsonUnmarshaller<PriceWithCurrency, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PriceWithCurrency Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
