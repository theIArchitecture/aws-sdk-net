...
{
    /// <summary>
    /// Response Unmarshaller for PushDomain operation
    /// </summary>  
    public class PushDomainResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PushDomainResponse response = new PushDomainResponse();
        ...
        private static PushDomainResponseUnmarshaller _instance = new PushDomainResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PushDomainResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
