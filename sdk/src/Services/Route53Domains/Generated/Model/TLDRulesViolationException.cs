...
namespace Amazon.Route53Domains.Model
{
    ...
    public partial class TLDRulesViolationException : AmazonRoute53DomainsException
    {
        ...
        public TLDRulesViolationException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TLDRulesViolationException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
