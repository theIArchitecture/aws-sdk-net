...
{
    /// <summary>
    /// Configuration for accessing Amazon Route53Profiles service
    /// </summary>
    public partial class AmazonRoute53ProfilesConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Route53Profiles", "4.0.1.5");
        ...
        /// Default constructor
        /// </summary>
        public AmazonRoute53ProfilesConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonRoute53ProfilesDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "Route53Profiles";
            this.AuthenticationServiceName = "route53profiles";
            this.EndpointProvider = new AmazonRoute53ProfilesEndpointProvider();
        }
