...
namespace Amazon.Route53Profiles.Internal
{
    ...
    public class AmazonRoute53ProfilesAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonRoute53ProfilesAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Route53Profiles.
        /// </summary>
        public AmazonRoute53ProfilesAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonRoute53ProfilesAuthSchemeParameters
            {
    ...
    public class AmazonRoute53ProfilesAuthSchemeResolver : IAuthSchemeResolver<AmazonRoute53ProfilesAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonRoute53ProfilesAuthSchemeParameters authParameters)
        {
