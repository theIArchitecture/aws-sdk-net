...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateResourceFromProfile operation
    /// </summary>  
    public class DisassociateResourceFromProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateResourceFromProfileResponse response = new DisassociateResourceFromProfileResponse();
        ...
        private static DisassociateResourceFromProfileResponseUnmarshaller _instance = new DisassociateResourceFromProfileResponseUnmarshaller();        

        internal static DisassociateResourceFromProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateResourceFromProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
