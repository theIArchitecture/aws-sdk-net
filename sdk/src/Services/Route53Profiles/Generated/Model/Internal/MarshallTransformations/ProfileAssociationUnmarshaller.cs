...
{
    /// <summary>
    /// Response Unmarshaller for ProfileAssociation Object
    /// </summary>  
    public class ProfileAssociationUnmarshaller : IJsonUnmarshaller<ProfileAssociation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ProfileAssociation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static ProfileAssociationUnmarshaller _instance = new ProfileAssociationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ProfileAssociationUnmarshaller Instance
        {
            get
            {
                return _instance;
