...
namespace Amazon.Route53Profiles.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateProfileResourceAssociationRequestMarshaller : IMarshaller<IRequest, UpdateProfileResourceAssociationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static UpdateProfileResourceAssociationRequestMarshaller _instance = new UpdateProfileResourceAssociationRequestMarshaller();        

        internal static UpdateProfileResourceAssociationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateProfileResourceAssociationRequestMarshaller Instance
        {
            get
            {
                return _instance;
