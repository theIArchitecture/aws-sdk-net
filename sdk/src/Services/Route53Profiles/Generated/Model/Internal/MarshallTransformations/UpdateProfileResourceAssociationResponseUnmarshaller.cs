...
{
    /// <summary>
    /// Response Unmarshaller for UpdateProfileResourceAssociation operation
    /// </summary>  
    public class UpdateProfileResourceAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateProfileResourceAssociationResponse response = new UpdateProfileResourceAssociationResponse();
        ...
        private static UpdateProfileResourceAssociationResponseUnmarshaller _instance = new UpdateProfileResourceAssociationResponseUnmarshaller();        

        internal static UpdateProfileResourceAssociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateProfileResourceAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
