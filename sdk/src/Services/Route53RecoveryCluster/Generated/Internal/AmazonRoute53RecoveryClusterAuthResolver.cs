...
namespace Amazon.Route53RecoveryCluster.Internal
{
    ...
    public class AmazonRoute53RecoveryClusterAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonRoute53RecoveryClusterAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Route53RecoveryCluster.
        /// </summary>
        public AmazonRoute53RecoveryClusterAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonRoute53RecoveryClusterAuthSchemeParameters
            {
    ...
    public class AmazonRoute53RecoveryClusterAuthSchemeResolver : IAuthSchemeResolver<AmazonRoute53RecoveryClusterAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonRoute53RecoveryClusterAuthSchemeParameters authParameters)
        {
