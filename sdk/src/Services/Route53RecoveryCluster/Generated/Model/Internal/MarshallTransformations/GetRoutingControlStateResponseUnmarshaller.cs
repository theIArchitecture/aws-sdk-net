...
{
    /// <summary>
    /// Response Unmarshaller for GetRoutingControlState operation
    /// </summary>  
    public class GetRoutingControlStateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRoutingControlStateResponse response = new GetRoutingControlStateResponse();
        ...
        private static GetRoutingControlStateResponseUnmarshaller _instance = new GetRoutingControlStateResponseUnmarshaller();        

        internal static GetRoutingControlStateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRoutingControlStateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
