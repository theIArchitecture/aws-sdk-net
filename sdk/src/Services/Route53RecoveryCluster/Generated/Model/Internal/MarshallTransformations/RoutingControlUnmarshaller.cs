...
{
    /// <summary>
    /// Response Unmarshaller for RoutingControl Object
    /// </summary>  
    public class RoutingControlUnmarshaller : IJsonUnmarshaller<RoutingControl, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RoutingControl Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ControlPanelName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RoutingControlArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("RoutingControlName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RoutingControlName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("RoutingControlState", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RoutingControlState = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static RoutingControlUnmarshaller _instance = new RoutingControlUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RoutingControlUnmarshaller Instance
        {
            get
            {
                return _instance;
