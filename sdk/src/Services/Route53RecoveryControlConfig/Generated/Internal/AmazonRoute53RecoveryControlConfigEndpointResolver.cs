...
{
    /// <summary>
    /// Amazon Route53RecoveryControlConfig endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for Route53RecoveryControlConfig service requests.
    /// Collects values for Route53RecoveryControlConfigEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses Route53RecoveryControlConfigEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonRoute53RecoveryControlConfigEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonRoute53RecoveryControlConfigConfig)requestContext.ClientConfig;
            var result = new Route53RecoveryControlConfigEndpointParameters();
