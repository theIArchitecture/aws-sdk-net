...
namespace Amazon.Route53RecoveryControlConfig.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ClusterEndpointUnmarshaller : IJsonUnmarshaller<ClusterEndpoint, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ClusterEndpoint Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
