...
namespace Amazon.Route53RecoveryControlConfig.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ControlPanelUnmarshaller : IJsonUnmarshaller<ControlPanel, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ControlPanel Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("DefaultControlPanel", targetDepth))
                {
                    ...
                    unmarshalledObject.DefaultControlPanel = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("RoutingControlCount", targetDepth))
                {
                    ...
                    unmarshalledObject.RoutingControlCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
