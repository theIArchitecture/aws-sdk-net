...
{
    /// <summary>
    /// DescribeRoutingControl Request Marshaller
    /// </summary>       
    public class DescribeRoutingControlRequestMarshaller : IMarshaller<IRequest, DescribeRoutingControlRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeRoutingControlRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeRoutingControlRequest publicRequest)
        {
        ...
        private static DescribeRoutingControlRequestMarshaller _instance = new DescribeRoutingControlRequestMarshaller();        

        internal static DescribeRoutingControlRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeRoutingControlRequestMarshaller Instance
        {
            get
            {
                return _instance;
