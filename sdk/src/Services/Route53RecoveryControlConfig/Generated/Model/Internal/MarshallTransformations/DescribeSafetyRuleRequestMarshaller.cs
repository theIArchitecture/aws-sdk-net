...
namespace Amazon.Route53RecoveryControlConfig.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeSafetyRuleRequestMarshaller : IMarshaller<IRequest, DescribeSafetyRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DescribeSafetyRuleRequestMarshaller _instance = new DescribeSafetyRuleRequestMarshaller();        

        internal static DescribeSafetyRuleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSafetyRuleRequestMarshaller Instance
        {
            get
            {
                return _instance;
