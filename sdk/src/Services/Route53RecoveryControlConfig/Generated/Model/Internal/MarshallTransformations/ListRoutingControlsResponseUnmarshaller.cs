    ...
    public class ListRoutingControlsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<RoutingControl, RoutingControlUnmarshaller>(RoutingControlUnmarshaller.Instance);
                    response.RoutingControls = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
