...
namespace Amazon.Route53RecoveryControlConfig.Model
{
    ...
    internal sealed partial class ListAssociatedRoute53HealthChecksPaginator : IPaginator<ListAssociatedRoute53HealthChecksResponse>, IListAssociatedRoute53HealthChecksPaginator
    {
        ...
        public IPaginatedEnumerable<string> HealthCheckIds => 
            new PaginatedResultKeyResponse<ListAssociatedRoute53HealthChecksResponse, string>(this, (i) => i.HealthCheckIds ?? new List<string>());
        ...
        async IAsyncEnumerable<ListAssociatedRoute53HealthChecksResponse> IPaginator<ListAssociatedRoute53HealthChecksResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
