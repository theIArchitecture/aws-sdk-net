...
namespace Amazon.Route53RecoveryControlConfig.Model
{
    ...
    internal sealed partial class ListControlPanelsPaginator : IPaginator<ListControlPanelsResponse>, IListControlPanelsPaginator
    {
        ...
        async IAsyncEnumerable<ListControlPanelsResponse> IPaginator<ListControlPanelsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
