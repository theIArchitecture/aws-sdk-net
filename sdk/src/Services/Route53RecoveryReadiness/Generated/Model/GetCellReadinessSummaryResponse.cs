...
{
    /// <summary>
    /// This is the response object from the GetCellReadinessSummary operation.
    /// </summary>
    public partial class GetCellReadinessSummaryResponse : AmazonWebServiceResponse
    {
        private string _nextToken;
        private Readiness _readiness;
        private List<ReadinessCheckSummary> _readinessChecks = AWSConfigs.InitializeCollections ? new List<ReadinessCheckSummary>() : null;
        ...
        {
            get { return this._readinessChecks; }
            set { this._readinessChecks = value; }
        }
