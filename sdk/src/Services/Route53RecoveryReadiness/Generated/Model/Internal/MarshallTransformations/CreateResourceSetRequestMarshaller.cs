...
{
    /// <summary>
    /// CreateResourceSet Request Marshaller
    /// </summary>       
    public class CreateResourceSetRequestMarshaller : IMarshaller<IRequest, CreateResourceSetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateResourceSetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateResourceSetRequest publicRequest)
        {
        ...
        private static CreateResourceSetRequestMarshaller _instance = new CreateResourceSetRequestMarshaller();        

        internal static CreateResourceSetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateResourceSetRequestMarshaller Instance
        {
            get
            {
                return _instance;
