...
{
    /// <summary>
    /// DeleteCell Request Marshaller
    /// </summary>       
    public class DeleteCellRequestMarshaller : IMarshaller<IRequest, DeleteCellRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteCellRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteCellRequest publicRequest)
        {
        ...
        private static DeleteCellRequestMarshaller _instance = new DeleteCellRequestMarshaller();        

        internal static DeleteCellRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCellRequestMarshaller Instance
        {
            get
            {
                return _instance;
