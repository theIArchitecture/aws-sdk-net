...
namespace Amazon.Route53RecoveryReadiness.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteReadinessCheckRequestMarshaller : IMarshaller<IRequest, DeleteReadinessCheckRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteReadinessCheckRequestMarshaller _instance = new DeleteReadinessCheckRequestMarshaller();        

        internal static DeleteReadinessCheckRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteReadinessCheckRequestMarshaller Instance
        {
            get
            {
                return _instance;
