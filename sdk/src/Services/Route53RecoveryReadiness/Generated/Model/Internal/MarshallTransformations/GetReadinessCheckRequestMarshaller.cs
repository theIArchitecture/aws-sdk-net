...
{
    /// <summary>
    /// GetReadinessCheck Request Marshaller
    /// </summary>       
    public class GetReadinessCheckRequestMarshaller : IMarshaller<IRequest, GetReadinessCheckRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetReadinessCheckRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetReadinessCheckRequest publicRequest)
        {
        ...
        private static GetReadinessCheckRequestMarshaller _instance = new GetReadinessCheckRequestMarshaller();        

        internal static GetReadinessCheckRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetReadinessCheckRequestMarshaller Instance
        {
            get
            {
                return _instance;
