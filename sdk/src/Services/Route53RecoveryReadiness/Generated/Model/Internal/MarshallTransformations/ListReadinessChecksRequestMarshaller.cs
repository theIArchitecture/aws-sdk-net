...
namespace Amazon.Route53RecoveryReadiness.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListReadinessChecksRequestMarshaller : IMarshaller<IRequest, ListReadinessChecksRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListReadinessChecksRequestMarshaller _instance = new ListReadinessChecksRequestMarshaller();        

        internal static ListReadinessChecksRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListReadinessChecksRequestMarshaller Instance
        {
            get
            {
                return _instance;
