...
{
    /// <summary>
    /// UpdateCell Request Marshaller
    /// </summary>       
    public class UpdateCellRequestMarshaller : IMarshaller<IRequest, UpdateCellRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateCellRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateCellRequest publicRequest)
        {
        ...
        private static UpdateCellRequestMarshaller _instance = new UpdateCellRequestMarshaller();        

        internal static UpdateCellRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCellRequestMarshaller Instance
        {
            get
            {
                return _instance;
