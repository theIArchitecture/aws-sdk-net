...
namespace Amazon.Route53Resolver.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FirewallDomainListUnmarshaller : IJsonUnmarshaller<FirewallDomainList, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FirewallDomainList Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("DomainCount", targetDepth))
                {
                    ...
                    unmarshalledObject.DomainCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
