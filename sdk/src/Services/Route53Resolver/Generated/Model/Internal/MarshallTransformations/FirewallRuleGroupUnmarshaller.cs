...
{
    /// <summary>
    /// Response Unmarshaller for FirewallRuleGroup Object
    /// </summary>  
    public class FirewallRuleGroupUnmarshaller : IJsonUnmarshaller<FirewallRuleGroup, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FirewallRuleGroup Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            FirewallRuleGroup unmarshalledObject = new FirewallRuleGroup();
        ...
        private static FirewallRuleGroupUnmarshaller _instance = new FirewallRuleGroupUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static FirewallRuleGroupUnmarshaller Instance
        {
            get
            {
                return _instance;
