...
namespace Amazon.Route53Resolver.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IpAddressResponseUnmarshaller : IJsonUnmarshaller<IpAddressResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IpAddressResponse Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.IpId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
