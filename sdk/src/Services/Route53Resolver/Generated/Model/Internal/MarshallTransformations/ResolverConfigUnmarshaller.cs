...
namespace Amazon.Route53Resolver.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResolverConfigUnmarshaller : IJsonUnmarshaller<ResolverConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResolverConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AutodefinedReverse", targetDepth))
                {
                    ...
                    unmarshalledObject.AutodefinedReverse = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
