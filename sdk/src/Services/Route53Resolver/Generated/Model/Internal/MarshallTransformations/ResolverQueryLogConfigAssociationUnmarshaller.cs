...
namespace Amazon.Route53Resolver.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResolverQueryLogConfigAssociationUnmarshaller : IJsonUnmarshaller<ResolverQueryLogConfigAssociation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResolverQueryLogConfigAssociation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ResolverQueryLogConfigId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
