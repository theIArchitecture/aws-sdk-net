...
{
    /// <summary>
    /// UpdateFirewallDomains Request Marshaller
    /// </summary>       
    public class UpdateFirewallDomainsRequestMarshaller : IMarshaller<IRequest, UpdateFirewallDomainsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateFirewallDomainsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateFirewallDomainsRequest publicRequest)
        {
        ...
        private static UpdateFirewallDomainsRequestMarshaller _instance = new UpdateFirewallDomainsRequestMarshaller();        

        internal static UpdateFirewallDomainsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFirewallDomainsRequestMarshaller Instance
        {
            get
            {
                return _instance;
