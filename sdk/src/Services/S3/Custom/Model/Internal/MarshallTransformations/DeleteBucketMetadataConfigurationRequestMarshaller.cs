...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    public class DeleteBucketMetadataConfigurationRequestMarshaller : IMarshaller<IRequest, DeleteBucketMetadataConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((DeleteBucketMetadataConfigurationRequest)input);
        }
        ...
        internal static DeleteBucketMetadataConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteBucketMetadataConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
