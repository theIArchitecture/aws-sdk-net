...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    public class GetBucketMetadataConfigurationResponseUnmarshaller : S3ReponseUnmarshaller
    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, GetBucketMetadataConfigurationResponse response)
        {
            ...
            while (context.Read())
            {
                ...
                {
                    if (context.TestExpression("GetBucketMetadataConfigurationResult", targetDepth))
                    {
                        var unmarshaller = GetBucketMetadataConfigurationResultUnmarshaller.Instance;
                        response.GetBucketMetadataConfigurationResult = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBucketMetadataConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
