...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public partial class GetObjectTaggingResponseUnmarshaller : S3ReponseUnmarshaller
    {
        /// <summary>
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, GetObjectTaggingResponse response)
        {
            ...
            while (context.Read())
            {
                ...
                {
                    if (context.TestExpression("TagSet/Tag", targetDepth))
                    {
                        ...
                        response.Tagging.Add(unmarshaller.Unmarshall(context));
                        continue;
                    }
                }
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, GetObjectTaggingResponse response);

        private static GetObjectTaggingResponseUnmarshaller _instance = new GetObjectTaggingResponseUnmarshaller();        

        internal static GetObjectTaggingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
