...
{
    /// <summary>
    /// Response Unmarshaller for LifecycleFilter Object
    /// </summary>  
    public partial class LifecycleFilterUnmarshaller : IXmlUnmarshaller<LifecycleFilter, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public LifecycleFilter Unmarshall(XmlUnmarshallerContext context)
        {
            LifecycleFilter unmarshalledObject = new LifecycleFilter();
        ...
        partial void XmlStructureUnmarshallCustomization(XmlUnmarshallerContext context, LifecycleFilter unmarshalledObject, int targetDepth);

        private static LifecycleFilterUnmarshaller _instance = new LifecycleFilterUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static LifecycleFilterUnmarshaller Instance
        {
            get
            {
                return _instance;
