...
{
    /// <summary>
    /// Response Unmarshaller for NoSuchKeyException operation
    /// </summary>  
    public class NoSuchKeyExceptionUnmarshaller : IXmlErrorResponseUnmarshaller<NoSuchKeyException, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public NoSuchKeyException Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static NoSuchKeyExceptionUnmarshaller _instance = new NoSuchKeyExceptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static NoSuchKeyExceptionUnmarshaller Instance
        {
            get
            {
                return _instance;
