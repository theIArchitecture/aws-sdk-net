...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    public partial class ServerSideEncryptionConfigurationUnmarshaller : IXmlUnmarshaller<ServerSideEncryptionConfiguration, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ServerSideEncryptionConfiguration Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        if (unmarshalledObject.ServerSideEncryptionRules == null)
                        {
                            unmarshalledObject.ServerSideEncryptionRules = new List<ServerSideEncryptionRule>();
                        }
                        var unmarshaller = ServerSideEncryptionRuleUnmarshaller.Instance;
