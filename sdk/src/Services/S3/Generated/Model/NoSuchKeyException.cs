...
namespace Amazon.S3.Model
{
    ...
    [Serializable]
    #endif
    public partial class NoSuchKeyException : AmazonS3Exception
    {

        /// <summary>
        /// Constructs a new NoSuchKeyException with the specified error
        /// message.
        /// </summary>
        /// <param name="message">
        ...
        /// </summary>
        /// <param name="innerException"></param>
        public NoSuchKeyException(Exception innerException) 
            : base(innerException) {}
        ...
        public NoSuchKeyException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NoSuchKeyException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
            : base(message, errorType, errorCode, requestId, statusCode) {}


#if !NETSTANDARD
        /// <summary>
        /// Constructs a new instance of the NoSuchKeyException class with serialized data.
        /// </summary>
