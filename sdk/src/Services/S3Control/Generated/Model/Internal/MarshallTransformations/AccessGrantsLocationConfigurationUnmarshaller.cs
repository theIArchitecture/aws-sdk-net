...
namespace Amazon.S3Control.Model.Internal.MarshallTransformations
{
    ...
    public partial class AccessGrantsLocationConfigurationUnmarshaller : IXmlUnmarshaller<AccessGrantsLocationConfiguration, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public AccessGrantsLocationConfiguration Unmarshall(XmlUnmarshallerContext context)
        {
            AccessGrantsLocationConfiguration unmarshalledObject = new AccessGrantsLocationConfiguration();
            ...
            while (context.Read())
            {
                ...
                {
                    if (context.TestExpression("S3SubPrefix", targetDepth))
                    {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AccessGrantsLocationConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
