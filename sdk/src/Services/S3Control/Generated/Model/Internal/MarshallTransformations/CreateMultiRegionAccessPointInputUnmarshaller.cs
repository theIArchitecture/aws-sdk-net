...
namespace Amazon.S3Control.Model.Internal.MarshallTransformations
{
    ...
    public partial class CreateMultiRegionAccessPointInputUnmarshaller : IXmlUnmarshaller<CreateMultiRegionAccessPointInput, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public CreateMultiRegionAccessPointInput Unmarshall(XmlUnmarshallerContext context)
        {
            CreateMultiRegionAccessPointInput unmarshalledObject = new CreateMultiRegionAccessPointInput();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("Regions/Region", targetDepth))
                    {
                        ...
                        {
                            unmarshalledObject.Regions = new List<Region>();
                        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMultiRegionAccessPointInputUnmarshaller Instance
        {
            get
            {
                return _instance;
