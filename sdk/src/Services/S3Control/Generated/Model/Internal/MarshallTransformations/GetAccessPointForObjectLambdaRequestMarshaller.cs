...
namespace Amazon.S3Control.Model.Internal.MarshallTransformations
{
    ...
    public partial class GetAccessPointForObjectLambdaRequestMarshaller : IMarshaller<IRequest, GetAccessPointForObjectLambdaRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((GetAccessPointForObjectLambdaRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetAccessPointForObjectLambdaRequest publicRequest)
        {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAccessPointForObjectLambdaRequestMarshaller Instance
        {
            get
            {
                return _instance;
