...
{
    /// <summary>
    /// Response Unmarshaller for GetAccessPointForObjectLambda operation
    /// </summary>  
    public partial class GetAccessPointForObjectLambdaResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAccessPointForObjectLambdaResponse response = new GetAccessPointForObjectLambdaResponse();
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, GetAccessPointForObjectLambdaResponse response);

        private static GetAccessPointForObjectLambdaResponseUnmarshaller _instance = new GetAccessPointForObjectLambdaResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAccessPointForObjectLambdaResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
