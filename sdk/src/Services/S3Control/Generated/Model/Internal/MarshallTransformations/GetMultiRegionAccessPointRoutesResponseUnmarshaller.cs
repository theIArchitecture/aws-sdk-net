    ...
    public partial class GetMultiRegionAccessPointRoutesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, GetMultiRegionAccessPointRoutesResponse response)
        {
            ...
            while (context.Read())
            {
                ...
                {
                    if (context.TestExpression("Mrap", targetDepth))
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        response.Mrap = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMultiRegionAccessPointRoutesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
