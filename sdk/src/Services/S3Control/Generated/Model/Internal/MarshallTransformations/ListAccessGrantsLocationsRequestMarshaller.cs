...
namespace Amazon.S3Control.Model.Internal.MarshallTransformations
{
    ...
    public partial class ListAccessGrantsLocationsRequestMarshaller : IMarshaller<IRequest, ListAccessGrantsLocationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((ListAccessGrantsLocationsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListAccessGrantsLocationsRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetLocationScope())
                request.Parameters.Add("locationscope", StringUtils.FromString(publicRequest.LocationScope));
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAccessGrantsLocationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
