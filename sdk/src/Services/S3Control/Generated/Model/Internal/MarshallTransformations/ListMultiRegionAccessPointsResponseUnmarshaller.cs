...
{
    /// <summary>
    /// Response Unmarshaller for ListMultiRegionAccessPoints operation
    /// </summary>  
    public partial class ListMultiRegionAccessPointsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMultiRegionAccessPointsResponse response = new ListMultiRegionAccessPointsResponse();
        ...
        partial void PostUnmarshallCustomization(XmlUnmarshallerContext context, ListMultiRegionAccessPointsResponse response);

        private static ListMultiRegionAccessPointsResponseUnmarshaller _instance = new ListMultiRegionAccessPointsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMultiRegionAccessPointsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
