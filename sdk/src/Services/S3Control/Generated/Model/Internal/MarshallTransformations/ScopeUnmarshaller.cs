...
namespace Amazon.S3Control.Model.Internal.MarshallTransformations
{
    ...
    public partial class ScopeUnmarshaller : IXmlUnmarshaller<Scope, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public Scope Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.Read())
            {
                ...
                {
                    if (context.TestExpression("Permissions/Permission", targetDepth))
                    {
                        if (unmarshalledObject.Permissions == null)
                        {
                            unmarshalledObject.Permissions = new List<string>();
                        }
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.Permissions.Add(unmarshaller.Unmarshall(context));
                        continue;
                    }
                    if (context.TestExpression("Prefixes/Prefix", targetDepth))
                    {
                        if (unmarshalledObject.Prefixes == null)
                        {
                            unmarshalledObject.Prefixes = new List<string>();
                        }
                        var unmarshaller = StringUnmarshaller.Instance;
