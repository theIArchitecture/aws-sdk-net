...
namespace Amazon.S3Control.Model.Internal.MarshallTransformations
{
    ...
    public partial class StorageLensGroupAndOperatorUnmarshaller : IXmlUnmarshaller<StorageLensGroupAndOperator, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public StorageLensGroupAndOperator Unmarshall(XmlUnmarshallerContext context)
        {
            StorageLensGroupAndOperator unmarshalledObject = new StorageLensGroupAndOperator();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StorageLensGroupAndOperatorUnmarshaller Instance
        {
            get
            {
                return _instance;
