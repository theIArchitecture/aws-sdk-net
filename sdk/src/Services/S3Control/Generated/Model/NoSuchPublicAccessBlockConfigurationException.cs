...
namespace Amazon.S3Control.Model
{
    ...
    public partial class NoSuchPublicAccessBlockConfigurationException : AmazonS3ControlException
    {
        ...
        public NoSuchPublicAccessBlockConfigurationException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NoSuchPublicAccessBlockConfigurationException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
