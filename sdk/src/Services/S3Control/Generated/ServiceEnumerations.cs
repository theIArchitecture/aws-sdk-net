...
namespace Amazon.S3Control
{
    ...
    /// <summary>
    /// Constants used for properties of type ScopePermission.
    /// </summary>
    public class ScopePermission : ConstantClass
    {

        /// <summary>
        /// Constant AbortMultipartUpload for ScopePermission
        /// </summary>
        public static readonly ScopePermission AbortMultipartUpload = new ScopePermission("AbortMultipartUpload");
        /// <summary>
        /// Constant DeleteObject for ScopePermission
        /// </summary>
        public static readonly ScopePermission DeleteObject = new ScopePermission("DeleteObject");
        /// <summary>
        /// Constant GetObject for ScopePermission
        /// </summary>
        public static readonly ScopePermission GetObject = new ScopePermission("GetObject");
        /// <summary>
        /// Constant GetObjectAttributes for ScopePermission
        /// </summary>
        public static readonly ScopePermission GetObjectAttributes = new ScopePermission("GetObjectAttributes");
        /// <summary>
        /// Constant ListBucket for ScopePermission
        /// </summary>
        public static readonly ScopePermission ListBucket = new ScopePermission("ListBucket");
        /// <summary>
        /// Constant ListBucketMultipartUploads for ScopePermission
        /// </summary>
        public static readonly ScopePermission ListBucketMultipartUploads = new ScopePermission("ListBucketMultipartUploads");
        /// <summary>
        /// Constant ListMultipartUploadParts for ScopePermission
        /// </summary>
        public static readonly ScopePermission ListMultipartUploadParts = new ScopePermission("ListMultipartUploadParts");
        /// <summary>
        /// Constant PutObject for ScopePermission
        /// </summary>
        public static readonly ScopePermission PutObject = new ScopePermission("PutObject");
        ...
        /// newer than the current version of the SDK.
        /// </summary>
        public ScopePermission(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value">The unique value for the constant</param>
        /// <returns>The constant for the unique value</returns>
        public static ScopePermission FindValue(string value)
        {
            return FindValue<ScopePermission>(value);
        }
        ...
        /// <param name="value">The string value to convert to the constant class.</param>
        /// <returns></returns>
        public static implicit operator ScopePermission(string value)
        {
            return FindValue(value);
        }
    }
