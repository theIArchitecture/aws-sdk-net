...
namespace Amazon.S3Outposts.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListSharedEndpointsRequestMarshaller : IMarshaller<IRequest, ListSharedEndpointsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListSharedEndpointsRequestMarshaller _instance = new ListSharedEndpointsRequestMarshaller();        

        internal static ListSharedEndpointsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSharedEndpointsRequestMarshaller Instance
        {
            get
            {
                return _instance;
