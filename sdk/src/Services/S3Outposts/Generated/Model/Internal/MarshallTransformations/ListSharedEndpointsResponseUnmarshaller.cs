...
{
    /// <summary>
    /// Response Unmarshaller for ListSharedEndpoints operation
    /// </summary>  
    public class ListSharedEndpointsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSharedEndpointsResponse response = new ListSharedEndpointsResponse();
        ...
        private static ListSharedEndpointsResponseUnmarshaller _instance = new ListSharedEndpointsResponseUnmarshaller();        

        internal static ListSharedEndpointsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSharedEndpointsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
