...
namespace Amazon.S3Tables.Internal
{
    ...
    public class AmazonS3TablesAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonS3TablesAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for S3Tables.
        /// </summary>
        public AmazonS3TablesAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonS3TablesAuthSchemeParameters
            {
    ...
    public class AmazonS3TablesAuthSchemeResolver : IAuthSchemeResolver<AmazonS3TablesAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonS3TablesAuthSchemeParameters authParameters)
        {
