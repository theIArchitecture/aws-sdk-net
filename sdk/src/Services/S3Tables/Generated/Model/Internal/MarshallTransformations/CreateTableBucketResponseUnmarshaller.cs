...
{
    /// <summary>
    /// Response Unmarshaller for CreateTableBucket operation
    /// </summary>  
    public class CreateTableBucketResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTableBucketResponse response = new CreateTableBucketResponse();
        ...
        private static CreateTableBucketResponseUnmarshaller _instance = new CreateTableBucketResponseUnmarshaller();        

        internal static CreateTableBucketResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTableBucketResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
