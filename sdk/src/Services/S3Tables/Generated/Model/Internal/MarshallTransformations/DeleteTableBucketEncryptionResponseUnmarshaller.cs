...
{
    /// <summary>
    /// Response Unmarshaller for DeleteTableBucketEncryption operation
    /// </summary>  
    public class DeleteTableBucketEncryptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteTableBucketEncryptionResponse response = new DeleteTableBucketEncryptionResponse();
        ...
        private static DeleteTableBucketEncryptionResponseUnmarshaller _instance = new DeleteTableBucketEncryptionResponseUnmarshaller();        

        internal static DeleteTableBucketEncryptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTableBucketEncryptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
