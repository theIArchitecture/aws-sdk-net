...
{
    /// <summary>
    /// Response Unmarshaller for DeleteTableBucketPolicy operation
    /// </summary>  
    public class DeleteTableBucketPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteTableBucketPolicyResponse response = new DeleteTableBucketPolicyResponse();
        ...
        private static DeleteTableBucketPolicyResponseUnmarshaller _instance = new DeleteTableBucketPolicyResponseUnmarshaller();        

        internal static DeleteTableBucketPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTableBucketPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
