...
{
    /// <summary>
    /// Response Unmarshaller for DeleteTableBucket operation
    /// </summary>  
    public class DeleteTableBucketResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteTableBucketResponse response = new DeleteTableBucketResponse();
        ...
        private static DeleteTableBucketResponseUnmarshaller _instance = new DeleteTableBucketResponseUnmarshaller();        

        internal static DeleteTableBucketResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTableBucketResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
