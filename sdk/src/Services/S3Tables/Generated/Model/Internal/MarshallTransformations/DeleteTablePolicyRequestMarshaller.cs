...
{
    /// <summary>
    /// DeleteTablePolicy Request Marshaller
    /// </summary>       
    public class DeleteTablePolicyRequestMarshaller : IMarshaller<IRequest, DeleteTablePolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteTablePolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteTablePolicyRequest publicRequest)
        {
            ...
            request.ResourcePath = "/tables/{tableBucketARN}/{namespace}/{name}/policy";

            return request;
        }
        private static DeleteTablePolicyRequestMarshaller _instance = new DeleteTablePolicyRequestMarshaller();        

        internal static DeleteTablePolicyRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTablePolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
