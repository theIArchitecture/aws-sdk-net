...
namespace Amazon.S3Tables.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetTableBucketPolicyRequestMarshaller : IMarshaller<IRequest, GetTableBucketPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetTableBucketPolicyRequestMarshaller _instance = new GetTableBucketPolicyRequestMarshaller();        

        internal static GetTableBucketPolicyRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTableBucketPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
