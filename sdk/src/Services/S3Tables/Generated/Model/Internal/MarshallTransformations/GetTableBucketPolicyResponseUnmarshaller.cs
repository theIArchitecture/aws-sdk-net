...
{
    /// <summary>
    /// Response Unmarshaller for GetTableBucketPolicy operation
    /// </summary>  
    public class GetTableBucketPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTableBucketPolicyResponse response = new GetTableBucketPolicyResponse();
        ...
        private static GetTableBucketPolicyResponseUnmarshaller _instance = new GetTableBucketPolicyResponseUnmarshaller();        

        internal static GetTableBucketPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTableBucketPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
