...
{
    /// <summary>
    /// GetTableEncryption Request Marshaller
    /// </summary>       
    public class GetTableEncryptionRequestMarshaller : IMarshaller<IRequest, GetTableEncryptionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetTableEncryptionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetTableEncryptionRequest publicRequest)
        {
            ...
            request.ResourcePath = "/tables/{tableBucketARN}/{namespace}/{name}/encryption";

            return request;
        }
        private static GetTableEncryptionRequestMarshaller _instance = new GetTableEncryptionRequestMarshaller();        

        internal static GetTableEncryptionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTableEncryptionRequestMarshaller Instance
        {
            get
            {
                return _instance;
