...
{
    /// <summary>
    /// Response Unmarshaller for GetTableEncryption operation
    /// </summary>  
    public class GetTableEncryptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTableEncryptionResponse response = new GetTableEncryptionResponse();
        ...
        private static GetTableEncryptionResponseUnmarshaller _instance = new GetTableEncryptionResponseUnmarshaller();        

        internal static GetTableEncryptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTableEncryptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
