...
{
    /// <summary>
    /// Response Unmarshaller for GetTableMaintenanceConfiguration operation
    /// </summary>  
    public class GetTableMaintenanceConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTableMaintenanceConfigurationResponse response = new GetTableMaintenanceConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonDictionaryUnmarshaller<string, TableMaintenanceConfigurationValue, StringUnmarshaller, TableMaintenanceConfigurationValueUnmarshaller>(StringUnmarshaller.Instance, TableMaintenanceConfigurationValueUnmarshaller.Instance);
        ...
        private static GetTableMaintenanceConfigurationResponseUnmarshaller _instance = new GetTableMaintenanceConfigurationResponseUnmarshaller();        

        internal static GetTableMaintenanceConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTableMaintenanceConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
