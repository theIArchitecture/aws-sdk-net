...
{
    /// <summary>
    /// Response Unmarshaller for GetTableMaintenanceJobStatus operation
    /// </summary>  
    public class GetTableMaintenanceJobStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTableMaintenanceJobStatusResponse response = new GetTableMaintenanceJobStatusResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonDictionaryUnmarshaller<string, TableMaintenanceJobStatusValue, StringUnmarshaller, TableMaintenanceJobStatusValueUnmarshaller>(StringUnmarshaller.Instance, TableMaintenanceJobStatusValueUnmarshaller.Instance);
        ...
        private static GetTableMaintenanceJobStatusResponseUnmarshaller _instance = new GetTableMaintenanceJobStatusResponseUnmarshaller();        

        internal static GetTableMaintenanceJobStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTableMaintenanceJobStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
