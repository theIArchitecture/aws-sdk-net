...
{
    /// <summary>
    /// GetTableMetadataLocation Request Marshaller
    /// </summary>       
    public class GetTableMetadataLocationRequestMarshaller : IMarshaller<IRequest, GetTableMetadataLocationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetTableMetadataLocationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetTableMetadataLocationRequest publicRequest)
        {
        ...
        private static GetTableMetadataLocationRequestMarshaller _instance = new GetTableMetadataLocationRequestMarshaller();        

        internal static GetTableMetadataLocationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTableMetadataLocationRequestMarshaller Instance
        {
            get
            {
                return _instance;
