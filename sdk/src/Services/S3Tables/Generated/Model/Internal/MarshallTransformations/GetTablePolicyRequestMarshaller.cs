...
{
    /// <summary>
    /// GetTablePolicy Request Marshaller
    /// </summary>       
    public class GetTablePolicyRequestMarshaller : IMarshaller<IRequest, GetTablePolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetTablePolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetTablePolicyRequest publicRequest)
        {
        ...
        private static GetTablePolicyRequestMarshaller _instance = new GetTablePolicyRequestMarshaller();        

        internal static GetTablePolicyRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTablePolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
