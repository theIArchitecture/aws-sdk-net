...
{
    /// <summary>
    /// Response Unmarshaller for GetTablePolicy operation
    /// </summary>  
    public class GetTablePolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTablePolicyResponse response = new GetTablePolicyResponse();
        ...
        private static GetTablePolicyResponseUnmarshaller _instance = new GetTablePolicyResponseUnmarshaller();        

        internal static GetTablePolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTablePolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
