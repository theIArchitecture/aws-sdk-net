...
{
    /// <summary>
    /// Response Unmarshaller for ListTableBuckets operation
    /// </summary>  
    public class ListTableBucketsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTableBucketsResponse response = new ListTableBucketsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("tableBuckets", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<TableBucketSummary, TableBucketSummaryUnmarshaller>(TableBucketSummaryUnmarshaller.Instance);
                    response.TableBuckets = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static ListTableBucketsResponseUnmarshaller _instance = new ListTableBucketsResponseUnmarshaller();        

        internal static ListTableBucketsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTableBucketsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
