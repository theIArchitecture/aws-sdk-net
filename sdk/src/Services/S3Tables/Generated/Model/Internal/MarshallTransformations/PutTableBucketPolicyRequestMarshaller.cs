...
{
    /// <summary>
    /// PutTableBucketPolicy Request Marshaller
    /// </summary>       
    public class PutTableBucketPolicyRequestMarshaller : IMarshaller<IRequest, PutTableBucketPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutTableBucketPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutTableBucketPolicyRequest publicRequest)
        {
        ...
        private static PutTableBucketPolicyRequestMarshaller _instance = new PutTableBucketPolicyRequestMarshaller();        

        internal static PutTableBucketPolicyRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutTableBucketPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
