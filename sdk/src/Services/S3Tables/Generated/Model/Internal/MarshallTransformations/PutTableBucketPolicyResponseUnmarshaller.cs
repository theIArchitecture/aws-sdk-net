...
{
    /// <summary>
    /// Response Unmarshaller for PutTableBucketPolicy operation
    /// </summary>  
    public class PutTableBucketPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutTableBucketPolicyResponse response = new PutTableBucketPolicyResponse();
        ...
        private static PutTableBucketPolicyResponseUnmarshaller _instance = new PutTableBucketPolicyResponseUnmarshaller();        

        internal static PutTableBucketPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutTableBucketPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
