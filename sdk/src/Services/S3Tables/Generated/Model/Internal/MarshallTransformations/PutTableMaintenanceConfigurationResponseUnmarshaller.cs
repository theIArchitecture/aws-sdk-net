...
{
    /// <summary>
    /// Response Unmarshaller for PutTableMaintenanceConfiguration operation
    /// </summary>  
    public class PutTableMaintenanceConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutTableMaintenanceConfigurationResponse response = new PutTableMaintenanceConfigurationResponse();
        ...
        private static PutTableMaintenanceConfigurationResponseUnmarshaller _instance = new PutTableMaintenanceConfigurationResponseUnmarshaller();        

        internal static PutTableMaintenanceConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutTableMaintenanceConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
