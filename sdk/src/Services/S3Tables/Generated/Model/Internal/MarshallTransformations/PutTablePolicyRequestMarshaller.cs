...
{
    /// <summary>
    /// PutTablePolicy Request Marshaller
    /// </summary>       
    public class PutTablePolicyRequestMarshaller : IMarshaller<IRequest, PutTablePolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutTablePolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutTablePolicyRequest publicRequest)
        {
        ...
        private static PutTablePolicyRequestMarshaller _instance = new PutTablePolicyRequestMarshaller();        

        internal static PutTablePolicyRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutTablePolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
