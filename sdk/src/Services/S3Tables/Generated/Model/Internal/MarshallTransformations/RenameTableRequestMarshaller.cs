...
{
    /// <summary>
    /// RenameTable Request Marshaller
    /// </summary>       
    public class RenameTableRequestMarshaller : IMarshaller<IRequest, RenameTableRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RenameTableRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RenameTableRequest publicRequest)
        {
        ...
        private static RenameTableRequestMarshaller _instance = new RenameTableRequestMarshaller();        

        internal static RenameTableRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RenameTableRequestMarshaller Instance
        {
            get
            {
                return _instance;
