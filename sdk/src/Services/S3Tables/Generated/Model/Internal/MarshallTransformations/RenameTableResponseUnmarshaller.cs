...
{
    /// <summary>
    /// Response Unmarshaller for RenameTable operation
    /// </summary>  
    public class RenameTableResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static RenameTableResponseUnmarshaller _instance = new RenameTableResponseUnmarshaller();        

        internal static RenameTableResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RenameTableResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
