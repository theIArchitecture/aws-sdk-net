...
namespace Amazon.S3Tables.Model.Internal.MarshallTransformations
{
    ...
    public class TableMaintenanceSettingsUnmarshaller : IJsonUnmarshaller<TableMaintenanceSettings, JsonUnmarshallerContext>
    {
        ...
        private static TableMaintenanceSettingsUnmarshaller _instance = new TableMaintenanceSettingsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TableMaintenanceSettingsUnmarshaller Instance
        {
            get
            {
                return _instance;
