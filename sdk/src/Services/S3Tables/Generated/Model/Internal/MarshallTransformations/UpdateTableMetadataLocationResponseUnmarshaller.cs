...
{
    /// <summary>
    /// Response Unmarshaller for UpdateTableMetadataLocation operation
    /// </summary>  
    public class UpdateTableMetadataLocationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateTableMetadataLocationResponse response = new UpdateTableMetadataLocationResponse();
        ...
        private static UpdateTableMetadataLocationResponseUnmarshaller _instance = new UpdateTableMetadataLocationResponseUnmarshaller();        

        internal static UpdateTableMetadataLocationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTableMetadataLocationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
