...
namespace Amazon.S3Vectors
{
    ...
    public partial class AmazonS3VectorsConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("S3Vectors", "4.0.1.8");
        ...
        /// Default constructor
        /// </summary>
        public AmazonS3VectorsConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonS3VectorsDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "S3Vectors";
            this.AuthenticationServiceName = "s3vectors";
            this.EndpointProvider = new AmazonS3VectorsEndpointProvider();
        }
