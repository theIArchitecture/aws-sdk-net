...
{
    /// <summary>
    /// This is the response object from the GetVectors operation.
    /// </summary>
    public partial class GetVectorsResponse : AmazonWebServiceResponse
    {
        private List<GetOutputVector> _vectors = AWSConfigs.InitializeCollections ? new List<GetOutputVector>() : null;
        ...
        public List<GetOutputVector> Vectors
        {
