...
{
    /// <summary>
    /// Response Unmarshaller for CreateVectorBucket operation
    /// </summary>  
    public class CreateVectorBucketResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateVectorBucketResponse response = new CreateVectorBucketResponse();
        ...
        private static CreateVectorBucketResponseUnmarshaller _instance = new CreateVectorBucketResponseUnmarshaller();        

        internal static CreateVectorBucketResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateVectorBucketResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
