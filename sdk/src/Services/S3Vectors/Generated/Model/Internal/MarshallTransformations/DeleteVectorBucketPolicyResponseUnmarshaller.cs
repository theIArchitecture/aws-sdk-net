...
{
    /// <summary>
    /// Response Unmarshaller for DeleteVectorBucketPolicy operation
    /// </summary>  
    public class DeleteVectorBucketPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteVectorBucketPolicyResponse response = new DeleteVectorBucketPolicyResponse();
        ...
        private static DeleteVectorBucketPolicyResponseUnmarshaller _instance = new DeleteVectorBucketPolicyResponseUnmarshaller();        

        internal static DeleteVectorBucketPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVectorBucketPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
