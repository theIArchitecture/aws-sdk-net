...
{
    /// <summary>
    /// DeleteVectors Request Marshaller
    /// </summary>       
    public class DeleteVectorsRequestMarshaller : IMarshaller<IRequest, DeleteVectorsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteVectorsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteVectorsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/DeleteVectors";
#if !NETFRAMEWORK
        ...
        private static DeleteVectorsRequestMarshaller _instance = new DeleteVectorsRequestMarshaller();        

        internal static DeleteVectorsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVectorsRequestMarshaller Instance
        {
            get
            {
                return _instance;
