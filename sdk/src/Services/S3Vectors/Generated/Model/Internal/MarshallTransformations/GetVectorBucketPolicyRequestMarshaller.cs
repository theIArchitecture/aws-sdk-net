...
{
    /// <summary>
    /// GetVectorBucketPolicy Request Marshaller
    /// </summary>       
    public class GetVectorBucketPolicyRequestMarshaller : IMarshaller<IRequest, GetVectorBucketPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetVectorBucketPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetVectorBucketPolicyRequest publicRequest)
        {
            ...
            request.ResourcePath = "/GetVectorBucketPolicy";
#if !NETFRAMEWORK
        ...
        private static GetVectorBucketPolicyRequestMarshaller _instance = new GetVectorBucketPolicyRequestMarshaller();        

        internal static GetVectorBucketPolicyRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetVectorBucketPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
