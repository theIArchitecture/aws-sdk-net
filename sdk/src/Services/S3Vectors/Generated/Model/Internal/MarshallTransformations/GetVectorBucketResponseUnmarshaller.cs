...
{
    /// <summary>
    /// Response Unmarshaller for GetVectorBucket operation
    /// </summary>  
    public class GetVectorBucketResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetVectorBucketResponse response = new GetVectorBucketResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("vectorBucket", targetDepth))
                {
                    var unmarshaller = VectorBucketUnmarshaller.Instance;
                    response.VectorBucket = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetVectorBucketResponseUnmarshaller _instance = new GetVectorBucketResponseUnmarshaller();        

        internal static GetVectorBucketResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetVectorBucketResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
