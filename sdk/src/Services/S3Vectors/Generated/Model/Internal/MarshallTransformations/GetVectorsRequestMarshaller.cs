...
{
    /// <summary>
    /// GetVectors Request Marshaller
    /// </summary>       
    public class GetVectorsRequestMarshaller : IMarshaller<IRequest, GetVectorsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetVectorsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetVectorsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/GetVectors";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetKeys())
            {
                ...
                {
                        context.Writer.WriteStringValue(publicRequestKeysListValue);
                }
        ...
        private static GetVectorsRequestMarshaller _instance = new GetVectorsRequestMarshaller();        

        internal static GetVectorsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetVectorsRequestMarshaller Instance
        {
            get
            {
                return _instance;
