...
{
    /// <summary>
    /// Response Unmarshaller for GetVectors operation
    /// </summary>  
    public class GetVectorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetVectorsResponseUnmarshaller _instance = new GetVectorsResponseUnmarshaller();        

        internal static GetVectorsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetVectorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
