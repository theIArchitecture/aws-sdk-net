...
{
    /// <summary>
    /// Response Unmarshaller for IndexSummary Object
    /// </summary>  
    public class IndexSummaryUnmarshaller : IJsonUnmarshaller<IndexSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IndexSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            IndexSummary unmarshalledObject = new IndexSummary();
        ...
        private static IndexSummaryUnmarshaller _instance = new IndexSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static IndexSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
