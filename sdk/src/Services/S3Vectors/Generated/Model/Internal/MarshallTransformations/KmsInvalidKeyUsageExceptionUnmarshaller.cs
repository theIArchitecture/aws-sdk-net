...
namespace Amazon.S3Vectors.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class KmsInvalidKeyUsageExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<KmsInvalidKeyUsageException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public KmsInvalidKeyUsageException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public KmsInvalidKeyUsageException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
