...
{
    /// <summary>
    /// ListVectors Request Marshaller
    /// </summary>       
    public class ListVectorsRequestMarshaller : IMarshaller<IRequest, ListVectorsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListVectorsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListVectorsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/ListVectors";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetReturnData())
            {
                context.Writer.WritePropertyName("returnData");
                context.Writer.WriteBooleanValue(publicRequest.ReturnData.Value);
            }
            ...
            if(publicRequest.IsSetSegmentCount())
            {
                context.Writer.WritePropertyName("segmentCount");
                context.Writer.WriteNumberValue(publicRequest.SegmentCount.Value);
            }

            if(publicRequest.IsSetSegmentIndex())
            {
                context.Writer.WritePropertyName("segmentIndex");
                context.Writer.WriteNumberValue(publicRequest.SegmentIndex.Value);
            }
        ...
        private static ListVectorsRequestMarshaller _instance = new ListVectorsRequestMarshaller();        

        internal static ListVectorsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListVectorsRequestMarshaller Instance
        {
            get
            {
                return _instance;
