...
{
    /// <summary>
    /// Response Unmarshaller for ListVectors operation
    /// </summary>  
    public class ListVectorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListVectorsResponse response = new ListVectorsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ListOutputVector, ListOutputVectorUnmarshaller>(ListOutputVectorUnmarshaller.Instance);
        ...
        private static ListVectorsResponseUnmarshaller _instance = new ListVectorsResponseUnmarshaller();        

        internal static ListVectorsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListVectorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
