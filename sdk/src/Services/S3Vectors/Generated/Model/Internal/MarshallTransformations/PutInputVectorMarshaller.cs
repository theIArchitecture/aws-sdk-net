...
{
    /// <summary>
    /// PutInputVector Marshaller
    /// </summary>
    public class PutInputVectorMarshaller : IRequestMarshaller<PutInputVector, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(PutInputVector requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetMetadata())
            {
                ...
                Amazon.Runtime.Documents.Internal.Transform.DocumentMarshaller.Instance.Write(context.Writer, requestObject.Metadata);
            }
        ...
        /// </summary>
        public readonly static PutInputVectorMarshaller Instance = new PutInputVectorMarshaller();
