...
{
    /// <summary>
    /// PutVectorBucketPolicy Request Marshaller
    /// </summary>       
    public class PutVectorBucketPolicyRequestMarshaller : IMarshaller<IRequest, PutVectorBucketPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutVectorBucketPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutVectorBucketPolicyRequest publicRequest)
        {
            ...
            request.ResourcePath = "/PutVectorBucketPolicy";
#if !NETFRAMEWORK
        ...
        private static PutVectorBucketPolicyRequestMarshaller _instance = new PutVectorBucketPolicyRequestMarshaller();        

        internal static PutVectorBucketPolicyRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutVectorBucketPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
