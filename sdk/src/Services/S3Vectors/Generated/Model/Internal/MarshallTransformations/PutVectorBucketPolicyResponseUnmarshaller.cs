...
{
    /// <summary>
    /// Response Unmarshaller for PutVectorBucketPolicy operation
    /// </summary>  
    public class PutVectorBucketPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutVectorBucketPolicyResponse response = new PutVectorBucketPolicyResponse();
        ...
        private static PutVectorBucketPolicyResponseUnmarshaller _instance = new PutVectorBucketPolicyResponseUnmarshaller();        

        internal static PutVectorBucketPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutVectorBucketPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
