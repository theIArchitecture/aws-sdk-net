...
{
    /// <summary>
    /// PutVectors Request Marshaller
    /// </summary>       
    public class PutVectorsRequestMarshaller : IMarshaller<IRequest, PutVectorsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutVectorsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutVectorsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/PutVectors";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetVectors())
            {
                context.Writer.WritePropertyName("vectors");
                context.Writer.WriteStartArray();
                foreach(var publicRequestVectorsListValue in publicRequest.Vectors)
                {
                    context.Writer.WriteStartObject();

                    var marshaller = PutInputVectorMarshaller.Instance;
                    marshaller.Marshall(publicRequestVectorsListValue, context);
        ...
        private static PutVectorsRequestMarshaller _instance = new PutVectorsRequestMarshaller();        

        internal static PutVectorsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutVectorsRequestMarshaller Instance
        {
            get
            {
                return _instance;
