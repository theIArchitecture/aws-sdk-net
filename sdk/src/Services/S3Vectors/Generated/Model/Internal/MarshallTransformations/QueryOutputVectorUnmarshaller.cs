...
{
    /// <summary>
    /// Response Unmarshaller for QueryOutputVector Object
    /// </summary>  
    public class QueryOutputVectorUnmarshaller : IJsonUnmarshaller<QueryOutputVector, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public QueryOutputVector Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            QueryOutputVector unmarshalledObject = new QueryOutputVector();
        ...
        private static QueryOutputVectorUnmarshaller _instance = new QueryOutputVectorUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static QueryOutputVectorUnmarshaller Instance
        {
            get
            {
                return _instance;
