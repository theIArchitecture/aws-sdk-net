...
{
    /// <summary>
    /// Response Unmarshaller for QueryVectors operation
    /// </summary>  
    public class QueryVectorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            QueryVectorsResponse response = new QueryVectorsResponse();
        ...
        private static QueryVectorsResponseUnmarshaller _instance = new QueryVectorsResponseUnmarshaller();        

        internal static QueryVectorsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static QueryVectorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
