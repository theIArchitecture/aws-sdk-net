...
namespace Amazon.SQS.Internal
{
    ...
    public class AmazonSQSAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSQSAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for SQS.
        /// </summary>
        public AmazonSQSAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSQSAuthSchemeParameters
            {
    ...
    public class AmazonSQSAuthSchemeResolver : IAuthSchemeResolver<AmazonSQSAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSQSAuthSchemeParameters authParameters)
        {
