...
{
    /// <summary>
    /// Response Unmarshaller for ListMessageMoveTasks operation
    /// </summary>  
    public class ListMessageMoveTasksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMessageMoveTasksResponse response = new ListMessageMoveTasksResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ListMessageMoveTasksResultEntry, ListMessageMoveTasksResultEntryUnmarshaller>(ListMessageMoveTasksResultEntryUnmarshaller.Instance);
        ...
        private static ListMessageMoveTasksResponseUnmarshaller _instance = new ListMessageMoveTasksResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMessageMoveTasksResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
