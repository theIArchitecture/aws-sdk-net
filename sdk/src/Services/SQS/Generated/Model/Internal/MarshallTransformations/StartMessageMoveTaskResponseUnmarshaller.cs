...
{
    /// <summary>
    /// Response Unmarshaller for StartMessageMoveTask operation
    /// </summary>  
    public class StartMessageMoveTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartMessageMoveTaskResponse response = new StartMessageMoveTaskResponse();
        ...
        private static StartMessageMoveTaskResponseUnmarshaller _instance = new StartMessageMoveTaskResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartMessageMoveTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
