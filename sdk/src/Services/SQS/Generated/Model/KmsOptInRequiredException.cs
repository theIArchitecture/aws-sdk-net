...
namespace Amazon.SQS.Model
{
    ...
    [Serializable]
    #endif
    public partial class KmsOptInRequiredException : AmazonSQSException
    {
        ...
        public KmsOptInRequiredException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public KmsOptInRequiredException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
