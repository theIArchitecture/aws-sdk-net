...
namespace Amazon.SQS.Model
{
    ...
    public partial class TooManyEntriesInBatchRequestException : AmazonSQSException
    {
        ...
        public TooManyEntriesInBatchRequestException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TooManyEntriesInBatchRequestException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
