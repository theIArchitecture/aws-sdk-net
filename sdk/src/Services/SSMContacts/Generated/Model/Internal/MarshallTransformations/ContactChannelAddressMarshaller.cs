...
namespace Amazon.SSMContacts.Model.Internal.MarshallTransformations
{
    ...
    public class ContactChannelAddressMarshaller : IRequestMarshaller<ContactChannelAddress, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(ContactChannelAddress requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetSimpleAddress())
            {
                context.Writer.WritePropertyName("SimpleAddress");
                context.Writer.WriteStringValue(requestObject.SimpleAddress);
            }
