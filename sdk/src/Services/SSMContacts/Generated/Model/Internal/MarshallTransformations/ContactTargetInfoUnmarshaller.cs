...
namespace Amazon.SSMContacts.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ContactTargetInfoUnmarshaller : IJsonUnmarshaller<ContactTargetInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ContactTargetInfo Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("IsEssential", targetDepth))
                {
                    ...
                    unmarshalledObject.IsEssential = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
