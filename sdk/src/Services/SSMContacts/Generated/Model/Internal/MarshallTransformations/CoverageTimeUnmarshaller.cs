...
namespace Amazon.SSMContacts.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CoverageTimeUnmarshaller : IJsonUnmarshaller<CoverageTime, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CoverageTime Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
