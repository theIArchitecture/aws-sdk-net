...
{
    /// <summary>
    /// Response Unmarshaller for CreateRotationOverride operation
    /// </summary>  
    public class CreateRotationOverrideResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRotationOverrideResponse response = new CreateRotationOverrideResponse();
        ...
        private static CreateRotationOverrideResponseUnmarshaller _instance = new CreateRotationOverrideResponseUnmarshaller();        

        internal static CreateRotationOverrideResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRotationOverrideResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
