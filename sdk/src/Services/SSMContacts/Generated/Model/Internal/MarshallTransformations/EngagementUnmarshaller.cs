...
namespace Amazon.SSMContacts.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EngagementUnmarshaller : IJsonUnmarshaller<Engagement, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Engagement Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
