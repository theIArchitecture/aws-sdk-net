...
{
    /// <summary>
    /// Response Unmarshaller for ListRotations operation
    /// </summary>  
    public class ListRotationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListRotationsResponse response = new ListRotationsResponse();
        ...
        private static ListRotationsResponseUnmarshaller _instance = new ListRotationsResponseUnmarshaller();        

        internal static ListRotationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRotationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
