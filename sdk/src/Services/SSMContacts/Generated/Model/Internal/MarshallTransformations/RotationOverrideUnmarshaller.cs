...
namespace Amazon.SSMContacts.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RotationOverrideUnmarshaller : IJsonUnmarshaller<RotationOverride, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RotationOverride Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("NewContactIds", targetDepth))
                {
                    ...
                    unmarshalledObject.NewContactIds = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("RotationOverrideId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.RotationOverrideId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
