...
namespace Amazon.SSMContacts.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RotationShiftUnmarshaller : IJsonUnmarshaller<RotationShift, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RotationShift Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
