...
namespace Amazon.SSMContacts.Model.Internal.MarshallTransformations
{
    ...
    public class UpdateContactRequestMarshaller : IMarshaller<IRequest, UpdateContactRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(UpdateContactRequest publicRequest)
        {
            ...
            string target = "SSMContacts.UpdateContact";
            ...
            {
                context.Writer.WritePropertyName("Plan");
                context.Writer.WriteStartObject();

                var marshaller = PlanMarshaller.Instance;
                marshaller.Marshall(publicRequest.Plan, context);
