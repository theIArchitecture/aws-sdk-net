...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonSSMContactsConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonSSMContactsConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonSSMContactsConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonSSMContactsConfig to create AmazonSSMContactsClient");
            }

            return awsCredentials == null ? 
                    new AmazonSSMContactsClient(serviceClientConfig) :
                    new AmazonSSMContactsClient(awsCredentials, serviceClientConfig);
        }
