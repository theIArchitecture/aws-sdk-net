...
namespace Amazon.SSMIncidents.Internal
{
    ...
    public class AmazonSSMIncidentsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSSMIncidentsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for SSMIncidents.
        /// </summary>
        public AmazonSSMIncidentsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSSMIncidentsAuthSchemeParameters
            {
    ...
    public class AmazonSSMIncidentsAuthSchemeResolver : IAuthSchemeResolver<AmazonSSMIncidentsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSSMIncidentsAuthSchemeParameters authParameters)
        {
