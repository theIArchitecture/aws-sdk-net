...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IncidentRecordSourceUnmarshaller : IJsonUnmarshaller<IncidentRecordSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IncidentRecordSource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
