...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IncidentRecordSummaryUnmarshaller : IJsonUnmarshaller<IncidentRecordSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            IncidentRecordSummary unmarshalledObject = new IncidentRecordSummary();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static IncidentRecordSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
