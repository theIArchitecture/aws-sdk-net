...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IncidentRecordUnmarshaller : IJsonUnmarshaller<IncidentRecord, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IncidentRecord Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
