...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IncidentTemplateUnmarshaller : IJsonUnmarshaller<IncidentTemplate, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IncidentTemplate Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("incidentTags", targetDepth))
                {
                    ...
                    unmarshalledObject.IncidentTags = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
