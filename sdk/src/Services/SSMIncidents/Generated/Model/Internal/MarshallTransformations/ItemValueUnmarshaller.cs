...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ItemValueUnmarshaller : IJsonUnmarshaller<ItemValue, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ItemValue Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("pagerDutyIncidentDetail", targetDepth))
                {
                    ...
                    unmarshalledObject.PagerDutyIncidentDetail = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
