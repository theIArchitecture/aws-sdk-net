...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PagerDutyConfigurationUnmarshaller : IJsonUnmarshaller<PagerDutyConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PagerDutyConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
