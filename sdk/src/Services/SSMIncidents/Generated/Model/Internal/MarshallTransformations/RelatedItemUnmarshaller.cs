...
namespace Amazon.SSMIncidents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RelatedItemUnmarshaller : IJsonUnmarshaller<RelatedItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RelatedItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("generatedId", targetDepth))
                {
                    ...
                    unmarshalledObject.GeneratedId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
