...
namespace Amazon.SSMQuickSetup.Internal
{
    ...
    public class AmazonSSMQuickSetupAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSSMQuickSetupAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for SSMQuickSetup.
        /// </summary>
        public AmazonSSMQuickSetupAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSSMQuickSetupAuthSchemeParameters
            {
    ...
    public class AmazonSSMQuickSetupAuthSchemeResolver : IAuthSchemeResolver<AmazonSSMQuickSetupAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSSMQuickSetupAuthSchemeParameters authParameters)
        {
