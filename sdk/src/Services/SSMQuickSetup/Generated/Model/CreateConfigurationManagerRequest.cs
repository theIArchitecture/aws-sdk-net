...
{
    /// <summary>
    /// Container for the parameters to the CreateConfigurationManager operation.
    ...
    /// </summary>
    public partial class CreateConfigurationManagerRequest : AmazonSSMQuickSetupRequest
    {
        private List<ConfigurationDefinitionInput> _configurationDefinitions = AWSConfigs.InitializeCollections ? new List<ConfigurationDefinitionInput>() : null;
        ...
        public List<ConfigurationDefinitionInput> ConfigurationDefinitions
        {
