...
{
    /// <summary>
    /// Response Unmarshaller for CreateConfigurationManager operation
    /// </summary>  
    public class CreateConfigurationManagerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateConfigurationManagerResponse response = new CreateConfigurationManagerResponse();
        ...
        private static CreateConfigurationManagerResponseUnmarshaller _instance = new CreateConfigurationManagerResponseUnmarshaller();        

        internal static CreateConfigurationManagerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateConfigurationManagerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
