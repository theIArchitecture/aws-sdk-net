...
{
    /// <summary>
    /// ListConfigurationManagers Request Marshaller
    /// </summary>       
    public class ListConfigurationManagersRequestMarshaller : IMarshaller<IRequest, ListConfigurationManagersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListConfigurationManagersRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListConfigurationManagersRequest publicRequest)
        {
        ...
        private static ListConfigurationManagersRequestMarshaller _instance = new ListConfigurationManagersRequestMarshaller();        

        internal static ListConfigurationManagersRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListConfigurationManagersRequestMarshaller Instance
        {
            get
            {
                return _instance;
