...
namespace Amazon.SSMQuickSetup.Model.Internal.MarshallTransformations
{
    ...
    public class ListConfigurationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("ConfigurationsList", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<ConfigurationSummary, ConfigurationSummaryUnmarshaller>(ConfigurationSummaryUnmarshaller.Instance);
                    response.ConfigurationsList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
