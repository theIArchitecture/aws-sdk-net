...
namespace Amazon.SSMQuickSetup.Model.Internal.MarshallTransformations
{
    ...
    public class UpdateServiceSettingsRequestMarshaller : IMarshaller<IRequest, UpdateServiceSettingsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(UpdateServiceSettingsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/serviceSettings";
#if !NETFRAMEWORK
            ...
            if(publicRequest.IsSetExplorerEnablingRoleArn())
            {
                context.Writer.WritePropertyName("ExplorerEnablingRoleArn");
                context.Writer.WriteStringValue(publicRequest.ExplorerEnablingRoleArn);
            }
