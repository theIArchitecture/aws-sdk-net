...
namespace Amazon.SSOAdmin.Internal
{
    ...
    public class AmazonSSOAdminAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSSOAdminAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for SSOAdmin.
        /// </summary>
        public AmazonSSOAdminAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSSOAdminAuthSchemeParameters
            {
    ...
    public class AmazonSSOAdminAuthSchemeResolver : IAuthSchemeResolver<AmazonSSOAdminAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSSOAdminAuthSchemeParameters authParameters)
        {
