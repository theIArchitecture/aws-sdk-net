...
namespace Amazon.SSOAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AccountAssignmentForPrincipalUnmarshaller : IJsonUnmarshaller<AccountAssignmentForPrincipal, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AccountAssignmentForPrincipal Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
