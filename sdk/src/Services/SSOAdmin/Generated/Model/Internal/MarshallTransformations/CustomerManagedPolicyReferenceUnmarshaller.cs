...
namespace Amazon.SSOAdmin.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CustomerManagedPolicyReferenceUnmarshaller : IJsonUnmarshaller<CustomerManagedPolicyReference, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CustomerManagedPolicyReference Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
