...
{
    /// <summary>
    /// Response Unmarshaller for DescribeTrustedTokenIssuer operation
    /// </summary>  
    public class DescribeTrustedTokenIssuerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeTrustedTokenIssuerResponse response = new DescribeTrustedTokenIssuerResponse();
        ...
        private static DescribeTrustedTokenIssuerResponseUnmarshaller _instance = new DescribeTrustedTokenIssuerResponseUnmarshaller();        

        internal static DescribeTrustedTokenIssuerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTrustedTokenIssuerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
