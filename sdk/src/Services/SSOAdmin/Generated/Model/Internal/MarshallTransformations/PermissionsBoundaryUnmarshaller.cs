...
{
    /// <summary>
    /// Response Unmarshaller for PermissionsBoundary Object
    /// </summary>  
    public class PermissionsBoundaryUnmarshaller : IJsonUnmarshaller<PermissionsBoundary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PermissionsBoundary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static PermissionsBoundaryUnmarshaller _instance = new PermissionsBoundaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PermissionsBoundaryUnmarshaller Instance
        {
            get
            {
                return _instance;
