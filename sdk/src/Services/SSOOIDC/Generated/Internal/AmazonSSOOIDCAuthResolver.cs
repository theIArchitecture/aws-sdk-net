...
namespace Amazon.SSOOIDC.Internal
{
    ...
    public class AmazonSSOOIDCAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSSOOIDCAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for SSOOIDC.
        /// </summary>
        public AmazonSSOOIDCAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSSOOIDCAuthSchemeParameters
            {
    ...
    public class AmazonSSOOIDCAuthSchemeResolver : IAuthSchemeResolver<AmazonSSOOIDCAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSSOOIDCAuthSchemeParameters authParameters)
        {
            switch (authParameters.Operation)
            {
                ...
                case "RegisterClientRequest":
                    return AuthSchemeOption.DEFAULT_NOAUTH;
                case "StartDeviceAuthorizationRequest":
                    return AuthSchemeOption.DEFAULT_NOAUTH;
                default:
