...
{
    /// <summary>
    /// Response Unmarshaller for InvalidRedirectUriException Object
    /// </summary>  
    public class InvalidRedirectUriExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<InvalidRedirectUriException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public InvalidRedirectUriException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        public InvalidRedirectUriException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
            ...
            InvalidRedirectUriException unmarshalledObject = new InvalidRedirectUriException(errorResponse.Message, errorResponse.InnerException,
        ...
        private static InvalidRedirectUriExceptionUnmarshaller _instance = new InvalidRedirectUriExceptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static InvalidRedirectUriExceptionUnmarshaller Instance
        {
            get
            {
                return _instance;
