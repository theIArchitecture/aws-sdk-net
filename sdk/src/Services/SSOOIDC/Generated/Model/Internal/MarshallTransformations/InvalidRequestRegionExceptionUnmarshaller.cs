...
{
    /// <summary>
    /// Response Unmarshaller for InvalidRequestRegionException Object
    /// </summary>  
    public class InvalidRequestRegionExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<InvalidRequestRegionException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InvalidRequestRegionException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
            ...
            InvalidRequestRegionException unmarshalledObject = new InvalidRequestRegionException(errorResponse.Message, errorResponse.InnerException,
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InvalidRequestRegionExceptionUnmarshaller Instance
        {
            get
            {
                return _instance;
