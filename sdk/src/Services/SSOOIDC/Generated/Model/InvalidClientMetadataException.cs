...
namespace Amazon.SSOOIDC.Model
{
    ...
    public partial class InvalidClientMetadataException : AmazonSSOOIDCException
    {
        ...
        public InvalidClientMetadataException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidClientMetadataException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
