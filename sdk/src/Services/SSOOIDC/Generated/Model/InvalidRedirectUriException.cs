...
namespace Amazon.SSOOIDC.Model
{
    ...
    public partial class InvalidRedirectUriException : AmazonSSOOIDCException
    {
        ...
        /// </summary>
        /// <param name="innerException"></param>
        public InvalidRedirectUriException(Exception innerException) 
            : base(innerException) {}
        ...
        public InvalidRedirectUriException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidRedirectUriException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
