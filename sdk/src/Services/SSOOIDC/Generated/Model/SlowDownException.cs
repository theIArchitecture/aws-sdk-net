...
namespace Amazon.SSOOIDC.Model
{
    ...
    public partial class SlowDownException : AmazonSSOOIDCException
    {
        ...
        public SlowDownException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public SlowDownException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <para>
        /// Single error code. For this exception the value will be <c>slow_down</c>.
        /// </para>
        /// </summary>
        public string Error
        {
