...
namespace Amazon.SSOOIDC
{
    ...
    public partial interface IAmazonSSOOIDC : IAmazonService, IDisposable
    {
        ...
        Task<CreateTokenWithIAMResponse> CreateTokenWithIAMAsync(CreateTokenWithIAMRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonSSOOIDCConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonSSOOIDCConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonSSOOIDCConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonSSOOIDCConfig to create AmazonSSOOIDCClient");
            }

            return awsCredentials == null ? 
                    new AmazonSSOOIDCClient(serviceClientConfig) :
                    new AmazonSSOOIDCClient(awsCredentials, serviceClientConfig);
        }
