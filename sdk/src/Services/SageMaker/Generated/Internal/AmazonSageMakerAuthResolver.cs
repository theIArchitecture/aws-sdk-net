...
namespace Amazon.SageMaker.Internal
{
    ...
    public class AmazonSageMakerAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSageMakerAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for SageMaker.
        /// </summary>
        public AmazonSageMakerAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSageMakerAuthSchemeParameters
            {
    ...
    public class AmazonSageMakerAuthSchemeResolver : IAuthSchemeResolver<AmazonSageMakerAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSageMakerAuthSchemeParameters authParameters)
        {
