...
namespace Amazon.SageMaker.Model
{
    ...
    /// information.
    /// </summary>
    public partial class CfnTemplateProviderDetail
    {
        private List<CfnStackParameter> _parameters = AWSConfigs.InitializeCollections ? new List<CfnStackParameter>() : null;
        private string _roleARN;
        private CfnStackDetail _stackDetail;
        ...
        public List<CfnStackParameter> Parameters
        {
        ...
        /// </para>
        /// </summary>
        public CfnStackDetail StackDetail
        {
            get { return this._stackDetail; }
            set { this._stackDetail = value; }
        }

        // Check to see if StackDetail property is set
        internal bool IsSetStackDetail()
        {
            return this._stackDetail != null;
        }
