...
{
    /// <summary>
    /// The configuration for a private hub model reference that points to a public SageMaker
    /// JumpStart model.
    /// 
    ///  
    /// <para>
    /// For more information about private hubs, see <a href="https://docs.aws.amazon.com/sagemaker/latest/dg/jumpstart-curated-hubs.html">Private
    /// curated hubs for foundation model access control in JumpStart</a>.
    /// </para>
    /// </summary>
    public partial class HubAccessConfig
    {
        ...
        /// <para>
        /// The ARN of your private model hub content. This should be a <c>ModelReference</c>
