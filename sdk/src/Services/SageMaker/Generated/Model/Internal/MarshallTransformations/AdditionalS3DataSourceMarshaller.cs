...
{
    /// <summary>
    /// AdditionalS3DataSource Marshaller
    /// </summary>
    public class AdditionalS3DataSourceMarshaller : IRequestMarshaller<AdditionalS3DataSource, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(AdditionalS3DataSource requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static AdditionalS3DataSourceMarshaller Instance = new AdditionalS3DataSourceMarshaller();
