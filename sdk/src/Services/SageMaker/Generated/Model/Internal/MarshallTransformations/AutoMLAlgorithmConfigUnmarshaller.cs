...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AutoMLAlgorithmConfigUnmarshaller : IJsonUnmarshaller<AutoMLAlgorithmConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AutoMLAlgorithmConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AutoMLAlgorithms", targetDepth))
                {
                    ...
                    unmarshalledObject.AutoMLAlgorithms = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
