...
{
    /// <summary>
    /// Response Unmarshaller for BatchDescribeModelPackage operation
    /// </summary>  
    public class BatchDescribeModelPackageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchDescribeModelPackageResponse response = new BatchDescribeModelPackageResponse();
        ...
        private static BatchDescribeModelPackageResponseUnmarshaller _instance = new BatchDescribeModelPackageResponseUnmarshaller();        

        internal static BatchDescribeModelPackageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDescribeModelPackageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
