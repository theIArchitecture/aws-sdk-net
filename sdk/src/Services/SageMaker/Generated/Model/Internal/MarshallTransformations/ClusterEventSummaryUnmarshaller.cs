...
{
    /// <summary>
    /// Response Unmarshaller for ClusterEventSummary Object
    /// </summary>  
    public class ClusterEventSummaryUnmarshaller : IJsonUnmarshaller<ClusterEventSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ClusterEventSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ClusterEventSummary unmarshalledObject = new ClusterEventSummary();
        ...
        private static ClusterEventSummaryUnmarshaller _instance = new ClusterEventSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ClusterEventSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
