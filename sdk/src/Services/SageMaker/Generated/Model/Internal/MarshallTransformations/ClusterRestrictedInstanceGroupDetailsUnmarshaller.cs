...
{
    /// <summary>
    /// Response Unmarshaller for ClusterRestrictedInstanceGroupDetails Object
    /// </summary>  
    public class ClusterRestrictedInstanceGroupDetailsUnmarshaller : IJsonUnmarshaller<ClusterRestrictedInstanceGroupDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ClusterRestrictedInstanceGroupDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ClusterRestrictedInstanceGroupDetails unmarshalledObject = new ClusterRestrictedInstanceGroupDetails();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("EnvironmentConfig", targetDepth))
                {
                    var unmarshaller = EnvironmentConfigDetailsUnmarshaller.Instance;
                    unmarshalledObject.EnvironmentConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ClusterRestrictedInstanceGroupDetailsUnmarshaller _instance = new ClusterRestrictedInstanceGroupDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ClusterRestrictedInstanceGroupDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
