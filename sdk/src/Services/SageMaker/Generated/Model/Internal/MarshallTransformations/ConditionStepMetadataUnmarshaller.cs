...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConditionStepMetadataUnmarshaller : IJsonUnmarshaller<ConditionStepMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ConditionStepMetadata Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Outcome", targetDepth))
                {
                    ...
                    unmarshalledObject.Outcome = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
