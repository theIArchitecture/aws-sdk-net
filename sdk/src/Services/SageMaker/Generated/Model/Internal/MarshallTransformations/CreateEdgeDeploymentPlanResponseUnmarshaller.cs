...
{
    /// <summary>
    /// Response Unmarshaller for CreateEdgeDeploymentPlan operation
    /// </summary>  
    public class CreateEdgeDeploymentPlanResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateEdgeDeploymentPlanResponse response = new CreateEdgeDeploymentPlanResponse();
        ...
        private static CreateEdgeDeploymentPlanResponseUnmarshaller _instance = new CreateEdgeDeploymentPlanResponseUnmarshaller();        

        internal static CreateEdgeDeploymentPlanResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateEdgeDeploymentPlanResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
