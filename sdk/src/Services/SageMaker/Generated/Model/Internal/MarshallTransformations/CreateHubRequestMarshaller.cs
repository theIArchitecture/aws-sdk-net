...
{
    /// <summary>
    /// CreateHub Request Marshaller
    /// </summary>       
    public class CreateHubRequestMarshaller : IMarshaller<IRequest, CreateHubRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateHubRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateHubRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.CreateHub";
            ...
            if(publicRequest.IsSetHubDescription())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.HubDescription);
            }

            if(publicRequest.IsSetHubDisplayName())
            {
                context.Writer.WritePropertyName("HubDisplayName");
                context.Writer.WriteStringValue(publicRequest.HubDisplayName);
            }
            ...
            if(publicRequest.IsSetHubSearchKeywords())
            {
                ...
                {
                        context.Writer.WriteStringValue(publicRequestHubSearchKeywordsListValue);
                }
        ...
        private static CreateHubRequestMarshaller _instance = new CreateHubRequestMarshaller();        

        internal static CreateHubRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateHubRequestMarshaller Instance
        {
            get
            {
                return _instance;
