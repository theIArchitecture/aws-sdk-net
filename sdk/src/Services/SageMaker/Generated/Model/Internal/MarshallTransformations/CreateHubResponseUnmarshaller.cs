...
{
    /// <summary>
    /// Response Unmarshaller for CreateHub operation
    /// </summary>  
    public class CreateHubResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateHubResponse response = new CreateHubResponse();
        ...
        private static CreateHubResponseUnmarshaller _instance = new CreateHubResponseUnmarshaller();        

        internal static CreateHubResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateHubResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
