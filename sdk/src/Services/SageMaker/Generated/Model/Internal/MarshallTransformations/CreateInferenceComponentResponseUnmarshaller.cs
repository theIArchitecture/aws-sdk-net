...
{
    /// <summary>
    /// Response Unmarshaller for CreateInferenceComponent operation
    /// </summary>  
    public class CreateInferenceComponentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateInferenceComponentResponse response = new CreateInferenceComponentResponse();
        ...
        private static CreateInferenceComponentResponseUnmarshaller _instance = new CreateInferenceComponentResponseUnmarshaller();        

        internal static CreateInferenceComponentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateInferenceComponentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
