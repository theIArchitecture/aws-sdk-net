...
{
    /// <summary>
    /// Response Unmarshaller for CreateInferenceExperiment operation
    /// </summary>  
    public class CreateInferenceExperimentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateInferenceExperimentResponse response = new CreateInferenceExperimentResponse();
        ...
        private static CreateInferenceExperimentResponseUnmarshaller _instance = new CreateInferenceExperimentResponseUnmarshaller();        

        internal static CreateInferenceExperimentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateInferenceExperimentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
