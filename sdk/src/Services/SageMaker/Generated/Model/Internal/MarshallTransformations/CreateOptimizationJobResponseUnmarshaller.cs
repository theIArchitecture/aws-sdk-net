...
{
    /// <summary>
    /// Response Unmarshaller for CreateOptimizationJob operation
    /// </summary>  
    public class CreateOptimizationJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateOptimizationJobResponse response = new CreateOptimizationJobResponse();
        ...
        private static CreateOptimizationJobResponseUnmarshaller _instance = new CreateOptimizationJobResponseUnmarshaller();        

        internal static CreateOptimizationJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateOptimizationJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
