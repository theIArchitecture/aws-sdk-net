...
{
    /// <summary>
    /// Response Unmarshaller for CreateTrainingPlan operation
    /// </summary>  
    public class CreateTrainingPlanResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateTrainingPlanResponseUnmarshaller _instance = new CreateTrainingPlanResponseUnmarshaller();        

        internal static CreateTrainingPlanResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTrainingPlanResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
