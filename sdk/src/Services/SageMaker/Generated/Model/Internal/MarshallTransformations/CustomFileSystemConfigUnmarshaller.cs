...
{
    /// <summary>
    /// Response Unmarshaller for CustomFileSystemConfig Object
    /// </summary>  
    public class CustomFileSystemConfigUnmarshaller : IJsonUnmarshaller<CustomFileSystemConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CustomFileSystemConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            CustomFileSystemConfig unmarshalledObject = new CustomFileSystemConfig();
        ...
        private static CustomFileSystemConfigUnmarshaller _instance = new CustomFileSystemConfigUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CustomFileSystemConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
