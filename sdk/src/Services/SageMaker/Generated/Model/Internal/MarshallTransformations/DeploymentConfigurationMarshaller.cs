    ...
    public class DeploymentConfigurationMarshaller : IRequestMarshaller<DeploymentConfiguration, JsonMarshallerContext> 
    {
        ...
        public void Marshall(DeploymentConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetAutoRollbackConfiguration())
            {
                ...
                foreach(var requestObjectAutoRollbackConfigurationListValue in requestObject.AutoRollbackConfiguration)
                {
                    context.Writer.WriteStartObject();

                    var marshaller = AlarmDetailsMarshaller.Instance;
                    marshaller.Marshall(requestObjectAutoRollbackConfigurationListValue, context);
            ...
            if(requestObject.IsSetRollingUpdatePolicy())
            {
                ...
                var marshaller = RollingDeploymentPolicyMarshaller.Instance;
