...
{
    /// <summary>
    /// Response Unmarshaller for DeploymentRecommendation Object
    /// </summary>  
    public class DeploymentRecommendationUnmarshaller : IJsonUnmarshaller<DeploymentRecommendation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DeploymentRecommendation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static DeploymentRecommendationUnmarshaller _instance = new DeploymentRecommendationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DeploymentRecommendationUnmarshaller Instance
        {
            get
            {
                return _instance;
