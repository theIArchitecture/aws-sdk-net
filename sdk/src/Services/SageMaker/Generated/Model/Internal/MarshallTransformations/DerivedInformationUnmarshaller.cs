...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DerivedInformationUnmarshaller : IJsonUnmarshaller<DerivedInformation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DerivedInformation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("DerivedDataInputConfig", targetDepth))
                {
                    ...
                    unmarshalledObject.DerivedDataInputConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
