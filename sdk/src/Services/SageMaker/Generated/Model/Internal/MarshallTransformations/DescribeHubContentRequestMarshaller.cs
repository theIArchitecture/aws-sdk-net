...
{
    /// <summary>
    /// DescribeHubContent Request Marshaller
    /// </summary>       
    public class DescribeHubContentRequestMarshaller : IMarshaller<IRequest, DescribeHubContentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeHubContentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeHubContentRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.DescribeHubContent";
        ...
        private static DescribeHubContentRequestMarshaller _instance = new DescribeHubContentRequestMarshaller();        

        internal static DescribeHubContentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeHubContentRequestMarshaller Instance
        {
            get
            {
                return _instance;
