    ...
    public class DescribeHubResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.HubDescription = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("HubDisplayName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.HubDisplayName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("HubSearchKeywords", targetDepth))
                {
                    ...
                    response.HubSearchKeywords = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("HubStatus", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.HubStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("S3StorageConfig", targetDepth))
                {
                    ...
                    response.S3StorageConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
