...
{
    /// <summary>
    /// Response Unmarshaller for DescribeLineageGroup operation
    /// </summary>  
    public class DescribeLineageGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeLineageGroupResponse response = new DescribeLineageGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.LineageGroupName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeLineageGroupResponseUnmarshaller _instance = new DescribeLineageGroupResponseUnmarshaller();        

        internal static DescribeLineageGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeLineageGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
