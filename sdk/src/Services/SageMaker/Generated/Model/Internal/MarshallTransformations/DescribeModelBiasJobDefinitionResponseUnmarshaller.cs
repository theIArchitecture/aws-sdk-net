        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ModelBiasAppSpecification", targetDepth))
                {
                    ...
                    response.ModelBiasAppSpecification = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ModelBiasBaselineConfig", targetDepth))
                {
                    ...
                    response.ModelBiasBaselineConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ModelBiasJobInput", targetDepth))
                {
                    var unmarshaller = ModelBiasJobInputUnmarshaller.Instance;
                    response.ModelBiasJobInput = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ModelBiasJobOutputConfig", targetDepth))
                {
                    ...
                    response.ModelBiasJobOutputConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
