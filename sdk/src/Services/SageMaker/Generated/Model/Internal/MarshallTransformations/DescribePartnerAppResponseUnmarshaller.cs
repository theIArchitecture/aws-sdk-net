...
{
    /// <summary>
    /// Response Unmarshaller for DescribePartnerApp operation
    /// </summary>  
    public class DescribePartnerAppResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribePartnerAppResponse response = new DescribePartnerAppResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = PartnerAppConfigUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.BaseUrl = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("EnableIamSessionBasedIdentity", targetDepth))
                {
                    ...
                    response.EnableIamSessionBasedIdentity = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("MaintenanceConfig", targetDepth))
                {
                    ...
                    response.MaintenanceConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribePartnerAppResponseUnmarshaller _instance = new DescribePartnerAppResponseUnmarshaller();        

        internal static DescribePartnerAppResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribePartnerAppResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
