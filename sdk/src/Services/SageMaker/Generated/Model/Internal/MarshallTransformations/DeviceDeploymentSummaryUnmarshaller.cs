...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    public class DeviceDeploymentSummaryUnmarshaller : IJsonUnmarshaller<DeviceDeploymentSummary, JsonUnmarshallerContext>
    {
        ...
        private static DeviceDeploymentSummaryUnmarshaller _instance = new DeviceDeploymentSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DeviceDeploymentSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
