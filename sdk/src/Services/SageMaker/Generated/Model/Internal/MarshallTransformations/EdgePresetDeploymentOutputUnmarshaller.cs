...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EdgePresetDeploymentOutputUnmarshaller : IJsonUnmarshaller<EdgePresetDeploymentOutput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EdgePresetDeploymentOutput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Artifact", targetDepth))
                {
                    ...
                    unmarshalledObject.Artifact = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
