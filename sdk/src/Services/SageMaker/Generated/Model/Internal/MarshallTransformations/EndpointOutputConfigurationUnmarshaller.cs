...
{
    /// <summary>
    /// Response Unmarshaller for EndpointOutputConfiguration Object
    /// </summary>  
    public class EndpointOutputConfigurationUnmarshaller : IJsonUnmarshaller<EndpointOutputConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EndpointOutputConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            EndpointOutputConfiguration unmarshalledObject = new EndpointOutputConfiguration();
        ...
        private static EndpointOutputConfigurationUnmarshaller _instance = new EndpointOutputConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static EndpointOutputConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
