...
{
    /// <summary>
    /// Response Unmarshaller for EventMetadata Object
    /// </summary>  
    public class EventMetadataUnmarshaller : IJsonUnmarshaller<EventMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EventMetadata Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            EventMetadata unmarshalledObject = new EventMetadata();
        ...
        private static EventMetadataUnmarshaller _instance = new EventMetadataUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static EventMetadataUnmarshaller Instance
        {
            get
            {
                return _instance;
