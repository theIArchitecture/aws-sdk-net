...
{
    /// <summary>
    /// Response Unmarshaller for ImportHubContent operation
    /// </summary>  
    public class ImportHubContentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ImportHubContentResponse response = new ImportHubContentResponse();
        ...
        private static ImportHubContentResponseUnmarshaller _instance = new ImportHubContentResponseUnmarshaller();        

        internal static ImportHubContentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImportHubContentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
