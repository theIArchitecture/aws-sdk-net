...
{
    /// <summary>
    /// InferenceComponentRollingUpdatePolicy Marshaller
    /// </summary>
    public class InferenceComponentRollingUpdatePolicyMarshaller : IRequestMarshaller<InferenceComponentRollingUpdatePolicy, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(InferenceComponentRollingUpdatePolicy requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetMaximumBatchSize())
            {
                ...
                var marshaller = InferenceComponentCapacitySizeMarshaller.Instance;
        ...
        /// </summary>
        public readonly static InferenceComponentRollingUpdatePolicyMarshaller Instance = new InferenceComponentRollingUpdatePolicyMarshaller();
