...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InferenceComponentRollingUpdatePolicyUnmarshaller : IJsonUnmarshaller<InferenceComponentRollingUpdatePolicy, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InferenceComponentRollingUpdatePolicy Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("MaximumBatchSize", targetDepth))
                {
                    ...
                    unmarshalledObject.MaximumBatchSize = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = InferenceComponentCapacitySizeUnmarshaller.Instance;
                    unmarshalledObject.RollbackMaximumBatchSize = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
