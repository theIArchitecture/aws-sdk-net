    ...
    public class ListAssociationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AssociationSummary, AssociationSummaryUnmarshaller>(AssociationSummaryUnmarshaller.Instance);
                    response.AssociationSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
