...
{
    /// <summary>
    /// ListClusterNodes Request Marshaller
    /// </summary>       
    public class ListClusterNodesRequestMarshaller : IMarshaller<IRequest, ListClusterNodesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListClusterNodesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListClusterNodesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.ListClusterNodes";
            ...
            if(publicRequest.IsSetInstanceGroupNameContains())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.InstanceGroupNameContains);
            }
        ...
        private static ListClusterNodesRequestMarshaller _instance = new ListClusterNodesRequestMarshaller();        

        internal static ListClusterNodesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListClusterNodesRequestMarshaller Instance
        {
            get
            {
                return _instance;
