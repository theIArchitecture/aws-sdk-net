...
{
    /// <summary>
    /// ListHubContentVersions Request Marshaller
    /// </summary>       
    public class ListHubContentVersionsRequestMarshaller : IMarshaller<IRequest, ListHubContentVersionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListHubContentVersionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListHubContentVersionsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.ListHubContentVersions";
            ...
            if(publicRequest.IsSetMaxSchemaVersion())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.MaxSchemaVersion);
            }
        ...
        private static ListHubContentVersionsRequestMarshaller _instance = new ListHubContentVersionsRequestMarshaller();        

        internal static ListHubContentVersionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListHubContentVersionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
