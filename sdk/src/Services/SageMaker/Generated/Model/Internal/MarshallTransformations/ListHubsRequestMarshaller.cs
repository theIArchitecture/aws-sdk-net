...
{
    /// <summary>
    /// ListHubs Request Marshaller
    /// </summary>       
    public class ListHubsRequestMarshaller : IMarshaller<IRequest, ListHubsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListHubsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListHubsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.ListHubs";
        ...
        private static ListHubsRequestMarshaller _instance = new ListHubsRequestMarshaller();        

        internal static ListHubsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListHubsRequestMarshaller Instance
        {
            get
            {
                return _instance;
