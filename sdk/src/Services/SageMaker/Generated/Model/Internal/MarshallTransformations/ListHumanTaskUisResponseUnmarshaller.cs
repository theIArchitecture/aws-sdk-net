    ...
    public class ListHumanTaskUisResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<HumanTaskUiSummary, HumanTaskUiSummaryUnmarshaller>(HumanTaskUiSummaryUnmarshaller.Instance);
                    response.HumanTaskUiSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
