...
{
    /// <summary>
    /// ListInferenceComponents Request Marshaller
    /// </summary>       
    public class ListInferenceComponentsRequestMarshaller : IMarshaller<IRequest, ListInferenceComponentsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListInferenceComponentsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListInferenceComponentsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.ListInferenceComponents";
            ...
            if(publicRequest.IsSetEndpointNameEquals())
            {
                context.Writer.WritePropertyName("EndpointNameEquals");
                context.Writer.WriteStringValue(publicRequest.EndpointNameEquals);
            }
            ...
            if(publicRequest.IsSetVariantNameEquals())
            {
                context.Writer.WritePropertyName("VariantNameEquals");
                context.Writer.WriteStringValue(publicRequest.VariantNameEquals);
            }
        ...
        private static ListInferenceComponentsRequestMarshaller _instance = new ListInferenceComponentsRequestMarshaller();        

        internal static ListInferenceComponentsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListInferenceComponentsRequestMarshaller Instance
        {
            get
            {
                return _instance;
