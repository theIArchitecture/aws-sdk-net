...
{
    /// <summary>
    /// ListInferenceExperiments Request Marshaller
    /// </summary>       
    public class ListInferenceExperimentsRequestMarshaller : IMarshaller<IRequest, ListInferenceExperimentsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListInferenceExperimentsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListInferenceExperimentsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.ListInferenceExperiments";
        ...
        private static ListInferenceExperimentsRequestMarshaller _instance = new ListInferenceExperimentsRequestMarshaller();        

        internal static ListInferenceExperimentsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListInferenceExperimentsRequestMarshaller Instance
        {
            get
            {
                return _instance;
