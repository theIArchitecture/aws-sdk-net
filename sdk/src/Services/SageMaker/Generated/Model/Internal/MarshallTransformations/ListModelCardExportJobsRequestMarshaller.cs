...
{
    /// <summary>
    /// ListModelCardExportJobs Request Marshaller
    /// </summary>       
    public class ListModelCardExportJobsRequestMarshaller : IMarshaller<IRequest, ListModelCardExportJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListModelCardExportJobsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListModelCardExportJobsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.ListModelCardExportJobs";
            ...
            if(publicRequest.IsSetModelCardExportJobNameContains())
            {
                context.Writer.WritePropertyName("ModelCardExportJobNameContains");
                context.Writer.WriteStringValue(publicRequest.ModelCardExportJobNameContains);
            }
        ...
        private static ListModelCardExportJobsRequestMarshaller _instance = new ListModelCardExportJobsRequestMarshaller();        

        internal static ListModelCardExportJobsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListModelCardExportJobsRequestMarshaller Instance
        {
            get
            {
                return _instance;
