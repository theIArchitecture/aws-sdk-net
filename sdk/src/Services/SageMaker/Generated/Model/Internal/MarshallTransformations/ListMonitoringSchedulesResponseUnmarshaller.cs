    ...
    public class ListMonitoringSchedulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<MonitoringScheduleSummary, MonitoringScheduleSummaryUnmarshaller>(MonitoringScheduleSummaryUnmarshaller.Instance);
                    response.MonitoringScheduleSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
