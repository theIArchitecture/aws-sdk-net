    ...
    public class ListNotebookInstancesRequestMarshaller : IMarshaller<IRequest, ListNotebookInstancesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListNotebookInstancesRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetAdditionalCodeRepositoryEquals())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.AdditionalCodeRepositoryEquals);
            }
            ...
            if(publicRequest.IsSetDefaultCodeRepositoryContains())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.DefaultCodeRepositoryContains);
            }
            ...
            if(publicRequest.IsSetNotebookInstanceLifecycleConfigNameContains())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.NotebookInstanceLifecycleConfigNameContains);
            }
