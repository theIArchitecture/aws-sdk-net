...
{
    /// <summary>
    /// ListOptimizationJobs Request Marshaller
    /// </summary>       
    public class ListOptimizationJobsRequestMarshaller : IMarshaller<IRequest, ListOptimizationJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListOptimizationJobsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListOptimizationJobsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.ListOptimizationJobs";
            ...
            if(publicRequest.IsSetOptimizationContains())
            {
                context.Writer.WritePropertyName("OptimizationContains");
                context.Writer.WriteStringValue(publicRequest.OptimizationContains);
            }
        ...
        private static ListOptimizationJobsRequestMarshaller _instance = new ListOptimizationJobsRequestMarshaller();        

        internal static ListOptimizationJobsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListOptimizationJobsRequestMarshaller Instance
        {
            get
            {
                return _instance;
