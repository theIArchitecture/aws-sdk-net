...
{
    /// <summary>
    /// ListStudioLifecycleConfigs Request Marshaller
    /// </summary>       
    public class ListStudioLifecycleConfigsRequestMarshaller : IMarshaller<IRequest, ListStudioLifecycleConfigsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListStudioLifecycleConfigsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListStudioLifecycleConfigsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.ListStudioLifecycleConfigs";
            ...
            if(publicRequest.IsSetAppTypeEquals())
            {
                context.Writer.WritePropertyName("AppTypeEquals");
                context.Writer.WriteStringValue(publicRequest.AppTypeEquals);
            }
        ...
        private static ListStudioLifecycleConfigsRequestMarshaller _instance = new ListStudioLifecycleConfigsRequestMarshaller();        

        internal static ListStudioLifecycleConfigsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListStudioLifecycleConfigsRequestMarshaller Instance
        {
            get
            {
                return _instance;
