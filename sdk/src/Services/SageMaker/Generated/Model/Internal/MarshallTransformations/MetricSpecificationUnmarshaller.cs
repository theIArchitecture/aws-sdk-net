...
{
    /// <summary>
    /// Response Unmarshaller for MetricSpecification Object
    /// </summary>  
    public class MetricSpecificationUnmarshaller : IJsonUnmarshaller<MetricSpecification, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MetricSpecification Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static MetricSpecificationUnmarshaller _instance = new MetricSpecificationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static MetricSpecificationUnmarshaller Instance
        {
            get
            {
                return _instance;
