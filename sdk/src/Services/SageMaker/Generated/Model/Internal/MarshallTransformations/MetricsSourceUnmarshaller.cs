...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MetricsSourceUnmarshaller : IJsonUnmarshaller<MetricsSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MetricsSource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ContentDigest", targetDepth))
                {
                    ...
                    unmarshalledObject.ContentDigest = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
