...
{
    /// <summary>
    /// Response Unmarshaller for ModelCardVersionSummary Object
    /// </summary>  
    public class ModelCardVersionSummaryUnmarshaller : IJsonUnmarshaller<ModelCardVersionSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ModelCardVersionSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ModelCardVersionSummary unmarshalledObject = new ModelCardVersionSummary();
        ...
        private static ModelCardVersionSummaryUnmarshaller _instance = new ModelCardVersionSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ModelCardVersionSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
