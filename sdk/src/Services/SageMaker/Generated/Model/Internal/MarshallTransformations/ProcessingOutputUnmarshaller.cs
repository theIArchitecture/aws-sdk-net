...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ProcessingOutputUnmarshaller : IJsonUnmarshaller<ProcessingOutput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ProcessingOutput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("FeatureStoreOutput", targetDepth))
                {
                    ...
                    unmarshalledObject.FeatureStoreOutput = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
