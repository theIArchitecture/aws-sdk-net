...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    public class ProductionVariantServerlessConfigUnmarshaller : IJsonUnmarshaller<ProductionVariantServerlessConfig, JsonUnmarshallerContext>
    {
        ...
        private static ProductionVariantServerlessConfigUnmarshaller _instance = new ProductionVariantServerlessConfigUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ProductionVariantServerlessConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
