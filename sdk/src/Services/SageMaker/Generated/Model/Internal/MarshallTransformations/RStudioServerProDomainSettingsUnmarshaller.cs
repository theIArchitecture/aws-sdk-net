...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    public class RStudioServerProDomainSettingsUnmarshaller : IJsonUnmarshaller<RStudioServerProDomainSettings, JsonUnmarshallerContext>
    {
        ...
        private static RStudioServerProDomainSettingsUnmarshaller _instance = new RStudioServerProDomainSettingsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RStudioServerProDomainSettingsUnmarshaller Instance
        {
            get
            {
                return _instance;
