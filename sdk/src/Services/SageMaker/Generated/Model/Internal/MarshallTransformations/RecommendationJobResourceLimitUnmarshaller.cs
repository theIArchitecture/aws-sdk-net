...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RecommendationJobResourceLimitUnmarshaller : IJsonUnmarshaller<RecommendationJobResourceLimit, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RecommendationJobResourceLimit Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("MaxNumberOfTests", targetDepth))
                {
                    ...
                    unmarshalledObject.MaxNumberOfTests = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("MaxParallelOfTests", targetDepth))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.MaxParallelOfTests = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
