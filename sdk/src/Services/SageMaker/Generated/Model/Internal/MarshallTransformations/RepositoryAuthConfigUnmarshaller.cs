...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RepositoryAuthConfigUnmarshaller : IJsonUnmarshaller<RepositoryAuthConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RepositoryAuthConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("RepositoryCredentialsProviderArn", targetDepth))
                {
                    ...
                    unmarshalledObject.RepositoryCredentialsProviderArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
