...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ReservedCapacitySummaryUnmarshaller : IJsonUnmarshaller<ReservedCapacitySummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ReservedCapacitySummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ReservedCapacityArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
