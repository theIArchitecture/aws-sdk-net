...
{
    /// <summary>
    /// Response Unmarshaller for RetryPipelineExecution operation
    /// </summary>  
    public class RetryPipelineExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RetryPipelineExecutionResponse response = new RetryPipelineExecutionResponse();
        ...
        private static RetryPipelineExecutionResponseUnmarshaller _instance = new RetryPipelineExecutionResponseUnmarshaller();        

        internal static RetryPipelineExecutionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RetryPipelineExecutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
