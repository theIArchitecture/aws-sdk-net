...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StudioLifecycleConfigDetailsUnmarshaller : IJsonUnmarshaller<StudioLifecycleConfigDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public StudioLifecycleConfigDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("StudioLifecycleConfigAppType", targetDepth))
                {
                    ...
                    unmarshalledObject.StudioLifecycleConfigAppType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("StudioLifecycleConfigArn", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.StudioLifecycleConfigArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("StudioLifecycleConfigName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.StudioLifecycleConfigName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
