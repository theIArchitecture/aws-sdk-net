...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TimeSeriesConfigUnmarshaller : IJsonUnmarshaller<TimeSeriesConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TimeSeriesConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("GroupingAttributeNames", targetDepth))
                {
                    ...
                    unmarshalledObject.GroupingAttributeNames = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ItemIdentifierAttributeName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ItemIdentifierAttributeName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
