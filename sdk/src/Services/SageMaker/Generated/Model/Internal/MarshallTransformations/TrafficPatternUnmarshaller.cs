...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TrafficPatternUnmarshaller : IJsonUnmarshaller<TrafficPattern, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TrafficPattern Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<Phase, PhaseUnmarshaller>(PhaseUnmarshaller.Instance);
                ...
                if (context.TestExpression("Stairs", targetDepth))
                {
                    ...
                    unmarshalledObject.Stairs = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
