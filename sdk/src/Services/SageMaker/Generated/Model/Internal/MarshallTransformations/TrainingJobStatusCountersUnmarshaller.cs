...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TrainingJobStatusCountersUnmarshaller : IJsonUnmarshaller<TrainingJobStatusCounters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TrainingJobStatusCounters Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.NonRetryableError = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("RetryableError", targetDepth))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.RetryableError = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
