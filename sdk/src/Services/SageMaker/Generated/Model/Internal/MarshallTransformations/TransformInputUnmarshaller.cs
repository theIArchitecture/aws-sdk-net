...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TransformInputUnmarshaller : IJsonUnmarshaller<TransformInput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TransformInput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SplitType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
