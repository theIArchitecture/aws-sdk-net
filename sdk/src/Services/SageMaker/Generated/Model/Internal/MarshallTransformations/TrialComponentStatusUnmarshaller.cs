...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TrialComponentStatusUnmarshaller : IJsonUnmarshaller<TrialComponentStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TrialComponentStatus Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PrimaryStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
