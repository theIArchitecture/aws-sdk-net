...
{
    /// <summary>
    /// Response Unmarshaller for UpdateHubContentReference operation
    /// </summary>  
    public class UpdateHubContentReferenceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateHubContentReferenceResponse response = new UpdateHubContentReferenceResponse();
        ...
        private static UpdateHubContentReferenceResponseUnmarshaller _instance = new UpdateHubContentReferenceResponseUnmarshaller();        

        internal static UpdateHubContentReferenceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateHubContentReferenceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
