...
{
    /// <summary>
    /// Response Unmarshaller for UpdateHubContent operation
    /// </summary>  
    public class UpdateHubContentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateHubContentResponse response = new UpdateHubContentResponse();
        ...
        private static UpdateHubContentResponseUnmarshaller _instance = new UpdateHubContentResponseUnmarshaller();        

        internal static UpdateHubContentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateHubContentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
