...
{
    /// <summary>
    /// Response Unmarshaller for UpdateInferenceComponent operation
    /// </summary>  
    public class UpdateInferenceComponentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateInferenceComponentResponse response = new UpdateInferenceComponentResponse();
        ...
        private static UpdateInferenceComponentResponseUnmarshaller _instance = new UpdateInferenceComponentResponseUnmarshaller();        

        internal static UpdateInferenceComponentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateInferenceComponentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
