...
{
    /// <summary>
    /// Response Unmarshaller for UpdateMonitoringAlert operation
    /// </summary>  
    public class UpdateMonitoringAlertResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateMonitoringAlertResponse response = new UpdateMonitoringAlertResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("MonitoringAlertName", targetDepth))
                {
                    ...
                    response.MonitoringAlertName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateMonitoringAlertResponseUnmarshaller _instance = new UpdateMonitoringAlertResponseUnmarshaller();        

        internal static UpdateMonitoringAlertResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMonitoringAlertResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
