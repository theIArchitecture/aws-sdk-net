...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateSpaceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSpaceResponse response = new UpdateSpaceResponse();
        ...
        internal static UpdateSpaceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSpaceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
