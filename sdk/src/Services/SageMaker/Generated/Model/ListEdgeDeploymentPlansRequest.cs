...
{
    /// <summary>
    /// Container for the parameters to the ListEdgeDeploymentPlans operation.
    /// Lists all edge deployment plans.
    /// </summary>
    public partial class ListEdgeDeploymentPlansRequest : AmazonSageMakerRequest
    {
        private DateTime? _creationTimeAfter;
        private DateTime? _creationTimeBefore;
        private string _deviceFleetNameContains;
        private DateTime? _lastModifiedTimeAfter;
        private DateTime? _lastModifiedTimeBefore;
        private int? _maxResults;
        private string _nameContains;
        private string _nextToken;
        private ListEdgeDeploymentPlansSortBy _sortBy;
        ...
        public string DeviceFleetNameContains
        {
            ...
            set { this._deviceFleetNameContains = value; }
        }

        // Check to see if DeviceFleetNameContains property is set
        internal bool IsSetDeviceFleetNameContains()
        {
            return this._deviceFleetNameContains != null;
        }
