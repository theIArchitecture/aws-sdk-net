...
{
    /// <summary>
    /// This is the response object from the ListHubContentVersions operation.
    /// </summary>
    public partial class ListHubContentVersionsResponse : AmazonWebServiceResponse
    {
        private List<HubContentInfo> _hubContentSummaries = AWSConfigs.InitializeCollections ? new List<HubContentInfo>() : null;
        private string _nextToken;

        /// <summary>
        /// Gets and sets the property HubContentSummaries. 
        /// <para>
        ...
        public List<HubContentInfo> HubContentSummaries
        {
            get { return this._hubContentSummaries; }
            set { this._hubContentSummaries = value; }
        }
        ...
        /// of hub content versions, use it in the subsequent request.
        /// </para>
        /// </summary>
