...
namespace Amazon.SageMaker.Model
{
    ...
    /// Lists spaces.
    /// </summary>
    public partial class ListSpacesRequest : AmazonSageMakerRequest
    {
        private string _domainIdEquals;
        private int? _maxResults;
        private string _nextToken;
        private SpaceSortKey _sortBy;
        private SortOrder _sortOrder;
        private string _spaceNameContains;
        ...
        /// <summary>
        /// Gets and sets the property SpaceNameContains. 
        /// <para>
        ...
        {
            get { return this._spaceNameContains; }
            set { this._spaceNameContains = value; }
        }

        // Check to see if SpaceNameContains property is set
        internal bool IsSetSpaceNameContains()
        {
            return this._spaceNameContains != null;
        }
