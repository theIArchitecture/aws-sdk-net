...
{
    /// <summary>
    /// Container for the parameters to the ListUltraServersByReservedCapacity operation.
    /// Lists all UltraServers that are part of a specified reserved capacity.
    /// </summary>
    public partial class ListUltraServersByReservedCapacityRequest : AmazonSageMakerRequest
    {
        ...
        /// <para>
        /// The maximum number of UltraServers to return in the response. The default value is
        /// 10.
        /// </para>
        /// </summary>
