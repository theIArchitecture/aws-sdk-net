...
namespace Amazon.SageMaker.Model
{
    ...
    /// </summary>
    public partial class PipelineVersion
    {
        private UserContext _createdBy;
        private DateTime? _creationTime;
        private string _lastExecutedPipelineExecutionArn;
        private string _lastExecutedPipelineExecutionDisplayName;
        private PipelineExecutionStatus _lastExecutedPipelineExecutionStatus;
        ...
        /// <summary>
        /// Gets and sets the property LastExecutedPipelineExecutionArn. 
        /// <para>
        ...
        public string LastExecutedPipelineExecutionArn
        {
            get { return this._lastExecutedPipelineExecutionArn; }
            set { this._lastExecutedPipelineExecutionArn = value; }
        }

        // Check to see if LastExecutedPipelineExecutionArn property is set
        internal bool IsSetLastExecutedPipelineExecutionArn()
        {
            return this._lastExecutedPipelineExecutionArn != null;
        }

        /// <summary>
        /// Gets and sets the property LastExecutedPipelineExecutionDisplayName. 
        /// <para>
        /// The display name of the most recent pipeline execution created from this pipeline
        /// version.
        /// </para>
        /// </summary>
        [AWSProperty(Min=1, Max=82)]
        public string LastExecutedPipelineExecutionDisplayName
        {
            get { return this._lastExecutedPipelineExecutionDisplayName; }
            set { this._lastExecutedPipelineExecutionDisplayName = value; }
        }

        // Check to see if LastExecutedPipelineExecutionDisplayName property is set
        internal bool IsSetLastExecutedPipelineExecutionDisplayName()
        {
            return this._lastExecutedPipelineExecutionDisplayName != null;
        }

        /// <summary>
        /// Gets and sets the property LastExecutedPipelineExecutionStatus. 
        /// <para>
        /// The status of the most recent pipeline execution created from this pipeline version.
        /// </para>
        /// </summary>
        public PipelineExecutionStatus LastExecutedPipelineExecutionStatus
        {
            get { return this._lastExecutedPipelineExecutionStatus; }
            set { this._lastExecutedPipelineExecutionStatus = value; }
        }

        // Check to see if LastExecutedPipelineExecutionStatus property is set
        internal bool IsSetLastExecutedPipelineExecutionStatus()
        {
            return this._lastExecutedPipelineExecutionStatus != null;
        }
