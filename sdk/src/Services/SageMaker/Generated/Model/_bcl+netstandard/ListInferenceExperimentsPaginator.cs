...
namespace Amazon.SageMaker.Model
{
    ...
    internal sealed partial class ListInferenceExperimentsPaginator : IPaginator<ListInferenceExperimentsResponse>, IListInferenceExperimentsPaginator
    {
        ...
        public IPaginatedEnumerable<InferenceExperimentSummary> InferenceExperiments => 
            new PaginatedResultKeyResponse<ListInferenceExperimentsResponse, InferenceExperimentSummary>(this, (i) => i.InferenceExperiments ?? new List<InferenceExperimentSummary>());
        ...
        async IAsyncEnumerable<ListInferenceExperimentsResponse> IPaginator<ListInferenceExperimentsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
