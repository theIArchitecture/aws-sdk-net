...
namespace Amazon.SageMaker.Model
{
    ...
    internal sealed partial class ListModelExplainabilityJobDefinitionsPaginator : IPaginator<ListModelExplainabilityJobDefinitionsResponse>, IListModelExplainabilityJobDefinitionsPaginator
    {
        ...
        public IPaginatedEnumerable<MonitoringJobDefinitionSummary> JobDefinitionSummaries => 
            new PaginatedResultKeyResponse<ListModelExplainabilityJobDefinitionsResponse, MonitoringJobDefinitionSummary>(this, (i) => i.JobDefinitionSummaries ?? new List<MonitoringJobDefinitionSummary>());
        ...
        async IAsyncEnumerable<ListModelExplainabilityJobDefinitionsResponse> IPaginator<ListModelExplainabilityJobDefinitionsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
