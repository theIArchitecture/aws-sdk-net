...
namespace Amazon.SageMaker.Model
{
    ...
    internal sealed partial class ListPipelineParametersForExecutionPaginator : IPaginator<ListPipelineParametersForExecutionResponse>, IListPipelineParametersForExecutionPaginator
    {
        ...
        async IAsyncEnumerable<ListPipelineParametersForExecutionResponse> IPaginator<ListPipelineParametersForExecutionResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
