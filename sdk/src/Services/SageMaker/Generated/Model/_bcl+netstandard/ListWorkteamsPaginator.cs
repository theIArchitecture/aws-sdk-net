...
namespace Amazon.SageMaker.Model
{
    ...
    internal sealed partial class ListWorkteamsPaginator : IPaginator<ListWorkteamsResponse>, IListWorkteamsPaginator
    {
        ...
        async IAsyncEnumerable<ListWorkteamsResponse> IPaginator<ListWorkteamsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
