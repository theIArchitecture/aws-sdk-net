...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetRecordError Object
    /// </summary>  
    public class BatchGetRecordErrorUnmarshaller : IJsonUnmarshaller<BatchGetRecordError, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchGetRecordError Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            BatchGetRecordError unmarshalledObject = new BatchGetRecordError();
        ...
        private static BatchGetRecordErrorUnmarshaller _instance = new BatchGetRecordErrorUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetRecordErrorUnmarshaller Instance
        {
            get
            {
                return _instance;
