...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetRecord operation
    /// </summary>  
    public class BatchGetRecordResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static BatchGetRecordResponseUnmarshaller _instance = new BatchGetRecordResponseUnmarshaller();        

        internal static BatchGetRecordResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetRecordResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
