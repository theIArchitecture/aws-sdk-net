...
namespace Amazon.SageMakerGeospatial.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GeoMosaicConfigInputUnmarshaller : IJsonUnmarshaller<GeoMosaicConfigInput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GeoMosaicConfigInput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
