...
{
    /// <summary>
    /// Response Unmarshaller for InputConfigOutput Object
    /// </summary>  
    public class InputConfigOutputUnmarshaller : IJsonUnmarshaller<InputConfigOutput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InputConfigOutput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            InputConfigOutput unmarshalledObject = new InputConfigOutput();
        ...
        private static InputConfigOutputUnmarshaller _instance = new InputConfigOutputUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static InputConfigOutputUnmarshaller Instance
        {
            get
            {
                return _instance;
