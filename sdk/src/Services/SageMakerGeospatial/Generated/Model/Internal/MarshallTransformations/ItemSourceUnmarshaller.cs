...
namespace Amazon.SageMakerGeospatial.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ItemSourceUnmarshaller : IJsonUnmarshaller<ItemSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ItemSource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
