...
namespace Amazon.SageMakerGeospatial.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class JobConfigInputUnmarshaller : IJsonUnmarshaller<JobConfigInput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public JobConfigInput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
