...
namespace Amazon.SageMakerGeospatial.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LandsatCloudCoverLandInputUnmarshaller : IJsonUnmarshaller<LandsatCloudCoverLandInput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LandsatCloudCoverLandInput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
