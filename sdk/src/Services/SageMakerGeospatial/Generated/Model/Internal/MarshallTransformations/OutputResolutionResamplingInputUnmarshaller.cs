...
namespace Amazon.SageMakerGeospatial.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OutputResolutionResamplingInputUnmarshaller : IJsonUnmarshaller<OutputResolutionResamplingInput, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public OutputResolutionResamplingInput Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
