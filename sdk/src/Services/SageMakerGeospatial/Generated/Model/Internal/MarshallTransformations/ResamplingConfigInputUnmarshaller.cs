...
namespace Amazon.SageMakerGeospatial.Model.Internal.MarshallTransformations
{
    ...
    public class ResamplingConfigInputUnmarshaller : IJsonUnmarshaller<ResamplingConfigInput, JsonUnmarshallerContext>
    {
        ...
        private static ResamplingConfigInputUnmarshaller _instance = new ResamplingConfigInputUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ResamplingConfigInputUnmarshaller Instance
        {
            get
            {
                return _instance;
