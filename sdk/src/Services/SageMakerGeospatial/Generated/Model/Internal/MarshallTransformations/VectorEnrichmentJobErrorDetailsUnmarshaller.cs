...
namespace Amazon.SageMakerGeospatial.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VectorEnrichmentJobErrorDetailsUnmarshaller : IJsonUnmarshaller<VectorEnrichmentJobErrorDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public VectorEnrichmentJobErrorDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
