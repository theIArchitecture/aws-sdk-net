...
{
    /// <summary>
    /// Container for the parameters to the ListEarthObservationJobs operation.
    /// Use this operation to get a list of the Earth Observation jobs associated with the
    /// calling Amazon Web Services account.
    /// </summary>
    public partial class ListEarthObservationJobsRequest : AmazonSageMakerGeospatialRequest
    {
        private int? _maxResults;
        private string _nextToken;
        private string _sortBy;
        private SortOrder _sortOrder;
        private EarthObservationJobStatus _statusEquals;
        ...
        /// </para>
        /// </summary>
        public EarthObservationJobStatus StatusEquals
        {
