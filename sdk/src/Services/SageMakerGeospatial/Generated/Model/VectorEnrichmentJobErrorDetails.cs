...
namespace Amazon.SageMakerGeospatial.Model
{
    ...
    /// </summary>
    public partial class VectorEnrichmentJobErrorDetails
    {
        private string _errorMessage;
        private VectorEnrichmentJobErrorType _errorType;

        /// <summary>
        /// Gets and sets the property ErrorMessage. 
        /// <para>
        /// A message that you define and then is processed and rendered by the Vector Enrichment
        /// job when the error occurs.
        /// </para>
        /// </summary>
        ...
        /// </para>
        /// </summary>
        public VectorEnrichmentJobErrorType ErrorType
        {
