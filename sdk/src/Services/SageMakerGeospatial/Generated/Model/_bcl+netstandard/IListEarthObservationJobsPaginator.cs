...
namespace Amazon.SageMakerGeospatial.Model
{
    ...
    public interface IListEarthObservationJobsPaginator
    {
        ...
        /// </summary>
        IPaginatedEnumerable<ListEarthObservationJobsResponse> Responses { get; }

        /// <summary>
        /// Enumerable containing all of the EarthObservationJobSummaries
        /// </summary>
        IPaginatedEnumerable<ListEarthObservationJobOutputConfig> EarthObservationJobSummaries { get; }
    }
}