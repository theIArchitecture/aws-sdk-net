...
namespace Amazon.SageMakerGeospatial
{
    ...
    public partial interface IAmazonSageMakerGeospatial : IAmazonService, IDisposable
    {
        ...
        Task<DeleteEarthObservationJobResponse> DeleteEarthObservationJobAsync(DeleteEarthObservationJobRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteVectorEnrichmentJobResponse> DeleteVectorEnrichmentJobAsync(DeleteVectorEnrichmentJobRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ExportEarthObservationJobResponse> ExportEarthObservationJobAsync(ExportEarthObservationJobRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ExportVectorEnrichmentJobResponse> ExportVectorEnrichmentJobAsync(ExportVectorEnrichmentJobRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetEarthObservationJobResponse> GetEarthObservationJobAsync(GetEarthObservationJobRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetRasterDataCollectionResponse> GetRasterDataCollectionAsync(GetRasterDataCollectionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetVectorEnrichmentJobResponse> GetVectorEnrichmentJobAsync(GetVectorEnrichmentJobRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListEarthObservationJobsResponse> ListEarthObservationJobsAsync(ListEarthObservationJobsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListRasterDataCollectionsResponse> ListRasterDataCollectionsAsync(ListRasterDataCollectionsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListVectorEnrichmentJobsResponse> ListVectorEnrichmentJobsAsync(ListVectorEnrichmentJobsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<SearchRasterDataCollectionResponse> SearchRasterDataCollectionAsync(SearchRasterDataCollectionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StartEarthObservationJobResponse> StartEarthObservationJobAsync(StartEarthObservationJobRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StartVectorEnrichmentJobResponse> StartVectorEnrichmentJobAsync(StartVectorEnrichmentJobRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StopEarthObservationJobResponse> StopEarthObservationJobAsync(StopEarthObservationJobRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StopVectorEnrichmentJobResponse> StopVectorEnrichmentJobAsync(StopVectorEnrichmentJobRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonSageMakerGeospatialConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonSageMakerGeospatialConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonSageMakerGeospatialConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonSageMakerGeospatialConfig to create AmazonSageMakerGeospatialClient");
            }

            return awsCredentials == null ? 
                    new AmazonSageMakerGeospatialClient(serviceClientConfig) :
                    new AmazonSageMakerGeospatialClient(awsCredentials, serviceClientConfig);
        }
