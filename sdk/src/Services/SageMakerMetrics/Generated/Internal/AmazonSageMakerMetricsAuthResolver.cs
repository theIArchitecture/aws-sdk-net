...
namespace Amazon.SageMakerMetrics.Internal
{
    ...
    public class AmazonSageMakerMetricsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSageMakerMetricsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for SageMakerMetrics.
        /// </summary>
        public AmazonSageMakerMetricsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSageMakerMetricsAuthSchemeParameters
            {
    ...
    public class AmazonSageMakerMetricsAuthSchemeResolver : IAuthSchemeResolver<AmazonSageMakerMetricsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSageMakerMetricsAuthSchemeParameters authParameters)
        {
