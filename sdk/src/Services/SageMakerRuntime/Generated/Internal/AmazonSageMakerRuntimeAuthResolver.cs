...
namespace Amazon.SageMakerRuntime.Internal
{
    ...
    public class AmazonSageMakerRuntimeAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSageMakerRuntimeAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for SageMakerRuntime.
        /// </summary>
        public AmazonSageMakerRuntimeAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSageMakerRuntimeAuthSchemeParameters
            {
    ...
    public class AmazonSageMakerRuntimeAuthSchemeResolver : IAuthSchemeResolver<AmazonSageMakerRuntimeAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSageMakerRuntimeAuthSchemeParameters authParameters)
        {
