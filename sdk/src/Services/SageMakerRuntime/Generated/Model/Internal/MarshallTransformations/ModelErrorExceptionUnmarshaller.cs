...
namespace Amazon.SageMakerRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ModelErrorExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<ModelErrorException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public ModelErrorException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public ModelErrorException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
