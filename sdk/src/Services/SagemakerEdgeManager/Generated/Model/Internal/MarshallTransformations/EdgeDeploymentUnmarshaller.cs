...
namespace Amazon.SagemakerEdgeManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EdgeDeploymentUnmarshaller : IJsonUnmarshaller<EdgeDeployment, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EdgeDeployment Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
