...
namespace Amazon.Scheduler.Internal
{
    ...
    public class AmazonSchedulerAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSchedulerAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Scheduler.
        /// </summary>
        public AmazonSchedulerAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSchedulerAuthSchemeParameters
            {
    ...
    public class AmazonSchedulerAuthSchemeResolver : IAuthSchemeResolver<AmazonSchedulerAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSchedulerAuthSchemeParameters authParameters)
        {
