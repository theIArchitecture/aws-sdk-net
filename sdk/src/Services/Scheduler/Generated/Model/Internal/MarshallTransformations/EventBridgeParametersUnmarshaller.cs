...
namespace Amazon.Scheduler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EventBridgeParametersUnmarshaller : IJsonUnmarshaller<EventBridgeParameters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EventBridgeParameters Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
