...
namespace Amazon.Scheduler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ScheduleSummaryUnmarshaller : IJsonUnmarshaller<ScheduleSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ScheduleSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
