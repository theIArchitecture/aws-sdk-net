...
namespace Amazon.Scheduler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SqsParametersUnmarshaller : IJsonUnmarshaller<SqsParameters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SqsParameters Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
