...
namespace Amazon.Scheduler
{
    ...
    public partial interface IAmazonScheduler : IAmazonService, IDisposable
    {
        ...
        Task<CreateScheduleGroupResponse> CreateScheduleGroupAsync(CreateScheduleGroupRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteScheduleGroupResponse> DeleteScheduleGroupAsync(DeleteScheduleGroupRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetScheduleResponse> GetScheduleAsync(GetScheduleRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetScheduleGroupResponse> GetScheduleGroupAsync(GetScheduleGroupRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListScheduleGroupsResponse> ListScheduleGroupsAsync(ListScheduleGroupsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonSchedulerConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonSchedulerConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonSchedulerConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonSchedulerConfig to create AmazonSchedulerClient");
            }

            return awsCredentials == null ? 
                    new AmazonSchedulerClient(serviceClientConfig) :
                    new AmazonSchedulerClient(awsCredentials, serviceClientConfig);
        }
