...
namespace Amazon.Schemas.Internal
{
    ...
    public class AmazonSchemasAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSchemasAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Schemas.
        /// </summary>
        public AmazonSchemasAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSchemasAuthSchemeParameters
            {
    ...
    public class AmazonSchemasAuthSchemeResolver : IAuthSchemeResolver<AmazonSchemasAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSchemasAuthSchemeParameters authParameters)
        {
