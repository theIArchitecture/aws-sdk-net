...
{
    /// <summary>
    /// Amazon Schemas endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for Schemas service requests.
    /// Collects values for SchemasEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses SchemasEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonSchemasEndpointResolver : BaseEndpointResolver
    {
