    ...
    public class ListDiscoverersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DiscovererSummary, DiscovererSummaryUnmarshaller>(DiscovererSummaryUnmarshaller.Instance);
                    response.Discoverers = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
