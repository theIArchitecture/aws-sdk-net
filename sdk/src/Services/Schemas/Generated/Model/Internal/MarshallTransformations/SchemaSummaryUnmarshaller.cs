...
namespace Amazon.Schemas.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SchemaSummaryUnmarshaller : IJsonUnmarshaller<SchemaSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SchemaSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("VersionCount", targetDepth))
                {
                    ...
                    unmarshalledObject.VersionCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
