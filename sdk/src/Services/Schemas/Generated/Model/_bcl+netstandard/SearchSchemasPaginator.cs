...
namespace Amazon.Schemas.Model
{
    ...
    internal sealed partial class SearchSchemasPaginator : IPaginator<SearchSchemasResponse>, ISearchSchemasPaginator
    {
        ...
        public IPaginatedEnumerable<SearchSchemaSummary> Schemas => 
            new PaginatedResultKeyResponse<SearchSchemasResponse, SearchSchemaSummary>(this, (i) => i.Schemas ?? new List<SearchSchemaSummary>());
        ...
        async IAsyncEnumerable<SearchSchemasResponse> IPaginator<SearchSchemasResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
