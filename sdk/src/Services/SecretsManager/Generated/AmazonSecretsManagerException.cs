...
namespace Amazon.SecretsManager
{
    ...
    public partial class AmazonSecretsManagerException : AmazonServiceException
    {
        ...
        public AmazonSecretsManagerException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonSecretsManagerException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
