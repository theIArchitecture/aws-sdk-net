...
namespace Amazon.SecretsManager.Internal
{
    ...
    public class AmazonSecretsManagerAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSecretsManagerAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for SecretsManager.
        /// </summary>
        public AmazonSecretsManagerAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSecretsManagerAuthSchemeParameters
            {
    ...
    public class AmazonSecretsManagerAuthSchemeResolver : IAuthSchemeResolver<AmazonSecretsManagerAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSecretsManagerAuthSchemeParameters authParameters)
        {
