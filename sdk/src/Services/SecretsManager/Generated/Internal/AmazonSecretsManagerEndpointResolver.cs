...
namespace Amazon.SecretsManager.Internal
{
    ...
    /// </summary>
    public class AmazonSecretsManagerEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonSecretsManagerConfig)requestContext.ClientConfig;
            var result = new SecretsManagerEndpointParameters();
