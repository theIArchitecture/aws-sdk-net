...
namespace Amazon.SecretsManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class APIErrorTypeUnmarshaller : IJsonUnmarshaller<APIErrorType, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public APIErrorType Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            APIErrorType unmarshalledObject = new APIErrorType();
        ...
        private static APIErrorTypeUnmarshaller _instance = new APIErrorTypeUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static APIErrorTypeUnmarshaller Instance
        {
            get
            {
                return _instance;
