...
namespace Amazon.SecretsManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchGetSecretValueResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchGetSecretValueResponse response = new BatchGetSecretValueResponse();
        ...
        private static BatchGetSecretValueResponseUnmarshaller _instance = new BatchGetSecretValueResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetSecretValueResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
