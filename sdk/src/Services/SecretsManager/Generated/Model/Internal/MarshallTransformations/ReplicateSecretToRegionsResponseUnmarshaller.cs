...
namespace Amazon.SecretsManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ReplicateSecretToRegionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ReplicateSecretToRegionsResponse response = new ReplicateSecretToRegionsResponse();
        ...
        private static ReplicateSecretToRegionsResponseUnmarshaller _instance = new ReplicateSecretToRegionsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ReplicateSecretToRegionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
