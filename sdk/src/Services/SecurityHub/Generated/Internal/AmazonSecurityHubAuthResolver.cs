...
namespace Amazon.SecurityHub.Internal
{
    ...
    public class AmazonSecurityHubAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSecurityHubAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for SecurityHub.
        /// </summary>
        public AmazonSecurityHubAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSecurityHubAuthSchemeParameters
            {
    ...
    public class AmazonSecurityHubAuthSchemeResolver : IAuthSchemeResolver<AmazonSecurityHubAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSecurityHubAuthSchemeParameters authParameters)
        {
