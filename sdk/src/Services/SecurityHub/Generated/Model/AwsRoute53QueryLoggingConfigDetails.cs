...
namespace Amazon.SecurityHub.Model
{
    ...
    /// </summary>
    public partial class AwsRoute53QueryLoggingConfigDetails
    {
        private CloudWatchLogsLogGroupArnConfigDetails _cloudWatchLogsLogGroupArn;

        /// <summary>
        /// Gets and sets the property CloudWatchLogsLogGroupArn. 
        /// <para>
        ///  The Amazon Resource Name (ARN) of the Amazon CloudWatch Logs log group that Route 53
        /// is publishing logs to.
        /// </para>
        /// </summary>
        public CloudWatchLogsLogGroupArnConfigDetails CloudWatchLogsLogGroupArn
        {
