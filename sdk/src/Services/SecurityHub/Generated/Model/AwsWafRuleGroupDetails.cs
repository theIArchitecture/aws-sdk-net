...
{
    /// <summary>
    /// Provides information about an WAF rule group. A rule group is a collection of rules
    /// for inspecting and controlling web requests.
    /// </summary>
    public partial class AwsWafRuleGroupDetails
    {
        private string _metricName;
        private string _name;
        private string _ruleGroupId;
        private List<AwsWafRuleGroupRulesDetails> _rules = AWSConfigs.InitializeCollections ? new List<AwsWafRuleGroupRulesDetails>() : null;
        ...
        /// </summary>
        public List<AwsWafRuleGroupRulesDetails> Rules
        {
