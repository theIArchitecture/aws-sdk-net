...
{
    /// <summary>
    /// This is the response object from the BatchUpdateFindingsV2 operation.
    /// </summary>
    public partial class BatchUpdateFindingsV2Response : AmazonWebServiceResponse
    {
        private List<BatchUpdateFindingsV2ProcessedFinding> _processedFindings = AWSConfigs.InitializeCollections ? new List<BatchUpdateFindingsV2ProcessedFinding>() : null;
        private List<BatchUpdateFindingsV2UnprocessedFinding> _unprocessedFindings = AWSConfigs.InitializeCollections ? new List<BatchUpdateFindingsV2UnprocessedFinding>() : null;
        ...
        public List<BatchUpdateFindingsV2ProcessedFinding> ProcessedFindings
        {
        ...
        /// </summary>
        [AWSProperty(Required=true)]
        public List<BatchUpdateFindingsV2UnprocessedFinding> UnprocessedFindings
        {
