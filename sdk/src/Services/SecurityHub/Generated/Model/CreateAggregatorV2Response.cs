...
{
    /// <summary>
    /// This is the response object from the CreateAggregatorV2 operation.
    /// </summary>
    public partial class CreateAggregatorV2Response : AmazonWebServiceResponse
    {
        private string _aggregationRegion;
        ...
        /// </para>
        /// </summary>
        public string AggregationRegion
        {
            get { return this._aggregationRegion; }
            set { this._aggregationRegion = value; }
        }

        // Check to see if AggregationRegion property is set
        internal bool IsSetAggregationRegion()
        {
            return this._aggregationRegion != null;
        }
