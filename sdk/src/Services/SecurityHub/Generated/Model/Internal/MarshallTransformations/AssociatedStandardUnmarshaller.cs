...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssociatedStandardUnmarshaller : IJsonUnmarshaller<AssociatedStandard, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AssociatedStandard Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("StandardsId", targetDepth))
                {
                    ...
                    unmarshalledObject.StandardsId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
