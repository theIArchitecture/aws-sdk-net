...
{
    /// <summary>
    /// Response Unmarshaller for AutomationRulesFindingFieldsUpdate Object
    /// </summary>  
    public class AutomationRulesFindingFieldsUpdateUnmarshaller : IJsonUnmarshaller<AutomationRulesFindingFieldsUpdate, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AutomationRulesFindingFieldsUpdate Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            AutomationRulesFindingFieldsUpdate unmarshalledObject = new AutomationRulesFindingFieldsUpdate();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = NoteUpdateUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = SeverityUpdateUnmarshaller.Instance;
                ...
                {
                    var unmarshaller = WorkflowUpdateUnmarshaller.Instance;
        ...
        private static AutomationRulesFindingFieldsUpdateUnmarshaller _instance = new AutomationRulesFindingFieldsUpdateUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AutomationRulesFindingFieldsUpdateUnmarshaller Instance
        {
            get
            {
                return _instance;
