...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    public class AwsBackupBackupPlanDetailsUnmarshaller : IJsonUnmarshaller<AwsBackupBackupPlanDetails, JsonUnmarshallerContext>
    {
        ...
        private static AwsBackupBackupPlanDetailsUnmarshaller _instance = new AwsBackupBackupPlanDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AwsBackupBackupPlanDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
