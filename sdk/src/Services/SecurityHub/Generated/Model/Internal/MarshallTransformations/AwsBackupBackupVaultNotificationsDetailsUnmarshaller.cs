...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AwsBackupBackupVaultNotificationsDetailsUnmarshaller : IJsonUnmarshaller<AwsBackupBackupVaultNotificationsDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AwsBackupBackupVaultNotificationsDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("BackupVaultEvents", targetDepth))
                {
                    ...
                    unmarshalledObject.BackupVaultEvents = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
