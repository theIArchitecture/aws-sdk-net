...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AwsCloudFormationStackOutputsDetailsUnmarshaller : IJsonUnmarshaller<AwsCloudFormationStackOutputsDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AwsCloudFormationStackOutputsDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.OutputKey = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("OutputValue", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.OutputValue = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
