...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AwsCodeBuildProjectArtifactsDetailsUnmarshaller : IJsonUnmarshaller<AwsCodeBuildProjectArtifactsDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AwsCodeBuildProjectArtifactsDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.NamespaceType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
