...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AwsDynamoDbTableSseDescriptionUnmarshaller : IJsonUnmarshaller<AwsDynamoDbTableSseDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AwsDynamoDbTableSseDescription Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("InaccessibleEncryptionDateTime", targetDepth))
                {
                    ...
                    unmarshalledObject.InaccessibleEncryptionDateTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
