...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    public class AwsEc2ClientVpnEndpointAuthenticationOptionsFederatedAuthenticationDetailsUnmarshaller : IJsonUnmarshaller<AwsEc2ClientVpnEndpointAuthenticationOptionsFederatedAuthenticationDetails, JsonUnmarshallerContext>
    {
        ...
        private static AwsEc2ClientVpnEndpointAuthenticationOptionsFederatedAuthenticationDetailsUnmarshaller _instance = new AwsEc2ClientVpnEndpointAuthenticationOptionsFederatedAuthenticationDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AwsEc2ClientVpnEndpointAuthenticationOptionsFederatedAuthenticationDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
