...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    public class AwsEc2LaunchTemplateDataCreditSpecificationDetailsUnmarshaller : IJsonUnmarshaller<AwsEc2LaunchTemplateDataCreditSpecificationDetails, JsonUnmarshallerContext>
    {
        ...
        private static AwsEc2LaunchTemplateDataCreditSpecificationDetailsUnmarshaller _instance = new AwsEc2LaunchTemplateDataCreditSpecificationDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AwsEc2LaunchTemplateDataCreditSpecificationDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
