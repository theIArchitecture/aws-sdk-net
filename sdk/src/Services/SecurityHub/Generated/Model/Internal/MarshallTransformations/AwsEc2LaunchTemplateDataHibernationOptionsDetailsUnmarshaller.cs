...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    public class AwsEc2LaunchTemplateDataHibernationOptionsDetailsUnmarshaller : IJsonUnmarshaller<AwsEc2LaunchTemplateDataHibernationOptionsDetails, JsonUnmarshallerContext>
    {
        ...
        private static AwsEc2LaunchTemplateDataHibernationOptionsDetailsUnmarshaller _instance = new AwsEc2LaunchTemplateDataHibernationOptionsDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AwsEc2LaunchTemplateDataHibernationOptionsDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
