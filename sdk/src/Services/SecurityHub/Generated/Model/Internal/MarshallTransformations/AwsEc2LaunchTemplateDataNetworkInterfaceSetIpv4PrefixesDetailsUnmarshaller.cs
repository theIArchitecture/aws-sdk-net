...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AwsEc2LaunchTemplateDataNetworkInterfaceSetIpv4PrefixesDetailsUnmarshaller : IJsonUnmarshaller<AwsEc2LaunchTemplateDataNetworkInterfaceSetIpv4PrefixesDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AwsEc2LaunchTemplateDataNetworkInterfaceSetIpv4PrefixesDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Ipv4Prefix", targetDepth))
                {
                    ...
                    unmarshalledObject.Ipv4Prefix = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
