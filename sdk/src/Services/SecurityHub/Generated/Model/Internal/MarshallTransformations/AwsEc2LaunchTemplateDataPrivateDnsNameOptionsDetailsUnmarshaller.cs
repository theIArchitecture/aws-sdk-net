...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    public class AwsEc2LaunchTemplateDataPrivateDnsNameOptionsDetailsUnmarshaller : IJsonUnmarshaller<AwsEc2LaunchTemplateDataPrivateDnsNameOptionsDetails, JsonUnmarshallerContext>
    {
        ...
        private static AwsEc2LaunchTemplateDataPrivateDnsNameOptionsDetailsUnmarshaller _instance = new AwsEc2LaunchTemplateDataPrivateDnsNameOptionsDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AwsEc2LaunchTemplateDataPrivateDnsNameOptionsDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
