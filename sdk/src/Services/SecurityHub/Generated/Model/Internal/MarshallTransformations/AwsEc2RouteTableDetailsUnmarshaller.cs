...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    public class AwsEc2RouteTableDetailsUnmarshaller : IJsonUnmarshaller<AwsEc2RouteTableDetails, JsonUnmarshallerContext>
    {
        ...
        private static AwsEc2RouteTableDetailsUnmarshaller _instance = new AwsEc2RouteTableDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AwsEc2RouteTableDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
