...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    public class AwsEcrRepositoryLifecyclePolicyDetailsUnmarshaller : IJsonUnmarshaller<AwsEcrRepositoryLifecyclePolicyDetails, JsonUnmarshallerContext>
    {
        ...
        private static AwsEcrRepositoryLifecyclePolicyDetailsUnmarshaller _instance = new AwsEcrRepositoryLifecyclePolicyDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AwsEcrRepositoryLifecyclePolicyDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
