...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    public class AwsEcsContainerDetailsUnmarshaller : IJsonUnmarshaller<AwsEcsContainerDetails, JsonUnmarshallerContext>
    {
        ...
        private static AwsEcsContainerDetailsUnmarshaller _instance = new AwsEcsContainerDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AwsEcsContainerDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
