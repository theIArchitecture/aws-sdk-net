...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    public class AwsEcsTaskDefinitionVolumesDetailsUnmarshaller : IJsonUnmarshaller<AwsEcsTaskDefinitionVolumesDetails, JsonUnmarshallerContext>
    {
        ...
        private static AwsEcsTaskDefinitionVolumesDetailsUnmarshaller _instance = new AwsEcsTaskDefinitionVolumesDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AwsEcsTaskDefinitionVolumesDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
