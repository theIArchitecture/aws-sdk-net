...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AwsIamAccessKeySessionContextUnmarshaller : IJsonUnmarshaller<AwsIamAccessKeySessionContext, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AwsIamAccessKeySessionContext Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SessionIssuer", targetDepth))
                {
                    ...
                    unmarshalledObject.SessionIssuer = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
