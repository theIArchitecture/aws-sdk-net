...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AwsNetworkFirewallRuleGroupDetailsUnmarshaller : IJsonUnmarshaller<AwsNetworkFirewallRuleGroupDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AwsNetworkFirewallRuleGroupDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("RuleGroup", targetDepth))
                {
                    ...
                    unmarshalledObject.RuleGroup = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
