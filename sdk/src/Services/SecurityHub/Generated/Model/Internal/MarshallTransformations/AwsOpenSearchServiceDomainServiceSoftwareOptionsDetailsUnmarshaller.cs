...
{
    /// <summary>
    /// Response Unmarshaller for AwsOpenSearchServiceDomainServiceSoftwareOptionsDetails Object
    /// </summary>  
    public class AwsOpenSearchServiceDomainServiceSoftwareOptionsDetailsUnmarshaller : IJsonUnmarshaller<AwsOpenSearchServiceDomainServiceSoftwareOptionsDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AwsOpenSearchServiceDomainServiceSoftwareOptionsDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            AwsOpenSearchServiceDomainServiceSoftwareOptionsDetails unmarshalledObject = new AwsOpenSearchServiceDomainServiceSoftwareOptionsDetails();
        ...
        private static AwsOpenSearchServiceDomainServiceSoftwareOptionsDetailsUnmarshaller _instance = new AwsOpenSearchServiceDomainServiceSoftwareOptionsDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AwsOpenSearchServiceDomainServiceSoftwareOptionsDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
