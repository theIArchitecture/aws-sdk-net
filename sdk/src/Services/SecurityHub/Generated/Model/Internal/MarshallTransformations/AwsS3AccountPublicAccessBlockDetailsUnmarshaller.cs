...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    public class AwsS3AccountPublicAccessBlockDetailsUnmarshaller : IJsonUnmarshaller<AwsS3AccountPublicAccessBlockDetails, JsonUnmarshallerContext>
    {
        ...
        private static AwsS3AccountPublicAccessBlockDetailsUnmarshaller _instance = new AwsS3AccountPublicAccessBlockDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AwsS3AccountPublicAccessBlockDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
