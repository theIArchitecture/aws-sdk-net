...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AwsS3BucketBucketVersioningConfigurationUnmarshaller : IJsonUnmarshaller<AwsS3BucketBucketVersioningConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AwsS3BucketBucketVersioningConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("IsMfaDeleteEnabled", targetDepth))
                {
                    ...
                    unmarshalledObject.IsMfaDeleteEnabled = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
