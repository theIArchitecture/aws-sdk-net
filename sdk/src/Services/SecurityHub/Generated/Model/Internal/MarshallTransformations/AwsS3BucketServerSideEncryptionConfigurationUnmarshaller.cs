...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AwsS3BucketServerSideEncryptionConfigurationUnmarshaller : IJsonUnmarshaller<AwsS3BucketServerSideEncryptionConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AwsS3BucketServerSideEncryptionConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AwsS3BucketServerSideEncryptionRule, AwsS3BucketServerSideEncryptionRuleUnmarshaller>(AwsS3BucketServerSideEncryptionRuleUnmarshaller.Instance);
