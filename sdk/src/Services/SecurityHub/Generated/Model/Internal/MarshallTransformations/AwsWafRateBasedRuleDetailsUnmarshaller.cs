...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AwsWafRateBasedRuleDetailsUnmarshaller : IJsonUnmarshaller<AwsWafRateBasedRuleDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AwsWafRateBasedRuleDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AwsWafRateBasedRuleMatchPredicate, AwsWafRateBasedRuleMatchPredicateUnmarshaller>(AwsWafRateBasedRuleMatchPredicateUnmarshaller.Instance);
