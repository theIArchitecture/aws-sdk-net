...
{
    /// <summary>
    /// AwsWafRegionalRateBasedRuleDetails Marshaller
    /// </summary>
    public class AwsWafRegionalRateBasedRuleDetailsMarshaller : IRequestMarshaller<AwsWafRegionalRateBasedRuleDetails, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(AwsWafRegionalRateBasedRuleDetails requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetMatchPredicates())
            {
                ...
                foreach(var requestObjectMatchPredicatesListValue in requestObject.MatchPredicates)
                {
                    ...
                    var marshaller = AwsWafRegionalRateBasedRuleMatchPredicateMarshaller.Instance;
        ...
        /// </summary>
        public readonly static AwsWafRegionalRateBasedRuleDetailsMarshaller Instance = new AwsWafRegionalRateBasedRuleDetailsMarshaller();
