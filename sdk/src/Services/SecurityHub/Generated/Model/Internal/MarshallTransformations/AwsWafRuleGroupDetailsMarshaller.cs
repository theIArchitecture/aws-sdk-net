...
{
    /// <summary>
    /// AwsWafRuleGroupDetails Marshaller
    /// </summary>
    public class AwsWafRuleGroupDetailsMarshaller : IRequestMarshaller<AwsWafRuleGroupDetails, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(AwsWafRuleGroupDetails requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetRules())
            {
                ...
                foreach(var requestObjectRulesListValue in requestObject.Rules)
                {
                    ...
                    var marshaller = AwsWafRuleGroupRulesDetailsMarshaller.Instance;
        ...
        /// </summary>
        public readonly static AwsWafRuleGroupDetailsMarshaller Instance = new AwsWafRuleGroupDetailsMarshaller();
