...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    public class CustomDataIdentifiersResultUnmarshaller : IJsonUnmarshaller<CustomDataIdentifiersResult, JsonUnmarshallerContext>
    {
        ...
        private static CustomDataIdentifiersResultUnmarshaller _instance = new CustomDataIdentifiersResultUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CustomDataIdentifiersResultUnmarshaller Instance
        {
            get
            {
                return _instance;
