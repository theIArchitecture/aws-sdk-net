...
{
    /// <summary>
    /// Response Unmarshaller for DeleteConfigurationPolicy operation
    /// </summary>  
    public class DeleteConfigurationPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteConfigurationPolicyResponse response = new DeleteConfigurationPolicyResponse();
        ...
        private static DeleteConfigurationPolicyResponseUnmarshaller _instance = new DeleteConfigurationPolicyResponseUnmarshaller();        

        internal static DeleteConfigurationPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteConfigurationPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
