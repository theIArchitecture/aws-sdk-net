...
{
    /// <summary>
    /// Response Unmarshaller for DeleteFindingAggregator operation
    /// </summary>  
    public class DeleteFindingAggregatorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteFindingAggregatorResponse response = new DeleteFindingAggregatorResponse();
        ...
        private static DeleteFindingAggregatorResponseUnmarshaller _instance = new DeleteFindingAggregatorResponseUnmarshaller();        

        internal static DeleteFindingAggregatorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteFindingAggregatorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
