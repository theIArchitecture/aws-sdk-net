...
{
    /// <summary>
    /// Response Unmarshaller for FilePaths Object
    /// </summary>  
    public class FilePathsUnmarshaller : IJsonUnmarshaller<FilePaths, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FilePaths Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static FilePathsUnmarshaller _instance = new FilePathsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static FilePathsUnmarshaller Instance
        {
            get
            {
                return _instance;
