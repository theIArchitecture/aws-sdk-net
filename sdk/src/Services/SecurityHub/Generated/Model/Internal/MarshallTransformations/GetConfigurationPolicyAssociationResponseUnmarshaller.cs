...
{
    /// <summary>
    /// Response Unmarshaller for GetConfigurationPolicyAssociation operation
    /// </summary>  
    public class GetConfigurationPolicyAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetConfigurationPolicyAssociationResponse response = new GetConfigurationPolicyAssociationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AssociationStatus", targetDepth))
                {
                    ...
                    response.AssociationStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("AssociationStatusMessage", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AssociationStatusMessage = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ConfigurationPolicyId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetConfigurationPolicyAssociationResponseUnmarshaller _instance = new GetConfigurationPolicyAssociationResponseUnmarshaller();        

        internal static GetConfigurationPolicyAssociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetConfigurationPolicyAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
