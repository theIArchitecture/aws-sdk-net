...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetConnectorV2RequestMarshaller : IMarshaller<IRequest, GetConnectorV2Request> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetConnectorV2RequestMarshaller _instance = new GetConnectorV2RequestMarshaller();        

        internal static GetConnectorV2RequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetConnectorV2RequestMarshaller Instance
        {
            get
            {
                return _instance;
