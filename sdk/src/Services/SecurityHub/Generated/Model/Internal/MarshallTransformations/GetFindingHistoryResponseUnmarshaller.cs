...
{
    /// <summary>
    /// Response Unmarshaller for GetFindingHistory operation
    /// </summary>  
    public class GetFindingHistoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetFindingHistoryResponse response = new GetFindingHistoryResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<FindingHistoryRecord, FindingHistoryRecordUnmarshaller>(FindingHistoryRecordUnmarshaller.Instance);
        ...
        private static GetFindingHistoryResponseUnmarshaller _instance = new GetFindingHistoryResponseUnmarshaller();        

        internal static GetFindingHistoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFindingHistoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
