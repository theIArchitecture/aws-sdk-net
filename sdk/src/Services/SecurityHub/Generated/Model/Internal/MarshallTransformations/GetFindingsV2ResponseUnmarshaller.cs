...
{
    /// <summary>
    /// Response Unmarshaller for GetFindingsV2 operation
    /// </summary>  
    public class GetFindingsV2ResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetFindingsV2Response response = new GetFindingsV2Response();
        ...
        private static GetFindingsV2ResponseUnmarshaller _instance = new GetFindingsV2ResponseUnmarshaller();        

        internal static GetFindingsV2ResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFindingsV2ResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
