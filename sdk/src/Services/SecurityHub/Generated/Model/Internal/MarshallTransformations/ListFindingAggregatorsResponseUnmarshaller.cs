...
{
    /// <summary>
    /// Response Unmarshaller for ListFindingAggregators operation
    /// </summary>  
    public class ListFindingAggregatorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListFindingAggregatorsResponse response = new ListFindingAggregatorsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<FindingAggregator, FindingAggregatorUnmarshaller>(FindingAggregatorUnmarshaller.Instance);
                    response.FindingAggregators = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListFindingAggregatorsResponseUnmarshaller _instance = new ListFindingAggregatorsResponseUnmarshaller();        

        internal static ListFindingAggregatorsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFindingAggregatorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
