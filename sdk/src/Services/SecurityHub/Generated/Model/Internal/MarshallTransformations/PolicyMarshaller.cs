    ...
    public class PolicyMarshaller : IRequestMarshaller<Policy, JsonMarshallerContext> 
    {
        ...
        public void Marshall(Policy requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetSecurityHub())
            {
                context.Writer.WritePropertyName("SecurityHub");
                context.Writer.WriteStartObject();

                var marshaller = SecurityHubPolicyMarshaller.Instance;
                marshaller.Marshall(requestObject.SecurityHub, context);
