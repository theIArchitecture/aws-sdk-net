...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RuleGroupSourceUnmarshaller : IJsonUnmarshaller<RuleGroupSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            RuleGroupSource unmarshalledObject = new RuleGroupSource();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RuleGroupSourceUnmarshaller Instance
        {
            get
            {
                return _instance;
