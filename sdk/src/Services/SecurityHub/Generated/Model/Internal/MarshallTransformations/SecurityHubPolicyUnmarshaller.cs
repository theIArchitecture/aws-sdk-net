...
{
    /// <summary>
    /// Response Unmarshaller for SecurityHubPolicy Object
    /// </summary>  
    public class SecurityHubPolicyUnmarshaller : IJsonUnmarshaller<SecurityHubPolicy, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SecurityHubPolicy Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            SecurityHubPolicy unmarshalledObject = new SecurityHubPolicy();
        ...
        private static SecurityHubPolicyUnmarshaller _instance = new SecurityHubPolicyUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SecurityHubPolicyUnmarshaller Instance
        {
            get
            {
                return _instance;
