...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartConfigurationPolicyAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartConfigurationPolicyAssociationResponse response = new StartConfigurationPolicyAssociationResponse();
        ...
        internal static StartConfigurationPolicyAssociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartConfigurationPolicyAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
