...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    public class StatelessCustomActionDefinitionMarshaller : IRequestMarshaller<StatelessCustomActionDefinition, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(StatelessCustomActionDefinition requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetPublishMetricAction())
            {
                ...
                var marshaller = StatelessCustomPublishMetricActionMarshaller.Instance;
