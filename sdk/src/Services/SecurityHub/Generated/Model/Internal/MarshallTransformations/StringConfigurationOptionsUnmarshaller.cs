...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    public class StringConfigurationOptionsUnmarshaller : IJsonUnmarshaller<StringConfigurationOptions, JsonUnmarshallerContext>
    {
        ...
        private static StringConfigurationOptionsUnmarshaller _instance = new StringConfigurationOptionsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static StringConfigurationOptionsUnmarshaller Instance
        {
            get
            {
                return _instance;
