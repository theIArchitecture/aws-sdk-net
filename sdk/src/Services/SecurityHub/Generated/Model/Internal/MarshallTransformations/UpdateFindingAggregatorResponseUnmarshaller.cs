...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateFindingAggregatorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateFindingAggregatorResponse response = new UpdateFindingAggregatorResponse();
        ...
        internal static UpdateFindingAggregatorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFindingAggregatorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
