...
namespace Amazon.SecurityIR.Internal
{
    ...
    public class AmazonSecurityIRAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSecurityIRAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for SecurityIR.
        /// </summary>
        public AmazonSecurityIRAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSecurityIRAuthSchemeParameters
            {
    ...
    public class AmazonSecurityIRAuthSchemeResolver : IAuthSchemeResolver<AmazonSecurityIRAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSecurityIRAuthSchemeParameters authParameters)
        {
