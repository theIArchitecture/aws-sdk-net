...
namespace Amazon.SecurityIR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CancelMembershipRequestMarshaller : IMarshaller<IRequest, CancelMembershipRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static CancelMembershipRequestMarshaller _instance = new CancelMembershipRequestMarshaller();        

        internal static CancelMembershipRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelMembershipRequestMarshaller Instance
        {
            get
            {
                return _instance;
