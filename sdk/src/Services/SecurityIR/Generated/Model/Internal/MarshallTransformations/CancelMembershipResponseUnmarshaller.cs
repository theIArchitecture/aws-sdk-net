...
{
    /// <summary>
    /// Response Unmarshaller for CancelMembership operation
    /// </summary>  
    public class CancelMembershipResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelMembershipResponse response = new CancelMembershipResponse();
        ...
        private static CancelMembershipResponseUnmarshaller _instance = new CancelMembershipResponseUnmarshaller();        

        internal static CancelMembershipResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelMembershipResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
