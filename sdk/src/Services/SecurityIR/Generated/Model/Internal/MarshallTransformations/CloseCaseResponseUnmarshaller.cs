...
{
    /// <summary>
    /// Response Unmarshaller for CloseCase operation
    /// </summary>  
    public class CloseCaseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CloseCaseResponseUnmarshaller _instance = new CloseCaseResponseUnmarshaller();        

        internal static CloseCaseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CloseCaseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
