...
{
    /// <summary>
    /// Response Unmarshaller for CreateCaseComment operation
    /// </summary>  
    public class CreateCaseCommentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateCaseCommentResponse response = new CreateCaseCommentResponse();
        ...
        private static CreateCaseCommentResponseUnmarshaller _instance = new CreateCaseCommentResponseUnmarshaller();        

        internal static CreateCaseCommentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCaseCommentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
