...
{
    /// <summary>
    /// Response Unmarshaller for GetCaseAttachmentDownloadUrl operation
    /// </summary>  
    public class GetCaseAttachmentDownloadUrlResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCaseAttachmentDownloadUrlResponse response = new GetCaseAttachmentDownloadUrlResponse();
        ...
        private static GetCaseAttachmentDownloadUrlResponseUnmarshaller _instance = new GetCaseAttachmentDownloadUrlResponseUnmarshaller();        

        internal static GetCaseAttachmentDownloadUrlResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCaseAttachmentDownloadUrlResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
