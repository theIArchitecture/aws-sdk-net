...
{
    /// <summary>
    /// Response Unmarshaller for GetCaseAttachmentUploadUrl operation
    /// </summary>  
    public class GetCaseAttachmentUploadUrlResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCaseAttachmentUploadUrlResponse response = new GetCaseAttachmentUploadUrlResponse();
        ...
        private static GetCaseAttachmentUploadUrlResponseUnmarshaller _instance = new GetCaseAttachmentUploadUrlResponseUnmarshaller();        

        internal static GetCaseAttachmentUploadUrlResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCaseAttachmentUploadUrlResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
