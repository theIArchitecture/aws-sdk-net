...
namespace Amazon.SecurityIR.Model.Internal.MarshallTransformations
{
    ...
    public class GetMembershipAccountDetailItemUnmarshaller : IJsonUnmarshaller<GetMembershipAccountDetailItem, JsonUnmarshallerContext>
    {
        ...
        private static GetMembershipAccountDetailItemUnmarshaller _instance = new GetMembershipAccountDetailItemUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static GetMembershipAccountDetailItemUnmarshaller Instance
        {
            get
            {
                return _instance;
