...
{
    /// <summary>
    /// Response Unmarshaller for ListCaseEdits operation
    /// </summary>  
    public class ListCaseEditsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListCaseEditsResponse response = new ListCaseEditsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<CaseEditItem, CaseEditItemUnmarshaller>(CaseEditItemUnmarshaller.Instance);
        ...
        private static ListCaseEditsResponseUnmarshaller _instance = new ListCaseEditsResponseUnmarshaller();        

        internal static ListCaseEditsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCaseEditsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
