...
{
    /// <summary>
    /// Response Unmarshaller for UpdateCaseStatus operation
    /// </summary>  
    public class UpdateCaseStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateCaseStatusResponse response = new UpdateCaseStatusResponse();
        ...
        private static UpdateCaseStatusResponseUnmarshaller _instance = new UpdateCaseStatusResponseUnmarshaller();        

        internal static UpdateCaseStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCaseStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
