...
{
    /// <summary>
    /// UpdateResolverType Request Marshaller
    /// </summary>       
    public class UpdateResolverTypeRequestMarshaller : IMarshaller<IRequest, UpdateResolverTypeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateResolverTypeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateResolverTypeRequest publicRequest)
        {
        ...
        private static UpdateResolverTypeRequestMarshaller _instance = new UpdateResolverTypeRequestMarshaller();        

        internal static UpdateResolverTypeRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateResolverTypeRequestMarshaller Instance
        {
            get
            {
                return _instance;
