...
namespace Amazon.SecurityLake.Internal
{
    ...
    public class AmazonSecurityLakeAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSecurityLakeAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for SecurityLake.
        /// </summary>
        public AmazonSecurityLakeAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSecurityLakeAuthSchemeParameters
            {
    ...
    public class AmazonSecurityLakeAuthSchemeResolver : IAuthSchemeResolver<AmazonSecurityLakeAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSecurityLakeAuthSchemeParameters authParameters)
        {
