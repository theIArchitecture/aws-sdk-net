...
namespace Amazon.SecurityLake.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public class AwsLogSourceResourceMarshaller : IRequestMarshaller<AwsLogSourceResource, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(AwsLogSourceResource requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static AwsLogSourceResourceMarshaller Instance = new AwsLogSourceResourceMarshaller();
