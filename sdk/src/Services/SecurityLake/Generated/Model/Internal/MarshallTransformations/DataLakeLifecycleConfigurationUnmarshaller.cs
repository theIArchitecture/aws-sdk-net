...
namespace Amazon.SecurityLake.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DataLakeLifecycleConfigurationUnmarshaller : IJsonUnmarshaller<DataLakeLifecycleConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DataLakeLifecycleConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
