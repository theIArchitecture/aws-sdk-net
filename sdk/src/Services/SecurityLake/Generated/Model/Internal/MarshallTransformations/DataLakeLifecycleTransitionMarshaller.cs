...
namespace Amazon.SecurityLake.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public class DataLakeLifecycleTransitionMarshaller : IRequestMarshaller<DataLakeLifecycleTransition, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(DataLakeLifecycleTransition requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static DataLakeLifecycleTransitionMarshaller Instance = new DataLakeLifecycleTransitionMarshaller();
