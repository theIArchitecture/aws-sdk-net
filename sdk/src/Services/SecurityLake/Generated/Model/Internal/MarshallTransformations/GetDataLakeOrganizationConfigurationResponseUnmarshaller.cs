...
namespace Amazon.SecurityLake.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetDataLakeOrganizationConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDataLakeOrganizationConfigurationResponse response = new GetDataLakeOrganizationConfigurationResponse();
        ...
        private static GetDataLakeOrganizationConfigurationResponseUnmarshaller _instance = new GetDataLakeOrganizationConfigurationResponseUnmarshaller();        

        internal static GetDataLakeOrganizationConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDataLakeOrganizationConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
