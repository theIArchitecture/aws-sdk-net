...
namespace Amazon.SecurityLake.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LogSourceResourceUnmarshaller : IJsonUnmarshaller<LogSourceResource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LogSourceResource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
