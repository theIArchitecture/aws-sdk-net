...
namespace Amazon.SecurityLake.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LogSourceUnmarshaller : IJsonUnmarshaller<LogSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LogSource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            LogSource unmarshalledObject = new LogSource();
        ...
        private static LogSourceUnmarshaller _instance = new LogSourceUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static LogSourceUnmarshaller Instance
        {
            get
            {
                return _instance;
