...
namespace Amazon.SecurityToken
{
    ...
    public partial class AmazonSecurityTokenServiceException : AmazonServiceException
    {
        ...
        public AmazonSecurityTokenServiceException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonSecurityTokenServiceException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
