...
namespace Amazon.SecurityToken.Model
{
    ...
    public partial class IDPCommunicationErrorException : AmazonSecurityTokenServiceException
    {
        ...
        public IDPCommunicationErrorException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public IDPCommunicationErrorException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
