...
namespace Amazon.SecurityToken.Model
{
    ...
    public partial class IDPRejectedClaimException : AmazonSecurityTokenServiceException
    {
        ...
        public IDPRejectedClaimException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public IDPRejectedClaimException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
