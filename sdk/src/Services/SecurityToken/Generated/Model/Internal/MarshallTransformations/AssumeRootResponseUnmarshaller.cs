...
{
    /// <summary>
    /// Response Unmarshaller for AssumeRoot operation
    /// </summary>  
    public class AssumeRootResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssumeRootResponse response = new AssumeRootResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("AssumeRootResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, AssumeRootResponse response)
        {
        ...
        private static AssumeRootResponseUnmarshaller _instance = new AssumeRootResponseUnmarshaller();        

        internal static AssumeRootResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssumeRootResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
