...
namespace Amazon.ServiceCatalog.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ProductViewAggregationValueUnmarshaller : IJsonUnmarshaller<ProductViewAggregationValue, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ProductViewAggregationValue Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ApproximateCount", targetDepth))
                {
                    ...
                    unmarshalledObject.ApproximateCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
