...
namespace Amazon.ServiceCatalog.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ProductViewDetailUnmarshaller : IJsonUnmarshaller<ProductViewDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ProductViewDetail Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SourceConnection", targetDepth))
                {
                    ...
                    unmarshalledObject.SourceConnection = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
