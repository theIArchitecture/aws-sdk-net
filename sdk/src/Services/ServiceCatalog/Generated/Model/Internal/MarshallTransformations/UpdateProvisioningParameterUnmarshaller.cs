...
namespace Amazon.ServiceCatalog.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateProvisioningParameterUnmarshaller : IJsonUnmarshaller<UpdateProvisioningParameter, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public UpdateProvisioningParameter Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("UsePreviousValue", targetDepth))
                {
                    ...
                    unmarshalledObject.UsePreviousValue = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
