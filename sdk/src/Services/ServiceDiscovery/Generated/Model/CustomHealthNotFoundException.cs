...
namespace Amazon.ServiceDiscovery.Model
{
    ...
    public partial class CustomHealthNotFoundException : AmazonServiceDiscoveryException
    {
        ...
        public CustomHealthNotFoundException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CustomHealthNotFoundException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
