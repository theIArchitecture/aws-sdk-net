...
namespace Amazon.ServiceDiscovery.Model
{
    ...
    public partial class InstanceNotFoundException : AmazonServiceDiscoveryException
    {
        ...
        public InstanceNotFoundException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InstanceNotFoundException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
