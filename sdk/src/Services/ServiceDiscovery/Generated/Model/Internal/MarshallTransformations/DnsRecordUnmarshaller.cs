...
namespace Amazon.ServiceDiscovery.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DnsRecordUnmarshaller : IJsonUnmarshaller<DnsRecord, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DnsRecord Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
