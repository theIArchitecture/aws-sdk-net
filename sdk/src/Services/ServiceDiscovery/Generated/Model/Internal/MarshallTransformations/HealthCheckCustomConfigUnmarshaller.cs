...
namespace Amazon.ServiceDiscovery.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class HealthCheckCustomConfigUnmarshaller : IJsonUnmarshaller<HealthCheckCustomConfig, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public HealthCheckCustomConfig Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("FailureThreshold", targetDepth))
                {
                    ...
                    unmarshalledObject.FailureThreshold = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
