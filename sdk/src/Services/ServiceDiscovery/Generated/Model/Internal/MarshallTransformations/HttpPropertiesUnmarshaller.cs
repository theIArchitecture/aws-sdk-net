...
namespace Amazon.ServiceDiscovery.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class HttpPropertiesUnmarshaller : IJsonUnmarshaller<HttpProperties, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public HttpProperties Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("HttpName", targetDepth))
                {
                    ...
                    unmarshalledObject.HttpName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
