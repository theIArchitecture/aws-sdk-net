...
namespace Amazon.ServiceDiscovery.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NamespacePropertiesUnmarshaller : IJsonUnmarshaller<NamespaceProperties, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NamespaceProperties Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
