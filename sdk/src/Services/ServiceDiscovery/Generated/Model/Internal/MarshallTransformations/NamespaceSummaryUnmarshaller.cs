...
namespace Amazon.ServiceDiscovery.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NamespaceSummaryUnmarshaller : IJsonUnmarshaller<NamespaceSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NamespaceSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ServiceCount", targetDepth))
                {
                    ...
                    unmarshalledObject.ServiceCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
