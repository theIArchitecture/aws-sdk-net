...
{
    /// <summary>
    /// Response Unmarshaller for UpdateHttpNamespace operation
    /// </summary>  
    public class UpdateHttpNamespaceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateHttpNamespaceResponse response = new UpdateHttpNamespaceResponse();
        ...
        private static UpdateHttpNamespaceResponseUnmarshaller _instance = new UpdateHttpNamespaceResponseUnmarshaller();        

        internal static UpdateHttpNamespaceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateHttpNamespaceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
