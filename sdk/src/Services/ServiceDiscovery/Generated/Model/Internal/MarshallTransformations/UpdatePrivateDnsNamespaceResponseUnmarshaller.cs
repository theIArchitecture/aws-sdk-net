...
{
    /// <summary>
    /// Response Unmarshaller for UpdatePrivateDnsNamespace operation
    /// </summary>  
    public class UpdatePrivateDnsNamespaceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdatePrivateDnsNamespaceResponse response = new UpdatePrivateDnsNamespaceResponse();
        ...
        private static UpdatePrivateDnsNamespaceResponseUnmarshaller _instance = new UpdatePrivateDnsNamespaceResponseUnmarshaller();        

        internal static UpdatePrivateDnsNamespaceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePrivateDnsNamespaceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
