...
{
    /// <summary>
    /// Response Unmarshaller for UpdatePublicDnsNamespace operation
    /// </summary>  
    public class UpdatePublicDnsNamespaceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdatePublicDnsNamespaceResponse response = new UpdatePublicDnsNamespaceResponse();
        ...
        private static UpdatePublicDnsNamespaceResponseUnmarshaller _instance = new UpdatePublicDnsNamespaceResponseUnmarshaller();        

        internal static UpdatePublicDnsNamespaceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePublicDnsNamespaceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
