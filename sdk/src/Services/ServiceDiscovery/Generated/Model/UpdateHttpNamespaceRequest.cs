...
{
    /// <summary>
    /// Container for the parameters to the UpdateHttpNamespace operation.
    /// Updates an HTTP namespace.
    /// </summary>
    public partial class UpdateHttpNamespaceRequest : AmazonServiceDiscoveryRequest
    {
        private string _id;
        private HttpNamespaceChange _awsNamespace;
        ...
        /// <para>
        /// A unique string that identifies the request and that allows failed <c>UpdateHttpNamespace</c>
