...
namespace Amazon.ServiceDiscovery
{
    ...
    public partial interface IAmazonServiceDiscovery : IAmazonService, IDisposable
    {
        ...
        Task<DeleteServiceAttributesResponse> DeleteServiceAttributesAsync(DeleteServiceAttributesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DiscoverInstancesRevisionResponse> DiscoverInstancesRevisionAsync(DiscoverInstancesRevisionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetServiceAttributesResponse> GetServiceAttributesAsync(GetServiceAttributesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateServiceAttributesResponse> UpdateServiceAttributesAsync(UpdateServiceAttributesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonServiceDiscoveryConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonServiceDiscoveryConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonServiceDiscoveryConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonServiceDiscoveryConfig to create AmazonServiceDiscoveryClient");
            }

            return awsCredentials == null ? 
                    new AmazonServiceDiscoveryClient(serviceClientConfig) :
                    new AmazonServiceDiscoveryClient(awsCredentials, serviceClientConfig);
        }
