...
namespace Amazon.ServiceQuotas.Internal
{
    ...
    public class AmazonServiceQuotasAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonServiceQuotasAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for ServiceQuotas.
        /// </summary>
        public AmazonServiceQuotasAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonServiceQuotasAuthSchemeParameters
            {
    ...
    public class AmazonServiceQuotasAuthSchemeResolver : IAuthSchemeResolver<AmazonServiceQuotasAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonServiceQuotasAuthSchemeParameters authParameters)
        {
