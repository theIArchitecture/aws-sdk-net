...
namespace Amazon.ServiceQuotas.Model
{
    ...
    public partial class AWSServiceAccessNotEnabledException : AmazonServiceQuotasException
    {
        ...
        public AWSServiceAccessNotEnabledException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AWSServiceAccessNotEnabledException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
