...
namespace Amazon.ServiceQuotas.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MetricInfoUnmarshaller : IJsonUnmarshaller<MetricInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MetricInfo Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("MetricDimensions", targetDepth))
                {
                    ...
                    unmarshalledObject.MetricDimensions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.MetricStatisticRecommendation = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
