...
namespace Amazon.ServiceQuotas.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ServiceQuotaIncreaseRequestInTemplateUnmarshaller : IJsonUnmarshaller<ServiceQuotaIncreaseRequestInTemplate, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ServiceQuotaIncreaseRequestInTemplate Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
