...
namespace Amazon.ServiceQuotas.Model
{
    ...
    public partial class TemplatesNotAvailableInRegionException : AmazonServiceQuotasException
    {
        ...
        public TemplatesNotAvailableInRegionException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TemplatesNotAvailableInRegionException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
