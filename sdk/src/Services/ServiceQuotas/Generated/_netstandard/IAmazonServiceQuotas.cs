...
namespace Amazon.ServiceQuotas
{
    ...
    public partial interface IAmazonServiceQuotas : IAmazonService, IDisposable
    {
        ...
        Task<CreateSupportCaseResponse> CreateSupportCaseAsync(CreateSupportCaseRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonServiceQuotasConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonServiceQuotasConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonServiceQuotasConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonServiceQuotasConfig to create AmazonServiceQuotasClient");
            }

            return awsCredentials == null ? 
                    new AmazonServiceQuotasClient(serviceClientConfig) :
                    new AmazonServiceQuotasClient(awsCredentials, serviceClientConfig);
        }
