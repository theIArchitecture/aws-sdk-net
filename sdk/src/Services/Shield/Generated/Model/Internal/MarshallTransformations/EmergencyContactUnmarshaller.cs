...
namespace Amazon.Shield.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EmergencyContactUnmarshaller : IJsonUnmarshaller<EmergencyContact, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EmergencyContact Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ContactNotes", targetDepth))
                {
                    ...
                    unmarshalledObject.ContactNotes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
