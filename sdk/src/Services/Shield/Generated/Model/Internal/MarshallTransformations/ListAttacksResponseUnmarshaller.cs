    ...
    public class ListAttacksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AttackSummary, AttackSummaryUnmarshaller>(AttackSummaryUnmarshaller.Instance);
                    response.AttackSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
