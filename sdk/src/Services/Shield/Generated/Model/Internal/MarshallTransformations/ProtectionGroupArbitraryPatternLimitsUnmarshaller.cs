...
namespace Amazon.Shield.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ProtectionGroupArbitraryPatternLimitsUnmarshaller : IJsonUnmarshaller<ProtectionGroupArbitraryPatternLimits, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ProtectionGroupArbitraryPatternLimits Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("MaxMembers", targetDepth))
                {
                    ...
                    unmarshalledObject.MaxMembers = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
