...
namespace Amazon.Signer.Internal
{
    ...
    public class AmazonSignerAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSignerAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Signer.
        /// </summary>
        public AmazonSignerAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSignerAuthSchemeParameters
            {
    ...
    public class AmazonSignerAuthSchemeResolver : IAuthSchemeResolver<AmazonSignerAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSignerAuthSchemeParameters authParameters)
        {
