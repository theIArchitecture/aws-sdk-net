...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class HashAlgorithmOptionsUnmarshaller : IJsonUnmarshaller<HashAlgorithmOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public HashAlgorithmOptions Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
