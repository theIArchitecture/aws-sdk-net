...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SignatureValidityPeriodUnmarshaller : IJsonUnmarshaller<SignatureValidityPeriod, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SignatureValidityPeriod Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
