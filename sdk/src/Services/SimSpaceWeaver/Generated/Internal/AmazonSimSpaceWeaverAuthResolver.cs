...
namespace Amazon.SimSpaceWeaver.Internal
{
    ...
    public class AmazonSimSpaceWeaverAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSimSpaceWeaverAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for SimSpaceWeaver.
        /// </summary>
        public AmazonSimSpaceWeaverAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSimSpaceWeaverAuthSchemeParameters
            {
    ...
    public class AmazonSimSpaceWeaverAuthSchemeResolver : IAuthSchemeResolver<AmazonSimSpaceWeaverAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSimSpaceWeaverAuthSchemeParameters authParameters)
        {
