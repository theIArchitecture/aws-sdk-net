...
{
    /// <summary>
    /// LaunchOverrides Marshaller
    /// </summary>
    public class LaunchOverridesMarshaller : IRequestMarshaller<LaunchOverrides, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(LaunchOverrides requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetLaunchCommands())
            {
                ...
                foreach(var requestObjectLaunchCommandsListValue in requestObject.LaunchCommands)
                {
                        context.Writer.WriteStringValue(requestObjectLaunchCommandsListValue);
                }
        ...
        /// </summary>
        public readonly static LaunchOverridesMarshaller Instance = new LaunchOverridesMarshaller();
