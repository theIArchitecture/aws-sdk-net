...
{
    /// <summary>
    /// Response Unmarshaller for LaunchOverrides Object
    /// </summary>  
    public class LaunchOverridesUnmarshaller : IJsonUnmarshaller<LaunchOverrides, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LaunchOverrides Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static LaunchOverridesUnmarshaller _instance = new LaunchOverridesUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static LaunchOverridesUnmarshaller Instance
        {
            get
            {
                return _instance;
