...
namespace Amazon.SimSpaceWeaver.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SimulationClockUnmarshaller : IJsonUnmarshaller<SimulationClock, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SimulationClock Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
