...
{
    /// <summary>
    /// StartClock Request Marshaller
    /// </summary>       
    public class StartClockRequestMarshaller : IMarshaller<IRequest, StartClockRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartClockRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartClockRequest publicRequest)
        {
            ...
            request.ResourcePath = "/startclock";
#if !NETFRAMEWORK
        ...
        private static StartClockRequestMarshaller _instance = new StartClockRequestMarshaller();        

        internal static StartClockRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartClockRequestMarshaller Instance
        {
            get
            {
                return _instance;
