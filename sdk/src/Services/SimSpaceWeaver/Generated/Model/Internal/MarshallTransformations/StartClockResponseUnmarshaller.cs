...
{
    /// <summary>
    /// Response Unmarshaller for StartClock operation
    /// </summary>  
    public class StartClockResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartClockResponse response = new StartClockResponse();
        ...
        private static StartClockResponseUnmarshaller _instance = new StartClockResponseUnmarshaller();        

        internal static StartClockResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartClockResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
