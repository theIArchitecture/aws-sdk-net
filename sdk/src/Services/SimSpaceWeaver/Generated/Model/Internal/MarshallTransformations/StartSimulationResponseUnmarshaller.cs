...
{
    /// <summary>
    /// Response Unmarshaller for StartSimulation operation
    /// </summary>  
    public class StartSimulationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartSimulationResponse response = new StartSimulationResponse();
        ...
        private static StartSimulationResponseUnmarshaller _instance = new StartSimulationResponseUnmarshaller();        

        internal static StartSimulationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartSimulationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
