...
{
    /// <summary>
    /// Response Unmarshaller for StopApp operation
    /// </summary>  
    public class StopAppResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopAppResponse response = new StopAppResponse();
        ...
        private static StopAppResponseUnmarshaller _instance = new StopAppResponseUnmarshaller();        

        internal static StopAppResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopAppResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
