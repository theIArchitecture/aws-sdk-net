...
{
    /// <summary>
    /// StopClock Request Marshaller
    /// </summary>       
    public class StopClockRequestMarshaller : IMarshaller<IRequest, StopClockRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StopClockRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StopClockRequest publicRequest)
        {
            ...
            request.ResourcePath = "/stopclock";
#if !NETFRAMEWORK
        ...
        private static StopClockRequestMarshaller _instance = new StopClockRequestMarshaller();        

        internal static StopClockRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopClockRequestMarshaller Instance
        {
            get
            {
                return _instance;
