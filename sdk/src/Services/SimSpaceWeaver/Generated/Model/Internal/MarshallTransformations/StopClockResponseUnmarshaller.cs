...
{
    /// <summary>
    /// Response Unmarshaller for StopClock operation
    /// </summary>  
    public class StopClockResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopClockResponse response = new StopClockResponse();
        ...
        private static StopClockResponseUnmarshaller _instance = new StopClockResponseUnmarshaller();        

        internal static StopClockResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopClockResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
