...
namespace Amazon.SimSpaceWeaver.Model
{
    ...
    public partial class ListAppsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<SimulationAppMetadata> Apps
        {
        ...
        /// <para>
        /// If SimSpace Weaver returns <c>nextToken</c>, then there are more results available.
        ...
        /// then you receive an <i>HTTP 400 ValidationException</i> error.
        /// </para>
        /// </summary>
