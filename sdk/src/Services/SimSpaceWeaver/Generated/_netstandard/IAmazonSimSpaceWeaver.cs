...
namespace Amazon.SimSpaceWeaver
{
    ...
    public partial interface IAmazonSimSpaceWeaver : IAmazonService, IDisposable
    {
        ...
        Task<DeleteSimulationResponse> DeleteSimulationAsync(DeleteSimulationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DescribeSimulationResponse> DescribeSimulationAsync(DescribeSimulationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListSimulationsResponse> ListSimulationsAsync(ListSimulationsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StartAppResponse> StartAppAsync(StartAppRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StartClockResponse> StartClockAsync(StartClockRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StartSimulationResponse> StartSimulationAsync(StartSimulationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StopAppResponse> StopAppAsync(StopAppRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StopClockResponse> StopClockAsync(StopClockRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StopSimulationResponse> StopSimulationAsync(StopSimulationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonSimSpaceWeaverConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonSimSpaceWeaverConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonSimSpaceWeaverConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonSimSpaceWeaverConfig to create AmazonSimSpaceWeaverClient");
            }

            return awsCredentials == null ? 
                    new AmazonSimSpaceWeaverClient(serviceClientConfig) :
                    new AmazonSimSpaceWeaverClient(awsCredentials, serviceClientConfig);
        }
