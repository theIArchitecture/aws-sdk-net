...
namespace Amazon.SimpleDB.Internal
{
    ...
    public class AmazonSimpleDBAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSimpleDBAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for SimpleDB.
        /// </summary>
        public AmazonSimpleDBAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSimpleDBAuthSchemeParameters
            {
    ...
    public class AmazonSimpleDBAuthSchemeResolver : IAuthSchemeResolver<AmazonSimpleDBAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSimpleDBAuthSchemeParameters authParameters)
        {
