...
namespace Amazon.SimpleDB.Model
{
    ...
    public partial class AttributeDoesNotExistException : AmazonSimpleDBException
    {
        ...
        public AttributeDoesNotExistException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AttributeDoesNotExistException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
