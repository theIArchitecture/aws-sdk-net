...
namespace Amazon.SimpleDB.Model
{
    ...
    public partial class InvalidNumberPredicatesException : AmazonSimpleDBException
    {
        ...
        public InvalidNumberPredicatesException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidNumberPredicatesException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
