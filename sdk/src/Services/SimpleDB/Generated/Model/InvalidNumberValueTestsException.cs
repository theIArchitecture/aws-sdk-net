...
namespace Amazon.SimpleDB.Model
{
    ...
    public partial class InvalidNumberValueTestsException : AmazonSimpleDBException
    {
        ...
        public InvalidNumberValueTestsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidNumberValueTestsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
