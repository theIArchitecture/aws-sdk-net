...
namespace Amazon.SimpleDB.Model
{
    ...
    public partial class InvalidQueryExpressionException : AmazonSimpleDBException
    {
        ...
        public InvalidQueryExpressionException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidQueryExpressionException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
