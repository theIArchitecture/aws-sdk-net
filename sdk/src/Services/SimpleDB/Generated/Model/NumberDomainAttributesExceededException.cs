...
namespace Amazon.SimpleDB.Model
{
    ...
    public partial class NumberDomainAttributesExceededException : AmazonSimpleDBException
    {
        ...
        public NumberDomainAttributesExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NumberDomainAttributesExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
