...
namespace Amazon.SimpleDB.Model
{
    ...
    public partial class NumberItemAttributesExceededException : AmazonSimpleDBException
    {
        ...
        public NumberItemAttributesExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NumberItemAttributesExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
