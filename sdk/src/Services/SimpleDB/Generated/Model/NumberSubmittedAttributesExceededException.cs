...
namespace Amazon.SimpleDB.Model
{
    ...
    public partial class NumberSubmittedAttributesExceededException : AmazonSimpleDBException
    {
        ...
        public NumberSubmittedAttributesExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NumberSubmittedAttributesExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
