...
namespace Amazon.SimpleDB.Model
{
    ...
    public partial class NumberSubmittedItemsExceededException : AmazonSimpleDBException
    {
        ...
        public NumberSubmittedItemsExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public NumberSubmittedItemsExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
