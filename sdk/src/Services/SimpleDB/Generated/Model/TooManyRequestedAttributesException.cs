...
namespace Amazon.SimpleDB.Model
{
    ...
    public partial class TooManyRequestedAttributesException : AmazonSimpleDBException
    {
        ...
        public TooManyRequestedAttributesException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TooManyRequestedAttributesException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
