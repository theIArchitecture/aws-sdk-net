...
namespace Amazon.SimpleEmail.Model
{
    ...
    public partial class AccountSendingPausedException : AmazonSimpleEmailServiceException
    {
        ...
        public AccountSendingPausedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AccountSendingPausedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
