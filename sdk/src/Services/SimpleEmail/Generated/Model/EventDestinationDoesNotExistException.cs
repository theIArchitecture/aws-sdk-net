...
namespace Amazon.SimpleEmail.Model
{
    ...
    public partial class EventDestinationDoesNotExistException : AmazonSimpleEmailServiceException
    {
        ...
        public EventDestinationDoesNotExistException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public EventDestinationDoesNotExistException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
