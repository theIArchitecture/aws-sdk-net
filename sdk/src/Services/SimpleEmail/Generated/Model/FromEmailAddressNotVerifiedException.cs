...
namespace Amazon.SimpleEmail.Model
{
    ...
    public partial class FromEmailAddressNotVerifiedException : AmazonSimpleEmailServiceException
    {
        ...
        public FromEmailAddressNotVerifiedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public FromEmailAddressNotVerifiedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
