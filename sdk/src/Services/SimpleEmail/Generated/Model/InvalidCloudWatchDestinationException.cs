...
namespace Amazon.SimpleEmail.Model
{
    ...
    public partial class InvalidCloudWatchDestinationException : AmazonSimpleEmailServiceException
    {
        ...
        public InvalidCloudWatchDestinationException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidCloudWatchDestinationException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
