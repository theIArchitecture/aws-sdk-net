...
namespace Amazon.SimpleEmail.Model
{
    ...
    public partial class InvalidConfigurationSetException : AmazonSimpleEmailServiceException
    {
        ...
        public InvalidConfigurationSetException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidConfigurationSetException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
