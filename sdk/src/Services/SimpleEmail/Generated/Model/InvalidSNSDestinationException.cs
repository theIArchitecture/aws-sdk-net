...
namespace Amazon.SimpleEmail.Model
{
    ...
    public partial class InvalidSNSDestinationException : AmazonSimpleEmailServiceException
    {
        ...
        public InvalidSNSDestinationException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidSNSDestinationException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
