...
namespace Amazon.SimpleEmail.Model
{
    ...
    public partial class InvalidSnsTopicException : AmazonSimpleEmailServiceException
    {
        ...
        public InvalidSnsTopicException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidSnsTopicException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
