...
namespace Amazon.SimpleEmail.Model
{
    ...
    public partial class InvalidTrackingOptionsException : AmazonSimpleEmailServiceException
    {
        ...
        public InvalidTrackingOptionsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidTrackingOptionsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
