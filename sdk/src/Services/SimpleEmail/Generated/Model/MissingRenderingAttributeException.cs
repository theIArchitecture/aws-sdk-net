...
namespace Amazon.SimpleEmail.Model
{
    ...
    public partial class MissingRenderingAttributeException : AmazonSimpleEmailServiceException
    {
        ...
        public MissingRenderingAttributeException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public MissingRenderingAttributeException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
