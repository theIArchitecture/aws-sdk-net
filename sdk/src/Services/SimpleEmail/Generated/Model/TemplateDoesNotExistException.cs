...
namespace Amazon.SimpleEmail.Model
{
    ...
    public partial class TemplateDoesNotExistException : AmazonSimpleEmailServiceException
    {
        ...
        public TemplateDoesNotExistException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TemplateDoesNotExistException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
