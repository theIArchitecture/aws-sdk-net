...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonSimpleEmailServiceConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonSimpleEmailServiceConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonSimpleEmailServiceConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonSimpleEmailServiceConfig to create AmazonSimpleEmailServiceClient");
            }

            return awsCredentials == null ? 
                    new AmazonSimpleEmailServiceClient(serviceClientConfig) :
                    new AmazonSimpleEmailServiceClient(awsCredentials, serviceClientConfig);
        }
