...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchGetMetricDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchGetMetricDataResponse response = new BatchGetMetricDataResponse();
        ...
        internal static BatchGetMetricDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetMetricDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
