...
{
    /// <summary>
    /// Response Unmarshaller for CreateMultiRegionEndpoint operation
    /// </summary>  
    public class CreateMultiRegionEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateMultiRegionEndpointResponse response = new CreateMultiRegionEndpointResponse();
        ...
        private static CreateMultiRegionEndpointResponseUnmarshaller _instance = new CreateMultiRegionEndpointResponseUnmarshaller();        

        internal static CreateMultiRegionEndpointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMultiRegionEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
