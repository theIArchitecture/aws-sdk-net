...
{
    /// <summary>
    /// Response Unmarshaller for CreateTenantResourceAssociation operation
    /// </summary>  
    public class CreateTenantResourceAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTenantResourceAssociationResponse response = new CreateTenantResourceAssociationResponse();
        ...
        private static CreateTenantResourceAssociationResponseUnmarshaller _instance = new CreateTenantResourceAssociationResponseUnmarshaller();        

        internal static CreateTenantResourceAssociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTenantResourceAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
