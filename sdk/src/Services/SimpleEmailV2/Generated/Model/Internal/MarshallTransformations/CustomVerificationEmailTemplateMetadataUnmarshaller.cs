...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CustomVerificationEmailTemplateMetadataUnmarshaller : IJsonUnmarshaller<CustomVerificationEmailTemplateMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CustomVerificationEmailTemplateMetadata Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("FailureRedirectionURL", targetDepth))
                {
                    ...
                    unmarshalledObject.FailureRedirectionURL = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SuccessRedirectionURL = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TemplateSubject = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
