...
{
    /// <summary>
    /// Response Unmarshaller for DeleteMultiRegionEndpoint operation
    /// </summary>  
    public class DeleteMultiRegionEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteMultiRegionEndpointResponse response = new DeleteMultiRegionEndpointResponse();
        ...
        private static DeleteMultiRegionEndpointResponseUnmarshaller _instance = new DeleteMultiRegionEndpointResponseUnmarshaller();        

        internal static DeleteMultiRegionEndpointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteMultiRegionEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
