...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetMessageInsightsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMessageInsightsResponse response = new GetMessageInsightsResponse();
        ...
        internal static GetMessageInsightsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMessageInsightsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
