...
{
    /// <summary>
    /// Response Unmarshaller for PutDedicatedIpPoolScalingAttributes operation
    /// </summary>  
    public class PutDedicatedIpPoolScalingAttributesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutDedicatedIpPoolScalingAttributesResponse response = new PutDedicatedIpPoolScalingAttributesResponse();
        ...
        private static PutDedicatedIpPoolScalingAttributesResponseUnmarshaller _instance = new PutDedicatedIpPoolScalingAttributesResponseUnmarshaller();        

        internal static PutDedicatedIpPoolScalingAttributesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutDedicatedIpPoolScalingAttributesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
