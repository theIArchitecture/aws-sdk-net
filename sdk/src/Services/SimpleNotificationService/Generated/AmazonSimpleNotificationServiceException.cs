...
namespace Amazon.SimpleNotificationService
{
    ...
    public partial class AmazonSimpleNotificationServiceException : AmazonServiceException
    {
        ...
        public AmazonSimpleNotificationServiceException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonSimpleNotificationServiceException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
