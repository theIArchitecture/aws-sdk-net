...
namespace Amazon.SimpleNotificationService.Internal
{
    ...
    /// </summary>
    public class AmazonSimpleNotificationServiceEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonSimpleNotificationServiceConfig)requestContext.ClientConfig;
            var result = new SimpleNotificationServiceEndpointParameters();
