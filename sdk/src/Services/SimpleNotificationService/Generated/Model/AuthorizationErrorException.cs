...
namespace Amazon.SimpleNotificationService.Model
{
    ...
    public partial class AuthorizationErrorException : AmazonSimpleNotificationServiceException
    {
        ...
        public AuthorizationErrorException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AuthorizationErrorException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
