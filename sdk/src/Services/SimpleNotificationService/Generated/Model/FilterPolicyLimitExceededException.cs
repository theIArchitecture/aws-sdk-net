...
namespace Amazon.SimpleNotificationService.Model
{
    ...
    public partial class FilterPolicyLimitExceededException : AmazonSimpleNotificationServiceException
    {
        ...
        public FilterPolicyLimitExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public FilterPolicyLimitExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
