...
namespace Amazon.SimpleNotificationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateSMSSandboxPhoneNumberResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSMSSandboxPhoneNumberResponse response = new CreateSMSSandboxPhoneNumberResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("CreateSMSSandboxPhoneNumberResult", 2))
                    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("OptedOut"))
                {
                    return OptedOutExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("UserError"))
                {
                    return UserErrorExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
            }
        ...
        private static CreateSMSSandboxPhoneNumberResponseUnmarshaller _instance = new CreateSMSSandboxPhoneNumberResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSMSSandboxPhoneNumberResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
