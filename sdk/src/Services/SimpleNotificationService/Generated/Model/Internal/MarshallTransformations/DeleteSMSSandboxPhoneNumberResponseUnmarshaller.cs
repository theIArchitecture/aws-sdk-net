...
namespace Amazon.SimpleNotificationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteSMSSandboxPhoneNumberResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSMSSandboxPhoneNumberResponse response = new DeleteSMSSandboxPhoneNumberResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteSMSSandboxPhoneNumberResult", 2))
                    {
        ...
        private static DeleteSMSSandboxPhoneNumberResponseUnmarshaller _instance = new DeleteSMSSandboxPhoneNumberResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSMSSandboxPhoneNumberResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
