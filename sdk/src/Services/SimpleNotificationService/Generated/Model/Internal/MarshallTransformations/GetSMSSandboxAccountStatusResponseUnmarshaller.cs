...
namespace Amazon.SimpleNotificationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetSMSSandboxAccountStatusResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSMSSandboxAccountStatusResponse response = new GetSMSSandboxAccountStatusResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("GetSMSSandboxAccountStatusResult", 2))
                    {
        ...
        private static GetSMSSandboxAccountStatusResponseUnmarshaller _instance = new GetSMSSandboxAccountStatusResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSMSSandboxAccountStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
