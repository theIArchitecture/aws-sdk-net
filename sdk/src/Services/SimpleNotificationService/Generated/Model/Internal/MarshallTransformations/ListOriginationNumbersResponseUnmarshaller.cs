...
namespace Amazon.SimpleNotificationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListOriginationNumbersResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListOriginationNumbersResponse response = new ListOriginationNumbersResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ListOriginationNumbersResult", 2))
                    {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("PhoneNumbers/member", targetDepth))
                    {
                        ...
                        {
                            response.PhoneNumbers = new List<PhoneNumberInformation>();
                        }
        ...
        private static ListOriginationNumbersResponseUnmarshaller _instance = new ListOriginationNumbersResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListOriginationNumbersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
