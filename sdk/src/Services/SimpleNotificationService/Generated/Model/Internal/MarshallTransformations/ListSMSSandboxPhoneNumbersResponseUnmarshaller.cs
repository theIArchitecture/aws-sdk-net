...
namespace Amazon.SimpleNotificationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListSMSSandboxPhoneNumbersResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSMSSandboxPhoneNumbersResponse response = new ListSMSSandboxPhoneNumbersResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ListSMSSandboxPhoneNumbersResult", 2))
                    {
        ...
        private static ListSMSSandboxPhoneNumbersResponseUnmarshaller _instance = new ListSMSSandboxPhoneNumbersResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSMSSandboxPhoneNumbersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
