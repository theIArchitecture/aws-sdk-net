...
namespace Amazon.SimpleNotificationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VerifySMSSandboxPhoneNumberResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            VerifySMSSandboxPhoneNumberResponse response = new VerifySMSSandboxPhoneNumberResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("VerifySMSSandboxPhoneNumberResult", 2))
                    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("VerificationException"))
                {
                    return VerificationExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
            }
        ...
        private static VerifySMSSandboxPhoneNumberResponseUnmarshaller _instance = new VerifySMSSandboxPhoneNumberResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static VerifySMSSandboxPhoneNumberResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
