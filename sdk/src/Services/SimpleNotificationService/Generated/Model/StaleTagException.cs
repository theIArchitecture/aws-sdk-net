...
namespace Amazon.SimpleNotificationService.Model
{
    ...
    public partial class StaleTagException : AmazonSimpleNotificationServiceException
    {
        ...
        public StaleTagException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public StaleTagException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
