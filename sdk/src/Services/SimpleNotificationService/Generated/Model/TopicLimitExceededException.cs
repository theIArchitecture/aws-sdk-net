...
namespace Amazon.SimpleNotificationService.Model
{
    ...
    public partial class TopicLimitExceededException : AmazonSimpleNotificationServiceException
    {
        ...
        public TopicLimitExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TopicLimitExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
