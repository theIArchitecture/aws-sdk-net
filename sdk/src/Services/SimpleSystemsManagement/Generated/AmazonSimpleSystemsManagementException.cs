...
namespace Amazon.SimpleSystemsManagement
{
    ...
    public partial class AmazonSimpleSystemsManagementException : AmazonServiceException
    {
        ...
        public AmazonSimpleSystemsManagementException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonSimpleSystemsManagementException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
