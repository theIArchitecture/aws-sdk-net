...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class ComplianceTypeCountLimitExceededException : AmazonSimpleSystemsManagementException
    {
        ...
        public ComplianceTypeCountLimitExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ComplianceTypeCountLimitExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
