...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class CustomSchemaCountLimitExceededException : AmazonSimpleSystemsManagementException
    {
        ...
        public CustomSchemaCountLimitExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CustomSchemaCountLimitExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
