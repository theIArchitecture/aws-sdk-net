...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class DocumentPermissionLimitException : AmazonSimpleSystemsManagementException
    {
        ...
        public DocumentPermissionLimitException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DocumentPermissionLimitException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
