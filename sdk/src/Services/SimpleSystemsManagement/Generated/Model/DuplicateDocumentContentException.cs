...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class DuplicateDocumentContentException : AmazonSimpleSystemsManagementException
    {
        ...
        public DuplicateDocumentContentException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DuplicateDocumentContentException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
