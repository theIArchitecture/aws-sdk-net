...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class FeatureNotAvailableException : AmazonSimpleSystemsManagementException
    {
        ...
        public FeatureNotAvailableException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public FeatureNotAvailableException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
