...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class HierarchyTypeMismatchException : AmazonSimpleSystemsManagementException
    {
        ...
        public HierarchyTypeMismatchException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public HierarchyTypeMismatchException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
