...
namespace Amazon.SimpleSystemsManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssociationExecutionUnmarshaller : IJsonUnmarshaller<AssociationExecution, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AssociationExecution Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ResourceCountByStatus = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
