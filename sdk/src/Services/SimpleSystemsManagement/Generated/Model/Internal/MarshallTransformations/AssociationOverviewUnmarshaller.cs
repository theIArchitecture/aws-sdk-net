...
namespace Amazon.SimpleSystemsManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssociationOverviewUnmarshaller : IJsonUnmarshaller<AssociationOverview, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AssociationOverview Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AssociationStatusAggregatedCount", targetDepth))
                {
                    ...
                    unmarshalledObject.AssociationStatusAggregatedCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
