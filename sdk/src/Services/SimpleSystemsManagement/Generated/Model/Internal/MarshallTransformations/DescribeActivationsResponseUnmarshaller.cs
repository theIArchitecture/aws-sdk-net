    ...
    public class DescribeActivationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<Activation, ActivationUnmarshaller>(ActivationUnmarshaller.Instance);
                    response.ActivationList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
