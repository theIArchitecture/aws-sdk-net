    ...
    public class DescribeAutomationExecutionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AutomationExecutionMetadata, AutomationExecutionMetadataUnmarshaller>(AutomationExecutionMetadataUnmarshaller.Instance);
                    response.AutomationExecutionMetadataList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
