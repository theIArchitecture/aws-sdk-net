    ...
    public class DescribeDocumentPermissionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AccountSharingInfo, AccountSharingInfoUnmarshaller>(AccountSharingInfoUnmarshaller.Instance);
                    response.AccountSharingInfoList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
