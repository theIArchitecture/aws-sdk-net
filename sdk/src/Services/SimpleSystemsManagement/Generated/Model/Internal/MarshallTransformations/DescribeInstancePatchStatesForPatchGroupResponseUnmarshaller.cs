    ...
    public class DescribeInstancePatchStatesForPatchGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<InstancePatchState, InstancePatchStateUnmarshaller>(InstancePatchStateUnmarshaller.Instance);
                    response.InstancePatchStates = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
