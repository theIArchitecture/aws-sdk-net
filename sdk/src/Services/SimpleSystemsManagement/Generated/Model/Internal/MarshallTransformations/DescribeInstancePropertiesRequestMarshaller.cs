...
{
    /// <summary>
    /// DescribeInstanceProperties Request Marshaller
    /// </summary>       
    public class DescribeInstancePropertiesRequestMarshaller : IMarshaller<IRequest, DescribeInstancePropertiesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeInstancePropertiesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeInstancePropertiesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SimpleSystemsManagement");
            string target = "AmazonSSM.DescribeInstanceProperties";
        ...
        private static DescribeInstancePropertiesRequestMarshaller _instance = new DescribeInstancePropertiesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeInstancePropertiesRequestMarshaller Instance
        {
            get
            {
                return _instance;
