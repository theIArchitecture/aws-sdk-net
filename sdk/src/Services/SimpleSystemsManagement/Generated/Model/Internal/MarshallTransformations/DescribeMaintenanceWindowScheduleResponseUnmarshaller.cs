    ...
    public class DescribeMaintenanceWindowScheduleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ScheduledWindowExecution, ScheduledWindowExecutionUnmarshaller>(ScheduledWindowExecutionUnmarshaller.Instance);
                    response.ScheduledWindowExecutions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
