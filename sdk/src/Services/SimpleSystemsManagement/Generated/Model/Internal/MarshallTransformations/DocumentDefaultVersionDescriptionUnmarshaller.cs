...
namespace Amazon.SimpleSystemsManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DocumentDefaultVersionDescriptionUnmarshaller : IJsonUnmarshaller<DocumentDefaultVersionDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DocumentDefaultVersionDescription Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DefaultVersionName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
