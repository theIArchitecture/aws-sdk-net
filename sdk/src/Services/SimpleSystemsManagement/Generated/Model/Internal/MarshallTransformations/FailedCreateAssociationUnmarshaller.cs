...
namespace Amazon.SimpleSystemsManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FailedCreateAssociationUnmarshaller : IJsonUnmarshaller<FailedCreateAssociation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FailedCreateAssociation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Fault", targetDepth))
                {
                    ...
                    unmarshalledObject.Fault = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
