    ...
    public class ListAssociationVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AssociationVersionInfo, AssociationVersionInfoUnmarshaller>(AssociationVersionInfoUnmarshaller.Instance);
                    response.AssociationVersions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
