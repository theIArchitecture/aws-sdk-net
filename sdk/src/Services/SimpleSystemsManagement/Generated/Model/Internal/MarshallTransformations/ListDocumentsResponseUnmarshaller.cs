    ...
    public class ListDocumentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DocumentIdentifier, DocumentIdentifierUnmarshaller>(DocumentIdentifierUnmarshaller.Instance);
                    response.DocumentIdentifiers = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
