...
namespace Amazon.SimpleSystemsManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResolvedTargetsUnmarshaller : IJsonUnmarshaller<ResolvedTargets, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResolvedTargets Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ParameterValues", targetDepth))
                {
                    ...
                    unmarshalledObject.ParameterValues = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
