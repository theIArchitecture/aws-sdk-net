...
{
    /// <summary>
    /// StartExecutionPreview Request Marshaller
    /// </summary>       
    public class StartExecutionPreviewRequestMarshaller : IMarshaller<IRequest, StartExecutionPreviewRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartExecutionPreviewRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartExecutionPreviewRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SimpleSystemsManagement");
            string target = "AmazonSSM.StartExecutionPreview";
        ...
        private static StartExecutionPreviewRequestMarshaller _instance = new StartExecutionPreviewRequestMarshaller();        

        internal static StartExecutionPreviewRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartExecutionPreviewRequestMarshaller Instance
        {
            get
            {
                return _instance;
