...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class InvalidActivationException : AmazonSimpleSystemsManagementException
    {
        ...
        public InvalidActivationException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidActivationException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
