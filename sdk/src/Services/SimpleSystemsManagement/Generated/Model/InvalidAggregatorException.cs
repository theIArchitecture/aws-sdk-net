...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class InvalidAggregatorException : AmazonSimpleSystemsManagementException
    {
        ...
        public InvalidAggregatorException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidAggregatorException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
