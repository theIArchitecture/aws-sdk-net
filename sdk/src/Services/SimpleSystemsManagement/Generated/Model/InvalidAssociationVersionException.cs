...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class InvalidAssociationVersionException : AmazonSimpleSystemsManagementException
    {
        ...
        public InvalidAssociationVersionException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidAssociationVersionException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
