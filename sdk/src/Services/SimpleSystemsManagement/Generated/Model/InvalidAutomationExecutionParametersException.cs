...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class InvalidAutomationExecutionParametersException : AmazonSimpleSystemsManagementException
    {
        ...
        public InvalidAutomationExecutionParametersException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidAutomationExecutionParametersException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
