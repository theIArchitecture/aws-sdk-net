...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class InvalidDeleteInventoryParametersException : AmazonSimpleSystemsManagementException
    {
        ...
        public InvalidDeleteInventoryParametersException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidDeleteInventoryParametersException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
