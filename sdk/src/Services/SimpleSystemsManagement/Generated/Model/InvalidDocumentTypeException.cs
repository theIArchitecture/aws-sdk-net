...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class InvalidDocumentTypeException : AmazonSimpleSystemsManagementException
    {
        ...
        public InvalidDocumentTypeException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidDocumentTypeException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
