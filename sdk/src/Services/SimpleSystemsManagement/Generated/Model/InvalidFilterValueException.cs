...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class InvalidFilterValueException : AmazonSimpleSystemsManagementException
    {
        ...
        public InvalidFilterValueException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidFilterValueException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
