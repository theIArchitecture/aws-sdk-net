...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class InvalidNotificationConfigException : AmazonSimpleSystemsManagementException
    {
        ...
        public InvalidNotificationConfigException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidNotificationConfigException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
