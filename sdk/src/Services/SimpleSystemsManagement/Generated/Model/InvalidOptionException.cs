...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class InvalidOptionException : AmazonSimpleSystemsManagementException
    {
        ...
        public InvalidOptionException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidOptionException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
