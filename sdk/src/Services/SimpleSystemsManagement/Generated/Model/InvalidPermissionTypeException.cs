...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class InvalidPermissionTypeException : AmazonSimpleSystemsManagementException
    {
        ...
        public InvalidPermissionTypeException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidPermissionTypeException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
