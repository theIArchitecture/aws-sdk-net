...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class InvalidPolicyTypeException : AmazonSimpleSystemsManagementException
    {
        ...
        public InvalidPolicyTypeException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidPolicyTypeException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
