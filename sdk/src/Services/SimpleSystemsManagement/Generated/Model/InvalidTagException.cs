...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    [Serializable]
    #endif
    public partial class InvalidTagException : AmazonSimpleSystemsManagementException
    {
        ...
        public InvalidTagException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidTagException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
