...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class ParameterLimitExceededException : AmazonSimpleSystemsManagementException
    {
        ...
        public ParameterLimitExceededException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ParameterLimitExceededException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
