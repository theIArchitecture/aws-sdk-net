...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class ResourceDataSyncAlreadyExistsException : AmazonSimpleSystemsManagementException
    {
        ...
        public ResourceDataSyncAlreadyExistsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ResourceDataSyncAlreadyExistsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
