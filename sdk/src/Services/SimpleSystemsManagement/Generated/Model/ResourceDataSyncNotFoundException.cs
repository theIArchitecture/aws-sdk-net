...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class ResourceDataSyncNotFoundException : AmazonSimpleSystemsManagementException
    {
        ...
        public ResourceDataSyncNotFoundException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ResourceDataSyncNotFoundException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
