...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class ServiceSettingNotFoundException : AmazonSimpleSystemsManagementException
    {
        ...
        public ServiceSettingNotFoundException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ServiceSettingNotFoundException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
