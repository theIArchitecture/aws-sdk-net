...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class TooManyTagsErrorException : AmazonSimpleSystemsManagementException
    {
        ...
        public TooManyTagsErrorException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TooManyTagsErrorException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
