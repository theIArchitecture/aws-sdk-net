...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class UnsupportedInventoryItemContextException : AmazonSimpleSystemsManagementException
    {
        ...
        public UnsupportedInventoryItemContextException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public UnsupportedInventoryItemContextException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
