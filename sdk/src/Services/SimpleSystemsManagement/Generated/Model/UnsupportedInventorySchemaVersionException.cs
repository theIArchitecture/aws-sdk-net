...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class UnsupportedInventorySchemaVersionException : AmazonSimpleSystemsManagementException
    {
        ...
        public UnsupportedInventorySchemaVersionException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public UnsupportedInventorySchemaVersionException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
