...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    public partial class UnsupportedPlatformTypeException : AmazonSimpleSystemsManagementException
    {
        ...
        public UnsupportedPlatformTypeException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public UnsupportedPlatformTypeException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
