...
namespace Amazon.SimpleWorkflow.Internal
{
    ...
    public class AmazonSimpleWorkflowAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSimpleWorkflowAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for SimpleWorkflow.
        /// </summary>
        public AmazonSimpleWorkflowAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSimpleWorkflowAuthSchemeParameters
            {
    ...
    public class AmazonSimpleWorkflowAuthSchemeResolver : IAuthSchemeResolver<AmazonSimpleWorkflowAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSimpleWorkflowAuthSchemeParameters authParameters)
        {
