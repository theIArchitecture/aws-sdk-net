...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ActivityTaskCanceledEventAttributesUnmarshaller : IJsonUnmarshaller<ActivityTaskCanceledEventAttributes, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ActivityTaskCanceledEventAttributes Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("latestCancelRequestedEventId", targetDepth))
                {
                    ...
                    unmarshalledObject.LatestCancelRequestedEventId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
