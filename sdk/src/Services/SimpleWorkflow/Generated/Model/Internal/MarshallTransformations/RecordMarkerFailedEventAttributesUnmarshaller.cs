...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RecordMarkerFailedEventAttributesUnmarshaller : IJsonUnmarshaller<RecordMarkerFailedEventAttributes, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RecordMarkerFailedEventAttributes Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.MarkerName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
