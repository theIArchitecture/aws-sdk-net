...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class WorkflowExecutionContinuedAsNewEventAttributesUnmarshaller : IJsonUnmarshaller<WorkflowExecutionContinuedAsNewEventAttributes, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public WorkflowExecutionContinuedAsNewEventAttributes Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.NewExecutionRunId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
