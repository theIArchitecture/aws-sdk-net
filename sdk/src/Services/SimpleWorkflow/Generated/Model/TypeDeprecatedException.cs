...
namespace Amazon.SimpleWorkflow.Model
{
    ...
    public partial class TypeDeprecatedException : AmazonSimpleWorkflowException
    {
        ...
        public TypeDeprecatedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public TypeDeprecatedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
