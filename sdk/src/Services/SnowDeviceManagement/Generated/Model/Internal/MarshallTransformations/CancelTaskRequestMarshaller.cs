...
namespace Amazon.SnowDeviceManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CancelTaskRequestMarshaller : IMarshaller<IRequest, CancelTaskRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CancelTaskRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CancelTaskRequest publicRequest)
        {
            ...
            request.ResourcePath = "/task/{taskId}/cancel";

            return request;
        }
        private static CancelTaskRequestMarshaller _instance = new CancelTaskRequestMarshaller();        

        internal static CancelTaskRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelTaskRequestMarshaller Instance
        {
            get
            {
                return _instance;
