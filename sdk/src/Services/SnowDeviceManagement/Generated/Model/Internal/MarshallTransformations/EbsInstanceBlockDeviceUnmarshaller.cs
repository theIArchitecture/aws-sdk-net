...
namespace Amazon.SnowDeviceManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EbsInstanceBlockDeviceUnmarshaller : IJsonUnmarshaller<EbsInstanceBlockDevice, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EbsInstanceBlockDevice Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
