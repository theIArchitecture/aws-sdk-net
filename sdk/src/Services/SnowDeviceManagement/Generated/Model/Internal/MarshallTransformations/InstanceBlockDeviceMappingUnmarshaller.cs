...
namespace Amazon.SnowDeviceManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InstanceBlockDeviceMappingUnmarshaller : IJsonUnmarshaller<InstanceBlockDeviceMapping, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InstanceBlockDeviceMapping Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
