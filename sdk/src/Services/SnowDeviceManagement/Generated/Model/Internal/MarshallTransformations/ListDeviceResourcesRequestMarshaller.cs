...
namespace Amazon.SnowDeviceManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListDeviceResourcesRequestMarshaller : IMarshaller<IRequest, ListDeviceResourcesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListDeviceResourcesRequestMarshaller _instance = new ListDeviceResourcesRequestMarshaller();        

        internal static ListDeviceResourcesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDeviceResourcesRequestMarshaller Instance
        {
            get
            {
                return _instance;
