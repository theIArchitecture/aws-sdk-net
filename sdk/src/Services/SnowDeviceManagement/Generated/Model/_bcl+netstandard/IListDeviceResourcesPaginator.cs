...
namespace Amazon.SnowDeviceManagement.Model
{
    ...
    ///</summary>
    public interface IListDeviceResourcesPaginator
    {
        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        IPaginatedEnumerable<ListDeviceResourcesResponse> Responses { get; }

        /// <summary>
        /// Enumerable containing all of the Resources
        /// </summary>
        IPaginatedEnumerable<ResourceSummary> Resources { get; }
    }
}