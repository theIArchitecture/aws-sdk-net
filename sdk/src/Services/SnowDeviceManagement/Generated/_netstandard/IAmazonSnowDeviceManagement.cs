...
namespace Amazon.SnowDeviceManagement
{
    ...
    public partial interface IAmazonSnowDeviceManagement : IAmazonService, IDisposable
    {
        ...
        Task<CancelTaskResponse> CancelTaskAsync(CancelTaskRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DescribeDeviceEc2InstancesResponse> DescribeDeviceEc2InstancesAsync(DescribeDeviceEc2InstancesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListDeviceResourcesResponse> ListDeviceResourcesAsync(ListDeviceResourcesRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonSnowDeviceManagementConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonSnowDeviceManagementConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonSnowDeviceManagementConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonSnowDeviceManagementConfig to create AmazonSnowDeviceManagementClient");
            }

            return awsCredentials == null ? 
                    new AmazonSnowDeviceManagementClient(serviceClientConfig) :
                    new AmazonSnowDeviceManagementClient(awsCredentials, serviceClientConfig);
        }
