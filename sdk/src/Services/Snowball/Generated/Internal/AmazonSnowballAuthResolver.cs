...
namespace Amazon.Snowball.Internal
{
    ...
    public class AmazonSnowballAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSnowballAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Snowball.
        /// </summary>
        public AmazonSnowballAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSnowballAuthSchemeParameters
            {
    ...
    public class AmazonSnowballAuthSchemeResolver : IAuthSchemeResolver<AmazonSnowballAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSnowballAuthSchemeParameters authParameters)
        {
