...
namespace Amazon.Snowball.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DependentServiceUnmarshaller : IJsonUnmarshaller<DependentService, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DependentService Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ServiceVersion", targetDepth))
                {
                    ...
                    unmarshalledObject.ServiceVersion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
