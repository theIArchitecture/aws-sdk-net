...
namespace Amazon.Snowball.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EKSOnDeviceServiceConfigurationUnmarshaller : IJsonUnmarshaller<EKSOnDeviceServiceConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EKSOnDeviceServiceConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("EKSAnywhereVersion", targetDepth))
                {
                    ...
                    unmarshalledObject.EKSAnywhereVersion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
