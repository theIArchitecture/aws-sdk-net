...
namespace Amazon.Snowball.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TaxDocumentsUnmarshaller : IJsonUnmarshaller<TaxDocuments, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TaxDocuments Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("IND", targetDepth))
                {
                    ...
                    unmarshalledObject.IND = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
