...
namespace Amazon.Snowball.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class WirelessConnectionUnmarshaller : IJsonUnmarshaller<WirelessConnection, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public WirelessConnection Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("IsWifiEnabled", targetDepth))
                {
                    ...
                    unmarshalledObject.IsWifiEnabled = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
