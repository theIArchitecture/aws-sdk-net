...
namespace Amazon.Snowball.Model
{
    ...
    public partial class KMSRequestFailedException : AmazonSnowballException
    {
        ...
        public KMSRequestFailedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public KMSRequestFailedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
