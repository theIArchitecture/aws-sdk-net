...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonSnowballConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonSnowballConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonSnowballConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonSnowballConfig to create AmazonSnowballClient");
            }

            return awsCredentials == null ? 
                    new AmazonSnowballClient(serviceClientConfig) :
                    new AmazonSnowballClient(awsCredentials, serviceClientConfig);
        }
