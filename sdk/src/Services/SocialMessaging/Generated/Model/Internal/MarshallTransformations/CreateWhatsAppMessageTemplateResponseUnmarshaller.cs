...
{
    /// <summary>
    /// Response Unmarshaller for CreateWhatsAppMessageTemplate operation
    /// </summary>  
    public class CreateWhatsAppMessageTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateWhatsAppMessageTemplateResponse response = new CreateWhatsAppMessageTemplateResponse();
        ...
        private static CreateWhatsAppMessageTemplateResponseUnmarshaller _instance = new CreateWhatsAppMessageTemplateResponseUnmarshaller();        

        internal static CreateWhatsAppMessageTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWhatsAppMessageTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
