...
{
    /// <summary>
    /// Response Unmarshaller for DeleteWhatsAppMessageMedia operation
    /// </summary>  
    public class DeleteWhatsAppMessageMediaResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteWhatsAppMessageMediaResponse response = new DeleteWhatsAppMessageMediaResponse();
        ...
        private static DeleteWhatsAppMessageMediaResponseUnmarshaller _instance = new DeleteWhatsAppMessageMediaResponseUnmarshaller();        

        internal static DeleteWhatsAppMessageMediaResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteWhatsAppMessageMediaResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
