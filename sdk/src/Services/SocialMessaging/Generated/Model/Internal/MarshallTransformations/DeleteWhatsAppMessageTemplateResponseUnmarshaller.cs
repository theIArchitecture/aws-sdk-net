...
{
    /// <summary>
    /// Response Unmarshaller for DeleteWhatsAppMessageTemplate operation
    /// </summary>  
    public class DeleteWhatsAppMessageTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteWhatsAppMessageTemplateResponse response = new DeleteWhatsAppMessageTemplateResponse();
        ...
        private static DeleteWhatsAppMessageTemplateResponseUnmarshaller _instance = new DeleteWhatsAppMessageTemplateResponseUnmarshaller();        

        internal static DeleteWhatsAppMessageTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteWhatsAppMessageTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
