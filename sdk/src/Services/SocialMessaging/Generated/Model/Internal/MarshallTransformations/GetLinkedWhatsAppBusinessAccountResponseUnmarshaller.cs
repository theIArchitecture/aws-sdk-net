...
{
    /// <summary>
    /// Response Unmarshaller for GetLinkedWhatsAppBusinessAccount operation
    /// </summary>  
    public class GetLinkedWhatsAppBusinessAccountResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetLinkedWhatsAppBusinessAccountResponse response = new GetLinkedWhatsAppBusinessAccountResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = LinkedWhatsAppBusinessAccountUnmarshaller.Instance;
        ...
        private static GetLinkedWhatsAppBusinessAccountResponseUnmarshaller _instance = new GetLinkedWhatsAppBusinessAccountResponseUnmarshaller();        

        internal static GetLinkedWhatsAppBusinessAccountResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLinkedWhatsAppBusinessAccountResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
