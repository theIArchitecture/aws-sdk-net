...
{
    /// <summary>
    /// Response Unmarshaller for GetWhatsAppMessageMedia operation
    /// </summary>  
    public class GetWhatsAppMessageMediaResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetWhatsAppMessageMediaResponse response = new GetWhatsAppMessageMediaResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("mimeType", targetDepth))
                {
                    ...
                    response.MimeType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetWhatsAppMessageMediaResponseUnmarshaller _instance = new GetWhatsAppMessageMediaResponseUnmarshaller();        

        internal static GetWhatsAppMessageMediaResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetWhatsAppMessageMediaResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
