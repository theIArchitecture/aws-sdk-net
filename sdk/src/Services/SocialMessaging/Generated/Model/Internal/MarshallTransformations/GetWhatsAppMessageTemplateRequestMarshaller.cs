...
namespace Amazon.SocialMessaging.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetWhatsAppMessageTemplateRequestMarshaller : IMarshaller<IRequest, GetWhatsAppMessageTemplateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetWhatsAppMessageTemplateRequestMarshaller _instance = new GetWhatsAppMessageTemplateRequestMarshaller();        

        internal static GetWhatsAppMessageTemplateRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetWhatsAppMessageTemplateRequestMarshaller Instance
        {
            get
            {
                return _instance;
