...
{
    /// <summary>
    /// Response Unmarshaller for PostWhatsAppMessageMedia operation
    /// </summary>  
    public class PostWhatsAppMessageMediaResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PostWhatsAppMessageMediaResponse response = new PostWhatsAppMessageMediaResponse();
        ...
        private static PostWhatsAppMessageMediaResponseUnmarshaller _instance = new PostWhatsAppMessageMediaResponseUnmarshaller();        

        internal static PostWhatsAppMessageMediaResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PostWhatsAppMessageMediaResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
