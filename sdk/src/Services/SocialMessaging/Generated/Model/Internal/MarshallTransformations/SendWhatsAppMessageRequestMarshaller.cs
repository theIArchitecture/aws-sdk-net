...
{
    /// <summary>
    /// SendWhatsAppMessage Request Marshaller
    /// </summary>       
    public class SendWhatsAppMessageRequestMarshaller : IMarshaller<IRequest, SendWhatsAppMessageRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SendWhatsAppMessageRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SendWhatsAppMessageRequest publicRequest)
        {
        ...
        private static SendWhatsAppMessageRequestMarshaller _instance = new SendWhatsAppMessageRequestMarshaller();        

        internal static SendWhatsAppMessageRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendWhatsAppMessageRequestMarshaller Instance
        {
            get
            {
                return _instance;
