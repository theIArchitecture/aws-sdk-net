...
{
    /// <summary>
    /// Response Unmarshaller for SendWhatsAppMessage operation
    /// </summary>  
    public class SendWhatsAppMessageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SendWhatsAppMessageResponse response = new SendWhatsAppMessageResponse();
        ...
        private static SendWhatsAppMessageResponseUnmarshaller _instance = new SendWhatsAppMessageResponseUnmarshaller();        

        internal static SendWhatsAppMessageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendWhatsAppMessageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
