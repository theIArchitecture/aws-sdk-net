...
{
    /// <summary>
    /// Response Unmarshaller for WhatsAppSignupCallbackResult Object
    /// </summary>  
    public class WhatsAppSignupCallbackResultUnmarshaller : IJsonUnmarshaller<WhatsAppSignupCallbackResult, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public WhatsAppSignupCallbackResult Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            WhatsAppSignupCallbackResult unmarshalledObject = new WhatsAppSignupCallbackResult();
        ...
        private static WhatsAppSignupCallbackResultUnmarshaller _instance = new WhatsAppSignupCallbackResultUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static WhatsAppSignupCallbackResultUnmarshaller Instance
        {
            get
            {
                return _instance;
