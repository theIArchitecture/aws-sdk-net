...
namespace Amazon.SsmSap.Internal
{
    ...
    public class AmazonSsmSapAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSsmSapAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for SsmSap.
        /// </summary>
        public AmazonSsmSapAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSsmSapAuthSchemeParameters
            {
    ...
    public class AmazonSsmSapAuthSchemeResolver : IAuthSchemeResolver<AmazonSsmSapAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSsmSapAuthSchemeParameters authParameters)
        {
