...
{
    /// <summary>
    /// Response Unmarshaller for DatabaseSummary Object
    /// </summary>  
    public class DatabaseSummaryUnmarshaller : IJsonUnmarshaller<DatabaseSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DatabaseSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            DatabaseSummary unmarshalledObject = new DatabaseSummary();
        ...
        private static DatabaseSummaryUnmarshaller _instance = new DatabaseSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DatabaseSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
