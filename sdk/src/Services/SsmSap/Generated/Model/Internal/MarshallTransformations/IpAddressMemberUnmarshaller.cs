...
namespace Amazon.SsmSap.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IpAddressMemberUnmarshaller : IJsonUnmarshaller<IpAddressMember, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IpAddressMember Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AllocationType", targetDepth))
                {
                    ...
                    unmarshalledObject.AllocationType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
