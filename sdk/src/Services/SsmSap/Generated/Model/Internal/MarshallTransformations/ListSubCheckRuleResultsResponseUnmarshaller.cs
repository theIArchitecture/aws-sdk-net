...
namespace Amazon.SsmSap.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListSubCheckRuleResultsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSubCheckRuleResultsResponse response = new ListSubCheckRuleResultsResponse();
        ...
        internal static ListSubCheckRuleResultsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSubCheckRuleResultsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
