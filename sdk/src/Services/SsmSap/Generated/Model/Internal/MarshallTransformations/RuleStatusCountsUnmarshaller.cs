...
namespace Amazon.SsmSap.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RuleStatusCountsUnmarshaller : IJsonUnmarshaller<RuleStatusCounts, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            RuleStatusCounts unmarshalledObject = new RuleStatusCounts();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RuleStatusCountsUnmarshaller Instance
        {
            get
            {
                return _instance;
