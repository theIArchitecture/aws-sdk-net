...
{
    /// <summary>
    /// Response Unmarshaller for StartConfigurationChecks operation
    /// </summary>  
    public class StartConfigurationChecksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartConfigurationChecksResponse response = new StartConfigurationChecksResponse();
        ...
        private static StartConfigurationChecksResponseUnmarshaller _instance = new StartConfigurationChecksResponseUnmarshaller();        

        internal static StartConfigurationChecksResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartConfigurationChecksResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
