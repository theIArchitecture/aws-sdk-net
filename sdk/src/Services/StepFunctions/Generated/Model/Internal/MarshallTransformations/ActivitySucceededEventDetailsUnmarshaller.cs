...
namespace Amazon.StepFunctions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ActivitySucceededEventDetailsUnmarshaller : IJsonUnmarshaller<ActivitySucceededEventDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ActivitySucceededEventDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
