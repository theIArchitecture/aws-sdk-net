...
{
    /// <summary>
    /// Response Unmarshaller for CreateStateMachineAlias operation
    /// </summary>  
    public class CreateStateMachineAliasResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateStateMachineAliasResponse response = new CreateStateMachineAliasResponse();
        ...
        private static CreateStateMachineAliasResponseUnmarshaller _instance = new CreateStateMachineAliasResponseUnmarshaller();        

        internal static CreateStateMachineAliasResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateStateMachineAliasResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
