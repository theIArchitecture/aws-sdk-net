...
{
    /// <summary>
    /// Response Unmarshaller for DescribeMapRun operation
    /// </summary>  
    public class DescribeMapRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeMapRunResponseUnmarshaller _instance = new DescribeMapRunResponseUnmarshaller();        

        internal static DescribeMapRunResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeMapRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
