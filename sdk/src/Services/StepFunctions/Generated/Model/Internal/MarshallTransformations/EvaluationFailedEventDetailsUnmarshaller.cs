...
namespace Amazon.StepFunctions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EvaluationFailedEventDetailsUnmarshaller : IJsonUnmarshaller<EvaluationFailedEventDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EvaluationFailedEventDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
