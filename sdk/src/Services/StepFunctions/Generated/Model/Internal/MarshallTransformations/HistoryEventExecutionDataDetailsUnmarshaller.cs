...
namespace Amazon.StepFunctions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class HistoryEventExecutionDataDetailsUnmarshaller : IJsonUnmarshaller<HistoryEventExecutionDataDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public HistoryEventExecutionDataDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
