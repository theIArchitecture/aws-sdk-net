...
{
    /// <summary>
    /// Response Unmarshaller for InspectionDataRequest Object
    /// </summary>  
    public class InspectionDataRequestUnmarshaller : IJsonUnmarshaller<InspectionDataRequest, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InspectionDataRequest Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            InspectionDataRequest unmarshalledObject = new InspectionDataRequest();
        ...
        private static InspectionDataRequestUnmarshaller _instance = new InspectionDataRequestUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static InspectionDataRequestUnmarshaller Instance
        {
            get
            {
                return _instance;
