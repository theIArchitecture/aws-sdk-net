...
namespace Amazon.StepFunctions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MapRunStartedEventDetailsUnmarshaller : IJsonUnmarshaller<MapRunStartedEventDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MapRunStartedEventDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
