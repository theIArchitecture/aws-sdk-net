...
namespace Amazon.StepFunctions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StateEnteredEventDetailsUnmarshaller : IJsonUnmarshaller<StateEnteredEventDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public StateEnteredEventDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
