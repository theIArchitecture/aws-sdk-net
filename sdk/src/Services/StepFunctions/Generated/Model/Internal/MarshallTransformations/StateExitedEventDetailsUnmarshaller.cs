...
namespace Amazon.StepFunctions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StateExitedEventDetailsUnmarshaller : IJsonUnmarshaller<StateExitedEventDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public StateExitedEventDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
