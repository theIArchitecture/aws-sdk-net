...
namespace Amazon.StepFunctions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TaskScheduledEventDetailsUnmarshaller : IJsonUnmarshaller<TaskScheduledEventDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TaskScheduledEventDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
