...
{
    /// <summary>
    /// Response Unmarshaller for UpdateMapRun operation
    /// </summary>  
    public class UpdateMapRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateMapRunResponse response = new UpdateMapRunResponse();
        ...
        private static UpdateMapRunResponseUnmarshaller _instance = new UpdateMapRunResponseUnmarshaller();        

        internal static UpdateMapRunResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMapRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
