...
namespace Amazon.StorageGateway.Internal
{
    ...
    public class AmazonStorageGatewayAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonStorageGatewayAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for StorageGateway.
        /// </summary>
        public AmazonStorageGatewayAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonStorageGatewayAuthSchemeParameters
            {
    ...
    public class AmazonStorageGatewayAuthSchemeResolver : IAuthSchemeResolver<AmazonStorageGatewayAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonStorageGatewayAuthSchemeParameters authParameters)
        {
