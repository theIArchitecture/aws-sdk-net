...
{
    /// <summary>
    /// Response Unmarshaller for DeleteCacheReport operation
    /// </summary>  
    public class DeleteCacheReportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteCacheReportResponse response = new DeleteCacheReportResponse();
        ...
        private static DeleteCacheReportResponseUnmarshaller _instance = new DeleteCacheReportResponseUnmarshaller();        

        internal static DeleteCacheReportResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCacheReportResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
