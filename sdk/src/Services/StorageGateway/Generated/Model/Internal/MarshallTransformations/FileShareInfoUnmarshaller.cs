...
namespace Amazon.StorageGateway.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FileShareInfoUnmarshaller : IJsonUnmarshaller<FileShareInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FileShareInfo Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.FileShareType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
