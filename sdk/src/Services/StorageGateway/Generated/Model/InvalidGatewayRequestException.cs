...
namespace Amazon.StorageGateway.Model
{
    ...
    public partial class InvalidGatewayRequestException : AmazonStorageGatewayException
    {
        ...
        public InvalidGatewayRequestException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidGatewayRequestException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
