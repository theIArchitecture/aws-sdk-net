...
namespace Amazon.StorageGateway.Model
{
    ...
    public interface IListFileSystemAssociationsPaginator
    {
        ...
        /// </summary>
        IPaginatedEnumerable<ListFileSystemAssociationsResponse> Responses { get; }

        /// <summary>
        /// Enumerable containing all of the FileSystemAssociationSummaryList
        /// </summary>
        IPaginatedEnumerable<FileSystemAssociationSummary> FileSystemAssociationSummaryList { get; }
    }
}