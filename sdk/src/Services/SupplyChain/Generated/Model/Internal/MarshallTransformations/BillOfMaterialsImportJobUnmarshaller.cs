...
{
    /// <summary>
    /// Response Unmarshaller for BillOfMaterialsImportJob Object
    /// </summary>  
    public class BillOfMaterialsImportJobUnmarshaller : IJsonUnmarshaller<BillOfMaterialsImportJob, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BillOfMaterialsImportJob Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static BillOfMaterialsImportJobUnmarshaller _instance = new BillOfMaterialsImportJobUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BillOfMaterialsImportJobUnmarshaller Instance
        {
            get
            {
                return _instance;
