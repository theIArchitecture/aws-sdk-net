...
{
    /// <summary>
    /// Response Unmarshaller for DataLakeDatasetSchema Object
    /// </summary>  
    public class DataLakeDatasetSchemaUnmarshaller : IJsonUnmarshaller<DataLakeDatasetSchema, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DataLakeDatasetSchema Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            DataLakeDatasetSchema unmarshalledObject = new DataLakeDatasetSchema();
        ...
        private static DataLakeDatasetSchemaUnmarshaller _instance = new DataLakeDatasetSchemaUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DataLakeDatasetSchemaUnmarshaller Instance
        {
            get
            {
                return _instance;
