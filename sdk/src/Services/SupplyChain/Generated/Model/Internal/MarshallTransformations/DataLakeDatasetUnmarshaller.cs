...
{
    /// <summary>
    /// Response Unmarshaller for DataLakeDataset Object
    /// </summary>  
    public class DataLakeDatasetUnmarshaller : IJsonUnmarshaller<DataLakeDataset, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DataLakeDataset Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            DataLakeDataset unmarshalledObject = new DataLakeDataset();
        ...
        private static DataLakeDatasetUnmarshaller _instance = new DataLakeDatasetUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DataLakeDatasetUnmarshaller Instance
        {
            get
            {
                return _instance;
