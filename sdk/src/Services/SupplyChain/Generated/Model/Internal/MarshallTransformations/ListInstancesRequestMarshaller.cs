...
namespace Amazon.SupplyChain.Model.Internal.MarshallTransformations
{
    ...
    public class ListInstancesRequestMarshaller : IMarshaller<IRequest, ListInstancesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListInstancesRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetInstanceNameFilter())
                request.ParameterCollection.Add("instanceNameFilter", publicRequest.InstanceNameFilter);
            
            if (publicRequest.IsSetInstanceStateFilter())
                request.ParameterCollection.Add("instanceStateFilter", publicRequest.InstanceStateFilter);
            ...
            request.ResourcePath = "/api/instance";
