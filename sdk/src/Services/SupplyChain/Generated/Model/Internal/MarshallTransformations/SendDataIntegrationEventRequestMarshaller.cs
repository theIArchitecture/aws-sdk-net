...
{
    /// <summary>
    /// SendDataIntegrationEvent Request Marshaller
    /// </summary>       
    public class SendDataIntegrationEventRequestMarshaller : IMarshaller<IRequest, SendDataIntegrationEventRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SendDataIntegrationEventRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SendDataIntegrationEventRequest publicRequest)
        {
        ...
        private static SendDataIntegrationEventRequestMarshaller _instance = new SendDataIntegrationEventRequestMarshaller();        

        internal static SendDataIntegrationEventRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendDataIntegrationEventRequestMarshaller Instance
        {
            get
            {
                return _instance;
