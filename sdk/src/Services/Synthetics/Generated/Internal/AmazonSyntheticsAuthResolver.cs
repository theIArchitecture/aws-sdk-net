...
namespace Amazon.Synthetics.Internal
{
    ...
    public class AmazonSyntheticsAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonSyntheticsAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Synthetics.
        /// </summary>
        public AmazonSyntheticsAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonSyntheticsAuthSchemeParameters
            {
    ...
    public class AmazonSyntheticsAuthSchemeResolver : IAuthSchemeResolver<AmazonSyntheticsAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonSyntheticsAuthSchemeParameters authParameters)
        {
