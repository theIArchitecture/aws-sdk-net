...
namespace Amazon.Synthetics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RuntimeVersionUnmarshaller : IJsonUnmarshaller<RuntimeVersion, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RuntimeVersion Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
