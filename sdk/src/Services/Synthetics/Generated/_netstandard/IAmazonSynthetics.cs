...
namespace Amazon.Synthetics
{
    ...
    public partial interface IAmazonSynthetics : IAmazonService, IDisposable
    {
        ...
        Task<ListAssociatedGroupsResponse> ListAssociatedGroupsAsync(ListAssociatedGroupsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StartCanaryDryRunResponse> StartCanaryDryRunAsync(StartCanaryDryRunRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonSyntheticsConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonSyntheticsConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonSyntheticsConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonSyntheticsConfig to create AmazonSyntheticsClient");
            }

            return awsCredentials == null ? 
                    new AmazonSyntheticsClient(serviceClientConfig) :
                    new AmazonSyntheticsClient(awsCredentials, serviceClientConfig);
        }
