...
{
    /// <summary>
    /// Response Unmarshaller for CanadaAdditionalInfo Object
    /// </summary>  
    public class CanadaAdditionalInfoUnmarshaller : IJsonUnmarshaller<CanadaAdditionalInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CanadaAdditionalInfo Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            CanadaAdditionalInfo unmarshalledObject = new CanadaAdditionalInfo();
        ...
        private static CanadaAdditionalInfoUnmarshaller _instance = new CanadaAdditionalInfoUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CanadaAdditionalInfoUnmarshaller Instance
        {
            get
            {
                return _instance;
