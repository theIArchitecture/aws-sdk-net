...
namespace Amazon.TaxSettings.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CaseCreationLimitExceededExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<CaseCreationLimitExceededException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public CaseCreationLimitExceededException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public CaseCreationLimitExceededException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
