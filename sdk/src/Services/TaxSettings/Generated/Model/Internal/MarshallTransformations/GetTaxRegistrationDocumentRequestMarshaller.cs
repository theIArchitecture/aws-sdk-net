...
{
    /// <summary>
    /// GetTaxRegistrationDocument Request Marshaller
    /// </summary>       
    public class GetTaxRegistrationDocumentRequestMarshaller : IMarshaller<IRequest, GetTaxRegistrationDocumentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetTaxRegistrationDocumentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetTaxRegistrationDocumentRequest publicRequest)
        {
        ...
        private static GetTaxRegistrationDocumentRequestMarshaller _instance = new GetTaxRegistrationDocumentRequestMarshaller();        

        internal static GetTaxRegistrationDocumentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTaxRegistrationDocumentRequestMarshaller Instance
        {
            get
            {
                return _instance;
