...
{
    /// <summary>
    /// Response Unmarshaller for TaxRegistrationWithJurisdiction Object
    /// </summary>  
    public class TaxRegistrationWithJurisdictionUnmarshaller : IJsonUnmarshaller<TaxRegistrationWithJurisdiction, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TaxRegistrationWithJurisdiction Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            TaxRegistrationWithJurisdiction unmarshalledObject = new TaxRegistrationWithJurisdiction();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = JurisdictionUnmarshaller.Instance;
                    unmarshalledObject.Jurisdiction = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static TaxRegistrationWithJurisdictionUnmarshaller _instance = new TaxRegistrationWithJurisdictionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TaxRegistrationWithJurisdictionUnmarshaller Instance
        {
            get
            {
                return _instance;
