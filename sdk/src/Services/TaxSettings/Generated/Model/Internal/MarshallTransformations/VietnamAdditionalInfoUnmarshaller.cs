...
namespace Amazon.TaxSettings.Model.Internal.MarshallTransformations
{
    ...
    public class VietnamAdditionalInfoUnmarshaller : IJsonUnmarshaller<VietnamAdditionalInfo, JsonUnmarshallerContext>
    {
        ...
        private static VietnamAdditionalInfoUnmarshaller _instance = new VietnamAdditionalInfoUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static VietnamAdditionalInfoUnmarshaller Instance
        {
            get
            {
                return _instance;
