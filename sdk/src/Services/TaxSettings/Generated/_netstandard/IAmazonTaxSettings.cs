...
namespace Amazon.TaxSettings
{
    ...
    public partial interface IAmazonTaxSettings : IAmazonService, IDisposable
    {
        ...
        Task<BatchDeleteTaxRegistrationResponse> BatchDeleteTaxRegistrationAsync(BatchDeleteTaxRegistrationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<BatchPutTaxRegistrationResponse> BatchPutTaxRegistrationAsync(BatchPutTaxRegistrationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteSupplementalTaxRegistrationResponse> DeleteSupplementalTaxRegistrationAsync(DeleteSupplementalTaxRegistrationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteTaxRegistrationResponse> DeleteTaxRegistrationAsync(DeleteTaxRegistrationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetTaxRegistrationResponse> GetTaxRegistrationAsync(GetTaxRegistrationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetTaxRegistrationDocumentResponse> GetTaxRegistrationDocumentAsync(GetTaxRegistrationDocumentRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListSupplementalTaxRegistrationsResponse> ListSupplementalTaxRegistrationsAsync(ListSupplementalTaxRegistrationsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListTaxRegistrationsResponse> ListTaxRegistrationsAsync(ListTaxRegistrationsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<PutTaxRegistrationResponse> PutTaxRegistrationAsync(PutTaxRegistrationRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonTaxSettingsConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonTaxSettingsConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonTaxSettingsConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonTaxSettingsConfig to create AmazonTaxSettingsClient");
            }

            return awsCredentials == null ? 
                    new AmazonTaxSettingsClient(serviceClientConfig) :
                    new AmazonTaxSettingsClient(awsCredentials, serviceClientConfig);
        }
