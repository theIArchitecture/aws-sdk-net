...
namespace Amazon.Textract.Internal
{
    ...
    public class AmazonTextractAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonTextractAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Textract.
        /// </summary>
        public AmazonTextractAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonTextractAuthSchemeParameters
            {
    ...
    public class AmazonTextractAuthSchemeResolver : IAuthSchemeResolver<AmazonTextractAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonTextractAuthSchemeParameters authParameters)
        {
