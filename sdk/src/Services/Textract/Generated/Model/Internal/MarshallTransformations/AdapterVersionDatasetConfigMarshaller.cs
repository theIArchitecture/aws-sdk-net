...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public class AdapterVersionDatasetConfigMarshaller : IRequestMarshaller<AdapterVersionDatasetConfig, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(AdapterVersionDatasetConfig requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetManifestS3Object())
            {
                ...
                marshaller.Marshall(requestObject.ManifestS3Object, context);
        ...
        /// </summary>
        public readonly static AdapterVersionDatasetConfigMarshaller Instance = new AdapterVersionDatasetConfigMarshaller();
