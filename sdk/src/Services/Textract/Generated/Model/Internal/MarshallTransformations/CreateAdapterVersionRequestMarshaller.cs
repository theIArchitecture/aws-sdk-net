...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateAdapterVersionRequestMarshaller : IMarshaller<IRequest, CreateAdapterVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateAdapterVersionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateAdapterVersionRequest publicRequest)
        {
        ...
        private static CreateAdapterVersionRequestMarshaller _instance = new CreateAdapterVersionRequestMarshaller();        

        internal static CreateAdapterVersionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAdapterVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
