...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateAdapterVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAdapterVersionResponse response = new CreateAdapterVersionResponse();
        ...
        private static CreateAdapterVersionResponseUnmarshaller _instance = new CreateAdapterVersionResponseUnmarshaller();        

        internal static CreateAdapterVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAdapterVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
