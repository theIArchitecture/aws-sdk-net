...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteAdapterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAdapterResponse response = new DeleteAdapterResponse();
        ...
        private static DeleteAdapterResponseUnmarshaller _instance = new DeleteAdapterResponseUnmarshaller();        

        internal static DeleteAdapterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAdapterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
