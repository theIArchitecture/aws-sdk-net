...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteAdapterVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAdapterVersionResponse response = new DeleteAdapterVersionResponse();
        ...
        private static DeleteAdapterVersionResponseUnmarshaller _instance = new DeleteAdapterVersionResponseUnmarshaller();        

        internal static DeleteAdapterVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAdapterVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
