...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExpenseCurrencyUnmarshaller : IJsonUnmarshaller<ExpenseCurrency, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ExpenseCurrency Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
