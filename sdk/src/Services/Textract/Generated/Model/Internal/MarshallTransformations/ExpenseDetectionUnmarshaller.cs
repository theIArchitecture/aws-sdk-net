...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExpenseDetectionUnmarshaller : IJsonUnmarshaller<ExpenseDetection, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ExpenseDetection Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
