...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExpenseGroupPropertyUnmarshaller : IJsonUnmarshaller<ExpenseGroupProperty, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ExpenseGroupProperty Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
