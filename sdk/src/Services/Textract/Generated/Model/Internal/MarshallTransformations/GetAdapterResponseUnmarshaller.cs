...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetAdapterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAdapterResponse response = new GetAdapterResponse();
        ...
        private static GetAdapterResponseUnmarshaller _instance = new GetAdapterResponseUnmarshaller();        

        internal static GetAdapterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAdapterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
