...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetExpenseAnalysisResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetExpenseAnalysisResponse response = new GetExpenseAnalysisResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AnalyzeExpenseModelVersion", targetDepth))
                {
                    ...
                    response.AnalyzeExpenseModelVersion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetExpenseAnalysisResponseUnmarshaller _instance = new GetExpenseAnalysisResponseUnmarshaller();        

        internal static GetExpenseAnalysisResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetExpenseAnalysisResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
