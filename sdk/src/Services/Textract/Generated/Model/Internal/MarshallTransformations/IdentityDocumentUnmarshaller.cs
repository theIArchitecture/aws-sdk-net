...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IdentityDocumentUnmarshaller : IJsonUnmarshaller<IdentityDocument, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IdentityDocument Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
