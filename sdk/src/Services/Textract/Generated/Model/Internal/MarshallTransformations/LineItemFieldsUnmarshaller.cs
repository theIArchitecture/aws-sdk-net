...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LineItemFieldsUnmarshaller : IJsonUnmarshaller<LineItemFields, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LineItemFields Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
