...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListAdapterVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAdapterVersionsResponse response = new ListAdapterVersionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AdapterVersionOverview, AdapterVersionOverviewUnmarshaller>(AdapterVersionOverviewUnmarshaller.Instance);
                    response.AdapterVersions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListAdapterVersionsResponseUnmarshaller _instance = new ListAdapterVersionsResponseUnmarshaller();        

        internal static ListAdapterVersionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAdapterVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
