...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListAdaptersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAdaptersResponse response = new ListAdaptersResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<AdapterOverview, AdapterOverviewUnmarshaller>(AdapterOverviewUnmarshaller.Instance);
                    response.Adapters = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListAdaptersResponseUnmarshaller _instance = new ListAdaptersResponseUnmarshaller();        

        internal static ListAdaptersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAdaptersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
