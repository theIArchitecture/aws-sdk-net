...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public class QueriesConfigMarshaller : IRequestMarshaller<QueriesConfig, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(QueriesConfig requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static QueriesConfigMarshaller Instance = new QueriesConfigMarshaller();
