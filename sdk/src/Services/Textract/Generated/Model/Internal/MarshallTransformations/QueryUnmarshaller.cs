...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class QueryUnmarshaller : IJsonUnmarshaller<Query, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Query Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            Query unmarshalledObject = new Query();
        ...
        private static QueryUnmarshaller _instance = new QueryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static QueryUnmarshaller Instance
        {
            get
            {
                return _instance;
