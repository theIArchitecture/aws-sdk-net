...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SplitDocumentUnmarshaller : IJsonUnmarshaller<SplitDocument, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SplitDocument Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            SplitDocument unmarshalledObject = new SplitDocument();
        ...
        private static SplitDocumentUnmarshaller _instance = new SplitDocumentUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SplitDocumentUnmarshaller Instance
        {
            get
            {
                return _instance;
