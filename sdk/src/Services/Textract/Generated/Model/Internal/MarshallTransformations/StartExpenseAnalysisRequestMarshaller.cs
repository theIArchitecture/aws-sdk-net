...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class StartExpenseAnalysisRequestMarshaller : IMarshaller<IRequest, StartExpenseAnalysisRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartExpenseAnalysisRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartExpenseAnalysisRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Textract");
            string target = "Textract.StartExpenseAnalysis";
        ...
        private static StartExpenseAnalysisRequestMarshaller _instance = new StartExpenseAnalysisRequestMarshaller();        

        internal static StartExpenseAnalysisRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartExpenseAnalysisRequestMarshaller Instance
        {
            get
            {
                return _instance;
