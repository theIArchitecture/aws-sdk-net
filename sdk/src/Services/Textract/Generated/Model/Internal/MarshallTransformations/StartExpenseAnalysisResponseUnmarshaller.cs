...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartExpenseAnalysisResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartExpenseAnalysisResponse response = new StartExpenseAnalysisResponse();
        ...
        private static StartExpenseAnalysisResponseUnmarshaller _instance = new StartExpenseAnalysisResponseUnmarshaller();        

        internal static StartExpenseAnalysisResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartExpenseAnalysisResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
