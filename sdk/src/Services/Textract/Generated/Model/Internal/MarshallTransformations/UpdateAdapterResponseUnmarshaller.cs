...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateAdapterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAdapterResponse response = new UpdateAdapterResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.AdapterName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static UpdateAdapterResponseUnmarshaller _instance = new UpdateAdapterResponseUnmarshaller();        

        internal static UpdateAdapterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAdapterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
