...
namespace Amazon.Textract.Model
{
    ...
    public partial class InvalidS3ObjectException : AmazonTextractException
    {
        ...
        public InvalidS3ObjectException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidS3ObjectException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
