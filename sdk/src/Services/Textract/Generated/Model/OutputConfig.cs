...
namespace Amazon.Textract.Model
{
    ...
    ///  
    /// <para>
    ///  <c>OutputConfig</c> is an optional parameter which lets you adjust where your output
    /// will be placed. By default, Amazon Textract will store the results internally and
    /// can only be accessed by the Get API operations. With <c>OutputConfig</c> enabled,
    /// you can set the name of the bucket the output will be sent to the file prefix of the
    /// results where you can download your results. Additionally, you can set the <c>KMSKeyID</c>
