...
namespace Amazon.Textract
{
    ...
    public partial interface IAmazonTextract : IAmazonService, IDisposable
    {
        ...
        Task<AnalyzeExpenseResponse> AnalyzeExpenseAsync(AnalyzeExpenseRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<AnalyzeIDResponse> AnalyzeIDAsync(AnalyzeIDRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<CreateAdapterResponse> CreateAdapterAsync(CreateAdapterRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<CreateAdapterVersionResponse> CreateAdapterVersionAsync(CreateAdapterVersionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteAdapterResponse> DeleteAdapterAsync(DeleteAdapterRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DeleteAdapterVersionResponse> DeleteAdapterVersionAsync(DeleteAdapterVersionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetAdapterResponse> GetAdapterAsync(GetAdapterRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetAdapterVersionResponse> GetAdapterVersionAsync(GetAdapterVersionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetExpenseAnalysisResponse> GetExpenseAnalysisAsync(GetExpenseAnalysisRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetLendingAnalysisResponse> GetLendingAnalysisAsync(GetLendingAnalysisRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetLendingAnalysisSummaryResponse> GetLendingAnalysisSummaryAsync(GetLendingAnalysisSummaryRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListAdaptersResponse> ListAdaptersAsync(ListAdaptersRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListAdapterVersionsResponse> ListAdapterVersionsAsync(ListAdapterVersionsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StartExpenseAnalysisResponse> StartExpenseAnalysisAsync(StartExpenseAnalysisRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StartLendingAnalysisResponse> StartLendingAnalysisAsync(StartLendingAnalysisRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<UpdateAdapterResponse> UpdateAdapterAsync(UpdateAdapterRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonTextractConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonTextractConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonTextractConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonTextractConfig to create AmazonTextractClient");
            }

            return awsCredentials == null ? 
                    new AmazonTextractClient(serviceClientConfig) :
                    new AmazonTextractClient(awsCredentials, serviceClientConfig);
        }
