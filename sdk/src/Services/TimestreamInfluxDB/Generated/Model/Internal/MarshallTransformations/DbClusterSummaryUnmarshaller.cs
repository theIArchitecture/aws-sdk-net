...
{
    /// <summary>
    /// Response Unmarshaller for DbClusterSummary Object
    /// </summary>  
    public class DbClusterSummaryUnmarshaller : IJsonUnmarshaller<DbClusterSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DbClusterSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            DbClusterSummary unmarshalledObject = new DbClusterSummary();
        ...
        private static DbClusterSummaryUnmarshaller _instance = new DbClusterSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DbClusterSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
