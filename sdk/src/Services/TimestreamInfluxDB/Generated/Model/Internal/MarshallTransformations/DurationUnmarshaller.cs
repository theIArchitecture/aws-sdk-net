...
namespace Amazon.TimestreamInfluxDB.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DurationUnmarshaller : IJsonUnmarshaller<Duration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Duration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("durationType", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DurationType = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
