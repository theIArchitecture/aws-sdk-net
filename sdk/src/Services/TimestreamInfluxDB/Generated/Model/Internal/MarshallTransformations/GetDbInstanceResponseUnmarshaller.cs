...
{
    /// <summary>
    /// Response Unmarshaller for GetDbInstance operation
    /// </summary>  
    public class GetDbInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDbInstanceResponse response = new GetDbInstanceResponse();
        ...
        private static GetDbInstanceResponseUnmarshaller _instance = new GetDbInstanceResponseUnmarshaller();        

        internal static GetDbInstanceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDbInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
