...
{
    /// <summary>
    /// Response Unmarshaller for GetDbParameterGroup operation
    /// </summary>  
    public class GetDbParameterGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDbParameterGroupResponse response = new GetDbParameterGroupResponse();
        ...
        private static GetDbParameterGroupResponseUnmarshaller _instance = new GetDbParameterGroupResponseUnmarshaller();        

        internal static GetDbParameterGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDbParameterGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
