...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDbInstance operation
    /// </summary>  
    public class UpdateDbInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDbInstanceResponse response = new UpdateDbInstanceResponse();
        ...
        private static UpdateDbInstanceResponseUnmarshaller _instance = new UpdateDbInstanceResponseUnmarshaller();        

        internal static UpdateDbInstanceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDbInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
