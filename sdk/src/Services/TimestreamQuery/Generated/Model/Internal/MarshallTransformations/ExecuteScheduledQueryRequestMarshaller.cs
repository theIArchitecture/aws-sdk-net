...
{
    /// <summary>
    /// ExecuteScheduledQuery Request Marshaller
    /// </summary>       
    public class ExecuteScheduledQueryRequestMarshaller : IMarshaller<IRequest, ExecuteScheduledQueryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ExecuteScheduledQueryRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ExecuteScheduledQueryRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.TimestreamQuery");
            string target = "Timestream_20181101.ExecuteScheduledQuery";
        ...
        private static ExecuteScheduledQueryRequestMarshaller _instance = new ExecuteScheduledQueryRequestMarshaller();        

        internal static ExecuteScheduledQueryRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExecuteScheduledQueryRequestMarshaller Instance
        {
            get
            {
                return _instance;
