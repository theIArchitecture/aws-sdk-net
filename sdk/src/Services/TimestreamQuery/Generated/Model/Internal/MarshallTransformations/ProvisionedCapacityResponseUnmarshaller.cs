...
{
    /// <summary>
    /// Response Unmarshaller for ProvisionedCapacityResponse Object
    /// </summary>  
    public class ProvisionedCapacityResponseUnmarshaller : IJsonUnmarshaller<ProvisionedCapacityResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ProvisionedCapacityResponse Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ProvisionedCapacityResponse unmarshalledObject = new ProvisionedCapacityResponse();
        ...
        private static ProvisionedCapacityResponseUnmarshaller _instance = new ProvisionedCapacityResponseUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ProvisionedCapacityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
