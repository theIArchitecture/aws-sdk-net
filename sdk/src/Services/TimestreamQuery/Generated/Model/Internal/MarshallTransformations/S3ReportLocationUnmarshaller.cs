...
namespace Amazon.TimestreamQuery.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class S3ReportLocationUnmarshaller : IJsonUnmarshaller<S3ReportLocation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public S3ReportLocation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
