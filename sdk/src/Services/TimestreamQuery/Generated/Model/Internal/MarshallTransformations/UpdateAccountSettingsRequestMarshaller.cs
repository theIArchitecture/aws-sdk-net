...
namespace Amazon.TimestreamQuery.Model.Internal.MarshallTransformations
{
    ...
    public class UpdateAccountSettingsRequestMarshaller : IMarshaller<IRequest, UpdateAccountSettingsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(UpdateAccountSettingsRequest publicRequest)
        {
            ...
            string target = "Timestream_20181101.UpdateAccountSettings";
            ...
            if(publicRequest.IsSetMaxQueryTCU())
            {
                ...
                context.Writer.WriteNumberValue(publicRequest.MaxQueryTCU.Value);
            }
            ...
            if(publicRequest.IsSetQueryPricingModel())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.QueryPricingModel);
            }
