...
namespace Amazon.TimestreamWrite.Model.Internal.MarshallTransformations
{
    ...
    public class BatchLoadProgressReportUnmarshaller : IJsonUnmarshaller<BatchLoadProgressReport, JsonUnmarshallerContext>
    {
        ...
        private static BatchLoadProgressReportUnmarshaller _instance = new BatchLoadProgressReportUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BatchLoadProgressReportUnmarshaller Instance
        {
            get
            {
                return _instance;
