...
namespace Amazon.TimestreamWrite.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DataModelUnmarshaller : IJsonUnmarshaller<DataModel, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DataModel Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
