    ...
    public class DataSourceConfigurationMarshaller : IRequestMarshaller<DataSourceConfiguration, JsonMarshallerContext> 
    {
        ...
        public void Marshall(DataSourceConfiguration requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetCsvConfiguration())
            {
                context.Writer.WritePropertyName("CsvConfiguration");
                context.Writer.WriteStartObject();

                var marshaller = CsvConfigurationMarshaller.Instance;
                marshaller.Marshall(requestObject.CsvConfiguration, context);
            ...
            if(requestObject.IsSetDataSourceS3Configuration())
            {
                context.Writer.WritePropertyName("DataSourceS3Configuration");
                context.Writer.WriteStartObject();

                var marshaller = DataSourceS3ConfigurationMarshaller.Instance;
                marshaller.Marshall(requestObject.DataSourceS3Configuration, context);
