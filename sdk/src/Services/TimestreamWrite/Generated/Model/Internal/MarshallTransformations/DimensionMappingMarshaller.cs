...
namespace Amazon.TimestreamWrite.Model.Internal.MarshallTransformations
{
    ...
    public class DimensionMappingMarshaller : IRequestMarshaller<DimensionMapping, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(DimensionMapping requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetDestinationColumn())
            {
                context.Writer.WritePropertyName("DestinationColumn");
                context.Writer.WriteStringValue(requestObject.DestinationColumn);
            }
