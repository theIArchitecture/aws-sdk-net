...
namespace Amazon.TimestreamWrite.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PartitionKeyUnmarshaller : IJsonUnmarshaller<PartitionKey, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PartitionKey Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("EnforcementInRecord", targetDepth))
                {
                    ...
                    unmarshalledObject.EnforcementInRecord = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
