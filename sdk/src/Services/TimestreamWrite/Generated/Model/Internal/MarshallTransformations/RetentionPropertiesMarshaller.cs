    ...
    public class RetentionPropertiesMarshaller : IRequestMarshaller<RetentionProperties, JsonMarshallerContext> 
    {
        ...
        public void Marshall(RetentionProperties requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetMagneticStoreRetentionPeriodInDays())
            {
                ...
                context.Writer.WriteNumberValue(requestObject.MagneticStoreRetentionPeriodInDays.Value);
            }
            ...
            if(requestObject.IsSetMemoryStoreRetentionPeriodInHours())
            {
                ...
                context.Writer.WriteNumberValue(requestObject.MemoryStoreRetentionPeriodInHours.Value);
            }
