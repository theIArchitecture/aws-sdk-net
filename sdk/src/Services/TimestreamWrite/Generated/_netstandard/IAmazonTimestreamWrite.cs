...
namespace Amazon.TimestreamWrite
{
    ...
    public partial interface IAmazonTimestreamWrite : IAmazonService, IDisposable
    {
        ...
        Task<CreateBatchLoadTaskResponse> CreateBatchLoadTaskAsync(CreateBatchLoadTaskRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<DescribeBatchLoadTaskResponse> DescribeBatchLoadTaskAsync(DescribeBatchLoadTaskRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListBatchLoadTasksResponse> ListBatchLoadTasksAsync(ListBatchLoadTasksRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ResumeBatchLoadTaskResponse> ResumeBatchLoadTaskAsync(ResumeBatchLoadTaskRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonTimestreamWriteConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonTimestreamWriteConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonTimestreamWriteConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonTimestreamWriteConfig to create AmazonTimestreamWriteClient");
            }

            return awsCredentials == null ? 
                    new AmazonTimestreamWriteClient(serviceClientConfig) :
                    new AmazonTimestreamWriteClient(awsCredentials, serviceClientConfig);
        }
