...
namespace Amazon.Tnb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetSolNetworkPackageContentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSolNetworkPackageContentResponse response = new GetSolNetworkPackageContentResponse();
            var ms = new MemoryStream();
            Amazon.Util.AWSSDKUtils.CopyStream(context.Stream, ms);
            ms.Seek(0, SeekOrigin.Begin);
            if (ms.Length > 0)
                response.NsdContent = ms;
        ...
        private static GetSolNetworkPackageContentResponseUnmarshaller _instance = new GetSolNetworkPackageContentResponseUnmarshaller();        

        internal static GetSolNetworkPackageContentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSolNetworkPackageContentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
