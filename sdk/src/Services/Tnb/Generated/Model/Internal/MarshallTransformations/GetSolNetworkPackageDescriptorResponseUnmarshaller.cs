...
namespace Amazon.Tnb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetSolNetworkPackageDescriptorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSolNetworkPackageDescriptorResponse response = new GetSolNetworkPackageDescriptorResponse();
        ...
        private static GetSolNetworkPackageDescriptorResponseUnmarshaller _instance = new GetSolNetworkPackageDescriptorResponseUnmarshaller();        

        internal static GetSolNetworkPackageDescriptorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSolNetworkPackageDescriptorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
