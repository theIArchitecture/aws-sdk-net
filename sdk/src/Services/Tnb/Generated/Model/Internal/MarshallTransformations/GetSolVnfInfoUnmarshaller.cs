...
namespace Amazon.Tnb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetSolVnfInfoUnmarshaller : IJsonUnmarshaller<GetSolVnfInfo, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public GetSolVnfInfo Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            GetSolVnfInfo unmarshalledObject = new GetSolVnfInfo();
        ...
        private static GetSolVnfInfoUnmarshaller _instance = new GetSolVnfInfoUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static GetSolVnfInfoUnmarshaller Instance
        {
            get
            {
                return _instance;
