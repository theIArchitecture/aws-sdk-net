...
namespace Amazon.Tnb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListSolFunctionInstancesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSolFunctionInstancesResponse response = new ListSolFunctionInstancesResponse();
        ...
        private static ListSolFunctionInstancesResponseUnmarshaller _instance = new ListSolFunctionInstancesResponseUnmarshaller();        

        internal static ListSolFunctionInstancesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSolFunctionInstancesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
