...
namespace Amazon.Tnb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NetworkArtifactMetaUnmarshaller : IJsonUnmarshaller<NetworkArtifactMeta, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public NetworkArtifactMeta Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static NetworkArtifactMetaUnmarshaller _instance = new NetworkArtifactMetaUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static NetworkArtifactMetaUnmarshaller Instance
        {
            get
            {
                return _instance;
