...
namespace Amazon.Tnb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ToscaOverrideUnmarshaller : IJsonUnmarshaller<ToscaOverride, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ToscaOverride Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
