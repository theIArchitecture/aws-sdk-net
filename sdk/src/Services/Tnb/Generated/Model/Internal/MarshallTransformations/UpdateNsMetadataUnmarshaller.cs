...
namespace Amazon.Tnb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateNsMetadataUnmarshaller : IJsonUnmarshaller<UpdateNsMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public UpdateNsMetadata Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
