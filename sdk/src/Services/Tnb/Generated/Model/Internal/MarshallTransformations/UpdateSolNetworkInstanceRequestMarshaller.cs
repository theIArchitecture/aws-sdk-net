...
namespace Amazon.Tnb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateSolNetworkInstanceRequestMarshaller : IMarshaller<IRequest, UpdateSolNetworkInstanceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateSolNetworkInstanceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateSolNetworkInstanceRequest publicRequest)
        {
        ...
        private static UpdateSolNetworkInstanceRequestMarshaller _instance = new UpdateSolNetworkInstanceRequestMarshaller();        

        internal static UpdateSolNetworkInstanceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSolNetworkInstanceRequestMarshaller Instance
        {
            get
            {
                return _instance;
