...
namespace Amazon.Tnb.Model.Internal.MarshallTransformations
{
    ...
    public class ValidateSolFunctionPackageContentMetadataUnmarshaller : IJsonUnmarshaller<ValidateSolFunctionPackageContentMetadata, JsonUnmarshallerContext>
    {
        ...
        private static ValidateSolFunctionPackageContentMetadataUnmarshaller _instance = new ValidateSolFunctionPackageContentMetadataUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ValidateSolFunctionPackageContentMetadataUnmarshaller Instance
        {
            get
            {
                return _instance;
