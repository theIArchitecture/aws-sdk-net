...
{
    /// <summary>
    /// Amazon TranscribeService endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for TranscribeService service requests.
    /// Collects values for TranscribeServiceEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses TranscribeServiceEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonTranscribeServiceEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonTranscribeServiceConfig)requestContext.ClientConfig;
            var result = new TranscribeServiceEndpointParameters();
