...
{
    /// <summary>
    /// Response Unmarshaller for DeleteCallAnalyticsCategory operation
    /// </summary>  
    public class DeleteCallAnalyticsCategoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteCallAnalyticsCategoryResponse response = new DeleteCallAnalyticsCategoryResponse();
        ...
        private static DeleteCallAnalyticsCategoryResponseUnmarshaller _instance = new DeleteCallAnalyticsCategoryResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCallAnalyticsCategoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
