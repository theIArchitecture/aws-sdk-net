...
{
    /// <summary>
    /// Response Unmarshaller for DeleteCallAnalyticsJob operation
    /// </summary>  
    public class DeleteCallAnalyticsJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteCallAnalyticsJobResponse response = new DeleteCallAnalyticsJobResponse();
        ...
        private static DeleteCallAnalyticsJobResponseUnmarshaller _instance = new DeleteCallAnalyticsJobResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCallAnalyticsJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
