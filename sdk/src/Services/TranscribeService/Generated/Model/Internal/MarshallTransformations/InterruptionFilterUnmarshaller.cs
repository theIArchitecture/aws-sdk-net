...
{
    /// <summary>
    /// Response Unmarshaller for InterruptionFilter Object
    /// </summary>  
    public class InterruptionFilterUnmarshaller : IJsonUnmarshaller<InterruptionFilter, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InterruptionFilter Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static InterruptionFilterUnmarshaller _instance = new InterruptionFilterUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static InterruptionFilterUnmarshaller Instance
        {
            get
            {
                return _instance;
