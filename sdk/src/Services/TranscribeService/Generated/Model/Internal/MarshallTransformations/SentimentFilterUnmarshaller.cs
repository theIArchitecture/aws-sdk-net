...
{
    /// <summary>
    /// Response Unmarshaller for SentimentFilter Object
    /// </summary>  
    public class SentimentFilterUnmarshaller : IJsonUnmarshaller<SentimentFilter, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SentimentFilter Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            SentimentFilter unmarshalledObject = new SentimentFilter();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Sentiments", targetDepth))
                {
                    ...
                    unmarshalledObject.Sentiments = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static SentimentFilterUnmarshaller _instance = new SentimentFilterUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SentimentFilterUnmarshaller Instance
        {
            get
            {
                return _instance;
