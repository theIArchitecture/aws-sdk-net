...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonTranscribeServiceConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonTranscribeServiceConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonTranscribeServiceConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonTranscribeServiceConfig to create AmazonTranscribeServiceClient");
            }

            return awsCredentials == null ? 
                    new AmazonTranscribeServiceClient(serviceClientConfig) :
                    new AmazonTranscribeServiceClient(awsCredentials, serviceClientConfig);
        }
