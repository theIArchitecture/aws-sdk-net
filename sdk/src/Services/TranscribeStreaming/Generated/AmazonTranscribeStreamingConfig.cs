...
namespace Amazon.TranscribeStreaming
{
    ...
    public partial class AmazonTranscribeStreamingConfig : ClientConfig
    {
        ...
        public static new string ServiceId
        {
            get
            {
                return "Transcribe Streaming";
            }
        }
        /// <summary>
        /// Default constructor
        /// </summary>
        public AmazonTranscribeStreamingConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonTranscribeStreamingDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "Transcribe Streaming";
            this.AuthenticationServiceName = "transcribe";
            this.EndpointProvider = new AmazonTranscribeStreamingEndpointProvider();
        }
