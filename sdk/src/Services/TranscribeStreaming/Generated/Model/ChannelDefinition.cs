...
namespace Amazon.TranscribeStreaming.Model
{
    ...
    /// if your agent is the first participant to speak, you would set <c>ChannelId</c> to
    /// <c>0</c> (to indicate the first channel) and <c>ParticipantRole</c> to <c>AGENT</c>
