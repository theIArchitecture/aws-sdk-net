...
namespace Amazon.TranscribeStreaming.Model
{
    ...
    public partial class ClinicalNoteGenerationSettings
    {
        ...
        /// <para>
        /// The name of the Amazon S3 bucket where you want the output of Amazon Web Services
        /// HealthScribe post-stream analytics stored. Don't include the <c>S3://</c> prefix of
        /// the specified bucket. 
        /// </para>
        ///  
        /// <para>
        /// HealthScribe outputs transcript and clinical note files under the prefix: <c>S3://$output-bucket-name/healthscribe-streaming/session-id/post-stream-analytics/clinical-notes</c>
        /// 
        /// </para>
        ///  
        /// <para>
        /// The role <c>ResourceAccessRoleArn</c> specified in the <c>MedicalScribeConfigurationEvent</c>
