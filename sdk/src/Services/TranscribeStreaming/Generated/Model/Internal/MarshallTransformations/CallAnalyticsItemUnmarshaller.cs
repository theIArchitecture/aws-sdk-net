...
{
    /// <summary>
    /// Response Unmarshaller for CallAnalyticsItem Object
    /// </summary>  
    public class CallAnalyticsItemUnmarshaller : IJsonUnmarshaller<CallAnalyticsItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CallAnalyticsItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            CallAnalyticsItem unmarshalledObject = new CallAnalyticsItem();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("Stable", targetDepth))
                {
                    var unmarshaller = NullableBoolUnmarshaller.Instance;
                    unmarshalledObject.Stable = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CallAnalyticsItemUnmarshaller _instance = new CallAnalyticsItemUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CallAnalyticsItemUnmarshaller Instance
        {
            get
            {
                return _instance;
