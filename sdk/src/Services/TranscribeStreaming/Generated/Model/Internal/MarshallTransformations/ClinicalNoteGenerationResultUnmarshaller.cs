...
namespace Amazon.TranscribeStreaming.Model.Internal.MarshallTransformations
{
    ...
    public class ClinicalNoteGenerationResultUnmarshaller : IJsonUnmarshaller<ClinicalNoteGenerationResult, JsonUnmarshallerContext>
    {
        ...
        public ClinicalNoteGenerationResult Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("ClinicalNoteOutputLocation", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ClinicalNoteOutputLocation = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("TranscriptOutputLocation", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TranscriptOutputLocation = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
