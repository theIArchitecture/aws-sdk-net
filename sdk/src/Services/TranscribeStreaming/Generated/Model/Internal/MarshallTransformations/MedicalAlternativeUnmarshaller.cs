...
{
    /// <summary>
    /// Response Unmarshaller for MedicalAlternative Object
    /// </summary>  
    public class MedicalAlternativeUnmarshaller : IJsonUnmarshaller<MedicalAlternative, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MedicalAlternative Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            MedicalAlternative unmarshalledObject = new MedicalAlternative();
        ...
        private static MedicalAlternativeUnmarshaller _instance = new MedicalAlternativeUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static MedicalAlternativeUnmarshaller Instance
        {
            get
            {
                return _instance;
