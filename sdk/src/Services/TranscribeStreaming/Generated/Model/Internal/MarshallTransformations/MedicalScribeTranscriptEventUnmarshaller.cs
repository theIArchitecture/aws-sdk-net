...
namespace Amazon.TranscribeStreaming.Model.Internal.MarshallTransformations
{
    ...
    public class MedicalScribeTranscriptEventUnmarshaller : IJsonUnmarshaller<MedicalScribeTranscriptEvent, JsonUnmarshallerContext>
    {
        ...
        private static MedicalScribeTranscriptEventUnmarshaller _instance = new MedicalScribeTranscriptEventUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static MedicalScribeTranscriptEventUnmarshaller Instance
        {
            get
            {
                return _instance;
