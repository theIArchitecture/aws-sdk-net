...
namespace Amazon.TranscribeStreaming.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class StartMedicalScribeStreamRequestMarshaller : IMarshaller<IRequest, StartMedicalScribeStreamRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        internal static StartMedicalScribeStreamRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartMedicalScribeStreamRequestMarshaller Instance
        {
            get
            {
                return _instance;
