...
{
    /// <summary>
    /// Response Unmarshaller for StartMedicalStreamTranscription operation
    /// </summary>  
    public class StartMedicalStreamTranscriptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartMedicalStreamTranscriptionResponse response = new StartMedicalStreamTranscriptionResponse();
            response.TranscriptResultStream = new MedicalTranscriptResultStream(context.Stream);
            ...
            if (context.ResponseData.IsHeaderPresent("x-amzn-transcribe-specialty"))
                response.Specialty = context.ResponseData.GetHeaderValue("x-amzn-transcribe-specialty");
            if (context.ResponseData.IsHeaderPresent("x-amzn-transcribe-type"))
                response.Type = context.ResponseData.GetHeaderValue("x-amzn-transcribe-type");
        ...
        private static StartMedicalStreamTranscriptionResponseUnmarshaller _instance = new StartMedicalStreamTranscriptionResponseUnmarshaller();        

        internal static StartMedicalStreamTranscriptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartMedicalStreamTranscriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
