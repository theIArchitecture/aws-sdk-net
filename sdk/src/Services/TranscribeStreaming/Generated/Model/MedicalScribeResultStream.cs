...
namespace Amazon.TranscribeStreaming.Model
{
    ...
    /// the <c>MedicalScribeTranscriptEvent</c> object.
    /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Naming", "CA1710:Identifiers should have correct suffix", Justification = "MedicalScribeResultStreamCollection is not descriptive")]
    ...
    public sealed class MedicalScribeResultStream : EnumerableEventOutputStream<IEventStreamEvent, TranscribeStreamingEventStreamException>
    {
        /// <summary>
        ...
        public MedicalScribeResultStream(Stream stream) : this (stream, null)
        {
        }
        ...
        public MedicalScribeResultStream(Stream stream, IEventStreamDecoder eventStreamDecoder) : base(stream, eventStreamDecoder)
        {
