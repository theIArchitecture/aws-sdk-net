...
namespace Amazon.TranscribeStreaming.Model
{
    ...
    /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Naming", "CA1710:Identifiers should have correct suffix", Justification = "MedicalTranscriptResultStreamCollection is not descriptive")]
    ...
    public sealed class MedicalTranscriptResultStream : EnumerableEventOutputStream<IEventStreamEvent, TranscribeStreamingEventStreamException>
    {
        /// <summary>
        ...
        ///</summary>
        public event EventHandler<EventStreamEventReceivedArgs<MedicalTranscriptEvent>> TranscriptEventReceived;

        /// <summary>
        /// Construct an instance
        /// </summary>
        /// <param name="stream"></param>        
        public MedicalTranscriptResultStream(Stream stream) : this (stream, null)
        {
        }
        ...
        public MedicalTranscriptResultStream(Stream stream, IEventStreamDecoder eventStreamDecoder) : base(stream, eventStreamDecoder)
        {
