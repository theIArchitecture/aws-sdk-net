...
namespace Amazon.TranscribeStreaming.Model
{
    ...
    /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Naming", "CA1710:Identifiers should have correct suffix", Justification = "TranscriptResultStreamCollection is not descriptive")]
    ...
    public sealed class TranscriptResultStream : EnumerableEventOutputStream<IEventStreamEvent, TranscribeStreamingEventStreamException>
    {
        /// <summary>
        ...
        public TranscriptResultStream(Stream stream) : this (stream, null)
        {
        }
        ...
        public TranscriptResultStream(Stream stream, IEventStreamDecoder eventStreamDecoder) : base(stream, eventStreamDecoder)
        {
