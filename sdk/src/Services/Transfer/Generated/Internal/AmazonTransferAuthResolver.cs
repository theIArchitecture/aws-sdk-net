...
namespace Amazon.Transfer.Internal
{
    ...
    public class AmazonTransferAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonTransferAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Transfer.
        /// </summary>
        public AmazonTransferAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonTransferAuthSchemeParameters
            {
    ...
    public class AmazonTransferAuthSchemeResolver : IAuthSchemeResolver<AmazonTransferAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonTransferAuthSchemeParameters authParameters)
        {
