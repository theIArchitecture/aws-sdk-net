...
{
    /// <summary>
    /// A structure that contains the details for files transferred using an SFTP connector,
    /// during a single transfer.
    /// </summary>
    public partial class ConnectorFileTransferResult
    {
        private string _failureCode;
        private string _failureMessage;
        private string _filePath;
        private TransferTableStatus _statusCode;

        /// <summary>
        /// Gets and sets the property FailureCode. 
        /// <para>
        /// For transfers that fail, this parameter contains a code indicating the reason. For
        /// example, <c>RETRIEVE_FILE_NOT_FOUND</c> 
        /// </para>
        /// </summary>
        ...
        public TransferTableStatus StatusCode
        {
