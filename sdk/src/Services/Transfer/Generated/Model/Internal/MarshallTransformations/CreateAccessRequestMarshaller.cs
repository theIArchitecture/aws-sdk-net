...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateAccessRequestMarshaller : IMarshaller<IRequest, CreateAccessRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateAccessRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateAccessRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Transfer");
            string target = "TransferService.CreateAccess";
        ...
        private static CreateAccessRequestMarshaller _instance = new CreateAccessRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAccessRequestMarshaller Instance
        {
            get
            {
                return _instance;
