...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    public class CreateProfileRequestMarshaller : IMarshaller<IRequest, CreateProfileRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateProfileRequest publicRequest)
        {
            ...
            string target = "TransferService.CreateProfile";
            ...
            if(publicRequest.IsSetAs2Id())
            {
                context.Writer.WritePropertyName("As2Id");
                context.Writer.WriteStringValue(publicRequest.As2Id);
            }
            ...
            if(publicRequest.IsSetCertificateIds())
            {
                ...
                {
                        context.Writer.WriteStringValue(publicRequestCertificateIdsListValue);
                }
