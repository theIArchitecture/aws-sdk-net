...
{
    /// <summary>
    /// Response Unmarshaller for CreateWebApp operation
    /// </summary>  
    public class CreateWebAppResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateWebAppResponse response = new CreateWebAppResponse();
        ...
        private static CreateWebAppResponseUnmarshaller _instance = new CreateWebAppResponseUnmarshaller();        

        internal static CreateWebAppResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWebAppResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
