...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteAccessRequestMarshaller : IMarshaller<IRequest, DeleteAccessRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteAccessRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteAccessRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Transfer");
            string target = "TransferService.DeleteAccess";
        ...
        private static DeleteAccessRequestMarshaller _instance = new DeleteAccessRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAccessRequestMarshaller Instance
        {
            get
            {
                return _instance;
