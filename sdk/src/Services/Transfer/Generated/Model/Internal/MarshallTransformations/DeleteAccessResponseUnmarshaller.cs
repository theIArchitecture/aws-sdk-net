...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteAccessResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAccessResponse response = new DeleteAccessResponse();
        ...
        private static DeleteAccessResponseUnmarshaller _instance = new DeleteAccessResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAccessResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
