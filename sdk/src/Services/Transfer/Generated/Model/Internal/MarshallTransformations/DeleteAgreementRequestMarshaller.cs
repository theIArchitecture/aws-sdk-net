...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteAgreementRequestMarshaller : IMarshaller<IRequest, DeleteAgreementRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteAgreementRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteAgreementRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Transfer");
            string target = "TransferService.DeleteAgreement";
        ...
        private static DeleteAgreementRequestMarshaller _instance = new DeleteAgreementRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAgreementRequestMarshaller Instance
        {
            get
            {
                return _instance;
