...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteAgreementResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAgreementResponse response = new DeleteAgreementResponse();
        ...
        private static DeleteAgreementResponseUnmarshaller _instance = new DeleteAgreementResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAgreementResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
