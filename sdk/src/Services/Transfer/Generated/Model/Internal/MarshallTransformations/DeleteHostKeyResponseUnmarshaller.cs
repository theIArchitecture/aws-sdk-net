...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteHostKeyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteHostKeyResponse response = new DeleteHostKeyResponse();
        ...
        private static DeleteHostKeyResponseUnmarshaller _instance = new DeleteHostKeyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteHostKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
