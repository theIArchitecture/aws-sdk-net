...
{
    /// <summary>
    /// Response Unmarshaller for DeleteWebApp operation
    /// </summary>  
    public class DeleteWebAppResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteWebAppResponse response = new DeleteWebAppResponse();
        ...
        private static DeleteWebAppResponseUnmarshaller _instance = new DeleteWebAppResponseUnmarshaller();        

        internal static DeleteWebAppResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteWebAppResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
