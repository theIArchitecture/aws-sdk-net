...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeAccessResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAccessResponse response = new DescribeAccessResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = DescribedAccessUnmarshaller.Instance;
                    response.Access = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeAccessResponseUnmarshaller _instance = new DescribeAccessResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAccessResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
