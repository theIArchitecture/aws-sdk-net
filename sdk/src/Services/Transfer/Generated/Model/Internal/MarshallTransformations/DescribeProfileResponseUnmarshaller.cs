...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeProfileResponse response = new DescribeProfileResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = DescribedProfileUnmarshaller.Instance;
        ...
        private static DescribeProfileResponseUnmarshaller _instance = new DescribeProfileResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
