...
{
    /// <summary>
    /// Response Unmarshaller for DescribeWebApp operation
    /// </summary>  
    public class DescribeWebAppResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeWebAppResponse response = new DescribeWebAppResponse();
        ...
        private static DescribeWebAppResponseUnmarshaller _instance = new DescribeWebAppResponseUnmarshaller();        

        internal static DescribeWebAppResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeWebAppResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
