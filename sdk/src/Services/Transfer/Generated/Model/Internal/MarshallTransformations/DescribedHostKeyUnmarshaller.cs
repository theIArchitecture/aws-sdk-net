...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribedHostKeyUnmarshaller : IJsonUnmarshaller<DescribedHostKey, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DescribedHostKey Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            DescribedHostKey unmarshalledObject = new DescribedHostKey();
        ...
        private static DescribedHostKeyUnmarshaller _instance = new DescribedHostKeyUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DescribedHostKeyUnmarshaller Instance
        {
            get
            {
                return _instance;
