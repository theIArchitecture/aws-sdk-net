...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IdentityProviderDetailsUnmarshaller : IJsonUnmarshaller<IdentityProviderDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IdentityProviderDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.InvocationRole = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("SftpAuthenticationMethods", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.SftpAuthenticationMethods = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
