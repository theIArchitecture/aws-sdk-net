...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListAgreementsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAgreementsResponse response = new ListAgreementsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ListedAgreement, ListedAgreementUnmarshaller>(ListedAgreementUnmarshaller.Instance);
        ...
        private static ListAgreementsResponseUnmarshaller _instance = new ListAgreementsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAgreementsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
