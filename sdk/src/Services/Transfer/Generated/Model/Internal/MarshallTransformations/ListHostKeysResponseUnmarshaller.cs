...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListHostKeysResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListHostKeysResponse response = new ListHostKeysResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ListedHostKey, ListedHostKeyUnmarshaller>(ListedHostKeyUnmarshaller.Instance);
                    response.HostKeys = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListHostKeysResponseUnmarshaller _instance = new ListHostKeysResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListHostKeysResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
