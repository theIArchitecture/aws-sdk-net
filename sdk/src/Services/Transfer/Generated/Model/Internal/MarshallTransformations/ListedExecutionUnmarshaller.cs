...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListedExecutionUnmarshaller : IJsonUnmarshaller<ListedExecution, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ListedExecution Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static ListedExecutionUnmarshaller _instance = new ListedExecutionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ListedExecutionUnmarshaller Instance
        {
            get
            {
                return _instance;
