...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListedUserUnmarshaller : IJsonUnmarshaller<ListedUser, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ListedUser Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("SshPublicKeyCount", targetDepth))
                {
                    ...
                    unmarshalledObject.SshPublicKeyCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
