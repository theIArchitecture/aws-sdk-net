...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SendWorkflowStepStateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SendWorkflowStepStateResponse response = new SendWorkflowStepStateResponse();
        ...
        private static SendWorkflowStepStateResponseUnmarshaller _instance = new SendWorkflowStepStateResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendWorkflowStepStateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
