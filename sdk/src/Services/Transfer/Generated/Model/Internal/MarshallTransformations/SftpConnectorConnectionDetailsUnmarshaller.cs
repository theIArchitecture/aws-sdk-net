...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SftpConnectorConnectionDetailsUnmarshaller : IJsonUnmarshaller<SftpConnectorConnectionDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SftpConnectorConnectionDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("HostKey", targetDepth))
                {
                    ...
                    unmarshalledObject.HostKey = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
