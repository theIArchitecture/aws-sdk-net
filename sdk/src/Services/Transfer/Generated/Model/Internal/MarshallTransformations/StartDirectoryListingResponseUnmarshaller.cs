...
{
    /// <summary>
    /// Response Unmarshaller for StartDirectoryListing operation
    /// </summary>  
    public class StartDirectoryListingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartDirectoryListingResponse response = new StartDirectoryListingResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.OutputFileName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static StartDirectoryListingResponseUnmarshaller _instance = new StartDirectoryListingResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartDirectoryListingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
