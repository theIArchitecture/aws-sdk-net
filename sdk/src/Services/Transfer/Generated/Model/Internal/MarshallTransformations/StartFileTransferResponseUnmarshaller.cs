...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartFileTransferResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartFileTransferResponse response = new StartFileTransferResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("TransferId", targetDepth))
                {
                    ...
                    response.TransferId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static StartFileTransferResponseUnmarshaller _instance = new StartFileTransferResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartFileTransferResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
