...
{
    /// <summary>
    /// Response Unmarshaller for StartRemoteMove operation
    /// </summary>  
    public class StartRemoteMoveResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartRemoteMoveResponse response = new StartRemoteMoveResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("MoveId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.MoveId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static StartRemoteMoveResponseUnmarshaller _instance = new StartRemoteMoveResponseUnmarshaller();        

        internal static StartRemoteMoveResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartRemoteMoveResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
