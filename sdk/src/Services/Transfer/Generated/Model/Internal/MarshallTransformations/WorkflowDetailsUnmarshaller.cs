...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class WorkflowDetailsUnmarshaller : IJsonUnmarshaller<WorkflowDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public WorkflowDetails Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            WorkflowDetails unmarshalledObject = new WorkflowDetails();
        ...
        private static WorkflowDetailsUnmarshaller _instance = new WorkflowDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static WorkflowDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
