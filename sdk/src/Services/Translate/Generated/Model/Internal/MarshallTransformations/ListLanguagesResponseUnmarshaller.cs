...
{
    /// <summary>
    /// Response Unmarshaller for ListLanguages operation
    /// </summary>  
    public class ListLanguagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("UnsupportedDisplayLanguageCodeException"))
                {
                    return UnsupportedDisplayLanguageCodeExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
            }
        ...
        private static ListLanguagesResponseUnmarshaller _instance = new ListLanguagesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLanguagesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
