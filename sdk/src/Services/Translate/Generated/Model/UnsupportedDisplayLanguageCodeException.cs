...
namespace Amazon.Translate.Model
{
    ...
    public partial class UnsupportedDisplayLanguageCodeException : AmazonTranslateException
    {
        ...
        public UnsupportedDisplayLanguageCodeException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public UnsupportedDisplayLanguageCodeException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
