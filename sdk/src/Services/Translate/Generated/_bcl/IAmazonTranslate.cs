...
namespace Amazon.Translate
{
    ...
    public partial interface IAmazonTranslate : IAmazonService, IDisposable
    {
        ...
        TranslateDocumentResponse TranslateDocument(TranslateDocumentRequest request);
        ...
        /// </exception>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/translate-2017-07-01/TranslateDocument">REST API Reference for TranslateDocument Operation</seealso>
        Task<TranslateDocumentResponse> TranslateDocumentAsync(TranslateDocumentRequest request, CancellationToken cancellationToken = default(CancellationToken));
