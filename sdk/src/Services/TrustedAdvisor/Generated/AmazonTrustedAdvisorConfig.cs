...
namespace Amazon.TrustedAdvisor
{
    ...
    public partial class AmazonTrustedAdvisorConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("TrustedAdvisor", "4.0.1.5");
        ...
        /// Default constructor
        /// </summary>
        public AmazonTrustedAdvisorConfig()
            : base(new Amazon.Runtime.Internal.DefaultConfigurationProvider(AmazonTrustedAdvisorDefaultConfiguration.GetAllConfigurations()))
        {
            base.ServiceId = "TrustedAdvisor";
            this.AuthenticationServiceName = "trustedadvisor";
            this.EndpointProvider = new AmazonTrustedAdvisorEndpointProvider();
        }
