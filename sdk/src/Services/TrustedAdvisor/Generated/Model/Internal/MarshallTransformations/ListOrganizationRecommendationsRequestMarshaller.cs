...
{
    /// <summary>
    /// ListOrganizationRecommendations Request Marshaller
    /// </summary>       
    public class ListOrganizationRecommendationsRequestMarshaller : IMarshaller<IRequest, ListOrganizationRecommendationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListOrganizationRecommendationsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListOrganizationRecommendationsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/organization-recommendations";
            request.UseQueryString = true;

            return request;
        }
        private static ListOrganizationRecommendationsRequestMarshaller _instance = new ListOrganizationRecommendationsRequestMarshaller();        

        internal static ListOrganizationRecommendationsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListOrganizationRecommendationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
