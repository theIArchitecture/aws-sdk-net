...
{
    /// <summary>
    /// ListRecommendationResources Request Marshaller
    /// </summary>       
    public class ListRecommendationResourcesRequestMarshaller : IMarshaller<IRequest, ListRecommendationResourcesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListRecommendationResourcesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListRecommendationResourcesRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/recommendations/{recommendationIdentifier}/resources";
            request.UseQueryString = true;

            return request;
        }
        private static ListRecommendationResourcesRequestMarshaller _instance = new ListRecommendationResourcesRequestMarshaller();        

        internal static ListRecommendationResourcesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRecommendationResourcesRequestMarshaller Instance
        {
            get
            {
                return _instance;
