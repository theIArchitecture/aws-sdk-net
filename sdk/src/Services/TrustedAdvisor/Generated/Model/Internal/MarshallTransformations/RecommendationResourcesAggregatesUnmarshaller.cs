...
namespace Amazon.TrustedAdvisor.Model.Internal.MarshallTransformations
{
    ...
    public class RecommendationResourcesAggregatesUnmarshaller : IJsonUnmarshaller<RecommendationResourcesAggregates, JsonUnmarshallerContext>
    {
        ...
        private static RecommendationResourcesAggregatesUnmarshaller _instance = new RecommendationResourcesAggregatesUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RecommendationResourcesAggregatesUnmarshaller Instance
        {
            get
            {
                return _instance;
