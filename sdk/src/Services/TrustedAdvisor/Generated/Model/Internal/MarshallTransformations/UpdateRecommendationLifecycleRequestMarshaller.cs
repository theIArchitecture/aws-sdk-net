...
{
    /// <summary>
    /// UpdateRecommendationLifecycle Request Marshaller
    /// </summary>       
    public class UpdateRecommendationLifecycleRequestMarshaller : IMarshaller<IRequest, UpdateRecommendationLifecycleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateRecommendationLifecycleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateRecommendationLifecycleRequest publicRequest)
        {
        ...
        private static UpdateRecommendationLifecycleRequestMarshaller _instance = new UpdateRecommendationLifecycleRequestMarshaller();        

        internal static UpdateRecommendationLifecycleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRecommendationLifecycleRequestMarshaller Instance
        {
            get
            {
                return _instance;
