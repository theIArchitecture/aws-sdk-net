...
namespace Amazon.VPCLattice.Internal
{
    ...
    public class AmazonVPCLatticeAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonVPCLatticeAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for VPCLattice.
        /// </summary>
        public AmazonVPCLatticeAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonVPCLatticeAuthSchemeParameters
            {
    ...
    public class AmazonVPCLatticeAuthSchemeResolver : IAuthSchemeResolver<AmazonVPCLatticeAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonVPCLatticeAuthSchemeParameters authParameters)
        {
