...
{
    /// <summary>
    /// Response Unmarshaller for CreateResourceConfiguration operation
    /// </summary>  
    public class CreateResourceConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateResourceConfigurationResponse response = new CreateResourceConfigurationResponse();
        ...
        private static CreateResourceConfigurationResponseUnmarshaller _instance = new CreateResourceConfigurationResponseUnmarshaller();        

        internal static CreateResourceConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateResourceConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
