...
{
    /// <summary>
    /// Response Unmarshaller for CreateResourceGateway operation
    /// </summary>  
    public class CreateResourceGatewayResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateResourceGatewayResponse response = new CreateResourceGatewayResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ipv4AddressesPerEni", targetDepth))
                {
                    ...
                    response.Ipv4AddressesPerEni = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.VpcIdentifier = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateResourceGatewayResponseUnmarshaller _instance = new CreateResourceGatewayResponseUnmarshaller();        

        internal static CreateResourceGatewayResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateResourceGatewayResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
