...
{
    /// <summary>
    /// Response Unmarshaller for CreateServiceNetworkServiceAssociation operation
    /// </summary>  
    public class CreateServiceNetworkServiceAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateServiceNetworkServiceAssociationResponse response = new CreateServiceNetworkServiceAssociationResponse();
        ...
        private static CreateServiceNetworkServiceAssociationResponseUnmarshaller _instance = new CreateServiceNetworkServiceAssociationResponseUnmarshaller();        

        internal static CreateServiceNetworkServiceAssociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateServiceNetworkServiceAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
