...
{
    /// <summary>
    /// Response Unmarshaller for DeleteResourceEndpointAssociation operation
    /// </summary>  
    public class DeleteResourceEndpointAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteResourceEndpointAssociationResponse response = new DeleteResourceEndpointAssociationResponse();
        ...
        private static DeleteResourceEndpointAssociationResponseUnmarshaller _instance = new DeleteResourceEndpointAssociationResponseUnmarshaller();        

        internal static DeleteResourceEndpointAssociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteResourceEndpointAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
