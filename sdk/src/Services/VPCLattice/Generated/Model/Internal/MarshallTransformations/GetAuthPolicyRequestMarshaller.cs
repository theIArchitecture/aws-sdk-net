...
namespace Amazon.VPCLattice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetAuthPolicyRequestMarshaller : IMarshaller<IRequest, GetAuthPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetAuthPolicyRequestMarshaller _instance = new GetAuthPolicyRequestMarshaller();        

        internal static GetAuthPolicyRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAuthPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
