...
namespace Amazon.VPCLattice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetListenerRequestMarshaller : IMarshaller<IRequest, GetListenerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetListenerRequestMarshaller _instance = new GetListenerRequestMarshaller();        

        internal static GetListenerRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetListenerRequestMarshaller Instance
        {
            get
            {
                return _instance;
