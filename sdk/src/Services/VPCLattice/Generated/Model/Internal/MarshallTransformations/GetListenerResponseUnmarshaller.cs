...
{
    /// <summary>
    /// Response Unmarshaller for GetListener operation
    /// </summary>  
    public class GetListenerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetListenerResponse response = new GetListenerResponse();
        ...
        private static GetListenerResponseUnmarshaller _instance = new GetListenerResponseUnmarshaller();        

        internal static GetListenerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetListenerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
