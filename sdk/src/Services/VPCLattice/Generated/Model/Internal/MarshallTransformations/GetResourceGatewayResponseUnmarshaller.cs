...
{
    /// <summary>
    /// Response Unmarshaller for GetResourceGateway operation
    /// </summary>  
    public class GetResourceGatewayResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetResourceGatewayResponse response = new GetResourceGatewayResponse();
        ...
        private static GetResourceGatewayResponseUnmarshaller _instance = new GetResourceGatewayResponseUnmarshaller();        

        internal static GetResourceGatewayResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetResourceGatewayResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
