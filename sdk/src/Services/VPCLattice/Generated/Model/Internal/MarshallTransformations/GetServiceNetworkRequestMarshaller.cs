...
namespace Amazon.VPCLattice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetServiceNetworkRequestMarshaller : IMarshaller<IRequest, GetServiceNetworkRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetServiceNetworkRequestMarshaller _instance = new GetServiceNetworkRequestMarshaller();        

        internal static GetServiceNetworkRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetServiceNetworkRequestMarshaller Instance
        {
            get
            {
                return _instance;
