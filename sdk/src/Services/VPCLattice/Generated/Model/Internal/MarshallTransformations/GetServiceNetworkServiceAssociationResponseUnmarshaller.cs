...
namespace Amazon.VPCLattice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetServiceNetworkServiceAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetServiceNetworkServiceAssociationResponse response = new GetServiceNetworkServiceAssociationResponse();
        ...
        internal static GetServiceNetworkServiceAssociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetServiceNetworkServiceAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
