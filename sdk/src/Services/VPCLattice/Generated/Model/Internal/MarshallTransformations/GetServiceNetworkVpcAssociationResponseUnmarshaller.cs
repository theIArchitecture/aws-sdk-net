...
{
    /// <summary>
    /// Response Unmarshaller for GetServiceNetworkVpcAssociation operation
    /// </summary>  
    public class GetServiceNetworkVpcAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetServiceNetworkVpcAssociationResponse response = new GetServiceNetworkVpcAssociationResponse();
        ...
        private static GetServiceNetworkVpcAssociationResponseUnmarshaller _instance = new GetServiceNetworkVpcAssociationResponseUnmarshaller();        

        internal static GetServiceNetworkVpcAssociationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetServiceNetworkVpcAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
