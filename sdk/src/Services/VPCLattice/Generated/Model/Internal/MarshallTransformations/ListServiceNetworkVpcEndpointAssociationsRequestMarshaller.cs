...
namespace Amazon.VPCLattice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListServiceNetworkVpcEndpointAssociationsRequestMarshaller : IMarshaller<IRequest, ListServiceNetworkVpcEndpointAssociationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListServiceNetworkVpcEndpointAssociationsRequestMarshaller _instance = new ListServiceNetworkVpcEndpointAssociationsRequestMarshaller();        

        internal static ListServiceNetworkVpcEndpointAssociationsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListServiceNetworkVpcEndpointAssociationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
