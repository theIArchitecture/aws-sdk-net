...
namespace Amazon.VPCLattice.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateResourceConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateResourceConfigurationResponse response = new UpdateResourceConfigurationResponse();
        ...
        internal static UpdateResourceConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateResourceConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
