...
{
    /// <summary>
    /// UpdateServiceNetworkVpcAssociation Request Marshaller
    /// </summary>       
    public class UpdateServiceNetworkVpcAssociationRequestMarshaller : IMarshaller<IRequest, UpdateServiceNetworkVpcAssociationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateServiceNetworkVpcAssociationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateServiceNetworkVpcAssociationRequest publicRequest)
        {
        ...
        private static UpdateServiceNetworkVpcAssociationRequestMarshaller _instance = new UpdateServiceNetworkVpcAssociationRequestMarshaller();        

        internal static UpdateServiceNetworkVpcAssociationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateServiceNetworkVpcAssociationRequestMarshaller Instance
        {
            get
            {
                return _instance;
