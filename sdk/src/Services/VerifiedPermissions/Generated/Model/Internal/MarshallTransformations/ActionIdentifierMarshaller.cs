...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public class ActionIdentifierMarshaller : IRequestMarshaller<ActionIdentifier, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(ActionIdentifier requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static ActionIdentifierMarshaller Instance = new ActionIdentifierMarshaller();
