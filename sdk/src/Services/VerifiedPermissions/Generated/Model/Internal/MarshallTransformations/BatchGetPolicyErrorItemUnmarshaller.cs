...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchGetPolicyErrorItemUnmarshaller : IJsonUnmarshaller<BatchGetPolicyErrorItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchGetPolicyErrorItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
