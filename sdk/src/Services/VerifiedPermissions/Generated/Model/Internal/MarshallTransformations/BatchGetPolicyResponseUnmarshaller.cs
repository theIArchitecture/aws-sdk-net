...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetPolicy operation
    /// </summary>  
    public class BatchGetPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchGetPolicyResponse response = new BatchGetPolicyResponse();
        ...
        private static BatchGetPolicyResponseUnmarshaller _instance = new BatchGetPolicyResponseUnmarshaller();        

        internal static BatchGetPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
