...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public class BatchIsAuthorizedInputItemMarshaller : IRequestMarshaller<BatchIsAuthorizedInputItem, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(BatchIsAuthorizedInputItem requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>
        public readonly static BatchIsAuthorizedInputItemMarshaller Instance = new BatchIsAuthorizedInputItemMarshaller();
