...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchIsAuthorizedOutputItemUnmarshaller : IJsonUnmarshaller<BatchIsAuthorizedOutputItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public BatchIsAuthorizedOutputItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            BatchIsAuthorizedOutputItem unmarshalledObject = new BatchIsAuthorizedOutputItem();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = BatchIsAuthorizedInputItemUnmarshaller.Instance;
        ...
        private static BatchIsAuthorizedOutputItemUnmarshaller _instance = new BatchIsAuthorizedOutputItemUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BatchIsAuthorizedOutputItemUnmarshaller Instance
        {
            get
            {
                return _instance;
