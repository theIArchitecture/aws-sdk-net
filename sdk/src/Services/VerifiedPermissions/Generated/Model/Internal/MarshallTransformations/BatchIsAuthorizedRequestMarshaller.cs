...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class BatchIsAuthorizedRequestMarshaller : IMarshaller<IRequest, BatchIsAuthorizedRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((BatchIsAuthorizedRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(BatchIsAuthorizedRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.VerifiedPermissions");
            string target = "VerifiedPermissions.BatchIsAuthorized";
            ...
            if(publicRequest.IsSetRequests())
            {
                ...
                foreach(var publicRequestRequestsListValue in publicRequest.Requests)
                {
                    ...
                    var marshaller = BatchIsAuthorizedInputItemMarshaller.Instance;
        ...
        private static BatchIsAuthorizedRequestMarshaller _instance = new BatchIsAuthorizedRequestMarshaller();        

        internal static BatchIsAuthorizedRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchIsAuthorizedRequestMarshaller Instance
        {
            get
            {
                return _instance;
