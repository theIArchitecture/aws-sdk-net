...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    public class BatchIsAuthorizedWithTokenOutputItemUnmarshaller : IJsonUnmarshaller<BatchIsAuthorizedWithTokenOutputItem, JsonUnmarshallerContext>
    {
        ...
        private static BatchIsAuthorizedWithTokenOutputItemUnmarshaller _instance = new BatchIsAuthorizedWithTokenOutputItemUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BatchIsAuthorizedWithTokenOutputItemUnmarshaller Instance
        {
            get
            {
                return _instance;
