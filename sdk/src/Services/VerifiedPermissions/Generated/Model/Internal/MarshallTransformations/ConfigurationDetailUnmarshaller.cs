...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConfigurationDetailUnmarshaller : IJsonUnmarshaller<ConfigurationDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ConfigurationDetail Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
