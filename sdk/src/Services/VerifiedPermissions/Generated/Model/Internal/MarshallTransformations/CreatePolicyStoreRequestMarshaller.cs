...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreatePolicyStoreRequestMarshaller : IMarshaller<IRequest, CreatePolicyStoreRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreatePolicyStoreRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreatePolicyStoreRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.VerifiedPermissions");
            string target = "VerifiedPermissions.CreatePolicyStore";
        ...
        private static CreatePolicyStoreRequestMarshaller _instance = new CreatePolicyStoreRequestMarshaller();        

        internal static CreatePolicyStoreRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePolicyStoreRequestMarshaller Instance
        {
            get
            {
                return _instance;
