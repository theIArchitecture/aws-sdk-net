...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreatePolicyStoreResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePolicyStoreResponse response = new CreatePolicyStoreResponse();
        ...
        private static CreatePolicyStoreResponseUnmarshaller _instance = new CreatePolicyStoreResponseUnmarshaller();        

        internal static CreatePolicyStoreResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePolicyStoreResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
