...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeletePolicyStoreResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeletePolicyStoreResponse response = new DeletePolicyStoreResponse();
        ...
        private static DeletePolicyStoreResponseUnmarshaller _instance = new DeletePolicyStoreResponseUnmarshaller();        

        internal static DeletePolicyStoreResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePolicyStoreResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
