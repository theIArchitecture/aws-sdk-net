...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetPolicyTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPolicyTemplateResponse response = new GetPolicyTemplateResponse();
        ...
        private static GetPolicyTemplateResponseUnmarshaller _instance = new GetPolicyTemplateResponseUnmarshaller();        

        internal static GetPolicyTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPolicyTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
