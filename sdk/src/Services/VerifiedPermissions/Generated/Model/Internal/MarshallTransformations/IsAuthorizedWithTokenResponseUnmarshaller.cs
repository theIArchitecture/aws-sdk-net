...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IsAuthorizedWithTokenResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            IsAuthorizedWithTokenResponse response = new IsAuthorizedWithTokenResponse();
        ...
        private static IsAuthorizedWithTokenResponseUnmarshaller _instance = new IsAuthorizedWithTokenResponseUnmarshaller();        

        internal static IsAuthorizedWithTokenResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static IsAuthorizedWithTokenResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
