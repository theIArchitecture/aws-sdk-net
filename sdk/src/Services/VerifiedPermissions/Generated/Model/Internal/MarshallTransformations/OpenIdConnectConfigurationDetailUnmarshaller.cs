...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OpenIdConnectConfigurationDetailUnmarshaller : IJsonUnmarshaller<OpenIdConnectConfigurationDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public OpenIdConnectConfigurationDetail Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
