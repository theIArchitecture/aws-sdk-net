...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PolicyItemUnmarshaller : IJsonUnmarshaller<PolicyItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PolicyItem Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
