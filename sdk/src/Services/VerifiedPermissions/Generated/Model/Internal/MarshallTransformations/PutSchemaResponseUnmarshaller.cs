...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutSchemaResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutSchemaResponse response = new PutSchemaResponse();
        ...
        private static PutSchemaResponseUnmarshaller _instance = new PutSchemaResponseUnmarshaller();        

        internal static PutSchemaResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutSchemaResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
