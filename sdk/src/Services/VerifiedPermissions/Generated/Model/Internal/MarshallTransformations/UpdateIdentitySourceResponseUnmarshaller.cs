...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateIdentitySourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateIdentitySourceResponse response = new UpdateIdentitySourceResponse();
        ...
        private static UpdateIdentitySourceResponseUnmarshaller _instance = new UpdateIdentitySourceResponseUnmarshaller();        

        internal static UpdateIdentitySourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateIdentitySourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
