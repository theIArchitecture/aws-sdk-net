...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdatePolicyStoreRequestMarshaller : IMarshaller<IRequest, UpdatePolicyStoreRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdatePolicyStoreRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdatePolicyStoreRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.VerifiedPermissions");
            string target = "VerifiedPermissions.UpdatePolicyStore";
        ...
        private static UpdatePolicyStoreRequestMarshaller _instance = new UpdatePolicyStoreRequestMarshaller();        

        internal static UpdatePolicyStoreRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePolicyStoreRequestMarshaller Instance
        {
            get
            {
                return _instance;
