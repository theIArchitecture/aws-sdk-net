...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdatePolicyStoreResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdatePolicyStoreResponse response = new UpdatePolicyStoreResponse();
        ...
        private static UpdatePolicyStoreResponseUnmarshaller _instance = new UpdatePolicyStoreResponseUnmarshaller();        

        internal static UpdatePolicyStoreResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePolicyStoreResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
