...
namespace Amazon.VerifiedPermissions.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdatePolicyTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdatePolicyTemplateResponse response = new UpdatePolicyTemplateResponse();
        ...
        private static UpdatePolicyTemplateResponseUnmarshaller _instance = new UpdatePolicyTemplateResponseUnmarshaller();        

        internal static UpdatePolicyTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePolicyTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
