...
namespace Amazon.VoiceID.Internal
{
    ...
    public class AmazonVoiceIDAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonVoiceIDAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for VoiceID.
        /// </summary>
        public AmazonVoiceIDAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonVoiceIDAuthSchemeParameters
            {
    ...
    public class AmazonVoiceIDAuthSchemeResolver : IAuthSchemeResolver<AmazonVoiceIDAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonVoiceIDAuthSchemeParameters authParameters)
        {
