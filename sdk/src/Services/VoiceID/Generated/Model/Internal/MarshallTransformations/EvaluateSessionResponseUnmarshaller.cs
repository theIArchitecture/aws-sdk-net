...
{
    /// <summary>
    /// Response Unmarshaller for EvaluateSession operation
    /// </summary>  
    public class EvaluateSessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static EvaluateSessionResponseUnmarshaller _instance = new EvaluateSessionResponseUnmarshaller();        

        internal static EvaluateSessionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EvaluateSessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
