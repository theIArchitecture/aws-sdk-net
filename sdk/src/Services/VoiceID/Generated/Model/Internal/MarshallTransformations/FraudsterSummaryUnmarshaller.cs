...
{
    /// <summary>
    /// Response Unmarshaller for FraudsterSummary Object
    /// </summary>  
    public class FraudsterSummaryUnmarshaller : IJsonUnmarshaller<FraudsterSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FraudsterSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static FraudsterSummaryUnmarshaller _instance = new FraudsterSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static FraudsterSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
