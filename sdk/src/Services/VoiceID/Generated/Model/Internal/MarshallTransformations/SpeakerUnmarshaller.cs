...
namespace Amazon.VoiceID.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SpeakerUnmarshaller : IJsonUnmarshaller<Speaker, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Speaker Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
