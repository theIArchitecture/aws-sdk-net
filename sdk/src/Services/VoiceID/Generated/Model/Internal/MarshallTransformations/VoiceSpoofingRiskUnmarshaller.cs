...
namespace Amazon.VoiceID.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VoiceSpoofingRiskUnmarshaller : IJsonUnmarshaller<VoiceSpoofingRisk, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public VoiceSpoofingRisk Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
