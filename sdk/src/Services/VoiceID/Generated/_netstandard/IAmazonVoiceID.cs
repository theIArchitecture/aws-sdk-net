...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonVoiceIDConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonVoiceIDConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonVoiceIDConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonVoiceIDConfig to create AmazonVoiceIDClient");
            }

            return awsCredentials == null ? 
                    new AmazonVoiceIDClient(serviceClientConfig) :
                    new AmazonVoiceIDClient(awsCredentials, serviceClientConfig);
        }
