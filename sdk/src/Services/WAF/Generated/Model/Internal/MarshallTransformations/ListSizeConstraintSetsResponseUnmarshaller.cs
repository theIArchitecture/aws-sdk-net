    ...
    public class ListSizeConstraintSetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SizeConstraintSetSummary, SizeConstraintSetSummaryUnmarshaller>(SizeConstraintSetSummaryUnmarshaller.Instance);
                    response.SizeConstraintSets = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
