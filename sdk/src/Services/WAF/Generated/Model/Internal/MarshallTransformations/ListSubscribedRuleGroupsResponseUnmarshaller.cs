    ...
    public class ListSubscribedRuleGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SubscribedRuleGroupSummary, SubscribedRuleGroupSummaryUnmarshaller>(SubscribedRuleGroupSummaryUnmarshaller.Instance);
