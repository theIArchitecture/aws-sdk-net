...
namespace Amazon.WAFRegional.Internal
{
    ...
    public class AmazonWAFRegionalAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonWAFRegionalAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for WAFRegional.
        /// </summary>
        public AmazonWAFRegionalAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonWAFRegionalAuthSchemeParameters
            {
    ...
    public class AmazonWAFRegionalAuthSchemeResolver : IAuthSchemeResolver<AmazonWAFRegionalAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonWAFRegionalAuthSchemeParameters authParameters)
        {
