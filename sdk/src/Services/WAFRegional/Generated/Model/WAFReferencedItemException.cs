...
namespace Amazon.WAFRegional.Model
{
    ...
    public partial class WAFReferencedItemException : AmazonWAFRegionalException
    {
        ...
        public WAFReferencedItemException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public WAFReferencedItemException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
