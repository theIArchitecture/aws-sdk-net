...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonWAFRegionalConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonWAFRegionalConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonWAFRegionalConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonWAFRegionalConfig to create AmazonWAFRegionalClient");
            }

            return awsCredentials == null ? 
                    new AmazonWAFRegionalClient(serviceClientConfig) :
                    new AmazonWAFRegionalClient(awsCredentials, serviceClientConfig);
        }
