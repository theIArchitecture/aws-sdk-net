...
{
    /// <summary>
    /// This is the response object from the GetManagedRuleSet operation.
    /// </summary>
    public partial class GetManagedRuleSetResponse : AmazonWebServiceResponse
    {
        private string _lockToken;
        private ManagedRuleSet _managedRuleSet;
        ...
        /// <summary>
        /// Gets and sets the property ManagedRuleSet. 
        /// <para>
        /// The managed rule set that you requested. 
        /// </para>
        /// </summary>
        public ManagedRuleSet ManagedRuleSet
        {
            get { return this._managedRuleSet; }
            set { this._managedRuleSet = value; }
        }

        // Check to see if ManagedRuleSet property is set
        internal bool IsSetManagedRuleSet()
        {
            return this._managedRuleSet != null;
        }
