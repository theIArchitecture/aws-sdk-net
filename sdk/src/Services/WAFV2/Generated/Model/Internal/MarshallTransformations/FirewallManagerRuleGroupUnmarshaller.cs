...
namespace Amazon.WAFV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FirewallManagerRuleGroupUnmarshaller : IJsonUnmarshaller<FirewallManagerRuleGroup, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FirewallManagerRuleGroup Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("FirewallManagerStatement", targetDepth))
                {
                    ...
                    unmarshalledObject.FirewallManagerStatement = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
