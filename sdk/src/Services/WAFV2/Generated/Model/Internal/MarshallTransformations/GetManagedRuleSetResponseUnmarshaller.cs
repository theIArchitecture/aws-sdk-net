...
{
    /// <summary>
    /// Response Unmarshaller for GetManagedRuleSet operation
    /// </summary>  
    public class GetManagedRuleSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetManagedRuleSetResponse response = new GetManagedRuleSetResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = ManagedRuleSetUnmarshaller.Instance;
                    response.ManagedRuleSet = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static GetManagedRuleSetResponseUnmarshaller _instance = new GetManagedRuleSetResponseUnmarshaller();        

        internal static GetManagedRuleSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetManagedRuleSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
