...
{
    /// <summary>
    /// Response Unmarshaller for GetMobileSdkRelease operation
    /// </summary>  
    public class GetMobileSdkReleaseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMobileSdkReleaseResponse response = new GetMobileSdkReleaseResponse();
        ...
        private static GetMobileSdkReleaseResponseUnmarshaller _instance = new GetMobileSdkReleaseResponseUnmarshaller();        

        internal static GetMobileSdkReleaseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMobileSdkReleaseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
