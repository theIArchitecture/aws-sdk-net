...
namespace Amazon.WAFV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class JsonBodyUnmarshaller : IJsonUnmarshaller<JsonBody, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public JsonBody Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("InvalidFallbackBehavior", targetDepth))
                {
                    ...
                    unmarshalledObject.InvalidFallbackBehavior = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
