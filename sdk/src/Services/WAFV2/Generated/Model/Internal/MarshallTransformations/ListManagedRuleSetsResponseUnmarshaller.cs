...
{
    /// <summary>
    /// Response Unmarshaller for ListManagedRuleSets operation
    /// </summary>  
    public class ListManagedRuleSetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListManagedRuleSetsResponse response = new ListManagedRuleSetsResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ManagedRuleSets", targetDepth))
                {
                    var unmarshaller = new JsonListUnmarshaller<ManagedRuleSetSummary, ManagedRuleSetSummaryUnmarshaller>(ManagedRuleSetSummaryUnmarshaller.Instance);
                    response.ManagedRuleSets = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListManagedRuleSetsResponseUnmarshaller _instance = new ListManagedRuleSetsResponseUnmarshaller();        

        internal static ListManagedRuleSetsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListManagedRuleSetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
