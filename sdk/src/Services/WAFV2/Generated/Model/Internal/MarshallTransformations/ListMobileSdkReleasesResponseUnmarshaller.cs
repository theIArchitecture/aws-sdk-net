    ...
    public class ListMobileSdkReleasesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ReleaseSummary, ReleaseSummaryUnmarshaller>(ReleaseSummaryUnmarshaller.Instance);
                    response.ReleaseSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
