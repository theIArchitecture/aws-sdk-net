...
{
    /// <summary>
    /// PutManagedRuleSetVersions Request Marshaller
    /// </summary>       
    public class PutManagedRuleSetVersionsRequestMarshaller : IMarshaller<IRequest, PutManagedRuleSetVersionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutManagedRuleSetVersionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutManagedRuleSetVersionsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.WAFV2");
            string target = "AWSWAF_20190729.PutManagedRuleSetVersions";
            ...
            if(publicRequest.IsSetRecommendedVersion())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.RecommendedVersion);
            }
        ...
        private static PutManagedRuleSetVersionsRequestMarshaller _instance = new PutManagedRuleSetVersionsRequestMarshaller();        

        internal static PutManagedRuleSetVersionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutManagedRuleSetVersionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
