...
{
    /// <summary>
    /// Response Unmarshaller for PutManagedRuleSetVersions operation
    /// </summary>  
    public class PutManagedRuleSetVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutManagedRuleSetVersionsResponse response = new PutManagedRuleSetVersionsResponse();
        ...
        private static PutManagedRuleSetVersionsResponseUnmarshaller _instance = new PutManagedRuleSetVersionsResponseUnmarshaller();        

        internal static PutManagedRuleSetVersionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutManagedRuleSetVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
