...
namespace Amazon.WAFV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RateBasedStatementManagedKeysIPSetUnmarshaller : IJsonUnmarshaller<RateBasedStatementManagedKeysIPSet, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RateBasedStatementManagedKeysIPSet Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("IPAddressVersion", targetDepth))
                {
                    ...
                    unmarshalledObject.IPAddressVersion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
