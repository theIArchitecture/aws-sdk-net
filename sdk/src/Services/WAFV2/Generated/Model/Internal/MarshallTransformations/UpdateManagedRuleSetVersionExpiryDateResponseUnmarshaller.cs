...
{
    /// <summary>
    /// Response Unmarshaller for UpdateManagedRuleSetVersionExpiryDate operation
    /// </summary>  
    public class UpdateManagedRuleSetVersionExpiryDateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateManagedRuleSetVersionExpiryDateResponse response = new UpdateManagedRuleSetVersionExpiryDateResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ExpiringVersion", targetDepth))
                {
                    ...
                    response.ExpiringVersion = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ExpiryTimestamp", targetDepth))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    response.ExpiryTimestamp = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("NextLockToken", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.NextLockToken = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateManagedRuleSetVersionExpiryDateResponseUnmarshaller _instance = new UpdateManagedRuleSetVersionExpiryDateResponseUnmarshaller();        

        internal static UpdateManagedRuleSetVersionExpiryDateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateManagedRuleSetVersionExpiryDateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
