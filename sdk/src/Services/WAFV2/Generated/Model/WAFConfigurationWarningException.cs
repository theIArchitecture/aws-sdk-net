...
namespace Amazon.WAFV2.Model
{
    ...
    public partial class WAFConfigurationWarningException : AmazonWAFV2Exception
    {
        ...
        public WAFConfigurationWarningException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public WAFConfigurationWarningException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
