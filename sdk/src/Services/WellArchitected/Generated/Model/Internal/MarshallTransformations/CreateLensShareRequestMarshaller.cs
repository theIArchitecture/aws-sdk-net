...
{
    /// <summary>
    /// CreateLensShare Request Marshaller
    /// </summary>       
    public class CreateLensShareRequestMarshaller : IMarshaller<IRequest, CreateLensShareRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateLensShareRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateLensShareRequest publicRequest)
        {
        ...
        private static CreateLensShareRequestMarshaller _instance = new CreateLensShareRequestMarshaller();        

        internal static CreateLensShareRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLensShareRequestMarshaller Instance
        {
            get
            {
                return _instance;
