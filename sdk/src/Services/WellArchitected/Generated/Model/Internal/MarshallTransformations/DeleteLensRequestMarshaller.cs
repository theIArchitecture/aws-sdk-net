...
{
    /// <summary>
    /// DeleteLens Request Marshaller
    /// </summary>       
    public class DeleteLensRequestMarshaller : IMarshaller<IRequest, DeleteLensRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteLensRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteLensRequest publicRequest)
        {
        ...
        private static DeleteLensRequestMarshaller _instance = new DeleteLensRequestMarshaller();        

        internal static DeleteLensRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteLensRequestMarshaller Instance
        {
            get
            {
                return _instance;
