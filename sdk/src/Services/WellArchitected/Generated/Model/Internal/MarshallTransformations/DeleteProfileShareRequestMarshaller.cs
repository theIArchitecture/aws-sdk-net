...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteProfileShareRequestMarshaller : IMarshaller<IRequest, DeleteProfileShareRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteProfileShareRequestMarshaller _instance = new DeleteProfileShareRequestMarshaller();        

        internal static DeleteProfileShareRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteProfileShareRequestMarshaller Instance
        {
            get
            {
                return _instance;
