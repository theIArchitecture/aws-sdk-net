...
{
    /// <summary>
    /// DeleteTemplateShare Request Marshaller
    /// </summary>       
    public class DeleteTemplateShareRequestMarshaller : IMarshaller<IRequest, DeleteTemplateShareRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteTemplateShareRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteTemplateShareRequest publicRequest)
        {
            ...
            request.ResourcePath = "/templates/shares/{TemplateArn}/{ShareId}";
            request.UseQueryString = true;

            return request;
        }
        private static DeleteTemplateShareRequestMarshaller _instance = new DeleteTemplateShareRequestMarshaller();        

        internal static DeleteTemplateShareRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTemplateShareRequestMarshaller Instance
        {
            get
            {
                return _instance;
