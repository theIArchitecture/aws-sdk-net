...
{
    /// <summary>
    /// GetReviewTemplateAnswer Request Marshaller
    /// </summary>       
    public class GetReviewTemplateAnswerRequestMarshaller : IMarshaller<IRequest, GetReviewTemplateAnswerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetReviewTemplateAnswerRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetReviewTemplateAnswerRequest publicRequest)
        {
        ...
        private static GetReviewTemplateAnswerRequestMarshaller _instance = new GetReviewTemplateAnswerRequestMarshaller();        

        internal static GetReviewTemplateAnswerRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetReviewTemplateAnswerRequestMarshaller Instance
        {
            get
            {
                return _instance;
