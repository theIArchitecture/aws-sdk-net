...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetReviewTemplateLensReviewRequestMarshaller : IMarshaller<IRequest, GetReviewTemplateLensReviewRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetReviewTemplateLensReviewRequestMarshaller _instance = new GetReviewTemplateLensReviewRequestMarshaller();        

        internal static GetReviewTemplateLensReviewRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetReviewTemplateLensReviewRequestMarshaller Instance
        {
            get
            {
                return _instance;
