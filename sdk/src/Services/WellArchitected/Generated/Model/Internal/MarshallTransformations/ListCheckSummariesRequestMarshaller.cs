...
{
    /// <summary>
    /// ListCheckSummaries Request Marshaller
    /// </summary>       
    public class ListCheckSummariesRequestMarshaller : IMarshaller<IRequest, ListCheckSummariesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListCheckSummariesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListCheckSummariesRequest publicRequest)
        {
            ...
            request.ResourcePath = "/workloads/{WorkloadId}/checkSummaries";
#if !NETFRAMEWORK
        ...
        private static ListCheckSummariesRequestMarshaller _instance = new ListCheckSummariesRequestMarshaller();        

        internal static ListCheckSummariesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCheckSummariesRequestMarshaller Instance
        {
            get
            {
                return _instance;
