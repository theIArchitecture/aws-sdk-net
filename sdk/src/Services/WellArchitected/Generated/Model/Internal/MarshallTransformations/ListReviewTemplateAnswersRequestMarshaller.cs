...
{
    /// <summary>
    /// ListReviewTemplateAnswers Request Marshaller
    /// </summary>       
    public class ListReviewTemplateAnswersRequestMarshaller : IMarshaller<IRequest, ListReviewTemplateAnswersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListReviewTemplateAnswersRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListReviewTemplateAnswersRequest publicRequest)
        {
            ...
            request.ResourcePath = "/reviewTemplates/{TemplateArn}/lensReviews/{LensAlias}/answers";
            request.UseQueryString = true;

            return request;
        }
        private static ListReviewTemplateAnswersRequestMarshaller _instance = new ListReviewTemplateAnswersRequestMarshaller();        

        internal static ListReviewTemplateAnswersRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListReviewTemplateAnswersRequestMarshaller Instance
        {
            get
            {
                return _instance;
