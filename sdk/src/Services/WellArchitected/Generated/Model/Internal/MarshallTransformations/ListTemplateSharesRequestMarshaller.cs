...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListTemplateSharesRequestMarshaller : IMarshaller<IRequest, ListTemplateSharesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListTemplateSharesRequestMarshaller _instance = new ListTemplateSharesRequestMarshaller();        

        internal static ListTemplateSharesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTemplateSharesRequestMarshaller Instance
        {
            get
            {
                return _instance;
