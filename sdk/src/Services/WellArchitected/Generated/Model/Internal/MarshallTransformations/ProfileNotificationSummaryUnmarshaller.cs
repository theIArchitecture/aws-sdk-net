...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    public class ProfileNotificationSummaryUnmarshaller : IJsonUnmarshaller<ProfileNotificationSummary, JsonUnmarshallerContext>
    {
        ...
        private static ProfileNotificationSummaryUnmarshaller _instance = new ProfileNotificationSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ProfileNotificationSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
