...
{
    /// <summary>
    /// Response Unmarshaller for QuestionMetric Object
    /// </summary>  
    public class QuestionMetricUnmarshaller : IJsonUnmarshaller<QuestionMetric, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public QuestionMetric Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            QuestionMetric unmarshalledObject = new QuestionMetric();
        ...
        private static QuestionMetricUnmarshaller _instance = new QuestionMetricUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static QuestionMetricUnmarshaller Instance
        {
            get
            {
                return _instance;
