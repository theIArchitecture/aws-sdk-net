...
namespace Amazon.WorkDocs.Model
{
    ...
    public partial class DocumentLockedForCommentsException : AmazonWorkDocsException
    {
        ...
        public DocumentLockedForCommentsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DocumentLockedForCommentsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
