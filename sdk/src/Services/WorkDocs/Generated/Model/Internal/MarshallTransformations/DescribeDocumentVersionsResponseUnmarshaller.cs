    ...
    public class DescribeDocumentVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DocumentVersionMetadata, DocumentVersionMetadataUnmarshaller>(DocumentVersionMetadataUnmarshaller.Instance);
                    response.DocumentVersions = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
