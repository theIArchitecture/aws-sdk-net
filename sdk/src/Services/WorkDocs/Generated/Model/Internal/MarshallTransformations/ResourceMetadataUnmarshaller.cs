...
namespace Amazon.WorkDocs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResourceMetadataUnmarshaller : IJsonUnmarshaller<ResourceMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResourceMetadata Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.OriginalName = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
