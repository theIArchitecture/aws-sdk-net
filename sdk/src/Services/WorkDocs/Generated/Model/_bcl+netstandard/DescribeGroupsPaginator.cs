...
{
    /// <summary>
    /// Base class for DescribeGroups paginators.
    /// </summary>
    internal sealed partial class DescribeGroupsPaginator : IPaginator<DescribeGroupsResponse>, IDescribeGroupsPaginator
    {
        private readonly IAmazonWorkDocs _client;
        private readonly DescribeGroupsRequest _request;
        private int _isPaginatorInUse = 0;
        
        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<DescribeGroupsResponse> Responses => new PaginatedResponse<DescribeGroupsResponse>(this);
...
#if BCL
        IEnumerable<DescribeGroupsResponse> IPaginator<DescribeGroupsResponse>.Paginate()
        {
            ...
            do
            {
                ...
                response = _client.DescribeGroups(_request);
        ...
        async IAsyncEnumerable<DescribeGroupsResponse> IPaginator<DescribeGroupsResponse>.PaginateAsync([System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
        {
            ...
            {
                _request.Marker = marker;
                response = await _client.DescribeGroupsAsync(_request, cancellationToken).ConfigureAwait(false);
                marker = response.Marker;
