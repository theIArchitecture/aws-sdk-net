...
{
    /// <summary>
    /// Response Unmarshaller for AssumeImpersonationRole operation
    /// </summary>  
    public class AssumeImpersonationRoleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssumeImpersonationRoleResponse response = new AssumeImpersonationRoleResponse();
        ...
        private static AssumeImpersonationRoleResponseUnmarshaller _instance = new AssumeImpersonationRoleResponseUnmarshaller();        

        internal static AssumeImpersonationRoleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssumeImpersonationRoleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
