...
{
    /// <summary>
    /// Response Unmarshaller for CreateAvailabilityConfiguration operation
    /// </summary>  
    public class CreateAvailabilityConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAvailabilityConfigurationResponse response = new CreateAvailabilityConfigurationResponse();
        ...
        private static CreateAvailabilityConfigurationResponseUnmarshaller _instance = new CreateAvailabilityConfigurationResponseUnmarshaller();        

        internal static CreateAvailabilityConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAvailabilityConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
