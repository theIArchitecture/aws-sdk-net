...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAvailabilityConfiguration operation
    /// </summary>  
    public class DeleteAvailabilityConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAvailabilityConfigurationResponse response = new DeleteAvailabilityConfigurationResponse();
        ...
        private static DeleteAvailabilityConfigurationResponseUnmarshaller _instance = new DeleteAvailabilityConfigurationResponseUnmarshaller();        

        internal static DeleteAvailabilityConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAvailabilityConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
