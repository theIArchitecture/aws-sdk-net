...
{
    /// <summary>
    /// Response Unmarshaller for DeleteIdentityProviderConfiguration operation
    /// </summary>  
    public class DeleteIdentityProviderConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteIdentityProviderConfigurationResponse response = new DeleteIdentityProviderConfigurationResponse();
        ...
        private static DeleteIdentityProviderConfigurationResponseUnmarshaller _instance = new DeleteIdentityProviderConfigurationResponseUnmarshaller();        

        internal static DeleteIdentityProviderConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteIdentityProviderConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
