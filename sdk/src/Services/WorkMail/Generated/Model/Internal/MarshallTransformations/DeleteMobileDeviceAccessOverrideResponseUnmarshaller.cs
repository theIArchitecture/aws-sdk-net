...
{
    /// <summary>
    /// Response Unmarshaller for DeleteMobileDeviceAccessOverride operation
    /// </summary>  
    public class DeleteMobileDeviceAccessOverrideResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteMobileDeviceAccessOverrideResponse response = new DeleteMobileDeviceAccessOverrideResponse();
        ...
        private static DeleteMobileDeviceAccessOverrideResponseUnmarshaller _instance = new DeleteMobileDeviceAccessOverrideResponseUnmarshaller();        

        internal static DeleteMobileDeviceAccessOverrideResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteMobileDeviceAccessOverrideResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
