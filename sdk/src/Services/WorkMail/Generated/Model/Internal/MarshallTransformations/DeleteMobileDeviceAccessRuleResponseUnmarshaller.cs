...
{
    /// <summary>
    /// Response Unmarshaller for DeleteMobileDeviceAccessRule operation
    /// </summary>  
    public class DeleteMobileDeviceAccessRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteMobileDeviceAccessRuleResponse response = new DeleteMobileDeviceAccessRuleResponse();
        ...
        private static DeleteMobileDeviceAccessRuleResponseUnmarshaller _instance = new DeleteMobileDeviceAccessRuleResponseUnmarshaller();        

        internal static DeleteMobileDeviceAccessRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteMobileDeviceAccessRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
