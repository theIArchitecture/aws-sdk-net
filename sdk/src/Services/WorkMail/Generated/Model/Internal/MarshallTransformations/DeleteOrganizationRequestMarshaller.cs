    ...
    public class DeleteOrganizationRequestMarshaller : IMarshaller<IRequest, DeleteOrganizationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DeleteOrganizationRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetDeleteDirectory())
            {
                ...
                context.Writer.WriteBooleanValue(publicRequest.DeleteDirectory.Value);
            }

            if(publicRequest.IsSetDeleteIdentityCenterApplication())
            {
                context.Writer.WritePropertyName("DeleteIdentityCenterApplication");
                context.Writer.WriteBooleanValue(publicRequest.DeleteIdentityCenterApplication.Value);
            }
