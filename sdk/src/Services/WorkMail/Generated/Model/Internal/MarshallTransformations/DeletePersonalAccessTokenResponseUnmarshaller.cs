...
{
    /// <summary>
    /// Response Unmarshaller for DeletePersonalAccessToken operation
    /// </summary>  
    public class DeletePersonalAccessTokenResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeletePersonalAccessTokenResponse response = new DeletePersonalAccessTokenResponse();
        ...
        private static DeletePersonalAccessTokenResponseUnmarshaller _instance = new DeletePersonalAccessTokenResponseUnmarshaller();        

        internal static DeletePersonalAccessTokenResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePersonalAccessTokenResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
