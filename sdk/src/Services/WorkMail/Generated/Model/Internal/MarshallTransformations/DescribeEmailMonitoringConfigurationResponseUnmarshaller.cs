...
{
    /// <summary>
    /// Response Unmarshaller for DescribeEmailMonitoringConfiguration operation
    /// </summary>  
    public class DescribeEmailMonitoringConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeEmailMonitoringConfigurationResponse response = new DescribeEmailMonitoringConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("LogGroupArn", targetDepth))
                {
                    ...
                    response.LogGroupArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static DescribeEmailMonitoringConfigurationResponseUnmarshaller _instance = new DescribeEmailMonitoringConfigurationResponseUnmarshaller();        

        internal static DescribeEmailMonitoringConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeEmailMonitoringConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
