...
{
    /// <summary>
    /// Response Unmarshaller for DescribeInboundDmarcSettings operation
    /// </summary>  
    public class DescribeInboundDmarcSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeInboundDmarcSettingsResponse response = new DescribeInboundDmarcSettingsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("Enforced", targetDepth))
                {
                    ...
                    response.Enforced = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DescribeInboundDmarcSettingsResponseUnmarshaller _instance = new DescribeInboundDmarcSettingsResponseUnmarshaller();        

        internal static DescribeInboundDmarcSettingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeInboundDmarcSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
