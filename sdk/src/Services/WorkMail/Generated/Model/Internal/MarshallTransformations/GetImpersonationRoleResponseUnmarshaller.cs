...
{
    /// <summary>
    /// Response Unmarshaller for GetImpersonationRole operation
    /// </summary>  
    public class GetImpersonationRoleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetImpersonationRoleResponse response = new GetImpersonationRoleResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ImpersonationRule, ImpersonationRuleUnmarshaller>(ImpersonationRuleUnmarshaller.Instance);
        ...
        private static GetImpersonationRoleResponseUnmarshaller _instance = new GetImpersonationRoleResponseUnmarshaller();        

        internal static GetImpersonationRoleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetImpersonationRoleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
