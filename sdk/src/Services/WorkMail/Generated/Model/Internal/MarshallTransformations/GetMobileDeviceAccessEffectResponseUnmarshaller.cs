...
{
    /// <summary>
    /// Response Unmarshaller for GetMobileDeviceAccessEffect operation
    /// </summary>  
    public class GetMobileDeviceAccessEffectResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMobileDeviceAccessEffectResponse response = new GetMobileDeviceAccessEffectResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<MobileDeviceAccessMatchedRule, MobileDeviceAccessMatchedRuleUnmarshaller>(MobileDeviceAccessMatchedRuleUnmarshaller.Instance);
        ...
        private static GetMobileDeviceAccessEffectResponseUnmarshaller _instance = new GetMobileDeviceAccessEffectResponseUnmarshaller();        

        internal static GetMobileDeviceAccessEffectResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMobileDeviceAccessEffectResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
