...
{
    /// <summary>
    /// Response Unmarshaller for GetPersonalAccessTokenMetadata operation
    /// </summary>  
    public class GetPersonalAccessTokenMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPersonalAccessTokenMetadataResponse response = new GetPersonalAccessTokenMetadataResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    response.DateLastUsed = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("ExpiresTime", targetDepth))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                    response.ExpiresTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PersonalAccessTokenId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static GetPersonalAccessTokenMetadataResponseUnmarshaller _instance = new GetPersonalAccessTokenMetadataResponseUnmarshaller();        

        internal static GetPersonalAccessTokenMetadataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPersonalAccessTokenMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
