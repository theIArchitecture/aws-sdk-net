...
namespace Amazon.WorkMail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ImpersonationRoleUnmarshaller : IJsonUnmarshaller<ImpersonationRole, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ImpersonationRole Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ImpersonationRoleId", targetDepth))
                {
                    ...
                    unmarshalledObject.ImpersonationRoleId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
