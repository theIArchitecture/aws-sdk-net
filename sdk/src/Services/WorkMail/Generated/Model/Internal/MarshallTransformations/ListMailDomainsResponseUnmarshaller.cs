...
{
    /// <summary>
    /// Response Unmarshaller for ListMailDomains operation
    /// </summary>  
    public class ListMailDomainsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMailDomainsResponse response = new ListMailDomainsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<MailDomainSummary, MailDomainSummaryUnmarshaller>(MailDomainSummaryUnmarshaller.Instance);
                    response.MailDomains = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListMailDomainsResponseUnmarshaller _instance = new ListMailDomainsResponseUnmarshaller();        

        internal static ListMailDomainsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMailDomainsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
