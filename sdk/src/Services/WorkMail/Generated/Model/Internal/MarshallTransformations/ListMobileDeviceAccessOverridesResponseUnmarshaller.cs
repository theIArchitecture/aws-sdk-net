...
{
    /// <summary>
    /// Response Unmarshaller for ListMobileDeviceAccessOverrides operation
    /// </summary>  
    public class ListMobileDeviceAccessOverridesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMobileDeviceAccessOverridesResponse response = new ListMobileDeviceAccessOverridesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<MobileDeviceAccessOverride, MobileDeviceAccessOverrideUnmarshaller>(MobileDeviceAccessOverrideUnmarshaller.Instance);
        ...
        private static ListMobileDeviceAccessOverridesResponseUnmarshaller _instance = new ListMobileDeviceAccessOverridesResponseUnmarshaller();        

        internal static ListMobileDeviceAccessOverridesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMobileDeviceAccessOverridesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
