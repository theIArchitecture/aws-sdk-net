...
{
    /// <summary>
    /// Response Unmarshaller for ListMobileDeviceAccessRules operation
    /// </summary>  
    public class ListMobileDeviceAccessRulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMobileDeviceAccessRulesResponse response = new ListMobileDeviceAccessRulesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<MobileDeviceAccessRule, MobileDeviceAccessRuleUnmarshaller>(MobileDeviceAccessRuleUnmarshaller.Instance);
        ...
        private static ListMobileDeviceAccessRulesResponseUnmarshaller _instance = new ListMobileDeviceAccessRulesResponseUnmarshaller();        

        internal static ListMobileDeviceAccessRulesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMobileDeviceAccessRulesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
