    ...
    public class ListResourceDelegatesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<Delegate, DelegateUnmarshaller>(DelegateUnmarshaller.Instance);
                    response.Delegates = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
