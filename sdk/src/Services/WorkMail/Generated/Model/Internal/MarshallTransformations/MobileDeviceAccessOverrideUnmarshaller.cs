...
{
    /// <summary>
    /// Response Unmarshaller for MobileDeviceAccessOverride Object
    /// </summary>  
    public class MobileDeviceAccessOverrideUnmarshaller : IJsonUnmarshaller<MobileDeviceAccessOverride, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public MobileDeviceAccessOverride Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            MobileDeviceAccessOverride unmarshalledObject = new MobileDeviceAccessOverride();
        ...
        private static MobileDeviceAccessOverrideUnmarshaller _instance = new MobileDeviceAccessOverrideUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static MobileDeviceAccessOverrideUnmarshaller Instance
        {
            get
            {
                return _instance;
