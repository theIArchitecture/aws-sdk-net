...
{
    /// <summary>
    /// Response Unmarshaller for PutInboundDmarcSettings operation
    /// </summary>  
    public class PutInboundDmarcSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutInboundDmarcSettingsResponse response = new PutInboundDmarcSettingsResponse();
        ...
        private static PutInboundDmarcSettingsResponseUnmarshaller _instance = new PutInboundDmarcSettingsResponseUnmarshaller();        

        internal static PutInboundDmarcSettingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutInboundDmarcSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
