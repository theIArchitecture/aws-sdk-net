...
namespace Amazon.WorkMail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RedactedEwsAvailabilityProviderUnmarshaller : IJsonUnmarshaller<RedactedEwsAvailabilityProvider, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RedactedEwsAvailabilityProvider Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("EwsEndpoint", targetDepth))
                {
                    ...
                    unmarshalledObject.EwsEndpoint = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("EwsUsername", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.EwsUsername = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
