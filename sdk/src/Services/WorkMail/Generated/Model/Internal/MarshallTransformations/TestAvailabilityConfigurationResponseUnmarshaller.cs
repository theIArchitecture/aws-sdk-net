...
{
    /// <summary>
    /// Response Unmarshaller for TestAvailabilityConfiguration operation
    /// </summary>  
    public class TestAvailabilityConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TestAvailabilityConfigurationResponse response = new TestAvailabilityConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("TestPassed", targetDepth))
                {
                    ...
                    response.TestPassed = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static TestAvailabilityConfigurationResponseUnmarshaller _instance = new TestAvailabilityConfigurationResponseUnmarshaller();        

        internal static TestAvailabilityConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TestAvailabilityConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
