...
{
    /// <summary>
    /// UpdateAvailabilityConfiguration Request Marshaller
    /// </summary>       
    public class UpdateAvailabilityConfigurationRequestMarshaller : IMarshaller<IRequest, UpdateAvailabilityConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateAvailabilityConfigurationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateAvailabilityConfigurationRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.WorkMail");
            string target = "WorkMailService.UpdateAvailabilityConfiguration";
        ...
        private static UpdateAvailabilityConfigurationRequestMarshaller _instance = new UpdateAvailabilityConfigurationRequestMarshaller();        

        internal static UpdateAvailabilityConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAvailabilityConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
