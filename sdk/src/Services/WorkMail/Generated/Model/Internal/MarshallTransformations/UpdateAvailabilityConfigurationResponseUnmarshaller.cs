...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAvailabilityConfiguration operation
    /// </summary>  
    public class UpdateAvailabilityConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAvailabilityConfigurationResponse response = new UpdateAvailabilityConfigurationResponse();
        ...
        private static UpdateAvailabilityConfigurationResponseUnmarshaller _instance = new UpdateAvailabilityConfigurationResponseUnmarshaller();        

        internal static UpdateAvailabilityConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAvailabilityConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
