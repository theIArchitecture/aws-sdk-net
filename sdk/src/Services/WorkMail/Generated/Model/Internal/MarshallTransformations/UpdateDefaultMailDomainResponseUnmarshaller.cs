...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDefaultMailDomain operation
    /// </summary>  
    public class UpdateDefaultMailDomainResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDefaultMailDomainResponse response = new UpdateDefaultMailDomainResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                {
                    return MailDomainNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("MailDomainStateException"))
                {
                    return MailDomainStateExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static UpdateDefaultMailDomainResponseUnmarshaller _instance = new UpdateDefaultMailDomainResponseUnmarshaller();        

        internal static UpdateDefaultMailDomainResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDefaultMailDomainResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
