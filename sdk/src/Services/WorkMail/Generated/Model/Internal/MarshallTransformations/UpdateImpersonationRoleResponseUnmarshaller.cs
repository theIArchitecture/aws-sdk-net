...
{
    /// <summary>
    /// Response Unmarshaller for UpdateImpersonationRole operation
    /// </summary>  
    public class UpdateImpersonationRoleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateImpersonationRoleResponse response = new UpdateImpersonationRoleResponse();
        ...
        private static UpdateImpersonationRoleResponseUnmarshaller _instance = new UpdateImpersonationRoleResponseUnmarshaller();        

        internal static UpdateImpersonationRoleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateImpersonationRoleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
