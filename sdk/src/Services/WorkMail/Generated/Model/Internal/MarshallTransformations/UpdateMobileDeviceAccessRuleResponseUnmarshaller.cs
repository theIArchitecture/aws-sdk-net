...
{
    /// <summary>
    /// Response Unmarshaller for UpdateMobileDeviceAccessRule operation
    /// </summary>  
    public class UpdateMobileDeviceAccessRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateMobileDeviceAccessRuleResponse response = new UpdateMobileDeviceAccessRuleResponse();
        ...
        private static UpdateMobileDeviceAccessRuleResponseUnmarshaller _instance = new UpdateMobileDeviceAccessRuleResponseUnmarshaller();        

        internal static UpdateMobileDeviceAccessRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMobileDeviceAccessRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
