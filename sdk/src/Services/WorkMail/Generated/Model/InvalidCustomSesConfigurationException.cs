...
namespace Amazon.WorkMail.Model
{
    ...
    public partial class InvalidCustomSesConfigurationException : AmazonWorkMailException
    {
        ...
        public InvalidCustomSesConfigurationException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidCustomSesConfigurationException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
