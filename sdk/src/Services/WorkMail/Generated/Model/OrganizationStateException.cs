...
namespace Amazon.WorkMail.Model
{
    ...
    public partial class OrganizationStateException : AmazonWorkMailException
    {
        ...
        public OrganizationStateException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public OrganizationStateException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
