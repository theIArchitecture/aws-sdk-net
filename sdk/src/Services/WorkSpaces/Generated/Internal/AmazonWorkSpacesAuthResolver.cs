...
namespace Amazon.WorkSpaces.Internal
{
    ...
    public class AmazonWorkSpacesAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonWorkSpacesAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for WorkSpaces.
        /// </summary>
        public AmazonWorkSpacesAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonWorkSpacesAuthSchemeParameters
            {
    ...
    public class AmazonWorkSpacesAuthSchemeResolver : IAuthSchemeResolver<AmazonWorkSpacesAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonWorkSpacesAuthSchemeParameters authParameters)
        {
