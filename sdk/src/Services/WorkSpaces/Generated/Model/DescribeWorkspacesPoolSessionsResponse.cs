...
namespace Amazon.WorkSpaces.Model
{
    ...
    /// </summary>
    public partial class DescribeWorkspacesPoolSessionsResponse : AmazonWebServiceResponse
    {
        private string _nextToken;
        private List<WorkspacesPoolSession> _sessions = AWSConfigs.InitializeCollections ? new List<WorkspacesPoolSession>() : null;
