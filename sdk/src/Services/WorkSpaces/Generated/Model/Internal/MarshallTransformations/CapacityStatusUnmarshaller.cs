...
{
    /// <summary>
    /// Response Unmarshaller for CapacityStatus Object
    /// </summary>  
    public class CapacityStatusUnmarshaller : IJsonUnmarshaller<CapacityStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CapacityStatus Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            CapacityStatus unmarshalledObject = new CapacityStatus();
        ...
        private static CapacityStatusUnmarshaller _instance = new CapacityStatusUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CapacityStatusUnmarshaller Instance
        {
            get
            {
                return _instance;
