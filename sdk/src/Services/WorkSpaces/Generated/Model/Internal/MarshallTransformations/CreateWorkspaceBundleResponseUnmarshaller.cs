...
{
    /// <summary>
    /// Response Unmarshaller for CreateWorkspaceBundle operation
    /// </summary>  
    public class CreateWorkspaceBundleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateWorkspaceBundleResponse response = new CreateWorkspaceBundleResponse();
            StreamingUtf8JsonReader reader = new StreamingUtf8JsonReader(context.Stream);
            context.Read(ref reader);
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("WorkspaceBundle", targetDepth))
                {
                    var unmarshaller = WorkspaceBundleUnmarshaller.Instance;
                    response.WorkspaceBundle = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreateWorkspaceBundleResponseUnmarshaller _instance = new CreateWorkspaceBundleResponseUnmarshaller();        

        internal static CreateWorkspaceBundleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWorkspaceBundleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
