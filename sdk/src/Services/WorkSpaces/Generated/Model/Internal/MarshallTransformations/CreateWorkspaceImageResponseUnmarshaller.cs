...
{
    /// <summary>
    /// Response Unmarshaller for CreateWorkspaceImage operation
    /// </summary>  
    public class CreateWorkspaceImageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateWorkspaceImageResponse response = new CreateWorkspaceImageResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RequiredTenancy = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateWorkspaceImageResponseUnmarshaller _instance = new CreateWorkspaceImageResponseUnmarshaller();        

        internal static CreateWorkspaceImageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWorkspaceImageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
