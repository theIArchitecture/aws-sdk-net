...
{
    /// <summary>
    /// Response Unmarshaller for CreateWorkspacesPool operation
    /// </summary>  
    public class CreateWorkspacesPoolResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateWorkspacesPoolResponse response = new CreateWorkspacesPoolResponse();
        ...
        private static CreateWorkspacesPoolResponseUnmarshaller _instance = new CreateWorkspacesPoolResponseUnmarshaller();        

        internal static CreateWorkspacesPoolResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWorkspacesPoolResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
