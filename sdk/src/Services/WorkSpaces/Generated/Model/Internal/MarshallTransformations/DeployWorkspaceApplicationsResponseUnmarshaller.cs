...
{
    /// <summary>
    /// Response Unmarshaller for DeployWorkspaceApplications operation
    /// </summary>  
    public class DeployWorkspaceApplicationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeployWorkspaceApplicationsResponse response = new DeployWorkspaceApplicationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = WorkSpaceApplicationDeploymentUnmarshaller.Instance;
        ...
        private static DeployWorkspaceApplicationsResponseUnmarshaller _instance = new DeployWorkspaceApplicationsResponseUnmarshaller();        

        internal static DeployWorkspaceApplicationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeployWorkspaceApplicationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
