...
{
    /// <summary>
    /// Response Unmarshaller for DescribeBundleAssociations operation
    /// </summary>  
    public class DescribeBundleAssociationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeBundleAssociationsResponse response = new DescribeBundleAssociationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<BundleResourceAssociation, BundleResourceAssociationUnmarshaller>(BundleResourceAssociationUnmarshaller.Instance);
        ...
        private static DescribeBundleAssociationsResponseUnmarshaller _instance = new DescribeBundleAssociationsResponseUnmarshaller();        

        internal static DescribeBundleAssociationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeBundleAssociationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
