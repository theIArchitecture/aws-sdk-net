...
{
    /// <summary>
    /// Response Unmarshaller for DescribeClientBranding operation
    /// </summary>  
    public class DescribeClientBrandingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeClientBrandingResponse response = new DescribeClientBrandingResponse();
        ...
        private static DescribeClientBrandingResponseUnmarshaller _instance = new DescribeClientBrandingResponseUnmarshaller();        

        internal static DescribeClientBrandingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeClientBrandingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
