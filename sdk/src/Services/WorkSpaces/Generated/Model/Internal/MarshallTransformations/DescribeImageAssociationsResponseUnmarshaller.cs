...
{
    /// <summary>
    /// Response Unmarshaller for DescribeImageAssociations operation
    /// </summary>  
    public class DescribeImageAssociationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeImageAssociationsResponse response = new DescribeImageAssociationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ImageResourceAssociation, ImageResourceAssociationUnmarshaller>(ImageResourceAssociationUnmarshaller.Instance);
        ...
        private static DescribeImageAssociationsResponseUnmarshaller _instance = new DescribeImageAssociationsResponseUnmarshaller();        

        internal static DescribeImageAssociationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeImageAssociationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
