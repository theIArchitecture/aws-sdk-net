...
{
    /// <summary>
    /// Response Unmarshaller for DescribeWorkspaceAssociations operation
    /// </summary>  
    public class DescribeWorkspaceAssociationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeWorkspaceAssociationsResponse response = new DescribeWorkspaceAssociationsResponse();
        ...
        private static DescribeWorkspaceAssociationsResponseUnmarshaller _instance = new DescribeWorkspaceAssociationsResponseUnmarshaller();        

        internal static DescribeWorkspaceAssociationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeWorkspaceAssociationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
