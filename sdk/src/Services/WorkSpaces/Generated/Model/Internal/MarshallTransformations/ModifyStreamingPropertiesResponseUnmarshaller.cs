...
{
    /// <summary>
    /// Response Unmarshaller for ModifyStreamingProperties operation
    /// </summary>  
    public class ModifyStreamingPropertiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyStreamingPropertiesResponse response = new ModifyStreamingPropertiesResponse();
        ...
        private static ModifyStreamingPropertiesResponseUnmarshaller _instance = new ModifyStreamingPropertiesResponseUnmarshaller();        

        internal static ModifyStreamingPropertiesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyStreamingPropertiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
