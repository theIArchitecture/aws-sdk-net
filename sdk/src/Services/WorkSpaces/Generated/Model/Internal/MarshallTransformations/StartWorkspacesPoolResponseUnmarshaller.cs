...
{
    /// <summary>
    /// Response Unmarshaller for StartWorkspacesPool operation
    /// </summary>  
    public class StartWorkspacesPoolResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartWorkspacesPoolResponse response = new StartWorkspacesPoolResponse();
        ...
        private static StartWorkspacesPoolResponseUnmarshaller _instance = new StartWorkspacesPoolResponseUnmarshaller();        

        internal static StartWorkspacesPoolResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartWorkspacesPoolResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
