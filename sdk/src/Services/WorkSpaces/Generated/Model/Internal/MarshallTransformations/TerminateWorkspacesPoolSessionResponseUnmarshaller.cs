...
{
    /// <summary>
    /// Response Unmarshaller for TerminateWorkspacesPoolSession operation
    /// </summary>  
    public class TerminateWorkspacesPoolSessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TerminateWorkspacesPoolSessionResponse response = new TerminateWorkspacesPoolSessionResponse();
        ...
        private static TerminateWorkspacesPoolSessionResponseUnmarshaller _instance = new TerminateWorkspacesPoolSessionResponseUnmarshaller();        

        internal static TerminateWorkspacesPoolSessionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TerminateWorkspacesPoolSessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
