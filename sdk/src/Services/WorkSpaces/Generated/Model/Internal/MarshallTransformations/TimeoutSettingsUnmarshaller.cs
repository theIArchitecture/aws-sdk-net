...
{
    /// <summary>
    /// Response Unmarshaller for TimeoutSettings Object
    /// </summary>  
    public class TimeoutSettingsUnmarshaller : IJsonUnmarshaller<TimeoutSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public TimeoutSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            TimeoutSettings unmarshalledObject = new TimeoutSettings();
        ...
        private static TimeoutSettingsUnmarshaller _instance = new TimeoutSettingsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TimeoutSettingsUnmarshaller Instance
        {
            get
            {
                return _instance;
