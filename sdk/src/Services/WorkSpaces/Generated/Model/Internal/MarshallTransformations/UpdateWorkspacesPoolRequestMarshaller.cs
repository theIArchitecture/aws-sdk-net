...
{
    /// <summary>
    /// UpdateWorkspacesPool Request Marshaller
    /// </summary>       
    public class UpdateWorkspacesPoolRequestMarshaller : IMarshaller<IRequest, UpdateWorkspacesPoolRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateWorkspacesPoolRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateWorkspacesPoolRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.WorkSpaces");
            string target = "WorkspacesService.UpdateWorkspacesPool";
        ...
        private static UpdateWorkspacesPoolRequestMarshaller _instance = new UpdateWorkspacesPoolRequestMarshaller();        

        internal static UpdateWorkspacesPoolRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateWorkspacesPoolRequestMarshaller Instance
        {
            get
            {
                return _instance;
