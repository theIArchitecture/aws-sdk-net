...
{
    /// <summary>
    /// Response Unmarshaller for UpdateWorkspacesPool operation
    /// </summary>  
    public class UpdateWorkspacesPoolResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateWorkspacesPoolResponse response = new UpdateWorkspacesPoolResponse();
        ...
        private static UpdateWorkspacesPoolResponseUnmarshaller _instance = new UpdateWorkspacesPoolResponseUnmarshaller();        

        internal static UpdateWorkspacesPoolResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateWorkspacesPoolResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
