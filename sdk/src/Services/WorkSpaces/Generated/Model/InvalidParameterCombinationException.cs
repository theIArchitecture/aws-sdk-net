...
namespace Amazon.WorkSpaces.Model
{
    ...
    [Serializable]
    #endif
    public partial class InvalidParameterCombinationException : AmazonWorkSpacesException
    {
        ...
        public InvalidParameterCombinationException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidParameterCombinationException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
