...
namespace Amazon.WorkSpacesThinClient.Internal
{
    ...
    public class AmazonWorkSpacesThinClientAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonWorkSpacesThinClientAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for WorkSpacesThinClient.
        /// </summary>
        public AmazonWorkSpacesThinClientAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonWorkSpacesThinClientAuthSchemeParameters
            {
    ...
    public class AmazonWorkSpacesThinClientAuthSchemeResolver : IAuthSchemeResolver<AmazonWorkSpacesThinClientAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonWorkSpacesThinClientAuthSchemeParameters authParameters)
        {
