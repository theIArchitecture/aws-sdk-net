...
namespace Amazon.WorkSpacesThinClient.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SoftwareSetSummaryUnmarshaller : IJsonUnmarshaller<SoftwareSetSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            SoftwareSetSummary unmarshalledObject = new SoftwareSetSummary();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SoftwareSetSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
