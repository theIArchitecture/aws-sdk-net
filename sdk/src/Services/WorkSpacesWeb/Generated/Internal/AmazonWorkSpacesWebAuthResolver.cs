...
namespace Amazon.WorkSpacesWeb.Internal
{
    ...
    public class AmazonWorkSpacesWebAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonWorkSpacesWebAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for WorkSpacesWeb.
        /// </summary>
        public AmazonWorkSpacesWebAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonWorkSpacesWebAuthSchemeParameters
            {
    ...
    public class AmazonWorkSpacesWebAuthSchemeResolver : IAuthSchemeResolver<AmazonWorkSpacesWebAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonWorkSpacesWebAuthSchemeParameters authParameters)
        {
