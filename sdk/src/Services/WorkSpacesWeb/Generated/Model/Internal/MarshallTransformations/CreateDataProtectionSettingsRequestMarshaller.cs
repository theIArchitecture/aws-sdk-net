...
{
    /// <summary>
    /// CreateDataProtectionSettings Request Marshaller
    /// </summary>       
    public class CreateDataProtectionSettingsRequestMarshaller : IMarshaller<IRequest, CreateDataProtectionSettingsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateDataProtectionSettingsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateDataProtectionSettingsRequest publicRequest)
        {
        ...
        private static CreateDataProtectionSettingsRequestMarshaller _instance = new CreateDataProtectionSettingsRequestMarshaller();        

        internal static CreateDataProtectionSettingsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDataProtectionSettingsRequestMarshaller Instance
        {
            get
            {
                return _instance;
