...
namespace Amazon.WorkSpacesWeb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteBrowserSettingsRequestMarshaller : IMarshaller<IRequest, DeleteBrowserSettingsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteBrowserSettingsRequestMarshaller _instance = new DeleteBrowserSettingsRequestMarshaller();        

        internal static DeleteBrowserSettingsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteBrowserSettingsRequestMarshaller Instance
        {
            get
            {
                return _instance;
