...
namespace Amazon.WorkSpacesWeb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetIdentityProviderRequestMarshaller : IMarshaller<IRequest, GetIdentityProviderRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetIdentityProviderRequestMarshaller _instance = new GetIdentityProviderRequestMarshaller();        

        internal static GetIdentityProviderRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetIdentityProviderRequestMarshaller Instance
        {
            get
            {
                return _instance;
