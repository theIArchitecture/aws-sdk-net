...
namespace Amazon.WorkSpacesWeb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetTrustStoreCertificateRequestMarshaller : IMarshaller<IRequest, GetTrustStoreCertificateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetTrustStoreCertificateRequestMarshaller _instance = new GetTrustStoreCertificateRequestMarshaller();        

        internal static GetTrustStoreCertificateRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTrustStoreCertificateRequestMarshaller Instance
        {
            get
            {
                return _instance;
