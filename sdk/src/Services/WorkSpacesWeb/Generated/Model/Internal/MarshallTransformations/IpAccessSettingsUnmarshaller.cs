...
namespace Amazon.WorkSpacesWeb.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IpAccessSettingsUnmarshaller : IJsonUnmarshaller<IpAccessSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public IpAccessSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<IpRule, IpRuleUnmarshaller>(IpRuleUnmarshaller.Instance);
                    unmarshalledObject.IpRules = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
