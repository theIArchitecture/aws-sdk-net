...
namespace Amazon.WorkSpacesWeb.Model
{
    ...
    {
        private List<string> _clientIpAddresses = AWSConfigs.InitializeCollections ? new List<string>() : null;
        ...
        {
            get { return this._clientIpAddresses; }
            set { this._clientIpAddresses = value; }
        }

        // Check to see if ClientIpAddresses property is set
        internal bool IsSetClientIpAddresses()
        {
            return this._clientIpAddresses != null && (this._clientIpAddresses.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
