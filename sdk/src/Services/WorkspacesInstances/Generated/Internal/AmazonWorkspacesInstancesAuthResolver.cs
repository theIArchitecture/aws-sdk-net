...
namespace Amazon.WorkspacesInstances.Internal
{
    ...
    public class AmazonWorkspacesInstancesAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonWorkspacesInstancesAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for WorkspacesInstances.
        /// </summary>
        public AmazonWorkspacesInstancesAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonWorkspacesInstancesAuthSchemeParameters
            {
    ...
    public class AmazonWorkspacesInstancesAuthSchemeResolver : IAuthSchemeResolver<AmazonWorkspacesInstancesAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonWorkspacesInstancesAuthSchemeParameters authParameters)
        {
