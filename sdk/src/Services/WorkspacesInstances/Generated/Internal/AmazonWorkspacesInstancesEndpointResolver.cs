...
{
    /// <summary>
    /// Amazon WorkspacesInstances endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for WorkspacesInstances service requests.
    /// Collects values for WorkspacesInstancesEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses WorkspacesInstancesEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonWorkspacesInstancesEndpointResolver : BaseEndpointResolver
    {
        ...
        {
            var config = (AmazonWorkspacesInstancesConfig)requestContext.ClientConfig;
            var result = new WorkspacesInstancesEndpointParameters();
