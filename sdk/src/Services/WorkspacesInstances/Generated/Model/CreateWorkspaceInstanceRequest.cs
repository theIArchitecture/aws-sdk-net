...
{
    /// <summary>
    /// Container for the parameters to the CreateWorkspaceInstance operation.
    ...
    public partial class CreateWorkspaceInstanceRequest : AmazonWorkspacesInstancesRequest
    {
        ...
        /// <summary>
        /// Gets and sets the property ManagedInstance. 
        /// <para>
        ...
        public ManagedInstanceRequest ManagedInstance
        {
            get { return this._managedInstance; }
            set { this._managedInstance = value; }
        }

        // Check to see if ManagedInstance property is set
        internal bool IsSetManagedInstance()
        {
            return this._managedInstance != null;
        }
