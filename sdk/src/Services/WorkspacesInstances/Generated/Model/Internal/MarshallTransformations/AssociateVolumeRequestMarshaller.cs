...
{
    /// <summary>
    /// AssociateVolume Request Marshaller
    /// </summary>       
    public class AssociateVolumeRequestMarshaller : IMarshaller<IRequest, AssociateVolumeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AssociateVolumeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AssociateVolumeRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.WorkspacesInstances");
            string target = "EUCMIFrontendAPIService.AssociateVolume";
        ...
        private static AssociateVolumeRequestMarshaller _instance = new AssociateVolumeRequestMarshaller();        

        internal static AssociateVolumeRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateVolumeRequestMarshaller Instance
        {
            get
            {
                return _instance;
