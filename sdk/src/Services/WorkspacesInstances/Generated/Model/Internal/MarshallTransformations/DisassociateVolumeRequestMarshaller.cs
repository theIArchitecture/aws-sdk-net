...
{
    /// <summary>
    /// DisassociateVolume Request Marshaller
    /// </summary>       
    public class DisassociateVolumeRequestMarshaller : IMarshaller<IRequest, DisassociateVolumeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DisassociateVolumeRequest)input);
        }
        ...
        internal static DisassociateVolumeRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateVolumeRequestMarshaller Instance
        {
            get
            {
                return _instance;
