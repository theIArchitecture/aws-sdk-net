...
{
    /// <summary>
    /// Response Unmarshaller for GetWorkspaceInstance operation
    /// </summary>  
    public class GetWorkspaceInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetWorkspaceInstanceResponse response = new GetWorkspaceInstanceResponse();
        ...
        private static GetWorkspaceInstanceResponseUnmarshaller _instance = new GetWorkspaceInstanceResponseUnmarshaller();        

        internal static GetWorkspaceInstanceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetWorkspaceInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
