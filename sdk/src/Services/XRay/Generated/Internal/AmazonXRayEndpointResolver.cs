...
namespace Amazon.XRay.Internal
{
    ...
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for XRay service requests.
    /// Collects values for XRayEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses XRayEndpointProvider.
