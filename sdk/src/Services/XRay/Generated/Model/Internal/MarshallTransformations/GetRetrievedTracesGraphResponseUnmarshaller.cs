...
{
    /// <summary>
    /// Response Unmarshaller for GetRetrievedTracesGraph operation
    /// </summary>  
    public class GetRetrievedTracesGraphResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRetrievedTracesGraphResponse response = new GetRetrievedTracesGraphResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<RetrievedService, RetrievedServiceUnmarshaller>(RetrievedServiceUnmarshaller.Instance);
        ...
        private static GetRetrievedTracesGraphResponseUnmarshaller _instance = new GetRetrievedTracesGraphResponseUnmarshaller();        

        internal static GetRetrievedTracesGraphResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRetrievedTracesGraphResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
