    ...
    public class GetSamplingRulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<SamplingRuleRecord, SamplingRuleRecordUnmarshaller>(SamplingRuleRecordUnmarshaller.Instance);
                    response.SamplingRuleRecords = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
