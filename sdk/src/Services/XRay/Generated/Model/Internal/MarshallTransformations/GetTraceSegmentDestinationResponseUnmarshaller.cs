...
namespace Amazon.XRay.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetTraceSegmentDestinationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTraceSegmentDestinationResponse response = new GetTraceSegmentDestinationResponse();
        ...
        internal static GetTraceSegmentDestinationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTraceSegmentDestinationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
