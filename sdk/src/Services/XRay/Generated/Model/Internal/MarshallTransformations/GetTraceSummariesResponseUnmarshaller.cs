        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("ApproximateTime", targetDepth))
                {
                    ...
                    response.ApproximateTime = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("TracesProcessedCount", targetDepth))
                {
                    ...
                    response.TracesProcessedCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("TraceSummaries", targetDepth))
                {
                    ...
                    response.TraceSummaries = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
