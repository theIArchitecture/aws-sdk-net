...
namespace Amazon.XRay.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InsightImpactGraphServiceUnmarshaller : IJsonUnmarshaller<InsightImpactGraphService, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public InsightImpactGraphService Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<InsightImpactGraphEdge, InsightImpactGraphEdgeUnmarshaller>(InsightImpactGraphEdgeUnmarshaller.Instance);
