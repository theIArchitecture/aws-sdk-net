...
{
    /// <summary>
    /// Response Unmarshaller for ListRetrievedTraces operation
    /// </summary>  
    public class ListRetrievedTracesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListRetrievedTracesResponse response = new ListRetrievedTracesResponse();
        ...
        private static ListRetrievedTracesResponseUnmarshaller _instance = new ListRetrievedTracesResponseUnmarshaller();        

        internal static ListRetrievedTracesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRetrievedTracesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
