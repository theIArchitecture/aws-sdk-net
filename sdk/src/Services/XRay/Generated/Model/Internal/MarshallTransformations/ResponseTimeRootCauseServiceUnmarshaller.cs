...
namespace Amazon.XRay.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResponseTimeRootCauseServiceUnmarshaller : IJsonUnmarshaller<ResponseTimeRootCauseService, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResponseTimeRootCauseService Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<ResponseTimeRootCauseEntity, ResponseTimeRootCauseEntityUnmarshaller>(ResponseTimeRootCauseEntityUnmarshaller.Instance);
