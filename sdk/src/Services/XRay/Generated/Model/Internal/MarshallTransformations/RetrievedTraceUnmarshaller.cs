...
namespace Amazon.XRay.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RetrievedTraceUnmarshaller : IJsonUnmarshaller<RetrievedTrace, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RetrievedTrace Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<Span, SpanUnmarshaller>(SpanUnmarshaller.Instance);
