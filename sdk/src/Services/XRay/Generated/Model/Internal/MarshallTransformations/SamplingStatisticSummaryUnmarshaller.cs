...
namespace Amazon.XRay.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SamplingStatisticSummaryUnmarshaller : IJsonUnmarshaller<SamplingStatisticSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public SamplingStatisticSummary Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("BorrowCount", targetDepth))
                {
                    ...
                    unmarshalledObject.BorrowCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.SampledCount = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
