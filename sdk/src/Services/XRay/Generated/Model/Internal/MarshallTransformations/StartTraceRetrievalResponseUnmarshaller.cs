...
{
    /// <summary>
    /// Response Unmarshaller for StartTraceRetrieval operation
    /// </summary>  
    public class StartTraceRetrievalResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartTraceRetrievalResponse response = new StartTraceRetrievalResponse();
        ...
        private static StartTraceRetrievalResponseUnmarshaller _instance = new StartTraceRetrievalResponseUnmarshaller();        

        internal static StartTraceRetrievalResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartTraceRetrievalResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
