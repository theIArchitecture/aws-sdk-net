...
namespace Amazon.XRay.Model
{
    ...
    {
        private double? _actualSamplingPercentage;
        ...
        // Check to see if ActualSamplingPercentage property is set
        internal bool IsSetActualSamplingPercentage()
        {
            return this._actualSamplingPercentage.HasValue; 
        }
