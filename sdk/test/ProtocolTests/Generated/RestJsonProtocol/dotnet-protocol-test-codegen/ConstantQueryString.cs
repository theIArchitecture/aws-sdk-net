...
{
    [TestClass]
    public class ConstantQueryString
    {
        /// <summary>
        ...
        public void RestJsonConstantQueryStringRequest()
        {
            // Arrange
            var request = new ConstantQueryStringRequest
            {
                Hello = "hi",
            };
            ...
            Assert.AreEqual("/ConstantQueryString/hi", ProtocolTestUtils.GetEncodedResourcePathFromOriginalString(actualUri));
            ...
            Assert.IsTrue(actualQuerySegments.Contains("hello"));
        }
