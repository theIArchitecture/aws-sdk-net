...
namespace AWSSDK.ProtocolTests.RestJson
{
    ...
    public class JsonEnums
    {
        ...
        public void RestJsonJsonEnumsRequest()
        {
            // Arrange
            ...
            Assert.AreEqual("/JsonEnums", ProtocolTestUtils.GetEncodedResourcePathFromOriginalString(actualUri));
        ...
        [TestCategory("RestJson")]
        public void RestJsonJsonEnumsResponse()
        {
            // Arrange
