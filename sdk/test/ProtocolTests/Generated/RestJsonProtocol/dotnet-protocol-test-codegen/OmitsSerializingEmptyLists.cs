...
{
    [TestClass]
    public class OmitsSerializingEmptyLists
    {
        /// <summary>
        ...
        public void RestJsonOmitsEmptyListQueryValuesRequest()
        {
            // Arrange
            var request = new OmitsSerializingEmptyListsRequest
            {
            ...
            Assert.AreEqual("/OmitsSerializingEmptyLists", ProtocolTestUtils.GetEncodedResourcePathFromOriginalString(actualUri));
        }
