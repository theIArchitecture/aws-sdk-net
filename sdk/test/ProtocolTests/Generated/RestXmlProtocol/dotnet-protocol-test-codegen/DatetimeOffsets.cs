...
namespace AWSSDK.ProtocolTests.RestXml
{
    ...
    public class DatetimeOffsets
    {
        ...
        public void RestXmlDateTimeWithNegativeOffsetResponse()
        {
            // Arrange
            var webResponseData = new WebResponseData();
            webResponseData.StatusCode = (HttpStatusCode)Enum.ToObject(typeof(HttpStatusCode), 200);
            webResponseData.Headers["Content-Type"] = "application/xml";
            byte[] bytes = Encoding.ASCII.GetBytes("<DatetimeOffsetsOutput>\n    <datetime>2019-12-16T22:48:18-01:00</datetime>\n</DatetimeOffsetsOutput>\n");
        ...
        [TestCategory("ResponseTest")]
        [TestCategory("RestXml")]
        public void RestXmlDateTimeWithPositiveOffsetResponse()
        {
            // Arrange
            var webResponseData = new WebResponseData();
            webResponseData.StatusCode = (HttpStatusCode)Enum.ToObject(typeof(HttpStatusCode), 200);
