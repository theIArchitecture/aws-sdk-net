...
namespace AWSSDK_DotNet.UnitTests.Endpoints
{
    ...
    public partial class AWSMarketplaceMeteringEndpointsTests
    {
        ...
        public void For_region_usisoeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonAWSMarketplaceMeteringEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://metering.marketplace-fips.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonAWSMarketplaceMeteringEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://metering.marketplace.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_euisoewest1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonAWSMarketplaceMeteringEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://metering.marketplace-fips.eu-isoe-west-1.cloud.adc-e.uk", endpoint.URL);
        }
        ...
        public void For_region_euisoewest1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonAWSMarketplaceMeteringEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://metering.marketplace.eu-isoe-west-1.cloud.adc-e.uk", endpoint.URL);
        }
        ...
        public void For_region_usisofsouth1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonAWSMarketplaceMeteringEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://metering.marketplace-fips.us-isof-south-1.csp.hci.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisofsouth1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonAWSMarketplaceMeteringEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://metering.marketplace.us-isof-south-1.csp.hci.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_euscdeeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonAWSMarketplaceMeteringEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://metering.marketplace-fips.eusc-de-east-1.amazonaws.eu", endpoint.URL);
        }
