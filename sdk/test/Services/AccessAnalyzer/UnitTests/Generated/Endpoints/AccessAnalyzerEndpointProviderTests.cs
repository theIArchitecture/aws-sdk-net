...
namespace AWSSDK_DotNet.UnitTests.Endpoints
{
    ...
    public partial class AccessAnalyzerEndpointsTests
    {
        ...
        public void For_region_usisoeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonAccessAnalyzerEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://access-analyzer-fips.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonAccessAnalyzerEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://access-analyzer.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonAccessAnalyzerEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://access-analyzer-fips.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonAccessAnalyzerEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://access-analyzer.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
