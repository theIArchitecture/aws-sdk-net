...
namespace AWSSDK_DotNet.UnitTests.Endpoints
{
    ...
    public partial class CodeCommitEndpointsTests
    {
        ...
        public void For_region_usisoeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonCodeCommitEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://codecommit-fips.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonCodeCommitEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://codecommit.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonCodeCommitEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://codecommit-fips.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonCodeCommitEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://codecommit.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
