...
namespace Amazon.DocumentTypesTest.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonDocumentTypesTestAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonDocumentTypesTestAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for DocumentTypesTest.
        /// </summary>
        public AmazonDocumentTypesTestAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonDocumentTypesTestAuthSchemeParameters
            {
    ...
    public class AmazonDocumentTypesTestAuthSchemeResolver : IAuthSchemeResolver<AmazonDocumentTypesTestAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonDocumentTypesTestAuthSchemeParameters authParameters)
        {
