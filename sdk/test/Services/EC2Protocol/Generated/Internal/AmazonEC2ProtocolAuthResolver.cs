...
namespace Amazon.EC2Protocol.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonEC2ProtocolAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonEC2ProtocolAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for EC2Protocol.
        /// </summary>
        public AmazonEC2ProtocolAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonEC2ProtocolAuthSchemeParameters
            {
    ...
    public class AmazonEC2ProtocolAuthSchemeResolver : IAuthSchemeResolver<AmazonEC2ProtocolAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonEC2ProtocolAuthSchemeParameters authParameters)
        {
