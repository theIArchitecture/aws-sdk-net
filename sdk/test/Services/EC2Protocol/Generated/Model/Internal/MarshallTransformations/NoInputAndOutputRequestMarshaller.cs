...
namespace Amazon.EC2Protocol.Model.Internal.MarshallTransformations
{
    ...
    public class NoInputAndOutputRequestMarshaller : IMarshaller<IRequest, NoInputAndOutputRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((NoInputAndOutputRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(NoInputAndOutputRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2Protocol");
            request.Parameters.Add("Action", "NoInputAndOutput");
        ...
        internal static NoInputAndOutputRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static NoInputAndOutputRequestMarshaller Instance
        {
            get
            {
                return _instance;
