...
namespace Amazon.EC2Protocol.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class XmlNamespacesRequestMarshaller : IMarshaller<IRequest, XmlNamespacesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(XmlNamespacesRequest publicRequest)
        {
            ...
            request.Parameters.Add("Action", "XmlNamespaces");
