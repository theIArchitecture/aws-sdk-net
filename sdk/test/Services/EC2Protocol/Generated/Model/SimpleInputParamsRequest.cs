...
namespace Amazon.EC2Protocol.Model
{
    ...
    /// </summary>
    public partial class SimpleInputParamsRequest : AmazonEC2ProtocolRequest
    {
        private int? _bam;
        private string _bar;
        private bool? _baz;
        ...
        private string _hasQueryAndXmlName;
        private string _hasQueryName;
        private MemoryStream _qux;
        private string _usesXmlName;
        ...
        /// <summary>
        /// Gets and sets the property HasQueryAndXmlName.
        /// </summary>
        public string HasQueryAndXmlName
        {
            get { return this._hasQueryAndXmlName; }
            set { this._hasQueryAndXmlName = value; }
        }

        // Check to see if HasQueryAndXmlName property is set
        internal bool IsSetHasQueryAndXmlName()
        {
            return this._hasQueryAndXmlName != null;
        }

        /// <summary>
        /// Gets and sets the property HasQueryName.
        /// </summary>
        public string HasQueryName
        {
            get { return this._hasQueryName; }
            set { this._hasQueryName = value; }
        }

        // Check to see if HasQueryName property is set
        internal bool IsSetHasQueryName()
        {
            return this._hasQueryName != null;
        }
        ...
        /// <summary>
        /// Gets and sets the property UsesXmlName.
        /// </summary>
        public string UsesXmlName
        {
            get { return this._usesXmlName; }
            set { this._usesXmlName = value; }
        }

        // Check to see if UsesXmlName property is set
        internal bool IsSetUsesXmlName()
        {
            return this._usesXmlName != null;
        }
