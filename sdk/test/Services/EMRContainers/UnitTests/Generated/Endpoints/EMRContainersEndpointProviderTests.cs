...
namespace AWSSDK_DotNet.UnitTests.Endpoints
{
    ...
    public partial class EMRContainersEndpointsTests
    {
        ...
        public void For_region_usgoveast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonEMRContainersEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://emr-containers.us-gov-east-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_usgovwest1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonEMRContainersEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://emr-containers.us-gov-west-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonEMRContainersEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://emr-containers-fips.us-gov-east-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonEMRContainersEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://emr-containers.us-gov-east-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonEMRContainersEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://emr-containers-fips.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonEMRContainersEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://emr-containers.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonEMRContainersEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://emr-containers-fips.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonEMRContainersEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://emr-containers.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
