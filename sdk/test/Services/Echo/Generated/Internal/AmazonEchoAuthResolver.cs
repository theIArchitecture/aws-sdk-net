...
namespace Amazon.Echo.Internal
{
    ...
    public class AmazonEchoAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonEchoAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Echo.
        /// </summary>
        public AmazonEchoAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonEchoAuthSchemeParameters
            {
    ...
    public class AmazonEchoAuthSchemeResolver : IAuthSchemeResolver<AmazonEchoAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonEchoAuthSchemeParameters authParameters)
        {
