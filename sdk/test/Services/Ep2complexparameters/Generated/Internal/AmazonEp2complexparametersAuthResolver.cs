...
namespace Amazon.Ep2complexparameters.Internal
{
    ...
    public class AmazonEp2complexparametersAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonEp2complexparametersAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Ep2complexparameters.
        /// </summary>
        public AmazonEp2complexparametersAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonEp2complexparametersAuthSchemeParameters
            {
    ...
    public class AmazonEp2complexparametersAuthSchemeResolver : IAuthSchemeResolver<AmazonEp2complexparametersAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonEp2complexparametersAuthSchemeParameters authParameters)
        {
