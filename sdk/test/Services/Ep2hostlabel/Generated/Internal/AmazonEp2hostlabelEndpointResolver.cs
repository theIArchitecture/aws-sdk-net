...
{
    /// <summary>
    /// Amazon Ep2hostlabel endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for Ep2hostlabel service requests.
    /// Collects values for Ep2hostlabelEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses Ep2hostlabelEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonEp2hostlabelEndpointResolver : BaseEndpointResolver
    {
