...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonEp2hostlabelConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonEp2hostlabelConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonEp2hostlabelConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonEp2hostlabelConfig to create AmazonEp2hostlabelClient");
            }

            return awsCredentials == null ? 
                    new AmazonEp2hostlabelClient(serviceClientConfig) :
                    new AmazonEp2hostlabelClient(awsCredentials, serviceClientConfig);
        }
