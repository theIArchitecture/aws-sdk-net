...
{
    /// <summary>
    /// Amazon Ep2parsearn endpoint resolver.
    /// Custom PipelineHandler responsible for resolving endpoint and setting authentication parameters for Ep2parsearn service requests.
    /// Collects values for Ep2parsearnEndpointParameters and then tries to resolve endpoint by calling 
    /// ResolveEndpoint method on GlobalEndpoints.Provider if present, otherwise uses Ep2parsearnEndpointProvider.
    /// Responsible for setting authentication and http headers provided by resolved endpoint.
    /// </summary>
    public class AmazonEp2parsearnEndpointResolver : BaseEndpointResolver
    {
