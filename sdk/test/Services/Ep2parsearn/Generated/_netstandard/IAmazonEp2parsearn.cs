...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonEp2parsearnConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonEp2parsearnConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonEp2parsearnConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonEp2parsearnConfig to create AmazonEp2parsearnClient");
            }

            return awsCredentials == null ? 
                    new AmazonEp2parsearnClient(serviceClientConfig) :
                    new AmazonEp2parsearnClient(awsCredentials, serviceClientConfig);
        }
