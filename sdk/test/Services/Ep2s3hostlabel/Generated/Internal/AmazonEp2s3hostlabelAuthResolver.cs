...
namespace Amazon.Ep2s3hostlabel.Internal
{
    ...
    public class AmazonEp2s3hostlabelAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonEp2s3hostlabelAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Ep2s3hostlabel.
        /// </summary>
        public AmazonEp2s3hostlabelAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonEp2s3hostlabelAuthSchemeParameters
            {
    ...
    public class AmazonEp2s3hostlabelAuthSchemeResolver : IAuthSchemeResolver<AmazonEp2s3hostlabelAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonEp2s3hostlabelAuthSchemeParameters authParameters)
        {
