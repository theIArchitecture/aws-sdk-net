...
namespace Amazon.Ep2substring.Internal
{
    ...
    public class AmazonEp2substringAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonEp2substringAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Ep2substring.
        /// </summary>
        public AmazonEp2substringAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonEp2substringAuthSchemeParameters
            {
    ...
    public class AmazonEp2substringAuthSchemeResolver : IAuthSchemeResolver<AmazonEp2substringAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonEp2substringAuthSchemeParameters authParameters)
        {
