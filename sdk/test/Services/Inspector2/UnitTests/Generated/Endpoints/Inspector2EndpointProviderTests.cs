...
namespace AWSSDK_DotNet.UnitTests.Endpoints
{
    ...
    public partial class Inspector2EndpointsTests
    {
        ...
        public void For_region_cnnorth1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonInspector2EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://inspector2-fips.cn-north-1.api.amazonwebservices.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorth1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonInspector2EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://inspector2-fips.cn-north-1.amazonaws.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorth1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonInspector2EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://inspector2.cn-north-1.api.amazonwebservices.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorth1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonInspector2EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://inspector2.cn-north-1.amazonaws.com.cn", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonInspector2EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://inspector2-fips.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonInspector2EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://inspector2.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonInspector2EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://inspector2-fips.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonInspector2EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://inspector2.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
