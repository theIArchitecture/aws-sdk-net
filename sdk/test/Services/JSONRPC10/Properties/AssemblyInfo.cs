...
#elif NETCOREAPP3_1
[assembly: AssemblyDescription("The Amazon Web Services SDK for .NET (.NET Core 3.1) - Sample Json 1.0 Protocol Service. JSON 1.0 test service")]
#elif NET8_0
[assembly: AssemblyDescription("The Amazon Web Services SDK for .NET (.NET 8.0) - Sample Json 1.0 Protocol Service. JSON 1.0 test service")]
#else
