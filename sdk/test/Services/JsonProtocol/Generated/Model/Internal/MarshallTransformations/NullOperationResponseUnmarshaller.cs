...
{
    /// <summary>
    /// Response Unmarshaller for NullOperation operation
    /// </summary>  
    public class NullOperationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            NullOperationResponse response = new NullOperationResponse();
        ...
        private static NullOperationResponseUnmarshaller _instance = new NullOperationResponseUnmarshaller();        

        internal static NullOperationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static NullOperationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
