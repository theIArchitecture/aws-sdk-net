...
namespace Amazon.JsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class PutAndGetInlineDocumentsRequestMarshaller : IMarshaller<IRequest, PutAndGetInlineDocumentsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static PutAndGetInlineDocumentsRequestMarshaller _instance = new PutAndGetInlineDocumentsRequestMarshaller();        

        internal static PutAndGetInlineDocumentsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutAndGetInlineDocumentsRequestMarshaller Instance
        {
            get
            {
                return _instance;
