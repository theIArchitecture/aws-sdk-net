...
namespace AWSSDK_DotNet.UnitTests.Endpoints
{
    ...
    public partial class MediaPackageVodEndpointsTests
    {
        ...
        public void For_region_cnnorth1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonMediaPackageVodEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://mediapackage-vod-fips.cn-north-1.api.amazonwebservices.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorth1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonMediaPackageVodEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://mediapackage-vod-fips.cn-north-1.amazonaws.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorth1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonMediaPackageVodEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://mediapackage-vod.cn-north-1.api.amazonwebservices.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorth1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonMediaPackageVodEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://mediapackage-vod.cn-north-1.amazonaws.com.cn", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonMediaPackageVodEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://mediapackage-vod-fips.us-gov-east-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonMediaPackageVodEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://mediapackage-vod-fips.us-gov-east-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonMediaPackageVodEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://mediapackage-vod.us-gov-east-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonMediaPackageVodEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://mediapackage-vod.us-gov-east-1.amazonaws.com", endpoint.URL);
        }
