...
namespace AWSSDK_DotNet.UnitTests.Endpoints
{
    ...
    public partial class MemoryDBEndpointsTests
    {
        ...
        [TestCategory("Endpoints")]
        [TestCategory("MemoryDB")]
        [Description("For region fips with FIPS disabled and DualStack disabled")]
        public void For_region_fips_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            var parameters = new MemoryDBEndpointParameters();
            parameters["Region"] = "fips";
            parameters["UseFIPS"] = false;
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonMemoryDBEndpointProvider().ResolveEndpoint(parameters);
        ...
        public void For_region_usgoveast1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonMemoryDBEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://memory-db-fips.us-gov-east-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonMemoryDBEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://memory-db-fips.us-gov-east-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonMemoryDBEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://memory-db.us-gov-east-1.api.aws", endpoint.URL);
        }
        ...
        public void For_region_usgoveast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonMemoryDBEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://memory-db.us-gov-east-1.amazonaws.com", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonMemoryDBEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://memory-db-fips.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonMemoryDBEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://memory-db.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonMemoryDBEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://memory-db-fips.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonMemoryDBEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://memory-db.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
