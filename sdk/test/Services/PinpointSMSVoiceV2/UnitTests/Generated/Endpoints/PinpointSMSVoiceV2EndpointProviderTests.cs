...
namespace AWSSDK_DotNet.UnitTests.Endpoints
{
    ...
    public partial class PinpointSMSVoiceV2EndpointsTests
    {
        ...
        public void For_region_cnnorth1_with_FIPS_enabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonPinpointSMSVoiceV2EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://sms-voice-fips.cn-north-1.api.amazonwebservices.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorth1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonPinpointSMSVoiceV2EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://sms-voice-fips.cn-north-1.amazonaws.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorth1_with_FIPS_disabled_and_DualStack_enabled_Test()
        {
            ...
            parameters["UseDualStack"] = true;
            var endpoint = new AmazonPinpointSMSVoiceV2EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://sms-voice.cn-north-1.api.amazonwebservices.com.cn", endpoint.URL);
        }
        ...
        public void For_region_cnnorth1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonPinpointSMSVoiceV2EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://sms-voice.cn-north-1.amazonaws.com.cn", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonPinpointSMSVoiceV2EndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://sms-voice.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
