...
namespace Amazon.QueryCompatible
{
    ...
    public partial class AmazonQueryCompatibleException : AmazonServiceException
    {
        ...
        public AmazonQueryCompatibleException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonQueryCompatibleException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
