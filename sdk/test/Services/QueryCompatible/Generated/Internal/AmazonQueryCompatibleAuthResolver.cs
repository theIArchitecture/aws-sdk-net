...
namespace Amazon.QueryCompatible.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonQueryCompatibleAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonQueryCompatibleAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for QueryCompatible.
        /// </summary>
        public AmazonQueryCompatibleAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonQueryCompatibleAuthSchemeParameters
            {
    ...
    public class AmazonQueryCompatibleAuthSchemeResolver : IAuthSchemeResolver<AmazonQueryCompatibleAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonQueryCompatibleAuthSchemeParameters authParameters)
        {
