...
namespace Amazon.QueryCompatible.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StaticOpResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        internal static StaticOpResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StaticOpResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
