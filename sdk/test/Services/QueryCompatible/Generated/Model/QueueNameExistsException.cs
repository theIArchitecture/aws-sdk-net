...
namespace Amazon.QueryCompatible.Model
{
    ...
    [Serializable]
    #endif
    public partial class QueueNameExistsException : AmazonQueryCompatibleException
    {
        ...
        public QueueNameExistsException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public QueueNameExistsException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
