...
{
    /// <summary>
    /// Response Unmarshaller for CustomCodeErrorException Object
    /// </summary>  
    public class CustomCodeErrorExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<CustomCodeErrorException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public CustomCodeErrorException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public CustomCodeErrorException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
            ...
            CustomCodeErrorException unmarshalledObject = new CustomCodeErrorException(errorResponse.Message, errorResponse.InnerException,
