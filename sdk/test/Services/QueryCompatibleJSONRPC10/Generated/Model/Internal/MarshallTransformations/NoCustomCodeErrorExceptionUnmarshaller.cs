...
namespace Amazon.QueryCompatibleJSONRPC10.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NoCustomCodeErrorExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<NoCustomCodeErrorException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public NoCustomCodeErrorException Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public NoCustomCodeErrorException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref StreamingUtf8JsonReader reader)
        {
