...
namespace Amazon.QueryCompatibleRpcV2Protocol.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CustomCodeErrorExceptionUnmarshaller : ICborErrorResponseUnmarshaller<CustomCodeErrorException, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public CustomCodeErrorException Unmarshall(CborUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public CustomCodeErrorException Unmarshall(CborUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse)
        {
            ...
            context.AddPathSegment("CustomCodeErrorException");
            reader.ReadStartMap();
