...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonQueryCompatibleRpcV2ProtocolConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonQueryCompatibleRpcV2ProtocolConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonQueryCompatibleRpcV2ProtocolConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonQueryCompatibleRpcV2ProtocolConfig to create AmazonQueryCompatibleRpcV2ProtocolClient");
            }

            return awsCredentials == null ? 
                    new AmazonQueryCompatibleRpcV2ProtocolClient(serviceClientConfig) :
                    new AmazonQueryCompatibleRpcV2ProtocolClient(awsCredentials, serviceClientConfig);
        }
