...
namespace Amazon.QueryProtocol.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonQueryProtocolAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonQueryProtocolAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for QueryProtocol.
        /// </summary>
        public AmazonQueryProtocolAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonQueryProtocolAuthSchemeParameters
            {
    ...
    public class AmazonQueryProtocolAuthSchemeResolver : IAuthSchemeResolver<AmazonQueryProtocolAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonQueryProtocolAuthSchemeParameters authParameters)
        {
