    ...
    public class EndpointWithHostLabelOperationResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("EndpointWithHostLabelOperationResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, EndpointWithHostLabelOperationResponse response)
        {
