...
namespace Amazon.QueryProtocol.Model.Internal.MarshallTransformations
{
    ...
    public class FlattenedXmlMapWithXmlNameRequestMarshaller : IMarshaller<IRequest, FlattenedXmlMapWithXmlNameRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((FlattenedXmlMapWithXmlNameRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(FlattenedXmlMapWithXmlNameRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.QueryProtocol");
            request.Parameters.Add("Action", "FlattenedXmlMapWithXmlName");
        ...
        internal static FlattenedXmlMapWithXmlNameRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static FlattenedXmlMapWithXmlNameRequestMarshaller Instance
        {
            get
            {
                return _instance;
