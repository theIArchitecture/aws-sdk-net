...
namespace Amazon.QueryProtocol.Model.Internal.MarshallTransformations
{
    ...
    public class FlattenedXmlMapWithXmlNamespaceRequestMarshaller : IMarshaller<IRequest, FlattenedXmlMapWithXmlNamespaceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((FlattenedXmlMapWithXmlNamespaceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(FlattenedXmlMapWithXmlNamespaceRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.QueryProtocol");
            request.Parameters.Add("Action", "FlattenedXmlMapWithXmlNamespace");
        ...
        internal static FlattenedXmlMapWithXmlNamespaceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static FlattenedXmlMapWithXmlNamespaceRequestMarshaller Instance
        {
            get
            {
                return _instance;
