...
namespace Amazon.QueryProtocol.Model.Internal.MarshallTransformations
{
    ...
    public class InvalidGreetingExceptionUnmarshaller : IXmlErrorResponseUnmarshaller<InvalidGreetingException, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public InvalidGreetingException Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public InvalidGreetingException Unmarshall(XmlUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse)
        {
            InvalidGreetingException response = new InvalidGreetingException(errorResponse.Message, errorResponse.InnerException, 
