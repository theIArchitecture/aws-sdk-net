...
namespace Amazon.QueryProtocol.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class NoInputAndNoOutputRequestMarshaller : IMarshaller<IRequest, NoInputAndNoOutputRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(NoInputAndNoOutputRequest publicRequest)
        {
            ...
            request.Parameters.Add("Action", "NoInputAndNoOutput");
