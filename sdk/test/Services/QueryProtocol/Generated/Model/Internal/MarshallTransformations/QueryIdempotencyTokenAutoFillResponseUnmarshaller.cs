    ...
    public class QueryIdempotencyTokenAutoFillResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("QueryIdempotencyTokenAutoFillResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, QueryIdempotencyTokenAutoFillResponse response)
        {
        ...
        internal static QueryIdempotencyTokenAutoFillResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static QueryIdempotencyTokenAutoFillResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
