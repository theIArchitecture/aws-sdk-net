...
namespace Amazon.QueryProtocol.Model.Internal.MarshallTransformations
{
    ...
    public class RecursiveXmlShapesOutputNested1Unmarshaller : IXmlUnmarshaller<RecursiveXmlShapesOutputNested1, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public RecursiveXmlShapesOutputNested1 Unmarshall(XmlUnmarshallerContext context)
        {
            RecursiveXmlShapesOutputNested1 unmarshalledObject = new RecursiveXmlShapesOutputNested1();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = RecursiveXmlShapesOutputNested2Unmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RecursiveXmlShapesOutputNested1Unmarshaller Instance
        {
            get
            {
                return _instance;
