...
namespace Amazon.QueryProtocol.Model
{
    ...
    public partial class QueryListsRequest : AmazonQueryProtocolRequest
    {
        ...
        private List<string> _flattenedListArg = AWSConfigs.InitializeCollections ? new List<string>() : null;
        private List<string> _flattenedListArgWithXmlName = AWSConfigs.InitializeCollections ? new List<string>() : null;
        ...
        {
            return this._flattenedListArg != null && (this._flattenedListArg.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
        ...
        {
            return this._flattenedListArgWithXmlName != null && (this._flattenedListArgWithXmlName.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
