...
{
    /// <summary>
    /// Container for the parameters to the HttpPayloadWithUnion operation.
    /// This example serializes a union in the payload.
    /// </summary>
    public partial class HttpPayloadWithUnionRequest : AmazonRestJsonProtocolRequest
    {
        private UnionPayload _nested;

        /// <summary>
        /// Gets and sets the property Nested.
        /// </summary>
        public UnionPayload Nested
        {
