...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class HttpEnumPayloadResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            HttpEnumPayloadResponse response = new HttpEnumPayloadResponse();
        ...
        internal static HttpEnumPayloadResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static HttpEnumPayloadResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
