...
{
    /// <summary>
    /// Response Unmarshaller for JsonTimestamps operation
    /// </summary>  
    public class JsonTimestampsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static JsonTimestampsResponseUnmarshaller _instance = new JsonTimestampsResponseUnmarshaller();        

        internal static JsonTimestampsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static JsonTimestampsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
