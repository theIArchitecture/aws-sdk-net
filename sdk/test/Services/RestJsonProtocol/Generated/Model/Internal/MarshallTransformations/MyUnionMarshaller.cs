...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    public class MyUnionMarshaller : IRequestMarshaller<MyUnion, JsonMarshallerContext> 
    {
        ...
        public void Marshall(MyUnion requestObject, JsonMarshallerContext context)
        {
            ...
            {
                context.Writer.WritePropertyName("renamedStructureValue");
                context.Writer.WriteStartObject();

                var marshaller = RenamedGreetingMarshaller.Instance;
                marshaller.Marshall(requestObject.RenamedStructureValue, context);
