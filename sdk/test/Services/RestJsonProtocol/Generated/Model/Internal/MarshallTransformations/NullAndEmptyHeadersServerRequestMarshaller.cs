...
namespace Amazon.RestJsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    public class NullAndEmptyHeadersServerRequestMarshaller : IMarshaller<IRequest, NullAndEmptyHeadersServerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((NullAndEmptyHeadersServerRequest)input);
        }
        ...
        internal static NullAndEmptyHeadersServerRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static NullAndEmptyHeadersServerRequestMarshaller Instance
        {
            get
            {
                return _instance;
