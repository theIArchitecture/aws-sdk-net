...
namespace Amazon.RestJsonTest.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonRestJsonTestAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonRestJsonTestAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for RestJsonTest.
        /// </summary>
        public AmazonRestJsonTestAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonRestJsonTestAuthSchemeParameters
            {
    ...
    public class AmazonRestJsonTestAuthSchemeResolver : IAuthSchemeResolver<AmazonRestJsonTestAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonRestJsonTestAuthSchemeParameters authParameters)
        {
