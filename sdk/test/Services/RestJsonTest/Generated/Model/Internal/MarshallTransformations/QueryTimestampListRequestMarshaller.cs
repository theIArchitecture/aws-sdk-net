...
{
    /// <summary>
    /// QueryTimestampList Request Marshaller
    /// </summary>       
    public class QueryTimestampListRequestMarshaller : IMarshaller<IRequest, QueryTimestampListRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((QueryTimestampListRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(QueryTimestampListRequest publicRequest)
        {
        ...
        private static QueryTimestampListRequestMarshaller _instance = new QueryTimestampListRequestMarshaller();        

        internal static QueryTimestampListRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static QueryTimestampListRequestMarshaller Instance
        {
            get
            {
                return _instance;
