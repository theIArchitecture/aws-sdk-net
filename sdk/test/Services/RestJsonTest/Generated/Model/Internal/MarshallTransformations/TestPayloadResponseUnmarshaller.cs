...
{
    /// <summary>
    /// Response Unmarshaller for TestPayload operation
    /// </summary>  
    public class TestPayloadResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TestPayloadResponse response = new TestPayloadResponse();
        ...
        private static TestPayloadResponseUnmarshaller _instance = new TestPayloadResponseUnmarshaller();        

        internal static TestPayloadResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TestPayloadResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
