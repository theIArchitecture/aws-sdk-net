...
{
    /// <summary>
    /// Container for the parameters to the QueryIntegerListMap operation.
    ...
    public partial class QueryIntegerListMapRequest : AmazonRestJsonTestRequest
    {
        ...
        /// </summary>
        public Dictionary<string, List<int>> QueryParamsMapOfIntegerList
        {
            get { return this._queryParamsMapOfIntegerList; }
            set { this._queryParamsMapOfIntegerList = value; }
        }
