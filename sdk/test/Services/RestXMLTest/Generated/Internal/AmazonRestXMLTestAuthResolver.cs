...
namespace Amazon.RestXMLTest.Internal
{
    ...
    public class AmazonRestXMLTestAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonRestXMLTestAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for RestXMLTest.
        /// </summary>
        public AmazonRestXMLTestAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonRestXMLTestAuthSchemeParameters
            {
    ...
    public class AmazonRestXMLTestAuthSchemeResolver : IAuthSchemeResolver<AmazonRestXMLTestAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonRestXMLTestAuthSchemeParameters authParameters)
        {
