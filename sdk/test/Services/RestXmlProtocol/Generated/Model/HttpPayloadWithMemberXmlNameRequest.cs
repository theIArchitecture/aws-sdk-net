...
{
    /// <summary>
    /// Container for the parameters to the HttpPayloadWithMemberXmlName operation.
    /// The following example serializes a payload that uses an XML name on the member, changing
    /// the wrapper name.
    /// </summary>
    public partial class HttpPayloadWithMemberXmlNameRequest : AmazonRestXmlProtocolRequest
    {
