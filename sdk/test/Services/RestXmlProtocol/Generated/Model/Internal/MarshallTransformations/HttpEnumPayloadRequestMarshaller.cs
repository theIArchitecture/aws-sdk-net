...
namespace Amazon.RestXmlProtocol.Model.Internal.MarshallTransformations
{
    ...
    public partial class HttpEnumPayloadRequestMarshaller : IMarshaller<IRequest, HttpEnumPayloadRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((HttpEnumPayloadRequest)input);
        }
        ...
        internal static HttpEnumPayloadRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static HttpEnumPayloadRequestMarshaller Instance
        {
            get
            {
                return _instance;
