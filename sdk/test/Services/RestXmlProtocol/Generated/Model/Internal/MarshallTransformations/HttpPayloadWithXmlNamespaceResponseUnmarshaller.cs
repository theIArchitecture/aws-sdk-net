...
namespace Amazon.RestXmlProtocol.Model.Internal.MarshallTransformations
{
    ...
    public partial class HttpPayloadWithXmlNamespaceResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, HttpPayloadWithXmlNamespaceResponse response)
        {
        ...
        internal static HttpPayloadWithXmlNamespaceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static HttpPayloadWithXmlNamespaceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
