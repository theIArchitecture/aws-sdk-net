...
{
    /// <summary>
    /// NestedXmlMaps Request Marshaller
    /// </summary>       
    public partial class NestedXmlMapsRequestMarshaller : IMarshaller<IRequest, NestedXmlMapsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((NestedXmlMapsRequest)input);
        }
        ...
        private static NestedXmlMapsRequestMarshaller _instance = new NestedXmlMapsRequestMarshaller();        

        internal static NestedXmlMapsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static NestedXmlMapsRequestMarshaller Instance
        {
            get
            {
                return _instance;
