...
namespace Amazon.RestXmlProtocol.Model.Internal.MarshallTransformations
{
    ...
    public partial class NestedXmlMapsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, NestedXmlMapsResponse response)
        {
        ...
        internal static NestedXmlMapsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static NestedXmlMapsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
