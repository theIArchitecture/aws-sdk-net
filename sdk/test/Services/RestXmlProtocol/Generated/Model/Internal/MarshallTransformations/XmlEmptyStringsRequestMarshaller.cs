...
{
    /// <summary>
    /// XmlEmptyStrings Request Marshaller
    /// </summary>       
    public partial class XmlEmptyStringsRequestMarshaller : IMarshaller<IRequest, XmlEmptyStringsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((XmlEmptyStringsRequest)input);
        }
        ...
        private static XmlEmptyStringsRequestMarshaller _instance = new XmlEmptyStringsRequestMarshaller();        

        internal static XmlEmptyStringsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static XmlEmptyStringsRequestMarshaller Instance
        {
            get
            {
                return _instance;
