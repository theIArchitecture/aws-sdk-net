...
{
    /// <summary>
    /// XmlNamespaces Request Marshaller
    /// </summary>       
    public partial class XmlNamespacesRequestMarshaller : IMarshaller<IRequest, XmlNamespacesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((XmlNamespacesRequest)input);
        }
            ...
            {   
                ...
                if (publicRequest.Nested != null)
                {
                    ...
                    if (publicRequestNestedValues != null && (publicRequestNestedValues.Count > 0 || !AWSConfigs.InitializeCollections)) 
                    {
                        ...
                        {
                            xmlWriter.WriteStartElement("member", "http://bux.com");
        ...
        internal static XmlNamespacesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static XmlNamespacesRequestMarshaller Instance
        {
            get
            {
                return _instance;
