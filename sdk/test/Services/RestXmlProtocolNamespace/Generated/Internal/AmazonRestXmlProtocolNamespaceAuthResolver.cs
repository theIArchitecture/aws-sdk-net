...
namespace Amazon.RestXmlProtocolNamespace.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonRestXmlProtocolNamespaceAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonRestXmlProtocolNamespaceAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for RestXmlProtocolNamespace.
        /// </summary>
        public AmazonRestXmlProtocolNamespaceAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonRestXmlProtocolNamespaceAuthSchemeParameters
            {
    ...
    public class AmazonRestXmlProtocolNamespaceAuthSchemeResolver : IAuthSchemeResolver<AmazonRestXmlProtocolNamespaceAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonRestXmlProtocolNamespaceAuthSchemeParameters authParameters)
        {
