...
namespace Amazon.RpcV2Protocol.Internal
{
    ...
    public class AmazonRpcV2ProtocolAuthSchemeResolver : IAuthSchemeResolver<AmazonRpcV2ProtocolAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonRpcV2ProtocolAuthSchemeParameters authParameters)
        {
