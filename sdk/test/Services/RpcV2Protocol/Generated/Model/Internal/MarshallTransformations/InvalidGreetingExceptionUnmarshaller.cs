...
namespace Amazon.RpcV2Protocol.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InvalidGreetingExceptionUnmarshaller : ICborErrorResponseUnmarshaller<InvalidGreetingException, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public InvalidGreetingException Unmarshall(CborUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public InvalidGreetingException Unmarshall(CborUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse)
        {
            ...
            context.AddPathSegment("InvalidGreetingException");
            reader.ReadStartMap();
