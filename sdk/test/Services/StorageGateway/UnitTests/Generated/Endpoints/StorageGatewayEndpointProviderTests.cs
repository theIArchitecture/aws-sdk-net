...
namespace AWSSDK_DotNet.UnitTests.Endpoints
{
    ...
    public partial class StorageGatewayEndpointsTests
    {
        ...
        public void For_region_usisoeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonStorageGatewayEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://storagegateway-fips.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
        ...
        public void For_region_usisoeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonStorageGatewayEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://storagegateway.us-iso-east-1.c2s.ic.gov", endpoint.URL);
        }
