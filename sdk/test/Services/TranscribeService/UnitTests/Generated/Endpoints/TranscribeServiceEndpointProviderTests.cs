...
namespace AWSSDK_DotNet.UnitTests.Endpoints
{
    ...
    public partial class TranscribeServiceEndpointsTests
    {
        ...
        public void For_region_usisobeast1_with_FIPS_enabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonTranscribeServiceEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://transcribe-fips.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
        ...
        public void For_region_usisobeast1_with_FIPS_disabled_and_DualStack_disabled_Test()
        {
            ...
            parameters["UseDualStack"] = false;
            var endpoint = new AmazonTranscribeServiceEndpointProvider().ResolveEndpoint(parameters);
            Assert.AreEqual("https://transcribe.us-isob-east-1.sc2s.sgov.gov", endpoint.URL);
        }
