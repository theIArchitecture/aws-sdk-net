...
namespace Amazon.UseServiceIdTestserviceId.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonUseServiceIdTestserviceIdAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonUseServiceIdTestserviceIdAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for UseServiceIdTestserviceId.
        /// </summary>
        public AmazonUseServiceIdTestserviceIdAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonUseServiceIdTestserviceIdAuthSchemeParameters
            {
    ...
    public class AmazonUseServiceIdTestserviceIdAuthSchemeResolver : IAuthSchemeResolver<AmazonUseServiceIdTestserviceIdAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonUseServiceIdTestserviceIdAuthSchemeParameters authParameters)
        {
